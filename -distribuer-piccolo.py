...
runCommand (["mkdir", DIR + "/COCOA-PICCOLO"])
runCommand (["cp", DIR + "/piccolo/AUTHORS", DIR + "/COCOA-PICCOLO"])
runCommand (["cp", DIR + "/piccolo/COPYING", DIR + "/COCOA-PICCOLO"])
runCommand (["cp", "-r", DIR + "/piccolo/xcode-project/build/Default/CocoaPiccolo.app", DIR + "/COCOA-PICCOLO"])
runCommand (["hdiutil", "create", "-srcfolder", DIR + "/COCOA-PICCOLO", DIR + "/cocoa-piccolo-gc.dmg"])
runCommand (["rm", "-fr", DIR + "/COCOA-PICCOLO"])
...
runCommand (["cp", DIR + "/piccolo/COPYING", DIR + "/COCOA-PICCOLO"])
runCommand (["cp", "-r", DIR + "/piccolo/xcode-project/build/Default/CocoaPiccolo.app", DIR + "/COCOA-PICCOLO"])
runCommand (["hdiutil", "create", "-srcfolder", DIR + "/COCOA-PICCOLO", DIR + "/cocoa-piccolo-arc.dmg"])
runCommand (["rm", "-fr", DIR + "/COCOA-PICCOLO"])
