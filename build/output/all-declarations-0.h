...
//--------------------------------- GALGAS constructors
  public : static class GALGAS_baseline_5F_IF_5F_BitTest_5F_opcode constructor_BTFSC (LOCATION_ARGS) ;

  public : static class GALGAS_baseline_5F_IF_5F_BitTest_5F_opcode constructor_BTFSS (LOCATION_ARGS) ;
