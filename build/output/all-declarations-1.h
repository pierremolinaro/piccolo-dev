...
//--------------------------------- Getters
  public: VIRTUAL_IN_DEBUG class GALGAS_bool getter_CLRW (LOCATION_ARGS) const ;
  ...
  public: VIRTUAL_IN_DEBUG class GALGAS_bool getter_OPTION_5F_ (LOCATION_ARGS) const ;
