...
void cPtr_pic_31__38_Instruction_5F_LDATA_31__36_PTR::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                      ...
                                                                      Compiler * inCompiler
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uintlist var_data_40031 ;
  GALGAS_bool var_isData_38__40041 ;
  ...
  if (kBoolTrue == test_4) {
    ...
    test_4 = GALGAS_bool (ComparisonKind::greaterOrEqual, temp_5.readProperty_mDataIndex ().readProperty_uint ().objectCompare (var_data_40031.getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1159)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      const GALGAS_pic_31__38_Instruction_5F_LDATA_31__36_PTR temp_6 = this ;
      TC_Array <FixItDescription> fixItArray7 ;
      inCompiler->emitSemanticError (temp_6.readProperty_mDataIndex ().readProperty_location (), GALGAS_string ("index should be < ").add_operation (var_data_40031.getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1160)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1160)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1160)), fixItArray7  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1160)) ;
    }
  }
  const GALGAS_pic_31__38_Instruction_5F_LDATA_31__36_PTR temp_8 = this ;
  GALGAS_registerExpression var_TBLPTRU_40299 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TBLPTRU"), temp_8.readProperty_mInstructionLocation (), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1165)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1166)), inCompiler COMMA_HERE) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_outIPICregisterDescription_40655 ;
  GALGAS_bitSliceTable joker_40686 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TBLPTRU_40299.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (true), var_outIPICregisterDescription_40655, joker_40686, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1168)) ;
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::init_21__21__21_ (temp_12.readProperty_mInstructionLocation (), GALGAS_FA_5F_sequential_5F_instruction_5F_base_5F_code::class_func_MOVWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1188)), var_outIPICregisterDescription_40655, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1191)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1186)) ;
  const GALGAS_pic_31__38_Instruction_5F_LDATA_31__36_PTR temp_13 = this ;
  GALGAS_registerExpression var_TBLPTRH_41132 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TBLPTRH"), temp_13.readProperty_mInstructionLocation (), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1196)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1197)), inCompiler COMMA_HERE) ;
  GALGAS_bitSliceTable joker_41474 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TBLPTRH_41132.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (true), var_outIPICregisterDescription_40655, joker_41474, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1199)) ;
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::init_21__21__21_ (temp_17.readProperty_mInstructionLocation (), GALGAS_FA_5F_sequential_5F_instruction_5F_base_5F_code::class_func_MOVWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1219)), var_outIPICregisterDescription_40655, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1222)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1217)) ;
  const GALGAS_pic_31__38_Instruction_5F_LDATA_31__36_PTR temp_18 = this ;
  GALGAS_registerExpression var_TBLPTRL_41918 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TBLPTRL"), temp_18.readProperty_mInstructionLocation (), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1227)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1228)), inCompiler COMMA_HERE) ;
  GALGAS_bitSliceTable joker_42261 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TBLPTRL_41918.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (true), var_outIPICregisterDescription_40655, joker_42261, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1230)) ;
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::init_21__21__21_ (temp_22.readProperty_mInstructionLocation (), GALGAS_FA_5F_sequential_5F_instruction_5F_base_5F_code::class_func_MOVWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1250)), var_outIPICregisterDescription_40655, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1253)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1248)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_Instruction_5F_LDATA_38_PTR::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                  ...
                                                                  Compiler * inCompiler
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uintlist var_data_43427 ;
  GALGAS_bool var_isData_38__43437 ;
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::init_21__21__21_ (temp_12.readProperty_mInstructionLocation (), GALGAS_FA_5F_sequential_5F_instruction_5F_base_5F_code::class_func_MOVWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1310)), var_outIPICregisterDescription_44075, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1313)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1308)) ;
  const GALGAS_pic_31__38_Instruction_5F_LDATA_38_PTR temp_13 = this ;
  GALGAS_registerExpression var_TBLPTRH_44548 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TBLPTRH"), temp_13.readProperty_mInstructionLocation (), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1318)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1319)), inCompiler COMMA_HERE) ;
  GALGAS_bitSliceTable joker_44890 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TBLPTRH_44548.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (true), var_outIPICregisterDescription_44075, joker_44890, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1321)) ;
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::init_21__21__21_ (temp_17.readProperty_mInstructionLocation (), GALGAS_FA_5F_sequential_5F_instruction_5F_base_5F_code::class_func_MOVWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1341)), var_outIPICregisterDescription_44075, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1344)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1339)) ;
  const GALGAS_pic_31__38_Instruction_5F_LDATA_38_PTR temp_18 = this ;
  GALGAS_registerExpression var_TBLPTRL_45330 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TBLPTRL"), temp_18.readProperty_mInstructionLocation (), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1349)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1350)), inCompiler COMMA_HERE) ;
  GALGAS_bitSliceTable joker_45673 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TBLPTRL_45330.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (true), var_outIPICregisterDescription_44075, joker_45673, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1352)) ;
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::init_21__21__21_ (temp_22.readProperty_mInstructionLocation (), GALGAS_FA_5F_sequential_5F_instruction_5F_base_5F_code::class_func_MOVWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1372)), var_outIPICregisterDescription_44075, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1375)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1370)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_Instruction_5F_JUMP::method_analyze (const GALGAS_uint /* constinArgument_inAccessBankSplitOffset */,
                                                          ...
                                                          Compiler * inCompiler
                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_isNoReturn_46869 ;
  GALGAS_uint var_requiredBank_46891 ;
  const GALGAS_pic_31__38_Instruction_5F_JUMP temp_0 = this ;
  GALGAS_uint joker_46904 ; // Joker input parameter
  GALGAS_bool joker_46907 ; // Joker input parameter
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_3) {
        ...
        if (kBoolTrue == test_3) {
          var_errorMessage_47000.plusAssign_operation(GALGAS_string ("is not defined"), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1403)) ;
        }
      }
      if (kBoolFalse == test_3) {
        var_errorMessage_47000.plusAssign_operation(GALGAS_string ("is set to ").add_operation (ioArgument_ioCurrentBank.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1405)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1405)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1405)) ;
      }
...
void cPtr_pic_31__38_Instruction_5F_computed_5F_rcall::method_analyze (const GALGAS_uint /* constinArgument_inAccessBankSplitOffset */,
                                                                       ...
                                                                       Compiler * inCompiler
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_someReturnsBank_48617 = GALGAS_bool (false) ;
  ...
  while (enumerator_48698.hasCurrentObject ()) {
    GALGAS_bool var_isNoReturn_48779 ;
    GALGAS_uint var_requiredBank_48801 ;
    GALGAS_uint var_returnedBank_48825 ;
    GALGAS_bool var_preservesBank_48849 ;
    ...
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_48801.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1449)))).operator_and (GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_48801.objectCompare (ioArgument_ioCurrentBank)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1449)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_errorMessage_48957 = GALGAS_string ("the routine '").add_operation (enumerator_48698.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1450)).add_operation (GALGAS_string ("' requires bank selection to be set to "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1450)).add_operation (var_requiredBank_48801.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1450)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1450)) ;
        var_errorMessage_48957.plusAssign_operation(GALGAS_string (", but bank selection "), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1451)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          ...
          if (kBoolTrue == test_2) {
            var_errorMessage_48957.plusAssign_operation(GALGAS_string ("is not defined"), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1453)) ;
          }
        }
        if (kBoolFalse == test_2) {
          var_errorMessage_48957.plusAssign_operation(GALGAS_string ("is set to ").add_operation (ioArgument_ioCurrentBank.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1455)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1455)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1455)) ;
        }
        TC_Array <FixItDescription> fixItArray3 ;
    ...
    if (kBoolTrue == test_4) {
      ...
      if (kBoolTrue == test_4) {
        TC_Array <FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (enumerator_48698.current_mValue (HERE).readProperty_location (), GALGAS_string ("for being named in a computed rcall, the '").add_operation (enumerator_48698.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1460)).add_operation (GALGAS_string ("' routine should be declared without the \"noreturn\" qualifier"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1460)), fixItArray5  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1460)) ;
      }
    }
    enumGalgasBool test_6 = kBoolTrue ;
    if (kBoolTrue == test_6) {
      ...
      if (kBoolTrue == test_6) {
        TC_Array <FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (enumerator_48698.current_mValue (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_48698.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1463)).add_operation (GALGAS_string ("' routine should preserved bank selection"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1463)), fixItArray7  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1463)) ;
      }
    }
        ...
        if (kBoolTrue == test_8) {
          ...
          if (kBoolTrue == test_9) {
            ...
            if (kBoolTrue == test_9) {
              ...
              var_someReturnsBank_48617 = GALGAS_bool (true) ;
            }
          }
          if (kBoolFalse == test_9) {
            enumGalgasBool test_10 = kBoolTrue ;
            if (kBoolTrue == test_10) {
              test_10 = GALGAS_bool (ComparisonKind::notEqual, var_returnedBankSelection_48653.objectCompare (var_returnedBank_48825)).boolEnum () ;
              if (kBoolTrue == test_10) {
                GALGAS_string var_errorMessage_49871 = GALGAS_string ("the '").add_operation (enumerator_48698.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1469)).add_operation (GALGAS_string ("' routine returns "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1469)) ;
                enumGalgasBool test_11 = kBoolTrue ;
                if (kBoolTrue == test_11) {
                  test_11 = GALGAS_bool (ComparisonKind::equal, var_returnedBank_48825.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1470)))).boolEnum () ;
                  if (kBoolTrue == test_11) {
                    var_errorMessage_49871.plusAssign_operation(GALGAS_string ("no bank selection"), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1471)) ;
                  }
                }
                if (kBoolFalse == test_11) {
                  var_errorMessage_49871.plusAssign_operation(GALGAS_string ("bank selection set to  ").add_operation (var_returnedBank_48825.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1473)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1473)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1473)) ;
                }
                var_errorMessage_49871.plusAssign_operation(GALGAS_string (", but previous routine(s) return(s) "), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1475)) ;
                enumGalgasBool test_12 = kBoolTrue ;
                if (kBoolTrue == test_12) {
                  test_12 = GALGAS_bool (ComparisonKind::equal, var_returnedBankSelection_48653.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1476)))).boolEnum () ;
                  if (kBoolTrue == test_12) {
                    var_errorMessage_49871.plusAssign_operation(GALGAS_string ("no bank selection"), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1477)) ;
                  }
                }
                if (kBoolFalse == test_12) {
                  var_errorMessage_49871.plusAssign_operation(GALGAS_string ("bank selection set to  ").add_operation (var_returnedBankSelection_48653.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1479)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1479)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1479)) ;
                }
                TC_Array <FixItDescription> fixItArray13 ;
  ...
  GALGAS_sint_36__34_ var_size_50625 ;
  ...
  if (kBoolTrue == test_16) {
    test_16 = GALGAS_bool (ComparisonKind::lowerThan, var_size_50625.objectCompare (GALGAS_sint_36__34_ (int64_t (2LL)))).boolEnum () ;
    if (kBoolTrue == test_16) {
      const GALGAS_pic_31__38_Instruction_5F_computed_5F_rcall temp_17 = this ;
      TC_Array <FixItDescription> fixItArray18 ;
      inCompiler->emitSemanticError (temp_17.readProperty_mInstructionLocation (), GALGAS_string ("the computed range (").add_operation (var_size_50625.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1491)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1491)).add_operation (GALGAS_string (") should be greater or equal to 2"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1491)), fixItArray18  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1491)) ;
    }
  }
  if (kBoolFalse == test_16) {
    enumGalgasBool test_19 = kBoolTrue ;
    if (kBoolTrue == test_19) {
      test_19 = GALGAS_bool (ComparisonKind::greaterThan, var_size_50625.objectCompare (GALGAS_sint_36__34_ (int64_t (64LL)))).boolEnum () ;
      if (kBoolTrue == test_19) {
        const GALGAS_pic_31__38_Instruction_5F_computed_5F_rcall temp_20 = this ;
        TC_Array <FixItDescription> fixItArray21 ;
        inCompiler->emitSemanticError (temp_20.readProperty_mInstructionLocation (), GALGAS_string ("the computed range (").add_operation (var_size_50625.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1493)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1493)).add_operation (GALGAS_string (") should be lower or equal to 64"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1493)), fixItArray21  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1493)) ;
      }
    }
    if (kBoolFalse == test_19) {
      ...
      if (kBoolTrue == test_22) {
        ...
        test_22 = GALGAS_bool (ComparisonKind::notEqual, var_size_50625.getter_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1494)).objectCompare (temp_23.readProperty_mTargetLabels ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1494)))).boolEnum () ;
        if (kBoolTrue == test_22) {
          ...
          inCompiler->emitSemanticError (temp_24.readProperty_mInstructionLocation (), GALGAS_string ("the routine name list length (").add_operation (temp_25.readProperty_mTargetLabels ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)).add_operation (GALGAS_string (") should be equal to the computed range ("), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)).add_operation (var_size_50625.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)), fixItArray26  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1495)) ;
        }
      }
    }
  }
  GALGAS_ipic_31__38_SequentialInstructionList var_targetInstructionList_51163 = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_51229.hasCurrentObject ()) {
    var_targetInstructionList_51163.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_JSR::init_21__21__21_ (enumerator_51229.current_mValue (HERE).readProperty_location (), enumerator_51229.current_mValue (HERE), GALGAS_jumpInstructionKind::class_func_relative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1500)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1500)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1500)) ;
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::init_21__21__21_ (temp_28.readProperty_mInstructionLocation (), var_targetInstructionList_51163, temp_29.readProperty_mUsesRelativeCall (), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1509)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1503)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_Instruction_5F_computed_5F_goto::method_analyze (const GALGAS_uint /* constinArgument_inAccessBankSplitOffset */,
  ...
  while (enumerator_52298.hasCurrentObject ()) {
    ...
    GALGAS_uint var_requiredBank_52401 ;
    GALGAS_uint joker_52414 ; // Joker input parameter
    GALGAS_bool joker_52417 ; // Joker input parameter
    ...
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_52401.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1534)))).operator_and (GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_52401.objectCompare (ioArgument_ioCurrentBank)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1534)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_errorMessage_52514 = GALGAS_string ("the routine '").add_operation (enumerator_52298.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1535)).add_operation (GALGAS_string ("' requires bank selection to be set to "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1535)).add_operation (var_requiredBank_52401.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1535)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1535)) ;
        var_errorMessage_52514.plusAssign_operation(GALGAS_string (", but bank selection "), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1536)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          ...
          if (kBoolTrue == test_2) {
            var_errorMessage_52514.plusAssign_operation(GALGAS_string ("is not defined"), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1538)) ;
          }
        }
        if (kBoolFalse == test_2) {
          var_errorMessage_52514.plusAssign_operation(GALGAS_string ("is set to ").add_operation (ioArgument_ioCurrentBank.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1540)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1540)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1540)) ;
        }
        TC_Array <FixItDescription> fixItArray3 ;
    ...
    if (kBoolTrue == test_4) {
      ...
      if (kBoolTrue == test_4) {
        TC_Array <FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (enumerator_52298.current_mValue (HERE).readProperty_location (), GALGAS_string ("for being named in a computed goto, the '").add_operation (enumerator_52298.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1545)).add_operation (GALGAS_string ("' routine should be declared with the \"noreturn\" qualifier"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1545)), fixItArray5  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1545)) ;
      }
    }
  ...
  GALGAS_sint_36__34_ var_size_53394 ;
  ...
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    test_9 = GALGAS_bool (ComparisonKind::lowerThan, var_size_53394.objectCompare (GALGAS_sint_36__34_ (int64_t (2LL)))).boolEnum () ;
    if (kBoolTrue == test_9) {
      const GALGAS_pic_31__38_Instruction_5F_computed_5F_goto temp_10 = this ;
      TC_Array <FixItDescription> fixItArray11 ;
      inCompiler->emitSemanticError (temp_10.readProperty_mInstructionLocation (), GALGAS_string ("the computed range (").add_operation (var_size_53394.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1557)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1557)).add_operation (GALGAS_string (") should be greater or equal to 2"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1557)), fixItArray11  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1557)) ;
    }
  }
  if (kBoolFalse == test_9) {
    enumGalgasBool test_12 = kBoolTrue ;
    if (kBoolTrue == test_12) {
      test_12 = GALGAS_bool (ComparisonKind::greaterThan, var_size_53394.objectCompare (GALGAS_sint_36__34_ (int64_t (64LL)))).boolEnum () ;
      if (kBoolTrue == test_12) {
        const GALGAS_pic_31__38_Instruction_5F_computed_5F_goto temp_13 = this ;
        TC_Array <FixItDescription> fixItArray14 ;
        inCompiler->emitSemanticError (temp_13.readProperty_mInstructionLocation (), GALGAS_string ("the computed range (").add_operation (var_size_53394.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1559)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1559)).add_operation (GALGAS_string (") should be lower or equal to 64"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1559)), fixItArray14  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1559)) ;
      }
    }
    if (kBoolFalse == test_12) {
      ...
      if (kBoolTrue == test_15) {
        ...
        test_15 = GALGAS_bool (ComparisonKind::notEqual, var_size_53394.getter_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1560)).objectCompare (temp_16.readProperty_mTargetLabels ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1560)))).boolEnum () ;
        if (kBoolTrue == test_15) {
          ...
          inCompiler->emitSemanticError (temp_17.readProperty_mInstructionLocation (), GALGAS_string ("the routine name list length (").add_operation (temp_18.readProperty_mTargetLabels ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)).add_operation (GALGAS_string (") should be equal to the computed range ("), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)).add_operation (var_size_53394.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)), fixItArray19  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1561)) ;
        }
      }
    }
  }
...
void cPtr_pic_31__38_Instruction_5F_computed_5F_bra::method_analyze (const GALGAS_uint /* constinArgument_inAccessBankSplitOffset */,
                                                                     ...
                                                                     Compiler * inCompiler
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_allPreserveBankSetting_55032 = GALGAS_bool (true) ;
  GALGAS_bool var_allReturnBank_55074 = GALGAS_bool (true) ;
  GALGAS_uint var_returnedBankValue_55101 = GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1601)) ;
  ...
  while (enumerator_55137.hasCurrentObject ()) {
    GALGAS_bool var_isNoReturn_55218 ;
    GALGAS_uint var_requiredBank_55240 ;
    GALGAS_uint var_returnedBank_55264 ;
    GALGAS_bool var_preservesBank_55288 ;
    ...
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_55240.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1605)))).operator_and (GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_55240.objectCompare (ioArgument_ioCurrentBank)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1605)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_errorMessage_55425 = GALGAS_string ("the routine '").add_operation (enumerator_55137.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1606)).add_operation (GALGAS_string ("' requires bank selection to be set to "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1606)).add_operation (var_requiredBank_55240.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1606)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1606)) ;
        var_errorMessage_55425.plusAssign_operation(GALGAS_string (", but bank selection "), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1607)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          ...
          if (kBoolTrue == test_2) {
            var_errorMessage_55425.plusAssign_operation(GALGAS_string ("is not defined"), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1609)) ;
          }
        }
        if (kBoolFalse == test_2) {
          var_errorMessage_55425.plusAssign_operation(GALGAS_string ("is set to ").add_operation (ioArgument_ioCurrentBank.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1611)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1611)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1611)) ;
        }
        TC_Array <FixItDescription> fixItArray3 ;
    ...
    if (kBoolTrue == test_4) {
      ...
      if (kBoolTrue == test_4) {
        var_allReturnBank_55074 = GALGAS_bool (false) ;
      }
    }
    if (kBoolFalse == test_4) {
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = GALGAS_bool (ComparisonKind::notEqual, var_returnedBankValue_55101.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1618)))).operator_and (GALGAS_bool (ComparisonKind::notEqual, var_returnedBankValue_55101.objectCompare (var_returnedBank_55264)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1618)).boolEnum () ;
        if (kBoolTrue == test_5) {
          TC_Array <FixItDescription> fixItArray6 ;
          inCompiler->emitSemanticError (enumerator_55137.current_mValue (HERE).readProperty_location (), GALGAS_string ("this routine ensures setting of bank '").add_operation (var_returnedBank_55264.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1619)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1619)).add_operation (GALGAS_string ("', but "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1619)).add_operation (GALGAS_string ("previous routine(s) ensure setting of bank '"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1619)).add_operation (var_returnedBankValue_55101.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1620)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1620)).add_operation (GALGAS_string ("'."), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1620)), fixItArray6  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1619)) ;
        }
      }
      if (kBoolFalse == test_5) {
        var_allPreserveBankSetting_55032 = GALGAS_bool (false) ;
    ...
    if (kBoolTrue == test_7) {
      ...
      if (kBoolTrue == test_7) {
        TC_Array <FixItDescription> fixItArray8 ;
        inCompiler->emitSemanticError (enumerator_55137.current_mValue (HERE).readProperty_location (), GALGAS_string ("for being named in a computed bra from a regular routine, the '").add_operation (enumerator_55137.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1626)).add_operation (GALGAS_string ("' routine should be declared without any \"noreturn\" qualifier"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1626)), fixItArray8  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1626)) ;
      }
    }
  ...
  GALGAS_sint_36__34_ var_size_57241 ;
  ...
  enumGalgasBool test_19 = kBoolTrue ;
  if (kBoolTrue == test_19) {
    test_19 = GALGAS_bool (ComparisonKind::lowerThan, var_size_57241.objectCompare (GALGAS_sint_36__34_ (int64_t (2LL)))).boolEnum () ;
    if (kBoolTrue == test_19) {
      const GALGAS_pic_31__38_Instruction_5F_computed_5F_bra temp_20 = this ;
      TC_Array <FixItDescription> fixItArray21 ;
      inCompiler->emitSemanticError (temp_20.readProperty_mInstructionLocation (), GALGAS_string ("the computed range (").add_operation (var_size_57241.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1648)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1648)).add_operation (GALGAS_string (") should be greater or equal to 2"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1648)), fixItArray21  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1648)) ;
    }
  }
  if (kBoolFalse == test_19) {
    enumGalgasBool test_22 = kBoolTrue ;
    if (kBoolTrue == test_22) {
      test_22 = GALGAS_bool (ComparisonKind::greaterThan, var_size_57241.objectCompare (GALGAS_sint_36__34_ (int64_t (128LL)))).boolEnum () ;
      if (kBoolTrue == test_22) {
    ...
    if (kBoolFalse == test_22) {
      ...
      if (kBoolTrue == test_25) {
        ...
        test_25 = GALGAS_bool (ComparisonKind::notEqual, var_size_57241.getter_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1651)).objectCompare (temp_26.readProperty_mTargetLabels ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1651)))).boolEnum () ;
        if (kBoolTrue == test_25) {
          ...
          inCompiler->emitSemanticError (temp_27.readProperty_mInstructionLocation (), GALGAS_string ("the routine name list length (").add_operation (temp_28.readProperty_mTargetLabels ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)).add_operation (GALGAS_string (") should be equal to the computed range ("), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)).add_operation (var_size_57241.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)), fixItArray29  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1652)) ;
        }
      }
    }
  }
...
void cPtr_pic_31__38_Instruction_5F_computed_5F_retlw::method_analyze (const GALGAS_uint /* constinArgument_inAccessBankSplitOffset */,
  ...
  GALGAS_sint_36__34_ var_size_59280 ;
  ...
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    test_5 = GALGAS_bool (ComparisonKind::lowerThan, var_size_59280.objectCompare (GALGAS_sint_36__34_ (int64_t (2LL)))).boolEnum () ;
    if (kBoolTrue == test_5) {
  ...
  if (kBoolFalse == test_5) {
    enumGalgasBool test_8 = kBoolTrue ;
    if (kBoolTrue == test_8) {
      test_8 = GALGAS_bool (ComparisonKind::greaterThan, var_size_59280.objectCompare (GALGAS_sint_36__34_ (int64_t (128LL)))).boolEnum () ;
      if (kBoolTrue == test_8) {
    ...
    if (kBoolFalse == test_8) {
      ...
      if (kBoolTrue == test_11) {
        ...
        test_11 = GALGAS_bool (ComparisonKind::notEqual, var_size_59280.getter_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1702)).objectCompare (temp_12.readProperty_mImmediateExpressionList ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1702)))).boolEnum () ;
        if (kBoolTrue == test_11) {
          ...
          TC_Array <FixItDescription> fixItArray15 ;
          inCompiler->emitSemanticError (temp_13.readProperty_mInstructionLocation (), GALGAS_string ("the constant list length (").add_operation (temp_14.readProperty_mImmediateExpressionList ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)).add_operation (GALGAS_string (") should be equal to the computed range ("), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)).add_operation (var_size_59280.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)), fixItArray15  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1703)) ;
        }
      }
    }
  }
  GALGAS_uintlist var_literalValues_59839 = GALGAS_uintlist::init (inCompiler COMMA_HERE) ;
  ...
  GALGAS_uint index_59869 (uint32_t (0)) ;
  while (enumerator_59886.hasCurrentObject ()) {
    GALGAS_sint_36__34_ var_v_59998 ;
    ...
    if (kBoolTrue == test_17) {
      test_17 = GALGAS_bool (ComparisonKind::greaterThan, var_v_59998.objectCompare (GALGAS_sint_36__34_ (int64_t (255LL)))).operator_or (GALGAS_bool (ComparisonKind::lowerThan, var_v_59998.objectCompare (GALGAS_sint_36__34_ (int64_t (-128LL)))) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1709)).boolEnum () ;
      if (kBoolTrue == test_17) {
        const GALGAS_pic_31__38_Instruction_5F_computed_5F_retlw temp_18 = this ;
        TC_Array <FixItDescription> fixItArray19 ;
        inCompiler->emitSemanticError (temp_18.readProperty_mInstructionLocation (), GALGAS_string ("immediate value with idx ").add_operation (index_59869.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1710)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1710)).add_operation (GALGAS_string (" is evaluated as "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1710)).add_operation (var_v_59998.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1710)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1710)).add_operation (GALGAS_string (" (should be <= 255)"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1710)), fixItArray19  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1710)) ;
      }
    }
...
void cPtr_pic_31__38_Instruction_5F_JUMPCC::method_analyze (const GALGAS_uint /* constinArgument_inAccessBankSplitOffset */,
                                                            ...
                                                            Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_isNoReturn_61421 ;
  GALGAS_uint var_requiredBank_61443 ;
  const GALGAS_pic_31__38_Instruction_5F_JUMPCC temp_0 = this ;
  GALGAS_uint joker_61456 ; // Joker input parameter
  GALGAS_bool joker_61459 ; // Joker input parameter
  ...
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_61443.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1750)))).operator_and (GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_61443.objectCompare (ioArgument_ioCurrentBank)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1750)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const GALGAS_pic_31__38_Instruction_5F_JUMPCC temp_2 = this ;
      GALGAS_string var_errorMessage_61552 = GALGAS_string ("the routine '").add_operation (temp_2.readProperty_mTargetLabel ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1751)).add_operation (GALGAS_string ("' requires bank selection to be set to "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1751)).add_operation (var_requiredBank_61443.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1751)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1751)) ;
      var_errorMessage_61552.plusAssign_operation(GALGAS_string (", but bank selection "), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1752)) ;
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        ...
        if (kBoolTrue == test_3) {
          var_errorMessage_61552.plusAssign_operation(GALGAS_string ("is not defined"), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1754)) ;
        }
      }
      if (kBoolFalse == test_3) {
  ...
  GALGAS_conditionalBranchMode var_mode_62086 ;
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    const GALGAS_pic_31__38_Instruction_5F_JUMPCC temp_10 = this ;
    test_9 = temp_10.readProperty_mIsBcc ().boolEnum () ;
    if (kBoolTrue == test_9) {
      var_mode_62086 = GALGAS_conditionalBranchMode::class_func_native (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1766)) ;
    }
  }
  if (kBoolFalse == test_9) {
    var_mode_62086 = GALGAS_conditionalBranchMode::class_func_ipicBRA (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1768)) ;
  }
  const GALGAS_pic_31__38_Instruction_5F_JUMPCC temp_11 = this ;
  GALGAS_lstring var_label_30__62252 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1771)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1771)), temp_11.readProperty_mInstructionLocation (), inCompiler COMMA_HERE) ;
...
void cPtr_pic_31__38_Instruction_5F_IF_5F_BitTest::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
  ...
  GALGAS_uint var_currentBank_64025 = ioArgument_ioCurrentBank ;
  GALGAS_ipic_31__38_SequentialInstruction var_embeddedInstruction_64312 ;
  ...
  enumGalgasBool test_3 = kBoolTrue ;
  if (kBoolTrue == test_3) {
    test_3 = GALGAS_bool (ComparisonKind::notEqual, var_currentBank_64025.objectCompare (var_currentBank_64025)).boolEnum () ;
    if (kBoolTrue == test_3) {
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip::init_21__21__21__21__21_ (temp_6.readProperty_mInstructionLocation (), var_embeddedInstruction_64312, temp_7.readProperty_mSkipIfSet (), var_IPICregisterDescription_63749, var_bitNumber_63965, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1854)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1847)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_Instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                               ...
                                                                               Compiler * inCompiler
                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code var_baseCode_65509 ;
  ...
  case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_CPFSEQ:
    {
      var_baseCode_65509 = GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::class_func_CPFSEQ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1878)) ;
    }
    break ;
  case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_CPFSGT:
    {
      var_baseCode_65509 = GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::class_func_CPFSGT (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1879)) ;
    }
    break ;
  case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_CPFSLT:
    {
      var_baseCode_65509 = GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::class_func_CPFSLT (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1880)) ;
    }
    break ;
  case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_TSTFSZ:
    {
      var_baseCode_65509 = GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::class_func_TSTFSZ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1881)) ;
    }
    break ;
  }
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription_66096 ;
  const GALGAS_pic_31__38_Instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON temp_1 = this ;
  GALGAS_bitSliceTable joker_66124 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) temp_1.readProperty_mRegisterExpression ().ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (false), var_IPICregisterDescription_66096, joker_66124, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1883)) ;
  GALGAS_uint var_currentBank_66199 = ioArgument_ioCurrentBank ;
  GALGAS_ipic_31__38_SequentialInstruction var_embeddedInstruction_66486 ;
  ...
  enumGalgasBool test_3 = kBoolTrue ;
  if (kBoolTrue == test_3) {
    test_3 = GALGAS_bool (ComparisonKind::notEqual, var_currentBank_66199.objectCompare (var_currentBank_66199)).boolEnum () ;
    if (kBoolTrue == test_3) {
  ...
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register::init_21__21__21__21_ (temp_6.readProperty_mInstructionLocation (), var_embeddedInstruction_66486, var_baseCode_65509, var_IPICregisterDescription_66096, inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1917)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1911)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_Instruction_5F_IF_5F_IncDec::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                  ...
                                                                  Compiler * inCompiler
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code var_baseCode_67649 ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      var_baseCode_67649 = GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::class_func_INCFSZ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1942)) ;
    }
  }
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_3) {
        var_baseCode_67649 = GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::class_func_INFSNZ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1944)) ;
      }
    }
    if (kBoolFalse == test_3) {
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
        ...
        if (kBoolTrue == test_6) {
          var_baseCode_67649 = GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::class_func_DECFSZ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1946)) ;
        }
      }
      if (kBoolFalse == test_6) {
        var_baseCode_67649 = GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::class_func_DCFSNZ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 1948)) ;
      }
    }
  }
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription_68260 ;
  const GALGAS_pic_31__38_Instruction_5F_IF_5F_IncDec temp_9 = this ;
  GALGAS_bitSliceTable joker_68288 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) temp_9.readProperty_mRegisterExpression ().ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (true), var_IPICregisterDescription_68260, joker_68288, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 1951)) ;
  GALGAS_uint var_currentBank_68363 = ioArgument_ioCurrentBank ;
  GALGAS_ipic_31__38_SequentialInstruction var_embeddedInstruction_68650 ;
  ...
  enumGalgasBool test_11 = kBoolTrue ;
  if (kBoolTrue == test_11) {
    test_11 = GALGAS_bool (ComparisonKind::notEqual, var_currentBank_68363.objectCompare (var_currentBank_68363)).boolEnum () ;
    if (kBoolTrue == test_11) {
...
void cPtr_pic_31__38_Instruction_5F_structured_5F_if::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                      ...
                                                                      Compiler * inCompiler
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint var_elseBranchFinalBank_69783 = ioArgument_ioCurrentBank ;
  GALGAS_uint var_thenBranchFinalBank_69831 = ioArgument_ioCurrentBank ;
  const GALGAS_pic_31__38_Instruction_5F_structured_5F_if temp_0 = this ;
  GALGAS_lstring var_conditionTrueLabel_69885 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2012)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2012)), temp_0.readProperty_mInstructionLocation (), inCompiler COMMA_HERE) ;
  ...
  GALGAS_lstring var_conditionFalseLabel_70017 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2014)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2014)), temp_1.readProperty_mInstructionLocation (), inCompiler COMMA_HERE) ;
  ...
  GALGAS_lstring var_exitLabel_70150 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2016)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2016)), temp_2.readProperty_mInstructionLocation (), inCompiler COMMA_HERE) ;
  ...
  GALGAS_ipic_31__38_AbstractBlockTerminator var_testTerminator_70579 ;
  ...
  GALGAS_bool var_thenContinuesInSequence_71353 = GALGAS_bool (ComparisonKind::notEqual, ioArgument_ioBlockLabel.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())) ;
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    test_5 = var_thenContinuesInSequence_71353.boolEnum () ;
    if (kBoolTrue == test_5) {
      const GALGAS_pic_31__38_Instruction_5F_structured_5F_if temp_6 = this ;
      ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2064)), ioArgument_ioBlockLabel, ioArgument_ioGeneratedInstructionList, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (temp_6.readProperty_mInstructionLocation (), var_exitLabel_70150, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2067)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2068)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2063)) ;
    }
  }
  ioArgument_ioGeneratedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  ...
  GALGAS_bool var_elseContinuesInSequence_72256 = GALGAS_bool (ComparisonKind::notEqual, ioArgument_ioBlockLabel.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())) ;
  enumGalgasBool test_8 = kBoolTrue ;
  if (kBoolTrue == test_8) {
    test_8 = var_elseContinuesInSequence_72256.boolEnum () ;
    if (kBoolTrue == test_8) {
      const GALGAS_pic_31__38_Instruction_5F_structured_5F_if temp_9 = this ;
      ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2096)), ioArgument_ioBlockLabel, ioArgument_ioGeneratedInstructionList, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (temp_9.readProperty_mInstructionLocation (), var_exitLabel_70150, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2099)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2100)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2095)) ;
    }
  }
  ioArgument_ioGeneratedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  enumGalgasBool test_10 = kBoolTrue ;
  if (kBoolTrue == test_10) {
    test_10 = GALGAS_bool (ComparisonKind::equal, var_elseBranchFinalBank_69783.objectCompare (var_thenBranchFinalBank_69831)).boolEnum () ;
    if (kBoolTrue == test_10) {
  ...
  if (kBoolFalse == test_10) {
    ...
    var_elseBranchFinalBank_69783 = GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2110)) ;
  }
  enumGalgasBool test_13 = kBoolTrue ;
  if (kBoolTrue == test_13) {
...
void cPtr_pic_31__38_Instruction_5F_macro::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                           ...
                                                           Compiler * inCompiler
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstringlist var_constantNameList_73793 ;
  GALGAS_pic_31__38_InstructionList var_instructionList_73815 ;
  ...
  if (kBoolTrue == test_1) {
    ...
    test_1 = GALGAS_bool (ComparisonKind::notEqual, temp_2.readProperty_mExpressionList ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2140)).objectCompare (var_constantNameList_73793.getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2140)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      const GALGAS_pic_31__38_Instruction_5F_macro temp_3 = this ;
      TC_Array <FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (temp_3.readProperty_mInstructionLocation (), var_constantNameList_73793.getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2142)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2142)).add_operation (GALGAS_string (" argument(s) required"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2142)), fixItArray4  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2141)) ;
    }
  }
  GALGAS_constantMap var_constantMap_74026 = constinArgument_inConstantMap ;
  ...
  while (enumerator_74073.hasCurrentObject () && enumerator_74102.hasCurrentObject ()) {
    GALGAS_sint_36__34_ var_expressionValue_74204 ;
...
void cPtr_pic_31__38_Instruction_5F_do_5F_while::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
  ...
  GALGAS_lstring var_startLabel_75393 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2189)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2189)), temp_0.readProperty_mInstructionLocation (), inCompiler COMMA_HERE) ;
  ...
  ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2193)), ioArgument_ioBlockLabel, ioArgument_ioGeneratedInstructionList, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (temp_1.readProperty_mInstructionLocation (), var_startLabel_75393, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2196)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2197)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2192)) ;
  ioArgument_ioGeneratedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  ioArgument_ioBlockLabel = var_startLabel_75393 ;
  GALGAS_uint var_repeatedBranchFinalBank_75936 = ioArgument_ioCurrentBank ;
  {
  ...
  GALGAS_bool var_repeatedInstructionsContinuesInSequence_76396 = GALGAS_bool (ComparisonKind::notEqual, ioArgument_ioBlockLabel.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())) ;
  enumGalgasBool test_3 = kBoolTrue ;
  if (kBoolTrue == test_3) {
    test_3 = GALGAS_bool (ComparisonKind::notEqual, ioArgument_ioCurrentBank.objectCompare (var_repeatedBranchFinalBank_75936)).boolEnum () ;
    if (kBoolTrue == test_3) {
  ...
  while (enumerator_76832.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_conditionTrueLabel_76901 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2232)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2232)), temp_10.readProperty_mInstructionLocation (), inCompiler COMMA_HERE) ;
    ...
    GALGAS_ipic_31__38_AbstractBlockTerminator var_testTerminator_77493 ;
    ...
    ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2250)), ioArgument_ioBlockLabel, ioArgument_ioGeneratedInstructionList, var_testTerminator_77493, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2254)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2249)) ;
    ioArgument_ioGeneratedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
    ioArgument_ioBlockLabel = var_conditionTrueLabel_76901 ;
    GALGAS_uint var_branchFinalBank_77824 = ioArgument_ioCurrentBank ;
    {
    ...
    enumGalgasBool test_12 = kBoolTrue ;
    if (kBoolTrue == test_12) {
      test_12 = GALGAS_bool (ComparisonKind::notEqual, ioArgument_ioCurrentBank.objectCompare (var_branchFinalBank_77824)).boolEnum () ;
      if (kBoolTrue == test_12) {
        TC_Array <FixItDescription> fixItArray13 ;
        inCompiler->emitSemanticError (enumerator_76832.current_mEndOfPartLocation (HERE), GALGAS_string ("This branch does not leave bank selection value unchanged"), fixItArray13  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2279)) ;
      }
    }
    enumGalgasBool test_14 = kBoolTrue ;
    if (kBoolTrue == test_14) {
...
void cPtr_exitBlockTerminationForBlockInstruction::method_addVisitedBlocks (GALGAS_stringset & /* ioArgument_ioVisitedBlockSet */,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_uint var_otherInitialBlockSetting_80790 ;
      GALGAS_string var_otherBlockName_80828 ;
      ioArgument_ioBlockInitialBankSelectionMap.method_searchKey (GALGAS_string ("-").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2343)), var_otherInitialBlockSetting_80790, var_otherBlockName_80828, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2343)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (ComparisonKind::notEqual, var_otherInitialBlockSetting_80790.objectCompare (constinArgument_inInitialBlockSetting)).boolEnum () ;
        if (kBoolTrue == test_1) {
          ...
          const enumGalgasBool test_6 = GALGAS_bool (ComparisonKind::equal, var_otherInitialBlockSetting_80790.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2348)))).boolEnum () ;
          if (kBoolTrue == test_6) {
...
void cPtr_gotoTerminationForBlockInstruction::method_addVisitedBlocks (GALGAS_stringset & ioArgument_ioVisitedBlockSet,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_pic_31__38_InstructionList joker_82104 ; // Joker input parameter
      GALGAS_abstractBlockTerminationForBlockInstruction joker_82107 ; // Joker input parameter
      GALGAS_location joker_82110 ; // Joker input parameter
      ...
      if (kBoolTrue == test_4) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_uint var_otherInitialBlockSetting_82266 ;
          GALGAS_string var_otherBlockName_82304 ;
          ...
          enumGalgasBool test_7 = kBoolTrue ;
          if (kBoolTrue == test_7) {
            test_7 = GALGAS_bool (ComparisonKind::notEqual, var_otherInitialBlockSetting_82266.objectCompare (constinArgument_inInitialBlockSetting)).boolEnum () ;
            if (kBoolTrue == test_7) {
              ...
              const enumGalgasBool test_13 = GALGAS_bool (ComparisonKind::equal, var_otherInitialBlockSetting_82266.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2376)))).boolEnum () ;
              if (kBoolTrue == test_13) {
              ...
              TC_Array <FixItDescription> fixItArray14 ;
              inCompiler->emitSemanticError (temp_8.readProperty_mNextBlock ().readProperty_location (), GALGAS_string ("this block goes to '").add_operation (temp_9.readProperty_mNextBlock ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2373)).add_operation (GALGAS_string ("' block and sets bank selection to "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2373)).add_operation (temp_10, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2373)).add_operation (GALGAS_string (", '"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2374)).add_operation (var_otherBlockName_82304, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2375)).add_operation (GALGAS_string ("' block goes to the same block, but sets bank selection to "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2375)).add_operation (temp_12, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2375)).add_operation (GALGAS_string ("; theses two settings should be the same"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2376)), fixItArray14  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2373)) ;
            }
          }
        }
      }
...
void cPtr_testTerminationForBlockInstruction::method_generateBlock (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_testTerminationForBlockInstruction temp_0 = this ;
  GALGAS_lstring var_conditionTrueLabel_86178 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2478)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2478)), temp_0.readProperty_mLocation (), inCompiler COMMA_HERE) ;
  ...
  const GALGAS_testTerminationForBlockInstruction temp_1 = this ;
  GALGAS_lstring var_conditionFalseLabel_86299 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2480)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2480)), temp_1.readProperty_mLocation (), inCompiler COMMA_HERE) ;
  ...
  GALGAS_ipic_31__38_AbstractBlockTerminator var_trueTerminator_87006 ;
  ...
  ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2508)), var_conditionTrueLabel_86178, GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), var_trueTerminator_87006, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2512)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2507)) ;
  GALGAS_ipic_31__38_AbstractBlockTerminator var_falseTerminator_87513 ;
  ...
  ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2528)), var_conditionFalseLabel_86299, GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), var_falseTerminator_87513, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2532)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2527)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_Instruction_5F_block::method_analyze (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
  ...
  GALGAS_pic_31__38_InstructionList joker_89321 ; // Joker input parameter
  GALGAS_abstractBlockTerminationForBlockInstruction joker_89324 ; // Joker input parameter
  GALGAS_location joker_89327 ; // Joker input parameter
  ...
  GALGAS_blockInitialBankSelectionMap var_blockInitialBankSelectionMap_89337 = GALGAS_blockInitialBankSelectionMap::init (inCompiler COMMA_HERE) ;
  {
  const GALGAS_pic_31__38_Instruction_5F_block temp_5 = this ;
  var_blockInitialBankSelectionMap_89337.setter_insertKey (temp_5.readProperty_mStartBlockName (), ioArgument_ioCurrentBank, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2580)) ;
  }
  const GALGAS_pic_31__38_Instruction_5F_block temp_6 = this ;
  GALGAS_stringset var_accessibleBlockSet_89524 = GALGAS_stringset::class_func_setWithString (temp_6.readProperty_mStartBlockName ().readProperty_string ()  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2582)) ;
  GALGAS_stringset var_handledBlockSet_89606 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
  GALGAS_bool var_continueAccessibilityExploration_89649 = GALGAS_bool (true) ;
  GALGAS_bool var_continuesInSequence_89701 = GALGAS_bool (false) ;
  ...
  if (temp_7.readProperty_mBlockList ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2586)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2586)).isValid ()) {
    uint32_t variant_89731 = temp_7.readProperty_mBlockList ().getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2586)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2586)).uintValue () ;
    ...
    while (loop_89731) {
      ...
      if (loop_89731) {
        variant_89731 -- ;
        var_continueAccessibilityExploration_89649 = GALGAS_bool (false) ;
        ...
        while (enumerator_89902.hasCurrentObject ()) {
          ...
          GALGAS_pic_31__38_InstructionList var_instructionList_90061 ;
          GALGAS_abstractBlockTerminationForBlockInstruction var_blockTermination_90135 ;
          GALGAS_location var_endOfBlock_90175 ;
          ...
          GALGAS_uint var_currentBank_90302 ;
          GALGAS_string joker_90314 ; // Joker input parameter
          ...
          ioArgument_ioBlockLabel = GALGAS_lstring::init_21__21_ (var_labelForBlock_88404.add_operation (enumerator_89902.current (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2598)), var_blockMap_88981.getter_locationForKey (enumerator_89902.current (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2598)), inCompiler COMMA_HERE) ;
          {
          ...
          GALGAS_ipic_31__38_AbstractBlockTerminator var_terminator_91181 ;
          ...
          if (kBoolTrue == test_8) {
            ...
            if (kBoolTrue == test_8) {
              TC_Array <FixItDescription> fixItArray9 ;
              inCompiler->emitSemanticError (var_endOfBlock_90175, GALGAS_string ("execution will not reach the end of the block, but endless block is not allowed"), fixItArray9  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2629)) ;
            }
          }
          ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2632)), ioArgument_ioBlockLabel, ioArgument_ioGeneratedInstructionList, var_terminator_91181, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2636)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2631)) ;
          ioArgument_ioGeneratedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  ...
  if (kBoolTrue == test_14) {
    ...
    if (kBoolTrue == test_14) {
      ...
      ioArgument_ioBlockLabel = GALGAS_lstring::init_21__21_ (var_labelForBlock_88404.add_operation (GALGAS_string ("_exit"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2652)), temp_15.readProperty_mStartBlockName ().readProperty_location (), inCompiler COMMA_HERE) ;
      GALGAS_string joker_92292 ; // Joker input parameter
      var_blockInitialBankSelectionMap_89337.method_searchKey (GALGAS_string ("-").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2653)), ioArgument_ioCurrentBank, joker_92292, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2653)) ;
    }
  }
  if (kBoolFalse == test_14) {
...
void cPtr_pic_31__38_RegisterComparisonCondition::method_analyzeCondition (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                           ...
                                                                           Compiler * inCompiler
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription_94489 ;
  const GALGAS_pic_31__38_RegisterComparisonCondition temp_0 = this ;
  GALGAS_bitSliceTable joker_94517 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) temp_0.readProperty_mRegisterExpression ().ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (false), var_IPICregisterDescription_94489, joker_94517, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2713)) ;
  GALGAS_ipic_31__38_RegisterComparison var_ipicComparison_94601 ;
  GALGAS_bool var_complementaryBranch_94628 ;
  ...
  case GALGAS_pic_31__38_RegisterComparison::kEnum_equal:
    {
      var_ipicComparison_94601 = GALGAS_ipic_31__38_RegisterComparison::class_func_registerEqualsToW (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2728)) ;
      var_complementaryBranch_94628 = GALGAS_bool (false) ;
    }
    break ;
  case GALGAS_pic_31__38_RegisterComparison::kEnum_greater:
    {
      var_ipicComparison_94601 = GALGAS_ipic_31__38_RegisterComparison::class_func_registerGreaterThanW (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2731)) ;
      var_complementaryBranch_94628 = GALGAS_bool (false) ;
    }
    break ;
  case GALGAS_pic_31__38_RegisterComparison::kEnum_lower:
    {
      var_ipicComparison_94601 = GALGAS_ipic_31__38_RegisterComparison::class_func_registerLowerThanW (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2734)) ;
      var_complementaryBranch_94628 = GALGAS_bool (false) ;
    }
    break ;
  case GALGAS_pic_31__38_RegisterComparison::kEnum_greaterOrEqual:
    {
      var_ipicComparison_94601 = GALGAS_ipic_31__38_RegisterComparison::class_func_registerLowerThanW (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2737)) ;
      var_complementaryBranch_94628 = GALGAS_bool (true) ;
    }
    break ;
  case GALGAS_pic_31__38_RegisterComparison::kEnum_lowerOrEqual:
    {
      var_ipicComparison_94601 = GALGAS_ipic_31__38_RegisterComparison::class_func_registerGreaterThanW (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2740)) ;
      var_complementaryBranch_94628 = GALGAS_bool (true) ;
    }
    break ;
  case GALGAS_pic_31__38_RegisterComparison::kEnum_notEqual:
    {
      var_ipicComparison_94601 = GALGAS_ipic_31__38_RegisterComparison::class_func_registerEqualsToW (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2743)) ;
      var_complementaryBranch_94628 = GALGAS_bool (true) ;
    }
    break ;
  }
  const GALGAS_pic_31__38_RegisterComparisonCondition temp_2 = this ;
  GALGAS_location var_location_95438 = temp_2.readProperty_mRegisterExpression ().readProperty_mRegisterName ().readProperty_location () ;
  enumGalgasBool test_3 = kBoolTrue ;
  if (kBoolTrue == test_3) {
    test_3 = var_complementaryBranch_94628.boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_RegisterComparisonTerminator::init_21__21__21__21__21_ (var_location_95438, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_95438, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2751)), inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_95438, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2752)), inCompiler COMMA_HERE), var_IPICregisterDescription_94489, var_ipicComparison_94601, inCompiler COMMA_HERE) ;
    }
  }
  if (kBoolFalse == test_3) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_RegisterComparisonTerminator::init_21__21__21__21__21_ (var_location_95438, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_95438, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2758)), inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_95438, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2759)), inCompiler COMMA_HERE), var_IPICregisterDescription_94489, var_ipicComparison_94601, inCompiler COMMA_HERE) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_IncDecRegisterInCondition::method_analyzeCondition (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                         ...
                                                                         Compiler * inCompiler
                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription_96975 ;
  const GALGAS_pic_31__38_IncDecRegisterInCondition temp_0 = this ;
  GALGAS_bitSliceTable joker_97003 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) temp_0.readProperty_mRegisterExpression ().ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (true), var_IPICregisterDescription_96975, joker_97003, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2778)) ;
  const GALGAS_pic_31__38_IncDecRegisterInCondition temp_1 = this ;
  GALGAS_location var_location_97086 = temp_1.readProperty_mRegisterExpression ().readProperty_mRegisterName ().readProperty_location () ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      ...
      outArgument_outCurrentBlockTerminator = GALGAS_ipic_31__38_IncDecRegisterTerminator::init_21__21__21__21__21__21_ (var_location_97086, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_97086, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2793)), inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_97086, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2794)), inCompiler COMMA_HERE), var_IPICregisterDescription_96975, temp_4.readProperty_mIncrement (), temp_5.readProperty_m_5F_W_5F_isDestination (), inCompiler COMMA_HERE) ;
    }
  }
  if (kBoolFalse == test_2) {
    ...
    outArgument_outCurrentBlockTerminator = GALGAS_ipic_31__38_IncDecRegisterTerminator::init_21__21__21__21__21__21_ (var_location_97086, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_97086, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2801)), inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_97086, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2802)), inCompiler COMMA_HERE), var_IPICregisterDescription_96975, temp_6.readProperty_mIncrement (), temp_7.readProperty_m_5F_W_5F_isDestination (), inCompiler COMMA_HERE) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_RegisterTestCondition::method_analyzeCondition (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                     ...
                                                                     Compiler * inCompiler
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription_98675 ;
  const GALGAS_pic_31__38_RegisterTestCondition temp_0 = this ;
  GALGAS_bitSliceTable joker_98703 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) temp_0.readProperty_mRegisterExpression ().ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (false), var_IPICregisterDescription_98675, joker_98703, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2822)) ;
  const GALGAS_pic_31__38_RegisterTestCondition temp_1 = this ;
  GALGAS_location var_location_98786 = temp_1.readProperty_mRegisterExpression ().readProperty_mRegisterName ().readProperty_location () ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    const GALGAS_pic_31__38_RegisterTestCondition temp_3 = this ;
    test_2 = temp_3.readProperty_mBranchIfZero ().boolEnum () ;
    if (kBoolTrue == test_2) {
      outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_TestRegisterTerminator::init_21__21__21__21_ (var_location_98786, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_98786, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2837)), inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_98786, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2838)), inCompiler COMMA_HERE), var_IPICregisterDescription_98675, inCompiler COMMA_HERE) ;
    }
  }
  if (kBoolFalse == test_2) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_TestRegisterTerminator::init_21__21__21__21_ (var_location_98786, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_98786, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2843)), inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_98786, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2844)), inCompiler COMMA_HERE), var_IPICregisterDescription_98675, inCompiler COMMA_HERE) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_BitTestInStructuredCondition::method_analyzeCondition (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                                            ...
                                                                            Compiler * inCompiler
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription_100270 ;
  GALGAS_bitSliceTable var_bitSliceTable_100318 ;
  const GALGAS_pic_31__38_BitTestInStructuredCondition temp_0 = this ;
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) temp_0.readProperty_mRegisterExpression ().ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, constinArgument_inConstantMap, GALGAS_bool (false), var_IPICregisterDescription_100270, var_bitSliceTable_100318, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2862)) ;
  GALGAS_uint var_bitNumber_100486 ;
  ...
  GALGAS_location var_location_100554 = temp_2.readProperty_mRegisterExpression ().readProperty_mRegisterName ().readProperty_location () ;
  outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BitTestTerminator::init_21__21__21__21__21_ (var_location_100554, GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_100554, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2883)), inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_location_100554, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2884)), inCompiler COMMA_HERE), var_IPICregisterDescription_100270, var_bitNumber_100486, inCompiler COMMA_HERE) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_pic_31__38_AndCondition::method_analyzeCondition (const GALGAS_uint constinArgument_inAccessBankSplitOffset,
                                                            ...
                                                            Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_conditionTrueLabel_102284 = GALGAS_lstring::init_21__21_ (GALGAS_string (".L").add_operation (ioArgument_ioLocalLabelIndex.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2931)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2931)), constinArgument_inConditionTrueLabel.readProperty_location (), inCompiler COMMA_HERE) ;
  ...
  GALGAS_ipic_31__38_AbstractBlockTerminator var_secondTestBlockTerminator_103041 ;
  ...
  ioArgument_ioGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2961)), var_conditionTrueLabel_102284, GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), var_secondTestBlockTerminator_103041, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 2965)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2960)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void routine_analyzeInstructionList_3F__26__3F__3F__3F__3F__3F__3F__26__26__26__26__26__3F__3F__26_ (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  while (enumerator_104073.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_0) {
        TC_Array <FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (enumerator_104073.current_mInstruction (HERE).readProperty_mInstructionLocation (), GALGAS_string ("Unreachable code"), fixItArray1  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 2995)) ;
...
void routine_pic_31__38__5F_analyze_5F_data_5F_sections_3F__3F__3F__26__21__26__26_ (const GALGAS_dataList constinArgument_inDataDefinitionList,
  ...
  outArgument_outDataMap = GALGAS_pic_31__38__5F_dataMap::init (inCompiler COMMA_HERE) ;
  ...
  if (enumerator_105366.hasCurrentObject () && bool_0) {
    ...
    while (enumerator_105366.hasCurrentObject () && bool_0) {
      GALGAS_uintlist var_data_105685 = GALGAS_uintlist::init (inCompiler COMMA_HERE) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        ...
        if (kBoolTrue == test_1) {
          enumGalgasBool test_2 = kBoolTrue ;
          if (kBoolTrue == test_2) {
            test_2 = GALGAS_bool (ComparisonKind::notEqual, enumerator_105366.current_mValueList (HERE).getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3042)).operator_and (GALGAS_uint (uint32_t (1U)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3042)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
            if (kBoolTrue == test_2) {
              TC_Array <FixItDescription> fixItArray3 ;
              inCompiler->emitSemanticError (enumerator_105366.current_mDataName (HERE).readProperty_location (), GALGAS_string ("the data8 byte count should be even"), fixItArray3  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3043)) ;
            }
          }
          ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("Data8 '").add_operation (enumerator_105366.current_mDataName (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)).add_operation (GALGAS_string ("', "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)).add_operation (enumerator_105366.current_mValueList (HERE).getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)).divide_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)).add_operation (GALGAS_string (" words ("), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)).add_operation (enumerator_105366.current_mValueList (HERE).getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3046)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3046)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3046)).add_operation (GALGAS_string (" bytes).\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3046)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3045)) ;
          {
          ioArgument_ioConstantMap.setter_insertKey (GALGAS_lstring::init_21__21_ (enumerator_105366.current_mDataName (HERE).readProperty_string ().add_operation (GALGAS_string ("_BYTE_COUNT"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3047)), enumerator_105366.current_mDataName (HERE).readProperty_location (), inCompiler COMMA_HERE), enumerator_105366.current_mValueList (HERE).getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3047)).getter_sint_36__34_ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3047)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3047)) ;
          }
          GALGAS_sint var_byte_106086 = GALGAS_sint (int32_t (0L)) ;
          cEnumerator_immediatExpressionList enumerator_106117 (enumerator_105366.current_mValueList (HERE), EnumerationOrder::up) ;
          GALGAS_uint index_106101 (uint32_t (0)) ;
          while (enumerator_106117.hasCurrentObject ()) {
            GALGAS_sint_36__34_ var_value_106225 ;
            ...
            enumGalgasBool test_4 = kBoolTrue ;
            if (kBoolTrue == test_4) {
              test_4 = GALGAS_bool (ComparisonKind::lowerThan, var_value_106225.objectCompare (GALGAS_sint_36__34_ (int64_t (0LL)))).boolEnum () ;
              if (kBoolTrue == test_4) {
                TC_Array <FixItDescription> fixItArray5 ;
                inCompiler->emitSemanticError (enumerator_106117.current_mErrorLocation (HERE), GALGAS_string ("data8 value is ").add_operation (var_value_106225.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3052)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3052)).add_operation (GALGAS_string (" (negative)"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3052)), fixItArray5  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3052)) ;
              }
            }
            if (kBoolFalse == test_4) {
              enumGalgasBool test_6 = kBoolTrue ;
              if (kBoolTrue == test_6) {
                test_6 = GALGAS_bool (ComparisonKind::greaterThan, var_value_106225.objectCompare (GALGAS_sint_36__34_ (int64_t (255LL)))).boolEnum () ;
                if (kBoolTrue == test_6) {
                  TC_Array <FixItDescription> fixItArray7 ;
                  inCompiler->emitSemanticError (enumerator_106117.current_mErrorLocation (HERE), GALGAS_string ("data8 value is ").add_operation (var_value_106225.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3054)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3054)).add_operation (GALGAS_string (" (greater than 255"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3054)), fixItArray7  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3054)) ;
                }
              }
              if (kBoolFalse == test_6) {
                enumGalgasBool test_8 = kBoolTrue ;
                if (kBoolTrue == test_8) {
                  test_8 = GALGAS_bool (ComparisonKind::equal, index_106101.operator_and (GALGAS_uint (uint32_t (1U)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3055)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    var_byte_106086 = var_value_106225.getter_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3056)) ;
                  }
                }
                if (kBoolFalse == test_8) {
                  var_data_105685.addAssign_operation (var_value_106225.left_shift_operation (GALGAS_bigint ("8", inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3058)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3058)).operator_or (var_byte_106086.getter_sint_36__34_ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3058)) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3058)).getter_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3058))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3058)) ;
                }
              }
            }
      ...
      if (kBoolFalse == test_1) {
        ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("Data16 '").add_operation (enumerator_105366.current_mDataName (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3062)).add_operation (GALGAS_string ("', "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3062)).add_operation (enumerator_105366.current_mValueList (HERE).getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3062)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3062)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3062)).add_operation (GALGAS_string (" words ("), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3062)).add_operation (enumerator_105366.current_mValueList (HERE).getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3063)).multiply_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3063)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3063)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3063)).add_operation (GALGAS_string (" bytes).\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3063)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3062)) ;
        {
        ioArgument_ioConstantMap.setter_insertKey (GALGAS_lstring::init_21__21_ (enumerator_105366.current_mDataName (HERE).readProperty_string ().add_operation (GALGAS_string ("_BYTE_COUNT"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3064)), enumerator_105366.current_mDataName (HERE).readProperty_location (), inCompiler COMMA_HERE), enumerator_105366.current_mValueList (HERE).getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3064)).multiply_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3064)).getter_sint_36__34_ (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3064)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3064)) ;
        }
        ...
        while (enumerator_106876.hasCurrentObject ()) {
          GALGAS_sint_36__34_ var_value_106980 ;
          ...
          enumGalgasBool test_9 = kBoolTrue ;
          if (kBoolTrue == test_9) {
            test_9 = GALGAS_bool (ComparisonKind::lowerThan, var_value_106980.objectCompare (GALGAS_sint_36__34_ (int64_t (0LL)))).boolEnum () ;
            if (kBoolTrue == test_9) {
              TC_Array <FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (enumerator_106876.current_mErrorLocation (HERE), GALGAS_string ("data16 value is ").add_operation (var_value_106980.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3068)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3068)).add_operation (GALGAS_string (" (negative)"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3068)), fixItArray10  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3068)) ;
            }
          }
          if (kBoolFalse == test_9) {
            enumGalgasBool test_11 = kBoolTrue ;
            if (kBoolTrue == test_11) {
              test_11 = GALGAS_bool (ComparisonKind::greaterThan, var_value_106980.objectCompare (GALGAS_sint_36__34_ (int64_t (65535LL)))).boolEnum () ;
              if (kBoolTrue == test_11) {
                TC_Array <FixItDescription> fixItArray12 ;
                inCompiler->emitSemanticError (enumerator_106876.current_mErrorLocation (HERE), GALGAS_string ("data16 value is ").add_operation (var_value_106980.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3070)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3070)).add_operation (GALGAS_string (" (greater than 2**16-1)"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3070)), fixItArray12  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3070)) ;
              }
            }
            if (kBoolFalse == test_11) {
...
void routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list_3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__26_ (const GALGAS_string constinArgument_inSourceFileName,
                                                                                                                                                                               ...
                                                                                                                                                                               Compiler * inCompiler
                                                                                                                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_constantMap var_constantMap_108684 = constinArgument_inConstantMap ;
  GALGAS_stringset var_usedRegisters_108718 = constinArgument_inUsedRegisters ;
  GALGAS_routineMap var_routineMap_108808 = GALGAS_routineMap::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_109433.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::notEqual, enumerator_109433.current_mRequiredBank (HERE).readProperty_uint ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3121)))).operator_and (GALGAS_bool (ComparisonKind::greaterThan, enumerator_109433.current_mRequiredBank (HERE).readProperty_uint ().objectCompare (GALGAS_uint (uint32_t (15U)))) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3121)).boolEnum () ;
      if (kBoolTrue == test_0) {
        TC_Array <FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (enumerator_109433.current_mRequiredBank (HERE).readProperty_location (), GALGAS_string ("the required bank value should be lower or equal to 15"), fixItArray1  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3122)) ;
      }
    }
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (ComparisonKind::notEqual, enumerator_109433.current_mReturnedBank (HERE).readProperty_uint ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3124)))).operator_and (GALGAS_bool (ComparisonKind::greaterThan, enumerator_109433.current_mReturnedBank (HERE).readProperty_uint ().objectCompare (GALGAS_uint (uint32_t (15U)))) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3124)).boolEnum () ;
      if (kBoolTrue == test_2) {
        TC_Array <FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (enumerator_109433.current_mReturnedBank (HERE).readProperty_location (), GALGAS_string ("the returned bank value should be lower or equal to 15"), fixItArray3  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3125)) ;
      }
    }
    {
  ...
  GALGAS_pic_31__38__5F_dataMap var_dataMap_111157 ;
  {
  ...
  if (kBoolTrue == test_4) {
    ...
    if (kBoolTrue == test_4) {
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = var_routineMap_108808.getter_hasKey (GALGAS_string ("main") COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3166)).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_bool var_isNoReturn_111575 ;
          GALGAS_uint var_requiredBank_111591 ;
          GALGAS_uint joker_111604 ; // Joker input parameter
          GALGAS_bool joker_111607 ; // Joker input parameter
          var_routineMap_108808.method_searchKey (GALGAS_lstring::init_21__21_ (GALGAS_string ("main"), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3167)), inCompiler COMMA_HERE), var_isNoReturn_111575, var_requiredBank_111591, joker_111604, joker_111607, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3167)) ;
          enumGalgasBool test_6 = kBoolTrue ;
          if (kBoolTrue == test_6) {
          ...
          enumGalgasBool test_8 = kBoolTrue ;
          if (kBoolTrue == test_8) {
            test_8 = GALGAS_bool (ComparisonKind::notEqual, var_requiredBank_111591.objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
            if (kBoolTrue == test_8) {
              TC_Array <FixItDescription> fixItArray9 ;
  ...
  GALGAS_ipic_31__38_BlockList var_generatedBlockList_112142 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
  GALGAS_uint var_entryPoint_112194 = GALGAS_uint (uint32_t (4U)) ;
  ...
  while (enumerator_112238.hasCurrentObject ()) {
    var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (var_entryPoint_112194, enumerator_112238.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), GALGAS_ipic_31__38_ReturnTerminator::init_21_ (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3186)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3187)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3182)) ;
    var_entryPoint_112194 = var_entryPoint_112194.add_operation (GALGAS_uint (uint32_t (4U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3190)) ;
    enumGalgasBool test_11 = kBoolTrue ;
    if (kBoolTrue == test_11) {
      test_11 = GALGAS_bool (ComparisonKind::equal, var_entryPoint_112194.objectCompare (GALGAS_uint (uint32_t (8U)))).boolEnum () ;
      if (kBoolTrue == test_11) {
        var_entryPoint_112194 = GALGAS_uint (uint32_t (12U)) ;
      }
    }
    if (kBoolFalse == test_11) {
      enumGalgasBool test_12 = kBoolTrue ;
      if (kBoolTrue == test_12) {
        test_12 = GALGAS_bool (ComparisonKind::equal, var_entryPoint_112194.objectCompare (GALGAS_uint (uint32_t (24U)))).boolEnum () ;
        if (kBoolTrue == test_12) {
          var_entryPoint_112194 = GALGAS_uint (uint32_t (28U)) ;
        }
      }
    }
  ...
  while (enumerator_112849.hasCurrentObject ()) {
    var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (var_entryPoint_112194, GALGAS_string ("_entry_user_").add_operation (var_entryPoint_112194.getter_xString (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3202)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3202)).getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3202)), GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (enumerator_112849.current_mRoutineName (HERE).readProperty_location (), enumerator_112849.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3204)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3205)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3200)) ;
    var_entryPoint_112194 = var_entryPoint_112194.add_operation (GALGAS_uint (uint32_t (4U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3208)) ;
  ...
  if (kBoolTrue == test_13) {
    ...
    if (kBoolTrue == test_13) {
      var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_string (".START").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3214)), GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3216)), GALGAS_string ("main").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3216)), GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3216)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3217)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3212)) ;
    }
  }
  GALGAS_routineDeclarationList var_tempBootloaderRoutineDeclarationList_113780 = constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation ;
  enumGalgasBool test_14 = kBoolTrue ;
  if (kBoolTrue == test_14) {
    test_14 = GALGAS_bool (ComparisonKind::greaterThan, var_tempBootloaderRoutineDeclarationList_113780.getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3223)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
    if (kBoolTrue == test_14) {
      GALGAS_lstring var_routineName_114007 ;
      {
      GALGAS_luint joker_114019 ; // Joker input parameter
      GALGAS_luint joker_114022 ; // Joker input parameter
      GALGAS_bool joker_114025 ; // Joker input parameter
      GALGAS_bool joker_114028 ; // Joker input parameter
      ...
      var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint (uint32_t (4U)), GALGAS_string ("_entry_bootloader_04").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3227)), GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_routineName_114007.readProperty_location (), var_routineName_114007, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3229)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3230)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3225)) ;
    }
  }
  enumGalgasBool test_15 = kBoolTrue ;
  if (kBoolTrue == test_15) {
  ...
  if (var_tempBootloaderRoutineDeclarationList_113780.getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3247)).isValid ()) {
    ...
    while (loop_114893) {
      loop_114893 = GALGAS_bool (ComparisonKind::greaterThan, var_tempBootloaderRoutineDeclarationList_113780.getter_count (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3248)).objectCompare (GALGAS_uint (uint32_t (0U)))).operator_and (GALGAS_bool (ComparisonKind::lowerThan, var_entryPoint_112194.objectCompare (GALGAS_uint (uint32_t (24U)))) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3248)).isValid () ;
      if (loop_114893) {
      ...
      if (loop_114893) {
        variant_114893 -- ;
        GALGAS_lstring var_routineName_115099 ;
        {
        GALGAS_luint joker_115111 ; // Joker input parameter
        GALGAS_luint joker_115114 ; // Joker input parameter
        GALGAS_bool joker_115117 ; // Joker input parameter
        GALGAS_bool joker_115120 ; // Joker input parameter
        ...
        var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (var_entryPoint_112194, GALGAS_string ("_entry_bootloader_").add_operation (var_entryPoint_112194.getter_xString (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3253)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3253)).getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3253)), GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (var_routineName_115099.readProperty_location (), var_routineName_115099, GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3255)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3256)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3251)) ;
        var_entryPoint_112194 = var_entryPoint_112194.add_operation (GALGAS_uint (uint32_t (4U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3259)) ;
      }
    }
  }
  enumGalgasBool test_16 = kBoolTrue ;
  ...
  while (enumerator_116006.hasCurrentObject ()) {
    var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (var_entryPoint_112194, GALGAS_string ("_entry_bootloader_").add_operation (var_entryPoint_112194.getter_xString (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3277)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3277)).getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3277)), GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (enumerator_116006.current_mRoutineName (HERE).readProperty_location (), enumerator_116006.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3279)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3280)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3275)) ;
    var_entryPoint_112194 = var_entryPoint_112194.add_operation (GALGAS_uint (uint32_t (4U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3283)) ;
    enumerator_116006.gotoNextObject () ;
  }
  GALGAS_uint var_localLabelIndex_116535 = GALGAS_uint (uint32_t (0U)) ;
  enumGalgasBool test_17 = kBoolTrue ;
  if (kBoolTrue == test_17) {
    ...
    if (kBoolTrue == test_17) {
      ...
      while (enumerator_116636.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_18) {
          test_18 = GALGAS_bool (ComparisonKind::equal, enumerator_116636.current_mInterruptName (HERE).readProperty_string ().objectCompare (GALGAS_string ("low"))).boolEnum () ;
          if (kBoolTrue == test_18) {
            GALGAS_uint var_currentBank_116751 = GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3291)) ;
            GALGAS_ipic_31__38_SequentialInstructionList var_generatedInstructionList_116796 = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
            GALGAS_lstring var_currentBlockLabel_116870 = GALGAS_lstring::init_21__21_ (GALGAS_string ("_low_interrupt"), enumerator_116636.current_mInterruptName (HERE).readProperty_location (), inCompiler COMMA_HERE) ;
            {
            routine_analyzeInstructionList_3F__26__3F__3F__3F__3F__3F__3F__26__26__26__26__26__3F__3F__26_ (enumerator_116636.current_mInstructionList (HERE), var_generatedBlockList_112142, constinArgument_inAccessBankSplitOffset, var_routineMap_108808, constinArgument_inRegisterTable, var_dataMap_111157, var_constantMap_108684, constinArgument_inMacroMap, var_localLabelIndex_116535, var_generatedInstructionList_116796, var_currentBlockLabel_116870, ioArgument_ioListFileContents, var_currentBank_116751, enumerator_116636.current_mFastReturn (HERE).operator_not (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3308)), GALGAS_routineKind::class_func_interruptRoutine (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3309)), var_usedRegisters_108718, inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3294)) ;
            }
            enumGalgasBool test_19 = kBoolTrue ;
            if (kBoolTrue == test_19) {
              test_19 = GALGAS_bool (ComparisonKind::equal, var_currentBlockLabel_116870.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_19) {
                TC_Array <FixItDescription> fixItArray20 ;
                inCompiler->emitSemanticError (enumerator_116636.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine"), fixItArray20  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3313)) ;
              }
            }
            var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3317)), var_currentBlockLabel_116870, var_generatedInstructionList_116796, GALGAS_ipic_31__38_RetfieTerminator::init_21__21_ (enumerator_116636.current_mInterruptName (HERE).readProperty_location (), enumerator_116636.current_mFastReturn (HERE), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3321)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3316)) ;
          }
        }
  ...
  if (kBoolTrue == test_21) {
    ...
    if (kBoolTrue == test_21) {
      ...
      while (enumerator_118115.hasCurrentObject ()) {
        enumGalgasBool test_22 = kBoolTrue ;
        if (kBoolTrue == test_22) {
          test_22 = GALGAS_bool (ComparisonKind::equal, enumerator_118115.current_mInterruptName (HERE).readProperty_string ().objectCompare (GALGAS_string ("high"))).boolEnum () ;
          if (kBoolTrue == test_22) {
            GALGAS_uint var_currentBank_118231 = GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3331)) ;
            GALGAS_ipic_31__38_SequentialInstructionList var_generatedInstructionList_118276 = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
            GALGAS_lstring var_currentBlockLabel_118350 = GALGAS_lstring::init_21__21_ (GALGAS_string ("_high_interrupt"), enumerator_118115.current_mInterruptName (HERE).readProperty_location (), inCompiler COMMA_HERE) ;
            {
            routine_analyzeInstructionList_3F__26__3F__3F__3F__3F__3F__3F__26__26__26__26__26__3F__3F__26_ (enumerator_118115.current_mInstructionList (HERE), var_generatedBlockList_112142, constinArgument_inAccessBankSplitOffset, var_routineMap_108808, constinArgument_inRegisterTable, var_dataMap_111157, var_constantMap_108684, constinArgument_inMacroMap, var_localLabelIndex_116535, var_generatedInstructionList_118276, var_currentBlockLabel_118350, ioArgument_ioListFileContents, var_currentBank_118231, enumerator_118115.current_mFastReturn (HERE).operator_not (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3348)), GALGAS_routineKind::class_func_interruptRoutine (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3349)), var_usedRegisters_108718, inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3334)) ;
            }
            enumGalgasBool test_23 = kBoolTrue ;
            if (kBoolTrue == test_23) {
              test_23 = GALGAS_bool (ComparisonKind::equal, var_currentBlockLabel_118350.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_23) {
                TC_Array <FixItDescription> fixItArray24 ;
                inCompiler->emitSemanticError (enumerator_118115.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine"), fixItArray24  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3353)) ;
              }
            }
            var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3357)), var_currentBlockLabel_118350, var_generatedInstructionList_118276, GALGAS_ipic_31__38_RetfieTerminator::init_21__21_ (enumerator_118115.current_mInterruptName (HERE).readProperty_location (), GALGAS_bool (true), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3361)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3356)) ;
          }
        }
  ...
  while (enumerator_119576.hasCurrentObject ()) {
    GALGAS_uint var_currentBank_119624 = enumerator_119576.current_mRequiredBank (HERE).readProperty_uint () ;
    GALGAS_routineKind var_routineKind_119678 ;
    enumGalgasBool test_25 = kBoolTrue ;
    if (kBoolTrue == test_25) {
      test_25 = enumerator_119576.current_mIsNoReturn (HERE).boolEnum () ;
      if (kBoolTrue == test_25) {
        var_routineKind_119678 = GALGAS_routineKind::class_func_noReturnRoutine (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3372)) ;
      }
    }
    if (kBoolFalse == test_25) {
      var_routineKind_119678 = GALGAS_routineKind::class_func_regularRoutine (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3374)) ;
    }
    GALGAS_ipic_31__38_SequentialInstructionList var_generatedInstructionList_119838 = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
    GALGAS_lstring var_currentBlockLabel_119917 = enumerator_119576.current_mRoutineName (HERE) ;
    {
    ...
    GALGAS_bool var_continuesInSequence_120367 = GALGAS_bool (ComparisonKind::notEqual, var_currentBlockLabel_119917.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())) ;
    enumGalgasBool test_26 = kBoolTrue ;
    if (kBoolTrue == test_26) {
      test_26 = var_continuesInSequence_120367.boolEnum () ;
      if (kBoolTrue == test_26) {
        var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3400)), var_currentBlockLabel_119917, var_generatedInstructionList_119838, GALGAS_ipic_31__38_ReturnTerminator::init_21_ (enumerator_119576.current_mRoutineName (HERE).readProperty_location (), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3404)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3399)) ;
      }
    }
    enumGalgasBool test_27 = kBoolTrue ;
    if (kBoolTrue == test_27) {
      test_27 = enumerator_119576.current_mIsNoReturn (HERE).operator_not (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3409)).operator_and (GALGAS_bool (ComparisonKind::notEqual, enumerator_119576.current_mReturnedBank (HERE).readProperty_uint ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3409)))) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3409)).operator_and (GALGAS_bool (ComparisonKind::notEqual, var_currentBank_119624.objectCompare (enumerator_119576.current_mReturnedBank (HERE).readProperty_uint ())) COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3409)).boolEnum () ;
      if (kBoolTrue == test_27) {
        TC_Array <FixItDescription> fixItArray28 ;
        inCompiler->emitSemanticError (enumerator_119576.current_mRoutineName (HERE).readProperty_location (), GALGAS_string ("execution will not set bank selection to ").add_operation (enumerator_119576.current_mReturnedBank (HERE).readProperty_uint ().getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3410)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3410)), fixItArray28  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3410)) ;
      }
    }
    ...
    if (kBoolTrue == test_29) {
      ...
      if (kBoolTrue == test_29) {
        ...
        inCompiler->emitSemanticError (enumerator_119576.current_mRoutineName (HERE).readProperty_location (), GALGAS_string ("execution should not reach the end of a \"noreturn\" routine"), fixItArray30  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3413)) ;
      }
    }
    enumerator_119576.gotoNextObject () ;
  }
  GALGAS_registerExpression var_WREGregister_121268 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("WREG"), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3420)), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3421)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3422)), inCompiler COMMA_HERE) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_WREG_5F_IPICregisterDescription_121613 ;
  GALGAS_bitSliceTable joker_121646 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_WREGregister_121268.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint (uint32_t (0U)), constinArgument_inRegisterTable, var_constantMap_108684, GALGAS_bool (false), var_WREG_5F_IPICregisterDescription_121613, joker_121646, var_usedRegisters_108718, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3424)) ;
  GALGAS_registerExpression var_TOSLregister_121713 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TOSL"), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3436)), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3437)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3438)), inCompiler COMMA_HERE) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_TOSL_5F_IPICregisterDescription_122057 ;
  GALGAS_bitSliceTable joker_122090 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TOSLregister_121713.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint (uint32_t (0U)), constinArgument_inRegisterTable, var_constantMap_108684, GALGAS_bool (true), var_TOSL_5F_IPICregisterDescription_122057, joker_122090, var_usedRegisters_108718, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3440)) ;
  GALGAS_registerExpression var_TOSHregister_122157 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TOSH"), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3452)), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3453)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3454)), inCompiler COMMA_HERE) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_TOSH_5F_IPICregisterDescription_122501 ;
  GALGAS_bitSliceTable joker_122534 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TOSHregister_122157.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint (uint32_t (0U)), constinArgument_inRegisterTable, var_constantMap_108684, GALGAS_bool (true), var_TOSH_5F_IPICregisterDescription_122501, joker_122534, var_usedRegisters_108718, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3456)) ;
  GALGAS_registerExpression var_TOSUregister_122601 = GALGAS_registerExpression::init_21__21__21_ (GALGAS_lstring::init_21__21_ (GALGAS_string ("TOSU"), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3468)), inCompiler COMMA_HERE), GALGAS_immediatInteger::init_21_ (GALGAS_luint::init_21__21_ (GALGAS_uint (uint32_t (0U)), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3469)), inCompiler COMMA_HERE), inCompiler COMMA_HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3470)), inCompiler COMMA_HERE) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_TOSU_5F_IPICregisterDescription_122944 ;
  GALGAS_bitSliceTable joker_122977 ; // Joker input parameter
  callExtensionMethod_analyzeRegisterExpression ((cPtr_registerExpression *) var_TOSUregister_122601.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint (uint32_t (0U)), constinArgument_inRegisterTable, var_constantMap_108684, GALGAS_bool (true), var_TOSU_5F_IPICregisterDescription_122944, joker_122977, var_usedRegisters_108718, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3472)) ;
  GALGAS_ipic_31__38_SequentialInstruction var_ADDWF_5F_WREG_123044 = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::init_21__21__21__21_ (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3484)), GALGAS_pic_31__38_Instruction_5F_FDA_5F_base_5F_code_5F_AST::class_func_ADDWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3485)), var_WREG_5F_IPICregisterDescription_121613, GALGAS_bool (true), inCompiler COMMA_HERE) ;
  GALGAS_ipic_31__38_Block var_goto_34_Block_123257 = GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3491)), GALGAS_string ("_computed_goto_4").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3492)), GALGAS_ipic_31__38_SequentialInstructionList::class_func_listWithValue (var_ADDWF_5F_WREG_123044, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3493)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3493)), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3494)), GALGAS_string ("_computed_goto_2").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3494)), GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3494)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3495)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE) ;
  ...
  GALGAS_ipic_31__38_SequentialInstructionList var_goto_32_InstructionList_123645 = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  var_goto_32_InstructionList_123645.addAssign_operation (var_ADDWF_5F_WREG_123044, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3501)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3501)) ;
  var_goto_32_InstructionList_123645.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::init_21__21__21__21_ (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3503)), GALGAS_pic_31__38_Instruction_5F_FDA_5F_base_5F_code_5F_AST::class_func_ADDWF (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3504)), var_TOSL_5F_IPICregisterDescription_122057, GALGAS_bool (false), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3506)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3502)) ;
  var_goto_32_InstructionList_123645.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation::init_21__21__21_ (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3508)), GALGAS_literal_5F_instruction_5F_opcode::class_func_MOVLW (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3509)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3510)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3507)) ;
  var_goto_32_InstructionList_123645.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::init_21__21__21__21_ (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3512)), GALGAS_pic_31__38_Instruction_5F_FDA_5F_base_5F_code_5F_AST::class_func_ADDWFC (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3513)), var_TOSH_5F_IPICregisterDescription_122501, GALGAS_bool (false), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3515)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3511)) ;
  var_goto_32_InstructionList_123645.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::init_21__21__21__21_ (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3517)), GALGAS_pic_31__38_Instruction_5F_FDA_5F_base_5F_code_5F_AST::class_func_ADDWFC (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3518)), var_TOSU_5F_IPICregisterDescription_122944, GALGAS_bool (false), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3522)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3516)) ;
  GALGAS_ipic_31__38_Block var_goto_32_Block_124616 = GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3526)), GALGAS_string ("_computed_goto_2").getter_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3527)), var_goto_32_InstructionList_123645, GALGAS_ipic_31__38_ReturnTerminator::init_21_ (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3529)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3530)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE) ;
  ...
  while (enumerator_125009.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_31) {
      ...
      if (kBoolTrue == test_31) {
        var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (var_entryPoint_112194, enumerator_125009.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE), GALGAS_ipic_31__38_JumpTerminator::init_21__21__21_ (enumerator_125009.current_mRoutineName (HERE).readProperty_location (), enumerator_125009.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::class_func_ipicRelative (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3542)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3543)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3538)) ;
      }
    }
    if (kBoolFalse == test_31) {
      GALGAS_ipic_31__38_SequentialInstructionList var_instructionList_125414 = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
      enumGalgasBool test_32 = kBoolTrue ;
      if (kBoolTrue == test_32) {
        test_32 = GALGAS_bool (ComparisonKind::notEqual, enumerator_125009.current_mReturnedBank (HERE).readProperty_uint ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3548)))).boolEnum () ;
        if (kBoolTrue == test_32) {
          var_instructionList_125414.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB::init_21__21_ (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3549)), enumerator_125009.current_mReturnedBank (HERE), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3549)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3549)) ;
        }
      }
      var_generatedBlockList_112142.addAssign_operation (GALGAS_ipic_31__38_Block::init_21__21__21__21__21__21_ (var_entryPoint_112194, enumerator_125009.current_mRoutineName (HERE), var_instructionList_125414, GALGAS_ipic_31__38_ReturnTerminator::init_21_ (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3555)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3556)), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3551)) ;
    }
    var_entryPoint_112194 = var_entryPoint_112194.add_operation (GALGAS_uint (uint32_t (4U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3560)) ;
    enumerator_125009.gotoNextObject () ;
  }
  GALGAS_stringset var_unusedDeclarationUnicity_126004 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_126051.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_33) {
      ...
      if (kBoolTrue == test_33) {
        ...
        inCompiler->emitSemanticError (enumerator_126051.current_mValue (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_126051.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3566)).add_operation (GALGAS_string ("' byte is not declared"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3566)), fixItArray34  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3566)) ;
      }
    }
    if (kBoolFalse == test_33) {
      ...
      if (kBoolTrue == test_35) {
        ...
        if (kBoolTrue == test_35) {
          ...
          inCompiler->emitSemanticWarning (enumerator_126051.current_mValue (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_126051.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3568)).add_operation (GALGAS_string ("' byte is already declared as unused"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3568)), fixItArray36  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3568)) ;
        }
      }
      if (kBoolFalse == test_35) {
        ...
        if (kBoolTrue == test_37) {
          ...
          if (kBoolTrue == test_37) {
            ...
            inCompiler->emitSemanticWarning (enumerator_126051.current_mValue (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_126051.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3570)).add_operation (GALGAS_string ("' byte is declared as unused, but is used"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3570)), fixItArray38  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3570)) ;
          }
        }
      }
    }
  ...
  while (enumerator_126560.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_39) {
      ...
      if (kBoolTrue == test_39) {
        ...
        inCompiler->emitSemanticWarning (enumerator_126560.current_lkey (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_126560.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3576)).add_operation (GALGAS_string ("' byte is unused"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3576)), fixItArray40  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3576)) ;
      }
    }
    enumerator_126560.gotoNextObject () ;
  }
  {
  routine_displayBlockList_3F__26__3F_ (GALGAS_string ("INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_generatedBlockList_112142, inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3580)) ;
  }
  ...
  if (kBoolTrue == test_41) {
    ...
    if (kBoolTrue == test_41) {
      ...
      {
      routine_displayBlockList_3F__26__3F_ (GALGAS_string ("OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_generatedBlockList_112142, inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3584)) ;
      }
    }
  }
  ...
  GALGAS_blockDurationMap var_blockDurationMap_128076 = GALGAS_blockDurationMap::init (inCompiler COMMA_HERE) ;
  ...
  if (kBoolTrue == test_46) {
    ...
    if (kBoolTrue == test_46) {
      GALGAS_uint var_usedROMsize_128641 ;
      GALGAS_generatedCodeMap var_generatedCodeMap_128689 ;
      {
      ...
      if (kBoolTrue == test_47) {
        ...
        if (kBoolTrue == test_47) {
          GALGAS_string var_verboseMessage_128844 = GALGAS_string ("Resource usage:\n") ;
          var_verboseMessage_128844.plusAssign_operation(GALGAS_string ("  ROM, used ").add_operation (var_usedROMsize_128641.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3633)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3633)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3633)) ;
          ...
          while (enumerator_129140.hasCurrentObject ()) {
            GALGAS_uint var_bankSize_129177 = enumerator_129140.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_129140.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3637)) ;
            GALGAS_uint var_usedSize_129242 = enumerator_129140.current_mFirstFreeAddress (HERE).substract_operation (enumerator_129140.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3638)) ;
            var_verboseMessage_128844.plusAssign_operation(GALGAS_string ("  Bank '").add_operation (enumerator_129140.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3639)).add_operation (GALGAS_string ("': "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3639)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3639)) ;
            var_verboseMessage_128844.plusAssign_operation(var_usedSize_129242.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3640)).add_operation (GALGAS_string (" / "), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3640)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3640)) ;
            var_verboseMessage_128844.plusAssign_operation(var_bankSize_129177.getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3641)).add_operation (GALGAS_string (" bytes ("), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3641)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3641)) ;
            var_verboseMessage_128844.plusAssign_operation(var_usedSize_129242.multiply_operation (GALGAS_uint (uint32_t (100U)), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3642)).divide_operation (var_bankSize_129177, inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3642)).getter_string (SOURCE_FILE ("ipic18_build_block_representation.galgas", 3642)).add_operation (GALGAS_string ("%)\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3642)), inCompiler  COMMA_SOURCE_FILE ("ipic18_build_block_representation.galgas", 3642)) ;
...
void cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::method_optimizeInstruction (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  outArgument_outOptimizationDone = GALGAS_bool (false) ;
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstructionList var_optimizedInstructionList_28918 = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall temp_0 = this ;
  ...
  while (enumerator_28970.hasCurrentObject ()) {
    GALGAS_bool var_opt_29019 = GALGAS_bool (false) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (nullptr != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_28970.current_mInstruction (HERE).ptr ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        ...
        GALGAS_ipic_31__38__5F_intermediate_5F_JSR var_jsr_29124 = temp_2 ;
        GALGAS_uint var_targetBlockIndex_29234 ;
        ...
        GALGAS_ipic_31__38_Block var_targetBloc_29276 = constinArgument_inBlockList.getter_mBlockAtIndex (var_targetBlockIndex_29234, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 752)) ;
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          test_3 = GALGAS_bool (nullptr != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc_29276.readProperty_mTerminator ().ptr ())).operator_and (GALGAS_bool (ComparisonKind::equal, var_targetBloc_29276.readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_optimize_block.galgas", 754)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 753)).boolEnum () ;
          if (kBoolTrue == test_3) {
            enumGalgasBool test_4 = kBoolTrue ;
            if (kBoolTrue == test_4) {
              test_4 = constinArgument_inOptimizeFlagStruct.readProperty_mJSRtoEmptyRoutineInComputedRCALLreplacedByBlank ().operator_and (GALGAS_bool (ComparisonKind::equal, var_targetBloc_29276.readProperty_mInstructionList ().getter_count (SOURCE_FILE ("ipic18_optimize_block.galgas", 756)).objectCompare (GALGAS_uint (uint32_t (0U)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 755)).boolEnum () ;
              if (kBoolTrue == test_4) {
                var_opt_29019 = GALGAS_bool (true) ;
                outArgument_outOptimizationDone = GALGAS_bool (true) ;
                var_optimizedInstructionList_28918.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BLANK::init_21__21_ (var_jsr_29124.readProperty_mInstructionLocation (), GALGAS_uint (uint32_t (0U)), inCompiler COMMA_HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_optimize_block.galgas", 759)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 759)) ;
            ...
            if (kBoolFalse == test_4) {
              enumGalgasBool test_5 = kBoolTrue ;
              if (kBoolTrue == test_5) {
                test_5 = constinArgument_inOptimizeFlagStruct.readProperty_mJSRtoOneInstructionRoutineInComputedRCALLreplacedByInstruction ().operator_and (GALGAS_bool (ComparisonKind::equal, var_targetBloc_29276.readProperty_mInstructionList ().getter_count (SOURCE_FILE ("ipic18_optimize_block.galgas", 764)).objectCompare (GALGAS_uint (uint32_t (1U)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 763)).boolEnum () ;
                if (kBoolTrue == test_5) {
                  GALGAS_ipic_31__38_SequentialInstruction var_inst_30273 = var_targetBloc_29276.readProperty_mInstructionList ().getter_mInstructionAtIndex (GALGAS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 765)) ;
                  enumGalgasBool test_6 = kBoolTrue ;
                  if (kBoolTrue == test_6) {
                    test_6 = GALGAS_bool (ComparisonKind::equal, callExtensionGetter_instructionSize ((const cPtr_ipic_31__38_SequentialInstruction *) var_inst_30273.ptr (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 766)).objectCompare (GALGAS_uint (uint32_t (2U)))).boolEnum () ;
                    if (kBoolTrue == test_6) {
                      var_opt_29019 = GALGAS_bool (true) ;
                      outArgument_outOptimizationDone = GALGAS_bool (true) ;
                      var_optimizedInstructionList_28918.addAssign_operation (var_inst_30273, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_optimize_block.galgas", 769)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 769)) ;
    ...
    if (kBoolTrue == test_7) {
      ...
      if (kBoolTrue == test_7) {
        var_optimizedInstructionList_28918.addAssign_operation (enumerator_28970.current_mInstruction (HERE), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_optimize_block.galgas", 778)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 778)) ;
      }
    }
...
void cPtr_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip::method_optimizeInstruction (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
                                                                                          ...
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction_31888 ;
  const GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip temp_0 = this ;
  GALGAS_bool joker_31921 ; // Joker input parameter
...
void cPtr_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register::method_optimizeInstruction (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
                                                                                                  ...
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction_32954 ;
  const GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register temp_0 = this ;
  GALGAS_bool joker_32987 ; // Joker input parameter
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      ...
      outArgument_outOptimizedInstruction = GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register::init_21__21__21__21_ (temp_2.readProperty_mInstructionLocation (), var_optimizedEmbeddedInstruction_32954, temp_3.readProperty_mCompareInstruction (), temp_4.readProperty_mRegisterDescription (), inCompiler COMMA_HERE) ;
    }
  }
  if (kBoolFalse == test_1) {
...
void cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FDA::method_optimizeInstruction (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
                                                                                  ...
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction_33998 ;
  const GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FDA temp_0 = this ;
  GALGAS_bool joker_34031 ; // Joker input parameter
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      ...
      outArgument_outOptimizedInstruction = GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FDA::init_21__21__21__21__21_ (temp_2.readProperty_mInstructionLocation (), var_optimizedEmbeddedInstruction_33998, temp_3.readProperty_mInstruction_5F_FDA_5F_base_5F_code (), temp_4.readProperty_mRegisterDescription (), temp_5.readProperty_m_5F_W_5F_isDestination (), inCompiler COMMA_HERE) ;
    }
  }
  if (kBoolFalse == test_1) {
...
void routine_instructionListOptimization_3F__3F__3F__3F__3F__21__26__21_ (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  outArgument_outOptimizationDone = GALGAS_bool (false) ;
  outArgument_outOptimizedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_35054.hasCurrentObject ()) {
    GALGAS_bool var_optimizationDone_35225 ;
    GALGAS_ipic_31__38_SequentialInstruction var_optimizedInstruction_35309 ;
    GALGAS_bool var_NOPsubstitution_35347 ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_1) {
        outArgument_outOptimizedInstructionList.addAssign_operation (var_optimizedInstruction_35309, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_optimize_block.galgas", 927)), GALGAS_uint (uint32_t (0U))  COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 927)) ;
      }
    }
...
void routine_ipic_31__38_OptimizeBlocks_26__26_ (GALGAS_string & ioArgument_ioListFileContents,
  ...
  GALGAS_bool var_optimizationDone_44236 = GALGAS_bool (true) ;
  GALGAS_uint var_optimizationPass_44272 = GALGAS_uint (uint32_t (0U)) ;
  if (ioArgument_ioGeneratedBlockList.getter_count (SOURCE_FILE ("ipic18_optimize_block.galgas", 1115)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1115)).isValid ()) {
    uint32_t variant_44295 = ioArgument_ioGeneratedBlockList.getter_count (SOURCE_FILE ("ipic18_optimize_block.galgas", 1115)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1115)).uintValue () ;
    bool loop_44295 = true ;
    while (loop_44295) {
      loop_44295 = var_optimizationDone_44236.operator_and (GALGAS_bool (ComparisonKind::equal, GALGAS_uint::class_func_errorCount (SOURCE_FILE ("ipic18_optimize_block.galgas", 1116)).objectCompare (GALGAS_uint (uint32_t (0U)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1116)).isValid () ;
      if (loop_44295) {
        loop_44295 = var_optimizationDone_44236.operator_and (GALGAS_bool (ComparisonKind::equal, GALGAS_uint::class_func_errorCount (SOURCE_FILE ("ipic18_optimize_block.galgas", 1116)).objectCompare (GALGAS_uint (uint32_t (0U)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1116)).boolValue () ;
      }
      ...
      if (loop_44295) {
        variant_44295 -- ;
        var_optimizationDone_44236 = GALGAS_bool (false) ;
        var_optimizationPass_44272 = var_optimizationPass_44272.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1118)) ;
        ...
        GALGAS_stringset var_referencedBlockSet_45098 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
        ...
        while (enumerator_45141.hasCurrentObject ()) {
          enumGalgasBool test_2 = kBoolTrue ;
          if (kBoolTrue == test_2) {
            test_2 = GALGAS_bool (ComparisonKind::notEqual, enumerator_45141.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_optimize_block.galgas", 1132)))).boolEnum () ;
            if (kBoolTrue == test_2) {
        ...
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList_45456 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
        ...
        while (enumerator_45505.hasCurrentObject ()) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_referencedBlockSet_45098.getter_hasKey (enumerator_45505.current_mBlock (HERE).readProperty_mLabel ().readProperty_string () COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1143)).operator_or (GALGAS_bool (ComparisonKind::notEqual, enumerator_45505.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_optimize_block.galgas", 1143)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1143)).boolEnum () ;
            if (kBoolTrue == test_3) {
              GALGAS_ipic_31__38_Block var_optimizedBlock_45837 ;
          ...
          if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  [D] ").add_operation (enumerator_45505.current_mBlock (HERE).readProperty_mLabel ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1154)).add_operation (GALGAS_string (": not referenced, deleted\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1154)), inCompiler  COMMA_SOURCE_FILE ("ipic18_optimize_block.galgas", 1154)) ;
            var_optimizationDone_44236 = GALGAS_bool (true) ;
          }
...
void routine_buildOrderedGraph_26__3F__26_ (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  GALGAS_symbolTableForBlockOptimization var_symbolTable_13292 = GALGAS_symbolTableForBlockOptimization::init (inCompiler COMMA_HERE) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13348 (ioArgument_ioBlockList, EnumerationOrder::up) ;
  GALGAS_uint index_13343 (uint32_t (0)) ;
  ...
  GALGAS_blockInvocationGraph var_g_13461 = GALGAS_blockInvocationGraph::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_13499.hasCurrentObject ()) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::equal, enumerator_13499.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_block_ordering.galgas", 391)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
  ...
  GALGAS_lstringlist var_nodeList_13793 ;
  GALGAS_stringlist joker_13772 ; // Joker input parameter
  ...
  GALGAS_stringlist var_newOrderedLabelList_13809 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
  GALGAS_stringset var_visitedNodeSet_13851 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
  GALGAS_clusterList var_clusterList_13887 = GALGAS_clusterList::init (inCompiler COMMA_HERE) ;
  cEnumerator_lstringlist enumerator_13923 (var_nodeList_13793, EnumerationOrder::up) ;
  while (enumerator_13923.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg_13977 = var_g_13461.getter_subgraphFromNodes (GALGAS_lstringlist::class_func_listWithValue (enumerator_13923.current_mValue (HERE)  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 403)), var_visitedNodeSet_13851, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 402)) ;
    ...
    GALGAS_stringlist var_partialOrderedLabelList_14267 ;
    GALGAS_lstringlist joker_14297_3 ; // Joker input parameter
    GALGAS_stringlist joker_14297_2 ; // Joker input parameter
    GALGAS_lstringlist joker_14297_1 ; // Joker input parameter
    ...
    GALGAS_ipic_31__38_BlockList var_cluster_14366 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
    ...
    while (enumerator_14404.hasCurrentObject ()) {
      GALGAS_uint var_blockIndex_14501 ;
      ...
      GALGAS_ipic_31__38_Block var_b_14536 = ioArgument_ioBlockList.getter_mBlockAtIndex (var_blockIndex_14501, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 418)) ;
  ...
  while (enumerator_14727.hasCurrentObject ()) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (ComparisonKind::equal, enumerator_14727.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_block_ordering.galgas", 425)))).operator_and (var_visitedNodeSet_13851.getter_hasKey (enumerator_14727.current_mBlock (HERE).readProperty_mLabel ().readProperty_string () COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 426)).operator_not (SOURCE_FILE ("ipic18_block_ordering.galgas", 426)) COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 425)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_blockInvocationGraph var_gg_14912 = var_g_13461.getter_subgraphFromNodes (GALGAS_lstringlist::class_func_listWithValue (enumerator_14727.current_mBlock (HERE).readProperty_mLabel ()  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 428)), var_visitedNodeSet_13851, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 427)) ;
        ...
        GALGAS_stringlist var_partialOrderedLabelList_15276 ;
        GALGAS_lstringlist joker_15308_3 ; // Joker input parameter
        GALGAS_stringlist joker_15308_2 ; // Joker input parameter
        GALGAS_lstringlist joker_15308_1 ; // Joker input parameter
        ...
        GALGAS_ipic_31__38_BlockList var_cluster_15383 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
        ...
        while (enumerator_15423.hasCurrentObject ()) {
          GALGAS_uint var_blockIndex_15522 ;
          ...
          GALGAS_ipic_31__38_Block var_b_15559 = ioArgument_ioBlockList.getter_mBlockAtIndex (var_blockIndex_15522, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 444)) ;
  ...
  GALGAS_ipic_31__38_BlockList var_orderedBlockList_15734 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
  GALGAS_bool var_continue_15825 = GALGAS_bool (true) ;
  ...
  if (enumerator_15848.hasCurrentObject () && bool_3) {
    while (enumerator_15848.hasCurrentObject () && bool_3) {
      var_continue_15825 = GALGAS_bool (ComparisonKind::notEqual, enumerator_15848.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_block_ordering.galgas", 455)))) ;
      enumGalgasBool test_4 = kBoolTrue ;
      if (kBoolTrue == test_4) {
  ...
  while (enumerator_16039.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex_16130 ;
    ...
    GALGAS_ipic_31__38_Block var_b_16163 = ioArgument_ioBlockList.getter_mBlockAtIndex (var_blockIndex_16130, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 463)) ;
  ...
  GALGAS_uint var_insertionIndex_16299 = var_orderedBlockList_15734.getter_count (SOURCE_FILE ("ipic18_block_ordering.galgas", 467)) ;
  var_continue_15825 = GALGAS_bool (true) ;
  ...
  if (enumerator_16368.hasCurrentObject () && bool_5) {
    while (enumerator_16368.hasCurrentObject () && bool_5) {
      var_continue_15825 = GALGAS_bool (ComparisonKind::notEqual, enumerator_16368.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_block_ordering.galgas", 470)))) ;
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
  ...
  GALGAS_uint var_p_16604 = function_blockDiscontinuityCount (var_orderedBlockList_15734, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 476)) ;
  ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  jump count after optimization: ").add_operation (var_p_16604.getter_string (SOURCE_FILE ("ipic18_block_ordering.galgas", 477)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 477)).add_operation (GALGAS_string ("\n\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 477)), inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 477)) ;
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    test_7 = GALGAS_application::class_func_verboseOutput (SOURCE_FILE ("ipic18_block_ordering.galgas", 478)).boolEnum () ;
    if (kBoolTrue == test_7) {
      {
      routine_print_3F_ (var_n_13026.getter_string (SOURCE_FILE ("ipic18_block_ordering.galgas", 479)).add_operation (GALGAS_string (" -> "), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 479)).add_operation (var_p_16604.getter_string (SOURCE_FILE ("ipic18_block_ordering.galgas", 479)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 479)).add_operation (GALGAS_string (".\n\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 479)), inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 479)) ;
      }
    }
  }
  enumGalgasBool test_8 = kBoolTrue ;
  if (kBoolTrue == test_8) {
    ...
    if (kBoolTrue == test_8) {
      ...
      var_g_13461.getter_graphviz (SOURCE_FILE ("ipic18_block_ordering.galgas", 483)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.add_operation (GALGAS_string (".blockOrderingConstraints.dot"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 483)), joker_17005, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 483)) ;
    }
  }
  GALGAS_stringset var_newSymbolSet_17049 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
  GALGAS_bool var_ok_17089 = GALGAS_bool (true) ;
  ...
  while (enumerator_17106.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      ...
      if (kBoolTrue == test_9) {
        GALGAS_string var_s_17212 = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").add_operation (enumerator_17106.current_mBlock (HERE).readProperty_mLabel ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 490)).add_operation (GALGAS_string ("\" is duplicated"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 491)) ;
        TC_Array <FixItDescription> fixItArray10 ;
        inCompiler->emitSemanticWarning (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_block_ordering.galgas", 492)), var_s_17212, fixItArray10  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 492)) ;
        ioArgument_ioListFileContents.plusAssign_operation(var_s_17212.add_operation (GALGAS_string (".\n\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 493)), inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 493)) ;
        var_ok_17089 = GALGAS_bool (false) ;
      }
    }
    if (kBoolFalse == test_9) {
  ...
  while (enumerator_17475.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_11) {
      ...
      if (kBoolTrue == test_11) {
        GALGAS_string var_s_17566 = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").add_operation (enumerator_17475.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 501)).add_operation (GALGAS_string ("\" is missing"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 502)) ;
        TC_Array <FixItDescription> fixItArray12 ;
        inCompiler->emitSemanticWarning (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_block_ordering.galgas", 503)), var_s_17566, fixItArray12  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 503)) ;
        ioArgument_ioListFileContents.plusAssign_operation(var_s_17566.add_operation (GALGAS_string (".\n\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 504)), inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 504)) ;
        var_ok_17089 = GALGAS_bool (false) ;
      }
    }
  ...
  if (kBoolTrue == test_13) {
    ...
    if (kBoolTrue == test_13) {
      ...
      {
      routine_displayBlockList_3F__26__3F_ (GALGAS_string ("ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_orderedBlockList_15734, inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 511)) ;
      }
    }
  }
  if (kBoolFalse == test_13) {
    GALGAS_string var_s_17994 = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: reordered block list is inconsistent, it is not used anymore") ;
    TC_Array <FixItDescription> fixItArray14 ;
    inCompiler->emitSemanticWarning (GALGAS_location::class_func_nowhere (SOURCE_FILE ("ipic18_block_ordering.galgas", 514)), var_s_17994, fixItArray14  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 514)) ;
    ioArgument_ioListFileContents.plusAssign_operation(var_s_17994.add_operation (GALGAS_string (".\n\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 515)), inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 515)) ;
    {
    routine_displayBlockList_3F__26__3F_ (GALGAS_string ("INCONSISTENT ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION (not used)"), ioArgument_ioListFileContents, var_orderedBlockList_15734, inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 516)) ;
    }
  }
  enumGalgasBool test_15 = kBoolTrue ;
  if (kBoolTrue == test_15) {
...
void routine_buildInvocationGraph_3F__21_ (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  while (enumerator_18748.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::notEqual, enumerator_18748.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_block_ordering.galgas", 536)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        outArgument_outGraphVizString.plusAssign_operation(GALGAS_string ("  \"").add_operation (enumerator_18748.current_mBlock (HERE).readProperty_mLabel ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 537)).add_operation (GALGAS_string ("\" [shape=rectangle]\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 537)), inCompiler  COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 537)) ;
      }
    }
    ...
    callExtensionMethod_buildTerminatorInvocationGraph ((cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18748.current_mBlock (HERE).readProperty_mTerminator ().ptr (), enumerator_18748.current_mBlock (HERE).readProperty_mLabel (), outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 542)) ;
...
GALGAS_uint function_blockDiscontinuityCount (const GALGAS_ipic_31__38_BlockList & constinArgument_inBlockList,
  ...
  GALGAS_uint index_19390 (uint32_t (0)) ;
  while (enumerator_19395.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::equal, enumerator_19395.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_block_ordering.galgas", 552)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_nextBlockLabel_19519 ;
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (ComparisonKind::lowerThan, index_19390.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 554)).objectCompare (constinArgument_inBlockList.getter_count (SOURCE_FILE ("ipic18_block_ordering.galgas", 554)))).boolEnum () ;
          if (kBoolTrue == test_1) {
            var_nextBlockLabel_19519 = constinArgument_inBlockList.getter_mBlockAtIndex (index_19390.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 555)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 555)).readProperty_mLabel ().readProperty_string () ;
          }
        }
        if (kBoolFalse == test_1) {
          var_nextBlockLabel_19519 = GALGAS_string::makeEmptyString () ;
        }
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
...
void routine_ipic_31__38_OptimizeBlockOrdering_3F__26__26_ (const GALGAS_string constinArgument_inSourceFileName,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_string var_invocationGraph_20189 ;
      {
      ...
      GALGAS_bool joker_20303 ; // Joker input parameter
      var_invocationGraph_20189.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.add_operation (GALGAS_string (".blockInvocation.dot"), inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 574)), joker_20303, inCompiler COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 574)) ;
    }
  }
  GALGAS_bool var_optimize_20330 = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.readProperty_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.readProperty_value ()).getter_containsCharacter (GALGAS_char (TO_UNICODE (66)) COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 578)) COMMA_SOURCE_FILE ("ipic18_block_ordering.galgas", 577)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
...
void routine_perform_5F_cluster_5F_ordering_3F__26__26_ (const GALGAS_clusterList constinArgument_inInitialClusterList,
  ...
  if (kBoolFalse == test_0) {
    ...
    GALGAS_neededConversionForClusterOrder var_neededConversionForClusterOrder_2062 = GALGAS_neededConversionForClusterOrder::init (inCompiler COMMA_HERE) ;
    GALGAS_bool var_continue_2145 = GALGAS_bool (true) ;
    GALGAS_uint var_pass_2175 = GALGAS_uint (uint32_t (0U)) ;
    if (var_clusterList_2019.getter_count (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 56)).multiply_operation (var_clusterList_2019.getter_count (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 56)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 56)).isValid ()) {
      ...
      while (loop_2188) {
        ...
        if (loop_2188) {
          variant_2188 -- ;
          var_pass_2175.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 58)) ;
          ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("Pass ").add_operation (var_pass_2175.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 59)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 59)).add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 59)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 59)) ;
          GALGAS_ipic_31__38_BlockList var_workingBlockList_2387 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
          GALGAS_symbolTableForClusterOrdering var_symbolTable_2435 = GALGAS_symbolTableForClusterOrdering::init (inCompiler COMMA_HERE) ;
          cEnumerator_clusterList enumerator_2493 (var_clusterList_2019, EnumerationOrder::up) ;
          GALGAS_uint index_2488 (uint32_t (0)) ;
          ...
          GALGAS_uint var_insertionIdx_2769 = var_workingBlockList_2387.getter_count (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 70)) ;
          ...
          if (enumerator_2822.hasCurrentObject () && bool_4) {
            while (enumerator_2822.hasCurrentObject () && bool_4) {
              var_continue_2145 = GALGAS_bool (ComparisonKind::notEqual, enumerator_2822.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 72)))) ;
              enumGalgasBool test_5 = kBoolTrue ;
              if (kBoolTrue == test_5) {
                test_5 = var_continue_2145.boolEnum () ;
                if (kBoolTrue == test_5) {
                  {
                  var_symbolTable_2435.setter_insertKey (enumerator_2822.current_mBlock (HERE).readProperty_mLabel (), GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 74)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 74)) ;
                  }
                  {
          ...
          GALGAS_branchOverflowMap var_overflowMap_3267 ;
          {
          ...
          GALGAS_uint var_overflowCount_3303 = GALGAS_uint (uint32_t (0U)) ;
          cEnumerator_branchOverflowMap enumerator_3336 (var_overflowMap_3267, EnumerationOrder::up) ;
          while (enumerator_3336.hasCurrentObject ()) {
            cEnumerator_stringlist enumerator_3375 (enumerator_3336.current_mList (HERE), EnumerationOrder::up) ;
            while (enumerator_3375.hasCurrentObject ()) {
              var_overflowCount_3303.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 87)) ;
              GALGAS_uint var_sourceCluster_3484 ;
              var_symbolTable_2435.method_searchKey (enumerator_3336.current_key (HERE).getter_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 88)), var_sourceCluster_3484, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 88)) ;
              GALGAS_uint var_targetCluster_3561 ;
              var_symbolTable_2435.method_searchKey (enumerator_3375.current_mValue (HERE).getter_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 89)), var_targetCluster_3561, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 89)) ;
              ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  ").add_operation (enumerator_3336.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)).add_operation (GALGAS_string (" (cluster #"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)).add_operation (var_sourceCluster_3484.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)).add_operation (GALGAS_string (") --> "), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)).add_operation (enumerator_3375.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)).add_operation (GALGAS_string (" (cluster #"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)).add_operation (var_targetCluster_3561.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 90)) ;
          ...
          if (kBoolTrue == test_6) {
            ...
            if (kBoolTrue == test_6) {
              GALGAS_string var_s_3918 = GALGAS_string ("  Pass ").add_operation (var_pass_2175.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 98)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 98)).add_operation (GALGAS_string (": "), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 98)) ;
              enumGalgasBool test_7 = kBoolTrue ;
              if (kBoolTrue == test_7) {
                test_7 = GALGAS_bool (ComparisonKind::equal, var_overflowCount_3303.objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  var_s_3918.plusAssign_operation(GALGAS_string ("no branch overflow"), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 100)) ;
                }
              }
              if (kBoolFalse == test_7) {
                enumGalgasBool test_8 = kBoolTrue ;
                if (kBoolTrue == test_8) {
                  test_8 = GALGAS_bool (ComparisonKind::equal, var_overflowCount_3303.objectCompare (GALGAS_uint (uint32_t (1U)))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    var_s_3918.plusAssign_operation(GALGAS_string ("1 branch overflow"), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 102)) ;
                  }
                }
                if (kBoolFalse == test_8) {
                  var_s_3918.plusAssign_operation(var_overflowCount_3303.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 104)).add_operation (GALGAS_string (" branch overflows"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 104)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 104)) ;
                }
              }
              {
              routine_print_3F_ (var_s_3918, inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 106)) ;
              }
            }
          }
          GALGAS_bool var_correctionLoop_4240 = GALGAS_bool (true) ;
          cEnumerator_branchOverflowMap enumerator_4277 (var_overflowMap_3267, EnumerationOrder::up) ;
          bool bool_9 = var_correctionLoop_4240.isValidAndTrue () ;
          if (enumerator_4277.hasCurrentObject () && bool_9) {
            while (enumerator_4277.hasCurrentObject () && bool_9) {
              cEnumerator_stringlist enumerator_4337 (enumerator_4277.current_mList (HERE), EnumerationOrder::up) ;
              bool bool_10 = var_correctionLoop_4240.isValidAndTrue () ;
              if (enumerator_4337.hasCurrentObject () && bool_10) {
                while (enumerator_4337.hasCurrentObject () && bool_10) {
                  GALGAS_uint var_targetCluster_4441 ;
                  var_symbolTable_2435.method_searchKey (enumerator_4337.current_mValue (HERE).getter_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 112)), var_targetCluster_4441, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 112)) ;
                  enumGalgasBool test_11 = kBoolTrue ;
                  if (kBoolTrue == test_11) {
                    test_11 = GALGAS_bool (ComparisonKind::notEqual, var_targetCluster_4441.objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 113)))).boolEnum () ;
                    if (kBoolTrue == test_11) {
                      GALGAS_uint var_sourceCluster_4563 ;
                      var_symbolTable_2435.method_searchKey (enumerator_4277.current_key (HERE).getter_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 114)), var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 114)) ;
                      enumGalgasBool test_12 = kBoolTrue ;
                      if (kBoolTrue == test_12) {
                        test_12 = GALGAS_bool (ComparisonKind::equal, var_sourceCluster_4563.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 115)).objectCompare (var_targetCluster_4441)).boolEnum () ;
                        if (kBoolTrue == test_12) {
                          var_correctionLoop_4240 = GALGAS_bool (false) ;
                          var_continue_2145 = GALGAS_bool (true) ;
                          GALGAS_ipic_31__38_BlockList var_last_4767 ;
                          {
                          var_clusterList_2019.setter_removeAtIndex (var_last_4767, var_targetCluster_4441, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 118)) ;
                          }
                          GALGAS_ipic_31__38_BlockList var_first_4854 ;
                          {
                          var_clusterList_2019.setter_removeAtIndex (var_first_4854, var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 119)) ;
                          }
                          {
                          var_clusterList_2019.setter_insertAtIndex (var_first_4854.add_operation (var_last_4767, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 120)), var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 120)) ;
                          }
                          GALGAS_string var_m_4976 = GALGAS_string ("merge #").add_operation (var_targetCluster_4441.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 121)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 121)).add_operation (GALGAS_string (" into #"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 121)).add_operation (var_sourceCluster_4563.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 121)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 121)).add_operation (GALGAS_string ("]"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 121)) ;
                          ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  --> ").add_operation (var_m_4976, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 122)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 122)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 122)) ;
                          enumGalgasBool test_13 = kBoolTrue ;
                          if (kBoolTrue == test_13) {
                            test_13 = GALGAS_application::class_func_verboseOutput (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 123)).boolEnum () ;
                            if (kBoolTrue == test_13) {
                              {
                              routine_print_3F_ (GALGAS_string (" -> ").add_operation (var_m_4976, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 124)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 124)) ;
                              }
                            }
                          }
                        }
                      ...
                      if (kBoolFalse == test_12) {
                        enumGalgasBool test_14 = kBoolTrue ;
                        if (kBoolTrue == test_14) {
                          test_14 = GALGAS_bool (ComparisonKind::equal, var_sourceCluster_4563.objectCompare (var_targetCluster_4441.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 126)))).boolEnum () ;
                          if (kBoolTrue == test_14) {
                            var_correctionLoop_4240 = GALGAS_bool (false) ;
                            var_continue_2145 = GALGAS_bool (true) ;
                            GALGAS_ipic_31__38_BlockList var_last_5391 ;
                            {
                            var_clusterList_2019.setter_removeAtIndex (var_last_5391, var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 129)) ;
                            }
                            GALGAS_ipic_31__38_BlockList var_first_5478 ;
                            {
                            var_clusterList_2019.setter_removeAtIndex (var_first_5478, var_targetCluster_4441, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 130)) ;
                            }
                            {
                            var_clusterList_2019.setter_insertAtIndex (var_first_5478.add_operation (var_last_5391, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 131)), var_targetCluster_4441, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 131)) ;
                            }
                            GALGAS_string var_m_5600 = GALGAS_string ("merge #").add_operation (var_sourceCluster_4563.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 132)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 132)).add_operation (GALGAS_string (" into #"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 132)).add_operation (var_targetCluster_4441.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 132)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 132)).add_operation (GALGAS_string ("]"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 132)) ;
                            ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  --> ").add_operation (var_m_5600, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 133)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 133)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 133)) ;
                            enumGalgasBool test_15 = kBoolTrue ;
                            if (kBoolTrue == test_15) {
                              test_15 = GALGAS_application::class_func_verboseOutput (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 134)).boolEnum () ;
                              if (kBoolTrue == test_15) {
                                {
                                routine_print_3F_ (GALGAS_string (" -> ").add_operation (var_m_5600, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 135)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 135)) ;
                                }
                              }
                            }
                          }
                        ...
                        if (kBoolFalse == test_14) {
                          enumGalgasBool test_16 = kBoolTrue ;
                          if (kBoolTrue == test_16) {
                            test_16 = GALGAS_bool (ComparisonKind::lowerThan, var_sourceCluster_4563.objectCompare (var_targetCluster_4441)).boolEnum () ;
                            if (kBoolTrue == test_16) {
                              GALGAS_clusterList var_candidate_5907 = var_clusterList_2019 ;
                              GALGAS_ipic_31__38_BlockList var_b_5994 ;
                              {
                              var_candidate_5907.setter_removeAtIndex (var_b_5994, var_targetCluster_4441, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 139)) ;
                              }
                              {
                              var_candidate_5907.setter_insertAtIndex (var_b_5994, var_targetCluster_4441.add_operation (var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 140)).divide_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 140)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 140)) ;
                              }
                              enumGalgasBool test_17 = kBoolTrue ;
                              if (kBoolTrue == test_17) {
                                test_17 = var_neededConversionForClusterOrder_2062.getter_hasKey (function_sortKey (var_candidate_5907, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 141)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 141)).operator_not (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 141)).boolEnum () ;
                                if (kBoolTrue == test_17) {
                                  var_clusterList_2019 = var_candidate_5907 ;
                                  var_correctionLoop_4240 = GALGAS_bool (false) ;
                                  var_continue_2145 = GALGAS_bool (true) ;
                                  GALGAS_string var_m_6324 = GALGAS_string ("roll up [#").add_operation (var_targetCluster_4441.add_operation (var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)).divide_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)).getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)).add_operation (GALGAS_string (", #"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)).add_operation (var_targetCluster_4441.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)).add_operation (GALGAS_string ("]"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 145)) ;
                                  ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  --> ").add_operation (var_m_6324, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 146)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 146)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 146)) ;
                                  enumGalgasBool test_18 = kBoolTrue ;
                                  if (kBoolTrue == test_18) {
                                    test_18 = GALGAS_application::class_func_verboseOutput (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 147)).boolEnum () ;
                                    if (kBoolTrue == test_18) {
                                      {
                                      routine_print_3F_ (GALGAS_string (" -> ").add_operation (var_m_6324, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 148)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 148)) ;
                                      }
                                    }
                                  }
                                }
                          ...
                          if (kBoolFalse == test_16) {
                            enumGalgasBool test_19 = kBoolTrue ;
                            if (kBoolTrue == test_19) {
                              test_19 = GALGAS_bool (ComparisonKind::greaterThan, var_sourceCluster_4563.objectCompare (var_targetCluster_4441)).boolEnum () ;
                              if (kBoolTrue == test_19) {
                                GALGAS_clusterList var_candidate_6680 = var_clusterList_2019 ;
                                GALGAS_ipic_31__38_BlockList var_b_6767 ;
                                {
                                var_candidate_6680.setter_removeAtIndex (var_b_6767, var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 153)) ;
                                }
                                {
                                var_candidate_6680.setter_insertAtIndex (var_b_6767, var_targetCluster_4441.add_operation (var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 154)).divide_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 154)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 154)) ;
                                }
                                enumGalgasBool test_20 = kBoolTrue ;
                                if (kBoolTrue == test_20) {
                                  test_20 = var_neededConversionForClusterOrder_2062.getter_hasKey (function_sortKey (var_candidate_6680, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 155)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 155)).operator_not (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 155)).boolEnum () ;
                                  if (kBoolTrue == test_20) {
                                    var_clusterList_2019 = var_candidate_6680 ;
                                    var_correctionLoop_4240 = GALGAS_bool (false) ;
                                    var_continue_2145 = GALGAS_bool (true) ;
                                    GALGAS_string var_m_7097 = GALGAS_string ("roll up [#").add_operation (var_targetCluster_4441.getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)).add_operation (GALGAS_string (", #"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)).add_operation (var_targetCluster_4441.add_operation (var_sourceCluster_4563, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)).divide_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)).getter_string (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)).add_operation (GALGAS_string ("]"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 159)) ;
                                    ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  --> ").add_operation (var_m_7097, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 160)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 160)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 160)) ;
                                    enumGalgasBool test_21 = kBoolTrue ;
                                    if (kBoolTrue == test_21) {
                                      test_21 = GALGAS_application::class_func_verboseOutput (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 161)).boolEnum () ;
                                      if (kBoolTrue == test_21) {
                                        {
                                        routine_print_3F_ (GALGAS_string (" -> ").add_operation (var_m_7097, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 162)), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 162)) ;
                                        }
                                      }
                                    }
                                  }
                  ...
                  if (enumerator_4337.hasCurrentObject ()) {
                    bool_10 = var_correctionLoop_4240.isValidAndTrue () ;
                  }
                }
              }
              enumerator_4277.gotoNextObject () ;
              if (enumerator_4277.hasCurrentObject ()) {
                bool_9 = var_correctionLoop_4240.isValidAndTrue () ;
              }
            }
          }
          enumGalgasBool test_22 = kBoolTrue ;
    ...
    GALGAS_ipic_31__38_BlockList var_newBlockList_7679 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
    var_continue_2145 = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_7785 (ioArgument_ioBlockList, EnumerationOrder::up) ;
    bool bool_24 = var_continue_2145.isValidAndTrue () ;
    if (enumerator_7785.hasCurrentObject () && bool_24) {
      while (enumerator_7785.hasCurrentObject () && bool_24) {
        var_continue_2145 = GALGAS_bool (ComparisonKind::notEqual, enumerator_7785.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 182)))) ;
        enumGalgasBool test_25 = kBoolTrue ;
        if (kBoolTrue == test_25) {
          test_25 = var_continue_2145.boolEnum () ;
          if (kBoolTrue == test_25) {
            var_newBlockList_7679.addAssign_operation (enumerator_7785.current_mBlock (HERE)  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 184)) ;
          }
        }
    ...
    cEnumerator_clusterList enumerator_7986 (var_clusterList_2019, EnumerationOrder::up) ;
    while (enumerator_7986.hasCurrentObject ()) {
      var_newBlockList_7679.plusAssign_operation(enumerator_7986.current_mBlockList (HERE), inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 189)) ;
      enumerator_7986.gotoNextObject () ;
    }
    GALGAS_uint var_insertionIndex_8115 = var_newBlockList_7679.getter_count (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 192)) ;
    var_continue_2145 = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_8184 (ioArgument_ioBlockList, EnumerationOrder::down) ;
    bool bool_26 = var_continue_2145.isValidAndTrue () ;
    if (enumerator_8184.hasCurrentObject () && bool_26) {
      while (enumerator_8184.hasCurrentObject () && bool_26) {
        var_continue_2145 = GALGAS_bool (ComparisonKind::notEqual, enumerator_8184.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_cluster_ordering.galgas", 195)))) ;
        enumGalgasBool test_27 = kBoolTrue ;
        if (kBoolTrue == test_27) {
          test_27 = var_continue_2145.boolEnum () ;
          if (kBoolTrue == test_27) {
            {
            var_newBlockList_7679.setter_insertAtIndex (enumerator_8184.current_mBlock (HERE), var_insertionIndex_8115, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.galgas", 197)) ;
            }
          }
        }
        enumerator_8184.gotoNextObject () ;
        if (enumerator_8184.hasCurrentObject ()) {
          bool_26 = var_continue_2145.isValidAndTrue () ;
        }
      }
    }
    ioArgument_ioBlockList = var_newBlockList_7679 ;
  }
}
...
void routine_performRelativesResolution_3F__26__26__26_ (const GALGAS_symbolTableForRelativesResolution constinArgument_inSymbolTable,
                                                         ...
                                                         Compiler * inCompiler
                                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38_BlockList var_modifiedBlockList_1593 = GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE) ;
  GALGAS_uint var_blockStartAddress_1644 = GALGAS_uint (uint32_t (0U)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_1673 (ioArgument_ioBlockList, EnumerationOrder::up) ;
  GALGAS_uint index_1668 (uint32_t (0)) ;
  while (enumerator_1673.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel_1728 ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::lowerThan, index_1668.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 60)).objectCompare (ioArgument_ioBlockList.getter_count (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 60)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_nextBlockLabel_1728 = ioArgument_ioBlockList.getter_mBlockAtIndex (index_1668.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 61)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 61)).readProperty_mLabel ().readProperty_string () ;
      }
    }
    if (kBoolFalse == test_0) {
      var_nextBlockLabel_1728 = GALGAS_string::makeEmptyString () ;
    }
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::notEqual, enumerator_1673.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 65)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_blockStartAddress_1644 = enumerator_1673.current_mBlock (HERE).readProperty_mAddress () ;
      }
    }
    GALGAS_ipic_31__38_Block var_modifiedBlock_2207 ;
    ...
    GALGAS_uint var_blockSize_2281 = extensionGetter_blockSize (enumerator_1673.current_mBlock (HERE), var_nextBlockLabel_1728, inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 77)) ;
...
void routine_computeLabelAbsoluteAddressMap_3F__3F__21__21_ (const GALGAS_ipic_31__38_BlockList constinArgument_inGeneratedBlockList,
  ...
  outArgument_outSymbolTable = GALGAS_symbolTableForRelativesResolution::init (inCompiler COMMA_HERE) ;
  outArgument_outFreeAddress = GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 106)) ;
  GALGAS_uint var_blockStartAddress_3330 = GALGAS_uint (uint32_t (0U)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_3359 (constinArgument_inGeneratedBlockList, EnumerationOrder::up) ;
  GALGAS_uint index_3354 (uint32_t (0)) ;
  while (enumerator_3359.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel_3423 ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::lowerThan, index_3354.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 111)).objectCompare (constinArgument_inGeneratedBlockList.getter_count (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 111)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_nextBlockLabel_3423 = constinArgument_inGeneratedBlockList.getter_mBlockAtIndex (index_3354.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 112)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 112)).readProperty_mLabel ().readProperty_string () ;
      }
    }
    if (kBoolFalse == test_0) {
      var_nextBlockLabel_3423 = GALGAS_string::makeEmptyString () ;
    }
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::notEqual, enumerator_3359.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 116)))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    GALGAS_uint var_blockSize_3817 = extensionGetter_blockSize (enumerator_3359.current_mBlock (HERE), var_nextBlockLabel_3423, inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 120)) ;
    ...
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (ComparisonKind::equal, enumerator_3359.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 122)))).boolEnum () ;
      if (kBoolTrue == test_2) {
  ...
  while (enumerator_4047.hasCurrentObject ()) {
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = GALGAS_bool (ComparisonKind::notEqual, enumerator_4047.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 128)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
...
void routine_ipic_31__38_RelativesResolution_26__26_ (GALGAS_string & ioArgument_ioListFileContents,
  ...
  GALGAS_bool var_resolutionDone_4859 = GALGAS_bool (false) ;
  GALGAS_uint var_pass_4894 = GALGAS_uint (uint32_t (0U)) ;
  if (ioArgument_ioGeneratedBlockList.getter_count (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 151)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 151)).isValid ()) {
    uint32_t variant_4905 = ioArgument_ioGeneratedBlockList.getter_count (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 151)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 151)).uintValue () ;
    bool loop_4905 = true ;
    while (loop_4905) {
      loop_4905 = var_resolutionDone_4859.operator_not (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 152)).operator_and (GALGAS_bool (ComparisonKind::equal, GALGAS_uint::class_func_errorCount (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 152)).objectCompare (GALGAS_uint (uint32_t (0U)))) COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 152)).isValid () ;
      if (loop_4905) {
      ...
      if (loop_4905) {
        variant_4905 -- ;
        var_pass_4894.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 153)) ;
        GALGAS_symbolTableForRelativesResolution var_symbolTable_5156 ;
        {
        GALGAS_uint joker_5174 ; // Joker input parameter
        routine_computeLabelAbsoluteAddressMap_3F__3F__21__21_ (ioArgument_ioGeneratedBlockList, GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE), var_symbolTable_5156, joker_5174, inCompiler  COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 154)) ;
        }
        ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("\nPass ").add_operation (var_pass_4894.getter_string (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 160)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 160)).add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 160)), inCompiler  COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 160)) ;
        GALGAS_uint var_conversionCount_5248 = GALGAS_uint (uint32_t (0U)) ;
        {
        ...
        var_resolutionDone_4859 = GALGAS_bool (ComparisonKind::equal, var_conversionCount_5248.objectCompare (GALGAS_uint (uint32_t (0U)))) ;
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_application::class_func_verboseOutput (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 169)).boolEnum () ;
          if (kBoolTrue == test_1) {
            GALGAS_string var_s_5505 = GALGAS_string ("  Pass ").add_operation (var_pass_4894.getter_string (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 170)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 170)).add_operation (GALGAS_string (": "), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 170)) ;
            enumGalgasBool test_2 = kBoolTrue ;
            if (kBoolTrue == test_2) {
              test_2 = GALGAS_bool (ComparisonKind::equal, var_conversionCount_5248.objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
              if (kBoolTrue == test_2) {
                var_s_5505.plusAssign_operation(GALGAS_string ("none."), inCompiler  COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 172)) ;
              }
            }
            if (kBoolFalse == test_2) {
              enumGalgasBool test_3 = kBoolTrue ;
              if (kBoolTrue == test_3) {
                test_3 = GALGAS_bool (ComparisonKind::equal, var_conversionCount_5248.objectCompare (GALGAS_uint (uint32_t (1U)))).boolEnum () ;
                if (kBoolTrue == test_3) {
                  var_s_5505.plusAssign_operation(GALGAS_string ("1 conversion"), inCompiler  COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 174)) ;
                }
              }
              if (kBoolFalse == test_3) {
                var_s_5505.plusAssign_operation(var_conversionCount_5248.getter_string (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 176)).add_operation (GALGAS_string (" conversions"), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 176)), inCompiler  COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 176)) ;
              }
            }
            {
            routine_print_3F_ (var_s_5505.add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 178)), inCompiler  COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 178)) ;
            }
          }
        }
      }
...
void routine_ipic_31__38_RelativeBranchOverflow_3F__3F__21_ (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  GALGAS_symbolTableForRelativesResolution var_symbolTable_7201 ;
  {
  GALGAS_uint joker_7217 ; // Joker input parameter
  ...
  outArgument_outOverflowMap = GALGAS_branchOverflowMap::init (inCompiler COMMA_HERE) ;
  GALGAS_uint var_blockStartAddress_7282 = GALGAS_uint (uint32_t (0U)) ;
  ...
  while (enumerator_7311.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel_7366 ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::lowerThan, index_7306.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 237)).objectCompare (constinArgument_inBlockList.getter_count (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 237)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_nextBlockLabel_7366 = constinArgument_inBlockList.getter_mBlockAtIndex (index_7306.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 238)), inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 238)).readProperty_mLabel ().readProperty_string () ;
      }
    }
    if (kBoolFalse == test_0) {
      var_nextBlockLabel_7366 = GALGAS_string::makeEmptyString () ;
    }
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::notEqual, enumerator_7311.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_relatives_resolution.galgas", 242)))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    GALGAS_uint var_blockSize_7805 = extensionGetter_blockSize (enumerator_7311.current_mBlock (HERE), var_nextBlockLabel_7366, inCompiler COMMA_SOURCE_FILE ("ipic18_relatives_resolution.galgas", 251)) ;
...
void routine_ipic_31__38_GenerateCode_3F__3F__3F__3F__3F__3F__3F__3F__3F__26__3F__21__21_ (const GALGAS_string constinArgument_inSourceFileName,
  ...
  GALGAS_symbolTableForRelativesResolution var_symbolTable_7638 ;
  GALGAS_uint var_firstDataAddress_7665 ;
  {
  routine_computeLabelAbsoluteAddressMap_3F__3F__21__21_ (constinArgument_inGeneratedBlockList, GALGAS_ipic_31__38_BlockList::init (inCompiler COMMA_HERE), var_symbolTable_7638, var_firstDataAddress_7665, inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 226)) ;
  }
  GALGAS_uint var_dataAddress_7756 = var_firstDataAddress_7665 ;
  GALGAS_pic_31__38__5F_dataAddressMap var_dataAddressMap_7815 = GALGAS_pic_31__38__5F_dataAddressMap::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_7853.hasCurrentObject ()) {
    ...
    var_dataAddress_7756 = var_dataAddress_7756.add_operation (enumerator_7853.current_mData (HERE).getter_count (SOURCE_FILE ("ipic18_code_generation.galgas", 237)).multiply_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 237)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 237)) ;
    enumerator_7853.gotoNextObject () ;
  }
  {
  routine_initCodeGenerator (inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 240)) ;
  }
  GALGAS_string var_assemblyString_8062 = GALGAS_string::makeEmptyString () ;
  GALGAS_bigint var_relocatableCodeSize_8088 = GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 242)) ;
  GALGAS_bigint var_blockStartAddress_8118 = GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 243)) ;
  outArgument_outGeneratedCodeMap = GALGAS_generatedCodeMap::init (inCompiler COMMA_HERE) ;
  cEnumerator_ipic_31__38_BlockList enumerator_8174 (constinArgument_inGeneratedBlockList, EnumerationOrder::up) ;
  GALGAS_uint index_8169 (uint32_t (0)) ;
  while (enumerator_8174.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel_8238 ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (ComparisonKind::lowerThan, index_8169.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 247)).objectCompare (constinArgument_inGeneratedBlockList.getter_count (SOURCE_FILE ("ipic18_code_generation.galgas", 247)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel_8238 = constinArgument_inGeneratedBlockList.getter_mBlockAtIndex (index_8169.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 248)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 248)).readProperty_mLabel ().readProperty_string () ;
      }
    }
    if (kBoolFalse == test_1) {
      var_nextBlockLabel_8238 = GALGAS_string::makeEmptyString () ;
    }
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (ComparisonKind::notEqual, enumerator_8174.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_code_generation.galgas", 252)))).boolEnum () ;
      if (kBoolTrue == test_2) {
    ...
    GALGAS_uint var_blockSize_8806 = extensionGetter_blockSize (enumerator_8174.current_mBlock (HERE), var_nextBlockLabel_8238, inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 265)) ;
    ...
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = GALGAS_bool (ComparisonKind::equal, enumerator_8174.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_code_generation.galgas", 267)))).boolEnum () ;
      if (kBoolTrue == test_3) {
  ...
  if (enumerator_9090.hasCurrentObject () && bool_4) {
    ...
    {
    GALGAS_codeList temp_5 = GALGAS_codeList::init (inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 278)) ;
    temp_5.enterElement (GALGAS_codeList_2D_element::init_21__21_ (GALGAS_string ("    ORG ").add_operation (var_dataAddress_7756.getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 278)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 278)), GALGAS_uintlist::init (inCompiler COMMA_HERE), inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 278)) ;
    GALGAS_stringlist temp_6 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 279)) ;
    temp_6.enterElement (GALGAS_stringlist_2D_element::init_21_ (GALGAS_string ("    ORG ").add_operation (var_dataAddress_7756.getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 279)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 279)), inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 279)) ;
    routine_generateLineWithCode_3F__3F__3F__3F__3F__26_ (var_dataAddress_7756, temp_5, temp_6, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_code_generation.galgas", 280)), GALGAS_uint (uint32_t (0U)), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 276)) ;
    }
    var_assemblyString_8062.plusAssign_operation(GALGAS_string ("    ORG ").add_operation (var_dataAddress_7756.getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 284)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 284)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 284)), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 284)) ;
    while (enumerator_9090.hasCurrentObject () && bool_4) {
      {
      GALGAS_codeList temp_7 = GALGAS_codeList::init (inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 288)) ;
      temp_7.enterElement (GALGAS_codeList_2D_element::init_21__21_ (GALGAS_string ("_data_").add_operation (enumerator_9090.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 288)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 288)), GALGAS_uintlist::init (inCompiler COMMA_HERE), inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 288)) ;
      GALGAS_stringlist temp_8 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 289)) ;
      temp_8.enterElement (GALGAS_stringlist_2D_element::init_21_ (GALGAS_string ("_data_").add_operation (enumerator_9090.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 289)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 289)), inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 289)) ;
      routine_generateLineWithCode_3F__3F__3F__3F__3F__26_ (var_dataAddress_7756, temp_7, temp_8, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_code_generation.galgas", 290)), GALGAS_uint (uint32_t (0U)), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 286)) ;
      }
      var_assemblyString_8062.plusAssign_operation(GALGAS_string ("_data_").add_operation (enumerator_9090.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 294)).add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 294)), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 294)) ;
      ...
      while (enumerator_9697.hasCurrentObject ()) {
        var_assemblyString_8062.plusAssign_operation(GALGAS_string ("    DW ").add_operation (enumerator_9697.current_mValue (HERE).getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 296)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 296)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 296)), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 296)) ;
        {
        routine_emitCode_3F_ (enumerator_9697.current_mValue (HERE), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 297)) ;
        }
        {
        GALGAS_codeList temp_9 = GALGAS_codeList::init (inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 300)) ;
        GALGAS_uintlist temp_10 = GALGAS_uintlist::init (inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 300)) ;
        temp_10.enterElement (GALGAS_uintlist_2D_element::init_21_ (enumerator_9697.current_mValue (HERE), inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 300)) ;
        temp_9.enterElement (GALGAS_codeList_2D_element::init_21__21_ (GALGAS_string ("    DW ").add_operation (enumerator_9697.current_mValue (HERE).getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 300)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 300)), temp_10, inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 300)) ;
        GALGAS_stringlist temp_11 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 301)) ;
        temp_11.enterElement (GALGAS_stringlist_2D_element::init_21_ (GALGAS_string ("    DW ").add_operation (enumerator_9697.current_mValue (HERE).getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 301)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 301)), inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 301)) ;
        routine_generateLineWithCode_3F__3F__3F__3F__3F__26_ (var_dataAddress_7756, temp_9, temp_11, GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_code_generation.galgas", 302)), GALGAS_uint (uint32_t (0U)), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 298)) ;
        }
        var_dataAddress_7756 = var_dataAddress_7756.add_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 306)) ;
  ...
  if (kBoolTrue == test_12) {
    ...
    if (kBoolTrue == test_12) {
      {
      routine_print_3F_ (GALGAS_string ("  Relocatable code size: ").add_operation (var_relocatableCodeSize_8088.getter_string (SOURCE_FILE ("ipic18_code_generation.galgas", 311)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 311)).add_operation (GALGAS_string (" bytes.\n\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 311)), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 311)) ;
      }
    }
  }
  ...
  GALGAS_string var_contents_11071 ;
  {
  routine_getGeneratedContents_21_ (var_contents_11071, inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 332)) ;
  }
  GALGAS_string var_destinationFile_11087 = constinArgument_inSourceFileName.getter_stringByDeletingPathExtension (SOURCE_FILE ("ipic18_code_generation.galgas", 333)).add_operation (GALGAS_string (".hex"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 333)) ;
  ...
  if (kBoolTrue == test_17) {
    ...
    if (kBoolTrue == test_17) {
      GALGAS_string var_baseName_11328 = constinArgument_inSourceFileName.getter_lastPathComponent (SOURCE_FILE ("ipic18_code_generation.galgas", 337)).getter_stringByDeletingPathExtension (SOURCE_FILE ("ipic18_code_generation.galgas", 337)) ;
      GALGAS_string var_cContents_11462 ;
      {
      ...
      var_destinationFile_11087 = constinArgument_inSourceFileName.getter_stringByDeletingPathExtension (SOURCE_FILE ("ipic18_code_generation.galgas", 339)).add_operation (GALGAS_string (".c"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 339)) ;
      GALGAS_bool joker_11616 ; // Joker input parameter
      ...
      GALGAS_string var_hContents_11666 ;
      {
      ...
      var_destinationFile_11087 = constinArgument_inSourceFileName.getter_stringByDeletingPathExtension (SOURCE_FILE ("ipic18_code_generation.galgas", 342)).add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 342)) ;
      GALGAS_bool joker_11820 ; // Joker input parameter
...
void routine_pic_31__38_GenerateAssemblyFile_3F__3F__3F__3F__3F__3F_ (const GALGAS_string constinArgument_inSourceFileName,
                                                                      ...
                                                                      Compiler * inCompiler
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_assemblyString_12843 = GALGAS_string ("  PROCESSOR ").add_operation (constinArgument_inProcessorName, inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 371)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 371)) ;
  var_assemblyString_12843.plusAssign_operation(GALGAS_string (";--- Code\n"), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 373)) ;
  ...
  var_assemblyString_12843.plusAssign_operation(GALGAS_string (";--- Prefefined registers\n"), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 376)) ;
  ...
  while (enumerator_13092.hasCurrentObject ()) {
    GALGAS_uint var_firstRegister_13167 ;
  ...
  while (enumerator_13429.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_0) {
        GALGAS_uint var_firstRegister_13559 ;
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      var_assemblyString_12843.plusAssign_operation(GALGAS_string (";--- Configuration\n\n"), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 398)) ;
      ...
      while (enumerator_14062.hasCurrentObject ()) {
        var_assemblyString_12843.plusAssign_operation(GALGAS_string ("  __config ").add_operation (enumerator_14062.current_mRegisterAddress (HERE).getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 400)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 400)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 400)).add_operation (enumerator_14062.current_mRegisterValue (HERE).operator_and (GALGAS_uint (uint32_t (255U)) COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 400)).getter_hexString (SOURCE_FILE ("ipic18_code_generation.galgas", 400)), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 400)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 400)), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 400)) ;
        enumerator_14062.gotoNextObject () ;
      }
    }
  }
  var_assemblyString_12843.plusAssign_operation(GALGAS_string (";---\n\n"), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 404)) ;
  var_assemblyString_12843.plusAssign_operation(GALGAS_string ("  END\n\n"), inCompiler  COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 405)) ;
  GALGAS_string var_asmDestinationFile_14405 = constinArgument_inSourceFileName.getter_stringByDeletingPathExtension (SOURCE_FILE ("ipic18_code_generation.galgas", 407)).add_operation (GALGAS_string (".asm"), inCompiler COMMA_SOURCE_FILE ("ipic18_code_generation.galgas", 407)) ;
  GALGAS_bool joker_14554 ; // Joker input parameter
...
void routine_ipic_31__38_StackComputations_26__3F_ (GALGAS_string & ioArgument_ioListFileContents,
  ...
  GALGAS_stringset var_startLabelsToExplore_6779 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
  GALGAS_blockMapForStackComputation var_blockMapForStackComputation_6821 = GALGAS_blockMapForStackComputation::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_6889.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::notEqual, enumerator_6889.current_mBlock (HERE).readProperty_mAddress ().objectCompare (GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_stack_computations.galgas", 204)))).boolEnum () ;
      if (kBoolTrue == test_0) {
  ...
  GALGAS_routineCallMap var_routineCallMap_7186 = GALGAS_routineCallMap::init (inCompiler COMMA_HERE) ;
  if (constinArgument_inBlockList.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 211)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 211)).isValid ()) {
    uint32_t variant_7208 = constinArgument_inBlockList.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 211)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 211)).uintValue () ;
    bool loop_7208 = true ;
    while (loop_7208) {
      loop_7208 = GALGAS_bool (ComparisonKind::greaterThan, var_startLabelsToExplore_6779.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 212)).objectCompare (GALGAS_uint (uint32_t (0U)))).isValid () ;
      if (loop_7208) {
        loop_7208 = GALGAS_bool (ComparisonKind::greaterThan, var_startLabelsToExplore_6779.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 212)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolValue () ;
      }
      ...
      if (loop_7208) {
        variant_7208 -- ;
        GALGAS_string var_startLabel_7293 = var_startLabelsToExplore_6779.getter_anyString (inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 214)) ;
        {
        ...
        GALGAS_stringset var_blockToExploreSet_7431 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
        ...
        GALGAS_stringset var_exploredBlockSet_7520 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
        GALGAS_stringset var_calledRoutineSet_7561 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
        GALGAS_uint var_terminatorStackNeeds_7597 = GALGAS_uint (uint32_t (0U)) ;
        if (constinArgument_inBlockList.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 222)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 222)).isValid ()) {
          uint32_t variant_7626 = constinArgument_inBlockList.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 222)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 222)).uintValue () ;
          bool loop_7626 = true ;
          while (loop_7626) {
            loop_7626 = GALGAS_bool (ComparisonKind::greaterThan, var_blockToExploreSet_7431.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 223)).objectCompare (GALGAS_uint (uint32_t (0U)))).isValid () ;
            if (loop_7626) {
              loop_7626 = GALGAS_bool (ComparisonKind::greaterThan, var_blockToExploreSet_7431.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 223)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolValue () ;
            }
            ...
            if (loop_7626) {
              variant_7626 -- ;
              GALGAS_string var_b_7722 = var_blockToExploreSet_7431.getter_anyString (inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 225)) ;
              {
              ...
              GALGAS_ipic_31__38_Block var_aBlock_7902 ;
              ...
              enumGalgasBool test_1 = kBoolTrue ;
              if (kBoolTrue == test_1) {
                test_1 = GALGAS_bool (ComparisonKind::greaterThan, var_tsn_8048.objectCompare (var_terminatorStackNeeds_7597)).boolEnum () ;
                if (kBoolTrue == test_1) {
  ...
  GALGAS_routineStackRequirementMap var_routineStackRequirementMap_8654 = GALGAS_routineStackRequirementMap::init (inCompiler COMMA_HERE) ;
  GALGAS_bool var_progress_8692 = GALGAS_bool (true) ;
  if (var_routineCallMap_7186.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 252)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 252)).isValid ()) {
    uint32_t variant_8710 = var_routineCallMap_7186.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 252)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 252)).uintValue () ;
    bool loop_8710 = true ;
    while (loop_8710) {
      ...
      if (loop_8710) {
        variant_8710 -- ;
        var_progress_8692 = GALGAS_bool (false) ;
        GALGAS_routineCallMap var_tempRoutineCallMap_8811 = var_routineCallMap_7186 ;
        var_routineCallMap_7186 = GALGAS_routineCallMap::init (inCompiler COMMA_HERE) ;
        ...
        while (enumerator_8903.hasCurrentObject ()) {
          GALGAS_uint var_levels_8968 = enumerator_8903.current_mTerminatorStackNeeds (HERE) ;
          GALGAS_bool var_solved_9015 = GALGAS_bool (true) ;
            ...
            while (enumerator_9040.hasCurrentObject () && bool_3) {
              ...
              if (kBoolTrue == test_4) {
                ...
                if (kBoolTrue == test_4) {
                  ...
                  enumGalgasBool test_5 = kBoolTrue ;
                  if (kBoolTrue == test_5) {
                    test_5 = GALGAS_bool (ComparisonKind::lowerOrEqual, var_levels_8968.objectCompare (var_rLevel_9237)).boolEnum () ;
                    if (kBoolTrue == test_5) {
                      var_levels_8968 = var_rLevel_9237.add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 266)) ;
                    }
                  }
                }
              }
          ...
          if (kBoolTrue == test_6) {
            ...
            if (kBoolTrue == test_6) {
              ...
              var_progress_8692 = GALGAS_bool (true) ;
            }
          }
          if (kBoolFalse == test_6) {
            {
  ...
  while (enumerator_9631.hasCurrentObject ()) {
    ioArgument_ioListFileContents.plusAssign_operation(enumerator_9631.current_mLevels (HERE).getter_string (SOURCE_FILE ("ipic18_stack_computations.galgas", 280)).getter_stringByLeftPadding (GALGAS_uint (uint32_t (6U)), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 280)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 280)).add_operation (enumerator_9631.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 280)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 280)), inCompiler  COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 280)) ;
    enumerator_9631.gotoNextObject () ;
  }
  ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 282)) ;
  GALGAS_bool var_noRecursiveRoutine_9837 = GALGAS_bool (ComparisonKind::equal, var_routineCallMap_7186.getter_count (SOURCE_FILE ("ipic18_stack_computations.galgas", 284)).objectCompare (GALGAS_uint (uint32_t (0U)))) ;
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    ...
    if (kBoolTrue == test_7) {
      ...
      while (enumerator_10142.hasCurrentObject ()) {
        ioArgument_ioListFileContents.plusAssign_operation(GALGAS_string ("  - ").add_operation (enumerator_10142.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 291)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 291)), inCompiler  COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 291)) ;
  ...
  if (kBoolTrue == test_10) {
    ...
    if (kBoolTrue == test_10) {
      GALGAS_uint var_mainLevels_10395 ;
      var_routineStackRequirementMap_8654.method_searchKey (GALGAS_string (".START").getter_nowhere (SOURCE_FILE ("ipic18_stack_computations.galgas", 297)), var_mainLevels_10395, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 297)) ;
      GALGAS_uint var_totalLevels_10421 = var_mainLevels_10395 ;
      enumGalgasBool test_11 = kBoolTrue ;
      if (kBoolTrue == test_11) {
        test_11 = var_routineStackRequirementMap_8654.getter_hasKey (GALGAS_string (".HIGH_INTERRUPT") COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 299)).boolEnum () ;
        if (kBoolTrue == test_11) {
          GALGAS_uint var_highIntLevels_10597 ;
          var_routineStackRequirementMap_8654.method_searchKey (GALGAS_string (".HIGH_INTERRUPT").getter_nowhere (SOURCE_FILE ("ipic18_stack_computations.galgas", 300)), var_highIntLevels_10597, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 300)) ;
          var_totalLevels_10421 = var_totalLevels_10421.add_operation (var_highIntLevels_10597, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 301)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 301)) ;
        }
      }
      enumGalgasBool test_12 = kBoolTrue ;
      if (kBoolTrue == test_12) {
        test_12 = var_routineStackRequirementMap_8654.getter_hasKey (GALGAS_string (".LOW_INTERRUPT") COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 303)).boolEnum () ;
        if (kBoolTrue == test_12) {
          GALGAS_uint var_lowIntLevels_10821 ;
          var_routineStackRequirementMap_8654.method_searchKey (GALGAS_string (".LOW_INTERRUPT").getter_nowhere (SOURCE_FILE ("ipic18_stack_computations.galgas", 304)), var_lowIntLevels_10821, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 304)) ;
          var_totalLevels_10421 = var_totalLevels_10421.add_operation (var_lowIntLevels_10821, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 305)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 305)) ;
        }
      }
      {
      routine_print_3F_ (GALGAS_string ("Max stack depth: ").add_operation (var_totalLevels_10421.getter_string (SOURCE_FILE ("ipic18_stack_computations.galgas", 307)), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 307)).add_operation (GALGAS_string ("\n\n"), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 307)), inCompiler  COMMA_SOURCE_FILE ("ipic18_stack_computations.galgas", 307)) ;
      }
      enumGalgasBool test_13 = kBoolTrue ;
      if (kBoolTrue == test_13) {
        test_13 = GALGAS_bool (ComparisonKind::greaterThan, var_totalLevels_10421.objectCompare (GALGAS_uint (uint32_t (31U)))).boolEnum () ;
        if (kBoolTrue == test_13) {
          TC_Array <FixItDescription> fixItArray14 ;
...
void cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::method_minMaxDuration (GALGAS_blockDurationMap inArgument_inExploredBlockMap,
                                                                                                   GALGAS_uint & outArgument_outMin,
                                                                                                   GALGAS_uint & outArgument_outMax,
                                                                                                   Compiler * inCompiler
                                                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outMin = GALGAS_uint::class_func_max (SOURCE_FILE ("ipic18_duration_computations.galgas", 523)) ;
  outArgument_outMax = GALGAS_uint (uint32_t (0U)) ;
  GALGAS_bool var_solved_20181 = GALGAS_bool (true) ;
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall temp_0 = this ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_20210 (temp_0.readProperty_mTargetInstructions (), EnumerationOrder::up) ;
  ...
  if (enumerator_20210.hasCurrentObject () && bool_1) {
    while (enumerator_20210.hasCurrentObject () && bool_1) {
      GALGAS_uint var_min_20308 ;
      GALGAS_uint var_max_20317 ;
      callExtensionMethod_minMaxDuration ((cPtr_ipic_31__38_SequentialInstruction *) enumerator_20210.current_mInstruction (HERE).ptr (), inArgument_inExploredBlockMap, var_min_20308, var_max_20317, inCompiler COMMA_SOURCE_FILE ("ipic18_duration_computations.galgas", 527)) ;
      var_solved_20181 = GALGAS_bool (ComparisonKind::lowerOrEqual, var_min_20308.objectCompare (var_max_20317)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_20386 (temp_3.readProperty_mTargetInstructions (), EnumerationOrder::up) ;
      GALGAS_uint index_20373 (uint32_t (0)) ;
      while (enumerator_20386.hasCurrentObject ()) {
        GALGAS_uint var_min_20481 ;
        GALGAS_uint var_max_20492 ;
        callExtensionMethod_minMaxDuration ((cPtr_ipic_31__38_SequentialInstruction *) enumerator_20386.current_mInstruction (HERE).ptr (), inArgument_inExploredBlockMap, var_min_20481, var_max_20492, inCompiler COMMA_SOURCE_FILE ("ipic18_duration_computations.galgas", 532)) ;
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall temp_5 = this ;
          test_4 = GALGAS_bool (ComparisonKind::lowerThan, index_20373.objectCompare (temp_5.readProperty_mTargetInstructions ().getter_count (SOURCE_FILE ("ipic18_duration_computations.galgas", 534)).substract_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("ipic18_duration_computations.galgas", 534)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            var_min_20481 = var_min_20481.add_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_duration_computations.galgas", 535)) ;
            var_max_20492 = var_max_20492.add_operation (GALGAS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("ipic18_duration_computations.galgas", 536)) ;
          }
        }
        enumGalgasBool test_6 = kBoolTrue ;
        if (kBoolTrue == test_6) {
          test_6 = GALGAS_bool (ComparisonKind::lowerThan, var_min_20481.objectCompare (outArgument_outMin)).boolEnum () ;
          if (kBoolTrue == test_6) {
        ...
        enumGalgasBool test_7 = kBoolTrue ;
        if (kBoolTrue == test_7) {
          test_7 = GALGAS_bool (ComparisonKind::greaterThan, var_max_20492.objectCompare (outArgument_outMax)).boolEnum () ;
          if (kBoolTrue == test_7) {
