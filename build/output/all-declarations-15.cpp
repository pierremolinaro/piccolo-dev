    ...
    if (GalgasBool::boolTrue == test_0) {
      ...
      if (GalgasBool::boolTrue == test_0) {
        ...
        while (enumerator_656.hasCurrentObject ()) {
          ...
          {
          routine_parseDeviceDefinition_3F__21_ (GGS_lstring::init_21__21_ (var_name_700, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 18)), inCompiler COMMA_HERE), var_piccoloDeviceModel_857, inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 18)) ;
          }
          switch (var_piccoloDeviceModel_857.readProperty_mProcessorType ().enumValue ()) {
        ...
        if (GalgasBool::boolTrue == test_1) {
          ...
          if (GalgasBool::boolTrue == test_1) {
            ...
            while (enumerator_1785.hasCurrentObject ()) {
              ...
              var_idx_1766.plusAssignOperation(GGS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 40)) ;
        ...
        if (GalgasBool::boolTrue == test_4) {
          ...
          if (GalgasBool::boolTrue == test_4) {
            ...
            while (enumerator_2394.hasCurrentObject ()) {
              ...
              var_idx_2375.plusAssignOperation(GGS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 56)) ;
        ...
        if (GalgasBool::boolTrue == test_7) {
          ...
          if (GalgasBool::boolTrue == test_7) {
            ...
            while (enumerator_2989.hasCurrentObject ()) {
              ...
              var_idx_2970.plusAssignOperation(GGS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 72)) ;
          ...
          if (GalgasBool::boolTrue == test_13) {
            ...
            while (enumerator_4920.hasCurrentObject ()) {
              ...
              if (enumerator_5204.hasCurrentObject () && bool_14) {
                ...
                while (enumerator_5204.hasCurrentObject () && bool_14) {
                  {
                  routine_print_3F_ (enumerator_4920.current_mFirstFreeAddress (HERE).add_operation (enumerator_5204.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 116)).getter_hexString (SOURCE_FILE ("piccolo_program.galgas", 116)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 116)) ;
                  }
            ...
            switch (var_piccoloDeviceModel_4450.readProperty_mProcessorType ().enumValue ()) {
            case GGS_processorType::Enumeration::invalid:
              break ;
            case GGS_processorType::Enumeration::enum_pic_31__38__5F__36__30_:
            case GGS_processorType::Enumeration::enum_pic_31__38__5F__38__30_:
              {
                {
                routine_print_3F_ (GGS_string ("  ROM size: ").add_operation (var_piccoloDeviceModel_4450.readProperty_mRomSize ().readProperty_uint ().getter_string (SOURCE_FILE ("piccolo_program.galgas", 123)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 123)).add_operation (GGS_string (" bytes\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 123)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 123)) ;
                }
              }
              break ;
            case GGS_processorType::Enumeration::enum_midrange:
            ...
            case GGS_processorType::Enumeration::enum_baseline:
              {
                {
                routine_print_3F_ (GGS_string ("  ROM size: ").add_operation (var_piccoloDeviceModel_4450.readProperty_mRomSize ().readProperty_uint ().getter_string (SOURCE_FILE ("piccolo_program.galgas", 133)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 133)).add_operation (GGS_string (" instructions\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 133)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 133)) ;
                }
              }
              break ;
            }
          ...
          if (GalgasBool::boolTrue == test_19) {
            ...
            while (enumerator_7114.hasCurrentObject ()) {
              ...
              while (enumerator_7221.hasCurrentObject ()) {
                var_s_7152.plusAssignOperation(enumerator_7221.current (HERE).readProperty_mValue ().getter_hexString (SOURCE_FILE ("piccolo_program.galgas", 155)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 155)) ;
                enumerator_7221.gotoNextObject () ;
                if (enumerator_7221.hasCurrentObject ()) {
                  var_s_7152.plusAssignOperation(GGS_string (", "), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 156)) ;
                }
              }
              var_s_7152.plusAssignOperation(enumerator_7114.current (HERE).readProperty_mBitDefinitionString ().add_operation (GGS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 158)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 158)) ;
              {
              routine_print_3F_ (var_s_7152, inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 159)) ;
              }
