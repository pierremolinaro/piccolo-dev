                            ...
                            COMMA_UNUSED_LOCATION_ARGS) {
  {
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_0) {
        ...
        GALGAS_stringlist var_pic_31__38__5F_devices_517 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
        GALGAS_stringlist var_midrange_5F_devices_555 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
        GALGAS_stringlist var_baseline_5F_devices_596 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
        cEnumerator_stringlist enumerator_656 (var_allDevices_446, EnumerationOrder::up) ;
        while (enumerator_656.hasCurrentObject ()) {
          GALGAS_string var_name_700 = enumerator_656.current_mValue (HERE).getter_lastPathComponent (SOURCE_FILE ("piccolo_program.galgas", 17)).getter_stringByDeletingPathExtension (SOURCE_FILE ("piccolo_program.galgas", 17)) ;
          GALGAS_piccoloDeviceModel var_piccoloDeviceModel_862 ;
          {
          routine_parseDeviceDefinition_3F__21_ (GALGAS_lstring::init_21__21_ (var_name_700, GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 18)), inCompiler COMMA_HERE), var_piccoloDeviceModel_862, inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 18)) ;
          }
        ...
        if (kBoolTrue == test_1) {
          ...
          if (kBoolTrue == test_1) {
            ...
            GALGAS_uint var_idx_1771 = GALGAS_uint (uint32_t (0U)) ;
            ...
            while (enumerator_1790.hasCurrentObject ()) {
              {
              routine_print_3F_ (enumerator_1790.current_mValue (HERE).getter_stringByRightPadding (GALGAS_uint (uint32_t (15U)), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("piccolo_program.galgas", 39)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 39)) ;
              }
              var_idx_1771.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 40)) ;
              enumGalgasBool test_2 = kBoolTrue ;
              if (kBoolTrue == test_2) {
                test_2 = GALGAS_bool (ComparisonKind::equal, var_idx_1771.objectCompare (GALGAS_uint (uint32_t (5U)))).boolEnum () ;
                if (kBoolTrue == test_2) {
                  var_idx_1771 = GALGAS_uint (uint32_t (0U)) ;
                  {
            ...
            if (kBoolTrue == test_3) {
              test_3 = GALGAS_bool (ComparisonKind::notEqual, var_idx_1771.objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
              if (kBoolTrue == test_3) {
                {
        ...
        if (kBoolTrue == test_4) {
          ...
          if (kBoolTrue == test_4) {
            ...
            GALGAS_uint var_idx_2380 = GALGAS_uint (uint32_t (0U)) ;
            ...
            while (enumerator_2399.hasCurrentObject ()) {
              {
              routine_print_3F_ (enumerator_2399.current_mValue (HERE).getter_stringByRightPadding (GALGAS_uint (uint32_t (15U)), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("piccolo_program.galgas", 55)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 55)) ;
              }
              var_idx_2380.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 56)) ;
              enumGalgasBool test_5 = kBoolTrue ;
              if (kBoolTrue == test_5) {
                test_5 = GALGAS_bool (ComparisonKind::equal, var_idx_2380.objectCompare (GALGAS_uint (uint32_t (5U)))).boolEnum () ;
                if (kBoolTrue == test_5) {
                  var_idx_2380 = GALGAS_uint (uint32_t (0U)) ;
                  {
            ...
            if (kBoolTrue == test_6) {
              test_6 = GALGAS_bool (ComparisonKind::notEqual, var_idx_2380.objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
              if (kBoolTrue == test_6) {
                {
        ...
        if (kBoolTrue == test_7) {
          ...
          if (kBoolTrue == test_7) {
            ...
            GALGAS_uint var_idx_2975 = GALGAS_uint (uint32_t (0U)) ;
            ...
            while (enumerator_2994.hasCurrentObject ()) {
              {
              routine_print_3F_ (enumerator_2994.current_mValue (HERE).getter_stringByRightPadding (GALGAS_uint (uint32_t (15U)), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("piccolo_program.galgas", 71)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 71)) ;
              }
              var_idx_2975.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 72)) ;
              enumGalgasBool test_8 = kBoolTrue ;
              if (kBoolTrue == test_8) {
                test_8 = GALGAS_bool (ComparisonKind::equal, var_idx_2975.objectCompare (GALGAS_uint (uint32_t (5U)))).boolEnum () ;
                if (kBoolTrue == test_8) {
                  var_idx_2975 = GALGAS_uint (uint32_t (0U)) ;
                  {
            ...
            if (kBoolTrue == test_9) {
              test_9 = GALGAS_bool (ComparisonKind::notEqual, var_idx_2975.objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
              if (kBoolTrue == test_9) {
                {
    ...
    if (kBoolTrue == test_10) {
      ...
      if (kBoolTrue == test_10) {
        GALGAS_string var_dir_3442 = GALGAS_string (gOption_piccolo_5F_options_5F_not_5F_in_5F_cocoa_exportDeviceFiles.readProperty_value ()) ;
        ...
        GALGAS_filewrapper var_fw_3603 = GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices) ;
        GALGAS_stringlist var_allDevices_3658 = GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).getter_allTextFilePathes (SOURCE_FILE ("piccolo_program.galgas", 91)) ;
        cEnumerator_stringlist enumerator_3730 (var_allDevices_3658, EnumerationOrder::up) ;
        while (enumerator_3730.hasCurrentObject ()) {
          GALGAS_string var_definitionString_3774 = var_fw_3603.getter_textFileContentsAtPath (enumerator_3730.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 93)) ;
    ...
    GALGAS_string var_deviceForMemoryDescription_4070 = GALGAS_string (gOption_piccolo_5F_options_5F_not_5F_in_5F_cocoa_memoryDescription.readProperty_value ()) ;
    enumGalgasBool test_12 = kBoolTrue ;
    if (kBoolTrue == test_12) {
      test_12 = GALGAS_bool (ComparisonKind::greaterThan, var_deviceForMemoryDescription_4070.getter_count (SOURCE_FILE ("piccolo_program.galgas", 100)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
      if (kBoolTrue == test_12) {
        GALGAS_string var_devicePath_4226 = GALGAS_string ("/").add_operation (var_deviceForMemoryDescription_4070, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 101)).add_operation (GALGAS_string (".piccoloDevice"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 101)) ;
        enumGalgasBool test_13 = kBoolTrue ;
        if (kBoolTrue == test_13) {
          test_13 = GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).getter_fileExistsAtPath (var_devicePath_4226, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 102)).boolEnum () ;
          if (kBoolTrue == test_13) {
            GALGAS_piccoloDeviceModel var_piccoloDeviceModel_4460 ;
            {
            routine_parseDeviceDefinition_3F__21_ (GALGAS_lstring::init_21__21_ (var_deviceForMemoryDescription_4070, GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 103)), inCompiler COMMA_HERE), var_piccoloDeviceModel_4460, inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 103)) ;
            }
            GALGAS_uint var_totalRam_4496 = GALGAS_uint (uint32_t (0U)) ;
            ...
            case GALGAS_processorType::Enumeration::enum_pic_31__38__5F__38__30_:
              {
                {
                routine_print_3F_ (GALGAS_string ("  ROM size: ").add_operation (var_piccoloDeviceModel_4460.readProperty_mRomSize ().readProperty_uint ().getter_string (SOURCE_FILE ("piccolo_program.galgas", 123)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 123)).add_operation (GALGAS_string (" bytes\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 123)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 123)) ;
                }
              }
              break ;
            case GALGAS_processorType::Enumeration::enum_midrange:
              {
                GALGAS_uint var_pageCount_5626 = var_piccoloDeviceModel_4460.readProperty_mRomSize ().readProperty_uint ().add_operation (GALGAS_uint (uint32_t (2047U)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 125)).divide_operation (GALGAS_uint (uint32_t (2048U)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 125)) ;
                GALGAS_string var_s_5707 = GALGAS_string::makeEmptyString () ;
                enumGalgasBool test_15 = kBoolTrue ;
                if (kBoolTrue == test_15) {
                  test_15 = GALGAS_bool (ComparisonKind::greaterThan, var_pageCount_5626.objectCompare (GALGAS_uint (uint32_t (1U)))).boolEnum () ;
                  if (kBoolTrue == test_15) {
                    var_s_5707 = GALGAS_string ("s") ;
                  }
                }
                {
                routine_print_3F_ (GALGAS_string ("  ROM size: ").add_operation (var_piccoloDeviceModel_4460.readProperty_mRomSize ().readProperty_uint ().getter_string (SOURCE_FILE ("piccolo_program.galgas", 130)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 130)).add_operation (GALGAS_string (" instructions ("), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 130)).add_operation (var_pageCount_5626.getter_string (SOURCE_FILE ("piccolo_program.galgas", 131)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 130)).add_operation (GALGAS_string (" page"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 131)).add_operation (var_s_5707, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 131)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 131)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 130)) ;
                }
              }
              break ;
            case GALGAS_processorType::Enumeration::enum_baseline:
              {
                {
                routine_print_3F_ (GALGAS_string ("  ROM size: ").add_operation (var_piccoloDeviceModel_4460.readProperty_mRomSize ().readProperty_uint ().getter_string (SOURCE_FILE ("piccolo_program.galgas", 133)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 133)).add_operation (GALGAS_string (" instructions\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 133)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 133)) ;
                }
              }
              break ;
            }
            ...
            if (kBoolTrue == test_16) {
              test_16 = GALGAS_bool (ComparisonKind::equal, var_piccoloDeviceModel_4460.readProperty_mEepromSize ().objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
              if (kBoolTrue == test_16) {
                {
        ...
        if (kBoolFalse == test_13) {
          ...
          inCompiler->emitSemanticError (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 142)), GALGAS_string ("The ").add_operation (var_deviceForMemoryDescription_4070, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 142)).add_operation (GALGAS_string (" device is not supported or does not exist"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 142)), fixItArray17  COMMA_SOURCE_FILE ("piccolo_program.galgas", 142)) ;
        }
      }
    }
    GALGAS_string var_deviceForRegistersDescription_6528 = GALGAS_string (gOption_piccolo_5F_options_5F_not_5F_in_5F_cocoa_registerDescription.readProperty_value ()) ;
    enumGalgasBool test_18 = kBoolTrue ;
    if (kBoolTrue == test_18) {
      test_18 = GALGAS_bool (ComparisonKind::greaterThan, var_deviceForRegistersDescription_6528.getter_count (SOURCE_FILE ("piccolo_program.galgas", 147)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_string var_devicePath_6692 = GALGAS_string ("/").add_operation (var_deviceForRegistersDescription_6528, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 148)).add_operation (GALGAS_string (".piccoloDevice"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 148)) ;
        enumGalgasBool test_19 = kBoolTrue ;
        if (kBoolTrue == test_19) {
          test_19 = GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).getter_fileExistsAtPath (var_devicePath_6692, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 149)).boolEnum () ;
          if (kBoolTrue == test_19) {
            GALGAS_piccoloDeviceModel var_piccoloDeviceModel_6933 ;
            {
            routine_parseDeviceDefinition_3F__21_ (GALGAS_lstring::init_21__21_ (var_deviceForRegistersDescription_6528, GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 150)), inCompiler COMMA_HERE), var_piccoloDeviceModel_6933, inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 150)) ;
            }
            {
            routine_print_3F_ (var_deviceForRegistersDescription_6528.add_operation (GALGAS_string (" has "), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 151)).add_operation (var_piccoloDeviceModel_6933.readProperty_mRegisterTable ().getter_count (SOURCE_FILE ("piccolo_program.galgas", 151)).getter_string (SOURCE_FILE ("piccolo_program.galgas", 151)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 151)).add_operation (GALGAS_string (" special registers:\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 151)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 151)) ;
            }
            ...
            while (enumerator_7129.hasCurrentObject ()) {
              GALGAS_string var_s_7167 = GALGAS_string ("  '").add_operation (enumerator_7129.current (HERE).readProperty_lkey ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 153)).add_operation (GALGAS_string ("' at "), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 153)) ;
              ...
              while (enumerator_7236.hasCurrentObject ()) {
                ...
                if (enumerator_7236.hasNextObject ()) {
                  var_s_7167.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 156)) ;
                }
                enumerator_7236.gotoNextObject () ;
              }
              var_s_7167.plusAssign_operation(enumerator_7129.current (HERE).readProperty_mBitDefinitionString ().add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 158)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 158)) ;
              {
        ...
        if (kBoolFalse == test_19) {
          ...
          inCompiler->emitSemanticError (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 162)), GALGAS_string ("The ").add_operation (var_deviceForRegistersDescription_6528, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 162)).add_operation (GALGAS_string (" device is not supported or does not exist"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 162)), fixItArray20  COMMA_SOURCE_FILE ("piccolo_program.galgas", 162)) ;
        }
      }
    }
    GALGAS_string var_deviceForConfigDescription_7640 = GALGAS_string (gOption_piccolo_5F_options_5F_not_5F_in_5F_cocoa_configDescription.readProperty_value ()) ;
    enumGalgasBool test_21 = kBoolTrue ;
    if (kBoolTrue == test_21) {
      test_21 = GALGAS_bool (ComparisonKind::greaterThan, var_deviceForConfigDescription_7640.getter_count (SOURCE_FILE ("piccolo_program.galgas", 167)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
      if (kBoolTrue == test_21) {
        GALGAS_string var_devicePath_7796 = GALGAS_string ("/").add_operation (var_deviceForConfigDescription_7640, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 168)).add_operation (GALGAS_string (".piccoloDevice"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 168)) ;
        enumGalgasBool test_22 = kBoolTrue ;
        if (kBoolTrue == test_22) {
          test_22 = GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).getter_fileExistsAtPath (var_devicePath_7796, inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 169)).boolEnum () ;
          if (kBoolTrue == test_22) {
            GALGAS_piccoloDeviceModel var_piccoloDeviceModel_8031 ;
            {
            routine_parseDeviceDefinition_3F__21_ (GALGAS_lstring::init_21__21_ (var_deviceForConfigDescription_7640, GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 170)), inCompiler COMMA_HERE), var_piccoloDeviceModel_8031, inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 170)) ;
            }
            {
            routine_print_3F_ (var_deviceForConfigDescription_7640.add_operation (GALGAS_string (" has "), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 171)).add_operation (var_piccoloDeviceModel_8031.readProperty_mConfigRegisterMap ().getter_count (SOURCE_FILE ("piccolo_program.galgas", 171)).getter_string (SOURCE_FILE ("piccolo_program.galgas", 171)), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 171)).add_operation (GALGAS_string (" configuration registers:\n"), inCompiler COMMA_SOURCE_FILE ("piccolo_program.galgas", 171)), inCompiler  COMMA_SOURCE_FILE ("piccolo_program.galgas", 171)) ;
            }
