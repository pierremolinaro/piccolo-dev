...
static void extensionMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_optimizeMOVLW (const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation * inObject,
  ...
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, object->mProperty_mLiteralInstruction.objectCompare (GALGAS_midrange_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE ("midrange_optimizations.galgas", 367)))).boolEnum () ;
    if (kBoolTrue == test_0) {
...
static void extensionMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_optimizeTestDecInc (const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition * inObject,
  ...
  if (var_firstInstruction_17352.isValid ()) {
    if (var_firstInstruction_17352.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
      ...
      if (kBoolTrue == test_3) {
        test_3 = object->mProperty_mIncrement.boolEnum () ;
        if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_4) {
        test_4 = object->mProperty_m_5F_W_5F_isDestination.boolEnum () ;
        if (kBoolTrue == test_4) {
      ...
      if (kBoolTrue == test_5) {
        test_5 = object->mProperty_mBranchIfZero.boolEnum () ;
        if (kBoolTrue == test_5) {
