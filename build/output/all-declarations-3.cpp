...
GALGAS_bool cPtr_midrange_5F_intermediate_5F_instruction::getter_isLABELorORG (C_Compiler */* inCompiler */
...
GALGAS_bool cPtr_midrange_5F_intermediate_5F_instruction::getter_isNULL (C_Compiler */* inCompiler */
                                                                         COMMA_UNUSED_LOCATION_ARGS) const {
...
GALGAS_bool cPtr_midrange_5F_intermediate_5F_instruction::getter_isSkippingInstruction (C_Compiler */* inCompiler */
                                                                                        COMMA_UNUSED_LOCATION_ARGS) const {
...
GALGAS_bool cPtr_midrange_5F_intermediate_5F_instruction::getter_nextInstructionIsReachable (C_Compiler */* inCompiler */
                                                                                             COMMA_UNUSED_LOCATION_ARGS) const {
...
void cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition::method_optimizeTestDecInc (const GALGAS_symbolTableForOptimizations constinArgument_inSymbolTable,
  ...
  constinArgument_inSymbolTable.method_searchKey (GALGAS_lstring::constructor_new (temp_0.readProperty_mTargetLabel (), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("midrange_optimizations.galgas", 403))  COMMA_SOURCE_FILE ("midrange_optimizations.galgas", 403)), var_line_18303, joker_18308, inCompiler COMMA_SOURCE_FILE ("midrange_optimizations.galgas", 403)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (NULL == var_instruction_21449.ptr ()) {
          test_2 = kBoolFalse ;
        }
        if (kBoolTrue == test_2) {
          var_ok_21068 = GALGAS_bool (kIsEqual, callExtensionGetter_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) var_instruction_21449.ptr (), inCompiler COMMA_SOURCE_FILE ("midrange_optimizations.galgas", 496)).objectCompare (GALGAS_uint (uint32_t (1U)))) ;
        }
      }
