...
GALGAS_branchOverflowMapDictionary_2D_element::GALGAS_branchOverflowMapDictionary_2D_element (void) :
mProperty_key (),
mProperty_mList () {
}
...
GALGAS_branchOverflowMapDictionary_2D_element GALGAS_branchOverflowMapDictionary_2D_element::init_21__21_ (const GALGAS_string & in_key,
                                                                                                           const GALGAS_stringlist & in_mList,
                                                                                                           Compiler * inCompiler
                                                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_branchOverflowMapDictionary_2D_element result ;
...
void GALGAS_branchOverflowMapDictionary_2D_element::setInitializedProperties (Compiler * /* inCompiler */) {
}

//--------------------------------------------------------------------------------------------------

GALGAS_branchOverflowMapDictionary_2D_element::GALGAS_branchOverflowMapDictionary_2D_element (const GALGAS_string & inOperand0,
...
GALGAS_branchOverflowMapDictionary_2D_element GALGAS_branchOverflowMapDictionary_2D_element::class_func_new (const GALGAS_string & in_key,
                                                                                                             const GALGAS_stringlist & in_mList,
                                                                                                             Compiler * inCompiler
                                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_branchOverflowMapDictionary_2D_element result ;
...
bool GALGAS_branchOverflowMapDictionary_2D_element::isValid (void) const {
  return mProperty_key.isValid () && mProperty_mList.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_branchOverflowMapDictionary_2D_element::drop (void) {
  mProperty_key.drop () ;
...
void GALGAS_branchOverflowMapDictionary_2D_element::description (String & ioString,
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_branchOverflowMapDictionary_2D_element ("branchOverflowMapDictionary-element",
                                                                                              nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_branchOverflowMapDictionary_2D_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_branchOverflowMapDictionary_2D_element ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_branchOverflowMapDictionary_2D_element::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_branchOverflowMapDictionary_2D_element (*this)) ;
  }
  return result ;
}
...
GALGAS_branchOverflowMapDictionary_2D_element GALGAS_branchOverflowMapDictionary_2D_element::extractObject (const GALGAS_object & inObject,
                                                                                                            Compiler * inCompiler
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_branchOverflowMapDictionary_2D_element result ;
  const GALGAS_branchOverflowMapDictionary_2D_element * p = (const GALGAS_branchOverflowMapDictionary_2D_element *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_branchOverflowMapDictionary_2D_element *> (p)) {
      result = *p ;
    }else{
...
//--------------------------------------------------------------------------------------------------
//
//Optional @branchOverflowMapDictionary_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_branchOverflowMapDictionary_2D_element_3F_::GALGAS_branchOverflowMapDictionary_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
...
GALGAS_branchOverflowMapDictionary_2D_element_3F_::GALGAS_branchOverflowMapDictionary_2D_element_3F_ (const GALGAS_branchOverflowMapDictionary_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
...
GALGAS_branchOverflowMapDictionary_2D_element_3F_ GALGAS_branchOverflowMapDictionary_2D_element_3F_::init_nil (void) {
...
bool GALGAS_branchOverflowMapDictionary_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
...
bool GALGAS_branchOverflowMapDictionary_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_branchOverflowMapDictionary_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_branchOverflowMapDictionary_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_branchOverflowMapDictionary_2D_element_3F_::description (String & ioString,
                                                                     const int32_t inIndentation) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_branchOverflowMapDictionary_2D_element_3F_ ("branchOverflowMapDictionary-element?",
                                                                                                  nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_branchOverflowMapDictionary_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_branchOverflowMapDictionary_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_branchOverflowMapDictionary_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_branchOverflowMapDictionary_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_branchOverflowMapDictionary_2D_element_3F_ GALGAS_branchOverflowMapDictionary_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                                                    Compiler * inCompiler
                                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_branchOverflowMapDictionary_2D_element_3F_ result ;
  const GALGAS_branchOverflowMapDictionary_2D_element_3F_ * p = (const GALGAS_branchOverflowMapDictionary_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_branchOverflowMapDictionary_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("branchOverflowMapDictionary-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
void cPtr_registerExpression::method_resolveMidrangeAccess (const GALGAS_uint constinArgument_inTotalBankCount,
  ...
  GALGAS_uintlist var_acceptableBanks_1305 = GALGAS_uintlist::init (inCompiler COMMA_HERE) ;
  ...
  while (enumerator_1342.hasCurrentObject ()) {
    var_acceptableBanks_1305.addAssign_operation (enumerator_1342.current_mValue (HERE).right_shift_operation (GALGAS_bigint ("7", inCompiler  COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 45)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 45))  COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 45)) ;
    enumerator_1342.gotoNextObject () ;
  }
  GALGAS_uint var_registerAddress_1436 = GALGAS_uint (uint32_t (0U)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    if (kBoolTrue == test_9) {
      GALGAS_uint var_bank_1574 = GALGAS_uint (uint32_t (0U)) ;
      GALGAS_bool var_ok_1597 = GALGAS_bool (true) ;
      if (constinArgument_inTotalBankCount.isValid ()) {
        uint32_t variant_1611 = constinArgument_inTotalBankCount.uintValue () ;
        bool loop_1611 = true ;
        while (loop_1611) {
          loop_1611 = GALGAS_bool (ComparisonKind::lowerThan, var_bank_1574.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok_1597 COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 53)).isValid () ;
          if (loop_1611) {
            loop_1611 = GALGAS_bool (ComparisonKind::lowerThan, var_bank_1574.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok_1597 COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 53)).boolValue () ;
          }
          ...
          if (loop_1611) {
            ...
            if (enumerator_1703.hasCurrentObject () && bool_10) {
              while (enumerator_1703.hasCurrentObject () && bool_10) {
                var_ok_1597 = GALGAS_bool (ComparisonKind::greaterOrEqual, enumerator_1703.current_mValue (HERE).objectCompare (var_bank_1574.multiply_operation (GALGAS_uint (uint32_t (128U)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 56)))).operator_and (GALGAS_bool (ComparisonKind::lowerThan, enumerator_1703.current_mValue (HERE).objectCompare (var_bank_1574.multiply_operation (GALGAS_uint (uint32_t (128U)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 56)).add_operation (GALGAS_uint (uint32_t (128U)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 56)))) COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 56)) ;
                var_registerAddress_1436 = enumerator_1703.current_mValue (HERE).operator_and (GALGAS_uint (uint32_t (127U)) COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 57)) ;
            ...
            var_bank_1574.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 59)) ;
          }
        }
      }
      enumGalgasBool test_11 = kBoolTrue ;
      if (kBoolTrue == test_11) {
        ...
        if (kBoolTrue == test_11) {
          GALGAS_string var_acceptableBankMessage_1932 = GALGAS_string::makeEmptyString () ;
          ...
          while (enumerator_1970.hasCurrentObject ()) {
            var_acceptableBankMessage_1932.plusAssign_operation(enumerator_1970.current_mValue (HERE).right_shift_operation (GALGAS_bigint ("7", inCompiler  COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 64)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 64)).getter_string (SOURCE_FILE ("midrange_intermediate_classes.galgas", 64)), inCompiler  COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 64)) ;
            if (enumerator_1970.hasNextObject ()) {
              var_acceptableBankMessage_1932.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 65)) ;
            }
  ...
  if (kBoolFalse == test_9) {
    GALGAS_bool var_found_2354 = GALGAS_bool (false) ;
    ...
    if (enumerator_2377.hasCurrentObject () && bool_15) {
      while (enumerator_2377.hasCurrentObject () && bool_15) {
        var_found_2354 = GALGAS_bool (ComparisonKind::greaterOrEqual, enumerator_2377.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint (uint32_t (128U)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 72)))).operator_and (GALGAS_bool (ComparisonKind::lowerThan, enumerator_2377.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint (uint32_t (128U)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 72)).add_operation (GALGAS_uint (uint32_t (128U)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 72)))) COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 72)) ;
        var_registerAddress_1436 = enumerator_2377.current_mValue (HERE).operator_and (GALGAS_uint (uint32_t (127U)) COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 73)) ;
    ...
    if (kBoolTrue == test_16) {
      ...
      if (kBoolTrue == test_16) {
        GALGAS_string var_acceptableBankMessage_2603 = GALGAS_string::makeEmptyString () ;
        ...
        while (enumerator_2641.hasCurrentObject ()) {
          ...
          if (enumerator_2641.hasNextObject ()) {
            var_acceptableBankMessage_2603.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 79)) ;
          }
  ...
  outArgument_outIPICregisterDescription = GALGAS_midrange_5F_intermediate_5F_registerExpression::init_21__21_ (var_assemblyString_763, var_registerAddress_1436.add_operation (var_offset_648.getter_uint (inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 87)), inCompiler COMMA_SOURCE_FILE ("midrange_intermediate_classes.galgas", 87)), inCompiler COMMA_HERE) ;
}
...
ComparisonResult GALGAS_gotoTerminationForBlockInstruction::objectCompare (const GALGAS_gotoTerminationForBlockInstruction & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    const size_t myObjectPtr = size_t (mObjectPtr) ;
    const size_t operandObjectPtr = size_t (inOperand.mObjectPtr) ;
...
GALGAS_gotoTerminationForBlockInstruction GALGAS_gotoTerminationForBlockInstruction::
init_21_ (const GALGAS_lstring & in_mNextBlock,
          Compiler * inCompiler
          COMMA_LOCATION_ARGS) {
  ...
  const GALGAS_gotoTerminationForBlockInstruction result (object) ;
  macroDetachSharedObject (object) ;
  return result ;
}
...
gotoTerminationForBlockInstruction_init_21_ (const GALGAS_lstring & in_mNextBlock,
                                             Compiler * /* inCompiler */) {
...
GALGAS_gotoTerminationForBlockInstruction GALGAS_gotoTerminationForBlockInstruction::class_func_new (const GALGAS_lstring & in_mNextBlock
                                                                                                     COMMA_LOCATION_ARGS) {
  GALGAS_gotoTerminationForBlockInstruction result ;
  macroMyNew (result.mObjectPtr, cPtr_gotoTerminationForBlockInstruction (in_mNextBlock COMMA_THERE)) ;
  return result ;
}
...
void GALGAS_gotoTerminationForBlockInstruction::setProperty_mNextBlock (const GALGAS_lstring & inValue) {
  if (nullptr != mObjectPtr) {
    cPtr_gotoTerminationForBlockInstruction * p = (cPtr_gotoTerminationForBlockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_gotoTerminationForBlockInstruction) ;
...
ComparisonResult GALGAS_testTerminationForBlockInstruction::objectCompare (const GALGAS_testTerminationForBlockInstruction & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    const size_t myObjectPtr = size_t (mObjectPtr) ;
    const size_t operandObjectPtr = size_t (inOperand.mObjectPtr) ;
...
GALGAS_testTerminationForBlockInstruction GALGAS_testTerminationForBlockInstruction::
init_21__21__21__21_ (const GALGAS_pic_31__38_ConditionExpression & in_mCondition,
  ...
  const GALGAS_testTerminationForBlockInstruction result (object) ;
  macroDetachSharedObject (object) ;
  return result ;
}
...
testTerminationForBlockInstruction_init_21__21__21__21_ (const GALGAS_pic_31__38_ConditionExpression & in_mCondition,
                                                         const GALGAS_abstractBlockTerminationForBlockInstruction & in_mTrueTermination,
                                                         const GALGAS_abstractBlockTerminationForBlockInstruction & in_mFalseTermination,
                                                         const GALGAS_location & in_mLocation,
                                                         Compiler * /* inCompiler */) {
...
GALGAS_testTerminationForBlockInstruction GALGAS_testTerminationForBlockInstruction::class_func_new (const GALGAS_pic_31__38_ConditionExpression & in_mCondition,
                                                                                                     const GALGAS_abstractBlockTerminationForBlockInstruction & in_mTrueTermination,
                                                                                                     const GALGAS_abstractBlockTerminationForBlockInstruction & in_mFalseTermination,
                                                                                                     const GALGAS_location & in_mLocation
                                                                                                     COMMA_LOCATION_ARGS) {
  GALGAS_testTerminationForBlockInstruction result ;
  macroMyNew (result.mObjectPtr, cPtr_testTerminationForBlockInstruction (in_mCondition, in_mTrueTermination, in_mFalseTermination, in_mLocation COMMA_THERE)) ;
  return result ;
}
...
void GALGAS_testTerminationForBlockInstruction::setProperty_mCondition (const GALGAS_pic_31__38_ConditionExpression & inValue) {
  if (nullptr != mObjectPtr) {
    cPtr_testTerminationForBlockInstruction * p = (cPtr_testTerminationForBlockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_testTerminationForBlockInstruction) ;
...
void GALGAS_testTerminationForBlockInstruction::setProperty_mTrueTermination (const GALGAS_abstractBlockTerminationForBlockInstruction & inValue) {
  if (nullptr != mObjectPtr) {
    cPtr_testTerminationForBlockInstruction * p = (cPtr_testTerminationForBlockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_testTerminationForBlockInstruction) ;
...
void GALGAS_testTerminationForBlockInstruction::setProperty_mFalseTermination (const GALGAS_abstractBlockTerminationForBlockInstruction & inValue) {
  if (nullptr != mObjectPtr) {
    cPtr_testTerminationForBlockInstruction * p = (cPtr_testTerminationForBlockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_testTerminationForBlockInstruction) ;
...
void GALGAS_testTerminationForBlockInstruction::setProperty_mLocation (const GALGAS_location & inValue) {
  if (nullptr != mObjectPtr) {
    cPtr_testTerminationForBlockInstruction * p = (cPtr_testTerminationForBlockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_testTerminationForBlockInstruction) ;
