...
\subsectionLabel{Instructions nommant un registre, et optionellement \texttt{W}}{instructionsBaselineNommantRegistreEtW}
...
\begin{table}[htbp]
  ...
  \end{tabular}
  \caption{Instructions \emph{baseline} nommant un registre, et optionellement \texttt{W}}
