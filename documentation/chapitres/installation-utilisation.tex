...
\begin{itemize}
  ...
  \item \texttt{e} : dans une instruction \texttt{computed rcall}, l'appel à une routine constituée d'une instruction \assembleur{RETURN} est supprimé une instruction \texttt{BLANK} (c'est à dire un \assembleur{NOP} dont le code est 0xF000) ;
