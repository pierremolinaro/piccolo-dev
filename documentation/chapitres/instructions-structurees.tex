...
\begin{itemize}
  ...
  \item l'instruction \pic!nopbra! (\refSectionPage{instructionNOPBRA}, pour \emph{pic18} uniquement) ;
...
\sectionLabel{Instruction \texttt{nopbra}}{instructionNOPBRA}

\textcolor{red}{\bf Cette instruction n'est valide que pour les \emph{pic18}, à partir de la version 3.1.1.}

Cette instruction n'existe pas en assembleur. En Piccolo, \pic!nopbra k! engendre une séquence de \pic!k! instructions assembleur \assembleur{BRA \$+2}.

\pic!k! est une expression statique. La forme générale des expressions statiques est donnée à la \refSectionPage{expressionImmediate}. Une expression statique est évaluée à la compilation. Le compilateur effectue tous les calculs avec des nombres entiers 32 bits signés.

Cette instruction permet d'exprimer des cycles d'attente de manière plus compacte que l'instruction \pic!mnop k!. En effet, en assembleur, l'instruction \assembleur{BRA \$+2} effectue un saut vers l'instruction qui suit, et donc ne rompt pas l'exécution séquentielle. Comme une instruction \assembleur{NOP}, elle occupe deux octets, mais s'exécute en deux cycles, alors que l'instruction \assembleur{NOP} s'exécute en un seul :
...
Une étiquette « \pic!@un! »\footnote{Voir \refSectionPage{etiquette}.} permet d'étiqueter un \pic!if!, et impose que le \pic!end! correspondant porte la même étiquette. Ceci permet de faciliter la repérage visuel des  \pic!if! et des \pic!end! appairés. Les \pic!elsif! et le \pic!else! obéissent à la même règle :
\begin{piccolo}
if@un (cca)
  instructions_1
elsif@un (ccb)
...
Une étiquette « \pic!@choix! »\footnote{Voir \refSectionPage{etiquette}.} permet d'étiqueter un \pic!switch!, et impose que les \pic!case!, \pic!else! et \pic!end! correspondants portent la même étiquette. Ceci permet de faciliter la repérage visuel des  \pic!switch!,  \pic!case!, \pic!else! et \pic!end! appairés.
...
Une étiquette « \pic!@boucle! »\footnote{Voir \refSectionPage{etiquette}.} permet d'étiqueter un \pic!forever!, et impose que le \pic!end! correspondant porte la même étiquette. Ceci permet de faciliter la repérage visuel des  \pic!forever! et des \pic!end! appairés.
...
Une étiquette « \pic!@rep! »\footnote{Voir \refSectionPage{etiquette}.} permet d'étiqueter un \pic!do!, et impose que le \pic!end! correspondant porte la même étiquette. Ceci permet de faciliter la repérage visuel des  \pic!do! et des \pic!end! appairés.
...
Une étiquette « \pic!@boucle! »\footnote{Voir \refSectionPage{etiquette}.} permet d'étiqueter un \pic!do!, et impose que les \pic!while! et le \pic!end! correspondants portent la même étiquette. Ceci permet de faciliter la repérage visuel des \pic!do!, des \pic!while! et des \pic!end! appairés.
