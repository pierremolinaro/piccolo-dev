...
\lstset{emph={cst1, instructions1, cst2, instructions2, instructionsElse}, emphstyle=\emph}
...
\textbf{Notes :}
\begin{itemize}
  \item les comparaisons successives sont réalisées à l'aide d'instructions \piccolo{xorlw}, aussi la valeur de \piccolo{W} est modifiée durant les tests successifs; on ne peut donc pas l'utiliser de manière fiable au début des branches \piccolo{case} et de la branche \piccolo{else} ;
