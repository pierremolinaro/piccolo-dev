...
\textbf{Notes :}
\begin{itemize}
  \item les comparaisons successives sont réalisées à l'aide d'instructions \piccolo{xorlw}, aussi la valeur de \piccolo{W} est modifiée durant les tests successifs; on ne peut donc pas prévoir sa valeur de manière fiable au début des branches \piccolo{case} et de la branche \piccolo{else} ;
...
Les instructions associées à une branche \piccolo{case} sont exécutées si \piccolo{W} est égal à l'une des constantes citées.
