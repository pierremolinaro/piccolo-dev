...
Les \refTableau{pic18ByteOrientedOperations}, \refTableau{pic18BitOrientedOperations}, \refTableau{pic18OperationsControle}, \refTableau{pic18BitLiteralOperations} et \refTableau{pic18BitProgramMemoryOperations} donnent la liste des instructions \emph{pic18} et les liens vers les sections précisant leur prise en charge en Piccolo.

Le \refTableau{pic18InstructionsPropresPiccolo} liste les instructions complémentaires disponibles en Piccolo.
...
\begin{table}[!ht]
  ...
  \labelTableau{pic18ByteOrientedOperations}
\end{table}
...
\begin{table}[!ht]
  ...
  \labelTableau{pic18BitOrientedOperations}
\end{table}
...
\begin{table}[!ht]
  ...
  \labelTableau{pic18OperationsControle}
\end{table}
...
\begin{table}[!ht]
  ...
  \labelTableau{pic18BitLiteralOperations}
\end{table}
...
\begin{table}[!ht]
  ...
  \labelTableau{pic18BitProgramMemoryOperations}
\end{table}
...
\begin{table}[!ht]
  ...
  \begin{tabular}{lll}
    ...
    \hline
    \texttt{mnop k} & Séquence d'instructions \texttt{NOP} & \refSubsectionPage{instructionMNOP} \\
...
\subsectionLabel{Instruction \texttt{mnop}}{instructionMNOP}
