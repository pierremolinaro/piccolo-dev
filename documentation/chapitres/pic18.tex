...
%  \rowcolors{2}{\fondTableau}{}
  \begin{tabular}{p{5cm}lll}
    ...
    \hdashline
    Data & \pic!data! & \refSectionPage{sectionData} \\
    \hdashline
...
\begin{itemize}
  ...
  \item l'instruction \pic!ldataptr! (\refSubsectionPage{instructionLDATAPTR}) ;
...
\begin{itemize}
  \item \pic!nom!  est utilisé en argument de l'instruction \pic!ldataptr! (\refSubsectionPage{instructionLDATAPTR}) pour charger les registres \assembleur{TBLPTRU}, \assembleur{TBLPTRH} et \assembleur{TBLPTRL} pour qu'ils désignent le début du tableau ;
...
Cette instruction permet de charger les registres \assembleur{TBLPTRU}, \assembleur{TBLPTRH} et \assembleur{TBLPTRL} qui représente l'adresse d'un élément de tableau en flash, défini par une section \pic!data! (\refSectionPage{sectionData}).
...
Cette instruction charge les registres \assembleur{TBLPTRU}, \assembleur{TBLPTRH} et \assembleur{TBLPTRL} pour qu'ils désignent l'octet de poids faible premier élément du tableau défini par la section \pic!data nom_section_data!.
...
Dans cette seconde forme, l'instruction charge les registres \assembleur{TBLPTRU}, \assembleur{TBLPTRH} et \assembleur{TBLPTRL} pour qu'ils désignent l'octet de poids faible de l'élément \pic!indice_element! du tableau défini par la section \pic!data nom_section_data!. Si \pic!indice_element! est nul, elle est équivalent à la première forme.
