...
\sectionLabel{Section \texttt{data16}}{sectionData}
...
L'instruction charge les registres \assembleur{TBLPTRU}, \assembleur{TBLPTRH} et \assembleur{TBLPTRL} pour qu'ils désignent l'octet de poids faible de l'élément \pic!indice_element! du tableau défini par la section \pic!data nom_section_data!.
