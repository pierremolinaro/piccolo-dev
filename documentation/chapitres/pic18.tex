...
L'instruction Piccolo \piccolo{fnop k}, où \piccolo{k} est une valeur immédiate comprise entre 0 et 4095 permet d'engendrer une instruction NOP dont le code est de la forme \texttt{0xFxxx}. Par exemple, \piccolo{fnop 0x123} engendre l'instruction dont le code est \texttt{0xF123}.
