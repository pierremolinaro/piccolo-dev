...
\lstdefinelanguage{piccolo}{
  style=piccolo,
  keywords={bank, banksave, banksel, baseline, block, bootloader, byte, case, checkbank, checknobank, checkpic, computed, configuration, const,
     ...
     ram, requires, rom, ensures, routine, switch, unused, uses, w, while},
  keywordstyle=\bf\color{blue},
  sensitive=false,
  keywords=[2]{addlw, addwf, addwfc, andlw, andwf, bc, bcf, bn, bnc, bnn, bov, bnov, bnz, bsf,
    bra, btg, bz, call, clrf, clrw, clrwdt, comf, daw, decf, fnop, goto, incf, iorlw, iorwf, jsr, jump,
...
\input{chapitres/checkpic.tex}
%\input{chapitres/stats-pile-duree.tex}
