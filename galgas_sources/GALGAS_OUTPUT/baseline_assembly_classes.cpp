//---------------------------------------------------------------------------*
//                                                                           *
//                   File 'baseline_assembly_classes.cpp'                    *
//                        Generated by version 2.4.3                         *
//                       april 14th, 2013, at 20h4'3"                        *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "baseline_assembly_classes.gSemantics", line
...
class cCollectionElement_baseline_5F_assembly_5F_instructionList : public cCollectionElement {
  public : GALGAS_baseline_5F_assembly_5F_instructionList_2E_element mObject ;
...
void cCollectionElement_baseline_5F_assembly_5F_instructionList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
void GALGAS_baseline_5F_assembly_5F_instructionList::modifier_prependValue (GALGAS_baseline_5F_assembly_5F_instruction inOperand0
                                                                            COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_baseline_5F_assembly_5F_instructionList (inOperand0 COMMA_THERE)) ;
...
GALGAS_baseline_5F_assembly_5F_instructionList_2E_element cEnumerator_baseline_5F_assembly_5F_instructionList::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cCollectionElement_baseline_5F_assembly_5F_instructionList) ;
  return p->mObject ;
}
...
GALGAS_baseline_5F_assembly_5F_instructionList GALGAS_baseline_5F_assembly_5F_instructionList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instructionList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instructionList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_instruction) ;
}
...
GALGAS_baseline_5F_assembly_5F_instruction GALGAS_baseline_5F_assembly_5F_instruction::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instruction *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_assembly_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_actualInstruction) ;
}
...
GALGAS_location GALGAS_baseline_5F_assembly_5F_actualInstruction::reader_mInstructionLocation (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    ...
    macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_actualInstruction) ;
...
GALGAS_baseline_5F_assembly_5F_actualInstruction GALGAS_baseline_5F_assembly_5F_actualInstruction::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_actualInstruction *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_actualInstruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_CALL::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_CALL) ;
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_CALL) ;
}
...
void GALGAS_baseline_5F_assembly_5F_CALL::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_CALL * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_CALL (p->mAttribute_mInstructionLocation, p->mAttribute_mTargetLabel COMMA_THERE)) ;
...
GALGAS_baseline_5F_assembly_5F_CALL GALGAS_baseline_5F_assembly_5F_CALL::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_CALL *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_CALL", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_GOTO::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_GOTO) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_GOTO) ;
}
...
void GALGAS_baseline_5F_assembly_5F_GOTO::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_GOTO * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_GOTO (p->mAttribute_mInstructionLocation, p->mAttribute_mTargetLabel COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_GOTO GALGAS_baseline_5F_assembly_5F_GOTO::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_GOTO *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_GOTO", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_SKIP::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_SKIP) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  return result ;
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_SKIP) ;
}
...
void GALGAS_baseline_5F_assembly_5F_SKIP::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_assembly_5F_SKIP * p = (cPtr_baseline_5F_assembly_5F_SKIP *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_assembly_5F_SKIP) ;
    cPtr_baseline_5F_assembly_5F_SKIP * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_SKIP (p->mAttribute_mInstructionLocation COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_SKIP GALGAS_baseline_5F_assembly_5F_SKIP::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_SKIP *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_SKIP", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_TRIS::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_TRIS) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_TRIS) ;
}
...
void GALGAS_baseline_5F_assembly_5F_TRIS::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_TRIS * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_TRIS (p->mAttribute_mInstructionLocation, p->mAttribute_mOperand, p->mAttribute_mOpcode COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_TRIS GALGAS_baseline_5F_assembly_5F_TRIS::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_TRIS *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_TRIS", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_WO_5F_OPERAND::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_WO_5F_OPERAND) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_WO_5F_OPERAND) ;
}
...
void GALGAS_baseline_5F_assembly_5F_WO_5F_OPERAND::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_WO_5F_OPERAND * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_WO_5F_OPERAND (p->mAttribute_mInstructionLocation, p->mAttribute_mInstruction COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_WO_5F_OPERAND GALGAS_baseline_5F_assembly_5F_WO_5F_OPERAND::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_WO_5F_OPERAND *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_WO_OPERAND", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_incDecRegisterInCondition::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_incDecRegisterInCondition) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_incDecRegisterInCondition) ;
}
...
void GALGAS_baseline_5F_assembly_5F_incDecRegisterInCondition::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_incDecRegisterInCondition * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_incDecRegisterInCondition (p->mAttribute_mInstructionLocation, p->mAttribute_mRegisterDescription, p->mAttribute_mIncrement, p->mAttribute_m_5F_W_5F_isDestination COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_incDecRegisterInCondition GALGAS_baseline_5F_assembly_5F_incDecRegisterInCondition::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_incDecRegisterInCondition *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_incDecRegisterInCondition", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_instruction_5F_BitTestSkip::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_instruction_5F_BitTestSkip) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_instruction_5F_BitTestSkip) ;
}
...
void GALGAS_baseline_5F_assembly_5F_instruction_5F_BitTestSkip::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_instruction_5F_BitTestSkip * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_instruction_5F_BitTestSkip (p->mAttribute_mInstructionLocation, p->mAttribute_mSkipIfSet, p->mAttribute_mRegisterDescription, p->mAttribute_mBitNumber COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_instruction_5F_BitTestSkip GALGAS_baseline_5F_assembly_5F_instruction_5F_BitTestSkip::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instruction_5F_BitTestSkip *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instruction_BitTestSkip", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_instruction_5F_F::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_instruction_5F_F) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_instruction_5F_F) ;
}
...
void GALGAS_baseline_5F_assembly_5F_instruction_5F_F::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_instruction_5F_F * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_instruction_5F_F (p->mAttribute_mInstructionLocation, p->mAttribute_mInstruction, p->mAttribute_mRegisterDescription COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_instruction_5F_F GALGAS_baseline_5F_assembly_5F_instruction_5F_F::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instruction_5F_F *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instruction_F", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_instruction_5F_FB::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_instruction_5F_FB) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_instruction_5F_FB) ;
}
...
void GALGAS_baseline_5F_assembly_5F_instruction_5F_FB::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_instruction_5F_FB * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_instruction_5F_FB (p->mAttribute_mInstructionLocation, p->mAttribute_mInstruction, p->mAttribute_mRegisterDescription, p->mAttribute_mBitNumber COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_instruction_5F_FB GALGAS_baseline_5F_assembly_5F_instruction_5F_FB::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instruction_5F_FB *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instruction_FB", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_instruction_5F_FD::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_instruction_5F_FD) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_instruction_5F_FD) ;
}
...
void GALGAS_baseline_5F_assembly_5F_instruction_5F_FD::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_baseline_5F_assembly_5F_instruction_5F_FD * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_instruction_5F_FD (p->mAttribute_mInstructionLocation, p->mAttribute_mInstruction, p->mAttribute_mRegisterDescription, p->mAttribute_m_5F_W_5F_isDestination COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_baseline_5F_assembly_5F_instruction_5F_FD GALGAS_baseline_5F_assembly_5F_instruction_5F_FD::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instruction_5F_FD *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instruction_FD", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_instruction_5F_literalOperation::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_instruction_5F_literalOperation) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_instruction_5F_literalOperation) ;
}
...
GALGAS_baseline_5F_assembly_5F_instruction_5F_literalOperation GALGAS_baseline_5F_assembly_5F_instruction_5F_literalOperation::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instruction_5F_literalOperation *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instruction_literalOperation", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE * p = (const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE) ;
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::objectCompare (const GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE (void) :
GALGAS_baseline_5F_assembly_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE (const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE * inSourcePtr) :
GALGAS_baseline_5F_assembly_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::constructor_new (const GALGAS_lstring & inAttribute_mRoutineName,
                                                                                                                  const GALGAS_uint & inAttribute_mPage
                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE result ;
  if (inAttribute_mRoutineName.isValid () && inAttribute_mPage.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE (inAttribute_mRoutineName, inAttribute_mPage COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE * p = (cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE) ;
    cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE (p->mAttribute_mRoutineName, p->mAttribute_mPage COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstring GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE * p = (const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE) ;
...
GALGAS_lstring cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::reader_mPage (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE * p = (const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE) ;
...
GALGAS_uint cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE::reader_mPage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPage ;
}

//---------------------------------------------------------------------------*
//         Pointer class for @baseline_assembly_pseudo_INPAGE class          *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE::cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE (const GALGAS_lstring & in_mRoutineName,
...
const C_galgas_type_descriptor * cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE ;
}

void cPtr_baseline_5F_assembly_5F_pseudo_5F_INPAGE::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
  ioString << "[@baseline_assembly_pseudo_INPAGE:" ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                   @baseline_assembly_pseudo_INPAGE type                   *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE ("baseline_assembly_pseudo_INPAGE",
                                                                 & kTypeDescriptor_GALGAS_baseline_5F_assembly_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE::extractObject (const GALGAS_object & inObject,
                                                                                                                C_Compiler * inCompiler,
                                                                                                                const GALGAS_location & inErrorLocation
                                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE result ;
  const GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE * p = (const GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_pseudo_INPAGE", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_pseudo_5F_LABEL::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_pseudo_5F_LABEL) ;
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_pseudo_5F_LABEL) ;
}
...
GALGAS_baseline_5F_assembly_5F_pseudo_5F_LABEL GALGAS_baseline_5F_assembly_5F_pseudo_5F_LABEL::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_pseudo_5F_LABEL *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_pseudo_LABEL", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_assembly_5F_pseudo_5F_ORG::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_assembly_5F_pseudo_5F_ORG) ;
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_assembly_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_assembly_5F_pseudo_5F_ORG) ;
}
...
GALGAS_baseline_5F_assembly_5F_pseudo_5F_ORG GALGAS_baseline_5F_assembly_5F_pseudo_5F_ORG::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_pseudo_5F_ORG *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_pseudo_ORG", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::GALGAS_baseline_5F_assembly_5F_instructionList_2E_element (void) :
...
GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::GALGAS_baseline_5F_assembly_5F_instructionList_2E_element (const GALGAS_baseline_5F_assembly_5F_instruction & inOperand0) :
mAttribute_mInstruction (inOperand0) {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_assembly_5F_instructionList_2E_element GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::constructor_new (const GALGAS_baseline_5F_assembly_5F_instruction & inOperand0 
                                                                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_baseline_5F_assembly_5F_instructionList_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_baseline_5F_assembly_5F_instructionList_2E_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::objectCompare (const GALGAS_baseline_5F_assembly_5F_instructionList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::isValid (void) const {
  return mAttribute_mInstruction.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::drop (void) {
  mAttribute_mInstruction.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::description (C_String & ioString,
                                                                             const PMSInt32 inIndentation) const {
...
GALGAS_baseline_5F_assembly_5F_instruction GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::reader_mInstruction (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstruction ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_assembly_5F_instructionList_2E_element ("baseline_assembly_instructionList.element",
                                                                           NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_assembly_5F_instructionList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_assembly_5F_instructionList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_assembly_5F_instructionList_2E_element GALGAS_baseline_5F_assembly_5F_instructionList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                                                                    C_Compiler * inCompiler,
                                                                                                                                    const GALGAS_location & inErrorLocation
                                                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_assembly_5F_instructionList_2E_element result ;
  const GALGAS_baseline_5F_assembly_5F_instructionList_2E_element * p = (const GALGAS_baseline_5F_assembly_5F_instructionList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_assembly_5F_instructionList_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_assembly_instructionList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
