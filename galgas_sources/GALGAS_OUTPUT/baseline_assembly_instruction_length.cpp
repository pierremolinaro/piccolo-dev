...
//---------------------------------------------------------------------------*
//                                                                           *
//   Overriding category reader '@baseline_assembly_pseudo_INPAGE length'    *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_uint categoryReader_baseline_5F_assembly_5F_pseudo_5F_INPAGE_length (const cPtr_baseline_5F_assembly_5F_instruction * /* inObject */,
                                                                                   C_Compiler * /* inCompiler */
                                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outLength ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_baseline_5F_assembly_5F_pseudo_5F_INPAGE_length (void) {
  enterCategoryReader_length (kTypeDescriptor_GALGAS_baseline_5F_assembly_5F_pseudo_5F_INPAGE.mSlotID,
                              categoryReader_baseline_5F_assembly_5F_pseudo_5F_INPAGE_length) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_baseline_5F_assembly_5F_pseudo_5F_INPAGE_length (defineCategoryReader_baseline_5F_assembly_5F_pseudo_5F_INPAGE_length, NULL) ;
