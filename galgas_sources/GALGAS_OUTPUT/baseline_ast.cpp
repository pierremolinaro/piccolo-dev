...
GALGAS_baseline_5F_routineDefinitionList GALGAS_baseline_5F_routineDefinitionList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
                                                                                                              ...
                                                                                                              const GALGAS_baseline_5F_instructionList & inOperand6,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_baseline_5F_routineDefinitionList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_routineDefinitionList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_baseline_5F_routineDefinitionList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_baseline_5F_routineDefinitionList::modifier_prependValue (GALGAS_lstring inOperand0,
                                                                      ...
                                                                      GALGAS_baseline_5F_instructionList inOperand6,
...
void GALGAS_baseline_5F_routineDefinitionList::modifier_popFirst (GALGAS_lstring & outOperand0,
                                                                  ...
                                                                  GALGAS_baseline_5F_instructionList & outOperand6,
...
GALGAS_luint GALGAS_baseline_5F_routineDefinitionList::reader_mRequiredBankAtIndex (const GALGAS_uint & inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_baseline_5F_routineDefinitionList * p = (cCollectionElement_baseline_5F_routineDefinitionList *) attributes.ptr () ;
...
GALGAS_luint GALGAS_baseline_5F_routineDefinitionList::reader_mReturnedBankAtIndex (const GALGAS_uint & inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_baseline_5F_routineDefinitionList * p = (cCollectionElement_baseline_5F_routineDefinitionList *) attributes.ptr () ;
...
GALGAS_bool GALGAS_baseline_5F_routineDefinitionList::reader_mPreservesBankAtIndex (const GALGAS_uint & inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_baseline_5F_routineDefinitionList * p = (cCollectionElement_baseline_5F_routineDefinitionList *) attributes.ptr () ;
...
GALGAS_luint cEnumerator_baseline_5F_routineDefinitionList::current_mRequiredBank (LOCATION_ARGS) const {
  const cCollectionElement_baseline_5F_routineDefinitionList * p = (const cCollectionElement_baseline_5F_routineDefinitionList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_baseline_5F_routineDefinitionList) ;
...
GALGAS_luint cEnumerator_baseline_5F_routineDefinitionList::current_mReturnedBank (LOCATION_ARGS) const {
  const cCollectionElement_baseline_5F_routineDefinitionList * p = (const cCollectionElement_baseline_5F_routineDefinitionList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_baseline_5F_routineDefinitionList) ;
...
GALGAS_bool cEnumerator_baseline_5F_routineDefinitionList::current_mPreservesBank (LOCATION_ARGS) const {
  const cCollectionElement_baseline_5F_routineDefinitionList * p = (const cCollectionElement_baseline_5F_routineDefinitionList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_baseline_5F_routineDefinitionList) ;
...
GALGAS_baseline_5F_instruction_5F_TRIS GALGAS_baseline_5F_instruction_5F_TRIS::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_TRIS *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_TRIS", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_WO_5F_OPERAND GALGAS_baseline_5F_instruction_5F_WO_5F_OPERAND::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_WO_5F_OPERAND *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_WO_OPERAND", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_banksel::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_banksel * p = (const cPtr_baseline_5F_instruction_5F_banksel *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_banksel) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_banksel::objectCompare (const GALGAS_baseline_5F_instruction_5F_banksel & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_banksel::GALGAS_baseline_5F_instruction_5F_banksel (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_banksel::GALGAS_baseline_5F_instruction_5F_banksel (const cPtr_baseline_5F_instruction_5F_banksel * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_banksel) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_banksel GALGAS_baseline_5F_instruction_5F_banksel::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                                      const GALGAS_luint & inAttribute_mBankIndex
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_banksel result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mBankIndex.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_banksel (inAttribute_mInstructionLocation, inAttribute_mBankIndex COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_banksel::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_banksel * p = (cPtr_baseline_5F_instruction_5F_banksel *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_banksel) ;
    cPtr_baseline_5F_instruction_5F_banksel * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_banksel (p->mAttribute_mInstructionLocation, p->mAttribute_mBankIndex COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_luint GALGAS_baseline_5F_instruction_5F_banksel::reader_mBankIndex (UNUSED_LOCATION_ARGS) const {
  GALGAS_luint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_instruction_5F_banksel * p = (const cPtr_baseline_5F_instruction_5F_banksel *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_banksel) ;
...
GALGAS_luint cPtr_baseline_5F_instruction_5F_banksel::reader_mBankIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBankIndex ;
}

//---------------------------------------------------------------------------*
//           Pointer class for @baseline_instruction_banksel class           *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_banksel::cPtr_baseline_5F_instruction_5F_banksel (const GALGAS_location & in_mInstructionLocation,
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_banksel::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_banksel ;
}

void cPtr_baseline_5F_instruction_5F_banksel::description (C_String & ioString,
                                                           const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_banksel:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    @baseline_instruction_banksel type                     *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_banksel ("baseline_instruction_banksel",
                                                           & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_banksel::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_banksel ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_banksel::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_banksel (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_banksel GALGAS_baseline_5F_instruction_5F_banksel::extractObject (const GALGAS_object & inObject,
                                                                                                    C_Compiler * inCompiler,
                                                                                                    const GALGAS_location & inErrorLocation
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_banksel result ;
  const GALGAS_baseline_5F_instruction_5F_banksel * p = (const GALGAS_baseline_5F_instruction_5F_banksel *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_banksel *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_banksel", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_nobanksel::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_nobanksel * p = (const cPtr_baseline_5F_instruction_5F_nobanksel *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_nobanksel) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  return result ;
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_nobanksel::objectCompare (const GALGAS_baseline_5F_instruction_5F_nobanksel & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_nobanksel::GALGAS_baseline_5F_instruction_5F_nobanksel (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_nobanksel::GALGAS_baseline_5F_instruction_5F_nobanksel (const cPtr_baseline_5F_instruction_5F_nobanksel * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_nobanksel) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_nobanksel GALGAS_baseline_5F_instruction_5F_nobanksel::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation
                                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_nobanksel result ;
  if (inAttribute_mInstructionLocation.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_nobanksel (inAttribute_mInstructionLocation COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_nobanksel::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_nobanksel * p = (cPtr_baseline_5F_instruction_5F_nobanksel *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_nobanksel) ;
    cPtr_baseline_5F_instruction_5F_nobanksel * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_nobanksel (p->mAttribute_mInstructionLocation COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
//---------------------------------------------------------------------------*
//          Pointer class for @baseline_instruction_nobanksel class          *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_nobanksel::cPtr_baseline_5F_instruction_5F_nobanksel (const GALGAS_location & in_mInstructionLocation
                                                                                      COMMA_LOCATION_ARGS) :
cPtr_baseline_5F_instruction (in_mInstructionLocation COMMA_THERE) {
}
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_nobanksel::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_nobanksel ;
}

void cPtr_baseline_5F_instruction_5F_nobanksel::description (C_String & ioString,
                                                             const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_nobanksel:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                   @baseline_instruction_nobanksel type                    *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_nobanksel ("baseline_instruction_nobanksel",
                                                             & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_nobanksel::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_nobanksel ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_nobanksel::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_nobanksel (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_nobanksel GALGAS_baseline_5F_instruction_5F_nobanksel::extractObject (const GALGAS_object & inObject,
                                                                                                        C_Compiler * inCompiler,
                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_nobanksel result ;
  const GALGAS_baseline_5F_instruction_5F_nobanksel * p = (const GALGAS_baseline_5F_instruction_5F_nobanksel *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_nobanksel *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_nobanksel", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_savebank::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_savebank * p = (const cPtr_baseline_5F_instruction_5F_savebank *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_savebank) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_savebank::objectCompare (const GALGAS_baseline_5F_instruction_5F_savebank & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_savebank::GALGAS_baseline_5F_instruction_5F_savebank (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_savebank::GALGAS_baseline_5F_instruction_5F_savebank (const cPtr_baseline_5F_instruction_5F_savebank * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_savebank) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_savebank GALGAS_baseline_5F_instruction_5F_savebank::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                                        const GALGAS_registerExpression & inAttribute_mRegister,
                                                                                                        const GALGAS_baseline_5F_instructionList & inAttribute_mInstructionList,
                                                                                                        const GALGAS_location & inAttribute_mEndOfSaveBankInstruction
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_savebank result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mRegister.isValid () && inAttribute_mInstructionList.isValid () && inAttribute_mEndOfSaveBankInstruction.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_savebank (inAttribute_mInstructionLocation, inAttribute_mRegister, inAttribute_mInstructionList, inAttribute_mEndOfSaveBankInstruction COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_savebank::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_savebank * p = (cPtr_baseline_5F_instruction_5F_savebank *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_savebank) ;
    cPtr_baseline_5F_instruction_5F_savebank * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_savebank (p->mAttribute_mInstructionLocation, p->mAttribute_mRegister, p->mAttribute_mInstructionList, p->mAttribute_mEndOfSaveBankInstruction COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_registerExpression GALGAS_baseline_5F_instruction_5F_savebank::reader_mRegister (UNUSED_LOCATION_ARGS) const {
  GALGAS_registerExpression result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_instruction_5F_savebank * p = (const cPtr_baseline_5F_instruction_5F_savebank *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_savebank) ;
...
GALGAS_registerExpression cPtr_baseline_5F_instruction_5F_savebank::reader_mRegister (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegister ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instructionList GALGAS_baseline_5F_instruction_5F_savebank::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  GALGAS_baseline_5F_instructionList result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_instruction_5F_savebank * p = (const cPtr_baseline_5F_instruction_5F_savebank *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_savebank) ;
...
GALGAS_baseline_5F_instructionList cPtr_baseline_5F_instruction_5F_savebank::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_baseline_5F_instruction_5F_savebank::reader_mEndOfSaveBankInstruction (UNUSED_LOCATION_ARGS) const {
  GALGAS_location result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_instruction_5F_savebank * p = (const cPtr_baseline_5F_instruction_5F_savebank *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_savebank) ;
...
GALGAS_location cPtr_baseline_5F_instruction_5F_savebank::reader_mEndOfSaveBankInstruction (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndOfSaveBankInstruction ;
}

//---------------------------------------------------------------------------*
//          Pointer class for @baseline_instruction_savebank class           *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_savebank::cPtr_baseline_5F_instruction_5F_savebank (const GALGAS_location & in_mInstructionLocation,
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_savebank::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_savebank ;
}

void cPtr_baseline_5F_instruction_5F_savebank::description (C_String & ioString,
                                                            const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_savebank:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    @baseline_instruction_savebank type                    *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_savebank ("baseline_instruction_savebank",
                                                            & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_savebank::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_savebank ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_savebank::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_savebank (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_savebank GALGAS_baseline_5F_instruction_5F_savebank::extractObject (const GALGAS_object & inObject,
                                                                                                      C_Compiler * inCompiler,
                                                                                                      const GALGAS_location & inErrorLocation
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_savebank result ;
  const GALGAS_baseline_5F_instruction_5F_savebank * p = (const GALGAS_baseline_5F_instruction_5F_savebank *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_savebank *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_savebank", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_routineDefinitionList_2E_element GALGAS_baseline_5F_routineDefinitionList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    result = GALGAS_baseline_5F_routineDefinitionList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7) ;
  }
  return result ;
}
...
GALGAS_luint GALGAS_baseline_5F_routineDefinitionList_2E_element::reader_mRequiredBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRequiredBank ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_baseline_5F_routineDefinitionList_2E_element::reader_mReturnedBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mReturnedBank ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_baseline_5F_routineDefinitionList_2E_element::reader_mPreservesBank (UNUSED_LOCATION_ARGS) const {
