...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_PAGE_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioAssemblyInstructionList.addAssign_operation (GALGAS_baseline_5F_assembly_5F_pseudo_5F_ORG::constructor_new (object->mAttribute_mPage.multiply_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE_AT_LINE (36)) COMMA_SOURCE_FILE_AT_LINE (36)) COMMA_SOURCE_FILE_AT_LINE (36)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_instruction_5F_MNOP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (178)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (182)).isValid ()) {
    uint32_t variant_7207 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (182)).uintValue () ;
    bool loop_7207 = true ;
    while (loop_7207) {
...
static void categoryMethod_baseline_5F_intermediate_5F_JUMP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (GALGAS_uint ((uint32_t) 8U).isValid ()) {
    ...
    while (loop_8378) {
      ...
      if (loop_8378) {
        variant_8378 -- ;
        const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.operator_and (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (218)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_0) {
          ...
          const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_targetPageFlags.operator_and (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (245)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_6) {
        ...
        var_pageChangeFlags = var_pageChangeFlags.divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (250)) ;
        var_targetPageFlags = var_targetPageFlags.divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (251)) ;
        var_idx = var_idx.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (252)) ;
      }
    }
  }
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (GALGAS_uint ((uint32_t) 8U).isValid ()) {
    ...
    while (loop_10975) {
      ...
      if (loop_10975) {
        variant_10975 -- ;
        const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.operator_and (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (286)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_0) {
          GALGAS_uint var_bitIndex ;
          ...
          //--- @ifExpressionForGeneration
          GALGAS_baseline_5F_bit_5F_oriented_5F_op temp_5 ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_targetPageFlags.operator_and (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (313)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_6) {
          ...
          const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_targetPageFlags.operator_and (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (319)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_8) {
        ...
        var_pageChangeFlags = var_pageChangeFlags.divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (324)) ;
        var_targetPageFlags = var_targetPageFlags.divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (325)) ;
        var_idx = var_idx.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (326)) ;
      }
    }
  }
