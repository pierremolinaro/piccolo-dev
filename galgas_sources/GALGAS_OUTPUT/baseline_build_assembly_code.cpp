...
void routine_build_5F_baseline_5F_assembly_5F_code (const GALGAS_baseline_5F_intermediate_5F_instructionList constinArgument_inGeneratedInstructionList,
  ...
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_14556 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_14556.hasCurrentObject ()) {
    callCategoryMethod_generateAssemblyCode ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_14556.current_mInstruction (HERE).ptr (), constinArgument_inSTATUSregister, constinArgument_inStatusRegisterBitSliceTable, ioArgument_ioAssemblyInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
    enumerator_14556.gotoNextObject () ;
  }
  cEnumerator_actualConfigurationMap enumerator_14781 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_14781.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_14781.current_mRegisterAddress (HERE).add_operation (enumerator_14781.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
    }
    {
    routine_emitCode (enumerator_14781.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
    }
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (GALGAS_uint ((PMUInt32) 8U).isValid ()) {
    PMUInt32 variant_10977 = GALGAS_uint ((PMUInt32) 8U).uintValue () ;
    bool loop_10977 = true ;
    while (loop_10977) {
      loop_10977 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_10977) {
        loop_10977 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
  ...
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_12880 (var_pageRestoreInstructions, kEnumeration_up) ;
  while (enumerator_12880.hasCurrentObject ()) {
    ioArgument_ioAssemblyInstructionList.addAssign_operation (enumerator_12880.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (333)) ;
