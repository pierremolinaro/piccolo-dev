...
void routine_build_5F_baseline_5F_intermediate_5F_assembly_5F_code (const GALGAS_baseline_5F_intermediate_5F_instructionList constinArgument_inGeneratedInstructionList,
  ...
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_7269 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7269.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateAssemblyCode ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_7269.current_mInstruction (HERE).ptr (), ioArgument_ioAssemblyInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_7269.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_7445 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7445.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_setEmitAddress (enumerator_7445.current_mRegisterAddress (HERE).add_operation (enumerator_7445.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (212)), inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
    routine_emitCode (enumerator_7445.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (213)) ;
    } //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_baseline_5F_intermediate_5F_TRIS_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioAssemblyInstructionList.addAssign_operation (GALGAS_baseline_5F_pic_5F_assembly_5F_TRIS::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mOperand, object->mAttribute_mOpcode COMMA_SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_LABEL_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioAssemblyInstructionList.addAssign_operation (GALGAS_baseline_5F_pic_5F_assembly_5F_pseudo_5F_LABEL::constructor_new (object->mAttribute_mLabel COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_instruction_5F_MNOP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (134)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("No generated code") COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @loopInstructionForGeneration
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (138)).isValid ()) {
    PMUInt32 variant_4850 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (138)).uintValue () ;
    bool loop_4850 = true ;
    while (loop_4850) {
      loop_4850 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (139)))).isValid () ;
      if (loop_4850) {
        loop_4850 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (139)))).boolValue () ;
      }
      if (loop_4850 && (0 == variant_4850)) {
        loop_4850 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (138)) ;
      }
      if (loop_4850) {
        variant_4850 -- ;
        //-------- @plusEqualnstructionForGeneration
        ioArgument_ioAssemblyInstructionList.addAssign_operation (GALGAS_baseline_5F_pic_5F_assembly_5F_WO_5F_OPERAND::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_WO_5F_OPERAND_5F_group::constructor_NOP (SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (141)) ;
        //-------- @incrementInstructionForGeneration
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_GOTO_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioAssemblyInstructionList.addAssign_operation (GALGAS_baseline_5F_pic_5F_assembly_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel COMMA_SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (154)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_CALL_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioAssemblyInstructionList.addAssign_operation (GALGAS_baseline_5F_pic_5F_assembly_5F_CALL::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)) ;
}
//---------------------------------------------------------------------------*
