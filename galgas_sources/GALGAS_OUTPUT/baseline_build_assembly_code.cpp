...
void routine_build_5F_baseline_5F_assembly_5F_code (const GALGAS_baseline_5F_intermediate_5F_instructionList constinArgument_inGeneratedInstructionList,
  ...
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_13168 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13168.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateAssemblyCode ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_13168.current_mInstruction (HERE).ptr (), constinArgument_inSTATUSregister, constinArgument_inStatusRegisterBitSliceTable, ioArgument_ioAssemblyInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (341)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_13168.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_13393 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13393.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_setEmitAddress (enumerator_13393.current_mRegisterAddress (HERE).add_operation (enumerator_13393.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (345)), inCompiler COMMA_SOURCE_FILE_AT_LINE (345)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
    routine_emitCode (enumerator_13393.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) ;
    } //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_baseline_5F_intermediate_5F_GOTO_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (GALGAS_uint ((PMUInt32) 8U).isValid ()) {
    PMUInt32 variant_7909 = GALGAS_uint ((PMUInt32) 8U).uintValue () ;
    bool loop_7909 = true ;
    while (loop_7909) {
      loop_7909 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_7909) {
        loop_7909 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_7909 && (0 == variant_7909)) {
        loop_7909 = false ;
...
static void categoryMethod_baseline_5F_intermediate_5F_CALL_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @loopInstructionForGeneration
  if (GALGAS_uint ((PMUInt32) 8U).isValid ()) {
    PMUInt32 variant_9967 = GALGAS_uint ((PMUInt32) 8U).uintValue () ;
    bool loop_9967 = true ;
    while (loop_9967) {
      loop_9967 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_9967) {
        loop_9967 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_9967 && (0 == variant_9967)) {
        loop_9967 = false ;
