...
void routine_build_5F_baseline_5F_intermediate_5F_assembly_5F_code (const GALGAS_baseline_5F_intermediate_5F_instructionList constinArgument_inGeneratedInstructionList,
  ...
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_6915 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_6915.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateAssemblyCode ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_6915.current_mInstruction (HERE).ptr (), ioArgument_ioAssemblyInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (196)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_6915.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_7091 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7091.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_setEmitAddress (enumerator_7091.current_mRegisterAddress (HERE).add_operation (enumerator_7091.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
    routine_emitCode (enumerator_7091.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (201)) ;
    } //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_baseline_5F_intermediate_5F_instruction_5F_MNOP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (126)).isValid ()) {
    PMUInt32 variant_4496 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (126)).uintValue () ;
    bool loop_4496 = true ;
    while (loop_4496) {
      loop_4496 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (127)))).isValid () ;
      if (loop_4496) {
        loop_4496 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (127)))).boolValue () ;
      }
      if (loop_4496 && (0 == variant_4496)) {
        loop_4496 = false ;
