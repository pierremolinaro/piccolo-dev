...
void routine_build_5F_baseline_5F_assembly_5F_code (const GALGAS_baseline_5F_intermediate_5F_instructionList constinArgument_inGeneratedInstructionList,
  ...
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_14552 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_14552.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateAssemblyCode ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_14552.current_mInstruction (HERE).ptr (), constinArgument_inSTATUSregister, constinArgument_inStatusRegisterBitSliceTable, ioArgument_ioAssemblyInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_14552.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_14777 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_14777.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_setEmitAddress (enumerator_14777.current_mRegisterAddress (HERE).add_operation (enumerator_14777.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
    routine_emitCode (enumerator_14777.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
    } //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_baseline_5F_intermediate_5F_instruction_5F_MNOP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (182)).isValid ()) {
    PMUInt32 variant_7209 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (182)).uintValue () ;
    bool loop_7209 = true ;
    while (loop_7209) {
      loop_7209 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (183)))).isValid () ;
      if (loop_7209) {
        loop_7209 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (183)))).boolValue () ;
      }
...
static void categoryMethod_baseline_5F_intermediate_5F_JUMP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (GALGAS_uint ((PMUInt32) 8U).isValid ()) {
    PMUInt32 variant_8380 = GALGAS_uint ((PMUInt32) 8U).uintValue () ;
    bool loop_8380 = true ;
    while (loop_8380) {
      loop_8380 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_8380) {
        loop_8380 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_8380 && (0 == variant_8380)) {
        loop_8380 = false ;
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_12876 (var_pageRestoreInstructions, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12876.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioAssemblyInstructionList.addAssign_operation (enumerator_12876.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (333)) ;
