...
void routine_build_5F_baseline_5F_assembly_5F_code (const GALGAS_baseline_5F_intermediate_5F_instructionList constinArgument_inGeneratedInstructionList,
  ...
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_14544 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_14544.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateAssemblyCode ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_14544.current_mInstruction (HERE).ptr (), constinArgument_inSTATUSregister, constinArgument_inStatusRegisterBitSliceTable, ioArgument_ioAssemblyInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_14544.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_14769 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_14769.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_setEmitAddress (enumerator_14769.current_mRegisterAddress (HERE).add_operation (enumerator_14769.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
    routine_emitCode (enumerator_14769.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
    } //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_baseline_5F_intermediate_5F_instruction_5F_MNOP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (182)).isValid ()) {
    PMUInt32 variant_7201 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (182)).uintValue () ;
    bool loop_7201 = true ;
    while (loop_7201) {
      loop_7201 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (183)))).isValid () ;
      if (loop_7201) {
        loop_7201 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (183)))).boolValue () ;
      }
      if (loop_7201 && (0 == variant_7201)) {
        loop_7201 = false ;
...
static void categoryMethod_baseline_5F_intermediate_5F_JUMP_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  if (GALGAS_uint ((PMUInt32) 8U).isValid ()) {
    PMUInt32 variant_8372 = GALGAS_uint ((PMUInt32) 8U).uintValue () ;
    bool loop_8372 = true ;
    while (loop_8372) {
      loop_8372 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_8372) {
        loop_8372 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_generateAssemblyCode (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @loopInstructionForGeneration
  if (GALGAS_uint ((PMUInt32) 8U).isValid ()) {
    PMUInt32 variant_10967 = GALGAS_uint ((PMUInt32) 8U).uintValue () ;
    bool loop_10967 = true ;
    while (loop_10967) {
      loop_10967 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_10967) {
        loop_10967 = GALGAS_bool (kIsNotEqual, var_pageChangeFlags.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_12868 (var_pageRestoreInstructions, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12868.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioAssemblyInstructionList.addAssign_operation (enumerator_12868.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (333)) ;
