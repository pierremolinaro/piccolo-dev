...
void routine_build_5F_baseline_5F_binary_5F_code (const GALGAS_baseline_5F_assembly_5F_instructionList constinArgument_inAssemblyInstructionList,
  ...
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_12843 (constinArgument_inAssemblyInstructionList, kEnumeration_up) ;
  while (enumerator_12843.hasCurrentObject ()) {
    callCategoryMethod_enterLabelAtAddress ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_12843.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentWordAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (354)) ;
  ...
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_13182 (constinArgument_inAssemblyInstructionList, kEnumeration_up) ;
  while (enumerator_13182.hasCurrentObject ()) {
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_13182.current_mInstruction (HERE).ptr (), var_symbolTable, ioArgument_ioListFileContents, var_currentWordAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (362)) ;
    {
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentWordAddress.reader_hexString (SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (370)).operator_concat (GALGAS_string (" value in second pass, while it gets ") COMMA_SOURCE_FILE_AT_LINE (370)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string (" value in first pass") COMMA_SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (370)) ;
    ...
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Program too large: ").operator_concat (var_lastAddressForFirstPass.reader_string (SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)).operator_concat (GALGAS_string (" bytes (rom size is ") COMMA_SOURCE_FILE_AT_LINE (374)).operator_concat (constinArgument_inROMsize.reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (375)).operator_concat (GALGAS_string (" bytes)") COMMA_SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (374)) ;
    }
  }
}
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_LABEL_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("Internal second pass error: the '").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)).operator_concat (GALGAS_string ("' label gets ") COMMA_SOURCE_FILE_AT_LINE (331)).operator_concat (ioArgument_ioWordAddress.reader_hexString (SOURCE_FILE_AT_LINE (332)) COMMA_SOURCE_FILE_AT_LINE (332)).operator_concat (GALGAS_string (" value in second pass, while it gets ") COMMA_SOURCE_FILE_AT_LINE (332)).operator_concat (var_targetAddress.reader_hexString (SOURCE_FILE_AT_LINE (333)) COMMA_SOURCE_FILE_AT_LINE (332)).operator_concat (GALGAS_string (" in first pass") COMMA_SOURCE_FILE_AT_LINE (333)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
  }
  {
  //--- @selfCopyInExpressionForGeneration
