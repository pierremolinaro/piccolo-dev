...
void routine_build_5F_baseline_5F_binary_5F_code (const GALGAS_baseline_5F_assembly_5F_instructionList constinArgument_inAssemblyInstructionList,
  ...
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_11935 (constinArgument_inAssemblyInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_11935.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterLabelAtAddress ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_11935.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentWordAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (341)) ;
    //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_12274 (constinArgument_inAssemblyInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12274.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_12274.current_mInstruction (HERE).ptr (), var_symbolTable, ioArgument_ioListFileContents, var_currentWordAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
