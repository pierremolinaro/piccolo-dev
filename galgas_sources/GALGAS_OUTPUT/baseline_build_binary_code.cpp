...
void routine_emitBaselineCodeAtWordAddress (const GALGAS_uint constinArgument_inCode,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("   ").operator_concat (categoryReader_x_34_String (ioArgument_ioWordAddress.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 15)), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 15))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 15))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 15)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" ").operator_concat (categoryReader_x_34_String (constinArgument_inCode, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 16))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 16)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 16))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 16)) ;
  callCategoryMethod_print ((const cPtr_baseline_5F_assembly_5F_instruction *) constinArgument_inInstruction.ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 17)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 18)) ;
  {
  routine_emitCode (constinArgument_inCode, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 19)) ;
  }
  ioArgument_ioWordAddress = ioArgument_ioWordAddress.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 20)) ;
}
...
void routine_emitNoBaselineCodeAtWordAddress (const GALGAS_uint constinArgument_inWordAddress,
                                              ...
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("   ").operator_concat (categoryReader_x_34_String (constinArgument_inWordAddress.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 30)), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 30))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 30))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 30)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("      ")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 31)) ;
  callCategoryMethod_print ((const cPtr_baseline_5F_assembly_5F_instruction *) constinArgument_inInstruction.ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 32)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 33)) ;
}
...
void routine_build_5F_baseline_5F_binary_5F_code (const GALGAS_baseline_5F_assembly_5F_instructionList constinArgument_inAssemblyInstructionList,
  ...
  GALGAS_baseline_5F_symbolTable var_symbolTable = GALGAS_baseline_5F_symbolTable::constructor_emptyMap (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 351)) ;
  GALGAS_uint var_currentWordAddress = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_12831 (constinArgument_inAssemblyInstructionList, kEnumeration_up) ;
  while (enumerator_12831.hasCurrentObject ()) {
    callCategoryMethod_enterLabelAtAddress ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_12831.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentWordAddress, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 354)) ;
  ...
  {
  routine_setEmitAddress (GALGAS_uint ((uint32_t) 0U), inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 360)) ;
  }
  cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_13170 (constinArgument_inAssemblyInstructionList, kEnumeration_up) ;
  while (enumerator_13170.hasCurrentObject ()) {
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_13170.current_mInstruction (HERE).ptr (), var_symbolTable, ioArgument_ioListFileContents, var_currentWordAddress, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 362)) ;
    {
    routine_checkCurrentEmitAddress (var_currentWordAddress.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 367)), inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 367)) ;
    }
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentWordAddress.reader_hexString (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 370))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 370)).operator_concat (GALGAS_string (" value in second pass, while it gets ")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 370)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 372))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 371)).operator_concat (GALGAS_string (" value in first pass")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 372))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 370)) ;
    ...
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Program too large: ").operator_concat (var_lastAddressForFirstPass.reader_string (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 374))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 374)).operator_concat (GALGAS_string (" bytes (rom size is ")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 374)).operator_concat (constinArgument_inROMsize.reader_string (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 376))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 375)).operator_concat (GALGAS_string (" bytes)")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 376))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 374)) ;
    }
  }
}
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_LABEL_enterLabelAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  {
  ioArgument_ioRoutineSymbolTable.modifier_insertKey (object->mAttribute_mLabel, ioArgument_ioWordAddress, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 62)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_actualInstruction_enterLabelAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioWordAddress = ioArgument_ioWordAddress.add_operation (callCategoryReader_length ((const cPtr_baseline_5F_assembly_5F_actualInstruction *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 80)), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 80)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_BEGINOFROUTINE_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mIsRegular.operator_and (GALGAS_bool (kIsNotEqual, ioArgument_ioWordAddress.operator_and (GALGAS_uint ((uint32_t) 256U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 102)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 102)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mRoutineName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 8th bit of the routine address is not 0; a regular routine should be begin in the first half of a page")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 103)) ;
  }
  {
  const GALGAS_baseline_5F_assembly_5F_pseudo_5F_BEGINOFROUTINE temp_2 = object ;
  routine_emitNoBaselineCodeAtWordAddress (ioArgument_ioWordAddress, temp_2, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 105)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_ENDOFROUTINE_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, ioArgument_ioWordAddress.objectCompare (object->mAttribute_mPage.multiply_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 115)).add_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 115)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mRoutineName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the routine is too large, it does not lie in page ").operator_concat (object->mAttribute_mPage.reader_string (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116)).operator_concat (ioArgument_ioWordAddress.substract_operation (object->mAttribute_mPage.multiply_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116)).add_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116)), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116)).reader_string (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116)).operator_concat (GALGAS_string (" word(s) in excess)")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 116)) ;
  }
  {
  const GALGAS_baseline_5F_assembly_5F_pseudo_5F_ENDOFROUTINE temp_2 = object ;
  routine_emitNoBaselineCodeAtWordAddress (ioArgument_ioWordAddress, temp_2, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 118)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_ORG_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioWordAddress = object->mAttribute_mOrigin ;
  {
  routine_setEmitAddress (object->mAttribute_mOrigin.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 129)), inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 129)) ;
  }
  {
  const GALGAS_baseline_5F_assembly_5F_pseudo_5F_ORG temp_0 = object ;
  routine_emitNoBaselineCodeAtWordAddress (ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 130)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_FD_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_m_5F_W_5F_isDestination.operator_not (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 158)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((uint32_t) 32U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 159)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 161)).operator_and (GALGAS_uint ((uint32_t) 31U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 161)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 161)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_instruction_5F_FD temp_1 = object ;
  routine_emitBaselineCodeAtWordAddress (var_code, ioArgument_ioWordAddress, temp_1, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 162)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_F_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 177)).operator_and (GALGAS_uint ((uint32_t) 31U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 177)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 177)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_instruction_5F_F temp_0 = object ;
  routine_emitBaselineCodeAtWordAddress (var_code, ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 178)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_FB_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 193)).operator_and (GALGAS_uint ((uint32_t) 31U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 193)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 193)) ;
  var_code = var_code.operator_or (object->mAttribute_mBitNumber.left_shift_operation (GALGAS_uint ((uint32_t) 5U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 194)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 194)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_instruction_5F_FB temp_0 = object ;
  routine_emitBaselineCodeAtWordAddress (var_code, ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 195)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_BitTestSkip_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 212)).operator_and (GALGAS_uint ((uint32_t) 31U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 212)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 212)) ;
  var_code = var_code.operator_or (object->mAttribute_mBitNumber.left_shift_operation (GALGAS_uint ((uint32_t) 5U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 213)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 213)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_instruction_5F_BitTestSkip temp_1 = object ;
  routine_emitBaselineCodeAtWordAddress (var_code, ioArgument_ioWordAddress, temp_1, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 214)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_GOTO_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 225)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_GOTO temp_0 = object ;
  routine_emitBaselineCodeAtWordAddress (GALGAS_uint ((uint32_t) 2560U).operator_or (var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 511U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 227)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 227)), ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 227)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_SKIP_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  routine_emitBaselineCodeAtWordAddress (GALGAS_uint ((uint32_t) 2560U).operator_or (ioArgument_ioWordAddress.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 237)).operator_and (GALGAS_uint ((uint32_t) 511U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 237)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 237)), ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 237)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_CALL_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 249)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_CALL temp_0 = object ;
  routine_emitBaselineCodeAtWordAddress (GALGAS_uint ((uint32_t) 2304U).operator_or (var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 255U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 251)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 251)), ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 251)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_incDecRegisterInCondition_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  const enumGalgasBool test_1 = object->mAttribute_m_5F_W_5F_isDestination.operator_not (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 267)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_code = var_code.operator_or (GALGAS_uint ((uint32_t) 32U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 268)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 270)).operator_and (GALGAS_uint ((uint32_t) 31U) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 270)) COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 270)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_incDecRegisterInCondition temp_2 = object ;
  routine_emitBaselineCodeAtWordAddress (var_code, ioArgument_ioWordAddress, temp_2, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 271)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_WO_5F_OPERAND_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  routine_emitBaselineCodeAtWordAddress (var_code, ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 289)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_TRIS_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  routine_emitBaselineCodeAtWordAddress (object->mAttribute_mOpcode, ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 299)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_literalOperation_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  var_code = var_code.operator_or (object->mAttribute_mLiteralValue COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 317)) ;
  {
  const GALGAS_baseline_5F_assembly_5F_instruction_5F_literalOperation temp_0 = object ;
  routine_emitBaselineCodeAtWordAddress (var_code, ioArgument_ioWordAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 318)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_LABEL_generateBinaryCodeAtAddress (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  macroValidSharedObject (object, cPtr_baseline_5F_assembly_5F_pseudo_5F_LABEL) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 329)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("Internal second pass error: the '").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 331))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 331)).operator_concat (GALGAS_string ("' label gets ")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 331)).operator_concat (ioArgument_ioWordAddress.reader_hexString (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 332))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 332)).operator_concat (GALGAS_string (" value in second pass, while it gets ")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 332)).operator_concat (var_targetAddress.reader_hexString (SOURCE_FILE ("baseline_build_binary_code.gSemantics", 333))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 332)).operator_concat (GALGAS_string (" in first pass")  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 333))  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 331)) ;
  }
  {
  const GALGAS_baseline_5F_assembly_5F_pseudo_5F_LABEL temp_2 = object ;
  routine_emitNoBaselineCodeAtWordAddress (ioArgument_ioWordAddress, temp_2, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("baseline_build_binary_code.gSemantics", 335)) ;
  }
}
//-----------------------------------------------------------------------------*
