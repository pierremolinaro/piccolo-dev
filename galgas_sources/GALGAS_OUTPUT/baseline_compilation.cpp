...
void routine_baseline_5F_analysis (const GALGAS_baseline_5F_model constinArgument_inPiccoloModel,
  ...
  if (kBoolTrue == test_46) {
    ...
    GALGAS_bool joker_17111_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_17111_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (383)) ;
  }
  ...
  if (kBoolTrue == test_47) {
    ...
    GALGAS_bool joker_17755_0 ; // Joker input parameter
    var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_17755_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
    ...
    if (kBoolTrue == test_48) {
      ...
      GALGAS_bool joker_18125_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_18125_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (405)) ;
      {
      ...
      GALGAS_bool joker_18326_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_18326_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (408)) ;
    }
    ...
    if (kBoolTrue == test_49) {
      ...
      cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_19435 (var_assemblyInstructionList, kEnumeration_up) ;
      while (enumerator_19435.hasCurrentObject ()) {
        callCategoryMethod_print ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_19435.current_mInstruction (HERE).ptr (), var_assemblyCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (429)) ;
      ...
      cEnumerator_registerTable enumerator_19608 (var_registerTable, kEnumeration_up) ;
      while (enumerator_19608.hasCurrentObject ()) {
        GALGAS_uint var_address ;
        enumerator_19608.current_mRegisterAddressList (HERE).method_first (var_address, inCompiler COMMA_SOURCE_FILE_AT_LINE (434)) ;
        var_assemblyCode.dotAssign_operation (enumerator_19608.current_lkey (HERE).mAttribute_string.operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (435)).operator_concat (var_address.reader_hexString (SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) ;
      ...
      cEnumerator_actualConfigurationMap enumerator_19885 (var_actualConfigurationMap, kEnumeration_up) ;
      while (enumerator_19885.hasCurrentObject ()) {
        var_assemblyCode.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_19885.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (enumerator_19885.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (440)).reader_hexString (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)) ;
      ...
      var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_20235_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
    }
