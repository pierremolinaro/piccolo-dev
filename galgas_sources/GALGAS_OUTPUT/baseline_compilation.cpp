...
void routine_baseline_5F_analysis (const GALGAS_baseline_5F_model constinArgument_inPiccoloModel,
  ...
  GALGAS_uint var_totalPageCount = var_piccoloDeviceModel.mAttribute_mRomSize.reader_uint (SOURCE_FILE_AT_LINE (191)).add_operation (GALGAS_uint ((uint32_t) 511U), inCompiler COMMA_SOURCE_FILE_AT_LINE (191)).divide_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE_AT_LINE (191)) ;
  ...
  while (enumerator_8265.hasCurrentObject ()) {
    const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, enumerator_8265.current_mPage (HERE).reader_uint (SOURCE_FILE_AT_LINE (193)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  ...
  const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (224)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          ...
          while (enumerator_9566.hasCurrentObject ()) {
            ...
            if (kBoolTrue == test_16) {
              ...
              if (kBoolTrue == test_18) {
                ...
                const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_9566.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (241)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
                ...
                const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_9566.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (250)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  ...
  const enumGalgasBool test_42 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (328)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_ouputListingFile.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (328)).boolEnum () ;
  if (kBoolTrue == test_42) {
    var_listFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (329)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (329)) COMMA_SOURCE_FILE_AT_LINE (329)) ;
    var_listFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("INTERMEDIATE INSTRUCTION LIST").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) ;
    var_listFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (331)).operator_concat (GALGAS_string ("\n"
    ...
    while (enumerator_14906.hasCurrentObject ()) {
      var_listFileContents.dotAssign_operation (index_14878.reader_string (SOURCE_FILE_AT_LINE (336)).reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 5U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (336)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)) ;
      var_listFileContents.dotAssign_operation (callCategoryReader_length ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_14906.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (337)).reader_string (SOURCE_FILE_AT_LINE (337)).reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 6U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)) ;
  ...
  const enumGalgasBool test_43 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (346)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (346)).boolEnum () ;
  ...
  GALGAS_registerExpression var_sr = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("STATUS"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (351)), GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (351)) COMMA_SOURCE_FILE_AT_LINE (351)) ;
  ...
  const enumGalgasBool test_44 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (359)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  ...
  const enumGalgasBool test_45 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (369)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_45) {
    var_listFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (370)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (370)) ;
    var_listFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("GENERATED CODE").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)) ;
    var_listFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_string ("\n"
  ...
  const enumGalgasBool test_47 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (388)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_47) {
    ...
    if (kBoolTrue == test_49) {
      ...
      while (enumerator_19907.hasCurrentObject ()) {
        var_assemblyCode.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_19907.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (441)).operator_concat (enumerator_19907.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((uint32_t) 255U) COMMA_SOURCE_FILE_AT_LINE (441)).reader_hexString (SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)) ;
...
static void categoryMethod_baseline_5F_instruction_5F_structured_5F_if_shouldTerminateWithMOVLW (const cPtr_baseline_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mThenInstructionList.reader_length (SOURCE_FILE_AT_LINE (57)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, object->mAttribute_mElseInstructionList.reader_length (SOURCE_FILE_AT_LINE (64)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
