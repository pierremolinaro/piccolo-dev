...
void routine_baseline_5F_analysis (const GALGAS_baseline_5F_model constinArgument_inPiccoloModel,
  ...
  cEnumerator_baseline_5F_routineDefinitionList enumerator_6367 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_6367.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_6367.current_mRoutineName (HERE), enumerator_6367.current_mIsNoReturn (HERE), enumerator_6367.current_mPage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
    }
  ...
  cEnumerator_constantDefinitionList enumerator_6827 (constinArgument_inPiccoloModel.reader_mConstantDefinitionList (SOURCE_FILE_AT_LINE (162)), kEnumeration_up) ;
  while (enumerator_6827.hasCurrentObject ()) {
    GALGAS_sint_36__34_ var_result ;
    callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_6827.current_mExpression (HERE).ptr (), var_registerTable, var_constantMap, var_result, var_usedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (163)) ;
    const enumGalgasBool test_4 = var_registerTable.reader_hasKey (enumerator_6827.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_6827.current_mConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_6827.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (GALGAS_string ("' is already declared as ram register or special register") COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)) ;
    }else if (kBoolFalse == test_4) {
      {
      var_constantMap.modifier_insertKey (enumerator_6827.current_mConstantName (HERE), var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) ;
      }
    }
  ...
  cEnumerator_baseline_5F_routineDefinitionList enumerator_8268 (constinArgument_inPiccoloModel.reader_mRoutineDefinitionList (SOURCE_FILE_AT_LINE (192)), kEnumeration_up) ;
  while (enumerator_8268.hasCurrentObject ()) {
    const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, enumerator_8268.current_mPage (HERE).reader_uint (SOURCE_FILE_AT_LINE (193)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_11) {
      var_needsToSavePCLATH = GALGAS_bool (true) ;
    }
    const enumGalgasBool test_12 = GALGAS_bool (kIsSupOrEqual, enumerator_8268.current_mPage (HERE).reader_uint (SOURCE_FILE_AT_LINE (196)).objectCompare (var_totalPageCount)).boolEnum () ;
    if (kBoolTrue == test_12) {
      GALGAS_location location_13 (enumerator_8268.current_mPage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, GALGAS_string ("invalid value (").operator_concat (enumerator_8268.current_mPage (HERE).mAttribute_uint.reader_string (SOURCE_FILE_AT_LINE (197)) COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (GALGAS_string ("); the device has ") COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (var_totalPageCount.reader_string (SOURCE_FILE_AT_LINE (197)) COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (GALGAS_string (" 512 word page(s) on rom") COMMA_SOURCE_FILE_AT_LINE (197)) COMMA_SOURCE_FILE_AT_LINE (197)) ;
    }
  ...
  cEnumerator_baseline_5F_routineDefinitionList enumerator_8743 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_8743.hasCurrentObject ()) {
    const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_8743.current_mRoutineName (HERE).mAttribute_string.objectCompare (GALGAS_string ("main"))).boolEnum () ;
    if (kBoolTrue == test_14) {
      {
      var_sortedRoutineDefinitionList.modifier_insertAtIndex (enumerator_8743.current_mRoutineName (HERE), enumerator_8743.current_mPage (HERE), enumerator_8743.current_mIsNoReturn (HERE), enumerator_8743.current_mInstructionList (HERE), enumerator_8743.current_mEndOfRoutineLocation (HERE), GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
      }
    }else if (kBoolFalse == test_14) {
      var_sortedRoutineDefinitionList.addAssign_operation (enumerator_8743.current_mRoutineName (HERE), enumerator_8743.current_mPage (HERE), enumerator_8743.current_mIsNoReturn (HERE), enumerator_8743.current_mInstructionList (HERE), enumerator_8743.current_mEndOfRoutineLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (213)) ;
    }
  ...
  if (kBoolTrue == test_15) {
    ...
    if (var_totalPageCount.isValid ()) {
      PMUInt32 variant_9439 = var_totalPageCount.uintValue () ;
      bool loop_9439 = true ;
      while (loop_9439) {
        loop_9439 = GALGAS_bool (kIsStrictInf, var_currentPage.objectCompare (var_totalPageCount)).isValid () ;
        if (loop_9439) {
          loop_9439 = GALGAS_bool (kIsStrictInf, var_currentPage.objectCompare (var_totalPageCount)).boolValue () ;
        }
        if (loop_9439 && (0 == variant_9439)) {
          loop_9439 = false ;
        ...
        if (loop_9439) {
          ...
          cEnumerator_baseline_5F_routineDefinitionList enumerator_9569 (var_sortedRoutineDefinitionList, kEnumeration_up) ;
          while (enumerator_9569.hasCurrentObject ()) {
            const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_9569.current_mPage (HERE).reader_uint (SOURCE_FILE_AT_LINE (230)).objectCompare (var_currentPage)).boolEnum () ;
            if (kBoolTrue == test_16) {
              ...
              const enumGalgasBool test_18 = enumerator_9569.current_mIsNoReturn (HERE).boolEnum () ;
              if (kBoolTrue == test_18) {
                var_routineKind = GALGAS_routineKind::constructor_noReturnRoutine (SOURCE_FILE_AT_LINE (239)) ;
                const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_9569.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (241)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
                if (kBoolTrue == test_19) {
                  GALGAS_location location_20 (enumerator_9569.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  ...
                  enumerator_9569.current_mInstructionList (HERE).method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (244)) ;
                ...
                const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_9569.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (250)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
                if (kBoolTrue == test_21) {
                  GALGAS_location location_22 (enumerator_9569.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  ...
                  GALGAS_baseline_5F_instruction var_lastInstruction ;
                  enumerator_9569.current_mInstructionList (HERE).method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)) ;
              ...
              const enumGalgasBool test_23 = GALGAS_bool (kIsNotEqual, enumerator_9569.current_mRoutineName (HERE).mAttribute_string.objectCompare (GALGAS_string ("main"))).boolEnum () ;
              if (kBoolTrue == test_23) {
                var_intermediateInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE::constructor_new (enumerator_9569.current_mRoutineName (HERE), enumerator_9569.current_mIsNoReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)) ;
                var_intermediateInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (enumerator_9569.current_mRoutineName (HERE) COMMA_SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (260)) ;
              }
              GALGAS_bool var_continuesInSequence ;
              {
              routine_handleBaselineInstructionList (var_currentPage, enumerator_9569.current_mInstructionList (HERE), var_routineMap, var_registerTable, var_constantMap, var_localLabelIndex, var_intermediateInstructionList, var_listFileContents, var_continuesInSequence, var_routineKind, enumerator_9569.current_mIsNoReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (273)), var_usedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) ;
              }
              var_intermediateInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_END_5F_ROUTINE::constructor_new (enumerator_9569.current_mRoutineName (HERE), var_currentPage COMMA_SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276)) ;
              const enumGalgasBool test_24 = enumerator_9569.current_mIsNoReturn (HERE).operator_and (var_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (277)).boolEnum () ;
              if (kBoolTrue == test_24) {
                GALGAS_location location_25 (enumerator_9569.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_baseline_5F_routineDefinitionList enumerator_12403 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_12403.hasCurrentObject ()) {
    {
    var_declaredRoutineMap.modifier_insertKey (enumerator_12403.current_mRoutineName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (291)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_12632 (constinArgument_inPiccoloModel.mAttribute_mUnusedRoutineList, kEnumeration_up) ;
  while (enumerator_12632.hasCurrentObject ()) {
    const enumGalgasBool test_26 = var_declaredRoutineMap.reader_hasKey (enumerator_12632.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (296)).operator_not (SOURCE_FILE_AT_LINE (296)).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_location location_27 (enumerator_12632.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").operator_concat (enumerator_12632.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (297)) COMMA_SOURCE_FILE_AT_LINE (297)).operator_concat (GALGAS_string ("' routine is not declared") COMMA_SOURCE_FILE_AT_LINE (297)) COMMA_SOURCE_FILE_AT_LINE (297)) ;
    }else if (kBoolFalse == test_26) {
      const enumGalgasBool test_28 = var_unusedRoutineDeclarationUnicity.reader_hasKey (enumerator_12632.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (298)).boolEnum () ;
      if (kBoolTrue == test_28) {
        GALGAS_location location_29 (enumerator_12632.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_29, GALGAS_string ("the '").operator_concat (enumerator_12632.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (299)) COMMA_SOURCE_FILE_AT_LINE (299)).operator_concat (GALGAS_string ("' routine is already declared as unused") COMMA_SOURCE_FILE_AT_LINE (299)) COMMA_SOURCE_FILE_AT_LINE (299)) ;
      }else if (kBoolFalse == test_28) {
        const enumGalgasBool test_30 = var_usedRoutineSet.reader_hasKey (enumerator_12632.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (300)).boolEnum () ;
        if (kBoolTrue == test_30) {
          GALGAS_location location_31 (enumerator_12632.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_31, GALGAS_string ("the '").operator_concat (enumerator_12632.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (301)) COMMA_SOURCE_FILE_AT_LINE (301)).operator_concat (GALGAS_string ("' routine is declared as unused, but is used") COMMA_SOURCE_FILE_AT_LINE (301)) COMMA_SOURCE_FILE_AT_LINE (301)) ;
        }
      }
    }
    var_unusedRoutineDeclarationUnicity.addAssign_operation (enumerator_12632.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (303)) ;
    enumerator_12632.gotoNextObject () ;
  }
  cEnumerator_baseline_5F_declaredRoutineMap enumerator_13184 (var_declaredRoutineMap, kEnumeration_up) ;
  while (enumerator_13184.hasCurrentObject ()) {
    const enumGalgasBool test_32 = var_usedRoutineSet.reader_hasKey (enumerator_13184.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (306)).operator_not (SOURCE_FILE_AT_LINE (306)).operator_and (var_unusedRoutineDeclarationUnicity.reader_hasKey (enumerator_13184.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (306)).operator_not (SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)).boolEnum () ;
    if (kBoolTrue == test_32) {
      GALGAS_location location_33 (enumerator_13184.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_33, GALGAS_string ("the '").operator_concat (enumerator_13184.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307)).operator_concat (GALGAS_string ("' routine is unused") COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_13585 (constinArgument_inPiccoloModel.mAttribute_mUnusedRegisterList, kEnumeration_up) ;
  while (enumerator_13585.hasCurrentObject ()) {
    const enumGalgasBool test_34 = var_registerTable.reader_hasKey (enumerator_13585.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (313)).operator_not (SOURCE_FILE_AT_LINE (313)).boolEnum () ;
    if (kBoolTrue == test_34) {
      GALGAS_location location_35 (enumerator_13585.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_35, GALGAS_string ("the '").operator_concat (enumerator_13585.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)).operator_concat (GALGAS_string ("' byte is not declared") COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)) ;
    }else if (kBoolFalse == test_34) {
      const enumGalgasBool test_36 = var_unusedDeclarationUnicity.reader_hasKey (enumerator_13585.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (315)).boolEnum () ;
      if (kBoolTrue == test_36) {
        GALGAS_location location_37 (enumerator_13585.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_37, GALGAS_string ("the '").operator_concat (enumerator_13585.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (316)) COMMA_SOURCE_FILE_AT_LINE (316)).operator_concat (GALGAS_string ("' byte is already declared as unused") COMMA_SOURCE_FILE_AT_LINE (316)) COMMA_SOURCE_FILE_AT_LINE (316)) ;
      }else if (kBoolFalse == test_36) {
        const enumGalgasBool test_38 = var_usedRegisters.reader_hasKey (enumerator_13585.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (317)).boolEnum () ;
        if (kBoolTrue == test_38) {
          GALGAS_location location_39 (enumerator_13585.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_39, GALGAS_string ("the '").operator_concat (enumerator_13585.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (318)) COMMA_SOURCE_FILE_AT_LINE (318)).operator_concat (GALGAS_string ("' byte is declared as unused, but is used") COMMA_SOURCE_FILE_AT_LINE (318)) COMMA_SOURCE_FILE_AT_LINE (318)) ;
        }
      }
    }
    var_unusedDeclarationUnicity.addAssign_operation (enumerator_13585.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (320)) ;
    enumerator_13585.gotoNextObject () ;
  }
  cEnumerator_declaredByteMap enumerator_14105 (var_declaredByteMap, kEnumeration_up) ;
  while (enumerator_14105.hasCurrentObject ()) {
    const enumGalgasBool test_40 = var_usedRegisters.reader_hasKey (enumerator_14105.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (323)).operator_not (SOURCE_FILE_AT_LINE (323)).operator_and (var_unusedDeclarationUnicity.reader_hasKey (enumerator_14105.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (323)).operator_not (SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (323)).boolEnum () ;
    if (kBoolTrue == test_40) {
      GALGAS_location location_41 (enumerator_14105.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_41, GALGAS_string ("the '").operator_concat (enumerator_14105.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (324)) COMMA_SOURCE_FILE_AT_LINE (324)).operator_concat (GALGAS_string ("' byte is unused") COMMA_SOURCE_FILE_AT_LINE (324)) COMMA_SOURCE_FILE_AT_LINE (324)) ;
    }
  ...
  if (kBoolTrue == test_42) {
    ...
    cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_14912 (var_intermediateInstructionList, kEnumeration_up) ;
    GALGAS_uint index_14906 ((PMUInt32) 0) ;
    while (enumerator_14912.hasCurrentObject ()) {
      var_listFileContents.dotAssign_operation (index_14906.reader_string (SOURCE_FILE_AT_LINE (336)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 5U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (336)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)) ;
      var_listFileContents.dotAssign_operation (callCategoryReader_length ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_14912.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (337)).reader_string (SOURCE_FILE_AT_LINE (337)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 6U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)) ;
      callCategoryMethod_print ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_14912.current_mInstruction (HERE).ptr (), var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (338)) ;
      var_listFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (339)) ;
      callCategoryMethod_setCurrentAddress ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_14912.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (340)) ;
      enumerator_14912.gotoNextObject () ;
      index_14906.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
    }
  ...
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) var_sr.ptr (), var_registerTable, var_statusRegister, var_statusRegisterBitSliceTable, var_usedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (351)) ;
  GALGAS_baseline_5F_assembly_5F_instructionList var_assemblyInstructionList = GALGAS_baseline_5F_assembly_5F_instructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (357)) ;
  const enumGalgasBool test_44 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (358)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_44) {
    {
    routine_build_5F_baseline_5F_assembly_5F_code (var_intermediateInstructionList, var_actualConfigurationMap, var_statusRegister, var_statusRegisterBitSliceTable, var_assemblyInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (359)) ;
    }
  }
  const enumGalgasBool test_45 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (368)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_45) {
    var_listFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (369)) ;
    var_listFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("GENERATED CODE").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (370)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (370)) ;
    var_listFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string ("\n"
    ...
    {
    routine_build_5F_baseline_5F_binary_5F_code (var_assemblyInstructionList, var_piccoloDeviceModel.mAttribute_mRomSize.reader_uint (SOURCE_FILE_AT_LINE (375)), var_listFileContents, var_usedROMsize, inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
    }
  }
  const enumGalgasBool test_46 = GALGAS_bool (gOption_piccolo_5F_options_ouputListingFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_46) {
    GALGAS_string var_listFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (382)).operator_concat (GALGAS_string (".list") COMMA_SOURCE_FILE_AT_LINE (382)) ;
    GALGAS_bool joker_17112_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_17112_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (383)) ;
  }
  const enumGalgasBool test_47 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (387)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_47) {
    GALGAS_string var_contents ;
    {
    routine_getGeneratedContents (var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (398)) ;
    }
    GALGAS_string var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (399)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (399)) ;
    GALGAS_bool joker_17756_0 ; // Joker input parameter
    var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_17756_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
    const enumGalgasBool test_48 = GALGAS_bool (gOption_piccolo_5F_options_output_5F_C_5F_Array.reader_value ()).boolEnum () ;
    if (kBoolTrue == test_48) {
      GALGAS_string var_baseName = constinArgument_inSourceFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (402)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (402)) ;
      {
      routine_get_5F_C_5F_ArrayImplementation (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (403)) ;
      }
      var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (404)).operator_concat (GALGAS_string (".c") COMMA_SOURCE_FILE_AT_LINE (404)) ;
      GALGAS_bool joker_18126_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_18126_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (405)) ;
      {
      routine_get_5F_C_5F_ArrayHeader (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (406)) ;
      }
      var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (407)) ;
      GALGAS_bool joker_18327_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_18327_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (408)) ;
    }
    const enumGalgasBool test_49 = GALGAS_bool (gOption_piccolo_5F_options_generateAssembly.reader_value ()).boolEnum () ;
    if (kBoolTrue == test_49) {
      GALGAS_string var_assemblyCode = GALGAS_string ("  processor ").operator_concat (constinArgument_inPiccoloModel.mAttribute_mDeviceName.reader_string (SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427)).operator_concat (GALGAS_string ("\n"
        "\n") COMMA_SOURCE_FILE_AT_LINE (427)) ;
      cEnumerator_baseline_5F_assembly_5F_instructionList enumerator_19438 (var_assemblyInstructionList, kEnumeration_up) ;
      while (enumerator_19438.hasCurrentObject ()) {
        callCategoryMethod_print ((const cPtr_baseline_5F_assembly_5F_instruction *) enumerator_19438.current_mInstruction (HERE).ptr (), var_assemblyCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (429)) ;
      ...
      cEnumerator_registerTable enumerator_19611 (var_registerTable, kEnumeration_up) ;
      while (enumerator_19611.hasCurrentObject ()) {
        GALGAS_uint var_address ;
        enumerator_19611.current_mRegisterAddressList (HERE).method_first (var_address, inCompiler COMMA_SOURCE_FILE_AT_LINE (434)) ;
        var_assemblyCode.dotAssign_operation (enumerator_19611.current_lkey (HERE).mAttribute_string.operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (435)).operator_concat (var_address.reader_hexString (SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) ;
      ...
      cEnumerator_actualConfigurationMap enumerator_19888 (var_actualConfigurationMap, kEnumeration_up) ;
      while (enumerator_19888.hasCurrentObject ()) {
        var_assemblyCode.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_19888.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (enumerator_19888.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (440)).reader_hexString (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)) ;
        enumerator_19888.gotoNextObject () ;
      }
      var_assemblyCode.dotAssign_operation (GALGAS_string ("\n"
        "  END\n") COMMA_SOURCE_FILE_AT_LINE (442)) ;
      GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (443)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (443)) ;
      GALGAS_bool joker_20236_0 ; // Joker input parameter
      var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_20236_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
    }
  }else if (kBoolFalse == test_47) {
    GALGAS_string var_hexDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (447)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (447)) ;
    const enumGalgasBool test_50 = var_hexDestinationFile.reader_fileExists (SOURCE_FILE_AT_LINE (448)).boolEnum () ;
    if (kBoolTrue == test_50) {
      {
      GALGAS_string::class_method_deleteFile (var_hexDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) ;
      }
    }
    GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (451)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (451)) ;
    const enumGalgasBool test_51 = var_asmDestinationFile.reader_fileExists (SOURCE_FILE_AT_LINE (452)).boolEnum () ;
    if (kBoolTrue == test_51) {
      {
      GALGAS_string::class_method_deleteFile (var_asmDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (453)) ;
      }
    }
  }
}
