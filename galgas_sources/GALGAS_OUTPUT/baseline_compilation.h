...
//--- Current element access
  public : class GALGAS_baseline_5F_declaredRoutineMap_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_baseline_5F_declaredRoutineMap_2E_element constructor_new (const class GALGAS_lstring & inOperand0
                                                                                    COMMA_LOCATION_ARGS) ;
