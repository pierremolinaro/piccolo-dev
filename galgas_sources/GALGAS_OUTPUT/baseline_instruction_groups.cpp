...
//---------------------------------------------------------------------------*
//                                                                           *
//       Category Reader '@baseline_literal_instruction_opcode opcode'       *
//                                                                           *
//---------------------------------------------------------------------------*

GALGAS_uint categoryReader_opcode (const GALGAS_baseline_5F_literal_5F_instruction_5F_opcode & inObject,
                                   C_Compiler * /* inCompiler */
                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outBaseCode ; // Returned variable
  //------- @switchInstructionForGeneration
...
//---------------------------------------------------------------------------*
//                                                                           *
//           Category Reader '@baseline_IF_BitTest_opcode opcode'            *
//                                                                           *
//---------------------------------------------------------------------------*

GALGAS_uint categoryReader_opcode (const GALGAS_baseline_5F_IF_5F_BitTest_5F_opcode & inObject,
                                   C_Compiler * /* inCompiler */
                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outBaseCode ; // Returned variable
  //------- @switchInstructionForGeneration
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_baseline_5F_IF_5F_BitTest_5F_opcode::kEnum_BTFSS: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 7168U) ;
      } break ;
    case GALGAS_baseline_5F_IF_5F_BitTest_5F_opcode::kEnum_BTFSC: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 6144U) ;
      } break ;
    }
  }
//---
...
//---------------------------------------------------------------------------*
//                                                                           *
//            Category Reader '@baseline_WO_OPERAND_group opcode'            *
//                                                                           *
//---------------------------------------------------------------------------*

GALGAS_uint categoryReader_opcode (const GALGAS_baseline_5F_WO_5F_OPERAND_5F_group & inObject,
                                   C_Compiler * /* inCompiler */
                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outOpCode ; // Returned variable
  //------- @switchInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
