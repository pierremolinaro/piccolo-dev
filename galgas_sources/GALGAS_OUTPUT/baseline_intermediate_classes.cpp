...
typeComparisonResult cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE) ;
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::objectCompare (const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE (void) :
GALGAS_baseline_5F_intermediate_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE * inSourcePtr) :
GALGAS_baseline_5F_intermediate_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::constructor_new (const GALGAS_lstring & inAttribute_mRoutineName,
                                                                                                                          const GALGAS_uint & inAttribute_mPage
                                                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE result ;
  if (inAttribute_mRoutineName.isValid () && inAttribute_mPage.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE (inAttribute_mRoutineName, inAttribute_mPage COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE * p = (cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE) ;
    cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE (p->mAttribute_mRoutineName, p->mAttribute_mPage COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstring GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE) ;
...
GALGAS_lstring cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::reader_mPage (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE) ;
...
GALGAS_uint cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::reader_mPage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPage ;
}

//---------------------------------------------------------------------------*
//       Pointer class for @baseline_intermediate_pseudo_INPAGE class        *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE (const GALGAS_lstring & in_mRoutineName,
...
const C_galgas_type_descriptor * cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE ;
}

void cPtr_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::description (C_String & ioString,
                                                                     const PMSInt32 inIndentation) const {
  ioString << "[@baseline_intermediate_pseudo_INPAGE:" ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                 @baseline_intermediate_pseudo_INPAGE type                 *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE ("baseline_intermediate_pseudo_INPAGE",
                                                                     & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE::extractObject (const GALGAS_object & inObject,
                                                                                                                        C_Compiler * inCompiler,
                                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE result ;
  const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE * p = (const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_INPAGE *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_intermediate_pseudo_INPAGE", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
