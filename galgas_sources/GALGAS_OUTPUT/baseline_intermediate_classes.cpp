...
GALGAS_baseline_5F_intermediate_5F_CALL GALGAS_baseline_5F_intermediate_5F_CALL::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
  ...
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mTargetLabel.isValid () && inAttribute_mCurrentPage.isValid () && inAttribute_mTargetPage.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_intermediate_5F_CALL (inAttribute_mInstructionLocation, inAttribute_mTargetLabel, inAttribute_mCurrentPage, inAttribute_mTargetPage COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_intermediate_5F_CALL::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_baseline_5F_intermediate_5F_CALL (p->mAttribute_mInstructionLocation, p->mAttribute_mTargetLabel, p->mAttribute_mCurrentPage, p->mAttribute_mTargetPage COMMA_THERE)) ;
...
GALGAS_uint GALGAS_baseline_5F_intermediate_5F_CALL::reader_mCurrentPage (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_CALL * p = (const cPtr_baseline_5F_intermediate_5F_CALL *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_CALL) ;
...
GALGAS_uint cPtr_baseline_5F_intermediate_5F_CALL::reader_mCurrentPage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCurrentPage ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_baseline_5F_intermediate_5F_CALL::reader_mTargetPage (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_CALL * p = (const cPtr_baseline_5F_intermediate_5F_CALL *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_CALL) ;
...
GALGAS_uint cPtr_baseline_5F_intermediate_5F_CALL::reader_mTargetPage (UNUSED_LOCATION_ARGS) const {
...
GALGAS_baseline_5F_intermediate_5F_GOTO GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
  ...
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mTargetLabel.isValid () && inAttribute_mCurrentPage.isValid () && inAttribute_mTargetPage.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_intermediate_5F_GOTO (inAttribute_mInstructionLocation, inAttribute_mTargetLabel, inAttribute_mCurrentPage, inAttribute_mTargetPage COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_intermediate_5F_GOTO::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_baseline_5F_intermediate_5F_GOTO (p->mAttribute_mInstructionLocation, p->mAttribute_mTargetLabel, p->mAttribute_mCurrentPage, p->mAttribute_mTargetPage COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_uint GALGAS_baseline_5F_intermediate_5F_GOTO::reader_mCurrentPage (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_GOTO * p = (const cPtr_baseline_5F_intermediate_5F_GOTO *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_GOTO) ;
...
GALGAS_uint cPtr_baseline_5F_intermediate_5F_GOTO::reader_mCurrentPage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCurrentPage ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_baseline_5F_intermediate_5F_GOTO::reader_mTargetPage (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_GOTO * p = (const cPtr_baseline_5F_intermediate_5F_GOTO *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_GOTO) ;
...
GALGAS_uint cPtr_baseline_5F_intermediate_5F_GOTO::reader_mTargetPage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTargetPage ;
}
...
typeComparisonResult cPtr_baseline_5F_intermediate_5F_TRIS::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_TRIS) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_baseline_5F_intermediate_5F_actualInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_intermediate_5F_TRIS) ;
}
...
GALGAS_baseline_5F_intermediate_5F_TRIS GALGAS_baseline_5F_intermediate_5F_TRIS::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_intermediate_5F_TRIS *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_intermediate_TRIS", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE) ;
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::objectCompare (const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE (void) :
GALGAS_baseline_5F_intermediate_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE * inSourcePtr) :
GALGAS_baseline_5F_intermediate_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::constructor_new (const GALGAS_lstring & inAttribute_mRoutineName,
                                                                                                                                          const GALGAS_bool & inAttribute_mIsRegular
                                                                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE result ;
  if (inAttribute_mRoutineName.isValid () && inAttribute_mIsRegular.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE (inAttribute_mRoutineName, inAttribute_mIsRegular COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE * p = (cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE) ;
    cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE (p->mAttribute_mRoutineName, p->mAttribute_mIsRegular COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstring GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE) ;
...
GALGAS_lstring cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::reader_mIsRegular (UNUSED_LOCATION_ARGS) const {
  GALGAS_bool result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE) ;
...
GALGAS_bool cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::reader_mIsRegular (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsRegular ;
}

//---------------------------------------------------------------------------*
//   Pointer class for @baseline_intermediate_pseudo_BEGINOFROUTINE class    *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE (const GALGAS_lstring & in_mRoutineName,
...
const C_galgas_type_descriptor * cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE ;
}

void cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::description (C_String & ioString,
                                                                             const PMSInt32 inIndentation) const {
  ioString << "[@baseline_intermediate_pseudo_BEGINOFROUTINE:" ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//             @baseline_intermediate_pseudo_BEGINOFROUTINE type             *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE ("baseline_intermediate_pseudo_BEGINOFROUTINE",
                                                                             & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE::extractObject (const GALGAS_object & inObject,
                                                                                                                                        C_Compiler * inCompiler,
                                                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE result ;
  const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE * p = (const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_intermediate_pseudo_BEGINOFROUTINE", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE) ;
  if (kOperandEqual == result) {
    result = mAttribute_mRoutineName.objectCompare (p->mAttribute_mRoutineName) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::objectCompare (const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE (void) :
GALGAS_baseline_5F_intermediate_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE * inSourcePtr) :
GALGAS_baseline_5F_intermediate_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::constructor_new (const GALGAS_lstring & inAttribute_mRoutineName,
                                                                                                                                      const GALGAS_uint & inAttribute_mPage
                                                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE result ;
  if (inAttribute_mRoutineName.isValid () && inAttribute_mPage.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE (inAttribute_mRoutineName, inAttribute_mPage COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE * p = (cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE) ;
    cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE (p->mAttribute_mRoutineName, p->mAttribute_mPage COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstring GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE) ;
    result = p->mAttribute_mRoutineName ;
  }
  return result ;
...
GALGAS_lstring cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::reader_mPage (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE * p = (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE) ;
...
GALGAS_uint cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::reader_mPage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPage ;
}

//---------------------------------------------------------------------------*
//    Pointer class for @baseline_intermediate_pseudo_ENDOFROUTINE class     *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE (const GALGAS_lstring & in_mRoutineName,
...
const C_galgas_type_descriptor * cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE ;
}

void cPtr_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::description (C_String & ioString,
                                                                           const PMSInt32 inIndentation) const {
  ioString << "[@baseline_intermediate_pseudo_ENDOFROUTINE:" ;
  mAttribute_mRoutineName.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//              @baseline_intermediate_pseudo_ENDOFROUTINE type              *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE ("baseline_intermediate_pseudo_ENDOFROUTINE",
                                                                           & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE::extractObject (const GALGAS_object & inObject,
                                                                                                                                    C_Compiler * inCompiler,
                                                                                                                                    const GALGAS_location & inErrorLocation
                                                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE result ;
  const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE * p = (const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_intermediate_pseudo_ENDOFROUTINE", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
