...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category reader '@baseline_intermediate_pseudo_BEGINOFROUTINE length'*
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_uint categoryReader_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE_length (const cPtr_baseline_5F_intermediate_5F_instruction * /* inObject */,
                                                                                               C_Compiler * /* inCompiler */
                                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outLength ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE_length (void) {
  enterCategoryReader_length (kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE.mSlotID,
                              categoryReader_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE_length) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE_length (defineCategoryReader_baseline_5F_intermediate_5F_pseudo_5F_BEGINOFROUTINE_length, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category reader '@baseline_intermediate_pseudo_ENDOFROUTINE length'*
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_uint categoryReader_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE_length (const cPtr_baseline_5F_intermediate_5F_instruction * /* inObject */,
                                                                                             C_Compiler * /* inCompiler */
                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outLength ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE_length (void) {
  enterCategoryReader_length (kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE.mSlotID,
                              categoryReader_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE_length) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE_length (defineCategoryReader_baseline_5F_intermediate_5F_pseudo_5F_ENDOFROUTINE_length, NULL) ;
...
static GALGAS_uint categoryReader_baseline_5F_intermediate_5F_instruction_5F_MNOP_length (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outLength = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (54)) ;
//---
  return result_outLength ;
}
