...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_PAGE_print (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("ORG ").operator_concat (object->mAttribute_mPage.multiply_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE_AT_LINE (17)).reader_hexString (SOURCE_FILE_AT_LINE (17)) COMMA_SOURCE_FILE_AT_LINE (17)) COMMA_SOURCE_FILE_AT_LINE (17)) ;
}
//-----------------------------------------------------------------------------*
