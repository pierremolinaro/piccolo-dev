//---------------------------------------------------------------------------*
//                                                                           *
//                      File 'baseline_metamodel.cpp'                        *
//                        Generated by version 2.4.3                         *
//                      april 8th, 2013, at 15h24'31"                        *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "baseline_metamodel.gSemantics", line
...
void GALGAS_baseline_5F_instructionList::modifier_prependValue (GALGAS_baseline_5F_instruction inOperand0
                                                                COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_baseline_5F_instructionList (inOperand0 COMMA_THERE)) ;
...
GALGAS_baseline_5F_instructionList GALGAS_baseline_5F_instructionList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instructionList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instructionList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void GALGAS_baseline_5F_partList::modifier_prependValue (GALGAS_baseline_5F_conditionExpression inOperand0,
                                                         GALGAS_baseline_5F_instructionList inOperand1,
...
GALGAS_baseline_5F_partList GALGAS_baseline_5F_partList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_partList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_partList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void GALGAS_baseline_5F_routineDefinitionList::modifier_prependValue (GALGAS_lstring inOperand0,
                                                                      GALGAS_luint inOperand1,
                                                                      GALGAS_bool inOperand2,
                                                                      GALGAS_baseline_5F_instructionList inOperand3,
...
GALGAS_baseline_5F_routineDefinitionList GALGAS_baseline_5F_routineDefinitionList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_routineDefinitionList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_routineDefinitionList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//          Class for element of '@baselineRamDefinitionList' list           *
//                                                                           *
//---------------------------------------------------------------------------*

class cCollectionElement_baselineRamDefinitionList : public cCollectionElement {
  public : GALGAS_baselineRamDefinitionList_2E_element mObject ;

//--- Constructor
  public : cCollectionElement_baselineRamDefinitionList (const GALGAS_declarationInRam & in_mDeclaration
                                                         COMMA_LOCATION_ARGS) ;
...
cCollectionElement_baselineRamDefinitionList::cCollectionElement_baselineRamDefinitionList (const GALGAS_declarationInRam & in_mDeclaration
                                                                                            COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
...
bool cCollectionElement_baselineRamDefinitionList::isValid (void) const {
  return mObject.isValid () ;
}

//---------------------------------------------------------------------------*

cCollectionElement * cCollectionElement_baselineRamDefinitionList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_baselineRamDefinitionList (mObject.mAttribute_mDeclaration COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

void cCollectionElement_baselineRamDefinitionList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
typeComparisonResult cCollectionElement_baselineRamDefinitionList::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_baselineRamDefinitionList * operand = (cCollectionElement_baselineRamDefinitionList *) inOperand ;
  macroValidSharedObject (operand, cCollectionElement_baselineRamDefinitionList) ;
  return mObject.objectCompare (operand->mObject) ;
}

//---------------------------------------------------------------------------*

GALGAS_baselineRamDefinitionList::GALGAS_baselineRamDefinitionList (void) :
AC_GALGAS_list () {
}

//---------------------------------------------------------------------------*

GALGAS_baselineRamDefinitionList::GALGAS_baselineRamDefinitionList (cSharedList * inSharedListPtr) :
AC_GALGAS_list (inSharedListPtr) {
  if (NULL == inSharedListPtr) {
    createNewEmptyList (HERE) ;
  }
...
GALGAS_baselineRamDefinitionList GALGAS_baselineRamDefinitionList::constructor_emptyList (LOCATION_ARGS) {
  GALGAS_baselineRamDefinitionList result ;
  result.createNewEmptyList (THERE) ;
  return result ;
}
...
GALGAS_baselineRamDefinitionList GALGAS_baselineRamDefinitionList::constructor_listWithValue (const GALGAS_declarationInRam & inOperand0
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_baselineRamDefinitionList result ;
  if (inOperand0.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_baselineRamDefinitionList::makeAttributesFromObjects (attributes, inOperand0 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_baselineRamDefinitionList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                                  const GALGAS_declarationInRam & in_mDeclaration
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_baselineRamDefinitionList * p = NULL ;
  macroMyNew (p, cCollectionElement_baselineRamDefinitionList (in_mDeclaration COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_baselineRamDefinitionList::addAssign_operation (const GALGAS_declarationInRam & inOperand0
                                                            COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_baselineRamDefinitionList (inOperand0 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_baselineRamDefinitionList::modifier_prependValue (GALGAS_declarationInRam inOperand0
                                                              COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_baselineRamDefinitionList (inOperand0 COMMA_THERE)) ;
...
void GALGAS_baselineRamDefinitionList::modifier_popFirst (GALGAS_declarationInRam & outOperand0,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_baselineRamDefinitionList * p = (cCollectionElement_baselineRamDefinitionList *) attributes.ptr () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidSharedObject (p, cCollectionElement_baselineRamDefinitionList) ;
...
void GALGAS_baselineRamDefinitionList::modifier_popLast (GALGAS_declarationInRam & outOperand0,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeLastObject (attributes, inCompiler COMMA_THERE) ;
...
void GALGAS_baselineRamDefinitionList::method_first (GALGAS_declarationInRam & outOperand0,
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes ;
  readFirst (attributes, inCompiler COMMA_THERE) ;
...
void GALGAS_baselineRamDefinitionList::method_last (GALGAS_declarationInRam & outOperand0,
                                                    C_Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes ;
  readLast (attributes, inCompiler COMMA_THERE) ;
...
GALGAS_baselineRamDefinitionList GALGAS_baselineRamDefinitionList::operator_concat (const GALGAS_baselineRamDefinitionList & inOperand
                                                                                    COMMA_UNUSED_LOCATION_ARGS) const {
  GALGAS_baselineRamDefinitionList result ;
  if (isValid () && inOperand.isValid ()) {
    result = *this ;
...
GALGAS_baselineRamDefinitionList GALGAS_baselineRamDefinitionList::reader_subListWithRange (const GALGAS_range & inRange,
                                                                                            C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) const {
  GALGAS_baselineRamDefinitionList result = GALGAS_baselineRamDefinitionList::constructor_emptyList (THERE) ;
  subListWithRange (result, inRange, inCompiler COMMA_THERE) ;
  return result ;
}
...
GALGAS_baselineRamDefinitionList GALGAS_baselineRamDefinitionList::reader_subListFromIndex (const GALGAS_uint & inIndex,
                                                                                            C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) const {
  GALGAS_baselineRamDefinitionList result = GALGAS_baselineRamDefinitionList::constructor_emptyList (THERE) ;
  subListFromIndex (result, inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_baselineRamDefinitionList::dotAssign_operation (const GALGAS_baselineRamDefinitionList inOperand
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
GALGAS_declarationInRam GALGAS_baselineRamDefinitionList::reader_mDeclarationAtIndex (const GALGAS_uint & inIndex,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_baselineRamDefinitionList * p = (cCollectionElement_baselineRamDefinitionList *) attributes.ptr () ;
...
cEnumerator_baselineRamDefinitionList::cEnumerator_baselineRamDefinitionList (const GALGAS_baselineRamDefinitionList & inEnumeratedObject,
                                                                              const typeEnumerationOrder inOrder) :
cGenericAbstractEnumerator () {
  inEnumeratedObject.populateEnumerationArray (mEnumerationArray, inOrder) ;
}
...
GALGAS_baselineRamDefinitionList_2E_element cEnumerator_baselineRamDefinitionList::current (LOCATION_ARGS) const {
  const cCollectionElement_baselineRamDefinitionList * p = (const cCollectionElement_baselineRamDefinitionList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_baselineRamDefinitionList) ;
  return p->mObject ;
}
...
GALGAS_declarationInRam cEnumerator_baselineRamDefinitionList::current_mDeclaration (LOCATION_ARGS) const {
  const cCollectionElement_baselineRamDefinitionList * p = (const cCollectionElement_baselineRamDefinitionList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_baselineRamDefinitionList) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      @baselineRamDefinitionList type                      *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baselineRamDefinitionList ("baselineRamDefinitionList",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baselineRamDefinitionList::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baselineRamDefinitionList ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baselineRamDefinitionList::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baselineRamDefinitionList (*this)) ;
  }
  return result ;
}
...
GALGAS_baselineRamDefinitionList GALGAS_baselineRamDefinitionList::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_baselineRamDefinitionList result ;
  const GALGAS_baselineRamDefinitionList * p = (const GALGAS_baselineRamDefinitionList *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baselineRamDefinitionList *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baselineRamDefinitionList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_conditionExpression GALGAS_baseline_5F_conditionExpression::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_conditionExpression *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_conditionExpression", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_andCondition GALGAS_baseline_5F_andCondition::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_andCondition *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_andCondition", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_bitTest_5F_in_5F_structured_5F_if_5F_condition GALGAS_baseline_5F_bitTest_5F_in_5F_structured_5F_if_5F_condition::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_bitTest_5F_in_5F_structured_5F_if_5F_condition *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_bitTest_in_structured_if_condition", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_incDecRegisterInCondition GALGAS_baseline_5F_incDecRegisterInCondition::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_incDecRegisterInCondition *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_incDecRegisterInCondition", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_negateCondition GALGAS_baseline_5F_negateCondition::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_negateCondition *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_negateCondition", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction GALGAS_baseline_5F_instruction::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_CALL GALGAS_baseline_5F_instruction_5F_CALL::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_CALL *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_CALL", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_CLRW::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_CLRW * p = (const cPtr_baseline_5F_instruction_5F_CLRW *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_CLRW) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  return result ;
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_CLRW::objectCompare (const GALGAS_baseline_5F_instruction_5F_CLRW & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_CLRW::GALGAS_baseline_5F_instruction_5F_CLRW (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_CLRW::GALGAS_baseline_5F_instruction_5F_CLRW (const cPtr_baseline_5F_instruction_5F_CLRW * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_CLRW) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_CLRW GALGAS_baseline_5F_instruction_5F_CLRW::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_CLRW result ;
  if (inAttribute_mInstructionLocation.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_CLRW (inAttribute_mInstructionLocation COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_CLRW::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_CLRW * p = (cPtr_baseline_5F_instruction_5F_CLRW *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_CLRW) ;
    cPtr_baseline_5F_instruction_5F_CLRW * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_CLRW (p->mAttribute_mInstructionLocation COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
//---------------------------------------------------------------------------*
//            Pointer class for @baseline_instruction_CLRW class             *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_CLRW::cPtr_baseline_5F_instruction_5F_CLRW (const GALGAS_location & in_mInstructionLocation
                                                                            COMMA_LOCATION_ARGS) :
cPtr_baseline_5F_instruction (in_mInstructionLocation COMMA_THERE) {
}
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_CLRW::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_CLRW ;
}

void cPtr_baseline_5F_instruction_5F_CLRW::description (C_String & ioString,
                                                        const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_CLRW:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      @baseline_instruction_CLRW type                      *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_CLRW ("baseline_instruction_CLRW",
                                                        & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_CLRW::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_CLRW ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_CLRW::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_CLRW (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_CLRW GALGAS_baseline_5F_instruction_5F_CLRW::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_CLRW result ;
  const GALGAS_baseline_5F_instruction_5F_CLRW * p = (const GALGAS_baseline_5F_instruction_5F_CLRW *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_CLRW *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_CLRW", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_CLRWDT::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_CLRWDT * p = (const cPtr_baseline_5F_instruction_5F_CLRWDT *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_CLRWDT) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  return result ;
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_CLRWDT::objectCompare (const GALGAS_baseline_5F_instruction_5F_CLRWDT & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_CLRWDT::GALGAS_baseline_5F_instruction_5F_CLRWDT (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_CLRWDT::GALGAS_baseline_5F_instruction_5F_CLRWDT (const cPtr_baseline_5F_instruction_5F_CLRWDT * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_CLRWDT) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_CLRWDT GALGAS_baseline_5F_instruction_5F_CLRWDT::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_CLRWDT result ;
  if (inAttribute_mInstructionLocation.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_CLRWDT (inAttribute_mInstructionLocation COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_CLRWDT::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_CLRWDT * p = (cPtr_baseline_5F_instruction_5F_CLRWDT *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_CLRWDT) ;
    cPtr_baseline_5F_instruction_5F_CLRWDT * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_CLRWDT (p->mAttribute_mInstructionLocation COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
//---------------------------------------------------------------------------*
//           Pointer class for @baseline_instruction_CLRWDT class            *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_CLRWDT::cPtr_baseline_5F_instruction_5F_CLRWDT (const GALGAS_location & in_mInstructionLocation
                                                                                COMMA_LOCATION_ARGS) :
cPtr_baseline_5F_instruction (in_mInstructionLocation COMMA_THERE) {
}
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_CLRWDT::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_CLRWDT ;
}

void cPtr_baseline_5F_instruction_5F_CLRWDT::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_CLRWDT:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     @baseline_instruction_CLRWDT type                     *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_CLRWDT ("baseline_instruction_CLRWDT",
                                                          & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_CLRWDT::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_CLRWDT ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_CLRWDT::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_CLRWDT (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_CLRWDT GALGAS_baseline_5F_instruction_5F_CLRWDT::extractObject (const GALGAS_object & inObject,
                                                                                                  C_Compiler * inCompiler,
                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_CLRWDT result ;
  const GALGAS_baseline_5F_instruction_5F_CLRWDT * p = (const GALGAS_baseline_5F_instruction_5F_CLRWDT *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_CLRWDT *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_CLRWDT", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_F GALGAS_baseline_5F_instruction_5F_F::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_F *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_F", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_FB GALGAS_baseline_5F_instruction_5F_FB::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_FB *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_FB", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_FD GALGAS_baseline_5F_instruction_5F_FD::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_FD *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_FD", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_FOREVER GALGAS_baseline_5F_instruction_5F_FOREVER::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_FOREVER *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_FOREVER", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_GOTO GALGAS_baseline_5F_instruction_5F_GOTO::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_GOTO *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_GOTO", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_IF_5F_SEMI_5F_COLON GALGAS_baseline_5F_instruction_5F_IF_5F_SEMI_5F_COLON::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_IF_5F_SEMI_5F_COLON *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_IF_SEMI_COLON", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_IF_5F_BitTest GALGAS_baseline_5F_instruction_5F_IF_5F_BitTest::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_IF_5F_BitTest *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_IF_BitTest", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_IF_5F_IncDec GALGAS_baseline_5F_instruction_5F_IF_5F_IncDec::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_IF_5F_IncDec *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_IF_IncDec", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_MNOP GALGAS_baseline_5F_instruction_5F_MNOP::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_MNOP *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_MNOP", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_NOP::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_NOP * p = (const cPtr_baseline_5F_instruction_5F_NOP *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_NOP) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  return result ;
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_NOP::objectCompare (const GALGAS_baseline_5F_instruction_5F_NOP & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_NOP::GALGAS_baseline_5F_instruction_5F_NOP (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_NOP::GALGAS_baseline_5F_instruction_5F_NOP (const cPtr_baseline_5F_instruction_5F_NOP * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_NOP) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_NOP GALGAS_baseline_5F_instruction_5F_NOP::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_NOP result ;
  if (inAttribute_mInstructionLocation.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_NOP (inAttribute_mInstructionLocation COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_NOP::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_NOP * p = (cPtr_baseline_5F_instruction_5F_NOP *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_NOP) ;
    cPtr_baseline_5F_instruction_5F_NOP * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_NOP (p->mAttribute_mInstructionLocation COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
//---------------------------------------------------------------------------*
//             Pointer class for @baseline_instruction_NOP class             *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_NOP::cPtr_baseline_5F_instruction_5F_NOP (const GALGAS_location & in_mInstructionLocation
                                                                          COMMA_LOCATION_ARGS) :
cPtr_baseline_5F_instruction (in_mInstructionLocation COMMA_THERE) {
}
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_NOP::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_NOP ;
}

void cPtr_baseline_5F_instruction_5F_NOP::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_NOP:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      @baseline_instruction_NOP type                       *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_NOP ("baseline_instruction_NOP",
                                                       & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_NOP::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_NOP ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_NOP::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_NOP (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_NOP GALGAS_baseline_5F_instruction_5F_NOP::extractObject (const GALGAS_object & inObject,
                                                                                            C_Compiler * inCompiler,
                                                                                            const GALGAS_location & inErrorLocation
                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_NOP result ;
  const GALGAS_baseline_5F_instruction_5F_NOP * p = (const GALGAS_baseline_5F_instruction_5F_NOP *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_NOP *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_NOP", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_OPTION::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_OPTION * p = (const cPtr_baseline_5F_instruction_5F_OPTION *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_OPTION) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  return result ;
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_OPTION::objectCompare (const GALGAS_baseline_5F_instruction_5F_OPTION & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_OPTION::GALGAS_baseline_5F_instruction_5F_OPTION (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_OPTION::GALGAS_baseline_5F_instruction_5F_OPTION (const cPtr_baseline_5F_instruction_5F_OPTION * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_OPTION) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_OPTION GALGAS_baseline_5F_instruction_5F_OPTION::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_OPTION result ;
  if (inAttribute_mInstructionLocation.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_OPTION (inAttribute_mInstructionLocation COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_OPTION::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_OPTION * p = (cPtr_baseline_5F_instruction_5F_OPTION *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_OPTION) ;
    cPtr_baseline_5F_instruction_5F_OPTION * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_OPTION (p->mAttribute_mInstructionLocation COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
//---------------------------------------------------------------------------*
//           Pointer class for @baseline_instruction_OPTION class            *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_OPTION::cPtr_baseline_5F_instruction_5F_OPTION (const GALGAS_location & in_mInstructionLocation
                                                                                COMMA_LOCATION_ARGS) :
cPtr_baseline_5F_instruction (in_mInstructionLocation COMMA_THERE) {
}
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_OPTION::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_OPTION ;
}

void cPtr_baseline_5F_instruction_5F_OPTION::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_OPTION:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     @baseline_instruction_OPTION type                     *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_OPTION ("baseline_instruction_OPTION",
                                                          & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_OPTION::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_OPTION ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_OPTION::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_OPTION (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_OPTION GALGAS_baseline_5F_instruction_5F_OPTION::extractObject (const GALGAS_object & inObject,
                                                                                                  C_Compiler * inCompiler,
                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_OPTION result ;
  const GALGAS_baseline_5F_instruction_5F_OPTION * p = (const GALGAS_baseline_5F_instruction_5F_OPTION *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_OPTION *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_OPTION", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_baseline_5F_instruction_5F_SLEEP::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_baseline_5F_instruction_5F_SLEEP * p = (const cPtr_baseline_5F_instruction_5F_SLEEP *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_baseline_5F_instruction_5F_SLEEP) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  return result ;
...
typeComparisonResult GALGAS_baseline_5F_instruction_5F_SLEEP::objectCompare (const GALGAS_baseline_5F_instruction_5F_SLEEP & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_baseline_5F_instruction_5F_SLEEP::GALGAS_baseline_5F_instruction_5F_SLEEP (void) :
GALGAS_baseline_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_SLEEP::GALGAS_baseline_5F_instruction_5F_SLEEP (const cPtr_baseline_5F_instruction_5F_SLEEP * inSourcePtr) :
GALGAS_baseline_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_baseline_5F_instruction_5F_SLEEP) ;
}

//---------------------------------------------------------------------------*

GALGAS_baseline_5F_instruction_5F_SLEEP GALGAS_baseline_5F_instruction_5F_SLEEP::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_SLEEP result ;
  if (inAttribute_mInstructionLocation.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_baseline_5F_instruction_5F_SLEEP (inAttribute_mInstructionLocation COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_baseline_5F_instruction_5F_SLEEP::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_baseline_5F_instruction_5F_SLEEP * p = (cPtr_baseline_5F_instruction_5F_SLEEP *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_baseline_5F_instruction_5F_SLEEP) ;
    cPtr_baseline_5F_instruction_5F_SLEEP * r = NULL ;
    macroMyNew (r, cPtr_baseline_5F_instruction_5F_SLEEP (p->mAttribute_mInstructionLocation COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
//---------------------------------------------------------------------------*
//            Pointer class for @baseline_instruction_SLEEP class            *
//---------------------------------------------------------------------------*

cPtr_baseline_5F_instruction_5F_SLEEP::cPtr_baseline_5F_instruction_5F_SLEEP (const GALGAS_location & in_mInstructionLocation
                                                                              COMMA_LOCATION_ARGS) :
cPtr_baseline_5F_instruction (in_mInstructionLocation COMMA_THERE) {
}
...
const C_galgas_type_descriptor * cPtr_baseline_5F_instruction_5F_SLEEP::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_SLEEP ;
}

void cPtr_baseline_5F_instruction_5F_SLEEP::description (C_String & ioString,
                                                         const PMSInt32 inIndentation) const {
  ioString << "[@baseline_instruction_SLEEP:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     @baseline_instruction_SLEEP type                      *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_SLEEP ("baseline_instruction_SLEEP",
                                                         & kTypeDescriptor_GALGAS_baseline_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baseline_5F_instruction_5F_SLEEP::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baseline_5F_instruction_5F_SLEEP ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baseline_5F_instruction_5F_SLEEP::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baseline_5F_instruction_5F_SLEEP (*this)) ;
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_SLEEP GALGAS_baseline_5F_instruction_5F_SLEEP::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler,
                                                                                                const GALGAS_location & inErrorLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_baseline_5F_instruction_5F_SLEEP result ;
  const GALGAS_baseline_5F_instruction_5F_SLEEP * p = (const GALGAS_baseline_5F_instruction_5F_SLEEP *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_SLEEP *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_SLEEP", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_do_5F_while GALGAS_baseline_5F_instruction_5F_do_5F_while::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_do_5F_while *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_do_while", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_literalOperation GALGAS_baseline_5F_instruction_5F_literalOperation::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_literalOperation *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_literalOperation", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instruction_5F_structured_5F_if GALGAS_baseline_5F_instruction_5F_structured_5F_if::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instruction_5F_structured_5F_if *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instruction_structured_if", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//       Category Reader '@baseline_instruction_FD_base_code basecode'       *
//                                                                           *
//---------------------------------------------------------------------------*

GALGAS_uint categoryReader_basecode (const GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code & inObject,
                                     C_Compiler * /* inCompiler */
                                     COMMA_UNUSED_LOCATION_ARGS) {
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_ADDWF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 448U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_ANDWF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 320U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_COMF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 576U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_DECF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 192U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_DECFSZ: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 704U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_INCF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 640U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_INCFSZ: {
      //-------- @assignmentInstructionForGeneration
    ...
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_IORWF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 256U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_MOVF: {
      //-------- @assignmentInstructionForGeneration
    ...
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_RLF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 832U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_RRF: {
      //-------- @assignmentInstructionForGeneration
    ...
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_SWAPF: {
      //-------- @assignmentInstructionForGeneration
      result_outBaseCode = GALGAS_uint ((PMUInt32) 896U) ;
      } break ;
    case GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::kEnum_XORWF: {
      //-------- @assignmentInstructionForGeneration
...
GALGAS_baseline_5F_model::GALGAS_baseline_5F_model (const GALGAS_lstring & inOperand0,
                                                    ...
                                                    const GALGAS_baselineRamDefinitionList & inOperand4,
...
GALGAS_bool GALGAS_baseline_5F_model::reader_mAcceptDefaultConfiguration (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAcceptDefaultConfiguration ;
}

//---------------------------------------------------------------------------*

GALGAS_baselineRamDefinitionList GALGAS_baseline_5F_model::reader_mRamDefinitionList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_baseline_5F_model GALGAS_baseline_5F_model::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_model *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_model", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_instructionList_2E_element GALGAS_baseline_5F_instructionList_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_instructionList_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_instructionList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_partList_2E_element GALGAS_baseline_5F_partList_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_partList_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_partList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baseline_5F_routineDefinitionList_2E_element GALGAS_baseline_5F_routineDefinitionList_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baseline_5F_routineDefinitionList_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "baseline_routineDefinitionList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_baselineRamDefinitionList_2E_element::GALGAS_baselineRamDefinitionList_2E_element (void) :
...
GALGAS_baselineRamDefinitionList_2E_element::GALGAS_baselineRamDefinitionList_2E_element (const GALGAS_declarationInRam & inOperand0) :
mAttribute_mDeclaration (inOperand0) {
}

//---------------------------------------------------------------------------*

GALGAS_baselineRamDefinitionList_2E_element GALGAS_baselineRamDefinitionList_2E_element::constructor_new (const GALGAS_declarationInRam & inOperand0 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_baselineRamDefinitionList_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_baselineRamDefinitionList_2E_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_baselineRamDefinitionList_2E_element::objectCompare (const GALGAS_baselineRamDefinitionList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_baselineRamDefinitionList_2E_element::isValid (void) const {
  return mAttribute_mDeclaration.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_baselineRamDefinitionList_2E_element::drop (void) {
  mAttribute_mDeclaration.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_baselineRamDefinitionList_2E_element::description (C_String & ioString,
                                                               const PMSInt32 inIndentation) const {
  ioString << "<struct @baselineRamDefinitionList.element:" ;
  if (! isValid ()) {
    ioString << " not built" ;
  }else{
...
GALGAS_declarationInRam GALGAS_baselineRamDefinitionList_2E_element::reader_mDeclaration (UNUSED_LOCATION_ARGS) const {
...
//---------------------------------------------------------------------------*
//                                                                           *
//                  @baselineRamDefinitionList.element type                  *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_baselineRamDefinitionList_2E_element ("baselineRamDefinitionList.element",
                                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_baselineRamDefinitionList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_baselineRamDefinitionList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_baselineRamDefinitionList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_baselineRamDefinitionList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_baselineRamDefinitionList_2E_element GALGAS_baselineRamDefinitionList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                                        C_Compiler * inCompiler,
                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_baselineRamDefinitionList_2E_element result ;
  const GALGAS_baselineRamDefinitionList_2E_element * p = (const GALGAS_baselineRamDefinitionList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_baselineRamDefinitionList_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "baselineRamDefinitionList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
