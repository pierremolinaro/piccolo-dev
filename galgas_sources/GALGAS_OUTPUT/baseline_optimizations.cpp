    ...
    while (loop_8527) {
      ...
      if (loop_8527) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).isValid ()) {
          if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_actualInstruction) {
...
void routine_findBaselineFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (250)).isValid ()) {
    PMUInt32 variant_9508 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (250)).uintValue () ;
    bool loop_9508 = true ;
    while (loop_9508) {
      loop_9508 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (251)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).isValid () ;
      if (loop_9508) {
        loop_9508 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (251)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).boolValue () ;
      }
      if (loop_9508 && (0 == variant_9508)) {
        loop_9508 = false ;
      ...
      if (loop_9508) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).isValid ()) {
          if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_actualInstruction) {
            ...
            var_found = GALGAS_bool (true) ;
          }else if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_PAGE) {
...
void routine_perform_5F_baseline_5F_optimizations (GALGAS_baseline_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_21500 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
  GALGAS_uint index_21494 ((PMUInt32) 0) ;
  while (enumerator_21500.hasCurrentObject ()) {
    callCategoryMethod_defineLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_21500.current_mInstruction (HERE).ptr (), var_symbolTable, index_21494, inCompiler COMMA_SOURCE_FILE_AT_LINE (561)) ;
    enumerator_21500.gotoNextObject () ;
    index_21494.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
  }
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (566)).isValid ()) {
    PMUInt32 variant_21715 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (566)).uintValue () ;
    bool loop_21715 = true ;
    while (loop_21715) {
      loop_21715 = var_optimizationsDone.isValid () ;
      if (loop_21715) {
        loop_21715 = var_optimizationsDone.boolValue () ;
      }
      if (loop_21715 && (0 == variant_21715)) {
        loop_21715 = false ;
      ...
      if (loop_21715) {
        ...
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_21969 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        GALGAS_uint index_21963 ((PMUInt32) 0) ;
        while (enumerator_21969.hasCurrentObject ()) {
          if (enumerator_21969.current_mInstruction (HERE).isValid ()) {
            if (enumerator_21969.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE) {
              GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE cast_22063_inst ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE *) enumerator_21969.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeBEGIN_5F_ROUTINE ((const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE *) cast_22063_inst.ptr (), index_21963, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (576)) ;
            }else if (enumerator_21969.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
              GALGAS_baseline_5F_intermediate_5F_GOTO cast_22226_inst ((cPtr_baseline_5F_intermediate_5F_GOTO *) enumerator_21969.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeGOTO ((const cPtr_baseline_5F_intermediate_5F_GOTO *) cast_22226_inst.ptr (), var_symbolTable, index_21963, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
            }else if (enumerator_21969.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JUMP) {
              GALGAS_baseline_5F_intermediate_5F_JUMP cast_22393_inst ((cPtr_baseline_5F_intermediate_5F_JUMP *) enumerator_21969.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeJUMP ((const cPtr_baseline_5F_intermediate_5F_JUMP *) cast_22393_inst.ptr (), var_symbolTable, index_21963, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (580)) ;
            }else if (enumerator_21969.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_CALL) {
              GALGAS_baseline_5F_intermediate_5F_CALL cast_22560_inst ((cPtr_baseline_5F_intermediate_5F_CALL *) enumerator_21969.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeCALL ((const cPtr_baseline_5F_intermediate_5F_CALL *) cast_22560_inst.ptr (), var_symbolTable, index_21963, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (582)) ;
            }else if (enumerator_21969.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JSR) {
              GALGAS_baseline_5F_intermediate_5F_JSR cast_22726_inst ((cPtr_baseline_5F_intermediate_5F_JSR *) enumerator_21969.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeJSR ((const cPtr_baseline_5F_intermediate_5F_JSR *) cast_22726_inst.ptr (), var_symbolTable, index_21963, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
            }else if (enumerator_21969.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition) {
              GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition cast_22913_inst ((cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition *) enumerator_21969.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeTestDecInc ((const cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition *) cast_22913_inst.ptr (), var_symbolTable, index_21963, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (586)) ;
            }
          }
          enumerator_21969.gotoNextObject () ;
          index_21963.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
        }
        GALGAS_stringset var_referencedLabels = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (591)) ;
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_23208 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        while (enumerator_23208.hasCurrentObject ()) {
          callCategoryMethod_enterReferencedLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23208.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE_AT_LINE (593)) ;
          enumerator_23208.gotoNextObject () ;
        }
        cEnumerator_baselineSymbolTableForOptimizations enumerator_23316 (var_symbolTable, kEnumeration_up) ;
        while (enumerator_23316.hasCurrentObject ()) {
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_23316.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (596)) COMMA_SOURCE_FILE_AT_LINE (596)).operator_not (SOURCE_FILE_AT_LINE (596)).boolEnum () ;
          if (kBoolTrue == test_0) {
            GALGAS_uint var_definitionLine ;
            var_symbolTable.method_searchKey (enumerator_23316.current_lkey (HERE), var_definitionLine, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)).operator_concat (GALGAS_string (": unreferenced label '") COMMA_SOURCE_FILE_AT_LINE (598)).operator_concat (enumerator_23316.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)).operator_concat (GALGAS_string ("' is deleted\n") COMMA_SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)) ;
            {
            ...
            {
            GALGAS_uint joker_23716_0 ; // Joker input parameter
            var_symbolTable.modifier_removeKey (enumerator_23316.current_lkey (HERE), joker_23716_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
            }
          }
          enumerator_23316.gotoNextObject () ;
        }
        ...
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_23949 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        GALGAS_uint index_23943 ((PMUInt32) 0) ;
        while (enumerator_23949.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_1) {
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23949.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (609)) ;
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23949.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (611)) ;
          }else if (kBoolFalse == test_1) {
            GALGAS_bool var_isLABEL = callCategoryReader_isLABEL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23949.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
            const enumGalgasBool test_2 = var_isLABEL.operator_not (SOURCE_FILE_AT_LINE (614)).operator_and (callCategoryReader_isNULL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23949.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)).operator_not (SOURCE_FILE_AT_LINE (614)) COMMA_SOURCE_FILE_AT_LINE (614)).boolEnum () ;
            if (kBoolTrue == test_2) {
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_23943.reader_string (SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)).operator_concat (GALGAS_string (": dead code is deleted\n") COMMA_SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)) ;
              {
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (616)), index_23943, inCompiler COMMA_SOURCE_FILE_AT_LINE (616)) ;
              }
            }else if (kBoolFalse == test_2) {
              const enumGalgasBool test_3 = var_isLABEL.boolEnum () ;
              if (kBoolTrue == test_3) {
                var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23949.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (618)) ;
          ...
          index_23943.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
        }
        ...
        if (kBoolTrue == test_4) {
          ...
          cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_24969 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
          while (enumerator_24969.hasCurrentObject ()) {
            callCategoryMethod_setCurrentAddress ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24969.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (629)) ;
            enumerator_24969.gotoNextObject () ;
          }
...
static void categoryMethod_baseline_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_baseline_5F_intermediate_5F_GOTO * inObject,
  ...
  {
  GALGAS_baseline_5F_intermediate_5F_instruction joker_10693_0 ; // Joker input parameter
  routine_findBaselineFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (281)), ioArgument_ioGeneratedInstructionList, joker_10693_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (281)) ;
  }
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      ...
      if (kBoolTrue == test_1) {
        ...
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string (": JUMP ") COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string (" branching to GOTO ") COMMA_SOURCE_FILE_AT_LINE (360)).operator_concat (cast_13624_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (360)).reader_string (SOURCE_FILE_AT_LINE (360)) COMMA_SOURCE_FILE_AT_LINE (360)).operator_concat (GALGAS_string (" replaced by JUMP ") COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (cast_13624_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (361)).reader_string (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      }
      ...
      if (kBoolTrue == test_2) {
        ...
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (": JUMP ") COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (" branching to JUMP ") COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (cast_14219_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (377)).reader_string (SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (GALGAS_string (" replaced by JUMP ") COMMA_SOURCE_FILE_AT_LINE (378)).operator_concat (cast_14219_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (378)).reader_string (SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (378)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (376)) ;
      }
    }
  }
}
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      ...
      if (kBoolTrue == test_0) {
        ...
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (GALGAS_string (": CALL ") COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (GALGAS_string (" to RETLW ") COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (cast_15599_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (416)).reader_string (SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string (" replaced by MOVLW ") COMMA_SOURCE_FILE_AT_LINE (417)).operator_concat (cast_15599_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (417)).reader_string (SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (415)) ;
      }
    }
  }
}
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      ...
      if (kBoolTrue == test_0) {
        ...
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (GALGAS_string (" to RETLW ") COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (cast_17024_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (454)).reader_string (SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (GALGAS_string (" replaced by MOVLW ") COMMA_SOURCE_FILE_AT_LINE (455)).operator_concat (cast_17024_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (455)).reader_string (SOURCE_FILE_AT_LINE (455)) COMMA_SOURCE_FILE_AT_LINE (455)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (455)) COMMA_SOURCE_FILE_AT_LINE (453)) ;
      }
    }
  }
}
