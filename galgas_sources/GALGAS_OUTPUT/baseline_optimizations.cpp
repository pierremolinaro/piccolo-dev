      ...
      if (loop_21744) {
        ...
        while (enumerator_23353.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_0) {
            ...
            { //-------- @modifierCallInstructionForGeneration
            GALGAS_uint joker_23770_0 ; // Joker input parameter
            var_symbolTable.modifier_removeKey (enumerator_23353.current_lkey (HERE), joker_23770_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
            } //-------- END @typeMethodInstructionForGeneration
          }
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_24003 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_23997 ((PMUInt32) 0) ;
        while (enumerator_24003.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_1) {
            //-------- @assignmentInstructionForGeneration
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24003.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (609)) ;
            //-------- @assignmentInstructionForGeneration
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            //-------- @assignmentInstructionForGeneration
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24003.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (611)) ;
          }else if (kBoolFalse == test_1) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_bool var_isLABEL = callCategoryReader_isLABEL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24003.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_2 = var_isLABEL.operator_not (SOURCE_FILE_AT_LINE (614)).operator_and (callCategoryReader_isNULL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24003.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)).operator_not (SOURCE_FILE_AT_LINE (614)) COMMA_SOURCE_FILE_AT_LINE (614)).boolEnum () ;
            if (kBoolTrue == test_2) {
              //-------- @concatInstructionForGeneration
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_23997.reader_string (SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)).operator_concat (GALGAS_string (": dead code is deleted\n") COMMA_SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)) ;
              { //-------- @modifierCallInstructionForGeneration
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (616)), index_23997, inCompiler COMMA_SOURCE_FILE_AT_LINE (616)) ;
              } //-------- END @typeMethodInstructionForGeneration
              ...
              if (kBoolTrue == test_3) {
                //-------- @assignmentInstructionForGeneration
                var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24003.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (618)) ;
                //-------- @assignmentInstructionForGeneration
          ...
          index_23997.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
        }
        //-------- @ifInstructionForGeneration
        ...
        if (kBoolTrue == test_4) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_25023 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_25023.hasCurrentObject ()) {
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_setCurrentAddress ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_25023.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (629)) ;
            //-------- END @methodCallInstructionForGeneration
            enumerator_25023.gotoNextObject () ;
          }
          //-------- @concatInstructionForGeneration
