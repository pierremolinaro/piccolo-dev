...
void routine_findBaselineFirstInstructionFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  outArgument_outFirstInstruction = GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE ("baseline_optimizations.gSemantics", 221)) ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 223)).isValid ()) {
    uint32_t variant_8519 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 223)).uintValue () ;
    bool loop_8519 = true ;
    while (loop_8519) {
      loop_8519 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 224)))).operator_and (var_found.operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 224)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 224)).isValid () ;
      if (loop_8519) {
        loop_8519 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 224)))).operator_and (var_found.operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 224)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 224)).boolValue () ;
      }
      if (loop_8519 && (0 == variant_8519)) {
        loop_8519 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("baseline_optimizations.gSemantics", 223)) ;
      }
      if (loop_8519) {
        variant_8519 -- ;
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 226)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 226)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_actualInstruction cast_8770_instr ((cPtr_baseline_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 226)).ptr ()) ;
            outArgument_outFirstInstruction = cast_8770_instr ;
            var_found = GALGAS_bool (true) ;
          }else{
            var_currentAddress.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 231)) ;
          }
        }
      }
    }
...
void routine_findBaselineFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  outArgument_outReachedLabelSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("baseline_optimizations.gSemantics", 244)) ;
  GALGAS_uint var_currentAddress = constinArgument_inLineIndex ;
  outArgument_outFirstInstruction = GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE ("baseline_optimizations.gSemantics", 248)) ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 250)).isValid ()) {
    uint32_t variant_9494 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 250)).uintValue () ;
    bool loop_9494 = true ;
    while (loop_9494) {
      loop_9494 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 251)))).operator_and (var_found.operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 251)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 251)).isValid () ;
      if (loop_9494) {
        loop_9494 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 251)))).operator_and (var_found.operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 251)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 251)).boolValue () ;
      }
      if (loop_9494 && (0 == variant_9494)) {
        loop_9494 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("baseline_optimizations.gSemantics", 250)) ;
      }
      if (loop_9494) {
        variant_9494 -- ;
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 253)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 253)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_actualInstruction cast_9745_instr ((cPtr_baseline_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 253)).ptr ()) ;
            outArgument_outFirstInstruction = cast_9745_instr ;
            var_found = GALGAS_bool (true) ;
          }else if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_pseudo_5F_PAGE *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 253)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_pseudo_5F_PAGE cast_9859_instr ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_PAGE *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 253)).ptr ()) ;
            outArgument_outFirstInstruction = cast_9859_instr ;
            var_found = GALGAS_bool (true) ;
          }else if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 253)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL) {
            GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL cast_9974_instr ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_LABEL *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 253)).ptr ()) ;
            outArgument_outFirstInstruction = cast_9974_instr ;
            outArgument_outReachedLabelSet.addAssign_operation (cast_9974_instr.reader_mLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 262)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 262))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 262)) ;
            var_currentAddress.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 263)) ;
          }else{
            var_currentAddress.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 265)) ;
          }
        }
      }
    }
...
void routine_perform_5F_baseline_5F_optimizations (GALGAS_baseline_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 555)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 555))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 555)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 556))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 556)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 556))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 556)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 557)).operator_concat (GALGAS_string ("\n"
    "\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 557))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 557)) ;
  GALGAS_baselineSymbolTableForOptimizations var_symbolTable = GALGAS_baselineSymbolTableForOptimizations::constructor_emptyMap (SOURCE_FILE ("baseline_optimizations.gSemantics", 559)) ;
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_21482 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
  GALGAS_uint index_21455 ((uint32_t) 0) ;
  while (enumerator_21482.hasCurrentObject ()) {
    callCategoryMethod_defineLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_21482.current_mInstruction (HERE).ptr (), var_symbolTable, index_21455, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 561)) ;
    enumerator_21482.gotoNextObject () ;
    index_21455.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 560)) ;
  }
  GALGAS_bool var_optimizationsDone = GALGAS_bool (true) ;
  GALGAS_uint var_iteration = GALGAS_uint ((uint32_t) 0U) ;
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 566)).isValid ()) {
    uint32_t variant_21701 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE ("baseline_optimizations.gSemantics", 566)).uintValue () ;
    bool loop_21701 = true ;
    while (loop_21701) {
      loop_21701 = var_optimizationsDone.isValid () ;
      if (loop_21701) {
        loop_21701 = var_optimizationsDone.boolValue () ;
      }
      if (loop_21701 && (0 == variant_21701)) {
        loop_21701 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("baseline_optimizations.gSemantics", 566)) ;
      }
      if (loop_21701) {
        variant_21701 -- ;
        var_optimizationsDone = GALGAS_bool (false) ;
        var_iteration.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 570)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Pass ").operator_concat (var_iteration.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 571))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 571)).operator_concat (GALGAS_string (":\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 571))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 571)) ;
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_21951 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        GALGAS_uint index_21924 ((uint32_t) 0) ;
        while (enumerator_21951.hasCurrentObject ()) {
          if (enumerator_21951.current_mInstruction (HERE).isValid ()) {
            if (enumerator_21951.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE) {
              GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE cast_22051_inst ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE *) enumerator_21951.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeBEGIN_5F_ROUTINE ((const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE *) cast_22051_inst.ptr (), index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 576)) ;
            }else if (enumerator_21951.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
              GALGAS_baseline_5F_intermediate_5F_GOTO cast_22214_inst ((cPtr_baseline_5F_intermediate_5F_GOTO *) enumerator_21951.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeGOTO ((const cPtr_baseline_5F_intermediate_5F_GOTO *) cast_22214_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 578)) ;
            }else if (enumerator_21951.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JUMP) {
              GALGAS_baseline_5F_intermediate_5F_JUMP cast_22381_inst ((cPtr_baseline_5F_intermediate_5F_JUMP *) enumerator_21951.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeJUMP ((const cPtr_baseline_5F_intermediate_5F_JUMP *) cast_22381_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 580)) ;
            }else if (enumerator_21951.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_CALL) {
              GALGAS_baseline_5F_intermediate_5F_CALL cast_22548_inst ((cPtr_baseline_5F_intermediate_5F_CALL *) enumerator_21951.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeCALL ((const cPtr_baseline_5F_intermediate_5F_CALL *) cast_22548_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 582)) ;
            }else if (enumerator_21951.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JSR) {
              GALGAS_baseline_5F_intermediate_5F_JSR cast_22714_inst ((cPtr_baseline_5F_intermediate_5F_JSR *) enumerator_21951.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeJSR ((const cPtr_baseline_5F_intermediate_5F_JSR *) cast_22714_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 584)) ;
            }else if (enumerator_21951.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition) {
              GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition cast_22901_inst ((cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition *) enumerator_21951.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeTestDecInc ((const cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition *) cast_22901_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 586)) ;
            }
          }
          enumerator_21951.gotoNextObject () ;
          index_21924.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 573)) ;
        }
        GALGAS_stringset var_referencedLabels = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("baseline_optimizations.gSemantics", 591)) ;
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_23193 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        while (enumerator_23193.hasCurrentObject ()) {
          callCategoryMethod_enterReferencedLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23193.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 593)) ;
          enumerator_23193.gotoNextObject () ;
        }
        cEnumerator_baselineSymbolTableForOptimizations enumerator_23301 (var_symbolTable, kEnumeration_up) ;
        while (enumerator_23301.hasCurrentObject ()) {
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_23301.current_lkey (HERE).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 596)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 596)).operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 596)).boolEnum () ;
          if (kBoolTrue == test_0) {
            GALGAS_uint var_definitionLine ;
            var_symbolTable.method_searchKey (enumerator_23301.current_lkey (HERE), var_definitionLine, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 597)) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 598))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 598)).operator_concat (GALGAS_string (": unreferenced label '")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 598)).operator_concat (enumerator_23301.current_lkey (HERE).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 598))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 598)).operator_concat (GALGAS_string ("' is deleted\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 598))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 598)) ;
            {
            ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE ("baseline_optimizations.gSemantics", 599)), var_definitionLine, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 599)) ;
            }
            {
            GALGAS_uint joker_23703_0 ; // Joker input parameter
            var_symbolTable.modifier_removeKey (enumerator_23301.current_lkey (HERE), joker_23703_0, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 600)) ;
            }
          }
        ...
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_23931 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        GALGAS_uint index_23904 ((uint32_t) 0) ;
        while (enumerator_23931.hasCurrentObject ()) {
          const enumGalgasBool test_1 = var_reachable.operator_or (var_previousWasSkippingInstruction COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 608)).boolEnum () ;
          if (kBoolTrue == test_1) {
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 609)) ;
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 611)) ;
          }else if (kBoolFalse == test_1) {
            GALGAS_bool var_isLABEL = callCategoryReader_isLABEL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 613)) ;
            const enumGalgasBool test_2 = var_isLABEL.operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 614)).operator_and (callCategoryReader_isNULL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 614)).operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 614)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 614)).boolEnum () ;
            if (kBoolTrue == test_2) {
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_23904.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 615))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 615)).operator_concat (GALGAS_string (": dead code is deleted\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 615))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 615)) ;
              {
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE ("baseline_optimizations.gSemantics", 616)), index_23904, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 616)) ;
              }
            }else if (kBoolFalse == test_2) {
              const enumGalgasBool test_3 = var_isLABEL.boolEnum () ;
              if (kBoolTrue == test_3) {
                var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 618)) ;
          ...
          index_23904.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 607)) ;
        }
        const enumGalgasBool test_4 = var_optimizationsDone.operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 624)).boolEnum () ;
        if (kBoolTrue == test_4) {
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  No optimization\n"
            "\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 625)) ;
          GALGAS_uint var_currentAddress = GALGAS_uint ((uint32_t) 0U) ;
          cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_24954 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
          while (enumerator_24954.hasCurrentObject ()) {
            callCategoryMethod_setCurrentAddress ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24954.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 629)) ;
            enumerator_24954.gotoNextObject () ;
          }
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Minimum code size: ").operator_concat (var_currentAddress.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 631))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 631)).operator_concat (GALGAS_string (" words\n"
            "\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 631))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 631)) ;
        }
      }
    }
  }
...
static void categoryMethod_baseline_5F_intermediate_5F_instruction_setCurrentAddress (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioCurrentWordAdress = ioArgument_ioCurrentWordAdress.add_operation (callCategoryReader_length ((const cPtr_baseline_5F_intermediate_5F_instruction *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 23)), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 23)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_PAGE_setCurrentAddress (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioCurrentWordAdress = object->mAttribute_mPage.multiply_operation (GALGAS_uint ((uint32_t) 512U), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 31)) ;
}
//-----------------------------------------------------------------------------*
...
static GALGAS_bool categoryReader_baseline_5F_intermediate_5F_instruction_5F_literalOperation_nextInstructionIsReachable (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  result_outIsReachable = GALGAS_bool (kIsNotEqual, object->mAttribute_mInstruction.objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE ("baseline_optimizations.gSemantics", 135)))) ;
//---
  return result_outIsReachable ;
}
...
static void categoryMethod_baseline_5F_intermediate_5F_GOTO_enterReferencedLabel (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioReferencedLabelSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 154)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_JUMP_enterReferencedLabel (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioReferencedLabelSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 162)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_CALL_enterReferencedLabel (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioReferencedLabelSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 170)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_enterReferencedLabel (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioReferencedLabelSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 178)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_incDecRegisterInCondition_enterReferencedLabel (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioReferencedLabelSet.addAssign_operation (object->mAttribute_mTargetLabel  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 186)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_LABEL_defineLabel (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  {
  ioArgument_ioRoutineSymbolTable.modifier_insertKey (object->mAttribute_mLabel, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 208)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_baseline_5F_intermediate_5F_GOTO * inObject,
  ...
  {
  GALGAS_baseline_5F_intermediate_5F_instruction joker_10680_0 ; // Joker input parameter
  routine_findBaselineFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 281)), ioArgument_ioGeneratedInstructionList, joker_10680_0, var_reachedLabelSet, inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 281)) ;
  }
  const enumGalgasBool test_0 = var_reachedLabelSet.reader_hasKey (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 282)) COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 282)).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE ("baseline_optimizations.gSemantics", 283)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 283)) ;
    }
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 284))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 284)).operator_concat (GALGAS_string (": GOTO branching to next instruction deleted\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 284))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 284)) ;
  }else if (kBoolFalse == test_0) {
    GALGAS_uint var_line ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 287)) ;
    GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
    {
    routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 290)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 290)) ;
    }
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
        GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_11445_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_11445_literalOp.reader_mInstruction (SOURCE_FILE ("baseline_optimizations.gSemantics", 294)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE ("baseline_optimizations.gSemantics", 294)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_11445_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 295)) ;
          }
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 300))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 300)).operator_concat (GALGAS_string (": GOTO branching to RETLW replaced by RETLW\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 300))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 300)) ;
        }
      }else if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
        GALGAS_baseline_5F_intermediate_5F_GOTO cast_11864_goto ((cPtr_baseline_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_11864_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 303)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, cast_11864_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 307))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 305)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 304)) ;
          }
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 312))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).operator_concat (GALGAS_string (": GOTO ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 312))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).operator_concat (GALGAS_string (" branching to GOTO ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).operator_concat (cast_11864_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 312))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).operator_concat (GALGAS_string (" replaced by GOTO ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).operator_concat (cast_11864_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 312))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 312)) ;
        }
      }
    }
  }
...
static void categoryMethod_baseline_5F_intermediate_5F_JUMP_optimizeJUMP (const cPtr_baseline_5F_intermediate_5F_JUMP * inObject,
  ...
  macroValidSharedObject (object, cPtr_baseline_5F_intermediate_5F_JUMP) ;
  GALGAS_uint var_line ;
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 329)) ;
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  {
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 332)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 331)) ;
  }
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_13211_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_13211_literalOp.reader_mInstruction (SOURCE_FILE ("baseline_optimizations.gSemantics", 339)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE ("baseline_optimizations.gSemantics", 339)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_13211_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 340)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 345))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 345)).operator_concat (GALGAS_string (": JUMP branching to RETLW replaced by RETLW\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 345))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 345)) ;
      }
    }else if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
      GALGAS_baseline_5F_intermediate_5F_GOTO cast_13612_goto ((cPtr_baseline_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_13612_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 348)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_13612_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 352)), object->mAttribute_mCurrentPage, object->mAttribute_mTargetPage  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 350)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 349)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 359))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 359)).operator_concat (GALGAS_string (": JUMP ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 359)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 359))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 359)).operator_concat (GALGAS_string (" branching to GOTO ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 359)).operator_concat (cast_13612_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 360)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 360))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 360)).operator_concat (GALGAS_string (" replaced by JUMP ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 360)).operator_concat (cast_13612_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 361)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 361))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 361)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 361))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 359)) ;
      }
    }else if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JUMP) {
      GALGAS_baseline_5F_intermediate_5F_JUMP cast_14207_jump ((cPtr_baseline_5F_intermediate_5F_JUMP *) var_firstInstruction.ptr ()) ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_14207_jump.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 365)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_14207_jump.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 369)), object->mAttribute_mCurrentPage, cast_14207_jump.reader_mTargetPage (SOURCE_FILE ("baseline_optimizations.gSemantics", 371))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 367)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 366)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 376))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 376)).operator_concat (GALGAS_string (": JUMP ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 376)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 376))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 376)).operator_concat (GALGAS_string (" branching to JUMP ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 376)).operator_concat (cast_14207_jump.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 377)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 377))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 377)).operator_concat (GALGAS_string (" replaced by JUMP ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 377)).operator_concat (cast_14207_jump.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 378)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 378))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 378)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 378))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 376)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_CALL_optimizeCALL (const cPtr_baseline_5F_intermediate_5F_CALL * inObject,
  ...
  macroValidSharedObject (object, cPtr_baseline_5F_intermediate_5F_CALL) ;
  GALGAS_uint var_line ;
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 395)) ;
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  {
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 398)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 397)) ;
  }
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_15587_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_15587_literalOp.reader_mInstruction (SOURCE_FILE ("baseline_optimizations.gSemantics", 405)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE ("baseline_optimizations.gSemantics", 405)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE ("baseline_optimizations.gSemantics", 409)), cast_15587_literalOp.reader_mLiteralValue (SOURCE_FILE ("baseline_optimizations.gSemantics", 410))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 407)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 406)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 415))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 415)).operator_concat (GALGAS_string (": CALL ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 415)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 415))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 415)).operator_concat (GALGAS_string (" to RETLW ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 415)).operator_concat (cast_15587_literalOp.reader_mLiteralValue (SOURCE_FILE ("baseline_optimizations.gSemantics", 416)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 416))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 416)).operator_concat (GALGAS_string (" replaced by MOVLW ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 416)).operator_concat (cast_15587_literalOp.reader_mLiteralValue (SOURCE_FILE ("baseline_optimizations.gSemantics", 417)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 417))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 417)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 417))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 415)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_optimizeJSR (const cPtr_baseline_5F_intermediate_5F_JSR * inObject,
  ...
  macroValidSharedObject (object, cPtr_baseline_5F_intermediate_5F_JSR) ;
  GALGAS_uint var_line ;
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 433)) ;
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  {
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 436)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 435)) ;
  }
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_17012_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_17012_literalOp.reader_mInstruction (SOURCE_FILE ("baseline_optimizations.gSemantics", 443)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE ("baseline_optimizations.gSemantics", 443)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE ("baseline_optimizations.gSemantics", 447)), cast_17012_literalOp.reader_mLiteralValue (SOURCE_FILE ("baseline_optimizations.gSemantics", 448))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 445)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 444)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 453))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 453)).operator_concat (GALGAS_string (": JSR ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 453)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 453))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 453)).operator_concat (GALGAS_string (" to RETLW ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 453)).operator_concat (cast_17012_literalOp.reader_mLiteralValue (SOURCE_FILE ("baseline_optimizations.gSemantics", 454)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 454))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 454)).operator_concat (GALGAS_string (" replaced by MOVLW ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 454)).operator_concat (cast_17012_literalOp.reader_mLiteralValue (SOURCE_FILE ("baseline_optimizations.gSemantics", 455)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 455))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 455)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 455))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 453)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE_optimizeBEGIN_5F_ROUTINE (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE * /* inObject */,
  ...
  const enumGalgasBool test_0 = var_reachable.operator_not (SOURCE_FILE ("baseline_optimizations.gSemantics", 481)).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE ("baseline_optimizations.gSemantics", 483)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 482)) ;
    }
    ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 487))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 487)).operator_concat (GALGAS_string (": dead code is deleted\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 487))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 487)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_incDecRegisterInCondition_optimizeTestDecInc (const cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition * inObject,
  ...
  macroValidSharedObject (object, cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition) ;
  GALGAS_uint var_line ;
  constinArgument_inSymbolTable.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mTargetLabel, inCompiler->here ()  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 501)), var_line, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 501)) ;
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  {
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 504)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 503)) ;
  }
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
      GALGAS_baseline_5F_intermediate_5F_GOTO cast_19526_goto ((cPtr_baseline_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
      {
      ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mRegisterDescription, cast_19526_goto.reader_mTargetLabel (SOURCE_FILE ("baseline_optimizations.gSemantics", 515)).reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 515)), object->mAttribute_mIncrement, object->mAttribute_m_5F_W_5F_isDestination, object->mAttribute_mBranchIfZero  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 512)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 511)) ;
      }
      ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE ("baseline_optimizations.gSemantics", 523))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 523)).operator_concat (GALGAS_string (": label of ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 523))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 523)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("GOTO ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 524)) ;
      const enumGalgasBool test_0 = object->mAttribute_mIncrement.boolEnum () ;
      if (kBoolTrue == test_0) {
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("INCF ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 526)) ;
      }else if (kBoolFalse == test_0) {
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("DECF ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 528)) ;
      }
      ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE ("baseline_optimizations.gSemantics", 530))  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 530)) ;
      const enumGalgasBool test_1 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", W")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 532)) ;
      }
      const enumGalgasBool test_2 = object->mAttribute_mBranchIfZero.boolEnum () ;
      if (kBoolTrue == test_2) {
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" Z")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 535)) ;
      }else if (kBoolFalse == test_2) {
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" NZ")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 537)) ;
      }
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (": branching to GOTO replaced by second GOTO label\n")  COMMA_SOURCE_FILE ("baseline_optimizations.gSemantics", 539)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
