...
void routine_findBaselineFirstInstructionFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  outArgument_outFirstInstruction = GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (213)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @loopInstructionForGeneration
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (215)).isValid ()) {
    PMUInt32 variant_8267 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (215)).uintValue () ;
    bool loop_8267 = true ;
    while (loop_8267) {
      loop_8267 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (216)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (216)) COMMA_SOURCE_FILE_AT_LINE (216)).isValid () ;
      if (loop_8267) {
        loop_8267 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (216)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (216)) COMMA_SOURCE_FILE_AT_LINE (216)).boolValue () ;
      }
      if (loop_8267 && (0 == variant_8267)) {
        loop_8267 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (215)) ;
      }
      if (loop_8267) {
        variant_8267 -- ;
        //-------- @structuredCastInstructionForGeneration
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (218)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (218)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_actualInstruction cast_8518_instr ((cPtr_baseline_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (218)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_8518_instr ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (true) ;
          }else{
            //-------- @incrementInstructionForGeneration
            var_currentAddress.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
          }
        }
      }
    }
...
void routine_findBaselineFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outReachedLabelSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (236)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_currentAddress = constinArgument_inLineIndex ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outFirstInstruction = GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (240)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @loopInstructionForGeneration
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (242)).isValid ()) {
    PMUInt32 variant_9251 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (242)).uintValue () ;
    bool loop_9251 = true ;
    while (loop_9251) {
      loop_9251 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (243)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (243)) COMMA_SOURCE_FILE_AT_LINE (243)).isValid () ;
      if (loop_9251) {
        loop_9251 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (243)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (243)) COMMA_SOURCE_FILE_AT_LINE (243)).boolValue () ;
      }
      if (loop_9251 && (0 == variant_9251)) {
        loop_9251 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (242)) ;
      }
      if (loop_9251) {
        variant_9251 -- ;
        //-------- @structuredCastInstructionForGeneration
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_actualInstruction cast_9502_instr ((cPtr_baseline_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_9502_instr ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (true) ;
          }else if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_pseudo_5F_PAGE *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_pseudo_5F_PAGE cast_9617_instr ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_PAGE *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_9617_instr ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (true) ;
          }else if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL) {
            GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL cast_9733_instr ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_LABEL *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_9733_instr ;
            //-------- @plusEqualnstructionForGeneration
            outArgument_outReachedLabelSet.addAssign_operation (cast_9733_instr.reader_mLabel (SOURCE_FILE_AT_LINE (254)).reader_string (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)) ;
            //-------- @incrementInstructionForGeneration
            var_currentAddress.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (255)) ;
          }else{
            //-------- @incrementInstructionForGeneration
            var_currentAddress.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (257)) ;
          }
        }
      }
    }
...
void routine_perform_5F_baseline_5F_optimizations (GALGAS_baseline_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (547)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (547)) COMMA_SOURCE_FILE_AT_LINE (547)) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (548)) COMMA_SOURCE_FILE_AT_LINE (548)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (548)) COMMA_SOURCE_FILE_AT_LINE (548)) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (549)).operator_concat (GALGAS_string ("\n"
  ...
  GALGAS_baselineSymbolTableForOptimizations var_symbolTable = GALGAS_baselineSymbolTableForOptimizations::constructor_emptyMap (SOURCE_FILE_AT_LINE (551)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_21269 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_21263 ((PMUInt32) 0) ;
  while (enumerator_21269.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_defineLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_21269.current_mInstruction (HERE).ptr (), var_symbolTable, index_21263, inCompiler COMMA_SOURCE_FILE_AT_LINE (553)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_21269.gotoNextObject () ;
    index_21263.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @loopInstructionForGeneration
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (558)).isValid ()) {
    PMUInt32 variant_21484 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (558)).uintValue () ;
    bool loop_21484 = true ;
    while (loop_21484) {
      loop_21484 = var_optimizationsDone.isValid () ;
      if (loop_21484) {
        loop_21484 = var_optimizationsDone.boolValue () ;
      }
      if (loop_21484 && (0 == variant_21484)) {
        loop_21484 = false ;
      ...
      if (loop_21484) {
        ...
        //-------- @incrementInstructionForGeneration
        var_iteration.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (562)) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Pass ").operator_concat (var_iteration.reader_string (SOURCE_FILE_AT_LINE (563)) COMMA_SOURCE_FILE_AT_LINE (563)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (563)) COMMA_SOURCE_FILE_AT_LINE (563)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_21738 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_21732 ((PMUInt32) 0) ;
        while (enumerator_21738.hasCurrentObject ()) {
          //-------- @structuredCastInstructionForGeneration
          if (enumerator_21738.current_mInstruction (HERE).isValid ()) {
            if (enumerator_21738.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE) {
              GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE cast_21834_inst ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE *) enumerator_21738.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeBEGIN_5F_ROUTINE ((const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE *) cast_21834_inst.ptr (), index_21732, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (568)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_21738.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
              GALGAS_baseline_5F_intermediate_5F_GOTO cast_21998_inst ((cPtr_baseline_5F_intermediate_5F_GOTO *) enumerator_21738.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeGOTO ((const cPtr_baseline_5F_intermediate_5F_GOTO *) cast_21998_inst.ptr (), var_symbolTable, index_21732, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (570)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_21738.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JUMP) {
              GALGAS_baseline_5F_intermediate_5F_JUMP cast_22166_inst ((cPtr_baseline_5F_intermediate_5F_JUMP *) enumerator_21738.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeJUMP ((const cPtr_baseline_5F_intermediate_5F_JUMP *) cast_22166_inst.ptr (), var_symbolTable, index_21732, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (572)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_21738.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_CALL) {
              GALGAS_baseline_5F_intermediate_5F_CALL cast_22334_inst ((cPtr_baseline_5F_intermediate_5F_CALL *) enumerator_21738.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeCALL ((const cPtr_baseline_5F_intermediate_5F_CALL *) cast_22334_inst.ptr (), var_symbolTable, index_21732, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (574)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_21738.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JSR) {
              GALGAS_baseline_5F_intermediate_5F_JSR cast_22501_inst ((cPtr_baseline_5F_intermediate_5F_JSR *) enumerator_21738.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeJSR ((const cPtr_baseline_5F_intermediate_5F_JSR *) cast_22501_inst.ptr (), var_symbolTable, index_21732, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (576)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_21738.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition) {
              GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition cast_22689_inst ((cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition *) enumerator_21738.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeTestDecInc ((const cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition *) cast_22689_inst.ptr (), var_symbolTable, index_21732, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
              //-------- END @methodCallInstructionForGeneration
            }
          }
          enumerator_21738.gotoNextObject () ;
          index_21732.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) ;
        }
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_stringset var_referencedLabels = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (583)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_22985 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_22985.hasCurrentObject ()) {
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_enterReferencedLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_22985.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE_AT_LINE (585)) ;
          //-------- END @methodCallInstructionForGeneration
          enumerator_22985.gotoNextObject () ;
        }
        //-------- @foreachInstructionForGeneration
        cEnumerator_baselineSymbolTableForOptimizations enumerator_23093 (var_symbolTable, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_23093.hasCurrentObject ()) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_23093.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)).operator_not (SOURCE_FILE_AT_LINE (588)).boolEnum () ;
          if (kBoolTrue == test_0) {
            //-------- @localVariableDeclarationForGeneration
            GALGAS_uint var_definitionLine ;
            //-------- @methodCallInstructionForGeneration
            var_symbolTable.method_searchKey (enumerator_23093.current_lkey (HERE), var_definitionLine, inCompiler COMMA_SOURCE_FILE_AT_LINE (589)) ;
            //-------- END @methodCallInstructionForGeneration
            //-------- @concatInstructionForGeneration
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE_AT_LINE (590)) COMMA_SOURCE_FILE_AT_LINE (590)).operator_concat (GALGAS_string (": unreferenced label '") COMMA_SOURCE_FILE_AT_LINE (590)).operator_concat (enumerator_23093.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (590)) COMMA_SOURCE_FILE_AT_LINE (590)).operator_concat (GALGAS_string ("' is deleted\n") COMMA_SOURCE_FILE_AT_LINE (590)) COMMA_SOURCE_FILE_AT_LINE (590)) ;
            { //-------- @modifierCallInstructionForGeneration
            ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (591)), var_definitionLine, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
            } //-------- END @typeMethodInstructionForGeneration
            { //-------- @modifierCallInstructionForGeneration
            GALGAS_uint joker_23510_0 ; // Joker input parameter
            var_symbolTable.modifier_removeKey (enumerator_23093.current_lkey (HERE), joker_23510_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (592)) ;
            } //-------- END @typeMethodInstructionForGeneration
          }
          enumerator_23093.gotoNextObject () ;
        }
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_23743 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_23737 ((PMUInt32) 0) ;
        while (enumerator_23743.hasCurrentObject ()) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_1 = var_reachable.operator_or (var_previousWasSkippingInstruction COMMA_SOURCE_FILE_AT_LINE (600)).boolEnum () ;
          if (kBoolTrue == test_1) {
            //-------- @assignmentInstructionForGeneration
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23743.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) ;
            //-------- @assignmentInstructionForGeneration
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            //-------- @assignmentInstructionForGeneration
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23743.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (603)) ;
          }else if (kBoolFalse == test_1) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_bool var_isLABEL = callCategoryReader_isLABEL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23743.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)) ;
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_2 = var_isLABEL.operator_not (SOURCE_FILE_AT_LINE (606)).operator_and (callCategoryReader_isNULL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23743.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (606)).operator_not (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)).boolEnum () ;
            if (kBoolTrue == test_2) {
              //-------- @concatInstructionForGeneration
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_23737.reader_string (SOURCE_FILE_AT_LINE (607)) COMMA_SOURCE_FILE_AT_LINE (607)).operator_concat (GALGAS_string (": dead code is deleted\n") COMMA_SOURCE_FILE_AT_LINE (607)) COMMA_SOURCE_FILE_AT_LINE (607)) ;
              { //-------- @modifierCallInstructionForGeneration
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (608)), index_23737, inCompiler COMMA_SOURCE_FILE_AT_LINE (608)) ;
              } //-------- END @typeMethodInstructionForGeneration
              ...
              if (kBoolTrue == test_3) {
                //-------- @assignmentInstructionForGeneration
                var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23743.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (610)) ;
                //-------- @assignmentInstructionForGeneration
          ...
          index_23737.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = var_optimizationsDone.operator_not (SOURCE_FILE_AT_LINE (616)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @concatInstructionForGeneration
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_baseline_5F_intermediate_5F_instructionList enumerator_24763 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_24763.hasCurrentObject ()) {
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_setCurrentAddress ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24763.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (621)) ;
            //-------- END @methodCallInstructionForGeneration
            enumerator_24763.gotoNextObject () ;
          }
          //-------- @concatInstructionForGeneration
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Minimum code size: ").operator_concat (var_currentAddress.reader_string (SOURCE_FILE_AT_LINE (623)) COMMA_SOURCE_FILE_AT_LINE (623)).operator_concat (GALGAS_string (" words\n"
            "\n") COMMA_SOURCE_FILE_AT_LINE (623)) COMMA_SOURCE_FILE_AT_LINE (623)) ;
        }
      }
    }
  }
...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_LABEL_defineLabel (const cPtr_baseline_5F_intermediate_5F_instruction * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioRoutineSymbolTable.modifier_insertKey (object->mAttribute_mLabel, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_baseline_5F_intermediate_5F_GOTO * inObject,
  ...
  GALGAS_baseline_5F_intermediate_5F_instruction joker_10441_0 ; // Joker input parameter
  routine_findBaselineFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (273)), ioArgument_ioGeneratedInstructionList, joker_10441_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (273)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = var_reachedLabelSet.reader_hasKey (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274)).boolEnum () ;
  if (kBoolTrue == test_0) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (275)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (275)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276)).operator_concat (GALGAS_string (": GOTO branching to next instruction deleted\n") COMMA_SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_uint var_line ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE_AT_LINE (279)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
    { //-------- @routineCallInstructionForGeneration
    routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (282)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @structuredCastInstructionForGeneration
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
        GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_11207_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_11207_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (286)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (286)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_11207_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (287)) ;
          } //-------- END @typeMethodInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          //-------- @concatInstructionForGeneration
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (292)) COMMA_SOURCE_FILE_AT_LINE (292)).operator_concat (GALGAS_string (": GOTO branching to RETLW replaced by RETLW\n") COMMA_SOURCE_FILE_AT_LINE (292)) COMMA_SOURCE_FILE_AT_LINE (292)) ;
        }
      }else if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
        GALGAS_baseline_5F_intermediate_5F_GOTO cast_11627_goto ((cPtr_baseline_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_11627_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (295)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, cast_11627_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (299)) COMMA_SOURCE_FILE_AT_LINE (297)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (296)) ;
          } //-------- END @typeMethodInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          //-------- @concatInstructionForGeneration
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)).operator_concat (GALGAS_string (": GOTO ") COMMA_SOURCE_FILE_AT_LINE (304)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)).operator_concat (GALGAS_string (" branching to GOTO ") COMMA_SOURCE_FILE_AT_LINE (304)).operator_concat (cast_11627_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (304)).reader_string (SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)).operator_concat (GALGAS_string (" replaced by GOTO ") COMMA_SOURCE_FILE_AT_LINE (304)).operator_concat (cast_11627_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (304)).reader_string (SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)) ;
        }
      }
    }
  }
...
static void categoryMethod_baseline_5F_intermediate_5F_JUMP_optimizeJUMP (const cPtr_baseline_5F_intermediate_5F_JUMP * inObject,
  ...
  GALGAS_uint var_line ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE_AT_LINE (321)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  { //-------- @routineCallInstructionForGeneration
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (324)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (323)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @structuredCastInstructionForGeneration
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_12977_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_12977_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (331)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (331)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_12977_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (332)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string (": JUMP branching to RETLW replaced by RETLW\n") COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)) ;
      }
    }else if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
      GALGAS_baseline_5F_intermediate_5F_GOTO cast_13379_goto ((cPtr_baseline_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_13379_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (340)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_13379_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (344)), object->mAttribute_mCurrentPage, object->mAttribute_mTargetPage COMMA_SOURCE_FILE_AT_LINE (342)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (341)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (351)) COMMA_SOURCE_FILE_AT_LINE (351)).operator_concat (GALGAS_string (": JUMP ") COMMA_SOURCE_FILE_AT_LINE (351)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (351)) COMMA_SOURCE_FILE_AT_LINE (351)).operator_concat (GALGAS_string (" branching to GOTO ") COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (cast_13379_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (352)).reader_string (SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (GALGAS_string (" replaced by JUMP ") COMMA_SOURCE_FILE_AT_LINE (353)).operator_concat (cast_13379_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (353)).reader_string (SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (351)) ;
      }
    }else if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_JUMP) {
      GALGAS_baseline_5F_intermediate_5F_JUMP cast_13975_jump ((cPtr_baseline_5F_intermediate_5F_JUMP *) var_firstInstruction.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_13975_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (357)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_13975_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (361)), object->mAttribute_mCurrentPage, cast_13975_jump.reader_mTargetPage (SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (359)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (358)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (368)) COMMA_SOURCE_FILE_AT_LINE (368)).operator_concat (GALGAS_string (": JUMP ") COMMA_SOURCE_FILE_AT_LINE (368)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (368)) COMMA_SOURCE_FILE_AT_LINE (368)).operator_concat (GALGAS_string (" branching to JUMP ") COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (cast_13975_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (369)).reader_string (SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (GALGAS_string (" replaced by JUMP ") COMMA_SOURCE_FILE_AT_LINE (370)).operator_concat (cast_13975_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (370)).reader_string (SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (370)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (370)) COMMA_SOURCE_FILE_AT_LINE (368)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_CALL_optimizeCALL (const cPtr_baseline_5F_intermediate_5F_CALL * inObject,
  ...
  GALGAS_uint var_line ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE_AT_LINE (387)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  { //-------- @routineCallInstructionForGeneration
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (390)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (389)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @structuredCastInstructionForGeneration
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_15358_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_15358_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (397)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (397)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (401)), cast_15358_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (402)) COMMA_SOURCE_FILE_AT_LINE (399)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (398)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (407)) COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_string (": CALL ") COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (407)) COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_string (" to RETLW ") COMMA_SOURCE_FILE_AT_LINE (408)).operator_concat (cast_15358_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (408)).reader_string (SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)).operator_concat (GALGAS_string (" replaced by MOVLW ") COMMA_SOURCE_FILE_AT_LINE (409)).operator_concat (cast_15358_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (409)).reader_string (SOURCE_FILE_AT_LINE (409)) COMMA_SOURCE_FILE_AT_LINE (409)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (409)) COMMA_SOURCE_FILE_AT_LINE (407)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_optimizeJSR (const cPtr_baseline_5F_intermediate_5F_JSR * inObject,
  ...
  GALGAS_uint var_line ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  { //-------- @routineCallInstructionForGeneration
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (428)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (427)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @structuredCastInstructionForGeneration
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation cast_16786_literalOp ((cPtr_baseline_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_16786_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (435)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (435)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (439)), cast_16786_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (437)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (445)) COMMA_SOURCE_FILE_AT_LINE (445)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (445)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (445)) COMMA_SOURCE_FILE_AT_LINE (445)).operator_concat (GALGAS_string (" to RETLW ") COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (cast_16786_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (446)).reader_string (SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string (" replaced by MOVLW ") COMMA_SOURCE_FILE_AT_LINE (447)).operator_concat (cast_16786_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (447)).reader_string (SOURCE_FILE_AT_LINE (447)) COMMA_SOURCE_FILE_AT_LINE (447)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (447)) COMMA_SOURCE_FILE_AT_LINE (445)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE_optimizeBEGIN_5F_ROUTINE (const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE * /* inObject */,
                                                                                                            ...
                                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_baseline_5F_intermediate_5F_instruction var_nextInstruction = ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (464)), inCompiler COMMA_SOURCE_FILE_AT_LINE (464)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = var_reachable.operator_not (SOURCE_FILE_AT_LINE (473)).boolEnum () ;
  if (kBoolTrue == test_0) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (475)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (474)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (479)) COMMA_SOURCE_FILE_AT_LINE (479)).operator_concat (GALGAS_string (": dead code is deleted\n") COMMA_SOURCE_FILE_AT_LINE (479)) COMMA_SOURCE_FILE_AT_LINE (479)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_intermediate_5F_incDecRegisterInCondition_optimizeTestDecInc (const cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition * inObject,
  ...
  GALGAS_uint var_line ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inSymbolTable.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mTargetLabel, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (493)), var_line, inCompiler COMMA_SOURCE_FILE_AT_LINE (493)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_baseline_5F_intermediate_5F_instruction var_firstInstruction ;
  { //-------- @routineCallInstructionForGeneration
  routine_findBaselineFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (495)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @structuredCastInstructionForGeneration
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_GOTO) {
      GALGAS_baseline_5F_intermediate_5F_GOTO cast_19306_goto ((cPtr_baseline_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_incDecRegisterInCondition::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mRegisterDescription, cast_19306_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (507)).reader_string (SOURCE_FILE_AT_LINE (507)), object->mAttribute_mIncrement, object->mAttribute_m_5F_W_5F_isDestination, object->mAttribute_mBranchIfZero COMMA_SOURCE_FILE_AT_LINE (504)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @assignmentInstructionForGeneration
      ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
      //-------- @concatInstructionForGeneration
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (515)) COMMA_SOURCE_FILE_AT_LINE (515)).operator_concat (GALGAS_string (": label of ") COMMA_SOURCE_FILE_AT_LINE (515)) COMMA_SOURCE_FILE_AT_LINE (515)) ;
      //-------- @concatInstructionForGeneration
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("GOTO ") COMMA_SOURCE_FILE_AT_LINE (516)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = object->mAttribute_mIncrement.boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("INCF ") COMMA_SOURCE_FILE_AT_LINE (518)) ;
      }else if (kBoolFalse == test_0) {
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("DECF ") COMMA_SOURCE_FILE_AT_LINE (520)) ;
      }
      //-------- @concatInstructionForGeneration
      ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (522)) COMMA_SOURCE_FILE_AT_LINE (522)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", W") COMMA_SOURCE_FILE_AT_LINE (524)) ;
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = object->mAttribute_mBranchIfZero.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" Z") COMMA_SOURCE_FILE_AT_LINE (527)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" NZ") COMMA_SOURCE_FILE_AT_LINE (529)) ;
      }
      //-------- @concatInstructionForGeneration
