...
void routine_findBaselineFirstInstructionFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (223)).isValid ()) {
    uint32_t variant_8519 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (223)).uintValue () ;
    bool loop_8519 = true ;
    while (loop_8519) {
      loop_8519 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (224)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (224)).isValid () ;
      if (loop_8519) {
        loop_8519 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (224)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (224)).boolValue () ;
      }
      ...
      if (loop_8519) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_actualInstruction cast_8770_instr ((cPtr_baseline_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).ptr ()) ;
...
void routine_findBaselineFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (250)).isValid ()) {
    uint32_t variant_9494 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (250)).uintValue () ;
    bool loop_9494 = true ;
    while (loop_9494) {
      loop_9494 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (251)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).isValid () ;
      if (loop_9494) {
        loop_9494 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (251)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).boolValue () ;
      }
      ...
      if (loop_9494) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_baseline_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).ptr ())) {
            GALGAS_baseline_5F_intermediate_5F_actualInstruction cast_9745_instr ((cPtr_baseline_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).ptr ()) ;
            ...
            GALGAS_baseline_5F_intermediate_5F_pseudo_5F_PAGE cast_9859_instr ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_PAGE *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).ptr ()) ;
            ...
            GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL cast_9974_instr ((cPtr_baseline_5F_intermediate_5F_pseudo_5F_LABEL *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).ptr ()) ;
            outArgument_outFirstInstruction = cast_9974_instr ;
            outArgument_outReachedLabelSet.addAssign_operation (cast_9974_instr.reader_mLabel (SOURCE_FILE_AT_LINE (262)).reader_string (SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
...
void routine_perform_5F_baseline_5F_optimizations (GALGAS_baseline_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  while (enumerator_21482.hasCurrentObject ()) {
    callCategoryMethod_defineLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_21482.current_mInstruction (HERE).ptr (), var_symbolTable, index_21455, inCompiler COMMA_SOURCE_FILE_AT_LINE (561)) ;
    enumerator_21482.gotoNextObject () ;
    index_21455.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
  }
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (566)).isValid ()) {
    uint32_t variant_21701 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (566)).uintValue () ;
    ...
    while (loop_21701) {
      ...
      if (loop_21701) {
        ...
        while (enumerator_21951.hasCurrentObject ()) {
          if (enumerator_21951.current_mInstruction (HERE).isValid ()) {
            if (enumerator_21951.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE) {
              ...
              callCategoryMethod_optimizeBEGIN_5F_ROUTINE ((const cPtr_baseline_5F_intermediate_5F_pseudo_5F_BEGIN_5F_ROUTINE *) cast_22051_inst.ptr (), index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (576)) ;
              ...
              callCategoryMethod_optimizeGOTO ((const cPtr_baseline_5F_intermediate_5F_GOTO *) cast_22214_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
              ...
              callCategoryMethod_optimizeJUMP ((const cPtr_baseline_5F_intermediate_5F_JUMP *) cast_22381_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (580)) ;
              ...
              callCategoryMethod_optimizeCALL ((const cPtr_baseline_5F_intermediate_5F_CALL *) cast_22548_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (582)) ;
              ...
              callCategoryMethod_optimizeJSR ((const cPtr_baseline_5F_intermediate_5F_JSR *) cast_22714_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
              ...
              callCategoryMethod_optimizeTestDecInc ((const cPtr_baseline_5F_intermediate_5F_incDecRegisterInCondition *) cast_22901_inst.ptr (), var_symbolTable, index_21924, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (586)) ;
            }
          }
          enumerator_21951.gotoNextObject () ;
          index_21924.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
        }
        ...
        while (enumerator_23193.hasCurrentObject ()) {
          callCategoryMethod_enterReferencedLabel ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23193.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE_AT_LINE (593)) ;
        ...
        while (enumerator_23301.hasCurrentObject ()) {
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_23301.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (596)) COMMA_SOURCE_FILE_AT_LINE (596)).operator_not (SOURCE_FILE_AT_LINE (596)).boolEnum () ;
          if (kBoolTrue == test_0) {
            GALGAS_uint var_definitionLine ;
            var_symbolTable.method_searchKey (enumerator_23301.current_lkey (HERE), var_definitionLine, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)).operator_concat (GALGAS_string (": unreferenced label '") COMMA_SOURCE_FILE_AT_LINE (598)).operator_concat (enumerator_23301.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)).operator_concat (GALGAS_string ("' is deleted\n") COMMA_SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (598)) ;
            {
            ...
            var_symbolTable.modifier_removeKey (enumerator_23301.current_lkey (HERE), joker_23703_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
            }
          }
        ...
        while (enumerator_23931.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_1) {
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (609)) ;
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (611)) ;
          }else if (kBoolFalse == test_1) {
            GALGAS_bool var_isLABEL = callCategoryReader_isLABEL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
            const enumGalgasBool test_2 = var_isLABEL.operator_not (SOURCE_FILE_AT_LINE (614)).operator_and (callCategoryReader_isNULL ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)).operator_not (SOURCE_FILE_AT_LINE (614)) COMMA_SOURCE_FILE_AT_LINE (614)).boolEnum () ;
            if (kBoolTrue == test_2) {
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_23904.reader_string (SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)).operator_concat (GALGAS_string (": dead code is deleted\n") COMMA_SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)) ;
              {
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (616)), index_23904, inCompiler COMMA_SOURCE_FILE_AT_LINE (616)) ;
              }
            }else if (kBoolFalse == test_2) {
              const enumGalgasBool test_3 = var_isLABEL.boolEnum () ;
              if (kBoolTrue == test_3) {
                var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_23931.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (618)) ;
          ...
          index_23904.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
        }
        ...
        if (kBoolTrue == test_4) {
          ...
          while (enumerator_24954.hasCurrentObject ()) {
            callCategoryMethod_setCurrentAddress ((const cPtr_baseline_5F_intermediate_5F_instruction *) enumerator_24954.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (629)) ;
...
static void categoryMethod_baseline_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_baseline_5F_intermediate_5F_GOTO * inObject,
  ...
  routine_findBaselineFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (281)), ioArgument_ioGeneratedInstructionList, joker_10680_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (281)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
        ...
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_11445_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (294)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (294)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_11445_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
          }
        ...
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_11864_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (303)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, cast_11864_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (305)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (304)) ;
          }
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (": GOTO ") COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (" branching to GOTO ") COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (cast_11864_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (312)).reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (" replaced by GOTO ") COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (cast_11864_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (312)).reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)) ;
        }
      }
    }
  }
...
static void categoryMethod_baseline_5F_intermediate_5F_JUMP_optimizeJUMP (const cPtr_baseline_5F_intermediate_5F_JUMP * inObject,
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      ...
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_13211_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (339)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (339)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_13211_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (340)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
      ...
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_13612_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (348)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_13612_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (352)), object->mAttribute_mCurrentPage, object->mAttribute_mTargetPage COMMA_SOURCE_FILE_AT_LINE (350)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string (": JUMP ") COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string (" branching to GOTO ") COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (cast_13612_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (360)).reader_string (SOURCE_FILE_AT_LINE (360)) COMMA_SOURCE_FILE_AT_LINE (360)).operator_concat (GALGAS_string (" replaced by JUMP ") COMMA_SOURCE_FILE_AT_LINE (360)).operator_concat (cast_13612_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (361)).reader_string (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      }
      ...
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_14207_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (365)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_14207_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (369)), object->mAttribute_mCurrentPage, cast_14207_jump.reader_mTargetPage (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (367)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (366)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (": JUMP ") COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (" branching to JUMP ") COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (cast_14207_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (377)).reader_string (SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (GALGAS_string (" replaced by JUMP ") COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (cast_14207_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (378)).reader_string (SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (378)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (376)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_CALL_optimizeCALL (const cPtr_baseline_5F_intermediate_5F_CALL * inObject,
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      ...
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_15587_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (405)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (405)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (409)), cast_15587_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (407)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (406)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (GALGAS_string (": CALL ") COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (415)) COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (GALGAS_string (" to RETLW ") COMMA_SOURCE_FILE_AT_LINE (415)).operator_concat (cast_15587_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (416)).reader_string (SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string (" replaced by MOVLW ") COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (cast_15587_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (417)).reader_string (SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (415)) ;
      }
    }
  }
}
...
static void categoryMethod_baseline_5F_intermediate_5F_JSR_optimizeJSR (const cPtr_baseline_5F_intermediate_5F_JSR * inObject,
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation) {
      ...
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, cast_17012_literalOp.reader_mInstruction (SOURCE_FILE_AT_LINE (443)).objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (443)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        {
        ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (447)), cast_17012_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (448)) COMMA_SOURCE_FILE_AT_LINE (445)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
        }
        ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inLineIndex.reader_string (SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (GALGAS_string (" to RETLW ") COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (cast_17012_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (454)).reader_string (SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (GALGAS_string (" replaced by MOVLW ") COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (cast_17012_literalOp.reader_mLiteralValue (SOURCE_FILE_AT_LINE (455)).reader_string (SOURCE_FILE_AT_LINE (455)) COMMA_SOURCE_FILE_AT_LINE (455)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (455)) COMMA_SOURCE_FILE_AT_LINE (453)) ;
      }
    }
  }
}
