...
//--- Current element access
  public : class GALGAS_baselineSymbolTableForOptimizations_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_baselineSymbolTableForOptimizations_2E_element constructor_new (const class GALGAS_lstring & inOperand0,
