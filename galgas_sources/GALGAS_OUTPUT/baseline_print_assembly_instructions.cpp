...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_ORG_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ORG ").operator_concat (object->mAttribute_mOrigin.reader_hexString (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 11))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 11))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 11)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_ENDOFROUTINE_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (";  END OF ROUTINE ").operator_concat (object->mAttribute_mRoutineName.reader_string (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 23))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 23)).operator_concat (GALGAS_string (" IN PAGE ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 23)).operator_concat (object->mAttribute_mPage.reader_string (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 23))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 23))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 23)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_pseudo_5F_LABEL_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mLabel.mAttribute_string.operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 29))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 29)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_FD_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (categoryReader_mnemonic (object->mAttribute_mInstruction, inCompiler COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 35))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 35)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 35)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 35))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 35))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 35)) ;
  const enumGalgasBool test_0 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", W")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 37)) ;
  }else if (kBoolFalse == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", 1")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 39)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_F_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (categoryReader_mnemonic (object->mAttribute_mInstruction, inCompiler COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 46))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 46)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 46)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 46))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 46))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 46)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_FB_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (categoryReader_mnemonic (object->mAttribute_mInstruction, inCompiler COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52)).operator_concat (object->mAttribute_mBitNumber.reader_string (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 52)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_BitTestSkip_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  BTFSS ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 59)) ;
  }else if (kBoolFalse == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  BTFSC ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 61)) ;
  }
  ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 63)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 63)).operator_concat (object->mAttribute_mBitNumber.reader_string (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 63))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 63))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 63)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_GOTO_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  GOTO ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 69))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 69))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 69)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_SKIP_print (const cPtr_baseline_5F_assembly_5F_instruction * /* inObject */,
                                                               ...
                                                               C_Compiler * /* inCompiler */
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  GOTO * + 2")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 75)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_instruction_5F_literalOperation_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (categoryReader_mnemonic (object->mAttribute_mInstruction, inCompiler COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 88))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 88)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 88)).operator_concat (object->mAttribute_mLiteralValue.reader_hexString (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 88))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 88))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 88)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_incDecRegisterInCondition_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  INCFSZ ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 95)) ;
  }else if (kBoolFalse == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  DECFSZ ")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 97)) ;
  }
  ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 99))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 99)) ;
  const enumGalgasBool test_1 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", W")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 101)) ;
  }else if (kBoolFalse == test_1) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", 1")  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 103)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_assembly_5F_WO_5F_OPERAND_print (const cPtr_baseline_5F_assembly_5F_instruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (categoryReader_mnemonic (object->mAttribute_mInstruction, inCompiler COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 110))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 110))  COMMA_SOURCE_FILE ("baseline_print_assembly_instructions.gSemantics", 110)) ;
}
//-----------------------------------------------------------------------------*
