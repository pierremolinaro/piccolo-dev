...
void routine_handleBaselineInstructionList (const GALGAS_baseline_5F_instructionList constinArgument_inInstructionList,
  ...
  GALGAS_uint index_2407 ((PMUInt32) 0) ;
  while (enumerator_2413.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = outArgument_outContinuesInSequence.operator_not (SOURCE_FILE_AT_LINE (74)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (enumerator_2413.current_mInstruction (HERE).reader_mInstructionLocation (SOURCE_FILE_AT_LINE (75)), GALGAS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (75)) ;
      //-------- @assignmentInstructionForGeneration
      outArgument_outContinuesInSequence = GALGAS_bool (true) ;
    }
    ...
    GALGAS_bool temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, index_2407.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (87)).objectCompare (constinArgument_inInstructionList.reader_length (SOURCE_FILE_AT_LINE (87)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      temp_1 = constinArgument_inLastInstructionShouldReturn ;
    }else if (kBoolFalse == test_2) {
      temp_1 = GALGAS_bool (false) ;
    }
    callCategoryMethod_build_5F_baseline_5F_intermediate_5F_instructionList ((const cPtr_baseline_5F_instruction *) enumerator_2413.current_mInstruction (HERE).ptr (), constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, outArgument_outContinuesInSequence, constinArgument_inRoutineKind, temp_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (78)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_2413.gotoNextObject () ;
    index_2407.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
}
...
static GALGAS_stringset onceFunction_acceptableTRISoperand (C_Compiler * /* inCompiler */
  ...
  //-------- @assignmentInstructionForGeneration
  result_set = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (128)) ;
  //-------- @plusEqualnstructionForGeneration
  result_set.addAssign_operation (GALGAS_string ("GPIO") COMMA_SOURCE_FILE_AT_LINE (129)) ;
  //-------- @plusEqualnstructionForGeneration
  result_set.addAssign_operation (GALGAS_string ("PORTA") COMMA_SOURCE_FILE_AT_LINE (130)) ;
  //-------- @plusEqualnstructionForGeneration
  result_set.addAssign_operation (GALGAS_string ("PORTB") COMMA_SOURCE_FILE_AT_LINE (131)) ;
  //-------- @plusEqualnstructionForGeneration
  result_set.addAssign_operation (GALGAS_string ("PORTC") COMMA_SOURCE_FILE_AT_LINE (132)) ;
  //-------- @plusEqualnstructionForGeneration
  result_set.addAssign_operation (GALGAS_string ("PORTD") COMMA_SOURCE_FILE_AT_LINE (133)) ;
  //-------- @plusEqualnstructionForGeneration
  result_set.addAssign_operation (GALGAS_string ("PORTE") COMMA_SOURCE_FILE_AT_LINE (134)) ;
//---
  return result_set ;
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inRoutineMap, constin_inRegisterTable, constin_inConstantMap, io_ioLocalLabelIndex, io_ioGeneratedInstructionList, io_ioListFileContents, io_ioContinuesInSequence, constin_inRoutineKind, constin_inLastInstructionShouldReturn, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_baseline_5F_instruction_5F_WO_5F_OPERAND_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("the last routine instruction should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_WO_5F_OPERAND::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mInstruction COMMA_SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_TRIS_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("this instruction is the last routine instruction but should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (151)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = function_acceptableTRISoperand (inCompiler COMMA_SOURCE_FILE_AT_LINE (154)).reader_hasKey (object->mAttribute_mOperand.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (154)).operator_not (SOURCE_FILE_AT_LINE (154)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringset enumerator_5463 (function_acceptableTRISoperand (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_5463.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (enumerator_5463.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (157)) ;
      if (enumerator_5463.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (158)) ;
      }
      enumerator_5463.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("invalid TRIS operand; accepted operand are: ").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_uintlist var_registerAddressList ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_uint joker_5695_3 ; // Joker input parameter
  GALGAS_bitSliceTable joker_5695_2 ; // Joker input parameter
  GALGAS_string joker_5695_1 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mOperand, var_registerAddressList, joker_5695_3, joker_5695_2, joker_5695_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (163)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_uint var_opcode ;
  //-------- @methodCallInstructionForGeneration
  var_registerAddressList.method_first (var_opcode, inCompiler COMMA_SOURCE_FILE_AT_LINE (164)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_TRIS::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mOperand, var_opcode COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_MNOP_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("this instruction is the last routine instruction and should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (183)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_instruction_5F_MNOP::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mOccurrenceFactor COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_literalOperation_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inLastInstructionShouldReturn.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mLiteralInstruction.objectCompare (GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (201)))) COMMA_SOURCE_FILE_AT_LINE (201)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mImmediatExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_immediatValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_immediatValue.objectCompare (GALGAS_sint ((PMSInt32) 255L))).operator_or (GALGAS_bool (kIsStrictInf, var_immediatValue.objectCompare (GALGAS_sint ((PMSInt32) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (206)))) COMMA_SOURCE_FILE_AT_LINE (206)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("immediate value is evaluated as ").operator_concat (var_immediatValue.reader_string (SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string (" (should be betwween -128 and 255)") COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inLastInstructionShouldReturn.boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_baseline_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (213)), var_immediatValue.operator_and (GALGAS_sint ((PMSInt32) 255L) COMMA_SOURCE_FILE_AT_LINE (214)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (211)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mLiteralInstruction, var_immediatValue.operator_and (GALGAS_sint ((PMSInt32) 255L) COMMA_SOURCE_FILE_AT_LINE (220)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_FD_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("this instruction is the last routine instruction and should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (240)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (242)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_instruction_5F_FD::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mInstruction_5F_FD_5F_base_5F_code, var_intermediateRegisterDescription, object->mAttribute_m_5F_W_5F_isDestination COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_CALL_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("this instruction is the last routine instruction and should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (269)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inRoutineMap.method_searchKey (object->mAttribute_mTargetLabel, var_isNoReturn, var_page, inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    ...
    inCompiler->emitSemanticError (location_2, GALGAS_string ("a \"noreturn\" routine should be called with a GOTO instruction") COMMA_SOURCE_FILE_AT_LINE (274)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_CALL::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_F_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("this instruction is the last routine instruction and should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (297)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_baseline_5F_intermediate_5F_registerExpression var_intermediateRegisterDescription ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bitSliceTable joker_11292_0 ; // Joker input parameter
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, joker_11292_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_instruction_5F_F::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mFAinstruction, var_intermediateRegisterDescription COMMA_SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_FB_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("this instruction is the last routine instruction and should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (325)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_baseline_5F_intermediate_5F_registerExpression var_intermediateRegisterDescription ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_bitSliceTable var_bitSliceTable ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (327)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_uint var_bitNumber ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_getBitNumber ((const cPtr_bitNumberExpression *) object->mAttribute_mBitNumber.ptr (), var_bitSliceTable, var_bitNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (333)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_baseline_5F_instruction_5F_GOTO_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("this instruction is the last routine instruction and should be MOVLW") COMMA_SOURCE_FILE_AT_LINE (359)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_bool var_isNoReturn ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_luint var_page ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inRoutineMap.method_searchKey (object->mAttribute_mTargetLabel, var_isNoReturn, var_page, inCompiler COMMA_SOURCE_FILE_AT_LINE (361)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_isNoReturn.operator_not (SOURCE_FILE_AT_LINE (362)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (object->mAttribute_mTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("a regular routine should be called with a CALL instruction") COMMA_SOURCE_FILE_AT_LINE (363)) ;
  }
  //-------- @assignmentInstructionForGeneration
  ioArgument_ioContinuesInSequence = GALGAS_bool (false) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel COMMA_SOURCE_FILE_AT_LINE (367)) COMMA_SOURCE_FILE_AT_LINE (367)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_IF_5F_BitTest_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  GALGAS_bitSliceTable var_bitSliceTable ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (386)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_uint var_bitNumber ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_getBitNumber ((const cPtr_bitNumberExpression *) object->mAttribute_mBitNumber.ptr (), var_bitSliceTable, var_bitNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (392)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_baseline_5F_instruction_5F_IF_5F_IncDec_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_baseCode = GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::constructor_INCFSZ (SOURCE_FILE_AT_LINE (433)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_baseCode = GALGAS_baseline_5F_instruction_5F_FD_5F_base_5F_code::constructor_DECFSZ (SOURCE_FILE_AT_LINE (435)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_baseline_5F_intermediate_5F_registerExpression var_intermediateRegisterDescription ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_bitSliceTable var_bitSliceTable ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (438)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_instruction_5F_FD::constructor_new (object->mAttribute_mInstructionLocation, var_baseCode, var_intermediateRegisterDescription, object->mAttribute_m_5F_W_5F_isDestination COMMA_SOURCE_FILE_AT_LINE (444)) COMMA_SOURCE_FILE_AT_LINE (444)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_unusedContinuesInSequence = GALGAS_bool (true) ;
  //-------- @methodCallInstructionForGeneration
...
static void categoryMethod_baseline_5F_instruction_5F_FOREVER_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (constinArgument_inRoutineKind.isValid ()) {
    ...
    case GALGAS_routineKind::kEnum_regularRoutine: {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("a regular routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (480)) ;
      } break ;
    case GALGAS_routineKind::kEnum_noReturnRoutine: {
      } break ;
    case GALGAS_routineKind::kEnum_interruptRoutine: {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("an interrupt routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (483)) ;
      } break ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_label_30_ = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (486)) COMMA_SOURCE_FILE_AT_LINE (486)) ;
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (GALGAS_lstring::constructor_new (var_label_30_, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (488)) COMMA_SOURCE_FILE_AT_LINE (488)) COMMA_SOURCE_FILE_AT_LINE (488)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_handleBaselineInstructionList (object->mAttribute_mInstructionList, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, ioArgument_ioContinuesInSequence, constinArgument_inRoutineKind, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_lstring::constructor_new (var_label_30_, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (504)) COMMA_SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502)) ;
  //-------- @assignmentInstructionForGeneration
  ioArgument_ioContinuesInSequence = GALGAS_bool (false) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_do_5F_while_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_labelInstructionBegin = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (524)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (GALGAS_lstring::constructor_new (var_labelInstructionBegin, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (526)) COMMA_SOURCE_FILE_AT_LINE (526)) COMMA_SOURCE_FILE_AT_LINE (526)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_handleBaselineInstructionList (object->mAttribute_mRepeatedInstructionList, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, ioArgument_ioContinuesInSequence, constinArgument_inRoutineKind, constinArgument_inLastInstructionShouldReturn, inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_baseline_5F_partList enumerator_19290 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19290.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_19290.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (542)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) enumerator_19290.current_mCondition (HERE).ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (false), object->mAttribute_mInstructionLocation, var_labelInstructionBegin, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (543)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_nextBranchLabel = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (552)) COMMA_SOURCE_FILE_AT_LINE (552)) ;
      //-------- @incrementInstructionForGeneration
      ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) enumerator_19290.current_mCondition (HERE).ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (true), object->mAttribute_mInstructionLocation, var_nextBranchLabel, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (553)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_handleBaselineInstructionList (enumerator_19290.current_mInstructionList (HERE), constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, ioArgument_ioContinuesInSequence, constinArgument_inRoutineKind, constinArgument_inLastInstructionShouldReturn, inCompiler COMMA_SOURCE_FILE_AT_LINE (561)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_lstring::constructor_new (var_labelInstructionBegin, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) ;
      //-------- @plusEqualnstructionForGeneration
      ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (GALGAS_lstring::constructor_new (var_nextBranchLabel, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)) ;
    }
...
static void categoryMethod_baseline_5F_instruction_5F_structured_5F_if_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_label_5F_nextCondition = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (593)) COMMA_SOURCE_FILE_AT_LINE (593)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (593)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_label_5F_endOfIfinstruction = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (594)) COMMA_SOURCE_FILE_AT_LINE (594)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (594)) ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) object->mAttribute_mIfCondition.ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (true), object->mAttribute_mInstructionLocation, var_label_5F_nextCondition, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (596)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mElseInstructionList.reader_length (SOURCE_FILE_AT_LINE (618)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (constinArgument_inLastInstructionShouldReturn.operator_not (SOURCE_FILE_AT_LINE (618)) COMMA_SOURCE_FILE_AT_LINE (618)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_lstring::constructor_new (var_label_5F_endOfIfinstruction, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (619)) COMMA_SOURCE_FILE_AT_LINE (619)) COMMA_SOURCE_FILE_AT_LINE (619)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (GALGAS_lstring::constructor_new (var_label_5F_nextCondition, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (621)) COMMA_SOURCE_FILE_AT_LINE (621)) COMMA_SOURCE_FILE_AT_LINE (621)) ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, object->mAttribute_mElseInstructionList.reader_length (SOURCE_FILE_AT_LINE (634)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (constinArgument_inLastInstructionShouldReturn.operator_not (SOURCE_FILE_AT_LINE (634)) COMMA_SOURCE_FILE_AT_LINE (634)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (GALGAS_lstring::constructor_new (var_label_5F_endOfIfinstruction, object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (635)) COMMA_SOURCE_FILE_AT_LINE (635)) COMMA_SOURCE_FILE_AT_LINE (635)) ;
  }
  //-------- @assignmentInstructionForGeneration
  ioArgument_ioContinuesInSequence = var_thenContinuesInSequence.operator_or (var_elseContinuesInSequence COMMA_SOURCE_FILE_AT_LINE (638)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_negateCondition_build_5F_intermediate_5F_condition_5F_instructions (const cPtr_baseline_5F_conditionExpression * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) object->mAttribute_mCondition.ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, constinArgument_inComplementaryBranch.operator_not (SOURCE_FILE_AT_LINE (695)), constinArgument_inInstructionLocation, constinArgument_inTargetLabel, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (692)) ;
  //-------- END @methodCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_andCondition_build_5F_intermediate_5F_condition_5F_instructions (const cPtr_baseline_5F_conditionExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (true), constinArgument_inInstructionLocation, constinArgument_inTargetLabel, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (713)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (true), constinArgument_inInstructionLocation, constinArgument_inTargetLabel, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (721)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_label_30_ = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (730)) COMMA_SOURCE_FILE_AT_LINE (730)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (730)) ;
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (true), constinArgument_inInstructionLocation, var_label_30_, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (731)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (false), constinArgument_inInstructionLocation, constinArgument_inTargetLabel, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (739)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (GALGAS_lstring::constructor_new (var_label_30_, constinArgument_inInstructionLocation COMMA_SOURCE_FILE_AT_LINE (747)) COMMA_SOURCE_FILE_AT_LINE (747)) COMMA_SOURCE_FILE_AT_LINE (747)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_bitTest_5F_in_5F_structured_5F_if_5F_condition_build_5F_intermediate_5F_condition_5F_instructions (const cPtr_baseline_5F_conditionExpression * inObject,
  ...
  GALGAS_bitSliceTable var_bitSliceTable ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (761)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_uint var_bitNumber ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_getBitNumber ((const cPtr_bitNumberExpression *) object->mAttribute_mBitNumber.ptr (), var_bitSliceTable, var_bitNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (767)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_instruction_5F_BitTestSkip::constructor_new (constinArgument_inInstructionLocation, object->mAttribute_mBTFSSinstruction.operator_xor (constinArgument_inComplementaryBranch COMMA_SOURCE_FILE_AT_LINE (773)), var_intermediateRegisterDescription, var_bitNumber COMMA_SOURCE_FILE_AT_LINE (771)) COMMA_SOURCE_FILE_AT_LINE (771)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioGeneratedInstructionList.addAssign_operation (GALGAS_baseline_5F_intermediate_5F_GOTO::constructor_new (constinArgument_inInstructionLocation, GALGAS_lstring::constructor_new (constinArgument_inTargetLabel, constinArgument_inInstructionLocation COMMA_SOURCE_FILE_AT_LINE (779)) COMMA_SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)) ;
}
//---------------------------------------------------------------------------*
