...
void routine_handleBaselineInstructionList (const GALGAS_uint constinArgument_inCurrentPage,
  ...
  cEnumerator_baseline_5F_instructionList enumerator_2553 (constinArgument_inInstructionList, kEnumeration_up) ;
  GALGAS_uint index_2547 ((PMUInt32) 0) ;
  while (enumerator_2553.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_2553.current_mInstruction (HERE).reader_mInstructionLocation (SOURCE_FILE_AT_LINE (79)), GALGAS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (79)) ;
      outArgument_outContinuesInSequence = GALGAS_bool (true) ;
    }
    //--- @ifExpressionForGeneration
    GALGAS_bool temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, index_2547.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (92)).objectCompare (constinArgument_inInstructionList.reader_length (SOURCE_FILE_AT_LINE (92)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      temp_1 = constinArgument_inLastInstructionShouldReturn ;
    }else if (kBoolFalse == test_2) {
      temp_1 = GALGAS_bool (false) ;
    }
    callCategoryMethod_build_5F_baseline_5F_intermediate_5F_instructionList ((const cPtr_baseline_5F_instruction *) enumerator_2553.current_mInstruction (HERE).ptr (), constinArgument_inCurrentPage, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, outArgument_outContinuesInSequence, constinArgument_inRoutineKind, temp_1, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (82)) ;
    enumerator_2553.gotoNextObject () ;
    index_2547.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
}
...
static void categoryMethod_registerExpression_resolveBaselineAccess (const cPtr_registerExpression * inObject,
  ...
  GALGAS_string joker_1310_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, var_registerAddressList, var_size, outArgument_outBitSliceTable, joker_1310_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (34)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_uintlist enumerator_1493 (var_registerAddressList, kEnumeration_up) ;
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (45)).isValidAndTrue () ;
    if (enumerator_1493.hasCurrentObject () && bool_2) {
      while (enumerator_1493.hasCurrentObject () && bool_2) {
        var_registerAddress = enumerator_1493.current_mValue (HERE) ;
        var_found = GALGAS_bool (kIsInfOrEqual, enumerator_1493.current_mValue (HERE).objectCompare (GALGAS_uint ((PMUInt32) 31U))) ;
        enumerator_1493.gotoNextObject () ;
        if (enumerator_1493.hasCurrentObject ()) {
...
static void categoryMethod_baseline_5F_instruction_5F_TRIS_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_stringset enumerator_5848 (function_acceptableTRISoperand (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)), kEnumeration_up) ;
    while (enumerator_5848.hasCurrentObject ()) {
      var_s.dotAssign_operation (enumerator_5848.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (169)) ;
  ...
  GALGAS_uintlist var_registerAddressList ;
  GALGAS_uint joker_6080_3 ; // Joker input parameter
  GALGAS_bitSliceTable joker_6080_2 ; // Joker input parameter
  GALGAS_string joker_6080_1 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mOperand, var_registerAddressList, joker_6080_3, joker_6080_2, joker_6080_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)) ;
...
static void categoryMethod_baseline_5F_instruction_5F_F_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  GALGAS_baseline_5F_intermediate_5F_registerExpression var_intermediateRegisterDescription ;
  GALGAS_bitSliceTable joker_13488_0 ; // Joker input parameter
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, joker_13488_0, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (367)) ;
...
static void categoryMethod_baseline_5F_instruction_5F_FOREVER_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  GALGAS_string var_label_30_ = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)) ;
...
static void categoryMethod_baseline_5F_instruction_5F_STATIC_5F_REPEAT_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  cEnumerator_range enumerator_23623 (GALGAS_range::constructor_new (GALGAS_uint ((PMUInt32) 0U), var_repeatCount.substract_operation (GALGAS_sint_36__34_ ((PMSInt64) 1LL), inCompiler COMMA_SOURCE_FILE_AT_LINE (671)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)), kEnumeration_up) ;
  ...
  if (enumerator_23623.hasCurrentObject () && bool_2) {
    while (enumerator_23623.hasCurrentObject () && bool_2) {
      {
      routine_handleBaselineInstructionList (constinArgument_inCurrentPage, object->mAttribute_mInstructionList, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, ioArgument_ioContinuesInSequence, constinArgument_inRoutineKind, GALGAS_bool (false), ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (672)) ;
      }
      enumerator_23623.gotoNextObject () ;
      if (enumerator_23623.hasCurrentObject ()) {
...
static void categoryMethod_baseline_5F_instruction_5F_do_5F_while_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  GALGAS_string var_labelInstructionBegin = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (705)) COMMA_SOURCE_FILE_AT_LINE (705)) ;
  ...
  cEnumerator_baseline_5F_partList enumerator_25290 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_25290.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_25290.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (725)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) enumerator_25290.current_mCondition (HERE).ptr (), constinArgument_inCurrentPage, constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (false), object->mAttribute_mInstructionLocation, var_labelInstructionBegin, ioArgument_ioGeneratedInstructionList, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (726)) ;
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_nextBranchLabel = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (737)) COMMA_SOURCE_FILE_AT_LINE (737)) ;
      ...
      {
      routine_handleBaselineInstructionList (constinArgument_inCurrentPage, enumerator_25290.current_mInstructionList (HERE), constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, ioArgument_ioContinuesInSequence, constinArgument_inRoutineKind, constinArgument_inLastInstructionShouldReturn, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (748)) ;
      }
...
static void categoryMethod_baseline_5F_instruction_5F_structured_5F_if_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  GALGAS_string var_label_5F_nextCondition = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (787)) COMMA_SOURCE_FILE_AT_LINE (787)) ;
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (787)) ;
  GALGAS_string var_label_5F_endOfIfinstruction = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (788)) COMMA_SOURCE_FILE_AT_LINE (788)) ;
...
static void categoryMethod_baseline_5F_andCondition_build_5F_intermediate_5F_condition_5F_instructions (const cPtr_baseline_5F_conditionExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_string var_label_30_ = GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (948)) COMMA_SOURCE_FILE_AT_LINE (948)) ;
