...
//                    september 28th, 2013, at 9h58'34"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_F_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  GALGAS_baseline_5F_intermediate_5F_registerExpression var_intermediateRegisterDescription ;
  GALGAS_bitSliceTable joker_13002_0 ; // Joker input parameter
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, joker_13002_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (353)) ;
...
static void categoryMethod_baseline_5F_instruction_5F_do_5F_while_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  cEnumerator_baseline_5F_partList enumerator_22531 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_22531.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_22531.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (639)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) enumerator_22531.current_mCondition (HERE).ptr (), constinArgument_inCurrentPage, constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (false), object->mAttribute_mInstructionLocation, var_labelInstructionBegin, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (640)) ;
    }else if (kBoolFalse == test_0) {
      ...
      {
      routine_handleBaselineInstructionList (constinArgument_inCurrentPage, enumerator_22531.current_mInstructionList (HERE), constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, ioArgument_ioContinuesInSequence, constinArgument_inRoutineKind, constinArgument_inLastInstructionShouldReturn, inCompiler COMMA_SOURCE_FILE_AT_LINE (660)) ;
      }
