...
void routine_handleBaselineInstructionList (const GALGAS_uint constinArgument_inCurrentPage,
  ...
  cEnumerator_baseline_5F_instructionList enumerator_2437 (constinArgument_inInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_2431 ((PMUInt32) 0) ;
  while (enumerator_2437.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      inCompiler->emitSemanticError (enumerator_2437.current_mInstruction (HERE).reader_mInstructionLocation (SOURCE_FILE_AT_LINE (76)), GALGAS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (76)) ;
      //-------- @assignmentInstructionForGeneration
      outArgument_outContinuesInSequence = GALGAS_bool (true) ;
    }
...
static void categoryMethod_registerExpression_resolveBaselineAccess (const cPtr_registerExpression * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_1225_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, var_registerAddressList, var_size, outArgument_outBitSliceTable, joker_1225_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (32)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (kBoolTrue == test_1) {
    ...
    if (enumerator_1408.hasCurrentObject () && bool_2) {
      while (enumerator_1408.hasCurrentObject () && bool_2) {
        //-------- @assignmentInstructionForGeneration
        var_registerAddress = enumerator_1408.current_mValue (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsInfOrEqual, enumerator_1408.current_mValue (HERE).objectCompare (GALGAS_uint ((PMUInt32) 31U))) ;
...
static void categoryMethod_baseline_5F_instruction_5F_TRIS_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringset enumerator_5601 (function_acceptableTRISoperand (inCompiler COMMA_SOURCE_FILE_AT_LINE (161)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_5601.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (enumerator_5601.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (162)) ;
      if (enumerator_5601.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
  ...
  GALGAS_uintlist var_registerAddressList ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_uint joker_5833_3 ; // Joker input parameter
  GALGAS_bitSliceTable joker_5833_2 ; // Joker input parameter
  GALGAS_string joker_5833_1 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mOperand, var_registerAddressList, joker_5833_3, joker_5833_2, joker_5833_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_baseline_5F_instruction_5F_F_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  GALGAS_baseline_5F_intermediate_5F_registerExpression var_intermediateRegisterDescription ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bitSliceTable joker_12990_0 ; // Joker input parameter
  callCategoryMethod_resolveBaselineAccess ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inRegisterTable, var_intermediateRegisterDescription, joker_12990_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (353)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_baseline_5F_instruction_5F_do_5F_while_build_5F_baseline_5F_intermediate_5F_instructionList (const cPtr_baseline_5F_instruction * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_baseline_5F_partList enumerator_22519 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_22519.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_22519.current_mInstructionList (HERE).reader_length (SOURCE_FILE_AT_LINE (639)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_build_5F_intermediate_5F_condition_5F_instructions ((const cPtr_baseline_5F_conditionExpression *) enumerator_22519.current_mCondition (HERE).ptr (), constinArgument_inCurrentPage, constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (false), object->mAttribute_mInstructionLocation, var_labelInstructionBegin, ioArgument_ioGeneratedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (640)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
