...
#ifndef baseline_5F_semantic_5F_analysis_ENTITIES_DEFINED
#define baseline_5F_semantic_5F_analysis_ENTITIES_DEFINED
...
//--- Current element access
  public : class GALGAS_baselineRoutineMap_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_baselineRoutineMap_2E_element constructor_new (const class GALGAS_lstring & inOperand0,
