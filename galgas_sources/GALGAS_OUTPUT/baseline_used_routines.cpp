...
void routine_addBaselineUsedRoutinesFromInstructionList (const GALGAS_baseline_5F_instructionList constinArgument_inInstructionList,
  ...
  while (enumerator_4775.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_baseline_5F_instruction *) enumerator_4775.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
...
GALGAS_stringset function_baseline_5F_computeUsedRoutines (const GALGAS_baseline_5F_routineDefinitionList & constinArgument_inRoutineDefinitionList,
  ...
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (172)).isValid ()) {
    uint32_t variant_5238 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (172)).uintValue () ;
    bool loop_5238 = true ;
    while (loop_5238) {
      ...
      if (loop_5238) {
        ...
        while (enumerator_5372.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_5372.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (176)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addBaselineUsedRoutinesFromInstructionList (enumerator_5372.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) ;
            }
          }
