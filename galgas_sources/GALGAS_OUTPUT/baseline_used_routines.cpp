...
void routine_addBaselineUsedRoutinesFromInstructionList (const GALGAS_baseline_5F_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_baseline_5F_instructionList enumerator_4784 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_4784.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_baseline_5F_instruction *) enumerator_4784.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
...
GALGAS_stringset function_baseline_5F_computeUsedRoutines (const GALGAS_baseline_5F_routineDefinitionList & constinArgument_inRoutineDefinitionList,
  ...
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (172)).isValid ()) {
    PMUInt32 variant_5246 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (172)).uintValue () ;
    bool loop_5246 = true ;
    while (loop_5246) {
      loop_5246 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_5246) {
        loop_5246 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_5246 && (0 == variant_5246)) {
        loop_5246 = false ;
      ...
      if (loop_5246) {
        ...
        cEnumerator_baseline_5F_routineDefinitionList enumerator_5381 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_5381.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_5381.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (176)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addBaselineUsedRoutinesFromInstructionList (enumerator_5381.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) ;
            }
          }
...
static void categoryMethod_baseline_5F_instruction_5F_do_5F_while_addUsedRoutines (const cPtr_baseline_5F_instruction * inObject,
  ...
  cEnumerator_baseline_5F_partList enumerator_3439 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_3439.hasCurrentObject ()) {
    {
    routine_addBaselineUsedRoutinesFromInstructionList (enumerator_3439.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) ;
    }
