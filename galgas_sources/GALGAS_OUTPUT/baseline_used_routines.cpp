...
void routine_addBaselineUsedRoutinesFromInstructionList (const GALGAS_baseline_5F_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_baseline_5F_instructionList enumerator_4509 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_4509.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_baseline_5F_instruction *) enumerator_4509.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (150)) ;
...
GALGAS_stringset function_baseline_5F_computeUsedRoutines (const GALGAS_baseline_5F_routineDefinitionList & constinArgument_inRoutineDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (161)) ;
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (163)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (164)).isValid ()) {
    PMUInt32 variant_4971 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (164)).uintValue () ;
    bool loop_4971 = true ;
    while (loop_4971) {
      loop_4971 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_4971) {
        loop_4971 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_4971 && (0 == variant_4971)) {
        loop_4971 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (164)) ;
      }
      if (loop_4971) {
        variant_4971 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_baseline_5F_routineDefinitionList enumerator_5106 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_5106.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_5106.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (168)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addBaselineUsedRoutinesFromInstructionList (enumerator_5106.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
            }
          }
...
static void categoryMethod_baseline_5F_instruction_5F_do_5F_while_addUsedRoutines (const cPtr_baseline_5F_instruction * inObject,
  ...
  {
  routine_addBaselineUsedRoutinesFromInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  cEnumerator_baseline_5F_partList enumerator_3164 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_3164.hasCurrentObject ()) {
    {
    routine_addBaselineUsedRoutinesFromInstructionList (enumerator_3164.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
    }
...
static void categoryMethod_baseline_5F_instruction_5F_structured_5F_if_addUsedRoutines (const cPtr_baseline_5F_instruction * inObject,
  ...
  {
  routine_addBaselineUsedRoutinesFromInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  {
  routine_addBaselineUsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_baseline_5F_instruction_5F_JSR_addUsedRoutines (const cPtr_baseline_5F_instruction * inObject,
  ...
  ioArgument_ioUsedRoutines.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (133)) ;
}
//---------------------------------------------------------------------------*
