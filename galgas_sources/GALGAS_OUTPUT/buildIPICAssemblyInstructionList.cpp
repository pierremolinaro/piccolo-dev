...
void routine_buildIPICAssemblyInstructionList (C_Compiler & _inLexique,
    ...
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, GGS_uint (true, 24U) COMMA_HERE)) ;
    {
      ...
      while (((operand_33569 = enumerator_33569.nextObject ()))) {
        ...
        if (((operand_33569->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1032)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          ...
          var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_instruction_RETFIE ::constructor_new (_inLexique, GGS_location (_inLexique), operand_33569->mFastReturn COMMA_HERE)) ;
        }
      }
    }
  }
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_34347 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1048)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_34347 = NULL ;
      while (((operand_34347 = enumerator_34347.nextObject ()))) {
        macroValidPointer (operand_34347) ;
        if (((operand_34347->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1049)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_34456 (operand_34347->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_34456 = NULL ;
            while (((operand_34456 = enumerator_34456.nextObject ()))) {
              macroValidPointer (operand_34456) ;
              const GGS_piccolo_instruction  _temp_34500 = operand_34456->mInstruction ;
              if (_temp_34500._isBuilt ()) {
                typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_34500._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_34500 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (1051)) ;
                }
              }
            }
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_34836 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1059)), true) ;
    const GGS_routineDefinitionList::cElement * operand_34836 = NULL ;
    while (((operand_34836 = enumerator_34836.nextObject ()))) {
      macroValidPointer (operand_34836) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_34836->mRoutineName COMMA_HERE)) ;
      {
        GGS_instructionList::cEnumerator enumerator_34968 (operand_34836->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_34968 = NULL ;
        while (((operand_34968 = enumerator_34968.nextObject ()))) {
          macroValidPointer (operand_34968) ;
          const GGS_piccolo_instruction  _temp_35008 = operand_34968->mInstruction ;
          if (_temp_35008._isBuilt ()) {
            typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_35008._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_35008 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (1062)) ;
            }
          }
        }
      }
      if (((operand_34836->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_34836->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1066)) COMMA_HERE)) ;
      }
    }
  }
  ...
  const GGS_registerExpression  _temp_35562 = var_cas_WREGregister ;
  if (_temp_35562._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_35562._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_35562 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1072)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_35877 = var_cas_TOSLregister ;
  if (_temp_35877._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_35877._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_35877 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (1081)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_36192 = var_cas_TOSHregister ;
  if (_temp_36192._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_36192._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_36192 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1090)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_36507 = var_cas_TOSUregister ;
  if (_temp_36507._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_36507._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_36507 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1099)) ;
    }
  }
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1153)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_ipic_instructionList::cEnumerator enumerator_38711 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_ipic_instructionList::cElement * operand_38711 = NULL ;
      while (((operand_38711 = enumerator_38711.nextObject ()))) {
        macroValidPointer (operand_38711) ;
        const GGS_ipic_instruction  _temp_38762 = operand_38711->mInstruction ;
        if (_temp_38762._isBuilt ()) {
          _temp_38762 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (1160)) ;
        }
        ...
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_ipic_instruction  _temp_38902 = operand_38711->mInstruction ;
        if (_temp_38902._isBuilt ()) {
          _temp_38902 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1162)) ;
        }
        var_cas_ioListFileContents.writeString ("\n") ;
