...
void routine_buildIPICAssemblyInstructionList (C_Compiler & _inLexique,
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListFile" COMMA_SOURCE_FILE_AT_LINE (1153)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_ipic_instructionList::cEnumerator enumerator_38708 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_ipic_instructionList::cElement * operand_38708 = NULL ;
      while (((operand_38708 = enumerator_38708.nextObject ()))) {
        macroValidPointer (operand_38708) ;
        const GGS_ipic_instruction  _temp_38759 = operand_38708->mInstruction ;
        if (_temp_38759._isBuilt ()) {
          _temp_38759 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (1160)) ;
        }
        ...
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_ipic_instruction  _temp_38899 = operand_38708->mInstruction ;
        if (_temp_38899._isBuilt ()) {
          _temp_38899 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1162)) ;
        }
        var_cas_ioListFileContents.writeString ("\n") ;
