...
void cParser_communs::rule_communs_declaration_5F_in_5F_ram_i1_ (GALGAS_declarationInRam & outArgument_outDeclaration,
  ...
  case 1: {
    var_size = GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 1U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (38)) ;
  } break ;
  case 2: {
    ...
    while (repeatFlag_0) {
      ...
      case 1: {
        ...
        while (repeatFlag_1) {
          ...
          case 1: {
            const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (GALGAS_uint ((uint32_t) 1U))) COMMA_SOURCE_FILE_AT_LINE (62)).boolEnum () ;
            if (kBoolTrue == test_3) {
          ...
          case 2: {
            ...
            const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (var_sliceSize.reader_uint (SOURCE_FILE_AT_LINE (70)))) COMMA_SOURCE_FILE_AT_LINE (70)).boolEnum () ;
            if (kBoolTrue == test_5) {
            ...
            var_sliceBase = var_sliceBase.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (74)).substract_operation (var_sliceSize.reader_uint (SOURCE_FILE_AT_LINE (74)), inCompiler COMMA_SOURCE_FILE_AT_LINE (74)) ;
...
void cParser_communs::rule_communs_immediate_5F_primary_i9_ (GALGAS_immediatExpression & outArgument_outExpression,
  ...
  case 5: {
    ...
    case 1: {
      var_offset = GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (278)) ;
    } break ;
    case 2: {
...
void cParser_communs::rule_communs_register_5F_parsing_i10_ (GALGAS_registerExpression & outArgument_outRegisterExpression,
  ...
  case 1: {
    var_offset = GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (318)) ;
  } break ;
  case 2: {
...
void cParser_communs::rule_communs_bit_5F_number_5F_parsing_i11_ (GALGAS_bitNumberExpression & outArgument_outBitNumber,
  ...
  case 1: {
    var_bitIndex = GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (336)) ;
  } break ;
  case 2: {
