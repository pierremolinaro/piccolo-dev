...
static void categoryMethod_bitNumberLiteralValue_display (const cPtr_bitNumberExpression * inObject,
  ...
  ioArgument_ioString.dotAssign_operation (object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE ("generic_metamodel.gSemantics", 256)).reader_string (SOURCE_FILE ("generic_metamodel.gSemantics", 256))  COMMA_SOURCE_FILE ("generic_metamodel.gSemantics", 256)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_bitNumberLabelValue_display (const cPtr_bitNumberExpression * inObject,
  ...
  ioArgument_ioString.dotAssign_operation (object->mAttribute_mBitNumberLabelValue.reader_string (SOURCE_FILE ("generic_metamodel.gSemantics", 269)).operator_concat (GALGAS_string (" [")  COMMA_SOURCE_FILE ("generic_metamodel.gSemantics", 269)).operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE ("generic_metamodel.gSemantics", 269)).reader_string (SOURCE_FILE ("generic_metamodel.gSemantics", 269))  COMMA_SOURCE_FILE ("generic_metamodel.gSemantics", 269)).operator_concat (GALGAS_string ("]")  COMMA_SOURCE_FILE ("generic_metamodel.gSemantics", 269))  COMMA_SOURCE_FILE ("generic_metamodel.gSemantics", 269)) ;
}
//-----------------------------------------------------------------------------*
...
GALGAS_immediatExpressionList_2E_element GALGAS_immediatExpressionList_2E_element::constructor_new (const GALGAS_immediatExpression & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_immediatExpressionList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
GALGAS_location GALGAS_immediatExpressionList_2E_element::reader_mErrorLocation (UNUSED_LOCATION_ARGS) const {
