...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mSliceIndex._operator_isEqual (ptr->mInfo.mSliceIndex)).boolValue ()
           && (mInfo.mSliceSize._operator_isEqual (ptr->mInfo.mSliceSize)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mRegisterName._operator_isEqual (ptr->mRegisterName).boolValue ()
         && mOffset._operator_isEqual (ptr->mOffset).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mName._operator_isEqual (ptr->mName).boolValue ()
         && mSize._operator_isEqual (ptr->mSize).boolValue ()
         && mBitSliceTable._operator_isEqual (ptr->mBitSliceTable).boolValue ()
         && mBitDefinitionString._operator_isEqual (ptr->mBitDefinitionString).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mDeclarationInRAM._operator_isEqual (ptr->mDeclarationInRAM).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mDeclarations._operator_isEqual (ptr->mDeclarations).boolValue ()
         && mEndOfBranchLocation._operator_isEqual (ptr->mEndOfBranchLocation).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mBankName._operator_isEqual (ptr->mBankName).boolValue ()
         && mDeclaration._operator_isEqual (ptr->mDeclaration).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mSettingName._operator_isEqual (ptr->mSettingName).boolValue ()
         && mSettingValue._operator_isEqual (ptr->mSettingValue).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mDefinitionLocation._operator_isEqual (ptr->mDefinitionLocation).boolValue ()
         && mSettingList._operator_isEqual (ptr->mSettingList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mRegister._operator_isEqual (ptr->mRegister).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mSliceName._operator_isEqual (ptr->mSliceName).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mRegisterName._operator_isEqual (ptr->mRegisterName).boolValue ()
         && mSliceExpressionList._operator_isEqual (ptr->mSliceExpressionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mRegisterAddress._operator_isEqual (ptr->mInfo.mRegisterAddress)).boolValue ()
           && (mInfo.mRegisterValue._operator_isEqual (ptr->mInfo.mRegisterValue)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mBitNumberLiteralValue._operator_isEqual (ptr->mBitNumberLiteralValue).boolValue () ;
  }
  return equal ;
}
...
method_display (C_Compiler & inLexique,
  ...
  var_cas_ioString._dotAssign_operation (mBitNumberLiteralValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (261)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (261))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mBitNumberLabelValue._operator_isEqual (ptr->mBitNumberLabelValue).boolValue ()
         && mBitNumberIndexValue._operator_isEqual (ptr->mBitNumberIndexValue).boolValue () ;
  }
  return equal ;
}
...
method_display (C_Compiler & inLexique,
                                GGS_string& var_cas_ioString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioString._dotAssign_operation (mBitNumberLabelValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271))) ;
  var_cas_ioString.appendCString (" [") ;
  var_cas_ioString._dotAssign_operation (mBitNumberIndexValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (271)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271))) ;
  var_cas_ioString.appendCString ("]") ;
}
