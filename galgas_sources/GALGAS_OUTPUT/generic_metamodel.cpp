...
static void categoryMethod_bitNumberLiteralValue_display (const cPtr_bitNumberExpression * inObject,
  ...
  ioArgument_ioString.dotAssign_operation (object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (256)).reader_string (SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (256)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_bitNumberLabelValue_display (const cPtr_bitNumberExpression * inObject,
  ...
  ioArgument_ioString.dotAssign_operation (object->mAttribute_mBitNumberLabelValue.reader_string (SOURCE_FILE_AT_LINE (269)).operator_concat (GALGAS_string (" [") COMMA_SOURCE_FILE_AT_LINE (269)).operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (269)).reader_string (SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)) ;
}
//---------------------------------------------------------------------------*
