...
enumComparisonResult cMapElement_bitSliceTable::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_bitSliceTable_searchKey [31] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_bitSliceTable::method_searchKey (GALGAS_lstring inKey,
  ...
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_bitSliceTable_searchKey COMMA_THERE) ;
  const cMapElement_bitSliceTable * p = (const cMapElement_bitSliceTable *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_bitSliceTable) ;
...
void GALGAS_bitSliceTable::modifier_setMSliceIndexForKey (GALGAS_uint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_bitSliceTable) ;
...
cMapElement_bitSliceTable * GALGAS_bitSliceTable::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_bitSliceTable) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_bitSliceTable::current_lkey (void) const {
...
GALGAS_uint cEnumerator_bitSliceTable::current_mSliceIndex (void) const {
  const cMapElement_bitSliceTable * p = (const cMapElement_bitSliceTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_bitSliceTable) ;
...
GALGAS_uint cEnumerator_bitSliceTable::current_mSliceSize (void) const {
  const cMapElement_bitSliceTable * p = (const cMapElement_bitSliceTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_bitSliceTable) ;
...
enumComparisonResult cCollectionElement_declarationInRamList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_declarationInRamList::modifier_popFirst (GALGAS_declarationInRam & outOperand0,
  ...
  cCollectionElement_declarationInRamList * p = (cCollectionElement_declarationInRamList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_declarationInRamList) ;
...
void GALGAS_declarationInRamList::modifier_setMDeclarationInRAMAtIndex (GALGAS_declarationInRam inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_declarationInRamList * p = (cCollectionElement_declarationInRamList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_declarationInRamList) ;
    p->mAttribute_mDeclarationInRAM = inOperand ;
  }
}
...
GALGAS_declarationInRam cEnumerator_declarationInRamList::current_mDeclarationInRAM (void) const {
  const cCollectionElement_declarationInRamList * p = (const cCollectionElement_declarationInRamList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_declarationInRamList) ;
...
enumComparisonResult cCollectionElement_commonBranchList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_commonBranchList::modifier_popFirst (GALGAS_declarationInRamList & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_commonBranchList * p = (cCollectionElement_commonBranchList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_commonBranchList) ;
...
void GALGAS_commonBranchList::modifier_setMDeclarationsAtIndex (GALGAS_declarationInRamList inOperand,
                                                                GALGAS_uint inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_commonBranchList * p = (cCollectionElement_commonBranchList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_commonBranchList) ;
    p->mAttribute_mDeclarations = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_commonBranchList::modifier_setMEndOfBranchLocationAtIndex (GALGAS_location inOperand,
                                                                       GALGAS_uint inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement_commonBranchList * p = (cCollectionElement_commonBranchList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_commonBranchList) ;
    p->mAttribute_mEndOfBranchLocation = inOperand ;
  }
}
...
GALGAS_declarationInRamList cEnumerator_commonBranchList::current_mDeclarations (void) const {
  const cCollectionElement_commonBranchList * p = (const cCollectionElement_commonBranchList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_commonBranchList) ;
  return p->mAttribute_mDeclarations ;
}

//---------------------------------------------------------------------------*

GALGAS_location cEnumerator_commonBranchList::current_mEndOfBranchLocation (void) const {
  const cCollectionElement_commonBranchList * p = (const cCollectionElement_commonBranchList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_commonBranchList) ;
...
enumComparisonResult cCollectionElement_ramDefinitionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_ramDefinitionList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_ramDefinitionList * p = (cCollectionElement_ramDefinitionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_ramDefinitionList) ;
...
void GALGAS_ramDefinitionList::modifier_setMBankNameAtIndex (GALGAS_lstring inOperand,
                                                             GALGAS_uint inIndex,
                                                             C_Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_ramDefinitionList * p = (cCollectionElement_ramDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_ramDefinitionList) ;
    p->mAttribute_mBankName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_ramDefinitionList::modifier_setMDeclarationAtIndex (GALGAS_declarationInRamList inOperand,
                                                                GALGAS_uint inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_ramDefinitionList * p = (cCollectionElement_ramDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_ramDefinitionList) ;
    p->mAttribute_mDeclaration = inOperand ;
  }
}
...
GALGAS_lstring cEnumerator_ramDefinitionList::current_mBankName (void) const {
  const cCollectionElement_ramDefinitionList * p = (const cCollectionElement_ramDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_ramDefinitionList) ;
  return p->mAttribute_mBankName ;
}

//---------------------------------------------------------------------------*

GALGAS_declarationInRamList cEnumerator_ramDefinitionList::current_mDeclaration (void) const {
  const cCollectionElement_ramDefinitionList * p = (const cCollectionElement_ramDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_ramDefinitionList) ;
...
enumComparisonResult cCollectionElement_configSettingList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_configSettingList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_configSettingList * p = (cCollectionElement_configSettingList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_configSettingList) ;
...
void GALGAS_configSettingList::modifier_setMSettingNameAtIndex (GALGAS_lstring inOperand,
                                                                GALGAS_uint inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_configSettingList * p = (cCollectionElement_configSettingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_configSettingList) ;
    p->mAttribute_mSettingName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_configSettingList::modifier_setMSettingValueAtIndex (GALGAS_lstring inOperand,
                                                                 GALGAS_uint inIndex,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement_configSettingList * p = (cCollectionElement_configSettingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_configSettingList) ;
    p->mAttribute_mSettingValue = inOperand ;
  }
}
...
GALGAS_lstring cEnumerator_configSettingList::current_mSettingName (void) const {
  const cCollectionElement_configSettingList * p = (const cCollectionElement_configSettingList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_configSettingList) ;
  return p->mAttribute_mSettingName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring cEnumerator_configSettingList::current_mSettingValue (void) const {
  const cCollectionElement_configSettingList * p = (const cCollectionElement_configSettingList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_configSettingList) ;
...
enumComparisonResult cCollectionElement_configDefinitionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_configDefinitionList::modifier_popFirst (GALGAS_location & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_configDefinitionList * p = (cCollectionElement_configDefinitionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_configDefinitionList) ;
...
void GALGAS_configDefinitionList::modifier_setMDefinitionLocationAtIndex (GALGAS_location inOperand,
                                                                          GALGAS_uint inIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_configDefinitionList * p = (cCollectionElement_configDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_configDefinitionList) ;
    p->mAttribute_mDefinitionLocation = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_configDefinitionList::modifier_setMSettingListAtIndex (GALGAS_configSettingList inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_configDefinitionList * p = (cCollectionElement_configDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_configDefinitionList) ;
    p->mAttribute_mSettingList = inOperand ;
  }
}
...
GALGAS_location cEnumerator_configDefinitionList::current_mDefinitionLocation (void) const {
  const cCollectionElement_configDefinitionList * p = (const cCollectionElement_configDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_configDefinitionList) ;
  return p->mAttribute_mDefinitionLocation ;
}

//---------------------------------------------------------------------------*

GALGAS_configSettingList cEnumerator_configDefinitionList::current_mSettingList (void) const {
  const cCollectionElement_configDefinitionList * p = (const cCollectionElement_configDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_configDefinitionList) ;
...
enumComparisonResult cCollectionElement_immediatExpressionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_immediatExpressionList::modifier_popFirst (GALGAS_immediatExpression & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_immediatExpressionList * p = (cCollectionElement_immediatExpressionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_immediatExpressionList) ;
...
void GALGAS_immediatExpressionList::modifier_setMExpressionAtIndex (GALGAS_immediatExpression inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_immediatExpressionList * p = (cCollectionElement_immediatExpressionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_immediatExpressionList) ;
...
GALGAS_immediatExpression cEnumerator_immediatExpressionList::current_mExpression (void) const {
  const cCollectionElement_immediatExpressionList * p = (const cCollectionElement_immediatExpressionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_immediatExpressionList) ;
...
enumComparisonResult cCollectionElement_immediatSliceExpressionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_immediatSliceExpressionList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_immediatSliceExpressionList * p = (cCollectionElement_immediatSliceExpressionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_immediatSliceExpressionList) ;
...
void GALGAS_immediatSliceExpressionList::modifier_setMSliceNameAtIndex (GALGAS_lstring inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_immediatSliceExpressionList * p = (cCollectionElement_immediatSliceExpressionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_immediatSliceExpressionList) ;
    p->mAttribute_mSliceName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_immediatSliceExpressionList::modifier_setMExpressionAtIndex (GALGAS_immediatExpression inOperand,
                                                                         GALGAS_uint inIndex,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement_immediatSliceExpressionList * p = (cCollectionElement_immediatSliceExpressionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring cEnumerator_immediatSliceExpressionList::current_mSliceName (void) const {
  const cCollectionElement_immediatSliceExpressionList * p = (const cCollectionElement_immediatSliceExpressionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_immediatSliceExpressionList) ;
  return p->mAttribute_mSliceName ;
}

//---------------------------------------------------------------------------*

GALGAS_immediatExpression cEnumerator_immediatSliceExpressionList::current_mExpression (void) const {
  const cCollectionElement_immediatSliceExpressionList * p = (const cCollectionElement_immediatSliceExpressionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_immediatSliceExpressionList) ;
  return p->mAttribute_mExpression ;
}
...
enumComparisonResult cCollectionElement_constantDefinitionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_constantDefinitionList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_constantDefinitionList * p = (cCollectionElement_constantDefinitionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_constantDefinitionList) ;
...
void GALGAS_constantDefinitionList::modifier_setMConstantNameAtIndex (GALGAS_lstring inOperand,
                                                                      GALGAS_uint inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_constantDefinitionList * p = (cCollectionElement_constantDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_constantDefinitionList) ;
...
void GALGAS_constantDefinitionList::modifier_setMExpressionAtIndex (GALGAS_immediatExpression inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_constantDefinitionList * p = (cCollectionElement_constantDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring cEnumerator_constantDefinitionList::current_mConstantName (void) const {
  const cCollectionElement_constantDefinitionList * p = (const cCollectionElement_constantDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_constantDefinitionList) ;
  return p->mAttribute_mConstantName ;
}

//---------------------------------------------------------------------------*

GALGAS_immediatExpression cEnumerator_constantDefinitionList::current_mExpression (void) const {
  const cCollectionElement_constantDefinitionList * p = (const cCollectionElement_constantDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_constantDefinitionList) ;
  return p->mAttribute_mExpression ;
}
...
enumComparisonResult cMapElement_actualConfigurationMap::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_actualConfigurationMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  attributes.setPointer (p) ;
  macroReleaseObject (p) ;
  const utf32 kInsertErrorMessage [58] = {
    TO_UNICODE ('t'),
    TO_UNICODE ('h'),
    TO_UNICODE ('e'),
    TO_UNICODE (' '),
...
static const utf32 kSearchErrorMessage_actualConfigurationMap_searchKey [48] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_actualConfigurationMap::method_searchKey (GALGAS_lstring inKey,
                                                      ...
                                                      C_Compiler * inCompiler
                                                      COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_actualConfigurationMap_searchKey COMMA_THERE) ;
  const cMapElement_actualConfigurationMap * p = (const cMapElement_actualConfigurationMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_actualConfigurationMap) ;
...
void GALGAS_actualConfigurationMap::modifier_setMRegisterAddressForKey (GALGAS_uint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_actualConfigurationMap) ;
...
cMapElement_actualConfigurationMap * GALGAS_actualConfigurationMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_actualConfigurationMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_actualConfigurationMap::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_uint cEnumerator_actualConfigurationMap::current_mRegisterAddress (void) const {
  const cMapElement_actualConfigurationMap * p = (const cMapElement_actualConfigurationMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_actualConfigurationMap) ;
...
GALGAS_uint cEnumerator_actualConfigurationMap::current_mRegisterValue (void) const {
  const cMapElement_actualConfigurationMap * p = (const cMapElement_actualConfigurationMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_actualConfigurationMap) ;
...
enumComparisonResult GALGAS_bitNumberExpression::objectCompare (const GALGAS_bitNumberExpression & inOperand) const {
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_bitNumberExpression) ;
}

//---------------------------------------------------------------------------*

void GALGAS_bitNumberExpression::method_display (GALGAS_string & ioArgument0,
                                                 C_Compiler * inCompiler
                                                 COMMA_LOCATION_ARGS) const {
  if (mObjectPtr != NULL) {
    const cPtr_bitNumberExpression * p = (const cPtr_bitNumberExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_bitNumberExpression) ;
    p->method_display (ioArgument0, inCompiler COMMA_THERE) ;
  }
}
...
enumComparisonResult GALGAS_bitNumberLabelValue::objectCompare (const GALGAS_bitNumberLabelValue & inOperand) const {
  enumComparisonResult result = GALGAS_bitNumberExpression::objectCompare (inOperand) ;
  const cPtr_bitNumberLabelValue * p = (const cPtr_bitNumberLabelValue *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_bitNumberLabelValue) ;
  const cPtr_bitNumberLabelValue * q = (const cPtr_bitNumberLabelValue *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_bitNumberLabelValue) ;
  if (kOperandEqual == result) {
...
GALGAS_bitNumberExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_bitNumberLabelValue) ;
}
...
void GALGAS_bitNumberLabelValue::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_bitNumberLabelValue) ;
...
void cPtr_bitNumberLabelValue::method_display (GALGAS_string & ioArgument_ioString,
                                               C_Compiler * /* inCompiler */
                                               COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  GALGAS_string temp_0 (mAttribute_mBitNumberLabelValue.reader_string (SOURCE_FILE_AT_LINE (271))) ;
  //--- @literalStringExpressionForGeneration
  GALGAS_string temp_1 (" [") ;
  GALGAS_string temp_2 (temp_0.operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (271))) ;
  //--- @readerCallExpressionForGeneration
  //--- @readerCallExpressionForGeneration
  GALGAS_uint temp_3 (mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (271))) ;
  GALGAS_string temp_4 (temp_3.reader_string (SOURCE_FILE_AT_LINE (271))) ;
  GALGAS_string temp_5 (temp_2.operator_concat (temp_4 COMMA_SOURCE_FILE_AT_LINE (271))) ;
  //--- @literalStringExpressionForGeneration
  GALGAS_string temp_6 ("]") ;
  GALGAS_string temp_7 (temp_5.operator_concat (temp_6 COMMA_SOURCE_FILE_AT_LINE (271))) ;
  ioArgument_ioString.dotAssign_operation (temp_7 COMMA_SOURCE_FILE_AT_LINE (271)) ;
}
...
GALGAS_lstring GALGAS_bitNumberLabelValue::reader_mBitNumberLabelValue (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_bitNumberLabelValue * p = (const cPtr_bitNumberLabelValue *) mObjectPtr ;
    macroValidObject (p, const cPtr_bitNumberLabelValue) ;
...
void GALGAS_bitNumberLabelValue::modifier_setMBitNumberLabelValue (GALGAS_lstring inValue
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_bitNumberLabelValue * p = (cPtr_bitNumberLabelValue *) mObjectPtr ;
    macroValidObject (p, cPtr_bitNumberLabelValue) ;
    p->mAttribute_mBitNumberLabelValue = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_bitNumberLabelValue::modifier_setMBitNumberIndexValue (GALGAS_luint inValue
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_bitNumberLabelValue * p = (cPtr_bitNumberLabelValue *) mObjectPtr ;
    macroValidObject (p, cPtr_bitNumberLabelValue) ;
    p->mAttribute_mBitNumberIndexValue = inValue ;
  }
}
...
enumComparisonResult GALGAS_bitNumberLiteralValue::objectCompare (const GALGAS_bitNumberLiteralValue & inOperand) const {
  enumComparisonResult result = GALGAS_bitNumberExpression::objectCompare (inOperand) ;
  const cPtr_bitNumberLiteralValue * p = (const cPtr_bitNumberLiteralValue *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_bitNumberLiteralValue) ;
  const cPtr_bitNumberLiteralValue * q = (const cPtr_bitNumberLiteralValue *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_bitNumberLiteralValue) ;
  if (kOperandEqual == result) {
...
GALGAS_bitNumberExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_bitNumberLiteralValue) ;
}
...
void GALGAS_bitNumberLiteralValue::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_bitNumberLiteralValue) ;
...
void cPtr_bitNumberLiteralValue::method_display (GALGAS_string & ioArgument_ioString,
                                                 C_Compiler * /* inCompiler */
                                                 COMMA_UNUSED_LOCATION_ARGS) const {
  //-------- @appendInstructionForGeneration
  //--- @readerCallExpressionForGeneration
  //--- @readerCallExpressionForGeneration
  GALGAS_uint temp_0 (mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (261))) ;
  GALGAS_string temp_1 (temp_0.reader_string (SOURCE_FILE_AT_LINE (261))) ;
  ioArgument_ioString.dotAssign_operation (temp_1 COMMA_SOURCE_FILE_AT_LINE (261)) ;
}
...
GALGAS_luint GALGAS_bitNumberLiteralValue::reader_mBitNumberLiteralValue (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_bitNumberLiteralValue * p = (const cPtr_bitNumberLiteralValue *) mObjectPtr ;
    macroValidObject (p, const cPtr_bitNumberLiteralValue) ;
...
void GALGAS_bitNumberLiteralValue::modifier_setMBitNumberLiteralValue (GALGAS_luint inValue
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_bitNumberLiteralValue * p = (cPtr_bitNumberLiteralValue *) mObjectPtr ;
    macroValidObject (p, cPtr_bitNumberLiteralValue) ;
    p->mAttribute_mBitNumberLiteralValue = inValue ;
  }
}
...
enumComparisonResult GALGAS_declarationInRam::objectCompare (const GALGAS_declarationInRam & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_declarationInRam) ;
}
...
enumComparisonResult GALGAS_byteDeclarationInRam::objectCompare (const GALGAS_byteDeclarationInRam & inOperand) const {
  enumComparisonResult result = GALGAS_declarationInRam::objectCompare (inOperand) ;
  const cPtr_byteDeclarationInRam * p = (const cPtr_byteDeclarationInRam *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_byteDeclarationInRam) ;
  const cPtr_byteDeclarationInRam * q = (const cPtr_byteDeclarationInRam *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_byteDeclarationInRam) ;
  if (kOperandEqual == result) {
...
GALGAS_declarationInRam (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_byteDeclarationInRam) ;
}
...
void GALGAS_byteDeclarationInRam::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_byteDeclarationInRam) ;
...
GALGAS_lstring GALGAS_byteDeclarationInRam::reader_mName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_byteDeclarationInRam * p = (const cPtr_byteDeclarationInRam *) mObjectPtr ;
    macroValidObject (p, const cPtr_byteDeclarationInRam) ;
...
void GALGAS_byteDeclarationInRam::modifier_setMName (GALGAS_lstring inValue
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_byteDeclarationInRam * p = (cPtr_byteDeclarationInRam *) mObjectPtr ;
    macroValidObject (p, cPtr_byteDeclarationInRam) ;
    p->mAttribute_mName = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_byteDeclarationInRam::modifier_setMSize (GALGAS_luint inValue
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_byteDeclarationInRam * p = (cPtr_byteDeclarationInRam *) mObjectPtr ;
    macroValidObject (p, cPtr_byteDeclarationInRam) ;
    p->mAttribute_mSize = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_byteDeclarationInRam::modifier_setMBitSliceTable (GALGAS_bitSliceTable inValue
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_byteDeclarationInRam * p = (cPtr_byteDeclarationInRam *) mObjectPtr ;
    macroValidObject (p, cPtr_byteDeclarationInRam) ;
    p->mAttribute_mBitSliceTable = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_byteDeclarationInRam::modifier_setMBitDefinitionString (GALGAS_string inValue
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_byteDeclarationInRam * p = (cPtr_byteDeclarationInRam *) mObjectPtr ;
    macroValidObject (p, cPtr_byteDeclarationInRam) ;
    p->mAttribute_mBitDefinitionString = inValue ;
  }
}
...
enumComparisonResult GALGAS_commonDeclarationInRam::objectCompare (const GALGAS_commonDeclarationInRam & inOperand) const {
  enumComparisonResult result = GALGAS_declarationInRam::objectCompare (inOperand) ;
  const cPtr_commonDeclarationInRam * p = (const cPtr_commonDeclarationInRam *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_commonDeclarationInRam) ;
  const cPtr_commonDeclarationInRam * q = (const cPtr_commonDeclarationInRam *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_commonDeclarationInRam) ;
  if (kOperandEqual == result) {
...
GALGAS_declarationInRam (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_commonDeclarationInRam) ;
}
...
void GALGAS_commonDeclarationInRam::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_commonDeclarationInRam) ;
...
GALGAS_commonBranchList GALGAS_commonDeclarationInRam::reader_mBranchList (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_commonDeclarationInRam * p = (const cPtr_commonDeclarationInRam *) mObjectPtr ;
    macroValidObject (p, const cPtr_commonDeclarationInRam) ;
...
void GALGAS_commonDeclarationInRam::modifier_setMBranchList (GALGAS_commonBranchList inValue
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_commonDeclarationInRam * p = (cPtr_commonDeclarationInRam *) mObjectPtr ;
    macroValidObject (p, cPtr_commonDeclarationInRam) ;
    p->mAttribute_mBranchList = inValue ;
  }
}
...
enumComparisonResult GALGAS_immediatExpression::objectCompare (const GALGAS_immediatExpression & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatExpression) ;
}
...
enumComparisonResult GALGAS_immediatAdd::objectCompare (const GALGAS_immediatAdd & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatAdd * p = (const cPtr_immediatAdd *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatAdd) ;
  const cPtr_immediatAdd * q = (const cPtr_immediatAdd *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatAdd) ;
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatAdd) ;
}
...
void GALGAS_immediatAdd::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatAdd) ;
...
GALGAS_immediatExpression GALGAS_immediatAdd::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatAdd * p = (const cPtr_immediatAdd *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatAdd) ;
...
void GALGAS_immediatAdd::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatAdd * p = (cPtr_immediatAdd *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatAdd) ;
...
void GALGAS_immediatAdd::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatAdd * p = (cPtr_immediatAdd *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatAdd) ;
...
enumComparisonResult GALGAS_immediatAnd::objectCompare (const GALGAS_immediatAnd & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatAnd * p = (const cPtr_immediatAnd *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatAnd) ;
  const cPtr_immediatAnd * q = (const cPtr_immediatAnd *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatAnd) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatAnd) ;
}
...
void GALGAS_immediatAnd::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatAnd) ;
...
GALGAS_immediatExpression GALGAS_immediatAnd::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatAnd * p = (const cPtr_immediatAnd *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatAnd) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatAnd::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatAnd * p = (cPtr_immediatAnd *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatAnd) ;
...
void GALGAS_immediatAnd::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatAnd * p = (cPtr_immediatAnd *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatAnd) ;
...
enumComparisonResult GALGAS_immediatComplement::objectCompare (const GALGAS_immediatComplement & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatComplement * p = (const cPtr_immediatComplement *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatComplement) ;
  const cPtr_immediatComplement * q = (const cPtr_immediatComplement *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatComplement) ;
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatComplement) ;
}
...
void GALGAS_immediatComplement::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatComplement) ;
...
GALGAS_immediatExpression GALGAS_immediatComplement::reader_mExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatComplement * p = (const cPtr_immediatComplement *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatComplement) ;
    result = p->mAttribute_mExpression ;
  }
  return result ;
}
...
void GALGAS_immediatComplement::modifier_setMExpression (GALGAS_immediatExpression inValue
                                                         COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatComplement * p = (cPtr_immediatComplement *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatComplement) ;
    p->mAttribute_mExpression = inValue ;
  }
}
...
enumComparisonResult GALGAS_immediatDiv::objectCompare (const GALGAS_immediatDiv & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatDiv * p = (const cPtr_immediatDiv *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatDiv) ;
  const cPtr_immediatDiv * q = (const cPtr_immediatDiv *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatDiv) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatDiv) ;
}
...
void GALGAS_immediatDiv::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatDiv) ;
...
GALGAS_immediatExpression GALGAS_immediatDiv::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatDiv * p = (const cPtr_immediatDiv *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatDiv) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatDiv::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatDiv * p = (cPtr_immediatDiv *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatDiv) ;
...
void GALGAS_immediatDiv::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatDiv * p = (cPtr_immediatDiv *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatDiv) ;
...
enumComparisonResult GALGAS_immediatEqualTest::objectCompare (const GALGAS_immediatEqualTest & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatEqualTest * p = (const cPtr_immediatEqualTest *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatEqualTest) ;
  const cPtr_immediatEqualTest * q = (const cPtr_immediatEqualTest *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatEqualTest) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatEqualTest) ;
}
...
void GALGAS_immediatEqualTest::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatEqualTest) ;
...
GALGAS_immediatExpression GALGAS_immediatEqualTest::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatEqualTest * p = (const cPtr_immediatEqualTest *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatEqualTest) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatEqualTest::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatEqualTest * p = (cPtr_immediatEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatEqualTest) ;
...
void GALGAS_immediatEqualTest::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatEqualTest * p = (cPtr_immediatEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatEqualTest) ;
...
enumComparisonResult GALGAS_immediatGreaterOrEqualTest::objectCompare (const GALGAS_immediatGreaterOrEqualTest & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatGreaterOrEqualTest * p = (const cPtr_immediatGreaterOrEqualTest *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatGreaterOrEqualTest) ;
  const cPtr_immediatGreaterOrEqualTest * q = (const cPtr_immediatGreaterOrEqualTest *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatGreaterOrEqualTest) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatGreaterOrEqualTest) ;
}
...
void GALGAS_immediatGreaterOrEqualTest::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatGreaterOrEqualTest) ;
...
GALGAS_immediatExpression GALGAS_immediatGreaterOrEqualTest::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatGreaterOrEqualTest * p = (const cPtr_immediatGreaterOrEqualTest *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatGreaterOrEqualTest) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatGreaterOrEqualTest::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatGreaterOrEqualTest * p = (cPtr_immediatGreaterOrEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatGreaterOrEqualTest) ;
...
void GALGAS_immediatGreaterOrEqualTest::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatGreaterOrEqualTest * p = (cPtr_immediatGreaterOrEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatGreaterOrEqualTest) ;
...
enumComparisonResult GALGAS_immediatGreaterTest::objectCompare (const GALGAS_immediatGreaterTest & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatGreaterTest * p = (const cPtr_immediatGreaterTest *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatGreaterTest) ;
  const cPtr_immediatGreaterTest * q = (const cPtr_immediatGreaterTest *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatGreaterTest) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatGreaterTest) ;
}
...
void GALGAS_immediatGreaterTest::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatGreaterTest) ;
...
GALGAS_immediatExpression GALGAS_immediatGreaterTest::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatGreaterTest * p = (const cPtr_immediatGreaterTest *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatGreaterTest) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatGreaterTest::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatGreaterTest * p = (cPtr_immediatGreaterTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatGreaterTest) ;
...
void GALGAS_immediatGreaterTest::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatGreaterTest * p = (cPtr_immediatGreaterTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatGreaterTest) ;
...
enumComparisonResult GALGAS_immediatInteger::objectCompare (const GALGAS_immediatInteger & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatInteger * p = (const cPtr_immediatInteger *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatInteger) ;
  const cPtr_immediatInteger * q = (const cPtr_immediatInteger *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatInteger) ;
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatInteger) ;
}
...
void GALGAS_immediatInteger::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatInteger) ;
...
GALGAS_luint GALGAS_immediatInteger::reader_mValue (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatInteger * p = (const cPtr_immediatInteger *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatInteger) ;
...
void GALGAS_immediatInteger::modifier_setMValue (GALGAS_luint inValue
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatInteger * p = (cPtr_immediatInteger *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatInteger) ;
...
enumComparisonResult GALGAS_immediatLeftShift::objectCompare (const GALGAS_immediatLeftShift & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatLeftShift * p = (const cPtr_immediatLeftShift *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatLeftShift) ;
  const cPtr_immediatLeftShift * q = (const cPtr_immediatLeftShift *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatLeftShift) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatLeftShift) ;
}
...
void GALGAS_immediatLeftShift::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatLeftShift) ;
...
GALGAS_immediatExpression GALGAS_immediatLeftShift::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatLeftShift * p = (const cPtr_immediatLeftShift *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatLeftShift) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatLeftShift::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatLeftShift * p = (cPtr_immediatLeftShift *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatLeftShift) ;
...
void GALGAS_immediatLeftShift::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatLeftShift * p = (cPtr_immediatLeftShift *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatLeftShift) ;
...
enumComparisonResult GALGAS_immediatLowerOrEqualTest::objectCompare (const GALGAS_immediatLowerOrEqualTest & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatLowerOrEqualTest * p = (const cPtr_immediatLowerOrEqualTest *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatLowerOrEqualTest) ;
  const cPtr_immediatLowerOrEqualTest * q = (const cPtr_immediatLowerOrEqualTest *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatLowerOrEqualTest) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatLowerOrEqualTest) ;
}
...
void GALGAS_immediatLowerOrEqualTest::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatLowerOrEqualTest) ;
...
GALGAS_immediatExpression GALGAS_immediatLowerOrEqualTest::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatLowerOrEqualTest * p = (const cPtr_immediatLowerOrEqualTest *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatLowerOrEqualTest) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatLowerOrEqualTest::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatLowerOrEqualTest * p = (cPtr_immediatLowerOrEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatLowerOrEqualTest) ;
...
void GALGAS_immediatLowerOrEqualTest::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatLowerOrEqualTest * p = (cPtr_immediatLowerOrEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatLowerOrEqualTest) ;
...
enumComparisonResult GALGAS_immediatLowerTest::objectCompare (const GALGAS_immediatLowerTest & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatLowerTest * p = (const cPtr_immediatLowerTest *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatLowerTest) ;
  const cPtr_immediatLowerTest * q = (const cPtr_immediatLowerTest *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatLowerTest) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatLowerTest) ;
}
...
void GALGAS_immediatLowerTest::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatLowerTest) ;
...
GALGAS_immediatExpression GALGAS_immediatLowerTest::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatLowerTest * p = (const cPtr_immediatLowerTest *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatLowerTest) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatLowerTest::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatLowerTest * p = (cPtr_immediatLowerTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatLowerTest) ;
...
void GALGAS_immediatLowerTest::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatLowerTest * p = (cPtr_immediatLowerTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatLowerTest) ;
...
enumComparisonResult GALGAS_immediatMod::objectCompare (const GALGAS_immediatMod & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatMod * p = (const cPtr_immediatMod *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatMod) ;
  const cPtr_immediatMod * q = (const cPtr_immediatMod *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatMod) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatMod) ;
}
...
void GALGAS_immediatMod::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatMod) ;
...
GALGAS_immediatExpression GALGAS_immediatMod::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatMod * p = (const cPtr_immediatMod *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatMod) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatMod::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatMod * p = (cPtr_immediatMod *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatMod) ;
...
void GALGAS_immediatMod::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatMod * p = (cPtr_immediatMod *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatMod) ;
...
enumComparisonResult GALGAS_immediatMul::objectCompare (const GALGAS_immediatMul & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatMul * p = (const cPtr_immediatMul *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatMul) ;
  const cPtr_immediatMul * q = (const cPtr_immediatMul *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatMul) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatMul) ;
}
...
void GALGAS_immediatMul::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatMul) ;
...
GALGAS_immediatExpression GALGAS_immediatMul::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatMul * p = (const cPtr_immediatMul *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatMul) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatMul::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatMul * p = (cPtr_immediatMul *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatMul) ;
...
void GALGAS_immediatMul::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatMul * p = (cPtr_immediatMul *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatMul) ;
...
enumComparisonResult GALGAS_immediatNegate::objectCompare (const GALGAS_immediatNegate & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatNegate * p = (const cPtr_immediatNegate *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatNegate) ;
  const cPtr_immediatNegate * q = (const cPtr_immediatNegate *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatNegate) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mExpression.objectCompare (q->mAttribute_mExpression) ;
  }
  return result ;
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatNegate) ;
}
...
void GALGAS_immediatNegate::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatNegate) ;
...
GALGAS_immediatExpression GALGAS_immediatNegate::reader_mExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatNegate * p = (const cPtr_immediatNegate *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatNegate) ;
    result = p->mAttribute_mExpression ;
  }
  return result ;
}
...
void GALGAS_immediatNegate::modifier_setMExpression (GALGAS_immediatExpression inValue
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatNegate * p = (cPtr_immediatNegate *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatNegate) ;
...
enumComparisonResult GALGAS_immediatNotEqualTest::objectCompare (const GALGAS_immediatNotEqualTest & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatNotEqualTest * p = (const cPtr_immediatNotEqualTest *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatNotEqualTest) ;
  const cPtr_immediatNotEqualTest * q = (const cPtr_immediatNotEqualTest *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatNotEqualTest) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatNotEqualTest) ;
}
...
void GALGAS_immediatNotEqualTest::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatNotEqualTest) ;
...
GALGAS_immediatExpression GALGAS_immediatNotEqualTest::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatNotEqualTest * p = (const cPtr_immediatNotEqualTest *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatNotEqualTest) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatNotEqualTest::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatNotEqualTest * p = (cPtr_immediatNotEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatNotEqualTest) ;
...
void GALGAS_immediatNotEqualTest::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatNotEqualTest * p = (cPtr_immediatNotEqualTest *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatNotEqualTest) ;
...
enumComparisonResult GALGAS_immediatOr::objectCompare (const GALGAS_immediatOr & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatOr * p = (const cPtr_immediatOr *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatOr) ;
  const cPtr_immediatOr * q = (const cPtr_immediatOr *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatOr) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatOr) ;
}
...
void GALGAS_immediatOr::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatOr) ;
...
GALGAS_immediatExpression GALGAS_immediatOr::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatOr * p = (const cPtr_immediatOr *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatOr) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatOr::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatOr * p = (cPtr_immediatOr *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatOr) ;
...
void GALGAS_immediatOr::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatOr * p = (cPtr_immediatOr *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatOr) ;
...
enumComparisonResult GALGAS_immediatRegister::objectCompare (const GALGAS_immediatRegister & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatRegister * p = (const cPtr_immediatRegister *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatRegister) ;
  const cPtr_immediatRegister * q = (const cPtr_immediatRegister *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatRegister) ;
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatRegister) ;
}
...
void GALGAS_immediatRegister::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatRegister) ;
...
GALGAS_registerExpression GALGAS_immediatRegister::reader_mRegister (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatRegister * p = (const cPtr_immediatRegister *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatRegister) ;
...
void GALGAS_immediatRegister::modifier_setMRegister (GALGAS_registerExpression inValue
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatRegister * p = (cPtr_immediatRegister *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatRegister) ;
...
enumComparisonResult GALGAS_immediatRightShift::objectCompare (const GALGAS_immediatRightShift & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatRightShift * p = (const cPtr_immediatRightShift *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatRightShift) ;
  const cPtr_immediatRightShift * q = (const cPtr_immediatRightShift *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatRightShift) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatRightShift) ;
}
...
void GALGAS_immediatRightShift::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatRightShift) ;
...
GALGAS_immediatExpression GALGAS_immediatRightShift::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatRightShift * p = (const cPtr_immediatRightShift *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatRightShift) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatRightShift::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatRightShift * p = (cPtr_immediatRightShift *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatRightShift) ;
...
void GALGAS_immediatRightShift::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatRightShift * p = (cPtr_immediatRightShift *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatRightShift) ;
...
enumComparisonResult GALGAS_immediatSlice::objectCompare (const GALGAS_immediatSlice & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatSlice * p = (const cPtr_immediatSlice *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatSlice) ;
  const cPtr_immediatSlice * q = (const cPtr_immediatSlice *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatSlice) ;
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatSlice) ;
}
...
void GALGAS_immediatSlice::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatSlice) ;
...
GALGAS_lstring GALGAS_immediatSlice::reader_mRegisterName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatSlice * p = (const cPtr_immediatSlice *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatSlice) ;
...
void GALGAS_immediatSlice::modifier_setMRegisterName (GALGAS_lstring inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatSlice * p = (cPtr_immediatSlice *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatSlice) ;
    p->mAttribute_mRegisterName = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_immediatSlice::modifier_setMSliceExpressionList (GALGAS_immediatSliceExpressionList inValue
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatSlice * p = (cPtr_immediatSlice *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatSlice) ;
    p->mAttribute_mSliceExpressionList = inValue ;
  }
}
...
enumComparisonResult GALGAS_immediatSub::objectCompare (const GALGAS_immediatSub & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatSub * p = (const cPtr_immediatSub *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatSub) ;
  const cPtr_immediatSub * q = (const cPtr_immediatSub *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatSub) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatSub) ;
}
...
void GALGAS_immediatSub::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatSub) ;
...
GALGAS_immediatExpression GALGAS_immediatSub::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatSub * p = (const cPtr_immediatSub *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatSub) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatSub::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatSub * p = (cPtr_immediatSub *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatSub) ;
...
void GALGAS_immediatSub::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatSub * p = (cPtr_immediatSub *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatSub) ;
...
enumComparisonResult GALGAS_immediatXor::objectCompare (const GALGAS_immediatXor & inOperand) const {
  enumComparisonResult result = GALGAS_immediatExpression::objectCompare (inOperand) ;
  const cPtr_immediatXor * p = (const cPtr_immediatXor *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_immediatXor) ;
  const cPtr_immediatXor * q = (const cPtr_immediatXor *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_immediatXor) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mLeftExpression.objectCompare (q->mAttribute_mLeftExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_immediatExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_immediatXor) ;
}
...
void GALGAS_immediatXor::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_immediatXor) ;
...
GALGAS_immediatExpression GALGAS_immediatXor::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_immediatXor * p = (const cPtr_immediatXor *) mObjectPtr ;
    macroValidObject (p, const cPtr_immediatXor) ;
    result = p->mAttribute_mLeftExpression ;
  }
  return result ;
}
...
void GALGAS_immediatXor::modifier_setMLeftExpression (GALGAS_immediatExpression inValue
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatXor * p = (cPtr_immediatXor *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatXor) ;
...
void GALGAS_immediatXor::modifier_setMRightExpression (GALGAS_immediatExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_immediatXor * p = (cPtr_immediatXor *) mObjectPtr ;
    macroValidObject (p, cPtr_immediatXor) ;
...
enumComparisonResult GALGAS_registerExpression::objectCompare (const GALGAS_registerExpression & inOperand) const {
  enumComparisonResult result = kOperandEqual ;
  const cPtr_registerExpression * p = (const cPtr_registerExpression *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_registerExpression) ;
  const cPtr_registerExpression * q = (const cPtr_registerExpression *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_registerExpression) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mRegisterName.objectCompare (q->mAttribute_mRegisterName) ;
  }
  if (kOperandEqual == result) {
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_registerExpression) ;
}
...
void GALGAS_registerExpression::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_registerExpression) ;
...
GALGAS_lstring GALGAS_registerExpression::reader_mRegisterName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_registerExpression * p = (const cPtr_registerExpression *) mObjectPtr ;
    macroValidObject (p, const cPtr_registerExpression) ;
    result = p->mAttribute_mRegisterName ;
  }
  return result ;
}
...
void GALGAS_registerExpression::modifier_setMRegisterName (GALGAS_lstring inValue
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_registerExpression * p = (cPtr_registerExpression *) mObjectPtr ;
    macroValidObject (p, cPtr_registerExpression) ;
...
void GALGAS_registerExpression::modifier_setMOffset (GALGAS_luint inValue
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_registerExpression * p = (cPtr_registerExpression *) mObjectPtr ;
    macroValidObject (p, cPtr_registerExpression) ;
    p->mAttribute_mOffset = inValue ;
  }
}
