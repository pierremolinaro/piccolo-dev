...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mSliceIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mSliceSize.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mDeclarationInRAM._operator_isEqual (_p->mDeclarationInRAM).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mDeclarationInRAM.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mDeclarationInRAM
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
  }
...
internalSubListWithRange (GGS_declarationInRamList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mDeclarationInRAM) ;
      _p = _p->nextObject () ;
    }
  }
}
...
/* const */ GGS_declarationInRam  & GGS_declarationInRamList::cEnumerator::_mDeclarationInRAM (LOCATION_ARGS) const {
  ...
  return ((cElement *) mCurrentEnumeratedObject)->mDeclarationInRAM ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mDefinitionLocation._operator_isEqual (_p->mDefinitionLocation).boolValue ()
         && mSettingList._operator_isEqual (_p->mSettingList).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mDefinitionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mDefinitionLocation,
                                _p->mSettingList
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
...
internalSubListWithRange (GGS_configDefinitionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mDefinitionLocation, _p->mSettingList) ;
      _p = _p->nextObject () ;
    }
  }
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mDefinitionLocation ;
    _out_1 = _p->mSettingList ;
  }else{
    _out_0.drop () ;
    _out_1.drop () ;
  }
...
/* const */ GGS_location  & GGS_configDefinitionList::cEnumerator::_mDefinitionLocation (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mDefinitionLocation ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mRegisterAddress.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mRegisterValue.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
method_display (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioString._dotAssign_operation (mBitNumberLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (261))) ;
}
...
method_display (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioString._dotAssign_operation (mBitNumberLabelValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (271))) ;
  var_cas_ioString.appendCString (" [") ;
  var_cas_ioString._dotAssign_operation (mBitNumberIndexValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (271))) ;
  var_cas_ioString.appendCString ("]") ;
}
