...
//                    december 29th, 2008, at 14h57'33"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
method_display (C_Compiler & _inLexique,
  ...
  var_cas_ioString._dotAssign_operation (mBitNumberLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (260)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (260))) ;
}
...
method_display (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioString._dotAssign_operation (mBitNumberLabelValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (270))) ;
  var_cas_ioString.writeString (" [") ;
  var_cas_ioString._dotAssign_operation (mBitNumberIndexValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (270)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (270))) ;
  var_cas_ioString.writeString ("]") ;
}
