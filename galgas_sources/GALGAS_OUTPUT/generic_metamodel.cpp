...
GALGAS_bitSliceTable_3A_element cEnumerator_bitSliceTable::current (LOCATION_ARGS) const {
  const cMapElement_bitSliceTable * p = (const cMapElement_bitSliceTable *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_bitSliceTable) ;
  return GALGAS_bitSliceTable_3A_element (p->mAttribute_lkey, p->mAttribute_mSliceIndex, p->mAttribute_mSliceSize) ;
}
...
class cCollectionElement_declarationInRamList : public cCollectionElement {
  public : GALGAS_declarationInRamList_3A_element mObject ;
...
GALGAS_declarationInRamList_3A_element cEnumerator_declarationInRamList::current (LOCATION_ARGS) const {
...
class cCollectionElement_commonBranchList : public cCollectionElement {
  public : GALGAS_commonBranchList_3A_element mObject ;
...
cCollectionElement_commonBranchList::cCollectionElement_commonBranchList (const GALGAS_declarationInRamList & in_mDeclarations,
                                                                          ...
                                                                          COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mDeclarations, in_mEndOfBranchLocation) {
}
...
cCollectionElement * cCollectionElement_commonBranchList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_commonBranchList (mObject.mAttribute_mDeclarations, mObject.mAttribute_mEndOfBranchLocation COMMA_HERE)) ;
  return result ;
}
...
void cCollectionElement_commonBranchList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ...
  mObject.mAttribute_mDeclarations.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mEndOfBranchLocation" ":" ;
  mObject.mAttribute_mEndOfBranchLocation.description (ioString, inIndentation) ;
}
...
typeComparisonResult cCollectionElement_commonBranchList::compare (const cCollectionElement * inOperand) const {
  ...
  macroValidSharedObject (operand, cCollectionElement_commonBranchList) ;
  return mObject.objectCompare (operand->mObject) ;
}
...
void GALGAS_commonBranchList::modifier_popFirst (GALGAS_declarationInRamList & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mObject.mAttribute_mDeclarations ;
    outOperand1 = p->mObject.mAttribute_mEndOfBranchLocation ;
  }
}
...
GALGAS_commonBranchList GALGAS_commonBranchList::reader_subListWithRange (const GALGAS_range & inRange,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
...
GALGAS_declarationInRamList GALGAS_commonBranchList::reader_mDeclarationsAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_commonBranchList) ;
    result = p->mObject.mAttribute_mDeclarations ;
  }
  return result ;
}
...
GALGAS_location GALGAS_commonBranchList::reader_mEndOfBranchLocationAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_commonBranchList) ;
    result = p->mObject.mAttribute_mEndOfBranchLocation ;
  }
  return result ;
}
...
GALGAS_commonBranchList_3A_element cEnumerator_commonBranchList::current (LOCATION_ARGS) const {
...
GALGAS_declarationInRamList cEnumerator_commonBranchList::current_mDeclarations (LOCATION_ARGS) const {
  const cCollectionElement_commonBranchList * p = (const cCollectionElement_commonBranchList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_commonBranchList) ;
  return p->mObject.mAttribute_mDeclarations ;
}
...
GALGAS_location cEnumerator_commonBranchList::current_mEndOfBranchLocation (LOCATION_ARGS) const {
  const cCollectionElement_commonBranchList * p = (const cCollectionElement_commonBranchList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_commonBranchList) ;
  return p->mObject.mAttribute_mEndOfBranchLocation ;
}
...
class cCollectionElement_ramDefinitionList : public cCollectionElement {
  public : GALGAS_ramDefinitionList_3A_element mObject ;
...
GALGAS_ramDefinitionList_3A_element cEnumerator_ramDefinitionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_configSettingList : public cCollectionElement {
  public : GALGAS_configSettingList_3A_element mObject ;
...
GALGAS_configSettingList_3A_element cEnumerator_configSettingList::current (LOCATION_ARGS) const {
...
class cCollectionElement_configDefinitionList : public cCollectionElement {
  public : GALGAS_configDefinitionList_3A_element mObject ;
...
GALGAS_configDefinitionList_3A_element cEnumerator_configDefinitionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_immediatExpressionList : public cCollectionElement {
  public : GALGAS_immediatExpressionList_3A_element mObject ;
...
cCollectionElement * cCollectionElement_immediatExpressionList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_immediatExpressionList (mObject.mAttribute_mExpression COMMA_HERE)) ;
  return result ;
}
...
GALGAS_immediatExpressionList_3A_element cEnumerator_immediatExpressionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_immediatSliceExpressionList : public cCollectionElement {
  public : GALGAS_immediatSliceExpressionList_3A_element mObject ;
...
GALGAS_immediatSliceExpressionList_3A_element cEnumerator_immediatSliceExpressionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_constantDefinitionList : public cCollectionElement {
  public : GALGAS_constantDefinitionList_3A_element mObject ;
...
GALGAS_constantDefinitionList_3A_element cEnumerator_constantDefinitionList::current (LOCATION_ARGS) const {
...
GALGAS_actualConfigurationMap_3A_element cEnumerator_actualConfigurationMap::current (LOCATION_ARGS) const {
  const cMapElement_actualConfigurationMap * p = (const cMapElement_actualConfigurationMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_actualConfigurationMap) ;
  return GALGAS_actualConfigurationMap_3A_element (p->mAttribute_lkey, p->mAttribute_mRegisterAddress, p->mAttribute_mRegisterValue) ;
}
...
typeComparisonResult cPtr_commonDeclarationInRam::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_commonDeclarationInRam * p = (const cPtr_commonDeclarationInRam *) inOperandPtr ;
...
GALGAS_bitSliceTable_3A_element::GALGAS_bitSliceTable_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_bitSliceTable_3A_element::GALGAS_bitSliceTable_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_bitSliceTable_3A_element & GALGAS_bitSliceTable_3A_element::operator = (const GALGAS_bitSliceTable_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSliceIndex = inOperand.mAttribute_mSliceIndex ;
  mAttribute_mSliceSize = inOperand.mAttribute_mSliceSize ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_bitSliceTable_3A_element GALGAS_bitSliceTable_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_uint & inOperand1,
                                                                                  const GALGAS_uint & inOperand2 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bitSliceTable_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_bitSliceTable_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_bitSliceTable_3A_element::objectCompare (const GALGAS_bitSliceTable_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_bitSliceTable_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSliceIndex.isValid () && mAttribute_mSliceSize.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_bitSliceTable_3A_element::drop (void) {
...
void GALGAS_bitSliceTable_3A_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_bitSliceTable_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_bitSliceTable_3A_element::reader_mSliceIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSliceIndex ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_bitSliceTable_3A_element::reader_mSliceSize (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_bitSliceTable_3A_element ("bitSliceTable:element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_bitSliceTable_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_bitSliceTable_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_bitSliceTable_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_bitSliceTable_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_bitSliceTable_3A_element GALGAS_bitSliceTable_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_bitSliceTable_3A_element result ;
  const GALGAS_bitSliceTable_3A_element * p = (const GALGAS_bitSliceTable_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_bitSliceTable_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "bitSliceTable:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_declarationInRamList_3A_element::GALGAS_declarationInRamList_3A_element (void) :
...
GALGAS_declarationInRamList_3A_element::GALGAS_declarationInRamList_3A_element (const GALGAS_declarationInRam & inOperand0) :
mAttribute_mDeclarationInRAM (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_declarationInRamList_3A_element & GALGAS_declarationInRamList_3A_element::operator = (const GALGAS_declarationInRamList_3A_element & inOperand) {
  mAttribute_mDeclarationInRAM = inOperand.mAttribute_mDeclarationInRAM ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_declarationInRamList_3A_element GALGAS_declarationInRamList_3A_element::constructor_new (const GALGAS_declarationInRam & inOperand0 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_declarationInRamList_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_declarationInRamList_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_declarationInRamList_3A_element::objectCompare (const GALGAS_declarationInRamList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_declarationInRamList_3A_element::isValid (void) const {
  return mAttribute_mDeclarationInRAM.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_declarationInRamList_3A_element::drop (void) {
  mAttribute_mDeclarationInRAM.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_declarationInRamList_3A_element::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
...
GALGAS_declarationInRam GALGAS_declarationInRamList_3A_element::reader_mDeclarationInRAM (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_declarationInRamList_3A_element ("declarationInRamList:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_declarationInRamList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_declarationInRamList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_declarationInRamList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_declarationInRamList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_declarationInRamList_3A_element GALGAS_declarationInRamList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_declarationInRamList_3A_element result ;
  const GALGAS_declarationInRamList_3A_element * p = (const GALGAS_declarationInRamList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_declarationInRamList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "declarationInRamList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_commonBranchList_3A_element::GALGAS_commonBranchList_3A_element (void) :
mAttribute_mDeclarations (),
mAttribute_mEndOfBranchLocation () {
}
...
GALGAS_commonBranchList_3A_element::GALGAS_commonBranchList_3A_element (const GALGAS_declarationInRamList & inOperand0,
                                                                        const GALGAS_location & inOperand1) :
mAttribute_mDeclarations (inOperand0),
mAttribute_mEndOfBranchLocation (inOperand1) {
}

//---------------------------------------------------------------------------*

/* GALGAS_commonBranchList_3A_element & GALGAS_commonBranchList_3A_element::operator = (const GALGAS_commonBranchList_3A_element & inOperand) {
  mAttribute_mDeclarations = inOperand.mAttribute_mDeclarations ;
  mAttribute_mEndOfBranchLocation = inOperand.mAttribute_mEndOfBranchLocation ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_commonBranchList_3A_element GALGAS_commonBranchList_3A_element::constructor_new (const GALGAS_declarationInRamList & inOperand0,
                                                                                        const GALGAS_location & inOperand1 
                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_commonBranchList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_commonBranchList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_commonBranchList_3A_element::objectCompare (const GALGAS_commonBranchList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mDeclarations.objectCompare (inOperand.mAttribute_mDeclarations) ;
  }
  if (result == kOperandEqual) {
    result = mAttribute_mEndOfBranchLocation.objectCompare (inOperand.mAttribute_mEndOfBranchLocation) ;
  }
  return result ;
}
...
bool GALGAS_commonBranchList_3A_element::isValid (void) const {
  return mAttribute_mDeclarations.isValid () && mAttribute_mEndOfBranchLocation.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_commonBranchList_3A_element::drop (void) {
  mAttribute_mDeclarations.drop () ;
  mAttribute_mEndOfBranchLocation.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_commonBranchList_3A_element::description (C_String & ioString,
                                                      const PMSInt32 inIndentation) const {
  ioString << "<struct @commonBranchList:element:" ;
  if (! isValid ()) {
    ioString << " not built" ;
  }else{
    mAttribute_mDeclarations.description (ioString, inIndentation+1) ;
    ioString << ", " ;
    mAttribute_mEndOfBranchLocation.description (ioString, inIndentation+1) ;
  }
  ioString << ">" ;
}
...
GALGAS_declarationInRamList GALGAS_commonBranchList_3A_element::reader_mDeclarations (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDeclarations ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_commonBranchList_3A_element::reader_mEndOfBranchLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndOfBranchLocation ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      @commonBranchList:element type                       *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_commonBranchList_3A_element ("commonBranchList:element",
                                                    NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_commonBranchList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_commonBranchList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_commonBranchList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_commonBranchList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_commonBranchList_3A_element GALGAS_commonBranchList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                      C_Compiler * inCompiler,
                                                                                      const GALGAS_location & inErrorLocation
                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_commonBranchList_3A_element result ;
  const GALGAS_commonBranchList_3A_element * p = (const GALGAS_commonBranchList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_commonBranchList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "commonBranchList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_ramDefinitionList_3A_element::GALGAS_ramDefinitionList_3A_element (void) :
...
GALGAS_ramDefinitionList_3A_element::GALGAS_ramDefinitionList_3A_element (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_declarationInRamList & inOperand1) :
...
/* GALGAS_ramDefinitionList_3A_element & GALGAS_ramDefinitionList_3A_element::operator = (const GALGAS_ramDefinitionList_3A_element & inOperand) {
  mAttribute_mBankName = inOperand.mAttribute_mBankName ;
  mAttribute_mDeclaration = inOperand.mAttribute_mDeclaration ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_ramDefinitionList_3A_element GALGAS_ramDefinitionList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_declarationInRamList & inOperand1 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ramDefinitionList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_ramDefinitionList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_ramDefinitionList_3A_element::objectCompare (const GALGAS_ramDefinitionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_ramDefinitionList_3A_element::isValid (void) const {
  return mAttribute_mBankName.isValid () && mAttribute_mDeclaration.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_ramDefinitionList_3A_element::drop (void) {
...
void GALGAS_ramDefinitionList_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_ramDefinitionList_3A_element::reader_mBankName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBankName ;
}

//---------------------------------------------------------------------------*

GALGAS_declarationInRamList GALGAS_ramDefinitionList_3A_element::reader_mDeclaration (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ramDefinitionList_3A_element ("ramDefinitionList:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ramDefinitionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ramDefinitionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ramDefinitionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ramDefinitionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_ramDefinitionList_3A_element GALGAS_ramDefinitionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_ramDefinitionList_3A_element result ;
  const GALGAS_ramDefinitionList_3A_element * p = (const GALGAS_ramDefinitionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ramDefinitionList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "ramDefinitionList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_configSettingList_3A_element::GALGAS_configSettingList_3A_element (void) :
...
GALGAS_configSettingList_3A_element::GALGAS_configSettingList_3A_element (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_lstring & inOperand1) :
...
/* GALGAS_configSettingList_3A_element & GALGAS_configSettingList_3A_element::operator = (const GALGAS_configSettingList_3A_element & inOperand) {
  mAttribute_mSettingName = inOperand.mAttribute_mSettingName ;
  mAttribute_mSettingValue = inOperand.mAttribute_mSettingValue ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_configSettingList_3A_element GALGAS_configSettingList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_lstring & inOperand1 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_configSettingList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_configSettingList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_configSettingList_3A_element::objectCompare (const GALGAS_configSettingList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_configSettingList_3A_element::isValid (void) const {
  return mAttribute_mSettingName.isValid () && mAttribute_mSettingValue.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_configSettingList_3A_element::drop (void) {
...
void GALGAS_configSettingList_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_configSettingList_3A_element::reader_mSettingName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSettingName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_configSettingList_3A_element::reader_mSettingValue (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_configSettingList_3A_element ("configSettingList:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_configSettingList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_configSettingList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_configSettingList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_configSettingList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_configSettingList_3A_element GALGAS_configSettingList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_configSettingList_3A_element result ;
  const GALGAS_configSettingList_3A_element * p = (const GALGAS_configSettingList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_configSettingList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "configSettingList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_configDefinitionList_3A_element::GALGAS_configDefinitionList_3A_element (void) :
...
GALGAS_configDefinitionList_3A_element::GALGAS_configDefinitionList_3A_element (const GALGAS_location & inOperand0,
                                                                                const GALGAS_configSettingList & inOperand1) :
...
/* GALGAS_configDefinitionList_3A_element & GALGAS_configDefinitionList_3A_element::operator = (const GALGAS_configDefinitionList_3A_element & inOperand) {
  mAttribute_mDefinitionLocation = inOperand.mAttribute_mDefinitionLocation ;
  mAttribute_mSettingList = inOperand.mAttribute_mSettingList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_configDefinitionList_3A_element GALGAS_configDefinitionList_3A_element::constructor_new (const GALGAS_location & inOperand0,
                                                                                                const GALGAS_configSettingList & inOperand1 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_configDefinitionList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_configDefinitionList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_configDefinitionList_3A_element::objectCompare (const GALGAS_configDefinitionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_configDefinitionList_3A_element::isValid (void) const {
  return mAttribute_mDefinitionLocation.isValid () && mAttribute_mSettingList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_configDefinitionList_3A_element::drop (void) {
...
void GALGAS_configDefinitionList_3A_element::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
...
GALGAS_location GALGAS_configDefinitionList_3A_element::reader_mDefinitionLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDefinitionLocation ;
}

//---------------------------------------------------------------------------*

GALGAS_configSettingList GALGAS_configDefinitionList_3A_element::reader_mSettingList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_configDefinitionList_3A_element ("configDefinitionList:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_configDefinitionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_configDefinitionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_configDefinitionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_configDefinitionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_configDefinitionList_3A_element GALGAS_configDefinitionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_configDefinitionList_3A_element result ;
  const GALGAS_configDefinitionList_3A_element * p = (const GALGAS_configDefinitionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_configDefinitionList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "configDefinitionList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_immediatExpressionList_3A_element::GALGAS_immediatExpressionList_3A_element (void) :
...
GALGAS_immediatExpressionList_3A_element::GALGAS_immediatExpressionList_3A_element (const GALGAS_immediatExpression & inOperand0) :
mAttribute_mExpression (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_immediatExpressionList_3A_element & GALGAS_immediatExpressionList_3A_element::operator = (const GALGAS_immediatExpressionList_3A_element & inOperand) {
...
GALGAS_immediatExpressionList_3A_element GALGAS_immediatExpressionList_3A_element::constructor_new (const GALGAS_immediatExpression & inOperand0 
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_immediatExpressionList_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_immediatExpressionList_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_immediatExpressionList_3A_element::objectCompare (const GALGAS_immediatExpressionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_immediatExpressionList_3A_element::isValid (void) const {
  return mAttribute_mExpression.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_immediatExpressionList_3A_element::drop (void) {
  mAttribute_mExpression.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_immediatExpressionList_3A_element::description (C_String & ioString,
                                                            const PMSInt32 inIndentation) const {
...
GALGAS_immediatExpression GALGAS_immediatExpressionList_3A_element::reader_mExpression (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_immediatExpressionList_3A_element ("immediatExpressionList:element",
                                                          NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_immediatExpressionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_immediatExpressionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_immediatExpressionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_immediatExpressionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_immediatExpressionList_3A_element GALGAS_immediatExpressionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                  C_Compiler * inCompiler,
                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_immediatExpressionList_3A_element result ;
  const GALGAS_immediatExpressionList_3A_element * p = (const GALGAS_immediatExpressionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_immediatExpressionList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "immediatExpressionList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_immediatSliceExpressionList_3A_element::GALGAS_immediatSliceExpressionList_3A_element (void) :
...
GALGAS_immediatSliceExpressionList_3A_element::GALGAS_immediatSliceExpressionList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                              const GALGAS_immediatExpression & inOperand1) :
...
/* GALGAS_immediatSliceExpressionList_3A_element & GALGAS_immediatSliceExpressionList_3A_element::operator = (const GALGAS_immediatSliceExpressionList_3A_element & inOperand) {
  mAttribute_mSliceName = inOperand.mAttribute_mSliceName ;
  mAttribute_mExpression = inOperand.mAttribute_mExpression ;
  return *this ;
} */
...
GALGAS_immediatSliceExpressionList_3A_element GALGAS_immediatSliceExpressionList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                              const GALGAS_immediatExpression & inOperand1 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_immediatSliceExpressionList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_immediatSliceExpressionList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_immediatSliceExpressionList_3A_element::objectCompare (const GALGAS_immediatSliceExpressionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_immediatSliceExpressionList_3A_element::isValid (void) const {
  return mAttribute_mSliceName.isValid () && mAttribute_mExpression.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_immediatSliceExpressionList_3A_element::drop (void) {
...
void GALGAS_immediatSliceExpressionList_3A_element::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_immediatSliceExpressionList_3A_element::reader_mSliceName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSliceName ;
}

//---------------------------------------------------------------------------*

GALGAS_immediatExpression GALGAS_immediatSliceExpressionList_3A_element::reader_mExpression (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mExpression ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_immediatSliceExpressionList_3A_element ("immediatSliceExpressionList:element",
                                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_immediatSliceExpressionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_immediatSliceExpressionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_immediatSliceExpressionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_immediatSliceExpressionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_immediatSliceExpressionList_3A_element GALGAS_immediatSliceExpressionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                            C_Compiler * inCompiler,
                                                                                                            const GALGAS_location & inErrorLocation
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_immediatSliceExpressionList_3A_element result ;
  const GALGAS_immediatSliceExpressionList_3A_element * p = (const GALGAS_immediatSliceExpressionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_immediatSliceExpressionList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "immediatSliceExpressionList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_constantDefinitionList_3A_element::GALGAS_constantDefinitionList_3A_element (void) :
...
GALGAS_constantDefinitionList_3A_element::GALGAS_constantDefinitionList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_immediatExpression & inOperand1) :
...
/* GALGAS_constantDefinitionList_3A_element & GALGAS_constantDefinitionList_3A_element::operator = (const GALGAS_constantDefinitionList_3A_element & inOperand) {
  mAttribute_mConstantName = inOperand.mAttribute_mConstantName ;
  mAttribute_mExpression = inOperand.mAttribute_mExpression ;
  return *this ;
} */
...
GALGAS_constantDefinitionList_3A_element GALGAS_constantDefinitionList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                    const GALGAS_immediatExpression & inOperand1 
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_constantDefinitionList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_constantDefinitionList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_constantDefinitionList_3A_element::objectCompare (const GALGAS_constantDefinitionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_constantDefinitionList_3A_element::isValid (void) const {
  return mAttribute_mConstantName.isValid () && mAttribute_mExpression.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_constantDefinitionList_3A_element::drop (void) {
...
void GALGAS_constantDefinitionList_3A_element::description (C_String & ioString,
                                                            const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_constantDefinitionList_3A_element::reader_mConstantName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mConstantName ;
}

//---------------------------------------------------------------------------*

GALGAS_immediatExpression GALGAS_constantDefinitionList_3A_element::reader_mExpression (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mExpression ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_constantDefinitionList_3A_element ("constantDefinitionList:element",
                                                          NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_constantDefinitionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_constantDefinitionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_constantDefinitionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_constantDefinitionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_constantDefinitionList_3A_element GALGAS_constantDefinitionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                  C_Compiler * inCompiler,
                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_constantDefinitionList_3A_element result ;
  const GALGAS_constantDefinitionList_3A_element * p = (const GALGAS_constantDefinitionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_constantDefinitionList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "constantDefinitionList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_actualConfigurationMap_3A_element::GALGAS_actualConfigurationMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_actualConfigurationMap_3A_element::GALGAS_actualConfigurationMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_uint & inOperand1,
                                                                                    const GALGAS_uint & inOperand2) :
mAttribute_lkey (inOperand0),
...
/* GALGAS_actualConfigurationMap_3A_element & GALGAS_actualConfigurationMap_3A_element::operator = (const GALGAS_actualConfigurationMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mRegisterAddress = inOperand.mAttribute_mRegisterAddress ;
  mAttribute_mRegisterValue = inOperand.mAttribute_mRegisterValue ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_actualConfigurationMap_3A_element GALGAS_actualConfigurationMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                    const GALGAS_uint & inOperand1,
                                                                                                    const GALGAS_uint & inOperand2 
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_actualConfigurationMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_actualConfigurationMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_actualConfigurationMap_3A_element::objectCompare (const GALGAS_actualConfigurationMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_actualConfigurationMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRegisterAddress.isValid () && mAttribute_mRegisterValue.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_actualConfigurationMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_actualConfigurationMap_3A_element::description (C_String & ioString,
                                                            const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_actualConfigurationMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_actualConfigurationMap_3A_element::reader_mRegisterAddress (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegisterAddress ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_actualConfigurationMap_3A_element::reader_mRegisterValue (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_actualConfigurationMap_3A_element ("actualConfigurationMap:element",
                                                          NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_actualConfigurationMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_actualConfigurationMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_actualConfigurationMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_actualConfigurationMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_actualConfigurationMap_3A_element GALGAS_actualConfigurationMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                  C_Compiler * inCompiler,
                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_actualConfigurationMap_3A_element result ;
  const GALGAS_actualConfigurationMap_3A_element * p = (const GALGAS_actualConfigurationMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_actualConfigurationMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "actualConfigurationMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
