...
cCollectionElement_declarationInRamList * GALGAS_declarationInRamList::makeElement (const GALGAS_declarationInRam & in_mDeclarationInRAM
                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_declarationInRamList * result = NULL ;
  macroMyNew (result, cCollectionElement_declarationInRamList (in_mDeclarationInRAM COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_commonBranchList * GALGAS_commonBranchList::makeElement (const GALGAS_declarationInRamList & in_mDeclarations,
                                                                            const GALGAS_location & in_mEndOfBranchLocation
                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_commonBranchList * result = NULL ;
  macroMyNew (result, cCollectionElement_commonBranchList (in_mDeclarations,
...
cCollectionElement_ramDefinitionList * GALGAS_ramDefinitionList::makeElement (const GALGAS_lstring & in_mBankName,
                                                                              const GALGAS_declarationInRamList & in_mDeclaration
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_ramDefinitionList * result = NULL ;
  macroMyNew (result, cCollectionElement_ramDefinitionList (in_mBankName,
...
cCollectionElement_configSettingList * GALGAS_configSettingList::makeElement (const GALGAS_lstring & in_mSettingName,
                                                                              const GALGAS_lstring & in_mSettingValue
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_configSettingList * result = NULL ;
  macroMyNew (result, cCollectionElement_configSettingList (in_mSettingName,
...
cCollectionElement_configDefinitionList * GALGAS_configDefinitionList::makeElement (const GALGAS_location & in_mDefinitionLocation,
                                                                                    const GALGAS_configSettingList & in_mSettingList
                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_configDefinitionList * result = NULL ;
  macroMyNew (result, cCollectionElement_configDefinitionList (in_mDefinitionLocation,
...
cCollectionElement_immediatExpressionList * GALGAS_immediatExpressionList::makeElement (const GALGAS_immediatExpression & in_mExpression
                                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_immediatExpressionList * result = NULL ;
  macroMyNew (result, cCollectionElement_immediatExpressionList (in_mExpression COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_immediatSliceExpressionList * GALGAS_immediatSliceExpressionList::makeElement (const GALGAS_lstring & in_mSliceName,
                                                                                                  const GALGAS_immediatExpression & in_mExpression
                                                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_immediatSliceExpressionList * result = NULL ;
  macroMyNew (result, cCollectionElement_immediatSliceExpressionList (in_mSliceName,
...
cCollectionElement_constantDefinitionList * GALGAS_constantDefinitionList::makeElement (const GALGAS_lstring & in_mConstantName,
                                                                                        const GALGAS_immediatExpression & in_mExpression
                                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_constantDefinitionList * result = NULL ;
  macroMyNew (result, cCollectionElement_constantDefinitionList (in_mConstantName,
                                                                                        in_mExpression COMMA_THERE)) ;
  return result ;
}
...
void GALGAS_bitNumberExpression::method_display (GALGAS_string & ioArgument0,
  ...
  if (mObjectPtr != NULL) {
    ...
    macroValidSharedObject (p, const cPtr_bitNumberExpression) ;
...
void cPtr_bitNumberLabelValue::method_display (GALGAS_string & ioArgument_ioString,
  ...
  ioArgument_ioString.dotAssign_operation (mAttribute_mBitNumberLabelValue.reader_string (SOURCE_FILE_AT_LINE (271)).operator_concat (GALGAS_string (" [") COMMA_SOURCE_FILE_AT_LINE (271)).operator_concat (mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (271)).reader_string (SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271)) ;
}
...
void cPtr_bitNumberLiteralValue::method_display (GALGAS_string & ioArgument_ioString,
                                                 ...
                                                 COMMA_UNUSED_LOCATION_ARGS) const {
  //-------- @appendInstructionForGeneration
  ioArgument_ioString.dotAssign_operation (mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (261)).reader_string (SOURCE_FILE_AT_LINE (261)) COMMA_SOURCE_FILE_AT_LINE (261)) ;
}
