...
//--- Current element access
  public : GALGAS_commonBranchList_2E_element current (LOCATION_ARGS) const ;
} ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    @commonBranchList_2E_element struct                    *
//                                                                           *
//---------------------------------------------------------------------------*

class GALGAS_commonBranchList_2E_element : public AC_GALGAS_root {
//--------------------------------- Public data members
...
//--------------------------------- Default constructor
  public : GALGAS_commonBranchList_2E_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_commonBranchList_2E_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_commonBranchList_2E_element (const GALGAS_declarationInRamList & in_mDeclarations,
                                               const GALGAS_location & in_mEndOfBranchLocation) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_commonBranchList_2E_element extractObject (const GALGAS_object & inObject,
                                                                    C_Compiler * inCompiler,
                                                                    const GALGAS_location & inErrorLocation
                                                                    COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_commonBranchList_2E_element constructor_new (const GALGAS_declarationInRamList & inOperand0,
                                                                      const GALGAS_location & inOperand1
                                                                      COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const PMSInt32 inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_commonBranchList_2E_element & inOperand) const ;
...
} ; // End of GALGAS_commonBranchList_2E_element class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_commonBranchList_2E_element ;
...
//--- Attribute accessors
  public : VIRTUAL_IN_DEBUG GALGAS_commonBranchList reader_mBranchList (UNUSED_LOCATION_ARGS) const ;
//--- Description
  public : virtual void description (C_String & ioString,
                                     const PMSInt32 inIndentation) const ;
