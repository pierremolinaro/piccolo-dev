...
void routine_checkCurrentEmitAddress (const GALGAS_uint constinArgument_inCurrentAddress,
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("internal error: current emit address is ").operator_concat (var_addr.reader_hexString (SOURCE_FILE_AT_LINE (42)) COMMA_SOURCE_FILE_AT_LINE (42)).operator_concat (GALGAS_string ("; it should be ") COMMA_SOURCE_FILE_AT_LINE (43)).operator_concat (constinArgument_inCurrentAddress.reader_hexString (SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (42)) ;
  }
}
...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_constantMap enumerator_18061 (constinArgument_inConstantMap, kEnumeration_up) ;
    while (enumerator_18061.hasCurrentObject ()) {
      ioArgument_ioListFileContents.dotAssign_operation (enumerator_18061.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (478)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (enumerator_18061.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (478)) ;
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bitSliceTable joker_4136_0 ; // Joker input parameter
    GALGAS_string joker_4139_0 ; // Joker input parameter
    constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (110)), var_registerAddressList, var_size, joker_4136_0, joker_4139_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_uintlist joker_14347_0 ; // Joker input parameter
  GALGAS_uint joker_14350_0 ; // Joker input parameter
  GALGAS_string joker_14369_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, joker_14347_0, joker_14350_0, var_bitSliceTable, joker_14369_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
  GALGAS_stringset var_sliceNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (394)) ;
  cEnumerator_immediatSliceExpressionList enumerator_14445 (object->mAttribute_mSliceExpressionList, kEnumeration_up) ;
  while (enumerator_14445.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_sliceNameSet.reader_hasKey (enumerator_14445.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (396)) COMMA_SOURCE_FILE_AT_LINE (396)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_14445.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_14445.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)).operator_concat (GALGAS_string ("' bit field has been already defined") COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)) ;
    }else if (kBoolFalse == test_0) {
      var_sliceNameSet.addAssign_operation (enumerator_14445.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (399)) COMMA_SOURCE_FILE_AT_LINE (399)) ;
      GALGAS_uint var_sliceIndex ;
      GALGAS_uint var_sliceSize ;
      var_bitSliceTable.method_searchKey (enumerator_14445.current_mSliceName (HERE), var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (402)) ;
      GALGAS_sint_36__34_ var_result ;
      callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_14445.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (403)) ;
      ...
      if (kBoolTrue == test_2) {
        GALGAS_location location_3 (enumerator_14445.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("invalid immediat value associated to the '").operator_concat (enumerator_14445.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string ("' bit field, evaluated as ") COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (var_result.reader_string (SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string (" (should be between 0 and ") COMMA_SOURCE_FILE_AT_LINE (406)).operator_concat (GALGAS_uint ((PMUInt32) 1U).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (406)).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (406)).reader_string (SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (406)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (405)) ;
      }
...
static void categoryMethod_bitNumberLabelValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The ").operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (446)).reader_string (SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string (" index is too large (should be < ") COMMA_SOURCE_FILE_AT_LINE (447)).operator_concat (var_sliceSize.reader_string (SOURCE_FILE_AT_LINE (447)) COMMA_SOURCE_FILE_AT_LINE (447)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (447)) COMMA_SOURCE_FILE_AT_LINE (446)) ;
  }
