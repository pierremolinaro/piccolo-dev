...
void routine_checkCurrentEmitAddress (const GALGAS_uint constinArgument_inCurrentAddress,
  ...
  {
  routine_currentEmitAddress (var_addr, inCompiler COMMA_SOURCE_FILE_AT_LINE (40)) ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (41)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_addr.objectCompare (constinArgument_inCurrentAddress)) COMMA_SOURCE_FILE_AT_LINE (41)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("internal error: current emit address is ").operator_concat (var_addr.reader_hexString (SOURCE_FILE_AT_LINE (42)) COMMA_SOURCE_FILE_AT_LINE (42)).operator_concat (GALGAS_string ("; it should be ") COMMA_SOURCE_FILE_AT_LINE (42)).operator_concat (constinArgument_inCurrentAddress.reader_hexString (SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (42)) ;
  }
}
...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
                                              ...
                                              C_Compiler * /* inCompiler */
                                              COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inConstantMap.reader_count (SOURCE_FILE_AT_LINE (472)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (473)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_SOURCE_FILE_AT_LINE (473)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CONSTANTS").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)) ;
    ...
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Constant").reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (476)).operator_concat (GALGAS_string (" Value\n") COMMA_SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)) ;
    cEnumerator_constantMap enumerator_18058 (constinArgument_inConstantMap, kEnumeration_up) ;
    while (enumerator_18058.hasCurrentObject ()) {
      ioArgument_ioListFileContents.dotAssign_operation (enumerator_18058.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (478)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (enumerator_18058.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (478)) ;
...
GALGAS_string categoryReader_x_34_String (const GALGAS_uint & inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    result_outResult = temp_2.right_shift_operation (GALGAS_uint ((PMUInt32) 12U) COMMA_SOURCE_FILE_AT_LINE (30)).reader_xString (SOURCE_FILE_AT_LINE (30)) ;
    //--- @selfCopyInExpressionForGeneration
    const GALGAS_uint temp_3 = inObject ;
    result_outResult.dotAssign_operation (temp_3.right_shift_operation (GALGAS_uint ((PMUInt32) 8U) COMMA_SOURCE_FILE_AT_LINE (31)).operator_and (GALGAS_uint ((PMUInt32) 15U) COMMA_SOURCE_FILE_AT_LINE (31)).reader_xString (SOURCE_FILE_AT_LINE (31)) COMMA_SOURCE_FILE_AT_LINE (31)) ;
    //--- @selfCopyInExpressionForGeneration
    const GALGAS_uint temp_4 = inObject ;
    result_outResult.dotAssign_operation (temp_4.right_shift_operation (GALGAS_uint ((PMUInt32) 4U) COMMA_SOURCE_FILE_AT_LINE (32)).operator_and (GALGAS_uint ((PMUInt32) 15U) COMMA_SOURCE_FILE_AT_LINE (32)).reader_xString (SOURCE_FILE_AT_LINE (32)) COMMA_SOURCE_FILE_AT_LINE (32)) ;
    //--- @selfCopyInExpressionForGeneration
    const GALGAS_uint temp_5 = inObject ;
    result_outResult.dotAssign_operation (temp_5.operator_and (GALGAS_uint ((PMUInt32) 15U) COMMA_SOURCE_FILE_AT_LINE (33)).reader_xString (SOURCE_FILE_AT_LINE (33)) COMMA_SOURCE_FILE_AT_LINE (33)) ;
  }
//---
...
static void categoryMethod_immediatInteger_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = object->mAttribute_mValue.reader_uint (SOURCE_FILE_AT_LINE (97)).reader_sint_36__34_ (SOURCE_FILE_AT_LINE (97)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inRegisterTable.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (108)).reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioUsedRegisters.addAssign_operation (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (109)).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (109)) ;
    GALGAS_uintlist var_registerAddressList ;
    GALGAS_uint var_size ;
    GALGAS_bitSliceTable joker_4135_0 ; // Joker input parameter
    GALGAS_string joker_4138_0 ; // Joker input parameter
    constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (110)), var_registerAddressList, var_size, joker_4135_0, joker_4138_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
    GALGAS_uint var_registerAddress ;
    var_registerAddressList.method_first (var_registerAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (112)).reader_uint (SOURCE_FILE_AT_LINE (112)).objectCompare (var_size)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (113)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("index (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (113)).reader_uint (SOURCE_FILE_AT_LINE (113)).reader_string (SOURCE_FILE_AT_LINE (113)) COMMA_SOURCE_FILE_AT_LINE (113)).operator_concat (GALGAS_string (") should be lower than size (") COMMA_SOURCE_FILE_AT_LINE (113)).operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (113)) COMMA_SOURCE_FILE_AT_LINE (113)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (113)) COMMA_SOURCE_FILE_AT_LINE (113)) ;
    }
    outArgument_outResult = var_registerAddress.add_operation (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (115)).reader_uint (SOURCE_FILE_AT_LINE (115)), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).reader_sint_36__34_ (SOURCE_FILE_AT_LINE (115)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_3 = constinArgument_inConstantMap.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (116)).reader_string (SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)).boolEnum () ;
    if (kBoolTrue == test_3) {
      constinArgument_inConstantMap.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (117)), outArgument_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (118)).reader_uint (SOURCE_FILE_AT_LINE (118)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_location location_5 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (119)).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("index notation (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (119)).reader_uint (SOURCE_FILE_AT_LINE (119)).reader_string (SOURCE_FILE_AT_LINE (119)) COMMA_SOURCE_FILE_AT_LINE (119)).operator_concat (GALGAS_string (") cannot be used with a constant") COMMA_SOURCE_FILE_AT_LINE (119)) COMMA_SOURCE_FILE_AT_LINE (119)) ;
      }
    }else if (kBoolFalse == test_3) {
      GALGAS_location location_6 (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (122)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (122)).reader_string (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (GALGAS_string ("' should be declared as ram register or as constant") COMMA_SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)) ;
...
static void categoryMethod_immediatAdd_eval (const cPtr_immediatExpression * inObject,
  ...
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) ;
  outArgument_outResult = var_leftResult.add_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatSub_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) ;
  outArgument_outResult = var_leftResult.substract_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (149)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatMul_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (161)) ;
  outArgument_outResult = var_leftResult.multiply_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (162)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatDiv_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (173)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (174)) ;
  outArgument_outResult = var_leftResult.divide_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatMod_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (186)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (187)) ;
  outArgument_outResult = var_leftResult.modulo_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (188)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatAnd_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (199)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
  outArgument_outResult = var_leftResult.operator_and (var_rightResult COMMA_SOURCE_FILE_AT_LINE (201)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatOr_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (213)) ;
  outArgument_outResult = var_leftResult.operator_or (var_rightResult COMMA_SOURCE_FILE_AT_LINE (214)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatXor_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)) ;
  outArgument_outResult = var_leftResult.operator_xor (var_rightResult COMMA_SOURCE_FILE_AT_LINE (227)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatLeftShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (238)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (239)) ;
  outArgument_outResult = var_leftResult.left_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (240)) COMMA_SOURCE_FILE_AT_LINE (240)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatRightShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (251)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (252)) ;
  outArgument_outResult = var_leftResult.right_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (264)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (265)) ;
...
static void categoryMethod_immediatNotEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (281)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
...
static void categoryMethod_immediatGreaterOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) ;
...
static void categoryMethod_immediatLowerOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (316)) ;
...
static void categoryMethod_immediatGreaterTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (332)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (333)) ;
...
static void categoryMethod_immediatLowerTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (350)) ;
...
static void categoryMethod_immediatNegate_eval (const cPtr_immediatExpression * inObject,
  ...
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (366)) ;
  outArgument_outResult = var_result.operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (367)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatComplement_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_result ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (378)) ;
  outArgument_outResult = var_result.operator_tilde (SOURCE_FILE_AT_LINE (379)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = GALGAS_sint_36__34_ ((PMSInt64) 0LL) ;
  ioArgument_ioUsedRegisters.addAssign_operation (object->mAttribute_mRegisterName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (392)) ;
  GALGAS_uintlist joker_14346_0 ; // Joker input parameter
  GALGAS_uint joker_14349_0 ; // Joker input parameter
  GALGAS_string joker_14368_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, joker_14346_0, joker_14349_0, var_bitSliceTable, joker_14368_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
  GALGAS_stringset var_sliceNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (394)) ;
  cEnumerator_immediatSliceExpressionList enumerator_14442 (object->mAttribute_mSliceExpressionList, kEnumeration_up) ;
  while (enumerator_14442.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_sliceNameSet.reader_hasKey (enumerator_14442.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (396)) COMMA_SOURCE_FILE_AT_LINE (396)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_14442.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_14442.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)).operator_concat (GALGAS_string ("' bit field has been already defined") COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)) ;
    }else if (kBoolFalse == test_0) {
      var_sliceNameSet.addAssign_operation (enumerator_14442.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (399)) COMMA_SOURCE_FILE_AT_LINE (399)) ;
      GALGAS_uint var_sliceIndex ;
      GALGAS_uint var_sliceSize ;
      var_bitSliceTable.method_searchKey (enumerator_14442.current_mSliceName (HERE), var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (402)) ;
      GALGAS_sint_36__34_ var_result ;
      callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_14442.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (403)) ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictInf, var_result.objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 0LL))).operator_or (GALGAS_bool (kIsStrictSup, var_result.objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 1LL).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (404)).substract_operation (GALGAS_sint_36__34_ ((PMSInt64) 1LL), inCompiler COMMA_SOURCE_FILE_AT_LINE (404)))) COMMA_SOURCE_FILE_AT_LINE (404)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_location location_3 (enumerator_14442.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("invalid immediat value associated to the '").operator_concat (enumerator_14442.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string ("' bit field, evaluated as ") COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (var_result.reader_string (SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string (" (should be between 0 and ") COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_uint ((PMUInt32) 1U).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (406)).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (406)).reader_string (SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (406)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (405)) ;
      }
      outArgument_outResult = outArgument_outResult.operator_or (var_result.left_shift_operation (var_sliceIndex COMMA_SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)) ;
    }
...
static void categoryMethod_bitNumberLiteralValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (430)).objectCompare (GALGAS_uint ((PMUInt32) 7U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mBitNumberLiteralValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The bit number is ").operator_concat (object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (431)).reader_string (SOURCE_FILE_AT_LINE (431)) COMMA_SOURCE_FILE_AT_LINE (431)).operator_concat (GALGAS_string (" (should be <= 7)") COMMA_SOURCE_FILE_AT_LINE (431)) COMMA_SOURCE_FILE_AT_LINE (431)) ;
  }
  outArgument_outBitNumber = object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (433)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_bitNumberLabelValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  GALGAS_uint var_sliceIndex ;
  GALGAS_uint var_sliceSize ;
  constinArgument_inBitSliceTable.method_searchKey (object->mAttribute_mBitNumberLabelValue, var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (445)).objectCompare (var_sliceSize)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mBitNumberIndexValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The ").operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (446)).reader_string (SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string (" index is too large (should be < ") COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (var_sliceSize.reader_string (SOURCE_FILE_AT_LINE (447)) COMMA_SOURCE_FILE_AT_LINE (447)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (447)) COMMA_SOURCE_FILE_AT_LINE (446)) ;
  }
  outArgument_outBitNumber = var_sliceIndex.add_operation (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (449)), inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) ;
}
//---------------------------------------------------------------------------*
