...
void routine_checkCurrentEmitAddress (const GALGAS_uint constinArgument_inCurrentAddress,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (43)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_addr.objectCompare (constinArgument_inCurrentAddress)) COMMA_SOURCE_FILE_AT_LINE (43)).boolEnum () ;
  if (kBoolTrue == test_0) {
...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
                                              ...
                                              C_Compiler * /* inCompiler */
                                              COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inConstantMap.reader_count (SOURCE_FILE_AT_LINE (474)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (475)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (475)) COMMA_SOURCE_FILE_AT_LINE (475)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CONSTANTS").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (477)).operator_concat (GALGAS_string ("\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (477)) COMMA_SOURCE_FILE_AT_LINE (477)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Constant").reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (GALGAS_string (" Value\n") COMMA_SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (478)) ;
    ...
    while (enumerator_18094.hasCurrentObject ()) {
      ioArgument_ioListFileContents.dotAssign_operation (enumerator_18094.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (480)).reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (480)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (480)).operator_concat (enumerator_18094.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (480)) COMMA_SOURCE_FILE_AT_LINE (480)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (480)) COMMA_SOURCE_FILE_AT_LINE (480)) ;
...
GALGAS_string categoryReader_x_34_String (const GALGAS_uint & inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    result_outResult = temp_2.right_shift_operation (GALGAS_uint ((uint32_t) 12U) COMMA_SOURCE_FILE_AT_LINE (32)).reader_xString (SOURCE_FILE_AT_LINE (32)) ;
    //--- @selfCopyInExpressionForGeneration
    const GALGAS_uint temp_3 = inObject ;
    result_outResult.dotAssign_operation (temp_3.right_shift_operation (GALGAS_uint ((uint32_t) 8U) COMMA_SOURCE_FILE_AT_LINE (33)).operator_and (GALGAS_uint ((uint32_t) 15U) COMMA_SOURCE_FILE_AT_LINE (33)).reader_xString (SOURCE_FILE_AT_LINE (33)) COMMA_SOURCE_FILE_AT_LINE (33)) ;
    //--- @selfCopyInExpressionForGeneration
    const GALGAS_uint temp_4 = inObject ;
    result_outResult.dotAssign_operation (temp_4.right_shift_operation (GALGAS_uint ((uint32_t) 4U) COMMA_SOURCE_FILE_AT_LINE (34)).operator_and (GALGAS_uint ((uint32_t) 15U) COMMA_SOURCE_FILE_AT_LINE (34)).reader_xString (SOURCE_FILE_AT_LINE (34)) COMMA_SOURCE_FILE_AT_LINE (34)) ;
    //--- @selfCopyInExpressionForGeneration
    const GALGAS_uint temp_5 = inObject ;
    result_outResult.dotAssign_operation (temp_5.operator_and (GALGAS_uint ((uint32_t) 15U) COMMA_SOURCE_FILE_AT_LINE (35)).reader_xString (SOURCE_FILE_AT_LINE (35)) COMMA_SOURCE_FILE_AT_LINE (35)) ;
  }
//---
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (120)).reader_uint (SOURCE_FILE_AT_LINE (120)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  while (enumerator_14478.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictInf, var_result.objectCompare (GALGAS_sint_36__34_ ((int64_t) 0LL))).operator_or (GALGAS_bool (kIsStrictSup, var_result.objectCompare (GALGAS_sint_36__34_ ((int64_t) 1LL).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (406)).substract_operation (GALGAS_sint_36__34_ ((int64_t) 1LL), inCompiler COMMA_SOURCE_FILE_AT_LINE (406)))) COMMA_SOURCE_FILE_AT_LINE (406)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_location location_3 (enumerator_14478.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("invalid immediat value associated to the '").operator_concat (enumerator_14478.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (407)) COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_string ("' bit field, evaluated as ") COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (var_result.reader_string (SOURCE_FILE_AT_LINE (407)) COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_string (" (should be between 0 and ") COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_uint ((uint32_t) 1U).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (408)).substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (408)).reader_string (SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (407)) ;
      }
...
static void categoryMethod_bitNumberLiteralValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (432)).objectCompare (GALGAS_uint ((uint32_t) 7U))).boolEnum () ;
  if (kBoolTrue == test_0) {
