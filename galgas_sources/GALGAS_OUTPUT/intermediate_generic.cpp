...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_constantMap enumerator_16939 (constinArgument_inConstantMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16939.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioListFileContents.dotAssign_operation (enumerator_16939.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (456)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (enumerator_16939.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (456)) COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (456)) COMMA_SOURCE_FILE_AT_LINE (456)) ;
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bitSliceTable joker_4004_0 ; // Joker input parameter
    GALGAS_string joker_4007_0 ; // Joker input parameter
    constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (109)), var_registerAddressList, var_size, joker_4004_0, joker_4007_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = GALGAS_sint ((PMSInt32) 0L) ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_uintlist joker_13263_0 ; // Joker input parameter
  GALGAS_uint joker_13266_0 ; // Joker input parameter
  GALGAS_string joker_13285_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, joker_13263_0, joker_13266_0, var_bitSliceTable, joker_13285_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) ;
  //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_immediatSliceExpressionList enumerator_13361 (object->mAttribute_mSliceExpressionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13361.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_sliceNameSet.reader_hasKey (enumerator_13361.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (375)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_13361.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_13361.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string ("' bit field has been already defined") COMMA_SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @plusEqualnstructionForGeneration
      var_sliceNameSet.addAssign_operation (enumerator_13361.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (378)) ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_uint var_sliceIndex ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_uint var_sliceSize ;
      //-------- @methodCallInstructionForGeneration
      var_bitSliceTable.method_searchKey (enumerator_13361.current_mSliceName (HERE), var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_sint var_result ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_13361.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
