...
//                                         september 25th, 2014, at 17h47'28"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_checkCurrentEmitAddress (const GALGAS_uint constinArgument_inCurrentAddress,
  ...
  {
  routine_currentEmitAddress (var_addr, inCompiler  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 42)) ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("intermediate_generic.gSemantics", 43)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_addr.objectCompare (constinArgument_inCurrentAddress)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 43)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("internal error: current emit address is ").operator_concat (var_addr.reader_hexString (SOURCE_FILE ("intermediate_generic.gSemantics", 44))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 44)).operator_concat (GALGAS_string ("; it should be ")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 44)).operator_concat (constinArgument_inCurrentAddress.reader_hexString (SOURCE_FILE ("intermediate_generic.gSemantics", 45))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 45))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 44)) ;
  }
}
...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
                                              ...
                                              C_Compiler * /* inCompiler */
                                              COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inConstantMap.reader_count (SOURCE_FILE ("intermediate_generic.gSemantics", 474)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 475)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 475))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 475)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CONSTANTS").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 476))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 476)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 476))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 476)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 477)).operator_concat (GALGAS_string ("\n"
      "\n")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 477))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 477)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Constant").reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 478)).operator_concat (GALGAS_string (" Value\n")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 478))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 478)) ;
    ...
    while (enumerator_18094.hasCurrentObject ()) {
      ioArgument_ioListFileContents.dotAssign_operation (enumerator_18094.current_lkey (HERE).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 480)).reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 480)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 480)).operator_concat (enumerator_18094.current_mValue (HERE).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 480))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 480)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 480))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 480)) ;
      enumerator_18094.gotoNextObject () ;
    }
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 482)) ;
  }
}
...
GALGAS_string categoryReader_x_34_String (const GALGAS_uint & inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    result_outResult = temp_2.right_shift_operation (GALGAS_uint ((uint32_t) 12U) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 32)).reader_xString (SOURCE_FILE ("intermediate_generic.gSemantics", 32)) ;
    const GALGAS_uint temp_3 = inObject ;
    result_outResult.dotAssign_operation (temp_3.right_shift_operation (GALGAS_uint ((uint32_t) 8U) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 33)).operator_and (GALGAS_uint ((uint32_t) 15U) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 33)).reader_xString (SOURCE_FILE ("intermediate_generic.gSemantics", 33))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 33)) ;
    const GALGAS_uint temp_4 = inObject ;
    result_outResult.dotAssign_operation (temp_4.right_shift_operation (GALGAS_uint ((uint32_t) 4U) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 34)).operator_and (GALGAS_uint ((uint32_t) 15U) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 34)).reader_xString (SOURCE_FILE ("intermediate_generic.gSemantics", 34))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 34)) ;
    const GALGAS_uint temp_5 = inObject ;
    result_outResult.dotAssign_operation (temp_5.operator_and (GALGAS_uint ((uint32_t) 15U) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 35)).reader_xString (SOURCE_FILE ("intermediate_generic.gSemantics", 35))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 35)) ;
  }
//---
...
static void categoryMethod_immediatInteger_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = object->mAttribute_mValue.reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 99)).reader_sint_36__34_ (SOURCE_FILE ("intermediate_generic.gSemantics", 99)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  const enumGalgasBool test_0 = constinArgument_inRegisterTable.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE ("intermediate_generic.gSemantics", 110)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 110)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 110)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioUsedRegisters.addAssign_operation (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE ("intermediate_generic.gSemantics", 111)).mAttribute_string  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 111)) ;
    ...
    constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE ("intermediate_generic.gSemantics", 112)), var_registerAddressList, var_size, joker_4171_0, joker_4174_0, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 112)) ;
    GALGAS_uint var_registerAddress ;
    var_registerAddressList.method_first (var_registerAddress, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 113)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE ("intermediate_generic.gSemantics", 114)).reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 114)).objectCompare (var_size)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE ("intermediate_generic.gSemantics", 115)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("index (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE ("intermediate_generic.gSemantics", 115)).reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 115)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 115))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 115)).operator_concat (GALGAS_string (") should be lower than size (")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 115)).operator_concat (var_size.reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 115))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 115)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 115))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 115)) ;
    }
    outArgument_outResult = var_registerAddress.add_operation (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE ("intermediate_generic.gSemantics", 117)).reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 117)), inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 117)).reader_sint_36__34_ (SOURCE_FILE ("intermediate_generic.gSemantics", 117)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_3 = constinArgument_inConstantMap.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE ("intermediate_generic.gSemantics", 118)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 118)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 118)).boolEnum () ;
    if (kBoolTrue == test_3) {
      constinArgument_inConstantMap.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE ("intermediate_generic.gSemantics", 119)), outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 119)) ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE ("intermediate_generic.gSemantics", 120)).reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 120)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_location location_5 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE ("intermediate_generic.gSemantics", 121)).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("index notation (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE ("intermediate_generic.gSemantics", 121)).reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 121)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 121))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 121)).operator_concat (GALGAS_string (") cannot be used with a constant")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 121))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 121)) ;
      }
    }else if (kBoolFalse == test_3) {
      GALGAS_location location_6 (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE ("intermediate_generic.gSemantics", 124)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE ("intermediate_generic.gSemantics", 124)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 124))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 124)).operator_concat (GALGAS_string ("' should be declared as ram register or as constant")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 124))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 124)) ;
...
static void categoryMethod_immediatAdd_eval (const cPtr_immediatExpression * inObject,
  ...
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 136)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 137)) ;
  outArgument_outResult = var_leftResult.add_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 138)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatSub_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 149)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 150)) ;
  outArgument_outResult = var_leftResult.substract_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 151)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatMul_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 162)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 163)) ;
  outArgument_outResult = var_leftResult.multiply_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 164)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatDiv_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 175)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 176)) ;
  outArgument_outResult = var_leftResult.divide_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 177)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatMod_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 188)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 189)) ;
  outArgument_outResult = var_leftResult.modulo_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 190)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatAnd_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 201)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 202)) ;
  outArgument_outResult = var_leftResult.operator_and (var_rightResult COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 203)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatOr_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 214)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 215)) ;
  outArgument_outResult = var_leftResult.operator_or (var_rightResult COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 216)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatXor_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 227)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 228)) ;
  outArgument_outResult = var_leftResult.operator_xor (var_rightResult COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 229)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatLeftShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 240)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 241)) ;
  outArgument_outResult = var_leftResult.left_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 242)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 242)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatRightShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 253)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 254)) ;
  outArgument_outResult = var_leftResult.right_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 255)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 255)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 266)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 267)) ;
...
static void categoryMethod_immediatNotEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 283)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 284)) ;
...
static void categoryMethod_immediatGreaterOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 300)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 301)) ;
...
static void categoryMethod_immediatLowerOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 317)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 318)) ;
...
static void categoryMethod_immediatGreaterTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 334)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 335)) ;
...
static void categoryMethod_immediatLowerTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_leftResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 351)) ;
  GALGAS_sint_36__34_ var_rightResult ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 352)) ;
...
static void categoryMethod_immediatNegate_eval (const cPtr_immediatExpression * inObject,
  ...
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 368)) ;
  outArgument_outResult = var_result.operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 369)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatComplement_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint_36__34_ var_result ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 380)) ;
  outArgument_outResult = var_result.operator_tilde (SOURCE_FILE ("intermediate_generic.gSemantics", 381)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = GALGAS_sint_36__34_ ((int64_t) 0LL) ;
  ioArgument_ioUsedRegisters.addAssign_operation (object->mAttribute_mRegisterName.mAttribute_string  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 394)) ;
  ...
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, joker_14382_0, joker_14385_0, var_bitSliceTable, joker_14404_0, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 395)) ;
  GALGAS_stringset var_sliceNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("intermediate_generic.gSemantics", 396)) ;
  ...
  while (enumerator_14478.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_sliceNameSet.reader_hasKey (enumerator_14478.current_mSliceName (HERE).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 398)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 398)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_14478.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_14478.current_mSliceName (HERE).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 399))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 399)).operator_concat (GALGAS_string ("' bit field has been already defined")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 399))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 399)) ;
    }else if (kBoolFalse == test_0) {
      var_sliceNameSet.addAssign_operation (enumerator_14478.current_mSliceName (HERE).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 401))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 401)) ;
      GALGAS_uint var_sliceIndex ;
      GALGAS_uint var_sliceSize ;
      var_bitSliceTable.method_searchKey (enumerator_14478.current_mSliceName (HERE), var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 404)) ;
      GALGAS_sint_36__34_ var_result ;
      callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_14478.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, ioArgument_ioUsedRegisters, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 405)) ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictInf, var_result.objectCompare (GALGAS_sint_36__34_ ((int64_t) 0LL))).operator_or (GALGAS_bool (kIsStrictSup, var_result.objectCompare (GALGAS_sint_36__34_ ((int64_t) 1LL).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 406)).substract_operation (GALGAS_sint_36__34_ ((int64_t) 1LL), inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 406)))) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 406)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_location location_3 (enumerator_14478.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("invalid immediat value associated to the '").operator_concat (enumerator_14478.current_mSliceName (HERE).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 407))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 407)).operator_concat (GALGAS_string ("' bit field, evaluated as ")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 407)).operator_concat (var_result.reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 407))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 407)).operator_concat (GALGAS_string (" (should be between 0 and ")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 407)).operator_concat (GALGAS_uint ((uint32_t) 1U).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 408)).substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 408)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 408))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 408)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 408))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 407)) ;
      }
      outArgument_outResult = outArgument_outResult.operator_or (var_result.left_shift_operation (var_sliceIndex COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 410)) COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 410)) ;
    }
...
static void categoryMethod_bitNumberLiteralValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 432)).objectCompare (GALGAS_uint ((uint32_t) 7U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mBitNumberLiteralValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The bit number is ").operator_concat (object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 433)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 433))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 433)).operator_concat (GALGAS_string (" (should be <= 7)")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 433))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 433)) ;
  }
  outArgument_outBitNumber = object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 435)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_bitNumberLabelValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  GALGAS_uint var_sliceIndex ;
  GALGAS_uint var_sliceSize ;
  constinArgument_inBitSliceTable.method_searchKey (object->mAttribute_mBitNumberLabelValue, var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 446)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 447)).objectCompare (var_sliceSize)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mBitNumberIndexValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The ").operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 448)).reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 448))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 448)).operator_concat (GALGAS_string (" index is too large (should be < ")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 448)).operator_concat (var_sliceSize.reader_string (SOURCE_FILE ("intermediate_generic.gSemantics", 449))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 449)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 449))  COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 448)) ;
  }
  outArgument_outBitNumber = var_sliceIndex.add_operation (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE ("intermediate_generic.gSemantics", 451)), inCompiler COMMA_SOURCE_FILE ("intermediate_generic.gSemantics", 451)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
