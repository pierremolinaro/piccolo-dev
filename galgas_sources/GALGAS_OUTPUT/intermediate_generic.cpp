...
//                    september 28th, 2013, at 10h3'10"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatInteger_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = object->mAttribute_mValue.reader_uint (SOURCE_FILE_AT_LINE (95)).reader_sint_36__34_ (SOURCE_FILE_AT_LINE (95)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bitSliceTable joker_4011_0 ; // Joker input parameter
    GALGAS_string joker_4014_0 ; // Joker input parameter
    constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (108)), var_registerAddressList, var_size, joker_4011_0, joker_4014_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
    ...
    outArgument_outResult = var_registerAddress.add_operation (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (113)).reader_uint (SOURCE_FILE_AT_LINE (113)), inCompiler COMMA_SOURCE_FILE_AT_LINE (113)).reader_sint_36__34_ (SOURCE_FILE_AT_LINE (113)) ;
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = GALGAS_sint_36__34_ ((PMSInt64) 0LL) ;
  GALGAS_uintlist joker_12975_0 ; // Joker input parameter
  GALGAS_uint joker_12978_0 ; // Joker input parameter
  GALGAS_string joker_12997_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, joker_12975_0, joker_12978_0, var_bitSliceTable, joker_12997_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (371)) ;
  GALGAS_stringset var_sliceNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (372)) ;
  cEnumerator_immediatSliceExpressionList enumerator_13073 (object->mAttribute_mSliceExpressionList, kEnumeration_up) ;
  while (enumerator_13073.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_sliceNameSet.reader_hasKey (enumerator_13073.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_13073.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_13073.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (375)).operator_concat (GALGAS_string ("' bit field has been already defined") COMMA_SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (375)) ;
    }else if (kBoolFalse == test_0) {
      var_sliceNameSet.addAssign_operation (enumerator_13073.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (377)) ;
      GALGAS_uint var_sliceIndex ;
      GALGAS_uint var_sliceSize ;
      var_bitSliceTable.method_searchKey (enumerator_13073.current_mSliceName (HERE), var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
      GALGAS_sint_36__34_ var_result ;
      callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_13073.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictInf, var_result.objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 0LL))).operator_or (GALGAS_bool (kIsStrictSup, var_result.objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 1LL).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (382)).substract_operation (GALGAS_sint_36__34_ ((PMSInt64) 1LL), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)))) COMMA_SOURCE_FILE_AT_LINE (382)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_location location_3 (enumerator_13073.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("invalid immediat value associated to the '").operator_concat (enumerator_13073.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (GALGAS_string ("' bit field, evaluated as ") COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (var_result.reader_string (SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (GALGAS_string (" (should be between 0 and ") COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_uint ((PMUInt32) 1U).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (384)).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (384)).reader_string (SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (383)) ;
      }
