...
category_method__ipic_pseudo_ORG__defineLabelAtAddress (C_Compiler & inLexique,
  ...
  if (operand_1438 != NULL) {
    if (((var_cas_ioAddress)._operator_strictSup (operand_1438->mOrigin)).isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("internal error: current address ("))._operator_concat (var_cas_ioAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (44))))._operator_concat (GGS_string (") is greater than origin (")))._operator_concat (operand_1438->mOrigin.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (44))))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (45)) ;
    }
...
category_method__ipic_actualInstruction__defineLabelAtAddress (C_Compiler & inLexique,
  ...
  if (operand_1899 != NULL) {
    ...
    var_cas_ioAddress = var_cas_ioAddress._add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (58)) ;
  }
}
  ...
  if (operand_4280 != NULL) {
    ...
    case GGS_condionalBranchMode::enum_native:
      ...
      if (_temp_4607.isBuilt ()) {
        _temp_4607 (HERE)->method_searchKey (inLexique, operand_4280->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (127)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (128))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (128))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) COMMA_SOURCE_FILE_AT_LINE (128))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (128)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (127L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (128L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        operand_4280->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("displacement ("))._operator_concat (var_cas_displacement.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130))))._operator_concat (GGS_string (") too large for Bcc instruction (limited to [-128, 127])")) COMMA_SOURCE_FILE_AT_LINE (131)) ;
      }
      }
      break ;
    case GGS_condionalBranchMode::enum_ipicNative:
      ...
      if (_temp_5012.isBuilt ()) {
        _temp_5012 (HERE)->method_searchKey (inLexique, operand_4280->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (134)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (135))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (135))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (135)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (127L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (128L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (138))) ;
    ...
    case GGS_condionalBranchMode::enum_ipicBRA:
      ...
      if (_temp_5734.isBuilt ()) {
        _temp_5734 (HERE)->method_searchKey (inLexique, operand_4280->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (149)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (150))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (150))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (150)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (153))) ;
...
category_method__ipic_jump_test_register__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_6597 != NULL) {
    if ((operand_6597->mUsesBra).isBuiltAndTrue ()) {
      ...
      var_cas_BRAaddress = var_cas_ioAddress._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (177)) ;
      if ((operand_6597->mBranchIfZero).isBuiltAndTrue ()) {
        var_cas_BRAaddress = var_cas_BRAaddress._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (179)) ;
      }
      GGS_uint  var_cas_targetAddress ;
      const GGS_ipic18_symbolTableForConvertingRelatives  _temp_7022 = var_cas_inRoutineSymbolTable ;
      if (_temp_7022.isBuilt ()) {
        _temp_7022 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_6597->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (182)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (183))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (183))._substract_operation (inLexique, var_cas_BRAaddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) COMMA_SOURCE_FILE_AT_LINE (183))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (183)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
...
category_method__ipic_registerComparisonCondition__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_7857 != NULL) {
    ...
    if ((operand_7857->mUsesBra).isBuiltAndTrue ()) {
      GGS_uint  var_cas_BRAaddress ;
      var_cas_BRAaddress = var_cas_ioAddress._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (211)) ;
      if ((var_cas_uses).isBuiltAndTrue ()) {
        var_cas_BRAaddress = var_cas_BRAaddress._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }
      GGS_uint  var_cas_targetAddress ;
      const GGS_ipic18_symbolTableForConvertingRelatives  _temp_8323 = var_cas_inRoutineSymbolTable ;
      if (_temp_8323.isBuilt ()) {
        _temp_8323 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_7857->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (216)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (217))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (217))._substract_operation (inLexique, var_cas_BRAaddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (217)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220))) ;
        var_cas_ioListFileContents.appendCString (":  JUMP with BRA overflow, converted to JUMP with GOTO\n") ;
        GGS_ipic_actualInstruction  var_cas_instruction ;
...
category_method__ipic_incDecRegisterInCondition__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_9163 != NULL) {
    if ((operand_9163->mUsesBra).isBuiltAndTrue ()) {
      GGS_uint  var_cas_BRAaddress ;
      var_cas_BRAaddress = var_cas_ioAddress._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (244)) ;
      GGS_uint  var_cas_targetAddress ;
      const GGS_ipic18_symbolTableForConvertingRelatives  _temp_9512 = var_cas_inRoutineSymbolTable ;
      if (_temp_9512.isBuilt ()) {
        _temp_9512 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_9163->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (246)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (247))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (247))._substract_operation (inLexique, var_cas_BRAaddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (247)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (250))) ;
        var_cas_ioListFileContents.appendCString (":  JUMP with BRA overflow, converted to JUMP with GOTO\n") ;
        GGS_ipic_actualInstruction  var_cas_instruction ;
  ...
  if (operand_10378 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_ipicRelative:
      ...
      if (_temp_10705.isBuilt ()) {
        _temp_10705 (HERE)->method_searchKey (inLexique, operand_10378->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (278)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (279))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (279))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (279)) COMMA_SOURCE_FILE_AT_LINE (279))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (279)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282))) ;
        var_cas_ioListFileContents.appendCString (":  JUMP with BRA overflow, converted to JUMP with GOTO\n") ;
        GGS_ipic_actualInstruction  var_cas_instruction ;
    ...
    case GGS_jumpInstructionKind::enum_relative:
      ...
      if (_temp_11412.isBuilt ()) {
        _temp_11412 (HERE)->method_searchKey (inLexique, operand_10378->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (293)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (294))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (294))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (294)) COMMA_SOURCE_FILE_AT_LINE (294))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (294)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        operand_10378->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("displacement ("))._operator_concat (var_cas_displacement.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (296))))._operator_concat (GGS_string (") too large for BRA instruction (limited to [-1024, 1023])")) COMMA_SOURCE_FILE_AT_LINE (297)) ;
      }
      }
      break ;
  ...
  if (operand_11917 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_ipicRelative:
      ...
      if (_temp_12244.isBuilt ()) {
        _temp_12244 (HERE)->method_searchKey (inLexique, operand_11917->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (315)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (316))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (316))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (316)) COMMA_SOURCE_FILE_AT_LINE (316))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (316)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (318))) ;
    ...
    case GGS_jumpInstructionKind::enum_relative:
      ...
      if (_temp_12950.isBuilt ()) {
        _temp_12950 (HERE)->method_searchKey (inLexique, operand_11917->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (330)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (331))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (331))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (331)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        operand_11917->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("displacement ("))._operator_concat (var_cas_displacement.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (333))))._operator_concat (GGS_string (") too large for RCALL instruction (limited to [-1024, 1023])")) COMMA_SOURCE_FILE_AT_LINE (334)) ;
      }
      }
      break ;
    case GGS_jumpInstructionKind::enum_absolute:
...
category_method__ipic_pseudo_LABEL__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_13466 != NULL) {
    ...
    if (_temp_13780.isBuilt ()) {
      _temp_13780 (HERE)->method_searchKey (inLexique, operand_13466->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (350)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_13466->mLabel.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("Internal second pass error: the '"))._operator_concat (operand_13466->mLabel))._operator_concat (GGS_string ("' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (353))))._operator_concat (GGS_string (" value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (354))))._operator_concat (GGS_string (" in first pass")) COMMA_SOURCE_FILE_AT_LINE (355)) ;
    }
  }
}
  ...
  if (operand_14225 != NULL) {
    if ((operand_14225->mUsesRCALL).isBuiltAndTrue ()) {
      ...
      if (_temp_14536.isBuilt ()) {
        _temp_14536 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (370)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (371))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (371))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (371)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (374))) ;
  ...
  if (operand_15356 != NULL) {
    if ((operand_15356->mUsesRCALL).isBuiltAndTrue ()) {
      ...
      if (_temp_15667.isBuilt ()) {
        _temp_15667 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (397)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (398))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (398))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (398)) COMMA_SOURCE_FILE_AT_LINE (398))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (398)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (401))) ;
    ...
    var_cas_addressForCheckingBRA = var_cas_ioAddress._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (410)) ;
    if (((operand_15356->mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_addressForCheckingBRA = var_cas_addressForCheckingBRA._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (412)) ;
    }
    {
      ...
      while (((operand_16509 = enumerator_16509.nextObject ()))) {
        ...
        if (_temp_16574.isBuilt ()) {
          _temp_16574 (HERE)->method_searchKey (inLexique, operand_16509->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (416)) ;
        }
        GGS_sint  var_cas_displacement ;
        var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (417))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (417))._substract_operation (inLexique, var_cas_addressForCheckingBRA.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (417)) ;
        if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
          operand_16509->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("displacement ("))._operator_concat (var_cas_displacement.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (419))))._operator_concat (GGS_string (") too large for BRA instruction (limited to [-1024, 1023])")) COMMA_SOURCE_FILE_AT_LINE (420)) ;
        }
        var_cas_addressForCheckingBRA = var_cas_addressForCheckingBRA._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (421)) ;
      }
    }
  }
}
  ...
  if (operand_17130 != NULL) {
    if ((operand_17130->mUsesRCALL).isBuiltAndTrue ()) {
      ...
      if (_temp_17441.isBuilt ()) {
        _temp_17441 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (437)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (438))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (438))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (438)) COMMA_SOURCE_FILE_AT_LINE (438))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (438)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (441))) ;
  ...
  if (operand_18355 != NULL) {
    if ((operand_18355->mUsesRCALL).isBuiltAndTrue ()) {
      ...
      if (_temp_18666.isBuilt ()) {
        _temp_18666 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (467)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (468))._substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (468))._substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (468)) COMMA_SOURCE_FILE_AT_LINE (468))._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (468)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (471))) ;
...
void routine_ipic18_convertRelativeBranchsToAbsoluteWhenNeeded (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (496))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("CONVERT RELATIVES").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (497))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (498))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  ...
  while (_condition_21865.isBuiltAndTrue ()) {
    ...
    if (_condition_21865.isBuiltAndTrue ()) {
      if (_variant_21865.uintValue () == 0) {
        ...
        _variant_21865._decrement_operation (inLexique COMMA_HERE) ;
        var_cas_relativeBranchOverflow = GGS_bool (false) ;
        var_cas_iteration._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (505)) ;
        var_cas_ioListFileContents.appendCString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (506))) ;
        var_cas_ioListFileContents.appendCString (":\n") ;
        ...
        var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_20732 = enumerator_20732.nextObject ()))) {
            ...
            if (_temp_20776.isBuilt ()) {
              ...
              if (_method != NULL) {
                _method (inLexique, _temp_20776 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (511)) ;
              }
            }
          }
        }
        ...
        var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_21010 = enumerator_21010.nextObject ()))) {
            ...
            if (_temp_21087.isBuilt ()) {
              _temp_21087 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (518)) ;
            }
            ...
            if (_temp_21149.isBuilt ()) {
              ...
              if (_method != NULL) {
                _method (inLexique, _temp_21149 (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_relativeBranchOverflow, var_cas_ioGeneratedInstructionList, var_cas_idx, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (519)) ;
              }
            }
            var_cas_currentAddress = var_cas_currentAddress._add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (520)) ;
            var_cas_idx.mValue ++ ;
          }
        }
        if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (523))))._operator_concat (GGS_string (" value when checking relative branches, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (525))))._operator_concat (GGS_string (" value when computing routine map")) COMMA_SOURCE_FILE_AT_LINE (526)) ;
        }
        if (((var_cas_relativeBranchOverflow)._operator_not ()).isBuiltAndTrue ()) {
          ...
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (529))) ;
