...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_ipic18_symbolTableForConvertingRelatives ("ipic18_symbolTableForConvertingRelatives", false, NULL) ;
...
GGS_object GGS_ipic18_symbolTableForConvertingRelatives::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_ipic18_symbolTableForConvertingRelatives * p = NULL ;
    macroMyNew (p, GGS_ipic18_symbolTableForConvertingRelatives (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_ipic18_symbolTableForConvertingRelatives GGS_ipic18_symbolTableForConvertingRelatives::castFromObject (C_Compiler & inLexique,
  ...
  if (NULL != embeddedObject) {
    const GGS_ipic18_symbolTableForConvertingRelatives * p = dynamic_cast <const GGS_ipic18_symbolTableForConvertingRelatives *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_ipic18_symbolTableForConvertingRelatives, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_ipic18_symbolTableForConvertingRelatives::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_ipic18_symbolTableForConvertingRelatives ;
}

//---------------------------------------------------------------------------*

GGS_ipic18_symbolTableForConvertingRelatives GGS_ipic18_symbolTableForConvertingRelatives::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_ipic18_symbolTableForConvertingRelatives result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
enterCategoryMethod__ipic18_instruction__defineLabelAtAddress (typeCategoryMethod__ipic18_instruction__defineLabelAtAddress inRoutine,
  ...
  gDispatchTableForMethod__ipic18_instruction__defineLabelAtAddress.forceObjectAtIndex (inClassID, inRoutine, NULL COMMA_HERE) ;
}
...
findCategoryMethod__ipic18_instruction__defineLabelAtAddress (AC_galgasClassRunTimeInformationEX * inClassPtr) {
  ...
  if (NULL == result) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__ipic18_instruction__defineLabelAtAddress.forceObjectAtIndex (inClassPtr->slotID (), result, NULL COMMA_HERE) ;
    }
  }
  return result ;
}
...
category_method__ipic_pseudo_ORG__defineLabelAtAddress (C_Compiler & inLexique,
  ...
  if (operand_1438 != NULL) {
    const GGS_bool cond_1714 = (var_cas_ioAddress).operator_strictSup (operand_1438->mOrigin) ;
    if (cond_1714.isBuiltAndTrue ()) {
...
enterCategoryMethod__ipic18_instruction__checkRelativeBranch (typeCategoryMethod__ipic18_instruction__checkRelativeBranch inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__ipic18_instruction__checkRelativeBranch.forceObjectAtIndex (inClassID, inRoutine, NULL COMMA_HERE) ;
}
...
findCategoryMethod__ipic18_instruction__checkRelativeBranch (AC_galgasClassRunTimeInformationEX * inClassPtr) {
  ...
  if (NULL == result) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__ipic18_instruction__checkRelativeBranch.forceObjectAtIndex (inClassPtr->slotID (), result, NULL COMMA_HERE) ;
    }
  }
  return result ;
}
  ...
  if (operand_4280 != NULL) {
    ...
    case GGS_condionalBranchMode::enum_native:
      ...
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_4280->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (127)) ;
      }
      ...
      const GGS_bool cond_4925 = ((var_cas_displacement).operator_strictSup (GGS_sint (127L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (128L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_4925.isBuiltAndTrue ()) {
    ...
    case GGS_condionalBranchMode::enum_ipicNative:
      ...
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_4280->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (134)) ;
      }
      ...
      const GGS_bool cond_5650 = ((var_cas_displacement).operator_strictSup (GGS_sint (127L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (128L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_5650.isBuiltAndTrue ()) {
        ...
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic18_instruction_conditionalBranch ::constructor_new (inLexique, operand_4280->mInstructionLocation, GGS_condionalBranchMode::constructor_ipicBRA (inLexique COMMA_SOURCE_FILE_AT_LINE (141)), operand_4280->mConditionalBranch, operand_4280->mTargetLabel COMMA_SOURCE_FILE_AT_LINE (139)) ;
    ...
    case GGS_condionalBranchMode::enum_ipicBRA:
      ...
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_4280->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (149)) ;
      }
      ...
      const GGS_bool cond_6378 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_6378.isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        ...
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic18_instruction_conditionalBranch ::constructor_new (inLexique, operand_4280->mInstructionLocation, GGS_condionalBranchMode::constructor_ipicGOTO (inLexique COMMA_SOURCE_FILE_AT_LINE (156)), operand_4280->mConditionalBranch, operand_4280->mTargetLabel COMMA_SOURCE_FILE_AT_LINE (154)) ;
...
category_method__ipic_jump_test_register__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_6597 != NULL) {
    const GGS_bool cond_7688 = operand_6597->mUsesBra ;
    if (cond_7688.isBuiltAndTrue ()) {
      GGS_uint  var_cas_BRAaddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (177)) ;
      const GGS_bool cond_6955 = operand_6597->mBranchIfZero ;
      ...
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_6597->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (182)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (182)) ;
      }
      ...
      const GGS_bool cond_7677 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_7677.isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        ...
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic_jump_test_register ::constructor_new (inLexique, operand_6597->mInstructionLocation, operand_6597->mRegisterDescription, operand_6597->mTargetLabel, operand_6597->mBranchIfZero, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (187)) ;
...
category_method__ipic_registerComparisonCondition__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_7857 != NULL) {
    ...
    const GGS_bool cond_8996 = operand_7857->mUsesBra ;
    if (cond_8996.isBuiltAndTrue ()) {
      GGS_uint  var_cas_BRAaddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (211)) ;
      const GGS_bool cond_8256 = var_cas_uses ;
      if (cond_8256.isBuiltAndTrue ()) {
        var_cas_BRAaddress = var_cas_BRAaddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_7857->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (216)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (216)) ;
      }
      ...
      const GGS_bool cond_8985 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_8985.isBuiltAndTrue ()) {
        ...
        var_cas_ioListFileContents.appendCString (":  JUMP with BRA overflow, converted to JUMP with GOTO\n") ;
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic_registerComparisonCondition ::constructor_new (inLexique, operand_7857->mInstructionLocation, operand_7857->mRegisterDescription, operand_7857->mTargetLabel, operand_7857->mComparison, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (221)) ;
...
category_method__ipic_incDecRegisterInCondition__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_9163 != NULL) {
    const GGS_bool cond_10232 = operand_9163->mUsesBra ;
    if (cond_10232.isBuiltAndTrue ()) {
      GGS_uint  var_cas_BRAaddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (244)) ;
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_9163->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (246)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (246)) ;
      }
      ...
      const GGS_bool cond_10221 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_10221.isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents.dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (250))) ;
        var_cas_ioListFileContents.appendCString (":  JUMP with BRA overflow, converted to JUMP with GOTO\n") ;
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic_incDecRegisterInCondition ::constructor_new (inLexique, operand_9163->mInstructionLocation, operand_9163->mRegisterDescription, operand_9163->mTargetLabel, operand_9163->mIncrement, operand_9163->m_W_isDestination, operand_9163->mBranchIfZero, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (251)) ;
...
category_method__ipic_JUMP__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_10378 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_ipicRelative:
      ...
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_10378->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (278)) ;
      }
      ...
      const GGS_bool cond_11300 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_11300.isBuiltAndTrue ()) {
        ...
        var_cas_ioListFileContents.appendCString (":  JUMP with BRA overflow, converted to JUMP with GOTO\n") ;
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic_JUMP ::constructor_new (inLexique, operand_10378->mInstructionLocation, operand_10378->mTargetLabel, GGS_jumpInstructionKind::constructor_ipicAbsolute (inLexique COMMA_SOURCE_FILE_AT_LINE (286)) COMMA_SOURCE_FILE_AT_LINE (283)) ;
    ...
    case GGS_jumpInstructionKind::enum_relative:
      ...
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_10378->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (293)) ;
      }
      ...
      const GGS_bool cond_11734 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_11734.isBuiltAndTrue ()) {
...
category_method__ipic_JSR__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_11917 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_ipicRelative:
      ...
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_11917->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (315)) ;
      }
      ...
      const GGS_bool cond_12838 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_12838.isBuiltAndTrue ()) {
        var_cas_ioListFileContents.appendCString ("  line ") ;
        ...
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic_JSR ::constructor_new (inLexique, operand_11917->mInstructionLocation, operand_11917->mTargetLabel, GGS_jumpInstructionKind::constructor_ipicAbsolute (inLexique COMMA_SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (320)) ;
    ...
    case GGS_jumpInstructionKind::enum_relative:
      ...
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_11917->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (330)) ;
      }
      ...
      const GGS_bool cond_13274 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_13274.isBuiltAndTrue ()) {
...
category_method__ipic_pseudo_LABEL__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_13466 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_13466->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (350)) ;
    }
    const GGS_bool cond_14055 = (var_cas_targetAddress).operator_isNotEqual (var_cas_ioAddress) ;
    if (cond_14055.isBuiltAndTrue ()) {
...
category_method__ipic18_instruction_computed_retlw__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_14225 != NULL) {
    const GGS_bool cond_15188 = operand_14225->mUsesRCALL ;
    if (cond_15188.isBuiltAndTrue ()) {
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (370)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (370)) ;
      }
      ...
      const GGS_bool cond_15177 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_15177.isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        ...
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic18_instruction_computed_retlw ::constructor_new (inLexique, operand_14225->mInstructionLocation, operand_14225->mLiteralValues, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (375)) ;
...
category_method__ipic18_instruction_computed_bra__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_15356 != NULL) {
    const GGS_bool cond_16312 = operand_15356->mUsesRCALL ;
    if (cond_16312.isBuiltAndTrue ()) {
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (397)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (397)) ;
      }
      ...
      const GGS_bool cond_16301 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_16301.isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        ...
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic18_instruction_computed_bra ::constructor_new (inLexique, operand_15356->mInstructionLocation, operand_15356->mTargetLabels, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (402)) ;
    ...
    GGS_uint  var_cas_addressForCheckingBRA = var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (410)) ;
    const GGS_bool cond_16480 = (operand_15356->mUsesRCALL).operator_not () ;
    if (cond_16480.isBuiltAndTrue ()) {
    ...
    }
    {
      ...
      while (((operand_16509 = enumerator_16509.nextObject ()))) {
        ...
        GGS_uint  var_cas_targetAddress ;
        if (var_cas_inRoutineSymbolTable.isBuilt ()) {
          var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_16509->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (416)) ;
        }
        ...
        const GGS_bool cond_16888 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
        if (cond_16888.isBuiltAndTrue ()) {
...
category_method__ipic18_instruction_computed_goto__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_17130 != NULL) {
    const GGS_bool cond_18089 = operand_17130->mUsesRCALL ;
    if (cond_18089.isBuiltAndTrue ()) {
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (437)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (437)) ;
      }
      ...
      const GGS_bool cond_18078 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_18078.isBuiltAndTrue ()) {
        ...
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic18_instruction_computed_goto ::constructor_new (inLexique, operand_17130->mInstructionLocation, operand_17130->mTargetLabels, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (442)) ;
...
category_method__ipic18_instruction_computed_rcall__checkRelativeBranch (C_Compiler & inLexique,
  ...
  if (operand_18355 != NULL) {
    const GGS_bool cond_19349 = operand_18355->mUsesRCALL ;
    if (cond_19349.isBuiltAndTrue ()) {
      GGS_uint  var_cas_targetAddress ;
      if (var_cas_inRoutineSymbolTable.isBuilt ()) {
        var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (467)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (467)) ;
      }
      ...
      const GGS_bool cond_19338 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
      if (cond_19338.isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true) ;
        var_cas_ioListFileContents.appendCString ("  line ") ;
        ...
        GGS_ipic_actualInstruction  var_cas_instruction = GGS_ipic18_instruction_computed_rcall ::constructor_new (inLexique, operand_18355->mInstructionLocation, operand_18355->mTargetLabels, operand_18355->mEndOfInstructionLabel, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (472)) ;
...
void routine_ipic18_convertRelativeBranchsToAbsoluteWhenNeeded (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("CONVERT RELATIVES").reader_stringByLeftAndRightPadding (GGS_uint (77U), GGS_char (TO_UNICODE (' ')))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (GGS_uint (79U), GGS_char (TO_UNICODE ('*')))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  GGS_bool var_cas_relativeBranchOverflow = GGS_bool (true) ;
  GGS_uint  var_cas_iteration = GGS_uint (0U) ;
  GGS_uint _variant_21871 = var_cas_ioGeneratedInstructionList.reader_length () ;
  GGS_bool _condition_21871 (_variant_21871.isBuilt (), true) ;
  while (_condition_21871.isBuiltAndTrue ()) {
    _condition_21871 = var_cas_relativeBranchOverflow ;
    if (_condition_21871.isBuiltAndTrue ()) {
      if (_variant_21871.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (531)) ;
        _condition_21871 = GGS_bool (false) ;
      }else{
        _variant_21871.decrement_operation (inLexique COMMA_HERE) ;
        ...
        var_cas_ioListFileContents.appendCString (":\n") ;
        GGS_ipic18_symbolTableForConvertingRelatives  var_cas_symbolTable = GGS_ipic18_symbolTableForConvertingRelatives ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (508)) ;
        GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_20732 = enumerator_20732.nextObject ()))) {
            ...
            { typeCategoryMethod__ipic18_instruction__defineLabelAtAddress method = findCategoryMethod__ipic18_instruction__defineLabelAtAddress (operand_20732->mInstruction.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_20732->mInstruction (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (511)) ;
              }
            }
          }
        }
        ...
        var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_21010 = enumerator_21010.nextObject ()))) {
            ...
            GGS_uint  var_cas_instructionLength ;
            if (operand_21010->mInstruction.isBuilt ()) {
              operand_21010->mInstruction (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (518)) ;
            }
            { typeCategoryMethod__ipic18_instruction__checkRelativeBranch method = findCategoryMethod__ipic18_instruction__checkRelativeBranch (operand_21010->mInstruction.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_21010->mInstruction (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_relativeBranchOverflow, var_cas_ioGeneratedInstructionList, var_cas_idx, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (519)) ;
              }
            }
        ...
        const GGS_bool cond_21659 = (var_cas_lastAddressForFirstPass).operator_isNotEqual (var_cas_currentAddress) ;
        ...
        const GGS_bool cond_21860 = (var_cas_relativeBranchOverflow).operator_not () ;
        if (cond_21860.isBuiltAndTrue ()) {
...
static void epilogueRoutineFor_ipc18_convert_relatives (void) {
  gDispatchTableForMethod__ipic18_instruction__defineLabelAtAddress.free () ;
  gDispatchTableForMethod__ipic18_instruction__checkRelativeBranch.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue prologueEpilogueObjectFor_ipc18_convert_relatives (prologueRoutineFor_ipc18_convert_relatives, epilogueRoutineFor_ipc18_convert_relatives) ;
