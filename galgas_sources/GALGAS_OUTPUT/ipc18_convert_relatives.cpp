...
const C_galgas_type_descriptor kTypeDescriptor_GGS_ipic18_symbolTableForConvertingRelatives ("ipic18_symbolTableForConvertingRelatives", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_ipic18_symbolTableForConvertingRelatives::typeDescriptor (void) const {
