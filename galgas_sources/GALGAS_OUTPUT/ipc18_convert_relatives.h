...
//--- Comparison methods
  public : GGS_bool _operator_isEqual (const GGS_ipic18_symbolTableForConvertingRelatives & inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_ipic18_symbolTableForConvertingRelatives & inOperand) const ;
