...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK INTER JUMP OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417)) ;
  ...
  GALGAS_uint var_n = function_blockDiscontinuityCount (ioArgument_ioBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (420)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  count before optimization: ").operator_concat (var_n.reader_string (SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (421)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (421)) ;
  const enumGalgasBool test_0 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->printMessage (GALGAS_string ("Block inter jump optimization... ") COMMA_SOURCE_FILE_AT_LINE (424)) ;
  }
  GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (427)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13599 (ioArgument_ioBlockList, kEnumeration_up) ;
  GALGAS_uint index_13593 ((PMUInt32) 0) ;
  while (enumerator_13599.hasCurrentObject ()) {
    {
    var_symbolTable.modifier_insertKey (enumerator_13599.current_mBlock (HERE).mAttribute_mLabel, index_13593, inCompiler COMMA_SOURCE_FILE_AT_LINE (429)) ;
    }
    enumerator_13599.gotoNextObject () ;
    index_13593.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (428)) ;
  }
  GALGAS_blockInvocationGraph var_g = GALGAS_blockInvocationGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (432)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13760 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_13760.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_13760.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (434)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      var_g.modifier_addNode (enumerator_13760.current_mBlock (HERE).mAttribute_mLabel, enumerator_13760.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) ;
      }
      callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_13760.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_13760.current_mBlock (HERE).mAttribute_mLabel, var_g, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
    }
    enumerator_13760.gotoNextObject () ;
  }
  GALGAS_lstringlist var_nodeList ;
  GALGAS_stringlist joker_14040_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14040_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (440)) ;
  GALGAS_stringlist var_newOrderedLabelList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (441)) ;
  GALGAS_stringset var_visitedNodeSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (442)) ;
  GALGAS_clusterList var_clusterList = GALGAS_clusterList::constructor_emptyList (SOURCE_FILE_AT_LINE (443)) ;
  cEnumerator_lstringlist enumerator_14219 (var_nodeList, kEnumeration_up) ;
  while (enumerator_14219.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14219.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (446)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (445)) ;
    cEnumerator_stringlist enumerator_14374 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (449)), kEnumeration_up) ;
    while (enumerator_14374.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14374.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (450)) ;
      enumerator_14374.gotoNextObject () ;
    }
    {
    var_gg.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (452)) ;
    }
    GALGAS_stringlist var_partialOrderedLabelList ;
    GALGAS_lstringlist joker_14571_3 ; // Joker input parameter
    GALGAS_stringlist joker_14571_2 ; // Joker input parameter
    GALGAS_lstringlist joker_14571_1 ; // Joker input parameter
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (453)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_14571_3, joker_14571_2, joker_14571_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (453)) ;
    var_newOrderedLabelList.dotAssign_operation (var_partialOrderedLabelList COMMA_SOURCE_FILE_AT_LINE (457)) ;
    GALGAS_ipic_31__38_BlockList var_cluster = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (458)) ;
    cEnumerator_stringlist enumerator_14715 (var_partialOrderedLabelList, kEnumeration_up) ;
    while (enumerator_14715.hasCurrentObject ()) {
      GALGAS_uint var_blockIndex ;
      var_symbolTable.method_searchKey (enumerator_14715.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (460)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
      GALGAS_ipic_31__38_Block var_b = ioArgument_ioBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
      var_cluster.addAssign_operation (var_b COMMA_SOURCE_FILE_AT_LINE (462)) ;
      enumerator_14715.gotoNextObject () ;
    }
    var_clusterList.addAssign_operation (var_cluster COMMA_SOURCE_FILE_AT_LINE (464)) ;
    enumerator_14219.gotoNextObject () ;
  }
  GALGAS_ipic_31__38_BlockList var_orderedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (467)) ;
  GALGAS_bool var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_15137 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_2 = var_continue.isValidAndTrue () ;
  if (enumerator_15137.hasCurrentObject () && bool_2) {
    while (enumerator_15137.hasCurrentObject () && bool_2) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_15137.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (471)))) ;
      const enumGalgasBool test_3 = var_continue.boolEnum () ;
      if (kBoolTrue == test_3) {
        var_orderedBlockList.addAssign_operation (enumerator_15137.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (473)) ;
      }
      enumerator_15137.gotoNextObject () ;
      if (enumerator_15137.hasCurrentObject ()) {
        bool_2 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_stringlist enumerator_15351 (var_newOrderedLabelList, kEnumeration_up) ;
  while (enumerator_15351.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_15351.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (478)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (478)) ;
    GALGAS_ipic_31__38_Block var_b = ioArgument_ioBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (479)) ;
    var_orderedBlockList.addAssign_operation (var_b COMMA_SOURCE_FILE_AT_LINE (480)) ;
    enumerator_15351.gotoNextObject () ;
  }
  GALGAS_uint var_insertionIndex = var_orderedBlockList.reader_length (SOURCE_FILE_AT_LINE (483)) ;
  var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_15695 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_4 = var_continue.isValidAndTrue () ;
  if (enumerator_15695.hasCurrentObject () && bool_4) {
    while (enumerator_15695.hasCurrentObject () && bool_4) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_15695.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (486)))) ;
      const enumGalgasBool test_5 = var_continue.boolEnum () ;
      if (kBoolTrue == test_5) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_15695.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (488)) ;
        }
      }
      enumerator_15695.gotoNextObject () ;
      if (enumerator_15695.hasCurrentObject ()) {
        bool_4 = var_continue.isValidAndTrue () ;
      }
    }
  }
  GALGAS_uint var_p = function_blockDiscontinuityCount (var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (492)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  count after optimization: ").operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (493)) COMMA_SOURCE_FILE_AT_LINE (493)).operator_concat (GALGAS_string ("\n"
  ...
  if (kBoolTrue == test_6) {
    inCompiler->printMessage (var_n.reader_string (SOURCE_FILE_AT_LINE (495)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (495)).operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (495)) COMMA_SOURCE_FILE_AT_LINE (495)).operator_concat (GALGAS_string (".\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (495)) COMMA_SOURCE_FILE_AT_LINE (495)) ;
  }
  GALGAS_bool joker_16278_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (498)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (498)), joker_16278_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
  {
  var_g.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (499)) ;
  }
  GALGAS_bool joker_16425_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (500)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraintsWoCycle.dot") COMMA_SOURCE_FILE_AT_LINE (500)), joker_16425_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
  GALGAS_stringset var_newSymbolSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (502)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_16546 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_16546.hasCurrentObject ()) {
    const enumGalgasBool test_7 = var_newSymbolSet.reader_hasKey (enumerator_16546.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (505)).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16546.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (507)) COMMA_SOURCE_FILE_AT_LINE (507)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (507)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (509)), var_s COMMA_SOURCE_FILE_AT_LINE (509)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_16546.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (513)) ;
    }
    enumerator_16546.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_16937 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_16937.hasCurrentObject ()) {
    const enumGalgasBool test_8 = var_newSymbolSet.reader_hasKey (enumerator_16937.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (517)).operator_not (SOURCE_FILE_AT_LINE (517)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16937.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (519)) COMMA_SOURCE_FILE_AT_LINE (519)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (519)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (521)), var_s COMMA_SOURCE_FILE_AT_LINE (521)) ;
      ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
  ...
  if (kBoolTrue == test_9) {
    ...
    {
    routine_displayBlockList (GALGAS_string ("ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (529)) ;
    }
    ...
    {
    routine_displayBlockList (GALGAS_string ("INCONSISTENT ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION (not used)"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (534)) ;
    }
  }
  const enumGalgasBool test_10 = var_ok.boolEnum () ;
  if (kBoolTrue == test_10) {
    {
    routine_perform_5F_cluster_5F_ordering (var_clusterList, ioArgument_ioBlockList, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (538)) ;
    }
  }
}
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18225 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_18225.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18225.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (554)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_18341 (enumerator_18225.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
      while (enumerator_18341.hasCurrentObject ()) {
        callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_18341.current_mInstruction (HERE).ptr (), enumerator_18225.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) ;
        enumerator_18341.gotoNextObject () ;
      }
      callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18225.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_18225.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
    }
    enumerator_18225.gotoNextObject () ;
  }
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18853 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_18847 ((PMUInt32) 0) ;
  while (enumerator_18853.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18853.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (572)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_18847.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (574)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_18847.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (575)), inCompiler COMMA_SOURCE_FILE_AT_LINE (575)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18853.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (579)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (580)) ;
      }
    }
    enumerator_18853.gotoNextObject () ;
    index_18847.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  {
  routine_buildInvocationGraph (ioArgument_ioGeneratedBlockList, var_invocationGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (594)) ;
  }
  GALGAS_bool joker_19725_0 ; // Joker input parameter
  var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (595)), joker_19725_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (595)) ;
  {
  routine_buildOrderedGraph (ioArgument_ioGeneratedBlockList, constinArgument_inSourceFileName, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
  }
}
...
static void categoryMethod_ipic_31__38_JumpTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  macroValidSharedObject (object, const cPtr_ipic_31__38_JumpTerminator) ;
  {
  ioArgument_ioGraph.modifier_addEdge (constinArgument_inBlockLabel, object->mAttribute_mLabel COMMA_SOURCE_FILE_AT_LINE (336)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  macroValidSharedObject (object, const cPtr_ipic_31__38_ConditionalJumpTerminator) ;
  {
  ioArgument_ioGraph.modifier_addEdge (constinArgument_inBlockLabel, object->mAttribute_mTargetLabelWhenTrue COMMA_SOURCE_FILE_AT_LINE (345)) ;
  }
  {
  ioArgument_ioGraph.modifier_addEdge (constinArgument_inBlockLabel, object->mAttribute_mTargetLabelWhenFalse COMMA_SOURCE_FILE_AT_LINE (346)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_RegisterComparisonTerminator * object = (const cPtr_pic_31__38_RegisterComparisonTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_RegisterComparisonTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_TestRegisterTerminator * object = (const cPtr_pic_31__38_TestRegisterTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_TestRegisterTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (367)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_IncDecRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (379)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (383)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_BitTestTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (395)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (399)) ;
}
//---------------------------------------------------------------------------*
