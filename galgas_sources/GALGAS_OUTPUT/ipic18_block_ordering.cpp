...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  while (enumerator_13795.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_13795.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (435)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
  ...
  GALGAS_stringlist joker_14070_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14070_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (441)) ;
  ...
  cEnumerator_lstringlist enumerator_14249 (var_nodeList, kEnumeration_up) ;
  while (enumerator_14249.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14249.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (447)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (446)) ;
    cEnumerator_stringlist enumerator_14404 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (450)), kEnumeration_up) ;
    while (enumerator_14404.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14404.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (451)) ;
    ...
    GALGAS_lstringlist joker_14601_3 ; // Joker input parameter
    GALGAS_stringlist joker_14601_2 ; // Joker input parameter
    GALGAS_lstringlist joker_14601_1 ; // Joker input parameter
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (454)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_14601_3, joker_14601_2, joker_14601_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) ;
    ...
    cEnumerator_stringlist enumerator_14745 (var_partialOrderedLabelList, kEnumeration_up) ;
    while (enumerator_14745.hasCurrentObject ()) {
      GALGAS_uint var_blockIndex ;
      var_symbolTable.method_searchKey (enumerator_14745.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (461)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_15075 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_15075.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_15075.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (469)))).operator_and (var_visitedNodeSet.reader_hasKey (enumerator_15075.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (470)).operator_not (SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_15075.current_mBlock (HERE).mAttribute_mLabel COMMA_SOURCE_FILE_AT_LINE (472)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
      cEnumerator_stringlist enumerator_15378 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (475)), kEnumeration_up) ;
      while (enumerator_15378.hasCurrentObject ()) {
        var_visitedNodeSet.addAssign_operation (enumerator_15378.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (476)) ;
        enumerator_15378.gotoNextObject () ;
      }
      {
      var_gg.modifier_removeEdgesToNode (enumerator_15075.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (478)) ;
      }
      {
      var_gg.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (479)) ;
      }
      GALGAS_stringlist var_partialOrderedLabelList ;
      GALGAS_lstringlist joker_15640_3 ; // Joker input parameter
      GALGAS_stringlist joker_15640_2 ; // Joker input parameter
      GALGAS_lstringlist joker_15640_1 ; // Joker input parameter
      var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (480)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_15640_3, joker_15640_2, joker_15640_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
      ...
      cEnumerator_stringlist enumerator_15792 (var_partialOrderedLabelList, kEnumeration_up) ;
      while (enumerator_15792.hasCurrentObject ()) {
        GALGAS_uint var_blockIndex ;
        var_symbolTable.method_searchKey (enumerator_15792.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (487)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
        ...
        enumerator_15792.gotoNextObject () ;
      }
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_16237 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_3 = var_continue.isValidAndTrue () ;
  if (enumerator_16237.hasCurrentObject () && bool_3) {
    while (enumerator_16237.hasCurrentObject () && bool_3) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16237.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (499)))) ;
      const enumGalgasBool test_4 = var_continue.boolEnum () ;
      if (kBoolTrue == test_4) {
        var_orderedBlockList.addAssign_operation (enumerator_16237.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (501)) ;
      }
      enumerator_16237.gotoNextObject () ;
      if (enumerator_16237.hasCurrentObject ()) {
        bool_3 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_stringlist enumerator_16446 (var_newOrderedLabelList, kEnumeration_up) ;
  while (enumerator_16446.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_16446.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (506)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_16786 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_5 = var_continue.isValidAndTrue () ;
  if (enumerator_16786.hasCurrentObject () && bool_5) {
    while (enumerator_16786.hasCurrentObject () && bool_5) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16786.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (514)))) ;
      const enumGalgasBool test_6 = var_continue.boolEnum () ;
      if (kBoolTrue == test_6) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_16786.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
        }
      }
      enumerator_16786.gotoNextObject () ;
      if (enumerator_16786.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_8) {
    GALGAS_bool joker_17429_0 ; // Joker input parameter
    var_g.reader_graphviz (SOURCE_FILE_AT_LINE (527)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (527)), joker_17429_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (527)) ;
  }
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_17561 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_17561.hasCurrentObject ()) {
    const enumGalgasBool test_9 = var_newSymbolSet.reader_hasKey (enumerator_17561.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (533)).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17561.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (535)) COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (535)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_17561.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (541)) ;
    }
    enumerator_17561.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_17952 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_17952.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_newSymbolSet.reader_hasKey (enumerator_17952.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (545)).operator_not (SOURCE_FILE_AT_LINE (545)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17952.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (547)) COMMA_SOURCE_FILE_AT_LINE (547)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (547)) ;
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19240 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_19240.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_19240.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (582)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_19351 (enumerator_19240.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
      while (enumerator_19351.hasCurrentObject ()) {
        callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_19351.current_mInstruction (HERE).ptr (), enumerator_19240.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
        enumerator_19351.gotoNextObject () ;
      }
      callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19240.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_19240.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (586)) ;
    }
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19863 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_19857 ((PMUInt32) 0) ;
  while (enumerator_19863.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_19863.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (600)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_19857.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (602)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (602)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_19857.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (603)), inCompiler COMMA_SOURCE_FILE_AT_LINE (603)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19863.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (608)) ;
      }
    }
    enumerator_19863.gotoNextObject () ;
    index_19857.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    routine_buildInvocationGraph (ioArgument_ioGeneratedBlockList, var_invocationGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (622)) ;
    }
    GALGAS_bool joker_20792_0 ; // Joker input parameter
    var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (623)), joker_20792_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (623)) ;
  }
  GALGAS_bool var_optimize = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (66)) COMMA_SOURCE_FILE_AT_LINE (627)) COMMA_SOURCE_FILE_AT_LINE (627)) ;
  const enumGalgasBool test_1 = var_optimize.boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    routine_buildOrderedGraph (ioArgument_ioGeneratedBlockList, constinArgument_inSourceFileName, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (629)) ;
    }
  }
}
