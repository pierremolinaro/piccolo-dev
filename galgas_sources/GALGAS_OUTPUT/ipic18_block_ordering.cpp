...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (417)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK ORDERING OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (419)).operator_concat (GALGAS_string ("\n"
  ...
  while (enumerator_13872.hasCurrentObject ()) {
    {
    var_symbolTable.modifier_insertKey (enumerator_13872.current_mBlock (HERE).mAttribute_mLabel, index_13860, inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
    }
    enumerator_13872.gotoNextObject () ;
    index_13860.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (429)) ;
  }
  ...
  while (enumerator_14036.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_14036.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (435)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      var_g.modifier_addNode (enumerator_14036.current_mBlock (HERE).mAttribute_mLabel, enumerator_14036.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
      }
      callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_14036.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_14036.current_mBlock (HERE).mAttribute_mLabel, var_g, inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) ;
    }
    enumerator_14036.gotoNextObject () ;
  }
  GALGAS_lstringlist var_nodeList ;
  GALGAS_stringlist joker_14313_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14313_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (441)) ;
  ...
  while (enumerator_14490.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14490.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (447)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (446)) ;
    cEnumerator_stringlist enumerator_14645 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (450)), kEnumeration_up) ;
    while (enumerator_14645.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14645.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (451)) ;
    ...
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (454)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_14844_3, joker_14844_2, joker_14844_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) ;
    ...
    while (enumerator_14986.hasCurrentObject ()) {
      ...
      var_symbolTable.method_searchKey (enumerator_14986.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (461)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
  ...
  while (enumerator_15316.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_15316.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (469)))).operator_and (var_visitedNodeSet.reader_hasKey (enumerator_15316.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (470)).operator_not (SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (469)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_15316.current_mBlock (HERE).mAttribute_mLabel COMMA_SOURCE_FILE_AT_LINE (472)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
      cEnumerator_stringlist enumerator_15619 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (475)), kEnumeration_up) ;
      while (enumerator_15619.hasCurrentObject ()) {
        var_visitedNodeSet.addAssign_operation (enumerator_15619.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (476)) ;
        enumerator_15619.gotoNextObject () ;
      }
      {
      var_gg.modifier_removeEdgesToNode (enumerator_15316.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (478)) ;
      }
      {
      ...
      var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (480)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_15883_3, joker_15883_2, joker_15883_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
      ...
      while (enumerator_16033.hasCurrentObject ()) {
        GALGAS_uint var_blockIndex ;
        var_symbolTable.method_searchKey (enumerator_16033.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (487)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
  ...
  if (enumerator_16475.hasCurrentObject () && bool_3) {
    while (enumerator_16475.hasCurrentObject () && bool_3) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16475.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (499)))) ;
      const enumGalgasBool test_4 = var_continue.boolEnum () ;
      if (kBoolTrue == test_4) {
        var_orderedBlockList.addAssign_operation (enumerator_16475.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (501)) ;
      }
  ...
  while (enumerator_16687.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_16687.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (506)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
  ...
  if (enumerator_17024.hasCurrentObject () && bool_5) {
    while (enumerator_17024.hasCurrentObject () && bool_5) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_17024.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (514)))) ;
      const enumGalgasBool test_6 = var_continue.boolEnum () ;
      if (kBoolTrue == test_6) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_17024.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
        }
      }
  ...
  if (kBoolTrue == test_8) {
    ...
    var_g.reader_graphviz (SOURCE_FILE_AT_LINE (527)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (527)), joker_17672_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (527)) ;
  }
  ...
  while (enumerator_17802.hasCurrentObject ()) {
    const enumGalgasBool test_9 = var_newSymbolSet.reader_hasKey (enumerator_17802.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (533)).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17802.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (534)) COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (535)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_17802.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (541)) ;
    }
  ...
  while (enumerator_18193.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_newSymbolSet.reader_hasKey (enumerator_18193.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (545)).operator_not (SOURCE_FILE_AT_LINE (545)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_18193.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (546)) COMMA_SOURCE_FILE_AT_LINE (546)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (547)) ;
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  while (enumerator_19531.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_19531.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (583)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      outArgument_outGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (enumerator_19531.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (GALGAS_string ("\" [shape=rectangle]\n") COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)) ;
    }
    ...
    while (enumerator_19724.hasCurrentObject ()) {
      callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_19724.current_mInstruction (HERE).ptr (), enumerator_19531.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (587)) ;
      enumerator_19724.gotoNextObject () ;
    }
    callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19531.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_19531.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (589)) ;
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  while (enumerator_20208.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_20208.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (602)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_20196.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (604)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_20196.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_20208.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (609)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (610)) ;
      }
    }
    enumerator_20208.gotoNextObject () ;
    index_20196.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (625)), joker_21142_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (625)) ;
  }
