...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  GALGAS_uint index_20214 ((uint32_t) 0) ;
  while (enumerator_20226.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_20214.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (604)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_20214.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)).mAttribute_mLabel.mAttribute_string ;
