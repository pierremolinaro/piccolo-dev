...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_13628 (ioArgument_ioBlockList, kEnumeration_up) ;
  GALGAS_uint index_13616 ((PMUInt32) 0) ;
  while (enumerator_13628.hasCurrentObject ()) {
    {
    var_symbolTable.modifier_insertKey (enumerator_13628.current_mBlock (HERE).mAttribute_mLabel, index_13616, inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
    }
    enumerator_13628.gotoNextObject () ;
    index_13616.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (429)) ;
  }
  GALGAS_blockInvocationGraph var_g = GALGAS_blockInvocationGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (433)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13792 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_13792.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_13792.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (435)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      var_g.modifier_addNode (enumerator_13792.current_mBlock (HERE).mAttribute_mLabel, enumerator_13792.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
      }
      callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_13792.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_13792.current_mBlock (HERE).mAttribute_mLabel, var_g, inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) ;
    }
    enumerator_13792.gotoNextObject () ;
  }
  GALGAS_lstringlist var_nodeList ;
  GALGAS_stringlist joker_14069_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14069_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (441)) ;
  ...
  cEnumerator_lstringlist enumerator_14246 (var_nodeList, kEnumeration_up) ;
  while (enumerator_14246.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14246.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (447)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (446)) ;
    cEnumerator_stringlist enumerator_14401 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (450)), kEnumeration_up) ;
    while (enumerator_14401.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14401.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (451)) ;
    ...
    GALGAS_lstringlist joker_14600_3 ; // Joker input parameter
    GALGAS_stringlist joker_14600_2 ; // Joker input parameter
    GALGAS_lstringlist joker_14600_1 ; // Joker input parameter
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (454)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_14600_3, joker_14600_2, joker_14600_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) ;
    ...
    cEnumerator_stringlist enumerator_14742 (var_partialOrderedLabelList, kEnumeration_up) ;
    while (enumerator_14742.hasCurrentObject ()) {
      GALGAS_uint var_blockIndex ;
      var_symbolTable.method_searchKey (enumerator_14742.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (461)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_15072 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_15072.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_15072.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (469)))).operator_and (var_visitedNodeSet.reader_hasKey (enumerator_15072.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (470)).operator_not (SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (469)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_15072.current_mBlock (HERE).mAttribute_mLabel COMMA_SOURCE_FILE_AT_LINE (472)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
      cEnumerator_stringlist enumerator_15375 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (475)), kEnumeration_up) ;
      while (enumerator_15375.hasCurrentObject ()) {
        var_visitedNodeSet.addAssign_operation (enumerator_15375.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (476)) ;
        enumerator_15375.gotoNextObject () ;
      }
      {
      var_gg.modifier_removeEdgesToNode (enumerator_15072.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (478)) ;
      }
      {
      var_gg.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (479)) ;
      }
      GALGAS_stringlist var_partialOrderedLabelList ;
      GALGAS_lstringlist joker_15639_3 ; // Joker input parameter
      GALGAS_stringlist joker_15639_2 ; // Joker input parameter
      GALGAS_lstringlist joker_15639_1 ; // Joker input parameter
      var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (480)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_15639_3, joker_15639_2, joker_15639_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
      ...
      cEnumerator_stringlist enumerator_15789 (var_partialOrderedLabelList, kEnumeration_up) ;
      while (enumerator_15789.hasCurrentObject ()) {
        GALGAS_uint var_blockIndex ;
        var_symbolTable.method_searchKey (enumerator_15789.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (487)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_16231 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_3 = var_continue.isValidAndTrue () ;
  if (enumerator_16231.hasCurrentObject () && bool_3) {
    while (enumerator_16231.hasCurrentObject () && bool_3) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16231.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (499)))) ;
      const enumGalgasBool test_4 = var_continue.boolEnum () ;
      if (kBoolTrue == test_4) {
        var_orderedBlockList.addAssign_operation (enumerator_16231.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (501)) ;
      }
      enumerator_16231.gotoNextObject () ;
      if (enumerator_16231.hasCurrentObject ()) {
        bool_3 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_stringlist enumerator_16443 (var_newOrderedLabelList, kEnumeration_up) ;
  while (enumerator_16443.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_16443.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (506)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_16780 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_5 = var_continue.isValidAndTrue () ;
  if (enumerator_16780.hasCurrentObject () && bool_5) {
    while (enumerator_16780.hasCurrentObject () && bool_5) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16780.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (514)))) ;
      const enumGalgasBool test_6 = var_continue.boolEnum () ;
      if (kBoolTrue == test_6) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_16780.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
        }
      }
      enumerator_16780.gotoNextObject () ;
      if (enumerator_16780.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_8) {
    GALGAS_bool joker_17428_0 ; // Joker input parameter
    var_g.reader_graphviz (SOURCE_FILE_AT_LINE (527)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (527)), joker_17428_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (527)) ;
  }
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_17558 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_17558.hasCurrentObject ()) {
    const enumGalgasBool test_9 = var_newSymbolSet.reader_hasKey (enumerator_17558.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (533)).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17558.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (534)) COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (535)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_17558.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (541)) ;
    }
    enumerator_17558.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_17949 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_17949.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_newSymbolSet.reader_hasKey (enumerator_17949.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (545)).operator_not (SOURCE_FILE_AT_LINE (545)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17949.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (546)) COMMA_SOURCE_FILE_AT_LINE (546)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (547)) ;
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19237 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_19237.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_19237.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (582)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_19348 (enumerator_19237.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
      while (enumerator_19348.hasCurrentObject ()) {
        callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_19348.current_mInstruction (HERE).ptr (), enumerator_19237.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
        enumerator_19348.gotoNextObject () ;
      }
      callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19237.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_19237.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (586)) ;
    }
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19857 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_19845 ((PMUInt32) 0) ;
  while (enumerator_19857.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_19857.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (600)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_19845.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (602)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (602)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_19845.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (603)), inCompiler COMMA_SOURCE_FILE_AT_LINE (603)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19857.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (608)) ;
      }
    }
    enumerator_19857.gotoNextObject () ;
    index_19845.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_20791_0 ; // Joker input parameter
    var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (623)), joker_20791_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (623)) ;
  }
  GALGAS_bool var_optimize = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (66)) COMMA_SOURCE_FILE_AT_LINE (627)) COMMA_SOURCE_FILE_AT_LINE (626)) ;
