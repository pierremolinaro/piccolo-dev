...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (422)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK INTER JUMP OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (424)).operator_concat (GALGAS_string ("\n"
  ...
  GALGAS_uint var_n = function_blockDiscontinuityCount (ioArgument_ioBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (426)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  count before optimization: ").operator_concat (var_n.reader_string (SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427)) ;
  const enumGalgasBool test_0 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->printMessage (GALGAS_string ("Block inter jump optimization... ") COMMA_SOURCE_FILE_AT_LINE (430)) ;
  }
  GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (433)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13814 (ioArgument_ioBlockList, kEnumeration_up) ;
  GALGAS_uint index_13808 ((PMUInt32) 0) ;
  while (enumerator_13814.hasCurrentObject ()) {
    {
    var_symbolTable.modifier_insertKey (enumerator_13814.current_mBlock (HERE).mAttribute_mLabel, index_13808, inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) ;
    }
    enumerator_13814.gotoNextObject () ;
    index_13808.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (434)) ;
  }
  GALGAS_blockInvocationGraph var_g = GALGAS_blockInvocationGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (438)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13975 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_13975.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_13975.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (440)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      var_g.modifier_addNode (enumerator_13975.current_mBlock (HERE).mAttribute_mLabel, enumerator_13975.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (441)) ;
      }
      callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_13975.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_13975.current_mBlock (HERE).mAttribute_mLabel, var_g, inCompiler COMMA_SOURCE_FILE_AT_LINE (442)) ;
    }
    enumerator_13975.gotoNextObject () ;
  }
  GALGAS_lstringlist var_nodeList ;
  GALGAS_stringlist joker_14255_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14255_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (446)) ;
  GALGAS_stringlist var_newOrderedLabelList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (447)) ;
  GALGAS_stringset var_visitedNodeSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (448)) ;
  GALGAS_clusterList var_clusterList = GALGAS_clusterList::constructor_emptyList (SOURCE_FILE_AT_LINE (449)) ;
  cEnumerator_lstringlist enumerator_14434 (var_nodeList, kEnumeration_up) ;
  while (enumerator_14434.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14434.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (452)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (451)) ;
    cEnumerator_stringlist enumerator_14589 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (455)), kEnumeration_up) ;
    while (enumerator_14589.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14589.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (456)) ;
      enumerator_14589.gotoNextObject () ;
    }
    {
    var_gg.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (458)) ;
    }
    GALGAS_stringlist var_partialOrderedLabelList ;
    GALGAS_lstringlist joker_14786_3 ; // Joker input parameter
    GALGAS_stringlist joker_14786_2 ; // Joker input parameter
    GALGAS_lstringlist joker_14786_1 ; // Joker input parameter
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (459)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_14786_3, joker_14786_2, joker_14786_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (459)) ;
    var_newOrderedLabelList.dotAssign_operation (var_partialOrderedLabelList COMMA_SOURCE_FILE_AT_LINE (463)) ;
    GALGAS_ipic_31__38_BlockList var_cluster = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (464)) ;
    cEnumerator_stringlist enumerator_14930 (var_partialOrderedLabelList, kEnumeration_up) ;
    while (enumerator_14930.hasCurrentObject ()) {
      GALGAS_uint var_blockIndex ;
      var_symbolTable.method_searchKey (enumerator_14930.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (466)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
      GALGAS_ipic_31__38_Block var_b = ioArgument_ioBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
      var_cluster.addAssign_operation (var_b COMMA_SOURCE_FILE_AT_LINE (468)) ;
      enumerator_14930.gotoNextObject () ;
    }
    var_clusterList.addAssign_operation (var_cluster COMMA_SOURCE_FILE_AT_LINE (470)) ;
    enumerator_14434.gotoNextObject () ;
  }
  GALGAS_ipic_31__38_BlockList var_orderedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (478)) ;
  GALGAS_bool var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_15474 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_2 = var_continue.isValidAndTrue () ;
  if (enumerator_15474.hasCurrentObject () && bool_2) {
    while (enumerator_15474.hasCurrentObject () && bool_2) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_15474.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (482)))) ;
      const enumGalgasBool test_3 = var_continue.boolEnum () ;
      if (kBoolTrue == test_3) {
        var_orderedBlockList.addAssign_operation (enumerator_15474.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (484)) ;
      }
      enumerator_15474.gotoNextObject () ;
      if (enumerator_15474.hasCurrentObject ()) {
        bool_2 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_stringlist enumerator_15688 (var_newOrderedLabelList, kEnumeration_up) ;
  while (enumerator_15688.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_15688.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (489)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
    GALGAS_ipic_31__38_Block var_b = ioArgument_ioBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (490)) ;
    var_orderedBlockList.addAssign_operation (var_b COMMA_SOURCE_FILE_AT_LINE (491)) ;
    enumerator_15688.gotoNextObject () ;
  }
  GALGAS_uint var_insertionIndex = var_orderedBlockList.reader_length (SOURCE_FILE_AT_LINE (494)) ;
  var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_16032 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_4 = var_continue.isValidAndTrue () ;
  if (enumerator_16032.hasCurrentObject () && bool_4) {
    while (enumerator_16032.hasCurrentObject () && bool_4) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16032.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (497)))) ;
      const enumGalgasBool test_5 = var_continue.boolEnum () ;
      if (kBoolTrue == test_5) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_16032.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
        }
      }
      enumerator_16032.gotoNextObject () ;
      if (enumerator_16032.hasCurrentObject ()) {
        bool_4 = var_continue.isValidAndTrue () ;
      }
    }
  }
  GALGAS_uint var_p = function_blockDiscontinuityCount (var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  count after optimization: ").operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (504)) COMMA_SOURCE_FILE_AT_LINE (504)).operator_concat (GALGAS_string ("\n"
  ...
  if (kBoolTrue == test_6) {
    inCompiler->printMessage (var_n.reader_string (SOURCE_FILE_AT_LINE (506)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (506)).operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (506)) COMMA_SOURCE_FILE_AT_LINE (506)).operator_concat (GALGAS_string (".\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (506)) COMMA_SOURCE_FILE_AT_LINE (506)) ;
  }
  GALGAS_bool joker_16615_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (509)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (509)), joker_16615_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (509)) ;
  {
  var_g.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (510)) ;
  }
  GALGAS_bool joker_16762_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (511)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraintsWoCycle.dot") COMMA_SOURCE_FILE_AT_LINE (511)), joker_16762_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (511)) ;
  GALGAS_stringset var_newSymbolSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (513)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_16883 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_16883.hasCurrentObject ()) {
    const enumGalgasBool test_7 = var_newSymbolSet.reader_hasKey (enumerator_16883.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (516)).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16883.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (518)) COMMA_SOURCE_FILE_AT_LINE (518)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (518)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (520)), var_s COMMA_SOURCE_FILE_AT_LINE (520)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_16883.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (524)) ;
    }
    enumerator_16883.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_17274 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_17274.hasCurrentObject ()) {
    const enumGalgasBool test_8 = var_newSymbolSet.reader_hasKey (enumerator_17274.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (528)).operator_not (SOURCE_FILE_AT_LINE (528)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17274.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (530)) COMMA_SOURCE_FILE_AT_LINE (530)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (530)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (532)), var_s COMMA_SOURCE_FILE_AT_LINE (532)) ;
      ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
  ...
  const enumGalgasBool test_9 = var_ok.boolEnum () ;
  if (kBoolTrue == test_9) {
    ioArgument_ioBlockList = var_orderedBlockList ;
    {
    routine_displayBlockList (GALGAS_string ("ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (540)) ;
    }
    ...
    inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (543)), var_s COMMA_SOURCE_FILE_AT_LINE (543)) ;
    ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (544)) COMMA_SOURCE_FILE_AT_LINE (544)) ;
    {
    routine_displayBlockList (GALGAS_string ("INCONSISTENT ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION (not used)"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (545)) ;
    }
  }
  const enumGalgasBool test_10 = var_ok.boolEnum () ;
  if (kBoolTrue == test_10) {
    {
    routine_perform_5F_cluster_5F_ordering (var_clusterList, ioArgument_ioBlockList, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (549)) ;
    }
  }
}
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18562 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_18562.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18562.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (565)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_18678 (enumerator_18562.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
      while (enumerator_18678.hasCurrentObject ()) {
        callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_18678.current_mInstruction (HERE).ptr (), enumerator_18562.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
        enumerator_18678.gotoNextObject () ;
      }
      callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18562.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_18562.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (569)) ;
    }
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19190 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_19184 ((PMUInt32) 0) ;
  while (enumerator_19190.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_19190.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (583)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_19184.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (585)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (585)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_19184.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (586)), inCompiler COMMA_SOURCE_FILE_AT_LINE (586)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19190.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
      }
    }
    enumerator_19190.gotoNextObject () ;
    index_19184.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (582)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  {
  routine_buildInvocationGraph (ioArgument_ioGeneratedBlockList, var_invocationGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (605)) ;
  }
  GALGAS_bool joker_20062_0 ; // Joker input parameter
  var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (606)), joker_20062_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (606)) ;
  {
  routine_buildOrderedGraph (ioArgument_ioGeneratedBlockList, constinArgument_inSourceFileName, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (608)) ;
  }
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_buildInstructionInvocationGraph (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (44)) COMMA_SOURCE_FILE_AT_LINE (44)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_4\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (44)) COMMA_SOURCE_FILE_AT_LINE (44)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_1560 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_1560.hasCurrentObject ()) {
    callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_1560.current_mInstruction (HERE).ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (46)) ;
...
static void categoryMethod_ipic_31__38__5F_condition_5F_skip_5F_instruction_buildInstructionInvocationGraph (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (59)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                              ...
                                                                                              C_Compiler * /* inCompiler */
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_4\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedRETLWTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                               ...
                                                                                               C_Compiler * /* inCompiler */
                                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_2\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                             ...
                                                                                             C_Compiler * /* inCompiler */
                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (131)) COMMA_SOURCE_FILE_AT_LINE (131)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_2\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (131)) COMMA_SOURCE_FILE_AT_LINE (131)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (142)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (163)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (164)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_JumpTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)).operator_concat (GALGAS_string ("\" -> \"") COMMA_SOURCE_FILE_AT_LINE (174)).operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) ;
  const enumGalgasBool test_0 = constinArgument_inDottedArrow.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" [style=dotted]") COMMA_SOURCE_FILE_AT_LINE (176)) ;
  }
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188)).operator_concat (GALGAS_string ("\" -> \"") COMMA_SOURCE_FILE_AT_LINE (188)).operator_concat (object->mAttribute_mTargetLabelWhenTrue.reader_string (SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188)) ;
  const enumGalgasBool test_0 = constinArgument_inDottedArrow.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" [style=dotted]") COMMA_SOURCE_FILE_AT_LINE (190)) ;
  }
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (192)) ;
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string ("\" -> \"") COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (object->mAttribute_mTargetLabelWhenFalse.reader_string (SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)) ;
  const enumGalgasBool test_1 = constinArgument_inDottedArrow.boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" [style=dotted]") COMMA_SOURCE_FILE_AT_LINE (195)) ;
  }
...
static GALGAS_bool categoryReader_ipic_31__38_AbstractConditionTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_AbstractConditionTerminator * object = (const cPtr_ipic_31__38_AbstractConditionTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38_AbstractConditionTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (290)).operator_and (callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)) COMMA_SOURCE_FILE_AT_LINE (291)) ;
//---
  return result_outResult ;
}
...
static GALGAS_bool categoryReader_pic_31__38_RegisterComparisonTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_RegisterComparisonTerminator * object = (const cPtr_pic_31__38_RegisterComparisonTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_RegisterComparisonTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (303)) ;
//---
  return result_outResult ;
}
...
static GALGAS_bool categoryReader_pic_31__38_TestRegisterTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_TestRegisterTerminator * object = (const cPtr_pic_31__38_TestRegisterTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_TestRegisterTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (314)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_0) {
    {
    ioArgument_ioGraph.modifier_addEdge (constinArgument_inBlockLabel, object->mAttribute_mTargetLabelWhenTrue COMMA_SOURCE_FILE_AT_LINE (348)) ;
    }
  }
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioGraph.modifier_addEdge (constinArgument_inBlockLabel, object->mAttribute_mTargetLabelWhenFalse COMMA_SOURCE_FILE_AT_LINE (351)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_RegisterComparisonTerminator * object = (const cPtr_pic_31__38_RegisterComparisonTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_RegisterComparisonTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (361)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_TestRegisterTerminator * object = (const cPtr_pic_31__38_TestRegisterTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_TestRegisterTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_IncDecRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (389)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_BitTestTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (401)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (405)) ;
}
//---------------------------------------------------------------------------*
