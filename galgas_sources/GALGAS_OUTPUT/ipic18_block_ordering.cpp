...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_13878 (ioArgument_ioBlockList, kEnumeration_up) ;
  GALGAS_uint index_13866 ((PMUInt32) 0) ;
  while (enumerator_13878.hasCurrentObject ()) {
    {
    var_symbolTable.modifier_insertKey (enumerator_13878.current_mBlock (HERE).mAttribute_mLabel, index_13866, inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
    }
    enumerator_13878.gotoNextObject () ;
    index_13866.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (429)) ;
  }
  GALGAS_blockInvocationGraph var_g = GALGAS_blockInvocationGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (433)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_14042 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_14042.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_14042.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (435)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      var_g.modifier_addNode (enumerator_14042.current_mBlock (HERE).mAttribute_mLabel, enumerator_14042.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
      }
      callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_14042.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_14042.current_mBlock (HERE).mAttribute_mLabel, var_g, inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) ;
    }
    enumerator_14042.gotoNextObject () ;
  }
  GALGAS_lstringlist var_nodeList ;
  GALGAS_stringlist joker_14319_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14319_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (441)) ;
  ...
  cEnumerator_lstringlist enumerator_14496 (var_nodeList, kEnumeration_up) ;
  while (enumerator_14496.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14496.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (447)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (446)) ;
    cEnumerator_stringlist enumerator_14651 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (450)), kEnumeration_up) ;
    while (enumerator_14651.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14651.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (451)) ;
    ...
    GALGAS_lstringlist joker_14850_3 ; // Joker input parameter
    GALGAS_stringlist joker_14850_2 ; // Joker input parameter
    GALGAS_lstringlist joker_14850_1 ; // Joker input parameter
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (454)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_14850_3, joker_14850_2, joker_14850_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) ;
    ...
    cEnumerator_stringlist enumerator_14992 (var_partialOrderedLabelList, kEnumeration_up) ;
    while (enumerator_14992.hasCurrentObject ()) {
      GALGAS_uint var_blockIndex ;
      var_symbolTable.method_searchKey (enumerator_14992.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (461)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_15322 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_15322.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_15322.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (469)))).operator_and (var_visitedNodeSet.reader_hasKey (enumerator_15322.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (470)).operator_not (SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (469)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_15322.current_mBlock (HERE).mAttribute_mLabel COMMA_SOURCE_FILE_AT_LINE (472)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
      cEnumerator_stringlist enumerator_15625 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (475)), kEnumeration_up) ;
      while (enumerator_15625.hasCurrentObject ()) {
        var_visitedNodeSet.addAssign_operation (enumerator_15625.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (476)) ;
        enumerator_15625.gotoNextObject () ;
      }
      {
      var_gg.modifier_removeEdgesToNode (enumerator_15322.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (478)) ;
      }
      {
      var_gg.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (479)) ;
      }
      GALGAS_stringlist var_partialOrderedLabelList ;
      GALGAS_lstringlist joker_15889_3 ; // Joker input parameter
      GALGAS_stringlist joker_15889_2 ; // Joker input parameter
      GALGAS_lstringlist joker_15889_1 ; // Joker input parameter
      var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (480)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_15889_3, joker_15889_2, joker_15889_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
      ...
      cEnumerator_stringlist enumerator_16039 (var_partialOrderedLabelList, kEnumeration_up) ;
      while (enumerator_16039.hasCurrentObject ()) {
        GALGAS_uint var_blockIndex ;
        var_symbolTable.method_searchKey (enumerator_16039.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (487)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_16481 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_3 = var_continue.isValidAndTrue () ;
  if (enumerator_16481.hasCurrentObject () && bool_3) {
    while (enumerator_16481.hasCurrentObject () && bool_3) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16481.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (499)))) ;
      const enumGalgasBool test_4 = var_continue.boolEnum () ;
      if (kBoolTrue == test_4) {
        var_orderedBlockList.addAssign_operation (enumerator_16481.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (501)) ;
      }
      enumerator_16481.gotoNextObject () ;
      if (enumerator_16481.hasCurrentObject ()) {
        bool_3 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_stringlist enumerator_16693 (var_newOrderedLabelList, kEnumeration_up) ;
  while (enumerator_16693.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_16693.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (506)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_17030 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_5 = var_continue.isValidAndTrue () ;
  if (enumerator_17030.hasCurrentObject () && bool_5) {
    while (enumerator_17030.hasCurrentObject () && bool_5) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_17030.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (514)))) ;
      const enumGalgasBool test_6 = var_continue.boolEnum () ;
      if (kBoolTrue == test_6) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_17030.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
        }
      }
      enumerator_17030.gotoNextObject () ;
      if (enumerator_17030.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_8) {
    GALGAS_bool joker_17678_0 ; // Joker input parameter
    var_g.reader_graphviz (SOURCE_FILE_AT_LINE (527)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (527)), joker_17678_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (527)) ;
  }
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_17808 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_17808.hasCurrentObject ()) {
    const enumGalgasBool test_9 = var_newSymbolSet.reader_hasKey (enumerator_17808.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (533)).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17808.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (534)) COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (535)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_17808.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (541)) ;
    }
    enumerator_17808.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_18199 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_18199.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_newSymbolSet.reader_hasKey (enumerator_18199.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (545)).operator_not (SOURCE_FILE_AT_LINE (545)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_18199.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (546)) COMMA_SOURCE_FILE_AT_LINE (546)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (547)) ;
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19543 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_19543.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_19543.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (583)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      outArgument_outGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (enumerator_19543.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (GALGAS_string ("\" [shape=rectangle]\n") COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)) ;
    }
    cEnumerator_ipic_31__38_SequentialInstructionList enumerator_19736 (enumerator_19543.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
    while (enumerator_19736.hasCurrentObject ()) {
      callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_19736.current_mInstruction (HERE).ptr (), enumerator_19543.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (587)) ;
      enumerator_19736.gotoNextObject () ;
    }
    callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19543.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_19543.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (589)) ;
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_20226 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_20214 ((PMUInt32) 0) ;
  while (enumerator_20226.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_20226.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (602)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_20214.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (604)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_20214.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_20226.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (609)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (610)) ;
      }
    }
    enumerator_20226.gotoNextObject () ;
    index_20214.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_21160_0 ; // Joker input parameter
    var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (625)), joker_21160_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (625)) ;
  }
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (142)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (164)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) ;
}
//-----------------------------------------------------------------------------*
...
static GALGAS_bool categoryReader_pic_31__38_RegisterComparisonTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_RegisterComparisonTerminator * object = (const cPtr_pic_31__38_RegisterComparisonTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_RegisterComparisonTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (304)) ;
//---
  return result_outResult ;
}
...
static GALGAS_bool categoryReader_pic_31__38_TestRegisterTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_TestRegisterTerminator * object = (const cPtr_pic_31__38_TestRegisterTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_TestRegisterTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_RegisterComparisonTerminator * object = (const cPtr_pic_31__38_RegisterComparisonTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_RegisterComparisonTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_TestRegisterTerminator * object = (const cPtr_pic_31__38_TestRegisterTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_TestRegisterTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (368)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_IncDecRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (384)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_BitTestTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (396)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
}
//-----------------------------------------------------------------------------*
