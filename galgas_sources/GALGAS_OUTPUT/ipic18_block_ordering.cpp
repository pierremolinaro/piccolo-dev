...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19231 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_19231.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_19231.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (582)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      outArgument_outGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (enumerator_19231.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (583)) COMMA_SOURCE_FILE_AT_LINE (583)).operator_concat (GALGAS_string ("\" [shape=octagon]\n") COMMA_SOURCE_FILE_AT_LINE (583)) COMMA_SOURCE_FILE_AT_LINE (583)) ;
    }
    cEnumerator_ipic_31__38_SequentialInstructionList enumerator_19422 (enumerator_19231.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
    while (enumerator_19422.hasCurrentObject ()) {
      callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_19422.current_mInstruction (HERE).ptr (), enumerator_19231.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (586)) ;
      enumerator_19422.gotoNextObject () ;
    }
    callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19231.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_19231.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_19912 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_19900 ((PMUInt32) 0) ;
  while (enumerator_19912.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_19912.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (601)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_19900.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (603)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (603)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_19900.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_19912.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (608)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (609)) ;
      }
    }
    enumerator_19912.gotoNextObject () ;
    index_19900.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    routine_buildInvocationGraph (ioArgument_ioGeneratedBlockList, var_invocationGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (623)) ;
    }
    GALGAS_bool joker_20846_0 ; // Joker input parameter
    var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (624)), joker_20846_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (624)) ;
  }
  GALGAS_bool var_optimize = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (66)) COMMA_SOURCE_FILE_AT_LINE (628)) COMMA_SOURCE_FILE_AT_LINE (627)) ;
  const enumGalgasBool test_1 = var_optimize.boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    routine_buildOrderedGraph (ioArgument_ioGeneratedBlockList, constinArgument_inSourceFileName, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (630)) ;
    }
  }
}
