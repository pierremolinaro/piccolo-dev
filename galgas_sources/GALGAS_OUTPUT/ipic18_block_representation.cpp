...
GALGAS_bool function_pic_31__38__5F_checkBCC (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (455)) ;
  GALGAS_sint var_displacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (456)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (456)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (456)), inCompiler COMMA_SOURCE_FILE_AT_LINE (456)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (456)) ;
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 127L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (457)))) COMMA_SOURCE_FILE_AT_LINE (457)) ;
//---
...
GALGAS_bool function_pic_31__38__5F_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_bool result_outDisplacementOK ; // Returned variable
  GALGAS_uint var_targetAddress ;
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (469)) ;
  GALGAS_sint var_displacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (470)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (470)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (470)), inCompiler COMMA_SOURCE_FILE_AT_LINE (470)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (470)) ;
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (471)))) COMMA_SOURCE_FILE_AT_LINE (471)) ;
//---
  return result_outDisplacementOK ;
}
...
GALGAS_sint function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (482)) ;
  result_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (483)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (483)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (483)), inCompiler COMMA_SOURCE_FILE_AT_LINE (483)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (483)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_Bcc_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inConditionalBranchInstructionAddress,
  ...
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (500)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (500)).substract_operation (constinArgument_inConditionalBranchInstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (500)), inCompiler COMMA_SOURCE_FILE_AT_LINE (500)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (500)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 127L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (501)))) COMMA_SOURCE_FILE_AT_LINE (501)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large for conditional branch instruction") COMMA_SOURCE_FILE_AT_LINE (502)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    if (constinArgument_inConditionalBranch.isValid ()) {
      ...
      case GALGAS_conditional_5F_branch::kEnum_bz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnz (SOURCE_FILE_AT_LINE (508)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bz (SOURCE_FILE_AT_LINE (509)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnn (SOURCE_FILE_AT_LINE (510)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bn (SOURCE_FILE_AT_LINE (511)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnc (SOURCE_FILE_AT_LINE (512)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bc (SOURCE_FILE_AT_LINE (513)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnov (SOURCE_FILE_AT_LINE (514)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bov (SOURCE_FILE_AT_LINE (515)) ;
        } break ;
      }
    }
  ...
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (var_mnemonic COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (534)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (534)) COMMA_SOURCE_FILE_AT_LINE (534)), GALGAS_uintlist::constructor_listWithValue (var_baseCode.operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 255L) COMMA_SOURCE_FILE_AT_LINE (535)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (535)) COMMA_SOURCE_FILE_AT_LINE (535)) COMMA_SOURCE_FILE_AT_LINE (535)) COMMA_SOURCE_FILE_AT_LINE (533)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_RCALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (547)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (547)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (547)), inCompiler COMMA_SOURCE_FILE_AT_LINE (547)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (547)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (548)))) COMMA_SOURCE_FILE_AT_LINE (548)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (549)) COMMA_SOURCE_FILE_AT_LINE (549)).operator_concat (GALGAS_string (") for RCALL instruction to '") COMMA_SOURCE_FILE_AT_LINE (549)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (550)) COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (550)) COMMA_SOURCE_FILE_AT_LINE (549)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    RCALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (553)) COMMA_SOURCE_FILE_AT_LINE (553)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 55296U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (554)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (552)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_BRA_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (566)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (566)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (566)), inCompiler COMMA_SOURCE_FILE_AT_LINE (566)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (566)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (567)))) COMMA_SOURCE_FILE_AT_LINE (567)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (568)) COMMA_SOURCE_FILE_AT_LINE (568)).operator_concat (GALGAS_string (") for BRA instruction to '") COMMA_SOURCE_FILE_AT_LINE (568)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (569)) COMMA_SOURCE_FILE_AT_LINE (569)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (569)) COMMA_SOURCE_FILE_AT_LINE (568)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    BRA ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 53248U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (573)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (571)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_CALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (584)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 60416U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (585)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (585)) COMMA_SOURCE_FILE_AT_LINE (585)) COMMA_SOURCE_FILE_AT_LINE (585)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (586)) COMMA_SOURCE_FILE_AT_LINE (586)) COMMA_SOURCE_FILE_AT_LINE (586)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    CALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (587)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_GOTO_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (600)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61184U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (601)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (601)) COMMA_SOURCE_FILE_AT_LINE (601)) COMMA_SOURCE_FILE_AT_LINE (601)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    GOTO ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (604)) COMMA_SOURCE_FILE_AT_LINE (604)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (603)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_definition_5F_label (const GALGAS_lstring & constinArgument_inTargetLabel,
                                                             ...
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  result_outCode = GALGAS_codeList::constructor_listWithValue (constinArgument_inTargetLabel.mAttribute_string.operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (616)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (617)) COMMA_SOURCE_FILE_AT_LINE (615)) ;
//---
  return result_outCode ;
}
...
typeComparisonResult cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FNOP::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FNOP) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_ipic_31__38_SequentialInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FNOP) ;
}
...
void GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FNOP::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FNOP * r = NULL ;
    macroMyNew (r, cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FNOP (p->mAttribute_mInstructionLocation, p->mAttribute_mBlankValue COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
static void categoryMethod_ipic_31__38_AbstractBlockTerminator_generateCode (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                             ...
                                                                             C_Compiler * /* inCompiler */
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outCode = GALGAS_codeList::constructor_emptyList (SOURCE_FILE_AT_LINE (440)) ;
}
//---------------------------------------------------------------------------*
