...
void routine_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution constinArgument_inSymbolTable,
  ...
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (363)) ;
  outArgument_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (364)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (364)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (364)), inCompiler COMMA_SOURCE_FILE_AT_LINE (364)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (364)) ;
  outArgument_outDisplacementOK = GALGAS_bool (kIsStrictInf, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L))).operator_and (GALGAS_bool (kIsStrictSup, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (365)))) COMMA_SOURCE_FILE_AT_LINE (365)) ;
}
...
GALGAS_ipic_31__38_ConditionalJumpTerminator GALGAS_ipic_31__38_ConditionalJumpTerminator::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
  ...
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mBranchMode.isValid () && inAttribute_mConditionalBranch.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_ConditionalJumpTerminator (inAttribute_mInstructionLocation, inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mBranchMode, inAttribute_mConditionalBranch COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_ConditionalJumpTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_ConditionalJumpTerminator (p->mAttribute_mInstructionLocation, p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mBranchMode, p->mAttribute_mConditionalBranch COMMA_THERE)) ;
...
GALGAS_pic_31__38_BraCCTerminator GALGAS_pic_31__38_BraCCTerminator::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                      const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionTrue,
                                                                                      const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionFalse,
                                                                                      const GALGAS_conditionalBranchMode & inAttribute_mBranchMode,
  ...
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mBranchMode.isValid () && inAttribute_mConditionalBranch.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_pic_31__38_BraCCTerminator (inAttribute_mInstructionLocation, inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mBranchMode, inAttribute_mConditionalBranch COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_pic_31__38_BraCCTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_pic_31__38_BraCCTerminator (p->mAttribute_mInstructionLocation, p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mBranchMode, p->mAttribute_mConditionalBranch COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_pic_31__38_BraCCTerminator::cPtr_pic_31__38_BraCCTerminator (const GALGAS_location & in_mInstructionLocation,
                                                                  const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
                                                                  const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionFalse,
                                                                  const GALGAS_conditionalBranchMode & in_mBranchMode,
...
//---------------------------------------------------------------------------*
//                                                                           *
//        Category method '@ipic18SequentialInstruction generateCode'        *
//                                                                           *
//---------------------------------------------------------------------------*
...
void callCategoryMethod_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
                                      ...
                                      const GALGAS_ipic_31__38_BlockList constin_inGeneratedBlockList,
  ...
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inAddress, constin_inSymbolTable, constin_inGeneratedBlockList, out_outCode, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_ipic_31__38_SequentialInstruction_generateCode (const cPtr_ipic_31__38_SequentialInstruction * /* inObject */,
                                                                           ...
                                                                           C_Compiler * /* inCompiler */
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outCode = GALGAS_codeList::constructor_emptyList (SOURCE_FILE_AT_LINE (347)) ;
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_ipic_31__38_SequentialInstruction_generateCode (void) {
  enterCategoryMethod_generateCode (kTypeDescriptor_GALGAS_ipic_31__38_SequentialInstruction.mSlotID,
                                    categoryMethod_ipic_31__38_SequentialInstruction_generateCode) ;
}
...
C_PrologueEpilogue gMethod_ipic_31__38_SequentialInstruction_generateCode (defineCategoryMethod_ipic_31__38_SequentialInstruction_generateCode,
