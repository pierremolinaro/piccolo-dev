...
GALGAS_conditionalBranchMode GALGAS_conditionalBranchMode::constructor_ipicNative (UNUSED_LOCATION_ARGS) {
  GALGAS_conditionalBranchMode result ;
...
static const char * gEnumNameArrayFor_conditionalBranchMode [5] = {
  "(not built)",
  "native",
  "ipicNative",
  "ipicBRA",
...
GALGAS_ipc_31__38_ConditionalBranch::GALGAS_ipc_31__38_ConditionalBranch (void) :
mEnum (kNotBuilt) {
}

//---------------------------------------------------------------------------*

GALGAS_ipc_31__38_ConditionalBranch GALGAS_ipc_31__38_ConditionalBranch::constructor_bz (UNUSED_LOCATION_ARGS) {
  GALGAS_ipc_31__38_ConditionalBranch result ;
...
GALGAS_ipc_31__38_ConditionalBranch GALGAS_ipc_31__38_ConditionalBranch::constructor_bn (UNUSED_LOCATION_ARGS) {
  GALGAS_ipc_31__38_ConditionalBranch result ;
...
GALGAS_ipc_31__38_ConditionalBranch GALGAS_ipc_31__38_ConditionalBranch::constructor_bc (UNUSED_LOCATION_ARGS) {
  GALGAS_ipc_31__38_ConditionalBranch result ;
...
GALGAS_ipc_31__38_ConditionalBranch GALGAS_ipc_31__38_ConditionalBranch::constructor_bov (UNUSED_LOCATION_ARGS) {
  GALGAS_ipc_31__38_ConditionalBranch result ;
...
static const char * gEnumNameArrayFor_ipc_31__38_ConditionalBranch [5] = {
  "(not built)",
  "bz",
  "bn",
  "bc",
...
void GALGAS_ipc_31__38_ConditionalBranch::description (C_String & ioString,
                                                       const PMSInt32 /* inIndentation */) const {
  ioString << "<enum @ipc18ConditionalBranch: " << gEnumNameArrayFor_ipc_31__38_ConditionalBranch [mEnum] << ">" ;
}

//---------------------------------------------------------------------------*

typeComparisonResult GALGAS_ipc_31__38_ConditionalBranch::objectCompare (const GALGAS_ipc_31__38_ConditionalBranch & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                       @ipc18ConditionalBranch type                        *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ipc_31__38_ConditionalBranch ("ipc18ConditionalBranch",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ipc_31__38_ConditionalBranch::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ipc_31__38_ConditionalBranch ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ipc_31__38_ConditionalBranch::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ipc_31__38_ConditionalBranch (*this)) ;
  }
  return result ;
}
...
GALGAS_ipc_31__38_ConditionalBranch GALGAS_ipc_31__38_ConditionalBranch::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_ipc_31__38_ConditionalBranch result ;
  const GALGAS_ipc_31__38_ConditionalBranch * p = (const GALGAS_ipc_31__38_ConditionalBranch *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ipc_31__38_ConditionalBranch *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("ipc18ConditionalBranch", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
cPtr_ipic_31__38_AbstractConditionTerminator::cPtr_ipic_31__38_AbstractConditionTerminator (const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
...
GALGAS_ipic_31__38_ConditionalJumpTerminator GALGAS_ipic_31__38_ConditionalJumpTerminator::constructor_new (const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionTrue,
                                                                                                            const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionFalse,
                                                                                                            const GALGAS_conditionalBranchMode & inAttribute_mBranchMode,
                                                                                                            const GALGAS_conditional_5F_branch & inAttribute_mConditionalBranch
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ConditionalJumpTerminator result ;
  if (inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mBranchMode.isValid () && inAttribute_mConditionalBranch.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_ConditionalJumpTerminator (inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mBranchMode, inAttribute_mConditionalBranch COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_ConditionalJumpTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_ConditionalJumpTerminator (p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mBranchMode, p->mAttribute_mConditionalBranch COMMA_THERE)) ;
...
GALGAS_conditionalBranchMode GALGAS_ipic_31__38_ConditionalJumpTerminator::reader_mBranchMode (UNUSED_LOCATION_ARGS) const {
  GALGAS_conditionalBranchMode result ;
  if (NULL != mObjectPtr) {
...
GALGAS_conditionalBranchMode cPtr_ipic_31__38_ConditionalJumpTerminator::reader_mBranchMode (UNUSED_LOCATION_ARGS) const {
...
cPtr_ipic_31__38_ConditionalJumpTerminator::cPtr_ipic_31__38_ConditionalJumpTerminator (const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
                                                                                        const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionFalse,
                                                                                        const GALGAS_conditionalBranchMode & in_mBranchMode,
                                                                                        const GALGAS_conditional_5F_branch & in_mConditionalBranch
                                                                                        COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_AbstractConditionTerminator (in_mInstructionIfConditionTrue, in_mInstructionIfConditionFalse COMMA_THERE),
...
GALGAS_ipic_31__38_IncDecRegisterTerminator GALGAS_ipic_31__38_IncDecRegisterTerminator::constructor_new (const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionTrue,
                                                                                                          const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionFalse,
  ...
  if (inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mRegisterDescription.isValid () && inAttribute_mIncrement.isValid () && inAttribute_m_5F_W_5F_isDestination.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_IncDecRegisterTerminator (inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mRegisterDescription, inAttribute_mIncrement, inAttribute_m_5F_W_5F_isDestination COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_IncDecRegisterTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_IncDecRegisterTerminator (p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mRegisterDescription, p->mAttribute_mIncrement, p->mAttribute_m_5F_W_5F_isDestination COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_ipic_31__38_IncDecRegisterTerminator::cPtr_ipic_31__38_IncDecRegisterTerminator (const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
                                                                                      const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionFalse,
...
GALGAS_pic_31__38_BitTestTerminator GALGAS_pic_31__38_BitTestTerminator::constructor_new (const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionTrue,
                                                                                          const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionFalse,
                                                                                          const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & inAttribute_mRegisterDescription,
                                                                                          const GALGAS_uint & inAttribute_mBitNumber
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_pic_31__38_BitTestTerminator result ;
  if (inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mRegisterDescription.isValid () && inAttribute_mBitNumber.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_pic_31__38_BitTestTerminator (inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mRegisterDescription, inAttribute_mBitNumber COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_pic_31__38_BitTestTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_pic_31__38_BitTestTerminator (p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mRegisterDescription, p->mAttribute_mBitNumber COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_pic_31__38_BitTestTerminator::cPtr_pic_31__38_BitTestTerminator (const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
                                                                      const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionFalse,
                                                                      const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & in_mRegisterDescription,
...
typeComparisonResult cPtr_pic_31__38_BraCCTerminator::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_pic_31__38_BraCCTerminator * p = (const cPtr_pic_31__38_BraCCTerminator *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_pic_31__38_BraCCTerminator) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionIfConditionTrue.objectCompare (p->mAttribute_mInstructionIfConditionTrue) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_pic_31__38_BraCCTerminator::objectCompare (const GALGAS_pic_31__38_BraCCTerminator & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_pic_31__38_BraCCTerminator::GALGAS_pic_31__38_BraCCTerminator (void) :
GALGAS_ipic_31__38_AbstractConditionTerminator () {
}

//---------------------------------------------------------------------------*

GALGAS_pic_31__38_BraCCTerminator::GALGAS_pic_31__38_BraCCTerminator (const cPtr_pic_31__38_BraCCTerminator * inSourcePtr) :
GALGAS_ipic_31__38_AbstractConditionTerminator (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_pic_31__38_BraCCTerminator) ;
}

//---------------------------------------------------------------------------*

GALGAS_pic_31__38_BraCCTerminator GALGAS_pic_31__38_BraCCTerminator::constructor_new (const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionTrue,
                                                                                      const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionFalse,
                                                                                      const GALGAS_conditionalBranchMode & inAttribute_mBranchMode,
                                                                                      const GALGAS_ipc_31__38_ConditionalBranch & inAttribute_mConditionalBranch
                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_pic_31__38_BraCCTerminator result ;
  if (inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mBranchMode.isValid () && inAttribute_mConditionalBranch.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_pic_31__38_BraCCTerminator (inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mBranchMode, inAttribute_mConditionalBranch COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_pic_31__38_BraCCTerminator::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_pic_31__38_BraCCTerminator * p = (cPtr_pic_31__38_BraCCTerminator *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_pic_31__38_BraCCTerminator) ;
    cPtr_pic_31__38_BraCCTerminator * r = NULL ;
    macroMyNew (r, cPtr_pic_31__38_BraCCTerminator (p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mBranchMode, p->mAttribute_mConditionalBranch COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_conditionalBranchMode GALGAS_pic_31__38_BraCCTerminator::reader_mBranchMode (UNUSED_LOCATION_ARGS) const {
  GALGAS_conditionalBranchMode result ;
  if (NULL != mObjectPtr) {
    const cPtr_pic_31__38_BraCCTerminator * p = (const cPtr_pic_31__38_BraCCTerminator *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_pic_31__38_BraCCTerminator) ;
    result = p->mAttribute_mBranchMode ;
  }
  return result ;
...
GALGAS_conditionalBranchMode cPtr_pic_31__38_BraCCTerminator::reader_mBranchMode (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBranchMode ;
}

//---------------------------------------------------------------------------*

GALGAS_ipc_31__38_ConditionalBranch GALGAS_pic_31__38_BraCCTerminator::reader_mConditionalBranch (UNUSED_LOCATION_ARGS) const {
  GALGAS_ipc_31__38_ConditionalBranch result ;
  if (NULL != mObjectPtr) {
    const cPtr_pic_31__38_BraCCTerminator * p = (const cPtr_pic_31__38_BraCCTerminator *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_pic_31__38_BraCCTerminator) ;
...
GALGAS_ipc_31__38_ConditionalBranch cPtr_pic_31__38_BraCCTerminator::reader_mConditionalBranch (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mConditionalBranch ;
}
...
cPtr_pic_31__38_BraCCTerminator::cPtr_pic_31__38_BraCCTerminator (const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
                                                                  const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionFalse,
                                                                  const GALGAS_conditionalBranchMode & in_mBranchMode,
                                                                  const GALGAS_ipc_31__38_ConditionalBranch & in_mConditionalBranch
                                                                  COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_AbstractConditionTerminator (in_mInstructionIfConditionTrue, in_mInstructionIfConditionFalse COMMA_THERE),
mAttribute_mBranchMode (in_mBranchMode),
mAttribute_mConditionalBranch (in_mConditionalBranch) {
...
const C_galgas_type_descriptor * cPtr_pic_31__38_BraCCTerminator::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_pic_31__38_BraCCTerminator ;
}

void cPtr_pic_31__38_BraCCTerminator::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
  ioString << "[@pic18BraCCTerminator:" ;
  mAttribute_mInstructionIfConditionTrue.description (ioString, inIndentation+1) ;
  ioString << ", " ;
  mAttribute_mInstructionIfConditionFalse.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                        @pic18BraCCTerminator type                         *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_pic_31__38_BraCCTerminator ("pic18BraCCTerminator",
                                                   & kTypeDescriptor_GALGAS_ipic_31__38_AbstractConditionTerminator) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_pic_31__38_BraCCTerminator::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_pic_31__38_BraCCTerminator ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_pic_31__38_BraCCTerminator::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_pic_31__38_BraCCTerminator (*this)) ;
  }
  return result ;
}
...
GALGAS_pic_31__38_BraCCTerminator GALGAS_pic_31__38_BraCCTerminator::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_pic_31__38_BraCCTerminator result ;
  const GALGAS_pic_31__38_BraCCTerminator * p = (const GALGAS_pic_31__38_BraCCTerminator *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_pic_31__38_BraCCTerminator *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("pic18BraCCTerminator", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_pic_31__38_RegisterComparisonTerminator GALGAS_pic_31__38_RegisterComparisonTerminator::constructor_new (const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionTrue,
                                                                                                                const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionFalse,
                                                                                                                const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & inAttribute_mRegisterDescription,
                                                                                                                const GALGAS_ipic_31__38_RegisterComparison & inAttribute_mComparison
                                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_pic_31__38_RegisterComparisonTerminator result ;
  if (inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mRegisterDescription.isValid () && inAttribute_mComparison.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_pic_31__38_RegisterComparisonTerminator (inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mRegisterDescription, inAttribute_mComparison COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_pic_31__38_RegisterComparisonTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_pic_31__38_RegisterComparisonTerminator (p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mRegisterDescription, p->mAttribute_mComparison COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_pic_31__38_RegisterComparisonTerminator::cPtr_pic_31__38_RegisterComparisonTerminator (const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
                                                                                            const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionFalse,
                                                                                            const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & in_mRegisterDescription,
...
GALGAS_pic_31__38_TestRegisterTerminator GALGAS_pic_31__38_TestRegisterTerminator::constructor_new (const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionTrue,
                                                                                                    const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mInstructionIfConditionFalse,
                                                                                                    const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & inAttribute_mRegisterDescription
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_pic_31__38_TestRegisterTerminator result ;
  if (inAttribute_mInstructionIfConditionTrue.isValid () && inAttribute_mInstructionIfConditionFalse.isValid () && inAttribute_mRegisterDescription.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_pic_31__38_TestRegisterTerminator (inAttribute_mInstructionIfConditionTrue, inAttribute_mInstructionIfConditionFalse, inAttribute_mRegisterDescription COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_pic_31__38_TestRegisterTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_pic_31__38_TestRegisterTerminator (p->mAttribute_mInstructionIfConditionTrue, p->mAttribute_mInstructionIfConditionFalse, p->mAttribute_mRegisterDescription COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_pic_31__38_TestRegisterTerminator::cPtr_pic_31__38_TestRegisterTerminator (const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionTrue,
                                                                                const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mInstructionIfConditionFalse,
                                                                                const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & in_mRegisterDescription
                                                                                COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_AbstractConditionTerminator (in_mInstructionIfConditionTrue, in_mInstructionIfConditionFalse COMMA_THERE),
...
GALGAS_ipic_31__38_ComputedBraTerminator GALGAS_ipic_31__38_ComputedBraTerminator::constructor_default (LOCATION_ARGS) {
  return GALGAS_ipic_31__38_ComputedBraTerminator::constructor_new (GALGAS_lstringlist::constructor_emptyList (HERE),
...
GALGAS_ipic_31__38_ComputedBraTerminator GALGAS_ipic_31__38_ComputedBraTerminator::constructor_new (const GALGAS_lstringlist & inAttribute_mTargetLabels,
                                                                                                    const GALGAS_bool & inAttribute_mUsesRCALL
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ComputedBraTerminator result ;
  if (inAttribute_mTargetLabels.isValid () && inAttribute_mUsesRCALL.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_ComputedBraTerminator (inAttribute_mTargetLabels, inAttribute_mUsesRCALL COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_ComputedBraTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_ComputedBraTerminator (p->mAttribute_mTargetLabels, p->mAttribute_mUsesRCALL COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_ipic_31__38_ComputedBraTerminator::cPtr_ipic_31__38_ComputedBraTerminator (const GALGAS_lstringlist & in_mTargetLabels,
...
GALGAS_ipic_31__38_ComputedGotoTerminator GALGAS_ipic_31__38_ComputedGotoTerminator::constructor_default (LOCATION_ARGS) {
  return GALGAS_ipic_31__38_ComputedGotoTerminator::constructor_new (GALGAS_lstringlist::constructor_emptyList (HERE),
                                                                     GALGAS_bool::constructor_default (HERE)
                                                                     COMMA_THERE) ;
}
...
GALGAS_ipic_31__38_ComputedGotoTerminator GALGAS_ipic_31__38_ComputedGotoTerminator::constructor_new (const GALGAS_lstringlist & inAttribute_mTargetLabels,
                                                                                                      const GALGAS_bool & inAttribute_mUsesRCALL
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ComputedGotoTerminator result ;
  if (inAttribute_mTargetLabels.isValid () && inAttribute_mUsesRCALL.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_ComputedGotoTerminator (inAttribute_mTargetLabels, inAttribute_mUsesRCALL COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_ComputedGotoTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_ComputedGotoTerminator (p->mAttribute_mTargetLabels, p->mAttribute_mUsesRCALL COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_ipic_31__38_ComputedGotoTerminator::cPtr_ipic_31__38_ComputedGotoTerminator (const GALGAS_lstringlist & in_mTargetLabels,
                                                                                  const GALGAS_bool & in_mUsesRCALL
                                                                                  COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_AbstractBlockTerminator (THERE),
mAttribute_mTargetLabels (in_mTargetLabels),
...
GALGAS_ipic_31__38_ComputedRETLWTerminator GALGAS_ipic_31__38_ComputedRETLWTerminator::constructor_default (LOCATION_ARGS) {
  return GALGAS_ipic_31__38_ComputedRETLWTerminator::constructor_new (GALGAS_uintlist::constructor_emptyList (HERE),
                                                                      GALGAS_bool::constructor_default (HERE)
                                                                      COMMA_THERE) ;
}
...
GALGAS_ipic_31__38_ComputedRETLWTerminator GALGAS_ipic_31__38_ComputedRETLWTerminator::constructor_new (const GALGAS_uintlist & inAttribute_mLiteralValues,
                                                                                                        const GALGAS_bool & inAttribute_mUsesRCALL
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ComputedRETLWTerminator result ;
  if (inAttribute_mLiteralValues.isValid () && inAttribute_mUsesRCALL.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_ComputedRETLWTerminator (inAttribute_mLiteralValues, inAttribute_mUsesRCALL COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_ComputedRETLWTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_ComputedRETLWTerminator (p->mAttribute_mLiteralValues, p->mAttribute_mUsesRCALL COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_ipic_31__38_ComputedRETLWTerminator::cPtr_ipic_31__38_ComputedRETLWTerminator (const GALGAS_uintlist & in_mLiteralValues,
                                                                                    const GALGAS_bool & in_mUsesRCALL
                                                                                    COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_AbstractBlockTerminator (THERE),
...
GALGAS_ipic_31__38_RetfieTerminator GALGAS_ipic_31__38_RetfieTerminator::constructor_default (LOCATION_ARGS) {
  return GALGAS_ipic_31__38_RetfieTerminator::constructor_new (GALGAS_bool::constructor_default (HERE)
                                                               COMMA_THERE) ;
}
...
GALGAS_ipic_31__38_RetfieTerminator GALGAS_ipic_31__38_RetfieTerminator::constructor_new (const GALGAS_bool & inAttribute_mFastReturn
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_RetfieTerminator result ;
  if (inAttribute_mFastReturn.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_RetfieTerminator (inAttribute_mFastReturn COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_RetfieTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_RetfieTerminator (p->mAttribute_mFastReturn COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_ipic_31__38_RetfieTerminator::cPtr_ipic_31__38_RetfieTerminator (const GALGAS_bool & in_mFastReturn
                                                                      COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_SingleInstructionTerminator (THERE),
...
GALGAS_ipic_31__38_RetlwTerminator GALGAS_ipic_31__38_RetlwTerminator::constructor_default (LOCATION_ARGS) {
  return GALGAS_ipic_31__38_RetlwTerminator::constructor_new (GALGAS_uint::constructor_default (HERE)
                                                              COMMA_THERE) ;
}
...
GALGAS_ipic_31__38_RetlwTerminator GALGAS_ipic_31__38_RetlwTerminator::constructor_new (const GALGAS_uint & inAttribute_mLiteralValue
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_RetlwTerminator result ;
  if (inAttribute_mLiteralValue.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_RetlwTerminator (inAttribute_mLiteralValue COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_RetlwTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_RetlwTerminator (p->mAttribute_mLiteralValue COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_ipic_31__38_RetlwTerminator::cPtr_ipic_31__38_RetlwTerminator (const GALGAS_uint & in_mLiteralValue
                                                                    COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_SingleInstructionTerminator (THERE),
...
GALGAS_FA_5F_instruction_5F_base_5F_code GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::reader_mFAinstruction (UNUSED_LOCATION_ARGS) const {
...
GALGAS_FA_5F_instruction_5F_base_5F_code cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FA::reader_mFAinstruction (UNUSED_LOCATION_ARGS) const {
...
GALGAS_instruction_5F_FDA_5F_base_5F_code GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::reader_mInstruction_5F_FDA_5F_base_5F_code (UNUSED_LOCATION_ARGS) const {
...
GALGAS_instruction_5F_FDA_5F_base_5F_code cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::reader_mInstruction_5F_FDA_5F_base_5F_code (UNUSED_LOCATION_ARGS) const {
...
GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
  ...
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mTargetLabels.isValid () && inAttribute_mEndOfInstructionLabel.isValid () && inAttribute_mUsesRCALL.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall (inAttribute_mInstructionLocation, inAttribute_mTargetLabels, inAttribute_mEndOfInstructionLabel, inAttribute_mUsesRCALL COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall (p->mAttribute_mInstructionLocation, p->mAttribute_mTargetLabels, p->mAttribute_mEndOfInstructionLabel, p->mAttribute_mUsesRCALL COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstringlist GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::reader_mTargetLabels (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstringlist result ;
  if (NULL != mObjectPtr) {
...
GALGAS_lstringlist cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::reader_mTargetLabels (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTargetLabels ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::reader_mEndOfInstructionLabel (UNUSED_LOCATION_ARGS) const {
...
GALGAS_string cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::reader_mEndOfInstructionLabel (UNUSED_LOCATION_ARGS) const {
...
typeComparisonResult GALGAS_ipic_31__38__5F_skip_5F_instruction::objectCompare (const GALGAS_ipic_31__38__5F_skip_5F_instruction & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_ipic_31__38__5F_skip_5F_instruction::GALGAS_ipic_31__38__5F_skip_5F_instruction (void) :
GALGAS_ipic_31__38_SequentialInstruction () {
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38__5F_skip_5F_instruction::GALGAS_ipic_31__38__5F_skip_5F_instruction (const cPtr_ipic_31__38__5F_skip_5F_instruction * inSourcePtr) :
GALGAS_ipic_31__38_SequentialInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_ipic_31__38__5F_skip_5F_instruction) ;
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38_SequentialInstruction GALGAS_ipic_31__38__5F_skip_5F_instruction::reader_mEmbeddedInstruction (UNUSED_LOCATION_ARGS) const {
  GALGAS_ipic_31__38_SequentialInstruction result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38__5F_skip_5F_instruction * p = (const cPtr_ipic_31__38__5F_skip_5F_instruction *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38__5F_skip_5F_instruction) ;
...
GALGAS_ipic_31__38_SequentialInstruction cPtr_ipic_31__38__5F_skip_5F_instruction::reader_mEmbeddedInstruction (UNUSED_LOCATION_ARGS) const {
...
cPtr_ipic_31__38__5F_skip_5F_instruction::cPtr_ipic_31__38__5F_skip_5F_instruction (const GALGAS_location & in_mInstructionLocation,
...
//---------------------------------------------------------------------------*
//                                                                           *
//                       @ipic18_skip_instruction type                       *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ipic_31__38__5F_skip_5F_instruction ("ipic18_skip_instruction",
                                                            & kTypeDescriptor_GALGAS_ipic_31__38_SequentialInstruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ipic_31__38__5F_skip_5F_instruction::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ipic_31__38__5F_skip_5F_instruction ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ipic_31__38__5F_skip_5F_instruction::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ipic_31__38__5F_skip_5F_instruction (*this)) ;
  }
  return result ;
}
...
GALGAS_ipic_31__38__5F_skip_5F_instruction GALGAS_ipic_31__38__5F_skip_5F_instruction::extractObject (const GALGAS_object & inObject,
                                                                                                      C_Compiler * inCompiler
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_skip_5F_instruction result ;
  const GALGAS_ipic_31__38__5F_skip_5F_instruction * p = (const GALGAS_ipic_31__38__5F_skip_5F_instruction *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ipic_31__38__5F_skip_5F_instruction *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("ipic18_skip_instruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * p = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::objectCompare (const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip (void) :
GALGAS_ipic_31__38__5F_skip_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * inSourcePtr) :
GALGAS_ipic_31__38__5F_skip_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip) ;
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                                                                                      const GALGAS_ipic_31__38_SequentialInstruction & inAttribute_mEmbeddedInstruction,
                                                                                                                                                      const GALGAS_bool & inAttribute_mSkipIfSet,
                                                                                                                                                      const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & inAttribute_mRegisterDescription,
                                                                                                                                                      const GALGAS_uint & inAttribute_mBitNumber
                                                                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mEmbeddedInstruction.isValid () && inAttribute_mSkipIfSet.isValid () && inAttribute_mRegisterDescription.isValid () && inAttribute_mBitNumber.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip (inAttribute_mInstructionLocation, inAttribute_mEmbeddedInstruction, inAttribute_mSkipIfSet, inAttribute_mRegisterDescription, inAttribute_mBitNumber COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * p = (cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip) ;
    cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * r = NULL ;
    macroMyNew (r, cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip (p->mAttribute_mInstructionLocation, p->mAttribute_mEmbeddedInstruction, p->mAttribute_mSkipIfSet, p->mAttribute_mRegisterDescription, p->mAttribute_mBitNumber COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_bool GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::reader_mSkipIfSet (UNUSED_LOCATION_ARGS) const {
  GALGAS_bool result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * p = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip) ;
...
GALGAS_bool cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::reader_mSkipIfSet (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSkipIfSet ;
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::reader_mRegisterDescription (UNUSED_LOCATION_ARGS) const {
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * p = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip) ;
...
GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::reader_mRegisterDescription (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegisterDescription ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::reader_mBitNumber (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * p = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip) ;
...
GALGAS_uint cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::reader_mBitNumber (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBitNumber ;
}
...
cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip (const GALGAS_location & in_mInstructionLocation,
                                                                                                                                  const GALGAS_ipic_31__38_SequentialInstruction & in_mEmbeddedInstruction,
                                                                                                                                  const GALGAS_bool & in_mSkipIfSet,
                                                                                                                                  const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & in_mRegisterDescription,
                                                                                                                                  const GALGAS_uint & in_mBitNumber
                                                                                                                                  COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38__5F_skip_5F_instruction (in_mInstructionLocation, in_mEmbeddedInstruction COMMA_THERE),
...
const C_galgas_type_descriptor * cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip ;
}

void cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::description (C_String & ioString,
                                                                                   const PMSInt32 inIndentation) const {
  ioString << "[@ipic18_intermediate_instruction_BitTestSkip:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//             @ipic18_intermediate_instruction_BitTestSkip type             *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip ("ipic18_intermediate_instruction_BitTestSkip",
                                                                                   & kTypeDescriptor_GALGAS_ipic_31__38__5F_skip_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip (*this)) ;
  }
  return result ;
}
...
GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip::extractObject (const GALGAS_object & inObject,
                                                                                                                                                    C_Compiler * inCompiler
                                                                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip result ;
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip * p = (const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("ipic18_intermediate_instruction_BitTestSkip", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA * p = (const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::objectCompare (const GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA (void) :
GALGAS_ipic_31__38__5F_skip_5F_instruction () {
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA (const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA * inSourcePtr) :
GALGAS_ipic_31__38__5F_skip_5F_instruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA) ;
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                                                    const GALGAS_ipic_31__38_SequentialInstruction & inAttribute_mEmbeddedInstruction,
                                                                                                                    const GALGAS_FA_5F_instruction_5F_base_5F_code & inAttribute_mFAinstruction,
                                                                                                                    const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & inAttribute_mRegisterDescription
                                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mEmbeddedInstruction.isValid () && inAttribute_mFAinstruction.isValid () && inAttribute_mRegisterDescription.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA (inAttribute_mInstructionLocation, inAttribute_mEmbeddedInstruction, inAttribute_mFAinstruction, inAttribute_mRegisterDescription COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA * p = (cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA) ;
    cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA * r = NULL ;
    macroMyNew (r, cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA (p->mAttribute_mInstructionLocation, p->mAttribute_mEmbeddedInstruction, p->mAttribute_mFAinstruction, p->mAttribute_mRegisterDescription COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_FA_5F_instruction_5F_base_5F_code GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::reader_mFAinstruction (UNUSED_LOCATION_ARGS) const {
  GALGAS_FA_5F_instruction_5F_base_5F_code result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA * p = (const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA) ;
    result = p->mAttribute_mFAinstruction ;
  }
  return result ;
...
GALGAS_FA_5F_instruction_5F_base_5F_code cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA::reader_mFAinstruction (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFAinstruction ;
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::reader_mRegisterDescription (UNUSED_LOCATION_ARGS) const {
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA * p = (const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA) ;
...
GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA::reader_mRegisterDescription (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegisterDescription ;
}
...
cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA::cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA (const GALGAS_location & in_mInstructionLocation,
                                                                                                const GALGAS_ipic_31__38_SequentialInstruction & in_mEmbeddedInstruction,
                                                                                                const GALGAS_FA_5F_instruction_5F_base_5F_code & in_mFAinstruction,
                                                                                                const GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression & in_mRegisterDescription
                                                                                                COMMA_LOCATION_ARGS) :
...
const C_galgas_type_descriptor * cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA ;
}

void cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FA::description (C_String & ioString,
                                                                  const PMSInt32 inIndentation) const {
  ioString << "[@ipic18_skip_instruction_FA:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << ", " ;
  mAttribute_mEmbeddedInstruction.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     @ipic18_skip_instruction_FA type                      *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA ("ipic18_skip_instruction_FA",
                                                                  & kTypeDescriptor_GALGAS_ipic_31__38__5F_skip_5F_instruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA (*this)) ;
  }
  return result ;
}
...
GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::extractObject (const GALGAS_object & inObject,
                                                                                                                  C_Compiler * inCompiler
                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA result ;
  const GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA * p = (const GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("ipic18_skip_instruction_FA", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_FDA_5F_base_5F_code GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FDA::reader_mInstruction_5F_FDA_5F_base_5F_code (UNUSED_LOCATION_ARGS) const {
  GALGAS_instruction_5F_FDA_5F_base_5F_code result ;
  if (NULL != mObjectPtr) {
...
GALGAS_instruction_5F_FDA_5F_base_5F_code cPtr_ipic_31__38__5F_skip_5F_instruction_5F_FDA::reader_mInstruction_5F_FDA_5F_base_5F_code (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstruction_5F_FDA_5F_base_5F_code ;
}
