...
void routine_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution constinArgument_inSymbolTable,
  ...
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
  outArgument_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (378)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (378)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (378)), inCompiler COMMA_SOURCE_FILE_AT_LINE (378)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (378)) ;
  outArgument_outDisplacementOK = GALGAS_bool (kIsStrictInf, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L))).operator_and (GALGAS_bool (kIsStrictSup, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (379)))) COMMA_SOURCE_FILE_AT_LINE (379)) ;
}
...
static void categoryMethod_ipic_31__38_SequentialInstruction_generateCode (const cPtr_ipic_31__38_SequentialInstruction * /* inObject */,
                                                                           ...
                                                                           C_Compiler * /* inCompiler */
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outCode = GALGAS_codeList::constructor_emptyList (SOURCE_FILE_AT_LINE (361)) ;
}
//---------------------------------------------------------------------------*
