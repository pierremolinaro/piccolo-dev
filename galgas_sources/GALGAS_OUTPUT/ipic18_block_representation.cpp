...
GALGAS_bool function_pic_31__38__5F_checkBCC (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_sint var_displacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (483)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (483)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (483)), inCompiler COMMA_SOURCE_FILE_AT_LINE (483)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (483)) ;
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 127L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (484)))) COMMA_SOURCE_FILE_AT_LINE (484)) ;
//---
...
GALGAS_bool function_pic_31__38__5F_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_sint var_displacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (497)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (497)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (497)), inCompiler COMMA_SOURCE_FILE_AT_LINE (497)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (497)) ;
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1023L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (498)))) COMMA_SOURCE_FILE_AT_LINE (498)) ;
//---
  return result_outDisplacementOK ;
}
...
GALGAS_sint function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  result_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (510)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (510)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (510)), inCompiler COMMA_SOURCE_FILE_AT_LINE (510)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (510)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_RCALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (574)), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (574)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (575)))) COMMA_SOURCE_FILE_AT_LINE (575)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    RCALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (580)) COMMA_SOURCE_FILE_AT_LINE (580)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((uint32_t) 55296U).operator_or (var_displacement.operator_and (GALGAS_sint ((int32_t) 2047L) COMMA_SOURCE_FILE_AT_LINE (581)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_SOURCE_FILE_AT_LINE (579)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_BRA_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
  ...
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    BRA ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (599)) COMMA_SOURCE_FILE_AT_LINE (599)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((uint32_t) 53248U).operator_or (var_displacement.operator_and (GALGAS_sint ((int32_t) 2047L) COMMA_SOURCE_FILE_AT_LINE (600)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (598)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_CALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
  ...
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 60416U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (612)).operator_and (GALGAS_uint ((uint32_t) 255U) COMMA_SOURCE_FILE_AT_LINE (612)) COMMA_SOURCE_FILE_AT_LINE (612)) COMMA_SOURCE_FILE_AT_LINE (612)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 9U) COMMA_SOURCE_FILE_AT_LINE (613)) COMMA_SOURCE_FILE_AT_LINE (613)) COMMA_SOURCE_FILE_AT_LINE (613)) ;
...
GALGAS_codeList function_pic_31__38__5F_GOTO_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
  ...
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 61184U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE_AT_LINE (628)).operator_and (GALGAS_uint ((uint32_t) 255U) COMMA_SOURCE_FILE_AT_LINE (628)) COMMA_SOURCE_FILE_AT_LINE (628)) COMMA_SOURCE_FILE_AT_LINE (628)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 9U) COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)) ;
