...
GALGAS_ipic_31__38_ConditionalBranch::GALGAS_ipic_31__38_ConditionalBranch (void) :
mEnum (kNotBuilt) {
}

//---------------------------------------------------------------------------*

GALGAS_ipic_31__38_ConditionalBranch GALGAS_ipic_31__38_ConditionalBranch::constructor_bz (UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ConditionalBranch result ;
...
GALGAS_ipic_31__38_ConditionalBranch GALGAS_ipic_31__38_ConditionalBranch::constructor_bn (UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ConditionalBranch result ;
...
GALGAS_ipic_31__38_ConditionalBranch GALGAS_ipic_31__38_ConditionalBranch::constructor_bc (UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ConditionalBranch result ;
...
GALGAS_ipic_31__38_ConditionalBranch GALGAS_ipic_31__38_ConditionalBranch::constructor_bov (UNUSED_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ConditionalBranch result ;
...
static const char * gEnumNameArrayFor_ipic_31__38_ConditionalBranch [5] = {
  "(not built)",
  "bz",
  "bn",
  "bc",
...
void GALGAS_ipic_31__38_ConditionalBranch::description (C_String & ioString,
                                                        const PMSInt32 /* inIndentation */) const {
  ioString << "<enum @ipic18ConditionalBranch: " << gEnumNameArrayFor_ipic_31__38_ConditionalBranch [mEnum] << ">" ;
}

//---------------------------------------------------------------------------*

typeComparisonResult GALGAS_ipic_31__38_ConditionalBranch::objectCompare (const GALGAS_ipic_31__38_ConditionalBranch & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                       @ipic18ConditionalBranch type                       *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ipic_31__38_ConditionalBranch ("ipic18ConditionalBranch",
                                                      NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ipic_31__38_ConditionalBranch::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ipic_31__38_ConditionalBranch ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ipic_31__38_ConditionalBranch::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ipic_31__38_ConditionalBranch (*this)) ;
  }
  return result ;
}
...
GALGAS_ipic_31__38_ConditionalBranch GALGAS_ipic_31__38_ConditionalBranch::extractObject (const GALGAS_object & inObject,
                                                                                          C_Compiler * inCompiler
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ConditionalBranch result ;
  const GALGAS_ipic_31__38_ConditionalBranch * p = (const GALGAS_ipic_31__38_ConditionalBranch *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ipic_31__38_ConditionalBranch *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("ipic18ConditionalBranch", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void routine_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution constinArgument_inSymbolTable,
  ...
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (386)) ;
  outArgument_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (387)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (387)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (387)), inCompiler COMMA_SOURCE_FILE_AT_LINE (387)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (387)) ;
  outArgument_outDisplacementOK = GALGAS_bool (kIsStrictInf, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L))).operator_and (GALGAS_bool (kIsSupOrEqual, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (388)))) COMMA_SOURCE_FILE_AT_LINE (388)) ;
}
...
GALGAS_codeList function_pic_31__38__5F_RCALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
  ...
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (403)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (403)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (403)), inCompiler COMMA_SOURCE_FILE_AT_LINE (403)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (403)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (404)))) COMMA_SOURCE_FILE_AT_LINE (404)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string (") for RCALL instruction to '") COMMA_SOURCE_FILE_AT_LINE (406)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (406)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (405)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("RCALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (409)) COMMA_SOURCE_FILE_AT_LINE (409)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 55296U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (410)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (408)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_BRA_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (422)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (422)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (422)), inCompiler COMMA_SOURCE_FILE_AT_LINE (422)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (422)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (423)))) COMMA_SOURCE_FILE_AT_LINE (423)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (424)) COMMA_SOURCE_FILE_AT_LINE (424)).operator_concat (GALGAS_string (") for BRA instruction to '") COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (424)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("BRA ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (428)) COMMA_SOURCE_FILE_AT_LINE (428)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 53248U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (429)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (429)) COMMA_SOURCE_FILE_AT_LINE (429)) COMMA_SOURCE_FILE_AT_LINE (429)) COMMA_SOURCE_FILE_AT_LINE (427)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_CALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (440)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 60416U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (441)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (442)) COMMA_SOURCE_FILE_AT_LINE (442)) COMMA_SOURCE_FILE_AT_LINE (442)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("CALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (444)) COMMA_SOURCE_FILE_AT_LINE (444)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (443)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_GOTO_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (456)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61184U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (457)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (457)) COMMA_SOURCE_FILE_AT_LINE (457)) COMMA_SOURCE_FILE_AT_LINE (457)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (458)) COMMA_SOURCE_FILE_AT_LINE (458)) COMMA_SOURCE_FILE_AT_LINE (458)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("GOTO ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (460)) COMMA_SOURCE_FILE_AT_LINE (460)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (459)) ;
//---
  return result_outCode ;
}
...
GALGAS_ipic_31__38_ConditionalJumpTerminator GALGAS_ipic_31__38_ConditionalJumpTerminator::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                                            ...
                                                                                                            const GALGAS_ipic_31__38_ConditionalBranch & inAttribute_mConditionalBranch
                                                                                                            COMMA_LOCATION_ARGS) {
...
GALGAS_ipic_31__38_ConditionalBranch GALGAS_ipic_31__38_ConditionalJumpTerminator::reader_mConditionalBranch (UNUSED_LOCATION_ARGS) const {
  GALGAS_ipic_31__38_ConditionalBranch result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38_ConditionalJumpTerminator * p = (const cPtr_ipic_31__38_ConditionalJumpTerminator *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38_ConditionalJumpTerminator) ;
...
GALGAS_ipic_31__38_ConditionalBranch cPtr_ipic_31__38_ConditionalJumpTerminator::reader_mConditionalBranch (UNUSED_LOCATION_ARGS) const {
...
cPtr_ipic_31__38_ConditionalJumpTerminator::cPtr_ipic_31__38_ConditionalJumpTerminator (const GALGAS_location & in_mInstructionLocation,
                                                                                        ...
                                                                                        const GALGAS_ipic_31__38_ConditionalBranch & in_mConditionalBranch
                                                                                        COMMA_LOCATION_ARGS) :
...
static void categoryMethod_ipic_31__38_AbstractBlockTerminator_generateCode (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                             ...
                                                                             C_Compiler * /* inCompiler */
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outCode = GALGAS_codeList::constructor_emptyList (SOURCE_FILE_AT_LINE (370)) ;
}
//---------------------------------------------------------------------------*
