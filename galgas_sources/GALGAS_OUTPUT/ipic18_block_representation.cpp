...
GALGAS_bool function_pic_31__38__5F_checkBCC (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 482)) ;
  GALGAS_sint var_displacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 483)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 483)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 483)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 483)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 483)) ;
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 127L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 484)))) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 484)) ;
//---
...
GALGAS_bool function_pic_31__38__5F_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_bool result_outDisplacementOK ; // Returned variable
  GALGAS_uint var_targetAddress ;
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 496)) ;
  GALGAS_sint var_displacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 497)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 497)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 497)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 497)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 497)) ;
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1023L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 498)))) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 498)) ;
//---
  return result_outDisplacementOK ;
}
...
GALGAS_sint function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 509)) ;
  result_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 510)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 510)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 510)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 510)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 510)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_Bcc_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inConditionalBranchInstructionAddress,
  ...
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 527)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 527)).substract_operation (constinArgument_inConditionalBranchInstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 527)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 527)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 527)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((int32_t) 127L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((int32_t) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 528)))) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 528)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large for conditional branch instruction")  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 529)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    if (constinArgument_inConditionalBranch.isValid ()) {
      ...
      case GALGAS_conditional_5F_branch::kEnum_bz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnz (SOURCE_FILE ("ipic18_block_representation.gSemantics", 535)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bz (SOURCE_FILE ("ipic18_block_representation.gSemantics", 536)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnn (SOURCE_FILE ("ipic18_block_representation.gSemantics", 537)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bn (SOURCE_FILE ("ipic18_block_representation.gSemantics", 538)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnc (SOURCE_FILE ("ipic18_block_representation.gSemantics", 539)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bc (SOURCE_FILE ("ipic18_block_representation.gSemantics", 540)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnov (SOURCE_FILE ("ipic18_block_representation.gSemantics", 541)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bov (SOURCE_FILE ("ipic18_block_representation.gSemantics", 542)) ;
        } break ;
      }
    }
  ...
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (var_mnemonic  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 561)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 561)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 561))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 561)), GALGAS_uintlist::constructor_listWithValue (var_baseCode.operator_or (var_displacement.operator_and (GALGAS_sint ((int32_t) 255L) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 562)).reader_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 562)) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 562))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 562))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 560)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_RCALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 574)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 574)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 574)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 574)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 574)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 575)))) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 575)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 576))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 576)).operator_concat (GALGAS_string (") for RCALL instruction to '")  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 576)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 577))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 577)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)")  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 577))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 576)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    RCALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 580))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 580)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((uint32_t) 55296U).operator_or (var_displacement.operator_and (GALGAS_sint ((int32_t) 2047L) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 581)).reader_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 581)) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 581))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 581))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 579)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_BRA_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 593)).substract_operation (GALGAS_sint ((int32_t) 2L), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 593)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 593)), inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 593)).right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 593)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((int32_t) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 594)))) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 594)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 595))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 595)).operator_concat (GALGAS_string (") for BRA instruction to '")  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 595)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 596))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 596)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)")  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 596))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 595)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    BRA ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 599))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 599)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((uint32_t) 53248U).operator_or (var_displacement.operator_and (GALGAS_sint ((int32_t) 2047L) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 600)).reader_uint (inCompiler COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 600)) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 600))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 600))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 598)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_CALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE ("ipic18_block_representation.gSemantics", 611)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 60416U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 612)).operator_and (GALGAS_uint ((uint32_t) 255U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 612)) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 612))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 612)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 9U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 613)) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 613))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 613)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    CALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 615))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 615)), var_binaryCode  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 614)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_GOTO_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE ("ipic18_block_representation.gSemantics", 627)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 61184U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 628)).operator_and (GALGAS_uint ((uint32_t) 255U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 628)) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 628))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 628)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((uint32_t) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((uint32_t) 9U) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 629)) COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 629))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 629)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    GOTO ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE ("ipic18_block_representation.gSemantics", 631))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 631)), var_binaryCode  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 630)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_definition_5F_label (const GALGAS_lstring & constinArgument_inTargetLabel,
                                                             ...
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  result_outCode = GALGAS_codeList::constructor_listWithValue (constinArgument_inTargetLabel.mAttribute_string.operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 643)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE ("ipic18_block_representation.gSemantics", 644))  COMMA_SOURCE_FILE ("ipic18_block_representation.gSemantics", 642)) ;
//---
  return result_outCode ;
}
