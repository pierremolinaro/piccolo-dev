...
void routine_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution constinArgument_inSymbolTable,
  ...
  outArgument_outDisplacementOK = GALGAS_bool (kIsStrictInf, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L))).operator_and (GALGAS_bool (kIsStrictSup, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (383)))) COMMA_SOURCE_FILE_AT_LINE (383)) ;
}
