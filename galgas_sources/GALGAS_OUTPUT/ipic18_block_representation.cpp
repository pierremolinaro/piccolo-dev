...
void routine_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution constinArgument_inSymbolTable,
  ...
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
  outArgument_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (382)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (382)), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (382)) ;
  outArgument_outDisplacementOK = GALGAS_bool (kIsStrictInf, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L))).operator_and (GALGAS_bool (kIsSupOrEqual, outArgument_outDisplacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (383)))) COMMA_SOURCE_FILE_AT_LINE (383)) ;
}
...
GALGAS_codeList function_pic_31__38__5F_Bcc_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inConditionalBranchInstructionAddress,
  ...
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (400)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (400)).substract_operation (constinArgument_inConditionalBranchInstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (400)), inCompiler COMMA_SOURCE_FILE_AT_LINE (400)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (400)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 127L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (401)))) COMMA_SOURCE_FILE_AT_LINE (401)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large for conditional branch instruction") COMMA_SOURCE_FILE_AT_LINE (402)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    if (constinArgument_inConditionalBranch.isValid ()) {
      ...
      case GALGAS_conditional_5F_branch::kEnum_bz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnz (SOURCE_FILE_AT_LINE (408)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bz (SOURCE_FILE_AT_LINE (409)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnn (SOURCE_FILE_AT_LINE (410)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bn (SOURCE_FILE_AT_LINE (411)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnc (SOURCE_FILE_AT_LINE (412)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bc (SOURCE_FILE_AT_LINE (413)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnov (SOURCE_FILE_AT_LINE (414)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bov (SOURCE_FILE_AT_LINE (415)) ;
        } break ;
      }
    }
  ...
  result_outCode = GALGAS_codeList::constructor_listWithValue (var_mnemonic.operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (434)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (434)) COMMA_SOURCE_FILE_AT_LINE (434)), GALGAS_uintlist::constructor_listWithValue (var_baseCode.operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 255L) COMMA_SOURCE_FILE_AT_LINE (435)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (433)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_RCALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (447)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (447)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (447)), inCompiler COMMA_SOURCE_FILE_AT_LINE (447)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (447)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (448)))) COMMA_SOURCE_FILE_AT_LINE (448)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (449)) COMMA_SOURCE_FILE_AT_LINE (449)).operator_concat (GALGAS_string (") for RCALL instruction to '") COMMA_SOURCE_FILE_AT_LINE (450)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (450)) COMMA_SOURCE_FILE_AT_LINE (450)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (450)) COMMA_SOURCE_FILE_AT_LINE (449)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("RCALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 55296U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (454)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (452)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_BRA_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (466)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (466)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (466)), inCompiler COMMA_SOURCE_FILE_AT_LINE (466)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (466)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (467)))) COMMA_SOURCE_FILE_AT_LINE (467)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (468)) COMMA_SOURCE_FILE_AT_LINE (468)).operator_concat (GALGAS_string (") for BRA instruction to '") COMMA_SOURCE_FILE_AT_LINE (469)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (469)) COMMA_SOURCE_FILE_AT_LINE (469)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (469)) COMMA_SOURCE_FILE_AT_LINE (468)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("BRA ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (472)) COMMA_SOURCE_FILE_AT_LINE (472)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 53248U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (473)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_SOURCE_FILE_AT_LINE (471)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_CALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (484)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 60416U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (485)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (485)) COMMA_SOURCE_FILE_AT_LINE (485)) COMMA_SOURCE_FILE_AT_LINE (485)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (486)) COMMA_SOURCE_FILE_AT_LINE (486)) COMMA_SOURCE_FILE_AT_LINE (486)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("CALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (488)) COMMA_SOURCE_FILE_AT_LINE (488)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (487)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_GOTO_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (500)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61184U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (501)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (501)) COMMA_SOURCE_FILE_AT_LINE (501)) COMMA_SOURCE_FILE_AT_LINE (501)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("GOTO ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (504)) COMMA_SOURCE_FILE_AT_LINE (504)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (503)) ;
//---
  return result_outCode ;
}
...
typeComparisonResult cPtr_ipic_31__38_ConditionalJumpTerminator::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_mOptimizableInstructionIfConditionFalse.objectCompare (p->mAttribute_mOptimizableInstructionIfConditionFalse) ;
  }
  return result ;
}
...
GALGAS_ipic_31__38_ConditionalJumpTerminator GALGAS_ipic_31__38_ConditionalJumpTerminator::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                                            ...
                                                                                                            const GALGAS_ipic_31__38_SingleInstructionTerminator & inAttribute_mOptimizableInstructionIfConditionFalse
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_ipic_31__38_ConditionalJumpTerminator result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mBranchMode.isValid () && inAttribute_mConditionalBranch.isValid () && inAttribute_mTargetLabelWhenTrue.isValid () && inAttribute_mOptimizableInstructionIfConditionFalse.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_ipic_31__38_ConditionalJumpTerminator (inAttribute_mInstructionLocation, inAttribute_mBranchMode, inAttribute_mConditionalBranch, inAttribute_mTargetLabelWhenTrue, inAttribute_mOptimizableInstructionIfConditionFalse COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_ipic_31__38_ConditionalJumpTerminator::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_ipic_31__38_ConditionalJumpTerminator (p->mAttribute_mInstructionLocation, p->mAttribute_mBranchMode, p->mAttribute_mConditionalBranch, p->mAttribute_mTargetLabelWhenTrue, p->mAttribute_mOptimizableInstructionIfConditionFalse COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_ipic_31__38_SingleInstructionTerminator GALGAS_ipic_31__38_ConditionalJumpTerminator::reader_mOptimizableInstructionIfConditionFalse (UNUSED_LOCATION_ARGS) const {
  GALGAS_ipic_31__38_SingleInstructionTerminator result ;
  if (NULL != mObjectPtr) {
    const cPtr_ipic_31__38_ConditionalJumpTerminator * p = (const cPtr_ipic_31__38_ConditionalJumpTerminator *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_ipic_31__38_ConditionalJumpTerminator) ;
    result = p->mAttribute_mOptimizableInstructionIfConditionFalse ;
  }
  return result ;
}
...
GALGAS_ipic_31__38_SingleInstructionTerminator cPtr_ipic_31__38_ConditionalJumpTerminator::reader_mOptimizableInstructionIfConditionFalse (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptimizableInstructionIfConditionFalse ;
}
...
cPtr_ipic_31__38_ConditionalJumpTerminator::cPtr_ipic_31__38_ConditionalJumpTerminator (const GALGAS_location & in_mInstructionLocation,
                                                                                        ...
                                                                                        const GALGAS_ipic_31__38_SingleInstructionTerminator & in_mOptimizableInstructionIfConditionFalse
                                                                                        COMMA_LOCATION_ARGS) :
cPtr_ipic_31__38_AbstractBlockTerminator (in_mInstructionLocation COMMA_THERE),
...
mAttribute_mOptimizableInstructionIfConditionFalse (in_mOptimizableInstructionIfConditionFalse) {
}
...
void cPtr_ipic_31__38_ConditionalJumpTerminator::description (C_String & ioString,
  ...
  ioString << ", " ;
  mAttribute_mOptimizableInstructionIfConditionFalse.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inAddress, constin_inSymbolTable, out_outCode, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_ipic_31__38_AbstractBlockTerminator_generateCode (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                             ...
                                                                             C_Compiler * /* inCompiler */
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outCode = GALGAS_codeList::constructor_emptyList (SOURCE_FILE_AT_LINE (365)) ;
}
//---------------------------------------------------------------------------*
