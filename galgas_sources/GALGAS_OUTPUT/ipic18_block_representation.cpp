...
GALGAS_bool function_pic_31__38__5F_checkBCC (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 127L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (484)))) COMMA_SOURCE_FILE_AT_LINE (484)) ;
//---
...
GALGAS_bool function_pic_31__38__5F_checkBRA_5F_RCALL (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_bool result_outDisplacementOK ; // Returned variable
  GALGAS_uint var_targetAddress ;
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (496)) ;
  GALGAS_sint var_displacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (497)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (497)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (497)), inCompiler COMMA_SOURCE_FILE_AT_LINE (497)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (497)) ;
  result_outDisplacementOK = GALGAS_bool (kIsInfOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_and (GALGAS_bool (kIsSupOrEqual, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (498)))) COMMA_SOURCE_FILE_AT_LINE (498)) ;
//---
  return result_outDisplacementOK ;
}
...
GALGAS_sint function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (const GALGAS_symbolTableForRelativesResolution & constinArgument_inSymbolTable,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inSymbolTable.method_searchKey (constinArgument_inTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (509)) ;
  result_outDisplacement = var_targetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (510)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (510)).substract_operation (constinArgument_inCurrentAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (510)), inCompiler COMMA_SOURCE_FILE_AT_LINE (510)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (510)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_Bcc_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inConditionalBranchInstructionAddress,
  ...
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (527)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (527)).substract_operation (constinArgument_inConditionalBranchInstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (527)), inCompiler COMMA_SOURCE_FILE_AT_LINE (527)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (527)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 127L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (528)))) COMMA_SOURCE_FILE_AT_LINE (528)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large for conditional branch instruction") COMMA_SOURCE_FILE_AT_LINE (529)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    if (constinArgument_inConditionalBranch.isValid ()) {
      ...
      case GALGAS_conditional_5F_branch::kEnum_bz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnz (SOURCE_FILE_AT_LINE (535)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnz: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bz (SOURCE_FILE_AT_LINE (536)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnn (SOURCE_FILE_AT_LINE (537)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnn: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bn (SOURCE_FILE_AT_LINE (538)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnc (SOURCE_FILE_AT_LINE (539)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnc: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bc (SOURCE_FILE_AT_LINE (540)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bnov (SOURCE_FILE_AT_LINE (541)) ;
        } break ;
      case GALGAS_conditional_5F_branch::kEnum_bnov: {
        var_conditionalBranch = GALGAS_conditional_5F_branch::constructor_bov (SOURCE_FILE_AT_LINE (542)) ;
        } break ;
      }
    }
  ...
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (var_mnemonic COMMA_SOURCE_FILE_AT_LINE (561)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (561)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (561)) COMMA_SOURCE_FILE_AT_LINE (561)), GALGAS_uintlist::constructor_listWithValue (var_baseCode.operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 255L) COMMA_SOURCE_FILE_AT_LINE (562)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (562)) COMMA_SOURCE_FILE_AT_LINE (562)) COMMA_SOURCE_FILE_AT_LINE (562)) COMMA_SOURCE_FILE_AT_LINE (560)) ;
//---
...
GALGAS_codeList function_pic_31__38__5F_RCALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (574)), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (574)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (575)))) COMMA_SOURCE_FILE_AT_LINE (575)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (576)) COMMA_SOURCE_FILE_AT_LINE (576)).operator_concat (GALGAS_string (") for RCALL instruction to '") COMMA_SOURCE_FILE_AT_LINE (576)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (577)) COMMA_SOURCE_FILE_AT_LINE (577)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (577)) COMMA_SOURCE_FILE_AT_LINE (576)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    RCALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (580)) COMMA_SOURCE_FILE_AT_LINE (580)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 55296U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (581)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_SOURCE_FILE_AT_LINE (579)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_BRA_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inRCALLinstructionAddress,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_sint var_displacement = constinArgument_inTargetAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (593)).substract_operation (GALGAS_sint ((PMSInt32) 2L), inCompiler COMMA_SOURCE_FILE_AT_LINE (593)).substract_operation (constinArgument_inRCALLinstructionAddress.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (593)), inCompiler COMMA_SOURCE_FILE_AT_LINE (593)).right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (593)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1023L))).operator_or (GALGAS_bool (kIsStrictInf, var_displacement.objectCompare (GALGAS_sint ((PMSInt32) 1024L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (594)))) COMMA_SOURCE_FILE_AT_LINE (594)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (constinArgument_inTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("** INTERNAL ERROR ** displacement too large (").operator_concat (var_displacement.reader_string (SOURCE_FILE_AT_LINE (595)) COMMA_SOURCE_FILE_AT_LINE (595)).operator_concat (GALGAS_string (") for BRA instruction to '") COMMA_SOURCE_FILE_AT_LINE (595)).operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (596)) COMMA_SOURCE_FILE_AT_LINE (596)).operator_concat (GALGAS_string ("' (should be between -1024 and 1023)") COMMA_SOURCE_FILE_AT_LINE (596)) COMMA_SOURCE_FILE_AT_LINE (595)) ;
  }
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    BRA ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (599)) COMMA_SOURCE_FILE_AT_LINE (599)), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 53248U).operator_or (var_displacement.operator_and (GALGAS_sint ((PMSInt32) 2047L) COMMA_SOURCE_FILE_AT_LINE (600)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (598)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_CALL_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (611)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 60416U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (612)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (612)) COMMA_SOURCE_FILE_AT_LINE (612)) COMMA_SOURCE_FILE_AT_LINE (612)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (613)) COMMA_SOURCE_FILE_AT_LINE (613)) COMMA_SOURCE_FILE_AT_LINE (613)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    CALL ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (615)) COMMA_SOURCE_FILE_AT_LINE (615)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (614)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_GOTO_5F_instruction_5F_code (const GALGAS_uint & constinArgument_inTargetAddress,
                                                                     ...
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  GALGAS_uintlist var_binaryCode = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (627)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61184U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (628)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (628)) COMMA_SOURCE_FILE_AT_LINE (628)) COMMA_SOURCE_FILE_AT_LINE (628)) ;
  var_binaryCode.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (constinArgument_inTargetAddress.right_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)) ;
  result_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    GOTO ").operator_concat (constinArgument_inTargetLabel.reader_string (SOURCE_FILE_AT_LINE (631)) COMMA_SOURCE_FILE_AT_LINE (631)), var_binaryCode COMMA_SOURCE_FILE_AT_LINE (630)) ;
//---
  return result_outCode ;
}
...
GALGAS_codeList function_pic_31__38__5F_definition_5F_label (const GALGAS_lstring & constinArgument_inTargetLabel,
                                                             ...
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_codeList result_outCode ; // Returned variable
  result_outCode = GALGAS_codeList::constructor_listWithValue (constinArgument_inTargetLabel.mAttribute_string.operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (643)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (644)) COMMA_SOURCE_FILE_AT_LINE (642)) ;
//---
  return result_outCode ;
}
...
void enterCategoryReader_isEqualToTerminator (const PMSInt32 inClassIndex,
