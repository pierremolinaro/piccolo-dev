...
void routine_pic18_build_assembly_code (C_Compiler & inLexique,
  ...
  var_cas_bccLabelIndex = GGS_uint (0U) ;
  {
    ...
    while (((operand_14871 = enumerator_14871.nextObject ()))) {
      ...
      const GGS_ipic18_instruction  temp_14910 = operand_14871->mInstruction ;
      if (temp_14910.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__buildAssemblyCode method = findCategoryMethod__ipic18_instruction__buildAssemblyCode (temp_14910.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_14910 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (511)) ;
        }
      }
    }
  }
  ...
  var_cas_outAssemblyCode.appendCString (";--- Prefefined registers\n") ;
  {
    ...
    while (((operand_15100 = enumerator_15100.nextObject ()))) {
      ...
      const GGS_uintlist  temp_15157 = operand_15100->mInfo.mRegisterAddressList ;
      if (temp_15157.isBuilt ()) {
        temp_15157 (HERE)->method_first (inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (517)) ;
      }
  ...
  var_cas_outAssemblyCode.appendCString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_15426 = enumerator_15426.nextObject ()))) {
      ...
      if (((var_cas_inPredefinedRegisters.reader_hasKey (inLexique, operand_15426->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524))).operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  temp_15546 = operand_15426->mInfo.mRegisterAddressList ;
        if (temp_15546.isBuilt ()) {
          temp_15546 (HERE)->method_first (inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (525)) ;
        }
