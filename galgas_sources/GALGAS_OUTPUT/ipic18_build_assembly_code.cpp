...
category_method__ipic_pseudo_ORG__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_849 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_849->mOrigin.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (30))) ;
...
category_method__ipic_pseudo_LABEL__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_1082 != NULL) {
    var_cas_ioString._dotAssign_operation (operand_1082->mLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (39))) ;
    var_cas_ioString.appendCString (":\n") ;
  }
}
...
category_method__ipic18_instruction_FDA__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_1306 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1306->mInstruction_FDA_base_code.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (48))) ;
    var_cas_ioString.appendCString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_1306->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (48))) ;
    if (((operand_1306->m_W_isDestination)._operator_and (operand_1306->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (49)))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", W, BSR_ACCESS") ;
    }else if ((operand_1306->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (51))).isBuiltAndTrue ()) {
...
category_method__ipic18_instruction_MOVFF__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_1899 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_1899->mSourceRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (68))) ;
    var_cas_ioString.appendCString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_1899->mDestinationRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (70))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__ipic18_instruction_FBA__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_2278 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_2278->mBitOrientedOp.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (80))) ;
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_2278->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (81))) ;
    var_cas_ioString.appendCString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_2278->mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (82))) ;
    if ((operand_2278->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (83))).isBuiltAndTrue ()) {
...
category_method__ipic18_instruction_BitTestSkip__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_2732 != NULL) {
    ...
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_2732->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (101))) ;
    var_cas_ioString.appendCString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_2732->mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102))) ;
    if ((operand_2732->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (103))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", BSR_ACCESS") ;
    }
    var_cas_ioString.appendCString ("\n") ;
  }
...
category_method__ipic18_instruction_FA__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_3240 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_3240->mFAinstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (115))) ;
    var_cas_ioString.appendCString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_3240->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (115))) ;
    if ((operand_3240->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (116))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", BSR_ACCESS") ;
    }
    var_cas_ioString.appendCString ("\n") ;
  }
...
category_method__ipic18_instruction_conditionalBranch__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_3642 != NULL) {
    ...
    case GGS_condionalBranchMode::enum_native:
      {
      var_cas_ioString.appendCString ("  ") ;
      var_cas_ioString._dotAssign_operation (operand_3642->mConditionalBranch.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (130))) ;
      var_cas_ioString.appendCString (" ") ;
      var_cas_ioString._dotAssign_operation (operand_3642->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_condionalBranchMode::enum_ipicBRA:
      ...
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134))) ;
      var_cas_ioBccLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
      var_cas_ioString.appendCString ("  ") ;
      var_cas_ioString._dotAssign_operation (var_cas_complementary.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (135))) ;
      var_cas_ioString.appendCString (" ") ;
      var_cas_ioString._dotAssign_operation (var_cas_aLabel) ;
      var_cas_ioString.appendCString ("\n") ;
      var_cas_ioString.appendCString ("  BRA ") ;
      var_cas_ioString._dotAssign_operation (operand_3642->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136))) ;
      var_cas_ioString.appendCString ("\n") ;
      var_cas_ioString._dotAssign_operation (var_cas_aLabel) ;
      var_cas_ioString.appendCString (":\n") ;
      }
    ...
    case GGS_condionalBranchMode::enum_ipicGOTO:
      ...
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141))) ;
      var_cas_ioBccLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
      var_cas_ioString.appendCString ("  ") ;
      var_cas_ioString._dotAssign_operation (var_cas_complementary.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (142))) ;
      var_cas_ioString.appendCString (" ") ;
      var_cas_ioString._dotAssign_operation (var_cas_aLabel) ;
      var_cas_ioString.appendCString ("\n") ;
      var_cas_ioString.appendCString ("  GOTO ") ;
      var_cas_ioString._dotAssign_operation (operand_3642->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143))) ;
      var_cas_ioString.appendCString ("\n") ;
      var_cas_ioString._dotAssign_operation (var_cas_aLabel) ;
      var_cas_ioString.appendCString (":\n") ;
      }
...
category_method__ipic_jump_test_register__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_4712 != NULL) {
    var_cas_ioString.appendCString ("  "
    "TSTFSZ ") ;
    var_cas_ioString._dotAssign_operation (operand_4712->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (154))) ;
    if ((operand_4712->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (155))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", BSR_ACCESS") ;
    }
    var_cas_ioString.appendCString ("\n") ;
    if ((operand_4712->mBranchIfZero).isBuiltAndTrue ()) {
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160))) ;
      var_cas_ioBccLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
      var_cas_ioString.appendCString ("  BRA ") ;
      var_cas_ioString._dotAssign_operation (var_cas_aLabel) ;
      var_cas_ioString.appendCString ("\n") ;
...
category_method__ipic_incDecRegisterInCondition__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_5575 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_5575->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (192))) ;
    if (((operand_5575->m_W_isDestination)._operator_and (operand_5575->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (193)))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", W, BSR_ACCESS") ;
    }else if ((operand_5575->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (195))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", F, BSR_ACCESS") ;
...
category_method__ipic_registerComparisonCondition__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_6544 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_6544->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (224))) ;
    if ((operand_6544->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", BSR_ACCESS") ;
    }
    var_cas_ioString.appendCString ("\n") ;
    ...
    if ((var_cas_usesIntermediateBRA).isBuiltAndTrue ()) {
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231))) ;
      var_cas_ioBccLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
      var_cas_ioString.appendCString ("  BRA ") ;
      var_cas_ioString._dotAssign_operation (var_cas_aLabel) ;
      var_cas_ioString.appendCString ("\n") ;
...
category_method__ipic_JUMP__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_7762 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_ipicRelative:
      {
      var_cas_ioString.appendCString ("  BRA   ") ;
      var_cas_ioString._dotAssign_operation (operand_7762->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_jumpInstructionKind::enum_ipicAbsolute:
      {
      var_cas_ioString.appendCString ("  GOTO  ") ;
      var_cas_ioString._dotAssign_operation (operand_7762->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (256))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_jumpInstructionKind::enum_relative:
      {
      var_cas_ioString.appendCString ("  BRA   ") ;
      var_cas_ioString._dotAssign_operation (operand_7762->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_jumpInstructionKind::enum_absolute:
      {
      var_cas_ioString.appendCString ("  GOTO  ") ;
      var_cas_ioString._dotAssign_operation (operand_7762->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (258))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
...
category_method__ipic_JSR__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_8282 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_ipicRelative:
      ...
      var_cas_ioString._dotAssign_operation (operand_8282->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_jumpInstructionKind::enum_ipicAbsolute:
      ...
      var_cas_ioString._dotAssign_operation (operand_8282->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (270))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_jumpInstructionKind::enum_relative:
      {
      var_cas_ioString.appendCString ("  RCALL ") ;
      var_cas_ioString._dotAssign_operation (operand_8282->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_jumpInstructionKind::enum_absolute:
      {
      var_cas_ioString.appendCString ("  CALL  ") ;
      var_cas_ioString._dotAssign_operation (operand_8282->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (272))) ;
      var_cas_ioString.appendCString ("\n") ;
      }
      break ;
    case GGS_jumpInstructionKind::kNotBuilt:
...
category_method__ipic18_instruction_MOVLB__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_8818 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_8818->mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (282)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (282))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__ipic18_instruction_literalOperation__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_11076 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_11076->mLiteralInstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (376))) ;
    var_cas_ioString.appendCString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_11076->mLiteralValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (376))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__ipic18_instruction_LFSR__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_11357 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_11357->mFSRindex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (385)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (385))) ;
    var_cas_ioString.appendCString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_11357->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (386))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__ipic18_instruction_MNOP__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_11645 != NULL) {
    if (((operand_11645->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (395)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    while (_condition_11949.isBuiltAndTrue ()) {
      _condition_11949 = (var_cas_idx)._operator_strictInf (operand_11645->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (400))) ;
      if (_condition_11949.isBuiltAndTrue ()) {
        if (_variant_11949.uintValue () == 0) {
          ...
          _variant_11949._decrement_operation (inLexique COMMA_HERE) ;
          var_cas_ioString.appendCString ("  NOP\n") ;
          var_cas_idx._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (403)) ;
        }
      }
    }
  }
...
category_method__ipic18_instruction_TBLRD__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_12086 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_12086->mOption.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (413))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__ipic18_instruction_TBLWT__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_12327 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_12327->mOption.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (422))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
  ...
  if (operand_12577 != NULL) {
    ...
    }
    {
      ...
      while (((operand_12790 = enumerator_12790.nextObject ()))) {
        ...
        var_cas_ioString._dotAssign_operation (operand_12790->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (437))) ;
        var_cas_ioString.appendCString ("\n") ;
      }
    }
  }
  ...
  if (operand_13003 != NULL) {
    ...
    }
    {
      ...
      while (((operand_13215 = enumerator_13215.nextObject ()))) {
        ...
        var_cas_ioString.appendCString ("  BRA ") ;
        var_cas_ioString._dotAssign_operation (operand_13215->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (453))) ;
        var_cas_ioString.appendCString ("\n") ;
      }
    }
  }
  ...
  if (operand_13424 != NULL) {
    ...
    }
    {
      ...
      while (((operand_13636 = enumerator_13636.nextObject ()))) {
        ...
        var_cas_ioString.appendCString ("  GOTO ") ;
        var_cas_ioString._dotAssign_operation (operand_13636->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (469))) ;
        var_cas_ioString.appendCString ("\n") ;
      }
    }
  }
  ...
  if (operand_13847 != NULL) {
    ...
    var_cas_index = GGS_uint (0U) ;
    {
      ...
      while (((operand_14080 = enumerator_14080.nextObject ()))) {
        ...
        var_cas_index._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (486)) ;
        var_cas_ioString.appendCString ("  RCALL ") ;
        var_cas_ioString._dotAssign_operation (operand_14080->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (487))) ;
        var_cas_ioString.appendCString ("\n") ;
        if (((var_cas_index)._operator_strictInf (operand_13847->mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (488)))).isBuiltAndTrue ()) {
          var_cas_ioString.appendCString ("  BRA   ") ;
...
void routine_pic18_build_assembly_code (C_Compiler & inLexique,
  ...
  var_cas_bccLabelIndex = GGS_uint (0U) ;
  {
    ...
    while (((operand_14871 = enumerator_14871.nextObject ()))) {
      ...
      if (_temp_14910.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (inLexique, _temp_14910 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (511)) ;
        }
      }
    }
  }
  ...
  var_cas_outAssemblyCode.appendCString (";--- Prefefined registers\n") ;
  {
    ...
    while (((operand_15100 = enumerator_15100.nextObject ()))) {
      ...
      if (_temp_15157.isBuilt ()) {
        _temp_15157 (HERE)->method_first (inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (517)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_15100->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (518))) ;
      var_cas_outAssemblyCode.appendCString (" EQU ") ;
      var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (518))) ;
      var_cas_outAssemblyCode.appendCString ("\n") ;
    }
  }
  var_cas_outAssemblyCode.appendCString ("\n") ;
  var_cas_outAssemblyCode.appendCString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_15426 = enumerator_15426.nextObject ()))) {
      ...
      if (((var_cas_inPredefinedRegisters.reader_hasKey (inLexique, operand_15426->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_15546 = operand_15426->mInfo.mRegisterAddressList ;
        if (_temp_15546.isBuilt ()) {
          _temp_15546 (HERE)->method_first (inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (525)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_15426->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (526))) ;
        var_cas_outAssemblyCode.appendCString (" EQU ") ;
        var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (526))) ;
        var_cas_outAssemblyCode.appendCString ("\n") ;
      }
    }
  }
  ...
  var_cas_outAssemblyCode.appendCString ("BSR_ACCESS EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (535)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      "\n") ;
    {
      ...
      while (((operand_16058 = enumerator_16058.nextObject ()))) {
        ...
        var_cas_outAssemblyCode._dotAssign_operation (operand_16058->mInfo.mRegisterAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (538))) ;
        var_cas_outAssemblyCode.appendCString (", ") ;
        var_cas_outAssemblyCode._dotAssign_operation ((operand_16058->mInfo.mRegisterValue)._operator_and (GGS_uint (255U)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (538))) ;
        var_cas_outAssemblyCode.appendCString ("\n") ;
      }
    }
  }
