...
void routine_pic18_build_assembly_code (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic18_instructionList::cEnumerator enumerator_14245 (var_cas_inInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_14245 = NULL ;
    while (((operand_14245 = enumerator_14245.nextObject ()))) {
      macroValidPointer (operand_14245) ;
      const GGS_ipic18_instruction  _temp_14284 = operand_14245->mInstruction ;
      if (_temp_14284._isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__buildAssemblyCode _method = findCategoryMethod__ipic18_instruction__buildAssemblyCode (_temp_14284._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_14284 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (489)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14474 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_14474 = NULL ;
    while (((operand_14474 = enumerator_14474.nextObject ()))) {
      macroValidPointer (operand_14474) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_14531 = operand_14474->mInfo.mRegisterAddressList ;
      if (_temp_14531._isBuilt ()) {
        _temp_14531 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (495)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_14474->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (496))) ;
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14800 (var_cas_inAllRegisters, true) ;
    const GGS_registerTable::cElement * operand_14800 = NULL ;
    while (((operand_14800 = enumerator_14800.nextObject ()))) {
      macroValidPointer (operand_14800) ;
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_14800->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_14920 = operand_14800->mInfo.mRegisterAddressList ;
        if (_temp_14920._isBuilt ()) {
          _temp_14920 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (503)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_14800->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (504))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
        var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (504))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
  ...
  var_cas_outAssemblyCode.writeString ("BSR_ACCESS EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (513)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outAssemblyCode.writeString (";--- Configuration\n"
      "\n") ;
    {
      GGS_actualConfigurationMap::cEnumerator enumerator_15432 (var_cas_inActualConfigurationMap, true) ;
      const GGS_actualConfigurationMap::cElement * operand_15432 = NULL ;
      while (((operand_15432 = enumerator_15432.nextObject ()))) {
        macroValidPointer (operand_15432) ;
        var_cas_outAssemblyCode.writeString ("  __config ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_15432->mInfo.mRegisterAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (516))) ;
        var_cas_outAssemblyCode.writeString (", ") ;
        var_cas_outAssemblyCode._dotAssign_operation ((operand_15432->mInfo.mRegisterValue)._operator_and (GGS_uint (true, 255U)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (516))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
