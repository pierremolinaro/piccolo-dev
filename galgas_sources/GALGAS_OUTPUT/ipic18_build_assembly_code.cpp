...
category_method__ipic18_instruction_FDA__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_1306 != NULL) {
    ...
    if (((operand_1306->m_W_isDestination).operator_and (operand_1306->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (49)))).isBuiltAndTrue ()) {
...
category_method__ipic18_instruction_conditionalBranch__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_3642 != NULL) {
    ...
    case GGS_condionalBranchMode::enum_ipicBRA:
      ...
      var_cas_aLabel = (GGS_string ("_bcc_label_")).operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134))) ;
    ...
    case GGS_condionalBranchMode::enum_ipicGOTO:
      ...
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_")).operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141))) ;
...
category_method__ipic_jump_test_register__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_4712 != NULL) {
    ...
    if ((operand_4712->mBranchIfZero).isBuiltAndTrue ()) {
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_")).operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160))) ;
...
category_method__ipic_incDecRegisterInCondition__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_5575 != NULL) {
    if (((operand_5575->mBranchIfZero).operator_and (operand_5575->mIncrement)).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString ("  "
      "INFSNZ ") ;
    }else if (((operand_5575->mBranchIfZero).operator_and ((operand_5575->mIncrement).operator_not ())).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString ("  "
      "DCFSNZ ") ;
    }else if ((((operand_5575->mBranchIfZero).operator_not ()).operator_and (operand_5575->mIncrement)).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString ("  "
      "INCFSZ ") ;
    }else{
      var_cas_ioString.appendCString ("  "
    ...
    if (((operand_5575->m_W_isDestination).operator_and (operand_5575->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (193)))).isBuiltAndTrue ()) {
      var_cas_ioString.appendCString (", W, BSR_ACCESS") ;
...
category_method__ipic_registerComparisonCondition__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_6544 != NULL) {
    ...
    if ((var_cas_usesIntermediateBRA).isBuiltAndTrue ()) {
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_")).operator_concat (var_cas_ioBccLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231))) ;
...
category_method__ipic18_instruction_MNOP__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_11645 != NULL) {
    if (((operand_11645->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (395))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
  ...
  if (operand_13847 != NULL) {
    ...
    var_cas_index = GGS_uint (0U) ;
    {
      ...
      while (((operand_14080 = enumerator_14080.nextObject ()))) {
        ...
        var_cas_index.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (486)) ;
        var_cas_ioString.appendCString ("  RCALL ") ;
        var_cas_ioString.dotAssign_operation (operand_14080->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (487))) ;
        var_cas_ioString.appendCString ("\n") ;
        if (((var_cas_index).operator_strictInf (operand_13847->mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (488)))).isBuiltAndTrue ()) {
          var_cas_ioString.appendCString ("  BRA   ") ;
...
void routine_pic18_build_assembly_code (C_Compiler & inLexique,
  ...
  var_cas_outAssemblyCode.appendCString (";--- Prefefined registers\n") ;
  {
    ...
    while (((operand_15100 = enumerator_15100.nextObject ()))) {
      ...
      var_cas_outAssemblyCode.dotAssign_operation (operand_15100->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (518))) ;
  ...
  var_cas_outAssemblyCode.appendCString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_15426 = enumerator_15426.nextObject ()))) {
      ...
      if (((var_cas_inPredefinedRegisters.reader_hasKey (inLexique, operand_15426->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524))).operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        ...
        var_cas_outAssemblyCode.dotAssign_operation (operand_15426->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (526))) ;
        var_cas_outAssemblyCode.appendCString (" EQU ") ;
  ...
  var_cas_outAssemblyCode.appendCString ("BSR_ACCESS EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (535))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      "\n") ;
    {
      ...
      while (((operand_16058 = enumerator_16058.nextObject ()))) {
        ...
        var_cas_outAssemblyCode.dotAssign_operation (operand_16058->mInfo.mRegisterAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (538))) ;
        var_cas_outAssemblyCode.appendCString (", ") ;
        var_cas_outAssemblyCode.dotAssign_operation ((operand_16058->mInfo.mRegisterValue).operator_and (GGS_uint (255U)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (538))) ;
        var_cas_outAssemblyCode.appendCString ("\n") ;
      }
    }
  }
