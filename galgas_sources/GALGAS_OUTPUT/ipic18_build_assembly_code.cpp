  ...
  if (operand_13847 != NULL) {
    ...
    GGS_uint  var_cas_idx = GGS_uint (0U) ;
    {
      ...
      while (((operand_14078 = enumerator_14078.nextObject ()))) {
        ...
        var_cas_ioString.appendCString ("\n") ;
        const GGS_bool cond_14260 = (var_cas_idx).operator_strictInf (operand_13847->mTargetLabels.reader_length ()) ;
...
void routine_pic18_build_assembly_code (C_Compiler & inLexique,
  ...
  var_cas_outAssemblyCode.appendCString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_15420 = enumerator_15420.nextObject ()))) {
      ...
      const GGS_bool cond_15651 = (var_cas_inPredefinedRegisters.reader_hasKey (operand_15420->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (524)))).operator_not () ;
  ...
  var_cas_outAssemblyCode.appendCString ("BSR_ACCESS EQU 1\n"
    "\n") ;
  const GGS_bool cond_16200 = (var_cas_inActualConfigurationMap.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
...
C_PrologueEpilogue prologueEpilogueObjectFor_ipic18_build_assembly_code (prologueRoutineFor_ipic18_build_assembly_code,
                                   NULL) ;
