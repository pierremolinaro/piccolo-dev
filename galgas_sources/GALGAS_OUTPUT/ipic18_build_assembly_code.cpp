...
category_method__ipic18_instruction_conditionalBranch__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_3642 != NULL) {
    ...
    case GGS_condionalBranchMode::enum_ipicBRA:
      ...
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (134))) ;
    ...
    case GGS_condionalBranchMode::enum_ipicGOTO:
      ...
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (141))) ;
...
category_method__ipic_jump_test_register__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_4712 != NULL) {
    ...
    if ((operand_4712->mBranchIfZero).isBuiltAndTrue ()) {
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (160))) ;
...
category_method__ipic_registerComparisonCondition__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_6544 != NULL) {
    ...
    if ((var_cas_usesIntermediateBRA).isBuiltAndTrue ()) {
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string ("_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (231))) ;
...
category_method__ipic18_instruction_MNOP__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_11645 != NULL) {
    if (((operand_11645->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (395)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      operand_11645->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("No generated code") COMMA_SOURCE_FILE_AT_LINE (396)) ;
    }
...
void routine_pic18_build_assembly_code (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_outAssemblyCode = ((GGS_string ("  PROCESSOR "))._operator_concat (var_cas_inProcessorName))._operator_concat (GGS_string ("\n")) ;
  ...
  var_cas_outAssemblyCode.appendCString ("BSR_ACCESS EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (535)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      "\n") ;
    {
      ...
      while (((operand_16058 = enumerator_16058.nextObject ()))) {
        ...
        var_cas_outAssemblyCode.appendCString (", ") ;
        var_cas_outAssemblyCode._dotAssign_operation ((operand_16058->mInfo.mRegisterValue)._operator_and (GGS_uint (255U)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (538))) ;
        var_cas_outAssemblyCode.appendCString ("\n") ;
      }
    }
  }
