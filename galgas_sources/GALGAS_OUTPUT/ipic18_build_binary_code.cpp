...
category_method__ipic18_instruction_FDA__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_3136 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_3136->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (102)))._operator_and (GGS_uint (255U))) ;
...
category_method__ipic18_instruction_FA__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_3675 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_3675->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)))._operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
...
category_method__ipic18_instruction_MOVFF__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_4146 != NULL) {
    if ((GGS_uint (49152U))._operator_or (operand_4146->mSourceRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (127))).isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (49152U))._operator_or (operand_4146->mSourceRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (127))) COMMA_SOURCE_FILE_AT_LINE (127)) ;
    }
    if ((GGS_uint (61440U))._operator_or (operand_4146->mDestinationRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (128))).isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (61440U))._operator_or (operand_4146->mDestinationRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (128))) COMMA_SOURCE_FILE_AT_LINE (128)) ;
    }
  }
}
...
category_method__ipic18_instruction_FBA__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_4532 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_4532->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (142)))._operator_and (GGS_uint (255U))) ;
    var_cas_code = (var_cas_code)._operator_or (operand_4532->mBitNumber._left_shift_operation (_inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (143))) ;
    if (var_cas_code.isBuilt ()) {
...
category_method__ipic18_instruction_BitTestSkip__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_5046 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_5046->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (158)))._operator_and (GGS_uint (255U))) ;
    var_cas_code = (var_cas_code)._operator_or (operand_5046->mBitNumber._left_shift_operation (_inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (159))) ;
    if (var_cas_code.isBuilt ()) {
...
void routine_emitConditionalBranchInstruction (C_Compiler & _inLexique,
  ...
  var_cas_displacement = var_cas_inTargetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (186))._substract_operation (_inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (186))._substract_operation (_inLexique, var_cas_inConditionalBranchInstructionAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186))._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (186)) ;
  if ((((var_cas_displacement)._operator_strictSup (GGS_sint (127L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (128L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("displacement too large for conditional branch instruction") COMMA_SOURCE_FILE_AT_LINE (189)) ;
  }
  ...
  if ((var_cas_baseCode)._operator_or ((var_cas_displacement)._operator_and (GGS_sint (255L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))).isBuilt ()) {
    ::routine_emitCode (_inLexique,  (var_cas_baseCode)._operator_or ((var_cas_displacement)._operator_and (GGS_sint (255L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))) COMMA_SOURCE_FILE_AT_LINE (193)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emitBRAinstruction (C_Compiler & _inLexique,
  ...
  #endif
  GGS_sint  var_cas_displacement ;
  var_cas_displacement = var_cas_inTargetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (203))._substract_operation (_inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (203))._substract_operation (_inLexique, var_cas_inBRAinstructionAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203))._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (203)) ;
  if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("displacement too large for BRA instruction") COMMA_SOURCE_FILE_AT_LINE (206)) ;
  }
  if ((GGS_uint (53248U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (208))).isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (53248U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (208))) COMMA_SOURCE_FILE_AT_LINE (208)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emit_pic18_GOTOinstruction (C_Compiler & _inLexique,
  ...
  #endif
  if ((GGS_uint (61184U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (216)))._operator_and (GGS_uint (255U))).isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (61184U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (216)))._operator_and (GGS_uint (255U))) COMMA_SOURCE_FILE_AT_LINE (216)) ;
  }
  if ((GGS_uint (61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (217))).isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (217))) COMMA_SOURCE_FILE_AT_LINE (217)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__ipic18_instruction_conditionalBranch__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_7554 != NULL) {
    ...
    case GGS_condionalBranchMode::enum_ipicBRA:
      ...
      ::routine_emitConditionalBranchInstruction (_inLexique,  var_cas_ioAddress,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (242)),  operand_7554->mTargetLabel.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (243)),  var_cas_complementary COMMA_SOURCE_FILE_AT_LINE (240)) ;
      ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (247)),  var_cas_targetAddress,  operand_7554->mTargetLabel.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (246)) ;
      }
      break ;
    case GGS_condionalBranchMode::enum_ipicGOTO:
      ...
      ::routine_emitConditionalBranchInstruction (_inLexique,  var_cas_ioAddress,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (256)),  operand_7554->mTargetLabel.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (257)),  var_cas_complementary COMMA_SOURCE_FILE_AT_LINE (254)) ;
...
category_method__ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_8740 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_relative:
      {
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (276))._substract_operation (_inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (276))._substract_operation (_inLexique, var_cas_ioAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276))._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (276)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (2048L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (2048L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        operand_8740->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("displacement too large for RCALL instruction") COMMA_SOURCE_FILE_AT_LINE (279)) ;
      }
...
void routine_emit_pic18_CALLinstruction (C_Compiler & _inLexique,
  ...
  #endif
  if ((GGS_uint (60416U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (295)))._operator_and (GGS_uint (255U))).isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (60416U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (295)))._operator_and (GGS_uint (255U))) COMMA_SOURCE_FILE_AT_LINE (295)) ;
  }
  if ((GGS_uint (61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (296))).isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (296))) COMMA_SOURCE_FILE_AT_LINE (296)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emitRCALLinstruction (C_Compiler & _inLexique,
  ...
  #endif
  GGS_sint  var_cas_displacement ;
  var_cas_displacement = var_cas_inTargetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (306))._substract_operation (_inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (306))._substract_operation (_inLexique, var_cas_inRCALLinstructionAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306))._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (306)) ;
  if ((((var_cas_displacement)._operator_strictSup (GGS_sint (1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (1024L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
    var_cas_inTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("displacement too large ("))._operator_concat (var_cas_displacement.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (308))))._operator_concat (GGS_string (") for RCALL instruction to '")))._operator_concat (var_cas_inTargetLabel))._operator_concat (GGS_string ("' (should be between -1024 and 1023)")) COMMA_SOURCE_FILE_AT_LINE (310)) ;
  }
  if ((GGS_uint (55296U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (312))).isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (55296U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (312))) COMMA_SOURCE_FILE_AT_LINE (312)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_10404 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_relative:
      {
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (325))._substract_operation (_inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (325))._substract_operation (_inLexique, var_cas_ioAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325))._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (325)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (2048L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (2048L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        operand_10404->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("displacement too large for RCALL instruction") COMMA_SOURCE_FILE_AT_LINE (328)) ;
      }
...
category_method__ipic_jump_test_register__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_11163 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_11163->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (351)))._operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
    ...
    if ((operand_11163->mBranchIfZero).isBuiltAndTrue ()) {
      ...
      if ((operand_11163->mUsesBra).isBuiltAndTrue ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      }else{
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (361)) ;
      }
      ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (364)),  var_cas_intermediateTargetAddress,  operand_11163->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (363)) ;
      if ((operand_11163->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (369)),  var_cas_targetAddress,  operand_11163->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (369)) ;
      }else{
        ::routine_emit_pic18_GOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (371)) ;
      }
    }else{
      if ((operand_11163->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (375)),  var_cas_targetAddress,  operand_11163->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (375)) ;
      }else{
...
category_method__ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_12449 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_12449->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (404)))._operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
    ...
    if ((operand_12449->mUsesBra).isBuiltAndTrue ()) {
      ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (410)),  var_cas_targetAddress,  operand_12449->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (410)) ;
    }else{
...
category_method__ipic_registerComparisonCondition__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_13502 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_13502->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (435)))._operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
    ...
    if ((var_cas_usesIntermediateBRA).isBuiltAndTrue ()) {
      ...
      if ((operand_13502->mUsesBra).isBuiltAndTrue ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }else{
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (446)) ;
      }
      ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (449)),  var_cas_intermediateTargetAddress,  operand_13502->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (448)) ;
      if ((operand_13502->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (454)),  var_cas_targetAddress,  operand_13502->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (454)) ;
      }else{
        ::routine_emit_pic18_GOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (456)) ;
      }
    }else{
      if ((operand_13502->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (460)),  var_cas_targetAddress,  operand_13502->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (460)) ;
      }else{
...
category_method__ipic18_instruction_CLRWDT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_15245 != NULL) {
    if (GGS_uint (4U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (473)) ;
    }
  }
}
...
category_method__ipic18_instruction_DAW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_15509 != NULL) {
    if (GGS_uint (7U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (482)) ;
    }
  }
}
...
category_method__ipic18_instruction_NOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_15773 != NULL) {
    if (GGS_uint (0U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (491)) ;
    }
  }
}
...
category_method__ipic18_instruction_POP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_16037 != NULL) {
    if (GGS_uint (6U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (500)) ;
    }
  }
}
...
category_method__ipic18_instruction_PUSH__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_16302 != NULL) {
    if (GGS_uint (5U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (5U) COMMA_SOURCE_FILE_AT_LINE (509)) ;
    }
  }
}
...
category_method__ipic18_instruction_RESET__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_16568 != NULL) {
    if (GGS_uint (255U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (255U) COMMA_SOURCE_FILE_AT_LINE (518)) ;
    }
  }
}
...
category_method__ipic18_instruction_RETURN__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_16835 != NULL) {
    if (GGS_uint (18U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (18U) COMMA_SOURCE_FILE_AT_LINE (527)) ;
    }
  }
}
...
category_method__ipic18_instruction_SLEEP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_17487 != NULL) {
    if (GGS_uint (3U).isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (3U) COMMA_SOURCE_FILE_AT_LINE (552)) ;
    }
  }
}
...
category_method__ipic18_instruction_LFSR__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_18118 != NULL) {
    if (((GGS_uint (60928U))._operator_or (operand_18118->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (573))._left_shift_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (573))))._operator_or (operand_18118->mValue._right_shift_operation (_inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (573))).isBuilt ()) {
      ::routine_emitCode (_inLexique,  ((GGS_uint (60928U))._operator_or (operand_18118->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (573))._left_shift_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (573))))._operator_or (operand_18118->mValue._right_shift_operation (_inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (573))) COMMA_SOURCE_FILE_AT_LINE (573)) ;
    }
    if ((GGS_uint (61440U))._operator_or ((operand_18118->mValue)._operator_and (GGS_uint (255U))).isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (61440U))._operator_or ((operand_18118->mValue)._operator_and (GGS_uint (255U))) COMMA_SOURCE_FILE_AT_LINE (574)) ;
    }
  }
}
...
category_method__ipic18_instruction_MOVLB__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_18464 != NULL) {
    if ((GGS_uint (256U))._operator_or (operand_18464->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (583))).isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (256U))._operator_or (operand_18464->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (583))) COMMA_SOURCE_FILE_AT_LINE (583)) ;
    }
  }
}
...
category_method__ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_18743 != NULL) {
    ...
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_18743->mLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("Internal second pass error: the '"))._operator_concat (operand_18743->mLabel))._operator_concat (GGS_string ("' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (596))))._operator_concat (GGS_string (" value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (597))))._operator_concat (GGS_string (" in first pass")) COMMA_SOURCE_FILE_AT_LINE (598)) ;
    }
  }
}
  ...
  if (operand_19312 != NULL) {
    ...
    case GGS_tableAccessOption::enum_simpleAccess:
      ...
      if (GGS_uint (8U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (608)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (9U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (609)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (10U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (10U) COMMA_SOURCE_FILE_AT_LINE (610)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (11U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (11U) COMMA_SOURCE_FILE_AT_LINE (611)) ;
      }
      }
      break ;
  ...
  if (operand_19757 != NULL) {
    ...
    case GGS_tableAccessOption::enum_simpleAccess:
      ...
      if (GGS_uint (12U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (12U) COMMA_SOURCE_FILE_AT_LINE (622)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (13U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (13U) COMMA_SOURCE_FILE_AT_LINE (623)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (14U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (14U) COMMA_SOURCE_FILE_AT_LINE (624)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (15U).isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (15U) COMMA_SOURCE_FILE_AT_LINE (625)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::kNotBuilt:
...
category_method__ipic18_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_20201 != NULL) {
    if (((operand_20201->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (635)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      operand_20201->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("No generated code") COMMA_SOURCE_FILE_AT_LINE (636)) ;
    }
    ...
    while (_condition_20525.isBuiltAndTrue ()) {
      ...
      if (_condition_20525.isBuiltAndTrue ()) {
        if (_variant_20525.uintValue () == 0) {
          ...
          if (GGS_uint (0U).isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (642)) ;
          }
...
category_method__ipic18_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_20705 != NULL) {
    ...
    var_cas_target = GGS_lstring ::constructor_new (_inLexique, GGS_string ("_computed_goto_2"), operand_20705->mInstructionLocation COMMA_HERE) ;
    ...
    }
    {
      ...
      while (((operand_21098 = enumerator_21098.nextObject ()))) {
        ...
        if ((GGS_uint (3072U))._operator_or (operand_21098->mValue).isBuilt ()) {
          ::routine_emitCode (_inLexique,  (GGS_uint (3072U))._operator_or (operand_21098->mValue) COMMA_SOURCE_FILE_AT_LINE (662)) ;
        }
      }
    }
  }
...
category_method__ipic18_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_21320 != NULL) {
    GGS_lstring  var_cas_target ;
    var_cas_target = GGS_lstring ::constructor_new (_inLexique, GGS_string ("_computed_goto_2"), operand_21320->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
    ...
    var_cas_addressForComputingBRA = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (681)) ;
    if (((operand_21320->mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_addressForComputingBRA = var_cas_addressForComputingBRA._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683)) ;
    }
    {
      ...
      while (((operand_21893 = enumerator_21893.nextObject ()))) {
        ...
        var_cas_addressForComputingBRA = var_cas_addressForComputingBRA._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (693)) ;
      }
    }
  }
}
...
category_method__ipic18_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_22310 != NULL) {
    GGS_lstring  var_cas_target ;
    var_cas_target = GGS_lstring ::constructor_new (_inLexique, GGS_string ("_computed_goto_4"), operand_22310->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
...
category_method__ipic18_instruction_computed_rcall__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_23013 != NULL) {
    GGS_lstring  var_cas_target ;
    var_cas_target = GGS_lstring ::constructor_new (_inLexique, GGS_string ("_computed_goto_4"), operand_23013->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
    ...
    if ((operand_23013->mUsesRCALL).isBuiltAndTrue ()) {
      ...
      var_cas_currentInstructionAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (731)) ;
    }else{
      ::routine_emit_pic18_CALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (733)) ;
      var_cas_currentInstructionAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (734)) ;
    }
    GGS_uint  var_cas_nextInstructionAddress ;
    var_cas_nextInstructionAddress = var_cas_currentInstructionAddress._add_operation (_inLexique, operand_23013->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (736))._multiply_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (736)) COMMA_SOURCE_FILE_AT_LINE (736))._substract_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (736)) ;
    ...
    var_cas_index = GGS_uint (0U) ;
    {
      ...
      while (((operand_23654 = enumerator_23654.nextObject ()))) {
        ...
        var_cas_currentInstructionAddress = var_cas_currentInstructionAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (742)) ;
        if (((var_cas_index)._operator_strictInf (operand_23013->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (743)))).isBuiltAndTrue ()) {
          ...
          var_cas_currentInstructionAddress = var_cas_currentInstructionAddress._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (745)) ;
        }
      }
    }
  }
...
void routine_build_ipic18_binary_code (C_Compiler & _inLexique,
  ...
  var_cas_currentAddress = GGS_uint (0U) ;
  if (GGS_uint (0U).isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (772)) ;
  }
  {
  ...
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (781))))._operator_concat (GGS_string (" value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (783))))._operator_concat (GGS_string (" value in first pass")) COMMA_SOURCE_FILE_AT_LINE (784)) ;
  }else if (((var_cas_lastAddressForFirstPass)._operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("Program too large: "))._operator_concat (var_cas_lastAddressForFirstPass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (785))))._operator_concat (GGS_string (" bytes (rom size is ")))._operator_concat (var_cas_inROMsize.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (787))))._operator_concat (GGS_string (" bytes)")) COMMA_SOURCE_FILE_AT_LINE (788)) ;
  }
  {
