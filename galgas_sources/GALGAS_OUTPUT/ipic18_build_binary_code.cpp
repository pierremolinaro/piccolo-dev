...
category_method__ipic18_instruction_FDA__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_3136 != NULL) {
    ...
    if (((operand_3136->m_W_isDestination).operator_not ()).isBuiltAndTrue ()) {
...
category_method__ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8740 != NULL) {
    ...
    case GGS_jumpInstructionKind::enum_relative:
      ...
      if ((((var_cas_displacement).operator_strictSup (GGS_sint (2048L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (2048L).operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
...
category_method__ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_12449 != NULL) {
    GGS_uint  var_cas_code ;
    if (((operand_12449->mBranchIfZero).operator_and (operand_12449->mIncrement)).isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (18432U) ;
    }else if (((operand_12449->mBranchIfZero).operator_and ((operand_12449->mIncrement).operator_not ())).isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (19456U) ;
    }else if ((((operand_12449->mBranchIfZero).operator_not ()).operator_and (operand_12449->mIncrement)).isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (15360U) ;
    }else{
      var_cas_code = GGS_uint (11264U) ;
    }
    if (((operand_12449->m_W_isDestination).operator_not ()).isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (512U)) ;
    }
...
category_method__ipic18_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_20201 != NULL) {
    if (((operand_20201->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (635))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
...
category_method__ipic18_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_21320 != NULL) {
    ...
    if (((operand_21320->mUsesRCALL).operator_not ()).isBuiltAndTrue ()) {
  ...
  if (operand_23013 != NULL) {
    ...
    GGS_uint  var_cas_idx = GGS_uint (0U) ;
    {
      ...
      while (((operand_23652 = enumerator_23652.nextObject ()))) {
        ...
        if (((var_cas_idx).operator_strictInf (operand_23013->mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (743)))).isBuiltAndTrue ()) {
...
void routine_build_ipic18_binary_code (C_Compiler & inLexique,
  ...
  }else if (((var_cas_lastAddressForFirstPass).operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
