  ...
  if (operand_23013 != NULL) {
    ...
    GGS_uint  var_cas_index = GGS_uint (0U) ;
    {
      ...
      while (((operand_23654 = enumerator_23654.nextObject ()))) {
        ...
        var_cas_index.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (739)) ;
        const GGS_ipic18_symbolTable  temp_23708 = var_cas_inRoutineSymbolTable ;
        if (temp_23708.isBuilt ()) {
          temp_23708 (HERE)->method_searchKey (inLexique, operand_23654->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (740)) ;
        }
        ...
        if (((var_cas_index).operator_strictInf (operand_23013->mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (743)))).isBuiltAndTrue ()) {
...
void routine_build_ipic18_binary_code (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
  {
    ...
    while (((operand_24885 = enumerator_24885.nextObject ()))) {
      ...
      const GGS_ipic18_instruction  temp_24926 = operand_24885->mInstruction ;
      if (temp_24926.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__enterLabelAtAddress method = findCategoryMethod__ipic18_instruction__enterLabelAtAddress (temp_24926.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_24926 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (766)) ;
        }
      }
    }
  }
  ...
  }
  {
    ...
    while (((operand_25209 = enumerator_25209.nextObject ()))) {
      ...
      const GGS_ipic18_instruction  temp_25258 = operand_25209->mInstruction ;
      if (temp_25258.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress method = findCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress (temp_25258.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_25258 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (774)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic18_instruction  temp_25357 = operand_25209->mInstruction ;
      if (temp_25357.isBuilt ()) {
        temp_25357 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (776)) ;
      }
