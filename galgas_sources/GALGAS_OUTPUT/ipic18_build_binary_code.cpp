...
//                    february 22th, 2010, at 21h44'56"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__ipic_jump_test_register__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_12208 != NULL) {
    ...
    if (temp_12670.isBuilt ()) {
      temp_12670 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12208->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (396)) ;
    }
...
category_method__ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_13601 != NULL) {
    ...
    if (temp_14346.isBuilt ()) {
      temp_14346 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_13601->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (451)) ;
    }
...
category_method__ipic_registerComparisonCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_14727 != NULL) {
    ...
    if (temp_15541.isBuilt ()) {
      temp_15541 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14727->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (483)) ;
    }
...
category_method__ipic18_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_23101 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), operand_23101->mInstructionLocation COMMA_HERE) ;
...
category_method__ipic18_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_23790 != NULL) {
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), operand_23790->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
...
category_method__ipic18_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_24839 != NULL) {
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), operand_24839->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
...
category_method__ipic18_instruction_computed_rcall__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_25601 != NULL) {
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), operand_25601->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
