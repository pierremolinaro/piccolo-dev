...
//                    november 12th, 2009, at 19h57'45"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
const C_galgas_type_reference kTypeReference_ipic18_symbolTable ("ipic18_symbolTable") ;
...
category_method__ipic18_instruction_computed_rcall__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_23013 != NULL) {
    ...
    GGS_uint  var_cas_nextInstructionAddress = var_cas_currentInstructionAddress.add_operation (inLexique, operand_23013->mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (736)).multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (736)) COMMA_SOURCE_FILE_AT_LINE (736)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (736)) ;
    GGS_uint  var_cas_idx = GGS_uint (0U) ;
    {
      ...
      while (((operand_23652 = enumerator_23652.nextObject ()))) {
        ...
        const GGS_bool cond_24085 = (var_cas_idx).operator_strictInf (operand_23013->mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (743))) ;
