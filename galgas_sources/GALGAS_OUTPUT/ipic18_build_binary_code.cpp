...
//                    december 13th, 2008, at 21h59'36"                      *
//                                                                           *
//---------------------------------------------------------------------------*
  ...
  if (operand_22310 != NULL) {
    ...
    }
    {
      ...
      while (((operand_22701 = enumerator_22701.nextObject ()))) {
        ...
        const GGS_ipic18_symbolTable  _temp_22773 = var_cas_inRoutineSymbolTable ;
        if (_temp_22773._isBuilt ()) {
          _temp_22773 (HERE)->method_searchKey (_inLexique, operand_22701->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (713)) ;
        }
        ::routine_emit_pic18_GOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (714)) ;
      }
    }
  }
}
...
category_method__ipic18_instruction_computed_rcall__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic18_instruction_computed_rcall * operand_23046,
                                const GGS_ipic18_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23046 != NULL) {
    GGS_lstring  var_cas_target ;
    var_cas_target = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), operand_23046->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  _temp_23239 = var_cas_inRoutineSymbolTable ;
    if (_temp_23239._isBuilt ()) {
      _temp_23239 (HERE)->method_searchKey (_inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (728)) ;
    }
    GGS_uint  var_cas_currentInstructionAddress ;
    if ((operand_23046->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  var_cas_target COMMA_SOURCE_FILE_AT_LINE (731)) ;
      var_cas_currentInstructionAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (732)) ;
    }else{
      ::routine_emit_pic18_CALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (734)) ;
      var_cas_currentInstructionAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (735)) ;
    }
    GGS_uint  var_cas_nextInstructionAddress ;
    var_cas_nextInstructionAddress = var_cas_currentInstructionAddress._add_operation (_inLexique, operand_23046->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (737))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (737)) COMMA_SOURCE_FILE_AT_LINE (737))._substract_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (737)) ;
    GGS_uint  var_cas_index ;
    var_cas_index = GGS_uint (true, 0U) ;
    {
      GGS_lstringlist::cEnumerator enumerator_23687 (operand_23046->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_23687 = NULL ;
      while (((operand_23687 = enumerator_23687.nextObject ()))) {
        macroValidPointer (operand_23687) ;
        var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (740)) ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_ipic18_symbolTable  _temp_23774 = var_cas_inRoutineSymbolTable ;
        if (_temp_23774._isBuilt ()) {
          _temp_23774 (HERE)->method_searchKey (_inLexique, operand_23687->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (742)) ;
        }
        ::routine_emitRCALLinstruction (_inLexique,  var_cas_currentInstructionAddress,  var_cas_targetAddress,  operand_23687->mValue COMMA_SOURCE_FILE_AT_LINE (743)) ;
        var_cas_currentInstructionAddress = var_cas_currentInstructionAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (744)) ;
        if (((var_cas_index)._operator_strictInf (operand_23046->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (745)))).isBuiltAndTrue ()) {
          ::routine_emitBRAinstruction (_inLexique,  var_cas_currentInstructionAddress,  var_cas_nextInstructionAddress,  operand_23687->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)) ;
          var_cas_currentInstructionAddress = var_cas_currentInstructionAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (747)) ;
        }
      }
    }
  }
...
void routine_build_ipic18_binary_code (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic18_instructionList::cEnumerator enumerator_24951 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_24951 = NULL ;
    while (((operand_24951 = enumerator_24951.nextObject ()))) {
      macroValidPointer (operand_24951) ;
      const GGS_ipic18_instruction  _temp_24992 = operand_24951->mInstruction ;
      if (_temp_24992._isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__enterLabelAtAddress _method = findCategoryMethod__ipic18_instruction__enterLabelAtAddress (_temp_24992._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_24992 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (768)) ;
        }
      }
    }
  }
  ...
  var_cas_currentAddress = GGS_uint (true, 0U) ;
  if (GGS_uint (true, 0U)._isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (774)) ;
  }
  {
    GGS_ipic18_instructionList::cEnumerator enumerator_25275 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_25275 = NULL ;
    while (((operand_25275 = enumerator_25275.nextObject ()))) {
      macroValidPointer (operand_25275) ;
      const GGS_ipic18_instruction  _temp_25324 = operand_25275->mInstruction ;
      if (_temp_25324._isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress (_temp_25324._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_25324 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (776)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic18_instruction  _temp_25423 = operand_25275->mInstruction ;
      if (_temp_25423._isBuilt ()) {
        _temp_25423 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (778)) ;
      }
      var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (779)) ;
      ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (780)) ;
    }
  }
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (783))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (785))))._operator_concat (GGS_string (true, " value in first pass")) COMMA_SOURCE_FILE_AT_LINE (786)) ;
  }else if (((var_cas_lastAddressForFirstPass)._operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Program too large: "))._operator_concat (var_cas_lastAddressForFirstPass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (787))))._operator_concat (GGS_string (true, " bytes (rom size is ")))._operator_concat (var_cas_inROMsize.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (789))))._operator_concat (GGS_string (true, " bytes)")) COMMA_SOURCE_FILE_AT_LINE (790)) ;
  }
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_26120 (var_cas_inActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_26120 = NULL ;
    while (((operand_26120 = enumerator_26120.nextObject ()))) {
      macroValidPointer (operand_26120) ;
      if (operand_26120->mInfo.mRegisterAddress._isBuilt ()) {
        ::routine_setEmitAddress (_inLexique,  operand_26120->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (793)) ;
      }
      if (operand_26120->mInfo.mRegisterValue._isBuilt ()) {
        ::routine_emitByte (_inLexique,  operand_26120->mInfo.mRegisterValue COMMA_SOURCE_FILE_AT_LINE (794)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
