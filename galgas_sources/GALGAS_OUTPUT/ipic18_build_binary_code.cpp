...
const C_galgas_type_descriptor kTypeDescriptor_GGS_ipic18_symbolTable ("ipic18_symbolTable", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_ipic18_symbolTable::typeDescriptor (void) const {
...
enterCategoryMethod__ipic18_instruction__enterLabelAtAddress (typeCategoryMethod__ipic18_instruction__enterLabelAtAddress inRoutine,
  ...
  gDispatchTableForMethod__ipic18_instruction__enterLabelAtAddress.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__ipic18_instruction__enterLabelAtAddress (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__ipic18_instruction__enterLabelAtAddress.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
enterCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress (typeCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__ipic18_instruction__generateBinaryCodeAtAddress.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__ipic18_instruction__generateBinaryCodeAtAddress.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__ipic18_instruction_FDA__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_3136 != NULL) {
    ...
    const GGS_bool cond_3352 = operand_3136->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) ;
    if (cond_3352.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (256U)) ;
    }
    const GGS_bool cond_3423 = (operand_3136->m_W_isDestination).operator_not () ;
    if (cond_3423.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (512U)) ;
    }
    var_cas_code = (var_cas_code).operator_or ((operand_3136->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (102))).operator_and (GGS_uint (255U))) ;
...
category_method__ipic18_instruction_FA__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_3675 != NULL) {
    ...
    const GGS_bool cond_3891 = operand_3675->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (114)) ;
    if (cond_3891.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (256U)) ;
    }
    var_cas_code = (var_cas_code).operator_or ((operand_3675->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (117))).operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
...
category_method__ipic18_instruction_MOVFF__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_4146 != NULL) {
    if ((GGS_uint (49152U)).operator_or (operand_4146->mSourceRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (127))).isBuilt ()) {
      ::routine_emitCode (inLexique,  (GGS_uint (49152U)).operator_or (operand_4146->mSourceRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (127))) COMMA_SOURCE_FILE_AT_LINE (127)) ;
    }
    if ((GGS_uint (61440U)).operator_or (operand_4146->mDestinationRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (128))).isBuilt ()) {
      ::routine_emitCode (inLexique,  (GGS_uint (61440U)).operator_or (operand_4146->mDestinationRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (128))) COMMA_SOURCE_FILE_AT_LINE (128)) ;
    }
  }
}
...
category_method__ipic18_instruction_FBA__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_4532 != NULL) {
    ...
    const GGS_bool cond_4748 = operand_4532->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
    if (cond_4748.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (256U)) ;
    }
    var_cas_code = (var_cas_code).operator_or ((operand_4532->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).operator_and (GGS_uint (255U))) ;
    var_cas_code = (var_cas_code).operator_or (operand_4532->mBitNumber.left_shift_operation (inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (143))) ;
    if (var_cas_code.isBuilt ()) {
...
category_method__ipic18_instruction_BitTestSkip__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_5046 != NULL) {
    ...
    const GGS_bool cond_5262 = operand_5046->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (155)) ;
    if (cond_5262.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (256U)) ;
    }
    var_cas_code = (var_cas_code).operator_or ((operand_5046->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (158))).operator_and (GGS_uint (255U))) ;
    var_cas_code = (var_cas_code).operator_or (operand_5046->mBitNumber.left_shift_operation (inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (159))) ;
    if (var_cas_code.isBuilt ()) {
...
void routine_emitConditionalBranchInstruction (C_Compiler & inLexique,
  ...
  #endif
  GGS_sint  var_cas_displacement = var_cas_inTargetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (186)).substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (186)).substract_operation (inLexique, var_cas_inConditionalBranchInstructionAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)).right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (186)) ;
  const GGS_bool cond_6441 = ((var_cas_displacement).operator_strictSup (GGS_sint (127L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (128L).operator_unary_minus (inLexique COMMA_HERE))) ;
  ...
  if ((var_cas_baseCode).operator_or ((var_cas_displacement).operator_and (GGS_sint (255L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (193))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (var_cas_baseCode).operator_or ((var_cas_displacement).operator_and (GGS_sint (255L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (193))) COMMA_SOURCE_FILE_AT_LINE (193)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emitBRAinstruction (C_Compiler & inLexique,
  ...
  #endif
  GGS_sint  var_cas_displacement = var_cas_inTargetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (203)).substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (203)).substract_operation (inLexique, var_cas_inBRAinstructionAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)).right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (203)) ;
  const GGS_bool cond_7039 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
  ...
  if ((GGS_uint (53248U)).operator_or ((var_cas_displacement).operator_and (GGS_sint (2047L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (208))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (53248U)).operator_or ((var_cas_displacement).operator_and (GGS_sint (2047L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (208))) COMMA_SOURCE_FILE_AT_LINE (208)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emit_pic18_GOTOinstruction (C_Compiler & inLexique,
  ...
  #endif
  if ((GGS_uint (61184U)).operator_or ((var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (216))).operator_and (GGS_uint (255U))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (61184U)).operator_or ((var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (216))).operator_and (GGS_uint (255U))) COMMA_SOURCE_FILE_AT_LINE (216)) ;
  }
  if ((GGS_uint (61440U)).operator_or (var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (217))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (61440U)).operator_or (var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (217))) COMMA_SOURCE_FILE_AT_LINE (217)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__ipic18_instruction_conditionalBranch__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_7554 != NULL) {
    ...
    const GGS_ipic18_symbolTable  temp_7679 = var_cas_inRoutineSymbolTable ;
    if (temp_7679.isBuilt ()) {
      temp_7679 (HERE)->method_searchKey (inLexique, operand_7554->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (227)) ;
    }
    ...
    case GGS_condionalBranchMode::enum_ipicBRA:
      ...
      ::routine_emitConditionalBranchInstruction (inLexique,  var_cas_ioAddress,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (242)),  operand_7554->mTargetLabel.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (243)),  var_cas_complementary COMMA_SOURCE_FILE_AT_LINE (240)) ;
      ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (247)),  var_cas_targetAddress,  operand_7554->mTargetLabel.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (246)) ;
      }
      break ;
    case GGS_condionalBranchMode::enum_ipicGOTO:
      ...
      ::routine_emitConditionalBranchInstruction (inLexique,  var_cas_ioAddress,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (256)),  operand_7554->mTargetLabel.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (257)),  var_cas_complementary COMMA_SOURCE_FILE_AT_LINE (254)) ;
...
category_method__ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8740 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_8865 = var_cas_inRoutineSymbolTable ;
    if (temp_8865.isBuilt ()) {
      temp_8865 (HERE)->method_searchKey (inLexique, operand_8740->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (273)) ;
    }
    ...
    case GGS_jumpInstructionKind::enum_relative:
      {
      GGS_sint  var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (276)).substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (276)).substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276)).right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (276)) ;
      const GGS_bool cond_9171 = ((var_cas_displacement).operator_strictSup (GGS_sint (2048L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (2048L).operator_unary_minus (inLexique COMMA_HERE))) ;
...
void routine_emit_pic18_CALLinstruction (C_Compiler & inLexique,
  ...
  #endif
  if ((GGS_uint (60416U)).operator_or ((var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (295))).operator_and (GGS_uint (255U))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (60416U)).operator_or ((var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (295))).operator_and (GGS_uint (255U))) COMMA_SOURCE_FILE_AT_LINE (295)) ;
  }
  if ((GGS_uint (61440U)).operator_or (var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (296))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (61440U)).operator_or (var_cas_inTargetAddress.right_shift_operation (inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (296))) COMMA_SOURCE_FILE_AT_LINE (296)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emitRCALLinstruction (C_Compiler & inLexique,
  ...
  #endif
  GGS_sint  var_cas_displacement = var_cas_inTargetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (306)).substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (306)).substract_operation (inLexique, var_cas_inRCALLinstructionAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)).right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (306)) ;
  const GGS_bool cond_10175 = ((var_cas_displacement).operator_strictSup (GGS_sint (1023L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (1024L).operator_unary_minus (inLexique COMMA_HERE))) ;
  if (cond_10175.isBuiltAndTrue ()) {
    var_cas_inTargetLabel.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("displacement too large (")).operator_concat (var_cas_displacement.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (308)))).operator_concat (GGS_string (") for RCALL instruction to '"))).operator_concat (var_cas_inTargetLabel)).operator_concat (GGS_string ("' (should be between -1024 and 1023)")) COMMA_SOURCE_FILE_AT_LINE (310)) ;
  }
  if ((GGS_uint (55296U)).operator_or ((var_cas_displacement).operator_and (GGS_sint (2047L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (312))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (55296U)).operator_or ((var_cas_displacement).operator_and (GGS_sint (2047L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (312))) COMMA_SOURCE_FILE_AT_LINE (312)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_10404 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_10529 = var_cas_inRoutineSymbolTable ;
    if (temp_10529.isBuilt ()) {
      temp_10529 (HERE)->method_searchKey (inLexique, operand_10404->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (322)) ;
    }
    switch (operand_10404->mKind.enumValue ()) {
    case GGS_jumpInstructionKind::enum_ipicRelative:
    case GGS_jumpInstructionKind::enum_relative:
      {
      GGS_sint  var_cas_displacement = var_cas_targetAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (325)).substract_operation (inLexique, GGS_sint (2L) COMMA_SOURCE_FILE_AT_LINE (325)).substract_operation (inLexique, var_cas_ioAddress.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)).right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (325)) ;
      const GGS_bool cond_10835 = ((var_cas_displacement).operator_strictSup (GGS_sint (2048L))).operator_or ((var_cas_displacement).operator_strictInf (GGS_sint (2048L).operator_unary_minus (inLexique COMMA_HERE))) ;
...
category_method__ipic_jump_test_register__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_11163 != NULL) {
    ...
    const GGS_bool cond_11375 = operand_11163->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (348)) ;
    if (cond_11375.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (256U)) ;
    }
    var_cas_code = (var_cas_code).operator_or ((operand_11163->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (351))).operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
      ::routine_emitCode (inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (352)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_11569 = var_cas_inRoutineSymbolTable ;
    if (temp_11569.isBuilt ()) {
      temp_11569 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11163->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (355)) ;
    }
    const GGS_bool cond_12120 = operand_11163->mBranchIfZero ;
    if (cond_12120.isBuiltAndTrue ()) {
      GGS_uint  var_cas_intermediateTargetAddress ;
      const GGS_bool cond_11766 = operand_11163->mUsesBra ;
      if (cond_11766.isBuiltAndTrue ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      }else if (cond_11766.isBuiltAndFalse ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (361)) ;
      }
      ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (364)),  var_cas_intermediateTargetAddress,  operand_11163->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (363)) ;
      const GGS_bool cond_12050 = operand_11163->mUsesBra ;
      if (cond_12050.isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (369)),  var_cas_targetAddress,  operand_11163->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (369)) ;
      }else if (cond_12050.isBuiltAndFalse ()) {
        ::routine_emit_pic18_GOTOinstruction (inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (371)) ;
      }
    }else if (cond_12120.isBuiltAndFalse ()) {
      const GGS_bool cond_12229 = operand_11163->mUsesBra ;
      if (cond_12229.isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (375)),  var_cas_targetAddress,  operand_11163->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (375)) ;
      }else if (cond_12229.isBuiltAndFalse ()) {
...
category_method__ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_12449 != NULL) {
    GGS_uint  var_cas_code ;
    const GGS_bool cond_12606 = (operand_12449->mBranchIfZero).operator_and (operand_12449->mIncrement) ;
    if (cond_12606.isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (18432U) ;
    }else if (cond_12606.isBuiltAndFalse ()) {
      const GGS_bool cond_12680 = (operand_12449->mBranchIfZero).operator_and ((operand_12449->mIncrement).operator_not ()) ;
      if (cond_12680.isBuiltAndTrue ()) {
        var_cas_code = GGS_uint (19456U) ;
      }else if (cond_12680.isBuiltAndFalse ()) {
        const GGS_bool cond_12755 = ((operand_12449->mBranchIfZero).operator_not ()).operator_and (operand_12449->mIncrement) ;
        if (cond_12755.isBuiltAndTrue ()) {
          var_cas_code = GGS_uint (15360U) ;
        }else if (cond_12755.isBuiltAndFalse ()) {
          var_cas_code = GGS_uint (11264U) ;
        }
      }
    }
    const GGS_bool cond_12862 = (operand_12449->m_W_isDestination).operator_not () ;
    if (cond_12862.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (512U)) ;
    }
    const GGS_bool cond_12944 = operand_12449->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (401)) ;
    if (cond_12944.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (256U)) ;
    }
    var_cas_code = (var_cas_code).operator_or ((operand_12449->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (404))).operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
      ::routine_emitCode (inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (405)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_13138 = var_cas_inRoutineSymbolTable ;
    if (temp_13138.isBuilt ()) {
      temp_13138 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12449->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (408)) ;
    }
    const GGS_bool cond_13295 = operand_12449->mUsesBra ;
    if (cond_13295.isBuiltAndTrue ()) {
      ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (410)),  var_cas_targetAddress,  operand_12449->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (410)) ;
    }else if (cond_13295.isBuiltAndFalse ()) {
...
category_method__ipic_registerComparisonCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_13502 != NULL) {
    ...
    const GGS_bool cond_14066 = operand_13502->mRegisterDescription.reader_mNeedsBSR (inLexique COMMA_SOURCE_FILE_AT_LINE (432)) ;
    if (cond_14066.isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code).operator_or (GGS_uint (256U)) ;
    }
    var_cas_code = (var_cas_code).operator_or ((operand_13502->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (435))).operator_and (GGS_uint (255U))) ;
    if (var_cas_code.isBuilt ()) {
      ::routine_emitCode (inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (436)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_14260 = var_cas_inRoutineSymbolTable ;
    if (temp_14260.isBuilt ()) {
      temp_14260 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_13502->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (439)) ;
    }
    ...
    const GGS_bool cond_14897 = var_cas_usesIntermediateBRA ;
    if (cond_14897.isBuiltAndTrue ()) {
      GGS_uint  var_cas_intermediateTargetAddress ;
      const GGS_bool cond_14543 = operand_13502->mUsesBra ;
      if (cond_14543.isBuiltAndTrue ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }else if (cond_14543.isBuiltAndFalse ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (446)) ;
      }
      ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (449)),  var_cas_intermediateTargetAddress,  operand_13502->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (448)) ;
      const GGS_bool cond_14827 = operand_13502->mUsesBra ;
      if (cond_14827.isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (454)),  var_cas_targetAddress,  operand_13502->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (454)) ;
      }else if (cond_14827.isBuiltAndFalse ()) {
        ::routine_emit_pic18_GOTOinstruction (inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (456)) ;
      }
    }else if (cond_14897.isBuiltAndFalse ()) {
      const GGS_bool cond_15006 = operand_13502->mUsesBra ;
      if (cond_15006.isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (inLexique,  var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (460)),  var_cas_targetAddress,  operand_13502->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (460)) ;
...
category_method__ipic18_instruction_RETFIE__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_17102 != NULL) {
    GGS_uint  var_cas_code ;
    const GGS_bool cond_17262 = operand_17102->mFastReturn ;
    if (cond_17262.isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (17U) ;
    }else if (cond_17262.isBuiltAndFalse ()) {
...
category_method__ipic18_instruction_literalOperation__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_17764 != NULL) {
    ...
    var_cas_code = (var_cas_code).operator_or (operand_17764->mLiteralValue) ;
    if (var_cas_code.isBuilt ()) {
...
category_method__ipic18_instruction_LFSR__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_18118 != NULL) {
    if (((GGS_uint (60928U)).operator_or (operand_18118->mFSRindex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (573)).left_shift_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (573)))).operator_or (operand_18118->mValue.right_shift_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (573))).isBuilt ()) {
      ::routine_emitCode (inLexique,  ((GGS_uint (60928U)).operator_or (operand_18118->mFSRindex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (573)).left_shift_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (573)))).operator_or (operand_18118->mValue.right_shift_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (573))) COMMA_SOURCE_FILE_AT_LINE (573)) ;
    }
    if ((GGS_uint (61440U)).operator_or ((operand_18118->mValue).operator_and (GGS_uint (255U))).isBuilt ()) {
      ::routine_emitCode (inLexique,  (GGS_uint (61440U)).operator_or ((operand_18118->mValue).operator_and (GGS_uint (255U))) COMMA_SOURCE_FILE_AT_LINE (574)) ;
    }
  }
}
...
category_method__ipic18_instruction_MOVLB__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_18464 != NULL) {
    if ((GGS_uint (256U)).operator_or (operand_18464->mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (583))).isBuilt ()) {
      ::routine_emitCode (inLexique,  (GGS_uint (256U)).operator_or (operand_18464->mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (583))) COMMA_SOURCE_FILE_AT_LINE (583)) ;
    }
  }
}
...
category_method__ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_18743 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_18868 = var_cas_inRoutineSymbolTable ;
    if (temp_18868.isBuilt ()) {
      temp_18868 (HERE)->method_searchKey (inLexique, operand_18743->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (593)) ;
    }
    const GGS_bool cond_19143 = (var_cas_targetAddress).operator_isNotEqual (var_cas_ioAddress) ;
    if (cond_19143.isBuiltAndTrue ()) {
      operand_18743->mLabel.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("Internal second pass error: the '")).operator_concat (operand_18743->mLabel)).operator_concat (GGS_string ("' label gets "))).operator_concat (var_cas_ioAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (596)))).operator_concat (GGS_string (" value in second pass, while it gets "))).operator_concat (var_cas_targetAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (597)))).operator_concat (GGS_string (" in first pass")) COMMA_SOURCE_FILE_AT_LINE (598)) ;
    }
  }
}
...
category_method__ipic18_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_20201 != NULL) {
    const GGS_bool cond_20381 = (operand_20201->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (635))).operator_isEqual (GGS_uint (0U)) ;
    ...
    while (_condition_20525.isBuiltAndTrue ()) {
      _condition_20525 = (var_cas_idx).operator_strictInf (operand_20201->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (640))) ;
      if (_condition_20525.isBuiltAndTrue ()) {
        if (_variant_20525.uintValue () == 0) {
          ...
          _variant_20525.decrement_operation (inLexique COMMA_HERE) ;
          if (GGS_uint (0U).isBuilt ()) {
            ::routine_emitCode (inLexique,  GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (642)) ;
          }
          var_cas_idx.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (643)) ;
        }
      }
    }
  }
...
category_method__ipic18_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_20705 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), operand_20705->mInstructionLocation COMMA_HERE) ;
    const GGS_ipic18_symbolTable  temp_20898 = var_cas_inRoutineSymbolTable ;
    if (temp_20898.isBuilt ()) {
      temp_20898 (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (655)) ;
    }
    const GGS_bool cond_21013 = operand_20705->mUsesRCALL ;
    ...
    }
    {
      ...
      while (((operand_21098 = enumerator_21098.nextObject ()))) {
        ...
        if ((GGS_uint (3072U)).operator_or (operand_21098->mValue).isBuilt ()) {
          ::routine_emitCode (inLexique,  (GGS_uint (3072U)).operator_or (operand_21098->mValue) COMMA_SOURCE_FILE_AT_LINE (662)) ;
        }
      }
    }
  }
...
category_method__ipic18_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_21320 != NULL) {
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_2"), operand_21320->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_21513 = var_cas_inRoutineSymbolTable ;
    if (temp_21513.isBuilt ()) {
      temp_21513 (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (674)) ;
    }
    const GGS_bool cond_21628 = operand_21320->mUsesRCALL ;
    if (cond_21628.isBuiltAndTrue ()) {
    ...
    }else if (cond_21628.isBuiltAndFalse ()) {
      ::routine_emit_pic18_CALLinstruction (inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (678)) ;
    }
    GGS_uint  var_cas_addressForComputingBRA = var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (681)) ;
    const GGS_bool cond_21859 = (operand_21320->mUsesRCALL).operator_not () ;
    if (cond_21859.isBuiltAndTrue ()) {
      var_cas_addressForComputingBRA = var_cas_addressForComputingBRA.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683)) ;
    }
    {
      ...
      while (((operand_21893 = enumerator_21893.nextObject ()))) {
        ...
        const GGS_ipic18_symbolTable  temp_21932 = var_cas_inRoutineSymbolTable ;
        if (temp_21932.isBuilt ()) {
          temp_21932 (HERE)->method_searchKey (inLexique, operand_21893->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (687)) ;
        }
        ...
        var_cas_addressForComputingBRA = var_cas_addressForComputingBRA.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (693)) ;
      }
    }
  }
}
...
category_method__ipic18_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_22310 != NULL) {
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), operand_22310->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_22503 = var_cas_inRoutineSymbolTable ;
    if (temp_22503.isBuilt ()) {
      temp_22503 (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (705)) ;
    }
    const GGS_bool cond_22618 = operand_22310->mUsesRCALL ;
    if (cond_22618.isBuiltAndTrue ()) {
    ...
    }else if (cond_22618.isBuiltAndFalse ()) {
    ...
    }
    {
      ...
      while (((operand_22701 = enumerator_22701.nextObject ()))) {
        ...
        const GGS_ipic18_symbolTable  temp_22740 = var_cas_inRoutineSymbolTable ;
        if (temp_22740.isBuilt ()) {
          temp_22740 (HERE)->method_searchKey (inLexique, operand_22701->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (712)) ;
        }
...
category_method__ipic18_instruction_computed_rcall__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_23013 != NULL) {
    GGS_lstring  var_cas_target = GGS_lstring ::constructor_new (inLexique, GGS_string ("_computed_goto_4"), operand_23013->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_targetAddress ;
    const GGS_ipic18_symbolTable  temp_23206 = var_cas_inRoutineSymbolTable ;
    if (temp_23206.isBuilt ()) {
      temp_23206 (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (727)) ;
    }
    GGS_uint  var_cas_currentInstructionAddress ;
    const GGS_bool cond_23406 = operand_23013->mUsesRCALL ;
    if (cond_23406.isBuiltAndTrue ()) {
      ...
      var_cas_currentInstructionAddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (731)) ;
    }else if (cond_23406.isBuiltAndFalse ()) {
      ::routine_emit_pic18_CALLinstruction (inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (733)) ;
      var_cas_currentInstructionAddress = var_cas_ioAddress.add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (734)) ;
    }
    GGS_uint  var_cas_nextInstructionAddress = var_cas_currentInstructionAddress.add_operation (inLexique, operand_23013->mTargetLabels.reader_length ().multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (736)) COMMA_SOURCE_FILE_AT_LINE (736)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (736)) ;
    GGS_uint  var_cas_idx = GGS_uint (0U) ;
    {
      GGS_lstringlist::cEnumerator enumerator_23652 (operand_23013->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_23652 = NULL ;
      while (((operand_23652 = enumerator_23652.nextObject ()))) {
        macroValidPointer (operand_23652) ;
        var_cas_idx.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (739)) ;
        const GGS_ipic18_symbolTable  temp_23704 = var_cas_inRoutineSymbolTable ;
        if (temp_23704.isBuilt ()) {
          temp_23704 (HERE)->method_searchKey (inLexique, operand_23652->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (740)) ;
        }
        ::routine_emitRCALLinstruction (inLexique,  var_cas_currentInstructionAddress,  var_cas_targetAddress,  operand_23652->mValue COMMA_SOURCE_FILE_AT_LINE (741)) ;
        var_cas_currentInstructionAddress = var_cas_currentInstructionAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (742)) ;
        const GGS_bool cond_24085 = (var_cas_idx).operator_strictInf (operand_23013->mTargetLabels.reader_length ()) ;
        if (cond_24085.isBuiltAndTrue ()) {
          ::routine_emitBRAinstruction (inLexique,  var_cas_currentInstructionAddress,  var_cas_nextInstructionAddress,  operand_23652->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (744)) COMMA_SOURCE_FILE_AT_LINE (744)) ;
          var_cas_currentInstructionAddress = var_cas_currentInstructionAddress.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (745)) ;
        }
      }
    }
  }
...
void routine_build_ipic18_binary_code (C_Compiler & inLexique,
  ...
  #endif
  GGS_ipic18_symbolTable  var_cas_symbolTable = GGS_ipic18_symbolTable ::constructor_emptyMap (inLexique COMMA_HERE) ;
  GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
  {
    GGS_ipic18_instructionList::cEnumerator enumerator_24879 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_24879 = NULL ;
    while (((operand_24879 = enumerator_24879.nextObject ()))) {
      macroValidPointer (operand_24879) ;
      const GGS_ipic18_instruction  temp_24920 = operand_24879->mInstruction ;
      if (temp_24920.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__enterLabelAtAddress method = findCategoryMethod__ipic18_instruction__enterLabelAtAddress (temp_24920.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_24920 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (766)) ;
        }
      }
    }
  }
  ...
  {
    GGS_ipic18_instructionList::cEnumerator enumerator_25203 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_25203 = NULL ;
    while (((operand_25203 = enumerator_25203.nextObject ()))) {
      macroValidPointer (operand_25203) ;
      const GGS_ipic18_instruction  temp_25252 = operand_25203->mInstruction ;
      if (temp_25252.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress method = findCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress (temp_25252.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_25252 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (774)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic18_instruction  temp_25351 = operand_25203->mInstruction ;
      if (temp_25351.isBuilt ()) {
        temp_25351 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (776)) ;
      }
      var_cas_currentAddress = var_cas_currentAddress.add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (777)) ;
      ::routine_checkCurrentEmitAddress (inLexique,  var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (778)) ;
    }
  }
  const GGS_bool cond_25768 = (var_cas_lastAddressForFirstPass).operator_isNotEqual (var_cas_currentAddress) ;
  if (cond_25768.isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("Internal second pass error: the last address gets ")).operator_concat (var_cas_currentAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (781)))).operator_concat (GGS_string (" value in second pass, while it gets "))).operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (783)))).operator_concat (GGS_string (" value in first pass")) COMMA_SOURCE_FILE_AT_LINE (784)) ;
  }else if (cond_25768.isBuiltAndFalse ()) {
    const GGS_bool cond_25956 = (var_cas_lastAddressForFirstPass).operator_strictSup (var_cas_inROMsize) ;
    if (cond_25956.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("Program too large: ")).operator_concat (var_cas_lastAddressForFirstPass.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (785)))).operator_concat (GGS_string (" bytes (rom size is "))).operator_concat (var_cas_inROMsize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (787)))).operator_concat (GGS_string (" bytes)")) COMMA_SOURCE_FILE_AT_LINE (788)) ;
    }
  }
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_26048 (var_cas_inActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_26048 = NULL ;
    while (((operand_26048 = enumerator_26048.nextObject ()))) {
      macroValidPointer (operand_26048) ;
      if (operand_26048->mInfo.mRegisterAddress.isBuilt ()) {
        ::routine_setEmitAddress (inLexique,  operand_26048->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (791)) ;
      }
      if (operand_26048->mInfo.mRegisterValue.isBuilt ()) {
        ::routine_emitByte (inLexique,  operand_26048->mInfo.mRegisterValue COMMA_SOURCE_FILE_AT_LINE (792)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
