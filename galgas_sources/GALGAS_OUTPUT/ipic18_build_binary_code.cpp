...
category_method__ipic18_instruction_conditionalBranch__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8227 != NULL) {
    ...
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_8227->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (248)) ;
    }
...
category_method__ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_9516 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_9516->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (300)) ;
    }
...
category_method__ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_11381 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_11381->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (358)) ;
    }
...
category_method__ipic_jump_test_register__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_12208 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12208->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (396)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (396)) ;
    }
...
category_method__ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_13601 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_13601->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (451)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (451)) ;
    }
...
category_method__ipic_registerComparisonCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_14727 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14727->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (483)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (483)) ;
    }
...
category_method__ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_20768 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_20768->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (653)) ;
    }
...
category_method__ipic18_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_23101 != NULL) {
    ...
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (719)) ;
    }
...
category_method__ipic18_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_23790 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (739)) ;
    }
    ...
    }
    {
      ...
      while (((operand_24407 = enumerator_24407.nextObject ()))) {
        ...
        if (var_cas_inRoutineSymbolTable.isBuilt ()) {
          var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_24407->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (752)) ;
        }
...
category_method__ipic18_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_24839 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (772)) ;
    }
    ...
    }
    {
      ...
      while (((operand_25274 = enumerator_25274.nextObject ()))) {
        ...
        if (var_cas_inRoutineSymbolTable.isBuilt ()) {
          var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_25274->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (779)) ;
        }
...
category_method__ipic18_instruction_computed_rcall__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_25601 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, var_cas_target, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (796)) ;
    }
    ...
    GGS_uint  var_cas_idx = GGS_uint (0U) ;
    {
      ...
      while (((operand_26284 = enumerator_26284.nextObject ()))) {
        ...
        if (var_cas_inRoutineSymbolTable.isBuilt ()) {
          var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_26284->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (809)) ;
        }
...
void routine_build_ipic18_binary_code (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
  {
    ...
    while (((operand_27527 = enumerator_27527.nextObject ()))) {
      ...
      { typeCategoryMethod__ipic18_instruction__enterLabelAtAddress method = findCategoryMethod__ipic18_instruction__enterLabelAtAddress (operand_27527->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_27527->mInstruction (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (835)) ;
        }
      }
    }
  }
  ...
  }
  {
    ...
    while (((operand_27851 = enumerator_27851.nextObject ()))) {
      ...
      { typeCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress method = findCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress (operand_27851->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_27851->mInstruction (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_code COMMA_SOURCE_FILE_AT_LINE (845)) ;
        }
      }
      ...
      GGS_uint  var_cas_instructionLength ;
      if (operand_27851->mInstruction.isBuilt ()) {
        operand_27851->mInstruction (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (855)) ;
      }
