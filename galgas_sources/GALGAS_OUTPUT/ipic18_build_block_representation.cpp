...
void routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (const GALGAS_string constinArgument_inSourceFileName,
                                                                       ...
                                                                       C_Compiler * inCompiler
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineMap var_routineMap = GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2127)) ;
  cEnumerator_routineDeclarationList enumerator_75724 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_75724.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_75724.current_mRoutineName (HERE), enumerator_75724.current_mIsNoReturn (HERE), enumerator_75724.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2129)), enumerator_75724.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2129)), enumerator_75724.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2129)) ;
    }
    enumerator_75724.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_75934 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_75934.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_75934.current_mRoutineName (HERE), enumerator_75934.current_mIsNoReturn (HERE), enumerator_75934.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2132)), enumerator_75934.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2132)), enumerator_75934.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2132)) ;
    }
    enumerator_75934.gotoNextObject () ;
  }
  cEnumerator_routineDefinitionList enumerator_76121 (constinArgument_inPiccoloModel.reader_mRoutineDefinitionList (SOURCE_FILE_AT_LINE (2134)), kEnumeration_up) ;
  while (enumerator_76121.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_76121.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2135)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2135)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_76121.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2135)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2135)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_76121.current_mRequiredBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (2136)) ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_76121.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2138)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2138)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_76121.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2138)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2138)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_76121.current_mReturnedBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (2139)) ;
    }
    {
    var_routineMap.modifier_insertKey (enumerator_76121.current_mRoutineName (HERE), enumerator_76121.current_mIsNoReturn (HERE), enumerator_76121.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2141)), enumerator_76121.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2141)), enumerator_76121.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2141)) ;
    }
    enumerator_76121.gotoNextObject () ;
  }
  GALGAS_constantMap var_constantMap = constinArgument_inDataLengthConstantMap ;
  {
  var_constantMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("ROM_SIZE"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2146)), constinArgument_inROMSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (2146)) ;
  }
  {
  var_constantMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("RAM_SIZE"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2147)), constinArgument_inRAMSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (2147)) ;
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_regularProgram (SOURCE_FILE_AT_LINE (2149)))).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_lstring var_bootloaderSizeString = GALGAS_lstring::constructor_new (GALGAS_string ("BOOTLOADER_RESERVED_SIZE"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2150)) ;
    {
    var_constantMap.modifier_insertKey (var_bootloaderSizeString, constinArgument_inBootloaderReservedROMsize.reader_uint (SOURCE_FILE_AT_LINE (2151)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (2151)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2151)) ;
    }
  }
  cEnumerator_constantDefinitionList enumerator_77298 (constinArgument_inPiccoloModel.reader_mConstantDefinitionList (SOURCE_FILE_AT_LINE (2154)), kEnumeration_up) ;
  while (enumerator_77298.hasCurrentObject ()) {
    GALGAS_sint var_result ;
    callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_77298.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, var_constantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2155)) ;
    const enumGalgasBool test_5 = constinArgument_inRegisterTable.reader_hasKey (enumerator_77298.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2156)) COMMA_SOURCE_FILE_AT_LINE (2156)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_77298.current_mConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (enumerator_77298.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2157)) COMMA_SOURCE_FILE_AT_LINE (2157)).operator_concat (GALGAS_string ("' is already declared as ram register or special register") COMMA_SOURCE_FILE_AT_LINE (2157)) COMMA_SOURCE_FILE_AT_LINE (2157)) ;
    }else if (kBoolFalse == test_5) {
      {
      var_constantMap.modifier_insertKey (enumerator_77298.current_mConstantName (HERE), var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2159)) ;
      }
    }
    enumerator_77298.gotoNextObject () ;
  }
  {
  routine_print_5F_constant_5F_definition (var_constantMap, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (2163)) ;
  }
  const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (2168)))).boolEnum () ;
  if (kBoolTrue == test_7) {
    const enumGalgasBool test_8 = var_routineMap.reader_hasKey (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (2169)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_bool var_isNoReturn ;
      GALGAS_uint var_requiredBank ;
      GALGAS_uint joker_78089_0 ; // Joker input parameter
      GALGAS_bool joker_78092_0 ; // Joker input parameter
      var_routineMap.method_searchKey (GALGAS_lstring::constructor_new (GALGAS_string ("main"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2172)), var_isNoReturn, var_requiredBank, joker_78089_0, joker_78092_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2172)) ;
      const enumGalgasBool test_9 = var_isNoReturn.operator_not (SOURCE_FILE_AT_LINE (2173)).boolEnum () ;
      if (kBoolTrue == test_9) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (2174)) ;
      }
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_requiredBank.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_10) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (2177)) ;
      }
    }else if (kBoolFalse == test_8) {
      inCompiler->emitSemanticError (constinArgument_inPiccoloModel.reader_mEndOfProgram (SOURCE_FILE_AT_LINE (2180)), GALGAS_string ("the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (2180)) ;
    }
  }
  GALGAS_ipic_31__38_BlockList var_generatedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (2184)) ;
  GALGAS_uint var_entryPoint = GALGAS_uint ((PMUInt32) 4U) ;
  cEnumerator_routineDeclarationList enumerator_78798 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_78798.hasCurrentObject ()) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_78798.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2190)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2191)) COMMA_SOURCE_FILE_AT_LINE (2191)) COMMA_SOURCE_FILE_AT_LINE (2187)) COMMA_SOURCE_FILE_AT_LINE (2187)) ;
  ...
  cEnumerator_routineDeclarationList enumerator_79391 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_79391.hasCurrentObject ()) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_user_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2205)) COMMA_SOURCE_FILE_AT_LINE (2205)).reader_nowhere (SOURCE_FILE_AT_LINE (2205)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2206)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_79391.current_mRoutineName (HERE).mAttribute_location, enumerator_79391.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2207)) COMMA_SOURCE_FILE_AT_LINE (2207)) COMMA_SOURCE_FILE_AT_LINE (2203)) COMMA_SOURCE_FILE_AT_LINE (2203)) ;
    var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2209)) ;
    enumerator_79391.gotoNextObject () ;
  }
  const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (2212)))).boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 0U), GALGAS_string ("_entry_main").reader_nowhere (SOURCE_FILE_AT_LINE (2215)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2216)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2217)), GALGAS_string ("main").reader_nowhere (SOURCE_FILE_AT_LINE (2217)), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2213)) COMMA_SOURCE_FILE_AT_LINE (2213)) ;
  }
  ...
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2222)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    GALGAS_lstring var_routineName ;
    {
    GALGAS_luint joker_80498_0 ; // Joker input parameter
    GALGAS_luint joker_80501_0 ; // Joker input parameter
    GALGAS_bool joker_80504_0 ; // Joker input parameter
    GALGAS_bool joker_80507_0 ; // Joker input parameter
    var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_80498_0, joker_80501_0, joker_80504_0, joker_80507_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2223)) ;
    }
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 4U), GALGAS_string ("_entry_bootloader_04").reader_nowhere (SOURCE_FILE_AT_LINE (2226)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2227)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_routineName.mAttribute_location, var_routineName, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2228)) COMMA_SOURCE_FILE_AT_LINE (2228)) COMMA_SOURCE_FILE_AT_LINE (2224)) COMMA_SOURCE_FILE_AT_LINE (2224)) ;
  }
  const enumGalgasBool test_15 = constinArgument_inHasHighInterrupt.boolEnum () ;
  if (kBoolTrue == test_15) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 8U), GALGAS_string ("_entry_high_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2235)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2236)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2237)), GALGAS_string ("_high_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2237)), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2237)) COMMA_SOURCE_FILE_AT_LINE (2237)) COMMA_SOURCE_FILE_AT_LINE (2233)) COMMA_SOURCE_FILE_AT_LINE (2233)) ;
  }
  var_entryPoint = GALGAS_uint ((PMUInt32) 12U) ;
  if (var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2242)).isValid ()) {
    PMUInt32 variant_81363 = var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2242)).uintValue () ;
    bool loop_81363 = true ;
    while (loop_81363) {
      loop_81363 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2243)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2243)).isValid () ;
      if (loop_81363) {
        loop_81363 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2243)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2243)).boolValue () ;
      }
      if (loop_81363 && (0 == variant_81363)) {
        loop_81363 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2242)) ;
      }
      if (loop_81363) {
        variant_81363 -- ;
        GALGAS_lstring var_routineName ;
        {
        GALGAS_luint joker_81575_0 ; // Joker input parameter
        GALGAS_luint joker_81578_0 ; // Joker input parameter
        GALGAS_bool joker_81581_0 ; // Joker input parameter
        GALGAS_bool joker_81584_0 ; // Joker input parameter
        var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_81575_0, joker_81578_0, joker_81581_0, joker_81584_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2245)) ;
        }
        var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_bootloader_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2248)) COMMA_SOURCE_FILE_AT_LINE (2248)).reader_nowhere (SOURCE_FILE_AT_LINE (2248)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2249)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_routineName.mAttribute_location, var_routineName, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2250)) COMMA_SOURCE_FILE_AT_LINE (2250)) COMMA_SOURCE_FILE_AT_LINE (2246)) COMMA_SOURCE_FILE_AT_LINE (2246)) ;
        var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2252)) ;
      }
    }
  }
  const enumGalgasBool test_16 = constinArgument_inHasLowInterrupt.boolEnum () ;
  if (kBoolTrue == test_16) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 24U), GALGAS_string ("_entry_low_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2258)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2259)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2260)), GALGAS_string ("_low_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2260)), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2260)) COMMA_SOURCE_FILE_AT_LINE (2260)) COMMA_SOURCE_FILE_AT_LINE (2256)) COMMA_SOURCE_FILE_AT_LINE (2256)) ;
  }
  var_entryPoint = GALGAS_uint ((PMUInt32) 28U) ;
  cEnumerator_routineDeclarationList enumerator_82483 (var_tempBootloaderRoutineDeclarationList, kEnumeration_up) ;
  while (enumerator_82483.hasCurrentObject ()) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_bootloader_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2268)) COMMA_SOURCE_FILE_AT_LINE (2268)).reader_nowhere (SOURCE_FILE_AT_LINE (2268)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2269)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_82483.current_mRoutineName (HERE).mAttribute_location, enumerator_82483.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2270)) COMMA_SOURCE_FILE_AT_LINE (2270)) COMMA_SOURCE_FILE_AT_LINE (2266)) COMMA_SOURCE_FILE_AT_LINE (2266)) ;
    var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2272)) ;
    enumerator_82483.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_17) {
    cEnumerator_interruptDefinitionList enumerator_83066 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2278)), kEnumeration_up) ;
    while (enumerator_83066.hasCurrentObject ()) {
      const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_83066.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2279)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2281)), GALGAS_lstring::constructor_new (GALGAS_string ("_low_interrupt"), enumerator_83066.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2282)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2283)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (enumerator_83066.current_mInterruptName (HERE).mAttribute_location, enumerator_83066.current_mFastReturn (HERE) COMMA_SOURCE_FILE_AT_LINE (2284)) COMMA_SOURCE_FILE_AT_LINE (2280)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2286)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_83066.current_mInstructionList (HERE), var_generatedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_83066.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2299)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2301)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2287)) ;
        }
        const enumGalgasBool test_19 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2303)).boolEnum () ;
        if (kBoolTrue == test_19) {
          inCompiler->emitSemanticError (enumerator_83066.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2304)) ;
        }
        var_generatedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2307)) ;
      }
  ...
  if (kBoolTrue == test_20) {
    cEnumerator_interruptDefinitionList enumerator_84360 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2313)), kEnumeration_up) ;
    while (enumerator_84360.hasCurrentObject ()) {
      const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_84360.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2314)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
      if (kBoolTrue == test_21) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2316)), GALGAS_lstring::constructor_new (GALGAS_string ("_high_interrupt"), enumerator_84360.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2317)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2318)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (enumerator_84360.current_mInterruptName (HERE).mAttribute_location, GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2319)) COMMA_SOURCE_FILE_AT_LINE (2315)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2321)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_84360.current_mInstructionList (HERE), var_generatedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_84360.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2334)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2336)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2322)) ;
        }
        const enumGalgasBool test_22 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2338)).boolEnum () ;
        if (kBoolTrue == test_22) {
          inCompiler->emitSemanticError (enumerator_84360.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2339)) ;
        }
        var_generatedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2342)) ;
      }
      enumerator_84360.gotoNextObject () ;
    }
  }
  cEnumerator_routineDefinitionList enumerator_85592 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_85592.hasCurrentObject ()) {
    GALGAS_uint var_currentBank = enumerator_85592.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2348)) ;
    GALGAS_routineKind var_routineKind ;
    const enumGalgasBool test_23 = enumerator_85592.current_mIsNoReturn (HERE).boolEnum () ;
    if (kBoolTrue == test_23) {
      var_routineKind = GALGAS_routineKind::constructor_noReturnRoutine (SOURCE_FILE_AT_LINE (2351)) ;
    }else if (kBoolFalse == test_23) {
      var_routineKind = GALGAS_routineKind::constructor_regularRoutine (SOURCE_FILE_AT_LINE (2353)) ;
    }
    GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2356)), enumerator_85592.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2358)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (enumerator_85592.current_mRoutineName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2359)) COMMA_SOURCE_FILE_AT_LINE (2355)) ;
    GALGAS_bool var_continuesInSequence ;
    {
    routine_analyzeInstructionList (enumerator_85592.current_mInstructionList (HERE), var_generatedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_85592.current_mPreservesBank (HERE), var_continuesInSequence, var_routineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2361)) ;
    }
    var_generatedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2378)) ;
    const enumGalgasBool test_24 = enumerator_85592.current_mIsNoReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2380)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_85592.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2380)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2380)))) COMMA_SOURCE_FILE_AT_LINE (2380)).operator_and (GALGAS_bool (kIsNotEqual, var_currentBank.objectCompare (enumerator_85592.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2380)))) COMMA_SOURCE_FILE_AT_LINE (2380)).boolEnum () ;
    if (kBoolTrue == test_24) {
      GALGAS_location location_25 (enumerator_85592.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_25, GALGAS_string ("execution will not set BSR to ").operator_concat (enumerator_85592.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2381)).reader_string (SOURCE_FILE_AT_LINE (2381)) COMMA_SOURCE_FILE_AT_LINE (2381)) COMMA_SOURCE_FILE_AT_LINE (2381)) ;
    }
    const enumGalgasBool test_26 = enumerator_85592.current_mIsNoReturn (HERE).operator_and (var_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (2383)).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_location location_27 (enumerator_85592.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, GALGAS_string ("execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2384)) ;
    }
    enumerator_85592.gotoNextObject () ;
  }
  GALGAS_registerExpression var_WREGregister = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("WREG"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2390)), GALGAS_luint::constructor_new (GALGAS_uint ((PMUInt32) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2390)) COMMA_SOURCE_FILE_AT_LINE (2390)) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_WREG_5F_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_87309_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_WREGregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_WREG_5F_IPICregisterDescription, joker_87309_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2391)) ;
  GALGAS_registerExpression var_TOSLregister = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("TOSL"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2399)), GALGAS_luint::constructor_new (GALGAS_uint ((PMUInt32) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2399)) COMMA_SOURCE_FILE_AT_LINE (2399)) ;
  ...
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSLregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSL_5F_IPICregisterDescription, joker_87641_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2400)) ;
  GALGAS_registerExpression var_TOSHregister = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("TOSH"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2408)), GALGAS_luint::constructor_new (GALGAS_uint ((PMUInt32) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2408)) COMMA_SOURCE_FILE_AT_LINE (2408)) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_TOSH_5F_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_87973_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSHregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSH_5F_IPICregisterDescription, joker_87973_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2409)) ;
  GALGAS_registerExpression var_TOSUregister = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("TOSU"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2417)), GALGAS_luint::constructor_new (GALGAS_uint ((PMUInt32) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2417)) COMMA_SOURCE_FILE_AT_LINE (2417)) ;
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_TOSU_5F_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_88305_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSUregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSU_5F_IPICregisterDescription, joker_88305_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2418)) ;
  GALGAS_ipic_31__38_SequentialInstruction var_ADDWF_5F_WREG = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code_5F_AST::constructor_ADDWF (SOURCE_FILE_AT_LINE (2428)), var_WREG_5F_IPICregisterDescription, GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2426)) ;
  GALGAS_ipic_31__38_Block var_goto_34_Block = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2435)), GALGAS_string ("_computed_goto_4").reader_nowhere (SOURCE_FILE_AT_LINE (2436)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_listWithValue (var_ADDWF_5F_WREG COMMA_SOURCE_FILE_AT_LINE (2437)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2438)), GALGAS_string ("_computed_goto_2").reader_nowhere (SOURCE_FILE_AT_LINE (2438)), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2438)) COMMA_SOURCE_FILE_AT_LINE (2438)) COMMA_SOURCE_FILE_AT_LINE (2434)) ;
  var_generatedBlockList.addAssign_operation (var_goto_34_Block COMMA_SOURCE_FILE_AT_LINE (2440)) ;
  GALGAS_ipic_31__38_SequentialInstructionList var_goto_32_InstructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2442)) ;
  var_goto_32_InstructionList.addAssign_operation (var_ADDWF_5F_WREG COMMA_SOURCE_FILE_AT_LINE (2443)) ;
  var_goto_32_InstructionList.addAssign_operation (var_ADDWF_5F_WREG COMMA_SOURCE_FILE_AT_LINE (2444)) ;
  var_goto_32_InstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code_5F_AST::constructor_ADDWF (SOURCE_FILE_AT_LINE (2447)), var_TOSL_5F_IPICregisterDescription, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2445)) COMMA_SOURCE_FILE_AT_LINE (2445)) ;
  var_goto_32_InstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (inCompiler->here (), GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (2453)), GALGAS_uint ((PMUInt32) 0U) COMMA_SOURCE_FILE_AT_LINE (2451)) COMMA_SOURCE_FILE_AT_LINE (2451)) ;
  var_goto_32_InstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code_5F_AST::constructor_ADDWFC (SOURCE_FILE_AT_LINE (2458)), var_TOSH_5F_IPICregisterDescription, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2456)) COMMA_SOURCE_FILE_AT_LINE (2456)) ;
  var_goto_32_InstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code_5F_AST::constructor_ADDWFC (SOURCE_FILE_AT_LINE (2464)), var_TOSU_5F_IPICregisterDescription, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2462)) COMMA_SOURCE_FILE_AT_LINE (2462)) ;
  GALGAS_ipic_31__38_Block var_goto_32_Block = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2470)), GALGAS_string ("_computed_goto_2").reader_nowhere (SOURCE_FILE_AT_LINE (2471)), var_goto_32_InstructionList, GALGAS_ipic_31__38_ReturnTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2473)) COMMA_SOURCE_FILE_AT_LINE (2473)) COMMA_SOURCE_FILE_AT_LINE (2469)) ;
  var_generatedBlockList.addAssign_operation (var_goto_32_Block COMMA_SOURCE_FILE_AT_LINE (2475)) ;
  var_entryPoint = constinArgument_inBootloaderReservedROMsize.reader_uint (SOURCE_FILE_AT_LINE (2477)) ;
  cEnumerator_routineDeclarationList enumerator_90218 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_90218.hasCurrentObject ()) {
    const enumGalgasBool test_28 = enumerator_90218.current_mIsNoReturn (HERE).boolEnum () ;
    if (kBoolTrue == test_28) {
      var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_90218.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2483)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_90218.current_mRoutineName (HERE).mAttribute_location, enumerator_90218.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2484)) COMMA_SOURCE_FILE_AT_LINE (2484)) COMMA_SOURCE_FILE_AT_LINE (2480)) COMMA_SOURCE_FILE_AT_LINE (2480)) ;
    }else if (kBoolFalse == test_28) {
      GALGAS_ipic_31__38_SequentialInstructionList var_instructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2487)) ;
      const enumGalgasBool test_29 = GALGAS_bool (kIsNotEqual, enumerator_90218.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2488)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2488)))).boolEnum () ;
      if (kBoolTrue == test_29) {
        var_instructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB::constructor_new (inCompiler->here (), enumerator_90218.current_mReturnedBank (HERE) COMMA_SOURCE_FILE_AT_LINE (2489)) COMMA_SOURCE_FILE_AT_LINE (2489)) ;
      }
      var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_90218.current_mRoutineName (HERE), var_instructionList, GALGAS_ipic_31__38_ReturnTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2495)) COMMA_SOURCE_FILE_AT_LINE (2495)) COMMA_SOURCE_FILE_AT_LINE (2491)) COMMA_SOURCE_FILE_AT_LINE (2491)) ;
    }
    var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2498)) ;
    enumerator_90218.gotoNextObject () ;
  }
  {
  routine_displayBlockList (GALGAS_string ("INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_generatedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2501)) ;
  }
  const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (2503)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (2503)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_ipic_31__38_OptimizeBlocks (ioArgument_ioListFileContents, var_generatedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2504)) ;
    }
    {
    routine_displayBlockList (GALGAS_string ("OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_generatedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2505)) ;
    }
  }
  const enumGalgasBool test_31 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (2508)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (2508)).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_ipic_31__38_OptimizeBlockOrdering (constinArgument_inSourceFileName, ioArgument_ioListFileContents, var_generatedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2509)) ;
    }
  }
  const enumGalgasBool test_32 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (2516)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_32) {
    {
    routine_ipic_31__38_RelativesResolution (ioArgument_ioListFileContents, var_generatedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2517)) ;
    }
  }
  const enumGalgasBool test_33 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (2523)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_ipic_31__38_GenerateCode (constinArgument_inSourceFileName, ioArgument_ioListFileContents, var_generatedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2524)) ;
    }
  }
}
