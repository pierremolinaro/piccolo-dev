...
void routine_registerComparisonComplementary (const GALGAS_pic_31__38_RegisterComparison constinArgument_inComparison,
  ...
  if (constinArgument_inComparison.isValid ()) {
    ...
    case GALGAS_pic_31__38_RegisterComparison::kEnum_notEqual: {
      outArgument_outComparison = GALGAS_pic_31__38_RegisterComparison::constructor_equal (SOURCE_FILE_AT_LINE (2023)) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_equal: {
      outArgument_outComparison = GALGAS_pic_31__38_RegisterComparison::constructor_notEqual (SOURCE_FILE_AT_LINE (2024)) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_greaterOrEqual: {
      outArgument_outComparison = GALGAS_pic_31__38_RegisterComparison::constructor_lower (SOURCE_FILE_AT_LINE (2025)) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_greater: {
      outArgument_outComparison = GALGAS_pic_31__38_RegisterComparison::constructor_lowerOrEqual (SOURCE_FILE_AT_LINE (2026)) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_lowerOrEqual: {
      outArgument_outComparison = GALGAS_pic_31__38_RegisterComparison::constructor_greater (SOURCE_FILE_AT_LINE (2027)) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_lower: {
      outArgument_outComparison = GALGAS_pic_31__38_RegisterComparison::constructor_greaterOrEqual (SOURCE_FILE_AT_LINE (2028)) ;
      } break ;
    }
  }
}
...
void routine_analyzeInstructionList (const GALGAS_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_instructionList enumerator_79911 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_79911.hasCurrentObject ()) {
    const enumGalgasBool test_0 = outArgument_outContinuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2323)).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_79911.current_mInstruction (HERE).reader_mInstructionLocation (SOURCE_FILE_AT_LINE (2324)), GALGAS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (2324)) ;
      outArgument_outContinuesInSequence = GALGAS_bool (true) ;
    }
    callCategoryMethod_analyze ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_79911.current_mInstruction (HERE).ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioGeneratedBlockList, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioCurrentBlock, ioArgument_ioListFileContents, ioArgument_ioCurrentBank, constinArgument_inShouldPreserveBSR, outArgument_outContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2327)) ;
    enumerator_79911.gotoNextObject () ;
  }
}
...
void routine_displayBlockList (const GALGAS_string constinArgument_inTitle,
                               ...
                               C_Compiler * inCompiler
                               COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (2352)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (2352)) COMMA_SOURCE_FILE_AT_LINE (2352)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (constinArgument_inTitle.reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (2353)) COMMA_SOURCE_FILE_AT_LINE (2353)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (2353)) COMMA_SOURCE_FILE_AT_LINE (2353)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (2354)).operator_concat (GALGAS_string ("\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (2354)) COMMA_SOURCE_FILE_AT_LINE (2354)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_80935 (constinArgument_inGeneratedBlockList, kEnumeration_up) ;
  while (enumerator_80935.hasCurrentObject ()) {
    categoryMethod_display (enumerator_80935.current_mBlock (HERE), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (2356)) ;
...
void routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (const GALGAS_sint constinArgument_inROMSize,
  ...
  GALGAS_routineMap var_routineMap = GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2381)) ;
  cEnumerator_routineDeclarationList enumerator_82023 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_82023.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_82023.current_mRoutineName (HERE), enumerator_82023.current_mIsNoReturn (HERE), enumerator_82023.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2383)), enumerator_82023.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2383)), enumerator_82023.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2383)) ;
    }
    enumerator_82023.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_82233 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_82233.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_82233.current_mRoutineName (HERE), enumerator_82233.current_mIsNoReturn (HERE), enumerator_82233.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2386)), enumerator_82233.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2386)), enumerator_82233.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2386)) ;
    }
    enumerator_82233.gotoNextObject () ;
  }
  cEnumerator_routineDefinitionList enumerator_82420 (constinArgument_inPiccoloModel.reader_mRoutineDefinitionList (SOURCE_FILE_AT_LINE (2388)), kEnumeration_up) ;
  while (enumerator_82420.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_82420.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2389)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2389)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_82420.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2389)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2389)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_82420.current_mRequiredBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (2390)) ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_82420.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2392)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2392)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_82420.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2392)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2392)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_82420.current_mReturnedBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (2393)) ;
    }
    {
    var_routineMap.modifier_insertKey (enumerator_82420.current_mRoutineName (HERE), enumerator_82420.current_mIsNoReturn (HERE), enumerator_82420.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2395)), enumerator_82420.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2395)), enumerator_82420.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2395)) ;
    }
    enumerator_82420.gotoNextObject () ;
  }
  GALGAS_constantMap var_constantMap = constinArgument_inDataLengthConstantMap ;
  {
  var_constantMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("ROM_SIZE"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2400)), constinArgument_inROMSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (2400)) ;
  }
  {
  var_constantMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("RAM_SIZE"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2401)), constinArgument_inRAMSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (2401)) ;
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_regularProgram (SOURCE_FILE_AT_LINE (2403)))).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_lstring var_bootloaderSizeString = GALGAS_lstring::constructor_new (GALGAS_string ("BOOTLOADER_RESERVED_SIZE"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2404)) ;
    {
    var_constantMap.modifier_insertKey (var_bootloaderSizeString, constinArgument_inBootloaderReservedROMsize.reader_uint (SOURCE_FILE_AT_LINE (2405)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (2405)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2405)) ;
    }
  }
  cEnumerator_constantDefinitionList enumerator_83597 (constinArgument_inPiccoloModel.reader_mConstantDefinitionList (SOURCE_FILE_AT_LINE (2408)), kEnumeration_up) ;
  while (enumerator_83597.hasCurrentObject ()) {
    GALGAS_sint var_result ;
    callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_83597.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, var_constantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2409)) ;
    const enumGalgasBool test_5 = constinArgument_inRegisterTable.reader_hasKey (enumerator_83597.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2410)) COMMA_SOURCE_FILE_AT_LINE (2410)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_83597.current_mConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (enumerator_83597.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2411)) COMMA_SOURCE_FILE_AT_LINE (2411)).operator_concat (GALGAS_string ("' is already declared as ram register or special register") COMMA_SOURCE_FILE_AT_LINE (2411)) COMMA_SOURCE_FILE_AT_LINE (2411)) ;
    }else if (kBoolFalse == test_5) {
      {
      var_constantMap.modifier_insertKey (enumerator_83597.current_mConstantName (HERE), var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2413)) ;
      }
    }
    enumerator_83597.gotoNextObject () ;
  }
  const enumGalgasBool test_7 = GALGAS_bool (gOption_piccolo_5F_options_ouputListingFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_7) {
    {
    routine_print_5F_constant_5F_definition (var_constantMap, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (2418)) ;
    }
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (2424)))).boolEnum () ;
  if (kBoolTrue == test_8) {
    const enumGalgasBool test_9 = var_routineMap.reader_hasKey (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (2425)).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_bool var_isNoReturn ;
      GALGAS_uint var_requiredBank ;
      GALGAS_uint joker_84465_0 ; // Joker input parameter
      GALGAS_bool joker_84468_0 ; // Joker input parameter
      var_routineMap.method_searchKey (GALGAS_lstring::constructor_new (GALGAS_string ("main"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2428)), var_isNoReturn, var_requiredBank, joker_84465_0, joker_84468_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2428)) ;
      const enumGalgasBool test_10 = var_isNoReturn.operator_not (SOURCE_FILE_AT_LINE (2429)).boolEnum () ;
      if (kBoolTrue == test_10) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (2430)) ;
      }
      const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, var_requiredBank.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (2433)) ;
      }
    }else if (kBoolFalse == test_9) {
      inCompiler->emitSemanticError (constinArgument_inPiccoloModel.reader_mEndOfProgram (SOURCE_FILE_AT_LINE (2436)), GALGAS_string ("the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (2436)) ;
    }
  }
  outArgument_outGeneratedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (2440)) ;
  GALGAS_uint var_entryPoint = GALGAS_uint ((PMUInt32) 4U) ;
  cEnumerator_routineDeclarationList enumerator_85180 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_85180.hasCurrentObject ()) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_85180.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2446)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (SOURCE_FILE_AT_LINE (2447)) COMMA_SOURCE_FILE_AT_LINE (2443)) COMMA_SOURCE_FILE_AT_LINE (2443)) ;
    ...
    enumerator_85180.gotoNextObject () ;
  }
  var_entryPoint = constinArgument_inBootloaderReservedROMsize.reader_uint (SOURCE_FILE_AT_LINE (2457)) ;
  cEnumerator_routineDeclarationList enumerator_85755 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_85755.hasCurrentObject ()) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_user_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2461)) COMMA_SOURCE_FILE_AT_LINE (2461)).reader_nowhere (SOURCE_FILE_AT_LINE (2461)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2462)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_85755.current_mRoutineName (HERE) COMMA_SOURCE_FILE_AT_LINE (2463)) COMMA_SOURCE_FILE_AT_LINE (2459)) COMMA_SOURCE_FILE_AT_LINE (2459)) ;
    var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2465)) ;
    enumerator_85755.gotoNextObject () ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (2468)))).boolEnum () ;
  if (kBoolTrue == test_14) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 0U), GALGAS_string ("_entry_main").reader_nowhere (SOURCE_FILE_AT_LINE (2471)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2472)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (GALGAS_string ("main").reader_nowhere (SOURCE_FILE_AT_LINE (2473)) COMMA_SOURCE_FILE_AT_LINE (2473)) COMMA_SOURCE_FILE_AT_LINE (2469)) COMMA_SOURCE_FILE_AT_LINE (2469)) ;
  }
  ...
  const enumGalgasBool test_15 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2478)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_15) {
    GALGAS_lstring var_routineName ;
    {
    GALGAS_luint joker_86749_0 ; // Joker input parameter
    GALGAS_luint joker_86752_0 ; // Joker input parameter
    GALGAS_bool joker_86755_0 ; // Joker input parameter
    GALGAS_bool joker_86758_0 ; // Joker input parameter
    var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_86749_0, joker_86752_0, joker_86755_0, joker_86758_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2479)) ;
    }
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 4U), GALGAS_string ("_entry_bootloader_04").reader_nowhere (SOURCE_FILE_AT_LINE (2482)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2483)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_routineName COMMA_SOURCE_FILE_AT_LINE (2484)) COMMA_SOURCE_FILE_AT_LINE (2480)) COMMA_SOURCE_FILE_AT_LINE (2480)) ;
  }
  const enumGalgasBool test_16 = constinArgument_inHasHighInterrupt.boolEnum () ;
  if (kBoolTrue == test_16) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 8U), GALGAS_string ("_entry_high_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2491)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2492)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (GALGAS_string ("_high_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2493)) COMMA_SOURCE_FILE_AT_LINE (2493)) COMMA_SOURCE_FILE_AT_LINE (2489)) COMMA_SOURCE_FILE_AT_LINE (2489)) ;
  }
  var_entryPoint = GALGAS_uint ((PMUInt32) 12U) ;
  if (var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2498)).isValid ()) {
    PMUInt32 variant_87502 = var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2498)).uintValue () ;
    bool loop_87502 = true ;
    while (loop_87502) {
      loop_87502 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2499)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2499)).isValid () ;
      if (loop_87502) {
        loop_87502 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2499)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2499)).boolValue () ;
      }
      if (loop_87502 && (0 == variant_87502)) {
        loop_87502 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2498)) ;
      }
      if (loop_87502) {
        variant_87502 -- ;
        GALGAS_lstring var_routineName ;
        {
        GALGAS_luint joker_87714_0 ; // Joker input parameter
        GALGAS_luint joker_87717_0 ; // Joker input parameter
        GALGAS_bool joker_87720_0 ; // Joker input parameter
        GALGAS_bool joker_87723_0 ; // Joker input parameter
        var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_87714_0, joker_87717_0, joker_87720_0, joker_87723_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2501)) ;
        }
        outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_bootloader_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2504)) COMMA_SOURCE_FILE_AT_LINE (2504)).reader_nowhere (SOURCE_FILE_AT_LINE (2504)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2505)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_routineName COMMA_SOURCE_FILE_AT_LINE (2506)) COMMA_SOURCE_FILE_AT_LINE (2502)) COMMA_SOURCE_FILE_AT_LINE (2502)) ;
        var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2508)) ;
      }
    }
  }
  const enumGalgasBool test_17 = constinArgument_inHasLowInterrupt.boolEnum () ;
  if (kBoolTrue == test_17) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint ((PMUInt32) 24U), GALGAS_string ("_entry_low_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2514)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2515)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (GALGAS_string ("_low_interrupt").reader_nowhere (SOURCE_FILE_AT_LINE (2516)) COMMA_SOURCE_FILE_AT_LINE (2516)) COMMA_SOURCE_FILE_AT_LINE (2512)) COMMA_SOURCE_FILE_AT_LINE (2512)) ;
  }
  var_entryPoint = GALGAS_uint ((PMUInt32) 28U) ;
  cEnumerator_routineDeclarationList enumerator_88510 (var_tempBootloaderRoutineDeclarationList, kEnumeration_up) ;
  while (enumerator_88510.hasCurrentObject ()) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_bootloader_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2524)) COMMA_SOURCE_FILE_AT_LINE (2524)).reader_nowhere (SOURCE_FILE_AT_LINE (2524)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2525)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_88510.current_mRoutineName (HERE) COMMA_SOURCE_FILE_AT_LINE (2526)) COMMA_SOURCE_FILE_AT_LINE (2522)) COMMA_SOURCE_FILE_AT_LINE (2522)) ;
    var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2528)) ;
    enumerator_88510.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_18) {
    cEnumerator_interruptDefinitionList enumerator_89035 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2534)), kEnumeration_up) ;
    while (enumerator_89035.hasCurrentObject ()) {
      const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_89035.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2535)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
      if (kBoolTrue == test_19) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2537)), GALGAS_lstring::constructor_new (GALGAS_string ("_low_interrupt"), enumerator_89035.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2538)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2539)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (enumerator_89035.current_mFastReturn (HERE) COMMA_SOURCE_FILE_AT_LINE (2540)) COMMA_SOURCE_FILE_AT_LINE (2536)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2542)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_89035.current_mInstructionList (HERE), outArgument_outGeneratedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_89035.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2555)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2557)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2543)) ;
        }
        const enumGalgasBool test_20 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2559)).boolEnum () ;
        if (kBoolTrue == test_20) {
          inCompiler->emitSemanticError (enumerator_89035.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2560)) ;
        }
        outArgument_outGeneratedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2563)) ;
      }
      enumerator_89035.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_21 = constinArgument_inHasHighInterrupt.boolEnum () ;
  if (kBoolTrue == test_21) {
    cEnumerator_interruptDefinitionList enumerator_90309 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2569)), kEnumeration_up) ;
    while (enumerator_90309.hasCurrentObject ()) {
      const enumGalgasBool test_22 = GALGAS_bool (kIsEqual, enumerator_90309.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2570)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
      if (kBoolTrue == test_22) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2572)), GALGAS_lstring::constructor_new (GALGAS_string ("_high_interrupt"), enumerator_90309.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2573)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2574)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2575)) COMMA_SOURCE_FILE_AT_LINE (2571)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2577)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_90309.current_mInstructionList (HERE), outArgument_outGeneratedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_90309.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2590)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2592)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2578)) ;
        }
        const enumGalgasBool test_23 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2594)).boolEnum () ;
        if (kBoolTrue == test_23) {
          inCompiler->emitSemanticError (enumerator_90309.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2595)) ;
        }
        outArgument_outGeneratedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2598)) ;
      }
      enumerator_90309.gotoNextObject () ;
    }
  }
  cEnumerator_routineDefinitionList enumerator_91521 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_91521.hasCurrentObject ()) {
    GALGAS_uint var_currentBank = enumerator_91521.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2604)) ;
    GALGAS_routineKind var_routineKind ;
    const enumGalgasBool test_24 = enumerator_91521.current_mIsNoReturn (HERE).boolEnum () ;
    if (kBoolTrue == test_24) {
      var_routineKind = GALGAS_routineKind::constructor_noReturnRoutine (SOURCE_FILE_AT_LINE (2607)) ;
    }else if (kBoolFalse == test_24) {
      var_routineKind = GALGAS_routineKind::constructor_regularRoutine (SOURCE_FILE_AT_LINE (2609)) ;
    }
    GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2612)), enumerator_91521.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2614)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (SOURCE_FILE_AT_LINE (2615)) COMMA_SOURCE_FILE_AT_LINE (2611)) ;
    GALGAS_bool var_continuesInSequence ;
    {
    routine_analyzeInstructionList (enumerator_91521.current_mInstructionList (HERE), outArgument_outGeneratedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_91521.current_mPreservesBank (HERE), var_continuesInSequence, var_routineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2617)) ;
    }
    outArgument_outGeneratedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2634)) ;
    const enumGalgasBool test_25 = enumerator_91521.current_mIsNoReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2636)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_91521.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2636)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2636)))) COMMA_SOURCE_FILE_AT_LINE (2636)).operator_and (GALGAS_bool (kIsNotEqual, var_currentBank.objectCompare (enumerator_91521.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2636)))) COMMA_SOURCE_FILE_AT_LINE (2636)).boolEnum () ;
    if (kBoolTrue == test_25) {
      GALGAS_location location_26 (enumerator_91521.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, GALGAS_string ("execution will not set BSR to ").operator_concat (enumerator_91521.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2637)).reader_string (SOURCE_FILE_AT_LINE (2637)) COMMA_SOURCE_FILE_AT_LINE (2637)) COMMA_SOURCE_FILE_AT_LINE (2637)) ;
    }
    const enumGalgasBool test_27 = enumerator_91521.current_mIsNoReturn (HERE).operator_and (var_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (2639)).boolEnum () ;
    if (kBoolTrue == test_27) {
      GALGAS_location location_28 (enumerator_91521.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_28, GALGAS_string ("execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2640)) ;
    }
    enumerator_91521.gotoNextObject () ;
  }
  var_entryPoint = constinArgument_inBootloaderReservedROMsize.reader_uint (SOURCE_FILE_AT_LINE (2644)) ;
  cEnumerator_routineDeclarationList enumerator_92943 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_92943.hasCurrentObject ()) {
    const enumGalgasBool test_29 = enumerator_92943.current_mIsNoReturn (HERE).boolEnum () ;
    if (kBoolTrue == test_29) {
      outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_92943.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2650)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_92943.current_mRoutineName (HERE) COMMA_SOURCE_FILE_AT_LINE (2651)) COMMA_SOURCE_FILE_AT_LINE (2647)) COMMA_SOURCE_FILE_AT_LINE (2647)) ;
    }else if (kBoolFalse == test_29) {
      GALGAS_ipic_31__38_SequentialInstructionList var_instructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2654)) ;
      const enumGalgasBool test_30 = GALGAS_bool (kIsNotEqual, enumerator_92943.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2655)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2655)))).boolEnum () ;
      if (kBoolTrue == test_30) {
        var_instructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB::constructor_new (inCompiler->here (), enumerator_92943.current_mReturnedBank (HERE) COMMA_SOURCE_FILE_AT_LINE (2656)) COMMA_SOURCE_FILE_AT_LINE (2656)) ;
      }
      outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_92943.current_mRoutineName (HERE), var_instructionList, GALGAS_ipic_31__38_ReturnTerminator::constructor_new (SOURCE_FILE_AT_LINE (2662)) COMMA_SOURCE_FILE_AT_LINE (2658)) COMMA_SOURCE_FILE_AT_LINE (2658)) ;
    }
  ...
  {
  routine_displayBlockList (GALGAS_string ("INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2668)) ;
  }
  const enumGalgasBool test_31 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (2670)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_31) {
    {
    routine_ipic_31__38_OptimizeBlocks (ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2671)) ;
    }
    {
    routine_displayBlockList (GALGAS_string ("OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2672)) ;
    }
  }
}
...
static void categoryMethod_instruction_5F_do_5F_while_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_partList enumerator_55908 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_55908.hasCurrentObject ()) {
    ...
    GALGAS_ipic_31__38_AbstractBlockTerminator var_testTerminator ;
    callCategoryMethod_analyzeCondition ((const cPtr_conditionExpression *) enumerator_55908.current_mCondition (HERE).ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, GALGAS_bool (false), object->mAttribute_mInstructionLocation, ioArgument_ioGeneratedBlockList, var_conditionTrueLabel, var_conditionFalseLabel, var_testTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (1600)) ;
    ioArgument_ioCurrentBlock.mAttribute_mTerminator = var_testTerminator ;
    ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1613)) ;
    ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1615)), var_conditionTrueLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1617)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_startLabel COMMA_SOURCE_FILE_AT_LINE (1618)) COMMA_SOURCE_FILE_AT_LINE (1614)) ;
    GALGAS_uint var_branchFinalBank = ioArgument_ioCurrentBank ;
    GALGAS_bool var_branchInstructionsContinuesInSequence ;
    {
    routine_analyzeInstructionList (enumerator_55908.current_mInstructionList (HERE), ioArgument_ioGeneratedBlockList, constinArgument_inAccessBankSplitOffset, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioCurrentBlock, ioArgument_ioListFileContents, var_branchFinalBank, constinArgument_inShouldPreserveBSR, var_branchInstructionsContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (1621)) ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, ioArgument_ioCurrentBank.objectCompare (var_branchFinalBank)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (enumerator_55908.current_mEndOfPartLocation (HERE), GALGAS_string ("This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (1638)) ;
    }
    const enumGalgasBool test_3 = var_branchInstructionsContinuesInSequence.operator_not (SOURCE_FILE_AT_LINE (1640)).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (enumerator_55908.current_mEndOfPartLocation (HERE), GALGAS_string ("This branch makes the next code unreachable") COMMA_SOURCE_FILE_AT_LINE (1641)) ;
    }
    ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1643)) ;
    ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1645)), var_conditionFalseLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1647)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_exitLabel COMMA_SOURCE_FILE_AT_LINE (1648)) COMMA_SOURCE_FILE_AT_LINE (1644)) ;
    enumerator_55908.gotoNextObject () ;
  }
  ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1651)) ;
  ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1654)), var_exitLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1656)), var_currentBlockTerminator COMMA_SOURCE_FILE_AT_LINE (1653)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_bcc_5F_in_5F_structured_5F_if_5F_condition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    {
    routine_getComplementaryBcc (object->mAttribute_mCondition, var_condition, inCompiler COMMA_SOURCE_FILE_AT_LINE (1696)) ;
    }
  }else if (kBoolFalse == test_0) {
    var_condition = object->mAttribute_mCondition ;
  }
  outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BraCCTerminator::constructor_new (GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionTrueLabel COMMA_SOURCE_FILE_AT_LINE (1702)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionFalseLabel COMMA_SOURCE_FILE_AT_LINE (1703)), GALGAS_conditionalBranchMode::constructor_native (SOURCE_FILE_AT_LINE (1704)), var_condition COMMA_SOURCE_FILE_AT_LINE (1701)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_registerComparisonCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_60563_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1730)) ;
  outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_RegisterComparisonTerminator::constructor_new (GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionTrueLabel COMMA_SOURCE_FILE_AT_LINE (1739)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionFalseLabel COMMA_SOURCE_FILE_AT_LINE (1740)), var_IPICregisterDescription, var_comparison COMMA_SOURCE_FILE_AT_LINE (1738)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_incDecRegisterInCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_61548_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_61548_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1760)) ;
  const enumGalgasBool test_0 = object->mAttribute_mBranchIfZero.operator_xor (constinArgument_inComplementaryBranch COMMA_SOURCE_FILE_AT_LINE (1768)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    outArgument_outCurrentBlockTerminator = GALGAS_ipic_31__38_IncDecRegisterTerminator::constructor_new (GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionFalseLabel COMMA_SOURCE_FILE_AT_LINE (1778)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionTrueLabel COMMA_SOURCE_FILE_AT_LINE (1779)), var_IPICregisterDescription, object->mAttribute_mIncrement, object->mAttribute_m_5F_W_5F_isDestination COMMA_SOURCE_FILE_AT_LINE (1777)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_registerTestCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_62896_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_62896_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1801)) ;
  const enumGalgasBool test_0 = object->mAttribute_mBranchIfZero.operator_xor (constinArgument_inComplementaryBranch COMMA_SOURCE_FILE_AT_LINE (1809)).boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_TestRegisterTerminator::constructor_new (GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionTrueLabel COMMA_SOURCE_FILE_AT_LINE (1811)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionFalseLabel COMMA_SOURCE_FILE_AT_LINE (1812)), var_IPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (1810)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_TestRegisterTerminator::constructor_new (GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionFalseLabel COMMA_SOURCE_FILE_AT_LINE (1817)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionTrueLabel COMMA_SOURCE_FILE_AT_LINE (1818)), var_IPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (1816)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_bitTest_5F_in_5F_structured_5F_if_5F_condition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable var_bitSliceTable ;
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (1838)) ;
  GALGAS_uint var_bitNumber ;
  callCategoryMethod_getBitNumber ((const cPtr_bitNumberExpression *) object->mAttribute_mBitNumber.ptr (), var_bitSliceTable, var_bitNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (1845)) ;
  const enumGalgasBool test_0 = object->mAttribute_mBTFSSinstruction.operator_xor (constinArgument_inComplementaryBranch COMMA_SOURCE_FILE_AT_LINE (1850)).boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BitTestTerminator::constructor_new (GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionTrueLabel COMMA_SOURCE_FILE_AT_LINE (1852)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionFalseLabel COMMA_SOURCE_FILE_AT_LINE (1853)), var_IPICregisterDescription, var_bitNumber COMMA_SOURCE_FILE_AT_LINE (1851)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BitTestTerminator::constructor_new (GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionFalseLabel COMMA_SOURCE_FILE_AT_LINE (1859)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inConditionTrueLabel COMMA_SOURCE_FILE_AT_LINE (1860)), var_IPICregisterDescription, var_bitNumber COMMA_SOURCE_FILE_AT_LINE (1858)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_registerComparisonCondition_instructionCountForCondition (const cPtr_conditionExpression * inObject,
  ...
  if (kBoolTrue == test_0) {
    {
    routine_registerComparisonComplementary (object->mAttribute_mComparison, var_comparison, inCompiler COMMA_SOURCE_FILE_AT_LINE (2056)) ;
    }
  }else if (kBoolFalse == test_0) {
    var_comparison = object->mAttribute_mComparison ;
  }
  {
  routine_registerComparisonInstructionCount (var_comparison, outArgument_outInstructionCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (2060)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_registerTestCondition_instructionCountForCondition (const cPtr_conditionExpression * inObject,
  ...
  const cPtr_registerTestCondition * object = (const cPtr_registerTestCondition *) inObject ;
  macroValidSharedObject (object, const cPtr_registerTestCondition) ;
  const enumGalgasBool test_0 = object->mAttribute_mBranchIfZero.operator_xor (constinArgument_inComplementaryBranch COMMA_SOURCE_FILE_AT_LINE (2078)).boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outInstructionCount = GALGAS_uint ((PMUInt32) 3U) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outInstructionCount = GALGAS_uint ((PMUInt32) 2U) ;
...
static void categoryMethod_negateCondition_instructionCountForCondition (const cPtr_conditionExpression * inObject,
  ...
  const cPtr_negateCondition * object = (const cPtr_negateCondition *) inObject ;
  macroValidSharedObject (object, const cPtr_negateCondition) ;
  callCategoryMethod_instructionCountForCondition ((const cPtr_conditionExpression *) object->mAttribute_mCondition.ptr (), constinArgument_inComplementaryBranch.operator_not (SOURCE_FILE_AT_LINE (2092)), outArgument_outInstructionCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (2091)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_andCondition_instructionCountForCondition (const cPtr_conditionExpression * inObject,
  ...
  callCategoryMethod_instructionCountForCondition ((const cPtr_conditionExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inComplementaryBranch, var_countLeft, inCompiler COMMA_SOURCE_FILE_AT_LINE (2104)) ;
  GALGAS_uint var_countRight ;
  callCategoryMethod_instructionCountForCondition ((const cPtr_conditionExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inComplementaryBranch, var_countRight, inCompiler COMMA_SOURCE_FILE_AT_LINE (2109)) ;
  outArgument_outInstructionCount = var_countLeft.add_operation (var_countRight, inCompiler COMMA_SOURCE_FILE_AT_LINE (2113)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_InstructionWithNoOperand_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (categoryReader_assemblyCode (object->mAttribute_mKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2140)) COMMA_SOURCE_FILE_AT_LINE (2140)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (categoryReader_mnemonic (object->mAttribute_mInstruction_5F_FDA_5F_base_5F_code, inCompiler COMMA_SOURCE_FILE_AT_LINE (2148)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2148)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (2148)) COMMA_SOURCE_FILE_AT_LINE (2148)) COMMA_SOURCE_FILE_AT_LINE (2148)) ;
  const enumGalgasBool test_0 = object->mAttribute_m_5F_W_5F_isDestination.operator_and (object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (2149)) COMMA_SOURCE_FILE_AT_LINE (2149)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", W, BSR_ACCESS") COMMA_SOURCE_FILE_AT_LINE (2150)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (2151)).boolEnum () ;
    if (kBoolTrue == test_1) {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", F, BSR_ACCESS") COMMA_SOURCE_FILE_AT_LINE (2152)) ;
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_2 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
      if (kBoolTrue == test_2) {
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", W") COMMA_SOURCE_FILE_AT_LINE (2154)) ;
      }else if (kBoolFalse == test_2) {
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", F") COMMA_SOURCE_FILE_AT_LINE (2156)) ;
      }
    }
  }
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_FA_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (categoryReader_mnemonic (object->mAttribute_mFAinstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (2163)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2163)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (2163)) COMMA_SOURCE_FILE_AT_LINE (2163)) COMMA_SOURCE_FILE_AT_LINE (2163)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (categoryReader_mnemonic (object->mAttribute_mLiteralInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (2176)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2176)).operator_concat (object->mAttribute_mLiteralValue.reader_hexString (SOURCE_FILE_AT_LINE (2176)) COMMA_SOURCE_FILE_AT_LINE (2176)) COMMA_SOURCE_FILE_AT_LINE (2176)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("LFSR ").operator_concat (object->mAttribute_mFSRindex.reader_uint (SOURCE_FILE_AT_LINE (2182)).reader_string (SOURCE_FILE_AT_LINE (2182)) COMMA_SOURCE_FILE_AT_LINE (2182)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (2182)).operator_concat (object->mAttribute_mValue.reader_hexString (SOURCE_FILE_AT_LINE (2182)) COMMA_SOURCE_FILE_AT_LINE (2182)) COMMA_SOURCE_FILE_AT_LINE (2182)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_FBA_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (categoryReader_mnemonic (object->mAttribute_mBitOrientedOp, inCompiler COMMA_SOURCE_FILE_AT_LINE (2188)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2188)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (2188)) COMMA_SOURCE_FILE_AT_LINE (2188)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (2188)).operator_concat (object->mAttribute_mBitNumber.reader_string (SOURCE_FILE_AT_LINE (2188)) COMMA_SOURCE_FILE_AT_LINE (2188)) COMMA_SOURCE_FILE_AT_LINE (2188)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("BSR ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (2195)) COMMA_SOURCE_FILE_AT_LINE (2195)) COMMA_SOURCE_FILE_AT_LINE (2195)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicAbsolute: {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("JSR ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (2196)) COMMA_SOURCE_FILE_AT_LINE (2196)) COMMA_SOURCE_FILE_AT_LINE (2196)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("RCALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (2197)) COMMA_SOURCE_FILE_AT_LINE (2197)) COMMA_SOURCE_FILE_AT_LINE (2197)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("CALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (2198)) COMMA_SOURCE_FILE_AT_LINE (2198)) COMMA_SOURCE_FILE_AT_LINE (2198)) ;
      } break ;
    }
  }
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("MOVLB ").operator_concat (object->mAttribute_mBankIndex.reader_uint (SOURCE_FILE_AT_LINE (2205)).reader_string (SOURCE_FILE_AT_LINE (2205)) COMMA_SOURCE_FILE_AT_LINE (2205)) COMMA_SOURCE_FILE_AT_LINE (2205)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLRD_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("TBLRD ").operator_concat (categoryReader_mnemonic (object->mAttribute_mOption, inCompiler COMMA_SOURCE_FILE_AT_LINE (2211)) COMMA_SOURCE_FILE_AT_LINE (2211)) COMMA_SOURCE_FILE_AT_LINE (2211)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLWT_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("TBLWT ").operator_concat (categoryReader_mnemonic (object->mAttribute_mOption, inCompiler COMMA_SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("MNOP ").operator_concat (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (2223)).reader_string (SOURCE_FILE_AT_LINE (2223)) COMMA_SOURCE_FILE_AT_LINE (2223)) COMMA_SOURCE_FILE_AT_LINE (2223)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_MOV_5F_LABEL_5F_W_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("MOVLW ((").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (2229)) COMMA_SOURCE_FILE_AT_LINE (2229)).operator_concat (GALGAS_string (" + ") COMMA_SOURCE_FILE_AT_LINE (2229)).operator_concat (object->mAttribute_mOffset.reader_string (SOURCE_FILE_AT_LINE (2229)) COMMA_SOURCE_FILE_AT_LINE (2229)).operator_concat (GALGAS_string (") >> ") COMMA_SOURCE_FILE_AT_LINE (2229)).operator_concat (object->mAttribute_mRightShift.reader_string (SOURCE_FILE_AT_LINE (2229)) COMMA_SOURCE_FILE_AT_LINE (2229)).operator_concat (GALGAS_string (") & 0xFF") COMMA_SOURCE_FILE_AT_LINE (2229)) COMMA_SOURCE_FILE_AT_LINE (2229)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("COMPUTED RCALL ") COMMA_SOURCE_FILE_AT_LINE (2235)) ;
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("(uses RCALL)") COMMA_SOURCE_FILE_AT_LINE (2237)) ;
  }else if (kBoolFalse == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("(uses CALL)") COMMA_SOURCE_FILE_AT_LINE (2239)) ;
  }
  cEnumerator_lstringlist enumerator_77231 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_77231.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
      "    ").operator_concat (enumerator_77231.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2242)) COMMA_SOURCE_FILE_AT_LINE (2242)) COMMA_SOURCE_FILE_AT_LINE (2242)) ;
    enumerator_77231.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_BitTestSkip_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("!") COMMA_SOURCE_FILE_AT_LINE (2250)) ;
  }
  ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (2252)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (2252)).operator_concat (object->mAttribute_mBitNumber.reader_string (SOURCE_FILE_AT_LINE (2252)) COMMA_SOURCE_FILE_AT_LINE (2252)).operator_concat (GALGAS_string (" \?\n"
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FA_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (categoryReader_mnemonic (object->mAttribute_mFAinstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (2260)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2260)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (2260)) COMMA_SOURCE_FILE_AT_LINE (2260)).operator_concat (GALGAS_string (" \?\n"
    "    ") COMMA_SOURCE_FILE_AT_LINE (2261)) COMMA_SOURCE_FILE_AT_LINE (2260)) ;
  callCategoryMethod_display ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (2262)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_display (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (categoryReader_mnemonic (object->mAttribute_mInstruction_5F_FDA_5F_base_5F_code, inCompiler COMMA_SOURCE_FILE_AT_LINE (2268)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2268)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (2268)) COMMA_SOURCE_FILE_AT_LINE (2268)) COMMA_SOURCE_FILE_AT_LINE (2268)) ;
  const enumGalgasBool test_0 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", W") COMMA_SOURCE_FILE_AT_LINE (2270)) ;
  }
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" \?\n"
    "    ") COMMA_SOURCE_FILE_AT_LINE (2272)) ;
  callCategoryMethod_display ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (2273)) ;
}
//---------------------------------------------------------------------------*
...
void categoryMethod_display (const GALGAS_ipic_31__38_Block inObject,
                             ...
                             C_Compiler * inCompiler
                             COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("LABEL ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (2285)) COMMA_SOURCE_FILE_AT_LINE (2285)) COMMA_SOURCE_FILE_AT_LINE (2285)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, inObject.mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2286)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (", ORG ").operator_concat (inObject.mAttribute_mStartAddress.reader_hexString (SOURCE_FILE_AT_LINE (2287)) COMMA_SOURCE_FILE_AT_LINE (2287)) COMMA_SOURCE_FILE_AT_LINE (2287)) ;
  }
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (2289)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_79011 (inObject.mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_79011.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ") COMMA_SOURCE_FILE_AT_LINE (2292)) ;
    callCategoryMethod_display ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_79011.current_mInstruction (HERE).ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (2293)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (2294)) ;
    enumerator_79011.gotoNextObject () ;
  }
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ") COMMA_SOURCE_FILE_AT_LINE (2297)) ;
  callCategoryMethod_display ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (2298)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (2299)) ;
}
