...
void routine_analyzeInstructionList (const GALGAS_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_instructionList enumerator_72762 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_72762.hasCurrentObject ()) {
    const enumGalgasBool test_0 = outArgument_outContinuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2046)).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_72762.current_mInstruction (HERE).reader_mInstructionLocation (SOURCE_FILE_AT_LINE (2047)), GALGAS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (2047)) ;
      outArgument_outContinuesInSequence = GALGAS_bool (true) ;
    }
    callCategoryMethod_analyze ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_72762.current_mInstruction (HERE).ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioGeneratedBlockList, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioCurrentBlock, ioArgument_ioListFileContents, ioArgument_ioCurrentBank, constinArgument_inShouldPreserveBSR, outArgument_outContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2050)) ;
    enumerator_72762.gotoNextObject () ;
  }
}
...
void routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_routineDeclarationList enumerator_74307 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_74307.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_74307.current_mRoutineName (HERE), enumerator_74307.current_mIsNoReturn (HERE), enumerator_74307.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2091)), enumerator_74307.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2091)), enumerator_74307.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2091)) ;
    }
    enumerator_74307.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_74517 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_74517.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_74517.current_mRoutineName (HERE), enumerator_74517.current_mIsNoReturn (HERE), enumerator_74517.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2094)), enumerator_74517.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2094)), enumerator_74517.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2094)) ;
    }
    enumerator_74517.gotoNextObject () ;
  }
  cEnumerator_routineDefinitionList enumerator_74704 (constinArgument_inPiccoloModel.reader_mRoutineDefinitionList (SOURCE_FILE_AT_LINE (2096)), kEnumeration_up) ;
  while (enumerator_74704.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_74704.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2097)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2097)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_74704.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2097)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2097)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_74704.current_mRequiredBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_74704.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2100)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2100)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_74704.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2100)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2100)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_74704.current_mReturnedBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    {
    var_routineMap.modifier_insertKey (enumerator_74704.current_mRoutineName (HERE), enumerator_74704.current_mIsNoReturn (HERE), enumerator_74704.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2103)), enumerator_74704.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2103)), enumerator_74704.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2103)) ;
    }
    enumerator_74704.gotoNextObject () ;
  }
  ...
  cEnumerator_constantDefinitionList enumerator_75881 (constinArgument_inPiccoloModel.reader_mConstantDefinitionList (SOURCE_FILE_AT_LINE (2116)), kEnumeration_up) ;
  while (enumerator_75881.hasCurrentObject ()) {
    GALGAS_sint var_result ;
    callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_75881.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, var_constantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2117)) ;
    const enumGalgasBool test_5 = constinArgument_inRegisterTable.reader_hasKey (enumerator_75881.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2118)) COMMA_SOURCE_FILE_AT_LINE (2118)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_75881.current_mConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (enumerator_75881.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2119)) COMMA_SOURCE_FILE_AT_LINE (2119)).operator_concat (GALGAS_string ("' is already declared as ram register or special register") COMMA_SOURCE_FILE_AT_LINE (2119)) COMMA_SOURCE_FILE_AT_LINE (2119)) ;
    }else if (kBoolFalse == test_5) {
      {
      var_constantMap.modifier_insertKey (enumerator_75881.current_mConstantName (HERE), var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2121)) ;
      }
    }
    enumerator_75881.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_7) {
    ...
    if (kBoolTrue == test_8) {
      ...
      GALGAS_uint joker_76672_0 ; // Joker input parameter
      GALGAS_bool joker_76675_0 ; // Joker input parameter
      var_routineMap.method_searchKey (GALGAS_lstring::constructor_new (GALGAS_string ("main"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2134)), var_isNoReturn, var_requiredBank, joker_76672_0, joker_76675_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2134)) ;
  ...
  cEnumerator_routineDeclarationList enumerator_77381 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_77381.hasCurrentObject ()) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_77381.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2152)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2153)) COMMA_SOURCE_FILE_AT_LINE (2153)) COMMA_SOURCE_FILE_AT_LINE (2149)) COMMA_SOURCE_FILE_AT_LINE (2149)) ;
  ...
  if (kBoolTrue == test_14) {
    ...
    {
    GALGAS_luint joker_79081_0 ; // Joker input parameter
    GALGAS_luint joker_79084_0 ; // Joker input parameter
    GALGAS_bool joker_79087_0 ; // Joker input parameter
    GALGAS_bool joker_79090_0 ; // Joker input parameter
    var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_79081_0, joker_79084_0, joker_79087_0, joker_79090_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2185)) ;
    }
  ...
  if (var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2204)).isValid ()) {
    PMUInt32 variant_79946 = var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2204)).uintValue () ;
    bool loop_79946 = true ;
    while (loop_79946) {
      loop_79946 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2205)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2205)).isValid () ;
      if (loop_79946) {
        loop_79946 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2205)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2205)).boolValue () ;
      }
      if (loop_79946 && (0 == variant_79946)) {
        loop_79946 = false ;
      ...
      if (loop_79946) {
        ...
        GALGAS_lstring var_routineName ;
        {
        GALGAS_luint joker_80158_0 ; // Joker input parameter
        GALGAS_luint joker_80161_0 ; // Joker input parameter
        GALGAS_bool joker_80164_0 ; // Joker input parameter
        GALGAS_bool joker_80167_0 ; // Joker input parameter
        var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_80158_0, joker_80161_0, joker_80164_0, joker_80167_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2207)) ;
        }
  ...
  var_entryPoint = GALGAS_uint ((PMUInt32) 28U) ;
  cEnumerator_routineDeclarationList enumerator_81066 (var_tempBootloaderRoutineDeclarationList, kEnumeration_up) ;
  while (enumerator_81066.hasCurrentObject ()) {
    var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_bootloader_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2230)) COMMA_SOURCE_FILE_AT_LINE (2230)).reader_nowhere (SOURCE_FILE_AT_LINE (2230)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2231)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_81066.current_mRoutineName (HERE).mAttribute_location, enumerator_81066.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2228)) COMMA_SOURCE_FILE_AT_LINE (2228)) ;
  ...
  if (kBoolTrue == test_17) {
    cEnumerator_interruptDefinitionList enumerator_81649 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2240)), kEnumeration_up) ;
    while (enumerator_81649.hasCurrentObject ()) {
      const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_81649.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2241)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2243)), GALGAS_lstring::constructor_new (GALGAS_string ("_low_interrupt"), enumerator_81649.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2244)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2245)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (enumerator_81649.current_mInterruptName (HERE).mAttribute_location, enumerator_81649.current_mFastReturn (HERE) COMMA_SOURCE_FILE_AT_LINE (2246)) COMMA_SOURCE_FILE_AT_LINE (2242)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2248)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_81649.current_mInstructionList (HERE), var_generatedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_81649.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2261)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2263)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2249)) ;
        }
        const enumGalgasBool test_19 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2265)).boolEnum () ;
        if (kBoolTrue == test_19) {
          inCompiler->emitSemanticError (enumerator_81649.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2266)) ;
        }
        var_generatedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2269)) ;
      }
      enumerator_81649.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_20 = constinArgument_inHasHighInterrupt.boolEnum () ;
  if (kBoolTrue == test_20) {
    cEnumerator_interruptDefinitionList enumerator_82943 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2275)), kEnumeration_up) ;
    while (enumerator_82943.hasCurrentObject ()) {
      const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_82943.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2276)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
      if (kBoolTrue == test_21) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2278)), GALGAS_lstring::constructor_new (GALGAS_string ("_high_interrupt"), enumerator_82943.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2279)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2280)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (enumerator_82943.current_mInterruptName (HERE).mAttribute_location, GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2281)) COMMA_SOURCE_FILE_AT_LINE (2277)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2283)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_82943.current_mInstructionList (HERE), var_generatedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_82943.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2296)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2298)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2284)) ;
        }
        const enumGalgasBool test_22 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2300)).boolEnum () ;
        if (kBoolTrue == test_22) {
          inCompiler->emitSemanticError (enumerator_82943.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2301)) ;
        }
  ...
  cEnumerator_routineDefinitionList enumerator_84175 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_84175.hasCurrentObject ()) {
    GALGAS_uint var_currentBank = enumerator_84175.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2310)) ;
    GALGAS_routineKind var_routineKind ;
    const enumGalgasBool test_23 = enumerator_84175.current_mIsNoReturn (HERE).boolEnum () ;
    ...
    GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2318)), enumerator_84175.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2320)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (enumerator_84175.current_mRoutineName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2321)) COMMA_SOURCE_FILE_AT_LINE (2317)) ;
    GALGAS_bool var_continuesInSequence ;
    {
    routine_analyzeInstructionList (enumerator_84175.current_mInstructionList (HERE), var_generatedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_84175.current_mPreservesBank (HERE), var_continuesInSequence, var_routineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2323)) ;
    }
    var_generatedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2340)) ;
    const enumGalgasBool test_24 = enumerator_84175.current_mIsNoReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2342)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_84175.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2342)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2342)))) COMMA_SOURCE_FILE_AT_LINE (2342)).operator_and (GALGAS_bool (kIsNotEqual, var_currentBank.objectCompare (enumerator_84175.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2342)))) COMMA_SOURCE_FILE_AT_LINE (2342)).boolEnum () ;
    if (kBoolTrue == test_24) {
      GALGAS_location location_25 (enumerator_84175.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_25, GALGAS_string ("execution will not set BSR to ").operator_concat (enumerator_84175.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2343)).reader_string (SOURCE_FILE_AT_LINE (2343)) COMMA_SOURCE_FILE_AT_LINE (2343)) COMMA_SOURCE_FILE_AT_LINE (2343)) ;
    }
    const enumGalgasBool test_26 = enumerator_84175.current_mIsNoReturn (HERE).operator_and (var_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (2345)).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_location location_27 (enumerator_84175.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_84175.gotoNextObject () ;
  }
  ...
  GALGAS_bitSliceTable joker_85892_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_WREGregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_WREG_5F_IPICregisterDescription, joker_85892_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2353)) ;
  ...
  GALGAS_bitSliceTable joker_86224_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSLregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSL_5F_IPICregisterDescription, joker_86224_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2362)) ;
  ...
  GALGAS_bitSliceTable joker_86556_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSHregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSH_5F_IPICregisterDescription, joker_86556_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2371)) ;
  ...
  GALGAS_bitSliceTable joker_86888_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSUregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSU_5F_IPICregisterDescription, joker_86888_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2380)) ;
  GALGAS_ipic_31__38_SequentialInstruction var_ADDWF_5F_WREG = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_ADDWF (SOURCE_FILE_AT_LINE (2390)), var_WREG_5F_IPICregisterDescription, GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2388)) ;
  ...
  var_goto_32_InstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_ADDWF (SOURCE_FILE_AT_LINE (2409)), var_TOSL_5F_IPICregisterDescription, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2407)) COMMA_SOURCE_FILE_AT_LINE (2407)) ;
  ...
  var_goto_32_InstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_ADDWFC (SOURCE_FILE_AT_LINE (2420)), var_TOSH_5F_IPICregisterDescription, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2418)) COMMA_SOURCE_FILE_AT_LINE (2418)) ;
  var_goto_32_InstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA::constructor_new (inCompiler->here (), GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_ADDWFC (SOURCE_FILE_AT_LINE (2426)), var_TOSU_5F_IPICregisterDescription, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2424)) COMMA_SOURCE_FILE_AT_LINE (2424)) ;
  ...
  cEnumerator_routineDeclarationList enumerator_88785 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_88785.hasCurrentObject ()) {
    const enumGalgasBool test_28 = enumerator_88785.current_mIsNoReturn (HERE).boolEnum () ;
    if (kBoolTrue == test_28) {
      var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_88785.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2445)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_88785.current_mRoutineName (HERE).mAttribute_location, enumerator_88785.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2446)) COMMA_SOURCE_FILE_AT_LINE (2446)) COMMA_SOURCE_FILE_AT_LINE (2442)) COMMA_SOURCE_FILE_AT_LINE (2442)) ;
      ...
      const enumGalgasBool test_29 = GALGAS_bool (kIsNotEqual, enumerator_88785.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2450)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2450)))).boolEnum () ;
      if (kBoolTrue == test_29) {
        var_instructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB::constructor_new (inCompiler->here (), enumerator_88785.current_mReturnedBank (HERE) COMMA_SOURCE_FILE_AT_LINE (2451)) COMMA_SOURCE_FILE_AT_LINE (2451)) ;
      }
      var_generatedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_88785.current_mRoutineName (HERE), var_instructionList, GALGAS_ipic_31__38_ReturnTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2457)) COMMA_SOURCE_FILE_AT_LINE (2457)) COMMA_SOURCE_FILE_AT_LINE (2453)) COMMA_SOURCE_FILE_AT_LINE (2453)) ;
    }
    var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2460)) ;
    enumerator_88785.gotoNextObject () ;
  }
  {
...
static void categoryMethod_instruction_5F_IF_5F_IncDec_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_INCFSZ (SOURCE_FILE_AT_LINE (1405)) ;
  }else if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_1) {
      var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_INFSNZ (SOURCE_FILE_AT_LINE (1407)) ;
    }else if (kBoolFalse == test_1) {
      ...
      if (kBoolTrue == test_2) {
        var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_DECFSZ (SOURCE_FILE_AT_LINE (1409)) ;
      }else if (kBoolFalse == test_2) {
        var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_DCFSNZ (SOURCE_FILE_AT_LINE (1411)) ;
      }
    }
  }
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_51105_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_51105_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1414)) ;
  GALGAS_uint var_currentBank = ioArgument_ioCurrentBank ;
  GALGAS_ipic_31__38_SequentialInstruction var_embeddedInstruction ;
...
static void categoryMethod_instruction_5F_do_5F_while_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_partList enumerator_57502 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_57502.hasCurrentObject ()) {
    ...
    GALGAS_ipic_31__38_AbstractBlockTerminator var_testTerminator ;
    callCategoryMethod_analyzeCondition ((const cPtr_conditionExpression *) enumerator_57502.current_mCondition (HERE).ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, object->mAttribute_mInstructionLocation, ioArgument_ioGeneratedBlockList, var_conditionTrueLabel, var_conditionFalseLabel, var_testTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (1621)) ;
    ioArgument_ioCurrentBlock.mAttribute_mTerminator = var_testTerminator ;
    ...
    enumerator_57502.gotoNextObject () ;
  }
...
static void categoryMethod_registerComparisonCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_63337_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_63337_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1773)) ;
...
static void categoryMethod_incDecRegisterInCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_65774_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_65774_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1836)) ;
...
static void categoryMethod_registerTestCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_67357_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_67357_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1878)) ;
  const enumGalgasBool test_0 = object->mAttribute_mBranchIfZero.boolEnum () ;
  if (kBoolTrue == test_0) {
