...
void routine_analyzeInstructionList (const GALGAS_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_instructionList enumerator_71885 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_71885.hasCurrentObject ()) {
    const enumGalgasBool test_0 = outArgument_outContinuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2031)).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (enumerator_71885.current_mInstruction (HERE).reader_mInstructionLocation (SOURCE_FILE_AT_LINE (2032)), GALGAS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (2032)) ;
      outArgument_outContinuesInSequence = GALGAS_bool (true) ;
    }
    callCategoryMethod_analyze ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_71885.current_mInstruction (HERE).ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioGeneratedBlockList, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioCurrentBlock, ioArgument_ioListFileContents, ioArgument_ioCurrentBank, constinArgument_inShouldPreserveBSR, outArgument_outContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2035)) ;
    enumerator_71885.gotoNextObject () ;
  }
}
...
void routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_routineDeclarationList enumerator_73472 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_73472.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_73472.current_mRoutineName (HERE), enumerator_73472.current_mIsNoReturn (HERE), enumerator_73472.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2077)), enumerator_73472.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2077)), enumerator_73472.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2077)) ;
    }
    enumerator_73472.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_73682 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_73682.hasCurrentObject ()) {
    {
    var_routineMap.modifier_insertKey (enumerator_73682.current_mRoutineName (HERE), enumerator_73682.current_mIsNoReturn (HERE), enumerator_73682.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2080)), enumerator_73682.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2080)), enumerator_73682.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2080)) ;
    }
    enumerator_73682.gotoNextObject () ;
  }
  cEnumerator_routineDefinitionList enumerator_73869 (constinArgument_inPiccoloModel.reader_mRoutineDefinitionList (SOURCE_FILE_AT_LINE (2082)), kEnumeration_up) ;
  while (enumerator_73869.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_73869.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2083)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2083)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_73869.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2083)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2083)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_73869.current_mRequiredBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_73869.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2086)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2086)))).operator_and (GALGAS_bool (kIsStrictSup, enumerator_73869.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2086)).objectCompare (GALGAS_uint ((PMUInt32) 15U))) COMMA_SOURCE_FILE_AT_LINE (2086)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_73869.current_mReturnedBank (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    {
    var_routineMap.modifier_insertKey (enumerator_73869.current_mRoutineName (HERE), enumerator_73869.current_mIsNoReturn (HERE), enumerator_73869.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2089)), enumerator_73869.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2089)), enumerator_73869.current_mPreservesBank (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2089)) ;
    }
  ...
  cEnumerator_constantDefinitionList enumerator_75046 (constinArgument_inPiccoloModel.reader_mConstantDefinitionList (SOURCE_FILE_AT_LINE (2102)), kEnumeration_up) ;
  while (enumerator_75046.hasCurrentObject ()) {
    GALGAS_sint var_result ;
    callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_75046.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, var_constantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2103)) ;
    const enumGalgasBool test_5 = constinArgument_inRegisterTable.reader_hasKey (enumerator_75046.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2104)) COMMA_SOURCE_FILE_AT_LINE (2104)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_75046.current_mConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (enumerator_75046.current_mConstantName (HERE).reader_string (SOURCE_FILE_AT_LINE (2105)) COMMA_SOURCE_FILE_AT_LINE (2105)).operator_concat (GALGAS_string ("' is already declared as ram register or special register") COMMA_SOURCE_FILE_AT_LINE (2105)) COMMA_SOURCE_FILE_AT_LINE (2105)) ;
    }else if (kBoolFalse == test_5) {
      {
      var_constantMap.modifier_insertKey (enumerator_75046.current_mConstantName (HERE), var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (2107)) ;
      }
    }
  ...
  if (kBoolTrue == test_7) {
    ...
    if (kBoolTrue == test_8) {
      ...
      GALGAS_uint joker_75837_0 ; // Joker input parameter
      GALGAS_bool joker_75840_0 ; // Joker input parameter
      var_routineMap.method_searchKey (GALGAS_lstring::constructor_new (GALGAS_string ("main"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2120)), var_isNoReturn, var_requiredBank, joker_75837_0, joker_75840_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2120)) ;
  ...
  outArgument_outGeneratedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (2132)) ;
  GALGAS_uint var_entryPoint = GALGAS_uint ((PMUInt32) 4U) ;
  cEnumerator_routineDeclarationList enumerator_76552 (constinArgument_inBootloaderRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_76552.hasCurrentObject ()) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_76552.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2138)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (2139)) COMMA_SOURCE_FILE_AT_LINE (2139)) COMMA_SOURCE_FILE_AT_LINE (2135)) COMMA_SOURCE_FILE_AT_LINE (2135)) ;
  ...
  if (kBoolTrue == test_14) {
    ...
    {
    GALGAS_luint joker_78261_0 ; // Joker input parameter
    GALGAS_luint joker_78264_0 ; // Joker input parameter
    GALGAS_bool joker_78267_0 ; // Joker input parameter
    GALGAS_bool joker_78270_0 ; // Joker input parameter
    var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_78261_0, joker_78264_0, joker_78267_0, joker_78270_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2171)) ;
    }
  ...
  if (var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2190)).isValid ()) {
    PMUInt32 variant_79132 = var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2190)).uintValue () ;
    bool loop_79132 = true ;
    while (loop_79132) {
      loop_79132 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2191)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2191)).isValid () ;
      if (loop_79132) {
        loop_79132 = GALGAS_bool (kIsStrictSup, var_tempBootloaderRoutineDeclarationList.reader_length (SOURCE_FILE_AT_LINE (2191)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsStrictInf, var_entryPoint.objectCompare (GALGAS_uint ((PMUInt32) 24U))) COMMA_SOURCE_FILE_AT_LINE (2191)).boolValue () ;
      }
      if (loop_79132 && (0 == variant_79132)) {
        loop_79132 = false ;
      ...
      if (loop_79132) {
        ...
        GALGAS_lstring var_routineName ;
        {
        GALGAS_luint joker_79344_0 ; // Joker input parameter
        GALGAS_luint joker_79347_0 ; // Joker input parameter
        GALGAS_bool joker_79350_0 ; // Joker input parameter
        GALGAS_bool joker_79353_0 ; // Joker input parameter
        var_tempBootloaderRoutineDeclarationList.modifier_popFirst (var_routineName, joker_79344_0, joker_79347_0, joker_79350_0, joker_79353_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2193)) ;
        }
  ...
  var_entryPoint = GALGAS_uint ((PMUInt32) 28U) ;
  cEnumerator_routineDeclarationList enumerator_80258 (var_tempBootloaderRoutineDeclarationList, kEnumeration_up) ;
  while (enumerator_80258.hasCurrentObject ()) {
    outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, GALGAS_string ("_entry_bootloader_").operator_concat (var_entryPoint.reader_xString (SOURCE_FILE_AT_LINE (2216)) COMMA_SOURCE_FILE_AT_LINE (2216)).reader_nowhere (SOURCE_FILE_AT_LINE (2216)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2217)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_80258.current_mRoutineName (HERE).mAttribute_location, enumerator_80258.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2218)) COMMA_SOURCE_FILE_AT_LINE (2218)) COMMA_SOURCE_FILE_AT_LINE (2214)) COMMA_SOURCE_FILE_AT_LINE (2214)) ;
    var_entryPoint = var_entryPoint.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2220)) ;
    enumerator_80258.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_17) {
    cEnumerator_interruptDefinitionList enumerator_80844 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2226)), kEnumeration_up) ;
    while (enumerator_80844.hasCurrentObject ()) {
      const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_80844.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2227)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2229)), GALGAS_lstring::constructor_new (GALGAS_string ("_low_interrupt"), enumerator_80844.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2230)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2231)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (enumerator_80844.current_mInterruptName (HERE).mAttribute_location, enumerator_80844.current_mFastReturn (HERE) COMMA_SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2228)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2234)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_80844.current_mInstructionList (HERE), outArgument_outGeneratedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_80844.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2247)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2249)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2235)) ;
        }
        const enumGalgasBool test_19 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2251)).boolEnum () ;
        if (kBoolTrue == test_19) {
          inCompiler->emitSemanticError (enumerator_80844.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2252)) ;
        }
        outArgument_outGeneratedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2255)) ;
      }
      enumerator_80844.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_20 = constinArgument_inHasHighInterrupt.boolEnum () ;
  if (kBoolTrue == test_20) {
    cEnumerator_interruptDefinitionList enumerator_82144 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (2261)), kEnumeration_up) ;
    while (enumerator_82144.hasCurrentObject ()) {
      const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_82144.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (2262)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
      if (kBoolTrue == test_21) {
        GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2264)), GALGAS_lstring::constructor_new (GALGAS_string ("_high_interrupt"), enumerator_82144.current_mInterruptName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2265)), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2266)), GALGAS_ipic_31__38_RetfieTerminator::constructor_new (enumerator_82144.current_mInterruptName (HERE).mAttribute_location, GALGAS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2267)) COMMA_SOURCE_FILE_AT_LINE (2263)) ;
        GALGAS_uint var_currentBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2269)) ;
        GALGAS_bool var_continuesInSequence ;
        {
        routine_analyzeInstructionList (enumerator_82144.current_mInstructionList (HERE), outArgument_outGeneratedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_82144.current_mFastReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2282)), var_continuesInSequence, GALGAS_routineKind::constructor_interruptRoutine (SOURCE_FILE_AT_LINE (2284)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2270)) ;
        }
        const enumGalgasBool test_22 = var_continuesInSequence.operator_not (SOURCE_FILE_AT_LINE (2286)).boolEnum () ;
        if (kBoolTrue == test_22) {
          inCompiler->emitSemanticError (enumerator_82144.current_mEndOfInterruptLocation (HERE), GALGAS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2287)) ;
        }
        outArgument_outGeneratedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2290)) ;
      }
      enumerator_82144.gotoNextObject () ;
    }
  }
  cEnumerator_routineDefinitionList enumerator_83382 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_83382.hasCurrentObject ()) {
    GALGAS_uint var_currentBank = enumerator_83382.current_mRequiredBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2296)) ;
    GALGAS_routineKind var_routineKind ;
    const enumGalgasBool test_23 = enumerator_83382.current_mIsNoReturn (HERE).boolEnum () ;
    ...
    GALGAS_ipic_31__38_Block var_currentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2304)), enumerator_83382.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2306)), GALGAS_ipic_31__38_ReturnTerminator::constructor_new (enumerator_83382.current_mRoutineName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2307)) COMMA_SOURCE_FILE_AT_LINE (2303)) ;
    GALGAS_bool var_continuesInSequence ;
    {
    routine_analyzeInstructionList (enumerator_83382.current_mInstructionList (HERE), outArgument_outGeneratedBlockList, constinArgument_inAccessBankSplitOffset, var_routineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, var_constantMap, var_localLabelIndex, var_currentBlock, ioArgument_ioListFileContents, var_currentBank, enumerator_83382.current_mPreservesBank (HERE), var_continuesInSequence, var_routineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (2309)) ;
    }
    outArgument_outGeneratedBlockList.addAssign_operation (var_currentBlock COMMA_SOURCE_FILE_AT_LINE (2326)) ;
    const enumGalgasBool test_24 = enumerator_83382.current_mIsNoReturn (HERE).operator_not (SOURCE_FILE_AT_LINE (2328)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_83382.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2328)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2328)))) COMMA_SOURCE_FILE_AT_LINE (2328)).operator_and (GALGAS_bool (kIsNotEqual, var_currentBank.objectCompare (enumerator_83382.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2328)))) COMMA_SOURCE_FILE_AT_LINE (2328)).boolEnum () ;
    if (kBoolTrue == test_24) {
      GALGAS_location location_25 (enumerator_83382.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_25, GALGAS_string ("execution will not set BSR to ").operator_concat (enumerator_83382.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2329)).reader_string (SOURCE_FILE_AT_LINE (2329)) COMMA_SOURCE_FILE_AT_LINE (2329)) COMMA_SOURCE_FILE_AT_LINE (2329)) ;
    }
    const enumGalgasBool test_26 = enumerator_83382.current_mIsNoReturn (HERE).operator_and (var_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (2331)).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_location location_27 (enumerator_83382.current_mRoutineName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    enumerator_83382.gotoNextObject () ;
  }
  ...
  GALGAS_bitSliceTable joker_85105_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_WREGregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_WREG_5F_IPICregisterDescription, joker_85105_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2339)) ;
  ...
  GALGAS_bitSliceTable joker_85437_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSLregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSL_5F_IPICregisterDescription, joker_85437_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2348)) ;
  ...
  GALGAS_bitSliceTable joker_85769_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSHregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSH_5F_IPICregisterDescription, joker_85769_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2357)) ;
  ...
  GALGAS_bitSliceTable joker_86101_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TOSUregister.ptr (), constinArgument_inAccessBankSplitOffset, GALGAS_uint ((PMUInt32) 0U), constinArgument_inRegisterTable, var_TOSU_5F_IPICregisterDescription, joker_86101_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2366)) ;
  ...
  outArgument_outGeneratedBlockList.addAssign_operation (var_goto_34_Block COMMA_SOURCE_FILE_AT_LINE (2388)) ;
  ...
  outArgument_outGeneratedBlockList.addAssign_operation (var_goto_32_Block COMMA_SOURCE_FILE_AT_LINE (2423)) ;
  var_entryPoint = constinArgument_inBootloaderReservedROMsize.reader_uint (SOURCE_FILE_AT_LINE (2425)) ;
  cEnumerator_routineDeclarationList enumerator_88004 (constinArgument_inUserRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_88004.hasCurrentObject ()) {
    const enumGalgasBool test_28 = enumerator_88004.current_mIsNoReturn (HERE).boolEnum () ;
    if (kBoolTrue == test_28) {
      outArgument_outGeneratedBlockList.addAssign_operation (GALGAS_ipic_31__38_Block::constructor_new (var_entryPoint, enumerator_88004.current_mRoutineName (HERE), GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (2431)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (enumerator_88004.current_mRoutineName (HERE).mAttribute_location, enumerator_88004.current_mRoutineName (HERE), GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (2432)) COMMA_SOURCE_FILE_AT_LINE (2432)) COMMA_SOURCE_FILE_AT_LINE (2428)) COMMA_SOURCE_FILE_AT_LINE (2428)) ;
      ...
      const enumGalgasBool test_29 = GALGAS_bool (kIsNotEqual, enumerator_88004.current_mReturnedBank (HERE).reader_uint (SOURCE_FILE_AT_LINE (2436)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (2436)))).boolEnum () ;
      if (kBoolTrue == test_29) {
        var_instructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB::constructor_new (inCompiler->here (), enumerator_88004.current_mReturnedBank (HERE) COMMA_SOURCE_FILE_AT_LINE (2437)) COMMA_SOURCE_FILE_AT_LINE (2437)) ;
      }
    ...
    enumerator_88004.gotoNextObject () ;
  }
  {
  routine_displayBlockList (GALGAS_string ("INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2449)) ;
  }
  ...
  if (kBoolTrue == test_30) {
    {
    routine_ipic_31__38_OptimizeBlocks (ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2452)) ;
    }
    {
    routine_displayBlockList (GALGAS_string ("OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2453)) ;
    }
  }
  ...
  if (kBoolTrue == test_31) {
    {
    routine_ipic_31__38_OptimizeBlockOrdering (constinArgument_inSourceFileName, ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2457)) ;
    }
  }
  ...
  if (kBoolTrue == test_32) {
    {
    routine_ipic_31__38_RelativesResolution (ioArgument_ioListFileContents, outArgument_outGeneratedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2465)) ;
    }
  }
}
...
static void categoryMethod_instruction_5F_LTBLPTR_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_bitSliceTable joker_24122_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TBLPTRU.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_outIPICregisterDescription, joker_24122_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (699)) ;
  ...
  GALGAS_bitSliceTable joker_25296_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TBLPTRH.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_outIPICregisterDescription, joker_25296_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (733)) ;
  ...
  GALGAS_bitSliceTable joker_26473_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TBLPTRL.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_outIPICregisterDescription, joker_26473_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (767)) ;
...
static void categoryMethod_instruction_5F_LDATAPTR_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_outIPICregisterDescription ;
  GALGAS_bitSliceTable joker_28512_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TBLPTRU.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_outIPICregisterDescription, joker_28512_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (826)) ;
  ...
  GALGAS_bitSliceTable joker_29154_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TBLPTRH.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_outIPICregisterDescription, joker_29154_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (846)) ;
  ...
  GALGAS_bitSliceTable joker_29794_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) var_TBLPTRL.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_outIPICregisterDescription, joker_29794_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (866)) ;
...
static void categoryMethod_instruction_5F_JUMP_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_bool var_isNoReturn ;
  GALGAS_uint var_requiredBank ;
  GALGAS_uint joker_30828_0 ; // Joker input parameter
  GALGAS_bool joker_30831_0 ; // Joker input parameter
  constinArgument_inRoutineMap.method_searchKey (object->mAttribute_mTargetLabel, var_isNoReturn, var_requiredBank, joker_30828_0, joker_30831_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (904)) ;
  ...
  ioArgument_ioContinuesInSequence = GALGAS_bool (false) ;
  ioArgument_ioCurrentBlock.mAttribute_mTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (920)) COMMA_SOURCE_FILE_AT_LINE (920)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_instruction_5F_computed_5F_rcall_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_32348 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_32348.hasCurrentObject ()) {
    GALGAS_bool var_isNoReturn ;
    GALGAS_uint var_requiredBank ;
    GALGAS_uint var_returnedBank ;
    GALGAS_bool var_preservesBank ;
    constinArgument_inRoutineMap.method_searchKey (enumerator_32348.current_mValue (HERE), var_isNoReturn, var_requiredBank, var_returnedBank, var_preservesBank, inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
    ...
    if (kBoolTrue == test_0) {
      GALGAS_string var_errorMessage = GALGAS_string ("the routine '").operator_concat (enumerator_32348.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (947)) COMMA_SOURCE_FILE_AT_LINE (947)).operator_concat (GALGAS_string ("' requires BSR to be set to ") COMMA_SOURCE_FILE_AT_LINE (947)).operator_concat (var_requiredBank.reader_string (SOURCE_FILE_AT_LINE (947)) COMMA_SOURCE_FILE_AT_LINE (947)) ;
      ...
      GALGAS_location location_2 (enumerator_32348.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, var_errorMessage COMMA_SOURCE_FILE_AT_LINE (954)) ;
    }
    const enumGalgasBool test_3 = var_isNoReturn.boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_32348.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("for being named in a computed rcall, the '").operator_concat (enumerator_32348.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)).operator_concat (GALGAS_string ("' routine should be declared without the \"noreturn\" qualifier") COMMA_SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)) ;
    }
    ...
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_32348.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("the '").operator_concat (enumerator_32348.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (960)) COMMA_SOURCE_FILE_AT_LINE (960)).operator_concat (GALGAS_string ("' routine should preserved bank selection") COMMA_SOURCE_FILE_AT_LINE (960)) COMMA_SOURCE_FILE_AT_LINE (960)) ;
    }else if (kBoolFalse == test_5) {
      ...
      if (kBoolTrue == test_7) {
        ...
        if (kBoolTrue == test_8) {
          ...
          if (kBoolTrue == test_9) {
            GALGAS_string var_errorMessage = GALGAS_string ("the '").operator_concat (enumerator_32348.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (966)) COMMA_SOURCE_FILE_AT_LINE (966)).operator_concat (GALGAS_string ("' routine returns ") COMMA_SOURCE_FILE_AT_LINE (966)) ;
            ...
            GALGAS_location location_12 (enumerator_32348.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_instruction_5F_computed_5F_goto_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_35727 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_35727.hasCurrentObject ()) {
    GALGAS_bool var_isNoReturn ;
    GALGAS_uint var_requiredBank ;
    GALGAS_uint joker_35806_0 ; // Joker input parameter
    GALGAS_bool joker_35809_0 ; // Joker input parameter
    constinArgument_inRoutineMap.method_searchKey (enumerator_35727.current_mValue (HERE), var_isNoReturn, var_requiredBank, joker_35806_0, joker_35809_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1025)) ;
    ...
    if (kBoolTrue == test_0) {
      GALGAS_string var_errorMessage = GALGAS_string ("the routine '").operator_concat (enumerator_35727.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1027)) COMMA_SOURCE_FILE_AT_LINE (1027)).operator_concat (GALGAS_string ("' requires BSR to be set to ") COMMA_SOURCE_FILE_AT_LINE (1027)).operator_concat (var_requiredBank.reader_string (SOURCE_FILE_AT_LINE (1027)) COMMA_SOURCE_FILE_AT_LINE (1027)) ;
      ...
      GALGAS_location location_2 (enumerator_35727.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_35727.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("for being named in a computed goto, the '").operator_concat (enumerator_35727.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1037)) COMMA_SOURCE_FILE_AT_LINE (1037)).operator_concat (GALGAS_string ("' routine should be declared with the \"noreturn\" qualifier") COMMA_SOURCE_FILE_AT_LINE (1037)) COMMA_SOURCE_FILE_AT_LINE (1037)) ;
    }
  ...
  ioArgument_ioCurrentBlock.mAttribute_mTerminator = GALGAS_ipic_31__38_ComputedGotoTerminator::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabels, object->mAttribute_mUsesRelativeCall COMMA_SOURCE_FILE_AT_LINE (1058)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_instruction_5F_computed_5F_retlw_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  if (constinArgument_inRoutineKind.isValid ()) {
    ...
    case GALGAS_routineKind::kEnum_noReturnRoutine: {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("a \"noreturn\" routine does not accept computed retlw instruction") COMMA_SOURCE_FILE_AT_LINE (1086)) ;
      } break ;
    case GALGAS_routineKind::kEnum_interruptRoutine: {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("an interrupt routine does not accept computed retlw instruction") COMMA_SOURCE_FILE_AT_LINE (1088)) ;
      } break ;
    }
  }
  GALGAS_sint var_size ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mSizeExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_size, inCompiler COMMA_SOURCE_FILE_AT_LINE (1091)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, var_size.objectCompare (GALGAS_sint ((PMSInt32) 2L))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("the computed range (").operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (1093)) COMMA_SOURCE_FILE_AT_LINE (1093)).operator_concat (GALGAS_string (") should be greater or equal to 2") COMMA_SOURCE_FILE_AT_LINE (1093)) COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_size.objectCompare (GALGAS_sint ((PMSInt32) 128L))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("the computed range (").operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (1095)) COMMA_SOURCE_FILE_AT_LINE (1095)).operator_concat (GALGAS_string (") should be lower or equal to 128") COMMA_SOURCE_FILE_AT_LINE (1095)) COMMA_SOURCE_FILE_AT_LINE (1095)) ;
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_size.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (1096)).objectCompare (object->mAttribute_mImmediateExpressionList.reader_length (SOURCE_FILE_AT_LINE (1096)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("the constant list length (").operator_concat (object->mAttribute_mImmediateExpressionList.reader_length (SOURCE_FILE_AT_LINE (1097)).reader_string (SOURCE_FILE_AT_LINE (1097)) COMMA_SOURCE_FILE_AT_LINE (1097)).operator_concat (GALGAS_string (") should be equal to the computed range (") COMMA_SOURCE_FILE_AT_LINE (1097)).operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (1097)) COMMA_SOURCE_FILE_AT_LINE (1097)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (1097)) COMMA_SOURCE_FILE_AT_LINE (1097)) ;
      }
    }
  }
  GALGAS_uintlist var_literalValues = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1100)) ;
  cEnumerator_immediatExpressionList enumerator_39192 (object->mAttribute_mImmediateExpressionList, kEnumeration_up) ;
  GALGAS_uint index_39186 ((PMUInt32) 0) ;
  while (enumerator_39192.hasCurrentObject ()) {
    GALGAS_sint var_v ;
    callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_39192.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_v, inCompiler COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_v.objectCompare (GALGAS_sint ((PMSInt32) 255L))).operator_or (GALGAS_bool (kIsStrictInf, var_v.objectCompare (GALGAS_sint ((PMSInt32) 128L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1103)))) COMMA_SOURCE_FILE_AT_LINE (1103)).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("immediate value with idx ").operator_concat (index_39186.reader_string (SOURCE_FILE_AT_LINE (1104)) COMMA_SOURCE_FILE_AT_LINE (1104)).operator_concat (GALGAS_string (" is evaluated as ") COMMA_SOURCE_FILE_AT_LINE (1104)).operator_concat (var_v.reader_string (SOURCE_FILE_AT_LINE (1104)) COMMA_SOURCE_FILE_AT_LINE (1104)).operator_concat (GALGAS_string (" (should be <= 255)") COMMA_SOURCE_FILE_AT_LINE (1104)) COMMA_SOURCE_FILE_AT_LINE (1104)) ;
    }
    var_literalValues.addAssign_operation (var_v.operator_and (GALGAS_sint ((PMSInt32) 255L) COMMA_SOURCE_FILE_AT_LINE (1106)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (1106)) COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    enumerator_39192.gotoNextObject () ;
    index_39186.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1101)) ;
  }
  ioArgument_ioCurrentBlock.mAttribute_mTerminator = GALGAS_ipic_31__38_ComputedRETLWTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_literalValues, object->mAttribute_mUsesRelativeCall COMMA_SOURCE_FILE_AT_LINE (1109)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_instruction_5F_JUMPCC_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_bool var_isNoReturn ;
  GALGAS_uint var_requiredBank ;
  GALGAS_uint joker_40364_0 ; // Joker input parameter
  GALGAS_bool joker_40367_0 ; // Joker input parameter
  constinArgument_inRoutineMap.method_searchKey (object->mAttribute_mTargetLabel, var_isNoReturn, var_requiredBank, joker_40364_0, joker_40367_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1133)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_requiredBank.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1134)))).operator_and (GALGAS_bool (kIsNotEqual, var_requiredBank.objectCompare (ioArgument_ioCurrentBank)) COMMA_SOURCE_FILE_AT_LINE (1134)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string var_errorMessage = GALGAS_string ("the routine '").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (1135)) COMMA_SOURCE_FILE_AT_LINE (1135)).operator_concat (GALGAS_string ("' requires BSR to be set to ") COMMA_SOURCE_FILE_AT_LINE (1135)).operator_concat (var_requiredBank.reader_string (SOURCE_FILE_AT_LINE (1135)) COMMA_SOURCE_FILE_AT_LINE (1135)) ;
    var_errorMessage.dotAssign_operation (GALGAS_string (", but BSR ") COMMA_SOURCE_FILE_AT_LINE (1136)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, ioArgument_ioCurrentBank.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1137)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_errorMessage.dotAssign_operation (GALGAS_string ("does contain any reliable value") COMMA_SOURCE_FILE_AT_LINE (1138)) ;
    }else if (kBoolFalse == test_1) {
      var_errorMessage.dotAssign_operation (GALGAS_string ("is set to ").operator_concat (ioArgument_ioCurrentBank.reader_string (SOURCE_FILE_AT_LINE (1140)) COMMA_SOURCE_FILE_AT_LINE (1140)) COMMA_SOURCE_FILE_AT_LINE (1140)) ;
    }
    GALGAS_location location_2 (object->mAttribute_mTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, var_errorMessage COMMA_SOURCE_FILE_AT_LINE (1142)) ;
  }
  const enumGalgasBool test_3 = var_isNoReturn.operator_not (SOURCE_FILE_AT_LINE (1144)).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_location location_4 (object->mAttribute_mTargetLabel.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("a regular routine should be called with a RCALL, CALL or JSR instruction") COMMA_SOURCE_FILE_AT_LINE (1145)) ;
  }
  ...
  if (kBoolTrue == test_5) {
    ...
    var_mode = GALGAS_conditionalBranchMode::constructor_native (SOURCE_FILE_AT_LINE (1152)) ;
  }
  GALGAS_lstring var_label_30_ = GALGAS_lstring::constructor_new (GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (1155)) COMMA_SOURCE_FILE_AT_LINE (1155)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1155)) ;
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1156)) ;
  GALGAS_ipic_31__38_AbstractBlockTerminator var_terminator = ioArgument_ioCurrentBlock.mAttribute_mTerminator ;
  ioArgument_ioCurrentBlock.mAttribute_mTerminator = GALGAS_ipic_31__38_ConditionalJumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1162)) COMMA_SOURCE_FILE_AT_LINE (1162)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_label_30_, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1163)) COMMA_SOURCE_FILE_AT_LINE (1163)), var_mode, object->mAttribute_mConditionalBranch COMMA_SOURCE_FILE_AT_LINE (1160)) ;
  ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1169)), var_label_30_, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1171)), var_terminator COMMA_SOURCE_FILE_AT_LINE (1168)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_instruction_5F_computed_5F_bra_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_uint var_returnedBankValue = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1196)) ;
  cEnumerator_lstringlist enumerator_42682 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_42682.hasCurrentObject ()) {
    GALGAS_bool var_isNoReturn ;
    GALGAS_uint var_requiredBank ;
    GALGAS_uint var_returnedBank ;
    GALGAS_bool var_preservesBank ;
    constinArgument_inRoutineMap.method_searchKey (enumerator_42682.current_mValue (HERE), var_isNoReturn, var_requiredBank, var_returnedBank, var_preservesBank, inCompiler COMMA_SOURCE_FILE_AT_LINE (1198)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_requiredBank.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1200)))).operator_and (GALGAS_bool (kIsNotEqual, var_requiredBank.objectCompare (ioArgument_ioCurrentBank)) COMMA_SOURCE_FILE_AT_LINE (1200)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_errorMessage = GALGAS_string ("the routine '").operator_concat (enumerator_42682.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1201)) COMMA_SOURCE_FILE_AT_LINE (1201)).operator_concat (GALGAS_string ("' requires BSR to be set to ") COMMA_SOURCE_FILE_AT_LINE (1201)).operator_concat (var_requiredBank.reader_string (SOURCE_FILE_AT_LINE (1201)) COMMA_SOURCE_FILE_AT_LINE (1201)) ;
      var_errorMessage.dotAssign_operation (GALGAS_string (", but BSR ") COMMA_SOURCE_FILE_AT_LINE (1202)) ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, ioArgument_ioCurrentBank.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1203)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_errorMessage.dotAssign_operation (GALGAS_string ("does contain any reliable value") COMMA_SOURCE_FILE_AT_LINE (1204)) ;
      }else if (kBoolFalse == test_1) {
        var_errorMessage.dotAssign_operation (GALGAS_string ("is set to ").operator_concat (ioArgument_ioCurrentBank.reader_string (SOURCE_FILE_AT_LINE (1206)) COMMA_SOURCE_FILE_AT_LINE (1206)) COMMA_SOURCE_FILE_AT_LINE (1206)) ;
      }
      GALGAS_location location_2 (enumerator_42682.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, var_errorMessage COMMA_SOURCE_FILE_AT_LINE (1208)) ;
    }
    const enumGalgasBool test_3 = var_preservesBank.boolEnum () ;
    if (kBoolTrue == test_3) {
      var_allReturnBank = GALGAS_bool (false) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_returnedBankValue.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1213)))).operator_and (GALGAS_bool (kIsNotEqual, var_returnedBankValue.objectCompare (var_returnedBank)) COMMA_SOURCE_FILE_AT_LINE (1213)).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_location location_5 (enumerator_42682.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("this routine ensures setting of bank '").operator_concat (var_returnedBank.reader_string (SOURCE_FILE_AT_LINE (1214)) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("', but ") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("previous routine(s) ensure setting of bank '") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (var_returnedBankValue.reader_string (SOURCE_FILE_AT_LINE (1215)) COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string ("'.") COMMA_SOURCE_FILE_AT_LINE (1215)) COMMA_SOURCE_FILE_AT_LINE (1214)) ;
      }else if (kBoolFalse == test_4) {
        var_allPreserveBankSetting = GALGAS_bool (false) ;
        var_returnedBankValue = var_returnedBank ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, GALGAS_routineKind::constructor_regularRoutine (SOURCE_FILE_AT_LINE (1220)).objectCompare (constinArgument_inRoutineKind)).operator_and (var_isNoReturn.operator_not (SOURCE_FILE_AT_LINE (1220)) COMMA_SOURCE_FILE_AT_LINE (1220)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_location location_7 (enumerator_42682.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("for being named in a computed bra from a regular routine, the '").operator_concat (enumerator_42682.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1221)) COMMA_SOURCE_FILE_AT_LINE (1221)).operator_concat (GALGAS_string ("' routine should be declared without any \"noreturn\" qualifier") COMMA_SOURCE_FILE_AT_LINE (1221)) COMMA_SOURCE_FILE_AT_LINE (1221)) ;
    }
    enumerator_42682.gotoNextObject () ;
  }
  const enumGalgasBool test_8 = var_allReturnBank.operator_and (var_allPreserveBankSetting.operator_not (SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1225)).boolEnum () ;
  if (kBoolTrue == test_8) {
    ioArgument_ioCurrentBank = var_returnedBankValue ;
  }else if (kBoolFalse == test_8) {
    const enumGalgasBool test_9 = var_allReturnBank.operator_not (SOURCE_FILE_AT_LINE (1227)).operator_and (var_allPreserveBankSetting.operator_not (SOURCE_FILE_AT_LINE (1227)) COMMA_SOURCE_FILE_AT_LINE (1227)).boolEnum () ;
    if (kBoolTrue == test_9) {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("invoked routine should either all preserve bank, eihter return the same selected bank") COMMA_SOURCE_FILE_AT_LINE (1228)) ;
    }
  }
  const enumGalgasBool test_10 = constinArgument_inShouldPreserveBSR.operator_and (var_allPreserveBankSetting.operator_not (SOURCE_FILE_AT_LINE (1230)) COMMA_SOURCE_FILE_AT_LINE (1230)).boolEnum () ;
  if (kBoolTrue == test_10) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("invoked routine(s) do(es) not preserve bank selection") COMMA_SOURCE_FILE_AT_LINE (1231)) ;
  }
  ioArgument_ioContinuesInSequence = GALGAS_bool (false) ;
  if (constinArgument_inRoutineKind.isValid ()) {
    switch (constinArgument_inRoutineKind.enumValue ()) {
    ...
    case GALGAS_routineKind::kEnum_interruptRoutine: {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("an interrupt routine does not accept computed bra instruction") COMMA_SOURCE_FILE_AT_LINE (1240)) ;
      } break ;
    }
  }
  GALGAS_sint var_size ;
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mSizeExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_size, inCompiler COMMA_SOURCE_FILE_AT_LINE (1243)) ;
  const enumGalgasBool test_11 = GALGAS_bool (kIsStrictInf, var_size.objectCompare (GALGAS_sint ((PMSInt32) 2L))).boolEnum () ;
  if (kBoolTrue == test_11) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("the computed range (").operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1245)).operator_concat (GALGAS_string (") should be greater or equal to 2") COMMA_SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1245)) ;
  }else if (kBoolFalse == test_11) {
    const enumGalgasBool test_12 = GALGAS_bool (kIsStrictSup, var_size.objectCompare (GALGAS_sint ((PMSInt32) 128L))).boolEnum () ;
    if (kBoolTrue == test_12) {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("the computed range (").operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (1247)) COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (GALGAS_string (") should be lower or equal to 128") COMMA_SOURCE_FILE_AT_LINE (1247)) COMMA_SOURCE_FILE_AT_LINE (1247)) ;
    }else if (kBoolFalse == test_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, var_size.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (1248)).objectCompare (object->mAttribute_mTargetLabels.reader_length (SOURCE_FILE_AT_LINE (1248)))).boolEnum () ;
      if (kBoolTrue == test_13) {
        inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("the routine name list length (").operator_concat (object->mAttribute_mTargetLabels.reader_length (SOURCE_FILE_AT_LINE (1249)).reader_string (SOURCE_FILE_AT_LINE (1249)) COMMA_SOURCE_FILE_AT_LINE (1249)).operator_concat (GALGAS_string (") should be equal to the computed range (") COMMA_SOURCE_FILE_AT_LINE (1249)).operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (1249)) COMMA_SOURCE_FILE_AT_LINE (1249)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (1249)) COMMA_SOURCE_FILE_AT_LINE (1249)) ;
      }
    }
  }
  ioArgument_ioCurrentBlock.mAttribute_mTerminator = GALGAS_ipic_31__38_ComputedBraTerminator::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabels, object->mAttribute_mUsesRelativeCall COMMA_SOURCE_FILE_AT_LINE (1252)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_instruction_5F_IF_5F_BitTest_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable var_bitSliceTable ;
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (1277)) ;
  GALGAS_uint var_bitNumber ;
  callCategoryMethod_getBitNumber ((const cPtr_bitNumberExpression *) object->mAttribute_mBitNumber.ptr (), var_bitSliceTable, var_bitNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (1284)) ;
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEmbeddedInstruction.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1302)), GALGAS_string ("this instruction does not preserve bank setting") COMMA_SOURCE_FILE_AT_LINE (1302)) ;
  }
...
static void categoryMethod_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  if (object->mAttribute_mOpCode.isValid ()) {
    ...
    case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_CPFSEQ: {
      var_baseCode = GALGAS_FA_5F_instruction_5F_base_5F_code::constructor_CPFSEQ (SOURCE_FILE_AT_LINE (1333)) ;
      } break ;
    case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_CPFSGT: {
      var_baseCode = GALGAS_FA_5F_instruction_5F_base_5F_code::constructor_CPFSGT (SOURCE_FILE_AT_LINE (1334)) ;
      } break ;
    case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_CPFSLT: {
      var_baseCode = GALGAS_FA_5F_instruction_5F_base_5F_code::constructor_CPFSLT (SOURCE_FILE_AT_LINE (1335)) ;
      } break ;
    case GALGAS_if_5F_semi_5F_colon_5F_op::kEnum_TSTFSZ: {
      var_baseCode = GALGAS_FA_5F_instruction_5F_base_5F_code::constructor_TSTFSZ (SOURCE_FILE_AT_LINE (1336)) ;
      } break ;
    }
  }
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_48343_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_48343_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  GALGAS_uint var_currentBank = ioArgument_ioCurrentBank ;
  GALGAS_ipic_31__38_SequentialInstruction var_embeddedInstruction ;
  callCategoryMethod_analyzeSimpleInstruction ((const cPtr_pic_31__38_PiccoloSimpleInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, var_currentBank, constinArgument_inShouldPreserveBSR, var_embeddedInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (1347)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_currentBank.objectCompare (var_currentBank)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEmbeddedInstruction.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1359)), GALGAS_string ("this instruction does not preserve bank setting") COMMA_SOURCE_FILE_AT_LINE (1359)) ;
  }
  ioArgument_ioCurrentBlock.mAttribute_mInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_FA::constructor_new (object->mAttribute_mInstructionLocation, var_embeddedInstruction, var_baseCode, var_IPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (1362)) COMMA_SOURCE_FILE_AT_LINE (1362)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_instruction_5F_IF_5F_IncDec_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mIncrement.operator_and (object->mAttribute_mSkipIfZero COMMA_SOURCE_FILE_AT_LINE (1389)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_INCFSZ (SOURCE_FILE_AT_LINE (1390)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = object->mAttribute_mIncrement.operator_and (object->mAttribute_mSkipIfZero.operator_not (SOURCE_FILE_AT_LINE (1391)) COMMA_SOURCE_FILE_AT_LINE (1391)).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_INFSNZ (SOURCE_FILE_AT_LINE (1392)) ;
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_2 = object->mAttribute_mIncrement.operator_not (SOURCE_FILE_AT_LINE (1393)).operator_and (object->mAttribute_mSkipIfZero COMMA_SOURCE_FILE_AT_LINE (1393)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_DECFSZ (SOURCE_FILE_AT_LINE (1394)) ;
      }else if (kBoolFalse == test_2) {
        var_baseCode = GALGAS_instruction_5F_FDA_5F_base_5F_code::constructor_DCFSNZ (SOURCE_FILE_AT_LINE (1396)) ;
      }
    }
  }
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_50228_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_50228_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1399)) ;
  GALGAS_uint var_currentBank = ioArgument_ioCurrentBank ;
  GALGAS_ipic_31__38_SequentialInstruction var_embeddedInstruction ;
  ...
  if (kBoolTrue == test_3) {
    inCompiler->emitSemanticError (object->mAttribute_mEmbeddedInstruction.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1420)), GALGAS_string ("this instruction does not preserve bank setting") COMMA_SOURCE_FILE_AT_LINE (1420)) ;
  }
...
static void categoryMethod_instruction_5F_structured_5F_if_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_lstring var_conditionTrueLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (1450)) COMMA_SOURCE_FILE_AT_LINE (1450)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1450)) ;
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1451)) ;
  GALGAS_lstring var_conditionFalseLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (1452)) COMMA_SOURCE_FILE_AT_LINE (1452)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1452)) ;
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1453)) ;
  GALGAS_lstring var_exitLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (1454)) COMMA_SOURCE_FILE_AT_LINE (1454)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1454)) ;
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1455)) ;
  GALGAS_ipic_31__38_AbstractBlockTerminator var_testTerminator ;
  callCategoryMethod_analyzeCondition ((const cPtr_conditionExpression *) object->mAttribute_mIfCondition.ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, object->mAttribute_mInstructionLocation, ioArgument_ioGeneratedBlockList, var_conditionTrueLabel, var_conditionFalseLabel, var_testTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (1457)) ;
  ...
  ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1472)) ;
  ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1475)), var_exitLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1477)), var_currentBlockTerminator COMMA_SOURCE_FILE_AT_LINE (1474)) ;
  GALGAS_uint var_elseBranchFinalBank = ioArgument_ioCurrentBank ;
  GALGAS_uint var_thenBranchFinalBank = ioArgument_ioCurrentBank ;
  GALGAS_ipic_31__38_Block var_thenBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1484)), var_conditionTrueLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1486)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_exitLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1487)) COMMA_SOURCE_FILE_AT_LINE (1487)) COMMA_SOURCE_FILE_AT_LINE (1483)) ;
  GALGAS_bool var_thenContinuesInSequence ;
  {
  routine_analyzeInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioGeneratedBlockList, constinArgument_inAccessBankSplitOffset, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, var_thenBlock, ioArgument_ioListFileContents, var_thenBranchFinalBank, constinArgument_inShouldPreserveBSR, var_thenContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (1489)) ;
  }
  ioArgument_ioGeneratedBlockList.addAssign_operation (var_thenBlock COMMA_SOURCE_FILE_AT_LINE (1505)) ;
  GALGAS_ipic_31__38_Block var_elseBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1508)), var_conditionFalseLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1510)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_exitLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1511)) COMMA_SOURCE_FILE_AT_LINE (1511)) COMMA_SOURCE_FILE_AT_LINE (1507)) ;
  GALGAS_bool var_elseContinuesInSequence ;
  {
  routine_analyzeInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioGeneratedBlockList, constinArgument_inAccessBankSplitOffset, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, var_elseBlock, ioArgument_ioListFileContents, var_elseBranchFinalBank, constinArgument_inShouldPreserveBSR, var_elseContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (1513)) ;
  }
  ioArgument_ioGeneratedBlockList.addAssign_operation (var_elseBlock COMMA_SOURCE_FILE_AT_LINE (1529)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (object->mAttribute_mEndOfElsePartLocation, GALGAS_string ("This branch does not leave BSR value as the first one does") COMMA_SOURCE_FILE_AT_LINE (1534)) ;
    var_elseBranchFinalBank = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1535)) ;
  }
  ioArgument_ioContinuesInSequence = var_thenContinuesInSequence.operator_or (var_elseContinuesInSequence COMMA_SOURCE_FILE_AT_LINE (1538)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_instruction_5F_do_5F_while_analyze (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  GALGAS_lstring var_startLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (1559)) COMMA_SOURCE_FILE_AT_LINE (1559)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1559)) ;
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1560)) ;
  GALGAS_lstring var_exitLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_label_").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (1561)) COMMA_SOURCE_FILE_AT_LINE (1561)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1561)) ;
  ioArgument_ioLocalLabelIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1562)) ;
  GALGAS_ipic_31__38_AbstractBlockTerminator var_currentBlockTerminator = ioArgument_ioCurrentBlock.mAttribute_mTerminator ;
  ioArgument_ioCurrentBlock.mAttribute_mTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_startLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1566)) COMMA_SOURCE_FILE_AT_LINE (1566)) ;
  ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1567)) ;
  ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1570)), var_startLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1572)), var_currentBlockTerminator COMMA_SOURCE_FILE_AT_LINE (1569)) ;
  GALGAS_uint var_repeatedBranchFinalBank = ioArgument_ioCurrentBank ;
  GALGAS_bool var_repeatedInstructionsContinuesInSequence ;
  {
  routine_analyzeInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioGeneratedBlockList, constinArgument_inAccessBankSplitOffset, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioCurrentBlock, ioArgument_ioListFileContents, var_repeatedBranchFinalBank, constinArgument_inShouldPreserveBSR, var_repeatedInstructionsContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (1576)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfRepeatedInstructionList, GALGAS_string ("This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (1593)) ;
  }
  const enumGalgasBool test_1 = var_repeatedInstructionsContinuesInSequence.operator_not (SOURCE_FILE_AT_LINE (1595)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfRepeatedInstructionList, GALGAS_string ("This branch makes the next code unreachable") COMMA_SOURCE_FILE_AT_LINE (1596)) ;
  }
  cEnumerator_partList enumerator_56625 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_56625.hasCurrentObject ()) {
    ...
    GALGAS_ipic_31__38_AbstractBlockTerminator var_testTerminator ;
    callCategoryMethod_analyzeCondition ((const cPtr_conditionExpression *) enumerator_56625.current_mCondition (HERE).ptr (), constinArgument_inAccessBankSplitOffset, ioArgument_ioCurrentBank, constinArgument_inRegisterTable, ioArgument_ioLocalLabelIndex, object->mAttribute_mInstructionLocation, ioArgument_ioGeneratedBlockList, var_conditionTrueLabel, var_conditionFalseLabel, var_testTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (1606)) ;
    ioArgument_ioCurrentBlock.mAttribute_mTerminator = var_testTerminator ;
    ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1618)) ;
    ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1620)), var_conditionTrueLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1622)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_startLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1623)) COMMA_SOURCE_FILE_AT_LINE (1623)) COMMA_SOURCE_FILE_AT_LINE (1619)) ;
    GALGAS_uint var_branchFinalBank = ioArgument_ioCurrentBank ;
    GALGAS_bool var_branchInstructionsContinuesInSequence ;
    {
    routine_analyzeInstructionList (enumerator_56625.current_mInstructionList (HERE), ioArgument_ioGeneratedBlockList, constinArgument_inAccessBankSplitOffset, constinArgument_inRoutineMap, constinArgument_inRegisterTable, constinArgument_inDataMap, constinArgument_inConstantMap, ioArgument_ioLocalLabelIndex, ioArgument_ioCurrentBlock, ioArgument_ioListFileContents, var_branchFinalBank, constinArgument_inShouldPreserveBSR, var_branchInstructionsContinuesInSequence, constinArgument_inRoutineKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (1626)) ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, ioArgument_ioCurrentBank.objectCompare (var_branchFinalBank)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (enumerator_56625.current_mEndOfPartLocation (HERE), GALGAS_string ("This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (1643)) ;
    }
    const enumGalgasBool test_3 = var_branchInstructionsContinuesInSequence.operator_not (SOURCE_FILE_AT_LINE (1645)).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (enumerator_56625.current_mEndOfPartLocation (HERE), GALGAS_string ("This branch makes the next code unreachable") COMMA_SOURCE_FILE_AT_LINE (1646)) ;
    }
    ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1648)) ;
    ioArgument_ioCurrentBlock = GALGAS_ipic_31__38_Block::constructor_new (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1650)), var_conditionFalseLabel, GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (1652)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_exitLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1653)) COMMA_SOURCE_FILE_AT_LINE (1653)) COMMA_SOURCE_FILE_AT_LINE (1649)) ;
    enumerator_56625.gotoNextObject () ;
  }
  ioArgument_ioGeneratedBlockList.addAssign_operation (ioArgument_ioCurrentBlock COMMA_SOURCE_FILE_AT_LINE (1656)) ;
...
static void categoryMethod_bcc_5F_in_5F_structured_5F_if_5F_condition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  if (object->mAttribute_mCondition.isValid ()) {
    ...
    case GALGAS_conditional_5F_branch::kEnum_bz: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bz (SOURCE_FILE_AT_LINE (1701)) ;
      var_complementaryCondition = GALGAS_bool (false) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnz: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bz (SOURCE_FILE_AT_LINE (1704)) ;
      var_complementaryCondition = GALGAS_bool (true) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bn: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bn (SOURCE_FILE_AT_LINE (1707)) ;
      var_complementaryCondition = GALGAS_bool (false) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnn: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bn (SOURCE_FILE_AT_LINE (1710)) ;
      var_complementaryCondition = GALGAS_bool (true) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bc: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bc (SOURCE_FILE_AT_LINE (1713)) ;
      var_complementaryCondition = GALGAS_bool (false) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnc: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bc (SOURCE_FILE_AT_LINE (1716)) ;
      var_complementaryCondition = GALGAS_bool (true) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bov: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bov (SOURCE_FILE_AT_LINE (1719)) ;
      var_complementaryCondition = GALGAS_bool (false) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnov: {
      var_ipicCondition = GALGAS_ipc_31__38_ConditionalBranch::constructor_bov (SOURCE_FILE_AT_LINE (1722)) ;
      var_complementaryCondition = GALGAS_bool (true) ;
      } break ;
    }
  }
  ...
  if (kBoolTrue == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BraCCTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1729)) COMMA_SOURCE_FILE_AT_LINE (1729)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1730)) COMMA_SOURCE_FILE_AT_LINE (1730)), GALGAS_conditionalBranchMode::constructor_native (SOURCE_FILE_AT_LINE (1731)), var_ipicCondition COMMA_SOURCE_FILE_AT_LINE (1727)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BraCCTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1737)) COMMA_SOURCE_FILE_AT_LINE (1737)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1738)) COMMA_SOURCE_FILE_AT_LINE (1738)), GALGAS_conditionalBranchMode::constructor_native (SOURCE_FILE_AT_LINE (1739)), var_ipicCondition COMMA_SOURCE_FILE_AT_LINE (1735)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_registerComparisonCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_62460_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_62460_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1758)) ;
  ...
  if (object->mAttribute_mComparison.isValid ()) {
    ...
    case GALGAS_pic_31__38_RegisterComparison::kEnum_equal: {
      var_ipicComparison = GALGAS_ipic_31__38_RegisterComparison::constructor_registerEqualsToW (SOURCE_FILE_AT_LINE (1770)) ;
      var_complementaryBranch = GALGAS_bool (false) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_greater: {
      var_ipicComparison = GALGAS_ipic_31__38_RegisterComparison::constructor_registerGreaterThanW (SOURCE_FILE_AT_LINE (1773)) ;
      var_complementaryBranch = GALGAS_bool (false) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_lower: {
      var_ipicComparison = GALGAS_ipic_31__38_RegisterComparison::constructor_registerLowerThanW (SOURCE_FILE_AT_LINE (1776)) ;
      var_complementaryBranch = GALGAS_bool (false) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_greaterOrEqual: {
      var_ipicComparison = GALGAS_ipic_31__38_RegisterComparison::constructor_registerLowerThanW (SOURCE_FILE_AT_LINE (1779)) ;
      var_complementaryBranch = GALGAS_bool (true) ;
      } break ;
    case GALGAS_pic_31__38_RegisterComparison::kEnum_lowerOrEqual: {
      var_ipicComparison = GALGAS_ipic_31__38_RegisterComparison::constructor_registerGreaterThanW (SOURCE_FILE_AT_LINE (1782)) ;
      var_complementaryBranch = GALGAS_bool (true) ;
      } break ;
  ...
  if (kBoolTrue == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_RegisterComparisonTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1792)) COMMA_SOURCE_FILE_AT_LINE (1792)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1793)) COMMA_SOURCE_FILE_AT_LINE (1793)), var_IPICregisterDescription, var_ipicComparison COMMA_SOURCE_FILE_AT_LINE (1790)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_RegisterComparisonTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1800)) COMMA_SOURCE_FILE_AT_LINE (1800)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1801)) COMMA_SOURCE_FILE_AT_LINE (1801)), var_IPICregisterDescription, var_ipicComparison COMMA_SOURCE_FILE_AT_LINE (1798)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_incDecRegisterInCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_64897_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_64897_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1821)) ;
  const enumGalgasBool test_0 = object->mAttribute_mBranchIfZero.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_ipic_31__38_IncDecRegisterTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1832)) COMMA_SOURCE_FILE_AT_LINE (1832)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1833)) COMMA_SOURCE_FILE_AT_LINE (1833)), var_IPICregisterDescription, object->mAttribute_mIncrement, object->mAttribute_m_5F_W_5F_isDestination COMMA_SOURCE_FILE_AT_LINE (1830)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_ipic_31__38_IncDecRegisterTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1841)) COMMA_SOURCE_FILE_AT_LINE (1841)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1842)) COMMA_SOURCE_FILE_AT_LINE (1842)), var_IPICregisterDescription, object->mAttribute_mIncrement, object->mAttribute_m_5F_W_5F_isDestination COMMA_SOURCE_FILE_AT_LINE (1839)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_registerTestCondition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_66480_0 ; // Joker input parameter
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, joker_66480_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1863)) ;
  const enumGalgasBool test_0 = object->mAttribute_mBranchIfZero.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_TestRegisterTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1874)) COMMA_SOURCE_FILE_AT_LINE (1874)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1875)) COMMA_SOURCE_FILE_AT_LINE (1875)), var_IPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (1872)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_TestRegisterTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1881)) COMMA_SOURCE_FILE_AT_LINE (1881)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1882)) COMMA_SOURCE_FILE_AT_LINE (1882)), var_IPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (1879)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_bitTest_5F_in_5F_structured_5F_if_5F_condition_analyzeCondition (const cPtr_conditionExpression * inObject,
  ...
  GALGAS_ipic_31__38__5F_intermediate_5F_registerExpression var_IPICregisterDescription ;
  GALGAS_bitSliceTable var_bitSliceTable ;
  callCategoryMethod_analyzeRegisterExpression ((const cPtr_registerExpression *) object->mAttribute_mRegisterExpression.ptr (), constinArgument_inAccessBankSplitOffset, constinArgument_inCurrentBank, constinArgument_inRegisterTable, var_IPICregisterDescription, var_bitSliceTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (1901)) ;
  GALGAS_uint var_bitNumber ;
  callCategoryMethod_getBitNumber ((const cPtr_bitNumberExpression *) object->mAttribute_mBitNumber.ptr (), var_bitSliceTable, var_bitNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (1908)) ;
  const enumGalgasBool test_0 = object->mAttribute_mBTFSSinstruction.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BitTestTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1916)) COMMA_SOURCE_FILE_AT_LINE (1916)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1917)) COMMA_SOURCE_FILE_AT_LINE (1917)), var_IPICregisterDescription, var_bitNumber COMMA_SOURCE_FILE_AT_LINE (1914)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCurrentBlockTerminator = GALGAS_pic_31__38_BitTestTerminator::constructor_new (constinArgument_inInstructionLocation, GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionFalseLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1924)) COMMA_SOURCE_FILE_AT_LINE (1924)), GALGAS_ipic_31__38_JumpTerminator::constructor_new (constinArgument_inInstructionLocation, constinArgument_inConditionTrueLabel, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE_AT_LINE (1925)) COMMA_SOURCE_FILE_AT_LINE (1925)), var_IPICregisterDescription, var_bitNumber COMMA_SOURCE_FILE_AT_LINE (1922)) ;
  }
}
//---------------------------------------------------------------------------*
