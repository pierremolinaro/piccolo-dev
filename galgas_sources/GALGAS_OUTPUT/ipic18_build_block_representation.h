...
void routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (const GALGAS_string constinArgument0,
                                                                       const GALGAS_piccoloDeviceModel constinArgument1,
                                                                       ...
                                                                       const GALGAS_ramBankTable constinArgument12,
                                                                       const GALGAS_bool constinArgument13,
                                                                       const GALGAS_bool constinArgument14,
                                                                       const GALGAS_string constinArgument15,
                                                                       const GALGAS_registerTable constinArgument16,
                                                                       const GALGAS_actualConfigurationMap constinArgument17,
                                                                       GALGAS_string & ioArgument18,
