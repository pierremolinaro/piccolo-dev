...
GALGAS_string function_sortKey (const GALGAS_clusterList & constinArgument_inClusterList,
  ...
  while (enumerator_729.hasCurrentObject ()) {
    result_outKey.dotAssign_operation (enumerator_729.current_mBlockList (HERE).reader_mBlockAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 25)).mAttribute_mLabel.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 25)) ;
    if (enumerator_729.hasNextObject ()) {
      result_outKey.dotAssign_operation (GALGAS_string (".")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 27)) ;
    }
...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_optimize = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (66)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 39)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 39)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 38)).operator_and (GALGAS_bool (gOption_piccolo_5F_options_doNotReorderCluster.reader_value ()).operator_not (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 40)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 39)) ;
  const enumGalgasBool test_0 = var_optimize.operator_not (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 41)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Option '--").operator_concat (GALGAS_string (gOption_piccolo_5F_options_doNotReorderCluster.reader_string ())  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 42)).operator_concat (GALGAS_string ("': this optimization is not performed.n\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 42))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 42)) ;
  }else if (kBoolFalse == test_0) {
    GALGAS_uint var_clusterCount = constinArgument_inInitialClusterList.reader_length (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 44)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 45)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 45))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 45)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CLUSTER ORDERING OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 46))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 46)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 46))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 46)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 47)).operator_concat (GALGAS_string ("\n"
      "\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 47))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 47)) ;
    ...
    GALGAS_string var_s = GALGAS_string ("Cluster ordering optimization (").operator_concat (var_clusterCount.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 48))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 48)).operator_concat (GALGAS_string (" cluster")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 48)).operator_concat (temp_1  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 48)).operator_concat (GALGAS_string ("):\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 48)) ;
    ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 49))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 49)) ;
    const enumGalgasBool test_3 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->printMessage (var_s  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 52)) ;
    }
    GALGAS_clusterList var_clusterList = constinArgument_inInitialClusterList ;
    GALGAS_neededConversionForClusterOrder var_neededConversionForClusterOrder = GALGAS_neededConversionForClusterOrder::constructor_emptyMap (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 56)) ;
    GALGAS_bool var_continue = GALGAS_bool (true) ;
    GALGAS_uint var_pass = GALGAS_uint ((uint32_t) 0U) ;
    if (var_clusterList.reader_length (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 59)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 59)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 59)).isValid ()) {
      uint32_t variant_2345 = var_clusterList.reader_length (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 59)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 59)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 59)).uintValue () ;
      bool loop_2345 = true ;
      while (loop_2345) {
        ...
        if (loop_2345 && (0 == variant_2345)) {
          loop_2345 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 59)) ;
        }
        if (loop_2345) {
          variant_2345 -- ;
          var_pass.increment_operation (inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 61)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 62))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 62)).operator_concat (GALGAS_string (":\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 62))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 62)) ;
          GALGAS_ipic_31__38_BlockList var_workingBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 64)) ;
          GALGAS_symbolTableForClusterOrdering var_symbolTable = GALGAS_symbolTableForClusterOrdering::constructor_emptyMap (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 65)) ;
          ...
          while (enumerator_2675.hasCurrentObject ()) {
            var_workingBlockList.dotAssign_operation (enumerator_2675.current_mBlockList (HERE)  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 67)) ;
            ...
            while (enumerator_2765.hasCurrentObject ()) {
              {
              var_symbolTable.modifier_insertKey (enumerator_2765.current_mBlock (HERE).mAttribute_mLabel, index_2663, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 69)) ;
              }
              enumerator_2765.gotoNextObject () ;
            }
            enumerator_2675.gotoNextObject () ;
            index_2663.increment_operation (inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 66)) ;
          }
          GALGAS_uint var_insertionIdx = var_workingBlockList.reader_length (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 73)) ;
          ...
          if (enumerator_3018.hasCurrentObject () && bool_4) {
            while (enumerator_3018.hasCurrentObject () && bool_4) {
              var_continue = GALGAS_bool (kIsNotEqual, enumerator_3018.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 75)))) ;
              const enumGalgasBool test_5 = var_continue.boolEnum () ;
              if (kBoolTrue == test_5) {
                {
                var_symbolTable.modifier_insertKey (enumerator_3018.current_mBlock (HERE).mAttribute_mLabel, GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 77)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 77)) ;
                }
                {
                var_workingBlockList.modifier_insertAtIndex (enumerator_3018.current_mBlock (HERE), var_insertionIdx, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 78)) ;
                }
              }
          ...
          {
          routine_ipic_31__38_RelativeBranchOverflow (var_workingBlockList, ioArgument_ioBlockList, var_overflowMap, inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 82)) ;
          }
          ...
          while (enumerator_3539.hasCurrentObject ()) {
            ...
            while (enumerator_3564.hasCurrentObject ()) {
              var_overflowCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 90)) ;
              GALGAS_uint var_sourceCluster ;
              var_symbolTable.method_searchKey (enumerator_3539.current_key (HERE).reader_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 91)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 91)) ;
              GALGAS_uint var_targetCluster ;
              var_symbolTable.method_searchKey (enumerator_3564.current_mValue (HERE).reader_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 92)), var_targetCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 92)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_3539.current_key (HERE)  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)).operator_concat (GALGAS_string (" (cluster #")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)).operator_concat (GALGAS_string (") --> ")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)).operator_concat (enumerator_3564.current_mValue (HERE)  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)).operator_concat (GALGAS_string (" (cluster #")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)).operator_concat (GALGAS_string (")\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 93)) ;
              enumerator_3564.gotoNextObject () ;
            }
            enumerator_3539.gotoNextObject () ;
          }
          {
          var_neededConversionForClusterOrder.modifier_insertKey (function_sortKey (var_clusterList, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 97)).reader_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 97)), var_overflowCount, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 96)) ;
          }
          const enumGalgasBool test_6 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_string var_s = GALGAS_string ("  Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 101))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 101)).operator_concat (GALGAS_string (": ")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 101)) ;
            const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_overflowCount.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
            if (kBoolTrue == test_7) {
              var_s.dotAssign_operation (GALGAS_string ("no branch overflow")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 103)) ;
            }else if (kBoolFalse == test_7) {
              const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_overflowCount.objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
              if (kBoolTrue == test_8) {
                var_s.dotAssign_operation (GALGAS_string ("1 branch overflow")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 105)) ;
              }else if (kBoolFalse == test_8) {
                var_s.dotAssign_operation (var_overflowCount.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 107)).operator_concat (GALGAS_string (" branch overflows")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 107))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 107)) ;
              }
            }
            inCompiler->printMessage (var_s  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 109)) ;
          }
            ...
            while (enumerator_4499.hasCurrentObject () && bool_9) {
              ...
              if (enumerator_4545.hasCurrentObject () && bool_10) {
                while (enumerator_4545.hasCurrentObject () && bool_10) {
                  GALGAS_uint var_targetCluster ;
                  var_symbolTable.method_searchKey (enumerator_4545.current_mValue (HERE).reader_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 115)), var_targetCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 115)) ;
                  const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, var_targetCluster.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 116)))).boolEnum () ;
                  if (kBoolTrue == test_11) {
                    GALGAS_uint var_sourceCluster ;
                    var_symbolTable.method_searchKey (enumerator_4499.current_key (HERE).reader_nowhere (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 117)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 117)) ;
                    const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, var_sourceCluster.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 118)).objectCompare (var_targetCluster)).boolEnum () ;
                    if (kBoolTrue == test_12) {
                      var_correctionLoop = GALGAS_bool (false) ;
                      var_continue = GALGAS_bool (true) ;
                      GALGAS_ipic_31__38_BlockList var_last ;
                      {
                      var_clusterList.modifier_removeAtIndex (var_last, var_targetCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 121)) ;
                      }
                      GALGAS_ipic_31__38_BlockList var_first ;
                      {
                      var_clusterList.modifier_removeAtIndex (var_first, var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 122)) ;
                      }
                      {
                      var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 123)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 123)) ;
                      }
                      GALGAS_string var_m = GALGAS_string ("merge #").operator_concat (var_targetCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 124))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 124)).operator_concat (GALGAS_string (" into #")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 124)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 124))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 124)).operator_concat (GALGAS_string ("]")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 124)) ;
                      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 125)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 125))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 125)) ;
                      ...
                      if (kBoolTrue == test_13) {
                        inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 127))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 127)) ;
                      }
                    }else if (kBoolFalse == test_12) {
                      const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, var_sourceCluster.objectCompare (var_targetCluster.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 129)))).boolEnum () ;
                      if (kBoolTrue == test_14) {
                        var_correctionLoop = GALGAS_bool (false) ;
                        var_continue = GALGAS_bool (true) ;
                        GALGAS_ipic_31__38_BlockList var_last ;
                        {
                        var_clusterList.modifier_removeAtIndex (var_last, var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 132)) ;
                        }
                        GALGAS_ipic_31__38_BlockList var_first ;
                        {
                        var_clusterList.modifier_removeAtIndex (var_first, var_targetCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 133)) ;
                        }
                        {
                        var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 134)), var_targetCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 134)) ;
                        }
                        GALGAS_string var_m = GALGAS_string ("merge #").operator_concat (var_sourceCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 135))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 135)).operator_concat (GALGAS_string (" into #")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 135)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 135))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 135)).operator_concat (GALGAS_string ("]")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 135)) ;
                        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 136)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 136))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 136)) ;
                        ...
                        if (kBoolTrue == test_15) {
                          inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 138))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 138)) ;
                        }
                        ...
                        if (kBoolTrue == test_16) {
                          ...
                          {
                          var_candidate.modifier_removeAtIndex (var_b, var_targetCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 142)) ;
                          }
                          {
                          var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 143)).divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 143)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 143)) ;
                          }
                          const enumGalgasBool test_17 = var_neededConversionForClusterOrder.reader_hasKey (function_sortKey (var_candidate, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 144)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 144)).operator_not (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 144)).boolEnum () ;
                          if (kBoolTrue == test_17) {
                            var_clusterList = var_candidate ;
                            var_correctionLoop = GALGAS_bool (false) ;
                            var_continue = GALGAS_bool (true) ;
                            GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148)).divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148)).reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148)).operator_concat (GALGAS_string (", #")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148)).operator_concat (GALGAS_string ("]")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 148)) ;
                            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 149)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 149))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 149)) ;
                            ...
                            if (kBoolTrue == test_18) {
                              inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 151))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 151)) ;
                            }
                          }
                          ...
                          if (kBoolTrue == test_19) {
                            ...
                            GALGAS_ipic_31__38_BlockList var_b ;
                            {
                            var_candidate.modifier_removeAtIndex (var_b, var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 156)) ;
                            }
                            {
                            var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 157)).divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 157)), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 157)) ;
                            }
                            const enumGalgasBool test_20 = var_neededConversionForClusterOrder.reader_hasKey (function_sortKey (var_candidate, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 158)) COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 158)).operator_not (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 158)).boolEnum () ;
                            if (kBoolTrue == test_20) {
                              var_clusterList = var_candidate ;
                              var_correctionLoop = GALGAS_bool (false) ;
                              var_continue = GALGAS_bool (true) ;
                              GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162)).operator_concat (GALGAS_string (", #")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162)).divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162)).reader_string (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162)).operator_concat (GALGAS_string ("]")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 162)) ;
                              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 163)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 163))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 163)) ;
                              ...
                              if (kBoolTrue == test_21) {
                                inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 165))  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 165)) ;
                              }
                            }
                          }
                        }
          ...
          if (kBoolTrue == test_22) {
            inCompiler->printMessage (GALGAS_string (".\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 173)) ;
          }
        }
      }
    }
    ...
    if (kBoolTrue == test_23) {
      inCompiler->printMessage (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 177)) ;
    }
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 179)) ;
    GALGAS_ipic_31__38_BlockList var_newBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 181)) ;
    var_continue = GALGAS_bool (true) ;
    ...
    if (enumerator_8159.hasCurrentObject () && bool_24) {
      while (enumerator_8159.hasCurrentObject () && bool_24) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8159.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 185)))) ;
        const enumGalgasBool test_25 = var_continue.boolEnum () ;
        if (kBoolTrue == test_25) {
          var_newBlockList.addAssign_operation (enumerator_8159.current_mBlock (HERE)  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 187)) ;
        }
    ...
    while (enumerator_8373.hasCurrentObject ()) {
      var_newBlockList.dotAssign_operation (enumerator_8373.current_mBlockList (HERE)  COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 192)) ;
      enumerator_8373.gotoNextObject () ;
    }
    GALGAS_uint var_insertionIndex = var_newBlockList.reader_length (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 195)) ;
    var_continue = GALGAS_bool (true) ;
    ...
    if (enumerator_8579.hasCurrentObject () && bool_26) {
      while (enumerator_8579.hasCurrentObject () && bool_26) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8579.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 198)))) ;
        const enumGalgasBool test_27 = var_continue.boolEnum () ;
        if (kBoolTrue == test_27) {
          {
          var_newBlockList.modifier_insertAtIndex (enumerator_8579.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_cluster_ordering.gSemantics", 200)) ;
          }
        }
