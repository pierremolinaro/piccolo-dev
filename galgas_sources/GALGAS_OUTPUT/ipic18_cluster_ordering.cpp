...
GALGAS_string function_sortKey (const GALGAS_clusterList & constinArgument0,
...
void cMapElement_neededConversionForClusterOrder::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
void GALGAS_neededConversionForClusterOrder::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_neededConversionForClusterOrder) ;
...
GALGAS_string function_sortKey (const GALGAS_clusterList & constinArgument_inClusterList,
  ...
  cEnumerator_clusterList enumerator_741 (constinArgument_inClusterList, kEnumeration_up) ;
  while (enumerator_741.hasCurrentObject ()) {
    result_outKey.dotAssign_operation (enumerator_741.current_mBlockList (HERE).reader_mBlockAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (26)).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (26)) ;
    if (enumerator_741.hasNextObject ()) {
      result_outKey.dotAssign_operation (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (28)) ;
    }
...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_optimize = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (67)) COMMA_SOURCE_FILE_AT_LINE (40)) COMMA_SOURCE_FILE_AT_LINE (40)) ;
  const enumGalgasBool test_0 = var_optimize.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_uint var_clusterCount = constinArgument_inInitialClusterList.reader_length (SOURCE_FILE_AT_LINE (42)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (43)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CLUSTER ORDERING OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (44)) COMMA_SOURCE_FILE_AT_LINE (44)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (44)) COMMA_SOURCE_FILE_AT_LINE (44)) ;
    ...
    GALGAS_string var_s = GALGAS_string ("Cluster ordering optimization (").operator_concat (var_clusterCount.reader_string (SOURCE_FILE_AT_LINE (46)) COMMA_SOURCE_FILE_AT_LINE (46)).operator_concat (GALGAS_string (" cluster") COMMA_SOURCE_FILE_AT_LINE (46)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (46)).operator_concat (GALGAS_string ("):\n") COMMA_SOURCE_FILE_AT_LINE (46)) ;
    ...
    if (kBoolTrue == test_3) {
      inCompiler->printMessage (var_s COMMA_SOURCE_FILE_AT_LINE (50)) ;
    }
    GALGAS_clusterList var_clusterList = constinArgument_inInitialClusterList ;
    GALGAS_neededConversionForClusterOrder var_neededConversionForClusterOrder = GALGAS_neededConversionForClusterOrder::constructor_emptyMap (SOURCE_FILE_AT_LINE (54)) ;
    GALGAS_bool var_continue = GALGAS_bool (true) ;
    GALGAS_uint var_pass = GALGAS_uint ((PMUInt32) 0U) ;
    if (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (57)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (57)), inCompiler COMMA_SOURCE_FILE_AT_LINE (57)).isValid ()) {
      PMUInt32 variant_2085 = var_clusterList.reader_length (SOURCE_FILE_AT_LINE (57)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (57)), inCompiler COMMA_SOURCE_FILE_AT_LINE (57)).uintValue () ;
      bool loop_2085 = true ;
      while (loop_2085) {
        loop_2085 = var_continue.isValid () ;
        if (loop_2085) {
          loop_2085 = var_continue.boolValue () ;
        }
        if (loop_2085 && (0 == variant_2085)) {
          loop_2085 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (57)) ;
        }
        if (loop_2085) {
          variant_2085 -- ;
          var_pass.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (59)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60)) ;
          GALGAS_ipic_31__38_BlockList var_workingBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (62)) ;
          GALGAS_symbolTableForClusterOrdering var_symbolTable = GALGAS_symbolTableForClusterOrdering::constructor_emptyMap (SOURCE_FILE_AT_LINE (63)) ;
          cEnumerator_clusterList enumerator_2419 (var_clusterList, kEnumeration_up) ;
          GALGAS_uint index_2413 ((PMUInt32) 0) ;
          while (enumerator_2419.hasCurrentObject ()) {
            var_workingBlockList.dotAssign_operation (enumerator_2419.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (65)) ;
            cEnumerator_ipic_31__38_BlockList enumerator_2506 (enumerator_2419.current_mBlockList (HERE), kEnumeration_up) ;
            while (enumerator_2506.hasCurrentObject ()) {
              {
              var_symbolTable.modifier_insertKey (enumerator_2506.current_mBlock (HERE).mAttribute_mLabel, index_2413, inCompiler COMMA_SOURCE_FILE_AT_LINE (67)) ;
              }
              enumerator_2506.gotoNextObject () ;
            }
            enumerator_2419.gotoNextObject () ;
            index_2413.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (64)) ;
          }
          GALGAS_uint var_insertionIdx = var_workingBlockList.reader_length (SOURCE_FILE_AT_LINE (71)) ;
          cEnumerator_ipic_31__38_BlockList enumerator_2762 (ioArgument_ioBlockList, kEnumeration_down) ;
          bool bool_4 = var_continue.isValidAndTrue () ;
          if (enumerator_2762.hasCurrentObject () && bool_4) {
            while (enumerator_2762.hasCurrentObject () && bool_4) {
              var_continue = GALGAS_bool (kIsNotEqual, enumerator_2762.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (73)))) ;
              const enumGalgasBool test_5 = var_continue.boolEnum () ;
              if (kBoolTrue == test_5) {
                {
                var_symbolTable.modifier_insertKey (enumerator_2762.current_mBlock (HERE).mAttribute_mLabel, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (75)), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) ;
                }
                {
                var_workingBlockList.modifier_insertAtIndex (enumerator_2762.current_mBlock (HERE), var_insertionIdx, inCompiler COMMA_SOURCE_FILE_AT_LINE (76)) ;
                }
              }
              enumerator_2762.gotoNextObject () ;
              if (enumerator_2762.hasCurrentObject ()) {
          ...
          {
          routine_ipic_31__38_RelativeBranchOverflow (var_workingBlockList, ioArgument_ioBlockList, var_overflowMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (80)) ;
          }
          GALGAS_uint var_overflowCount = GALGAS_uint ((PMUInt32) 0U) ;
          cEnumerator_branchOverflowMap enumerator_3280 (var_overflowMap, kEnumeration_up) ;
          while (enumerator_3280.hasCurrentObject ()) {
            cEnumerator_stringlist enumerator_3305 (enumerator_3280.current_mList (HERE), kEnumeration_up) ;
            while (enumerator_3305.hasCurrentObject ()) {
              var_overflowCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (88)) ;
              GALGAS_uint var_sourceCluster ;
              var_symbolTable.method_searchKey (enumerator_3280.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (89)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
              GALGAS_uint var_targetCluster ;
              var_symbolTable.method_searchKey (enumerator_3305.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (90)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_3280.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (") --> ") COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (enumerator_3305.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) ;
              enumerator_3305.gotoNextObject () ;
            }
            enumerator_3280.gotoNextObject () ;
          }
          {
          var_neededConversionForClusterOrder.modifier_insertKey (function_sortKey (var_clusterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)).reader_nowhere (SOURCE_FILE_AT_LINE (95)), var_overflowCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
          }
          const enumGalgasBool test_6 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_string var_s = GALGAS_string ("  Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (99)) ;
            const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_overflowCount.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
            if (kBoolTrue == test_7) {
              var_s.dotAssign_operation (GALGAS_string ("no branch overflow") COMMA_SOURCE_FILE_AT_LINE (101)) ;
            }else if (kBoolFalse == test_7) {
              const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_overflowCount.objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
              if (kBoolTrue == test_8) {
                var_s.dotAssign_operation (GALGAS_string ("1 branch overflow") COMMA_SOURCE_FILE_AT_LINE (103)) ;
              }else if (kBoolFalse == test_8) {
                var_s.dotAssign_operation (var_overflowCount.reader_string (SOURCE_FILE_AT_LINE (105)).operator_concat (GALGAS_string (" branch overflows") COMMA_SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)) ;
              }
            }
            inCompiler->printMessage (var_s COMMA_SOURCE_FILE_AT_LINE (107)) ;
          }
          GALGAS_bool var_correctionLoop = GALGAS_bool (true) ;
          cEnumerator_branchOverflowMap enumerator_4243 (var_overflowMap, kEnumeration_up) ;
          bool bool_9 = var_correctionLoop.isValidAndTrue () ;
          if (enumerator_4243.hasCurrentObject () && bool_9) {
            while (enumerator_4243.hasCurrentObject () && bool_9) {
              cEnumerator_stringlist enumerator_4289 (enumerator_4243.current_mList (HERE), kEnumeration_up) ;
              bool bool_10 = var_correctionLoop.isValidAndTrue () ;
              if (enumerator_4289.hasCurrentObject () && bool_10) {
                while (enumerator_4289.hasCurrentObject () && bool_10) {
                  GALGAS_uint var_targetCluster ;
                  var_symbolTable.method_searchKey (enumerator_4289.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (113)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (113)) ;
                  const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, var_targetCluster.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (114)))).boolEnum () ;
                  if (kBoolTrue == test_11) {
                    GALGAS_uint var_sourceCluster ;
                    var_symbolTable.method_searchKey (enumerator_4243.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (115)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
                    const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, var_sourceCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)).objectCompare (var_targetCluster)).boolEnum () ;
                    if (kBoolTrue == test_12) {
                      var_correctionLoop = GALGAS_bool (false) ;
                      var_continue = GALGAS_bool (true) ;
                      GALGAS_ipic_31__38_BlockList var_last ;
                      {
                      var_clusterList.modifier_removeAtIndex (var_last, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
                      }
                      GALGAS_ipic_31__38_BlockList var_first ;
                      {
                      var_clusterList.modifier_removeAtIndex (var_first, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) ;
                      }
                      {
                      var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last COMMA_SOURCE_FILE_AT_LINE (121)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)) ;
                      }
                      GALGAS_string var_m = GALGAS_string ("merge #").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (GALGAS_string (" into #") COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (122)) ;
                      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)) ;
                      ...
                      if (kBoolTrue == test_13) {
                        inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)) ;
                      }
                    }else if (kBoolFalse == test_12) {
                      const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, var_sourceCluster.objectCompare (var_targetCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (127)))).boolEnum () ;
                      if (kBoolTrue == test_14) {
                        var_correctionLoop = GALGAS_bool (false) ;
                        var_continue = GALGAS_bool (true) ;
                        GALGAS_ipic_31__38_BlockList var_last ;
                        {
                        var_clusterList.modifier_removeAtIndex (var_last, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)) ;
                        }
                        GALGAS_ipic_31__38_BlockList var_first ;
                        {
                        var_clusterList.modifier_removeAtIndex (var_first, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
                        }
                        {
                        var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last COMMA_SOURCE_FILE_AT_LINE (132)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) ;
                        }
                        GALGAS_string var_m = GALGAS_string ("merge #").operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string (" into #") COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (133)) ;
                        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (134)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)) ;
                        ...
                        if (kBoolTrue == test_15) {
                          inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)) ;
                        }
                        ...
                        if (kBoolTrue == test_16) {
                          ...
                          {
                          var_candidate.modifier_removeAtIndex (var_b, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) ;
                          }
                          {
                          var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (141)), inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
                          }
                          const enumGalgasBool test_17 = var_neededConversionForClusterOrder.reader_hasKey (function_sortKey (var_candidate, inCompiler COMMA_SOURCE_FILE_AT_LINE (142)) COMMA_SOURCE_FILE_AT_LINE (142)).operator_not (SOURCE_FILE_AT_LINE (142)).boolEnum () ;
                          if (kBoolTrue == test_17) {
                            var_clusterList = var_candidate ;
                            var_correctionLoop = GALGAS_bool (false) ;
                            var_continue = GALGAS_bool (true) ;
                            GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (146)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (146)).reader_string (SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_concat (GALGAS_string (", #") COMMA_SOURCE_FILE_AT_LINE (146)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (146)) ;
                            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (147)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
                            ...
                            if (kBoolTrue == test_18) {
                              inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (149)) ;
                            }
                          }
                          ...
                          if (kBoolTrue == test_19) {
                            ...
                            GALGAS_ipic_31__38_BlockList var_b ;
                            {
                            var_candidate.modifier_removeAtIndex (var_b, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
                            }
                            {
                            var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (155)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (155)), inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) ;
                            }
                            const enumGalgasBool test_20 = var_neededConversionForClusterOrder.reader_hasKey (function_sortKey (var_candidate, inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_not (SOURCE_FILE_AT_LINE (156)).boolEnum () ;
                            if (kBoolTrue == test_20) {
                              var_clusterList = var_candidate ;
                              var_correctionLoop = GALGAS_bool (false) ;
                              var_continue = GALGAS_bool (true) ;
                              GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (GALGAS_string (", #") COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (160)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (160)).reader_string (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (160)) ;
                              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (161)) COMMA_SOURCE_FILE_AT_LINE (161)) ;
                              ...
                              if (kBoolTrue == test_21) {
                                inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (163)) ;
                              }
                            }
                          }
                        }
    ...
    GALGAS_ipic_31__38_BlockList var_newBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (179)) ;
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_7903 (ioArgument_ioBlockList, kEnumeration_up) ;
    bool bool_24 = var_continue.isValidAndTrue () ;
    if (enumerator_7903.hasCurrentObject () && bool_24) {
      while (enumerator_7903.hasCurrentObject () && bool_24) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_7903.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (183)))) ;
        const enumGalgasBool test_25 = var_continue.boolEnum () ;
        if (kBoolTrue == test_25) {
          var_newBlockList.addAssign_operation (enumerator_7903.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (185)) ;
        }
        enumerator_7903.gotoNextObject () ;
        if (enumerator_7903.hasCurrentObject ()) {
          bool_24 = var_continue.isValidAndTrue () ;
        }
      }
    }
    cEnumerator_clusterList enumerator_8114 (var_clusterList, kEnumeration_up) ;
    while (enumerator_8114.hasCurrentObject ()) {
      var_newBlockList.dotAssign_operation (enumerator_8114.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (190)) ;
      enumerator_8114.gotoNextObject () ;
    }
    GALGAS_uint var_insertionIndex = var_newBlockList.reader_length (SOURCE_FILE_AT_LINE (193)) ;
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_8323 (ioArgument_ioBlockList, kEnumeration_down) ;
    bool bool_26 = var_continue.isValidAndTrue () ;
    if (enumerator_8323.hasCurrentObject () && bool_26) {
      while (enumerator_8323.hasCurrentObject () && bool_26) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8323.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (196)))) ;
        const enumGalgasBool test_27 = var_continue.boolEnum () ;
        if (kBoolTrue == test_27) {
          {
          var_newBlockList.modifier_insertAtIndex (enumerator_8323.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (198)) ;
          }
        }
