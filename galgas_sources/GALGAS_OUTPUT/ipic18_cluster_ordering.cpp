...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
          ...
          while (enumerator_2735.hasCurrentObject () && bool_6) {
            ...
            if (enumerator_2779.hasCurrentObject () && bool_7) {
              while (enumerator_2779.hasCurrentObject () && bool_7) {
                ...
                const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_sourceCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (78)).objectCompare (var_targetCluster)).boolEnum () ;
                if (kBoolTrue == test_8) {
                  var_correctionLoop = GALGAS_bool (false) ;
                  var_continue = GALGAS_bool (true) ;
                  GALGAS_ipic_31__38_BlockList var_last ;
                  {
                  var_clusterList.modifier_removeAtIndex (var_last, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (81)) ;
                  }
                  GALGAS_ipic_31__38_BlockList var_first ;
                  {
                  var_clusterList.modifier_removeAtIndex (var_first, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (82)) ;
                  }
                  {
                  var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last COMMA_SOURCE_FILE_AT_LINE (83)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (83)) ;
                  }
                  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> cluster #").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string (" merged into #") COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)) ;
                  const enumGalgasBool test_9 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
                  if (kBoolTrue == test_9) {
                    inCompiler->printMessage (GALGAS_string (" -> #").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (86)).operator_concat (GALGAS_string (" merged into #") COMMA_SOURCE_FILE_AT_LINE (86)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (86)) ;
                  }
                }else if (kBoolFalse == test_8) {
                  const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, var_sourceCluster.objectCompare (var_targetCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (88)))).boolEnum () ;
                  if (kBoolTrue == test_10) {
                    var_correctionLoop = GALGAS_bool (false) ;
                    var_continue = GALGAS_bool (true) ;
                    GALGAS_ipic_31__38_BlockList var_last ;
                    {
                    var_clusterList.modifier_removeAtIndex (var_last, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (91)) ;
                    }
                    GALGAS_ipic_31__38_BlockList var_first ;
                    {
                    var_clusterList.modifier_removeAtIndex (var_first, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) ;
                    }
                    {
                    var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last COMMA_SOURCE_FILE_AT_LINE (93)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)) ;
                    }
                    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> cluster #").operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)).operator_concat (GALGAS_string (" merged into #") COMMA_SOURCE_FILE_AT_LINE (94)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)) ;
                    ...
                    if (kBoolTrue == test_11) {
                      inCompiler->printMessage (GALGAS_string (" -> #").operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (GALGAS_string (" merged into #") COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)) ;
                    }
                  }else if (kBoolFalse == test_10) {
                    const enumGalgasBool test_12 = GALGAS_bool (kIsStrictInf, var_sourceCluster.objectCompare (var_targetCluster)).boolEnum () ;
                    if (kBoolTrue == test_12) {
                      var_correctionLoop = GALGAS_bool (false) ;
                      var_continue = GALGAS_bool (true) ;
                      GALGAS_ipic_31__38_BlockList var_b ;
                      {
                      var_clusterList.modifier_removeAtIndex (var_b, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) ;
                      }
                      {
                      var_clusterList.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (102)), inCompiler COMMA_SOURCE_FILE_AT_LINE (102)) ;
                      }
                      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> cluster #").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103)).operator_concat (GALGAS_string (" rolls downs to #") COMMA_SOURCE_FILE_AT_LINE (103)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (103)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (103)).reader_string (SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103)) ;
                      ...
                      if (kBoolTrue == test_13) {
                        inCompiler->printMessage (GALGAS_string (" -> #").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)).operator_concat (GALGAS_string (" rolls down to #") COMMA_SOURCE_FILE_AT_LINE (105)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (105)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (105)).reader_string (SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)) ;
                      }
                    }else if (kBoolFalse == test_12) {
                      const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_sourceCluster.objectCompare (var_targetCluster)).boolEnum () ;
                      if (kBoolTrue == test_14) {
                        var_correctionLoop = GALGAS_bool (false) ;
                        var_continue = GALGAS_bool (true) ;
                        GALGAS_ipic_31__38_BlockList var_b ;
                        {
                        var_clusterList.modifier_removeAtIndex (var_b, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
                        }
                        {
                        var_clusterList.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (111)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
                        }
                        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> cluster #").operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (GALGAS_string (" rolls downs to #") COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)).reader_string (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)) ;
                        ...
                        if (kBoolTrue == test_15) {
                          inCompiler->printMessage (GALGAS_string (" -> #").operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).operator_concat (GALGAS_string (" rolls downs to #") COMMA_SOURCE_FILE_AT_LINE (114)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (114)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (114)).reader_string (SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)) ;
                        }
                      }
                    }
                  }
  ...
  GALGAS_ipic_31__38_BlockList var_newBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (128)) ;
  var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_5796 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_18 = var_continue.isValidAndTrue () ;
  if (enumerator_5796.hasCurrentObject () && bool_18) {
    while (enumerator_5796.hasCurrentObject () && bool_18) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_5796.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (132)))) ;
      const enumGalgasBool test_19 = var_continue.boolEnum () ;
      if (kBoolTrue == test_19) {
        var_newBlockList.addAssign_operation (enumerator_5796.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (134)) ;
      }
      enumerator_5796.gotoNextObject () ;
      if (enumerator_5796.hasCurrentObject ()) {
        bool_18 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_clusterList enumerator_5998 (var_clusterList, kEnumeration_up) ;
  while (enumerator_5998.hasCurrentObject ()) {
    var_newBlockList.dotAssign_operation (enumerator_5998.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (139)) ;
    enumerator_5998.gotoNextObject () ;
  }
  GALGAS_uint var_insertionIndex = var_newBlockList.reader_length (SOURCE_FILE_AT_LINE (142)) ;
  var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_6205 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_20 = var_continue.isValidAndTrue () ;
  if (enumerator_6205.hasCurrentObject () && bool_20) {
    while (enumerator_6205.hasCurrentObject () && bool_20) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_6205.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (145)))) ;
      const enumGalgasBool test_21 = var_continue.boolEnum () ;
      if (kBoolTrue == test_21) {
        {
        var_newBlockList.modifier_insertAtIndex (enumerator_6205.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) ;
        }
      }
      enumerator_6205.gotoNextObject () ;
      if (enumerator_6205.hasCurrentObject ()) {
        bool_20 = var_continue.isValidAndTrue () ;
      }
    }
  }
