...
GALGAS_string function_sortKey (const GALGAS_clusterList & constinArgument_inClusterList,
  ...
  cEnumerator_clusterList enumerator_740 (constinArgument_inClusterList, kEnumeration_up) ;
  while (enumerator_740.hasCurrentObject ()) {
    result_outKey.dotAssign_operation (enumerator_740.current_mBlockList (HERE).reader_mBlockAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (25)).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (25)) ;
    if (enumerator_740.hasNextObject ()) {
...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_optimize = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (67)) COMMA_SOURCE_FILE_AT_LINE (39)) COMMA_SOURCE_FILE_AT_LINE (39)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)), inCompiler COMMA_SOURCE_FILE_AT_LINE (56)).isValid ()) {
      PMUInt32 variant_2084 = var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)), inCompiler COMMA_SOURCE_FILE_AT_LINE (56)).uintValue () ;
      bool loop_2084 = true ;
      while (loop_2084) {
        loop_2084 = var_continue.isValid () ;
        if (loop_2084) {
          loop_2084 = var_continue.boolValue () ;
        }
        if (loop_2084 && (0 == variant_2084)) {
          loop_2084 = false ;
        ...
        if (loop_2084) {
          ...
          cEnumerator_clusterList enumerator_2418 (var_clusterList, kEnumeration_up) ;
          GALGAS_uint index_2412 ((PMUInt32) 0) ;
          while (enumerator_2418.hasCurrentObject ()) {
            var_workingBlockList.dotAssign_operation (enumerator_2418.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (64)) ;
            cEnumerator_ipic_31__38_BlockList enumerator_2505 (enumerator_2418.current_mBlockList (HERE), kEnumeration_up) ;
            while (enumerator_2505.hasCurrentObject ()) {
              {
              var_symbolTable.modifier_insertKey (enumerator_2505.current_mBlock (HERE).mAttribute_mLabel, index_2412, inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
              }
              enumerator_2505.gotoNextObject () ;
            }
            enumerator_2418.gotoNextObject () ;
            index_2412.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (63)) ;
          }
          GALGAS_uint var_insertionIdx = var_workingBlockList.reader_length (SOURCE_FILE_AT_LINE (70)) ;
          cEnumerator_ipic_31__38_BlockList enumerator_2761 (ioArgument_ioBlockList, kEnumeration_down) ;
          bool bool_4 = var_continue.isValidAndTrue () ;
          if (enumerator_2761.hasCurrentObject () && bool_4) {
            while (enumerator_2761.hasCurrentObject () && bool_4) {
              var_continue = GALGAS_bool (kIsNotEqual, enumerator_2761.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (72)))) ;
              const enumGalgasBool test_5 = var_continue.boolEnum () ;
              if (kBoolTrue == test_5) {
                {
                var_symbolTable.modifier_insertKey (enumerator_2761.current_mBlock (HERE).mAttribute_mLabel, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (74)), inCompiler COMMA_SOURCE_FILE_AT_LINE (74)) ;
                }
                {
                var_workingBlockList.modifier_insertAtIndex (enumerator_2761.current_mBlock (HERE), var_insertionIdx, inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) ;
                }
              }
              enumerator_2761.gotoNextObject () ;
              if (enumerator_2761.hasCurrentObject ()) {
          ...
          cEnumerator_branchOverflowMap enumerator_3279 (var_overflowMap, kEnumeration_up) ;
          while (enumerator_3279.hasCurrentObject ()) {
            cEnumerator_stringlist enumerator_3304 (enumerator_3279.current_mList (HERE), kEnumeration_up) ;
            while (enumerator_3304.hasCurrentObject ()) {
              ...
              var_symbolTable.method_searchKey (enumerator_3279.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (88)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (88)) ;
              GALGAS_uint var_targetCluster ;
              var_symbolTable.method_searchKey (enumerator_3304.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (89)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_3279.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (") --> ") COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (enumerator_3304.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)) ;
          ...
          cEnumerator_branchOverflowMap enumerator_4242 (var_overflowMap, kEnumeration_up) ;
          bool bool_9 = var_correctionLoop.isValidAndTrue () ;
          if (enumerator_4242.hasCurrentObject () && bool_9) {
            while (enumerator_4242.hasCurrentObject () && bool_9) {
              cEnumerator_stringlist enumerator_4288 (enumerator_4242.current_mList (HERE), kEnumeration_up) ;
              bool bool_10 = var_correctionLoop.isValidAndTrue () ;
              if (enumerator_4288.hasCurrentObject () && bool_10) {
                while (enumerator_4288.hasCurrentObject () && bool_10) {
                  GALGAS_uint var_targetCluster ;
                  var_symbolTable.method_searchKey (enumerator_4288.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (112)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)) ;
                  ...
                  if (kBoolTrue == test_11) {
                    GALGAS_uint var_sourceCluster ;
                    var_symbolTable.method_searchKey (enumerator_4242.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (114)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) ;
                  ...
                  if (enumerator_4288.hasCurrentObject ()) {
    ...
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_7902 (ioArgument_ioBlockList, kEnumeration_up) ;
    bool bool_24 = var_continue.isValidAndTrue () ;
    if (enumerator_7902.hasCurrentObject () && bool_24) {
      while (enumerator_7902.hasCurrentObject () && bool_24) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_7902.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (182)))) ;
        const enumGalgasBool test_25 = var_continue.boolEnum () ;
        if (kBoolTrue == test_25) {
          var_newBlockList.addAssign_operation (enumerator_7902.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (184)) ;
        }
    ...
    cEnumerator_clusterList enumerator_8113 (var_clusterList, kEnumeration_up) ;
    while (enumerator_8113.hasCurrentObject ()) {
      var_newBlockList.dotAssign_operation (enumerator_8113.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (189)) ;
      enumerator_8113.gotoNextObject () ;
    }
    GALGAS_uint var_insertionIndex = var_newBlockList.reader_length (SOURCE_FILE_AT_LINE (192)) ;
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_8322 (ioArgument_ioBlockList, kEnumeration_down) ;
    bool bool_26 = var_continue.isValidAndTrue () ;
    if (enumerator_8322.hasCurrentObject () && bool_26) {
      while (enumerator_8322.hasCurrentObject () && bool_26) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8322.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (195)))) ;
        const enumGalgasBool test_27 = var_continue.boolEnum () ;
        if (kBoolTrue == test_27) {
          {
          var_newBlockList.modifier_insertAtIndex (enumerator_8322.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
          }
        }
