...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
  ...
  if (kBoolTrue == test_0) {
    ...
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CLUSTER ORDERING OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (46)) COMMA_SOURCE_FILE_AT_LINE (46)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (46)) COMMA_SOURCE_FILE_AT_LINE (46)) ;
    ...
    if (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)), inCompiler COMMA_SOURCE_FILE_AT_LINE (59)).isValid ()) {
      PMUInt32 variant_2351 = var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)), inCompiler COMMA_SOURCE_FILE_AT_LINE (59)).uintValue () ;
      bool loop_2351 = true ;
      while (loop_2351) {
        loop_2351 = var_continue.isValid () ;
        if (loop_2351) {
          loop_2351 = var_continue.boolValue () ;
        }
        if (loop_2351 && (0 == variant_2351)) {
          loop_2351 = false ;
        ...
        if (loop_2351) {
          ...
          cEnumerator_clusterList enumerator_2681 (var_clusterList, kEnumeration_up) ;
          GALGAS_uint index_2669 ((PMUInt32) 0) ;
          while (enumerator_2681.hasCurrentObject ()) {
            var_workingBlockList.dotAssign_operation (enumerator_2681.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (67)) ;
            cEnumerator_ipic_31__38_BlockList enumerator_2771 (enumerator_2681.current_mBlockList (HERE), kEnumeration_up) ;
            while (enumerator_2771.hasCurrentObject ()) {
              {
              var_symbolTable.modifier_insertKey (enumerator_2771.current_mBlock (HERE).mAttribute_mLabel, index_2669, inCompiler COMMA_SOURCE_FILE_AT_LINE (69)) ;
              }
              enumerator_2771.gotoNextObject () ;
            }
            enumerator_2681.gotoNextObject () ;
            index_2669.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
          }
          GALGAS_uint var_insertionIdx = var_workingBlockList.reader_length (SOURCE_FILE_AT_LINE (73)) ;
          cEnumerator_ipic_31__38_BlockList enumerator_3024 (ioArgument_ioBlockList, kEnumeration_down) ;
          bool bool_4 = var_continue.isValidAndTrue () ;
          if (enumerator_3024.hasCurrentObject () && bool_4) {
            while (enumerator_3024.hasCurrentObject () && bool_4) {
              var_continue = GALGAS_bool (kIsNotEqual, enumerator_3024.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (75)))) ;
              const enumGalgasBool test_5 = var_continue.boolEnum () ;
              if (kBoolTrue == test_5) {
                {
                var_symbolTable.modifier_insertKey (enumerator_3024.current_mBlock (HERE).mAttribute_mLabel, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (77)), inCompiler COMMA_SOURCE_FILE_AT_LINE (77)) ;
                }
                {
                var_workingBlockList.modifier_insertAtIndex (enumerator_3024.current_mBlock (HERE), var_insertionIdx, inCompiler COMMA_SOURCE_FILE_AT_LINE (78)) ;
                }
              }
              enumerator_3024.gotoNextObject () ;
              if (enumerator_3024.hasCurrentObject ()) {
          ...
          cEnumerator_branchOverflowMap enumerator_3545 (var_overflowMap, kEnumeration_up) ;
          while (enumerator_3545.hasCurrentObject ()) {
            cEnumerator_stringlist enumerator_3570 (enumerator_3545.current_mList (HERE), kEnumeration_up) ;
            while (enumerator_3570.hasCurrentObject ()) {
              ...
              var_symbolTable.method_searchKey (enumerator_3545.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (91)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (91)) ;
              GALGAS_uint var_targetCluster ;
              var_symbolTable.method_searchKey (enumerator_3570.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (92)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_3545.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (GALGAS_string (") --> ") COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (enumerator_3570.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)) ;
          ...
          cEnumerator_branchOverflowMap enumerator_4505 (var_overflowMap, kEnumeration_up) ;
          bool bool_9 = var_correctionLoop.isValidAndTrue () ;
          if (enumerator_4505.hasCurrentObject () && bool_9) {
            while (enumerator_4505.hasCurrentObject () && bool_9) {
              cEnumerator_stringlist enumerator_4551 (enumerator_4505.current_mList (HERE), kEnumeration_up) ;
              bool bool_10 = var_correctionLoop.isValidAndTrue () ;
              if (enumerator_4551.hasCurrentObject () && bool_10) {
                while (enumerator_4551.hasCurrentObject () && bool_10) {
                  GALGAS_uint var_targetCluster ;
                  var_symbolTable.method_searchKey (enumerator_4551.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (115)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
                  ...
                  if (kBoolTrue == test_11) {
                    GALGAS_uint var_sourceCluster ;
                    var_symbolTable.method_searchKey (enumerator_4505.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (117)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) ;
                    const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, var_sourceCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).objectCompare (var_targetCluster)).boolEnum () ;
                    if (kBoolTrue == test_12) {
                      ...
                      const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, var_sourceCluster.objectCompare (var_targetCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (129)))).boolEnum () ;
                      if (kBoolTrue == test_14) {
                        ...
                        if (kBoolTrue == test_16) {
                          ...
                          {
                          var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (143)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (143)), inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) ;
                          }
                          ...
                          if (kBoolTrue == test_17) {
                            ...
                            var_correctionLoop = GALGAS_bool (false) ;
                            var_continue = GALGAS_bool (true) ;
                            GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (148)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (148)).reader_string (SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_concat (GALGAS_string (", #") COMMA_SOURCE_FILE_AT_LINE (148)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (148)) ;
                          ...
                          if (kBoolTrue == test_19) {
                            ...
                            {
                            var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (157)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
                            }
                            ...
                            if (kBoolTrue == test_20) {
                              ...
                              var_correctionLoop = GALGAS_bool (false) ;
                              var_continue = GALGAS_bool (true) ;
                              GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (162)) COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string (", #") COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (162)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (162)).reader_string (SOURCE_FILE_AT_LINE (162)) COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (162)) ;
    ...
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_8165 (ioArgument_ioBlockList, kEnumeration_up) ;
    bool bool_24 = var_continue.isValidAndTrue () ;
    if (enumerator_8165.hasCurrentObject () && bool_24) {
      while (enumerator_8165.hasCurrentObject () && bool_24) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8165.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (185)))) ;
        const enumGalgasBool test_25 = var_continue.boolEnum () ;
        if (kBoolTrue == test_25) {
          var_newBlockList.addAssign_operation (enumerator_8165.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (187)) ;
        }
        enumerator_8165.gotoNextObject () ;
        if (enumerator_8165.hasCurrentObject ()) {
          bool_24 = var_continue.isValidAndTrue () ;
        }
      }
    }
    cEnumerator_clusterList enumerator_8379 (var_clusterList, kEnumeration_up) ;
    while (enumerator_8379.hasCurrentObject ()) {
      var_newBlockList.dotAssign_operation (enumerator_8379.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (192)) ;
      enumerator_8379.gotoNextObject () ;
    }
    GALGAS_uint var_insertionIndex = var_newBlockList.reader_length (SOURCE_FILE_AT_LINE (195)) ;
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_8585 (ioArgument_ioBlockList, kEnumeration_down) ;
    bool bool_26 = var_continue.isValidAndTrue () ;
    if (enumerator_8585.hasCurrentObject () && bool_26) {
      while (enumerator_8585.hasCurrentObject () && bool_26) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8585.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (198)))) ;
        const enumGalgasBool test_27 = var_continue.boolEnum () ;
        if (kBoolTrue == test_27) {
          {
          var_newBlockList.modifier_insertAtIndex (enumerator_8585.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
          }
        }
        enumerator_8585.gotoNextObject () ;
        if (enumerator_8585.hasCurrentObject ()) {
