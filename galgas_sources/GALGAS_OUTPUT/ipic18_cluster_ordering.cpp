...
GALGAS_string function_sortKey (const GALGAS_clusterList & constinArgument_inClusterList,
  ...
  cEnumerator_clusterList enumerator_735 (constinArgument_inClusterList, kEnumeration_up) ;
  while (enumerator_735.hasCurrentObject ()) {
    result_outKey.dotAssign_operation (enumerator_735.current_mBlockList (HERE).reader_mBlockAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (25)).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (25)) ;
...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_optimize = GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (67)) COMMA_SOURCE_FILE_AT_LINE (39)) COMMA_SOURCE_FILE_AT_LINE (38)) ;
  const enumGalgasBool test_0 = var_optimize.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_uint var_clusterCount = constinArgument_inInitialClusterList.reader_length (SOURCE_FILE_AT_LINE (41)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (42)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (42)) COMMA_SOURCE_FILE_AT_LINE (42)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CLUSTER ORDERING OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (44)).operator_concat (GALGAS_string ("\n"
    ...
    GALGAS_string var_s = GALGAS_string ("Cluster ordering optimization (").operator_concat (var_clusterCount.reader_string (SOURCE_FILE_AT_LINE (45)) COMMA_SOURCE_FILE_AT_LINE (45)).operator_concat (GALGAS_string (" cluster") COMMA_SOURCE_FILE_AT_LINE (45)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (45)).operator_concat (GALGAS_string ("):\n") COMMA_SOURCE_FILE_AT_LINE (45)) ;
    ...
    if (kBoolTrue == test_3) {
      inCompiler->printMessage (var_s COMMA_SOURCE_FILE_AT_LINE (49)) ;
    }
    GALGAS_clusterList var_clusterList = constinArgument_inInitialClusterList ;
    GALGAS_neededConversionForClusterOrder var_neededConversionForClusterOrder = GALGAS_neededConversionForClusterOrder::constructor_emptyMap (SOURCE_FILE_AT_LINE (53)) ;
    GALGAS_bool var_continue = GALGAS_bool (true) ;
    GALGAS_uint var_pass = GALGAS_uint ((PMUInt32) 0U) ;
    if (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)), inCompiler COMMA_SOURCE_FILE_AT_LINE (56)).isValid ()) {
      PMUInt32 variant_2082 = var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (56)), inCompiler COMMA_SOURCE_FILE_AT_LINE (56)).uintValue () ;
      bool loop_2082 = true ;
      while (loop_2082) {
        loop_2082 = var_continue.isValid () ;
        if (loop_2082) {
          loop_2082 = var_continue.boolValue () ;
        }
        if (loop_2082 && (0 == variant_2082)) {
          loop_2082 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (56)) ;
        }
        if (loop_2082) {
          variant_2082 -- ;
          var_pass.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (58)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)) ;
          GALGAS_ipic_31__38_BlockList var_workingBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (61)) ;
          GALGAS_symbolTableForClusterOrdering var_symbolTable = GALGAS_symbolTableForClusterOrdering::constructor_emptyMap (SOURCE_FILE_AT_LINE (62)) ;
          cEnumerator_clusterList enumerator_2412 (var_clusterList, kEnumeration_up) ;
          GALGAS_uint index_2400 ((PMUInt32) 0) ;
          while (enumerator_2412.hasCurrentObject ()) {
            var_workingBlockList.dotAssign_operation (enumerator_2412.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (64)) ;
            cEnumerator_ipic_31__38_BlockList enumerator_2502 (enumerator_2412.current_mBlockList (HERE), kEnumeration_up) ;
            while (enumerator_2502.hasCurrentObject ()) {
              {
              var_symbolTable.modifier_insertKey (enumerator_2502.current_mBlock (HERE).mAttribute_mLabel, index_2400, inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
              }
              enumerator_2502.gotoNextObject () ;
            }
            enumerator_2412.gotoNextObject () ;
            index_2400.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (63)) ;
          }
          GALGAS_uint var_insertionIdx = var_workingBlockList.reader_length (SOURCE_FILE_AT_LINE (70)) ;
          cEnumerator_ipic_31__38_BlockList enumerator_2755 (ioArgument_ioBlockList, kEnumeration_down) ;
          bool bool_4 = var_continue.isValidAndTrue () ;
          if (enumerator_2755.hasCurrentObject () && bool_4) {
            while (enumerator_2755.hasCurrentObject () && bool_4) {
              var_continue = GALGAS_bool (kIsNotEqual, enumerator_2755.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (72)))) ;
              const enumGalgasBool test_5 = var_continue.boolEnum () ;
              if (kBoolTrue == test_5) {
                {
                var_symbolTable.modifier_insertKey (enumerator_2755.current_mBlock (HERE).mAttribute_mLabel, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (74)), inCompiler COMMA_SOURCE_FILE_AT_LINE (74)) ;
                }
                {
                var_workingBlockList.modifier_insertAtIndex (enumerator_2755.current_mBlock (HERE), var_insertionIdx, inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) ;
                }
              }
          ...
          {
          routine_ipic_31__38_RelativeBranchOverflow (var_workingBlockList, ioArgument_ioBlockList, var_overflowMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (79)) ;
          }
          GALGAS_uint var_overflowCount = GALGAS_uint ((PMUInt32) 0U) ;
          cEnumerator_branchOverflowMap enumerator_3276 (var_overflowMap, kEnumeration_up) ;
          while (enumerator_3276.hasCurrentObject ()) {
            cEnumerator_stringlist enumerator_3301 (enumerator_3276.current_mList (HERE), kEnumeration_up) ;
            while (enumerator_3301.hasCurrentObject ()) {
              var_overflowCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (87)) ;
              GALGAS_uint var_sourceCluster ;
              var_symbolTable.method_searchKey (enumerator_3276.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (88)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (88)) ;
              GALGAS_uint var_targetCluster ;
              var_symbolTable.method_searchKey (enumerator_3301.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (89)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_3276.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (") --> ") COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (enumerator_3301.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)) ;
              enumerator_3301.gotoNextObject () ;
            }
            enumerator_3276.gotoNextObject () ;
          }
          {
          var_neededConversionForClusterOrder.modifier_insertKey (function_sortKey (var_clusterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)).reader_nowhere (SOURCE_FILE_AT_LINE (94)), var_overflowCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)) ;
          }
          const enumGalgasBool test_6 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_string var_s = GALGAS_string ("  Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (98)) ;
            const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_overflowCount.objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
            if (kBoolTrue == test_7) {
              var_s.dotAssign_operation (GALGAS_string ("no branch overflow") COMMA_SOURCE_FILE_AT_LINE (100)) ;
            }else if (kBoolFalse == test_7) {
              const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_overflowCount.objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
              if (kBoolTrue == test_8) {
                var_s.dotAssign_operation (GALGAS_string ("1 branch overflow") COMMA_SOURCE_FILE_AT_LINE (102)) ;
              }else if (kBoolFalse == test_8) {
                var_s.dotAssign_operation (var_overflowCount.reader_string (SOURCE_FILE_AT_LINE (104)).operator_concat (GALGAS_string (" branch overflows") COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (104)) ;
              }
            }
            inCompiler->printMessage (var_s COMMA_SOURCE_FILE_AT_LINE (106)) ;
          }
          GALGAS_bool var_correctionLoop = GALGAS_bool (true) ;
          cEnumerator_branchOverflowMap enumerator_4236 (var_overflowMap, kEnumeration_up) ;
          bool bool_9 = var_correctionLoop.isValidAndTrue () ;
          if (enumerator_4236.hasCurrentObject () && bool_9) {
            while (enumerator_4236.hasCurrentObject () && bool_9) {
              cEnumerator_stringlist enumerator_4282 (enumerator_4236.current_mList (HERE), kEnumeration_up) ;
              bool bool_10 = var_correctionLoop.isValidAndTrue () ;
              if (enumerator_4282.hasCurrentObject () && bool_10) {
                while (enumerator_4282.hasCurrentObject () && bool_10) {
                  GALGAS_uint var_targetCluster ;
                  var_symbolTable.method_searchKey (enumerator_4282.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (112)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)) ;
                  const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, var_targetCluster.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (113)))).boolEnum () ;
                  if (kBoolTrue == test_11) {
                    GALGAS_uint var_sourceCluster ;
                    var_symbolTable.method_searchKey (enumerator_4236.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (114)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) ;
                    const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, var_sourceCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).objectCompare (var_targetCluster)).boolEnum () ;
                    if (kBoolTrue == test_12) {
                      var_correctionLoop = GALGAS_bool (false) ;
                      var_continue = GALGAS_bool (true) ;
                      GALGAS_ipic_31__38_BlockList var_last ;
                      {
                      var_clusterList.modifier_removeAtIndex (var_last, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
                      }
                      GALGAS_ipic_31__38_BlockList var_first ;
                      {
                      var_clusterList.modifier_removeAtIndex (var_first, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
                      }
                      {
                      var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last COMMA_SOURCE_FILE_AT_LINE (120)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) ;
                      }
                      GALGAS_string var_m = GALGAS_string ("merge #").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string (" into #") COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (121)) ;
                      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)) ;
                      ...
                      if (kBoolTrue == test_13) {
                        inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)) ;
                      }
                    }else if (kBoolFalse == test_12) {
                      const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, var_sourceCluster.objectCompare (var_targetCluster.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (126)))).boolEnum () ;
                      if (kBoolTrue == test_14) {
                        var_correctionLoop = GALGAS_bool (false) ;
                        var_continue = GALGAS_bool (true) ;
                        GALGAS_ipic_31__38_BlockList var_last ;
                        {
                        var_clusterList.modifier_removeAtIndex (var_last, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (129)) ;
                        }
                        GALGAS_ipic_31__38_BlockList var_first ;
                        {
                        var_clusterList.modifier_removeAtIndex (var_first, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)) ;
                        }
                        {
                        var_clusterList.modifier_insertAtIndex (var_first.operator_concat (var_last COMMA_SOURCE_FILE_AT_LINE (131)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
                        }
                        GALGAS_string var_m = GALGAS_string ("merge #").operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (GALGAS_string (" into #") COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (132)) ;
                        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)) ;
                        ...
                        if (kBoolTrue == test_15) {
                          inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)) ;
                        }
                        ...
                        if (kBoolTrue == test_16) {
                          ...
                          {
                          var_candidate.modifier_removeAtIndex (var_b, var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (139)) ;
                          }
                          {
                          var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (140)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (140)), inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) ;
                          }
                          const enumGalgasBool test_17 = var_neededConversionForClusterOrder.reader_hasKey (function_sortKey (var_candidate, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (141)).operator_not (SOURCE_FILE_AT_LINE (141)).boolEnum () ;
                          if (kBoolTrue == test_17) {
                            var_clusterList = var_candidate ;
                            var_correctionLoop = GALGAS_bool (false) ;
                            var_continue = GALGAS_bool (true) ;
                            GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (145)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (145)).reader_string (SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (GALGAS_string (", #") COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (145)) ;
                            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (146)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)) ;
                            ...
                            if (kBoolTrue == test_18) {
                              inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)) ;
                            }
                          }
                          ...
                          if (kBoolTrue == test_19) {
                            ...
                            GALGAS_ipic_31__38_BlockList var_b ;
                            {
                            var_candidate.modifier_removeAtIndex (var_b, var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
                            }
                            {
                            var_candidate.modifier_insertAtIndex (var_b, var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (154)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (154)), inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
                            }
                            const enumGalgasBool test_20 = var_neededConversionForClusterOrder.reader_hasKey (function_sortKey (var_candidate, inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) COMMA_SOURCE_FILE_AT_LINE (155)).operator_not (SOURCE_FILE_AT_LINE (155)).boolEnum () ;
                            if (kBoolTrue == test_20) {
                              var_clusterList = var_candidate ;
                              var_correctionLoop = GALGAS_bool (false) ;
                              var_continue = GALGAS_bool (true) ;
                              GALGAS_string var_m = GALGAS_string ("roll up [#").operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string (", #") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (var_targetCluster.add_operation (var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (159)).divide_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (159)).reader_string (SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (159)) ;
                              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  --> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
                              ...
                              if (kBoolTrue == test_21) {
                                inCompiler->printMessage (GALGAS_string (" -> ").operator_concat (var_m COMMA_SOURCE_FILE_AT_LINE (162)) COMMA_SOURCE_FILE_AT_LINE (162)) ;
                              }
                            }
                          }
                        }
              ...
              if (enumerator_4236.hasCurrentObject ()) {
    ...
    GALGAS_ipic_31__38_BlockList var_newBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (178)) ;
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_7896 (ioArgument_ioBlockList, kEnumeration_up) ;
    bool bool_24 = var_continue.isValidAndTrue () ;
    if (enumerator_7896.hasCurrentObject () && bool_24) {
      while (enumerator_7896.hasCurrentObject () && bool_24) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_7896.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (182)))) ;
        const enumGalgasBool test_25 = var_continue.boolEnum () ;
        if (kBoolTrue == test_25) {
          var_newBlockList.addAssign_operation (enumerator_7896.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (184)) ;
        }
        enumerator_7896.gotoNextObject () ;
        if (enumerator_7896.hasCurrentObject ()) {
          bool_24 = var_continue.isValidAndTrue () ;
        }
      }
    }
    cEnumerator_clusterList enumerator_8110 (var_clusterList, kEnumeration_up) ;
    while (enumerator_8110.hasCurrentObject ()) {
      var_newBlockList.dotAssign_operation (enumerator_8110.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (189)) ;
      enumerator_8110.gotoNextObject () ;
    }
    GALGAS_uint var_insertionIndex = var_newBlockList.reader_length (SOURCE_FILE_AT_LINE (192)) ;
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_8316 (ioArgument_ioBlockList, kEnumeration_down) ;
    bool bool_26 = var_continue.isValidAndTrue () ;
    if (enumerator_8316.hasCurrentObject () && bool_26) {
      while (enumerator_8316.hasCurrentObject () && bool_26) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8316.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (195)))) ;
        const enumGalgasBool test_27 = var_continue.boolEnum () ;
        if (kBoolTrue == test_27) {
          {
          var_newBlockList.modifier_insertAtIndex (enumerator_8316.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
          }
        }
        enumerator_8316.gotoNextObject () ;
        if (enumerator_8316.hasCurrentObject ()) {
