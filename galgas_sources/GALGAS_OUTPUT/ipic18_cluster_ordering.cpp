...
GALGAS_string function_sortKey (const GALGAS_clusterList & constinArgument_inClusterList,
  ...
  while (enumerator_735.hasCurrentObject ()) {
    result_outKey.dotAssign_operation (enumerator_735.current_mBlockList (HERE).reader_mBlockAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (25)).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (25)) ;
...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)), inCompiler COMMA_SOURCE_FILE_AT_LINE (59)).isValid ()) {
      uint32_t variant_2351 = var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (59)), inCompiler COMMA_SOURCE_FILE_AT_LINE (59)).uintValue () ;
      bool loop_2351 = true ;
      while (loop_2351) {
        ...
        if (loop_2351) {
          ...
          GALGAS_uint index_2669 ((uint32_t) 0) ;
