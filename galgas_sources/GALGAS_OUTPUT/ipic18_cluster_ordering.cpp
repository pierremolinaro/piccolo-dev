...
void routine_perform_5F_cluster_5F_ordering (const GALGAS_clusterList constinArgument_inInitialClusterList,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (57)).multiply_operation (var_clusterList.reader_length (SOURCE_FILE_AT_LINE (57)), inCompiler COMMA_SOURCE_FILE_AT_LINE (57)).isValid ()) {
      ...
      while (loop_2085) {
        ...
        if (loop_2085) {
          ...
          cEnumerator_ipic_31__38_BlockList enumerator_2766 (ioArgument_ioBlockList, kEnumeration_down) ;
          ...
          if (enumerator_2766.hasCurrentObject () && bool_4) {
            while (enumerator_2766.hasCurrentObject () && bool_4) {
              var_continue = GALGAS_bool (kIsNotEqual, enumerator_2766.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (73)))) ;
              const enumGalgasBool test_5 = var_continue.boolEnum () ;
              if (kBoolTrue == test_5) {
                {
                var_symbolTable.modifier_insertKey (enumerator_2766.current_mBlock (HERE).mAttribute_mLabel, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (75)), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) ;
                }
                {
                var_workingBlockList.modifier_insertAtIndex (enumerator_2766.current_mBlock (HERE), var_insertionIdx, inCompiler COMMA_SOURCE_FILE_AT_LINE (76)) ;
                }
              }
          ...
          cEnumerator_branchOverflowMap enumerator_3284 (var_overflowMap, kEnumeration_up) ;
          while (enumerator_3284.hasCurrentObject ()) {
            cEnumerator_stringlist enumerator_3309 (enumerator_3284.current_mList (HERE), kEnumeration_up) ;
            while (enumerator_3309.hasCurrentObject ()) {
              ...
              var_symbolTable.method_searchKey (enumerator_3284.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (89)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
              GALGAS_uint var_targetCluster ;
              var_symbolTable.method_searchKey (enumerator_3309.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (90)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_3284.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (var_sourceCluster.reader_string (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (") --> ") COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (enumerator_3309.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (" (cluster #") COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (var_targetCluster.reader_string (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) ;
          ...
          cEnumerator_branchOverflowMap enumerator_4247 (var_overflowMap, kEnumeration_up) ;
          bool bool_9 = var_correctionLoop.isValidAndTrue () ;
          if (enumerator_4247.hasCurrentObject () && bool_9) {
            while (enumerator_4247.hasCurrentObject () && bool_9) {
              cEnumerator_stringlist enumerator_4293 (enumerator_4247.current_mList (HERE), kEnumeration_up) ;
              bool bool_10 = var_correctionLoop.isValidAndTrue () ;
              if (enumerator_4293.hasCurrentObject () && bool_10) {
                while (enumerator_4293.hasCurrentObject () && bool_10) {
                  GALGAS_uint var_targetCluster ;
                  var_symbolTable.method_searchKey (enumerator_4293.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (113)), var_targetCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (113)) ;
                  ...
                  if (kBoolTrue == test_11) {
                    GALGAS_uint var_sourceCluster ;
                    var_symbolTable.method_searchKey (enumerator_4247.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (115)), var_sourceCluster, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
    ...
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_7907 (ioArgument_ioBlockList, kEnumeration_up) ;
    bool bool_24 = var_continue.isValidAndTrue () ;
    if (enumerator_7907.hasCurrentObject () && bool_24) {
      while (enumerator_7907.hasCurrentObject () && bool_24) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_7907.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (183)))) ;
        const enumGalgasBool test_25 = var_continue.boolEnum () ;
        if (kBoolTrue == test_25) {
          var_newBlockList.addAssign_operation (enumerator_7907.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (185)) ;
        }
        enumerator_7907.gotoNextObject () ;
        if (enumerator_7907.hasCurrentObject ()) {
          bool_24 = var_continue.isValidAndTrue () ;
        }
      }
    }
    cEnumerator_clusterList enumerator_8118 (var_clusterList, kEnumeration_up) ;
    while (enumerator_8118.hasCurrentObject ()) {
      var_newBlockList.dotAssign_operation (enumerator_8118.current_mBlockList (HERE) COMMA_SOURCE_FILE_AT_LINE (190)) ;
      enumerator_8118.gotoNextObject () ;
    }
    GALGAS_uint var_insertionIndex = var_newBlockList.reader_length (SOURCE_FILE_AT_LINE (193)) ;
    var_continue = GALGAS_bool (true) ;
    cEnumerator_ipic_31__38_BlockList enumerator_8331 (ioArgument_ioBlockList, kEnumeration_down) ;
    bool bool_26 = var_continue.isValidAndTrue () ;
    if (enumerator_8331.hasCurrentObject () && bool_26) {
      while (enumerator_8331.hasCurrentObject () && bool_26) {
        var_continue = GALGAS_bool (kIsNotEqual, enumerator_8331.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (196)))) ;
        const enumGalgasBool test_27 = var_continue.boolEnum () ;
        if (kBoolTrue == test_27) {
          {
          var_newBlockList.modifier_insertAtIndex (enumerator_8331.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (198)) ;
          }
        }
        enumerator_8331.gotoNextObject () ;
        if (enumerator_8331.hasCurrentObject ()) {
