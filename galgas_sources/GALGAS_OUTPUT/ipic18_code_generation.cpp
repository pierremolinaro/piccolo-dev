...
void routine_ipic_31__38_GenerateCode (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_actualConfigurationMap enumerator_10428 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_10428.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_10428.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (283)) ;
    }
    {
    routine_emitByte (enumerator_10428.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (284)) ;
    }
  ...
  var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_10733_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (289)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    GALGAS_bool joker_11139_0 ; // Joker input parameter
    var_cContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_11139_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
    ...
    GALGAS_bool joker_11345_0 ; // Joker input parameter
    var_hContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_11345_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
  }
...
void routine_pic_31__38_GenerateAssemblyFile (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_registerTable enumerator_12627 (constinArgument_inPredefinedRegisters, kEnumeration_up) ;
  while (enumerator_12627.hasCurrentObject ()) {
    GALGAS_uint var_firstRegister ;
    enumerator_12627.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (334)) ;
    var_assemblyString.dotAssign_operation (enumerator_12627.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)) ;
  ...
  cEnumerator_registerTable enumerator_12938 (constinArgument_inAllRegisters, kEnumeration_up) ;
  while (enumerator_12938.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inPredefinedRegisters.reader_hasKey (enumerator_12938.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)).operator_not (SOURCE_FILE_AT_LINE (341)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_uint var_firstRegister ;
      enumerator_12938.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (342)) ;
      var_assemblyString.dotAssign_operation (enumerator_12938.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)) ;
    }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_actualConfigurationMap enumerator_13590 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
    while (enumerator_13590.hasCurrentObject ()) {
      var_assemblyString.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_13590.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (enumerator_13590.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (356)).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
  ...
  GALGAS_bool joker_14065_0 ; // Joker input parameter
  var_assemblyString.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_14065_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (364)) ;
}
