...
void routine_ipic_31__38_GenerateCode (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_pic_31__38__5F_dataMap enumerator_7231 (constinArgument_inDataMap, kEnumeration_up) ;
  while (enumerator_7231.hasCurrentObject ()) {
    {
    var_dataAddressMap.modifier_insertKey (enumerator_7231.current_lkey (HERE), var_dataAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (203)) ;
    }
    var_dataAddress = var_dataAddress.add_operation (enumerator_7231.current_mData (HERE).reader_length (SOURCE_FILE_AT_LINE (204)).multiply_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (204)), inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_7541 (constinArgument_inGeneratedBlockList, kEnumeration_up) ;
  GALGAS_uint index_7520 ((PMUInt32) 0) ;
  while (enumerator_7541.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_7520.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (212)).objectCompare (constinArgument_inGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (212)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_nextBlockLabel = constinArgument_inGeneratedBlockList.reader_mBlockAtIndex (index_7520.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (213)), inCompiler COMMA_SOURCE_FILE_AT_LINE (213)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_1) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_7541.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (217)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_blockStartAddress = enumerator_7541.current_mBlock (HERE).mAttribute_mAddress ;
      {
      routine_setEmitAddress (var_blockStartAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (219)) ;
      }
    }
    categoryMethod_generateCode (enumerator_7541.current_mBlock (HERE), var_symbolTable, var_dataAddressMap, var_blockStartAddress, var_nextBlockLabel, ioArgument_ioListFileContents, var_assemblyString, inCompiler COMMA_SOURCE_FILE_AT_LINE (221)) ;
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_7541.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (222)) ;
    var_blockStartAddress = var_blockStartAddress.add_operation (var_blockSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_7541.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (224)))).boolEnum () ;
    if (kBoolTrue == test_3) {
    ...
    index_7520.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (210)) ;
  }
  var_dataAddress = var_firstDataAddress ;
  cEnumerator_pic_31__38__5F_dataMap enumerator_8410 (constinArgument_inDataMap, kEnumeration_up) ;
  const bool bool_4 = true ;
  if (enumerator_8410.hasCurrentObject () && bool_4) {
    {
    ...
    while (enumerator_8410.hasCurrentObject () && bool_4) {
      {
      routine_generateLineWithCode (var_dataAddress, GALGAS_codeList::constructor_listWithValue (GALGAS_string ("_data_").operator_concat (enumerator_8410.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (243)) COMMA_SOURCE_FILE_AT_LINE (243)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (243)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (243)) COMMA_SOURCE_FILE_AT_LINE (243)), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("_data_").operator_concat (enumerator_8410.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) ;
      }
      var_assemblyString.dotAssign_operation (GALGAS_string ("_data_").operator_concat (enumerator_8410.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)) ;
      cEnumerator_uintlist enumerator_9050 (enumerator_8410.current_mData (HERE), kEnumeration_up) ;
      while (enumerator_9050.hasCurrentObject ()) {
        var_assemblyString.dotAssign_operation (GALGAS_string ("    DW ").operator_concat (enumerator_9050.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (249)) ;
        {
        routine_emitCode (enumerator_9050.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (250)) ;
        }
        {
        routine_generateLineWithCode (var_dataAddress, GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    DW ").operator_concat (enumerator_9050.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)), GALGAS_uintlist::constructor_listWithValue (enumerator_9050.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("    DW ").operator_concat (enumerator_9050.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (251)) ;
        }
  ...
  cEnumerator_actualConfigurationMap enumerator_9784 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_9784.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_9784.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
    }
    {
    routine_emitByte (enumerator_9784.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (269)) ;
    }
  ...
  var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_10089_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (274)) ;
  ...
  if (kBoolTrue == test_6) {
    ...
    GALGAS_bool joker_10495_0 ; // Joker input parameter
    var_cContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_10495_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (280)) ;
    ...
    GALGAS_bool joker_10701_0 ; // Joker input parameter
    var_hContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_10701_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (283)) ;
  }
...
void routine_pic_31__38_GenerateAssemblyFile (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_registerTable enumerator_11983 (constinArgument_inPredefinedRegisters, kEnumeration_up) ;
  while (enumerator_11983.hasCurrentObject ()) {
    GALGAS_uint var_firstRegister ;
    enumerator_11983.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
    var_assemblyString.dotAssign_operation (enumerator_11983.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (320)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (320)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (320)) COMMA_SOURCE_FILE_AT_LINE (320)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (320)) COMMA_SOURCE_FILE_AT_LINE (320)) ;
  ...
  cEnumerator_registerTable enumerator_12294 (constinArgument_inAllRegisters, kEnumeration_up) ;
  while (enumerator_12294.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inPredefinedRegisters.reader_hasKey (enumerator_12294.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (326)) COMMA_SOURCE_FILE_AT_LINE (326)).operator_not (SOURCE_FILE_AT_LINE (326)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_uint var_firstRegister ;
      enumerator_12294.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (327)) ;
      var_assemblyString.dotAssign_operation (enumerator_12294.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (328)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (328)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (328)) COMMA_SOURCE_FILE_AT_LINE (328)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (328)) COMMA_SOURCE_FILE_AT_LINE (328)) ;
    }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_actualConfigurationMap enumerator_12946 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
    while (enumerator_12946.hasCurrentObject ()) {
      var_assemblyString.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_12946.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (341)).operator_concat (enumerator_12946.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (341)).reader_hexString (SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)) ;
  ...
  var_assemblyString.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_13421_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
}
