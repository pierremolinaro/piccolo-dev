...
void routine_generateLineWithCode (const GALGAS_uint constinArgument_inAddress,
  ...
  if (constinArgument_inCode.reader_length (SOURCE_FILE_AT_LINE (40)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (40)).isValid ()) {
    uint32_t variant_1428 = constinArgument_inCode.reader_length (SOURCE_FILE_AT_LINE (40)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (40)).uintValue () ;
    bool loop_1428 = true ;
    while (loop_1428) {
  ...
  while (enumerator_1587.hasCurrentObject () && enumerator_1595.hasCurrentObject ()) {
    ...
    var_address = var_address.add_operation (GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_1595.current_mBinaryCode (HERE).reader_length (SOURCE_FILE_AT_LINE (48)), inCompiler COMMA_SOURCE_FILE_AT_LINE (48)), inCompiler COMMA_SOURCE_FILE_AT_LINE (48)) ;
    ...
    ioArgument_ioListFileContents.dotAssign_operation (enumerator_1595.current_mAssemblyCode (HERE).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 50U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (54)) COMMA_SOURCE_FILE_AT_LINE (54)) ;
...
void routine_ipic_31__38_GenerateCode (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_pic_31__38__5F_dataMap enumerator_7330 (constinArgument_inDataMap, kEnumeration_up) ;
  while (enumerator_7330.hasCurrentObject ()) {
    {
    var_dataAddressMap.modifier_insertKey (enumerator_7330.current_lkey (HERE), var_dataAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
    }
    var_dataAddress = var_dataAddress.add_operation (enumerator_7330.current_mData (HERE).reader_length (SOURCE_FILE_AT_LINE (207)).multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (207)), inCompiler COMMA_SOURCE_FILE_AT_LINE (207)) ;
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_7662 (constinArgument_inGeneratedBlockList, kEnumeration_up) ;
  GALGAS_uint index_7641 ((uint32_t) 0) ;
  while (enumerator_7662.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_7641.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (216)).objectCompare (constinArgument_inGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (216)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_nextBlockLabel = constinArgument_inGeneratedBlockList.reader_mBlockAtIndex (index_7641.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (217)), inCompiler COMMA_SOURCE_FILE_AT_LINE (217)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_1) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_7662.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (221)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_blockStartAddress = enumerator_7662.current_mBlock (HERE).mAttribute_mAddress ;
      {
      routine_setEmitAddress (var_blockStartAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
      }
    }
    categoryMethod_generateCode (enumerator_7662.current_mBlock (HERE), var_symbolTable, var_dataAddressMap, var_blockStartAddress, var_nextBlockLabel, ioArgument_ioListFileContents, var_assemblyString, inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_7662.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)) ;
    var_blockStartAddress = var_blockStartAddress.add_operation (var_blockSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (227)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_7662.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (228)))).boolEnum () ;
    if (kBoolTrue == test_3) {
    ...
    index_7641.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (214)) ;
  }
  var_dataAddress = var_firstDataAddress ;
  cEnumerator_pic_31__38__5F_dataMap enumerator_8531 (constinArgument_inDataMap, kEnumeration_up) ;
  const bool bool_4 = true ;
  if (enumerator_8531.hasCurrentObject () && bool_4) {
    {
    ...
    while (enumerator_8531.hasCurrentObject () && bool_4) {
      {
      routine_generateLineWithCode (var_dataAddress, GALGAS_codeList::constructor_listWithValue (GALGAS_string ("_data_").operator_concat (enumerator_8531.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (247)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("_data_").operator_concat (enumerator_8531.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (248)) COMMA_SOURCE_FILE_AT_LINE (248)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (248)) COMMA_SOURCE_FILE_AT_LINE (248)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)) ;
      }
      var_assemblyString.dotAssign_operation (GALGAS_string ("_data_").operator_concat (enumerator_8531.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)) ;
      cEnumerator_uintlist enumerator_9171 (enumerator_8531.current_mData (HERE), kEnumeration_up) ;
      while (enumerator_9171.hasCurrentObject ()) {
        var_assemblyString.dotAssign_operation (GALGAS_string ("    DW ").operator_concat (enumerator_9171.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)) ;
        {
        routine_emitCode (enumerator_9171.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (254)) ;
        }
        {
        routine_generateLineWithCode (var_dataAddress, GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    DW ").operator_concat (enumerator_9171.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)), GALGAS_uintlist::constructor_listWithValue (enumerator_9171.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("    DW ").operator_concat (enumerator_9171.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (255)) ;
        }
  ...
  cEnumerator_actualConfigurationMap enumerator_10438 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_10438.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_10438.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (283)) ;
    }
    {
    routine_emitByte (enumerator_10438.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (284)) ;
    }
  ...
  GALGAS_bool joker_10743_0 ; // Joker input parameter
  var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_10743_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (289)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    GALGAS_bool joker_11149_0 ; // Joker input parameter
    var_cContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_11149_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
    ...
    GALGAS_bool joker_11355_0 ; // Joker input parameter
    var_hContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_11355_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
  }
...
void routine_pic_31__38_GenerateAssemblyFile (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_registerTable enumerator_12948 (constinArgument_inAllRegisters, kEnumeration_up) ;
  while (enumerator_12948.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inPredefinedRegisters.reader_hasKey (enumerator_12948.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)).operator_not (SOURCE_FILE_AT_LINE (341)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_uint var_firstRegister ;
      enumerator_12948.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (342)) ;
      var_assemblyString.dotAssign_operation (enumerator_12948.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)) ;
    }
  ...
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_13600.hasCurrentObject ()) {
      var_assemblyString.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_13600.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (enumerator_13600.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((uint32_t) 255U) COMMA_SOURCE_FILE_AT_LINE (356)).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
  ...
  GALGAS_bool joker_14075_0 ; // Joker input parameter
  var_assemblyString.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_14075_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (364)) ;
}
...
void categoryMethod_generateCode (const GALGAS_ipic_31__38_Block inObject,
  ...
  while (enumerator_3728.hasCurrentObject ()) {
    ...
    while (enumerator_4307.hasCurrentObject ()) {
      var_generatedCodeSize = var_generatedCodeSize.add_operation (GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_4307.current_mBinaryCode (HERE).reader_length (SOURCE_FILE_AT_LINE (126)), inCompiler COMMA_SOURCE_FILE_AT_LINE (126)), inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) ;
  ...
  cEnumerator_codeList enumerator_5056 (var_code, kEnumeration_up) ;
  while (enumerator_5056.hasCurrentObject ()) {
    cEnumerator_uintlist enumerator_5083 (enumerator_5056.current_mBinaryCode (HERE), kEnumeration_up) ;
    while (enumerator_5083.hasCurrentObject ()) {
      {
      routine_emitCode (enumerator_5083.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (150)) ;
      }
      enumerator_5083.gotoNextObject () ;
    }
    ioArgument_ioAssemblyString.dotAssign_operation (enumerator_5056.current_mAssemblyCode (HERE).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (152)) COMMA_SOURCE_FILE_AT_LINE (152)) ;
    enumerator_5056.gotoNextObject () ;
  }
  GALGAS_uint var_generatedCodeSize = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_codeList enumerator_5305 (var_code, kEnumeration_up) ;
  while (enumerator_5305.hasCurrentObject ()) {
    var_generatedCodeSize = var_generatedCodeSize.add_operation (GALGAS_uint ((uint32_t) 2U).multiply_operation (enumerator_5305.current_mBinaryCode (HERE).reader_length (SOURCE_FILE_AT_LINE (157)), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
