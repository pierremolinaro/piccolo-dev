...
void routine_ipic_31__38_GenerateCode (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_7630 (constinArgument_inGeneratedBlockList, kEnumeration_up) ;
  GALGAS_uint index_7609 ((PMUInt32) 0) ;
  while (enumerator_7630.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_7609.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (215)).objectCompare (constinArgument_inGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (215)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_nextBlockLabel = constinArgument_inGeneratedBlockList.reader_mBlockAtIndex (index_7609.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (216)), inCompiler COMMA_SOURCE_FILE_AT_LINE (216)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_1) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_7630.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (220)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_blockStartAddress = enumerator_7630.current_mBlock (HERE).mAttribute_mAddress ;
      {
      routine_setEmitAddress (var_blockStartAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (222)) ;
      }
    }
    categoryMethod_generateCode (enumerator_7630.current_mBlock (HERE), var_symbolTable, var_dataAddressMap, var_blockStartAddress, var_nextBlockLabel, ioArgument_ioListFileContents, var_assemblyString, inCompiler COMMA_SOURCE_FILE_AT_LINE (224)) ;
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_7630.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
    var_blockStartAddress = var_blockStartAddress.add_operation (var_blockSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_7630.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (227)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      var_relocatableCodeSize = var_relocatableCodeSize.add_operation (var_blockSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (228)) ;
    }
    enumerator_7630.gotoNextObject () ;
    index_7609.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (213)) ;
  }
  var_dataAddress = var_firstDataAddress ;
  cEnumerator_pic_31__38__5F_dataMap enumerator_8499 (constinArgument_inDataMap, kEnumeration_up) ;
  const bool bool_4 = true ;
  if (enumerator_8499.hasCurrentObject () && bool_4) {
    {
    routine_setEmitAddress (var_dataAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (235)) ;
    }
    {
    routine_generateLineWithCode (var_dataAddress, GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ORG ").operator_concat (var_dataAddress.reader_hexString (SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (238)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (238)), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("    ORG ").operator_concat (var_dataAddress.reader_hexString (SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (236)) ;
    }
    var_assemblyString.dotAssign_operation (GALGAS_string ("    ORG ").operator_concat (var_dataAddress.reader_hexString (SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242)) ;
    while (enumerator_8499.hasCurrentObject () && bool_4) {
      {
      routine_generateLineWithCode (var_dataAddress, GALGAS_codeList::constructor_listWithValue (GALGAS_string ("_data_").operator_concat (enumerator_8499.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (246)) COMMA_SOURCE_FILE_AT_LINE (246)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (246)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (246)) COMMA_SOURCE_FILE_AT_LINE (246)), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("_data_").operator_concat (enumerator_8499.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (244)) ;
      }
      var_assemblyString.dotAssign_operation (GALGAS_string ("_data_").operator_concat (enumerator_8499.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)) ;
      cEnumerator_uintlist enumerator_9139 (enumerator_8499.current_mData (HERE), kEnumeration_up) ;
      while (enumerator_9139.hasCurrentObject ()) {
        var_assemblyString.dotAssign_operation (GALGAS_string ("    DW ").operator_concat (enumerator_9139.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (252)) COMMA_SOURCE_FILE_AT_LINE (252)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (252)) COMMA_SOURCE_FILE_AT_LINE (252)) ;
        {
        routine_emitCode (enumerator_9139.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (253)) ;
        }
        {
        routine_generateLineWithCode (var_dataAddress, GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    DW ").operator_concat (enumerator_9139.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (256)), GALGAS_uintlist::constructor_listWithValue (enumerator_9139.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (256)), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("    DW ").operator_concat (enumerator_9139.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (254)) ;
        }
        var_dataAddress = var_dataAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (260)) ;
  ...
  if (kBoolTrue == test_5) {
    inCompiler->printMessage (GALGAS_string ("  Relocatable code size: ").operator_concat (var_relocatableCodeSize.reader_string (SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (GALGAS_string (" bytes.\n"
  ...
  cEnumerator_actualConfigurationMap enumerator_10447 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_10447.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_10447.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (283)) ;
    }
    {
    routine_emitByte (enumerator_10447.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (284)) ;
    }
  ...
  var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_10752_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (289)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    GALGAS_bool joker_11158_0 ; // Joker input parameter
    var_cContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_11158_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
    ...
    GALGAS_bool joker_11364_0 ; // Joker input parameter
    var_hContents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_11364_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
  }
  const enumGalgasBool test_9 = GALGAS_bool (gOption_piccolo_5F_options_generateAssembly.reader_value ()).operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (301)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (301)).boolEnum () ;
  if (kBoolTrue == test_9) {
    {
...
void routine_pic_31__38_GenerateAssemblyFile (const GALGAS_string constinArgument_inSourceFileName,
  ...
  cEnumerator_registerTable enumerator_12646 (constinArgument_inPredefinedRegisters, kEnumeration_up) ;
  while (enumerator_12646.hasCurrentObject ()) {
    GALGAS_uint var_firstRegister ;
    enumerator_12646.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (334)) ;
    var_assemblyString.dotAssign_operation (enumerator_12646.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)) ;
  ...
  cEnumerator_registerTable enumerator_12957 (constinArgument_inAllRegisters, kEnumeration_up) ;
  while (enumerator_12957.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inPredefinedRegisters.reader_hasKey (enumerator_12957.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)).operator_not (SOURCE_FILE_AT_LINE (341)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_uint var_firstRegister ;
      enumerator_12957.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (342)) ;
      var_assemblyString.dotAssign_operation (enumerator_12957.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)) ;
    }
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, constinArgument_inActualConfigurationMap.reader_count (SOURCE_FILE_AT_LINE (353)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_assemblyString.dotAssign_operation (GALGAS_string (";--- Configuration\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (354)) ;
    cEnumerator_actualConfigurationMap enumerator_13609 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
    while (enumerator_13609.hasCurrentObject ()) {
      var_assemblyString.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_13609.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (enumerator_13609.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (356)).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
  ...
  GALGAS_bool joker_14084_0 ; // Joker input parameter
  var_assemblyString.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_14084_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (364)) ;
}
