...
void routine_ipic_31__38_GenerateCode (const GALGAS_string /* constinArgument_inSourceFileName */,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CODE GENERATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (127)).operator_concat (GALGAS_string ("\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  GALGAS_symbolTableForRelativesResolution var_symbolTable ;
  {
  routine_computeLabelAbsoluteAddressMap (constinArgument_inGeneratedBlockList, var_symbolTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  GALGAS_uint var_blockStartAddress = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_BlockList enumerator_4529 (constinArgument_inGeneratedBlockList, kEnumeration_up) ;
  GALGAS_uint index_4523 ((PMUInt32) 0) ;
  while (enumerator_4529.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, index_4523.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (137)).objectCompare (constinArgument_inGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (137)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_nextBlockLabel = constinArgument_inGeneratedBlockList.reader_mBlockAtIndex (index_4523.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (138)), inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_0) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_4529.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (142)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_blockStartAddress = enumerator_4529.current_mBlock (HERE).mAttribute_mStartAddress ;
    }
    categoryMethod_generateCode (enumerator_4529.current_mBlock (HERE), var_symbolTable, constinArgument_inGeneratedBlockList, var_blockStartAddress, var_nextBlockLabel, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) ;
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_4529.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) ;
    var_blockStartAddress = var_blockStartAddress.add_operation (var_blockSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) ;
    enumerator_4529.gotoNextObject () ;
    index_4523.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
}
...
void categoryMethod_generateCode (const GALGAS_ipic_31__38_Block inObject,
  ...
  while (enumerator_3379.hasCurrentObject ()) {
    ...
    callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_3379.current_mInstruction (HERE).ptr (), var_address, constinArgument_inSymbolTable, constinArgument_inGeneratedBlockList, var_inCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
    GALGAS_stringlist var_ipicText = callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_3379.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (102)) ;
    {
    routine_generateLineWithCode (var_address, var_inCode, var_ipicText, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (103)) ;
    }
    var_address = var_address.add_operation (callCategoryReader_instructionSize ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_3379.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (109)), inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
