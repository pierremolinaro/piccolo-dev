...
void routine_ipic_31__38_GenerateCode (const GALGAS_string constinArgument_inSourceFileName,
  ...
  while (enumerator_7330.hasCurrentObject ()) {
    ...
    var_dataAddress = var_dataAddress.add_operation (enumerator_7330.current_mData (HERE).reader_length (SOURCE_FILE_AT_LINE (207)).multiply_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (207)), inCompiler COMMA_SOURCE_FILE_AT_LINE (207)) ;
  ...
  GALGAS_uint index_7641 ((PMUInt32) 0) ;
  while (enumerator_7662.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_7641.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (216)).objectCompare (constinArgument_inGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (216)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_nextBlockLabel = constinArgument_inGeneratedBlockList.reader_mBlockAtIndex (index_7641.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (217)), inCompiler COMMA_SOURCE_FILE_AT_LINE (217)).mAttribute_mLabel.mAttribute_string ;
...
void routine_pic_31__38_GenerateAssemblyFile (const GALGAS_string constinArgument_inSourceFileName,
  ...
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_13600.hasCurrentObject ()) {
      var_assemblyString.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_13600.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (enumerator_13600.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (356)).reader_hexString (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
...
void categoryMethod_generateCode (const GALGAS_ipic_31__38_Block inObject,
  ...
  while (enumerator_5305.hasCurrentObject ()) {
    var_generatedCodeSize = var_generatedCodeSize.add_operation (GALGAS_uint ((PMUInt32) 2U).multiply_operation (enumerator_5305.current_mBinaryCode (HERE).reader_length (SOURCE_FILE_AT_LINE (157)), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)), inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
