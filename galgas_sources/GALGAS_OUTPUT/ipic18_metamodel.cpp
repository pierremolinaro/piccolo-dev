...
category_method__registerExpression__resolveAccess (C_Compiler & inLexique,
  ...
  if (operand_671 != NULL) {
    ...
    if (var_cas_inRegisterTable.isBuilt ()) {
      var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, operand_671->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_1214_0 COMMA_SOURCE_FILE_AT_LINE (39)) ;
    }
    ...
    if (cond_2223.isBuiltAndTrue ()) {
      ...
      if (var_cas_registerAddressList.isBuilt ()) {
        var_cas_registerAddressList (HERE)->method_first (inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (53)) ;
      }
...
category_method__registerExpression__resolveAccessWithoutCheckingBank (C_Compiler & inLexique,
  ...
  if (operand_2509 != NULL) {
    ...
    if (var_cas_inRegisterTable.isBuilt ()) {
      var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, operand_2509->mRegisterName, var_cas_registerAddressList, var_cas_size, automatic_var_2933_0, automatic_var_2933_1 COMMA_SOURCE_FILE_AT_LINE (87)) ;
    }
    GGS_uint  var_cas_registerAddress ;
    if (var_cas_registerAddressList.isBuilt ()) {
      var_cas_registerAddressList (HERE)->method_first (inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (89)) ;
    }
