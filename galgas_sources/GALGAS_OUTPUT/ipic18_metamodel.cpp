...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_uintlist::cEnumerator enumerator_17442 (mLiteralValues, true) ;
    const GGS_uintlist::cElement * operand_17442 = NULL ;
    while (((operand_17442 = enumerator_17442.nextObject ()))) {
      macroValidPointer (operand_17442) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_17442->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (610))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_18451 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18451 = NULL ;
    while (((operand_18451 = enumerator_18451.nextObject ()))) {
      macroValidPointer (operand_18451) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_18451->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_18798 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18798 = NULL ;
    while (((operand_18798 = enumerator_18798.nextObject ()))) {
      macroValidPointer (operand_18798) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_18798->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (657))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19546 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19546 = NULL ;
    while (((operand_19546 = enumerator_19546.nextObject ()))) {
      macroValidPointer (operand_19546) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_19546->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19894 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19894 = NULL ;
    while (((operand_19894 = enumerator_19894.nextObject ()))) {
      macroValidPointer (operand_19894) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_19894->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (697))) ;
    }
  }
}
