...
void GGS_ipic_registerExpressionWithoutBSRIndication::_drop (void) {
...
bool GGS_ipic_registerExpressionWithoutBSRIndication::_isBuilt (void) const {
...
_operator_isEqual (const GGS_ipic_registerExpressionWithoutBSRIndication & inOperand) const {
...
GGS_bool GGS_ipic_registerExpressionWithoutBSRIndication::
_operator_isNotEqual (const GGS_ipic_registerExpressionWithoutBSRIndication & inOperand) const {
...
category_method__registerExpression__resolveAccess (C_Compiler & _inLexique,
  ...
  if (operand_671 != NULL) {
    ...
    var_cas_assemblyString = operand_671->mRegisterName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
    if (((operand_671->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (32)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.writeString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_671->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (33)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (33))) ;
    }
    ...
    const GGS_registerTable  _temp_1150 = var_cas_inRegisterTable ;
    if (_temp_1150._isBuilt ()) {
      _temp_1150 (HERE)->method_searchKey (_inLexique, operand_671->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (39)) ;
    }
    if (((operand_671->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (41)))._operator_strictSup (var_cas_size)).isBuiltAndTrue ()) {
      operand_671->mOffset.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "this offset is too large: should be lower than "))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (42))) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    }
    ...
    var_cas_found = GGS_bool (true, false) ;
    {
      ...
      while (((operand_1411 = enumerator_1411.nextObject ()))
        ...
        var_cas_found = ((operand_1411->mValue)._operator_strictInf (var_cas_inAccessBankSplitOffset))._operator_or ((operand_1411->mValue)._operator_supOrEqual (GGS_uint (true, 3840U)._add_operation (_inLexique, var_cas_inAccessBankSplitOffset COMMA_SOURCE_FILE_AT_LINE (47)))) ;
    ...
    if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
      ...
      const GGS_uintlist  _temp_1691 = var_cas_registerAddressList ;
      if (_temp_1691._isBuilt ()) {
        _temp_1691 (HERE)->method_first (_inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (53)) ;
      }
      GGS_uint  var_cas_neededBank ;
      var_cas_neededBank = var_cas_registerAddress._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (54)) ;
      if (((var_cas_neededBank)._operator_isNotEqual (var_cas_inCurrentBank)).isBuiltAndTrue ()) {
        GGS_string var_cas_errorMessage ;
        var_cas_errorMessage = (((GGS_string (true, "Accessing the '"))._operator_concat (operand_671->mRegisterName))._operator_concat (GGS_string (true, "' needs the bank selection set to ")))._operator_concat (var_cas_neededBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (56))) ;
        if (((var_cas_inCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          var_cas_errorMessage.writeString (", but current bank selection cannot be known") ;
        }else{
          var_cas_errorMessage.writeString (", but current bank selection is set to ") ;
          var_cas_errorMessage._dotAssign_operation (var_cas_inCurrentBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (60))) ;
        }
        operand_671->mRegisterName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (63)) ;
      }
    }
    var_cas_outIPICregisterDescription = GGS_ipic_registerExpression::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (_inLexique, operand_671->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)) COMMA_SOURCE_FILE_AT_LINE (68)), var_cas_needsBSRaccess) ;
  }
}
...
static void
category_method__registerExpression__resolveAccessWithoutCheckingBank (C_Compiler & _inLexique,
  ...
  if (operand_2509 != NULL) {
    GGS_string var_cas_assemblyString ;
    var_cas_assemblyString = operand_2509->mRegisterName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (80)) ;
    if (((operand_2509->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (81)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.writeString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_2509->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (82)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (82))) ;
    }
    GGS_uintlist  var_cas_registerAddressList ;
    GGS_uint  var_cas_size ;
    GGS_bitSliceTable  automatic_var_1 ;
    GGS_string automatic_var_2 ;
    const GGS_registerTable  _temp_2884 = var_cas_inRegisterTable ;
    if (_temp_2884._isBuilt ()) {
      _temp_2884 (HERE)->method_searchKey (_inLexique, operand_2509->mRegisterName, var_cas_registerAddressList, var_cas_size, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (87)) ;
    }
    GGS_uint  var_cas_registerAddress ;
    const GGS_uintlist  _temp_2990 = var_cas_registerAddressList ;
    if (_temp_2990._isBuilt ()) {
      _temp_2990 (HERE)->method_first (_inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (89)) ;
    }
    if (((operand_2509->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)))._operator_strictSup (var_cas_size)).isBuiltAndTrue ()) {
      operand_2509->mOffset.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "this offset is too large: should be lower than "))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (92))) COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }
    var_cas_outIPICregisterDescription = GGS_ipic_registerExpressionWithoutBSRIndication::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (_inLexique, operand_2509->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97))) ;
  }
}
...
static TC_UniqueArray <typeCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank> gDispatchTableFor__registerExpression__resolveAccessWithoutCheckingBank ;
...
enterCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank (typeCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank inRoutine,
                     const sint32 inClassID) {
  gDispatchTableFor__registerExpression__resolveAccessWithoutCheckingBank.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (inClassPtr->slotID () < gDispatchTableFor__registerExpression__resolveAccessWithoutCheckingBank.count ()) {
    result = gDispatchTableFor__registerExpression__resolveAccessWithoutCheckingBank (inClassPtr->slotID () COMMA_HERE) ;
  }
  if (result == NULL) {
    AC_galgasClassRunTimeInformation * superClassPtr = inClassPtr->superClassPtr () ;
    if (superClassPtr != NULL) {
      result = findCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank (superClassPtr) ;
      gDispatchTableFor__registerExpression__resolveAccessWithoutCheckingBank.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
method_setCurrentAddress (C_Compiler & _inLexique,
  ...
  method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (109)) ;
  var_cas_ioCurrentAddress = var_cas_ioCurrentAddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (110)) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction _result ;
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_ipic18_instruction (inPointer) ;
    }else{
...
AC_galgasClassRunTimeInformation * GGS_ipic18_instruction::_galgasObjectRunTimeInfo (void) const {
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    const elementOf_GGS_ipic18_instructionList * _p = dynamic_cast <const elementOf_GGS_ipic18_instructionList *> (inOperand) ;
...
_operator_concat (const GGS_ipic18_instructionList & inOperand) const {
...
void GGS_ipic18_instructionList::
_dotAssign_operation (const GGS_ipic18_instructionList inOperand) {
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@ipic18_instructionList", inIndentation COMMA_THERE) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOrigin.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (171))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_FDA * _p = dynamic_cast <const cPtr_ipic18_instruction_FDA *> (inOperand) ;
    macroValidPointer (_p) ;
...
method_getBaseCode (C_Compiler & _inLexique,
  ...
  ::routine_getFDAinstructionBaseCode (_inLexique,  mInstruction_FDA_base_code,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (216)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mInstruction_FDA_base_code.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (221))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (221))) ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_FDA _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_FDA (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_FA * _p = dynamic_cast <const cPtr_ipic18_instruction_FA *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getFAinstructionBaseCode (_inLexique,  mFAinstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (273)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mFAinstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (278))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (278))) ;
}
...
method_isSkippingInstruction (C_Compiler & _inLexique,
                                GGS_bool& var_cas_outIsSkipping COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_FAinstructionIsSkippingInstruction (_inLexique,  mFAinstruction,  var_cas_outIsSkipping COMMA_SOURCE_FILE_AT_LINE (283)) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_FA _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_FA (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_MOVFF * _p = dynamic_cast <const cPtr_ipic18_instruction_MOVFF *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mSourceRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (300))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mDestinationRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (300))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_MOVFF _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_MOVFF (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_FBA * _p = dynamic_cast <const cPtr_ipic18_instruction_FBA *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBitOrientedOpBaseCode (_inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (322)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mBitOrientedOp.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (327))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (327))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (327))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_FBA _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_FBA (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_BitTestSkip * _p = dynamic_cast <const cPtr_ipic18_instruction_BitTestSkip *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (354))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (354))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_BitTestSkip _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_BitTestSkip (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_conditionalBranch * _p = dynamic_cast <const cPtr_ipic18_instruction_conditionalBranch *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mConditionalBranch.reader_condition (_inLexique COMMA_SOURCE_FILE_AT_LINE (392))) ;
  var_cas_ioListFileContents.writeString (" ") ;
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (402))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_conditionalBranch _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_conditionalBranch (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (437))) ;
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (468))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_CLRWDT * _p = dynamic_cast <const cPtr_ipic18_instruction_CLRWDT *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_CLRWDT _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_CLRWDT (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_DAW * _p = dynamic_cast <const cPtr_ipic18_instruction_DAW *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_DAW _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_DAW (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_NOP * _p = dynamic_cast <const cPtr_ipic18_instruction_NOP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_NOP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_NOP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_POP * _p = dynamic_cast <const cPtr_ipic18_instruction_POP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_POP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_POP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_PUSH * _p = dynamic_cast <const cPtr_ipic18_instruction_PUSH *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_PUSH _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_PUSH (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_RESET * _p = dynamic_cast <const cPtr_ipic18_instruction_RESET *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_RESET _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_RESET (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_RETURN * _p = dynamic_cast <const cPtr_ipic18_instruction_RETURN *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_RETURN _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_RETURN (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_RETFIE * _p = dynamic_cast <const cPtr_ipic18_instruction_RETFIE *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  if ((mFastReturn).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (" FAST") ;
  }
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_RETFIE _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_RETFIE (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_SLEEP * _p = dynamic_cast <const cPtr_ipic18_instruction_SLEEP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_SLEEP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_SLEEP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_literalOperation * _p = dynamic_cast <const cPtr_ipic18_instruction_literalOperation *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (597)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (602))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (602))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_literalOperation _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_literalOperation (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_LFSR * _p = dynamic_cast <const cPtr_ipic18_instruction_LFSR *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (623)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (623))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (623))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_LFSR _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_LFSR (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_MOVLB * _p = dynamic_cast <const cPtr_ipic18_instruction_MOVLB *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (634)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (634))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_MOVLB _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_MOVLB (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_TBLRD * _p = dynamic_cast <const cPtr_ipic18_instruction_TBLRD *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (645))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_TBLRD _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_TBLRD (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_TBLWT * _p = dynamic_cast <const cPtr_ipic18_instruction_TBLWT *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mOption._operator_isEqual (_p->mOption).boolValue () ;
  }
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (656))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_TBLWT _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_TBLWT (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_MNOP * _p = dynamic_cast <const cPtr_ipic18_instruction_MNOP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (666))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (666)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (671)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (671))) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_MNOP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_MNOP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_computed_retlw * _p = dynamic_cast <const cPtr_ipic18_instruction_computed_retlw *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (683))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (683))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (683)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (685)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  }
  {
    ...
    while (((operand_20521 = enumerator_20521.nextObject ()))) {
      ...
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_20521->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (698))) ;
    }
  }
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_computed_retlw _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_computed_retlw (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_computed_bra * _p = dynamic_cast <const cPtr_ipic18_instruction_computed_bra *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (719))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (719))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (719)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (721)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  }
  {
    ...
    while (((operand_21532 = enumerator_21532.nextObject ()))) {
      ...
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_21532->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    ...
    while (((operand_21879 = enumerator_21879.nextObject ()))) {
      ...
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_21879->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (745))) ;
    }
  }
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_computed_bra _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_computed_bra (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_computed_goto * _p = dynamic_cast <const cPtr_ipic18_instruction_computed_goto *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabels._operator_isEqual (_p->mTargetLabels).boolValue ()
         && mUsesRCALL._operator_isEqual (_p->mUsesRCALL).boolValue () ;
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (758))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (758))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (758)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (760)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  }
  {
    ...
    while (((operand_22629 = enumerator_22629.nextObject ()))) {
      ...
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_22629->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_4")) ;
  {
    ...
    while (((operand_22976 = enumerator_22976.nextObject ()))) {
      ...
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_22976->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (784))) ;
    }
  }
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_computed_goto _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_computed_goto (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic18_instruction_computed_rcall * _p = dynamic_cast <const cPtr_ipic18_instruction_computed_rcall *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabels._operator_isEqual (_p->mTargetLabels).boolValue ()
         && mEndOfInstructionLabel._operator_isEqual (_p->mEndOfInstructionLabel).boolValue ()
         && mUsesRCALL._operator_isEqual (_p->mUsesRCALL).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (798))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (798)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (800)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("COMPUTED RCALL ") ;
  if ((mUsesRCALL).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString ("(uses RCALL)") ;
  }else{
    var_cas_ioListFileContents.writeString ("(uses CALL)") ;
  }
  {
    ...
    while (((operand_23757 = enumerator_23757.nextObject ()))) {
      ...
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_23757->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_4")) ;
  {
    ...
    while (((operand_24104 = enumerator_24104.nextObject ()))) {
      ...
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_24104->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (825))) ;
    }
  }
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@ipic18_instruction_computed_rcall:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mTargetLabels.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mEndOfInstructionLabel.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mUsesRCALL.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic18_instruction_computed_rcall _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_ipic18_instruction_computed_rcall (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mBranchIfZero).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (842)) ;
  }
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (845)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (847)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (853))) ;
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (894))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W ") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (932)) ;
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (939)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (941)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (948))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (949))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
}
