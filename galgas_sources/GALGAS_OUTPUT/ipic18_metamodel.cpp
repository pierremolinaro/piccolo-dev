...
//                    september 10th, 2008, at 20h34'0"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_21160 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_21160 = NULL ;
    while (((operand_21160 = enumerator_21160.nextObject ()))) {
      macroValidPointer (operand_21160) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_21160->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (734))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mBranchIfZero).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (751)) ;
  }
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (754)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (756)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (762))) ;
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (803))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W ") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (841)) ;
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (848)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (850)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (857))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (858))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
}
