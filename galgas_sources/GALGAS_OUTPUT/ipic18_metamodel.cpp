...
category_method__registerExpression__resolveAccess (C_Compiler & inLexique,
  ...
  if (operand_671 != NULL) {
    ...
    if (((operand_671->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (32)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.appendCString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_671->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (33)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (33))) ;
    }
    ...
    if (_temp_1150.isBuilt ()) {
      _temp_1150 (HERE)->method_searchKey (inLexique, operand_671->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (39)) ;
    }
    if (((operand_671->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (41)))._operator_strictSup (var_cas_size)).isBuiltAndTrue ()) {
      operand_671->mOffset.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("this offset is too large: should be lower than "))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (42))) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    }
    ...
    var_cas_found = GGS_bool (false) ;
    {
      ...
      while (((operand_1411 = enumerator_1411.nextObject ()))
        ...
        var_cas_found = ((operand_1411->mValue)._operator_strictInf (var_cas_inAccessBankSplitOffset))._operator_or ((operand_1411->mValue)._operator_supOrEqual (GGS_uint (3840U)._add_operation (inLexique, var_cas_inAccessBankSplitOffset COMMA_SOURCE_FILE_AT_LINE (47)))) ;
    ...
    if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
      ...
      if (_temp_1691.isBuilt ()) {
        _temp_1691 (HERE)->method_first (inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (53)) ;
      }
      GGS_uint  var_cas_neededBank ;
      var_cas_neededBank = var_cas_registerAddress._right_shift_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (54)) ;
      if (((var_cas_neededBank)._operator_isNotEqual (var_cas_inCurrentBank)).isBuiltAndTrue ()) {
        GGS_string var_cas_errorMessage ;
        var_cas_errorMessage = (((GGS_string ("Accessing the '"))._operator_concat (operand_671->mRegisterName))._operator_concat (GGS_string ("' needs the bank selection set to ")))._operator_concat (var_cas_neededBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (56))) ;
        if (((var_cas_inCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          ...
          var_cas_errorMessage._dotAssign_operation (var_cas_inCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (60))) ;
        }
    ...
    var_cas_outIPICregisterDescription = GGS_ipic_registerExpression::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (inLexique, operand_671->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) COMMA_SOURCE_FILE_AT_LINE (68)), var_cas_needsBSRaccess) ;
  }
}
...
category_method__registerExpression__resolveAccessWithoutCheckingBank (C_Compiler & inLexique,
  ...
  if (operand_2509 != NULL) {
    ...
    if (((operand_2509->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (81)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.appendCString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_2509->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (82)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (82))) ;
    }
    GGS_uintlist  var_cas_registerAddressList ;
    GGS_uint  var_cas_size ;
    ...
    if (_temp_2884.isBuilt ()) {
      _temp_2884 (HERE)->method_searchKey (inLexique, operand_2509->mRegisterName, var_cas_registerAddressList, var_cas_size, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (87)) ;
    }
    GGS_uint  var_cas_registerAddress ;
    const GGS_uintlist  _temp_2990 = var_cas_registerAddressList ;
    if (_temp_2990.isBuilt ()) {
      _temp_2990 (HERE)->method_first (inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (89)) ;
    }
    if (((operand_2509->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (91)))._operator_strictSup (var_cas_size)).isBuiltAndTrue ()) {
      operand_2509->mOffset.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("this offset is too large: should be lower than "))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (92))) COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }
    var_cas_outIPICregisterDescription = GGS_ipic_registerExpressionWithoutBSRIndication::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (inLexique, operand_2509->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97))) ;
  }
}
...
method_setCurrentAddress (C_Compiler & inLexique,
  ...
  var_cas_ioCurrentAddress = var_cas_ioCurrentAddress._add_operation (inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (110)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOrigin.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (171))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mInstruction_FDA_base_code._operator_isEqual (ptr->mInstruction_FDA_base_code).boolValue ()
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mInstruction_FDA_base_code.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (221))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (221))) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mFAinstruction._operator_isEqual (ptr->mFAinstruction).boolValue ()
         && mRegisterDescription._operator_isEqual (ptr->mRegisterDescription).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mFAinstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (278))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (278))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mSourceRegisterDescription._operator_isEqual (ptr->mSourceRegisterDescription).boolValue ()
         && mDestinationRegisterDescription._operator_isEqual (ptr->mDestinationRegisterDescription).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mSourceRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (300))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mDestinationRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (300))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mBitOrientedOp.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (327))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (327))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (327))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (354))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (354))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mBranchMode._operator_isEqual (ptr->mBranchMode).boolValue ()
         && mConditionalBranch._operator_isEqual (ptr->mConditionalBranch).boolValue ()
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mConditionalBranch.reader_condition (inLexique COMMA_SOURCE_FILE_AT_LINE (392))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (ptr->mTargetLabel).boolValue ()
         && mKind._operator_isEqual (ptr->mKind).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mFastReturn._operator_isEqual (ptr->mFastReturn).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (602))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (602))) ;
}
...
method_nextInstructionIsReachable (C_Compiler & inLexique,
                                GGS_bool& var_cas_outIsReachable COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outIsReachable = (mLiteralInstruction)._operator_isNotEqual (GGS_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE)) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mFSRindex._operator_isEqual (ptr->mFSRindex).boolValue ()
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mFSRindex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (623)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (623))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (623))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mBankIndex._operator_isEqual (ptr->mBankIndex).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (634)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (634))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mOption._operator_isEqual (ptr->mOption).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (645))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (656))) ;
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (666))._multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (666)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (671)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (671))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mLiteralValues._operator_isEqual (ptr->mLiteralValues).boolValue ()
         && mUsesRCALL._operator_isEqual (ptr->mUsesRCALL).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (683))._multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683))._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (685)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  }
  {
    ...
    while (((operand_20521 = enumerator_20521.nextObject ()))) {
      ...
      var_cas_ioListFileContents.appendCString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_20521->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (698))) ;
    }
  }
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mTargetLabels._operator_isEqual (ptr->mTargetLabels).boolValue ()
         && mUsesRCALL._operator_isEqual (ptr->mUsesRCALL).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (719))._multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (719))._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (719)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (721)) ;
  }
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (758))._multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (758))._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (758)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (760)) ;
  }
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mTargetLabels._operator_isEqual (ptr->mTargetLabels).boolValue ()
         && mEndOfInstructionLabel._operator_isEqual (ptr->mEndOfInstructionLabel).boolValue ()
         && mUsesRCALL._operator_isEqual (ptr->mUsesRCALL).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (798))._multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (798)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (800)) ;
  }
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         ...
         && mUsesBra._operator_isEqual (ptr->mUsesBra).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & inLexique,
  ...
  if ((mBranchIfZero).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (842)) ;
  }
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (845)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (847)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.appendCString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (853))) ;
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (894))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (", W ") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mRegisterDescription._operator_isEqual (ptr->mRegisterDescription).boolValue ()
         && mTargetLabel._operator_isEqual (ptr->mTargetLabel).boolValue ()
         && mComparison._operator_isEqual (ptr->mComparison).boolValue ()
         && mUsesBra._operator_isEqual (ptr->mUsesBra).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & inLexique,
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (939)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (941)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.appendCString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (948))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (949))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
}
