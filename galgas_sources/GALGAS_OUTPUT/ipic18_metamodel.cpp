...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet.addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (402))) ;
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet.addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (437))) ;
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet.addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (468))) ;
}
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_16466 = mFastReturn ;
  if (cond_16466.isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length ().multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683)).add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683)) ;
  const GGS_bool cond_20217 = (mUsesRCALL).operator_not () ;
  if (cond_20217.isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  const GGS_bool cond_20436 = mUsesRCALL ;
  if (cond_20436.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" (uses RCALL)") ;
  }else if (cond_20436.isBuiltAndFalse ()) {
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length ().multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (719)).add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (719)) ;
  const GGS_bool cond_21231 = (mUsesRCALL).operator_not () ;
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_21448 = mUsesRCALL ;
  if (cond_21448.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" (uses RCALL)") ;
  }else if (cond_21448.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString (" (uses CALL)") ;
  }
  {
...
method_enterReferencedLabel (C_Compiler & inLexique,
  ...
  var_cas_ioReferencedLabelSet.addAssign_operation (GGS_string ("_computed_goto_2")) ;
  {
    ...
    while (((operand_21879 = enumerator_21879.nextObject ()))) {
      ...
      var_cas_ioReferencedLabelSet.addAssign_operation (operand_21879->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (745))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length ().multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (758)).add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (758)) ;
  const GGS_bool cond_22327 = (mUsesRCALL).operator_not () ;
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_22545 = mUsesRCALL ;
  if (cond_22545.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" (uses RCALL)") ;
  }else if (cond_22545.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString (" (uses CALL)") ;
  }
  {
...
method_enterReferencedLabel (C_Compiler & inLexique,
  ...
  var_cas_ioReferencedLabelSet.addAssign_operation (GGS_string ("_computed_goto_4")) ;
  {
    ...
    while (((operand_22976 = enumerator_22976.nextObject ()))) {
      ...
      var_cas_ioReferencedLabelSet.addAssign_operation (operand_22976->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (784))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length ().multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (798)) ;
  const GGS_bool cond_23456 = (mUsesRCALL).operator_not () ;
  if (cond_23456.isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_23674 = mUsesRCALL ;
  if (cond_23674.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString ("(uses RCALL)") ;
  }else if (cond_23674.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString ("(uses CALL)") ;
  }
  {
...
method_enterReferencedLabel (C_Compiler & inLexique,
  ...
  var_cas_ioReferencedLabelSet.addAssign_operation (GGS_string ("_computed_goto_4")) ;
  {
    ...
    while (((operand_24104 = enumerator_24104.nextObject ()))) {
      ...
      var_cas_ioReferencedLabelSet.addAssign_operation (operand_24104->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (825))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  const GGS_bool cond_24987 = mBranchIfZero ;
  if (cond_24987.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" Z") ;
  }else if (cond_24987.isBuiltAndFalse ()) {
...
method_instructionLength (C_Compiler & /* inLexique */,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_bool cond_25642 = mUsesBra ;
  if (cond_25642.isBuiltAndTrue ()) {
    var_cas_outLength = GGS_uint (4U) ;
  }else if (cond_25642.isBuiltAndFalse ()) {
    var_cas_outLength = GGS_uint (6U) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.appendCString ("JUMP ") ;
  const GGS_bool cond_25875 = mIncrement ;
  if (cond_25875.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString ("INCF ") ;
  }else if (cond_25875.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_26068 = m_W_isDestination ;
  if (cond_26068.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (", W ") ;
  }
  const GGS_bool cond_26142 = mBranchIfZero ;
  if (cond_26142.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString ("Z") ;
  }else if (cond_26142.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString ("NZ") ;
  }
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mTargetLabel) ;
...
method_instructionLength (C_Compiler & inLexique,
  ...
  const GGS_bool cond_27307 = var_cas_usesIntermediateBRA ;
  if (cond_27307.isBuiltAndTrue ()) {
    var_cas_outLength = GGS_uint (4U) ;
  }else if (cond_27307.isBuiltAndFalse ()) {
    var_cas_outLength = GGS_uint (2U) ;
  }
  const GGS_bool cond_27420 = mUsesBra ;
  ...
  }else if (cond_27420.isBuiltAndFalse ()) {
