...
category_method__registerExpression__resolveAccess (C_Compiler & _inLexique,
                                const cPtr_registerExpression * operand_483,
  ...
  if (operand_483 != NULL) {
    ...
    var_cas_assemblyString = operand_483->mRegisterName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (23)) ;
    if (((operand_483->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (24)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.writeString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_483->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (25)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (25))) ;
    }
    ...
    const GGS_registerTable  _temp_938 = var_cas_inRegisterTable ;
    if (_temp_938._isBuilt ()) {
      _temp_938 (HERE)->method_searchKey (_inLexique, operand_483->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (31)) ;
    }
    GGS_bool var_cas_found ;
    var_cas_found = GGS_bool (true, false) ;
    {
      GGS_uintlist::cEnumerator enumerator_1059 (var_cas_registerAddressList, true) ;
      const GGS_uintlist::cElement * operand_1059 = NULL ;
      while (((operand_1059 = enumerator_1059.nextObject ()))
          && ((var_cas_found)._operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_1059) ;
        var_cas_found = ((operand_1059->mValue)._operator_strictInf (var_cas_inAccessBankSplitOffset))._operator_or ((operand_1059->mValue)._operator_supOrEqual (GGS_uint (true, 3840U)._add_operation (_inLexique, var_cas_inAccessBankSplitOffset COMMA_SOURCE_FILE_AT_LINE (34)))) ;
        var_cas_registerAddress = operand_1059->mValue ;
      }
    }
    ...
    if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
      ...
      const GGS_uintlist  _temp_1339 = var_cas_registerAddressList ;
      if (_temp_1339._isBuilt ()) {
        _temp_1339 (HERE)->method_first (_inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (40)) ;
      }
    }
    var_cas_outIPICregisterDescription = GGS_ipic_registerExpression::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (_inLexique, operand_483->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (45)) COMMA_SOURCE_FILE_AT_LINE (45)), var_cas_needsBSRaccess) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_uintlist::cEnumerator enumerator_18706 (mLiteralValues, true) ;
    const GGS_uintlist::cElement * operand_18706 = NULL ;
    while (((operand_18706 = enumerator_18706.nextObject ()))) {
      macroValidPointer (operand_18706) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_18706->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (647))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19717 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19717 = NULL ;
    while (((operand_19717 = enumerator_19717.nextObject ()))) {
      macroValidPointer (operand_19717) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_19717->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_20064 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_20064 = NULL ;
    while (((operand_20064 = enumerator_20064.nextObject ()))) {
      macroValidPointer (operand_20064) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_20064->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (694))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_20814 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_20814 = NULL ;
    while (((operand_20814 = enumerator_20814.nextObject ()))) {
      macroValidPointer (operand_20814) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_20814->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_21162 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_21162 = NULL ;
    while (((operand_21162 = enumerator_21162.nextObject ()))) {
      macroValidPointer (operand_21162) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_21162->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (734))) ;
    }
  }
}
