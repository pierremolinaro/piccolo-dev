...
category_method__registerExpression__resolveAccess (C_Compiler & _inLexique,
  ...
  if (operand_671 != NULL) {
    ...
    if (((operand_671->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (32)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    if (((operand_671->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (41)))._operator_strictSup (var_cas_size)).isBuiltAndTrue ()) {
      operand_671->mOffset.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("this offset is too large: should be lower than "))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (42))) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    }
    ...
    var_cas_found = GGS_bool (false) ;
    {
      ...
      while (((operand_1411 = enumerator_1411.nextObject ()))
        ...
        var_cas_found = ((operand_1411->mValue)._operator_strictInf (var_cas_inAccessBankSplitOffset))._operator_or ((operand_1411->mValue)._operator_supOrEqual (GGS_uint (3840U)._add_operation (_inLexique, var_cas_inAccessBankSplitOffset COMMA_SOURCE_FILE_AT_LINE (47)))) ;
    ...
    if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
      ...
      if (_temp_1691.isBuilt ()) {
        _temp_1691 (HERE)->method_first (_inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (53)) ;
      }
      GGS_uint  var_cas_neededBank ;
      var_cas_neededBank = var_cas_registerAddress._right_shift_operation (_inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (54)) ;
      if (((var_cas_neededBank)._operator_isNotEqual (var_cas_inCurrentBank)).isBuiltAndTrue ()) {
        GGS_string var_cas_errorMessage ;
        var_cas_errorMessage = (((GGS_string ("Accessing the '"))._operator_concat (operand_671->mRegisterName))._operator_concat (GGS_string ("' needs the bank selection set to ")))._operator_concat (var_cas_neededBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (56))) ;
...
category_method__registerExpression__resolveAccessWithoutCheckingBank (C_Compiler & _inLexique,
  ...
  if (operand_2509 != NULL) {
    ...
    if (((operand_2509->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (81)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.appendCString (" + ") ;
    ...
    if (((operand_2509->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)))._operator_strictSup (var_cas_size)).isBuiltAndTrue ()) {
      operand_2509->mOffset.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("this offset is too large: should be lower than "))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (92))) COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (666))._multiply_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (666)) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (683))._multiply_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683))._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (685)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (719))._multiply_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (719))._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (719)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (721)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (758))._multiply_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (758))._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (758)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (760)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (798))._multiply_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (798)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (800)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mBranchIfZero).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (842)) ;
  }
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (845)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (847)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (939)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (941)) ;
  }
}
