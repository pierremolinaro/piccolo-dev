...
category_method__registerExpression__resolveAccess (C_Compiler & inLexique,
                                const cPtr_registerExpression * operand_706,
  ...
  if (operand_706 != NULL) {
    GGS_string var_cas_assemblyString = operand_706->mRegisterName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (32)) ;
    const GGS_bool cond_1065 = (operand_706->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (33))).operator_strictSup (GGS_uint (0U)) ;
    if (cond_1065.isBuiltAndTrue ()) {
      var_cas_assemblyString.appendCString (" + ") ;
      var_cas_assemblyString.dotAssign_operation (operand_706->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (34)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (34))) ;
    }
    GGS_uintlist  var_cas_registerAddressList ;
    GGS_uint  var_cas_size ;
    GGS_uint  var_cas_registerAddress = GGS_uint (0U) ;
    GGS_string automatic_var_1249_0 ;
    if (var_cas_inRegisterTable.isBuilt ()) {
      var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, operand_706->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_1249_0 COMMA_SOURCE_FILE_AT_LINE (40)) ;
    }
    const GGS_bool cond_1381 = (operand_706->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (42))).operator_strictSup (var_cas_size) ;
    if (cond_1381.isBuiltAndTrue ()) {
      operand_706->mOffset.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("this offset is too large: should be lower than ")).operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (43))) COMMA_SOURCE_FILE_AT_LINE (44)) ;
    }
    GGS_bool var_cas_found = GGS_bool (false) ;
    {
      GGS_uintlist::cEnumerator enumerator_1446 (var_cas_registerAddressList, true) ;
      const GGS_uintlist::cElement * operand_1446 = NULL ;
      while (((operand_1446 = enumerator_1446.nextObject ()))
          && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_1446) ;
        var_cas_found = ((operand_1446->mValue).operator_strictInf (var_cas_inAccessBankSplitOffset)).operator_or ((operand_1446->mValue).operator_supOrEqual (GGS_uint (3840U).add_operation (inLexique, var_cas_inAccessBankSplitOffset COMMA_SOURCE_FILE_AT_LINE (48)))) ;
        var_cas_registerAddress = operand_1446->mValue ;
      }
    }
    GGS_bool var_cas_needsBSRaccess = GGS_bool (false) ;
    const GGS_bool cond_2258 = (var_cas_found).operator_not () ;
    if (cond_2258.isBuiltAndTrue ()) {
      var_cas_needsBSRaccess = GGS_bool (true) ;
      if (var_cas_registerAddressList.isBuilt ()) {
        var_cas_registerAddressList (HERE)->method_first (inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (54)) ;
      }
      GGS_uint  var_cas_neededBank = var_cas_registerAddress.right_shift_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (55)) ;
      const GGS_bool cond_2247 = (var_cas_neededBank).operator_isNotEqual (var_cas_inCurrentBank) ;
      if (cond_2247.isBuiltAndTrue ()) {
        GGS_string var_cas_errorMessage = (((GGS_string ("Accessing the '")).operator_concat (operand_706->mRegisterName)).operator_concat (GGS_string ("' needs the bank selection set to "))).operator_concat (var_cas_neededBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (57))) ;
        const GGS_bool cond_2089 = (var_cas_inCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (58))) ;
        if (cond_2089.isBuiltAndTrue ()) {
          var_cas_errorMessage.appendCString (", but current bank selection cannot be known") ;
        }else if (cond_2089.isBuiltAndFalse ()) {
          var_cas_errorMessage.appendCString (", but current bank selection is set to ") ;
          var_cas_errorMessage.dotAssign_operation (var_cas_inCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (61))) ;
        }
        operand_706->mRegisterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (64)) ;
      }
    }
    var_cas_outIPICregisterDescription = GGS_ipic_registerExpression::constructor_new (var_cas_assemblyString, var_cas_registerAddress.add_operation (inLexique, operand_706->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) COMMA_SOURCE_FILE_AT_LINE (69)), var_cas_needsBSRaccess) ;
  }
}
...
category_method__registerExpression__resolveAccessWithoutCheckingBank (C_Compiler & inLexique,
                                const cPtr_registerExpression * operand_2544,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_ipic_registerExpressionWithoutBSRIndication & var_cas_outIPICregisterDescription
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_2544 != NULL) {
    GGS_string var_cas_assemblyString = operand_2544->mRegisterName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
    const GGS_bool cond_2830 = (operand_2544->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (82))).operator_strictSup (GGS_uint (0U)) ;
    if (cond_2830.isBuiltAndTrue ()) {
      var_cas_assemblyString.appendCString (" + ") ;
      var_cas_assemblyString.dotAssign_operation (operand_2544->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (83)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (83))) ;
    }
    GGS_uintlist  var_cas_registerAddressList ;
    GGS_uint  var_cas_size ;
    GGS_bitSliceTable  automatic_var_2968_0 ;
    GGS_string automatic_var_2968_1 ;
    if (var_cas_inRegisterTable.isBuilt ()) {
      var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, operand_2544->mRegisterName, var_cas_registerAddressList, var_cas_size, automatic_var_2968_0, automatic_var_2968_1 COMMA_SOURCE_FILE_AT_LINE (88)) ;
    }
    GGS_uint  var_cas_registerAddress ;
    if (var_cas_registerAddressList.isBuilt ()) {
      var_cas_registerAddressList (HERE)->method_first (inLexique, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (90)) ;
    }
    const GGS_bool cond_3175 = (operand_2544->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (92))).operator_strictSup (var_cas_size) ;
    if (cond_3175.isBuiltAndTrue ()) {
      operand_2544->mOffset.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("this offset is too large: should be lower than ")).operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93))) COMMA_SOURCE_FILE_AT_LINE (94)) ;
    }
    var_cas_outIPICregisterDescription = GGS_ipic_registerExpressionWithoutBSRIndication::constructor_new (var_cas_assemblyString, var_cas_registerAddress.add_operation (inLexique, operand_2544->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98))) ;
  }
}
...
method_setCurrentAddress (C_Compiler & inLexique,
  ...
  method_instructionLength (inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (110)) ;
  var_cas_ioCurrentAddress = var_cas_ioCurrentAddress.add_operation (inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (111)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mOrigin.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (172))) ;
}
...
method_getBaseCode (C_Compiler & inLexique,
  ...
  ::routine_getFDAinstructionBaseCode (inLexique,  mInstruction_FDA_base_code,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (217)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.dotAssign_operation (mInstruction_FDA_base_code.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (222))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (222))) ;
  const GGS_bool cond_6693 = m_W_isDestination ;
  if (cond_6693.isBuiltAndTrue ()) {
...
void routine_FAinstructionIsSkippingInstruction (C_Compiler &,
                                const GGS_FA_instruction_base_code  var_cas_inInstruction,
                                GGS_bool & var_cas_outIsSkipping
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
...
method_getBaseCode (C_Compiler & inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getFAinstructionBaseCode (inLexique,  mFAinstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (274)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.dotAssign_operation (mFAinstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (279))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (279))) ;
}
...
method_isSkippingInstruction (C_Compiler & inLexique,
                                GGS_bool& var_cas_outIsSkipping COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_FAinstructionIsSkippingInstruction (inLexique,  mFAinstruction,  var_cas_outIsSkipping COMMA_SOURCE_FILE_AT_LINE (284)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mSourceRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (301))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents.dotAssign_operation (mDestinationRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (301))) ;
}
...
method_getBaseCode (C_Compiler & inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBitOrientedOpBaseCode (inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (323)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.dotAssign_operation (mBitOrientedOp.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (328))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (328))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents.dotAssign_operation (mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (328))) ;
}
...
method_getBaseCode (C_Compiler & /* inLexique */,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_bool cond_10371 = mSkipIfSet ;
  if (cond_10371.isBuiltAndTrue ()) {
    var_cas_outBaseCode = GGS_uint (40960U) ;
  }else if (cond_10371.isBuiltAndFalse ()) {
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_bool cond_10582 = mSkipIfSet ;
  if (cond_10582.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString ("BTFSS") ;
  }else if (cond_10582.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString ("BTFSC") ;
  }
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (355))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents.dotAssign_operation (mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mConditionalBranch.reader_condition (inLexique COMMA_SOURCE_FILE_AT_LINE (390))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet.addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (435))) ;
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet.addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (466))) ;
}
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_16442 = mFastReturn ;
...
method_getBaseCode (C_Compiler & inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (595)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.dotAssign_operation (mLiteralInstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (600))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mLiteralValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (600))) ;
}
...
method_nextInstructionIsReachable (C_Compiler & inLexique,
                                GGS_bool& var_cas_outIsReachable COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outIsReachable = (mLiteralInstruction).operator_isNotEqual (GGS_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_SOURCE_FILE_AT_LINE (604))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mFSRindex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (621)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (621))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents.dotAssign_operation (mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (621))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (632)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (632))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mOption.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (643))) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mOption.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (654))) ;
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (664)).multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (664)) ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.dotAssign_operation (mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (669)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (669))) ;
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length ().multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (681)).add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (681)) ;
  const GGS_bool cond_20193 = (mUsesRCALL).operator_not () ;
  if (cond_20193.isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (683)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  const GGS_bool cond_20412 = mUsesRCALL ;
  if (cond_20412.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" (uses RCALL)") ;
  }else if (cond_20412.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString (" (uses CALL)") ;
  }
  {
    GGS_uintlist::cEnumerator enumerator_20497 (mLiteralValues, true) ;
    const GGS_uintlist::cElement * operand_20497 = NULL ;
    while (((operand_20497 = enumerator_20497.nextObject ()))) {
      macroValidPointer (operand_20497) ;
      var_cas_ioListFileContents.appendCString (", ") ;
      var_cas_ioListFileContents.dotAssign_operation (operand_20497->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (696))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length ().multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (717)).add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (717)) ;
  const GGS_bool cond_21207 = (mUsesRCALL).operator_not () ;
  if (cond_21207.isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (719)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_21424 = mUsesRCALL ;
  if (cond_21424.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" (uses RCALL)") ;
  }else if (cond_21424.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString (" (uses CALL)") ;
  }
  {
    GGS_lstringlist::cEnumerator enumerator_21508 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_21508 = NULL ;
    while (((operand_21508 = enumerator_21508.nextObject ()))) {
      macroValidPointer (operand_21508) ;
      var_cas_ioListFileContents.appendCString (", ") ;
      var_cas_ioListFileContents.dotAssign_operation (operand_21508->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
  ...
  var_cas_ioReferencedLabelSet.addAssign_operation (GGS_string ("_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_21855 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_21855 = NULL ;
    while (((operand_21855 = enumerator_21855.nextObject ()))) {
      macroValidPointer (operand_21855) ;
      var_cas_ioReferencedLabelSet.addAssign_operation (operand_21855->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (743))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length ().multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (756)).add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (756)) ;
  const GGS_bool cond_22303 = (mUsesRCALL).operator_not () ;
  if (cond_22303.isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (758)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_22521 = mUsesRCALL ;
  if (cond_22521.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" (uses RCALL)") ;
  }else if (cond_22521.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString (" (uses CALL)") ;
  }
  {
    GGS_lstringlist::cEnumerator enumerator_22605 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_22605 = NULL ;
    while (((operand_22605 = enumerator_22605.nextObject ()))) {
      macroValidPointer (operand_22605) ;
      var_cas_ioListFileContents.appendCString (", ") ;
      var_cas_ioListFileContents.dotAssign_operation (operand_22605->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_22952 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_22952 = NULL ;
    while (((operand_22952 = enumerator_22952.nextObject ()))) {
      macroValidPointer (operand_22952) ;
      var_cas_ioReferencedLabelSet.addAssign_operation (operand_22952->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (782))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length ().multiply_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (796)) ;
  const GGS_bool cond_23432 = (mUsesRCALL).operator_not () ;
  if (cond_23432.isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (798)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_23650 = mUsesRCALL ;
  if (cond_23650.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString ("(uses RCALL)") ;
  }else if (cond_23650.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString ("(uses CALL)") ;
  }
  {
    GGS_lstringlist::cEnumerator enumerator_23733 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_23733 = NULL ;
    while (((operand_23733 = enumerator_23733.nextObject ()))) {
      macroValidPointer (operand_23733) ;
      var_cas_ioListFileContents.appendCString (", ") ;
      var_cas_ioListFileContents.dotAssign_operation (operand_23733->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
  ...
  var_cas_ioReferencedLabelSet.addAssign_operation (GGS_string ("_computed_goto_4")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_24080 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_24080 = NULL ;
    while (((operand_24080 = enumerator_24080.nextObject ()))) {
      macroValidPointer (operand_24080) ;
      var_cas_ioReferencedLabelSet.addAssign_operation (operand_24080->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (823))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (2U) ;
  const GGS_bool cond_24583 = mBranchIfZero ;
  if (cond_24583.isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (840)) ;
  }
  const GGS_bool cond_24665 = mUsesBra ;
  if (cond_24665.isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (843)) ;
  }else if (cond_24665.isBuiltAndFalse ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (845)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.appendCString ("JUMP ") ;
  var_cas_ioListFileContents.dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (851))) ;
  const GGS_bool cond_24963 = mBranchIfZero ;
  if (cond_24963.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (" Z") ;
  }else if (cond_24963.isBuiltAndFalse ()) {
...
method_instructionLength (C_Compiler & /* inLexique */,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_bool cond_25618 = mUsesBra ;
  if (cond_25618.isBuiltAndTrue ()) {
    var_cas_outLength = GGS_uint (4U) ;
  }else if (cond_25618.isBuiltAndFalse ()) {
    var_cas_outLength = GGS_uint (6U) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.appendCString ("JUMP ") ;
  const GGS_bool cond_25851 = mIncrement ;
  if (cond_25851.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString ("INCF ") ;
  }else if (cond_25851.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString ("DECF ") ;
  }
  var_cas_ioListFileContents.dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (892))) ;
  const GGS_bool cond_26044 = m_W_isDestination ;
  if (cond_26044.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (", W ") ;
  }
  const GGS_bool cond_26118 = mBranchIfZero ;
  if (cond_26118.isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString ("Z") ;
  }else if (cond_26118.isBuiltAndFalse ()) {
    var_cas_ioListFileContents.appendCString ("NZ") ;
  }
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mTargetLabel) ;
...
method_instructionLength (C_Compiler & inLexique,
  ...
  method_usesIntermediateBRA (inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (930)) ;
  const GGS_bool cond_27283 = var_cas_usesIntermediateBRA ;
  if (cond_27283.isBuiltAndTrue ()) {
    var_cas_outLength = GGS_uint (4U) ;
  }else if (cond_27283.isBuiltAndFalse ()) {
    var_cas_outLength = GGS_uint (2U) ;
  }
  const GGS_bool cond_27396 = mUsesBra ;
  if (cond_27396.isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (937)) ;
  }else if (cond_27396.isBuiltAndFalse ()) {
    var_cas_outLength = var_cas_outLength.add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (939)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.appendCString ("JUMP ") ;
  var_cas_ioListFileContents.dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (946))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mComparison.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (947))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents.dotAssign_operation (mTargetLabel) ;
}
