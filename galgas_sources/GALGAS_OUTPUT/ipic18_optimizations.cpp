...
//                    september 14th, 2008, at 20h50'39"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & _inLexique,
  ...
  if (operand_13417 != NULL) {
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_ipic18_instruction _var_14197 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)) ; // CAST instruction
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      ::routine_findFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (374)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (374)) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (391)) COMMA_SOURCE_FILE_AT_LINE (391)), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (392)) COMMA_SOURCE_FILE_AT_LINE (390)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (395)) ;
      var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
      ...
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (402)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (402))) ;
...
void routine_performOptimizations (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents.writeString ("\n") ;
  var_cas_ioListFileContents.writeString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (419))) ;
  var_cas_ioListFileContents.writeString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (420))) ;
  var_cas_ioListFileContents.writeString ("\n"
    "\n") ;
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    GGS_ipic18_instructionList::cEnumerator enumerator_16496 (var_cas_ioGeneratedInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_16496 = NULL ;
    while (((operand_16496 = enumerator_16496.nextObject ()))) {
      macroValidPointer (operand_16496) ;
      const GGS_ipic18_instruction  _temp_16539 = operand_16496->mInstruction ;
      if (_temp_16539._isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__defineLabel _method = findCategoryMethod__ipic18_instruction__defineLabel (_temp_16539._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_16539 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (424)) ;
        }
      }
  ...
  GGS_uint _variant_20562 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (429)) ;
  GGS_bool _condition_20562 (_variant_20562._isBuilt (), true) ;
  while (_condition_20562.isBuiltAndTrue ()) {
    _condition_20562 = var_cas_optimizationsDone ;
    if (_condition_20562.isBuiltAndTrue ()) {
      if (_variant_20562.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (501)) ;
        _condition_20562 = GGS_bool (true, false) ;
      }else{
        _variant_20562._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_optimizationsDone = GGS_bool (true, false) ;
        var_cas_iteration._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (433)) ;
        var_cas_ioListFileContents.writeString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (434))) ;
        var_cas_ioListFileContents.writeString (":\n") ;
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic18_instructionList::cEnumerator enumerator_16959 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_16959 = NULL ;
          while (((operand_16959 = enumerator_16959.nextObject ()))) {
            macroValidPointer (operand_16959) ;
            { const GGS_ipic18_instruction _var_18430 = operand_16959->mInstruction ; // CAST instruction
              if (_var_18430.getPtr () != NULL) {
                macroValidPointer (_var_18430.getPtr ()) ;
                if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic_JUMP var_cas_ipic_JUMP (_var_18430.getPtr ()) ;
                  const GGS_ipic_JUMP  _temp_17063 = var_cas_ipic_JUMP ;
                  if (_temp_17063._isBuilt ()) {
                    typeCategoryMethod__ipic_JUMP__optimizeJUMP _method = findCategoryMethod__ipic_JUMP__optimizeJUMP (_temp_17063._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17063 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (439)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_JSR) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic_JSR var_cas_ipic_JSR (_var_18430.getPtr ()) ;
                  const GGS_ipic_JSR  _temp_17220 = var_cas_ipic_JSR ;
                  if (_temp_17220._isBuilt ()) {
                    typeCategoryMethod__ipic_JSR__optimizeJSR _method = findCategoryMethod__ipic_JSR__optimizeJSR (_temp_17220._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17220 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (441)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_literalOperation) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic18_instruction_literalOperation var_cas_ipic_literal (_var_18430.getPtr ()) ;
                  const GGS_ipic18_instruction_literalOperation  _temp_17401 = var_cas_ipic_literal ;
                  if (_temp_17401._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW _method = findCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW (_temp_17401._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17401 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (443)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_conditionalBranch) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic18_instruction_conditionalBranch var_cas_ipic_cc (_var_18430.getPtr ()) ;
                  const GGS_ipic18_instruction_conditionalBranch  _temp_17571 = var_cas_ipic_cc ;
                  if (_temp_17571._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC _method = findCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC (_temp_17571._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17571 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (445)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_jump_test_register) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic_jump_test_register var_cas_ipic_testReg (_var_18430.getPtr ()) ;
                  const GGS_ipic_jump_test_register  _temp_17755 = var_cas_ipic_testReg ;
                  if (_temp_17755._isBuilt ()) {
                    typeCategoryMethod__ipic_jump_test_register__optimizeTestReg _method = findCategoryMethod__ipic_jump_test_register__optimizeTestReg (_temp_17755._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17755 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (447)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_incDecRegisterInCondition) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic_incDecRegisterInCondition var_cas_ipic_decInc (_var_18430.getPtr ()) ;
                  const GGS_ipic_incDecRegisterInCondition  _temp_17947 = var_cas_ipic_decInc ;
                  if (_temp_17947._isBuilt ()) {
                    typeCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc _method = findCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc (_temp_17947._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17947 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (449)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_registerComparisonCondition) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic_registerComparisonCondition var_cas_ipic_CMP (_var_18430.getPtr ()) ;
                  const GGS_ipic_registerComparisonCondition  _temp_18128 = var_cas_ipic_CMP ;
                  if (_temp_18128._isBuilt ()) {
                    typeCategoryMethod__ipic_registerComparisonCondition__optimizeCMP _method = findCategoryMethod__ipic_registerComparisonCondition__optimizeCMP (_temp_18128._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18128 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (451)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_BitTestSkip) == typeid (* (_var_18430.getPtr ()))) {
                  const GGS_ipic18_instruction_BitTestSkip var_cas_ipic_bitTestSkip (_var_18430.getPtr ()) ;
                  const GGS_ipic18_instruction_BitTestSkip  _temp_18331 = var_cas_ipic_bitTestSkip ;
                  if (_temp_18331._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip _method = findCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (_temp_18331._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18331 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (453)) ;
                    }
                  }
                }else{
                }
        ...
        {
          GGS_ipic18_instructionList::cEnumerator enumerator_18575 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_18575 = NULL ;
          while (((operand_18575 = enumerator_18575.nextObject ()))) {
            macroValidPointer (operand_18575) ;
            const GGS_ipic18_instruction  _temp_18619 = operand_18575->mInstruction ;
            if (_temp_18619._isBuilt ()) {
              _temp_18619 (HERE)->method_enterReferencedLabel (_inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (460)) ;
            }
          }
        }
        {
          GGS_symbolTableForOptimizations::cEnumerator enumerator_18683 (var_cas_symbolTable, true) ;
          const GGS_symbolTableForOptimizations::cElement * operand_18683 = NULL ;
          while (((operand_18683 = enumerator_18683.nextObject ()))) {
            macroValidPointer (operand_18683) ;
            if (((var_cas_referencedLabels.reader_hasKey (_inLexique, operand_18683->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (463)) COMMA_SOURCE_FILE_AT_LINE (463)))._operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  _temp_18798 = var_cas_symbolTable ;
              if (_temp_18798._isBuilt ()) {
                _temp_18798 (HERE)->method_searchKey (_inLexique, operand_18683->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (464)) ;
              }
              var_cas_ioListFileContents.writeString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_definitionLine.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (465))) ;
              var_cas_ioListFileContents.writeString (": unreferenced label '") ;
              var_cas_ioListFileContents._dotAssign_operation (operand_18683->mKey) ;
              var_cas_ioListFileContents.writeString ("' is deleted\n") ;
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (466)) ;
              GGS_uint  automatic_var_2 ;
              var_cas_symbolTable.modifier_removeKey (_inLexique, operand_18683->mKey, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (467)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic18_instructionList::cEnumerator enumerator_19309 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_19309 = NULL ;
          while (((operand_19309 = enumerator_19309.nextObject ()))) {
            macroValidPointer (operand_19309) ;
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_ipic18_instruction  _temp_19425 = operand_19309->mInstruction ;
              if (_temp_19425._isBuilt ()) {
                _temp_19425 (HERE)->method_nextInstructionIsReachable (_inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (476)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_ipic18_instruction  _temp_19549 = operand_19309->mInstruction ;
              if (_temp_19549._isBuilt ()) {
                _temp_19549 (HERE)->method_isSkippingInstruction (_inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (478)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_ipic18_instruction  _temp_19642 = operand_19309->mInstruction ;
              if (_temp_19642._isBuilt ()) {
                _temp_19642 (HERE)->method_isLABELorORG (_inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (480)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_ipic18_instruction  _temp_19704 = operand_19309->mInstruction ;
              if (_temp_19704._isBuilt ()) {
                _temp_19704 (HERE)->method_isNULL (_inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (481)) ;
              }
              if ((((var_cas_isLABELorORG)._operator_not ())._operator_and ((var_cas_isNULL)._operator_not ())).isBuiltAndTrue ()) {
                var_cas_ioListFileContents.writeString ("  line ") ;
                var_cas_ioListFileContents._dotAssign_operation (var_cas_idx.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (483))) ;
                var_cas_ioListFileContents.writeString (": unreachable instruction is deleted\n") ;
                var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_idx COMMA_SOURCE_FILE_AT_LINE (484)) ;
        ...
        if (((var_cas_optimizationsDone)._operator_not ()).isBuiltAndTrue ()) {
          ...
          {
            GGS_ipic18_instructionList::cEnumerator enumerator_20360 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_ipic18_instructionList::cElement * operand_20360 = NULL ;
            while (((operand_20360 = enumerator_20360.nextObject ()))) {
              macroValidPointer (operand_20360) ;
              const GGS_ipic18_instruction  _temp_20403 = operand_20360->mInstruction ;
              if (_temp_20403._isBuilt ()) {
                _temp_20403 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (497)) ;
              }
            }
          }
          var_cas_ioListFileContents.writeString ("Minimum code size: ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (499))) ;
