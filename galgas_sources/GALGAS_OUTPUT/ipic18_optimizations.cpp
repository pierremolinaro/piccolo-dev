...
void routine_performOptimizations (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (482))) ;
  var_cas_ioListFileContents.writeString ("\n") ;
  var_cas_ioListFileContents.writeString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (483))) ;
  var_cas_ioListFileContents.writeString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (484))) ;
  var_cas_ioListFileContents.writeString ("\n"
    "\n") ;
  ...
  GGS_uint _variant_23101 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (493)) ;
  GGS_bool _condition_23101 (_variant_23101._isBuilt (), true) ;
  while (_condition_23101.isBuiltAndTrue ()) {
    _condition_23101 = var_cas_optimizationsDone ;
    if (_condition_23101.isBuiltAndTrue ()) {
      if (_variant_23101.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (567)) ;
        _condition_23101 = GGS_bool (true, false) ;
      }else{
        _variant_23101._decrement_operation (_inLexique COMMA_HERE) ;
