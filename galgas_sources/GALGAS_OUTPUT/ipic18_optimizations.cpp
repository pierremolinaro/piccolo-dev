      ...
      { const GGS_ipic18_instruction _var_5556 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5556.getPtr () != NULL) {
          ...
          if (typeid (cPtr_ipic18_instruction_RETURN) == typeid (* (_var_5556.getPtr ()))) {
            ...
            const GGS_bool cond_5095 = (var_cas_literalOp.reader_mLiteralInstruction (inLexique COMMA_SOURCE_FILE_AT_LINE (119))).operator_isEqual (GGS_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE)) ;
...
category_method__ipic18_instruction_literalOperation__optimizeMOVLW (C_Compiler & inLexique,
  ...
  if (operand_6601 != NULL) {
    const GGS_bool cond_7510 = (operand_6601->mLiteralInstruction).operator_isEqual (GGS_literal_instruction_opcode::constructor_MOVLW (inLexique COMMA_HERE)) ;
...
category_method__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & inLexique,
  ...
  if (operand_13416 != NULL) {
    ...
    if (cond_14524.isBuiltAndTrue ()) {
      GGS_ipic18_instruction  var_cas_thirdInstruction = GGS_ipic_NULL ::constructor_new (inLexique COMMA_HERE) ;
      GGS_stringset  var_cas_reachedLabelSet ;
...
void routine_performOptimizations (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  GGS_symbolTableForOptimizations  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
