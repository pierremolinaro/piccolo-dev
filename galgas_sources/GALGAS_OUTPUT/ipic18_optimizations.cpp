...
category_method__ipic18_instruction__defineLabel (C_Compiler &,
                                const cPtr_ipic18_instruction * operand_939,
...
category_method__ipic_pseudo_LABEL__defineLabel (C_Compiler & _inLexique,
                                const cPtr_ipic_pseudo_LABEL * operand_1172,
                                GGS_symbolTableForOptimizations  & var_cas_ioRoutineSymbolTable,
                                const GGS_uint   var_cas_inLineIndex
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_1172 != NULL) {
    var_cas_ioRoutineSymbolTable.modifier_insertKey (_inLexique, operand_1172->mLabel, var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (33)) ;
  }
}
...
void routine_findFirstInstructionFromAddress (C_Compiler & _inLexique,
  ...
  GGS_uint _variant_2120 = var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (48)) ;
  GGS_bool _condition_2120 (_variant_2120._isBuilt (), true) ;
  while (_condition_2120.isBuiltAndTrue ()) {
    _condition_2120 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (49))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_2120.isBuiltAndTrue ()) {
      if (_variant_2120.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (58)) ;
        _condition_2120 = GGS_bool (true, false) ;
      }else{
        _variant_2120._decrement_operation (_inLexique COMMA_HERE) ;
        { const GGS_ipic18_instruction _var_2107 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (51)) ; // CAST instruction
          if (_var_2107.getPtr () != NULL) {
            macroValidPointer (_var_2107.getPtr ()) ;
            if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_2107.getPtr ()) != NULL) {
              const GGS_ipic_actualInstruction var_cas_instr (_var_2107.getPtr ()) ;
...
void routine_findFirstInstructionOrLabelFromAddress (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_found ;
  var_cas_found = GGS_bool (true, false) ;
  GGS_uint _variant_3184 = var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (75)) ;
  GGS_bool _condition_3184 (_variant_3184._isBuilt (), true) ;
  while (_condition_3184.isBuiltAndTrue ()) {
    _condition_3184 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (76))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_3184.isBuiltAndTrue ()) {
      if (_variant_3184.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (89)) ;
        _condition_3184 = GGS_bool (true, false) ;
      }else{
        _variant_3184._decrement_operation (_inLexique COMMA_HERE) ;
        { const GGS_ipic18_instruction _var_3171 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (78)) ; // CAST instruction
          if (_var_3171.getPtr () != NULL) {
            macroValidPointer (_var_3171.getPtr ()) ;
            if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_3171.getPtr ()) != NULL) {
              const GGS_ipic_actualInstruction var_cas_instr (_var_3171.getPtr ()) ;
              var_cas_outFirstInstruction = var_cas_instr ;
              var_cas_found = GGS_bool (true, true) ;
            }else if (typeid (cPtr_ipic_pseudo_LABEL) == typeid (* (_var_3171.getPtr ()))) {
              const GGS_ipic_pseudo_LABEL var_cas_instr (_var_3171.getPtr ()) ;
              var_cas_outFirstInstruction = var_cas_instr ;
...
category_method__ipic_JUMP__optimizeJUMP (C_Compiler & _inLexique,
                                const cPtr_ipic_JUMP * operand_3633,
  ...
  if (operand_3633 != NULL) {
    ...
    if ((var_cas_reachedLabelSet.reader_hasKey (_inLexique, operand_3633->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109))).isBuiltAndTrue ()) {
      ...
      const GGS_symbolTableForOptimizations  _temp_4407 = var_cas_inSymbolTable ;
      if (_temp_4407._isBuilt ()) {
        _temp_4407 (HERE)->method_searchKey (_inLexique, operand_3633->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (114)) ;
      }
      ...
      { const GGS_ipic18_instruction _var_5920 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5920.getPtr () != NULL) {
          macroValidPointer (_var_5920.getPtr ()) ;
          if (typeid (cPtr_ipic18_instruction_RETURN) == typeid (* (_var_5920.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, operand_3633->mInstructionLocation COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (121)) ;
          ...
          }else if (typeid (cPtr_ipic18_instruction_literalOperation) == typeid (* (_var_5920.getPtr ()))) {
            const GGS_ipic18_instruction_literalOperation var_cas_literalOp (_var_5920.getPtr ()) ;
          ...
          }else if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_5920.getPtr ()))) {
            const GGS_ipic_JUMP var_cas_jump (_var_5920.getPtr ()) ;
            if (((operand_3633->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_JUMP ::constructor_new (_inLexique, operand_3633->mInstructionLocation, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (139)), operand_3633->mKind COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (138)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic_JSR__optimizeJSR (C_Compiler & _inLexique,
                                const cPtr_ipic_JSR * operand_6067,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic18_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6067 != NULL) {
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic18_instruction _var_6806 = var_cas_firstInstruction ; // CAST instruction
      if (_var_6806.getPtr () != NULL) {
        macroValidPointer (_var_6806.getPtr ()) ;
        if (typeid (cPtr_ipic18_instruction_RETURN) == typeid (* (_var_6806.getPtr ()))) {
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_JUMP ::constructor_new (_inLexique, operand_6067->mInstructionLocation, operand_6067->mTargetLabel, operand_6067->mKind COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (164)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic18_instruction_literalOperation__optimizeMOVLW (C_Compiler & _inLexique,
                                const cPtr_ipic18_instruction_literalOperation * operand_6965,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic18_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6965 != NULL) {
    if (((operand_6965->mLiteralInstruction)._operator_isEqual (GGS_literal_instruction_opcode::constructor_MOVLW (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_ipic18_instruction  var_cas_firstInstruction ;
      ...
      { const GGS_ipic18_instruction _var_7861 = var_cas_firstInstruction ; // CAST instruction
        if (_var_7861.getPtr () != NULL) {
          macroValidPointer (_var_7861.getPtr ()) ;
          if (typeid (cPtr_ipic18_instruction_RETURN) == typeid (* (_var_7861.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic18_instruction_literalOperation ::constructor_new (_inLexique, operand_6965->mInstructionLocation, GGS_literal_instruction_opcode::constructor_RETLW (_inLexique COMMA_HERE), operand_6965->mLiteralValue COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (189)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic18_instruction_conditionalBranch__optimizeBCC (C_Compiler & _inLexique,
                                const cPtr_ipic18_instruction_conditionalBranch * operand_8030,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic18_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
  ...
  if (operand_8030 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_8301 = var_cas_inSymbolTable ;
    if (_temp_8301._isBuilt ()) {
      _temp_8301 (HERE)->method_searchKey (_inLexique, operand_8030->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (210)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic18_instruction _var_9117 = var_cas_firstInstruction ; // CAST instruction
      if (_var_9117.getPtr () != NULL) {
        macroValidPointer (_var_9117.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_9117.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_9117.getPtr ()) ;
          if (((operand_8030->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)))._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)))).isBuiltAndTrue ()) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic18_instruction_conditionalBranch ::constructor_new (_inLexique, operand_8030->mInstructionLocation, operand_8030->mBranchMode, operand_8030->mConditionalBranch, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (218)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            ...
            var_cas_ioListFileContents._dotAssign_operation (operand_8030->mConditionalBranch.reader_condition (_inLexique COMMA_SOURCE_FILE_AT_LINE (223))) ;
...
category_method__ipic_jump_test_register__optimizeTestReg (C_Compiler & _inLexique,
                                const cPtr_ipic_jump_test_register * operand_9266,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic18_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9266 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_9537 = var_cas_inSymbolTable ;
    if (_temp_9537._isBuilt ()) {
      _temp_9537 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_9266->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (239)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic18_instruction _var_10539 = var_cas_firstInstruction ; // CAST instruction
      if (_var_10539.getPtr () != NULL) {
        macroValidPointer (_var_10539.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_10539.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_10539.getPtr ()) ;
          if (((operand_9266->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)))).isBuiltAndTrue ()) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_jump_test_register ::constructor_new (_inLexique, operand_9266->mInstructionLocation, operand_9266->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)), operand_9266->mBranchIfZero, operand_9266->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (247)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            ...
            var_cas_ioListFileContents.writeString (": label of JUMP ") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_9266->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (252))) ;
            if ((operand_9266->mBranchIfZero).isBuiltAndTrue ()) {
...
category_method__ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & _inLexique,
                                const cPtr_ipic_incDecRegisterInCondition * operand_10698,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic18_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10698 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_10969 = var_cas_inSymbolTable ;
    if (_temp_10969._isBuilt ()) {
      _temp_10969 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10698->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (274)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic18_instruction _var_12236 = var_cas_firstInstruction ; // CAST instruction
      if (_var_12236.getPtr () != NULL) {
        macroValidPointer (_var_12236.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_12236.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_12236.getPtr ()) ;
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_incDecRegisterInCondition ::constructor_new (_inLexique, operand_10698->mInstructionLocation, operand_10698->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)), operand_10698->mIncrement, operand_10698->m_W_isDestination, operand_10698->mBranchIfZero, operand_10698->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (281)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
          ...
          if ((operand_10698->mIncrement).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString ("INCF ") ;
          }else{
            var_cas_ioListFileContents.writeString ("DECF ") ;
          }
          var_cas_ioListFileContents._dotAssign_operation (operand_10698->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (301))) ;
          if ((operand_10698->m_W_isDestination).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString (", W ") ;
          }
          if ((operand_10698->mBranchIfZero).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString ("Z") ;
          }else{
            var_cas_ioListFileContents.writeString ("NZ") ;
          }
...
category_method__ipic_registerComparisonCondition__optimizeCMP (C_Compiler & _inLexique,
                                const cPtr_ipic_registerComparisonCondition * operand_12390,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic18_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
  ...
  if (operand_12390 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_12661 = var_cas_inSymbolTable ;
    if (_temp_12661._isBuilt ()) {
      _temp_12661 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_12390->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (325)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic18_instruction _var_13620 = var_cas_firstInstruction ; // CAST instruction
      if (_var_13620.getPtr () != NULL) {
        macroValidPointer (_var_13620.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_13620.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_13620.getPtr ()) ;
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_registerComparisonCondition ::constructor_new (_inLexique, operand_12390->mInstructionLocation, operand_12390->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)), operand_12390->mComparison, operand_12390->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (332)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
          ...
          var_cas_ioListFileContents.writeString (": label of ") ;
          var_cas_ioListFileContents.writeString ("JUMP ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12390->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (345))) ;
          var_cas_ioListFileContents.writeString (" ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12390->mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (346))) ;
          var_cas_ioListFileContents.writeString (" branching to JUMP replaced by second JUMP label\n") ;
        }else{
        }
      }
...
category_method__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & _inLexique,
                                const cPtr_ipic18_instruction_BitTestSkip * operand_13780,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic18_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13780 != NULL) {
    GGS_string var_cas_jumpLabel ;
    var_cas_jumpLabel = GGS_string (true, "") ;
    GGS_bool var_cas_ok ;
    var_cas_ok = GGS_bool (true, false) ;
    { const GGS_ipic18_instruction _var_14213 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ; // CAST instruction
      if (_var_14213.getPtr () != NULL) {
        macroValidPointer (_var_14213.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_14213.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_14213.getPtr ()) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_ipic18_instruction _var_14426 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)) ; // CAST instruction
        if (_var_14426.getPtr () != NULL) {
          macroValidPointer (_var_14426.getPtr ()) ;
          if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_14426.getPtr ()) != NULL) {
          }else{
            var_cas_ok = GGS_bool (true, false) ;
          }
        }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic18_instruction_BitTestSkip ::constructor_new (_inLexique, operand_13780->mInstructionLocation, (operand_13780->mSkipIfSet)._operator_not (), operand_13780->mRegisterDescription, operand_13780->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (387)) ;
...
void routine_performOptimizations (C_Compiler & _inLexique,
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    GGS_ipic18_instructionList::cEnumerator enumerator_16725 (var_cas_ioGeneratedInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_16725 = NULL ;
    while (((operand_16725 = enumerator_16725.nextObject ()))) {
      macroValidPointer (operand_16725) ;
      const GGS_ipic18_instruction  _temp_16768 = operand_16725->mInstruction ;
      if (_temp_16768._isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__defineLabel _method = findCategoryMethod__ipic18_instruction__defineLabel (_temp_16768._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_16768 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (431)) ;
        }
      }
  ...
  GGS_uint _variant_20784 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (436)) ;
  GGS_bool _condition_20784 (_variant_20784._isBuilt (), true) ;
  while (_condition_20784.isBuiltAndTrue ()) {
    _condition_20784 = var_cas_optimizationsDone ;
    if (_condition_20784.isBuiltAndTrue ()) {
      if (_variant_20784.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (508)) ;
        _condition_20784 = GGS_bool (true, false) ;
      }else{
        _variant_20784._decrement_operation (_inLexique COMMA_HERE) ;
        ...
        var_cas_ioListFileContents.writeString (":\n") ;
        {
          ...
          GGS_ipic18_instructionList::cEnumerator enumerator_17188 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_17188 = NULL ;
          while (((operand_17188 = enumerator_17188.nextObject ()))) {
            macroValidPointer (operand_17188) ;
            { const GGS_ipic18_instruction _var_18659 = operand_17188->mInstruction ; // CAST instruction
              if (_var_18659.getPtr () != NULL) {
                macroValidPointer (_var_18659.getPtr ()) ;
                if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic_JUMP var_cas_ipic_JUMP (_var_18659.getPtr ()) ;
                  const GGS_ipic_JUMP  _temp_17292 = var_cas_ipic_JUMP ;
                  if (_temp_17292._isBuilt ()) {
                    typeCategoryMethod__ipic_JUMP__optimizeJUMP _method = findCategoryMethod__ipic_JUMP__optimizeJUMP (_temp_17292._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17292 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (446)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_JSR) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic_JSR var_cas_ipic_JSR (_var_18659.getPtr ()) ;
                  const GGS_ipic_JSR  _temp_17449 = var_cas_ipic_JSR ;
                  if (_temp_17449._isBuilt ()) {
                    typeCategoryMethod__ipic_JSR__optimizeJSR _method = findCategoryMethod__ipic_JSR__optimizeJSR (_temp_17449._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17449 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (448)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_literalOperation) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic18_instruction_literalOperation var_cas_ipic_literal (_var_18659.getPtr ()) ;
                  const GGS_ipic18_instruction_literalOperation  _temp_17630 = var_cas_ipic_literal ;
                  if (_temp_17630._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW _method = findCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW (_temp_17630._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17630 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (450)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_conditionalBranch) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic18_instruction_conditionalBranch var_cas_ipic_cc (_var_18659.getPtr ()) ;
                  const GGS_ipic18_instruction_conditionalBranch  _temp_17800 = var_cas_ipic_cc ;
                  if (_temp_17800._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC _method = findCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC (_temp_17800._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17800 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (452)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_jump_test_register) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic_jump_test_register var_cas_ipic_testReg (_var_18659.getPtr ()) ;
                  const GGS_ipic_jump_test_register  _temp_17984 = var_cas_ipic_testReg ;
                  if (_temp_17984._isBuilt ()) {
                    typeCategoryMethod__ipic_jump_test_register__optimizeTestReg _method = findCategoryMethod__ipic_jump_test_register__optimizeTestReg (_temp_17984._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17984 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (454)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_incDecRegisterInCondition) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic_incDecRegisterInCondition var_cas_ipic_decInc (_var_18659.getPtr ()) ;
                  const GGS_ipic_incDecRegisterInCondition  _temp_18176 = var_cas_ipic_decInc ;
                  if (_temp_18176._isBuilt ()) {
                    typeCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc _method = findCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc (_temp_18176._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18176 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (456)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_registerComparisonCondition) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic_registerComparisonCondition var_cas_ipic_CMP (_var_18659.getPtr ()) ;
                  const GGS_ipic_registerComparisonCondition  _temp_18357 = var_cas_ipic_CMP ;
                  if (_temp_18357._isBuilt ()) {
                    typeCategoryMethod__ipic_registerComparisonCondition__optimizeCMP _method = findCategoryMethod__ipic_registerComparisonCondition__optimizeCMP (_temp_18357._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18357 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (458)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_BitTestSkip) == typeid (* (_var_18659.getPtr ()))) {
                  const GGS_ipic18_instruction_BitTestSkip var_cas_ipic_bitTestSkip (_var_18659.getPtr ()) ;
                  const GGS_ipic18_instruction_BitTestSkip  _temp_18560 = var_cas_ipic_bitTestSkip ;
                  if (_temp_18560._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip _method = findCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (_temp_18560._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18560 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (460)) ;
                    }
                  }
                }else{
                }
        ...
        {
          GGS_ipic18_instructionList::cEnumerator enumerator_18804 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_18804 = NULL ;
          while (((operand_18804 = enumerator_18804.nextObject ()))) {
            macroValidPointer (operand_18804) ;
            const GGS_ipic18_instruction  _temp_18848 = operand_18804->mInstruction ;
            if (_temp_18848._isBuilt ()) {
              _temp_18848 (HERE)->method_enterReferencedLabel (_inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (467)) ;
            }
          }
        }
        {
          GGS_symbolTableForOptimizations::cEnumerator enumerator_18912 (var_cas_symbolTable, true) ;
          const GGS_symbolTableForOptimizations::cElement * operand_18912 = NULL ;
          while (((operand_18912 = enumerator_18912.nextObject ()))) {
            macroValidPointer (operand_18912) ;
            if (((var_cas_referencedLabels.reader_hasKey (_inLexique, operand_18912->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470)))._operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  _temp_19027 = var_cas_symbolTable ;
              if (_temp_19027._isBuilt ()) {
                _temp_19027 (HERE)->method_searchKey (_inLexique, operand_18912->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (471)) ;
              }
              var_cas_ioListFileContents.writeString ("  line ") ;
              ...
              var_cas_ioListFileContents._dotAssign_operation (operand_18912->mKey) ;
              ...
              var_cas_symbolTable.modifier_removeKey (_inLexique, operand_18912->mKey, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (474)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic18_instructionList::cEnumerator enumerator_19538 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_19538 = NULL ;
          while (((operand_19538 = enumerator_19538.nextObject ()))) {
            ...
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_ipic18_instruction  _temp_19654 = operand_19538->mInstruction ;
              if (_temp_19654._isBuilt ()) {
                _temp_19654 (HERE)->method_nextInstructionIsReachable (_inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (483)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_ipic18_instruction  _temp_19778 = operand_19538->mInstruction ;
              if (_temp_19778._isBuilt ()) {
                _temp_19778 (HERE)->method_isSkippingInstruction (_inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (485)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_ipic18_instruction  _temp_19871 = operand_19538->mInstruction ;
              if (_temp_19871._isBuilt ()) {
                _temp_19871 (HERE)->method_isLABELorORG (_inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (487)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_ipic18_instruction  _temp_19933 = operand_19538->mInstruction ;
              if (_temp_19933._isBuilt ()) {
                _temp_19933 (HERE)->method_isNULL (_inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (488)) ;
              }
        ...
        if (((var_cas_optimizationsDone)._operator_not ()).isBuiltAndTrue ()) {
          ...
          {
            GGS_ipic18_instructionList::cEnumerator enumerator_20589 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_ipic18_instructionList::cElement * operand_20589 = NULL ;
            while (((operand_20589 = enumerator_20589.nextObject ()))) {
              macroValidPointer (operand_20589) ;
              const GGS_ipic18_instruction  _temp_20632 = operand_20589->mInstruction ;
              if (_temp_20632._isBuilt ()) {
                _temp_20632 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (504)) ;
              }
            }
          }
