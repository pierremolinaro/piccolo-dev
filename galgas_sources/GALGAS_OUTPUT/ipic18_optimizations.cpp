...
void routine_findFirstInstructionFromAddress (C_Compiler & _inLexique,
  ...
  GGS_bool _condition_1757 (_variant_1757._isBuilt (), true) ;
  while (_condition_1757.isBuiltAndTrue ()) {
    ...
    if (_condition_1757.isBuiltAndTrue ()) {
      if (_variant_1757.uintValue () == 0) {
        ...
        _condition_1757 = GGS_bool (true, false) ;
      }else{
...
void routine_findFirstInstructionOrLabelFromAddress (C_Compiler & _inLexique,
  ...
  GGS_bool _condition_2821 (_variant_2821._isBuilt (), true) ;
  while (_condition_2821.isBuiltAndTrue ()) {
    ...
    if (_condition_2821.isBuiltAndTrue ()) {
      if (_variant_2821.uintValue () == 0) {
        ...
        _condition_2821 = GGS_bool (true, false) ;
      }else{
...
category_method__ipic_jump_test_register__optimizeTestReg (C_Compiler & _inLexique,
  ...
  if (operand_8903 != NULL) {
    ...
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (233)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (233)) ;
...
category_method__ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & _inLexique,
  ...
  if (operand_10335 != NULL) {
    ...
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (268)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (268)) ;
...
category_method__ipic_registerComparisonCondition__optimizeCMP (C_Compiler & _inLexique,
  ...
  if (operand_12027 != NULL) {
    ...
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (319)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (319)) ;
...
category_method__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & _inLexique,
  ...
  if (operand_13417 != NULL) {
    ...
    { const GGS_ipic18_instruction _var_13850 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)) ; // CAST instruction
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_ipic18_instruction _var_14063 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)) ; // CAST instruction
        if (_var_14063.getPtr () != NULL) {
          macroValidPointer (_var_14063.getPtr ()) ;
          if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_14063.getPtr ()) != NULL) {
          }else{
            var_cas_ok = GGS_bool (true, false) ;
          }
        }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      ::routine_findFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (372)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (372)) ;
      var_cas_ok = var_cas_reachedLabelSet.reader_hasKey (_inLexique, var_cas_jumpLabel COMMA_SOURCE_FILE_AT_LINE (373)) ;
    }
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic18_instruction_BitTestSkip ::constructor_new (_inLexique, operand_13417->mInstructionLocation, (operand_13417->mSkipIfSet)._operator_not (), operand_13417->mRegisterDescription, operand_13417->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (378)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (389)) COMMA_SOURCE_FILE_AT_LINE (389)), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (390)) COMMA_SOURCE_FILE_AT_LINE (388)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (395)) COMMA_SOURCE_FILE_AT_LINE (393)) ;
      var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
      var_cas_ioListFileContents.writeString ("  lines ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (400))) ;
      var_cas_ioListFileContents.writeString (" to ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (400)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (400))) ;
...
void routine_performOptimizations (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (416))) ;
  var_cas_ioListFileContents.writeString ("\n") ;
  var_cas_ioListFileContents.writeString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (417))) ;
  var_cas_ioListFileContents.writeString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (418))) ;
  var_cas_ioListFileContents.writeString ("\n"
    "\n") ;
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    GGS_ipic18_instructionList::cEnumerator enumerator_16362 (var_cas_ioGeneratedInstructionList, true) ;
    const GGS_ipic18_instructionList::cElement * operand_16362 = NULL ;
    while (((operand_16362 = enumerator_16362.nextObject ()))) {
      macroValidPointer (operand_16362) ;
      const GGS_ipic18_instruction  _temp_16405 = operand_16362->mInstruction ;
      if (_temp_16405._isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__defineLabel _method = findCategoryMethod__ipic18_instruction__defineLabel (_temp_16405._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_16405 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (422)) ;
        }
      }
  ...
  GGS_uint _variant_20428 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (427)) ;
  GGS_bool _condition_20428 (_variant_20428._isBuilt (), true) ;
  while (_condition_20428.isBuiltAndTrue ()) {
    _condition_20428 = var_cas_optimizationsDone ;
    if (_condition_20428.isBuiltAndTrue ()) {
      if (_variant_20428.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (499)) ;
        _condition_20428 = GGS_bool (true, false) ;
      }else{
        _variant_20428._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_optimizationsDone = GGS_bool (true, false) ;
        var_cas_iteration._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (431)) ;
        var_cas_ioListFileContents.writeString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (432))) ;
        var_cas_ioListFileContents.writeString (":\n") ;
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic18_instructionList::cEnumerator enumerator_16825 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_16825 = NULL ;
          while (((operand_16825 = enumerator_16825.nextObject ()))) {
            macroValidPointer (operand_16825) ;
            { const GGS_ipic18_instruction _var_18296 = operand_16825->mInstruction ; // CAST instruction
              if (_var_18296.getPtr () != NULL) {
                macroValidPointer (_var_18296.getPtr ()) ;
                if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic_JUMP var_cas_ipic_JUMP (_var_18296.getPtr ()) ;
                  const GGS_ipic_JUMP  _temp_16929 = var_cas_ipic_JUMP ;
                  if (_temp_16929._isBuilt ()) {
                    typeCategoryMethod__ipic_JUMP__optimizeJUMP _method = findCategoryMethod__ipic_JUMP__optimizeJUMP (_temp_16929._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_16929 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (437)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_JSR) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic_JSR var_cas_ipic_JSR (_var_18296.getPtr ()) ;
                  const GGS_ipic_JSR  _temp_17086 = var_cas_ipic_JSR ;
                  if (_temp_17086._isBuilt ()) {
                    typeCategoryMethod__ipic_JSR__optimizeJSR _method = findCategoryMethod__ipic_JSR__optimizeJSR (_temp_17086._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17086 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (439)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_literalOperation) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic18_instruction_literalOperation var_cas_ipic_literal (_var_18296.getPtr ()) ;
                  const GGS_ipic18_instruction_literalOperation  _temp_17267 = var_cas_ipic_literal ;
                  if (_temp_17267._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW _method = findCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW (_temp_17267._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17267 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (441)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_conditionalBranch) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic18_instruction_conditionalBranch var_cas_ipic_cc (_var_18296.getPtr ()) ;
                  const GGS_ipic18_instruction_conditionalBranch  _temp_17437 = var_cas_ipic_cc ;
                  if (_temp_17437._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC _method = findCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC (_temp_17437._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17437 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (443)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_jump_test_register) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic_jump_test_register var_cas_ipic_testReg (_var_18296.getPtr ()) ;
                  const GGS_ipic_jump_test_register  _temp_17621 = var_cas_ipic_testReg ;
                  if (_temp_17621._isBuilt ()) {
                    typeCategoryMethod__ipic_jump_test_register__optimizeTestReg _method = findCategoryMethod__ipic_jump_test_register__optimizeTestReg (_temp_17621._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17621 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (445)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_incDecRegisterInCondition) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic_incDecRegisterInCondition var_cas_ipic_decInc (_var_18296.getPtr ()) ;
                  const GGS_ipic_incDecRegisterInCondition  _temp_17813 = var_cas_ipic_decInc ;
                  if (_temp_17813._isBuilt ()) {
                    typeCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc _method = findCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc (_temp_17813._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17813 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (447)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_registerComparisonCondition) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic_registerComparisonCondition var_cas_ipic_CMP (_var_18296.getPtr ()) ;
                  const GGS_ipic_registerComparisonCondition  _temp_17994 = var_cas_ipic_CMP ;
                  if (_temp_17994._isBuilt ()) {
                    typeCategoryMethod__ipic_registerComparisonCondition__optimizeCMP _method = findCategoryMethod__ipic_registerComparisonCondition__optimizeCMP (_temp_17994._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17994 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (449)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic18_instruction_BitTestSkip) == typeid (* (_var_18296.getPtr ()))) {
                  const GGS_ipic18_instruction_BitTestSkip var_cas_ipic_bitTestSkip (_var_18296.getPtr ()) ;
                  const GGS_ipic18_instruction_BitTestSkip  _temp_18197 = var_cas_ipic_bitTestSkip ;
                  if (_temp_18197._isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip _method = findCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (_temp_18197._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18197 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (451)) ;
                    }
                  }
                }else{
                }
        ...
        {
          GGS_ipic18_instructionList::cEnumerator enumerator_18441 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_18441 = NULL ;
          while (((operand_18441 = enumerator_18441.nextObject ()))) {
            macroValidPointer (operand_18441) ;
            const GGS_ipic18_instruction  _temp_18485 = operand_18441->mInstruction ;
            if (_temp_18485._isBuilt ()) {
              _temp_18485 (HERE)->method_enterReferencedLabel (_inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (458)) ;
            }
          }
        }
        {
          GGS_symbolTableForOptimizations::cEnumerator enumerator_18549 (var_cas_symbolTable, true) ;
          const GGS_symbolTableForOptimizations::cElement * operand_18549 = NULL ;
          while (((operand_18549 = enumerator_18549.nextObject ()))) {
            macroValidPointer (operand_18549) ;
            if (((var_cas_referencedLabels.reader_hasKey (_inLexique, operand_18549->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (461)) COMMA_SOURCE_FILE_AT_LINE (461)))._operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  _temp_18664 = var_cas_symbolTable ;
              if (_temp_18664._isBuilt ()) {
                _temp_18664 (HERE)->method_searchKey (_inLexique, operand_18549->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (462)) ;
              }
              var_cas_ioListFileContents.writeString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_definitionLine.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (463))) ;
              var_cas_ioListFileContents.writeString (": unreferenced label '") ;
              var_cas_ioListFileContents._dotAssign_operation (operand_18549->mKey) ;
              var_cas_ioListFileContents.writeString ("' is deleted\n") ;
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (464)) ;
              GGS_uint  automatic_var_2 ;
              var_cas_symbolTable.modifier_removeKey (_inLexique, operand_18549->mKey, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (465)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic18_instructionList::cEnumerator enumerator_19175 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_19175 = NULL ;
          while (((operand_19175 = enumerator_19175.nextObject ()))) {
            macroValidPointer (operand_19175) ;
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_ipic18_instruction  _temp_19291 = operand_19175->mInstruction ;
              if (_temp_19291._isBuilt ()) {
                _temp_19291 (HERE)->method_nextInstructionIsReachable (_inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (474)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_ipic18_instruction  _temp_19415 = operand_19175->mInstruction ;
              if (_temp_19415._isBuilt ()) {
                _temp_19415 (HERE)->method_isSkippingInstruction (_inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (476)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_ipic18_instruction  _temp_19508 = operand_19175->mInstruction ;
              if (_temp_19508._isBuilt ()) {
                _temp_19508 (HERE)->method_isLABELorORG (_inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (478)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_ipic18_instruction  _temp_19570 = operand_19175->mInstruction ;
              if (_temp_19570._isBuilt ()) {
                _temp_19570 (HERE)->method_isNULL (_inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (479)) ;
              }
              if ((((var_cas_isLABELorORG)._operator_not ())._operator_and ((var_cas_isNULL)._operator_not ())).isBuiltAndTrue ()) {
                var_cas_ioListFileContents.writeString ("  line ") ;
                var_cas_ioListFileContents._dotAssign_operation (var_cas_idx.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (481))) ;
                var_cas_ioListFileContents.writeString (": unreachable instruction is deleted\n") ;
                var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_idx COMMA_SOURCE_FILE_AT_LINE (482)) ;
        ...
        if (((var_cas_optimizationsDone)._operator_not ()).isBuiltAndTrue ()) {
          ...
          {
            GGS_ipic18_instructionList::cEnumerator enumerator_20226 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_ipic18_instructionList::cElement * operand_20226 = NULL ;
            while (((operand_20226 = enumerator_20226.nextObject ()))) {
              macroValidPointer (operand_20226) ;
              const GGS_ipic18_instruction  _temp_20269 = operand_20226->mInstruction ;
              if (_temp_20269._isBuilt ()) {
                _temp_20269 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (495)) ;
              }
            }
          }
          var_cas_ioListFileContents.writeString ("Minimum code size: ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (497))) ;
