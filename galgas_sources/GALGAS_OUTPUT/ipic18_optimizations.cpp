...
category_method__ipic_JUMP__optimizeJUMP (C_Compiler & inLexique,
  ...
  if (operand_3269 != NULL) {
    ...
    const GGS_bool cond_3949 = var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_3269->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100)) ;
...
void routine_performOptimizations (C_Compiler & inLexique,
  ...
  GGS_uint _variant_23109 = var_cas_ioGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (493)) ;
      ...
      if (_variant_23109.uintValue () == 0) {
        ...
        }
        {
          ...
          while (((operand_21232 = enumerator_21232.nextObject ()))) {
            ...
            const GGS_bool cond_21644 = (var_cas_referencedLabels.reader_hasKey (inLexique, operand_21232->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (529)) COMMA_SOURCE_FILE_AT_LINE (529))).operator_not () ;
