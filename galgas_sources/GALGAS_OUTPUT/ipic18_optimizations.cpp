...
void routine_findFirstInstructionOrLabelFromAddress (C_Compiler & inLexique,
                                ...
                                const GGS_ipic18_instructionList   var_cas_inGeneratedInstructionList,
                                GGS_ipic18_instruction  & var_cas_outFirstInstruction,
                                GGS_stringset  & var_cas_outReachedLabelSet
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__ipic_JUMP__optimizeJUMP (C_Compiler & inLexique,
  ...
  if (operand_3269 != NULL) {
    ...
    if (cond_3949.isBuiltAndTrue ()) {
      ...
      if (var_cas_inSymbolTable.isBuilt ()) {
        var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, operand_3269->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (105)) ;
      }
...
category_method__ipic18_instruction_conditionalBranch__optimizeBCC (C_Compiler & inLexique,
  ...
  if (operand_7666 != NULL) {
    GGS_uint  var_cas_line ;
    if (var_cas_inSymbolTable.isBuilt ()) {
      var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, operand_7666->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (201)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
...
category_method__ipic_jump_test_register__optimizeTestReg (C_Compiler & inLexique,
  ...
  if (operand_8902 != NULL) {
    GGS_uint  var_cas_line ;
    if (var_cas_inSymbolTable.isBuilt ()) {
      var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_8902->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (230)), var_cas_line COMMA_SOURCE_FILE_AT_LINE (230)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
...
category_method__ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & inLexique,
  ...
  if (operand_10334 != NULL) {
    GGS_uint  var_cas_line ;
    if (var_cas_inSymbolTable.isBuilt ()) {
      var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_10334->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (265)), var_cas_line COMMA_SOURCE_FILE_AT_LINE (265)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
...
category_method__ipic_registerComparisonCondition__optimizeCMP (C_Compiler & inLexique,
  ...
  if (operand_12026 != NULL) {
    GGS_uint  var_cas_line ;
    if (var_cas_inSymbolTable.isBuilt ()) {
      var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12026->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (316)), var_cas_line COMMA_SOURCE_FILE_AT_LINE (316)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
      ...
      { const GGS_ipic18_instruction _var_14196 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)) ; // CAST instruction
        if (_var_14196.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_14196.getPtr ()) != NULL) {
            ...
            if (var_cas_instruction.isBuilt ()) {
              var_cas_instruction (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (364)) ;
            }
...
void routine_performOptimizations (C_Compiler & inLexique,
  ...
  GGS_symbolTableForOptimizations  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (486)) ;
  {
    ...
    while (((operand_18831 = enumerator_18831.nextObject ()))) {
      ...
      { typeCategoryMethod__ipic18_instruction__defineLabel method = findCategoryMethod__ipic18_instruction__defineLabel (operand_18831->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_18831->mInstruction (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (488)) ;
        }
      }
  ...
  GGS_uint _variant_23113 = var_cas_ioGeneratedInstructionList.reader_length () ;
  GGS_bool _condition_23113 (_variant_23113.isBuilt (), true) ;
  while (_condition_23113.isBuiltAndTrue ()) {
    _condition_23113 = var_cas_optimizationsDone ;
    if (_condition_23113.isBuiltAndTrue ()) {
      if (_variant_23113.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (567)) ;
        _condition_23113 = GGS_bool (false) ;
      }else{
        _variant_23113.decrement_operation (inLexique COMMA_HERE) ;
            ...
            { const GGS_ipic18_instruction _var_20979 = operand_19300->mInstruction ; // CAST instruction
              if (_var_20979.getPtr () != NULL) {
                ...
                if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_20979.getPtr ()))) {
                  ...
                  { typeCategoryMethod__ipic_JUMP__optimizeJUMP method = findCategoryMethod__ipic_JUMP__optimizeJUMP (var_cas_ipic_JUMP.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_JUMP (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (503)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_JSR) == typeid (* (_var_20979.getPtr ()))) {
                  const GGS_ipic_JSR var_cas_ipic_JSR (_var_20979.getPtr ()) ;
                  { typeCategoryMethod__ipic_JSR__optimizeJSR method = findCategoryMethod__ipic_JSR__optimizeJSR (var_cas_ipic_JSR.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_JSR (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (505)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW method = findCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW (var_cas_ipic_literal.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_literal (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (507)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC method = findCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC (var_cas_ipic_cc.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_cc (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (509)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__ipic_jump_test_register__optimizeTestReg method = findCategoryMethod__ipic_jump_test_register__optimizeTestReg (var_cas_ipic_testReg.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_testReg (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (511)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc method = findCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc (var_cas_ipic_decInc.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_decInc (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (513)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__ipic_registerComparisonCondition__optimizeCMP method = findCategoryMethod__ipic_registerComparisonCondition__optimizeCMP (var_cas_ipic_CMP.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_CMP (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (515)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip method = findCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (var_cas_ipic_bitTestSkip.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_bitTestSkip (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (517)) ;
                    }
                  }
                }else{
                }
        ...
        GGS_stringset  var_cas_referencedLabels = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_21124 = enumerator_21124.nextObject ()))) {
            ...
            if (operand_21124->mInstruction.isBuilt ()) {
              operand_21124->mInstruction (HERE)->method_enterReferencedLabel (inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (526)) ;
            }
          }
        }
        {
          ...
          while (((operand_21232 = enumerator_21232.nextObject ()))) {
            ...
            const GGS_bool cond_21648 = (var_cas_referencedLabels.reader_hasKey (operand_21232->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (529)))).operator_not () ;
            if (cond_21648.isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              if (var_cas_symbolTable.isBuilt ()) {
                var_cas_symbolTable (HERE)->method_searchKey (inLexique, operand_21232->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (530)) ;
              }
              var_cas_ioListFileContents.appendCString ("  line ") ;
              ...
              GGS_uint  automatic_var_21636_0 ;
              var_cas_symbolTable.modifier_removeKey (inLexique, operand_21232->mKey, automatic_var_21636_0 COMMA_SOURCE_FILE_AT_LINE (533)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic18_instructionList::cEnumerator enumerator_21862 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic18_instructionList::cElement * operand_21862 = NULL ;
          while (((operand_21862 = enumerator_21862.nextObject ()))) {
            macroValidPointer (operand_21862) ;
            const GGS_bool cond_22143 = (var_cas_reachable).operator_or (var_cas_previousWasSkippingInstruction) ;
            if (cond_22143.isBuiltAndTrue ()) {
              if (operand_21862->mInstruction.isBuilt ()) {
                operand_21862->mInstruction (HERE)->method_nextInstructionIsReachable (inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (542)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              if (operand_21862->mInstruction.isBuilt ()) {
                operand_21862->mInstruction (HERE)->method_isSkippingInstruction (inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (544)) ;
              }
            }else if (cond_22143.isBuiltAndFalse ()) {
              GGS_bool var_cas_isLABELorORG ;
              if (operand_21862->mInstruction.isBuilt ()) {
                operand_21862->mInstruction (HERE)->method_isLABELorORG (inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (546)) ;
              }
              GGS_bool var_cas_isNULL ;
              if (operand_21862->mInstruction.isBuilt ()) {
                operand_21862->mInstruction (HERE)->method_isNULL (inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (547)) ;
              }
              const GGS_bool cond_22532 = ((var_cas_isLABELorORG).operator_not ()).operator_and ((var_cas_isNULL).operator_not ()) ;
              if (cond_22532.isBuiltAndTrue ()) {
                var_cas_ioListFileContents.appendCString ("  line ") ;
              ...
              }else if (cond_22532.isBuiltAndFalse ()) {
                const GGS_bool cond_22689 = var_cas_isLABELorORG ;
                if (cond_22689.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_23102 = (var_cas_optimizationsDone).operator_not () ;
        if (cond_23102.isBuiltAndTrue ()) {
          var_cas_ioListFileContents.appendCString ("  No optimization\n"
            "\n") ;
          GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
          {
            GGS_ipic18_instructionList::cEnumerator enumerator_22918 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_ipic18_instructionList::cElement * operand_22918 = NULL ;
            while (((operand_22918 = enumerator_22918.nextObject ()))) {
              macroValidPointer (operand_22918) ;
              if (operand_22918->mInstruction.isBuilt ()) {
                operand_22918->mInstruction (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (563)) ;
              }
            }
          }
