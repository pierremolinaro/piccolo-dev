...
void routine_findFirstInstructionFromAddress (C_Compiler & inLexique,
  ...
  while (_condition_1756.isBuiltAndTrue ()) {
    _condition_1756 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (40))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_1756.isBuiltAndTrue ()) {
      if (_variant_1756.uintValue () == 0) {
        ...
        _variant_1756._decrement_operation (inLexique COMMA_HERE) ;
        { const GGS_ipic18_instruction _var_1743 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (42)) ; // CAST instruction
          if (_var_1743.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_1743.getPtr ()) != NULL) {
              ...
              var_cas_currentAddress._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
            }
          }
        }
      }
...
void routine_findFirstInstructionOrLabelFromAddress (C_Compiler & inLexique,
  ...
  while (_condition_2820.isBuiltAndTrue ()) {
    _condition_2820 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (67))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_2820.isBuiltAndTrue ()) {
      if (_variant_2820.uintValue () == 0) {
        ...
        _variant_2820._decrement_operation (inLexique COMMA_HERE) ;
        { const GGS_ipic18_instruction _var_2807 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (69)) ; // CAST instruction
          if (_var_2807.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_2807.getPtr ()) != NULL) {
              ...
              var_cas_currentAddress._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
            }else{
              var_cas_currentAddress._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ;
            }
          }
        }
      }
...
category_method__ipic_JUMP__optimizeJUMP (C_Compiler & inLexique,
  ...
  if (operand_3269 != NULL) {
    ...
    ::routine_findFirstInstructionOrLabelFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (98)),  var_cas_ioGeneratedInstructionList,  automatic_var_0,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (98)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_3269->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100))).isBuiltAndTrue ()) {
      ...
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102))) ;
      var_cas_ioListFileContents.appendCString (": JUMP branching to next instruction deleted\n") ;
    }else{
      GGS_uint  var_cas_line ;
      const GGS_symbolTableForOptimizations  _temp_4043 = var_cas_inSymbolTable ;
      if (_temp_4043.isBuilt ()) {
        _temp_4043 (HERE)->method_searchKey (inLexique, operand_3269->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (105)) ;
      }
      GGS_ipic18_instruction  var_cas_firstInstruction ;
      ::routine_findFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (108)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (108)) ;
      { const GGS_ipic18_instruction _var_5556 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5556.getPtr () != NULL) {
          ...
          if (typeid (cPtr_ipic18_instruction_RETURN) == typeid (* (_var_5556.getPtr ()))) {
            ...
            var_cas_ioListFileContents.appendCString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (117))) ;
            ...
            if (((var_cas_literalOp.reader_mLiteralInstruction (inLexique COMMA_SOURCE_FILE_AT_LINE (119)))._operator_isEqual (GGS_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
              ...
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (125))) ;
            ...
            if (((operand_3269->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (128)))).isBuiltAndTrue ()) {
              ...
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134))) ;
...
category_method__ipic_JSR__optimizeJSR (C_Compiler & inLexique,
  ...
  if (operand_5703 != NULL) {
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (151)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (151)) ;
    { const GGS_ipic18_instruction _var_6442 = var_cas_firstInstruction ; // CAST instruction
      if (_var_6442.getPtr () != NULL) {
        ...
        if (typeid (cPtr_ipic18_instruction_RETURN) == typeid (* (_var_6442.getPtr ()))) {
          ...
          var_cas_ioOptimizationsDone = GGS_bool (true) ;
          var_cas_ioListFileContents.appendCString ("  line ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160))) ;
...
category_method__ipic18_instruction_literalOperation__optimizeMOVLW (C_Compiler & inLexique,
  ...
  if (operand_6601 != NULL) {
    if (((operand_6601->mLiteralInstruction)._operator_isEqual (GGS_literal_instruction_opcode::constructor_MOVLW (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_ipic18_instruction  var_cas_firstInstruction ;
      ::routine_findFirstInstructionFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (176)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (176)) ;
      { const GGS_ipic18_instruction _var_7497 = var_cas_firstInstruction ; // CAST instruction
        if (_var_7497.getPtr () != NULL) {
          ...
          if (typeid (cPtr_ipic18_instruction_RETURN) == typeid (* (_var_7497.getPtr ()))) {
            ...
            var_cas_ioOptimizationsDone = GGS_bool (true) ;
            var_cas_ioListFileContents.appendCString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185))) ;
...
category_method__ipic18_instruction_conditionalBranch__optimizeBCC (C_Compiler & inLexique,
  ...
  if (operand_7666 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_7937 = var_cas_inSymbolTable ;
    if (_temp_7937.isBuilt ()) {
      _temp_7937 (HERE)->method_searchKey (inLexique, operand_7666->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (201)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (204)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (204)) ;
    { const GGS_ipic18_instruction _var_8753 = var_cas_firstInstruction ; // CAST instruction
      if (_var_8753.getPtr () != NULL) {
        ...
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_8753.getPtr ()))) {
          ...
          if (((operand_7666->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (208)))._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (208)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (208)))).isBuiltAndTrue ()) {
            ...
            var_cas_ioOptimizationsDone = GGS_bool (true) ;
            var_cas_ioListFileContents.appendCString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214))) ;
            var_cas_ioListFileContents.appendCString (": label of JUMP ") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_7666->mConditionalBranch.reader_condition (inLexique COMMA_SOURCE_FILE_AT_LINE (214))) ;
...
category_method__ipic_jump_test_register__optimizeTestReg (C_Compiler & inLexique,
  ...
  if (operand_8902 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_9173 = var_cas_inSymbolTable ;
    if (_temp_9173.isBuilt ()) {
      _temp_9173 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_8902->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (230)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (233)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (233)) ;
    { const GGS_ipic18_instruction _var_10175 = var_cas_firstInstruction ; // CAST instruction
      if (_var_10175.getPtr () != NULL) {
        ...
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_10175.getPtr ()))) {
          ...
          if (((operand_8902->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (237)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (237)))).isBuiltAndTrue ()) {
            ...
            var_cas_ioOptimizationsDone = GGS_bool (true) ;
            var_cas_ioListFileContents.appendCString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (243))) ;
            var_cas_ioListFileContents.appendCString (": label of JUMP ") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_8902->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (243))) ;
...
category_method__ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & inLexique,
  ...
  if (operand_10334 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_10605 = var_cas_inSymbolTable ;
    if (_temp_10605.isBuilt ()) {
      _temp_10605 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_10334->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (265)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (268)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (268)) ;
    { const GGS_ipic18_instruction _var_11872 = var_cas_firstInstruction ; // CAST instruction
      if (_var_11872.getPtr () != NULL) {
        ...
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_11872.getPtr ()))) {
          ...
          var_cas_ioOptimizationsDone = GGS_bool (true) ;
          var_cas_ioListFileContents.appendCString ("  line ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (285))) ;
          ...
          var_cas_ioListFileContents._dotAssign_operation (operand_10334->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (292))) ;
...
category_method__ipic_registerComparisonCondition__optimizeCMP (C_Compiler & inLexique,
  ...
  if (operand_12026 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_12297 = var_cas_inSymbolTable ;
    if (_temp_12297.isBuilt ()) {
      _temp_12297 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12026->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (316)) ;
    }
    GGS_ipic18_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (319)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (319)) ;
    { const GGS_ipic18_instruction _var_13256 = var_cas_firstInstruction ; // CAST instruction
      if (_var_13256.getPtr () != NULL) {
        ...
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_13256.getPtr ()))) {
          ...
          var_cas_ioOptimizationsDone = GGS_bool (true) ;
          var_cas_ioListFileContents.appendCString ("  line ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (334))) ;
          var_cas_ioListFileContents.appendCString (": label of ") ;
          var_cas_ioListFileContents.appendCString ("JUMP ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12026->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (336))) ;
          var_cas_ioListFileContents.appendCString (" ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12026->mComparison.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (337))) ;
          var_cas_ioListFileContents.appendCString (" branching to JUMP replaced by second JUMP label\n") ;
        }else{
        }
      }
...
category_method__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & inLexique,
  ...
  if (operand_13416 != NULL) {
    ...
    { const GGS_ipic18_instruction _var_13849 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)) ; // CAST instruction
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_ipic18_instruction _var_14196 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)) ; // CAST instruction
        if (_var_14196.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_14196.getPtr ()) != NULL) {
            ...
            const GGS_ipic_actualInstruction  _temp_14100 = var_cas_instruction ;
            if (_temp_14100.isBuilt ()) {
              _temp_14100 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (364)) ;
            }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      ::routine_findFirstInstructionOrLabelFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (3U) COMMA_SOURCE_FILE_AT_LINE (374)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (374)) ;
      var_cas_ok = var_cas_reachedLabelSet.reader_hasKey (inLexique, var_cas_jumpLabel COMMA_SOURCE_FILE_AT_LINE (375)) ;
    }
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_ipic18_instruction_BitTestSkip ::constructor_new (inLexique, operand_13416->mInstructionLocation, (operand_13416->mSkipIfSet)._operator_not (), operand_13416->mRegisterDescription, operand_13416->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (380)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (391)) COMMA_SOURCE_FILE_AT_LINE (391)), var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (392)) COMMA_SOURCE_FILE_AT_LINE (390)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_ipic_NULL ::constructor_new (inLexique COMMA_HERE), var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (395)) ;
      var_cas_ioOptimizationsDone = GGS_bool (true) ;
      var_cas_ioListFileContents.appendCString ("  lines ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (402))) ;
      var_cas_ioListFileContents.appendCString (" to ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (402)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (402))) ;
...
void routine_performOptimizations (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (482))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (483))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (484))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_18831 = enumerator_18831.nextObject ()))) {
      ...
      const GGS_ipic18_instruction  _temp_18874 = operand_18831->mInstruction ;
      if (_temp_18874.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__defineLabel _method = findCategoryMethod__ipic18_instruction__defineLabel (_temp_18874._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (inLexique, _temp_18874 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (488)) ;
        }
      }
  ...
  while (_condition_23093.isBuiltAndTrue ()) {
    ...
    if (_condition_23093.isBuiltAndTrue ()) {
      if (_variant_23093.uintValue () == 0) {
        ...
        _variant_23093._decrement_operation (inLexique COMMA_HERE) ;
        var_cas_optimizationsDone = GGS_bool (false) ;
        var_cas_iteration._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (497)) ;
        var_cas_ioListFileContents.appendCString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (498))) ;
        var_cas_ioListFileContents.appendCString (":\n") ;
        {
            ...
            { const GGS_ipic18_instruction _var_20968 = operand_19294->mInstruction ; // CAST instruction
              if (_var_20968.getPtr () != NULL) {
                ...
                if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_20968.getPtr ()))) {
                  ...
                  const GGS_ipic_JUMP  _temp_19398 = var_cas_ipic_JUMP ;
                  if (_temp_19398.isBuilt ()) {
                    typeCategoryMethod__ipic_JUMP__optimizeJUMP _method = findCategoryMethod__ipic_JUMP__optimizeJUMP (_temp_19398._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_19398 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (503)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_JSR) == typeid (* (_var_20968.getPtr ()))) {
                  const GGS_ipic_JSR var_cas_ipic_JSR (_var_20968.getPtr ()) ;
                  const GGS_ipic_JSR  _temp_19555 = var_cas_ipic_JSR ;
                  if (_temp_19555.isBuilt ()) {
                    typeCategoryMethod__ipic_JSR__optimizeJSR _method = findCategoryMethod__ipic_JSR__optimizeJSR (_temp_19555._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_19555 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (505)) ;
                    }
                  }
                  ...
                  const GGS_ipic18_instruction_literalOperation  _temp_19736 = var_cas_ipic_literal ;
                  if (_temp_19736.isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW _method = findCategoryMethod__ipic18_instruction_literalOperation__optimizeMOVLW (_temp_19736._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_19736 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (507)) ;
                    }
                  }
                  ...
                  const GGS_ipic18_instruction_conditionalBranch  _temp_19906 = var_cas_ipic_cc ;
                  if (_temp_19906.isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC _method = findCategoryMethod__ipic18_instruction_conditionalBranch__optimizeBCC (_temp_19906._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_19906 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (509)) ;
                    }
                  }
                  ...
                  const GGS_ipic_jump_test_register  _temp_20090 = var_cas_ipic_testReg ;
                  if (_temp_20090.isBuilt ()) {
                    typeCategoryMethod__ipic_jump_test_register__optimizeTestReg _method = findCategoryMethod__ipic_jump_test_register__optimizeTestReg (_temp_20090._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_20090 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (511)) ;
                    }
                  }
                  ...
                  const GGS_ipic_incDecRegisterInCondition  _temp_20282 = var_cas_ipic_decInc ;
                  if (_temp_20282.isBuilt ()) {
                    typeCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc _method = findCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc (_temp_20282._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_20282 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (513)) ;
                    }
                  }
                  ...
                  const GGS_ipic_registerComparisonCondition  _temp_20463 = var_cas_ipic_CMP ;
                  if (_temp_20463.isBuilt ()) {
                    typeCategoryMethod__ipic_registerComparisonCondition__optimizeCMP _method = findCategoryMethod__ipic_registerComparisonCondition__optimizeCMP (_temp_20463._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_20463 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (515)) ;
                    }
                  }
                  ...
                  const GGS_ipic18_instruction_BitTestSkip  _temp_20666 = var_cas_ipic_bitTestSkip ;
                  if (_temp_20666.isBuilt ()) {
                    typeCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip _method = findCategoryMethod__ipic18_instruction_BitTestSkip__optimizeBitTestSkip (_temp_20666._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (inLexique, _temp_20666 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (517)) ;
                    }
                  }
                }else{
                }
        ...
        var_cas_referencedLabels = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_21113 = enumerator_21113.nextObject ()))) {
            ...
            const GGS_ipic18_instruction  _temp_21157 = operand_21113->mInstruction ;
            if (_temp_21157.isBuilt ()) {
              _temp_21157 (HERE)->method_enterReferencedLabel (inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (526)) ;
            }
          }
        }
        {
          ...
          while (((operand_21221 = enumerator_21221.nextObject ()))) {
            ...
            if (((var_cas_referencedLabels.reader_hasKey (inLexique, operand_21221->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (529)) COMMA_SOURCE_FILE_AT_LINE (529)))._operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  _temp_21336 = var_cas_symbolTable ;
              if (_temp_21336.isBuilt ()) {
                _temp_21336 (HERE)->method_searchKey (inLexique, operand_21221->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (530)) ;
              }
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_definitionLine.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (531))) ;
              var_cas_ioListFileContents.appendCString (": unreferenced label '") ;
              var_cas_ioListFileContents._dotAssign_operation (operand_21221->mKey) ;
        ...
        var_cas_previousWasSkippingInstruction = GGS_bool (false) ;
        {
          ...
          while (((operand_21847 = enumerator_21847.nextObject ()))) {
            ...
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_ipic18_instruction  _temp_21963 = operand_21847->mInstruction ;
              if (_temp_21963.isBuilt ()) {
                _temp_21963 (HERE)->method_nextInstructionIsReachable (inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (542)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_ipic18_instruction  _temp_22087 = operand_21847->mInstruction ;
              if (_temp_22087.isBuilt ()) {
                _temp_22087 (HERE)->method_isSkippingInstruction (inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (544)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_ipic18_instruction  _temp_22180 = operand_21847->mInstruction ;
              if (_temp_22180.isBuilt ()) {
                _temp_22180 (HERE)->method_isLABELorORG (inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (546)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_ipic18_instruction  _temp_22242 = operand_21847->mInstruction ;
              if (_temp_22242.isBuilt ()) {
                _temp_22242 (HERE)->method_isNULL (inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (547)) ;
              }
              if ((((var_cas_isLABELorORG)._operator_not ())._operator_and ((var_cas_isNULL)._operator_not ())).isBuiltAndTrue ()) {
                var_cas_ioListFileContents.appendCString ("  line ") ;
                var_cas_ioListFileContents._dotAssign_operation (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (549))) ;
        ...
        if (((var_cas_optimizationsDone)._operator_not ()).isBuiltAndTrue ()) {
          ...
          var_cas_currentAddress = GGS_uint (0U) ;
          {
            ...
            while (((operand_22898 = enumerator_22898.nextObject ()))) {
              ...
              const GGS_ipic18_instruction  _temp_22941 = operand_22898->mInstruction ;
              if (_temp_22941.isBuilt ()) {
                _temp_22941 (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (563)) ;
              }
            }
          }
          var_cas_ioListFileContents.appendCString ("Minimum code size: ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (565))) ;
