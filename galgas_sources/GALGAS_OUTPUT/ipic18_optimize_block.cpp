...
void routine_instructionListOptimization (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  outArgument_outOptimizedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (704)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_25699 (constinArgument_inInstructionList, kEnumeration_up) ;
  GALGAS_uint index_25693 ((PMUInt32) 0) ;
  while (enumerator_25699.hasCurrentObject ()) {
    GALGAS_bool var_retainInstruction = GALGAS_bool (true) ;
    const enumGalgasBool test_0 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_25699.current_mInstruction (HERE).ptr ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR temp_1 ;
      if (enumerator_25699.current_mInstruction (HERE).isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_25699.current_mInstruction (HERE).ptr ())) {
          temp_1 = (cPtr_ipic_31__38__5F_intermediate_5F_JSR *) enumerator_25699.current_mInstruction (HERE).ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", enumerator_25699.current_mInstruction (HERE).ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (708)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR var_jsr = temp_1 ;
      GALGAS_uint var_targetBlockIndex ;
      constinArgument_inSymbolTable.method_searchKey (var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (709)), var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (709)) ;
      GALGAS_ipic_31__38_Block var_targetBloc = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (712)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (712)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_retainInstruction = GALGAS_bool (false) ;
        outArgument_outOptimizationDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to empty ").operator_concat (var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (716)).reader_string (SOURCE_FILE_AT_LINE (716)) COMMA_SOURCE_FILE_AT_LINE (716)).operator_concat (GALGAS_string (" routine deleted") COMMA_SOURCE_FILE_AT_LINE (716)) COMMA_SOURCE_FILE_AT_LINE (716)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (717)) ;
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (719)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (719)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          if (var_targetBloc.mAttribute_mTerminator.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) {
              temp_4 = (cPtr_ipic_31__38_RetlwTerminator *) var_targetBloc.mAttribute_mTerminator.ptr () ;
            }else{
              inCompiler->castError ("ipic_31__38_RetlwTerminator", var_targetBloc.mAttribute_mTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (720)) ;
            }
          }
          ...
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to RETLW ").operator_concat (var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (724)).reader_string (SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (724)).operator_concat (GALGAS_string (" routine transformed to MOVLW") COMMA_SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (724)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (725)) ;
          outArgument_outOptimizedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (var_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (727)), GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (728)), var_t.reader_mLiteralValue (SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (726)) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_5 = GALGAS_bool (kIsStrictInf, index_25693.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (732)).objectCompare (constinArgument_inInstructionList.reader_length (SOURCE_FILE_AT_LINE (732)))).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (733)).objectCompare (GALGAS_uint ((PMUInt32) 1U))) COMMA_SOURCE_FILE_AT_LINE (733)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (734)).boolEnum () ;
          if (kBoolTrue == test_5) {
            GALGAS_ipic_31__38_SequentialInstruction var_instruction = var_targetBloc.mAttribute_mInstructionList.reader_mInstructionAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (735)) ;
            outArgument_outOptimizedInstructionList.addAssign_operation (var_instruction COMMA_SOURCE_FILE_AT_LINE (736)) ;
            var_retainInstruction = GALGAS_bool (false) ;
            outArgument_outOptimizationDone = GALGAS_bool (true) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (739)) COMMA_SOURCE_FILE_AT_LINE (739)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (739)) COMMA_SOURCE_FILE_AT_LINE (739)) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to single instruction routine ").operator_concat (var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (740)).reader_string (SOURCE_FILE_AT_LINE (740)) COMMA_SOURCE_FILE_AT_LINE (740)).operator_concat (GALGAS_string (" replaced by this single instruction") COMMA_SOURCE_FILE_AT_LINE (740)) COMMA_SOURCE_FILE_AT_LINE (740)) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (741)) ;
          }
        }
      }
    }
    const enumGalgasBool test_6 = var_retainInstruction.boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outOptimizedInstructionList.addAssign_operation (enumerator_25699.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (745)) ;
    }
    enumerator_25699.gotoNextObject () ;
    index_25693.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (705)) ;
  }
}
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (865)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (865)) COMMA_SOURCE_FILE_AT_LINE (865)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (872)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (872)).isValid ()) {
    PMUInt32 variant_32296 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (872)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (872)).uintValue () ;
    bool loop_32296 = true ;
    while (loop_32296) {
      loop_32296 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (873)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (873)).isValid () ;
      if (loop_32296) {
        loop_32296 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (873)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (873)).boolValue () ;
      }
      if (loop_32296 && (0 == variant_32296)) {
        loop_32296 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (872)) ;
      }
      if (loop_32296) {
        variant_32296 -- ;
        var_optimizationDone = GALGAS_bool (false) ;
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (875)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
          "--- Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (876)) COMMA_SOURCE_FILE_AT_LINE (876)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (876)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (876)).reader_string (SOURCE_FILE_AT_LINE (876)) COMMA_SOURCE_FILE_AT_LINE (876)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (876)) COMMA_SOURCE_FILE_AT_LINE (876)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (878)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (878)).reader_string (SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (881)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_32885 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_32879 ((PMUInt32) 0) ;
        while (enumerator_32885.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_32885.current_mBlock (HERE).mAttribute_mLabel, index_32879, inCompiler COMMA_SOURCE_FILE_AT_LINE (883)) ;
          }
          enumerator_32885.gotoNextObject () ;
          index_32879.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (882)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (886)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_33125 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_33125.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_33125.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (888)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_33125.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
          }
          enumerator_33125.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (897)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_33512 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_33512.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_33512.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (899)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_33512.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (899)))) COMMA_SOURCE_FILE_AT_LINE (899)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_33512.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (900)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (907)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_33512.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (909)) COMMA_SOURCE_FILE_AT_LINE (909)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (909)) COMMA_SOURCE_FILE_AT_LINE (909)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_24192 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_24192.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_24192.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (661)).operator_not (SOURCE_FILE_AT_LINE (661)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_24192.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (662)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_24192.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (663)) ;
      GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (664)) ;
      categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (665)) ;
    }
...
static void categoryMethod_ipic_31__38__5F_condition_5F_skip_5F_instruction_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (681)) ;
}
//---------------------------------------------------------------------------*
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_28554 (temp_0, kEnumeration_up) ;
  while (enumerator_28554.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_28554.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (762)) ;
...
void categoryMethod_enterReferencedLabels (const GALGAS_ipic_31__38_Block inObject,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  categoryMethod_enterInstructionReferencedLabels (inObject.mAttribute_mInstructionList, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (777)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (782)) ;
}
...
void categoryMethod_optimize (const GALGAS_ipic_31__38_Block inObject,
  ...
  {
  routine_instructionListOptimization (constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mInstructionList, inObject.mAttribute_mLabel, var_optimized, ioArgument_ioListFileContents, var_optimizedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (799)) ;
  }
  GALGAS_ipic_31__38_AbstractBlockTerminator var_optimizedTerminator = inObject.mAttribute_mTerminator ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_optimizedInstructionList.reader_length (SOURCE_FILE_AT_LINE (812)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (inObject.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (812)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_ipic_31__38_SequentialInstruction var_lastInstruction ;
    var_optimizedInstructionList.method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (813)) ;
    if (var_lastInstruction.isValid ()) {
      if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation) {
        GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation cast_30237_op ((cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *) var_lastInstruction.ptr ()) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_30237_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (816)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (816)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_30364_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_30364_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (817)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (cast_30237_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (818)), cast_30237_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (818)) COMMA_SOURCE_FILE_AT_LINE (818)) ;
          var_optimized = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (820)) COMMA_SOURCE_FILE_AT_LINE (820)).operator_concat (GALGAS_string (": MOVLW k ; RETURN --> RETLW k\n") COMMA_SOURCE_FILE_AT_LINE (820)) COMMA_SOURCE_FILE_AT_LINE (820)) ;
        }
      }else if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_JSR) {
        GALGAS_ipic_31__38__5F_intermediate_5F_JSR cast_30693_jsr ((cPtr_ipic_31__38__5F_intermediate_5F_JSR *) var_lastInstruction.ptr ()) ;
        {
        GALGAS_ipic_31__38_SequentialInstruction joker_30740_0 ; // Joker input parameter
        var_optimizedInstructionList.modifier_popLast (joker_30740_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (824)) ;
        }
        var_optimizedTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (cast_30693_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (825)), cast_30693_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (825)), cast_30693_jsr.reader_mKind (SOURCE_FILE_AT_LINE (825)) COMMA_SOURCE_FILE_AT_LINE (825)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (827)).operator_concat (cast_30693_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (827)).reader_string (SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)).operator_concat (GALGAS_string (" ; RETURN --> JUMP ") COMMA_SOURCE_FILE_AT_LINE (827)).operator_concat (cast_30693_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (827)).reader_string (SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)) ;
      }
    }
  }
  const enumGalgasBool test_2 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (833)).boolEnum () ;
  if (kBoolTrue == test_2) {
    callCategoryMethod_optimizeTerminator ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mLabel.mAttribute_string, var_optimized, ioArgument_ioListFileContents, var_optimizedTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (834)) ;
  }
  const enumGalgasBool test_3 = var_optimized.boolEnum () ;
  if (kBoolTrue == test_3) {
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_optimizedInstructionList, var_optimizedTerminator COMMA_SOURCE_FILE_AT_LINE (846)) ;
  }else if (kBoolFalse == test_3) {
    //--- @selfCopyInExpressionForGeneration
