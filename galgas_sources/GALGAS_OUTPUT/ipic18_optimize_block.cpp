...
void routine_instructionListOptimization (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  outArgument_outOptimizedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (824)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_31122 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_31122.hasCurrentObject ()) {
    ...
    callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_31122.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, constinArgument_inBlockLabel, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedInstruction, var_NOPsubstitution, inCompiler COMMA_SOURCE_FILE_AT_LINE (826)) ;
    const enumGalgasBool test_0 = var_optimizationDone.boolEnum () ;
    if (kBoolTrue == test_0) {
      outArgument_outOptimizationDone = GALGAS_bool (true) ;
    }
    const enumGalgasBool test_1 = var_NOPsubstitution.operator_not (SOURCE_FILE_AT_LINE (838)).boolEnum () ;
    if (kBoolTrue == test_1) {
      outArgument_outOptimizedInstructionList.addAssign_operation (var_optimizedInstruction COMMA_SOURCE_FILE_AT_LINE (839)) ;
    }
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (1064)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1064)) COMMA_SOURCE_FILE_AT_LINE (1064)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (1065)) COMMA_SOURCE_FILE_AT_LINE (1065)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (1065)) COMMA_SOURCE_FILE_AT_LINE (1065)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (1066)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1066)) COMMA_SOURCE_FILE_AT_LINE (1066)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1073)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1073)).isValid ()) {
    PMUInt32 variant_41530 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1073)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1073)).uintValue () ;
    bool loop_41530 = true ;
    while (loop_41530) {
      loop_41530 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1074)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1074)).isValid () ;
      if (loop_41530) {
        loop_41530 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1074)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1074)).boolValue () ;
      }
      if (loop_41530 && (0 == variant_41530)) {
        loop_41530 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1073)) ;
      }
      if (loop_41530) {
        variant_41530 -- ;
        var_optimizationDone = GALGAS_bool (false) ;
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1076)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
          "--- Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (1077)) COMMA_SOURCE_FILE_AT_LINE (1077)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (1077)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1077)).reader_string (SOURCE_FILE_AT_LINE (1077)) COMMA_SOURCE_FILE_AT_LINE (1077)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (1077)) COMMA_SOURCE_FILE_AT_LINE (1077)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (1079)) COMMA_SOURCE_FILE_AT_LINE (1079)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (1079)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1079)).reader_string (SOURCE_FILE_AT_LINE (1079)) COMMA_SOURCE_FILE_AT_LINE (1079)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (1079)) COMMA_SOURCE_FILE_AT_LINE (1079)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (1082)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_42119 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_42113 ((PMUInt32) 0) ;
        while (enumerator_42119.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_42119.current_mBlock (HERE).mAttribute_mLabel, index_42113, inCompiler COMMA_SOURCE_FILE_AT_LINE (1084)) ;
          }
          enumerator_42119.gotoNextObject () ;
          index_42113.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1083)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1087)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_42359 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_42359.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_42359.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1089)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_42359.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1090)) ;
          }
          enumerator_42359.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (1098)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_42746 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_42746.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_42746.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1100)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_42746.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1100)))) COMMA_SOURCE_FILE_AT_LINE (1100)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_42746.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (1101)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (1108)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_42746.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1110)) COMMA_SOURCE_FILE_AT_LINE (1110)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (1110)) COMMA_SOURCE_FILE_AT_LINE (1110)) ;
            var_optimizationDone = GALGAS_bool (true) ;
          }
          enumerator_42746.gotoNextObject () ;
        }
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_37788 (temp_0, kEnumeration_up) ;
  while (enumerator_37788.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_37788.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (963)) ;
...
void categoryMethod_enterReferencedLabels (const GALGAS_ipic_31__38_Block inObject,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  categoryMethod_enterInstructionReferencedLabels (inObject.mAttribute_mInstructionList, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
}
...
void categoryMethod_optimize (const GALGAS_ipic_31__38_Block inObject,
  ...
  {
  routine_instructionListOptimization (constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mInstructionList, inObject.mAttribute_mLabel, var_optimized, ioArgument_ioListFileContents, var_optimizedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1000)) ;
  }
  GALGAS_ipic_31__38_AbstractBlockTerminator var_optimizedTerminator = inObject.mAttribute_mTerminator ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_optimizedInstructionList.reader_length (SOURCE_FILE_AT_LINE (1013)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (inObject.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (1013)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_ipic_31__38_SequentialInstruction var_lastInstruction ;
    var_optimizedInstructionList.method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)) ;
    if (var_lastInstruction.isValid ()) {
      if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation) {
        GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation cast_39471_op ((cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *) var_lastInstruction.ptr ()) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_39471_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (1017)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (1017)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_39598_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_39598_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1018)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (cast_39471_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1019)), cast_39471_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (1019)) COMMA_SOURCE_FILE_AT_LINE (1019)) ;
          var_optimized = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1021)) COMMA_SOURCE_FILE_AT_LINE (1021)).operator_concat (GALGAS_string (": MOVLW k ; RETURN --> RETLW k\n") COMMA_SOURCE_FILE_AT_LINE (1021)) COMMA_SOURCE_FILE_AT_LINE (1021)) ;
        }
      }else if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_JSR) {
        GALGAS_ipic_31__38__5F_intermediate_5F_JSR cast_39927_jsr ((cPtr_ipic_31__38__5F_intermediate_5F_JSR *) var_lastInstruction.ptr ()) ;
        {
        GALGAS_ipic_31__38_SequentialInstruction joker_39974_0 ; // Joker input parameter
        var_optimizedInstructionList.modifier_popLast (joker_39974_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1025)) ;
        }
        var_optimizedTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (cast_39927_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1026)), cast_39927_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1026)), cast_39927_jsr.reader_mKind (SOURCE_FILE_AT_LINE (1026)) COMMA_SOURCE_FILE_AT_LINE (1026)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1028)) COMMA_SOURCE_FILE_AT_LINE (1028)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (1028)).operator_concat (cast_39927_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1028)).reader_string (SOURCE_FILE_AT_LINE (1028)) COMMA_SOURCE_FILE_AT_LINE (1028)).operator_concat (GALGAS_string (" ; RETURN --> JUMP ") COMMA_SOURCE_FILE_AT_LINE (1028)).operator_concat (cast_39927_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1028)).reader_string (SOURCE_FILE_AT_LINE (1028)) COMMA_SOURCE_FILE_AT_LINE (1028)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1028)) COMMA_SOURCE_FILE_AT_LINE (1028)) ;
      }
    }
  }
  const enumGalgasBool test_2 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (1034)).boolEnum () ;
  if (kBoolTrue == test_2) {
    callCategoryMethod_optimizeTerminator ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mLabel.mAttribute_string, var_optimized, ioArgument_ioListFileContents, var_optimizedTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  }
  const enumGalgasBool test_3 = var_optimized.boolEnum () ;
  if (kBoolTrue == test_3) {
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_optimizedInstructionList, var_optimizedTerminator COMMA_SOURCE_FILE_AT_LINE (1047)) ;
  }else if (kBoolFalse == test_3) {
    //--- @selfCopyInExpressionForGeneration
