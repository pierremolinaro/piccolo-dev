  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1177)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1177)).isValid ()) {
    ...
    while (loop_44487) {
      ...
      if (loop_44487) {
        ...
        GALGAS_uint var_blockCountBeforeOptimization = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1182)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)).operator_concat (GALGAS_string (" : ") COMMA_SOURCE_FILE_AT_LINE (1184)).operator_concat (var_blockCountBeforeOptimization.reader_string (SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)).operator_concat (GALGAS_string (" blocks.\n") COMMA_SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (1187)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_45156 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_45150 ((PMUInt32) 0) ;
        while (enumerator_45156.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_45156.current_mBlock (HERE).mAttribute_mLabel, index_45150, inCompiler COMMA_SOURCE_FILE_AT_LINE (1189)) ;
          }
          enumerator_45156.gotoNextObject () ;
          index_45150.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1188)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1192)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_45396 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_45396.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_45396.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1194)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_45396.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1195)) ;
          }
          enumerator_45396.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (1203)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_45783 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_45783.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_45783.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1205)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_45783.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1205)))) COMMA_SOURCE_FILE_AT_LINE (1205)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_45783.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (1206)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (1213)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_45783.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1215)) COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (1215)) COMMA_SOURCE_FILE_AT_LINE (1215)) ;
            var_optimizationDone = GALGAS_bool (true) ;
          }
          enumerator_45783.gotoNextObject () ;
        }
