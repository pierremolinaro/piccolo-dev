...
void routine_instructionListOptimization (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_35499 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_35499.hasCurrentObject ()) {
    ...
    callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_35499.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedInstruction, var_NOPsubstitution, inCompiler COMMA_SOURCE_FILE_AT_LINE (957)) ;
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (1125)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1125)) COMMA_SOURCE_FILE_AT_LINE (1125)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (1126)) COMMA_SOURCE_FILE_AT_LINE (1126)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (1126)) COMMA_SOURCE_FILE_AT_LINE (1126)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1145)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1145)).isValid ()) {
    PMUInt32 variant_43562 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1145)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1145)).uintValue () ;
    bool loop_43562 = true ;
    while (loop_43562) {
      loop_43562 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1146)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1146)).isValid () ;
      if (loop_43562) {
        loop_43562 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1146)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1146)).boolValue () ;
      }
      if (loop_43562 && (0 == variant_43562)) {
        loop_43562 = false ;
      ...
      if (loop_43562) {
        ...
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1148)) ;
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_44229 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_44208 ((PMUInt32) 0) ;
        while (enumerator_44229.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_44229.current_mBlock (HERE).mAttribute_mLabel, index_44208, inCompiler COMMA_SOURCE_FILE_AT_LINE (1157)) ;
          }
          enumerator_44229.gotoNextObject () ;
          index_44208.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1156)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1160)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_44472 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_44472.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_44472.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1162)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_44472.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1163)) ;
          }
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_44854 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_44854.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_44854.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1173)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_44854.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1173)))) COMMA_SOURCE_FILE_AT_LINE (1173)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_44854.current_mBlock (HERE), var_symbolTable, var_optimizeFlagStruct, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (1182)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [D] ").operator_concat (enumerator_44854.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)) ;
            var_optimizationDone = GALGAS_bool (true) ;
          }
          enumerator_44854.gotoNextObject () ;
        }
...
static void categoryMethod_ipic_31__38_JumpTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (64)))).operator_and (GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (65)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (64)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_SingleInstructionTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (65)).boolEnum () ;
    if (kBoolTrue == test_2) {
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (115)))).operator_and (GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (116)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (115)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (116)).boolEnum () ;
      if (kBoolTrue == test_2) {
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_19185 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_19185.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19185.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (515)).operator_not (SOURCE_FILE_AT_LINE (515)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19185.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (516)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19185.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (517)) ;
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_19980 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_19980.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19980.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (541)).operator_not (SOURCE_FILE_AT_LINE (541)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19980.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (542)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19980.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (543)) ;
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  macroValidSharedObject (object, const cPtr_ipic_31__38_AbstractConditionTerminator) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (618)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (619)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_24480 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_24480.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_24480.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_29370 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_29370.hasCurrentObject ()) {
    GALGAS_bool var_opt = GALGAS_bool (false) ;
    const enumGalgasBool test_0 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_29370.current_mInstruction (HERE).ptr ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR temp_1 ;
      if (enumerator_29370.current_mInstruction (HERE).isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_29370.current_mInstruction (HERE).ptr ())) {
          temp_1 = (cPtr_ipic_31__38__5F_intermediate_5F_JSR *) enumerator_29370.current_mInstruction (HERE).ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", enumerator_29370.current_mInstruction (HERE).ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (786)) ;
        }
      }
      ...
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoEmptyRoutineInComputedRCALLreplacedByBlank.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (792)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (791)).boolEnum () ;
        if (kBoolTrue == test_3) {
          var_opt = GALGAS_bool (true) ;
          outArgument_outOptimizationDone = GALGAS_bool (true) ;
          var_optimizedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BLANK::constructor_new (var_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (795)), GALGAS_uint ((PMUInt32) 0U) COMMA_SOURCE_FILE_AT_LINE (795)) COMMA_SOURCE_FILE_AT_LINE (795)) ;
          ...
          const enumGalgasBool test_4 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoOneInstructionRoutineInComputedRCALLreplacedByInstruction.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (800)).objectCompare (GALGAS_uint ((PMUInt32) 1U))) COMMA_SOURCE_FILE_AT_LINE (799)).boolEnum () ;
          if (kBoolTrue == test_4) {
            GALGAS_ipic_31__38_SequentialInstruction var_inst = var_targetBloc.mAttribute_mInstructionList.reader_mInstructionAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (801)) ;
            const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, callCategoryReader_instructionSize ((const cPtr_ipic_31__38_SequentialInstruction *) var_inst.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (802)).objectCompare (GALGAS_uint ((PMUInt32) 2U))).boolEnum () ;
            if (kBoolTrue == test_5) {
              var_opt = GALGAS_bool (true) ;
              outArgument_outOptimizationDone = GALGAS_bool (true) ;
    ...
    if (kBoolTrue == test_6) {
      var_optimizedInstructionList.addAssign_operation (enumerator_29370.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (814)) ;
    }
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_bool joker_32347_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_32347_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (842)) ;
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction ;
  GALGAS_bool joker_33406_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_33406_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction ;
  GALGAS_bool joker_34448_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_34448_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (915)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_36397 (temp_0, kEnumeration_up) ;
  while (enumerator_36397.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_36397.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (988)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_lastInstruction.isValid ()) {
      if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation) {
        GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation cast_38044_op ((cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *) var_lastInstruction.ptr ()) ;
        const enumGalgasBool test_1 = constinArgument_inOptimizeFlagStruct.mAttribute_mMOVLWfollowedByRETreplacedByRETLW.operator_and (GALGAS_bool (kIsEqual, cast_38044_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (1042)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (1042)))) COMMA_SOURCE_FILE_AT_LINE (1042)).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_38231_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_38231_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (cast_38044_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1044)), cast_38044_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1044)) ;
          var_optimized = GALGAS_bool (true) ;
        ...
        GALGAS_ipic_31__38__5F_intermediate_5F_JSR cast_38565_jsr ((cPtr_ipic_31__38__5F_intermediate_5F_JSR *) var_lastInstruction.ptr ()) ;
        const enumGalgasBool test_2 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRfollowedByRETreplacedByJUMP.boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_38681_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_38681_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1051)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (cast_38565_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1052)), cast_38565_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1052)), cast_38565_jsr.reader_mKind (SOURCE_FILE_AT_LINE (1052)) COMMA_SOURCE_FILE_AT_LINE (1052)) ;
          var_optimized = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [J] ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (1054)).operator_concat (cast_38565_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1054)).reader_string (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)).operator_concat (GALGAS_string (" ; RETURN --> JUMP ") COMMA_SOURCE_FILE_AT_LINE (1054)).operator_concat (cast_38565_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1054)).reader_string (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)) ;
        }
      }
    }
  }
