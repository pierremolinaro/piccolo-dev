...
void routine_enterGoto_32_block (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (GALGAS_string ("_computed_goto_2") COMMA_SOURCE_FILE_AT_LINE (398)).operator_not (SOURCE_FILE_AT_LINE (398)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (GALGAS_string ("_computed_goto_2") COMMA_SOURCE_FILE_AT_LINE (399)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (GALGAS_string ("_computed_goto_2").reader_nowhere (SOURCE_FILE_AT_LINE (400)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (401)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (402)) ;
  }
}
...
void routine_enterGoto_34_block (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (GALGAS_string ("_computed_goto_4") COMMA_SOURCE_FILE_AT_LINE (417)).operator_not (SOURCE_FILE_AT_LINE (417)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (GALGAS_string ("_computed_goto_4") COMMA_SOURCE_FILE_AT_LINE (418)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (GALGAS_string ("_computed_goto_4").reader_nowhere (SOURCE_FILE_AT_LINE (419)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (419)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (420)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (421)) ;
  }
}
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (735)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (735)) COMMA_SOURCE_FILE_AT_LINE (735)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (742)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (742)).isValid ()) {
    PMUInt32 variant_24570 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (742)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (742)).uintValue () ;
    bool loop_24570 = true ;
    while (loop_24570) {
      loop_24570 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (743)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (743)).isValid () ;
      if (loop_24570) {
        loop_24570 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (743)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (743)).boolValue () ;
      }
      if (loop_24570 && (0 == variant_24570)) {
        loop_24570 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (742)) ;
      }
      if (loop_24570) {
        variant_24570 -- ;
        var_optimizationDone = GALGAS_bool (false) ;
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (745)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
          "--- Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (746)).reader_string (SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (748)) COMMA_SOURCE_FILE_AT_LINE (748)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (748)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (748)).reader_string (SOURCE_FILE_AT_LINE (748)) COMMA_SOURCE_FILE_AT_LINE (748)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (748)) COMMA_SOURCE_FILE_AT_LINE (748)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (751)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_25159 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_25153 ((PMUInt32) 0) ;
        while (enumerator_25159.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_25159.current_mBlock (HERE).mAttribute_mLabel, index_25153, inCompiler COMMA_SOURCE_FILE_AT_LINE (753)) ;
          }
          enumerator_25159.gotoNextObject () ;
          index_25153.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (752)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (756)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_25399 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_25399.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_25399.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (758)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_25399.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (759)) ;
          }
          enumerator_25399.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (767)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_25786 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_25786.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_25786.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (769)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_25786.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (769)))) COMMA_SOURCE_FILE_AT_LINE (769)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_25786.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (770)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (777)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_25786.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (779)) COMMA_SOURCE_FILE_AT_LINE (779)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (779)) COMMA_SOURCE_FILE_AT_LINE (779)) ;
            var_optimizationDone = GALGAS_bool (true) ;
          }
          enumerator_25786.gotoNextObject () ;
        }
...
static void categoryMethod_pic_31__38_BraCCTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const enumGalgasBool test_1 = var_optimization.boolEnum () ;
  if (kBoolTrue == test_1) {
    outArgument_outOptimizedTerminator = GALGAS_pic_31__38_BraCCTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_optimizedTrueTerminator, var_optimizedFalseTerminator, object->mAttribute_mBranchMode, object->mAttribute_mConditionalBranch COMMA_SOURCE_FILE_AT_LINE (218)) ;
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
  }else if (kBoolFalse == test_1) {
    //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const enumGalgasBool test_1 = var_optimization.boolEnum () ;
  if (kBoolTrue == test_1) {
    outArgument_outOptimizedTerminator = GALGAS_pic_31__38_RegisterComparisonTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_optimizedTrueTerminator, var_optimizedFalseTerminator, object->mAttribute_mRegisterDescription, object->mAttribute_mComparison COMMA_SOURCE_FILE_AT_LINE (252)) ;
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
  }else if (kBoolFalse == test_1) {
    //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const enumGalgasBool test_1 = var_optimization.boolEnum () ;
  if (kBoolTrue == test_1) {
    outArgument_outOptimizedTerminator = GALGAS_pic_31__38_TestRegisterTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_optimizedTrueTerminator, var_optimizedFalseTerminator, object->mAttribute_mRegisterDescription COMMA_SOURCE_FILE_AT_LINE (286)) ;
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
  }else if (kBoolFalse == test_1) {
    //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_ipic_31__38_JumpTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mLabel, var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (310)) ;
    GALGAS_ipic_31__38_Block var_targetBlock = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (311)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (312)))).operator_and (GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (313)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (313)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_SingleInstructionTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (314)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      if (kBoolTrue == test_3) {
        ...
        if (var_targetBlock.mAttribute_mTerminator.isValid ()) {
          if (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) {
            ...
            inCompiler->castError ("ipic_31__38_JumpTerminator", var_targetBlock.mAttribute_mTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (317)) ;
          }
        }
        GALGAS_ipic_31__38_JumpTerminator var_candidate = temp_4 ;
        var_optimize = GALGAS_bool (kIsNotEqual, object->mAttribute_mLabel.mAttribute_string.objectCompare (var_candidate.reader_mLabel (SOURCE_FILE_AT_LINE (318)).mAttribute_string)) ;
      }else if (kBoolFalse == test_3) {
      ...
      if (kBoolTrue == test_5) {
        ...
        ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (325)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)) ;
        //--- @selfCopyInExpressionForGeneration
        const GALGAS_ipic_31__38_JumpTerminator temp_6 = object ;
        callCategoryMethod_display ((const cPtr_ipic_31__38_JumpTerminator *) temp_6.ptr (), GALGAS_string::makeEmptyString (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (326)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (327)) ;
        callCategoryMethod_display ((const cPtr_ipic_31__38_AbstractBlockTerminator *) outArgument_outOptimizedTerminator.ptr (), GALGAS_string::makeEmptyString (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (328)) ;
...
static void categoryMethod_ipic_31__38_ComputedRETLWTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                                ...
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_enterGoto_32_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  macroValidSharedObject (object, const cPtr_ipic_31__38_ComputedBraTerminator) ;
  {
  routine_enterGoto_32_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
  }
  cEnumerator_lstringlist enumerator_15005 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_15005.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_15005.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (464)).operator_not (SOURCE_FILE_AT_LINE (464)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_15005.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (465)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_15005.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
      GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
      categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (468)) ;
    }
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  macroValidSharedObject (object, const cPtr_ipic_31__38_ComputedGotoTerminator) ;
  {
  routine_enterGoto_34_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (484)) ;
  }
  cEnumerator_lstringlist enumerator_15800 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_15800.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_15800.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (490)).operator_not (SOURCE_FILE_AT_LINE (490)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_15800.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (491)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_15800.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (492)) ;
      GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (493)) ;
      categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (494)) ;
    }
...
static void categoryMethod_ipic_31__38_JumpTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_JumpTerminator * object = (const cPtr_ipic_31__38_JumpTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38_JumpTerminator) ;
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (510)).operator_not (SOURCE_FILE_AT_LINE (510)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (511)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mLabel, var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (512)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (513)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (514)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_AbstractConditionTerminator * object = (const cPtr_ipic_31__38_AbstractConditionTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38_AbstractConditionTerminator) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (538)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (562)).operator_not (SOURCE_FILE_AT_LINE (562)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (563)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  {
  routine_enterGoto_34_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) ;
  }
  cEnumerator_lstringlist enumerator_19206 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_19206.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19206.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (587)).operator_not (SOURCE_FILE_AT_LINE (587)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19206.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (588)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19206.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (589)) ;
      GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)) ;
      categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
    }
...
static void categoryMethod_ipic_31__38__5F_condition_5F_skip_5F_instruction_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
}
//---------------------------------------------------------------------------*
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_20439 (temp_0, kEnumeration_up) ;
  while (enumerator_20439.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_20439.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (626)) ;
...
void categoryMethod_enterReferencedLabels (const GALGAS_ipic_31__38_Block inObject,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  categoryMethod_enterInstructionReferencedLabels (inObject.mAttribute_mInstructionList, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (646)) ;
}
...
void categoryMethod_optimize (const GALGAS_ipic_31__38_Block inObject,
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, inObject.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (666)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (inObject.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (666)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_ipic_31__38_SequentialInstruction var_lastInstruction ;
    var_instructionList.method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      if (var_lastInstruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *> (var_lastInstruction.ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation", var_lastInstruction.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (669)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation var_op = temp_3 ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (670)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (670)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        GALGAS_ipic_31__38_SequentialInstruction joker_22066_0 ; // Joker input parameter
        var_instructionList.modifier_popLast (joker_22066_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (671)) ;
        }
        GALGAS_ipic_31__38_RetlwTerminator var_newTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (var_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (672)), var_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672)) ;
        outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, var_newTerminator COMMA_SOURCE_FILE_AT_LINE (673)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
        callCategoryMethod_display ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), GALGAS_string::makeEmptyString (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (682)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (683)) ;
        callCategoryMethod_display ((const cPtr_ipic_31__38_RetlwTerminator *) var_newTerminator.ptr (), GALGAS_string::makeEmptyString (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (684)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (685)) ;
      }
    }
    const enumGalgasBool test_5 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (689)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (var_lastInstruction.ptr ())) COMMA_SOURCE_FILE_AT_LINE (689)).boolEnum () ;
    if (kBoolTrue == test_5) {
      ...
      if (var_lastInstruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (var_lastInstruction.ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", var_lastInstruction.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (690)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR var_jsr = temp_6 ;
      {
      GALGAS_ipic_31__38_SequentialInstruction joker_22923_0 ; // Joker input parameter
      var_instructionList.modifier_popLast (joker_22923_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (691)) ;
      }
      GALGAS_ipic_31__38_JumpTerminator var_newTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (692)), var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (692)), var_jsr.reader_mKind (SOURCE_FILE_AT_LINE (692)) COMMA_SOURCE_FILE_AT_LINE (692)) ;
      outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, var_newTerminator COMMA_SOURCE_FILE_AT_LINE (693)) ;
      var_optimized = GALGAS_bool (true) ;
      ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (701)) COMMA_SOURCE_FILE_AT_LINE (701)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (701)) COMMA_SOURCE_FILE_AT_LINE (701)) ;
      callCategoryMethod_display ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), GALGAS_string::makeEmptyString (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (702)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (703)) ;
      callCategoryMethod_display ((const cPtr_ipic_31__38_JumpTerminator *) var_newTerminator.ptr (), GALGAS_string::makeEmptyString (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (704)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (705)) ;
    }
  }
  const enumGalgasBool test_7 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (709)).boolEnum () ;
  if (kBoolTrue == test_7) {
    GALGAS_ipic_31__38_AbstractBlockTerminator var_optimizedTerminator ;
    callCategoryMethod_optimizeTerminator ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mLabel.mAttribute_string, ioArgument_ioOptimizationDone, ioArgument_ioListFileContents, var_optimizedTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) ;
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, inObject.mAttribute_mInstructionList, var_optimizedTerminator COMMA_SOURCE_FILE_AT_LINE (718)) ;
  }
}
