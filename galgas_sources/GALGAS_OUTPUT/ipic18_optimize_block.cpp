...
void routine_instructionListOptimization (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_35664 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_35664.hasCurrentObject ()) {
    ...
    callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_35664.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedInstruction, var_NOPsubstitution, inCompiler COMMA_SOURCE_FILE_AT_LINE (959)) ;
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1147)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1147)).isValid ()) {
    PMUInt32 variant_43726 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1147)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1147)).uintValue () ;
    bool loop_43726 = true ;
    while (loop_43726) {
      loop_43726 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1148)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1148)).isValid () ;
      if (loop_43726) {
        loop_43726 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1148)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1148)).boolValue () ;
      }
      if (loop_43726 && (0 == variant_43726)) {
        loop_43726 = false ;
      ...
      if (loop_43726) {
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_44397 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_44391 ((PMUInt32) 0) ;
        while (enumerator_44397.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_44397.current_mBlock (HERE).mAttribute_mLabel, index_44391, inCompiler COMMA_SOURCE_FILE_AT_LINE (1159)) ;
          }
          enumerator_44397.gotoNextObject () ;
          index_44391.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1158)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1162)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_44637 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_44637.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_44637.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1164)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_44637.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1165)) ;
          }
          enumerator_44637.gotoNextObject () ;
        }
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_45019 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_45019.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_45019.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1175)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_45019.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1175)))) COMMA_SOURCE_FILE_AT_LINE (1175)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_45019.current_mBlock (HERE), var_symbolTable, var_optimizeFlagStruct, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (1176)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (1184)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [D] ").operator_concat (enumerator_45019.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1186)) COMMA_SOURCE_FILE_AT_LINE (1186)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (1186)) COMMA_SOURCE_FILE_AT_LINE (1186)) ;
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_19350 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_19350.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19350.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (517)).operator_not (SOURCE_FILE_AT_LINE (517)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19350.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (518)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19350.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (519)) ;
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_20145 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_20145.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_20145.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (543)).operator_not (SOURCE_FILE_AT_LINE (543)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_20145.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (544)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_20145.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (545)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_24645 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_24645.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_24645.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (669)) ;
    enumerator_24645.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_29535 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_29535.hasCurrentObject ()) {
    GALGAS_bool var_opt = GALGAS_bool (false) ;
    const enumGalgasBool test_0 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_29535.current_mInstruction (HERE).ptr ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR temp_1 ;
      if (enumerator_29535.current_mInstruction (HERE).isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_29535.current_mInstruction (HERE).ptr ())) {
          temp_1 = (cPtr_ipic_31__38__5F_intermediate_5F_JSR *) enumerator_29535.current_mInstruction (HERE).ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", enumerator_29535.current_mInstruction (HERE).ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (788)) ;
        }
      }
    ...
    if (kBoolTrue == test_6) {
      var_optimizedInstructionList.addAssign_operation (enumerator_29535.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (816)) ;
    }
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_bool joker_32510_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_32510_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (844)) ;
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction ;
  GALGAS_bool joker_33569_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_33569_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (881)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction ;
  GALGAS_bool joker_34611_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_34611_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (917)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_36562 (temp_0, kEnumeration_up) ;
  while (enumerator_36562.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_36562.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (990)) ;
    enumerator_36562.gotoNextObject () ;
  }
}
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_lastInstruction.isValid ()) {
      if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation) {
        GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation cast_38206_op ((cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *) var_lastInstruction.ptr ()) ;
        const enumGalgasBool test_1 = constinArgument_inOptimizeFlagStruct.mAttribute_mMOVLWfollowedByRETreplacedByRETLW.operator_and (GALGAS_bool (kIsEqual, cast_38206_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (1044)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (1044)))) COMMA_SOURCE_FILE_AT_LINE (1044)).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_38394_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_38394_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1045)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (cast_38206_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1046)), cast_38206_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (1046)) COMMA_SOURCE_FILE_AT_LINE (1046)) ;
          var_optimized = GALGAS_bool (true) ;
        ...
        GALGAS_ipic_31__38__5F_intermediate_5F_JSR cast_38727_jsr ((cPtr_ipic_31__38__5F_intermediate_5F_JSR *) var_lastInstruction.ptr ()) ;
        const enumGalgasBool test_2 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRfollowedByRETreplacedByJUMP.boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_38844_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_38844_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1053)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (cast_38727_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (1054)), cast_38727_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1054)), cast_38727_jsr.reader_mKind (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)) ;
          var_optimized = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [J] ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (1056)).operator_concat (cast_38727_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1056)).reader_string (SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)).operator_concat (GALGAS_string (" ; RETURN --> JUMP ") COMMA_SOURCE_FILE_AT_LINE (1056)).operator_concat (cast_38727_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (1056)).reader_string (SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)) ;
        }
      }
    }
  }
