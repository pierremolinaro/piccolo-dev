...
void routine_instructionListOptimization (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_25696 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_25696.hasCurrentObject ()) {
    GALGAS_bool var_retainInstruction = GALGAS_bool (true) ;
    const enumGalgasBool test_0 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_25696.current_mInstruction (HERE).ptr ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR temp_1 ;
      if (enumerator_25696.current_mInstruction (HERE).isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_25696.current_mInstruction (HERE).ptr ())) {
          temp_1 = (cPtr_ipic_31__38__5F_intermediate_5F_JSR *) enumerator_25696.current_mInstruction (HERE).ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", enumerator_25696.current_mInstruction (HERE).ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (708)) ;
        }
      }
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (720)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (720)).boolEnum () ;
      if (kBoolTrue == test_3) {
        ...
        if (var_targetBloc.mAttribute_mTerminator.isValid ()) {
          if (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) {
            ...
            inCompiler->castError ("ipic_31__38_RetlwTerminator", var_targetBloc.mAttribute_mTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (721)) ;
          }
        }
        ...
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to RETLW ").operator_concat (var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (725)).reader_string (SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (GALGAS_string (" routine transformed to MOVLW") COMMA_SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (726)) ;
        outArgument_outOptimizedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (var_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (728)), GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (729)), var_t.reader_mLiteralValue (SOURCE_FILE_AT_LINE (730)) COMMA_SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)) ;
      }
    }
    const enumGalgasBool test_5 = var_retainInstruction.boolEnum () ;
    if (kBoolTrue == test_5) {
      outArgument_outOptimizedInstructionList.addAssign_operation (enumerator_25696.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (735)) ;
    }
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (854)) COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (854)) COMMA_SOURCE_FILE_AT_LINE (854)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (862)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (862)).isValid ()) {
    PMUInt32 variant_31561 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (862)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (862)).uintValue () ;
    bool loop_31561 = true ;
    while (loop_31561) {
      loop_31561 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (863)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (863)).isValid () ;
      if (loop_31561) {
        loop_31561 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (863)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (863)).boolValue () ;
      }
      if (loop_31561 && (0 == variant_31561)) {
        loop_31561 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (862)) ;
      }
      if (loop_31561) {
        variant_31561 -- ;
        var_optimizationDone = GALGAS_bool (false) ;
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (865)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
          "--- Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (866)) COMMA_SOURCE_FILE_AT_LINE (866)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (866)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (866)).reader_string (SOURCE_FILE_AT_LINE (866)) COMMA_SOURCE_FILE_AT_LINE (866)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (866)) COMMA_SOURCE_FILE_AT_LINE (866)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (868)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (868)).reader_string (SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (871)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_32150 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_32144 ((PMUInt32) 0) ;
        while (enumerator_32150.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_32150.current_mBlock (HERE).mAttribute_mLabel, index_32144, inCompiler COMMA_SOURCE_FILE_AT_LINE (873)) ;
          }
          enumerator_32150.gotoNextObject () ;
          index_32144.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (872)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (876)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_32390 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_32390.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_32390.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (878)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_32390.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
          }
          enumerator_32390.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (887)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_32777 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_32777.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_32777.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (889)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_32777.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (889)))) COMMA_SOURCE_FILE_AT_LINE (889)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_32777.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (890)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (897)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_32777.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (899)) COMMA_SOURCE_FILE_AT_LINE (899)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (899)) COMMA_SOURCE_FILE_AT_LINE (899)) ;
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_27819 (temp_0, kEnumeration_up) ;
  while (enumerator_27819.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_27819.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (752)) ;
...
void categoryMethod_enterReferencedLabels (const GALGAS_ipic_31__38_Block inObject,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  categoryMethod_enterInstructionReferencedLabels (inObject.mAttribute_mInstructionList, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (767)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (772)) ;
}
...
void categoryMethod_optimize (const GALGAS_ipic_31__38_Block inObject,
  ...
  {
  routine_instructionListOptimization (constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mInstructionList, inObject.mAttribute_mLabel, var_optimized, ioArgument_ioListFileContents, var_optimizedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (789)) ;
  }
  GALGAS_ipic_31__38_AbstractBlockTerminator var_optimizedTerminator = inObject.mAttribute_mTerminator ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_optimizedInstructionList.reader_length (SOURCE_FILE_AT_LINE (802)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (inObject.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (802)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_ipic_31__38_SequentialInstruction var_lastInstruction ;
    var_optimizedInstructionList.method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (803)) ;
    if (var_lastInstruction.isValid ()) {
      if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation) {
        GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation cast_29502_op ((cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *) var_lastInstruction.ptr ()) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_29502_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (806)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (806)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_29629_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_29629_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (807)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (cast_29502_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (808)), cast_29502_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (808)) COMMA_SOURCE_FILE_AT_LINE (808)) ;
          var_optimized = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (810)) COMMA_SOURCE_FILE_AT_LINE (810)).operator_concat (GALGAS_string (": MOVLW k ; RETURN --> RETLW k\n") COMMA_SOURCE_FILE_AT_LINE (810)) COMMA_SOURCE_FILE_AT_LINE (810)) ;
        }
      }else if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_JSR) {
        GALGAS_ipic_31__38__5F_intermediate_5F_JSR cast_29958_jsr ((cPtr_ipic_31__38__5F_intermediate_5F_JSR *) var_lastInstruction.ptr ()) ;
        {
        GALGAS_ipic_31__38_SequentialInstruction joker_30005_0 ; // Joker input parameter
        var_optimizedInstructionList.modifier_popLast (joker_30005_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (814)) ;
        }
        var_optimizedTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (cast_29958_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (815)), cast_29958_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (815)), cast_29958_jsr.reader_mKind (SOURCE_FILE_AT_LINE (815)) COMMA_SOURCE_FILE_AT_LINE (815)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (817)) COMMA_SOURCE_FILE_AT_LINE (817)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (817)).operator_concat (cast_29958_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (817)).reader_string (SOURCE_FILE_AT_LINE (817)) COMMA_SOURCE_FILE_AT_LINE (817)).operator_concat (GALGAS_string (" ; RETURN --> JUMP ") COMMA_SOURCE_FILE_AT_LINE (817)).operator_concat (cast_29958_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (817)).reader_string (SOURCE_FILE_AT_LINE (817)) COMMA_SOURCE_FILE_AT_LINE (817)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (817)) COMMA_SOURCE_FILE_AT_LINE (817)) ;
      }
    }
  }
  const enumGalgasBool test_2 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (823)).boolEnum () ;
  if (kBoolTrue == test_2) {
    callCategoryMethod_optimizeTerminator ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mLabel.mAttribute_string, var_optimized, ioArgument_ioListFileContents, var_optimizedTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (824)) ;
  }
  const enumGalgasBool test_3 = var_optimized.boolEnum () ;
  if (kBoolTrue == test_3) {
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_optimizedInstructionList, var_optimizedTerminator COMMA_SOURCE_FILE_AT_LINE (836)) ;
  }else if (kBoolFalse == test_3) {
    //--- @selfCopyInExpressionForGeneration
