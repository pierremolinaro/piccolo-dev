...
//                    september 15th, 2013, at 15h17'6"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_instructionListOptimization (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_35502 (constinArgument_inInstructionList, kEnumeration_up) ;
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1145)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1145)).isValid ()) {
    PMUInt32 variant_43564 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1145)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1145)).uintValue () ;
    bool loop_43564 = true ;
    while (loop_43564) {
      loop_43564 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1146)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1146)).isValid () ;
      if (loop_43564) {
        loop_43564 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1146)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (1146)).boolValue () ;
      }
      if (loop_43564 && (0 == variant_43564)) {
        loop_43564 = false ;
      ...
      if (loop_43564) {
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_44235 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_44229 ((PMUInt32) 0) ;
        while (enumerator_44235.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_44235.current_mBlock (HERE).mAttribute_mLabel, index_44229, inCompiler COMMA_SOURCE_FILE_AT_LINE (1157)) ;
          }
          enumerator_44235.gotoNextObject () ;
          index_44229.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1156)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1160)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_44475 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_44475.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_44475.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1162)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_44475.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1163)) ;
          }
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_44857 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_44857.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_44857.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1173)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_44857.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1173)))) COMMA_SOURCE_FILE_AT_LINE (1173)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_44857.current_mBlock (HERE), var_symbolTable, var_optimizeFlagStruct, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (1182)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [D] ").operator_concat (enumerator_44857.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)) ;
            var_optimizationDone = GALGAS_bool (true) ;
          }
          enumerator_44857.gotoNextObject () ;
        }
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_19188 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_19188.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19188.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (515)).operator_not (SOURCE_FILE_AT_LINE (515)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19188.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (516)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19188.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (517)) ;
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_19983 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_19983.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19983.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (541)).operator_not (SOURCE_FILE_AT_LINE (541)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19983.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (542)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19983.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (543)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_24483 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_24483.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_24483.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_1 = constinArgument_inOptimizeFlagStruct.mAttribute_mRemoveEmptyRoutine.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (730)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (730)).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (731)))) COMMA_SOURCE_FILE_AT_LINE (731)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (732)).boolEnum () ;
  if (kBoolTrue == test_1) {
    outArgument_outOptimizationDone = GALGAS_bool (true) ;
    ...
    const enumGalgasBool test_2 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoRETLWreplacedByMOVLW.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (741)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (741)).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (742)))) COMMA_SOURCE_FILE_AT_LINE (742)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (743)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      const enumGalgasBool test_4 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoOneInstructionRoutineReplacedByInstruction.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (756)).objectCompare (GALGAS_uint ((PMUInt32) 1U))) COMMA_SOURCE_FILE_AT_LINE (756)).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (757)))) COMMA_SOURCE_FILE_AT_LINE (757)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (758)).boolEnum () ;
      if (kBoolTrue == test_4) {
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_29373 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_29373.hasCurrentObject ()) {
    GALGAS_bool var_opt = GALGAS_bool (false) ;
    const enumGalgasBool test_0 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_29373.current_mInstruction (HERE).ptr ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR temp_1 ;
      if (enumerator_29373.current_mInstruction (HERE).isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_29373.current_mInstruction (HERE).ptr ())) {
          temp_1 = (cPtr_ipic_31__38__5F_intermediate_5F_JSR *) enumerator_29373.current_mInstruction (HERE).ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", enumerator_29373.current_mInstruction (HERE).ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (786)) ;
        }
      }
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_3) {
          ...
          const enumGalgasBool test_4 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoOneInstructionRoutineInComputedRCALLreplacedByInstruction.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (800)).objectCompare (GALGAS_uint ((PMUInt32) 1U))) COMMA_SOURCE_FILE_AT_LINE (800)).boolEnum () ;
          if (kBoolTrue == test_4) {
    ...
    if (kBoolTrue == test_6) {
      var_optimizedInstructionList.addAssign_operation (enumerator_29373.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (814)) ;
    }
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_bool joker_32348_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_32348_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (842)) ;
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction ;
  GALGAS_bool joker_33407_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_33407_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstruction var_optimizedEmbeddedInstruction ;
  GALGAS_bool joker_34449_0 ; // Joker input parameter
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_34449_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (915)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_36400 (temp_0, kEnumeration_up) ;
  while (enumerator_36400.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_36400.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (988)) ;
    enumerator_36400.gotoNextObject () ;
  }
}
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_lastInstruction.isValid ()) {
      if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation) {
        ...
        if (kBoolTrue == test_1) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_38232_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_38232_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
          }
        ...
        if (kBoolTrue == test_2) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_38682_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_38682_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1051)) ;
          }
