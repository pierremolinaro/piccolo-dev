  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1147)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1147)).isValid ()) {
    ...
    while (loop_43678) {
      ...
      if (loop_43678) {
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_44349 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_44343 ((PMUInt32) 0) ;
        while (enumerator_44349.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_44349.current_mBlock (HERE).mAttribute_mLabel, index_44343, inCompiler COMMA_SOURCE_FILE_AT_LINE (1159)) ;
          }
          enumerator_44349.gotoNextObject () ;
          index_44343.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1158)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1162)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_44589 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_44589.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_44589.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1164)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_44589.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1165)) ;
          }
        ...
        cEnumerator_ipic_31__38_BlockList enumerator_44971 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_44971.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_44971.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1175)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_44971.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1175)))) COMMA_SOURCE_FILE_AT_LINE (1175)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_44971.current_mBlock (HERE), var_symbolTable, var_optimizeFlagStruct, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (1176)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (1184)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [D] ").operator_concat (enumerator_44971.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (1186)) COMMA_SOURCE_FILE_AT_LINE (1186)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (1186)) COMMA_SOURCE_FILE_AT_LINE (1186)) ;
            var_optimizationDone = GALGAS_bool (true) ;
          }
          enumerator_44971.gotoNextObject () ;
        }
