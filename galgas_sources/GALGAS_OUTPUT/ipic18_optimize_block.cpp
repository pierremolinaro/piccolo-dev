...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (752)) COMMA_SOURCE_FILE_AT_LINE (752)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (752)) COMMA_SOURCE_FILE_AT_LINE (752)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (753)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (753)) COMMA_SOURCE_FILE_AT_LINE (753)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (760)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (760)).isValid ()) {
    PMUInt32 variant_25592 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (760)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (760)).uintValue () ;
    bool loop_25592 = true ;
    while (loop_25592) {
      loop_25592 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (761)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (761)).isValid () ;
      if (loop_25592) {
        loop_25592 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (761)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (761)).boolValue () ;
      }
      if (loop_25592 && (0 == variant_25592)) {
        loop_25592 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (760)) ;
      }
      if (loop_25592) {
        variant_25592 -- ;
        var_optimizationDone = GALGAS_bool (false) ;
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
          "--- Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (764)).reader_string (SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (766)) COMMA_SOURCE_FILE_AT_LINE (766)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (766)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (766)).reader_string (SOURCE_FILE_AT_LINE (766)) COMMA_SOURCE_FILE_AT_LINE (766)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (766)) COMMA_SOURCE_FILE_AT_LINE (766)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (769)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_26181 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_26175 ((PMUInt32) 0) ;
        while (enumerator_26181.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_26181.current_mBlock (HERE).mAttribute_mLabel, index_26175, inCompiler COMMA_SOURCE_FILE_AT_LINE (771)) ;
          }
          enumerator_26181.gotoNextObject () ;
          index_26175.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (770)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (774)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_26421 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_26421.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_26421.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (776)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_26421.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (777)) ;
          }
          enumerator_26421.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (785)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_26808 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_26808.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_26808.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (787)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_26808.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (787)))) COMMA_SOURCE_FILE_AT_LINE (787)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_26808.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (788)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (795)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_26808.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (797)) COMMA_SOURCE_FILE_AT_LINE (797)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (797)) COMMA_SOURCE_FILE_AT_LINE (797)) ;
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  GALGAS_ipic_31__38_AbstractBlockTerminator var_optimizedFalseTerminator ;
  callCategoryMethod_optimizeTerminator ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mOptimizableInstructionIfConditionFalse.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, constinArgument_inBlockLabel, var_optimization, ioArgument_ioListFileContents, var_optimizedFalseTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (103)) ;
  const enumGalgasBool test_0 = var_optimization.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_ipic_31__38_SingleInstructionTerminator temp_1 ;
    if (var_optimizedFalseTerminator.isValid ()) {
      if (NULL != dynamic_cast <const cPtr_ipic_31__38_SingleInstructionTerminator *> (var_optimizedFalseTerminator.ptr ())) {
        ...
        inCompiler->castError ("ipic_31__38_SingleInstructionTerminator", var_optimizedFalseTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (118)) ;
      }
    }
    outArgument_outOptimizedTerminator = GALGAS_ipic_31__38_ConditionalJumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mBranchMode, object->mAttribute_mConditionalBranch, object->mAttribute_mTargetLabelWhenTrue, temp_1 COMMA_SOURCE_FILE_AT_LINE (113)) ;
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_14035 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_14035.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_14035.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (430)).operator_not (SOURCE_FILE_AT_LINE (430)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_14035.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (431)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_14035.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (432)) ;
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_14830 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_14830.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_14830.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (456)).operator_not (SOURCE_FILE_AT_LINE (456)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_14830.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (457)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_14830.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_ConditionalJumpTerminator * object = (const cPtr_ipic_31__38_ConditionalJumpTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38_ConditionalJumpTerminator) ;
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mTargetLabelWhenTrue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (495)).operator_not (SOURCE_FILE_AT_LINE (495)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mTargetLabelWhenTrue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (496)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabelWhenTrue, var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (497)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
  }
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mOptimizableInstructionIfConditionFalse.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (505)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_AbstractConditionTerminator * object = (const cPtr_ipic_31__38_AbstractConditionTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38_AbstractConditionTerminator) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (529)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (552)).operator_not (SOURCE_FILE_AT_LINE (552)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (553)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (554)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (555)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  {
  routine_enterGoto_34_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
  }
  cEnumerator_lstringlist enumerator_19071 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_19071.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19071.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (577)).operator_not (SOURCE_FILE_AT_LINE (577)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19071.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (578)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19071.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (579)) ;
      GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (580)) ;
      categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) ;
    }
...
static void categoryMethod_ipic_31__38__5F_condition_5F_skip_5F_instruction_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
}
//---------------------------------------------------------------------------*
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_20304 (temp_0, kEnumeration_up) ;
  while (enumerator_20304.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_20304.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (616)) ;
...
void categoryMethod_enterReferencedLabels (const GALGAS_ipic_31__38_Block inObject,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  categoryMethod_enterInstructionReferencedLabels (inObject.mAttribute_mInstructionList, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (631)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (636)) ;
}
...
void categoryMethod_optimize (const GALGAS_ipic_31__38_Block inObject,
  ...
  GALGAS_ipic_31__38_SequentialInstructionList var_instructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (654)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_21439 (inObject.mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_21439.hasCurrentObject ()) {
    GALGAS_bool var_retainInstruction = GALGAS_bool (true) ;
    const enumGalgasBool test_1 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_21439.current_mInstruction (HERE).ptr ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR temp_2 ;
      if (enumerator_21439.current_mInstruction (HERE).isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_21439.current_mInstruction (HERE).ptr ())) {
          temp_2 = (cPtr_ipic_31__38__5F_intermediate_5F_JSR *) enumerator_21439.current_mInstruction (HERE).ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", enumerator_21439.current_mInstruction (HERE).ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (659)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR var_jsr = temp_2 ;
      GALGAS_uint var_targetBlockIndex ;
      constinArgument_inSymbolTable.method_searchKey (var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (660)), var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (660)) ;
      GALGAS_ipic_31__38_Block var_targetBloc = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (661)) ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (662)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (662)).boolEnum () ;
      if (kBoolTrue == test_3) {
        var_retainInstruction = GALGAS_bool (false) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (666)) COMMA_SOURCE_FILE_AT_LINE (666)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (666)) COMMA_SOURCE_FILE_AT_LINE (666)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to empty ").operator_concat (var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (667)).reader_string (SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string (" routine deleted") COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (668)) ;
      }
    }
    const enumGalgasBool test_4 = var_retainInstruction.boolEnum () ;
    if (kBoolTrue == test_4) {
      var_instructionList.addAssign_operation (enumerator_21439.current_mInstruction (HERE) COMMA_SOURCE_FILE_AT_LINE (672)) ;
    }
    enumerator_21439.gotoNextObject () ;
  }
  const enumGalgasBool test_5 = var_optimized.boolEnum () ;
  if (kBoolTrue == test_5) {
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, inObject.mAttribute_mTerminator COMMA_SOURCE_FILE_AT_LINE (676)) ;
  }
  const enumGalgasBool test_6 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (684)).operator_and (GALGAS_bool (kIsStrictSup, var_instructionList.reader_length (SOURCE_FILE_AT_LINE (684)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (684)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (inObject.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (684)).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_ipic_31__38_SequentialInstruction var_lastInstruction ;
    var_instructionList.method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (685)) ;
    const enumGalgasBool test_7 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *> (var_lastInstruction.ptr ())).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation temp_8 ;
      if (var_lastInstruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *> (var_lastInstruction.ptr ())) {
          temp_8 = (cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *) var_lastInstruction.ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation", var_lastInstruction.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (687)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation var_op = temp_8 ;
      const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (688)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (688)))).boolEnum () ;
      if (kBoolTrue == test_9) {
        {
        GALGAS_ipic_31__38_SequentialInstruction joker_23045_0 ; // Joker input parameter
        var_instructionList.modifier_popLast (joker_23045_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (689)) ;
        }
        GALGAS_ipic_31__38_RetlwTerminator var_newTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (var_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (690)), var_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (690)) COMMA_SOURCE_FILE_AT_LINE (690)) ;
        outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, var_newTerminator COMMA_SOURCE_FILE_AT_LINE (691)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (699)) COMMA_SOURCE_FILE_AT_LINE (699)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (699)) COMMA_SOURCE_FILE_AT_LINE (699)) ;
        ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (700)) COMMA_SOURCE_FILE_AT_LINE (700)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (701)) ;
        ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_RetlwTerminator *) var_newTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (702)) COMMA_SOURCE_FILE_AT_LINE (702)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (703)) ;
      }
    }
    const enumGalgasBool test_10 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (707)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (var_lastInstruction.ptr ())) COMMA_SOURCE_FILE_AT_LINE (707)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR temp_11 ;
      if (var_lastInstruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (var_lastInstruction.ptr ())) {
          temp_11 = (cPtr_ipic_31__38__5F_intermediate_5F_JSR *) var_lastInstruction.ptr () ;
        }else{
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", var_lastInstruction.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (708)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR var_jsr = temp_11 ;
      {
      GALGAS_ipic_31__38_SequentialInstruction joker_23924_0 ; // Joker input parameter
      var_instructionList.modifier_popLast (joker_23924_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (709)) ;
      }
      GALGAS_ipic_31__38_JumpTerminator var_newTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (710)), var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (710)), var_jsr.reader_mKind (SOURCE_FILE_AT_LINE (710)) COMMA_SOURCE_FILE_AT_LINE (710)) ;
      outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, var_newTerminator COMMA_SOURCE_FILE_AT_LINE (711)) ;
      var_optimized = GALGAS_bool (true) ;
      ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (719)) COMMA_SOURCE_FILE_AT_LINE (719)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (719)) COMMA_SOURCE_FILE_AT_LINE (719)) ;
      ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) COMMA_SOURCE_FILE_AT_LINE (720)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (721)) ;
      ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_JumpTerminator *) var_newTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (722)) COMMA_SOURCE_FILE_AT_LINE (722)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (723)) ;
    }
  }
  const enumGalgasBool test_12 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (727)).boolEnum () ;
  if (kBoolTrue == test_12) {
    GALGAS_ipic_31__38_AbstractBlockTerminator var_optimizedTerminator ;
    callCategoryMethod_optimizeTerminator ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mLabel.mAttribute_string, ioArgument_ioOptimizationDone, ioArgument_ioListFileContents, var_optimizedTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (728)) ;
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, var_optimizedTerminator COMMA_SOURCE_FILE_AT_LINE (736)) ;
  }
}
