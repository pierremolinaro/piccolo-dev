...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (723)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (723)) COMMA_SOURCE_FILE_AT_LINE (723)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (724)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (724)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (732)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (732)).isValid ()) {
    PMUInt32 variant_24479 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (732)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (732)).uintValue () ;
    bool loop_24479 = true ;
    while (loop_24479) {
      loop_24479 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (733)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (733)).isValid () ;
      if (loop_24479) {
        loop_24479 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (733)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (733)).boolValue () ;
      }
      if (loop_24479 && (0 == variant_24479)) {
        loop_24479 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (732)) ;
      }
      if (loop_24479) {
        variant_24479 -- ;
        var_optimizationDone = GALGAS_bool (false) ;
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (735)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
          "--- Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (736)) COMMA_SOURCE_FILE_AT_LINE (736)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (736)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (736)).reader_string (SOURCE_FILE_AT_LINE (736)) COMMA_SOURCE_FILE_AT_LINE (736)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (736)) COMMA_SOURCE_FILE_AT_LINE (736)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE_AT_LINE (738)) COMMA_SOURCE_FILE_AT_LINE (738)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (738)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (738)).reader_string (SOURCE_FILE_AT_LINE (738)) COMMA_SOURCE_FILE_AT_LINE (738)).operator_concat (GALGAS_string (" blocks)\n") COMMA_SOURCE_FILE_AT_LINE (738)) COMMA_SOURCE_FILE_AT_LINE (738)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (741)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_25068 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        GALGAS_uint index_25062 ((PMUInt32) 0) ;
        while (enumerator_25068.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_25068.current_mBlock (HERE).mAttribute_mLabel, index_25062, inCompiler COMMA_SOURCE_FILE_AT_LINE (743)) ;
          }
          enumerator_25068.gotoNextObject () ;
          index_25062.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (742)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (746)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_25308 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_25308.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_25308.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (748)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_25308.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (749)) ;
          }
          enumerator_25308.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (757)) ;
        cEnumerator_ipic_31__38_BlockList enumerator_25695 (ioArgument_ioGeneratedBlockList, kEnumeration_up) ;
        while (enumerator_25695.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_25695.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (759)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_25695.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (759)))) COMMA_SOURCE_FILE_AT_LINE (759)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_25695.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (760)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock COMMA_SOURCE_FILE_AT_LINE (767)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_25695.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (769)) COMMA_SOURCE_FILE_AT_LINE (769)).operator_concat (GALGAS_string (": not referenced, deleted\n") COMMA_SOURCE_FILE_AT_LINE (769)) COMMA_SOURCE_FILE_AT_LINE (769)) ;
...
void categoryMethod_optimize (const GALGAS_ipic_31__38_Block inObject,
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, inObject.mAttribute_mInstructionList.reader_length (SOURCE_FILE_AT_LINE (656)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (inObject.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE_AT_LINE (656)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_ipic_31__38_SequentialInstruction var_lastInstruction ;
    var_instructionList.method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (657)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      if (var_lastInstruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *> (var_lastInstruction.ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation", var_lastInstruction.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (659)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation var_op = temp_3 ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_op.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (660)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE_AT_LINE (660)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        GALGAS_ipic_31__38_SequentialInstruction joker_21931_0 ; // Joker input parameter
        var_instructionList.modifier_popLast (joker_21931_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (661)) ;
        }
        GALGAS_ipic_31__38_RetlwTerminator var_newTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (var_op.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (662)), var_op.reader_mLiteralValue (SOURCE_FILE_AT_LINE (662)) COMMA_SOURCE_FILE_AT_LINE (662)) ;
        outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, var_newTerminator COMMA_SOURCE_FILE_AT_LINE (663)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)) ;
        ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (673)) ;
        ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_RetlwTerminator *) var_newTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (674)) COMMA_SOURCE_FILE_AT_LINE (674)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (675)) ;
      }
    }
    const enumGalgasBool test_5 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (679)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (var_lastInstruction.ptr ())) COMMA_SOURCE_FILE_AT_LINE (679)).boolEnum () ;
    if (kBoolTrue == test_5) {
      ...
      if (var_lastInstruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (var_lastInstruction.ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", var_lastInstruction.ptr ()->classDescriptor () COMMA_SOURCE_FILE_AT_LINE (680)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR var_jsr = temp_6 ;
      {
      GALGAS_ipic_31__38_SequentialInstruction joker_22810_0 ; // Joker input parameter
      var_instructionList.modifier_popLast (joker_22810_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (681)) ;
      }
      GALGAS_ipic_31__38_JumpTerminator var_newTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (var_jsr.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (682)), var_jsr.reader_mTargetLabel (SOURCE_FILE_AT_LINE (682)), var_jsr.reader_mKind (SOURCE_FILE_AT_LINE (682)) COMMA_SOURCE_FILE_AT_LINE (682)) ;
      outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, var_instructionList, var_newTerminator COMMA_SOURCE_FILE_AT_LINE (683)) ;
      var_optimized = GALGAS_bool (true) ;
      ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (691)) COMMA_SOURCE_FILE_AT_LINE (691)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (691)) COMMA_SOURCE_FILE_AT_LINE (691)) ;
      ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (692)) COMMA_SOURCE_FILE_AT_LINE (692)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (693)) ;
      ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_JumpTerminator *) var_newTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (694)) COMMA_SOURCE_FILE_AT_LINE (694)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (695)) ;
    }
  }
  const enumGalgasBool test_7 = var_optimized.operator_not (SOURCE_FILE_AT_LINE (699)).boolEnum () ;
  if (kBoolTrue == test_7) {
    GALGAS_ipic_31__38_AbstractBlockTerminator var_optimizedTerminator ;
    callCategoryMethod_optimizeTerminator ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, inObject.mAttribute_mLabel.mAttribute_string, ioArgument_ioOptimizationDone, ioArgument_ioListFileContents, var_optimizedTerminator, inCompiler COMMA_SOURCE_FILE_AT_LINE (700)) ;
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mStartAddress, inObject.mAttribute_mLabel, inObject.mAttribute_mInstructionList, var_optimizedTerminator COMMA_SOURCE_FILE_AT_LINE (708)) ;
  }
}
