...
void routine_enterGoto_32_block (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (GALGAS_string ("_computed_goto_2") COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 449)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 449)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (GALGAS_string ("_computed_goto_2")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 450)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (GALGAS_string ("_computed_goto_2").reader_nowhere (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 451)), var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 451)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 452)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 453)) ;
  }
}
...
void routine_enterGoto_34_block (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (GALGAS_string ("_computed_goto_4") COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 468)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 468)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (GALGAS_string ("_computed_goto_4")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 469)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (GALGAS_string ("_computed_goto_4").reader_nowhere (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 470)), var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 470)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 471)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 472)) ;
  }
}
...
void routine_instructionListOptimization (const GALGAS_symbolTableForBlockOptimization constinArgument_inSymbolTable,
  ...
  outArgument_outOptimizedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 955)) ;
  ...
  while (enumerator_35545.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_1 = var_NOPsubstitution.operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 970)).boolEnum () ;
    if (kBoolTrue == test_1) {
      outArgument_outOptimizedInstructionList.addAssign_operation (var_optimizedInstruction  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 971)) ;
    }
...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_optimizeFlagStruct var_optimizeFlagStruct = GALGAS_optimizeFlagStruct::constructor_new (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (69)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1116)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1116)), GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (82)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1117)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1117)), GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (74)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1118)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1118)), GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (77)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1119)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1119)), GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (73)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1120)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1120)), GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (105)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1121)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1121)), GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()).operator_or (GALGAS_string (gOption_piccolo_5F_options_optimizationFlags.reader_value ()).reader_containsCharacter (GALGAS_char (TO_UNICODE (101)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1122)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1122)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1115)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1125)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1125))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1125)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1126))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1126)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1126))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1126)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1127)).operator_concat (GALGAS_string ("\n"
    "\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1127))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1127)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Optimization flags:\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1128)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [D] Dead code elimination: always enabled\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1129)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [E] Empty routine elimination: ").operator_concat (categoryReader_flagValue (var_optimizeFlagStruct.mAttribute_mRemoveEmptyRoutine, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1130))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1130)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1130))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1130)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [e] In Computed RCALL, empty routine call replaced by BLANK: ").operator_concat (categoryReader_flagValue (var_optimizeFlagStruct.mAttribute_mJSRtoEmptyRoutineInComputedRCALLreplacedByBlank, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1131))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1131)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1131))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1131)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [I] Call to one instruction routine replaced by instruction: ").operator_concat (categoryReader_flagValue (var_optimizeFlagStruct.mAttribute_mJSRtoOneInstructionRoutineReplacedByInstruction, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1132))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1132)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1132))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1132)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [i] In Computed RCALL, rcall to one instruction routine replaced by instruction: ").operator_concat (categoryReader_flagValue (var_optimizeFlagStruct.mAttribute_mJSRtoOneInstructionRoutineInComputedRCALLreplacedByInstruction, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1133))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1133)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1133))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1133)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [J] JSR followed by RETURN replaced by JUMP: ").operator_concat (categoryReader_flagValue (var_optimizeFlagStruct.mAttribute_mJSRfollowedByRETreplacedByJUMP, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1134))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1134)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1134))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1134)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [M] MOVLW followed by RETURN replaced by RETLW: ").operator_concat (categoryReader_flagValue (var_optimizeFlagStruct.mAttribute_mMOVLWfollowedByRETreplacedByRETLW, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1135))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1135)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1135))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1135)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [P] JUMP propagation: always enabled\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1136)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [R] Call to RETLW replaced by MOVLW: ").operator_concat (categoryReader_flagValue (var_optimizeFlagStruct.mAttribute_mJSRtoRETLWreplacedByMOVLW, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1137))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1137)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1137))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1137)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [U] Useless test elimination: always enabled\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1138)) ;
  const enumGalgasBool test_0 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->printMessage (GALGAS_string ("Optimizations:\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1140)) ;
  }
  GALGAS_bool var_optimizationDone = GALGAS_bool (true) ;
  GALGAS_uint var_optimizationPass = GALGAS_uint ((uint32_t) 0U) ;
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1145)).isValid ()) {
    uint32_t variant_43608 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1145)).uintValue () ;
    bool loop_43608 = true ;
    while (loop_43608) {
      loop_43608 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1146)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1146)).isValid () ;
      if (loop_43608) {
        loop_43608 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1146)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1146)).boolValue () ;
      }
      if (loop_43608 && (0 == variant_43608)) {
        loop_43608 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1145)) ;
      }
      if (loop_43608) {
        variant_43608 -- ;
        var_optimizationDone = GALGAS_bool (false) ;
        var_optimizationPass = var_optimizationPass.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1148)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n"
          "--- Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149)).operator_concat (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149)).reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149)).operator_concat (GALGAS_string (" blocks)\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1149)) ;
        GALGAS_uint var_blockCountBeforeOptimization = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1150)) ;
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("  Pass ").operator_concat (var_optimizationPass.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1152))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1152)).operator_concat (GALGAS_string (" : ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1152)).operator_concat (var_blockCountBeforeOptimization.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1152))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1152)).operator_concat (GALGAS_string (" blocks.\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1152))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1152)) ;
        }
        GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1155)) ;
        ...
        while (enumerator_44275.hasCurrentObject ()) {
          {
          var_symbolTable.modifier_insertKey (enumerator_44275.current_mBlock (HERE).mAttribute_mLabel, index_44254, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1157)) ;
          }
          enumerator_44275.gotoNextObject () ;
          index_44254.increment_operation (inCompiler  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1156)) ;
        }
        GALGAS_stringset var_referencedBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1160)) ;
        ...
        while (enumerator_44518.hasCurrentObject ()) {
          const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_44518.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1162)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            categoryMethod_enterReferencedLabels (enumerator_44518.current_mBlock (HERE), var_symbolTable, ioArgument_ioGeneratedBlockList, var_referencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1163)) ;
          }
          enumerator_44518.gotoNextObject () ;
        }
        GALGAS_ipic_31__38_BlockList var_optimizedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1171)) ;
        ...
        while (enumerator_44898.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_referencedBlockSet.reader_hasKey (enumerator_44898.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1173)).operator_or (GALGAS_bool (kIsNotEqual, enumerator_44898.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1173)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1173)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_ipic_31__38_Block var_optimizedBlock ;
            categoryMethod_optimize (enumerator_44898.current_mBlock (HERE), var_symbolTable, var_optimizeFlagStruct, ioArgument_ioGeneratedBlockList, var_optimizationDone, ioArgument_ioListFileContents, var_optimizedBlock, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1174)) ;
            var_optimizedBlockList.addAssign_operation (var_optimizedBlock  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1182)) ;
          }else if (kBoolFalse == test_3) {
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [D] ").operator_concat (enumerator_44898.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1184))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1184)).operator_concat (GALGAS_string (": not referenced, deleted\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1184))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1184)) ;
...
static void categoryMethod_ipic_31__38_JumpTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mLabel, var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 62)) ;
    GALGAS_ipic_31__38_Block var_targetBlock = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 63)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 64)))).operator_and (GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 65)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 64)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_SingleInstructionTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 65)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      if (kBoolTrue == test_3) {
        ...
        if (var_targetBlock.mAttribute_mTerminator.isValid ()) {
          if (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) {
            ...
            inCompiler->castError ("ipic_31__38_JumpTerminator", var_targetBlock.mAttribute_mTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 69)) ;
          }
        }
        GALGAS_ipic_31__38_JumpTerminator var_candidate = temp_4 ;
        var_optimize = GALGAS_bool (kIsNotEqual, object->mAttribute_mLabel.mAttribute_string.objectCompare (var_candidate.reader_mLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 70)).mAttribute_string)) ;
      }else if (kBoolFalse == test_3) {
      ...
      if (kBoolTrue == test_5) {
        ...
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [P] ").operator_concat (constinArgument_inBlockLabel  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 77)).operator_concat (GALGAS_string (": ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 77))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 77)) ;
        const GALGAS_ipic_31__38_JumpTerminator temp_6 = object ;
        ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_JumpTerminator *) temp_6.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 78))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 78)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 79)) ;
        ioArgument_ioListFileContents.dotAssign_operation (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_AbstractBlockTerminator *) outArgument_outOptimizedTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 80))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 80)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 81)) ;
      }
    }
  }
}
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_0) {
    outArgument_outOptimizedTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabelWhenFalse, GALGAS_jumpInstructionKind::constructor_ipicRelative (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 103))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 100)) ;
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [U] ").operator_concat (constinArgument_inBlockLabel  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 106)).operator_concat (GALGAS_string (", useless terminator condition: replaced by JUMP ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 106)).operator_concat (object->mAttribute_mTargetLabelWhenFalse.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 106))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 106)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 106))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 106)) ;
    inCompiler->emitSemanticWarning (object->mAttribute_mInstructionLocation, GALGAS_string ("useless condition deleted")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 107)) ;
    ...
    if (kBoolTrue == test_1) {
      GALGAS_uint var_targetBlockIndex ;
      constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabelWhenTrue, var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 113)) ;
      GALGAS_ipic_31__38_Block var_targetBlock = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 114)) ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 115)))).operator_and (GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 116)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 115)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 116)).boolEnum () ;
      if (kBoolTrue == test_2) {
        ...
        if (var_targetBlock.mAttribute_mTerminator.isValid ()) {
          if (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) {
            ...
            inCompiler->castError ("ipic_31__38_JumpTerminator", var_targetBlock.mAttribute_mTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 118)) ;
          }
        }
        GALGAS_ipic_31__38_JumpTerminator var_jp = temp_3 ;
        var_targetLabelWhenTrue = var_jp.reader_mLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 119)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [P] ").operator_concat (constinArgument_inBlockLabel  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 121)).operator_concat (GALGAS_string (", jump optimization: ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 121))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 121)) ;
        ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mTargetLabelWhenTrue.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 122)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 123)) ;
        ioArgument_ioListFileContents.dotAssign_operation (var_targetLabelWhenTrue.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 124)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 125)) ;
      }
    }
    ...
    if (kBoolTrue == test_4) {
      GALGAS_uint var_targetBlockIndex ;
      constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabelWhenFalse, var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 131)) ;
      GALGAS_ipic_31__38_Block var_targetBlock = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 132)) ;
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 133)))).operator_and (GALGAS_bool (kIsEqual, var_targetBlock.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 134)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 133)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 134)).boolEnum () ;
      if (kBoolTrue == test_5) {
        ...
        if (var_targetBlock.mAttribute_mTerminator.isValid ()) {
          if (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (var_targetBlock.mAttribute_mTerminator.ptr ())) {
            ...
            inCompiler->castError ("ipic_31__38_JumpTerminator", var_targetBlock.mAttribute_mTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 136)) ;
          }
        }
        GALGAS_ipic_31__38_JumpTerminator var_jp = temp_6 ;
        var_targetLabelWhenFalse = var_jp.reader_mLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 137)) ;
        var_optimized = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [P] ").operator_concat (constinArgument_inBlockLabel  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 139)).operator_concat (GALGAS_string (", jump optimization: ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 139))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 139)) ;
        ioArgument_ioListFileContents.dotAssign_operation (object->mAttribute_mTargetLabelWhenFalse.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 140)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" -> ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 141)) ;
        ioArgument_ioListFileContents.dotAssign_operation (var_targetLabelWhenFalse.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 142)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 143)) ;
      }
    }
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_getOptimizedTerminators (const cPtr_ipic_31__38_AbstractConditionTerminator * inObject,
  ...
  if (var_optimizedTrueTerminator.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_ipic_31__38_SingleInstructionTerminator *> (var_optimizedTrueTerminator.ptr ())) {
      ...
      inCompiler->castError ("ipic_31__38_SingleInstructionTerminator", var_optimizedTrueTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 186)) ;
    }
  }
    ...
    if (kBoolTrue == test_3) {
      ...
      if (outArgument_outOptimizedTrueTerminator.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (outArgument_outOptimizedTrueTerminator.ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38_RetlwTerminator", outArgument_outOptimizedTrueTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 202)) ;
        }
      }
      ...
      if (outArgument_outOptimizedFalseTerminator.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (outArgument_outOptimizedFalseTerminator.ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38_RetlwTerminator", outArgument_outOptimizedFalseTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 203)) ;
        }
      }
      GALGAS_ipic_31__38_RetlwTerminator var_f = temp_5 ;
      outArgument_outIdenticalTerminators = GALGAS_bool (kIsEqual, var_t.reader_mLiteralValue (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 204)).objectCompare (var_f.reader_mLiteralValue (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 204)))) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_6 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (outArgument_outOptimizedTrueTerminator.ptr ())).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (outArgument_outOptimizedFalseTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 205)).boolEnum () ;
      if (kBoolTrue == test_6) {
        ...
        if (outArgument_outOptimizedTrueTerminator.isValid ()) {
          if (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (outArgument_outOptimizedTrueTerminator.ptr ())) {
            ...
            inCompiler->castError ("ipic_31__38_JumpTerminator", outArgument_outOptimizedTrueTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 206)) ;
          }
        }
        ...
        if (outArgument_outOptimizedFalseTerminator.isValid ()) {
          if (NULL != dynamic_cast <const cPtr_ipic_31__38_JumpTerminator *> (outArgument_outOptimizedFalseTerminator.ptr ())) {
            ...
            inCompiler->castError ("ipic_31__38_JumpTerminator", outArgument_outOptimizedFalseTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 207)) ;
          }
        }
        GALGAS_ipic_31__38_JumpTerminator var_f = temp_8 ;
        outArgument_outIdenticalTerminators = GALGAS_bool (kIsEqual, var_t.reader_mLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 208)).objectCompare (var_f.reader_mLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 208)))) ;
...
static void categoryMethod_ipic_31__38_IncDecRegisterTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("useless decf/incf condition should be replaced by decf/incf instruction")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 240)) ;
...
static void categoryMethod_pic_31__38_BitTestTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [U] ").operator_concat (constinArgument_inBlockLabel  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 283)).operator_concat (GALGAS_string (", useless terminator condition: replaced by ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 283)).operator_concat (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_SingleInstructionTerminator *) var_optimizedTrueTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 283))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 283)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 283))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 283)) ;
    inCompiler->emitSemanticWarning (object->mAttribute_mInstructionLocation, GALGAS_string ("useless condition deleted")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 284)) ;
  }else if (kBoolFalse == test_1) {
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_1) {
    outArgument_outOptimizedTerminator = var_optimizedTrueTerminator ;
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [U] ").operator_concat (constinArgument_inBlockLabel  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 325)).operator_concat (GALGAS_string (", useless terminator condition: replaced by ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 325)).operator_concat (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_SingleInstructionTerminator *) var_optimizedTrueTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 325))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 325)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 325))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 325)) ;
    inCompiler->emitSemanticWarning (object->mAttribute_mInstructionLocation, GALGAS_string ("useless condition deleted")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 326)) ;
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_2 = var_optimization.boolEnum () ;
    if (kBoolTrue == test_2) {
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_optimizeTerminator (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_1) {
    outArgument_outOptimizedTerminator = var_optimizedTrueTerminator ;
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [U] ").operator_concat (constinArgument_inBlockLabel  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 367)).operator_concat (GALGAS_string (", useless terminator condition: replaced by ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 367)).operator_concat (callCategoryReader_terminatorDisplay ((const cPtr_ipic_31__38_SingleInstructionTerminator *) var_optimizedTrueTerminator.ptr (), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 367))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 367)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 367))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 367)) ;
    inCompiler->emitSemanticWarning (object->mAttribute_mInstructionLocation, GALGAS_string ("useless condition deleted")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 368)) ;
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_2 = var_optimization.boolEnum () ;
    if (kBoolTrue == test_2) {
      outArgument_outOptimizedTerminator = GALGAS_pic_31__38_TestRegisterTerminator::constructor_new (object->mAttribute_mInstructionLocation, var_optimizedTrueTerminator, var_optimizedFalseTerminator, object->mAttribute_mRegisterDescription  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 370)) ;
      ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    }else if (kBoolFalse == test_2) {
...
static void categoryMethod_ipic_31__38_ComputedRETLWTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                                ...
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_enterGoto_32_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 495)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  macroValidSharedObject (object, cPtr_ipic_31__38_ComputedBraTerminator) ;
  {
  routine_enterGoto_32_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 509)) ;
  }
  ...
  while (enumerator_19205.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_19205.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 515)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 515)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_19205.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 516)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_19205.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 517)) ;
      GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 518)) ;
      categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 519)) ;
    }
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  macroValidSharedObject (object, cPtr_ipic_31__38_ComputedGotoTerminator) ;
  {
  routine_enterGoto_34_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 535)) ;
  }
  ...
  while (enumerator_20000.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (enumerator_20000.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 541)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 541)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioReferencedBlockSet.addAssign_operation (enumerator_20000.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 542)) ;
      GALGAS_uint var_blockIndex ;
      constinArgument_inSymbolTable.method_searchKey (enumerator_20000.current_mValue (HERE), var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 543)) ;
      GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 544)) ;
      categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 545)) ;
    }
...
static void categoryMethod_ipic_31__38_JumpTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_JumpTerminator * object = (const cPtr_ipic_31__38_JumpTerminator *) inObject ;
  macroValidSharedObject (object, cPtr_ipic_31__38_JumpTerminator) ;
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 561)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 561)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mLabel.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 562)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mLabel, var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 563)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 564)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 565)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_enterTerminatorReferencedLabels (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_ConditionalJumpTerminator * object = (const cPtr_ipic_31__38_ConditionalJumpTerminator *) inObject ;
  macroValidSharedObject (object, cPtr_ipic_31__38_ConditionalJumpTerminator) ;
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mTargetLabelWhenTrue.mAttribute_string COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 580)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 580)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mTargetLabelWhenTrue.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 581)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabelWhenTrue, var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 582)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 583)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 584)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mTargetLabelWhenFalse.mAttribute_string COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 590)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 590)).boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mTargetLabelWhenFalse.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 591)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabelWhenFalse, var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 592)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 593)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 594)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = ioArgument_ioReferencedBlockSet.reader_hasKey (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 642)).operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 642)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioReferencedBlockSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 643)) ;
    GALGAS_uint var_blockIndex ;
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 644)) ;
    GALGAS_ipic_31__38_Block var_b = constinArgument_inBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 645)) ;
    categoryMethod_enterReferencedLabels (var_b, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 646)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  {
  routine_enterGoto_34_block (constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 661)) ;
  }
  ...
  while (enumerator_24532.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_24532.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 667)) ;
...
static void categoryMethod_ipic_31__38__5F_condition_5F_skip_5F_instruction_enterInstructionReferencedLabels (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 682)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_uint var_targetBlockIndex ;
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 726)) ;
  GALGAS_ipic_31__38_Block var_targetBloc = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 727)) ;
  const enumGalgasBool test_1 = constinArgument_inOptimizeFlagStruct.mAttribute_mRemoveEmptyRoutine.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 730)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 729)).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 731)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 730)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 731)).boolEnum () ;
  if (kBoolTrue == test_1) {
    outArgument_outOptimizationDone = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [E] ").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 734))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 734)).operator_concat (GALGAS_string (": ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 734))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 734)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to empty ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 735))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 735)).operator_concat (GALGAS_string (" routine deleted")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 735))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 735)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 736)) ;
    outArgument_outOptimizedInstruction = GALGAS_ipic_31__38_InstructionWithNoOperand::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_pic_31__38_InstructionWithNoOperandKind::constructor_NOP (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 737))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 737)) ;
    outArgument_outNOPsubstitution = GALGAS_bool (true) ;
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_2 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoRETLWreplacedByMOVLW.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 741)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 740)).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 742)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 741)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 742)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      if (var_targetBloc.mAttribute_mTerminator.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38_RetlwTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38_RetlwTerminator", var_targetBloc.mAttribute_mTerminator.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 744)) ;
        }
      }
      GALGAS_ipic_31__38_RetlwTerminator var_t = temp_3 ;
      outArgument_outOptimizationDone = GALGAS_bool (true) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [R] ").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 746))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 746)).operator_concat (GALGAS_string (": ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 746))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 746)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to RETLW ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 747))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 747)).operator_concat (GALGAS_string (" routine transformed to MOVLW")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 747))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 747)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 748)) ;
      outArgument_outOptimizedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation::constructor_new (object->mAttribute_mInstructionLocation, GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 751)), var_t.reader_mLiteralValue (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 752))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 749)) ;
    }else if (kBoolFalse == test_2) {
      const enumGalgasBool test_4 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoOneInstructionRoutineReplacedByInstruction.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 756)).objectCompare (GALGAS_uint ((uint32_t) 1U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 755)).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 757)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 756)).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 757)).boolEnum () ;
      if (kBoolTrue == test_4) {
        outArgument_outOptimizedInstruction = var_targetBloc.mAttribute_mInstructionList.reader_mInstructionAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 759)) ;
        outArgument_outOptimizationDone = GALGAS_bool (true) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [I] ").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 761))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 761)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 761))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 761)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("call to single instruction routine ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 762))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 762)).operator_concat (GALGAS_string (" replaced by this single instruction")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 762))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 762)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 763)) ;
      }
    }
  }
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outOptimizationDone = GALGAS_bool (false) ;
  outArgument_outNOPsubstitution = GALGAS_bool (false) ;
  GALGAS_ipic_31__38_SequentialInstructionList var_optimizedInstructionList = GALGAS_ipic_31__38_SequentialInstructionList::constructor_emptyList (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 782)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      if (enumerator_29422.current_mInstruction (HERE).isValid ()) {
        if (NULL != dynamic_cast <const cPtr_ipic_31__38__5F_intermediate_5F_JSR *> (enumerator_29422.current_mInstruction (HERE).ptr ())) {
          ...
          inCompiler->castError ("ipic_31__38__5F_intermediate_5F_JSR", enumerator_29422.current_mInstruction (HERE).ptr ()->classDescriptor () COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 786)) ;
        }
      }
      GALGAS_ipic_31__38__5F_intermediate_5F_JSR var_jsr = temp_1 ;
      GALGAS_uint var_targetBlockIndex ;
      constinArgument_inSymbolTable.method_searchKey (var_jsr.reader_mTargetLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 787)), var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 787)) ;
      GALGAS_ipic_31__38_Block var_targetBloc = constinArgument_inBlockList.reader_mBlockAtIndex (var_targetBlockIndex, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 788)) ;
      const enumGalgasBool test_2 = GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (var_targetBloc.mAttribute_mTerminator.ptr ())).operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 790)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 789)).boolEnum () ;
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoEmptyRoutineInComputedRCALLreplacedByBlank.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 792)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 791)).boolEnum () ;
        if (kBoolTrue == test_3) {
          var_opt = GALGAS_bool (true) ;
          outArgument_outOptimizationDone = GALGAS_bool (true) ;
          var_optimizedInstructionList.addAssign_operation (GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_BLANK::constructor_new (var_jsr.reader_mInstructionLocation (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 795)), GALGAS_uint ((uint32_t) 0U)  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 795))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 795)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [e] ").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 796))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 796)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 796))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 796)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("JSR ").operator_concat (var_jsr.reader_mTargetLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 797)).reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 797))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 797)).operator_concat (GALGAS_string (" to empty routine replaced by BLANK 0")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 797))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 797)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 798)) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_4 = constinArgument_inOptimizeFlagStruct.mAttribute_mJSRtoOneInstructionRoutineInComputedRCALLreplacedByInstruction.operator_and (GALGAS_bool (kIsEqual, var_targetBloc.mAttribute_mInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 800)).objectCompare (GALGAS_uint ((uint32_t) 1U))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 799)).boolEnum () ;
          if (kBoolTrue == test_4) {
            GALGAS_ipic_31__38_SequentialInstruction var_inst = var_targetBloc.mAttribute_mInstructionList.reader_mInstructionAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 801)) ;
            const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, callCategoryReader_instructionSize ((const cPtr_ipic_31__38_SequentialInstruction *) var_inst.ptr (), inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 802)).objectCompare (GALGAS_uint ((uint32_t) 2U))).boolEnum () ;
            if (kBoolTrue == test_5) {
              var_opt = GALGAS_bool (true) ;
              outArgument_outOptimizationDone = GALGAS_bool (true) ;
              var_optimizedInstructionList.addAssign_operation (var_inst  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 805)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [i] ").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 806))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 806)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 806))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 806)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("JSR ").operator_concat (var_jsr.reader_mTargetLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 807)).reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 807))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 807)).operator_concat (GALGAS_string (" to one instruction routine replaced by routine instruction")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 807))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 807)) ;
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 808)) ;
            }
          }
        }
      }
    }
    const enumGalgasBool test_6 = var_opt.operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 813)).boolEnum () ;
    if (kBoolTrue == test_6) {
      var_optimizedInstructionList.addAssign_operation (enumerator_29422.current_mInstruction (HERE)  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 814)) ;
    }
    enumerator_29422.gotoNextObject () ;
  }
  const enumGalgasBool test_7 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_7) {
    outArgument_outOptimizedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::constructor_new (object->mAttribute_mInstructionLocation, var_optimizedInstructionList, object->mAttribute_mUsesRCALL  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 818)) ;
  }else if (kBoolFalse == test_7) {
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_33458_0, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 879)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_optimizeInstruction (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_optimizeInstruction ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inSymbolTable, constinArgument_inOptimizeFlagStruct, constinArgument_inBlockList, constinArgument_inBlockLabel, outArgument_outOptimizationDone, ioArgument_ioListFileContents, var_optimizedEmbeddedInstruction, joker_34500_0, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 915)) ;
  const enumGalgasBool test_0 = outArgument_outOptimizationDone.boolEnum () ;
  if (kBoolTrue == test_0) {
...
void categoryMethod_enterInstructionReferencedLabels (const GALGAS_ipic_31__38_SequentialInstructionList inObject,
  ...
  while (enumerator_36443.hasCurrentObject ()) {
    callCategoryMethod_enterInstructionReferencedLabels ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_36443.current_mInstruction (HERE).ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 988)) ;
...
void categoryMethod_enterReferencedLabels (const GALGAS_ipic_31__38_Block inObject,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  categoryMethod_enterInstructionReferencedLabels (inObject.mAttribute_mInstructionList, constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1003)) ;
  callCategoryMethod_enterTerminatorReferencedLabels ((const cPtr_ipic_31__38_AbstractBlockTerminator *) inObject.mAttribute_mTerminator.ptr (), constinArgument_inSymbolTable, constinArgument_inBlockList, ioArgument_ioReferencedBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1008)) ;
}
...
void categoryMethod_optimize (const GALGAS_ipic_31__38_Block inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_optimizedInstructionList.reader_length (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1038)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (NULL != dynamic_cast <const cPtr_ipic_31__38_ReturnTerminator *> (inObject.mAttribute_mTerminator.ptr ())) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1038)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_ipic_31__38_SequentialInstruction var_lastInstruction ;
    var_optimizedInstructionList.method_last (var_lastInstruction, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1039)) ;
    if (var_lastInstruction.isValid ()) {
      if (var_lastInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation) {
        ...
        const enumGalgasBool test_1 = constinArgument_inOptimizeFlagStruct.mAttribute_mMOVLWfollowedByRETreplacedByRETLW.operator_and (GALGAS_bool (kIsEqual, cast_38090_op.reader_mLiteralInstruction (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1042)).objectCompare (GALGAS_literal_5F_instruction_5F_opcode::constructor_MOVLW (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1042)))) COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1042)).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          GALGAS_ipic_31__38_SequentialInstruction joker_38277_0 ; // Joker input parameter
          var_optimizedInstructionList.modifier_popLast (joker_38277_0, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1043)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_RetlwTerminator::constructor_new (cast_38090_op.reader_mInstructionLocation (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1044)), cast_38090_op.reader_mLiteralValue (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1044))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1044)) ;
          var_optimized = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [M] ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1046))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1046)).operator_concat (GALGAS_string (": MOVLW k ; RETURN --> RETLW k\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1046))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1046)) ;
        }
        ...
        if (kBoolTrue == test_2) {
          ...
          var_optimizedInstructionList.modifier_popLast (joker_38727_0, inCompiler COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1051)) ;
          }
          var_optimizedTerminator = GALGAS_ipic_31__38_JumpTerminator::constructor_new (cast_38611_jsr.reader_mInstructionLocation (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1052)), cast_38611_jsr.reader_mTargetLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1052)), cast_38611_jsr.reader_mKind (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1052))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1052)) ;
          var_optimized = GALGAS_bool (true) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  [J] ").operator_concat (inObject.mAttribute_mLabel.reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)).operator_concat (GALGAS_string (": JSR ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)).operator_concat (cast_38611_jsr.reader_mTargetLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)).reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)).operator_concat (GALGAS_string (" ; RETURN --> JUMP ")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)).operator_concat (cast_38611_jsr.reader_mTargetLabel (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)).reader_string (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054))  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1054)) ;
        }
      }
    }
  }
  const enumGalgasBool test_3 = var_optimized.operator_not (SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1061)).boolEnum () ;
  if (kBoolTrue == test_3) {
  ...
  if (kBoolTrue == test_4) {
    ioArgument_ioOptimizationDone = GALGAS_bool (true) ;
    outArgument_outOptimizedBlock = GALGAS_ipic_31__38_Block::constructor_new (inObject.mAttribute_mAddress, inObject.mAttribute_mLabel, var_optimizedInstructionList, var_optimizedTerminator  COMMA_SOURCE_FILE ("ipic18_optimize_block.gSemantics", 1075)) ;
