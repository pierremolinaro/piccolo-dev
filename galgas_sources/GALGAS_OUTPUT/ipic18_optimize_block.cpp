...
void routine_ipic_31__38_OptimizeBlocks (GALGAS_string & ioArgument_ioListFileContents,
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1145)).isValid ()) {
    uint32_t variant_43626 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (1145)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1145)).uintValue () ;
    bool loop_43626 = true ;
    while (loop_43626) {
      loop_43626 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1146)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE_AT_LINE (1146)).isValid () ;
      if (loop_43626) {
        loop_43626 = var_optimizationDone.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1146)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE_AT_LINE (1146)).boolValue () ;
      }
      ...
      if (loop_43626) {
        ...
        GALGAS_uint index_44272 ((uint32_t) 0) ;
