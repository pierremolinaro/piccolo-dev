...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  inter block jump count before optimization: ").operator_concat (var_n.reader_string (SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)) ;
  ...
  GALGAS_symbolTableForBlockOptimization var_symbolTable = GALGAS_symbolTableForBlockOptimization::constructor_emptyMap (SOURCE_FILE_AT_LINE (432)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13802 (ioArgument_ioBlockList, kEnumeration_up) ;
  GALGAS_uint index_13796 ((PMUInt32) 0) ;
  while (enumerator_13802.hasCurrentObject ()) {
    {
    var_symbolTable.modifier_insertKey (enumerator_13802.current_mBlock (HERE).mAttribute_mLabel, index_13796, inCompiler COMMA_SOURCE_FILE_AT_LINE (434)) ;
    }
    enumerator_13802.gotoNextObject () ;
    index_13796.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) ;
  }
  GALGAS_blockInvocationGraph var_g = GALGAS_blockInvocationGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (437)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_13963 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_13963.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_13963.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (439)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      var_g.modifier_addNode (enumerator_13963.current_mBlock (HERE).mAttribute_mLabel, enumerator_13963.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) ;
      }
      callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_13963.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_13963.current_mBlock (HERE).mAttribute_mLabel, var_g, inCompiler COMMA_SOURCE_FILE_AT_LINE (441)) ;
    }
    enumerator_13963.gotoNextObject () ;
  }
  GALGAS_bool joker_14334_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (445)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (445)), joker_14334_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (445)) ;
  {
  var_g.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (446)) ;
  }
  GALGAS_bool joker_14481_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (447)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraintsWoCycle.dot") COMMA_SOURCE_FILE_AT_LINE (447)), joker_14481_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (447)) ;
  GALGAS_lstringlist var_nodeList ;
  GALGAS_stringlist joker_14521_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14521_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (449)) ;
  GALGAS_stringlist var_newOrderedLabelList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (450)) ;
  GALGAS_stringset var_visitedNodeSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (451)) ;
  cEnumerator_lstringlist enumerator_14659 (var_nodeList, kEnumeration_up) ;
  while (enumerator_14659.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14659.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (454)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (453)) ;
    cEnumerator_stringlist enumerator_14814 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (457)), kEnumeration_up) ;
    while (enumerator_14814.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14814.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (458)) ;
      enumerator_14814.gotoNextObject () ;
    }
    {
    var_gg.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (460)) ;
    }
    GALGAS_stringlist var_partialOrderedLabelList ;
    GALGAS_lstringlist joker_15011_3 ; // Joker input parameter
    GALGAS_stringlist joker_15011_2 ; // Joker input parameter
    GALGAS_lstringlist joker_15011_1 ; // Joker input parameter
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (461)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_15011_3, joker_15011_2, joker_15011_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
    var_newOrderedLabelList.dotAssign_operation (var_partialOrderedLabelList COMMA_SOURCE_FILE_AT_LINE (465)) ;
    enumerator_14659.gotoNextObject () ;
  }
  GALGAS_ipic_31__38_BlockList var_orderedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (473)) ;
  GALGAS_bool var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_15406 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_2 = var_continue.isValidAndTrue () ;
  if (enumerator_15406.hasCurrentObject () && bool_2) {
    while (enumerator_15406.hasCurrentObject () && bool_2) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_15406.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (477)))) ;
      const enumGalgasBool test_3 = var_continue.boolEnum () ;
      if (kBoolTrue == test_3) {
        var_orderedBlockList.addAssign_operation (enumerator_15406.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (479)) ;
      }
      enumerator_15406.gotoNextObject () ;
      if (enumerator_15406.hasCurrentObject ()) {
        bool_2 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_stringlist enumerator_15620 (var_newOrderedLabelList, kEnumeration_up) ;
  while (enumerator_15620.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_15620.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (484)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (484)) ;
    GALGAS_ipic_31__38_Block var_b = ioArgument_ioBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (485)) ;
    var_orderedBlockList.addAssign_operation (var_b COMMA_SOURCE_FILE_AT_LINE (486)) ;
    enumerator_15620.gotoNextObject () ;
  }
  GALGAS_uint var_insertionIndex = var_orderedBlockList.reader_length (SOURCE_FILE_AT_LINE (489)) ;
  var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_15964 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_4 = var_continue.isValidAndTrue () ;
  if (enumerator_15964.hasCurrentObject () && bool_4) {
    while (enumerator_15964.hasCurrentObject () && bool_4) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_15964.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (492)))) ;
      const enumGalgasBool test_5 = var_continue.boolEnum () ;
      if (kBoolTrue == test_5) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_15964.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (494)) ;
        }
      }
      enumerator_15964.gotoNextObject () ;
      if (enumerator_15964.hasCurrentObject ()) {
        bool_4 = var_continue.isValidAndTrue () ;
      }
    }
  }
  GALGAS_uint var_p = function_blockDiscontinuityCount (var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  inter block jump count after optimization: ").operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (499)) COMMA_SOURCE_FILE_AT_LINE (499)).operator_concat (GALGAS_string ("\n"
  ...
  if (kBoolTrue == test_6) {
    inCompiler->printMessage (GALGAS_string ("  inter block jump count: ").operator_concat (var_n.reader_string (SOURCE_FILE_AT_LINE (501)) COMMA_SOURCE_FILE_AT_LINE (501)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (501)).operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (501)) COMMA_SOURCE_FILE_AT_LINE (501)).operator_concat (GALGAS_string (".\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (501)) COMMA_SOURCE_FILE_AT_LINE (501)) ;
  }
  GALGAS_stringset var_newSymbolSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (504)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_16576 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_16576.hasCurrentObject ()) {
    const enumGalgasBool test_7 = var_newSymbolSet.reader_hasKey (enumerator_16576.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (507)).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16576.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (509)) COMMA_SOURCE_FILE_AT_LINE (509)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (509)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (511)), var_s COMMA_SOURCE_FILE_AT_LINE (511)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_16576.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (515)) ;
    }
    enumerator_16576.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_16967 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_16967.hasCurrentObject ()) {
    const enumGalgasBool test_8 = var_newSymbolSet.reader_hasKey (enumerator_16967.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (519)).operator_not (SOURCE_FILE_AT_LINE (519)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16967.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (521)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (521)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (523)), var_s COMMA_SOURCE_FILE_AT_LINE (523)) ;
      ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
  ...
  if (kBoolTrue == test_9) {
    ...
    {
    routine_displayBlockList (GALGAS_string ("ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (531)) ;
    }
    ...
    inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (534)), var_s COMMA_SOURCE_FILE_AT_LINE (534)) ;
    ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (535)) COMMA_SOURCE_FILE_AT_LINE (535)) ;
    {
    routine_displayBlockList (GALGAS_string ("INCONSISTENT ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION (not used)"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (536)) ;
    }
  }
}
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18093 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_18093.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18093.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (548)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_18209 (enumerator_18093.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
      while (enumerator_18209.hasCurrentObject ()) {
        callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_18209.current_mInstruction (HERE).ptr (), enumerator_18093.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (550)) ;
        enumerator_18209.gotoNextObject () ;
      }
      callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18093.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_18093.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
    }
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18721 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_18715 ((PMUInt32) 0) ;
  while (enumerator_18721.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18721.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (566)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_18715.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (568)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (568)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_18715.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (569)), inCompiler COMMA_SOURCE_FILE_AT_LINE (569)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18721.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (573)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (574)) ;
      }
    }
    enumerator_18721.gotoNextObject () ;
    index_18715.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  {
  routine_buildInvocationGraph (ioArgument_ioGeneratedBlockList, var_invocationGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
  }
  GALGAS_bool joker_19593_0 ; // Joker input parameter
  var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (589)), joker_19593_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (589)) ;
  {
  routine_buildOrderedGraph (ioArgument_ioGeneratedBlockList, constinArgument_inSourceFileName, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
  }
}
