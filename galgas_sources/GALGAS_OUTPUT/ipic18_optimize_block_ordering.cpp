...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (421)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (421)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("BLOCK REPRESENTATION ORDERING OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (423)).operator_concat (GALGAS_string ("\n"
  ...
  GALGAS_uint var_n = function_blockDiscontinuityCount (ioArgument_ioBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  discontinuity count before optimization: ").operator_concat (var_n.reader_string (SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->printMessage (GALGAS_string ("  discontinuity count before optimization: ").operator_concat (var_n.reader_string (SOURCE_FILE_AT_LINE (430)) COMMA_SOURCE_FILE_AT_LINE (430)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (430)) COMMA_SOURCE_FILE_AT_LINE (430)) ;
  }
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_13870 (ioArgument_ioBlockList, kEnumeration_up) ;
  GALGAS_uint index_13864 ((PMUInt32) 0) ;
  while (enumerator_13870.hasCurrentObject ()) {
    {
    var_symbolTable.modifier_insertKey (enumerator_13870.current_mBlock (HERE).mAttribute_mLabel, index_13864, inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) ;
    }
    enumerator_13870.gotoNextObject () ;
    index_13864.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (434)) ;
  }
  GALGAS_blockInvocationGraph var_g = GALGAS_blockInvocationGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (438)) ;
  cEnumerator_ipic_31__38_BlockList enumerator_14031 (ioArgument_ioBlockList, kEnumeration_up) ;
  while (enumerator_14031.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_14031.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (440)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      var_g.modifier_addNode (enumerator_14031.current_mBlock (HERE).mAttribute_mLabel, enumerator_14031.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (441)) ;
      }
      callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_14031.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_14031.current_mBlock (HERE).mAttribute_mLabel, var_g, inCompiler COMMA_SOURCE_FILE_AT_LINE (442)) ;
    }
    enumerator_14031.gotoNextObject () ;
  }
  GALGAS_bool joker_14402_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (446)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraints.dot") COMMA_SOURCE_FILE_AT_LINE (446)), joker_14402_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (446)) ;
  {
  var_g.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (447)) ;
  }
  GALGAS_bool joker_14549_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (448)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockOrderingConstraintsWoCycle.dot") COMMA_SOURCE_FILE_AT_LINE (448)), joker_14549_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (448)) ;
  GALGAS_lstringlist var_nodeList ;
  GALGAS_stringlist joker_14589_0 ; // Joker input parameter
  var_g.method_nodesWithNoPredecessor (joker_14589_0, var_nodeList COMMA_SOURCE_FILE_AT_LINE (450)) ;
  GALGAS_stringlist var_newOrderedLabelList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (451)) ;
  GALGAS_stringset var_visitedNodeSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (452)) ;
  cEnumerator_lstringlist enumerator_14727 (var_nodeList, kEnumeration_up) ;
  while (enumerator_14727.hasCurrentObject ()) {
    GALGAS_blockInvocationGraph var_gg = var_g.reader_subgraphFromNodes (GALGAS_lstringlist::constructor_listWithValue (enumerator_14727.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (455)), var_visitedNodeSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (454)) ;
    cEnumerator_stringlist enumerator_14882 (var_gg.reader_keyList (SOURCE_FILE_AT_LINE (458)), kEnumeration_up) ;
    while (enumerator_14882.hasCurrentObject ()) {
      var_visitedNodeSet.addAssign_operation (enumerator_14882.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (459)) ;
      enumerator_14882.gotoNextObject () ;
    }
    {
    var_gg.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (461)) ;
    }
    GALGAS_stringlist var_partialOrderedLabelList ;
    GALGAS_lstringlist joker_15079_3 ; // Joker input parameter
    GALGAS_stringlist joker_15079_2 ; // Joker input parameter
    GALGAS_lstringlist joker_15079_1 ; // Joker input parameter
    var_gg.reader_reversedGraph (SOURCE_FILE_AT_LINE (462)).method_depthFirstTopologicalSort (var_partialOrderedLabelList, joker_15079_3, joker_15079_2, joker_15079_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) ;
    var_newOrderedLabelList.dotAssign_operation (var_partialOrderedLabelList COMMA_SOURCE_FILE_AT_LINE (466)) ;
    enumerator_14727.gotoNextObject () ;
  }
  GALGAS_ipic_31__38_BlockList var_orderedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (474)) ;
  ...
  if (enumerator_15474.hasCurrentObject () && bool_2) {
    while (enumerator_15474.hasCurrentObject () && bool_2) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_15474.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (478)))) ;
      const enumGalgasBool test_3 = var_continue.boolEnum () ;
      if (kBoolTrue == test_3) {
        var_orderedBlockList.addAssign_operation (enumerator_15474.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (480)) ;
      }
  ...
  while (enumerator_15688.hasCurrentObject ()) {
    ...
    var_symbolTable.method_searchKey (enumerator_15688.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (485)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (485)) ;
    GALGAS_ipic_31__38_Block var_b = ioArgument_ioBlockList.reader_mBlockAtIndex (var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (486)) ;
    var_orderedBlockList.addAssign_operation (var_b COMMA_SOURCE_FILE_AT_LINE (487)) ;
    enumerator_15688.gotoNextObject () ;
  }
  GALGAS_uint var_insertionIndex = var_orderedBlockList.reader_length (SOURCE_FILE_AT_LINE (490)) ;
  ...
  if (enumerator_16032.hasCurrentObject () && bool_4) {
    while (enumerator_16032.hasCurrentObject () && bool_4) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_16032.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (493)))) ;
      const enumGalgasBool test_5 = var_continue.boolEnum () ;
      if (kBoolTrue == test_5) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_16032.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (495)) ;
        }
      }
  ...
  GALGAS_uint var_p = function_blockDiscontinuityCount (var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  discontinuity count after optimization: ").operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (500)) COMMA_SOURCE_FILE_AT_LINE (500)).operator_concat (GALGAS_string ("\n"
  ...
  if (kBoolTrue == test_6) {
    inCompiler->printMessage (GALGAS_string ("  discontinuity count after optimization: ").operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502)).operator_concat (GALGAS_string ("\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502)) ;
  }
  GALGAS_stringset var_newSymbolSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (505)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_16643 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_16643.hasCurrentObject ()) {
    const enumGalgasBool test_7 = var_newSymbolSet.reader_hasKey (enumerator_16643.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (508)).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16643.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (510)) COMMA_SOURCE_FILE_AT_LINE (510)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (510)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (512)), var_s COMMA_SOURCE_FILE_AT_LINE (512)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_16643.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (516)) ;
    }
    enumerator_16643.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_17034 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_17034.hasCurrentObject ()) {
    const enumGalgasBool test_8 = var_newSymbolSet.reader_hasKey (enumerator_17034.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (520)).operator_not (SOURCE_FILE_AT_LINE (520)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_17034.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (522)) COMMA_SOURCE_FILE_AT_LINE (522)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (522)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (524)), var_s COMMA_SOURCE_FILE_AT_LINE (524)) ;
      ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
  ...
  if (kBoolTrue == test_9) {
    ...
    {
    routine_displayBlockList (GALGAS_string ("ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (532)) ;
    }
    ...
    inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (535)), var_s COMMA_SOURCE_FILE_AT_LINE (535)) ;
    ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (536)) COMMA_SOURCE_FILE_AT_LINE (536)) ;
    {
    routine_displayBlockList (GALGAS_string ("INCONSISTENT ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION (not used)"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (537)) ;
    }
  }
}
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18160 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_18160.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18160.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (549)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_18276 (enumerator_18160.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
      while (enumerator_18276.hasCurrentObject ()) {
        callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_18276.current_mInstruction (HERE).ptr (), enumerator_18160.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
        enumerator_18276.gotoNextObject () ;
      }
      callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18160.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_18160.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (553)) ;
    }
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18788 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_18782 ((PMUInt32) 0) ;
  while (enumerator_18788.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18788.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (567)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_18782.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (569)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (569)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_18782.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (570)), inCompiler COMMA_SOURCE_FILE_AT_LINE (570)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18788.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (574)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (575)) ;
      }
    }
    enumerator_18788.gotoNextObject () ;
    index_18782.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (566)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  {
  routine_buildInvocationGraph (ioArgument_ioGeneratedBlockList, var_invocationGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (589)) ;
  }
  GALGAS_bool joker_19660_0 ; // Joker input parameter
  var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (590)), joker_19660_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)) ;
  {
  routine_buildOrderedGraph (ioArgument_ioGeneratedBlockList, constinArgument_inSourceFileName, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (592)) ;
  }
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_buildInstructionInvocationGraph (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (34)) COMMA_SOURCE_FILE_AT_LINE (34)).operator_concat (GALGAS_string ("\" -> \"") COMMA_SOURCE_FILE_AT_LINE (34)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (34)) COMMA_SOURCE_FILE_AT_LINE (34)).operator_concat (GALGAS_string ("\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (34)) COMMA_SOURCE_FILE_AT_LINE (34)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_buildInstructionInvocationGraph (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_4\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_1523 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_1523.hasCurrentObject ()) {
    callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_1523.current_mInstruction (HERE).ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (45)) ;
...
static void categoryMethod_ipic_31__38__5F_condition_5F_skip_5F_instruction_buildInstructionInvocationGraph (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (58)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                              ...
                                                                                              C_Compiler * /* inCompiler */
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_4\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedRETLWTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                               ...
                                                                                               C_Compiler * /* inCompiler */
                                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (120)) COMMA_SOURCE_FILE_AT_LINE (120)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_2\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (120)) COMMA_SOURCE_FILE_AT_LINE (120)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * /* inObject */,
                                                                                             ...
                                                                                             C_Compiler * /* inCompiler */
                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (130)) COMMA_SOURCE_FILE_AT_LINE (130)).operator_concat (GALGAS_string ("\" -> \"_computed_goto_2\" [color=red] ;\n") COMMA_SOURCE_FILE_AT_LINE (130)) COMMA_SOURCE_FILE_AT_LINE (130)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (151)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (162)) ;
  callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraphVizString, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (163)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_JumpTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (GALGAS_string ("\" -> \"") COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)) ;
  const enumGalgasBool test_0 = constinArgument_inDottedArrow.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" [style=dotted]") COMMA_SOURCE_FILE_AT_LINE (175)) ;
  }
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_buildTerminatorInvocationGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string ("\" -> \"") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (object->mAttribute_mTargetLabelWhenTrue.reader_string (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)) ;
  const enumGalgasBool test_0 = constinArgument_inDottedArrow.boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" [style=dotted]") COMMA_SOURCE_FILE_AT_LINE (189)) ;
  }
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (191)) ;
  ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string ("  \"").operator_concat (constinArgument_inBlockLabel.reader_string (SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string ("\" -> \"") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (object->mAttribute_mTargetLabelWhenFalse.reader_string (SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)) ;
  const enumGalgasBool test_1 = constinArgument_inDottedArrow.boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioGraphVizString.dotAssign_operation (GALGAS_string (" [style=dotted]") COMMA_SOURCE_FILE_AT_LINE (194)) ;
  }
...
static GALGAS_bool categoryReader_ipic_31__38_AbstractConditionTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_ipic_31__38_AbstractConditionTerminator * object = (const cPtr_ipic_31__38_AbstractConditionTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38_AbstractConditionTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (289)).operator_and (callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (291)) COMMA_SOURCE_FILE_AT_LINE (290)) ;
//---
  return result_outResult ;
}
...
static GALGAS_bool categoryReader_pic_31__38_RegisterComparisonTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_RegisterComparisonTerminator * object = (const cPtr_pic_31__38_RegisterComparisonTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_RegisterComparisonTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (302)) ;
//---
  return result_outResult ;
}
...
static GALGAS_bool categoryReader_pic_31__38_TestRegisterTerminator_needToInsertJumpInstruction (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_TestRegisterTerminator * object = (const cPtr_pic_31__38_TestRegisterTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_TestRegisterTerminator) ;
  result_outResult = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inNextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (313)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  if (kBoolTrue == test_0) {
    {
    ioArgument_ioGraph.modifier_addEdge (constinArgument_inBlockLabel, object->mAttribute_mTargetLabelWhenTrue COMMA_SOURCE_FILE_AT_LINE (347)) ;
    }
  }
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioGraph.modifier_addEdge (constinArgument_inBlockLabel, object->mAttribute_mTargetLabelWhenFalse COMMA_SOURCE_FILE_AT_LINE (350)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_RegisterComparisonTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_RegisterComparisonTerminator * object = (const cPtr_pic_31__38_RegisterComparisonTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_RegisterComparisonTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (360)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_TestRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const cPtr_pic_31__38_TestRegisterTerminator * object = (const cPtr_pic_31__38_TestRegisterTerminator *) inObject ;
  macroValidSharedObject (object, const cPtr_pic_31__38_TestRegisterTerminator) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_IncDecRegisterTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (384)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (388)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_BitTestTerminator_buildTerminatorOrderedGraph (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
  callCategoryMethod_buildTerminatorOrderedGraph ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), constinArgument_inBlockLabel, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (404)) ;
}
//---------------------------------------------------------------------------*
