...
void routine_buildOrderedGraph (GALGAS_ipic_31__38_BlockList & ioArgument_ioBlockList,
  ...
  GALGAS_bool joker_14392_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (446)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".orderedBlocks1.dot") COMMA_SOURCE_FILE_AT_LINE (446)), joker_14392_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (446)) ;
  {
  var_g.modifier_removeEdgesToDominators (SOURCE_FILE_AT_LINE (447)) ;
  }
  GALGAS_bool joker_14522_0 ; // Joker input parameter
  var_g.reader_graphviz (SOURCE_FILE_AT_LINE (448)).method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".orderedBlocks2.dot") COMMA_SOURCE_FILE_AT_LINE (448)), joker_14522_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (448)) ;
  GALGAS_stringlist var_orderedLabelList ;
  GALGAS_lstringlist joker_14636_3 ; // Joker input parameter
  GALGAS_stringlist joker_14636_2 ; // Joker input parameter
  GALGAS_lstringlist joker_14636_1 ; // Joker input parameter
  var_g.reader_reversedGraph (SOURCE_FILE_AT_LINE (450)).method_depthFirstTopologicalSort (var_orderedLabelList, joker_14636_3, joker_14636_2, joker_14636_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (450)) ;
  GALGAS_ipic_31__38_BlockList var_orderedBlockList = GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (455)) ;
  GALGAS_bool var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_14838 (ioArgument_ioBlockList, kEnumeration_up) ;
  bool bool_2 = var_continue.isValidAndTrue () ;
  if (enumerator_14838.hasCurrentObject () && bool_2) {
    while (enumerator_14838.hasCurrentObject () && bool_2) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_14838.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (459)))) ;
      const enumGalgasBool test_3 = var_continue.boolEnum () ;
      if (kBoolTrue == test_3) {
        var_orderedBlockList.addAssign_operation (enumerator_14838.current_mBlock (HERE) COMMA_SOURCE_FILE_AT_LINE (461)) ;
      }
      enumerator_14838.gotoNextObject () ;
      if (enumerator_14838.hasCurrentObject ()) {
        bool_2 = var_continue.isValidAndTrue () ;
      }
    }
  }
  cEnumerator_stringlist enumerator_15049 (var_orderedLabelList, kEnumeration_up) ;
  while (enumerator_15049.hasCurrentObject ()) {
    GALGAS_uint var_blockIndex ;
    var_symbolTable.method_searchKey (enumerator_15049.current_mValue (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (466)), var_blockIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
    ...
    var_orderedBlockList.addAssign_operation (var_b COMMA_SOURCE_FILE_AT_LINE (468)) ;
    enumerator_15049.gotoNextObject () ;
  }
  GALGAS_uint var_insertionIndex = var_orderedBlockList.reader_length (SOURCE_FILE_AT_LINE (471)) ;
  var_continue = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_15393 (ioArgument_ioBlockList, kEnumeration_down) ;
  bool bool_4 = var_continue.isValidAndTrue () ;
  if (enumerator_15393.hasCurrentObject () && bool_4) {
    while (enumerator_15393.hasCurrentObject () && bool_4) {
      var_continue = GALGAS_bool (kIsNotEqual, enumerator_15393.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (474)))) ;
      const enumGalgasBool test_5 = var_continue.boolEnum () ;
      if (kBoolTrue == test_5) {
        {
        var_orderedBlockList.modifier_insertAtIndex (enumerator_15393.current_mBlock (HERE), var_insertionIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (476)) ;
        }
      }
      enumerator_15393.gotoNextObject () ;
      if (enumerator_15393.hasCurrentObject ()) {
        bool_4 = var_continue.isValidAndTrue () ;
      }
    }
  }
  GALGAS_uint var_p = function_blockDiscontinuityCount (var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  discontinuity count after optimization: ").operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (481)) COMMA_SOURCE_FILE_AT_LINE (481)).operator_concat (GALGAS_string ("\n"
  ...
  if (kBoolTrue == test_6) {
    inCompiler->printMessage (GALGAS_string ("  discontinuity count after optimization: ").operator_concat (var_p.reader_string (SOURCE_FILE_AT_LINE (483)) COMMA_SOURCE_FILE_AT_LINE (483)).operator_concat (GALGAS_string ("\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (483)) COMMA_SOURCE_FILE_AT_LINE (483)) ;
  }
  GALGAS_stringset var_newSymbolSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (486)) ;
  GALGAS_bool var_ok = GALGAS_bool (true) ;
  cEnumerator_ipic_31__38_BlockList enumerator_16004 (var_orderedBlockList, kEnumeration_up) ;
  while (enumerator_16004.hasCurrentObject ()) {
    const enumGalgasBool test_7 = var_newSymbolSet.reader_hasKey (enumerator_16004.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (489)).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16004.current_mBlock (HERE).mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (491)) COMMA_SOURCE_FILE_AT_LINE (491)).operator_concat (GALGAS_string ("\" is duplicated") COMMA_SOURCE_FILE_AT_LINE (491)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (493)), var_s COMMA_SOURCE_FILE_AT_LINE (493)) ;
      ...
      var_newSymbolSet.addAssign_operation (enumerator_16004.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (497)) ;
    }
    enumerator_16004.gotoNextObject () ;
  }
  cEnumerator_symbolTableForBlockOptimization enumerator_16395 (var_symbolTable, kEnumeration_up) ;
  while (enumerator_16395.hasCurrentObject ()) {
    const enumGalgasBool test_8 = var_newSymbolSet.reader_hasKey (enumerator_16395.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (501)).operator_not (SOURCE_FILE_AT_LINE (501)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_s = GALGAS_string ("BLOCK REORDERING INTERNAL ERROR: block \"").operator_concat (enumerator_16395.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (503)) COMMA_SOURCE_FILE_AT_LINE (503)).operator_concat (GALGAS_string ("\" is missing") COMMA_SOURCE_FILE_AT_LINE (503)) ;
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (505)), var_s COMMA_SOURCE_FILE_AT_LINE (505)) ;
      ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
  ...
  if (kBoolTrue == test_9) {
    ...
    {
    routine_displayBlockList (GALGAS_string ("ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (513)) ;
    }
    ...
    inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (516)), var_s COMMA_SOURCE_FILE_AT_LINE (516)) ;
    ioArgument_ioListFileContents.dotAssign_operation (var_s.operator_concat (GALGAS_string (".\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (517)) COMMA_SOURCE_FILE_AT_LINE (517)) ;
    {
    routine_displayBlockList (GALGAS_string ("INCONSISTENT ORDERED OPTIMIZED INTERMEDIATE BLOCK REPRESENTATION (not used)"), ioArgument_ioListFileContents, var_orderedBlockList, inCompiler COMMA_SOURCE_FILE_AT_LINE (518)) ;
    }
  }
}
...
void routine_buildInvocationGraph (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_17521 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_17521.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_17521.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (530)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_ipic_31__38_SequentialInstructionList enumerator_17637 (enumerator_17521.current_mBlock (HERE).mAttribute_mInstructionList, kEnumeration_up) ;
      while (enumerator_17637.hasCurrentObject ()) {
        callCategoryMethod_buildInstructionInvocationGraph ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_17637.current_mInstruction (HERE).ptr (), enumerator_17521.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, inCompiler COMMA_SOURCE_FILE_AT_LINE (532)) ;
        enumerator_17637.gotoNextObject () ;
      }
      callCategoryMethod_buildTerminatorInvocationGraph ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_17521.current_mBlock (HERE).mAttribute_mTerminator.ptr (), enumerator_17521.current_mBlock (HERE).mAttribute_mLabel, outArgument_outGraphVizString, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (534)) ;
    }
...
GALGAS_uint function_blockDiscontinuityCount (GALGAS_ipic_31__38_BlockList inArgument_inBlockList,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_18149 (inArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_18143 ((PMUInt32) 0) ;
  while (enumerator_18149.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18149.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (548)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_nextBlockLabel ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, index_18143.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (550)).objectCompare (inArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (550)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_nextBlockLabel = inArgument_inBlockList.reader_mBlockAtIndex (index_18143.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (551)), inCompiler COMMA_SOURCE_FILE_AT_LINE (551)).mAttribute_mLabel.mAttribute_string ;
      }else if (kBoolFalse == test_1) {
        var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
      }
      const enumGalgasBool test_2 = callCategoryReader_needToInsertJumpInstruction ((const cPtr_ipic_31__38_AbstractBlockTerminator *) enumerator_18149.current_mBlock (HERE).mAttribute_mTerminator.ptr (), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (555)).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_outResult.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) ;
      }
    }
    enumerator_18149.gotoNextObject () ;
    index_18143.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (547)) ;
  }
//---
...
void routine_ipic_31__38_OptimizeBlockOrdering (const GALGAS_string constinArgument_inSourceFileName,
  ...
  {
  routine_buildInvocationGraph (ioArgument_ioGeneratedBlockList, var_invocationGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (570)) ;
  }
  GALGAS_bool joker_19021_0 ; // Joker input parameter
  var_invocationGraph.method_writeToFileWhenDifferentContents (constinArgument_inSourceFileName.operator_concat (GALGAS_string (".blockInvocation.dot") COMMA_SOURCE_FILE_AT_LINE (571)), joker_19021_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
  {
  routine_buildOrderedGraph (ioArgument_ioGeneratedBlockList, constinArgument_inSourceFileName, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
  }
}
