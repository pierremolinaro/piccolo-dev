...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_lstringlist enumerator_30674 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_30674.hasCurrentObject ()) {
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (961)) ;
    GALGAS_uint var_targetAddress ;
    constinArgument_inSymbolTable.method_searchKey (enumerator_30674.current_mValue (HERE), var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
    outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_RCALL_5F_instruction_5F_code (var_currentInstructionAddress, var_targetAddress, enumerator_30674.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (963)) COMMA_SOURCE_FILE_AT_LINE (963)) ;
    ...
    enumerator_30674.gotoNextObject () ;
  }
