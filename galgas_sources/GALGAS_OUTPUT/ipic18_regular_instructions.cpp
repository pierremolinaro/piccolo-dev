...
static void categoryMethod_ipic_31__38_InstructionWithNoOperand_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (categoryReader_mnemonic (object->mAttribute_mKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) COMMA_SOURCE_FILE_AT_LINE (106)), GALGAS_uintlist::constructor_listWithValue (var_c COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (105)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) ;
  const enumGalgasBool test_0 = object->mAttribute_m_5F_W_5F_isDestination.operator_and (object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (141)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_s.dotAssign_operation (GALGAS_string (", W, BSR_ACCESS") COMMA_SOURCE_FILE_AT_LINE (142)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (143)).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_s.dotAssign_operation (GALGAS_string (", F, BSR_ACCESS") COMMA_SOURCE_FILE_AT_LINE (144)) ;
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_2 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_s.dotAssign_operation (GALGAS_string (", W") COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }else if (kBoolFalse == test_2) {
        var_s.dotAssign_operation (GALGAS_string (", F") COMMA_SOURCE_FILE_AT_LINE (148)) ;
      }
    }
  }
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (150)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (182)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 256U) COMMA_SOURCE_FILE_AT_LINE (183)) ;
  }
  const enumGalgasBool test_1 = object->mAttribute_m_5F_W_5F_isDestination.operator_not (SOURCE_FILE_AT_LINE (185)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 512U) COMMA_SOURCE_FILE_AT_LINE (186)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (188)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188)) ;
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA temp_2 = object ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FDA *) temp_2.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (190)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)), GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (189)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_FA_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (211)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (212)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_FA_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (232)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 256U) COMMA_SOURCE_FILE_AT_LINE (233)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (235)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (235)) COMMA_SOURCE_FILE_AT_LINE (235)) ;
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FA temp_1 = object ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FA *) temp_1.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (237)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (237)), GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (236)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVFF_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = GALGAS_string ("MOVFF ").operator_concat (object->mAttribute_mSourceRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (object->mAttribute_mDestinationRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (259)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVFF_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVFF * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVFF *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVFF) ;
  GALGAS_uintlist var_code = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (270)) ;
  var_code.addAssign_operation (GALGAS_uint ((PMUInt32) 49152U).operator_or (object->mAttribute_mSourceRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271)) ;
  var_code.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (object->mAttribute_mDestinationRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (272)) COMMA_SOURCE_FILE_AT_LINE (272)) COMMA_SOURCE_FILE_AT_LINE (272)) ;
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVFF temp_0 = object ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVFF *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (274)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274)), var_code COMMA_SOURCE_FILE_AT_LINE (273)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = categoryReader_mnemonic (object->mAttribute_mLiteralInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (286)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (286)).operator_concat (object->mAttribute_mLiteralValue.reader_hexString (SOURCE_FILE_AT_LINE (286)) COMMA_SOURCE_FILE_AT_LINE (286)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (287)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  var_code = var_code.operator_or (object->mAttribute_mLiteralValue COMMA_SOURCE_FILE_AT_LINE (308)) ;
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation temp_0 = object ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_literalOperation *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (310)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (310)) COMMA_SOURCE_FILE_AT_LINE (310)), GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (311)) COMMA_SOURCE_FILE_AT_LINE (309)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = GALGAS_string ("LFSR ").operator_concat (object->mAttribute_mFSRindex.reader_uint (SOURCE_FILE_AT_LINE (330)).reader_string (SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (330)).operator_concat (object->mAttribute_mValue.reader_hexString (SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (331)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR) ;
  GALGAS_uintlist var_code = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (342)) ;
  var_code.addAssign_operation (GALGAS_uint ((PMUInt32) 60928U).operator_or (object->mAttribute_mFSRindex.reader_uint (SOURCE_FILE_AT_LINE (343)).left_shift_operation (GALGAS_uint ((PMUInt32) 4U) COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).operator_or (object->mAttribute_mValue.right_shift_operation (GALGAS_uint ((PMUInt32) 8U) COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)) ;
  var_code.addAssign_operation (GALGAS_uint ((PMUInt32) 61440U).operator_or (object->mAttribute_mValue.operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (344)) COMMA_SOURCE_FILE_AT_LINE (344)) COMMA_SOURCE_FILE_AT_LINE (344)) ;
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR temp_0 = object ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_LFSR *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (346)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) COMMA_SOURCE_FILE_AT_LINE (346)), var_code COMMA_SOURCE_FILE_AT_LINE (345)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_FBA_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = categoryReader_mnemonic (object->mAttribute_mBitOrientedOp, inCompiler COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (object->mAttribute_mBitNumber.reader_string (SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (359)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_FBA_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (376)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 256U) COMMA_SOURCE_FILE_AT_LINE (377)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (379)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (379)) COMMA_SOURCE_FILE_AT_LINE (379)) ;
  var_code = var_code.operator_or (object->mAttribute_mBitNumber.left_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (380)) COMMA_SOURCE_FILE_AT_LINE (380)) ;
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_FBA temp_1 = object ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_FBA *) temp_1.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (382)), GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (381)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = GALGAS_string ("MOVLB ").operator_concat (object->mAttribute_mBankIndex.reader_uint (SOURCE_FILE_AT_LINE (394)).reader_hexString (SOURCE_FILE_AT_LINE (394)) COMMA_SOURCE_FILE_AT_LINE (394)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (395)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB) ;
  GALGAS_uint var_code = GALGAS_uint ((PMUInt32) 256U).operator_or (object->mAttribute_mBankIndex.reader_uint (SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (406)) ;
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB temp_0 = object ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MOVLB *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (408)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)), GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (409)) COMMA_SOURCE_FILE_AT_LINE (407)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLRD_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = GALGAS_string ("TBLRD ").operator_concat (categoryReader_mnemonic (object->mAttribute_mOption, inCompiler COMMA_SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (421)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLRD_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLRD *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (440)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)), GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (439)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLWT_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = GALGAS_string ("TBLWT ").operator_concat (categoryReader_mnemonic (object->mAttribute_mOption, inCompiler COMMA_SOURCE_FILE_AT_LINE (452)) COMMA_SOURCE_FILE_AT_LINE (452)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (453)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLWT_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_TBLWT *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (472)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (472)) COMMA_SOURCE_FILE_AT_LINE (472)), GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_SOURCE_FILE_AT_LINE (471)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_uint categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP_instructionSize (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  result_outSize = object->mAttribute_mOccurrenceFactor.mAttribute_uint.multiply_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (486)) ;
//---
  return result_outSize ;
}
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP) ;
  GALGAS_string var_s = GALGAS_string ("MNOP ").operator_concat (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (492)).reader_string (SOURCE_FILE_AT_LINE (492)) COMMA_SOURCE_FILE_AT_LINE (492)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (493)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP) ;
  outArgument_outCode = GALGAS_codeList::constructor_emptyList (SOURCE_FILE_AT_LINE (504)) ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (506)).isValid ()) {
    PMUInt32 variant_16412 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (506)).uintValue () ;
    bool loop_16412 = true ;
    while (loop_16412) {
      loop_16412 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (507)))).isValid () ;
      if (loop_16412) {
        loop_16412 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (507)))).boolValue () ;
      }
      if (loop_16412 && (0 == variant_16412)) {
        loop_16412 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (506)) ;
      }
      if (loop_16412) {
        variant_16412 -- ;
        outArgument_outCode.addAssign_operation (GALGAS_string ("    NOP"), GALGAS_uintlist::constructor_listWithValue (GALGAS_uint ((PMUInt32) 0U) COMMA_SOURCE_FILE_AT_LINE (509)) COMMA_SOURCE_FILE_AT_LINE (509)) ;
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_MOV_5F_LABEL_5F_W_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = GALGAS_string ("MOVLW ((").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (521)).operator_concat (GALGAS_string (" + ") COMMA_SOURCE_FILE_AT_LINE (521)).operator_concat (object->mAttribute_mOffset.reader_string (SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (521)).operator_concat (GALGAS_string (") >> ") COMMA_SOURCE_FILE_AT_LINE (521)).operator_concat (object->mAttribute_mRightShift.reader_string (SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (521)).operator_concat (GALGAS_string (") & 0xFF") COMMA_SOURCE_FILE_AT_LINE (521)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (522)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_MOV_5F_LABEL_5F_W_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  constinArgument_inDataAddressMap.method_searchKey (object->mAttribute_mLabel, var_address, inCompiler COMMA_SOURCE_FILE_AT_LINE (533)) ;
  GALGAS_uint var_code = var_address.add_operation (object->mAttribute_mOffset, inCompiler COMMA_SOURCE_FILE_AT_LINE (534)).right_shift_operation (object->mAttribute_mRightShift COMMA_SOURCE_FILE_AT_LINE (534)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (534)) ;
  ...
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_MOV_5F_LABEL_5F_W *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (537)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (537)) COMMA_SOURCE_FILE_AT_LINE (537)), GALGAS_uintlist::constructor_listWithValue (var_code.operator_or (var_code_5F_MOVLW COMMA_SOURCE_FILE_AT_LINE (538)) COMMA_SOURCE_FILE_AT_LINE (538)) COMMA_SOURCE_FILE_AT_LINE (536)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_string var_s = object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (549)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (549)) ;
  if (object->mAttribute_mCompareInstruction.isValid ()) {
    ...
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_CPFSEQ: {
      var_s.dotAssign_operation (GALGAS_string ("!= W") COMMA_SOURCE_FILE_AT_LINE (551)) ;
      } break ;
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_CPFSGT: {
      var_s.dotAssign_operation (GALGAS_string ("<= W") COMMA_SOURCE_FILE_AT_LINE (552)) ;
      } break ;
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_CPFSLT: {
      var_s.dotAssign_operation (GALGAS_string (">= W") COMMA_SOURCE_FILE_AT_LINE (553)) ;
      } break ;
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_TSTFSZ: {
      var_s.dotAssign_operation (GALGAS_string ("!= 0") COMMA_SOURCE_FILE_AT_LINE (554)) ;
      } break ;
    }
  }
  var_s.dotAssign_operation (GALGAS_string (" \? ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (556)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (557)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (576)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 256U) COMMA_SOURCE_FILE_AT_LINE (577)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (579)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (579)) COMMA_SOURCE_FILE_AT_LINE (579)) ;
  GALGAS_string var_s = GALGAS_string ("    ") ;
  if (object->mAttribute_mCompareInstruction.isValid ()) {
    switch (object->mAttribute_mCompareInstruction.enumValue ()) {
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kNotBuilt:
      break ;
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_CPFSEQ: {
      var_s.dotAssign_operation (GALGAS_string ("CPFSEQ") COMMA_SOURCE_FILE_AT_LINE (583)) ;
      } break ;
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_CPFSGT: {
      var_s.dotAssign_operation (GALGAS_string ("CPFSGT") COMMA_SOURCE_FILE_AT_LINE (584)) ;
      } break ;
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_CPFSLT: {
      var_s.dotAssign_operation (GALGAS_string ("CPFSLT") COMMA_SOURCE_FILE_AT_LINE (585)) ;
      } break ;
    case GALGAS_ipic_31__38__5F_compare_5F_register_5F_instruction_5F_base_5F_code::kEnum_TSTFSZ: {
      var_s.dotAssign_operation (GALGAS_string ("TSTFSZ") COMMA_SOURCE_FILE_AT_LINE (586)) ;
      } break ;
    }
  }
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)) ;
  const enumGalgasBool test_1 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (589)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_s.dotAssign_operation (GALGAS_string (", BSR_ACCESS") COMMA_SOURCE_FILE_AT_LINE (590)) ;
  }
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (var_s, GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (595)) COMMA_SOURCE_FILE_AT_LINE (593)) ;
  GALGAS_codeList var_c ;
  callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (598)), constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_c, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
  outArgument_outCode.dotAssign_operation (var_c COMMA_SOURCE_FILE_AT_LINE (603)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_checkRelativesResolution ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (619)), constinArgument_inBlockLabel, constinArgument_inSymbolTable, ioArgument_ioConversionCount, ioArgument_ioListFileContents, var_outModifiedEmbeddedInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (618)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_n.objectCompare (ioArgument_ioConversionCount)).boolEnum () ;
  if (kBoolTrue == test_1) {
    outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_compare_5F_register::constructor_new (object->mAttribute_mInstructionLocation, var_outModifiedEmbeddedInstruction, object->mAttribute_mCompareInstruction, object->mAttribute_mRegisterDescription COMMA_SOURCE_FILE_AT_LINE (627)) ;
  }
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    var_s.dotAssign_operation (GALGAS_string ("!") COMMA_SOURCE_FILE_AT_LINE (645)) ;
  }
  var_s.dotAssign_operation (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (647)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (647)).operator_concat (object->mAttribute_mBitNumber.reader_string (SOURCE_FILE_AT_LINE (647)) COMMA_SOURCE_FILE_AT_LINE (647)).operator_concat (GALGAS_string (" \? ") COMMA_SOURCE_FILE_AT_LINE (648)) COMMA_SOURCE_FILE_AT_LINE (647)) ;
  GALGAS_stringlist var_x = callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (649)) ;
  var_s.dotAssign_operation (var_x.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (651)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_1 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (668)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 256U) COMMA_SOURCE_FILE_AT_LINE (669)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (671)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)) ;
  var_code = var_code.operator_or (object->mAttribute_mBitNumber.left_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672)) ;
  GALGAS_string var_s = GALGAS_string ("    ") ;
  const enumGalgasBool test_2 = object->mAttribute_mSkipIfSet.boolEnum () ;
  if (kBoolTrue == test_2) {
    var_s.dotAssign_operation (GALGAS_string ("BTFSS") COMMA_SOURCE_FILE_AT_LINE (676)) ;
  }else if (kBoolFalse == test_2) {
    var_s.dotAssign_operation (GALGAS_string ("BTFSC") COMMA_SOURCE_FILE_AT_LINE (678)) ;
  }
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (object->mAttribute_mBitNumber.reader_string (SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)) ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (var_s, GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (684)) COMMA_SOURCE_FILE_AT_LINE (682)) ;
  GALGAS_codeList var_c ;
  callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (687)), constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_c, inCompiler COMMA_SOURCE_FILE_AT_LINE (686)) ;
  outArgument_outCode.dotAssign_operation (var_c COMMA_SOURCE_FILE_AT_LINE (692)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_n = ioArgument_ioConversionCount ;
  GALGAS_ipic_31__38_SequentialInstruction var_outModifiedEmbeddedInstruction ;
  callCategoryMethod_checkRelativesResolution ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (708)), constinArgument_inBlockLabel, constinArgument_inSymbolTable, ioArgument_ioConversionCount, ioArgument_ioListFileContents, var_outModifiedEmbeddedInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_n.objectCompare (ioArgument_ioConversionCount)).boolEnum () ;
  if (kBoolTrue == test_1) {
    outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_skip_5F_instruction_5F_BitTestSkip::constructor_new (object->mAttribute_mInstructionLocation, var_outModifiedEmbeddedInstruction, object->mAttribute_mSkipIfSet, object->mAttribute_mRegisterDescription, object->mAttribute_mBitNumber COMMA_SOURCE_FILE_AT_LINE (716)) ;
  }
}
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_skip_5F_instruction_5F_FDA_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (740)) COMMA_SOURCE_FILE_AT_LINE (740)) COMMA_SOURCE_FILE_AT_LINE (740)) ;
  const enumGalgasBool test_0 = object->mAttribute_m_5F_W_5F_isDestination.boolEnum () ;
  if (kBoolTrue == test_0) {
    var_s.dotAssign_operation (GALGAS_string (", W") COMMA_SOURCE_FILE_AT_LINE (742)) ;
  }
  var_s.dotAssign_operation (GALGAS_string (" \? ") COMMA_SOURCE_FILE_AT_LINE (744)) ;
  GALGAS_stringlist var_x = callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (745)) ;
  var_s.dotAssign_operation (var_x.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)) ;
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (747)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mRegisterDescription.reader_mNeedsBSR (SOURCE_FILE_AT_LINE (765)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 256U) COMMA_SOURCE_FILE_AT_LINE (766)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (768)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (768)) COMMA_SOURCE_FILE_AT_LINE (768)) ;
  GALGAS_string var_s = GALGAS_string ("    ") ;
  if (object->mAttribute_mInstruction_5F_FDA_5F_base_5F_code.isValid ()) {
    switch (object->mAttribute_mInstruction_5F_FDA_5F_base_5F_code.enumValue ()) {
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kNotBuilt:
      break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_DECFSZ: {
      var_s.dotAssign_operation (GALGAS_string ("DECFSZ") COMMA_SOURCE_FILE_AT_LINE (772)) ;
      } break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_DCFSNZ: {
      var_s.dotAssign_operation (GALGAS_string ("DCFSNZ") COMMA_SOURCE_FILE_AT_LINE (773)) ;
      } break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_INCFSZ: {
      var_s.dotAssign_operation (GALGAS_string ("INCFSZ") COMMA_SOURCE_FILE_AT_LINE (774)) ;
      } break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_INFSNZ: {
      var_s.dotAssign_operation (GALGAS_string ("INFSNZ") COMMA_SOURCE_FILE_AT_LINE (775)) ;
      } break ;
    }
  }
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)) ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (var_s, GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (781)) COMMA_SOURCE_FILE_AT_LINE (779)) ;
  GALGAS_codeList var_c ;
  callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (784)), constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_c, inCompiler COMMA_SOURCE_FILE_AT_LINE (783)) ;
  outArgument_outCode.dotAssign_operation (var_c COMMA_SOURCE_FILE_AT_LINE (789)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_n = ioArgument_ioConversionCount ;
  GALGAS_ipic_31__38_SequentialInstruction var_outModifiedEmbeddedInstruction ;
  callCategoryMethod_checkRelativesResolution ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (805)), constinArgument_inBlockLabel, constinArgument_inSymbolTable, ioArgument_ioConversionCount, ioArgument_ioListFileContents, var_outModifiedEmbeddedInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (804)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_n.objectCompare (ioArgument_ioConversionCount)).boolEnum () ;
  if (kBoolTrue == test_1) {
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      const enumGalgasBool test_1 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (853)).operator_not (SOURCE_FILE_AT_LINE (853)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (854)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (GALGAS_string (" --> CALL ") COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)) ;
        outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_JSR::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, GALGAS_jumpInstructionKind::constructor_absolute (SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      const enumGalgasBool test_2 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (859)).operator_not (SOURCE_FILE_AT_LINE (859)).boolEnum () ;
      if (kBoolTrue == test_2) {
        inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("displacement (").operator_concat (function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (861)).reader_string (SOURCE_FILE_AT_LINE (861)) COMMA_SOURCE_FILE_AT_LINE (861)).operator_concat (GALGAS_string (") too large for RCALL ") COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (GALGAS_string (" instruction (limited to [-1024, 1023])") COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (860)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      } break ;
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_JSR_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      var_s = GALGAS_string ("JSR ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (873)) COMMA_SOURCE_FILE_AT_LINE (873)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      var_s = GALGAS_string ("RCALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (874)) COMMA_SOURCE_FILE_AT_LINE (874)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      var_s = GALGAS_string ("CALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (875)) COMMA_SOURCE_FILE_AT_LINE (875)) ;
      } break ;
    }
  }
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (877)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (888)) ;
  if (object->mAttribute_mKind.isValid ()) {
    switch (object->mAttribute_mKind.enumValue ()) {
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: case GALGAS_jumpInstructionKind::kEnum_relative: {
      outArgument_outCode = function_pic_31__38__5F_RCALL_5F_instruction_5F_code (constinArgument_inAddress, var_targetAddress, object->mAttribute_mTargetLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (891)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      outArgument_outCode = function_pic_31__38__5F_CALL_5F_instruction_5F_code (var_targetAddress, object->mAttribute_mTargetLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (893)) ;
      } break ;
    }
  }
}
...
static GALGAS_uint categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionSize (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  result_outSize = result_outSize.add_operation (GALGAS_uint ((PMUInt32) 4U).multiply_operation (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (911)), inCompiler COMMA_SOURCE_FILE_AT_LINE (911)), inCompiler COMMA_SOURCE_FILE_AT_LINE (911)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (911)) ;
//---
  return result_outSize ;
}
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.operator_not (SOURCE_FILE_AT_LINE (918)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_s.dotAssign_operation (GALGAS_string ("(uses CALL)") COMMA_SOURCE_FILE_AT_LINE (919)) ;
  }
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (921)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_29525 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_29525.hasCurrentObject ()) {
    cEnumerator_stringlist enumerator_29574 (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_29525.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (923)), kEnumeration_up) ;
    while (enumerator_29574.hasCurrentObject ()) {
      result_outResult.addAssign_operation (GALGAS_string ("   ").operator_concat (enumerator_29574.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (924)) COMMA_SOURCE_FILE_AT_LINE (924)) ;
      enumerator_29574.gotoNextObject () ;
    }
    enumerator_29525.gotoNextObject () ;
  }
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_30183 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_30183.hasCurrentObject ()) {
    GALGAS_ipic_31__38_SequentialInstruction joker_30391_0 ; // Joker input parameter
    callCategoryMethod_checkRelativesResolution ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_30183.current_mInstruction (HERE).ptr (), constinArgument_inAddress, constinArgument_inBlockLabel, constinArgument_inSymbolTable, var_unusedConversionCount, var_unusedListing, joker_30391_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (944)) ;
    enumerator_30183.gotoNextObject () ;
  }
  const enumGalgasBool test_1 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_1) {
    const enumGalgasBool test_2 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, GALGAS_string ("_computed_goto_2").reader_nowhere (SOURCE_FILE_AT_LINE (954)), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (954)).operator_not (SOURCE_FILE_AT_LINE (954)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (955)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (956)).operator_concat (GALGAS_string (": computed rcall needs to use CALL _computed_goto_2\n") COMMA_SOURCE_FILE_AT_LINE (956)) COMMA_SOURCE_FILE_AT_LINE (956)) ;
      outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetInstructions, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (957)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall) ;
  GALGAS_lstring var_target = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_goto_4"), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (974)) ;
  GALGAS_uint var_computetedGoto_34_Address ;
  constinArgument_inSymbolTable.method_searchKey (var_target, var_computetedGoto_34_Address, inCompiler COMMA_SOURCE_FILE_AT_LINE (976)) ;
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCode = function_pic_31__38__5F_RCALL_5F_instruction_5F_code (constinArgument_inAddress, var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (979)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCode = function_pic_31__38__5F_CALL_5F_instruction_5F_code (var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (981)) ;
  }
  GALGAS_uint var_nextInstructionAddress = constinArgument_inAddress.add_operation (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (983)).multiply_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (983)), inCompiler COMMA_SOURCE_FILE_AT_LINE (983)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
  GALGAS_lstring var_nextInstructionLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_").operator_concat (constinArgument_inAddress.reader_xString (SOURCE_FILE_AT_LINE (984)) COMMA_SOURCE_FILE_AT_LINE (984)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (984)) ;
  GALGAS_uint var_currentInstructionAddress = constinArgument_inAddress ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_31888 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_31888.hasCurrentObject ()) {
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (988)) ;
    GALGAS_codeList var_instructionCode ;
    callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_31888.current_mInstruction (HERE).ptr (), constinArgument_inAddress, constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_instructionCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (989)) ;
    outArgument_outCode.dotAssign_operation (var_instructionCode COMMA_SOURCE_FILE_AT_LINE (995)) ;
    var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (996)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (997)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_BRA_5F_instruction_5F_code (var_currentInstructionAddress, var_nextInstructionAddress, var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (998)) COMMA_SOURCE_FILE_AT_LINE (998)) ;
      var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (999)) ;
    }
    enumerator_31888.gotoNextObject () ;
  }
  outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_definition_5F_label (var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1003)) COMMA_SOURCE_FILE_AT_LINE (1003)) ;
}
//---------------------------------------------------------------------------*
