...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      GALGAS_bool var_ok ;
      {
      GALGAS_sint joker_26024_0 ; // Joker input parameter
      routine_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, var_ok, joker_26024_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
      }
      const enumGalgasBool test_1 = var_ok.operator_not (SOURCE_FILE_AT_LINE (836)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (837)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (838)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (838)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (838)) COMMA_SOURCE_FILE_AT_LINE (838)).operator_concat (GALGAS_string (" --> CALL ") COMMA_SOURCE_FILE_AT_LINE (838)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (838)) COMMA_SOURCE_FILE_AT_LINE (838)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (838)) COMMA_SOURCE_FILE_AT_LINE (838)) ;
        outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_JSR::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, GALGAS_jumpInstructionKind::constructor_absolute (SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (839)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      ...
      GALGAS_sint var_d ;
      {
      routine_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, var_ok, var_d, inCompiler COMMA_SOURCE_FILE_AT_LINE (842)) ;
      }
      const enumGalgasBool test_2 = var_ok.operator_not (SOURCE_FILE_AT_LINE (843)).boolEnum () ;
      if (kBoolTrue == test_2) {
        inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("displacement (").operator_concat (var_d.reader_string (SOURCE_FILE_AT_LINE (844)) COMMA_SOURCE_FILE_AT_LINE (844)).operator_concat (GALGAS_string (") too large for RCALL ") COMMA_SOURCE_FILE_AT_LINE (844)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (844)) COMMA_SOURCE_FILE_AT_LINE (844)).operator_concat (GALGAS_string (" instruction (limited to [-1024, 1023])") COMMA_SOURCE_FILE_AT_LINE (844)) COMMA_SOURCE_FILE_AT_LINE (844)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      } break ;
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_28497 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_28497.hasCurrentObject ()) {
    result_outResult.addAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_28497.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) ;
    enumerator_28497.gotoNextObject () ;
  }
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outModifiedInstruction = temp_0 ;
  cEnumerator_lstringlist enumerator_29010 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_29010.hasCurrentObject ()) {
    GALGAS_bool var_ok ;
    GALGAS_sint var_d ;
    {
    routine_checkBRA_5F_RCALL (constinArgument_inSymbolTable, enumerator_29010.current_mValue (HERE), constinArgument_inAddress, var_ok, var_d, inCompiler COMMA_SOURCE_FILE_AT_LINE (920)) ;
    }
    const enumGalgasBool test_1 = var_ok.operator_not (SOURCE_FILE_AT_LINE (921)).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("displacement (").operator_concat (var_d.reader_string (SOURCE_FILE_AT_LINE (922)) COMMA_SOURCE_FILE_AT_LINE (922)).operator_concat (GALGAS_string (") too large for rcall ") COMMA_SOURCE_FILE_AT_LINE (922)).operator_concat (enumerator_29010.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (922)) COMMA_SOURCE_FILE_AT_LINE (922)).operator_concat (GALGAS_string (" instruction (limited to [-1024, 1023])") COMMA_SOURCE_FILE_AT_LINE (922)) COMMA_SOURCE_FILE_AT_LINE (922)) ;
    }
  ...
  if (kBoolTrue == test_2) {
    GALGAS_bool var_ok ;
    {
    GALGAS_sint joker_29380_0 ; // Joker input parameter
    routine_checkBRA_5F_RCALL (constinArgument_inSymbolTable, GALGAS_string ("_computed_goto_2").reader_nowhere (SOURCE_FILE_AT_LINE (926)), constinArgument_inAddress, var_ok, joker_29380_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (926)) ;
    }
    const enumGalgasBool test_3 = var_ok.operator_not (SOURCE_FILE_AT_LINE (927)).boolEnum () ;
    if (kBoolTrue == test_3) {
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_lstring var_nexInstructionLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_").operator_concat (constinArgument_inAddress.reader_string (SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (957)) ;
  GALGAS_uint var_currentInstructionAddress = constinArgument_inAddress ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_lstringlist enumerator_30663 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_30663.hasCurrentObject ()) {
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (961)) ;
    GALGAS_uint var_targetAddress ;
    constinArgument_inSymbolTable.method_searchKey (enumerator_30663.current_mValue (HERE), var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
    outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_RCALL_5F_instruction_5F_code (var_currentInstructionAddress, var_targetAddress, enumerator_30663.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (963)) COMMA_SOURCE_FILE_AT_LINE (963)) ;
    ...
    if (kBoolTrue == test_1) {
      outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_BRA_5F_instruction_5F_code (var_currentInstructionAddress, var_nextInstructionAddress, var_nexInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) COMMA_SOURCE_FILE_AT_LINE (966)) ;
    ...
    enumerator_30663.gotoNextObject () ;
  }
  outArgument_outCode.addAssign_operation (var_nexInstructionLabel.mAttribute_string.operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (971)), GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (971)) COMMA_SOURCE_FILE_AT_LINE (971)) ;
}
//---------------------------------------------------------------------------*
