...
//                    september 27th, 2013, at 23h5'12"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  while (enumerator_31976.hasCurrentObject ()) {
    cEnumerator_stringlist enumerator_32025 (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_31976.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (992)), kEnumeration_up) ;
    while (enumerator_32025.hasCurrentObject ()) {
      result_outResult.addAssign_operation (GALGAS_string ("   ").operator_concat (enumerator_32025.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (993)) COMMA_SOURCE_FILE_AT_LINE (993)) ;
      enumerator_32025.gotoNextObject () ;
    }
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionRelativeBranchOverflow (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_32523 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_32523.hasCurrentObject ()) {
    callCategoryMethod_instructionRelativeBranchOverflow ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_32523.current_mInstruction (HERE).ptr (), var_address, constinArgument_inBlockLabel, constinArgument_inSymbolTable, ioArgument_ioOverflowMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1008)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_performInstructionRelativeBranchResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_33526 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_33526.hasCurrentObject ()) {
    GALGAS_ipic_31__38_SequentialInstruction joker_33750_0 ; // Joker input parameter
    callCategoryMethod_performInstructionRelativeBranchResolution ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_33526.current_mInstruction (HERE).ptr (), var_address, constinArgument_inBlockLabel, constinArgument_inSymbolTable, var_unusedConversionCount, var_unusedListing, joker_33750_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1039)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_35395 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_35395.hasCurrentObject ()) {
    ...
    callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_35395.current_mInstruction (HERE).ptr (), var_currentInstructionAddress, constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_instructionCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1087)) ;
