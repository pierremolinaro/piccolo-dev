...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_MOV_5F_LABEL_5F_W_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (GALGAS_string ("    ").operator_concat (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38__5F_intermediate_5F_MOV_5F_LABEL_5F_W *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (553)).reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (553)) COMMA_SOURCE_FILE_AT_LINE (553)), GALGAS_uintlist::constructor_listWithValue (var_code.operator_or (var_code_5F_MOVLW COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (552)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 256U) COMMA_SOURCE_FILE_AT_LINE (782)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (784)).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (784)) COMMA_SOURCE_FILE_AT_LINE (784)) ;
  GALGAS_string var_s = GALGAS_string ("    ") ;
  if (object->mAttribute_mInstruction_5F_FDA_5F_base_5F_code.isValid ()) {
    switch (object->mAttribute_mInstruction_5F_FDA_5F_base_5F_code.enumValue ()) {
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kNotBuilt:
      break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_DECFSZ: {
      var_s.dotAssign_operation (GALGAS_string ("DECFSZ") COMMA_SOURCE_FILE_AT_LINE (788)) ;
      } break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_DCFSNZ: {
      var_s.dotAssign_operation (GALGAS_string ("DCFSNZ") COMMA_SOURCE_FILE_AT_LINE (789)) ;
      } break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_INCFSZ: {
      var_s.dotAssign_operation (GALGAS_string ("INCFSZ") COMMA_SOURCE_FILE_AT_LINE (790)) ;
      } break ;
    case GALGAS_skip_5F_instruction_5F_FDA_5F_base_5F_code::kEnum_INFSNZ: {
      var_s.dotAssign_operation (GALGAS_string ("INFSNZ") COMMA_SOURCE_FILE_AT_LINE (791)) ;
      } break ;
    }
  }
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (793)) COMMA_SOURCE_FILE_AT_LINE (793)) COMMA_SOURCE_FILE_AT_LINE (793)) ;
  outArgument_outCode = GALGAS_codeList::constructor_listWithValue (var_s, GALGAS_uintlist::constructor_listWithValue (var_code COMMA_SOURCE_FILE_AT_LINE (797)) COMMA_SOURCE_FILE_AT_LINE (795)) ;
  GALGAS_codeList var_c ;
  callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (800)), constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_c, inCompiler COMMA_SOURCE_FILE_AT_LINE (799)) ;
  outArgument_outCode.dotAssign_operation (var_c COMMA_SOURCE_FILE_AT_LINE (805)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_skip_5F_instruction_5F_FDA_performInstructionRelativeBranchResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_n = ioArgument_ioConversionCount ;
  GALGAS_ipic_31__38_SequentialInstruction var_outModifiedEmbeddedInstruction ;
  callCategoryMethod_performInstructionRelativeBranchResolution ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), constinArgument_inAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (821)), constinArgument_inBlockLabel, constinArgument_inSymbolTable, ioArgument_ioConversionCount, ioArgument_ioListFileContents, var_outModifiedEmbeddedInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (820)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_n.objectCompare (ioArgument_ioConversionCount)).boolEnum () ;
  if (kBoolTrue == test_1) {
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_instructionRelativeBranchOverflow (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: case GALGAS_jumpInstructionKind::kEnum_relative: {
      const enumGalgasBool test_0 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (866)).operator_not (SOURCE_FILE_AT_LINE (866)).boolEnum () ;
      if (kBoolTrue == test_0) {
        ioArgument_ioOverflowMap.addAssign_operation (constinArgument_inBlockLabel, object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (867)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      } break ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_performInstructionRelativeBranchResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      const enumGalgasBool test_1 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (886)).operator_not (SOURCE_FILE_AT_LINE (886)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (887)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (888)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (888)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (888)) COMMA_SOURCE_FILE_AT_LINE (888)).operator_concat (GALGAS_string (" --> CALL ") COMMA_SOURCE_FILE_AT_LINE (888)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (888)) COMMA_SOURCE_FILE_AT_LINE (888)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (888)) COMMA_SOURCE_FILE_AT_LINE (888)) ;
        outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_JSR::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, GALGAS_jumpInstructionKind::constructor_absolute (SOURCE_FILE_AT_LINE (889)) COMMA_SOURCE_FILE_AT_LINE (889)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      const enumGalgasBool test_2 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (892)).operator_not (SOURCE_FILE_AT_LINE (892)).boolEnum () ;
      if (kBoolTrue == test_2) {
        inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("displacement (").operator_concat (function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (894)).reader_string (SOURCE_FILE_AT_LINE (894)) COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string (") too large for RCALL ") COMMA_SOURCE_FILE_AT_LINE (895)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (895)) COMMA_SOURCE_FILE_AT_LINE (895)).operator_concat (GALGAS_string (" instruction (limited to [-1024, 1023])") COMMA_SOURCE_FILE_AT_LINE (895)) COMMA_SOURCE_FILE_AT_LINE (893)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      } break ;
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_JSR_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      var_s = GALGAS_string ("JSR ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (906)) COMMA_SOURCE_FILE_AT_LINE (906)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      var_s = GALGAS_string ("RCALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (907)) COMMA_SOURCE_FILE_AT_LINE (907)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      var_s = GALGAS_string ("CALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (908)) COMMA_SOURCE_FILE_AT_LINE (908)) ;
      } break ;
    }
  }
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (910)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
  if (object->mAttribute_mKind.isValid ()) {
    switch (object->mAttribute_mKind.enumValue ()) {
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: case GALGAS_jumpInstructionKind::kEnum_relative: {
      outArgument_outCode = function_pic_31__38__5F_RCALL_5F_instruction_5F_code (constinArgument_inAddress, var_targetAddress, object->mAttribute_mTargetLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (924)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      outArgument_outCode = function_pic_31__38__5F_CALL_5F_instruction_5F_code (var_targetAddress, object->mAttribute_mTargetLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (926)) ;
      } break ;
    }
  }
}
...
static GALGAS_uint categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionSize (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  result_outSize = result_outSize.add_operation (GALGAS_uint ((PMUInt32) 4U).multiply_operation (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (944)), inCompiler COMMA_SOURCE_FILE_AT_LINE (944)), inCompiler COMMA_SOURCE_FILE_AT_LINE (944)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (944)) ;
//---
  return result_outSize ;
}
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.operator_not (SOURCE_FILE_AT_LINE (951)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_s.dotAssign_operation (GALGAS_string ("(uses CALL)") COMMA_SOURCE_FILE_AT_LINE (952)) ;
  }
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (954)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_30677 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_30677.hasCurrentObject ()) {
    cEnumerator_stringlist enumerator_30726 (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_30677.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (956)), kEnumeration_up) ;
    while (enumerator_30726.hasCurrentObject ()) {
      result_outResult.addAssign_operation (GALGAS_string ("   ").operator_concat (enumerator_30726.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionRelativeBranchOverflow (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_address = constinArgument_inAddress.add_operation (temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (970)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_31224 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_31224.hasCurrentObject ()) {
    callCategoryMethod_instructionRelativeBranchOverflow ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_31224.current_mInstruction (HERE).ptr (), var_address, constinArgument_inBlockLabel, constinArgument_inSymbolTable, ioArgument_ioOverflowMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
    var_address = var_address.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
    enumerator_31224.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_2) {
    const enumGalgasBool test_3 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, GALGAS_string ("_computed_goto_4").reader_nowhere (SOURCE_FILE_AT_LINE (981)), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (981)).operator_not (SOURCE_FILE_AT_LINE (981)).boolEnum () ;
    if (kBoolTrue == test_3) {
      ioArgument_ioOverflowMap.addAssign_operation (constinArgument_inBlockLabel, GALGAS_string ("_computed_goto_4") COMMA_SOURCE_FILE_AT_LINE (982)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_performInstructionRelativeBranchResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_address = constinArgument_inAddress.add_operation (temp_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1000)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_32227 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_32227.hasCurrentObject ()) {
    GALGAS_ipic_31__38_SequentialInstruction joker_32451_0 ; // Joker input parameter
    callCategoryMethod_performInstructionRelativeBranchResolution ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_32227.current_mInstruction (HERE).ptr (), var_address, constinArgument_inBlockLabel, constinArgument_inSymbolTable, var_unusedConversionCount, var_unusedListing, joker_32451_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1003)) ;
    var_address = var_address.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1011)) ;
    enumerator_32227.gotoNextObject () ;
  }
  const enumGalgasBool test_3 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_3) {
    const enumGalgasBool test_4 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, GALGAS_string ("_computed_goto_4").reader_nowhere (SOURCE_FILE_AT_LINE (1014)), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)).operator_not (SOURCE_FILE_AT_LINE (1014)).boolEnum () ;
    if (kBoolTrue == test_4) {
      ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1015)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (1016)).operator_concat (GALGAS_string (": computed rcall needs to use CALL _computed_goto_4\n") COMMA_SOURCE_FILE_AT_LINE (1016)) COMMA_SOURCE_FILE_AT_LINE (1016)) ;
      outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetInstructions, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1017)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall) ;
  GALGAS_lstring var_target = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_goto_4"), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1034)) ;
  GALGAS_uint var_computetedGoto_34_Address ;
  constinArgument_inSymbolTable.method_searchKey (var_target, var_computetedGoto_34_Address, inCompiler COMMA_SOURCE_FILE_AT_LINE (1036)) ;
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCode = function_pic_31__38__5F_RCALL_5F_instruction_5F_code (constinArgument_inAddress, var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (1039)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCode = function_pic_31__38__5F_CALL_5F_instruction_5F_code (var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (1041)) ;
  }
  GALGAS_uint var_nextInstructionAddress = constinArgument_inAddress.add_operation (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (1043)).multiply_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
  GALGAS_lstring var_nextInstructionLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_").operator_concat (constinArgument_inAddress.reader_xString (SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1044)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1044)) ;
  GALGAS_uint var_currentInstructionAddress = constinArgument_inAddress ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_33977 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_33977.hasCurrentObject ()) {
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    GALGAS_codeList var_instructionCode ;
    callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_33977.current_mInstruction (HERE).ptr (), constinArgument_inAddress, constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_instructionCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1049)) ;
    outArgument_outCode.dotAssign_operation (var_instructionCode COMMA_SOURCE_FILE_AT_LINE (1055)) ;
    var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (1057)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_BRA_5F_instruction_5F_code (var_currentInstructionAddress, var_nextInstructionAddress, var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1058)) COMMA_SOURCE_FILE_AT_LINE (1058)) ;
      var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    }
    enumerator_33977.gotoNextObject () ;
  }
  outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_definition_5F_label (var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)) COMMA_SOURCE_FILE_AT_LINE (1063)) ;
}
//---------------------------------------------------------------------------*
