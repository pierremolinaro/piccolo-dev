...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (495)).isValid ()) {
    PMUInt32 variant_15769 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (495)).uintValue () ;
    bool loop_15769 = true ;
    while (loop_15769) {
      loop_15769 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (496)))).isValid () ;
      if (loop_15769) {
        loop_15769 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (496)))).boolValue () ;
      }
      if (loop_15769 && (0 == variant_15769)) {
        loop_15769 = false ;
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_28541 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_28541.hasCurrentObject ()) {
    result_outResult.addAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_28541.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outModifiedInstruction = temp_0 ;
  cEnumerator_lstringlist enumerator_29054 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_29054.hasCurrentObject ()) {
    const enumGalgasBool test_1 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, enumerator_29054.current_mValue (HERE), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (920)).operator_not (SOURCE_FILE_AT_LINE (920)).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("displacement (").operator_concat (function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (constinArgument_inSymbolTable, enumerator_29054.current_mValue (HERE), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (922)).reader_string (SOURCE_FILE_AT_LINE (922)) COMMA_SOURCE_FILE_AT_LINE (922)).operator_concat (GALGAS_string (") too large for rcall ") COMMA_SOURCE_FILE_AT_LINE (922)).operator_concat (enumerator_29054.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (GALGAS_string (" instruction (limited to [-1024, 1023])") COMMA_SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (921)) ;
    }
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_lstringlist enumerator_30757 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_30757.hasCurrentObject ()) {
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (961)) ;
    GALGAS_uint var_targetAddress ;
    constinArgument_inSymbolTable.method_searchKey (enumerator_30757.current_mValue (HERE), var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
    outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_RCALL_5F_instruction_5F_code (var_currentInstructionAddress, var_targetAddress, enumerator_30757.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (963)) COMMA_SOURCE_FILE_AT_LINE (963)) ;
