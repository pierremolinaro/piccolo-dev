...
static GALGAS_uint categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionSize (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  result_outSize = result_outSize.add_operation (GALGAS_uint ((PMUInt32) 4U).multiply_operation (object->mAttribute_mTargetLabels.reader_length (SOURCE_FILE_AT_LINE (892)), inCompiler COMMA_SOURCE_FILE_AT_LINE (892)), inCompiler COMMA_SOURCE_FILE_AT_LINE (892)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (892)) ;
//---
  return result_outSize ;
}
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_28668 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_28668.hasCurrentObject ()) {
    result_outResult.addAssign_operation (GALGAS_string ("  ").operator_concat (enumerator_28668.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  outArgument_outModifiedInstruction = temp_0 ;
  cEnumerator_lstringlist enumerator_29181 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_29181.hasCurrentObject ()) {
    const enumGalgasBool test_1 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, enumerator_29181.current_mValue (HERE), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (920)).operator_not (SOURCE_FILE_AT_LINE (920)).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("displacement (").operator_concat (function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (constinArgument_inSymbolTable, enumerator_29181.current_mValue (HERE), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (922)).reader_string (SOURCE_FILE_AT_LINE (922)) COMMA_SOURCE_FILE_AT_LINE (922)).operator_concat (GALGAS_string (") too large for rcall ") COMMA_SOURCE_FILE_AT_LINE (922)).operator_concat (enumerator_29181.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (GALGAS_string (" instruction (limited to [-1024, 1023])") COMMA_SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (921)) ;
    }
    enumerator_29181.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_2) {
    const enumGalgasBool test_3 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, GALGAS_string ("_computed_goto_2").reader_nowhere (SOURCE_FILE_AT_LINE (927)), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (927)).operator_not (SOURCE_FILE_AT_LINE (927)).boolEnum () ;
    if (kBoolTrue == test_3) {
      ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (928)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (929)).operator_concat (GALGAS_string (": computed rcall needs to use CALL _computed_goto_2\n") COMMA_SOURCE_FILE_AT_LINE (929)) COMMA_SOURCE_FILE_AT_LINE (929)) ;
      outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabels, object->mAttribute_mEndOfInstructionLabel, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (930)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall) ;
  GALGAS_lstring var_target = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_goto_4"), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (947)) ;
  GALGAS_uint var_computetedGoto_34_Address ;
  constinArgument_inSymbolTable.method_searchKey (var_target, var_computetedGoto_34_Address, inCompiler COMMA_SOURCE_FILE_AT_LINE (949)) ;
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCode = function_pic_31__38__5F_RCALL_5F_instruction_5F_code (constinArgument_inAddress, var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (952)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCode = function_pic_31__38__5F_CALL_5F_instruction_5F_code (var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (954)) ;
  }
  GALGAS_uint var_nextInstructionAddress = constinArgument_inAddress.add_operation (object->mAttribute_mTargetLabels.reader_length (SOURCE_FILE_AT_LINE (956)).multiply_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (956)), inCompiler COMMA_SOURCE_FILE_AT_LINE (956)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (956)) ;
  GALGAS_lstring var_nextInstructionLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_").operator_concat (constinArgument_inAddress.reader_xString (SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (957)) ;
  GALGAS_uint var_currentInstructionAddress = constinArgument_inAddress ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_lstringlist enumerator_30884 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_30884.hasCurrentObject ()) {
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (961)) ;
    GALGAS_uint var_targetAddress ;
    constinArgument_inSymbolTable.method_searchKey (enumerator_30884.current_mValue (HERE), var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
    outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_RCALL_5F_instruction_5F_code (var_currentInstructionAddress, var_targetAddress, enumerator_30884.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (963)) COMMA_SOURCE_FILE_AT_LINE (963)) ;
    var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (964)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mTargetLabels.reader_length (SOURCE_FILE_AT_LINE (965)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_BRA_5F_instruction_5F_code (var_currentInstructionAddress, var_nextInstructionAddress, var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) COMMA_SOURCE_FILE_AT_LINE (966)) ;
      var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (967)) ;
    }
    enumerator_30884.gotoNextObject () ;
  }
  outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_definition_5F_label (var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (971)) COMMA_SOURCE_FILE_AT_LINE (971)) ;
}
//---------------------------------------------------------------------------*
