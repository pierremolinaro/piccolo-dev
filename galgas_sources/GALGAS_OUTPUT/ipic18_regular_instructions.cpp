...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (506)).isValid ()) {
    PMUInt32 variant_16430 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (506)).uintValue () ;
    bool loop_16430 = true ;
    while (loop_16430) {
      loop_16430 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (507)))).isValid () ;
      if (loop_16430) {
        loop_16430 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (507)))).boolValue () ;
      }
      if (loop_16430 && (0 == variant_16430)) {
        loop_16430 = false ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_instructionRelativeBranchOverflow (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: case GALGAS_jumpInstructionKind::kEnum_relative: {
      const enumGalgasBool test_0 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (850)).operator_not (SOURCE_FILE_AT_LINE (850)).boolEnum () ;
      if (kBoolTrue == test_0) {
        ioArgument_ioOverflowMap.addAssign_operation (constinArgument_inBlockLabel, object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (851)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      } break ;
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_performInstructionRelativeBranchResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      const enumGalgasBool test_1 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (870)).operator_not (SOURCE_FILE_AT_LINE (870)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (GALGAS_string (": JSR ") COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (GALGAS_string (" --> CALL ") COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
        outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_JSR::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, GALGAS_jumpInstructionKind::constructor_absolute (SOURCE_FILE_AT_LINE (873)) COMMA_SOURCE_FILE_AT_LINE (873)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      const enumGalgasBool test_2 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (876)).operator_not (SOURCE_FILE_AT_LINE (876)).boolEnum () ;
      if (kBoolTrue == test_2) {
        inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("displacement (").operator_concat (function_pic_31__38__5F_BRA_5F_RCALL_5F_displacement (constinArgument_inSymbolTable, object->mAttribute_mTargetLabel, constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (878)).reader_string (SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)).operator_concat (GALGAS_string (") too large for RCALL ") COMMA_SOURCE_FILE_AT_LINE (879)).operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (879)).operator_concat (GALGAS_string (" instruction (limited to [-1024, 1023])") COMMA_SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (877)) ;
      }
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      } break ;
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_JSR_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: {
      var_s = GALGAS_string ("JSR ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (890)) COMMA_SOURCE_FILE_AT_LINE (890)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_relative: {
      var_s = GALGAS_string ("RCALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (891)) COMMA_SOURCE_FILE_AT_LINE (891)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      var_s = GALGAS_string ("CALL ").operator_concat (object->mAttribute_mTargetLabel.reader_string (SOURCE_FILE_AT_LINE (892)) COMMA_SOURCE_FILE_AT_LINE (892)) ;
      } break ;
    }
  }
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (894)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (905)) ;
  if (object->mAttribute_mKind.isValid ()) {
    switch (object->mAttribute_mKind.enumValue ()) {
    case GALGAS_jumpInstructionKind::kNotBuilt:
      break ;
    case GALGAS_jumpInstructionKind::kEnum_ipicRelative: case GALGAS_jumpInstructionKind::kEnum_relative: {
      outArgument_outCode = function_pic_31__38__5F_RCALL_5F_instruction_5F_code (constinArgument_inAddress, var_targetAddress, object->mAttribute_mTargetLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (908)) ;
      } break ;
    case GALGAS_jumpInstructionKind::kEnum_absolute: {
      outArgument_outCode = function_pic_31__38__5F_CALL_5F_instruction_5F_code (var_targetAddress, object->mAttribute_mTargetLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (910)) ;
      } break ;
    }
  }
}
...
static GALGAS_uint categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionSize (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  result_outSize = result_outSize.add_operation (GALGAS_uint ((PMUInt32) 4U).multiply_operation (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (928)), inCompiler COMMA_SOURCE_FILE_AT_LINE (928)), inCompiler COMMA_SOURCE_FILE_AT_LINE (928)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (928)) ;
//---
  return result_outSize ;
}
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.operator_not (SOURCE_FILE_AT_LINE (935)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_s.dotAssign_operation (GALGAS_string ("(uses CALL)") COMMA_SOURCE_FILE_AT_LINE (936)) ;
  }
  result_outResult = GALGAS_stringlist::constructor_listWithValue (var_s COMMA_SOURCE_FILE_AT_LINE (938)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_30221 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_30221.hasCurrentObject ()) {
    cEnumerator_stringlist enumerator_30270 (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_30221.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (940)), kEnumeration_up) ;
    while (enumerator_30270.hasCurrentObject ()) {
      result_outResult.addAssign_operation (GALGAS_string ("   ").operator_concat (enumerator_30270.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (941)) COMMA_SOURCE_FILE_AT_LINE (941)) ;
      enumerator_30270.gotoNextObject () ;
    }
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionRelativeBranchOverflow (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_address = constinArgument_inAddress.add_operation (temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (954)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_30768 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_30768.hasCurrentObject ()) {
    callCategoryMethod_instructionRelativeBranchOverflow ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_30768.current_mInstruction (HERE).ptr (), var_address, constinArgument_inBlockLabel, constinArgument_inSymbolTable, ioArgument_ioOverflowMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (956)) ;
    var_address = var_address.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
    enumerator_30768.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_2) {
    const enumGalgasBool test_3 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, GALGAS_string ("_computed_goto_4").reader_nowhere (SOURCE_FILE_AT_LINE (965)), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (965)).operator_not (SOURCE_FILE_AT_LINE (965)).boolEnum () ;
    if (kBoolTrue == test_3) {
      ioArgument_ioOverflowMap.addAssign_operation (constinArgument_inBlockLabel, GALGAS_string ("_computed_goto_4") COMMA_SOURCE_FILE_AT_LINE (966)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_performInstructionRelativeBranchResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_address = constinArgument_inAddress.add_operation (temp_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (984)) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_31771 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_31771.hasCurrentObject ()) {
    GALGAS_ipic_31__38_SequentialInstruction joker_31995_0 ; // Joker input parameter
    callCategoryMethod_performInstructionRelativeBranchResolution ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_31771.current_mInstruction (HERE).ptr (), var_address, constinArgument_inBlockLabel, constinArgument_inSymbolTable, var_unusedConversionCount, var_unusedListing, joker_31995_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (987)) ;
    var_address = var_address.add_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (995)) ;
    enumerator_31771.gotoNextObject () ;
  }
  const enumGalgasBool test_3 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_3) {
    const enumGalgasBool test_4 = function_pic_31__38__5F_checkBRA_5F_RCALL (constinArgument_inSymbolTable, GALGAS_string ("_computed_goto_4").reader_nowhere (SOURCE_FILE_AT_LINE (998)), constinArgument_inAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (998)).operator_not (SOURCE_FILE_AT_LINE (998)).boolEnum () ;
    if (kBoolTrue == test_4) {
      ioArgument_ioConversionCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (999)) ;
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inBlockLabel COMMA_SOURCE_FILE_AT_LINE (1000)).operator_concat (GALGAS_string (": computed rcall needs to use CALL _computed_goto_4\n") COMMA_SOURCE_FILE_AT_LINE (1000)) COMMA_SOURCE_FILE_AT_LINE (1000)) ;
      outArgument_outModifiedInstruction = GALGAS_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetInstructions, GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1001)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall * object = (const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall *) inObject ;
  macroValidSharedObject (object, const cPtr_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall) ;
  GALGAS_lstring var_target = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_goto_4"), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1018)) ;
  GALGAS_uint var_computetedGoto_34_Address ;
  constinArgument_inSymbolTable.method_searchKey (var_target, var_computetedGoto_34_Address, inCompiler COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  const enumGalgasBool test_0 = object->mAttribute_mUsesRCALL.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outCode = function_pic_31__38__5F_RCALL_5F_instruction_5F_code (constinArgument_inAddress, var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (1023)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outCode = function_pic_31__38__5F_CALL_5F_instruction_5F_code (var_computetedGoto_34_Address, var_target, inCompiler COMMA_SOURCE_FILE_AT_LINE (1025)) ;
  }
  GALGAS_uint var_nextInstructionAddress = constinArgument_inAddress.add_operation (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (1027)).multiply_operation (GALGAS_uint ((PMUInt32) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1027)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1027)).substract_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1027)) ;
  GALGAS_lstring var_nextInstructionLabel = GALGAS_lstring::constructor_new (GALGAS_string ("_computed_").operator_concat (constinArgument_inAddress.reader_xString (SOURCE_FILE_AT_LINE (1028)) COMMA_SOURCE_FILE_AT_LINE (1028)), object->mAttribute_mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  GALGAS_uint var_currentInstructionAddress = constinArgument_inAddress ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_33521 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_33521.hasCurrentObject ()) {
    ...
    callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_33521.current_mInstruction (HERE).ptr (), constinArgument_inAddress, constinArgument_inSymbolTable, constinArgument_inDataAddressMap, var_instructionCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (1033)) ;
    outArgument_outCode.dotAssign_operation (var_instructionCode COMMA_SOURCE_FILE_AT_LINE (1039)) ;
    var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1040)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mTargetInstructions.reader_length (SOURCE_FILE_AT_LINE (1041)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_BRA_5F_instruction_5F_code (var_currentInstructionAddress, var_nextInstructionAddress, var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1042)) COMMA_SOURCE_FILE_AT_LINE (1042)) ;
      var_currentInstructionAddress = var_currentInstructionAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
    }
    enumerator_33521.gotoNextObject () ;
  }
  outArgument_outCode.dotAssign_operation (function_pic_31__38__5F_definition_5F_label (var_nextInstructionLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (1047)) COMMA_SOURCE_FILE_AT_LINE (1047)) ;
}
//---------------------------------------------------------------------------*
