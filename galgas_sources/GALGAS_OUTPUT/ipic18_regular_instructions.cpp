...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_MNOP_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (495)).isValid ()) {
    PMUInt32 variant_15859 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (495)).uintValue () ;
    bool loop_15859 = true ;
    while (loop_15859) {
      loop_15859 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (496)))).isValid () ;
      if (loop_15859) {
        loop_15859 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (496)))).boolValue () ;
      }
      if (loop_15859 && (0 == variant_15859)) {
        loop_15859 = false ;
...
static GALGAS_stringlist categoryReader_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_instructionDisplay (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_28674 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_28674.hasCurrentObject ()) {
    cEnumerator_stringlist enumerator_28723 (callCategoryReader_instructionDisplay ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_28674.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (904)), kEnumeration_up) ;
    while (enumerator_28723.hasCurrentObject ()) {
      result_outResult.addAssign_operation (GALGAS_string ("   ").operator_concat (enumerator_28723.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (905)) COMMA_SOURCE_FILE_AT_LINE (905)) ;
      enumerator_28723.gotoNextObject () ;
    }
    enumerator_28674.gotoNextObject () ;
  }
//---
  return result_outResult ;
}
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_checkRelativesResolution (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_29332 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_29332.hasCurrentObject ()) {
    GALGAS_ipic_31__38_SequentialInstruction joker_29540_0 ; // Joker input parameter
    callCategoryMethod_checkRelativesResolution ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_29332.current_mInstruction (HERE).ptr (), constinArgument_inAddress, constinArgument_inBlockLabel, constinArgument_inSymbolTable, var_unusedConversionCount, var_unusedListing, joker_29540_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (925)) ;
    enumerator_29332.gotoNextObject () ;
  }
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_generateCode (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_30994 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_30994.hasCurrentObject ()) {
    ...
    callCategoryMethod_generateCode ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_30994.current_mInstruction (HERE).ptr (), constinArgument_inAddress, constinArgument_inSymbolTable, var_instructionCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (969)) ;
