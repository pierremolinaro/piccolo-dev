...
void routine_performRelativesResolution (const GALGAS_symbolTableForRelativesResolution constinArgument_inSymbolTable,
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_1765 (ioArgument_ioBlockList, kEnumeration_up) ;
  GALGAS_uint index_1753 ((PMUInt32) 0) ;
  while (enumerator_1765.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, index_1753.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (61)).objectCompare (ioArgument_ioBlockList.reader_length (SOURCE_FILE_AT_LINE (61)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_nextBlockLabel = ioArgument_ioBlockList.reader_mBlockAtIndex (index_1753.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (62)), inCompiler COMMA_SOURCE_FILE_AT_LINE (62)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_0) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_1765.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (66)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_blockStartAddress = enumerator_1765.current_mBlock (HERE).mAttribute_mAddress ;
    }
    GALGAS_ipic_31__38_Block var_modifiedBlock ;
    categoryMethod_performRelativesResolution (enumerator_1765.current_mBlock (HERE), constinArgument_inSymbolTable, var_nextBlockLabel, var_blockStartAddress, ioArgument_ioConversionCount, ioArgument_ioListFileContents, var_modifiedBlock, inCompiler COMMA_SOURCE_FILE_AT_LINE (69)) ;
    var_modifiedBlockList.addAssign_operation (var_modifiedBlock COMMA_SOURCE_FILE_AT_LINE (77)) ;
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_1765.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (78)) ;
    ...
    index_1753.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (59)) ;
  }
...
void routine_computeLabelAbsoluteAddressMap (const GALGAS_ipic_31__38_BlockList constinArgument_inGeneratedBlockList,
  ...
  GALGAS_uint var_blockStartAddress = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_BlockList enumerator_3523 (constinArgument_inGeneratedBlockList, kEnumeration_up) ;
  GALGAS_uint index_3502 ((PMUInt32) 0) ;
  while (enumerator_3523.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, index_3502.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (114)).objectCompare (constinArgument_inGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (114)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_nextBlockLabel = constinArgument_inGeneratedBlockList.reader_mBlockAtIndex (index_3502.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_0) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_3523.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (119)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_blockStartAddress = enumerator_3523.current_mBlock (HERE).mAttribute_mAddress ;
    }
    {
    outArgument_outSymbolTable.modifier_insertKey (enumerator_3523.current_mBlock (HERE).mAttribute_mLabel, var_blockStartAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (122)) ;
    }
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_3523.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) ;
    var_blockStartAddress = var_blockStartAddress.add_operation (var_blockSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_3523.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (125)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      outArgument_outFreeAddress = var_blockStartAddress ;
    }
    enumerator_3523.gotoNextObject () ;
    index_3502.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  cEnumerator_ipic_31__38_BlockList enumerator_4259 (constinArgument_inInitialBlockList, kEnumeration_up) ;
  while (enumerator_4259.hasCurrentObject ()) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_4259.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (131)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      const enumGalgasBool test_4 = outArgument_outSymbolTable.reader_hasKey (enumerator_4259.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (132)).operator_not (SOURCE_FILE_AT_LINE (132)).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        outArgument_outSymbolTable.modifier_insertKey (enumerator_4259.current_mBlock (HERE).mAttribute_mLabel, enumerator_4259.current_mBlock (HERE).mAttribute_mAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)) ;
        }
      }
    }
...
void routine_ipic_31__38_RelativesResolution (GALGAS_string & ioArgument_ioListFileContents,
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (155)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (155)).isValid ()) {
    PMUInt32 variant_5144 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (155)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (155)).uintValue () ;
    bool loop_5144 = true ;
    while (loop_5144) {
      loop_5144 = var_resolutionDone.operator_not (SOURCE_FILE_AT_LINE (156)).operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (156)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (156)).isValid () ;
      if (loop_5144) {
        loop_5144 = var_resolutionDone.operator_not (SOURCE_FILE_AT_LINE (156)).operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (156)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (156)).boolValue () ;
      }
      if (loop_5144 && (0 == variant_5144)) {
        loop_5144 = false ;
      ...
      if (loop_5144) {
        ...
        {
        GALGAS_uint joker_5416_0 ; // Joker input parameter
        routine_computeLabelAbsoluteAddressMap (ioArgument_ioGeneratedBlockList, GALGAS_ipic_31__38_BlockList::constructor_emptyList (SOURCE_FILE_AT_LINE (160)), var_symbolTable, joker_5416_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
        }
...
void routine_ipic_31__38_RelativeBranchOverflow (const GALGAS_ipic_31__38_BlockList constinArgument_inBlockList,
  ...
  GALGAS_symbolTableForRelativesResolution var_symbolTable ;
  {
  GALGAS_uint joker_7483_0 ; // Joker input parameter
  routine_computeLabelAbsoluteAddressMap (constinArgument_inBlockList, constinArgument_inInitialBlockList, var_symbolTable, joker_7483_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (232)) ;
  }
  outArgument_outOverflowMap = GALGAS_branchOverflowMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (239)) ;
  GALGAS_uint var_blockStartAddress = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_BlockList enumerator_7600 (constinArgument_inBlockList, kEnumeration_up) ;
  GALGAS_uint index_7588 ((PMUInt32) 0) ;
  while (enumerator_7600.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, index_7588.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (243)).objectCompare (constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (243)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_nextBlockLabel = constinArgument_inBlockList.reader_mBlockAtIndex (index_7588.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (244)), inCompiler COMMA_SOURCE_FILE_AT_LINE (244)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_0) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_7600.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (248)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_blockStartAddress = enumerator_7600.current_mBlock (HERE).mAttribute_mAddress ;
    }
    categoryMethod_relativeBranchOverflow (enumerator_7600.current_mBlock (HERE), var_symbolTable, var_nextBlockLabel, var_blockStartAddress, outArgument_outOverflowMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (251)) ;
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_7600.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (257)) ;
    ...
    index_7588.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) ;
  }
}
...
void categoryMethod_performRelativesResolution (const GALGAS_ipic_31__38_Block inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_621 (inObject.mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_621.hasCurrentObject ()) {
    GALGAS_ipic_31__38_SequentialInstruction var_modifiedInstruction ;
    callCategoryMethod_performInstructionRelativeBranchResolution ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_621.current_mInstruction (HERE).ptr (), var_address, inObject.mAttribute_mLabel.mAttribute_string, constinArgument_inSymbolTable, ioArgument_ioConversionCount, ioArgument_ioListFileContents, var_modifiedInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (19)) ;
    var_modifiedInstructionList.addAssign_operation (var_modifiedInstruction COMMA_SOURCE_FILE_AT_LINE (27)) ;
    var_address = var_address.add_operation (callCategoryReader_instructionSize ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_621.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (28)), inCompiler COMMA_SOURCE_FILE_AT_LINE (28)) ;
...
GALGAS_uint categoryReader_blockSize (const GALGAS_ipic_31__38_Block & inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_2917 (inObject.mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_2917.hasCurrentObject ()) {
    result_outResult = result_outResult.add_operation (callCategoryReader_instructionSize ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_2917.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (96)), inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
...
void categoryMethod_relativeBranchOverflow (const GALGAS_ipic_31__38_Block inObject,
                                            ...
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint var_address = constinArgument_inBlockStartAddress ;
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_6641 (inObject.mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_6641.hasCurrentObject ()) {
    callCategoryMethod_instructionRelativeBranchOverflow ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_6641.current_mInstruction (HERE).ptr (), var_address, inObject.mAttribute_mLabel.mAttribute_string, constinArgument_inSymbolTable, ioArgument_ioOverflowMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
    var_address = var_address.add_operation (callCategoryReader_instructionSize ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_6641.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (212)), inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) ;
