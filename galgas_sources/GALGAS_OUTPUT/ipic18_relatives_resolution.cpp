...
void routine_computeLabelAbsoluteAddressMap (const GALGAS_ipic_31__38_BlockList constinArgument_inGeneratedBlockList,
  ...
  outArgument_outSymbolTable = GALGAS_symbolTableForRelativesResolution::constructor_emptyMap (SOURCE_FILE_AT_LINE (514)) ;
  GALGAS_uint var_blockStartAddress = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_ipic_31__38_BlockList enumerator_19423 (constinArgument_inGeneratedBlockList, kEnumeration_up) ;
  GALGAS_uint index_19417 ((PMUInt32) 0) ;
  while (enumerator_19423.hasCurrentObject ()) {
    GALGAS_string var_nextBlockLabel ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, index_19417.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (518)).objectCompare (constinArgument_inGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (518)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_nextBlockLabel = constinArgument_inGeneratedBlockList.reader_mBlockAtIndex (index_19417.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (519)), inCompiler COMMA_SOURCE_FILE_AT_LINE (519)).mAttribute_mLabel.mAttribute_string ;
    }else if (kBoolFalse == test_0) {
      var_nextBlockLabel = GALGAS_string::makeEmptyString () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_19423.current_mBlock (HERE).mAttribute_mStartAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (523)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_blockStartAddress = enumerator_19423.current_mBlock (HERE).mAttribute_mStartAddress ;
    }
    {
    outArgument_outSymbolTable.modifier_insertKey (enumerator_19423.current_mBlock (HERE).mAttribute_mLabel, var_blockStartAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (526)) ;
    }
    GALGAS_uint var_blockSize = categoryReader_blockSize (enumerator_19423.current_mBlock (HERE), var_nextBlockLabel, inCompiler COMMA_SOURCE_FILE_AT_LINE (527)) ;
    var_blockStartAddress = var_blockStartAddress.add_operation (var_blockSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) ;
    enumerator_19423.gotoNextObject () ;
    index_19417.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
  }
}
...
void routine_ipic_31__38_RelativesResolution (GALGAS_string & ioArgument_ioListFileContents,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (542)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (542)) COMMA_SOURCE_FILE_AT_LINE (542)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("RELATIVES RESOLUTION").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (543)) COMMA_SOURCE_FILE_AT_LINE (543)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (543)) COMMA_SOURCE_FILE_AT_LINE (543)) ;
  ...
  if (ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (548)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (548)).isValid ()) {
    PMUInt32 variant_20648 = ioArgument_ioGeneratedBlockList.reader_length (SOURCE_FILE_AT_LINE (548)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (548)).uintValue () ;
    bool loop_20648 = true ;
    while (loop_20648) {
      loop_20648 = var_resolutionDone.operator_not (SOURCE_FILE_AT_LINE (549)).operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (549)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (549)).isValid () ;
      if (loop_20648) {
        loop_20648 = var_resolutionDone.operator_not (SOURCE_FILE_AT_LINE (549)).operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (549)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (549)).boolValue () ;
      }
      if (loop_20648 && (0 == variant_20648)) {
        loop_20648 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (548)) ;
      }
      if (loop_20648) {
        variant_20648 -- ;
        var_pass.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (550)) ;
        GALGAS_symbolTableForRelativesResolution var_symbolTable ;
        {
        routine_computeLabelAbsoluteAddressMap (ioArgument_ioGeneratedBlockList, var_symbolTable, inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
        }
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (555)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (555)) ;
        GALGAS_uint var_conversionCount = GALGAS_uint ((PMUInt32) 0U) ;
        {
        routine_checkRelativeResolution (var_symbolTable, ioArgument_ioGeneratedBlockList, var_conversionCount, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (557)) ;
        }
        const enumGalgasBool test_1 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_string var_s = GALGAS_string ("--- Pass ").operator_concat (var_pass.reader_string (SOURCE_FILE_AT_LINE (564)) COMMA_SOURCE_FILE_AT_LINE (564)).operator_concat (GALGAS_string (": ") COMMA_SOURCE_FILE_AT_LINE (564)) ;
          ...
          if (kBoolTrue == test_2) {
            ...
            var_s.dotAssign_operation (GALGAS_string ("none.") COMMA_SOURCE_FILE_AT_LINE (567)) ;
          }else if (kBoolFalse == test_2) {
            const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_conversionCount.objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
            if (kBoolTrue == test_3) {
              var_s.dotAssign_operation (GALGAS_string ("1 conversion") COMMA_SOURCE_FILE_AT_LINE (569)) ;
            }else if (kBoolFalse == test_3) {
              var_s.dotAssign_operation (var_conversionCount.reader_string (SOURCE_FILE_AT_LINE (571)).operator_concat (GALGAS_string (" conversions") COMMA_SOURCE_FILE_AT_LINE (571)) COMMA_SOURCE_FILE_AT_LINE (571)) ;
            }
          }
