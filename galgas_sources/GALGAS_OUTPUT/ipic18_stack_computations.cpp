...
void cMapElement_blockMapForStackComputation::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
void cMapElement_routineCallMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
void cMapElement_routineStackRequirementMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mLevels" ":" ;
...
void routine_ipic_31__38_StackComputations (GALGAS_string & ioArgument_ioListFileContents,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("STACK COMPUTATIONS").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (181)).operator_concat (GALGAS_string ("\n"
  ...
  cEnumerator_ipic_31__38_BlockList enumerator_6209 (constinArgument_inBlockList, kEnumeration_up) ;
  while (enumerator_6209.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_6209.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (186)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_startLabelsToExplore.addAssign_operation (enumerator_6209.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (187)) ;
    }
    {
    var_blockMapForStackComputation.modifier_insertKey (enumerator_6209.current_mBlock (HERE).mAttribute_mLabel, enumerator_6209.current_mBlock (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) ;
    }
  ...
  if (constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (193)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).isValid ()) {
    PMUInt32 variant_6537 = constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (193)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).uintValue () ;
    bool loop_6537 = true ;
    while (loop_6537) {
      loop_6537 = GALGAS_bool (kIsStrictSup, var_startLabelsToExplore.reader_count (SOURCE_FILE_AT_LINE (194)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_6537) {
        loop_6537 = GALGAS_bool (kIsStrictSup, var_startLabelsToExplore.reader_count (SOURCE_FILE_AT_LINE (194)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_6537 && (0 == variant_6537)) {
        loop_6537 = false ;
      ...
      if (loop_6537) {
        ...
        if (constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (203)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (203)).isValid ()) {
          PMUInt32 variant_6947 = constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (203)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (203)).uintValue () ;
          bool loop_6947 = true ;
          while (loop_6947) {
            loop_6947 = GALGAS_bool (kIsStrictSup, var_blockToExploreSet.reader_count (SOURCE_FILE_AT_LINE (204)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
            if (loop_6947) {
              loop_6947 = GALGAS_bool (kIsStrictSup, var_blockToExploreSet.reader_count (SOURCE_FILE_AT_LINE (204)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
            }
            ...
            if (loop_6947) {
              ...
              cEnumerator_ipic_31__38_SequentialInstructionList enumerator_7367 (var_aBlock.mAttribute_mInstructionList, kEnumeration_up) ;
              while (enumerator_7367.hasCurrentObject ()) {
                callCategoryMethod_buildCalledRoutineSet ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_7367.current_mInstruction (HERE).ptr (), var_calledRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) ;
        ...
        cEnumerator_stringset enumerator_7575 (var_calledRoutineSet, kEnumeration_up) ;
        while (enumerator_7575.hasCurrentObject ()) {
          const enumGalgasBool test_1 = var_routineCallMap.reader_hasKey (enumerator_7575.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (217)).operator_not (SOURCE_FILE_AT_LINE (217)).boolEnum () ;
          if (kBoolTrue == test_1) {
            var_startLabelsToExplore.addAssign_operation (enumerator_7575.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (218)) ;
          }
  ...
  if (var_routineCallMap.reader_count (SOURCE_FILE_AT_LINE (226)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).isValid ()) {
    PMUInt32 variant_7886 = var_routineCallMap.reader_count (SOURCE_FILE_AT_LINE (226)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).uintValue () ;
    bool loop_7886 = true ;
    while (loop_7886) {
      loop_7886 = var_progress.isValid () ;
      if (loop_7886) {
        loop_7886 = var_progress.boolValue () ;
      }
      if (loop_7886 && (0 == variant_7886)) {
        loop_7886 = false ;
      ...
      if (loop_7886) {
        ...
        cEnumerator_routineCallMap enumerator_8102 (var_tempRoutineCallMap, kEnumeration_up) ;
        while (enumerator_8102.hasCurrentObject ()) {
          GALGAS_uint var_levels = GALGAS_uint ((PMUInt32) 0U) ;
          GALGAS_bool var_solved = GALGAS_bool (true) ;
          cEnumerator_stringset enumerator_8192 (enumerator_8102.current_mCalledRoutineSet (HERE), kEnumeration_up) ;
          bool bool_2 = var_solved.isValidAndTrue () ;
          if (enumerator_8192.hasCurrentObject () && bool_2) {
            while (enumerator_8192.hasCurrentObject () && bool_2) {
              var_solved = var_routineStackRequirementMap.reader_hasKey (enumerator_8192.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (236)) ;
              const enumGalgasBool test_3 = var_solved.boolEnum () ;
              if (kBoolTrue == test_3) {
                GALGAS_uint var_rLevel ;
                var_routineStackRequirementMap.method_searchKey (enumerator_8192.current_key (HERE).reader_nowhere (SOURCE_FILE_AT_LINE (238)), var_rLevel, inCompiler COMMA_SOURCE_FILE_AT_LINE (238)) ;
                const enumGalgasBool test_4 = GALGAS_bool (kIsInfOrEqual, var_levels.objectCompare (var_rLevel)).boolEnum () ;
                if (kBoolTrue == test_4) {
                  var_levels = var_rLevel.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (240)) ;
                }
              }
              enumerator_8192.gotoNextObject () ;
              if (enumerator_8192.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_5) {
            {
            var_routineStackRequirementMap.modifier_insertKey (enumerator_8102.current_lkey (HERE), var_levels, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)) ;
            }
            var_progress = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_5) {
            {
            var_routineCallMap.modifier_insertKey (enumerator_8102.current_lkey (HERE), enumerator_8102.current_mCalledRoutineSet (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (248)) ;
            }
          }
  ...
  cEnumerator_routineStackRequirementMap enumerator_8815 (var_routineStackRequirementMap, kEnumeration_up) ;
  while (enumerator_8815.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (enumerator_8815.current_mLevels (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 6U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (enumerator_8815.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)) ;
  ...
  GALGAS_bool var_noRecursiveRoutine = GALGAS_bool (kIsEqual, var_routineCallMap.reader_count (SOURCE_FILE_AT_LINE (258)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) ;
  ...
  if (kBoolTrue == test_6) {
    ...
    cEnumerator_routineCallMap enumerator_9326 (var_routineCallMap, kEnumeration_up) ;
    while (enumerator_9326.hasCurrentObject ()) {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  - ").operator_concat (enumerator_9326.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    if (kBoolTrue == test_9) {
      ...
      var_totalLevels = var_totalLevels.add_operation (var_highIntLevels, inCompiler COMMA_SOURCE_FILE_AT_LINE (275)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (275)) ;
    }
    ...
    if (kBoolTrue == test_10) {
      ...
      var_totalLevels = var_totalLevels.add_operation (var_lowIntLevels, inCompiler COMMA_SOURCE_FILE_AT_LINE (279)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (279)) ;
    }
    ...
    const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_totalLevels.objectCompare (GALGAS_uint ((PMUInt32) 31U))).boolEnum () ;
...
void enterCategoryMethod_exploreAccessibleBlocks (const PMSInt32 inClassIndex,
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_exploreAccessibleBlocks ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionTrue.ptr (), ioArgument_ioBlockToExploreSet, ioArgument_ioExploredBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (45)) ;
  callCategoryMethod_exploreAccessibleBlocks ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mInstructionIfConditionFalse.ptr (), ioArgument_ioBlockToExploreSet, ioArgument_ioExploredBlockSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (46)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_1948 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_1948.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioExploredBlockSet.reader_hasKey (enumerator_1948.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (56)).operator_not (SOURCE_FILE_AT_LINE (56)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioBlockToExploreSet.addAssign_operation (enumerator_1948.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (57)) ;
    }
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  cEnumerator_lstringlist enumerator_2346 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_2346.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioExploredBlockSet.reader_hasKey (enumerator_2346.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (69)).operator_not (SOURCE_FILE_AT_LINE (69)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioBlockToExploreSet.addAssign_operation (enumerator_2346.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (70)) ;
    }
...
void enterCategoryMethod_buildCalledRoutineSet (const PMSInt32 inClassIndex,
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_buildCalledRoutineSet (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  cEnumerator_ipic_31__38_SequentialInstructionList enumerator_5119 (object->mAttribute_mTargetInstructions, kEnumeration_up) ;
  while (enumerator_5119.hasCurrentObject ()) {
    callCategoryMethod_buildCalledRoutineSet ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_5119.current_mInstruction (HERE).ptr (), ioArgument_ioRoutineCalledSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
