...
void routine_ipic_31__38_StackComputations (GALGAS_string & ioArgument_ioListFileContents,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 179)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 179))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 179)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("STACK COMPUTATIONS").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 180))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 180)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 180))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 180)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 181)).operator_concat (GALGAS_string ("\n"
    "\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 181))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 181)) ;
  GALGAS_stringset var_startLabelsToExplore = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 183)) ;
  GALGAS_blockMapForStackComputation var_blockMapForStackComputation = GALGAS_blockMapForStackComputation::constructor_emptyMap (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 184)) ;
  ...
  while (enumerator_6241.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_6241.current_mBlock (HERE).mAttribute_mAddress.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 186)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_startLabelsToExplore.addAssign_operation (enumerator_6241.current_mBlock (HERE).mAttribute_mLabel.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 187)) ;
    }
    {
    var_blockMapForStackComputation.modifier_insertKey (enumerator_6241.current_mBlock (HERE).mAttribute_mLabel, enumerator_6241.current_mBlock (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 189)) ;
    }
    enumerator_6241.gotoNextObject () ;
  }
  GALGAS_routineCallMap var_routineCallMap = GALGAS_routineCallMap::constructor_emptyMap (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 192)) ;
  if (constinArgument_inBlockList.reader_length (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 193)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 193)).isValid ()) {
    uint32_t variant_6569 = constinArgument_inBlockList.reader_length (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 193)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 193)).uintValue () ;
    bool loop_6569 = true ;
    while (loop_6569) {
      loop_6569 = GALGAS_bool (kIsStrictSup, var_startLabelsToExplore.reader_count (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 194)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_6569) {
        loop_6569 = GALGAS_bool (kIsStrictSup, var_startLabelsToExplore.reader_count (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 194)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_6569 && (0 == variant_6569)) {
        loop_6569 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 193)) ;
      }
      if (loop_6569) {
        variant_6569 -- ;
        GALGAS_string var_startLabel = var_startLabelsToExplore.reader_anyString (inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 196)) ;
        {
        var_startLabelsToExplore.modifier_removeKey (var_startLabel COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 197)) ;
        }
        GALGAS_stringset var_blockToExploreSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 199)) ;
        var_blockToExploreSet.addAssign_operation (var_startLabel  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 200)) ;
        GALGAS_stringset var_exploredBlockSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 201)) ;
        GALGAS_stringset var_calledRoutineSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 202)) ;
        if (constinArgument_inBlockList.reader_length (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 203)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 203)).isValid ()) {
          uint32_t variant_6979 = constinArgument_inBlockList.reader_length (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 203)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 203)).uintValue () ;
          bool loop_6979 = true ;
          while (loop_6979) {
            loop_6979 = GALGAS_bool (kIsStrictSup, var_blockToExploreSet.reader_count (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 204)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
            if (loop_6979) {
              loop_6979 = GALGAS_bool (kIsStrictSup, var_blockToExploreSet.reader_count (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 204)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
            }
            if (loop_6979 && (0 == variant_6979)) {
              loop_6979 = false ;
              inCompiler->loopRunTimeVariantError (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 203)) ;
            }
            if (loop_6979) {
              variant_6979 -- ;
              GALGAS_string var_b = var_blockToExploreSet.reader_anyString (inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 206)) ;
              {
              var_blockToExploreSet.modifier_removeKey (var_b COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 207)) ;
              }
              var_exploredBlockSet.addAssign_operation (var_b  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 208)) ;
              GALGAS_ipic_31__38_Block var_aBlock ;
              var_blockMapForStackComputation.method_searchKey (var_b.reader_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 209)), var_aBlock, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 209)) ;
              callCategoryMethod_exploreAccessibleBlocks ((const cPtr_ipic_31__38_AbstractBlockTerminator *) var_aBlock.mAttribute_mTerminator.ptr (), var_blockToExploreSet, var_exploredBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 210)) ;
              ...
              while (enumerator_7399.hasCurrentObject ()) {
                callCategoryMethod_buildCalledRoutineSet ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_7399.current_mInstruction (HERE).ptr (), var_calledRoutineSet, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 212)) ;
        ...
        {
        var_routineCallMap.modifier_insertKey (var_startLabel.reader_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 215)), var_calledRoutineSet, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 215)) ;
        }
        cEnumerator_stringset enumerator_7607 (var_calledRoutineSet, kEnumeration_up) ;
        while (enumerator_7607.hasCurrentObject ()) {
          const enumGalgasBool test_1 = var_routineCallMap.reader_hasKey (enumerator_7607.current_key (HERE) COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 217)).operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 217)).boolEnum () ;
          if (kBoolTrue == test_1) {
            var_startLabelsToExplore.addAssign_operation (enumerator_7607.current_key (HERE)  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 218)) ;
          }
  ...
  GALGAS_routineStackRequirementMap var_routineStackRequirementMap = GALGAS_routineStackRequirementMap::constructor_emptyMap (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 224)) ;
  GALGAS_bool var_progress = GALGAS_bool (true) ;
  if (var_routineCallMap.reader_count (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 226)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 226)).isValid ()) {
    uint32_t variant_7918 = var_routineCallMap.reader_count (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 226)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 226)).uintValue () ;
    bool loop_7918 = true ;
    while (loop_7918) {
      ...
      if (loop_7918 && (0 == variant_7918)) {
        loop_7918 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 226)) ;
      }
      if (loop_7918) {
        variant_7918 -- ;
        var_progress = GALGAS_bool (false) ;
        GALGAS_routineCallMap var_tempRoutineCallMap = var_routineCallMap ;
        var_routineCallMap = GALGAS_routineCallMap::constructor_emptyMap (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 231)) ;
        ...
        while (enumerator_8134.hasCurrentObject ()) {
          ...
          if (enumerator_8224.hasCurrentObject () && bool_2) {
            while (enumerator_8224.hasCurrentObject () && bool_2) {
              var_solved = var_routineStackRequirementMap.reader_hasKey (enumerator_8224.current_key (HERE) COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 236)) ;
              const enumGalgasBool test_3 = var_solved.boolEnum () ;
              if (kBoolTrue == test_3) {
                GALGAS_uint var_rLevel ;
                var_routineStackRequirementMap.method_searchKey (enumerator_8224.current_key (HERE).reader_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 238)), var_rLevel, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 238)) ;
                const enumGalgasBool test_4 = GALGAS_bool (kIsInfOrEqual, var_levels.objectCompare (var_rLevel)).boolEnum () ;
                if (kBoolTrue == test_4) {
                  var_levels = var_rLevel.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 240)) ;
                }
              }
          ...
          if (kBoolTrue == test_5) {
            {
            var_routineStackRequirementMap.modifier_insertKey (enumerator_8134.current_lkey (HERE), var_levels, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 245)) ;
            }
            var_progress = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_5) {
            {
            var_routineCallMap.modifier_insertKey (enumerator_8134.current_lkey (HERE), enumerator_8134.current_mCalledRoutineSet (HERE), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 248)) ;
            }
          }
  ...
  while (enumerator_8847.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (enumerator_8847.current_mLevels (HERE).reader_string (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 254)).reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 6U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 254)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 254)).operator_concat (enumerator_8847.current_lkey (HERE).reader_string (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 254))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 254)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 254))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 254)) ;
    enumerator_8847.gotoNextObject () ;
  }
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 256)) ;
  GALGAS_bool var_noRecursiveRoutine = GALGAS_bool (kIsEqual, var_routineCallMap.reader_count (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 258)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
  const enumGalgasBool test_6 = var_noRecursiveRoutine.operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 259)).boolEnum () ;
  if (kBoolTrue == test_6) {
    const enumGalgasBool test_7 = GALGAS_bool (gOption_piccolo_5F_options_doNotWarnRecursive.reader_value ()).operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 260)).boolEnum () ;
    if (kBoolTrue == test_7) {
      inCompiler->emitSemanticWarning (GALGAS_location::constructor_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 261)), GALGAS_string ("There are recursive routines")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 261)) ;
    }
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("The following routines are recursive:\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 263)) ;
    cEnumerator_routineCallMap enumerator_9358 (var_routineCallMap, kEnumeration_up) ;
    while (enumerator_9358.hasCurrentObject ()) {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  - ").operator_concat (enumerator_9358.current_lkey (HERE).reader_string (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 265))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 265)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 265))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 265)) ;
      enumerator_9358.gotoNextObject () ;
    }
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 267)) ;
  }
  const enumGalgasBool test_8 = var_noRecursiveRoutine.boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_uint var_mainLevels ;
    var_routineStackRequirementMap.method_searchKey (GALGAS_string (".START").reader_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 271)), var_mainLevels, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 271)) ;
    GALGAS_uint var_totalLevels = var_mainLevels ;
    const enumGalgasBool test_9 = var_routineStackRequirementMap.reader_hasKey (GALGAS_string (".HIGH_INTERRUPT") COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 273)).boolEnum () ;
    if (kBoolTrue == test_9) {
      GALGAS_uint var_highIntLevels ;
      var_routineStackRequirementMap.method_searchKey (GALGAS_string (".HIGH_INTERRUPT").reader_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 274)), var_highIntLevels, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 274)) ;
      var_totalLevels = var_totalLevels.add_operation (var_highIntLevels, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 275)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 275)) ;
    }
    const enumGalgasBool test_10 = var_routineStackRequirementMap.reader_hasKey (GALGAS_string (".LOW_INTERRUPT") COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 277)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_uint var_lowIntLevels ;
      var_routineStackRequirementMap.method_searchKey (GALGAS_string (".LOW_INTERRUPT").reader_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 278)), var_lowIntLevels, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 278)) ;
      var_totalLevels = var_totalLevels.add_operation (var_lowIntLevels, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 279)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 279)) ;
    }
    inCompiler->printMessage (GALGAS_string ("Max stack depth: ").operator_concat (var_totalLevels.reader_string (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 281))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 281)).operator_concat (GALGAS_string ("\n"
      "\n")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 281))  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 281)) ;
    ...
    if (kBoolTrue == test_11) {
      inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 283)), GALGAS_string ("Max stack depth is greater than 31")  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 283)) ;
    }
  }
}
...
static void categoryMethod_ipic_31__38_AbstractConditionTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  callCategoryMethod_exploreAccessibleBlocks ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionTrue.ptr (), ioArgument_ioBlockToExploreSet, ioArgument_ioExploredBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 45)) ;
  callCategoryMethod_exploreAccessibleBlocks ((const cPtr_ipic_31__38_SingleInstructionTerminator *) object->mAttribute_mSingleInstructionTerminatorIfConditionFalse.ptr (), ioArgument_ioBlockToExploreSet, ioArgument_ioExploredBlockSet, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 46)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ComputedBraTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  while (enumerator_1980.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioExploredBlockSet.reader_hasKey (enumerator_1980.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 56)).operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 56)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioBlockToExploreSet.addAssign_operation (enumerator_1980.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 57)) ;
    }
...
static void categoryMethod_ipic_31__38_ComputedGotoTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  while (enumerator_2378.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioExploredBlockSet.reader_hasKey (enumerator_2378.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 69)).operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 69)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioBlockToExploreSet.addAssign_operation (enumerator_2378.current_mValue (HERE).mAttribute_string  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 70)) ;
    }
...
static void categoryMethod_ipic_31__38_JumpTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const enumGalgasBool test_0 = ioArgument_ioExploredBlockSet.reader_hasKey (object->mAttribute_mLabel.mAttribute_string COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 81)).operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 81)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioBlockToExploreSet.addAssign_operation (object->mAttribute_mLabel.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 82)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38_ConditionalJumpTerminator_exploreAccessibleBlocks (const cPtr_ipic_31__38_AbstractBlockTerminator * inObject,
  ...
  const enumGalgasBool test_0 = ioArgument_ioExploredBlockSet.reader_hasKey (object->mAttribute_mTargetLabelWhenTrue.mAttribute_string COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 92)).operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 92)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioBlockToExploreSet.addAssign_operation (object->mAttribute_mTargetLabelWhenTrue.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 93)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioExploredBlockSet.reader_hasKey (object->mAttribute_mTargetLabelWhenFalse.mAttribute_string COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 95)).operator_not (SOURCE_FILE ("ipic18_stack_computations.gSemantics", 95)).boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioBlockToExploreSet.addAssign_operation (object->mAttribute_mTargetLabelWhenFalse.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 96)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_JSR_buildCalledRoutineSet (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  ioArgument_ioRoutineCalledSet.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string  COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 148)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ipic_31__38__5F_intermediate_5F_instruction_5F_computed_5F_rcall_buildCalledRoutineSet (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  while (enumerator_5151.hasCurrentObject ()) {
    callCategoryMethod_buildCalledRoutineSet ((const cPtr_ipic_31__38_SequentialInstruction *) enumerator_5151.current_mInstruction (HERE).ptr (), ioArgument_ioRoutineCalledSet, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 157)) ;
...
static void categoryMethod_ipic_31__38__5F_condition_5F_skip_5F_instruction_buildCalledRoutineSet (const cPtr_ipic_31__38_SequentialInstruction * inObject,
  ...
  callCategoryMethod_buildCalledRoutineSet ((const cPtr_ipic_31__38_SequentialInstruction *) object->mAttribute_mEmbeddedInstruction.ptr (), ioArgument_ioRoutineCalledSet, inCompiler COMMA_SOURCE_FILE ("ipic18_stack_computations.gSemantics", 166)) ;
}
//-----------------------------------------------------------------------------*
