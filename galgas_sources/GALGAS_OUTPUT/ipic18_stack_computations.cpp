...
void routine_ipic_31__38_StackComputations (GALGAS_string & ioArgument_ioListFileContents,
  ...
  if (constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (193)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).isValid ()) {
    PMUInt32 variant_6569 = constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (193)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).uintValue () ;
    bool loop_6569 = true ;
    while (loop_6569) {
      loop_6569 = GALGAS_bool (kIsStrictSup, var_startLabelsToExplore.reader_count (SOURCE_FILE_AT_LINE (194)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_6569) {
        loop_6569 = GALGAS_bool (kIsStrictSup, var_startLabelsToExplore.reader_count (SOURCE_FILE_AT_LINE (194)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      ...
      if (loop_6569) {
        ...
        if (constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (203)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (203)).isValid ()) {
          PMUInt32 variant_6979 = constinArgument_inBlockList.reader_length (SOURCE_FILE_AT_LINE (203)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (203)).uintValue () ;
          bool loop_6979 = true ;
          while (loop_6979) {
            loop_6979 = GALGAS_bool (kIsStrictSup, var_blockToExploreSet.reader_count (SOURCE_FILE_AT_LINE (204)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
            if (loop_6979) {
              loop_6979 = GALGAS_bool (kIsStrictSup, var_blockToExploreSet.reader_count (SOURCE_FILE_AT_LINE (204)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
            }
  ...
  if (var_routineCallMap.reader_count (SOURCE_FILE_AT_LINE (226)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).isValid ()) {
    PMUInt32 variant_7918 = var_routineCallMap.reader_count (SOURCE_FILE_AT_LINE (226)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).uintValue () ;
    bool loop_7918 = true ;
    while (loop_7918) {
  ...
  while (enumerator_8847.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (enumerator_8847.current_mLevels (HERE).reader_string (SOURCE_FILE_AT_LINE (254)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 6U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (enumerator_8847.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)) ;
