...
//                    november 15th, 2010, at 20h33'25"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_checkCurrentEmitAddress (const GALGAS_uint constinArgument_inCurrentAddress,
  ...
  if (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (28)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_addr.objectCompare (constinArgument_inCurrentAddress)) COMMA_SOURCE_FILE_AT_LINE (28)).isValidAndTrue ()) {
...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
                                              ...
                                              COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, constinArgument_inConstantMap.reader_count (SOURCE_FILE_AT_LINE (437)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @appendInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (438)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (438)) COMMA_SOURCE_FILE_AT_LINE (438)) ;
    //-------- @appendInstructionForGeneration
    ...
    //-------- @appendInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("\n"
    ...
    cEnumerator_constantMap enumerator_16531 (constinArgument_inConstantMap, true) ;
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (constinArgument_inRegisterTable.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (93)).reader_string (SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)).isValidAndTrue ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (constinArgument_inConstantMap.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (102)).reader_string (SOURCE_FILE_AT_LINE (102)) COMMA_SOURCE_FILE_AT_LINE (102)).isValidAndTrue ()) {
      //-------- @methodCallInstructionForGeneration
      ...
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsStrictSup, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (104)).reader_uint (SOURCE_FILE_AT_LINE (104)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_1 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (105)).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("index notation (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (105)).reader_uint (SOURCE_FILE_AT_LINE (105)).reader_string (SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)).operator_concat (GALGAS_string (") cannot be used with a constant") COMMA_SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)) ;
      }
    }else{
      //-------- @errorInstructionForGeneration
      GALGAS_location location_2 (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (108)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("'").operator_concat (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (108)).reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).operator_concat (GALGAS_string ("' should be declared as ram register or as constant") COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)) ;
...
static void categoryMethod_immediatEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftResult.objectCompare (var_rightResult)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_immediatNotEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_leftResult.objectCompare (var_rightResult)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = GALGAS_sint ((PMSInt32) 1L) ;
  }else{
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_immediatGreaterOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsSupOrEqual, var_leftResult.objectCompare (var_rightResult)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = GALGAS_sint ((PMSInt32) 1L) ;
  }else{
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_immediatLowerOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsInfOrEqual, var_leftResult.objectCompare (var_rightResult)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = GALGAS_sint ((PMSInt32) 1L) ;
  }else{
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_immediatGreaterTest_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, var_leftResult.objectCompare (var_rightResult)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = GALGAS_sint ((PMSInt32) 1L) ;
  }else{
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_immediatLowerTest_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictInf, var_leftResult.objectCompare (var_rightResult)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = GALGAS_sint ((PMSInt32) 1L) ;
  }else{
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_immediatSliceExpressionList enumerator_12953 (object->mAttribute_mSliceExpressionList, true) ;
  //--- simple foreach instruction
  while (enumerator_12953.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (var_sliceNameSet.reader_hasKey (enumerator_12953.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (enumerator_12953.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_12953.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)).operator_concat (GALGAS_string ("' bit field has been already defined") COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ;
    }else{
...
static void categoryMethod_bitNumberLiteralValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (396)).objectCompare (GALGAS_uint ((PMUInt32) 7U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_0 (object->mAttribute_mBitNumberLiteralValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("The bit number is ").operator_concat (object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (397)).reader_string (SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)).operator_concat (GALGAS_string (" (should be <= 7)") COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)) ;
  }
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_bitNumberLabelValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (411)).objectCompare (var_sliceSize)).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_0 (object->mAttribute_mBitNumberIndexValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("The ").operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (412)).reader_string (SOURCE_FILE_AT_LINE (412)) COMMA_SOURCE_FILE_AT_LINE (412)).operator_concat (GALGAS_string (" index is too large (should be < ") COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (var_sliceSize.reader_string (SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (412)) ;
  }
  //-------- @assignmentInstructionForGeneration
