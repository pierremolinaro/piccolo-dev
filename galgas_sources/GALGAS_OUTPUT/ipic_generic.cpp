...
void routine_checkCurrentEmitAddress (const GALGAS_uint constinArgument_inCurrentAddress,
  ...
  routine_currentEmitAddress (var_addr, inCompiler COMMA_SOURCE_FILE_AT_LINE (27)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (28)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_addr.objectCompare (constinArgument_inCurrentAddress)) COMMA_SOURCE_FILE_AT_LINE (28)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("internal error: current emit address is ").operator_concat (var_addr.reader_hexString (SOURCE_FILE_AT_LINE (29)) COMMA_SOURCE_FILE_AT_LINE (29)).operator_concat (GALGAS_string ("; it should be ") COMMA_SOURCE_FILE_AT_LINE (30)).operator_concat (constinArgument_inCurrentAddress.reader_hexString (SOURCE_FILE_AT_LINE (30)) COMMA_SOURCE_FILE_AT_LINE (30)) COMMA_SOURCE_FILE_AT_LINE (29)) ;
  }
}
...
GALGAS_constantMap_3A_element cEnumerator_constantMap::current (LOCATION_ARGS) const {
  const cMapElement_constantMap * p = (const cMapElement_constantMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_constantMap) ;
  return GALGAS_constantMap_3A_element (p->mAttribute_lkey, p->mAttribute_mValue) ;
}
...
GALGAS_sint cEnumerator_constantMap::current_mValue (LOCATION_ARGS) const {
  const cMapElement_constantMap * p = (const cMapElement_constantMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_constantMap) ;
...
GALGAS_routineMap_3A_element cEnumerator_routineMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_routineMap) ;
  return GALGAS_routineMap_3A_element (p->mAttribute_lkey, p->mAttribute_mIsNoReturn, p->mAttribute_mRequiredBank, p->mAttribute_mReturnedBank, p->mAttribute_mPreservesBank) ;
}
...
GALGAS_symbolTableForOptimizations_3A_element cEnumerator_symbolTableForOptimizations::current (LOCATION_ARGS) const {
  const cMapElement_symbolTableForOptimizations * p = (const cMapElement_symbolTableForOptimizations *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_symbolTableForOptimizations) ;
  return GALGAS_symbolTableForOptimizations_3A_element (p->mAttribute_lkey, p->mAttribute_mDefinitionLineIndex) ;
}
...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
                                              ...
                                              COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inConstantMap.reader_count (SOURCE_FILE_AT_LINE (437)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (438)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (438)) COMMA_SOURCE_FILE_AT_LINE (438)) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CONSTANTS").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (439)) COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (439)) COMMA_SOURCE_FILE_AT_LINE (439)) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Constant").reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (441)).operator_concat (GALGAS_string (" Value\n") COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_constantMap enumerator_16531 (constinArgument_inConstantMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16531.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioListFileContents.dotAssign_operation (enumerator_16531.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (443)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (443)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (443)).operator_concat (enumerator_16531.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (443)) COMMA_SOURCE_FILE_AT_LINE (443)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (443)) COMMA_SOURCE_FILE_AT_LINE (443)) ;
...
static void categoryMethod_immediatInteger_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = object->mAttribute_mValue.reader_uint (SOURCE_FILE_AT_LINE (83)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (83)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inRegisterTable.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (93)).reader_string (SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_bitSliceTable joker_3596_0 ; // Joker input parameter
    GALGAS_string joker_3599_0 ; // Joker input parameter
    constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (96)), var_registerAddressList, var_size, joker_3596_0, joker_3599_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_uint var_registerAddress ;
    //-------- @methodCallInstructionForGeneration
    var_registerAddressList.method_first (var_registerAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (97)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (98)).reader_uint (SOURCE_FILE_AT_LINE (98)).objectCompare (var_size)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_2 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (99)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("index (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (99)).reader_uint (SOURCE_FILE_AT_LINE (99)).reader_string (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (GALGAS_string (") should be lower than size (") COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)) ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = var_registerAddress.add_operation (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (101)).reader_uint (SOURCE_FILE_AT_LINE (101)), inCompiler COMMA_SOURCE_FILE_AT_LINE (101)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inConstantMap.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (102)).reader_string (SOURCE_FILE_AT_LINE (102)) COMMA_SOURCE_FILE_AT_LINE (102)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @methodCallInstructionForGeneration
      constinArgument_inConstantMap.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (103)), outArgument_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (103)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (104)).reader_uint (SOURCE_FILE_AT_LINE (104)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_5 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (105)).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("index notation (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (105)).reader_uint (SOURCE_FILE_AT_LINE (105)).reader_string (SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)).operator_concat (GALGAS_string (") cannot be used with a constant") COMMA_SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_6 (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (108)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (108)).reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).operator_concat (GALGAS_string ("' should be declared as ram register or as constant") COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)) ;
...
static void categoryMethod_immediatAdd_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.add_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatSub_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.substract_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatMul_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.multiply_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatDiv_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.divide_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatMod_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.modulo_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatAnd_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (180)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.operator_and (var_rightResult COMMA_SOURCE_FILE_AT_LINE (181)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatOr_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (191)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.operator_or (var_rightResult COMMA_SOURCE_FILE_AT_LINE (193)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatXor_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (203)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.operator_xor (var_rightResult COMMA_SOURCE_FILE_AT_LINE (205)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatLeftShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (215)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.left_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatRightShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (227)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (228)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.right_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (229)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (239)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (240)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftResult.objectCompare (var_rightResult)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = GALGAS_sint ((PMSInt32) 1L) ;
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = GALGAS_sint ((PMSInt32) 0L) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatNotEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (255)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (256)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatGreaterOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (271)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatLowerOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (287)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (288)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatGreaterTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (303)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (304)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatLowerTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatNegate_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_result.operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (336)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatComplement_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_result ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_result.operator_tilde (SOURCE_FILE_AT_LINE (347)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = GALGAS_sint ((PMSInt32) 0L) ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_uintlist joker_12855_0 ; // Joker input parameter
  GALGAS_uint joker_12858_0 ; // Joker input parameter
  GALGAS_string joker_12877_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, joker_12855_0, joker_12858_0, var_bitSliceTable, joker_12877_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (359)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_sliceNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (360)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_immediatSliceExpressionList enumerator_12953 (object->mAttribute_mSliceExpressionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12953.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_sliceNameSet.reader_hasKey (enumerator_12953.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_12953.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_12953.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)).operator_concat (GALGAS_string ("' bit field has been already defined") COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @plusEqualnstructionForGeneration
      var_sliceNameSet.addAssign_operation (enumerator_12953.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (365)) COMMA_SOURCE_FILE_AT_LINE (365)) ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_uint var_sliceIndex ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_uint var_sliceSize ;
      //-------- @methodCallInstructionForGeneration
      var_bitSliceTable.method_searchKey (enumerator_12953.current_mSliceName (HERE), var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (368)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_sint var_result ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_12953.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (369)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictInf, var_result.objectCompare (GALGAS_sint ((PMSInt32) 0L))).operator_or (GALGAS_bool (kIsStrictSup, var_result.objectCompare (GALGAS_sint ((PMSInt32) 1L).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (370)).substract_operation (GALGAS_sint ((PMSInt32) 1L), inCompiler COMMA_SOURCE_FILE_AT_LINE (370)))) COMMA_SOURCE_FILE_AT_LINE (370)).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_12953.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("invalid immediat value associated to the '").operator_concat (enumerator_12953.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string ("' bit field, evaluated as ") COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (var_result.reader_string (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string (" (should be between 0 and ") COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_uint ((PMUInt32) 1U).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (372)).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (372)).reader_string (SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (371)) ;
      }
      //-------- @assignmentInstructionForGeneration
      outArgument_outResult = outArgument_outResult.operator_or (var_result.left_shift_operation (var_sliceIndex COMMA_SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)) ;
    }
...
static void categoryMethod_bitNumberLiteralValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (396)).objectCompare (GALGAS_uint ((PMUInt32) 7U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mBitNumberLiteralValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The bit number is ").operator_concat (object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (397)).reader_string (SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)).operator_concat (GALGAS_string (" (should be <= 7)") COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)) ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outBitNumber = object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (399)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_bitNumberLabelValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  GALGAS_uint var_sliceSize ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBitSliceTable.method_searchKey (object->mAttribute_mBitNumberLabelValue, var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (410)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (411)).objectCompare (var_sliceSize)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mBitNumberIndexValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The ").operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (412)).reader_string (SOURCE_FILE_AT_LINE (412)) COMMA_SOURCE_FILE_AT_LINE (412)).operator_concat (GALGAS_string (" index is too large (should be < ") COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (var_sliceSize.reader_string (SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (412)) ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outBitNumber = var_sliceIndex.add_operation (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (415)), inCompiler COMMA_SOURCE_FILE_AT_LINE (415)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_constantMap_3A_element::GALGAS_constantMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mValue () {
}
...
GALGAS_constantMap_3A_element::GALGAS_constantMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_constantMap_3A_element & GALGAS_constantMap_3A_element::operator = (const GALGAS_constantMap_3A_element & inOperand) {
...
GALGAS_constantMap_3A_element GALGAS_constantMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_sint & inOperand1 
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_constantMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_constantMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_constantMap_3A_element::objectCompare (const GALGAS_constantMap_3A_element & inOperand) const {
...
bool GALGAS_constantMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mValue.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_constantMap_3A_element::drop (void) {
...
void GALGAS_constantMap_3A_element::description (C_String & ioString,
                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_constantMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_sint GALGAS_constantMap_3A_element::reader_mValue (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_constantMap_3A_element ("constantMap:element",
                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_constantMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_constantMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_constantMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_constantMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_constantMap_3A_element GALGAS_constantMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                            C_Compiler * inCompiler,
                                                                            const GALGAS_location & inErrorLocation
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_constantMap_3A_element result ;
  const GALGAS_constantMap_3A_element * p = (const GALGAS_constantMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_constantMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "constantMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_routineMap_3A_element GALGAS_routineMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_routineMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
GALGAS_bool GALGAS_routineMap_3A_element::reader_mIsNoReturn (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsNoReturn ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_routineMap_3A_element::reader_mRequiredBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRequiredBank ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_routineMap_3A_element::reader_mReturnedBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mReturnedBank ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_routineMap_3A_element::reader_mPreservesBank (UNUSED_LOCATION_ARGS) const {
...
GALGAS_symbolTableForOptimizations_3A_element::GALGAS_symbolTableForOptimizations_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_symbolTableForOptimizations_3A_element::GALGAS_symbolTableForOptimizations_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_symbolTableForOptimizations_3A_element & GALGAS_symbolTableForOptimizations_3A_element::operator = (const GALGAS_symbolTableForOptimizations_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mDefinitionLineIndex = inOperand.mAttribute_mDefinitionLineIndex ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_symbolTableForOptimizations_3A_element GALGAS_symbolTableForOptimizations_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                              const GALGAS_uint & inOperand1 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_symbolTableForOptimizations_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_symbolTableForOptimizations_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_symbolTableForOptimizations_3A_element::objectCompare (const GALGAS_symbolTableForOptimizations_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_symbolTableForOptimizations_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mDefinitionLineIndex.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_symbolTableForOptimizations_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_symbolTableForOptimizations_3A_element::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_symbolTableForOptimizations_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_symbolTableForOptimizations_3A_element::reader_mDefinitionLineIndex (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_symbolTableForOptimizations_3A_element ("symbolTableForOptimizations:element",
                                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_symbolTableForOptimizations_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_symbolTableForOptimizations_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_symbolTableForOptimizations_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_symbolTableForOptimizations_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_symbolTableForOptimizations_3A_element GALGAS_symbolTableForOptimizations_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                            C_Compiler * inCompiler,
                                                                                                            const GALGAS_location & inErrorLocation
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_symbolTableForOptimizations_3A_element result ;
  const GALGAS_symbolTableForOptimizations_3A_element * p = (const GALGAS_symbolTableForOptimizations_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_symbolTableForOptimizations_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "symbolTableForOptimizations:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
