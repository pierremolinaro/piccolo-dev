...
GALGAS_symbolTableForOptimizations_2E_element cEnumerator_symbolTableForOptimizations::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_symbolTableForOptimizations) ;
  return GALGAS_symbolTableForOptimizations_2E_element (p->mAttribute_lkey, p->mAttribute_mDefinitionLineIndex) ;
}
...
void routine_print_5F_constant_5F_definition (const GALGAS_constantMap constinArgument_inConstantMap,
                                              ...
                                              COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inConstantMap.reader_count (SOURCE_FILE_AT_LINE (450)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (451)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (451)) COMMA_SOURCE_FILE_AT_LINE (451)) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CONSTANTS").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (452)) COMMA_SOURCE_FILE_AT_LINE (452)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (452)) COMMA_SOURCE_FILE_AT_LINE (452)) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (GALGAS_string ("\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Constant").reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (454)).operator_concat (GALGAS_string (" Value\n") COMMA_SOURCE_FILE_AT_LINE (454)) COMMA_SOURCE_FILE_AT_LINE (454)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_constantMap enumerator_16931 (constinArgument_inConstantMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16931.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      ioArgument_ioListFileContents.dotAssign_operation (enumerator_16931.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (456)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (enumerator_16931.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (456)) COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (456)) COMMA_SOURCE_FILE_AT_LINE (456)) ;
...
static void categoryMethod_immediatInteger_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = object->mAttribute_mValue.reader_uint (SOURCE_FILE_AT_LINE (96)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatRegister_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inRegisterTable.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (106)).reader_string (SOURCE_FILE_AT_LINE (106)) COMMA_SOURCE_FILE_AT_LINE (106)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_bitSliceTable joker_3996_0 ; // Joker input parameter
    GALGAS_string joker_3999_0 ; // Joker input parameter
    constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (109)), var_registerAddressList, var_size, joker_3996_0, joker_3999_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_uint var_registerAddress ;
    //-------- @methodCallInstructionForGeneration
    var_registerAddressList.method_first (var_registerAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (111)).reader_uint (SOURCE_FILE_AT_LINE (111)).objectCompare (var_size)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_2 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (112)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("index (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (112)).reader_uint (SOURCE_FILE_AT_LINE (112)).reader_string (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (GALGAS_string (") should be lower than size (") COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (var_size.reader_string (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)) ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outResult = var_registerAddress.add_operation (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (114)).reader_uint (SOURCE_FILE_AT_LINE (114)), inCompiler COMMA_SOURCE_FILE_AT_LINE (114)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inConstantMap.reader_hasKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (115)).reader_string (SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @methodCallInstructionForGeneration
      constinArgument_inConstantMap.method_searchKey (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (116)), outArgument_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (117)).reader_uint (SOURCE_FILE_AT_LINE (117)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_5 (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (118)).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("index notation (").operator_concat (object->mAttribute_mRegister.reader_mOffset (SOURCE_FILE_AT_LINE (118)).reader_uint (SOURCE_FILE_AT_LINE (118)).reader_string (SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)).operator_concat (GALGAS_string (") cannot be used with a constant") COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_6 (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (121)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("'").operator_concat (object->mAttribute_mRegister.reader_mRegisterName (SOURCE_FILE_AT_LINE (121)).reader_string (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string ("' should be declared as ram register or as constant") COMMA_SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)) ;
...
static void categoryMethod_immediatAdd_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.add_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatSub_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.substract_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatMul_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.multiply_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatDiv_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.divide_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (170)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatMod_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (180)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.modulo_operation (var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (182)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatAnd_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.operator_and (var_rightResult COMMA_SOURCE_FILE_AT_LINE (194)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatOr_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.operator_or (var_rightResult COMMA_SOURCE_FILE_AT_LINE (206)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatXor_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (217)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.operator_xor (var_rightResult COMMA_SOURCE_FILE_AT_LINE (218)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatLeftShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (228)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (229)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.left_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (230)) COMMA_SOURCE_FILE_AT_LINE (230)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatRightShift_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (240)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_leftResult.right_shift_operation (var_rightResult.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (252)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (253)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatNotEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (269)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatGreaterOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (284)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (285)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatLowerOrEqualTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (301)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatGreaterTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (316)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (317)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatLowerTest_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_leftResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_leftResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (332)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_sint var_rightResult ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mRightExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_rightResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (333)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_immediatNegate_eval (const cPtr_immediatExpression * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (348)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_result.operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatComplement_eval (const cPtr_immediatExpression * inObject,
  ...
  GALGAS_sint var_result ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_eval ((const cPtr_immediatExpression *) object->mAttribute_mExpression.ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (359)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outResult = var_result.operator_tilde (SOURCE_FILE_AT_LINE (360)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_immediatSlice_eval (const cPtr_immediatExpression * inObject,
  ...
  outArgument_outResult = GALGAS_sint ((PMSInt32) 0L) ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_uintlist joker_13255_0 ; // Joker input parameter
  GALGAS_uint joker_13258_0 ; // Joker input parameter
  GALGAS_string joker_13277_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, joker_13255_0, joker_13258_0, var_bitSliceTable, joker_13277_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_sliceNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (373)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_immediatSliceExpressionList enumerator_13353 (object->mAttribute_mSliceExpressionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13353.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_sliceNameSet.reader_hasKey (enumerator_13353.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (375)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_13353.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_13353.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string ("' bit field has been already defined") COMMA_SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @plusEqualnstructionForGeneration
      var_sliceNameSet.addAssign_operation (enumerator_13353.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (378)) ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_uint var_sliceIndex ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_uint var_sliceSize ;
      //-------- @methodCallInstructionForGeneration
      var_bitSliceTable.method_searchKey (enumerator_13353.current_mSliceName (HERE), var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_sint var_result ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_eval ((const cPtr_immediatExpression *) enumerator_13353.current_mExpression (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inConstantMap, var_result, inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictInf, var_result.objectCompare (GALGAS_sint ((PMSInt32) 0L))).operator_or (GALGAS_bool (kIsStrictSup, var_result.objectCompare (GALGAS_sint ((PMSInt32) 1L).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (383)).substract_operation (GALGAS_sint ((PMSInt32) 1L), inCompiler COMMA_SOURCE_FILE_AT_LINE (383)))) COMMA_SOURCE_FILE_AT_LINE (383)).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_13353.current_mSliceName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("invalid immediat value associated to the '").operator_concat (enumerator_13353.current_mSliceName (HERE).reader_string (SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string ("' bit field, evaluated as ") COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (var_result.reader_string (SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string (" (should be between 0 and ") COMMA_SOURCE_FILE_AT_LINE (385)).operator_concat (GALGAS_uint ((PMUInt32) 1U).left_shift_operation (var_sliceSize COMMA_SOURCE_FILE_AT_LINE (385)).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (385)).reader_string (SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (385)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (384)) ;
      }
      //-------- @assignmentInstructionForGeneration
      outArgument_outResult = outArgument_outResult.operator_or (var_result.left_shift_operation (var_sliceIndex COMMA_SOURCE_FILE_AT_LINE (387)) COMMA_SOURCE_FILE_AT_LINE (387)) ;
    }
...
static void categoryMethod_bitNumberLiteralValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (409)).objectCompare (GALGAS_uint ((PMUInt32) 7U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mBitNumberLiteralValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The bit number is ").operator_concat (object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (410)).reader_string (SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)).operator_concat (GALGAS_string (" (should be <= 7)") COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)) ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outBitNumber = object->mAttribute_mBitNumberLiteralValue.reader_uint (SOURCE_FILE_AT_LINE (412)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_bitNumberLabelValue_getBitNumber (const cPtr_bitNumberExpression * inObject,
  ...
  GALGAS_uint var_sliceSize ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBitSliceTable.method_searchKey (object->mAttribute_mBitNumberLabelValue, var_sliceIndex, var_sliceSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (423)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (424)).objectCompare (var_sliceSize)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mBitNumberIndexValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("The ").operator_concat (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (425)).reader_string (SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string (" index is too large (should be < ") COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (var_sliceSize.reader_string (SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (425)) ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outBitNumber = var_sliceIndex.add_operation (object->mAttribute_mBitNumberIndexValue.reader_uint (SOURCE_FILE_AT_LINE (428)), inCompiler COMMA_SOURCE_FILE_AT_LINE (428)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_sint GALGAS_constantMap_2E_element::reader_mValue (UNUSED_LOCATION_ARGS) const {
...
GALGAS_symbolTableForOptimizations_2E_element GALGAS_symbolTableForOptimizations_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_symbolTableForOptimizations_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
