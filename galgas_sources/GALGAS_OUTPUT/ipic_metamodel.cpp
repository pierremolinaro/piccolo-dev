...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOrigin.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (52))) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
  ...
  ::routine_getFDAinstructionBaseCode (_inLexique,  mInstruction_FDA_base_code,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (96)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mInstruction_FDA_base_code.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (102))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (102))) ;
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getFAinstructionBaseCode (_inLexique,  mFAinstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (134)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mFAinstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (140))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (140))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mSourceRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (157))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mDestinationRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (157))) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBitOrientedOpBaseCode (_inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (180)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mBitOrientedOp.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mConditionalBranch.reader_condition (_inLexique COMMA_SOURCE_FILE_AT_LINE (217))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
  switch (mBranchMode.enumValue ()) {
  case GGS_condionalBranchMode::enum_native:
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    class 'cPtr_ipic_instruction_JUMP'                     *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_JUMP::
cPtr_ipic_instruction_JUMP (const GGS_location & argument_0,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_JUMP * GGS_ipic_instruction_JUMP::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_JUMP *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_JUMP *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_JUMP::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_JUMP * _p = dynamic_cast <const cPtr_ipic_instruction_JUMP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue ()
...
void cPtr_ipic_instruction_JUMP::
method_instructionLength (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_JUMP:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mTargetLabel.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_ipic_instruction_JUMP::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_JUMP (& typeid (cPtr_ipic_instruction_JUMP), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_JUMP::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_JUMP ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                 GALGAS class 'GGS_ipic_instruction_JUMP'                  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_JUMP::
GGS_ipic_instruction_JUMP (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_JUMP::
GGS_ipic_instruction_JUMP (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_JUMP GGS_ipic_instruction_JUMP::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_JUMP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_JUMP *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_JUMP) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_JUMP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_JUMP),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_bool& argument_2
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_JUMP result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_JUMP (argument_0,
                                argument_1,
                                argument_2 COMMA_THERE)) ;
  return result ;
}
...
GGS_lstring  GGS_ipic_instruction_JUMP::
reader_mTargetLabel (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_JUMP *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_JUMP *) mPointer)->mTargetLabel ;
  }
  return result ;
}
...
GGS_bool GGS_ipic_instruction_JUMP::
reader_mUsesBRA (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_JUMP *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_JUMP *) mPointer)->mUsesBRA ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_JUMP::actualTypeName (void) const {
  return "ipic_instruction_JUMP" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_JUMP ("ipic_instruction_JUMP", gClassInfoFor__ipic_actualInstruction) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    class 'cPtr_ipic_instruction_JSR'                      *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_JSR::
cPtr_ipic_instruction_JSR (const GGS_location & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_bool& argument_2
                                COMMA_LOCATION_ARGS)
:cPtr_ipic_actualInstruction (argument_0 COMMA_THERE),
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_JSR * GGS_ipic_instruction_JSR::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_JSR *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_JSR *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_JSR::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_JSR * _p = dynamic_cast <const cPtr_ipic_instruction_JSR *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue ()
...
void cPtr_ipic_instruction_JSR::
method_instructionLength (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
...
const char * cPtr_ipic_instruction_JSR::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_JSR (& typeid (cPtr_ipic_instruction_JSR), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_JSR::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_JSR ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                 GALGAS class 'GGS_ipic_instruction_JSR'                   *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_JSR::
GGS_ipic_instruction_JSR (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_JSR::
GGS_ipic_instruction_JSR (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_JSR GGS_ipic_instruction_JSR::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_JSR _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_JSR *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_JSR) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_JSR (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_JSR),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_bool& argument_2
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_JSR result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_JSR (argument_0,
                                argument_1,
                                argument_2 COMMA_THERE)) ;
  return result ;
}
...
GGS_lstring  GGS_ipic_instruction_JSR::
reader_mTargetLabel (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_JSR *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_JSR *) mPointer)->mTargetLabel ;
  }
  return result ;
}
...
GGS_bool GGS_ipic_instruction_JSR::
reader_mUsesRCALL (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_JSR *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_JSR *) mPointer)->mUsesRCALL ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_JSR::actualTypeName (void) const {
  return "ipic_instruction_JSR" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_JSR ("ipic_instruction_JSR", gClassInfoFor__ipic_actualInstruction) ;
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (429)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (435))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (435)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (435))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (452)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (452))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (452))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (463)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (463))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (474))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (485))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (496))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (506))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (506)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (511)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (511))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (523))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (523))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (523)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (525)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_luintlist::cEnumerator enumerator_14984 (mLiteralValues, true) ;
    const GGS_luintlist::cElement * operand_14984 = NULL ;
    while (((operand_14984 = enumerator_14984.nextObject ()))) {
      macroValidPointer (operand_14984) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_14984->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (538)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (538))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (551))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (551))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (551)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (553)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_15745 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_15745 = NULL ;
    while (((operand_15745 = enumerator_15745.nextObject ()))) {
      macroValidPointer (operand_15745) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_15745->mValue) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (579))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (579))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (579)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (581)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_16488 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_16488 = NULL ;
    while (((operand_16488 = enumerator_16488.nextObject ()))) {
      macroValidPointer (operand_16488) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_16488->mValue) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mBranchIfZero).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (611)) ;
  }
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (614)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (616)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (622))) ;
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (664))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W ") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (703)) ;
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (710)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (712)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (719))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (720))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (" (uses BRA)") ;
