...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_luintlist::cEnumerator enumerator_17827 (mLiteralValues, true) ;
    const GGS_luintlist::cElement * operand_17827 = NULL ;
    while (((operand_17827 = enumerator_17827.nextObject ()))) {
      macroValidPointer (operand_17827) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_17827->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (620)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (620))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_18844 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18844 = NULL ;
    while (((operand_18844 = enumerator_18844.nextObject ()))) {
      macroValidPointer (operand_18844) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_18844->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_19191 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19191 = NULL ;
    while (((operand_19191 = enumerator_19191.nextObject ()))) {
      macroValidPointer (operand_19191) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_19191->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (667))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19939 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19939 = NULL ;
    while (((operand_19939 = enumerator_19939.nextObject ()))) {
      macroValidPointer (operand_19939) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_19939->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_20287 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_20287 = NULL ;
    while (((operand_20287 = enumerator_20287.nextObject ()))) {
      macroValidPointer (operand_20287) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_20287->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (707))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (776))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W ") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (814)) ;
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (821)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (823)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (830))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (831))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
}
