...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (508)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_uintlist::cEnumerator enumerator_17425 (mLiteralValues, true) ;
    const GGS_uintlist::cElement * operand_17425 = NULL ;
    while (((operand_17425 = enumerator_17425.nextObject ()))) {
      macroValidPointer (operand_17425) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_17425->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (610))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_18435 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18435 = NULL ;
    while (((operand_18435 = enumerator_18435.nextObject ()))) {
      macroValidPointer (operand_18435) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_18435->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_18782 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18782 = NULL ;
    while (((operand_18782 = enumerator_18782.nextObject ()))) {
      macroValidPointer (operand_18782) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_18782->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (657))) ;
    }
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19530 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19530 = NULL ;
    while (((operand_19530 = enumerator_19530.nextObject ()))) {
      macroValidPointer (operand_19530) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_19530->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19878 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19878 = NULL ;
    while (((operand_19878 = enumerator_19878.nextObject ()))) {
      macroValidPointer (operand_19878) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_19878->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (697))) ;
    }
  }
}
