...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (504)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (510))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (510)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (510))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (531)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (531))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (531))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (542)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (542))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (553))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (564))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (575))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (585))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (585)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (590)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (590))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (602))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (602))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (602)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (604)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_luintlist::cEnumerator enumerator_17746 (mLiteralValues, true) ;
    const GGS_luintlist::cElement * operand_17746 = NULL ;
    while (((operand_17746 = enumerator_17746.nextObject ()))) {
      macroValidPointer (operand_17746) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_17746->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (617)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (617))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (638))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (638))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (638)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (640)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_18763 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18763 = NULL ;
    while (((operand_18763 = enumerator_18763.nextObject ()))) {
      macroValidPointer (operand_18763) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_18763->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_19110 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19110 = NULL ;
    while (((operand_19110 = enumerator_19110.nextObject ()))) {
      macroValidPointer (operand_19110) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_19110->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (664))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (677))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (677))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (677)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (679)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19858 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19858 = NULL ;
    while (((operand_19858 = enumerator_19858.nextObject ()))) {
      macroValidPointer (operand_19858) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_19858->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_20206 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_20206 = NULL ;
    while (((operand_20206 = enumerator_20206.nextObject ()))) {
      macroValidPointer (operand_20206) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_20206->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (704))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    ...
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (726)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (732))) ;
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (778))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W ") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (821)) ;
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (828)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (830)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (837))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (838))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (" (uses BRA)") ;
