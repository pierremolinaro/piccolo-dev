...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBitOrientedOpBaseCode (_inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (233)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  case GGS_condionalBranchMode::enum_ipicNative:
    {
    var_cas_ioListFileContents.writeString (" (uses Bcc)") ;
    }
    break ;
  case GGS_condionalBranchMode::enum_ipicBRA:
    {
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (507)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (513))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (513)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (513))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (534)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (534))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (534))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (545)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (545))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (556))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (567))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (578))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (588))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (588)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (593)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (593))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (605))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (605))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (605)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (607)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_luintlist::cEnumerator enumerator_17821 (mLiteralValues, true) ;
    const GGS_luintlist::cElement * operand_17821 = NULL ;
    while (((operand_17821 = enumerator_17821.nextObject ()))) {
      macroValidPointer (operand_17821) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_17821->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (620)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (620))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (641))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (641))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (641)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (643)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_18838 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18838 = NULL ;
    while (((operand_18838 = enumerator_18838.nextObject ()))) {
      macroValidPointer (operand_18838) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_18838->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_19185 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19185 = NULL ;
    while (((operand_19185 = enumerator_19185.nextObject ()))) {
      macroValidPointer (operand_19185) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_19185->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (667))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (680))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (680))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (680)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19933 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19933 = NULL ;
    while (((operand_19933 = enumerator_19933.nextObject ()))) {
      macroValidPointer (operand_19933) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_19933->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_20281 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_20281 = NULL ;
    while (((operand_20281 = enumerator_20281.nextObject ()))) {
      macroValidPointer (operand_20281) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_20281->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (707))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mBranchIfZero).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (724)) ;
  }
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (727)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (729)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (735))) ;
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (781))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W ") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (824)) ;
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (831)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (833)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (840))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (841))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (" (uses BRA)") ;
