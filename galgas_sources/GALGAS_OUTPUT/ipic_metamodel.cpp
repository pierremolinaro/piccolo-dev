...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (542)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (542))) ;
}
