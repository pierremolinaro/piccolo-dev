...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "ipic_metamodel.ggs", line
...
//---------------------------------------------------------------------------*
//                                                                           *
//                   class 'cPtr_ipic_pseudoInstruction'                     *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_pseudoInstruction::
cPtr_ipic_pseudoInstruction (LOCATION_ARGS)
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_pseudoInstruction * GGS_ipic_pseudoInstruction::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_pseudoInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_pseudoInstruction *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

void cPtr_ipic_pseudoInstruction::
...
appendForDescription (C_Compiler & /* _inLexique */,
                      ...
                      const sint32 /* inIndentation */
                      COMMA_UNUSED_LOCATION_ARGS) const {
  ioString << "->@ipic_pseudoInstruction:" ;
}
...
const char * cPtr_ipic_pseudoInstruction::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_pseudoInstruction (& typeid (cPtr_ipic_pseudoInstruction), & typeid (cPtr_ipic_instruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_pseudoInstruction::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_pseudoInstruction ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                GALGAS class 'GGS_ipic_pseudoInstruction'                  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_pseudoInstruction::
GGS_ipic_pseudoInstruction (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_pseudoInstruction::
GGS_ipic_pseudoInstruction (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_pseudoInstruction GGS_ipic_pseudoInstruction::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_pseudoInstruction _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_pseudoInstruction *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_pseudoInstruction) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_pseudoInstruction (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_pseudoInstruction),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
const char * GGS_ipic_pseudoInstruction::actualTypeName (void) const {
  return "ipic_pseudoInstruction" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_pseudoInstruction ("ipic_pseudoInstruction", gClassInfoFor__ipic_instruction) ;

//---------------------------------------------------------------------------*
//                                                                           *
//                      class 'cPtr_ipic_pseudo_NULL'                        *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_pseudo_NULL::
cPtr_ipic_pseudo_NULL (LOCATION_ARGS)
:cPtr_ipic_pseudoInstruction (THERE) {
}

//---------------------------------------------------------------------------*

#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_pseudo_NULL * GGS_ipic_pseudo_NULL::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_pseudo_NULL *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_pseudo_NULL *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_pseudo_NULL::
...
void cPtr_ipic_pseudo_NULL::
appendForDescription (C_Compiler & /* _inLexique */,
                      C_String & ioString,
                      const sint32 /* inIndentation */
                      COMMA_UNUSED_LOCATION_ARGS) const {
  ioString << "->@ipic_pseudo_NULL:" ;
}
...
const char * cPtr_ipic_pseudo_NULL::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_pseudo_NULL (& typeid (cPtr_ipic_pseudo_NULL), & typeid (cPtr_ipic_pseudoInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_pseudo_NULL::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_pseudo_NULL ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                   GALGAS class 'GGS_ipic_pseudo_NULL'                     *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_pseudo_NULL::
GGS_ipic_pseudo_NULL (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_pseudo_NULL::
GGS_ipic_pseudo_NULL (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_pseudo_NULL GGS_ipic_pseudo_NULL::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_pseudo_NULL _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_pseudo_NULL *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_pseudo_NULL) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_pseudo_NULL (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_pseudo_NULL),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
static cPtr_ipic_pseudo_NULL * gSingleton_ipic_pseudo_NULL = NULL ;

//---------------------------------------------------------------------------*

static void cleanUp_ipic_pseudo_NULL (void) {
  macroDetachPointer (gSingleton_ipic_pseudo_NULL, cPtr_ipic_pseudo_NULL) ;
}
...
constructor_new (C_Compiler & /* inLexique */
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_pseudo_NULL result ;
  if (NULL == gSingleton_ipic_pseudo_NULL) {
    macroMyNew (gSingleton_ipic_pseudo_NULL, cPtr_ipic_pseudo_NULL (THERE)) ;
    registerReleaseRoutine (cleanUp_ipic_pseudo_NULL) ;
  }
  macroAssignPointer (result.mPointer, gSingleton_ipic_pseudo_NULL) ;
  return result ;
}

//---------------------------------------------------------------------------*

const char * GGS_ipic_pseudo_NULL::actualTypeName (void) const {
  return "ipic_pseudo_NULL" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_pseudo_NULL ("ipic_pseudo_NULL", gClassInfoFor__ipic_pseudoInstruction) ;
...
C_galgas_class_inspector _gInspectorFor_ipic_pseudo_ORG (& typeid (cPtr_ipic_pseudo_ORG), & typeid (cPtr_ipic_pseudoInstruction), "") ;
//---------------------------------------------------------------------------*
...
C_galgasClassRunTimeInformation gClassInfoFor__ipic_pseudo_ORG ("ipic_pseudo_ORG", gClassInfoFor__ipic_pseudoInstruction) ;
...
C_galgas_class_inspector _gInspectorFor_ipic_pseudo_LABEL (& typeid (cPtr_ipic_pseudo_LABEL), & typeid (cPtr_ipic_pseudoInstruction), "") ;
//---------------------------------------------------------------------------*
...
reader_mTargetLabel (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_pseudo_LABEL *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_pseudo_LABEL *) mPointer)->mTargetLabel ;
  }
  return result ;
}
...
C_galgasClassRunTimeInformation gClassInfoFor__ipic_pseudo_LABEL ("ipic_pseudo_LABEL", gClassInfoFor__ipic_pseudoInstruction) ;
...
method_getBaseCode (C_Compiler & _inLexique,
  ...
  ::routine_getFDAinstructionBaseCode (_inLexique,  mInstruction_FDA_base_code,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (148)) ;
}
...
GGS_registerExpression  GGS_ipic_instruction_FDA::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_FDA *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_FDA *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getFAinstructionBaseCode (_inLexique,  mFAinstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (204)) ;
}
...
GGS_registerExpression  GGS_ipic_instruction_FA::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_registerExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_FA *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_FA *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
GGS_registerExpression  GGS_ipic_instruction_MOVFF::
reader_mSourceRegisterName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_MOVFF *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_MOVFF *) mPointer)->mSourceRegisterName ;
  }
  return result ;
}
...
reader_mDestinationRegisterName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_MOVFF *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_MOVFF *) mPointer)->mDestinationRegisterName ;
  }
  return result ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBitOrientedOpBaseCode (_inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (276)) ;
}
...
GGS_registerExpression  GGS_ipic_instruction_FBA::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_registerExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_FBA *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_FBA *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
GGS_bitNumberExpression  GGS_ipic_instruction_FBA::
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    class 'cPtr_ipic_instruction_BRA'                      *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_BRA::
cPtr_ipic_instruction_BRA (const GGS_location & argument_0,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_BRA * GGS_ipic_instruction_BRA::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_BRA *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_BRA *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_BRA::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_BRA * _p = dynamic_cast <const cPtr_ipic_instruction_BRA *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue () ;
  }
...
void cPtr_ipic_instruction_BRA::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_BRA:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mTargetLabel.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
const char * cPtr_ipic_instruction_BRA::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_BRA (& typeid (cPtr_ipic_instruction_BRA), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_BRA::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_BRA ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                 GALGAS class 'GGS_ipic_instruction_BRA'                   *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_BRA::
GGS_ipic_instruction_BRA (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_BRA::
GGS_ipic_instruction_BRA (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_BRA GGS_ipic_instruction_BRA::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_BRA _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_BRA *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_BRA) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_BRA (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_BRA),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_BRA result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_BRA (argument_0,
...
GGS_lstring  GGS_ipic_instruction_BRA::
reader_mTargetLabel (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_BRA *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_BRA *) mPointer)->mTargetLabel ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_BRA::actualTypeName (void) const {
  return "ipic_instruction_BRA" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_BRA ("ipic_instruction_BRA", gClassInfoFor__ipic_actualInstruction) ;

//---------------------------------------------------------------------------*
//                                                                           *
//                    class 'cPtr_ipic_instruction_CALL'                     *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_CALL::
cPtr_ipic_instruction_CALL (const GGS_location & argument_0,
                                const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS)
:cPtr_ipic_actualInstruction (argument_0 COMMA_THERE),
mTargetLabel (argument_1) {
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_CALL * GGS_ipic_instruction_CALL::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_CALL *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_CALL *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_CALL::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_CALL * _p = dynamic_cast <const cPtr_ipic_instruction_CALL *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue () ;
  }
...
void cPtr_ipic_instruction_CALL::
method_instructionLength (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (true, 4U) ;
}
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_CALL:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mTargetLabel.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
const char * cPtr_ipic_instruction_CALL::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_CALL (& typeid (cPtr_ipic_instruction_CALL), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_CALL::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_CALL ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                 GALGAS class 'GGS_ipic_instruction_CALL'                  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_CALL::
GGS_ipic_instruction_CALL (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_CALL::
GGS_ipic_instruction_CALL (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_CALL GGS_ipic_instruction_CALL::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_CALL _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_CALL *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_CALL) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_CALL (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_CALL),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_CALL result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_CALL (argument_0,
                                argument_1 COMMA_THERE)) ;
  return result ;
}
...
GGS_lstring  GGS_ipic_instruction_CALL::
reader_mTargetLabel (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_CALL *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_CALL *) mPointer)->mTargetLabel ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_CALL::actualTypeName (void) const {
  return "ipic_instruction_CALL" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_CALL ("ipic_instruction_CALL", gClassInfoFor__ipic_actualInstruction) ;

//---------------------------------------------------------------------------*
//                                                                           *
//                    class 'cPtr_ipic_instruction_GOTO'                     *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_GOTO::
cPtr_ipic_instruction_GOTO (const GGS_location & argument_0,
                                const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS)
:cPtr_ipic_actualInstruction (argument_0 COMMA_THERE),
mTargetLabel (argument_1) {
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_GOTO * GGS_ipic_instruction_GOTO::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_GOTO *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_GOTO *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_GOTO::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_GOTO * _p = dynamic_cast <const cPtr_ipic_instruction_GOTO *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue () ;
  }
...
void cPtr_ipic_instruction_GOTO::
method_instructionLength (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (true, 4U) ;
}
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_GOTO:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mTargetLabel.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
const char * cPtr_ipic_instruction_GOTO::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_GOTO (& typeid (cPtr_ipic_instruction_GOTO), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_GOTO::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_GOTO ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                 GALGAS class 'GGS_ipic_instruction_GOTO'                  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_GOTO::
GGS_ipic_instruction_GOTO (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_GOTO::
GGS_ipic_instruction_GOTO (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_GOTO GGS_ipic_instruction_GOTO::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_GOTO _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_GOTO *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_GOTO) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_GOTO (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_GOTO),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_GOTO result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_GOTO (argument_0,
                                argument_1 COMMA_THERE)) ;
  return result ;
}
...
GGS_lstring  GGS_ipic_instruction_GOTO::
reader_mTargetLabel (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_GOTO *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_GOTO *) mPointer)->mTargetLabel ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_GOTO::actualTypeName (void) const {
  return "ipic_instruction_GOTO" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_GOTO ("ipic_instruction_GOTO", gClassInfoFor__ipic_actualInstruction) ;

//---------------------------------------------------------------------------*
//                                                                           *
//                   class 'cPtr_ipic_instruction_RCALL'                     *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_RCALL::
cPtr_ipic_instruction_RCALL (const GGS_location & argument_0,
                                const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS)
:cPtr_ipic_actualInstruction (argument_0 COMMA_THERE),
mTargetLabel (argument_1) {
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_RCALL * GGS_ipic_instruction_RCALL::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_RCALL *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_RCALL *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_RCALL::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_RCALL * _p = dynamic_cast <const cPtr_ipic_instruction_RCALL *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue () ;
  }
...
void cPtr_ipic_instruction_RCALL::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_RCALL:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mTargetLabel.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
const char * cPtr_ipic_instruction_RCALL::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_RCALL (& typeid (cPtr_ipic_instruction_RCALL), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_RCALL::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_RCALL ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                GALGAS class 'GGS_ipic_instruction_RCALL'                  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_RCALL::
GGS_ipic_instruction_RCALL (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_RCALL::
GGS_ipic_instruction_RCALL (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_RCALL GGS_ipic_instruction_RCALL::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_RCALL _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_RCALL *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_RCALL) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_RCALL (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_RCALL),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_RCALL result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_RCALL (argument_0,
                                argument_1 COMMA_THERE)) ;
  return result ;
}
...
GGS_lstring  GGS_ipic_instruction_RCALL::
reader_mTargetLabel (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_RCALL *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_RCALL *) mPointer)->mTargetLabel ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_RCALL::actualTypeName (void) const {
  return "ipic_instruction_RCALL" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_RCALL ("ipic_instruction_RCALL", gClassInfoFor__ipic_actualInstruction) ;
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (483)) ;
}
...
GGS_registerExpression  GGS_ipic_instruction_LFSR::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_registerExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_LFSR *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_LFSR *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
GGS_registerExpression  GGS_ipic_instruction_MOVAW::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_registerExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_MOVAW *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_MOVAW *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (546))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (546)) ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//               class 'cPtr_ipic_instruction_IF_SEMI_COLON'                 *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_IF_SEMI_COLON::
cPtr_ipic_instruction_IF_SEMI_COLON (const GGS_location & argument_0,
                                const GGS_ipic_instruction & argument_1
                                COMMA_LOCATION_ARGS)
:cPtr_ipic_actualInstruction (argument_0 COMMA_THERE),
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_IF_SEMI_COLON * GGS_ipic_instruction_IF_SEMI_COLON::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_SEMI_COLON *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_IF_SEMI_COLON *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

void cPtr_ipic_instruction_IF_SEMI_COLON::
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_ipic_instruction  _temp_15839 = mInstruction ;
  if (_temp_15839._isBuilt ()) {
    _temp_15839 (HERE)->method_instructionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (598)) ;
  }
  var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (599)) ;
}
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_IF_SEMI_COLON:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_ipic_instruction_IF_SEMI_COLON::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_IF_SEMI_COLON (& typeid (cPtr_ipic_instruction_IF_SEMI_COLON), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_IF_SEMI_COLON::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_IF_SEMI_COLON ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//            GALGAS class 'GGS_ipic_instruction_IF_SEMI_COLON'              *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_IF_SEMI_COLON::
GGS_ipic_instruction_IF_SEMI_COLON (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_IF_SEMI_COLON::
GGS_ipic_instruction_IF_SEMI_COLON (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_IF_SEMI_COLON GGS_ipic_instruction_IF_SEMI_COLON::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_IF_SEMI_COLON _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_IF_SEMI_COLON *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_IF_SEMI_COLON) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_IF_SEMI_COLON (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_IF_SEMI_COLON),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
GGS_ipic_instruction  GGS_ipic_instruction_IF_SEMI_COLON::
reader_mInstruction (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_SEMI_COLON *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_SEMI_COLON *) mPointer)->mInstruction ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_IF_SEMI_COLON::actualTypeName (void) const {
  return "ipic_instruction_IF_SEMI_COLON" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_IF_SEMI_COLON ("ipic_instruction_IF_SEMI_COLON", gClassInfoFor__ipic_actualInstruction) ;

//---------------------------------------------------------------------------*
//                                                                           *
//              class 'cPtr_ipic_instruction_IF_FA_SEMI_COLON'               *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_IF_FA_SEMI_COLON::
cPtr_ipic_instruction_IF_FA_SEMI_COLON (const GGS_location & argument_0,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_IF_FA_SEMI_COLON * GGS_ipic_instruction_IF_FA_SEMI_COLON::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_FA_SEMI_COLON *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_IF_FA_SEMI_COLON *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_IF_FA_SEMI_COLON::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_IF_FA_SEMI_COLON * _p = dynamic_cast <const cPtr_ipic_instruction_IF_FA_SEMI_COLON *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
void cPtr_ipic_instruction_IF_FA_SEMI_COLON::
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBaseCodeForIfSemiColonOp (_inLexique,  mOpCode,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (609)) ;
}
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_IF_FA_SEMI_COLON:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mInstruction.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_ipic_instruction_IF_FA_SEMI_COLON::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_IF_FA_SEMI_COLON (& typeid (cPtr_ipic_instruction_IF_FA_SEMI_COLON), & typeid (cPtr_instruction_IF_SEMI_COLON), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_IF_FA_SEMI_COLON::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_IF_FA_SEMI_COLON ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//           GALGAS class 'GGS_ipic_instruction_IF_FA_SEMI_COLON'            *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_IF_FA_SEMI_COLON::
GGS_ipic_instruction_IF_FA_SEMI_COLON (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_IF_FA_SEMI_COLON::
GGS_ipic_instruction_IF_FA_SEMI_COLON (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_IF_FA_SEMI_COLON GGS_ipic_instruction_IF_FA_SEMI_COLON::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_IF_FA_SEMI_COLON _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_IF_FA_SEMI_COLON *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_IF_FA_SEMI_COLON) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_IF_FA_SEMI_COLON (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_IF_FA_SEMI_COLON),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_registerExpression & argument_3
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_IF_FA_SEMI_COLON result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_IF_FA_SEMI_COLON (argument_0,
                                argument_1,
                                argument_2,
                                argument_3 COMMA_THERE)) ;
  return result ;
...
GGS_if_semi_colon_op GGS_ipic_instruction_IF_FA_SEMI_COLON::
reader_mOpCode (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_FA_SEMI_COLON *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_FA_SEMI_COLON *) mPointer)->mOpCode ;
  }
  return result ;
}
...
GGS_registerExpression  GGS_ipic_instruction_IF_FA_SEMI_COLON::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_registerExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_FA_SEMI_COLON *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_FA_SEMI_COLON *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_IF_FA_SEMI_COLON::actualTypeName (void) const {
  return "ipic_instruction_IF_FA_SEMI_COLON" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_IF_FA_SEMI_COLON ("ipic_instruction_IF_FA_SEMI_COLON", gClassInfoFor__instruction_IF_SEMI_COLON) ;

//---------------------------------------------------------------------------*
//                                                                           *
//                 class 'cPtr_ipic_instruction_IF_BitTest'                  *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_IF_BitTest::
cPtr_ipic_instruction_IF_BitTest (const GGS_location & argument_0,
                                const GGS_piccolo_instruction & argument_1,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_IF_BitTest * GGS_ipic_instruction_IF_BitTest::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_BitTest *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_IF_BitTest *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_IF_BitTest::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_IF_BitTest * _p = dynamic_cast <const cPtr_ipic_instruction_IF_BitTest *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mInstruction._operator_isEqual (_p->mInstruction).boolValue ()
...
void cPtr_ipic_instruction_IF_BitTest::
method_getBaseCode (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_IF_BitTest:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mInstruction.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_ipic_instruction_IF_BitTest::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_IF_BitTest (& typeid (cPtr_ipic_instruction_IF_BitTest), & typeid (cPtr_instruction_IF_SEMI_COLON), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_IF_BitTest::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_IF_BitTest ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//              GALGAS class 'GGS_ipic_instruction_IF_BitTest'               *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_IF_BitTest::
GGS_ipic_instruction_IF_BitTest (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_IF_BitTest::
GGS_ipic_instruction_IF_BitTest (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_IF_BitTest GGS_ipic_instruction_IF_BitTest::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_IF_BitTest _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_IF_BitTest *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_IF_BitTest) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_IF_BitTest (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_IF_BitTest),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_bitNumberExpression & argument_4
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_IF_BitTest result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_IF_BitTest (argument_0,
                                argument_1,
                                argument_2,
                                argument_3,
...
GGS_bool GGS_ipic_instruction_IF_BitTest::
reader_mSkipIfSet (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_BitTest *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_BitTest *) mPointer)->mSkipIfSet ;
  }
  return result ;
}
...
GGS_registerExpression  GGS_ipic_instruction_IF_BitTest::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_registerExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_BitTest *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_BitTest *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
GGS_bitNumberExpression  GGS_ipic_instruction_IF_BitTest::
reader_mBitNumber (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_bitNumberExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_BitTest *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_BitTest *) mPointer)->mBitNumber ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_IF_BitTest::actualTypeName (void) const {
  return "ipic_instruction_IF_BitTest" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_IF_BitTest ("ipic_instruction_IF_BitTest", gClassInfoFor__instruction_IF_SEMI_COLON) ;

//---------------------------------------------------------------------------*
//                                                                           *
//                 class 'cPtr_ipic_instruction_IF_IncDec'                   *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_ipic_instruction_IF_IncDec::
cPtr_ipic_instruction_IF_IncDec (const GGS_location & argument_0,
                                const GGS_piccolo_instruction & argument_1,
                                const GGS_bool& argument_2,
                                const GGS_bool& argument_3,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_IF_IncDec * GGS_ipic_instruction_IF_IncDec::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_IncDec *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_ipic_instruction_IF_IncDec *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_ipic_instruction_IF_IncDec::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_IF_IncDec * _p = dynamic_cast <const cPtr_ipic_instruction_IF_IncDec *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mInstruction._operator_isEqual (_p->mInstruction).boolValue ()
...
void cPtr_ipic_instruction_IF_IncDec::
method_getBaseCode (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  if (((mIncrement)._operator_and (mSkipIfZero)).isBuiltAndTrue ()) {
    var_cas_outBaseCode = GGS_uint (true, 15360U) ;
  }else if (((mIncrement)._operator_and ((mSkipIfZero)._operator_not ())).isBuiltAndTrue ()) {
    var_cas_outBaseCode = GGS_uint (true, 18432U) ;
  }else if ((((mIncrement)._operator_not ())._operator_and (mSkipIfZero)).isBuiltAndTrue ()) {
...
method_getMnemonic (C_Compiler & /* _inLexique */,
                                GGS_string& var_cas_outMnemonic COMMA_UNUSED_LOCATION_ARGS) const {
  if (((mIncrement)._operator_and (mSkipIfZero)).isBuiltAndTrue ()) {
    var_cas_outMnemonic = GGS_string (true, "INCFSZ") ;
  }else if (((mIncrement)._operator_and ((mSkipIfZero)._operator_not ())).isBuiltAndTrue ()) {
    var_cas_outMnemonic = GGS_string (true, "INFSNZ") ;
  }else if ((((mIncrement)._operator_not ())._operator_and (mSkipIfZero)).isBuiltAndTrue ()) {
    var_cas_outMnemonic = GGS_string (true, "DECFSZ") ;
  }else{
    var_cas_outMnemonic = GGS_string (true, "DCFSNZ") ;
  }
}
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_IF_IncDec:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mInstruction.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_ipic_instruction_IF_IncDec::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_IF_IncDec (& typeid (cPtr_ipic_instruction_IF_IncDec), & typeid (cPtr_instruction_IF_SEMI_COLON), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_IF_IncDec::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_IF_IncDec ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//              GALGAS class 'GGS_ipic_instruction_IF_IncDec'                *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_ipic_instruction_IF_IncDec::
GGS_ipic_instruction_IF_IncDec (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_IF_IncDec::
GGS_ipic_instruction_IF_IncDec (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_IF_IncDec GGS_ipic_instruction_IF_IncDec::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_IF_IncDec _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_IF_IncDec *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_IF_IncDec) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_IF_IncDec (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_IF_IncDec),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_bool& argument_5
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_IF_IncDec result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_IF_IncDec (argument_0,
                                argument_1,
                                argument_2,
                                argument_3,
                                argument_4,
...
GGS_bool GGS_ipic_instruction_IF_IncDec::
reader_mIncrement (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_IncDec *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_IncDec *) mPointer)->mIncrement ;
  }
  return result ;
}
...
reader_mSkipIfZero (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_IncDec *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_IncDec *) mPointer)->mSkipIfZero ;
  }
  return result ;
}
...
GGS_registerExpression  GGS_ipic_instruction_IF_IncDec::
reader_mRegisterExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_registerExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_IncDec *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_IncDec *) mPointer)->mRegisterExpression ;
  }
  return result ;
}
...
reader_m_W_isDestination (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_IF_IncDec *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_IF_IncDec *) mPointer)->m_W_isDestination ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_IF_IncDec::actualTypeName (void) const {
  return "ipic_instruction_IF_IncDec" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_IF_IncDec ("ipic_instruction_IF_IncDec", gClassInfoFor__instruction_IF_SEMI_COLON) ;
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (680))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (680))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (680)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (682)) ;
  }
}
...
reader_mUsesRelativeCall (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_computed_retlw *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_computed_retlw *) mPointer)->mUsesRelativeCall ;
  }
  return result ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (695))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (695))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (695)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (697)) ;
  }
}
...
reader_mUsesRelativeCall (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_computed_bra *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_computed_bra *) mPointer)->mUsesRelativeCall ;
  }
  return result ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (710))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (710))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (710)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
...
reader_mUsesRelativeCall (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_computed_goto *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_computed_goto *) mPointer)->mUsesRelativeCall ;
  }
  return result ;
}
