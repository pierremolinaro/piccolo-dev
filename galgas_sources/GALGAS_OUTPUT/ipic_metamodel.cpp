...
method_getBaseCode (C_Compiler & _inLexique,
  ...
  ::routine_getFDAinstructionBaseCode (_inLexique,  mInstruction_FDA_base_code,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (128)) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getFAinstructionBaseCode (_inLexique,  mFAinstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (185)) ;
}
...
method_isSkippingInstruction (C_Compiler & _inLexique,
                                GGS_bool& var_cas_outIsSkipping COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_FAinstructionIsSkippingInstruction (_inLexique,  mFAinstruction,  var_cas_outIsSkipping COMMA_SOURCE_FILE_AT_LINE (195)) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBitOrientedOpBaseCode (_inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (234)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mBitOrientedOp.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (239))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (239))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (239))) ;
}
...
cPtr_ipic_instruction_BitTestSkip::
cPtr_ipic_instruction_BitTestSkip (const GGS_location & argument_0,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_ipic_instruction_BitTestSkip * GGS_ipic_instruction_BitTestSkip::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_BitTestSkip *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
...
bool cPtr_ipic_instruction_BitTestSkip::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_ipic_instruction_BitTestSkip * _p = dynamic_cast <const cPtr_ipic_instruction_BitTestSkip *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
void cPtr_ipic_instruction_BitTestSkip::
method_getBaseCode (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (266))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (266))) ;
}
...
appendForDescription (C_Compiler & _inLexique,
                      ...
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@ipic_instruction_BitTestSkip:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_ipic_instruction_BitTestSkip::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_ipic_instruction_BitTestSkip (& typeid (cPtr_ipic_instruction_BitTestSkip), & typeid (cPtr_ipic_actualInstruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_ipic_instruction_BitTestSkip::galgasRTTI (void) const {
  return & gClassInfoFor__ipic_instruction_BitTestSkip ;
}
...
GGS_ipic_instruction_BitTestSkip::
GGS_ipic_instruction_BitTestSkip (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_ipic_instruction_BitTestSkip::
GGS_ipic_instruction_BitTestSkip (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_ipic_instruction_BitTestSkip GGS_ipic_instruction_BitTestSkip::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_BitTestSkip _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_ipic_instruction_BitTestSkip *> (inPointer) != NULL)
      : (typeid (cPtr_ipic_instruction_BitTestSkip) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_ipic_instruction_BitTestSkip (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_ipic_instruction_BitTestSkip),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_uint & argument_3
                                COMMA_LOCATION_ARGS) {
  GGS_ipic_instruction_BitTestSkip result ;
  macroMyNew (result.mPointer, cPtr_ipic_instruction_BitTestSkip (argument_0,
                                argument_1,
                                argument_2,
                                argument_3 COMMA_THERE)) ;
  return result ;
...
GGS_bool GGS_ipic_instruction_BitTestSkip::
reader_mSkipIfSet (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_BitTestSkip *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_BitTestSkip *) mPointer)->mSkipIfSet ;
  }
  return result ;
}
...
GGS_ipic_registerExpression GGS_ipic_instruction_BitTestSkip::
reader_mRegisterDescription (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_ipic_registerExpression  result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_BitTestSkip *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_BitTestSkip *) mPointer)->mRegisterDescription ;
  }
  return result ;
}
...
GGS_uint  GGS_ipic_instruction_BitTestSkip::
reader_mBitNumber (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_BitTestSkip *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_BitTestSkip *) mPointer)->mBitNumber ;
  }
  return result ;
}
...
const char * GGS_ipic_instruction_BitTestSkip::actualTypeName (void) const {
  return "ipic_instruction_BitTestSkip" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__ipic_instruction_BitTestSkip ("ipic_instruction_BitTestSkip", gClassInfoFor__ipic_actualInstruction) ;
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mConditionalBranch.reader_condition (_inLexique COMMA_SOURCE_FILE_AT_LINE (304))) ;
  var_cas_ioListFileContents.writeString (" ") ;
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (314))) ;
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (349))) ;
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (380))) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (509)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (514))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (514))) ;
}
...
GGS_uint  GGS_ipic_instruction_literalOperation::
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (535)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (535))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (535))) ;
}
...
GGS_uint  GGS_ipic_instruction_LFSR::
reader_mValue (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_LFSR *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_LFSR *) mPointer)->mValue ;
  }
  return result ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (546)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (546))) ;
}
...
reader_mBankIndex (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_ipic_instruction_MOVLB *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_ipic_instruction_MOVLB *) mPointer)->mBankIndex ;
  }
  return result ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (557))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (568))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (578))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (578)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (583)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (583))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (595))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (595))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (595)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (597)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  {
    GGS_uintlist::cEnumerator enumerator_17440 (mLiteralValues, true) ;
    const GGS_uintlist::cElement * operand_17440 = NULL ;
    while (((operand_17440 = enumerator_17440.nextObject ()))) {
      macroValidPointer (operand_17440) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_17440->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (610))) ;
    }
  }
}
...
GGS_uintlist  GGS_ipic_instruction_computed_retlw::
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (631))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (631))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (631)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (633)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_18449 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18449 = NULL ;
    while (((operand_18449 = enumerator_18449.nextObject ()))) {
      macroValidPointer (operand_18449) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_18449->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  var_cas_ioReferencedLabelSet._addAssign_operation (GGS_string (true, "_computed_goto_2")) ;
  {
    GGS_lstringlist::cEnumerator enumerator_18796 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_18796 = NULL ;
    while (((operand_18796 = enumerator_18796.nextObject ()))) {
      macroValidPointer (operand_18796) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_18796->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (657))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (670))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (670))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (670)) ;
  if (((mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (672)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19544 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19544 = NULL ;
    while (((operand_19544 = enumerator_19544.nextObject ()))) {
      macroValidPointer (operand_19544) ;
      var_cas_ioListFileContents.writeString (", ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_19544->mValue) ;
    }
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19892 (mTargetLabels, true) ;
    const GGS_lstringlist::cElement * operand_19892 = NULL ;
    while (((operand_19892 = enumerator_19892.nextObject ()))) {
      macroValidPointer (operand_19892) ;
      var_cas_ioReferencedLabelSet._addAssign_operation (operand_19892->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (697))) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (717)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (719)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (725))) ;
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (804)) ;
  ...
  if ((mUsesBra).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (811)) ;
  }else{
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (813)) ;
  }
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("JUMP ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (820))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (821))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mTargetLabel) ;
}
