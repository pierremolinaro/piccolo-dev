...
//---------------------------------------------------------------------------*
//                                                                           *
//               abstract class 'cPtr_ipic_instruction_MOVAW'                *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_ipic_instruction_MOVAW : public cPtr_ipic_actualInstruction {
  private : typedef cPtr_ipic_actualInstruction inherited ;
//--- Constructor
  public : cPtr_ipic_instruction_MOVAW (const GGS_location & ,
                                const GGS_ipic_registerExpression& 
                                COMMA_LOCATION_ARGS) ;
...
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_ipic_instruction_MOVAW (void) {}
  #endif
