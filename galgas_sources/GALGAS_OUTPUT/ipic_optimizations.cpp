...
category_method__ipic_JUMP__optimizeJUMP (C_Compiler & _inLexique,
  ...
  if (operand_3603 != NULL) {
    ...
    ::routine_findFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (107)),  var_cas_ioGeneratedInstructionList,  automatic_var_0,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (106)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (_inLexique, operand_3603->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109))).isBuiltAndTrue ()) {
      ...
      const GGS_symbolTableForOptimizations  _temp_4377 = var_cas_inSymbolTable ;
      if (_temp_4377._isBuilt ()) {
        _temp_4377 (HERE)->method_searchKey (_inLexique, operand_3603->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (114)) ;
      }
      GGS_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (117)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (116)) ;
      { const GGS_ipic_instruction _var_5866 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5866.getPtr () != NULL) {
          macroValidPointer (_var_5866.getPtr ()) ;
          if (typeid (cPtr_ipic_instruction_RETURN) == typeid (* (_var_5866.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_3603->mInstructionLocation COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (121)) ;
          ...
          }else if (typeid (cPtr_ipic_instruction_literalOperation) == typeid (* (_var_5866.getPtr ()))) {
            const GGS_ipic_instruction_literalOperation var_cas_literalOp (_var_5866.getPtr ()) ;
          ...
          }else if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_5866.getPtr ()))) {
            const GGS_ipic_JUMP var_cas_jump (_var_5866.getPtr ()) ;
            if (((operand_3603->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_JUMP ::constructor_new (_inLexique, operand_3603->mInstructionLocation, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (139)), operand_3603->mKind COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (138)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic_JSR__optimizeJSR (C_Compiler & _inLexique,
                                const cPtr_ipic_JSR * operand_6028,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
  ...
  if (operand_6028 != NULL) {
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (160)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (159)) ;
    { const GGS_ipic_instruction _var_6766 = var_cas_firstInstruction ; // CAST instruction
      if (_var_6766.getPtr () != NULL) {
        macroValidPointer (_var_6766.getPtr ()) ;
        if (typeid (cPtr_ipic_instruction_RETURN) == typeid (* (_var_6766.getPtr ()))) {
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_JUMP ::constructor_new (_inLexique, operand_6028->mInstructionLocation, operand_6028->mTargetLabel, operand_6028->mKind COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (164)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic_instruction_literalOperation__optimizeMOVLW (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_literalOperation * operand_6916,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6916 != NULL) {
    if (((operand_6916->mLiteralInstruction)._operator_isEqual (GGS_literal_instruction_opcode::constructor_MOVLW (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (185)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (184)) ;
      { const GGS_ipic_instruction _var_7809 = var_cas_firstInstruction ; // CAST instruction
        if (_var_7809.getPtr () != NULL) {
          macroValidPointer (_var_7809.getPtr ()) ;
          if (typeid (cPtr_ipic_instruction_RETURN) == typeid (* (_var_7809.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_literalOperation ::constructor_new (_inLexique, operand_6916->mInstructionLocation, GGS_literal_instruction_opcode::constructor_RETLW (_inLexique COMMA_HERE), operand_6916->mLiteralValue COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (189)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic_instruction_conditionalBranch__optimizeBCC (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_conditionalBranch * operand_7973,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7973 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_8243 = var_cas_inSymbolTable ;
    if (_temp_8243._isBuilt ()) {
      _temp_8243 (HERE)->method_searchKey (_inLexique, operand_7973->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (210)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (213)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (212)) ;
    { const GGS_ipic_instruction _var_9059 = var_cas_firstInstruction ; // CAST instruction
      if (_var_9059.getPtr () != NULL) {
        macroValidPointer (_var_9059.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_9059.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_9059.getPtr ()) ;
          if (((operand_7973->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)))._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)))).isBuiltAndTrue ()) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_conditionalBranch ::constructor_new (_inLexique, operand_7973->mInstructionLocation, operand_7973->mBranchMode, operand_7973->mConditionalBranch, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (218)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            ...
            var_cas_ioListFileContents._dotAssign_operation (operand_7973->mConditionalBranch.reader_condition (_inLexique COMMA_SOURCE_FILE_AT_LINE (223))) ;
...
category_method__ipic_jump_test_register__optimizeTestReg (C_Compiler & _inLexique,
                                const cPtr_ipic_jump_test_register * operand_9199,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9199 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_9473 = var_cas_inSymbolTable ;
    if (_temp_9473._isBuilt ()) {
      _temp_9473 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_9199->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (239)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (242)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (241)) ;
    { const GGS_ipic_instruction _var_10477 = var_cas_firstInstruction ; // CAST instruction
      if (_var_10477.getPtr () != NULL) {
        macroValidPointer (_var_10477.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_10477.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_10477.getPtr ()) ;
          if (((operand_9199->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)))).isBuiltAndTrue ()) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_jump_test_register ::constructor_new (_inLexique, operand_9199->mInstructionLocation, operand_9199->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)), operand_9199->mBranchIfZero, operand_9199->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (247)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            ...
            var_cas_ioListFileContents.writeString (": label of JUMP ") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_9199->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (252))) ;
            if ((operand_9199->mBranchIfZero).isBuiltAndTrue ()) {
...
category_method__ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & _inLexique,
                                const cPtr_ipic_incDecRegisterInCondition * operand_10624,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
  ...
  if (operand_10624 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_10901 = var_cas_inSymbolTable ;
    if (_temp_10901._isBuilt ()) {
      _temp_10901 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10624->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (274)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ::routine_findFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (277)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (276)) ;
    { const GGS_ipic_instruction _var_12170 = var_cas_firstInstruction ; // CAST instruction
      if (_var_12170.getPtr () != NULL) {
        macroValidPointer (_var_12170.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_12170.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_12170.getPtr ()) ;
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_incDecRegisterInCondition ::constructor_new (_inLexique, operand_10624->mInstructionLocation, operand_10624->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)), operand_10624->mIncrement, operand_10624->m_W_isDestination, operand_10624->mBranchIfZero, operand_10624->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (281)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
          ...
          if ((operand_10624->mIncrement).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString ("INCF ") ;
          }else{
            var_cas_ioListFileContents.writeString ("DECF ") ;
          }
          var_cas_ioListFileContents._dotAssign_operation (operand_10624->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (301))) ;
          if ((operand_10624->m_W_isDestination).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString (", W ") ;
          }
          if ((operand_10624->mBranchIfZero).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString ("Z") ;
          }else{
            var_cas_ioListFileContents.writeString ("NZ") ;
          }
...
category_method__ipic_registerComparisonCondition__optimizeCMP (C_Compiler & _inLexique,
                                const cPtr_ipic_registerComparisonCondition * operand_12319,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
  ...
  if (operand_12319 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_12589 = var_cas_inSymbolTable ;
    if (_temp_12589._isBuilt ()) {
      _temp_12589 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_12319->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (325)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic_instruction _var_13550 = var_cas_firstInstruction ; // CAST instruction
      if (_var_13550.getPtr () != NULL) {
        macroValidPointer (_var_13550.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_13550.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_13550.getPtr ()) ;
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_registerComparisonCondition ::constructor_new (_inLexique, operand_12319->mInstructionLocation, operand_12319->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)), operand_12319->mComparison, operand_12319->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (332)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
          ...
          var_cas_ioListFileContents.writeString (": label of ") ;
          var_cas_ioListFileContents.writeString ("JUMP ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12319->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (345))) ;
          var_cas_ioListFileContents.writeString (" ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12319->mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (346))) ;
          var_cas_ioListFileContents.writeString (" branching to JUMP replaced by second JUMP label\n") ;
        }else{
        }
      }
...
category_method__ipic_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_BitTestSkip * operand_13695,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
  ...
  if (operand_13695 != NULL) {
    ...
    { const GGS_ipic_instruction _var_14139 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ; // CAST instruction
      if (_var_14139.getPtr () != NULL) {
        macroValidPointer (_var_14139.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_14139.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_14139.getPtr ()) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_ipic_instruction _var_14350 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)) ; // CAST instruction
        if (_var_14350.getPtr () != NULL) {
          macroValidPointer (_var_14350.getPtr ()) ;
          if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_14350.getPtr ()) != NULL) {
          }else{
            var_cas_ok = GGS_bool (true, false) ;
          }
        }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      ::routine_findFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (381)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (380)) ;
      var_cas_ok = var_cas_reachedLabelSet.reader_hasKey (_inLexique, var_cas_jumpLabel COMMA_SOURCE_FILE_AT_LINE (382)) ;
    }
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_BitTestSkip ::constructor_new (_inLexique, operand_13695->mInstructionLocation, (operand_13695->mSkipIfSet)._operator_not (), operand_13695->mRegisterDescription, operand_13695->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (387)) ;
...
void routine_performOptimizations (C_Compiler & _inLexique,
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    GGS_ipic_instructionList::cEnumerator enumerator_16624 (var_cas_ioGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_16624 = NULL ;
    while (((operand_16624 = enumerator_16624.nextObject ()))) {
      macroValidPointer (operand_16624) ;
      const GGS_ipic_instruction  _temp_16682 = operand_16624->mInstruction ;
      if (_temp_16682._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__defineLabel _method = findCategoryMethod__ipic_instruction__defineLabel (_temp_16682._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_16682 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (431)) ;
        }
      }
  ...
  GGS_uint _variant_20698 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (436)) ;
  GGS_bool _condition_20698 (_variant_20698._isBuilt (), true) ;
  while (_condition_20698.isBuiltAndTrue ()) {
    _condition_20698 = var_cas_optimizationsDone ;
    if (_condition_20698.isBuiltAndTrue ()) {
      if (_variant_20698.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (507)) ;
        _condition_20698 = GGS_bool (true, false) ;
      }else{
        _variant_20698._decrement_operation (_inLexique COMMA_HERE) ;
        ...
        var_cas_ioListFileContents.writeString (":\n") ;
        {
          ...
          GGS_ipic_instructionList::cEnumerator enumerator_17087 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_17087 = NULL ;
          while (((operand_17087 = enumerator_17087.nextObject ()))) {
            macroValidPointer (operand_17087) ;
            { const GGS_ipic_instruction _var_18569 = operand_17087->mInstruction ; // CAST instruction
              if (_var_18569.getPtr () != NULL) {
                macroValidPointer (_var_18569.getPtr ()) ;
                if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_JUMP var_cas_ipic_JUMP (_var_18569.getPtr ()) ;
                  const GGS_ipic_JUMP  _temp_17205 = var_cas_ipic_JUMP ;
                  if (_temp_17205._isBuilt ()) {
                    typeCategoryMethod__ipic_JUMP__optimizeJUMP _method = findCategoryMethod__ipic_JUMP__optimizeJUMP (_temp_17205._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17205 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (446)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_JSR) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_JSR var_cas_ipic_JSR (_var_18569.getPtr ()) ;
                  const GGS_ipic_JSR  _temp_17363 = var_cas_ipic_JSR ;
                  if (_temp_17363._isBuilt ()) {
                    typeCategoryMethod__ipic_JSR__optimizeJSR _method = findCategoryMethod__ipic_JSR__optimizeJSR (_temp_17363._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17363 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (448)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_instruction_literalOperation) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_instruction_literalOperation var_cas_ipic_literal (_var_18569.getPtr ()) ;
                  const GGS_ipic_instruction_literalOperation  _temp_17540 = var_cas_ipic_literal ;
                  if (_temp_17540._isBuilt ()) {
                    typeCategoryMethod__ipic_instruction_literalOperation__optimizeMOVLW _method = findCategoryMethod__ipic_instruction_literalOperation__optimizeMOVLW (_temp_17540._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17540 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (450)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_instruction_conditionalBranch) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_instruction_conditionalBranch var_cas_ipic_cc (_var_18569.getPtr ()) ;
                  const GGS_ipic_instruction_conditionalBranch  _temp_17710 = var_cas_ipic_cc ;
                  if (_temp_17710._isBuilt ()) {
                    typeCategoryMethod__ipic_instruction_conditionalBranch__optimizeBCC _method = findCategoryMethod__ipic_instruction_conditionalBranch__optimizeBCC (_temp_17710._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17710 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (452)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_jump_test_register) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_jump_test_register var_cas_ipic_testReg (_var_18569.getPtr ()) ;
                  const GGS_ipic_jump_test_register  _temp_17890 = var_cas_ipic_testReg ;
                  if (_temp_17890._isBuilt ()) {
                    typeCategoryMethod__ipic_jump_test_register__optimizeTestReg _method = findCategoryMethod__ipic_jump_test_register__optimizeTestReg (_temp_17890._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17890 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (454)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_incDecRegisterInCondition) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_incDecRegisterInCondition var_cas_ipic_decInc (_var_18569.getPtr ()) ;
                  const GGS_ipic_incDecRegisterInCondition  _temp_18079 = var_cas_ipic_decInc ;
                  if (_temp_18079._isBuilt ()) {
                    typeCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc _method = findCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc (_temp_18079._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18079 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (456)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_registerComparisonCondition) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_registerComparisonCondition var_cas_ipic_CMP (_var_18569.getPtr ()) ;
                  const GGS_ipic_registerComparisonCondition  _temp_18267 = var_cas_ipic_CMP ;
                  if (_temp_18267._isBuilt ()) {
                    typeCategoryMethod__ipic_registerComparisonCondition__optimizeCMP _method = findCategoryMethod__ipic_registerComparisonCondition__optimizeCMP (_temp_18267._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18267 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (458)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_instruction_BitTestSkip) == typeid (* (_var_18569.getPtr ()))) {
                  const GGS_ipic_instruction_BitTestSkip var_cas_ipic_bitTestSkip (_var_18569.getPtr ()) ;
                  const GGS_ipic_instruction_BitTestSkip  _temp_18460 = var_cas_ipic_bitTestSkip ;
                  if (_temp_18460._isBuilt ()) {
                    typeCategoryMethod__ipic_instruction_BitTestSkip__optimizeBitTestSkip _method = findCategoryMethod__ipic_instruction_BitTestSkip__optimizeBitTestSkip (_temp_18460._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18460 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (460)) ;
                    }
                  }
                }else{
                }
        ...
        {
          GGS_ipic_instructionList::cEnumerator enumerator_18697 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_18697 = NULL ;
          while (((operand_18697 = enumerator_18697.nextObject ()))) {
            macroValidPointer (operand_18697) ;
            const GGS_ipic_instruction  _temp_18747 = operand_18697->mInstruction ;
            if (_temp_18747._isBuilt ()) {
              _temp_18747 (HERE)->method_enterReferencedLabel (_inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (467)) ;
            }
          }
        }
        {
          GGS_symbolTableForOptimizations::cEnumerator enumerator_18820 (var_cas_symbolTable, true) ;
          const GGS_symbolTableForOptimizations::cElement * operand_18820 = NULL ;
          while (((operand_18820 = enumerator_18820.nextObject ()))) {
            macroValidPointer (operand_18820) ;
            if (((var_cas_referencedLabels.reader_hasKey (_inLexique, operand_18820->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470)))._operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  _temp_18937 = var_cas_symbolTable ;
              if (_temp_18937._isBuilt ()) {
                _temp_18937 (HERE)->method_searchKey (_inLexique, operand_18820->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (471)) ;
              }
              var_cas_ioListFileContents.writeString ("  line ") ;
              ...
              var_cas_ioListFileContents._dotAssign_operation (operand_18820->mKey) ;
              ...
              var_cas_symbolTable.modifier_removeKey (_inLexique, operand_18820->mKey, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (474)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic_instructionList::cEnumerator enumerator_19431 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_19431 = NULL ;
          while (((operand_19431 = enumerator_19431.nextObject ()))) {
            macroValidPointer (operand_19431) ;
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_ipic_instruction  _temp_19547 = operand_19431->mInstruction ;
              if (_temp_19547._isBuilt ()) {
                _temp_19547 (HERE)->method_nextInstructionIsReachable (_inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (483)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_ipic_instruction  _temp_19676 = operand_19431->mInstruction ;
              if (_temp_19676._isBuilt ()) {
                _temp_19676 (HERE)->method_isSkippingInstruction (_inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (485)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_ipic_instruction  _temp_19778 = operand_19431->mInstruction ;
              if (_temp_19778._isBuilt ()) {
                _temp_19778 (HERE)->method_isLABELorORG (_inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (487)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_ipic_instruction  _temp_19846 = operand_19431->mInstruction ;
              if (_temp_19846._isBuilt ()) {
                _temp_19846 (HERE)->method_isNULL (_inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (488)) ;
              }
        ...
        if (((var_cas_optimizationsDone)._operator_not ()).isBuiltAndTrue ()) {
          ...
          {
            GGS_ipic_instructionList::cEnumerator enumerator_20482 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_ipic_instructionList::cElement * operand_20482 = NULL ;
            while (((operand_20482 = enumerator_20482.nextObject ()))) {
              macroValidPointer (operand_20482) ;
              const GGS_ipic_instruction  _temp_20534 = operand_20482->mInstruction ;
              if (_temp_20534._isBuilt ()) {
                _temp_20534 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (504)) ;
              }
            }
          }
