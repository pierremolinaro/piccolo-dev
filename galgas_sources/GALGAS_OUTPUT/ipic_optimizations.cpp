...
category_method__ipic_instruction__defineLabel (C_Compiler &,
                                const cPtr_ipic_instruction * operand_929,
...
category_method__ipic_pseudo_LABEL__defineLabel (C_Compiler & _inLexique,
                                const cPtr_ipic_pseudo_LABEL * operand_1162,
                                GGS_symbolTableForOptimizations  & var_cas_ioRoutineSymbolTable,
                                const GGS_uint   var_cas_inLineIndex
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_1162 != NULL) {
    var_cas_ioRoutineSymbolTable.modifier_insertKey (_inLexique, operand_1162->mLabel, var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (33)) ;
  }
}
...
void routine_findFirstInstructionFromAddress (C_Compiler & _inLexique,
  ...
  GGS_uint _variant_2106 = var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (48)) ;
  GGS_bool _condition_2106 (_variant_2106._isBuilt (), true) ;
  while (_condition_2106.isBuiltAndTrue ()) {
    _condition_2106 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (49))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_2106.isBuiltAndTrue ()) {
      if (_variant_2106.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (58)) ;
        _condition_2106 = GGS_bool (true, false) ;
      }else{
        _variant_2106._decrement_operation (_inLexique COMMA_HERE) ;
        { const GGS_ipic_instruction _var_2093 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (51)) ; // CAST instruction
          if (_var_2093.getPtr () != NULL) {
            macroValidPointer (_var_2093.getPtr ()) ;
            if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_2093.getPtr ()) != NULL) {
              const GGS_ipic_actualInstruction var_cas_instr (_var_2093.getPtr ()) ;
...
void routine_findFirstInstructionOrLabelFromAddress (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_found ;
  var_cas_found = GGS_bool (true, false) ;
  GGS_uint _variant_3166 = var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (75)) ;
  GGS_bool _condition_3166 (_variant_3166._isBuilt (), true) ;
  while (_condition_3166.isBuiltAndTrue ()) {
    _condition_3166 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (76))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_3166.isBuiltAndTrue ()) {
      if (_variant_3166.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (89)) ;
        _condition_3166 = GGS_bool (true, false) ;
      }else{
        _variant_3166._decrement_operation (_inLexique COMMA_HERE) ;
        { const GGS_ipic_instruction _var_3153 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (78)) ; // CAST instruction
          if (_var_3153.getPtr () != NULL) {
            macroValidPointer (_var_3153.getPtr ()) ;
            if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_3153.getPtr ()) != NULL) {
              const GGS_ipic_actualInstruction var_cas_instr (_var_3153.getPtr ()) ;
              var_cas_outFirstInstruction = var_cas_instr ;
              var_cas_found = GGS_bool (true, true) ;
            }else if (typeid (cPtr_ipic_pseudo_LABEL) == typeid (* (_var_3153.getPtr ()))) {
              const GGS_ipic_pseudo_LABEL var_cas_instr (_var_3153.getPtr ()) ;
              var_cas_outFirstInstruction = var_cas_instr ;
...
category_method__ipic_JUMP__optimizeJUMP (C_Compiler & _inLexique,
                                const cPtr_ipic_JUMP * operand_3615,
  ...
  if (operand_3615 != NULL) {
    ...
    if ((var_cas_reachedLabelSet.reader_hasKey (_inLexique, operand_3615->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109))).isBuiltAndTrue ()) {
      ...
      const GGS_symbolTableForOptimizations  _temp_4387 = var_cas_inSymbolTable ;
      if (_temp_4387._isBuilt ()) {
        _temp_4387 (HERE)->method_searchKey (_inLexique, operand_3615->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (114)) ;
      }
      ...
      { const GGS_ipic_instruction _var_5892 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5892.getPtr () != NULL) {
          macroValidPointer (_var_5892.getPtr ()) ;
          if (typeid (cPtr_ipic_instruction_RETURN) == typeid (* (_var_5892.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_3615->mInstructionLocation COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (121)) ;
          ...
          }else if (typeid (cPtr_ipic_instruction_literalOperation) == typeid (* (_var_5892.getPtr ()))) {
            const GGS_ipic_instruction_literalOperation var_cas_literalOp (_var_5892.getPtr ()) ;
          ...
          }else if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_5892.getPtr ()))) {
            const GGS_ipic_JUMP var_cas_jump (_var_5892.getPtr ()) ;
            if (((operand_3615->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_JUMP ::constructor_new (_inLexique, operand_3615->mInstructionLocation, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (139)), operand_3615->mKind COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (138)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic_JSR__optimizeJSR (C_Compiler & _inLexique,
                                const cPtr_ipic_JSR * operand_6039,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
  ...
  if (operand_6039 != NULL) {
    ...
    { const GGS_ipic_instruction _var_6772 = var_cas_firstInstruction ; // CAST instruction
      if (_var_6772.getPtr () != NULL) {
        macroValidPointer (_var_6772.getPtr ()) ;
        if (typeid (cPtr_ipic_instruction_RETURN) == typeid (* (_var_6772.getPtr ()))) {
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_JUMP ::constructor_new (_inLexique, operand_6039->mInstructionLocation, operand_6039->mTargetLabel, operand_6039->mKind COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (164)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic_instruction_literalOperation__optimizeMOVLW (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_literalOperation * operand_6929,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
  ...
  if (operand_6929 != NULL) {
    if (((operand_6929->mLiteralInstruction)._operator_isEqual (GGS_literal_instruction_opcode::constructor_MOVLW (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_ipic_instruction  var_cas_firstInstruction ;
      ...
      { const GGS_ipic_instruction _var_7817 = var_cas_firstInstruction ; // CAST instruction
        if (_var_7817.getPtr () != NULL) {
          macroValidPointer (_var_7817.getPtr ()) ;
          if (typeid (cPtr_ipic_instruction_RETURN) == typeid (* (_var_7817.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_literalOperation ::constructor_new (_inLexique, operand_6929->mInstructionLocation, GGS_literal_instruction_opcode::constructor_RETLW (_inLexique COMMA_HERE), operand_6929->mLiteralValue COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (189)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__ipic_instruction_conditionalBranch__optimizeBCC (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_conditionalBranch * operand_7984,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
  ...
  if (operand_7984 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_8253 = var_cas_inSymbolTable ;
    if (_temp_8253._isBuilt ()) {
      _temp_8253 (HERE)->method_searchKey (_inLexique, operand_7984->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (210)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic_instruction _var_9065 = var_cas_firstInstruction ; // CAST instruction
      if (_var_9065.getPtr () != NULL) {
        macroValidPointer (_var_9065.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_9065.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_9065.getPtr ()) ;
          if (((operand_7984->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)))._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)))).isBuiltAndTrue ()) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_conditionalBranch ::constructor_new (_inLexique, operand_7984->mInstructionLocation, operand_7984->mBranchMode, operand_7984->mConditionalBranch, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (218)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            ...
            var_cas_ioListFileContents._dotAssign_operation (operand_7984->mConditionalBranch.reader_condition (_inLexique COMMA_SOURCE_FILE_AT_LINE (223))) ;
...
category_method__ipic_jump_test_register__optimizeTestReg (C_Compiler & _inLexique,
                                const cPtr_ipic_jump_test_register * operand_9214,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9214 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_9483 = var_cas_inSymbolTable ;
    if (_temp_9483._isBuilt ()) {
      _temp_9483 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_9214->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (239)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic_instruction _var_10483 = var_cas_firstInstruction ; // CAST instruction
      if (_var_10483.getPtr () != NULL) {
        macroValidPointer (_var_10483.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_10483.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_10483.getPtr ()) ;
          if (((operand_9214->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)))).isBuiltAndTrue ()) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_jump_test_register ::constructor_new (_inLexique, operand_9214->mInstructionLocation, operand_9214->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)), operand_9214->mBranchIfZero, operand_9214->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (247)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            ...
            var_cas_ioListFileContents.writeString (": label of JUMP ") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_9214->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (252))) ;
            if ((operand_9214->mBranchIfZero).isBuiltAndTrue ()) {
...
category_method__ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & _inLexique,
                                const cPtr_ipic_incDecRegisterInCondition * operand_10642,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10642 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_10911 = var_cas_inSymbolTable ;
    if (_temp_10911._isBuilt ()) {
      _temp_10911 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_10642->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (274)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic_instruction _var_12176 = var_cas_firstInstruction ; // CAST instruction
      if (_var_12176.getPtr () != NULL) {
        macroValidPointer (_var_12176.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_12176.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_12176.getPtr ()) ;
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_incDecRegisterInCondition ::constructor_new (_inLexique, operand_10642->mInstructionLocation, operand_10642->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)), operand_10642->mIncrement, operand_10642->m_W_isDestination, operand_10642->mBranchIfZero, operand_10642->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (281)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
          ...
          if ((operand_10642->mIncrement).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString ("INCF ") ;
          }else{
            var_cas_ioListFileContents.writeString ("DECF ") ;
          }
          var_cas_ioListFileContents._dotAssign_operation (operand_10642->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (301))) ;
          if ((operand_10642->m_W_isDestination).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString (", W ") ;
          }
          if ((operand_10642->mBranchIfZero).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.writeString ("Z") ;
          }else{
            var_cas_ioListFileContents.writeString ("NZ") ;
          }
...
category_method__ipic_registerComparisonCondition__optimizeCMP (C_Compiler & _inLexique,
                                const cPtr_ipic_registerComparisonCondition * operand_12330,
                                const GGS_symbolTableForOptimizations   var_cas_inSymbolTable,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12330 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  _temp_12599 = var_cas_inSymbolTable ;
    if (_temp_12599._isBuilt ()) {
      _temp_12599 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_12330->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (325)) ;
    }
    GGS_ipic_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_ipic_instruction _var_13556 = var_cas_firstInstruction ; // CAST instruction
      if (_var_13556.getPtr () != NULL) {
        macroValidPointer (_var_13556.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_13556.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_13556.getPtr ()) ;
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_registerComparisonCondition ::constructor_new (_inLexique, operand_12330->mInstructionLocation, operand_12330->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)), operand_12330->mComparison, operand_12330->mUsesBra COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (332)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
          ...
          var_cas_ioListFileContents.writeString (": label of ") ;
          var_cas_ioListFileContents.writeString ("JUMP ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12330->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (345))) ;
          var_cas_ioListFileContents.writeString (" ") ;
          var_cas_ioListFileContents._dotAssign_operation (operand_12330->mComparison.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (346))) ;
          var_cas_ioListFileContents.writeString (" branching to JUMP replaced by second JUMP label\n") ;
        }else{
        }
      }
...
category_method__ipic_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_BitTestSkip * operand_13714,
                                const GGS_uint   var_cas_inLineIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                GGS_string & var_cas_ioListFileContents,
                                GGS_bool & var_cas_ioOptimizationsDone
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13714 != NULL) {
    GGS_string var_cas_jumpLabel ;
    var_cas_jumpLabel = GGS_string (true, "") ;
    GGS_bool var_cas_ok ;
    var_cas_ok = GGS_bool (true, false) ;
    { const GGS_ipic_instruction _var_14145 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ; // CAST instruction
      if (_var_14145.getPtr () != NULL) {
        macroValidPointer (_var_14145.getPtr ()) ;
        if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_14145.getPtr ()))) {
          const GGS_ipic_JUMP var_cas_jump (_var_14145.getPtr ()) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_ipic_instruction _var_14358 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)) ; // CAST instruction
        if (_var_14358.getPtr () != NULL) {
          macroValidPointer (_var_14358.getPtr ()) ;
          if (dynamic_cast <cPtr_ipic_actualInstruction *> (_var_14358.getPtr ()) != NULL) {
          }else{
            var_cas_ok = GGS_bool (true, false) ;
          }
        }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_ipic_instruction_BitTestSkip ::constructor_new (_inLexique, operand_13714->mInstructionLocation, (operand_13714->mSkipIfSet)._operator_not (), operand_13714->mRegisterDescription, operand_13714->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (387)) ;
...
void routine_performOptimizations (C_Compiler & _inLexique,
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    GGS_ipic_instructionList::cEnumerator enumerator_16651 (var_cas_ioGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_16651 = NULL ;
    while (((operand_16651 = enumerator_16651.nextObject ()))) {
      macroValidPointer (operand_16651) ;
      const GGS_ipic_instruction  _temp_16694 = operand_16651->mInstruction ;
      if (_temp_16694._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__defineLabel _method = findCategoryMethod__ipic_instruction__defineLabel (_temp_16694._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_16694 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (431)) ;
        }
      }
  ...
  GGS_uint _variant_20704 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (436)) ;
  GGS_bool _condition_20704 (_variant_20704._isBuilt (), true) ;
  while (_condition_20704.isBuiltAndTrue ()) {
    _condition_20704 = var_cas_optimizationsDone ;
    if (_condition_20704.isBuiltAndTrue ()) {
      if (_variant_20704.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (508)) ;
        _condition_20704 = GGS_bool (true, false) ;
      }else{
        _variant_20704._decrement_operation (_inLexique COMMA_HERE) ;
        ...
        var_cas_ioListFileContents.writeString (":\n") ;
        {
          ...
          GGS_ipic_instructionList::cEnumerator enumerator_17114 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_17114 = NULL ;
          while (((operand_17114 = enumerator_17114.nextObject ()))) {
            macroValidPointer (operand_17114) ;
            { const GGS_ipic_instruction _var_18579 = operand_17114->mInstruction ; // CAST instruction
              if (_var_18579.getPtr () != NULL) {
                macroValidPointer (_var_18579.getPtr ()) ;
                if (typeid (cPtr_ipic_JUMP) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_JUMP var_cas_ipic_JUMP (_var_18579.getPtr ()) ;
                  const GGS_ipic_JUMP  _temp_17218 = var_cas_ipic_JUMP ;
                  if (_temp_17218._isBuilt ()) {
                    typeCategoryMethod__ipic_JUMP__optimizeJUMP _method = findCategoryMethod__ipic_JUMP__optimizeJUMP (_temp_17218._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17218 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (446)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_JSR) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_JSR var_cas_ipic_JSR (_var_18579.getPtr ()) ;
                  const GGS_ipic_JSR  _temp_17375 = var_cas_ipic_JSR ;
                  if (_temp_17375._isBuilt ()) {
                    typeCategoryMethod__ipic_JSR__optimizeJSR _method = findCategoryMethod__ipic_JSR__optimizeJSR (_temp_17375._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17375 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (448)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_instruction_literalOperation) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_instruction_literalOperation var_cas_ipic_literal (_var_18579.getPtr ()) ;
                  const GGS_ipic_instruction_literalOperation  _temp_17554 = var_cas_ipic_literal ;
                  if (_temp_17554._isBuilt ()) {
                    typeCategoryMethod__ipic_instruction_literalOperation__optimizeMOVLW _method = findCategoryMethod__ipic_instruction_literalOperation__optimizeMOVLW (_temp_17554._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17554 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (450)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_instruction_conditionalBranch) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_instruction_conditionalBranch var_cas_ipic_cc (_var_18579.getPtr ()) ;
                  const GGS_ipic_instruction_conditionalBranch  _temp_17722 = var_cas_ipic_cc ;
                  if (_temp_17722._isBuilt ()) {
                    typeCategoryMethod__ipic_instruction_conditionalBranch__optimizeBCC _method = findCategoryMethod__ipic_instruction_conditionalBranch__optimizeBCC (_temp_17722._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17722 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (452)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_jump_test_register) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_jump_test_register var_cas_ipic_testReg (_var_18579.getPtr ()) ;
                  const GGS_ipic_jump_test_register  _temp_17906 = var_cas_ipic_testReg ;
                  if (_temp_17906._isBuilt ()) {
                    typeCategoryMethod__ipic_jump_test_register__optimizeTestReg _method = findCategoryMethod__ipic_jump_test_register__optimizeTestReg (_temp_17906._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17906 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (454)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_incDecRegisterInCondition) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_incDecRegisterInCondition var_cas_ipic_decInc (_var_18579.getPtr ()) ;
                  const GGS_ipic_incDecRegisterInCondition  _temp_18098 = var_cas_ipic_decInc ;
                  if (_temp_18098._isBuilt ()) {
                    typeCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc _method = findCategoryMethod__ipic_incDecRegisterInCondition__optimizeTestDecInc (_temp_18098._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18098 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (456)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_registerComparisonCondition) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_registerComparisonCondition var_cas_ipic_CMP (_var_18579.getPtr ()) ;
                  const GGS_ipic_registerComparisonCondition  _temp_18279 = var_cas_ipic_CMP ;
                  if (_temp_18279._isBuilt ()) {
                    typeCategoryMethod__ipic_registerComparisonCondition__optimizeCMP _method = findCategoryMethod__ipic_registerComparisonCondition__optimizeCMP (_temp_18279._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18279 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (458)) ;
                    }
                  }
                }else if (typeid (cPtr_ipic_instruction_BitTestSkip) == typeid (* (_var_18579.getPtr ()))) {
                  const GGS_ipic_instruction_BitTestSkip var_cas_ipic_bitTestSkip (_var_18579.getPtr ()) ;
                  const GGS_ipic_instruction_BitTestSkip  _temp_18480 = var_cas_ipic_bitTestSkip ;
                  if (_temp_18480._isBuilt ()) {
                    typeCategoryMethod__ipic_instruction_BitTestSkip__optimizeBitTestSkip _method = findCategoryMethod__ipic_instruction_BitTestSkip__optimizeBitTestSkip (_temp_18480._galgasObjectRunTimeInfo ()) ;
                    if (_method != NULL) {
                      _method (_inLexique, _temp_18480 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (460)) ;
                    }
                  }
                }else{
                }
        ...
        {
          GGS_ipic_instructionList::cEnumerator enumerator_18724 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_18724 = NULL ;
          while (((operand_18724 = enumerator_18724.nextObject ()))) {
            macroValidPointer (operand_18724) ;
            const GGS_ipic_instruction  _temp_18768 = operand_18724->mInstruction ;
            if (_temp_18768._isBuilt ()) {
              _temp_18768 (HERE)->method_enterReferencedLabel (_inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (467)) ;
            }
          }
        }
        {
          GGS_symbolTableForOptimizations::cEnumerator enumerator_18832 (var_cas_symbolTable, true) ;
          const GGS_symbolTableForOptimizations::cElement * operand_18832 = NULL ;
          while (((operand_18832 = enumerator_18832.nextObject ()))) {
            macroValidPointer (operand_18832) ;
            if (((var_cas_referencedLabels.reader_hasKey (_inLexique, operand_18832->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470)))._operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  _temp_18947 = var_cas_symbolTable ;
              if (_temp_18947._isBuilt ()) {
                _temp_18947 (HERE)->method_searchKey (_inLexique, operand_18832->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (471)) ;
              }
              var_cas_ioListFileContents.writeString ("  line ") ;
              ...
              var_cas_ioListFileContents._dotAssign_operation (operand_18832->mKey) ;
              ...
              var_cas_symbolTable.modifier_removeKey (_inLexique, operand_18832->mKey, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (474)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_ipic_instructionList::cEnumerator enumerator_19458 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_19458 = NULL ;
          while (((operand_19458 = enumerator_19458.nextObject ()))) {
            ...
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_ipic_instruction  _temp_19574 = operand_19458->mInstruction ;
              if (_temp_19574._isBuilt ()) {
                _temp_19574 (HERE)->method_nextInstructionIsReachable (_inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (483)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_ipic_instruction  _temp_19698 = operand_19458->mInstruction ;
              if (_temp_19698._isBuilt ()) {
                _temp_19698 (HERE)->method_isSkippingInstruction (_inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (485)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_ipic_instruction  _temp_19791 = operand_19458->mInstruction ;
              if (_temp_19791._isBuilt ()) {
                _temp_19791 (HERE)->method_isLABELorORG (_inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (487)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_ipic_instruction  _temp_19853 = operand_19458->mInstruction ;
              if (_temp_19853._isBuilt ()) {
                _temp_19853 (HERE)->method_isNULL (_inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (488)) ;
              }
        ...
        if (((var_cas_optimizationsDone)._operator_not ()).isBuiltAndTrue ()) {
          ...
          {
            GGS_ipic_instructionList::cEnumerator enumerator_20509 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_ipic_instructionList::cElement * operand_20509 = NULL ;
            while (((operand_20509 = enumerator_20509.nextObject ()))) {
              macroValidPointer (operand_20509) ;
              const GGS_ipic_instruction  _temp_20552 = operand_20509->mInstruction ;
              if (_temp_20552._isBuilt ()) {
                _temp_20552 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (504)) ;
              }
            }
          }
