...
GGS_midrange_symbolTable GGS_midrange_symbolTable::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_midrange_symbolTable result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
category_method__midrange_ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_6936 != NULL) {
    ...
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_6936->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (208)) ;
    }
    ...
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_PCLATH_register.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_PCLATH_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (214)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_7544_0 COMMA_SOURCE_FILE_AT_LINE (212)) ;
      }
    }
...
category_method__midrange_ipic_GOTO__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8359 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_8359->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (244)) ;
    }
...
category_method__midrange_ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8843 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_8843->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (259)) ;
    }
    ...
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_PCLATH_register.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_PCLATH_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (265)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_9451_0 COMMA_SOURCE_FILE_AT_LINE (263)) ;
      }
    }
...
category_method__midrange_ipic_CALL__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_10849 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_10849->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (304)) ;
    }
...
category_method__midrange_ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_11331 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11331->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (334)), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (334)) ;
    }
...
category_method__midrange_ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_14819 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_14819->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (427)) ;
    }
...
void routine_build_midrange_ipic_binary_code (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
  {
    ...
    while (((operand_16732 = enumerator_16732.nextObject ()))) {
      ...
      { typeCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress method = findCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress (operand_16732->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_16732->mInstruction (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (473)) ;
        }
      }
    }
  }
  ...
  }
  {
    ...
    while (((operand_17056 = enumerator_17056.nextObject ()))) {
      ...
      { typeCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress method = findCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress (operand_17056->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_17056->mInstruction (HERE), var_cas_inRegisterTable, var_cas_inTotalBankCount, var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (481)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      if (operand_17056->mInstruction.isBuilt ()) {
        operand_17056->mInstruction (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (488)) ;
      }
