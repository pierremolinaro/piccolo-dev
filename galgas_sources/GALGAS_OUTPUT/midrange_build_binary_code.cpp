...
category_method__midrange_ipic_actualInstruction__enterLabelAtAddress (C_Compiler & inLexique,
  ...
  if (operand_1796 != NULL) {
    ...
    var_cas_ioAddress = var_cas_ioAddress._add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (56)) ;
  }
}
...
category_method__midrange_ipic_pseudo_ORG__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_3090 != NULL) {
    ...
    if (operand_3090->mOrigin._add_operation (inLexique, operand_3090->mOrigin COMMA_SOURCE_FILE_AT_LINE (92)).isBuilt ()) {
      ::routine_setEmitAddress (inLexique,  operand_3090->mOrigin._add_operation (inLexique, operand_3090->mOrigin COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_FD__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_3474 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_3474->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (108)))._operator_and (GGS_uint (127U))) ;
...
category_method__midrange_ipic_instruction_F__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_4013 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_4013->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (122)))._operator_and (GGS_uint (127U))) ;
    if (var_cas_code.isBuilt ()) {
...
category_method__midrange_ipic_instruction_FB__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_4484 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_4484->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (136)))._operator_and (GGS_uint (127U))) ;
    var_cas_code = (var_cas_code)._operator_or (operand_4484->mBitNumber._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (137))) ;
    if (var_cas_code.isBuilt ()) {
...
category_method__midrange_ipic_instruction_BitTestSkip__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_5001 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_5001->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (151)))._operator_and (GGS_uint (127U))) ;
    var_cas_code = (var_cas_code)._operator_or (operand_5001->mBitNumber._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (152))) ;
    if (var_cas_code.isBuilt ()) {
...
void routine_emit_midrange_GOTOinstruction_nocheck (C_Compiler & inLexique,
  ...
  if ((GGS_uint (10240U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (2047U))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (10240U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (2047U))) COMMA_SOURCE_FILE_AT_LINE (161)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emit_midrange_GOTOinstruction (C_Compiler & inLexique,
  ...
  if (((((var_cas_inOriginAddress)._operator_xor (var_cas_inTargetAddress))._operator_and (GGS_uint (63488U)))._operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_inIntructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("GOTO (from "))._operator_concat (var_cas_inOriginAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (172))))._operator_concat (GGS_string (" to ")))._operator_concat (var_cas_inTargetAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (172))))._operator_concat (GGS_string (") crosses page boundary")) COMMA_SOURCE_FILE_AT_LINE (173)) ;
  }
...
void routine_emit_midrange_CALLinstruction_nocheck (C_Compiler & inLexique,
  ...
  if ((GGS_uint (8192U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (2047U))).isBuilt ()) {
    ::routine_emitCode (inLexique,  (GGS_uint (8192U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (2047U))) COMMA_SOURCE_FILE_AT_LINE (182)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emit_midrange_CALLinstruction (C_Compiler & inLexique,
  ...
  #endif
  if (((((var_cas_inOriginAddress)._operator_xor (var_cas_inTargetAddress))._operator_and (GGS_uint (63488U)))._operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_inIntructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("CALL (from "))._operator_concat (var_cas_inOriginAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (193))))._operator_concat (GGS_string (" to ")))._operator_concat (var_cas_inTargetAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (193))))._operator_concat (GGS_string (") crosses page boundary")) COMMA_SOURCE_FILE_AT_LINE (194)) ;
  }
...
category_method__midrange_ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_6936 != NULL) {
    ...
    if (_temp_7137.isBuilt ()) {
      _temp_7137 (HERE)->method_searchKey (inLexique, operand_6936->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (208)) ;
    }
    ...
    if (_temp_7416.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (inLexique, _temp_7416 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (212)) ;
      }
    }
    switch (operand_6936->mBit11.enumValue ()) {
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (5120U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (221))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (221)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (5120U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (221))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (221)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (221)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (4096U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (222))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (222)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (4096U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (222))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (222)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (222)) ;
      }
      }
      break ;
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (5120U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (226))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (226)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (5120U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (226))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (226)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (226)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (4096U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (227))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (227)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (4096U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (227))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (227)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (227)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
...
category_method__midrange_ipic_GOTO__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8359 != NULL) {
    ...
    if (_temp_8567.isBuilt ()) {
      _temp_8567 (HERE)->method_searchKey (inLexique, operand_8359->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (244)) ;
    }
...
category_method__midrange_ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8843 != NULL) {
    ...
    if (_temp_9044.isBuilt ()) {
      _temp_9044 (HERE)->method_searchKey (inLexique, operand_8843->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (259)) ;
    }
    GGS_registerExpression  var_cas_PCLATH_register ;
    var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("PCLATH"), GGS_location (inLexique) COMMA_HERE), GGS_luint ::constructor_new (inLexique, GGS_uint (0U), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
    GGS_midrange_ipic_registerExpression var_cas_PCLATH_IPICregisterDescription ;
    ...
    if (_temp_9323.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (inLexique, _temp_9323 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (263)) ;
      }
    }
    switch (operand_8843->mBit11.enumValue ()) {
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (5120U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (272))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (272)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (5120U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (272))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (272)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (272)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (4096U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (273))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (273)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (4096U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (273))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (273)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (273)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (5120U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (277))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (277)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (5120U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (277))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (277)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (277)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (4096U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (278))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (278)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (4096U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (278))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (278)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (278)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (4096U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (283))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (283)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (4096U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (283))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (283)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (283)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (5120U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (284))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (284)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (5120U))._operator_or (GGS_uint (3U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (284))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (284)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (284)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (4096U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (288))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (288)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (4096U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (288))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (288)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (288)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (5120U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (289))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (289)))._operator_and (GGS_uint (127U))).isBuilt ()) {
        ::routine_emitCode (inLexique,  ((GGS_uint (5120U))._operator_or (GGS_uint (4U)._left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (289))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (289)))._operator_and (GGS_uint (127U))) COMMA_SOURCE_FILE_AT_LINE (289)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
...
category_method__midrange_ipic_CALL__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_10849 != NULL) {
    ...
    if (_temp_11057.isBuilt ()) {
      _temp_11057 (HERE)->method_searchKey (inLexique, operand_10849->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (304)) ;
    }
...
category_method__midrange_ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_11331 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_11331->mRegisterDescription.reader_mRegisterAddress (inLexique COMMA_SOURCE_FILE_AT_LINE (326)))._operator_and (GGS_uint (127U))) ;
    if (var_cas_code.isBuilt ()) {
      ::routine_emitCode (inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (327)) ;
    }
    if ((operand_11331->mBranchIfZero).isBuiltAndTrue ()) {
      ::routine_emit_midrange_GOTOinstruction (inLexique,  operand_11331->mInstructionLocation,  var_cas_ioAddress,  var_cas_ioAddress._add_operation (inLexique, GGS_uint (3U) COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_midrange_symbolTable  _temp_11960 = var_cas_inRoutineSymbolTable ;
    if (_temp_11960.isBuilt ()) {
      _temp_11960 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11331->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (334)) ;
    }
...
category_method__midrange_ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_14819 != NULL) {
    ...
    if (_temp_15022.isBuilt ()) {
      _temp_15022 (HERE)->method_searchKey (inLexique, operand_14819->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (427)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_14819->mLabel.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("Internal second pass error: the '"))._operator_concat (operand_14819->mLabel))._operator_concat (GGS_string ("' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (430))))._operator_concat (GGS_string (" value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (431))))._operator_concat (GGS_string (" in first pass")) COMMA_SOURCE_FILE_AT_LINE (432)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_15472 != NULL) {
    if (((operand_15472->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (443)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    while (_condition_15874.isBuiltAndTrue ()) {
      _condition_15874 = (var_cas_idx)._operator_strictInf (operand_15472->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (448))) ;
      if (_condition_15874.isBuiltAndTrue ()) {
        if (_variant_15874.uintValue () == 0) {
          ...
          _variant_15874._decrement_operation (inLexique COMMA_HERE) ;
          if (GGS_uint (0U).isBuilt ()) {
            ::routine_emitCode (inLexique,  GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (450)) ;
          }
          var_cas_idx._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (451)) ;
        }
      }
    }
  }
...
void routine_build_midrange_ipic_binary_code (C_Compiler & inLexique,
  ...
  var_cas_symbolTable = GGS_midrange_symbolTable ::constructor_emptyMap (inLexique COMMA_HERE) ;
  ...
  var_cas_currentAddress = GGS_uint (0U) ;
  {
    ...
    while (((operand_16732 = enumerator_16732.nextObject ()))) {
      ...
      if (_temp_16773.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (inLexique, _temp_16773 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (473)) ;
        }
      }
    }
  }
  ...
  }
  {
    ...
    while (((operand_17056 = enumerator_17056.nextObject ()))) {
      ...
      if (_temp_17105.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (inLexique, _temp_17105 (HERE), var_cas_inRegisterTable, var_cas_inTotalBankCount, var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (481)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_midrange_ipic_instruction  _temp_17268 = operand_17056->mInstruction ;
      if (_temp_17268.isBuilt ()) {
        _temp_17268 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (488)) ;
      }
      var_cas_currentAddress = var_cas_currentAddress._add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (489)) ;
      ::routine_checkCurrentEmitAddress (inLexique,  var_cas_currentAddress._multiply_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (490)) COMMA_SOURCE_FILE_AT_LINE (490)) ;
    }
  }
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (493))))._operator_concat (GGS_string (" value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (495))))._operator_concat (GGS_string (" value in first pass")) COMMA_SOURCE_FILE_AT_LINE (496)) ;
  }else if (((var_cas_lastAddressForFirstPass)._operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("Program too large: "))._operator_concat (var_cas_lastAddressForFirstPass.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (497))))._operator_concat (GGS_string (" bytes (rom size is ")))._operator_concat (var_cas_inROMsize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (499))))._operator_concat (GGS_string (" bytes)")) COMMA_SOURCE_FILE_AT_LINE (500)) ;
  }
  {
    ...
    while (((operand_17969 = enumerator_17969.nextObject ()))) {
      ...
      if (operand_17969->mInfo.mRegisterAddress._add_operation (inLexique, operand_17969->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (503)).isBuilt ()) {
        ::routine_setEmitAddress (inLexique,  operand_17969->mInfo.mRegisterAddress._add_operation (inLexique, operand_17969->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (503)) COMMA_SOURCE_FILE_AT_LINE (503)) ;
      }
