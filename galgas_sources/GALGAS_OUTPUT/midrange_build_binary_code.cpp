...
void routine_build_5F_midrange_5F_ipic_5F_binary_5F_code (const GALGAS_registerTable constinArgument_inRegisterTable,
  ...
  while (enumerator_23723.hasCurrentObject ()) {
    callCategoryMethod_enterLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23723.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (686)) ;
  ...
  while (enumerator_24369.hasCurrentObject ()) {
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_24369.current_mInstruction (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inTotalBankCount, var_symbolTable, ioArgument_ioListFileContents, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (699)) ;
    {
  ...
  while (enumerator_25237.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_25237.current_mRegisterAddress (HERE).add_operation (enumerator_25237.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) ;
    }
    {
    routine_emitCode (enumerator_25237.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (721)) ;
    }
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (322)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_11384_0, var_usedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (659)).isValid ()) {
    uint32_t variant_22646 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (659)).uintValue () ;
    bool loop_22646 = true ;
    while (loop_22646) {
      loop_22646 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (660)))).isValid () ;
      if (loop_22646) {
        loop_22646 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (660)))).boolValue () ;
      }
