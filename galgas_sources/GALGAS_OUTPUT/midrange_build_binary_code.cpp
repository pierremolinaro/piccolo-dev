...
void routine_build_5F_midrange_5F_ipic_5F_binary_5F_code (const GALGAS_registerTable constinArgument_inRegisterTable,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_16827 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16827.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_16827.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_17151 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17151.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_17151.current_mInstruction (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inTotalBankCount, var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (479)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_uint var_instructionLength ;
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_instructionLength ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_17151.current_mInstruction (HERE).ptr (), var_instructionLength, inCompiler COMMA_SOURCE_FILE_AT_LINE (486)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_18064 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_18064.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_setEmitAddress (enumerator_18064.current_mRegisterAddress (HERE).add_operation (enumerator_18064.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (501)), inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
    routine_emitCode (enumerator_18064.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (502)) ;
    } //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_actualInstruction_enterLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) temp_0.ptr (), var_instructionLength, inCompiler COMMA_SOURCE_FILE_AT_LINE (53)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_getBaseCode ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_FD *) temp_0.ptr (), var_code, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_getBaseCode ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_F *) temp_0.ptr (), var_code, inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_getBaseCode ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_FB *) temp_0.ptr (), var_code, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip temp_0 = object ;
  callCategoryMethod_getBaseCode ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) temp_0.ptr (), var_code, inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bitSliceTable joker_7508_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (212)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_7508_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (210)) ;
  //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_getBaseCode ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) temp_0.ptr (), var_code, inCompiler COMMA_SOURCE_FILE_AT_LINE (411)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (445)).isValid ()) {
    PMUInt32 variant_15847 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (445)).uintValue () ;
    bool loop_15847 = true ;
    while (loop_15847) {
      loop_15847 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (446)))).isValid () ;
      if (loop_15847) {
        loop_15847 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (446)))).boolValue () ;
      }
