...
void routine_build_5F_midrange_5F_ipic_5F_binary_5F_code (const GALGAS_registerTable constinArgument_inRegisterTable,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23744 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_23744.hasCurrentObject ()) {
    callCategoryMethod_enterLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23744.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (686)) ;
  ...
  {
  routine_setEmitAddress (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (696)) ;
  }
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_24368 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_24368.hasCurrentObject ()) {
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_24368.current_mInstruction (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inTotalBankCount, var_symbolTable, ioArgument_ioListFileContents, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (698)) ;
    {
    routine_checkCurrentEmitAddress (var_currentAddress.multiply_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (706)), inCompiler COMMA_SOURCE_FILE_AT_LINE (706)) ;
    }
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentAddress.reader_hexString (SOURCE_FILE_AT_LINE (709)) COMMA_SOURCE_FILE_AT_LINE (709)).operator_concat (GALGAS_string (" value in second pass, while it gets ") COMMA_SOURCE_FILE_AT_LINE (710)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE_AT_LINE (711)) COMMA_SOURCE_FILE_AT_LINE (711)).operator_concat (GALGAS_string (" value in first pass") COMMA_SOURCE_FILE_AT_LINE (711)) COMMA_SOURCE_FILE_AT_LINE (709)) ;
    ...
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Program too large: ").operator_concat (var_lastAddressForFirstPass.reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)).operator_concat (GALGAS_string (" bytes (rom size is ") COMMA_SOURCE_FILE_AT_LINE (714)).operator_concat (constinArgument_inROMsize.reader_string (SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)).operator_concat (GALGAS_string (" bytes)") COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
    }
  }
  cEnumerator_actualConfigurationMap enumerator_25236 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_25236.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_25236.current_mRegisterAddress (HERE).add_operation (enumerator_25236.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (719)), inCompiler COMMA_SOURCE_FILE_AT_LINE (719)) ;
    }
    {
    routine_emitCode (enumerator_25236.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) ;
    }
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_bitSliceTable joker_11403_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (322)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_11403_0, var_usedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("Internal second pass error: the '").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (639)) COMMA_SOURCE_FILE_AT_LINE (639)).operator_concat (GALGAS_string ("' label gets ") COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE_AT_LINE (640)) COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (GALGAS_string (" value in second pass, while it gets ") COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (var_targetAddress.reader_hexString (SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (641)).operator_concat (GALGAS_string (" in first pass") COMMA_SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (639)) ;
  }
  {
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (659)).isValid ()) {
    PMUInt32 variant_22666 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (659)).uintValue () ;
    bool loop_22666 = true ;
    while (loop_22666) {
      loop_22666 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (660)))).isValid () ;
      if (loop_22666) {
        loop_22666 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (660)))).boolValue () ;
      }
      if (loop_22666 && (0 == variant_22666)) {
        loop_22666 = false ;
