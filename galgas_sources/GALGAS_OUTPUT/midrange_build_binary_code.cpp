...
void routine_build_5F_midrange_5F_ipic_5F_binary_5F_code (const GALGAS_registerTable constinArgument_inRegisterTable,
  ...
  GALGAS_midrange_5F_symbolTable var_symbolTable = GALGAS_midrange_5F_symbolTable::constructor_emptyMap (SOURCE_FILE_AT_LINE (683)) ;
  GALGAS_uint var_currentAddress = GALGAS_uint ((PMUInt32) 0U) ;
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23741 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_23741.hasCurrentObject ()) {
    callCategoryMethod_enterLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23741.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (686)) ;
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (691)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (691)) COMMA_SOURCE_FILE_AT_LINE (691)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("GENERATED CODE").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (692)) COMMA_SOURCE_FILE_AT_LINE (692)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (692)) COMMA_SOURCE_FILE_AT_LINE (692)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (693)).operator_concat (GALGAS_string ("\n"
  ...
  {
  routine_initCodeGenerator (inCompiler COMMA_SOURCE_FILE_AT_LINE (695)) ;
  }
  var_currentAddress = GALGAS_uint ((PMUInt32) 0U) ;
  {
  routine_setEmitAddress (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (697)) ;
  }
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_24387 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_24387.hasCurrentObject ()) {
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_24387.current_mInstruction (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inTotalBankCount, var_symbolTable, ioArgument_ioListFileContents, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (699)) ;
    {
    routine_checkCurrentEmitAddress (var_currentAddress.multiply_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (707)), inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) ;
    }
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentAddress.reader_hexString (SOURCE_FILE_AT_LINE (710)) COMMA_SOURCE_FILE_AT_LINE (710)).operator_concat (GALGAS_string (" value in second pass, while it gets ") COMMA_SOURCE_FILE_AT_LINE (710)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE_AT_LINE (712)) COMMA_SOURCE_FILE_AT_LINE (711)).operator_concat (GALGAS_string (" value in first pass") COMMA_SOURCE_FILE_AT_LINE (712)) COMMA_SOURCE_FILE_AT_LINE (710)) ;
    ...
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Program too large: ").operator_concat (var_lastAddressForFirstPass.reader_string (SOURCE_FILE_AT_LINE (714)) COMMA_SOURCE_FILE_AT_LINE (714)).operator_concat (GALGAS_string (" bytes (rom size is ") COMMA_SOURCE_FILE_AT_LINE (714)).operator_concat (constinArgument_inROMsize.reader_string (SOURCE_FILE_AT_LINE (716)) COMMA_SOURCE_FILE_AT_LINE (715)).operator_concat (GALGAS_string (" bytes)") COMMA_SOURCE_FILE_AT_LINE (716)) COMMA_SOURCE_FILE_AT_LINE (714)) ;
    }
  }
  cEnumerator_actualConfigurationMap enumerator_25255 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_25255.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_25255.current_mRegisterAddress (HERE).add_operation (enumerator_25255.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) ;
    }
    {
    routine_emitCode (enumerator_25255.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (721)) ;
    }
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_stringset var_usedRegisters = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (314)) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (316)) ;
  GALGAS_registerExpression var_PCLATH_5F_register = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("PCLATH"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (318)), GALGAS_luint::constructor_new (GALGAS_uint ((PMUInt32) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (318)) COMMA_SOURCE_FILE_AT_LINE (318)) ;
  GALGAS_midrange_5F_intermediate_5F_registerExpression var_PCLATH_5F_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_11402_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (322)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_11402_0, var_usedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
  if (object->mAttribute_mBit_31__31_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 5120U).operator_or (GALGAS_uint ((PMUInt32) 3U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (332)) COMMA_SOURCE_FILE_AT_LINE (332)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (332)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (332)) COMMA_SOURCE_FILE_AT_LINE (332)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (331)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 4096U).operator_or (GALGAS_uint ((PMUInt32) 3U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (339)) COMMA_SOURCE_FILE_AT_LINE (339)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (339)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (339)) COMMA_SOURCE_FILE_AT_LINE (339)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (338)) ;
      }
      } break ;
  ...
  if (object->mAttribute_mBit_31__32_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 5120U).operator_or (GALGAS_uint ((PMUInt32) 4U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (349)) COMMA_SOURCE_FILE_AT_LINE (349)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (349)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (349)) COMMA_SOURCE_FILE_AT_LINE (349)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (348)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 4096U).operator_or (GALGAS_uint ((PMUInt32) 4U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (356)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  {
  routine_emit_5F_midrange_5F_GOTOinstruction_5F_nocheck (object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioAddress, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (364)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_GOTO_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (378)) ;
  {
  routine_emit_5F_midrange_5F_GOTOinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_JSR_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_stringset var_usedRegisters = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (392)) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (395)) ;
  GALGAS_registerExpression var_PCLATH_5F_register = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("PCLATH"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (397)), GALGAS_luint::constructor_new (GALGAS_uint ((PMUInt32) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)) ;
  GALGAS_midrange_5F_intermediate_5F_registerExpression var_PCLATH_5F_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_13927_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (401)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_13927_0, var_usedRegisters, inCompiler COMMA_SOURCE_FILE_AT_LINE (399)) ;
  if (object->mAttribute_mBit_31__31_.isValid ()) {
    switch (object->mAttribute_mBit_31__31_.enumValue ()) {
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kNotBuilt:
      break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 5120U).operator_or (GALGAS_uint ((PMUInt32) 3U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (411)) COMMA_SOURCE_FILE_AT_LINE (411)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (411)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (411)) COMMA_SOURCE_FILE_AT_LINE (411)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (410)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 4096U).operator_or (GALGAS_uint ((PMUInt32) 3U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (418)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (417)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  if (object->mAttribute_mBit_31__32_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 5120U).operator_or (GALGAS_uint ((PMUInt32) 4U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (428)) COMMA_SOURCE_FILE_AT_LINE (428)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (428)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (428)) COMMA_SOURCE_FILE_AT_LINE (428)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (427)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 4096U).operator_or (GALGAS_uint ((PMUInt32) 4U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (435)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (434)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  {
  routine_emit_5F_midrange_5F_CALLinstruction_5F_nocheck (object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioAddress, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (442)) ;
  }
  if (object->mAttribute_mBit_31__31_.isValid ()) {
    switch (object->mAttribute_mBit_31__31_.enumValue ()) {
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kNotBuilt:
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 4096U).operator_or (GALGAS_uint ((PMUInt32) 3U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (446)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (445)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 5120U).operator_or (GALGAS_uint ((PMUInt32) 3U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (453)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (452)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  if (object->mAttribute_mBit_31__32_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 4096U).operator_or (GALGAS_uint ((PMUInt32) 4U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (463)) COMMA_SOURCE_FILE_AT_LINE (463)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (463)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (463)) COMMA_SOURCE_FILE_AT_LINE (463)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 5120U).operator_or (GALGAS_uint ((PMUInt32) 4U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (470)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (469)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
...
static void categoryMethod_midrange_5F_intermediate_5F_CALL_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (490)) ;
  {
  routine_emit_5F_midrange_5F_CALLinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (492)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_1 = object->mAttribute_m_5F_W_5F_isDestination.operator_not (SOURCE_FILE_AT_LINE (511)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_code = var_code.operator_or (GALGAS_uint ((PMUInt32) 128U) COMMA_SOURCE_FILE_AT_LINE (512)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE_AT_LINE (514)).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (514)) COMMA_SOURCE_FILE_AT_LINE (514)) ;
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE_AT_LINE (515)) COMMA_SOURCE_FILE_AT_LINE (515)) COMMA_SOURCE_FILE_AT_LINE (515)) ;
  {
  routine_emitMidrangeDirectCodeAtWordAddress (var_code, ioArgument_ioAddress, var_s, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
  }
  const enumGalgasBool test_2 = object->mAttribute_mBranchIfZero.boolEnum () ;
  if (kBoolTrue == test_2) {
    {
    routine_emit_5F_midrange_5F_GOTOinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, GALGAS_string ("$ + 2"), ioArgument_ioAddress.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (519)), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (519)) ;
    }
  }
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mTargetLabel, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (523)), var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (523)) ;
  {
  routine_emit_5F_midrange_5F_GOTOinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, object->mAttribute_mTargetLabel, var_targetAddress, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (524)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_CLRWDT_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((PMUInt32) 100U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (536)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_CLRW_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((PMUInt32) 256U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (548)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_NOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((PMUInt32) 0U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_RETURN_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((PMUInt32) 8U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (572)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_RETFIE_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((PMUInt32) 9U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_SLEEP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((PMUInt32) 99U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (596)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_code = categoryReader_baseCode (object->mAttribute_mLiteralInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (623)) ;
  var_code = var_code.operator_or (object->mAttribute_mLiteralValue COMMA_SOURCE_FILE_AT_LINE (624)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation temp_0 = object ;
  routine_emitMidrangeCodeAtWordAddress (var_code, ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (625)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  macroValidSharedObject (object, const cPtr_midrange_5F_intermediate_5F_pseudo_5F_LABEL) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (637)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("Internal second pass error: the '").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE_AT_LINE (639)) COMMA_SOURCE_FILE_AT_LINE (639)).operator_concat (GALGAS_string ("' label gets ") COMMA_SOURCE_FILE_AT_LINE (639)).operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE_AT_LINE (640)) COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (GALGAS_string (" value in second pass, while it gets ") COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (var_targetAddress.reader_hexString (SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (GALGAS_string (" in first pass") COMMA_SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (639)) ;
  }
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL temp_2 = object ;
  routine_emitNoMidrangeCodeAtWordAddress (ioArgument_ioAddress, temp_2, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (643)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (655)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mOccurrenceFactor.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("No generated code") COMMA_SOURCE_FILE_AT_LINE (656)) ;
  }
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (659)).isValid ()) {
    PMUInt32 variant_22664 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (659)).uintValue () ;
    bool loop_22664 = true ;
    while (loop_22664) {
      loop_22664 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (660)))).isValid () ;
      if (loop_22664) {
        loop_22664 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (660)))).boolValue () ;
      }
      if (loop_22664 && (0 == variant_22664)) {
        loop_22664 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (659)) ;
      }
      if (loop_22664) {
        variant_22664 -- ;
        {
        routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((PMUInt32) 0U), ioArgument_ioAddress, GALGAS_string ("NOP"), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (662)) ;
        }
