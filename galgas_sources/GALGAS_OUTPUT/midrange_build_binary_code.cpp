...
const C_galgas_type_descriptor kTypeDescriptor_GGS_midrange_symbolTable ("midrange_symbolTable", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_midrange_symbolTable::typeDescriptor (void) const {
