...
void routine_build_5F_midrange_5F_ipic_5F_binary_5F_code (const GALGAS_registerTable constinArgument_inRegisterTable,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23616 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23616.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23616.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (682)) ;
    //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_24240 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24240.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_24240.current_mInstruction (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inTotalBankCount, var_symbolTable, ioArgument_ioListFileContents, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (694)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_25108 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25108.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_setEmitAddress (enumerator_25108.current_mRegisterAddress (HERE).add_operation (enumerator_25108.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (715)), inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
    routine_emitCode (enumerator_25108.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (716)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_25108.gotoNextObject () ;
  }
}
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bitSliceTable joker_11355_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (321)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_11355_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
  //-------- END @methodCallInstructionForGeneration
  //------- @switchInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_JSR_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_midrange_5F_intermediate_5F_registerExpression var_PCLATH_5F_IPICregisterDescription ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bitSliceTable joker_13820_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (398)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_13820_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (396)) ;
  //-------- END @methodCallInstructionForGeneration
  //------- @switchInstructionForGeneration
  if (object->mAttribute_mBit_31__31_.isValid ()) {
    switch (object->mAttribute_mBit_31__31_.enumValue ()) {
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (655)).isValid ()) {
    PMUInt32 variant_22538 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (655)).uintValue () ;
    bool loop_22538 = true ;
    while (loop_22538) {
      loop_22538 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (656)))).isValid () ;
      if (loop_22538) {
        loop_22538 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (656)))).boolValue () ;
      }
      if (loop_22538 && (0 == variant_22538)) {
        loop_22538 = false ;
