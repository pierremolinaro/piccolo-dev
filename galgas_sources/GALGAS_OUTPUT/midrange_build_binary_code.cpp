...
void routine_build_5F_midrange_5F_ipic_5F_binary_5F_code (const GALGAS_registerTable constinArgument_inRegisterTable,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_24365 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_24365.hasCurrentObject ()) {
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_24365.current_mInstruction (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inTotalBankCount, var_symbolTable, ioArgument_ioListFileContents, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (698)) ;
    {
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentAddress.reader_hexString (SOURCE_FILE_AT_LINE (709)) COMMA_SOURCE_FILE_AT_LINE (709)).operator_concat (GALGAS_string (" value in second pass, while it gets ") COMMA_SOURCE_FILE_AT_LINE (709)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE_AT_LINE (711)) COMMA_SOURCE_FILE_AT_LINE (710)).operator_concat (GALGAS_string (" value in first pass") COMMA_SOURCE_FILE_AT_LINE (711)) COMMA_SOURCE_FILE_AT_LINE (709)) ;
    ...
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Program too large: ").operator_concat (var_lastAddressForFirstPass.reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)).operator_concat (GALGAS_string (" bytes (rom size is ") COMMA_SOURCE_FILE_AT_LINE (713)).operator_concat (constinArgument_inROMsize.reader_string (SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (714)).operator_concat (GALGAS_string (" bytes)") COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
    }
  }
  cEnumerator_actualConfigurationMap enumerator_25233 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_25233.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_25233.current_mRegisterAddress (HERE).add_operation (enumerator_25233.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (719)), inCompiler COMMA_SOURCE_FILE_AT_LINE (719)) ;
    }
    {
    routine_emitCode (enumerator_25233.current_mRegisterValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) ;
    }
