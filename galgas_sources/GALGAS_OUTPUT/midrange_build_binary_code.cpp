...
category_method__midrange_ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_6936 != NULL) {
    ...
    if (temp_7416.isBuilt ()) {
      ...
      if (method != NULL) {
        method (inLexique, temp_7416 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_7544_0 COMMA_SOURCE_FILE_AT_LINE (212)) ;
      }
    }
...
category_method__midrange_ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8843 != NULL) {
    ...
    if (temp_9323.isBuilt ()) {
      ...
      if (method != NULL) {
        method (inLexique, temp_9323 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_9451_0 COMMA_SOURCE_FILE_AT_LINE (263)) ;
      }
    }
...
C_PrologueEpilogue prologueEpilogueObjectFor_midrange_build_binary_code (prologueRoutineFor_midrange_build_binary_code,
                                   NULL) ;
