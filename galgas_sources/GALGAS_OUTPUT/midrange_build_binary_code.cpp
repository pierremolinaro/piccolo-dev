...
//                    september 11th, 2008, at 19h39'54"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__midrange_ipic_pseudo_ORG__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_3090 != NULL) {
    ...
    if (operand_3090->mOrigin._add_operation (_inLexique, operand_3090->mOrigin COMMA_SOURCE_FILE_AT_LINE (92))._isBuilt ()) {
...
category_method__midrange_ipic_instruction_FD__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_3474 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_3474->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (108)))._operator_and (GGS_uint (true, 127U))) ;
...
category_method__midrange_ipic_instruction_F__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_4013 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_4013->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (122)))._operator_and (GGS_uint (true, 127U))) ;
    if (var_cas_code._isBuilt ()) {
...
category_method__midrange_ipic_instruction_FB__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_4484 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_4484->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (136)))._operator_and (GGS_uint (true, 127U))) ;
    var_cas_code = (var_cas_code)._operator_or (operand_4484->mBitNumber._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (137))) ;
    if (var_cas_code._isBuilt ()) {
...
category_method__midrange_ipic_instruction_BitTestSkip__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_5001 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_5001->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (151)))._operator_and (GGS_uint (true, 127U))) ;
    var_cas_code = (var_cas_code)._operator_or (operand_5001->mBitNumber._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (152))) ;
    if (var_cas_code._isBuilt ()) {
...
void routine_emit_midrange_GOTOinstruction_nocheck (C_Compiler & _inLexique,
  ...
  if ((GGS_uint (true, 10240U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (true, 2047U)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 10240U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (true, 2047U))) COMMA_SOURCE_FILE_AT_LINE (161)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emit_midrange_GOTOinstruction (C_Compiler & _inLexique,
  ...
  if (((((var_cas_inOriginAddress)._operator_xor (var_cas_inTargetAddress))._operator_and (GGS_uint (true, 63488U)))._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_inIntructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "GOTO (from "))._operator_concat (var_cas_inOriginAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (172))))._operator_concat (GGS_string (true, " to ")))._operator_concat (var_cas_inTargetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (172))))._operator_concat (GGS_string (true, ") crosses page boundary")) COMMA_SOURCE_FILE_AT_LINE (173)) ;
  }
...
void routine_emit_midrange_CALLinstruction_nocheck (C_Compiler & _inLexique,
  ...
  if ((GGS_uint (true, 8192U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (true, 2047U)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 8192U))._operator_or ((var_cas_inTargetAddress)._operator_and (GGS_uint (true, 2047U))) COMMA_SOURCE_FILE_AT_LINE (182)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_emit_midrange_CALLinstruction (C_Compiler & _inLexique,
  ...
  #endif
  if (((((var_cas_inOriginAddress)._operator_xor (var_cas_inTargetAddress))._operator_and (GGS_uint (true, 63488U)))._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_inIntructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "CALL (from "))._operator_concat (var_cas_inOriginAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))))._operator_concat (GGS_string (true, " to ")))._operator_concat (var_cas_inTargetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))))._operator_concat (GGS_string (true, ") crosses page boundary")) COMMA_SOURCE_FILE_AT_LINE (194)) ;
  }
...
category_method__midrange_ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_6936 != NULL) {
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (221))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (221)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (221))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (221)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (221)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (222))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (222)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (222))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (222)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (222)) ;
      }
      }
      break ;
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (226))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (226))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (226)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (227))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (227))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (227)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
...
category_method__midrange_ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_8843 != NULL) {
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (272))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (272)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (272))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (272)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (272)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (277))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (277)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (277))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (277)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (277)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (283))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (283))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (283)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (284))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (284)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 3U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (284))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (284)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (284)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
    ...
    case GGS_midrange_call_goto_bit::enum_set:
      {
      if (((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (288))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (288)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 4096U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (288))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (288)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (288)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_clear:
      {
      if (((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (289))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (289)))._operator_and (GGS_uint (true, 127U)))._isBuilt ()) {
        ::routine_emitCode (_inLexique,  ((GGS_uint (true, 5120U))._operator_or (GGS_uint (true, 4U)._left_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (289))))._operator_or ((var_cas_PCLATH_IPICregisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (289)))._operator_and (GGS_uint (true, 127U))) COMMA_SOURCE_FILE_AT_LINE (289)) ;
      }
      }
      break ;
    case GGS_midrange_call_goto_bit::enum_noChange:
...
category_method__midrange_ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_11331 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or ((operand_11331->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (326)))._operator_and (GGS_uint (true, 127U))) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (327)) ;
    }
    if ((operand_11331->mBranchIfZero).isBuiltAndTrue ()) {
      ::routine_emit_midrange_GOTOinstruction (_inLexique,  operand_11331->mInstructionLocation,  var_cas_ioAddress,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_midrange_symbolTable  _temp_11960 = var_cas_inRoutineSymbolTable ;
    if (_temp_11960._isBuilt ()) {
...
category_method__midrange_ipic_instruction_CLRWDT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_12268 != NULL) {
    if (GGS_uint (true, 100U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 100U) COMMA_SOURCE_FILE_AT_LINE (346)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_CLRW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_12618 != NULL) {
    if (GGS_uint (true, 256U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 256U) COMMA_SOURCE_FILE_AT_LINE (357)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_NOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_12967 != NULL) {
    if (GGS_uint (true, 0U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (368)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_RETURN__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_13319 != NULL) {
    if (GGS_uint (true, 8U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (379)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_RETFIE__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_13671 != NULL) {
    if (GGS_uint (true, 9U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_SLEEP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_14022 != NULL) {
    if (GGS_uint (true, 99U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 99U) COMMA_SOURCE_FILE_AT_LINE (401)) ;
    }
  }
}
...
category_method__midrange_ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_14819 != NULL) {
    ...
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_14819->mLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "Internal second pass error: the '"))._operator_concat (operand_14819->mLabel))._operator_concat (GGS_string (true, "' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (430))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (431))))._operator_concat (GGS_string (true, " in first pass")) COMMA_SOURCE_FILE_AT_LINE (432)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_15472 != NULL) {
    if (((operand_15472->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (443)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_15472->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (444)) ;
    }
    ...
    GGS_bool _condition_15874 (_variant_15874._isBuilt (), true) ;
    while (_condition_15874.isBuiltAndTrue ()) {
      ...
      if (_condition_15874.isBuiltAndTrue ()) {
        if (_variant_15874.uintValue () == 0) {
          ...
          _condition_15874 = GGS_bool (true, false) ;
        }else{
          _variant_15874._decrement_operation (_inLexique COMMA_HERE) ;
          if (GGS_uint (true, 0U)._isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (450)) ;
          }
...
void routine_build_midrange_ipic_binary_code (C_Compiler & _inLexique,
  ...
  {
    GGS_midrange_ipic_instructionList::cEnumerator enumerator_16708 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_midrange_ipic_instructionList::cElement * operand_16708 = NULL ;
    while (((operand_16708 = enumerator_16708.nextObject ()))) {
      macroValidPointer (operand_16708) ;
      const GGS_midrange_ipic_instruction  _temp_16749 = operand_16708->mInstruction ;
      if (_temp_16749._isBuilt ()) {
        typeCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress _method = findCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress (_temp_16749._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_16749 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (472)) ;
        }
      }
    }
  }
  ...
  var_cas_currentAddress = GGS_uint (true, 0U) ;
  if (GGS_uint (true, 0U)._isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (477)) ;
  }
  {
    GGS_midrange_ipic_instructionList::cEnumerator enumerator_16995 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_midrange_ipic_instructionList::cElement * operand_16995 = NULL ;
    while (((operand_16995 = enumerator_16995.nextObject ()))) {
      macroValidPointer (operand_16995) ;
      const GGS_midrange_ipic_instruction  _temp_17044 = operand_16995->mInstruction ;
      if (_temp_17044._isBuilt ()) {
        typeCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress (_temp_17044._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_17044 (HERE), var_cas_inRegisterTable, var_cas_inTotalBankCount, var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (479)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_midrange_ipic_instruction  _temp_17207 = operand_16995->mInstruction ;
      if (_temp_17207._isBuilt ()) {
        _temp_17207 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (486)) ;
      }
      var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (487)) ;
      ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentAddress._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (488)) COMMA_SOURCE_FILE_AT_LINE (488)) ;
    }
  }
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (491))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (493))))._operator_concat (GGS_string (true, " value in first pass")) COMMA_SOURCE_FILE_AT_LINE (494)) ;
  }else if (((var_cas_lastAddressForFirstPass)._operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Program too large: "))._operator_concat (var_cas_lastAddressForFirstPass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (495))))._operator_concat (GGS_string (true, " bytes (rom size is ")))._operator_concat (var_cas_inROMsize.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (497))))._operator_concat (GGS_string (true, " bytes)")) COMMA_SOURCE_FILE_AT_LINE (498)) ;
  }
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_17908 (var_cas_inActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_17908 = NULL ;
    while (((operand_17908 = enumerator_17908.nextObject ()))) {
      macroValidPointer (operand_17908) ;
      if (operand_17908->mInfo.mRegisterAddress._add_operation (_inLexique, operand_17908->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (501))._isBuilt ()) {
        ::routine_setEmitAddress (_inLexique,  operand_17908->mInfo.mRegisterAddress._add_operation (_inLexique, operand_17908->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (501)) COMMA_SOURCE_FILE_AT_LINE (501)) ;
      }
      if (operand_17908->mInfo.mRegisterValue._isBuilt ()) {
        ::routine_emitCode (_inLexique,  operand_17908->mInfo.mRegisterValue COMMA_SOURCE_FILE_AT_LINE (502)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
