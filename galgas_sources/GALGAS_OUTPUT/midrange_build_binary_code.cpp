...
void routine_emitMidrangeCodeAtWordAddress (const GALGAS_uint constinArgument_inCode,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("   ").operator_concat (categoryReader_x_34_String (ioArgument_ioWordAddress.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 14)), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 14))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 14))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 14)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" ").operator_concat (categoryReader_x_34_String (constinArgument_inCode, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 15))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 15)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 15))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 15)) ;
  callCategoryMethod_print ((const cPtr_midrange_5F_intermediate_5F_instruction *) constinArgument_inInstruction.ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 16)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 17)) ;
  {
  routine_emitCode (constinArgument_inCode, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 18)) ;
  }
  ioArgument_ioWordAddress = ioArgument_ioWordAddress.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 19)) ;
}
...
void routine_emitMidrangeDirectCodeAtWordAddress (const GALGAS_uint constinArgument_inCode,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("   ").operator_concat (categoryReader_x_34_String (ioArgument_ioWordAddress.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 30)), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 30))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 30))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 30)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" ").operator_concat (categoryReader_x_34_String (constinArgument_inCode, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 31))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 31))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 31)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string (" ").operator_concat (constinArgument_inInstructionDescriptionString  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 32)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 32))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 32)) ;
  {
  routine_emitCode (constinArgument_inCode, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 33)) ;
  }
  ioArgument_ioWordAddress = ioArgument_ioWordAddress.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 34)) ;
}
...
void routine_emitNoMidrangeCodeAtWordAddress (const GALGAS_uint constinArgument_inWordAddress,
                                              ...
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("   ").operator_concat (categoryReader_x_34_String (constinArgument_inWordAddress.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 44)), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 44))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 44))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 44)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("      ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 45)) ;
  callCategoryMethod_print ((const cPtr_midrange_5F_intermediate_5F_instruction *) constinArgument_inInstruction.ptr (), ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 46)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 47)) ;
}
...
void routine_emit_5F_midrange_5F_GOTOinstruction_5F_nocheck (const GALGAS_string constinArgument_inTargetLabel,
                                                             ...
                                                             C_Compiler * inCompiler
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint var_code = GALGAS_uint ((uint32_t) 10240U).operator_or (constinArgument_inTargetAddress.operator_and (GALGAS_uint ((uint32_t) 2047U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 258)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 258)) ;
  {
  routine_emitMidrangeDirectCodeAtWordAddress (var_code, ioArgument_ioAddress, GALGAS_string ("GOTO ").operator_concat (constinArgument_inTargetLabel  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 259)), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 259)) ;
  }
}
...
void routine_emit_5F_midrange_5F_GOTOinstruction (const GALGAS_location constinArgument_inIntructionLocation,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, ioArgument_ioAddress.operator_xor (constinArgument_inTargetAddress COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 271)).operator_and (GALGAS_uint ((uint32_t) 63488U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 271)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (constinArgument_inIntructionLocation, GALGAS_string ("GOTO (from ").operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 272))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 272)).operator_concat (GALGAS_string (" to ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 272)).operator_concat (constinArgument_inTargetAddress.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 272))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 272)).operator_concat (GALGAS_string (") crosses page boundary")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 272))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 272)) ;
  }
  {
  routine_emit_5F_midrange_5F_GOTOinstruction_5F_nocheck (constinArgument_inTargetLabel, constinArgument_inTargetAddress, ioArgument_ioAddress, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 274)) ;
  }
}
...
void routine_emit_5F_midrange_5F_CALLinstruction_5F_nocheck (const GALGAS_string constinArgument_inTargetLabel,
                                                             ...
                                                             C_Compiler * inCompiler
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint var_code = GALGAS_uint ((uint32_t) 8192U).operator_or (constinArgument_inTargetAddress.operator_and (GALGAS_uint ((uint32_t) 2047U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 285)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 285)) ;
  {
  routine_emitMidrangeDirectCodeAtWordAddress (var_code, ioArgument_ioAddress, GALGAS_string ("CALL ").operator_concat (constinArgument_inTargetLabel  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 286)), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 286)) ;
  }
}
...
void routine_emit_5F_midrange_5F_CALLinstruction (const GALGAS_location constinArgument_inIntructionLocation,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, ioArgument_ioAddress.operator_xor (constinArgument_inTargetAddress COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 298)).operator_and (GALGAS_uint ((uint32_t) 63488U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 298)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (constinArgument_inIntructionLocation, GALGAS_string ("CALL (from ").operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 299))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 299)).operator_concat (GALGAS_string (" to ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 299)).operator_concat (constinArgument_inTargetAddress.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 299))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 299)).operator_concat (GALGAS_string (") crosses page boundary")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 299))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 299)) ;
  }
  {
  routine_emit_5F_midrange_5F_CALLinstruction_5F_nocheck (constinArgument_inTargetLabel, constinArgument_inTargetAddress, ioArgument_ioAddress, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 301)) ;
  }
}
...
void routine_build_5F_midrange_5F_ipic_5F_binary_5F_code (const GALGAS_registerTable constinArgument_inRegisterTable,
  ...
  GALGAS_midrange_5F_symbolTable var_symbolTable = GALGAS_midrange_5F_symbolTable::constructor_emptyMap (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 683)) ;
  GALGAS_uint var_currentAddress = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23723 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_23723.hasCurrentObject ()) {
    callCategoryMethod_enterLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23723.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 686)) ;
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 691)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 691))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 691)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("GENERATED CODE").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 692))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 692)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 692))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 692)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 693)).operator_concat (GALGAS_string ("\n"
    "\n")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 693))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 693)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Address Code Mnemonic\n")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 694)) ;
  {
  routine_initCodeGenerator (inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 695)) ;
  }
  var_currentAddress = GALGAS_uint ((uint32_t) 0U) ;
  {
  routine_setEmitAddress (GALGAS_uint ((uint32_t) 0U), inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 697)) ;
  }
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_24369 (constinArgument_inGeneratedInstructionList, kEnumeration_up) ;
  while (enumerator_24369.hasCurrentObject ()) {
    callCategoryMethod_generateBinaryCodeAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_24369.current_mInstruction (HERE).ptr (), constinArgument_inRegisterTable, constinArgument_inTotalBankCount, var_symbolTable, ioArgument_ioListFileContents, var_currentAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 699)) ;
    {
    routine_checkCurrentEmitAddress (var_currentAddress.multiply_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 707)), inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 707)) ;
    }
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentAddress.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 710))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 710)).operator_concat (GALGAS_string (" value in second pass, while it gets ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 710)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 712))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 711)).operator_concat (GALGAS_string (" value in first pass")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 712))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 710)) ;
    ...
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Program too large: ").operator_concat (var_lastAddressForFirstPass.reader_string (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 714))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 714)).operator_concat (GALGAS_string (" bytes (rom size is ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 714)).operator_concat (constinArgument_inROMsize.reader_string (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 716))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 715)).operator_concat (GALGAS_string (" bytes)")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 716))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 714)) ;
    }
  }
  cEnumerator_actualConfigurationMap enumerator_25237 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_25237.hasCurrentObject ()) {
    {
    routine_setEmitAddress (enumerator_25237.current_mRegisterAddress (HERE).add_operation (enumerator_25237.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 720)), inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 720)) ;
    }
    {
    routine_emitCode (enumerator_25237.current_mRegisterValue (HERE), inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 721)) ;
    }
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_enterLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  {
  ioArgument_ioRoutineSymbolTable.modifier_insertKey (object->mAttribute_mLabel, ioArgument_ioAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 76)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_actualInstruction_enterLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioAddress = ioArgument_ioAddress.add_operation (callCategoryReader_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 96)), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 96)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  ioArgument_ioAddress = object->mAttribute_mOrigin ;
  {
  routine_setEmitAddress (object->mAttribute_mOrigin.add_operation (object->mAttribute_mOrigin, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 135)), inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 135)) ;
  }
  {
  const GALGAS_midrange_5F_intermediate_5F_pseudo_5F_ORG temp_0 = object ;
  routine_emitNoMidrangeCodeAtWordAddress (ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 136)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_code = categoryReader_basecode (object->mAttribute_mInstruction_5F_FD_5F_base_5F_code, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 170)) ;
  const enumGalgasBool test_0 = object->mAttribute_m_5F_W_5F_isDestination.operator_not (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 171)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_code = var_code.operator_or (GALGAS_uint ((uint32_t) 128U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 172)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 174)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 174)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 174)) ;
  {
  const GALGAS_midrange_5F_intermediate_5F_instruction_5F_FD temp_1 = object ;
  routine_emitMidrangeCodeAtWordAddress (var_code, ioArgument_ioAddress, temp_1, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 175)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_code = categoryReader_baseCode (object->mAttribute_mFinstruction, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 198)) ;
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 199)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 199)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 199)) ;
  {
  const GALGAS_midrange_5F_intermediate_5F_instruction_5F_F temp_0 = object ;
  routine_emitMidrangeCodeAtWordAddress (var_code, ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 200)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_code = categoryReader_baseCode (object->mAttribute_mBitOrientedOp, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 223)) ;
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 224)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 224)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 224)) ;
  var_code = var_code.operator_or (object->mAttribute_mBitNumber.left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 225)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 225)) ;
  {
  const GALGAS_midrange_5F_intermediate_5F_instruction_5F_FB temp_0 = object ;
  routine_emitMidrangeCodeAtWordAddress (var_code, ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 226)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 245)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 245)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 245)) ;
  var_code = var_code.operator_or (object->mAttribute_mBitNumber.left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 246)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 246)) ;
  {
  const GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip temp_1 = object ;
  routine_emitMidrangeCodeAtWordAddress (var_code, ioArgument_ioAddress, temp_1, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 247)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_stringset var_usedRegisters = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 314)) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 316)) ;
  GALGAS_registerExpression var_PCLATH_5F_register = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("PCLATH"), inCompiler->here ()  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 318)), GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here ()  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 318)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 318)) ;
  GALGAS_midrange_5F_intermediate_5F_registerExpression var_PCLATH_5F_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_11384_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 322)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_11384_0, var_usedRegisters, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 320)) ;
  if (object->mAttribute_mBit_31__31_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 5120U).operator_or (GALGAS_uint ((uint32_t) 3U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 332)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 332)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 332)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 332)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 332)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 331)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 4096U).operator_or (GALGAS_uint ((uint32_t) 3U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 339)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 339)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 339)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 339)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 339)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 338)) ;
      }
      } break ;
  ...
  if (object->mAttribute_mBit_31__32_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 5120U).operator_or (GALGAS_uint ((uint32_t) 4U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 349)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 349)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 349)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 349)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 349)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 348)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 4096U).operator_or (GALGAS_uint ((uint32_t) 4U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 356)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 356)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 356)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 356)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 356)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 355)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  {
  routine_emit_5F_midrange_5F_GOTOinstruction_5F_nocheck (object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioAddress, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 364)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_GOTO_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 378)) ;
  {
  routine_emit_5F_midrange_5F_GOTOinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 380)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_JSR_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_stringset var_usedRegisters = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 392)) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 395)) ;
  GALGAS_registerExpression var_PCLATH_5F_register = GALGAS_registerExpression::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("PCLATH"), inCompiler->here ()  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 397)), GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here ()  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 397)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 397)) ;
  GALGAS_midrange_5F_intermediate_5F_registerExpression var_PCLATH_5F_IPICregisterDescription ;
  GALGAS_bitSliceTable joker_13909_0 ; // Joker input parameter
  callCategoryMethod_resolveMidrangeAccess ((const cPtr_registerExpression *) var_PCLATH_5F_register.ptr (), constinArgument_inTotalBankCount, GALGAS_uint::constructor_max (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 401)), constinArgument_inRegisterTable, var_PCLATH_5F_IPICregisterDescription, joker_13909_0, var_usedRegisters, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 399)) ;
  if (object->mAttribute_mBit_31__31_.isValid ()) {
    switch (object->mAttribute_mBit_31__31_.enumValue ()) {
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kNotBuilt:
      break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 5120U).operator_or (GALGAS_uint ((uint32_t) 3U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 411)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 411)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 411)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 411)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 411)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 410)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 4096U).operator_or (GALGAS_uint ((uint32_t) 3U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 418)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 418)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 418)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 418)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 418)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 417)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  if (object->mAttribute_mBit_31__32_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 5120U).operator_or (GALGAS_uint ((uint32_t) 4U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 428)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 428)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 428)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 428)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 428)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 427)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 4096U).operator_or (GALGAS_uint ((uint32_t) 4U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 435)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 435)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 435)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 435)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 435)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 434)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  {
  routine_emit_5F_midrange_5F_CALLinstruction_5F_nocheck (object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioAddress, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 442)) ;
  }
  if (object->mAttribute_mBit_31__31_.isValid ()) {
    switch (object->mAttribute_mBit_31__31_.enumValue ()) {
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kNotBuilt:
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 4096U).operator_or (GALGAS_uint ((uint32_t) 3U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 446)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 446)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 446)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 446)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 446)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 445)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 5120U).operator_or (GALGAS_uint ((uint32_t) 3U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 453)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 453)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 453)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 453)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 453)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 3"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 452)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
  ...
  if (object->mAttribute_mBit_31__32_.isValid ()) {
    ...
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_set: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 4096U).operator_or (GALGAS_uint ((uint32_t) 4U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 463)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 463)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 463)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 463)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 463)), ioArgument_ioAddress, GALGAS_string ("BCF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 462)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_clear: {
      {
      routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 5120U).operator_or (GALGAS_uint ((uint32_t) 4U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 470)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 470)).operator_or (var_PCLATH_5F_IPICregisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 470)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 470)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 470)), ioArgument_ioAddress, GALGAS_string ("BSF PCLATH, 4"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 469)) ;
      }
      } break ;
    case GALGAS_midrange_5F_call_5F_goto_5F_bit::kEnum_noChange: {
      } break ;
...
static void categoryMethod_midrange_5F_intermediate_5F_CALL_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 490)) ;
  {
  routine_emit_5F_midrange_5F_CALLinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, object->mAttribute_mTargetLabel.mAttribute_string, var_targetAddress, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 492)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_1 = object->mAttribute_m_5F_W_5F_isDestination.operator_not (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 511)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_code = var_code.operator_or (GALGAS_uint ((uint32_t) 128U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 512)) ;
  }
  var_code = var_code.operator_or (object->mAttribute_mRegisterDescription.reader_mRegisterAddress (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 514)).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 514)) COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 514)) ;
  var_s.dotAssign_operation (GALGAS_string (" ").operator_concat (object->mAttribute_mRegisterDescription.reader_mAssemblyString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 515))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 515))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 515)) ;
  {
  routine_emitMidrangeDirectCodeAtWordAddress (var_code, ioArgument_ioAddress, var_s, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 516)) ;
  }
  const enumGalgasBool test_2 = object->mAttribute_mBranchIfZero.boolEnum () ;
  if (kBoolTrue == test_2) {
    {
    routine_emit_5F_midrange_5F_GOTOinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, GALGAS_string ("$ + 2"), ioArgument_ioAddress.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 519)), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 519)) ;
    }
  }
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mTargetLabel, inCompiler->here ()  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 523)), var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 523)) ;
  {
  routine_emit_5F_midrange_5F_GOTOinstruction (object->mAttribute_mInstructionLocation, ioArgument_ioAddress, object->mAttribute_mTargetLabel, var_targetAddress, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 524)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_CLRWDT_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((uint32_t) 100U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 536)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_CLRW_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((uint32_t) 256U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 548)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_NOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((uint32_t) 0U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 560)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_RETURN_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((uint32_t) 8U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 572)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_RETFIE_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((uint32_t) 9U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 584)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_SLEEP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  routine_emitMidrangeCodeAtWordAddress (GALGAS_uint ((uint32_t) 99U), ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 596)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_code = categoryReader_baseCode (object->mAttribute_mLiteralInstruction, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 623)) ;
  var_code = var_code.operator_or (object->mAttribute_mLiteralValue COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 624)) ;
  {
  const GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation temp_0 = object ;
  routine_emitMidrangeCodeAtWordAddress (var_code, ioArgument_ioAddress, temp_0, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 625)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  macroValidSharedObject (object, cPtr_midrange_5F_intermediate_5F_pseudo_5F_LABEL) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 637)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("Internal second pass error: the '").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 639))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 639)).operator_concat (GALGAS_string ("' label gets ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 639)).operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 640))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 640)).operator_concat (GALGAS_string (" value in second pass, while it gets ")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 640)).operator_concat (var_targetAddress.reader_hexString (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 641))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 640)).operator_concat (GALGAS_string (" in first pass")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 641))  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 639)) ;
  }
  {
  const GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL temp_2 = object ;
  routine_emitNoMidrangeCodeAtWordAddress (ioArgument_ioAddress, temp_2, ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 643)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_generateBinaryCodeAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 655)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mOccurrenceFactor.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("No generated code")  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 656)) ;
  }
  GALGAS_uint var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 659)).isValid ()) {
    uint32_t variant_22646 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 659)).uintValue () ;
    bool loop_22646 = true ;
    while (loop_22646) {
      loop_22646 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 660)))).isValid () ;
      if (loop_22646) {
        loop_22646 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 660)))).boolValue () ;
      }
      if (loop_22646 && (0 == variant_22646)) {
        loop_22646 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("midrange_build_binary_code.gSemantics", 659)) ;
      }
      if (loop_22646) {
        variant_22646 -- ;
        {
        routine_emitMidrangeDirectCodeAtWordAddress (GALGAS_uint ((uint32_t) 0U), ioArgument_ioAddress, GALGAS_string ("NOP"), ioArgument_ioListFileContents, inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 662)) ;
        }
        var_idx.increment_operation (inCompiler  COMMA_SOURCE_FILE ("midrange_build_binary_code.gSemantics", 663)) ;
      }
    }
  }
}
