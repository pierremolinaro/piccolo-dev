...
category_method__midrange_ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_5867 != NULL) {
    ...
    GGS_uint  var_cas_targetAddress ;
    const GGS_midrange_symbolTable  _temp_6317 = var_cas_inRoutineSymbolTable ;
    if (_temp_6317._isBuilt ()) {
      _temp_6317 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_5867->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (190)) ;
    }
    ::routine_emit_midrange_GOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (191)) ;
  }
}
...
category_method__midrange_ipic_instruction_CLRWDT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_CLRWDT * operand_6592,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6592 != NULL) {
    if (GGS_uint (true, 100U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 100U) COMMA_SOURCE_FILE_AT_LINE (200)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_CLRW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_CLRW * operand_6866,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6866 != NULL) {
    if (GGS_uint (true, 256U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 256U) COMMA_SOURCE_FILE_AT_LINE (209)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_NOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_NOP * operand_7139,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7139 != NULL) {
    if (GGS_uint (true, 0U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (218)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_RETURN__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_RETURN * operand_7415,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7415 != NULL) {
    if (GGS_uint (true, 8U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (227)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_RETFIE__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_RETFIE * operand_7691,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7691 != NULL) {
    if (GGS_uint (true, 9U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (236)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_SLEEP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_SLEEP * operand_7966,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7966 != NULL) {
    if (GGS_uint (true, 99U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 99U) COMMA_SOURCE_FILE_AT_LINE (245)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_literalOperation__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_literalOperation * operand_8252,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8252 != NULL) {
    GGS_uint  var_cas_code ;
    operand_8252->method_getBaseCode (_inLexique, var_cas_code COMMA_SOURCE_FILE_AT_LINE (255)) ;
    var_cas_code = (var_cas_code)._operator_or (operand_8252->mLiteralValue) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (257)) ;
    }
  }
}
...
category_method__midrange_ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_pseudo_LABEL * operand_8611,
                                const GGS_midrange_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8611 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_midrange_symbolTable  _temp_8738 = var_cas_inRoutineSymbolTable ;
    if (_temp_8738._isBuilt ()) {
      _temp_8738 (HERE)->method_searchKey (_inLexique, operand_8611->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (267)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_8611->mLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "Internal second pass error: the '"))._operator_concat (operand_8611->mLabel))._operator_concat (GGS_string (true, "' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (270))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (271))))._operator_concat (GGS_string (true, " in first pass")) COMMA_SOURCE_FILE_AT_LINE (272)) ;
    }
  }
}
...
category_method__midrange_ipic_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_MNOP * operand_9188,
                                const GGS_midrange_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9188 != NULL) {
    if (((operand_9188->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (281)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_9188->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (282)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_9514 = operand_9188->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (285)) ;
    GGS_bool _condition_9514 (_variant_9514._isBuilt (), true) ;
    while (_condition_9514.isBuiltAndTrue ()) {
      _condition_9514 = (var_cas_idx)._operator_strictInf (operand_9188->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
      if (_condition_9514.isBuiltAndTrue ()) {
        if (_variant_9514.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (290)) ;
          _condition_9514 = GGS_bool (true, false) ;
        }else{
          _variant_9514._decrement_operation (_inLexique COMMA_HERE) ;
          if (GGS_uint (true, 0U)._isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (288)) ;
          }
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (289)) ;
        }
      }
    }
  }
...
void routine_build_midrange_ipic_binary_code (C_Compiler & _inLexique,
  ...
  {
    GGS_midrange_ipic_instructionList::cEnumerator enumerator_12667 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_midrange_ipic_instructionList::cElement * operand_12667 = NULL ;
    while (((operand_12667 = enumerator_12667.nextObject ()))) {
      macroValidPointer (operand_12667) ;
      const GGS_midrange_ipic_instruction  _temp_12708 = operand_12667->mInstruction ;
      if (_temp_12708._isBuilt ()) {
        typeCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress _method = findCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress (_temp_12708._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_12708 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (378)) ;
        }
      }
    }
  }
  ...
  var_cas_currentAddress = GGS_uint (true, 0U) ;
  if (GGS_uint (true, 0U)._isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (383)) ;
  }
  {
    GGS_midrange_ipic_instructionList::cEnumerator enumerator_12954 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_midrange_ipic_instructionList::cElement * operand_12954 = NULL ;
    while (((operand_12954 = enumerator_12954.nextObject ()))) {
      macroValidPointer (operand_12954) ;
      const GGS_midrange_ipic_instruction  _temp_13003 = operand_12954->mInstruction ;
      if (_temp_13003._isBuilt ()) {
        typeCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress (_temp_13003._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_13003 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (385)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_midrange_ipic_instruction  _temp_13102 = operand_12954->mInstruction ;
      if (_temp_13102._isBuilt ()) {
        _temp_13102 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (387)) ;
      }
      var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (388)) ;
      ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentAddress._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (389)) COMMA_SOURCE_FILE_AT_LINE (389)) ;
    }
  }
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (392))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (394))))._operator_concat (GGS_string (true, " value in first pass")) COMMA_SOURCE_FILE_AT_LINE (395)) ;
  }else if (((var_cas_lastAddressForFirstPass)._operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Program too large: "))._operator_concat (var_cas_lastAddressForFirstPass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (396))))._operator_concat (GGS_string (true, " bytes (rom size is ")))._operator_concat (var_cas_inROMsize.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (398))))._operator_concat (GGS_string (true, " bytes)")) COMMA_SOURCE_FILE_AT_LINE (399)) ;
  }
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_13803 (var_cas_inActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_13803 = NULL ;
    while (((operand_13803 = enumerator_13803.nextObject ()))) {
      macroValidPointer (operand_13803) ;
      if (operand_13803->mInfo.mRegisterAddress._add_operation (_inLexique, operand_13803->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (402))._isBuilt ()) {
        ::routine_setEmitAddress (_inLexique,  operand_13803->mInfo.mRegisterAddress._add_operation (_inLexique, operand_13803->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (402)) COMMA_SOURCE_FILE_AT_LINE (402)) ;
      }
      if (operand_13803->mInfo.mRegisterValue._isBuilt ()) {
        ::routine_emitCode (_inLexique,  operand_13803->mInfo.mRegisterValue COMMA_SOURCE_FILE_AT_LINE (403)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
