...
enterCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress (typeCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress inRoutine,
  ...
  gDispatchTableForMethod__midrange_ipic_instruction__enterLabelAtAddress.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_instruction__enterLabelAtAddress.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
enterCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress (typeCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__midrange_ipic_JUMP__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_6936 != NULL) {
    ...
    if (temp_7416.isBuilt ()) {
      ...
      if (method != NULL) {
        method (inLexique, temp_7416 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (212)) ;
      }
    }
...
category_method__midrange_ipic_JSR__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_8843 != NULL) {
    ...
    if (temp_9323.isBuilt ()) {
      ...
      if (method != NULL) {
        method (inLexique, temp_9323 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (263)) ;
      }
    }
...
category_method__midrange_ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & inLexique,
  ...
  if (operand_11331 != NULL) {
    ...
    if (temp_11960.isBuilt ()) {
      temp_11960 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11331->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (334)) ;
    }
...
void routine_build_midrange_ipic_binary_code (C_Compiler & inLexique,
  ...
  #endif
  GGS_midrange_symbolTable  var_cas_symbolTable = GGS_midrange_symbolTable ::constructor_emptyMap (inLexique COMMA_HERE) ;
