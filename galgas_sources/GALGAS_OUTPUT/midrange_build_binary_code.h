...
//--- Comparison methods
  public : GGS_bool _operator_isEqual (const GGS_midrange_symbolTable & inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_midrange_symbolTable & inOperand) const ;
...
typedef void (*typeCategoryMethod__midrange_ipic_instruction__enterLabelAtAddress)  (C_Compiler & _inLexique,
...
typedef void (*typeCategoryMethod__midrange_ipic_instruction__generateBinaryCodeAtAddress)  (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction * inObjectPtr,
