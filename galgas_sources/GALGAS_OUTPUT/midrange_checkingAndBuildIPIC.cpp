      ...
      while (_condition_9762.isBuiltAndTrue ()) {
        ...
        if (_condition_9762.isBuiltAndTrue ()) {
          if (_variant_9762.uintValue () == 0) {
            ...
            var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (inLexique, operand_7349->mInstructionLocation, var_cas_op, var_cas_STATUS_IPICregisterDescription, var_cas_rpIndex.add_operation (inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (284)) COMMA_HERE)) ;
        ...
        if (_condition_10910.isBuiltAndTrue ()) {
          if (_variant_10910.uintValue () == 0) {
            ...
            if (((((var_cas_shiftedXorBank).operator_and (GGS_uint (1U))).operator_isNotEqual (GGS_uint (0U))).operator_or ((var_cas_optimize).operator_not ())).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (inLexique, operand_7349->mInstructionLocation, var_cas_op, var_cas_STATUS_IPICregisterDescription, var_cas_rpIndex.add_operation (inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_HERE)) ;
            }else{
...
category_method__midrange_instruction_FD__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_11116 != NULL) {
    ...
    const GGS_registerExpression  temp_11635 = operand_11116->mRegisterExpression ;
    if (temp_11635.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_11635.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_11635 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (338)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (inLexique, operand_11116->mInstructionLocation, operand_11116->mInstruction_FD_base_code, var_cas_IPICregisterDescription, operand_11116->m_W_isDestination COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_F__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_12068 != NULL) {
    ...
    const GGS_registerExpression  temp_12587 = operand_12068->mRegisterExpression ;
    if (temp_12587.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_12587.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_12587 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (369)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_F ::constructor_new (inLexique, operand_12068->mInstructionLocation, operand_12068->mFAinstruction, var_cas_IPICregisterDescription COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_FB__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_12986 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_midrange_ipic_registerExpression var_cas_IPICregisterDescription ;
    const GGS_registerExpression  temp_13538 = operand_12986->mRegisterExpression ;
    if (temp_13538.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_13538.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_13538 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (400)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    const GGS_bitNumberExpression  temp_13701 = operand_12986->mBitNumber ;
    if (temp_13701.isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (temp_13701.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_13701 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (408)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (inLexique, operand_12986->mInstructionLocation, operand_12986->mBitOrientedOp, var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_JSR__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_14053 != NULL) {
    ...
    const GGS_routineMap  temp_14612 = var_cas_inRoutineMap ;
    if (temp_14612.isBuilt ()) {
      temp_14612 (HERE)->method_searchKey (inLexique, operand_14053->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (440)) ;
    }
    if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_14053->mTargetLabel)).operator_concat (GGS_string ("' requires bank selection to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (442))) ;
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_JSR ::constructor_new (inLexique, operand_14053->mInstructionLocation, operand_14053->mTargetLabel, GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE) COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_CALL__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_15712 != NULL) {
    ...
    GGS_uint  var_cas_returnedBank ;
    GGS_bool var_cas_preservesBank ;
    const GGS_routineMap  temp_16271 = var_cas_inRoutineMap ;
    if (temp_16271.isBuilt ()) {
      temp_16271 (HERE)->method_searchKey (inLexique, operand_15712->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (486)) ;
    }
    if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_15712->mTargetLabel)).operator_concat (GGS_string ("' requires bank selection to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (488))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_CALL ::constructor_new (inLexique, operand_15712->mInstructionLocation, operand_15712->mTargetLabel COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_JUMP__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_17292 != NULL) {
    ...
    const GGS_routineMap  temp_17797 = var_cas_inRoutineMap ;
    if (temp_17797.isBuilt ()) {
      temp_17797 (HERE)->method_searchKey (inLexique, operand_17292->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (528)) ;
    }
    if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_17292->mTargetLabel)).operator_concat (GGS_string ("' requires bank selection to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (530))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_JUMP ::constructor_new (inLexique, operand_17292->mInstructionLocation, operand_17292->mTargetLabel, GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE) COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_GOTO__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_18833 != NULL) {
    ...
    const GGS_routineMap  temp_19338 = var_cas_inRoutineMap ;
    if (temp_19338.isBuilt ()) {
      temp_19338 (HERE)->method_searchKey (inLexique, operand_18833->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (570)) ;
    }
    if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_18833->mTargetLabel)).operator_concat (GGS_string ("' requires bank selection to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (572))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
    ...
    var_cas_ioContinuesInSequence = GGS_bool (false) ;
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (inLexique, operand_18833->mInstructionLocation, operand_18833->mTargetLabel COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_CLRWDT__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_20296 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_CLRWDT ::constructor_new (inLexique, operand_20296->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_CLRW__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_20982 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_CLRW ::constructor_new (inLexique, operand_20982->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_NOP__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_21665 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_NOP ::constructor_new (inLexique, operand_21665->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_SLEEP__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_22349 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_SLEEP ::constructor_new (inLexique, operand_22349->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_literalOperation__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_23046 != NULL) {
    ...
    const GGS_immediatExpression  temp_23508 = operand_23046->mImmediatExpression ;
    if (temp_23508.isBuilt ()) {
      typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (temp_23508.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_23508 (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (687)) ;
      }
    }
...
category_method__midrange_instruction_MNOP__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_26181 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_MNOP ::constructor_new (inLexique, operand_26181->mInstructionLocation, operand_26181->mOccurrenceFactor COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_FOREVER__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_32036 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label0, operand_32036->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (inLexique, operand_32036->mInstructionLocation, GGS_lstring ::constructor_new (inLexique, var_cas_label0, operand_32036->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    var_cas_ioContinuesInSequence = GGS_bool (false) ;
  }
}
...
category_method__midrange_instruction_IF_BitTest__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_33819 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_midrange_ipic_registerExpression var_cas_IPICregisterDescription ;
    const GGS_registerExpression  temp_34329 = operand_33819->mRegisterExpression ;
    if (temp_34329.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_34329.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_34329 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (963)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    const GGS_bitNumberExpression  temp_34492 = operand_33819->mBitNumber ;
    if (temp_34492.isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (temp_34492.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_34492 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (971)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (inLexique, operand_33819->mInstructionLocation, operand_33819->mSkipIfSet, var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
    GGS_bool var_cas_unusedContinuesInSequence = GGS_bool (true) ;
    const GGS_midrange_instruction  temp_34821 = operand_33819->mInstruction ;
    if (temp_34821.isBuilt ()) {
      typeCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList method = findCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList (temp_34821.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_34821 (HERE), var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inShouldPreserveBank, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (983)) ;
      }
    }
  }
}
...
category_method__midrange_incDecRegisterInCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_35889 != NULL) {
    ...
    const GGS_registerExpression  temp_36313 = operand_35889->mRegisterExpression ;
    if (temp_36313.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_36313.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_36313 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1033)) ;
      }
    }
...
category_method__midrange_negateCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_37158 != NULL) {
    const GGS_midrange_conditionExpression  temp_37508 = operand_37158->mCondition ;
    if (temp_37508.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_37508.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_37508 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, (var_cas_inComplementaryBranch).operator_not (), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1077)) ;
      }
    }
  }
}
...
category_method__midrange_negateCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_37883 != NULL) {
    const GGS_midrange_conditionExpression  temp_37996 = operand_37883->mCondition ;
    if (temp_37996.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_37996.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_37996 (HERE), (var_cas_inComplementaryBranch).operator_not (), var_cas_outInstructionCount COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      }
    }
  }
}
...
category_method__midrange_andCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_38200 != NULL) {
    if ((var_cas_inComplementaryBranch).isBuiltAndTrue ()) {
      const GGS_midrange_conditionExpression  temp_38589 = operand_38200->mLeftExpression ;
      if (temp_38589.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_38589.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_38589 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1116)) ;
        }
      }
      const GGS_midrange_conditionExpression  temp_38870 = operand_38200->mRightExpression ;
      if (temp_38870.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_38870.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_38870 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1127)) ;
        }
      }
    }else{
      ...
      const GGS_midrange_conditionExpression  temp_39243 = operand_38200->mLeftExpression ;
      if (temp_39243.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_39243.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_39243 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1140)) ;
        }
      }
      const GGS_midrange_conditionExpression  temp_39517 = operand_38200->mRightExpression ;
      if (temp_39517.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_39517.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_39517 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1151)) ;
        }
      }
...
category_method__midrange_andCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_40018 != NULL) {
    ...
    const GGS_midrange_conditionExpression  temp_40156 = operand_40018->mLeftExpression ;
    if (temp_40156.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_40156.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_40156 (HERE), var_cas_inComplementaryBranch, var_cas_countLeft COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      }
    }
    GGS_uint  var_cas_countRight ;
    const GGS_midrange_conditionExpression  temp_40280 = operand_40018->mLeftExpression ;
    if (temp_40280.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_40280.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_40280 (HERE), var_cas_inComplementaryBranch, var_cas_countRight COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      }
    }
...
category_method__midrange_bitTest_in_structured_if_condition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_40543 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_midrange_ipic_registerExpression var_cas_IPICregisterDescription ;
    const GGS_registerExpression  temp_41000 = operand_40543->mRegisterExpression ;
    if (temp_41000.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_41000.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_41000 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    const GGS_bitNumberExpression  temp_41163 = operand_40543->mBitNumber ;
    if (temp_41163.isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (temp_41163.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_41163 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (1208)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (inLexique, var_cas_inInstructionLocation, (operand_40543->mBTFSSinstruction).operator_xor (var_cas_inComplementaryBranch), var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
...
category_method__midrange_instruction_structured_if__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_42062 != NULL) {
    ...
    if ((gOption_piccolo_5F_options_performOptimizations.value ()).isBuiltAndTrue ()) {
      ...
      const GGS_midrange_conditionExpression  temp_42640 = operand_42062->mIfCondition ;
      if (temp_42640.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_42640.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_42640 (HERE), GGS_bool (true), var_cas_directCount COMMA_SOURCE_FILE_AT_LINE (1254)) ;
        }
      }
      ...
      const GGS_midrange_conditionExpression  temp_42825 = operand_42062->mIfCondition ;
      if (temp_42825.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_42825.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_42825 (HERE), GGS_bool (false), var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1258)) ;
        }
      }
    ...
    if ((var_cas_generateComplementaryCondition).isBuiltAndTrue ()) {
      ...
      const GGS_midrange_conditionExpression  temp_43890 = operand_42062->mIfCondition ;
      if (temp_43890.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_43890.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_43890 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_42062->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        }
      }
      ...
      if (((operand_42062->mThenInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1308))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (inLexique, operand_42062->mInstructionLocation, GGS_lstring ::constructor_new (inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
      var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label_nextCondition, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ...
      if (((operand_42062->mThenInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1326))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
    }else{
      ...
      const GGS_midrange_conditionExpression  temp_45713 = operand_42062->mIfCondition ;
      if (temp_45713.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_45713.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_45713 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_42062->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        }
      }
      ::routine_handleMidrangeInstructionList (inLexique,  operand_42062->mThenInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1346)) ;
...
category_method__midrange_instruction_do_while__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_47787 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_labelInstructionBegin, operand_47787->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    GGS_uint  var_cas_finalBank = var_cas_ioCurrentBank ;
    ...
    }
    {
      ...
      while (((operand_48990 = enumerator_48990.nextObject ()))) {
        ...
        if (((operand_48990->mInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1433))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          const GGS_midrange_conditionExpression  temp_49087 = operand_48990->mCondition ;
          if (temp_49087.isBuilt ()) {
            typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_49087.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_49087 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_47787->mInstructionLocation, var_cas_labelInstructionBegin, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1434)) ;
            }
          }
        }else{
          ...
          const GGS_midrange_conditionExpression  temp_49498 = operand_48990->mCondition ;
          if (temp_49498.isBuilt ()) {
            typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_49498.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_49498 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_47787->mInstructionLocation, var_cas_nextBranchLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1447)) ;
            }
          }
          ...
          var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (inLexique, operand_47787->mInstructionLocation, GGS_lstring ::constructor_new (inLexique, var_cas_labelInstructionBegin, operand_47787->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
          var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_nextBranchLabel, operand_47787->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
        }
      }
    }
  }
...
category_method__midrange_instruction_IF_IncDec__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_50744 != NULL) {
    ...
    const GGS_registerExpression  temp_51442 = operand_50744->mRegisterExpression ;
    if (temp_51442.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_51442.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_51442 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1506)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (inLexique, operand_50744->mInstructionLocation, var_cas_baseCode, var_cas_IPICregisterDescription, operand_50744->m_W_isDestination COMMA_HERE)) ;
    GGS_bool var_cas_unusedContinuesInSequence = GGS_bool (true) ;
    const GGS_midrange_instruction  temp_51818 = operand_50744->mInstruction ;
    if (temp_51818.isBuilt ()) {
      typeCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList method = findCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList (temp_51818.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_51818 (HERE), var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inShouldPreserveBank, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1522)) ;
      }
    }
  }
}
...
void routine_generateInterruptRoutineForControllerWithSharedRAM (C_Compiler & inLexique,
  ...
  const GGS_registerTable  temp_52853 = var_cas_inRegisterTable ;
  if (temp_52853.isBuilt ()) {
    temp_52853 (HERE)->method_searchKey (inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (1556)) ;
  }
  ...
  const GGS_registerTable  temp_53728 = var_cas_inRegisterTable ;
  if (temp_53728.isBuilt ()) {
    temp_53728 (HERE)->method_searchKey (inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_12, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (1570)) ;
  }
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    const GGS_registerExpression  temp_54558 = var_cas_first_register ;
    if (temp_54558.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_54558.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_54558 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1585)) ;
      }
    }
    ...
    const GGS_registerExpression  temp_54876 = var_cas_second_register ;
    if (temp_54876.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_54876.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_54876 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_second_IPICregisterDescription, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (1594)) ;
      }
    }
    GGS_registerExpression  var_cas_STATUS_register = GGS_registerExpression ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("STATUS"), GGS_location (inLexique) COMMA_HERE), GGS_luint ::constructor_new (inLexique, GGS_uint (0U), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
    GGS_midrange_ipic_registerExpression var_cas_STATUS_IPICregisterDescription ;
    GGS_bitSliceTable  automatic_var_16 ;
    const GGS_registerExpression  temp_55252 = var_cas_STATUS_register ;
    if (temp_55252.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_55252.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_55252 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1604)) ;
      }
    }
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_56273 = var_cas_first_register_second_byte ;
      if (temp_56273.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_56273.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_56273 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1618)) ;
        }
      }
      ...
      const GGS_registerExpression  temp_56674 = var_cas_PCLATH_register ;
      if (temp_56674.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_56674.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_56674 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1628)) ;
        }
      }
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_58231 = var_cas_first_register_second_byte ;
      if (temp_58231.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_58231.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_58231 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_19 COMMA_SOURCE_FILE_AT_LINE (1662)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("PCLATH"), GGS_location (inLexique) COMMA_HERE), GGS_luint ::constructor_new (inLexique, GGS_uint (0U), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
      GGS_midrange_ipic_registerExpression var_cas_PCLATH_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_20 ;
      const GGS_registerExpression  temp_58632 = var_cas_PCLATH_register ;
      if (temp_58632.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_58632.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_58632 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (1672)) ;
        }
      }
...
void routine_generateInterruptRoutineForControllerWithoutSharedRAM (C_Compiler & inLexique,
  ...
  const GGS_registerTable  temp_60656 = var_cas_inRegisterTable ;
  if (temp_60656.isBuilt ()) {
    temp_60656 (HERE)->method_searchKey (inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_21, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (1711)) ;
  }
  GGS_bool var_cas_accessibleFromBank0 = GGS_bool (false) ;
  ...
  const GGS_registerTable  temp_61659 = var_cas_inRegisterTable ;
  if (temp_61659.isBuilt ()) {
    temp_61659 (HERE)->method_searchKey (inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_23, automatic_var_24 COMMA_SOURCE_FILE_AT_LINE (1728)) ;
  }
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    const GGS_registerExpression  temp_63162 = var_cas_first_register ;
    if (temp_63162.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_63162.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_63162 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (1755)) ;
      }
    }
    GGS_registerExpression  var_cas_first_register_second_byte = GGS_registerExpression ::constructor_new (inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (inLexique, GGS_uint (1U), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    const GGS_registerExpression  temp_63515 = var_cas_first_register_second_byte ;
    if (temp_63515.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_63515.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_63515 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_reg_second_byte_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (1764)) ;
      }
    }
    GGS_registerExpression  var_cas_STATUS_register = GGS_registerExpression ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("STATUS"), GGS_location (inLexique) COMMA_HERE), GGS_luint ::constructor_new (inLexique, GGS_uint (0U), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
    GGS_midrange_ipic_registerExpression var_cas_STATUS_IPICregisterDescription ;
    GGS_bitSliceTable  automatic_var_27 ;
    const GGS_registerExpression  temp_63897 = var_cas_STATUS_register ;
    if (temp_63897.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_63897.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_63897 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_27 COMMA_SOURCE_FILE_AT_LINE (1774)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_F ::constructor_new (inLexique, GGS_location (inLexique), GGS_midrange_F_instruction_base_code::constructor_MOVWF (inLexique COMMA_HERE), var_cas_first_IPICregisterDescription COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (inLexique, GGS_location (inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (inLexique COMMA_HERE), var_cas_STATUS_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_64931 = var_cas_first_register_third_byte ;
      if (temp_64931.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_64931.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_64931 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_third_byte_IPICregisterDescription, automatic_var_28 COMMA_SOURCE_FILE_AT_LINE (1788)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("PCLATH"), GGS_location (inLexique) COMMA_HERE), GGS_luint ::constructor_new (inLexique, GGS_uint (0U), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
      GGS_midrange_ipic_registerExpression var_cas_PCLATH_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_29 ;
      const GGS_registerExpression  temp_65331 = var_cas_PCLATH_register ;
      if (temp_65331.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_65331.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_65331 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_29 COMMA_SOURCE_FILE_AT_LINE (1798)) ;
        }
      }
      var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (inLexique, GGS_location (inLexique), GGS_midrange_instruction_FD_base_code::constructor_MOVF (inLexique COMMA_HERE), var_cas_PCLATH_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_66884 = var_cas_first_register_third_byte ;
      if (temp_66884.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_66884.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_66884 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_30 COMMA_SOURCE_FILE_AT_LINE (1832)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("PCLATH"), GGS_location (inLexique) COMMA_HERE), GGS_luint ::constructor_new (inLexique, GGS_uint (0U), GGS_location (inLexique) COMMA_HERE) COMMA_HERE) ;
      GGS_midrange_ipic_registerExpression var_cas_PCLATH_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_31 ;
      const GGS_registerExpression  temp_67285 = var_cas_PCLATH_register ;
      if (temp_67285.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_67285.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_67285 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_31 COMMA_SOURCE_FILE_AT_LINE (1842)) ;
        }
      }
      var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (inLexique, GGS_location (inLexique), GGS_midrange_instruction_FD_base_code::constructor_MOVF (inLexique COMMA_HERE), var_cas_first_var_second_byte_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
      var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_F ::constructor_new (inLexique, GGS_location (inLexique), GGS_midrange_F_instruction_base_code::constructor_MOVWF (inLexique COMMA_HERE), var_cas_PCLATH_IPICregisterDescription COMMA_HERE)) ;
...
void routine_build_midrange_assembly_instruction_list (C_Compiler & inLexique,
  ...
  var_cas_constantMap.modifier_insertKey (inLexique, var_cas_romSizeString, var_cas_inROMSize COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  {
    ...
    while (((operand_69912 = enumerator_69912.nextObject ()))) {
      ...
      GGS_sint  var_cas_result ;
      const GGS_immediatExpression  temp_69991 = operand_69912->mExpression ;
      if (temp_69991.isBuilt ()) {
        typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (temp_69991.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_69991 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1894)) ;
        }
      }
  ...
  if ((var_cas_routineMap.reader_hasKey (inLexique, GGS_string ("main") COMMA_SOURCE_FILE_AT_LINE (1909))).isBuiltAndTrue ()) {
    ...
    const GGS_routineMap  temp_70680 = var_cas_routineMap ;
    if (temp_70680.isBuilt ()) {
      temp_70680 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("main"), GGS_location (inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_32, automatic_var_33 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
    }
    if (((var_cas_isNoReturn).operator_not ()).isBuiltAndTrue ()) {
      ...
      while (((operand_71829 = enumerator_71829.nextObject ()))
        ...
        macroValidPointer (operand_71829) ;
        {
          ...
          while (((operand_71931 = enumerator_71931.nextObject ()))
            ...
            const GGS_midrange_instruction  temp_72010 = operand_71931->mInstruction ;
            if (temp_72010.isBuilt ()) {
              typeCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL method = findCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL (temp_72010.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_72010 (HERE), var_cas_needsToSavePCLATH COMMA_SOURCE_FILE_AT_LINE (1937)) ;
              }
            }
          }
        }
        ...
        GGS_bool var_cas_orgGenerated = (var_cas_currentPage).operator_isEqual (GGS_uint (0U)) ;
        {
          ...
          while (((operand_73857 = enumerator_73857.nextObject ()))) {
            ...
            if (((operand_73857->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1993))).operator_isEqual (var_cas_currentPage)).isBuiltAndTrue ()) {
              ...
              GGS_bool var_cas_continuesInSequence ;
              GGS_uint  var_cas_currentBank = operand_73857->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1999)) ;
              ...
              var_cas_outGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_73857->mRoutineName COMMA_HERE)) ;
              ...
              if (((operand_73857->mIsNoReturn).operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_RETURN ::constructor_new (inLexique, operand_73857->mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (2029)) COMMA_HERE)) ;
              }
            }
          }
        }
  ...
  if ((gOption_piccolo_5F_options_ouputListingFile.value ()).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_76310 = enumerator_76310.nextObject ()))) {
        ...
        const GGS_midrange_ipic_instruction  temp_76351 = operand_76310->mInstruction ;
        if (temp_76351.isBuilt ()) {
          temp_76351 (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2049)) ;
        }
        ...
        var_cas_ioListFileContents.appendCString (": ") ;
        const GGS_midrange_ipic_instruction  temp_76496 = operand_76310->mInstruction ;
