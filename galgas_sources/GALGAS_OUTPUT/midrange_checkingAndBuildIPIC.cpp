...
category_method__midrange_instruction_banksel__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_7349 != NULL) {
    ...
    const GGS_bitSliceTable  temp_8420 = var_cas_bitSliceTable ;
    if (temp_8420.isBuilt ()) {
      temp_8420 (HERE)->method_searchKey (inLexique, var_cas_RP, var_cas_rpIndex, var_cas_sliceSize COMMA_SOURCE_FILE_AT_LINE (260)) ;
    }
...
category_method__midrange_instruction_FD__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_11079 != NULL) {
    ...
    const GGS_registerExpression  temp_11598 = operand_11079->mRegisterExpression ;
    if (temp_11598.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_11598.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_11598 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_11700_0 COMMA_SOURCE_FILE_AT_LINE (338)) ;
      }
    }
...
category_method__midrange_instruction_F__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_12031 != NULL) {
    ...
    const GGS_registerExpression  temp_12550 = operand_12031->mRegisterExpression ;
    if (temp_12550.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_12550.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_12550 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_12652_0 COMMA_SOURCE_FILE_AT_LINE (369)) ;
      }
    }
...
category_method__midrange_instruction_FB__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_12949 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_midrange_ipic_registerExpression var_cas_IPICregisterDescription ;
    const GGS_registerExpression  temp_13501 = operand_12949->mRegisterExpression ;
    if (temp_13501.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_13501.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_13501 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (400)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    const GGS_bitNumberExpression  temp_13664 = operand_12949->mBitNumber ;
    if (temp_13664.isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (temp_13664.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_13664 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (408)) ;
      }
    }
...
category_method__midrange_instruction_JSR__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_14016 != NULL) {
    ...
    const GGS_routineMap  temp_14575 = var_cas_inRoutineMap ;
    if (temp_14575.isBuilt ()) {
      temp_14575 (HERE)->method_searchKey (inLexique, operand_14016->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (440)) ;
    }
...
category_method__midrange_instruction_CALL__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_15675 != NULL) {
    ...
    GGS_uint  var_cas_returnedBank ;
    GGS_bool var_cas_preservesBank ;
    const GGS_routineMap  temp_16234 = var_cas_inRoutineMap ;
    if (temp_16234.isBuilt ()) {
      temp_16234 (HERE)->method_searchKey (inLexique, operand_15675->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (486)) ;
    }
...
category_method__midrange_instruction_JUMP__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_17255 != NULL) {
    ...
    const GGS_routineMap  temp_17760 = var_cas_inRoutineMap ;
    if (temp_17760.isBuilt ()) {
      temp_17760 (HERE)->method_searchKey (inLexique, operand_17255->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_17807_0, automatic_var_17807_1 COMMA_SOURCE_FILE_AT_LINE (528)) ;
    }
...
category_method__midrange_instruction_GOTO__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_18796 != NULL) {
    ...
    const GGS_routineMap  temp_19301 = var_cas_inRoutineMap ;
    if (temp_19301.isBuilt ()) {
      temp_19301 (HERE)->method_searchKey (inLexique, operand_18796->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_19348_0, automatic_var_19348_1 COMMA_SOURCE_FILE_AT_LINE (570)) ;
    }
...
category_method__midrange_instruction_literalOperation__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_23009 != NULL) {
    ...
    const GGS_immediatExpression  temp_23471 = operand_23009->mImmediatExpression ;
    if (temp_23471.isBuilt ()) {
      typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (temp_23471.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_23471 (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (687)) ;
      }
    }
...
category_method__midrange_instruction_IF_BitTest__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_33780 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_midrange_ipic_registerExpression var_cas_IPICregisterDescription ;
    const GGS_registerExpression  temp_34290 = operand_33780->mRegisterExpression ;
    if (temp_34290.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_34290.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_34290 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (963)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    const GGS_bitNumberExpression  temp_34453 = operand_33780->mBitNumber ;
    if (temp_34453.isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (temp_34453.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_34453 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (971)) ;
      }
    }
    ...
    const GGS_midrange_instruction  temp_34782 = operand_33780->mInstruction ;
    if (temp_34782.isBuilt ()) {
      typeCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList method = findCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList (temp_34782.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_34782 (HERE), var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inShouldPreserveBank, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (983)) ;
      }
    }
  }
}
...
category_method__midrange_incDecRegisterInCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_35850 != NULL) {
    ...
    const GGS_registerExpression  temp_36274 = operand_35850->mRegisterExpression ;
    if (temp_36274.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_36274.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_36274 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_36376_0 COMMA_SOURCE_FILE_AT_LINE (1033)) ;
      }
    }
...
category_method__midrange_negateCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_37119 != NULL) {
    const GGS_midrange_conditionExpression  temp_37469 = operand_37119->mCondition ;
    if (temp_37469.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_37469.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_37469 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, (var_cas_inComplementaryBranch).operator_not (), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1077)) ;
      }
    }
  }
}
...
category_method__midrange_negateCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_37844 != NULL) {
    const GGS_midrange_conditionExpression  temp_37957 = operand_37844->mCondition ;
    if (temp_37957.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_37957.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_37957 (HERE), (var_cas_inComplementaryBranch).operator_not (), var_cas_outInstructionCount COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      }
    }
  }
}
...
category_method__midrange_andCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_38161 != NULL) {
    ...
    if (cond_39064.isBuiltAndTrue ()) {
      const GGS_midrange_conditionExpression  temp_38550 = operand_38161->mLeftExpression ;
      if (temp_38550.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_38550.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_38550 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1116)) ;
        }
      }
      const GGS_midrange_conditionExpression  temp_38831 = operand_38161->mRightExpression ;
      if (temp_38831.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_38831.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_38831 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1127)) ;
        }
      }
      ...
      const GGS_midrange_conditionExpression  temp_39204 = operand_38161->mLeftExpression ;
      if (temp_39204.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_39204.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_39204 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1140)) ;
        }
      }
      const GGS_midrange_conditionExpression  temp_39478 = operand_38161->mRightExpression ;
      if (temp_39478.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_39478.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_39478 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1151)) ;
        }
      }
...
category_method__midrange_andCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_39979 != NULL) {
    ...
    const GGS_midrange_conditionExpression  temp_40117 = operand_39979->mLeftExpression ;
    if (temp_40117.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_40117.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_40117 (HERE), var_cas_inComplementaryBranch, var_cas_countLeft COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      }
    }
    GGS_uint  var_cas_countRight ;
    const GGS_midrange_conditionExpression  temp_40241 = operand_39979->mLeftExpression ;
    if (temp_40241.isBuilt ()) {
      typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_40241.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_40241 (HERE), var_cas_inComplementaryBranch, var_cas_countRight COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      }
    }
...
category_method__midrange_bitTest_in_structured_if_condition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_40504 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_midrange_ipic_registerExpression var_cas_IPICregisterDescription ;
    const GGS_registerExpression  temp_40961 = operand_40504->mRegisterExpression ;
    if (temp_40961.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_40961.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_40961 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    const GGS_bitNumberExpression  temp_41124 = operand_40504->mBitNumber ;
    if (temp_41124.isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (temp_41124.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_41124 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (1208)) ;
      }
    }
...
category_method__midrange_instruction_structured_if__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_42023 != NULL) {
    ...
    if (cond_43361.isBuiltAndTrue ()) {
      ...
      const GGS_midrange_conditionExpression  temp_42607 = operand_42023->mIfCondition ;
      if (temp_42607.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_42607.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_42607 (HERE), GGS_bool (true), var_cas_directCount COMMA_SOURCE_FILE_AT_LINE (1254)) ;
        }
      }
      ...
      const GGS_midrange_conditionExpression  temp_42792 = operand_42023->mIfCondition ;
      if (temp_42792.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__midrange_conditionExpression__computeInstructionCountForCondition (temp_42792.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_42792 (HERE), GGS_bool (false), var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1258)) ;
        }
      }
    ...
    if (cond_45392.isBuiltAndTrue ()) {
      ...
      const GGS_midrange_conditionExpression  temp_43857 = operand_42023->mIfCondition ;
      if (temp_43857.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_43857.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_43857 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_42023->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        }
      }
      ...
      const GGS_midrange_conditionExpression  temp_45680 = operand_42023->mIfCondition ;
      if (temp_45680.isBuilt ()) {
        typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_45680.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_45680 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_42023->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        }
      }
      ::routine_handleMidrangeInstructionList (inLexique,  operand_42023->mThenInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1346)) ;
    ...
    }
    {
      ...
      while (((operand_48957 = enumerator_48957.nextObject ()))) {
        ...
        if (cond_49317.isBuiltAndTrue ()) {
          const GGS_midrange_conditionExpression  temp_49054 = operand_48957->mCondition ;
          if (temp_49054.isBuilt ()) {
            typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_49054.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_49054 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_47754->mInstructionLocation, var_cas_labelInstructionBegin, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1434)) ;
            }
          }
          ...
          const GGS_midrange_conditionExpression  temp_49465 = operand_48957->mCondition ;
          if (temp_49465.isBuilt ()) {
            typeCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__midrange_conditionExpression__buildIPICinstructionForCondition (temp_49465.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_49465 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_47754->mInstructionLocation, var_cas_nextBranchLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1447)) ;
            }
          }
...
category_method__midrange_instruction_IF_IncDec__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_50711 != NULL) {
    ...
    const GGS_registerExpression  temp_51409 = operand_50711->mRegisterExpression ;
    if (temp_51409.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_51409.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_51409 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_51511_0 COMMA_SOURCE_FILE_AT_LINE (1506)) ;
      }
    }
    ...
    GGS_bool var_cas_unusedContinuesInSequence = GGS_bool (true) ;
    const GGS_midrange_instruction  temp_51785 = operand_50711->mInstruction ;
    if (temp_51785.isBuilt ()) {
      typeCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList method = findCategoryMethod__midrange_instruction__build_midrange_ipic_instructionList (temp_51785.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_51785 (HERE), var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inShouldPreserveBank, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1522)) ;
      }
    }
  }
}
...
void routine_generateInterruptRoutineForControllerWithSharedRAM (C_Compiler & inLexique,
  ...
  const GGS_registerTable  temp_52820 = var_cas_inRegisterTable ;
  if (temp_52820.isBuilt ()) {
    temp_52820 (HERE)->method_searchKey (inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_52876_0, automatic_var_52876_1 COMMA_SOURCE_FILE_AT_LINE (1556)) ;
  }
  ...
  const GGS_registerTable  temp_53695 = var_cas_inRegisterTable ;
  if (temp_53695.isBuilt ()) {
    temp_53695 (HERE)->method_searchKey (inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_53752_0, automatic_var_53752_1 COMMA_SOURCE_FILE_AT_LINE (1570)) ;
  }
  ...
  if (cond_59844.isBuiltAndTrue ()) {
    ...
    const GGS_registerExpression  temp_54525 = var_cas_first_register ;
    if (temp_54525.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_54525.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_54525 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_54633_0 COMMA_SOURCE_FILE_AT_LINE (1585)) ;
      }
    }
    ...
    const GGS_registerExpression  temp_54843 = var_cas_second_register ;
    if (temp_54843.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_54843.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_54843 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1596)), var_cas_inRegisterTable, var_cas_second_IPICregisterDescription, automatic_var_54962_0 COMMA_SOURCE_FILE_AT_LINE (1594)) ;
      }
    }
    ...
    const GGS_registerExpression  temp_55219 = var_cas_STATUS_register ;
    if (temp_55219.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_55219.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_55219 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1606)), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_55338_0 COMMA_SOURCE_FILE_AT_LINE (1604)) ;
      }
    }
    ...
    if (cond_57268.isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_56240 = var_cas_first_register_second_byte ;
      if (temp_56240.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_56240.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_56240 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_56376_0 COMMA_SOURCE_FILE_AT_LINE (1618)) ;
        }
      }
      ...
      const GGS_registerExpression  temp_56641 = var_cas_PCLATH_register ;
      if (temp_56641.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_56641.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_56641 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1630)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_56772_0 COMMA_SOURCE_FILE_AT_LINE (1628)) ;
        }
      }
    ...
    if (cond_59072.isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_58198 = var_cas_first_register_second_byte ;
      if (temp_58198.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_58198.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_58198 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_58334_0 COMMA_SOURCE_FILE_AT_LINE (1662)) ;
        }
      }
      ...
      const GGS_registerExpression  temp_58599 = var_cas_PCLATH_register ;
      if (temp_58599.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_58599.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_58599 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1674)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_58730_0 COMMA_SOURCE_FILE_AT_LINE (1672)) ;
        }
      }
...
void routine_generateInterruptRoutineForControllerWithoutSharedRAM (C_Compiler & inLexique,
  ...
  const GGS_registerTable  temp_60623 = var_cas_inRegisterTable ;
  if (temp_60623.isBuilt ()) {
    temp_60623 (HERE)->method_searchKey (inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_60678_0, automatic_var_60678_1 COMMA_SOURCE_FILE_AT_LINE (1711)) ;
  }
  GGS_bool var_cas_accessibleFromBank0 = GGS_bool (false) ;
  ...
  const GGS_registerTable  temp_61626 = var_cas_inRegisterTable ;
  if (temp_61626.isBuilt ()) {
    temp_61626 (HERE)->method_searchKey (inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_61683_0, automatic_var_61683_1 COMMA_SOURCE_FILE_AT_LINE (1728)) ;
  }
  ...
  if (cond_68510.isBuiltAndTrue ()) {
    ...
    const GGS_registerExpression  temp_63129 = var_cas_first_register ;
    if (temp_63129.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_63129.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_63129 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_63237_0 COMMA_SOURCE_FILE_AT_LINE (1755)) ;
      }
    }
    ...
    const GGS_registerExpression  temp_63482 = var_cas_first_register_second_byte ;
    if (temp_63482.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_63482.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_63482 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_reg_second_byte_IPICregisterDescription, automatic_var_63607_0 COMMA_SOURCE_FILE_AT_LINE (1764)) ;
      }
    }
    ...
    const GGS_registerExpression  temp_63864 = var_cas_STATUS_register ;
    if (temp_63864.isBuilt ()) {
      typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_63864.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, temp_63864 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1776)), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_63983_0 COMMA_SOURCE_FILE_AT_LINE (1774)) ;
      }
    }
    ...
    if (cond_65924.isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_64898 = var_cas_first_register_third_byte ;
      if (temp_64898.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_64898.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_64898 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_third_byte_IPICregisterDescription, automatic_var_65033_0 COMMA_SOURCE_FILE_AT_LINE (1788)) ;
        }
      }
      ...
      const GGS_registerExpression  temp_65298 = var_cas_PCLATH_register ;
      if (temp_65298.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_65298.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_65298 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1800)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_65429_0 COMMA_SOURCE_FILE_AT_LINE (1798)) ;
        }
      }
    ...
    if (cond_67725.isBuiltAndTrue ()) {
      ...
      const GGS_registerExpression  temp_66851 = var_cas_first_register_third_byte ;
      if (temp_66851.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_66851.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_66851 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_66987_0 COMMA_SOURCE_FILE_AT_LINE (1832)) ;
        }
      }
      ...
      const GGS_registerExpression  temp_67252 = var_cas_PCLATH_register ;
      if (temp_67252.isBuilt ()) {
        typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (temp_67252.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_67252 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1844)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_67383_0 COMMA_SOURCE_FILE_AT_LINE (1842)) ;
        }
      }
...
void routine_build_midrange_assembly_instruction_list (C_Compiler & inLexique,
  ...
  var_cas_constantMap.modifier_insertKey (inLexique, var_cas_romSizeString, var_cas_inROMSize COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  {
    ...
    while (((operand_69879 = enumerator_69879.nextObject ()))) {
      ...
      GGS_sint  var_cas_result ;
      const GGS_immediatExpression  temp_69958 = operand_69879->mExpression ;
      if (temp_69958.isBuilt ()) {
        typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (temp_69958.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_69958 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1894)) ;
        }
      }
  ...
  if (cond_71048.isBuiltAndTrue ()) {
    ...
    const GGS_routineMap  temp_70653 = var_cas_routineMap ;
    if (temp_70653.isBuilt ()) {
      temp_70653 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("main"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1912)), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_70716_0, automatic_var_70716_1 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
    }
      ...
      while (((operand_71802 = enumerator_71802.nextObject ()))
        ...
        macroValidPointer (operand_71802) ;
        {
          ...
          while (((operand_71904 = enumerator_71904.nextObject ()))
            ...
            const GGS_midrange_instruction  temp_71983 = operand_71904->mInstruction ;
            if (temp_71983.isBuilt ()) {
              typeCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL method = findCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL (temp_71983.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_71983 (HERE), var_cas_needsToSavePCLATH COMMA_SOURCE_FILE_AT_LINE (1937)) ;
              }
            }
          }
        }
  ...
  if (cond_76723.isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_76287 = enumerator_76287.nextObject ()))) {
        ...
        const GGS_midrange_ipic_instruction  temp_76328 = operand_76287->mInstruction ;
        if (temp_76328.isBuilt ()) {
          temp_76328 (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2049)) ;
        }
        ...
        var_cas_ioListFileContents.appendCString (": ") ;
        const GGS_midrange_ipic_instruction  temp_76471 = operand_76287->mInstruction ;
        if (temp_76471.isBuilt ()) {
          temp_76471 (HERE)->method_displayIPICinstruction (inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2051)) ;
        }
        var_cas_ioListFileContents.appendCString ("\n") ;
