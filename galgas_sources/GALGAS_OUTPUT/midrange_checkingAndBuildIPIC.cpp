...
void routine_generateInterruptRoutineForControllerWithSharedRAM (C_Compiler & inLexique,
  ...
  GGS_bitSliceTable  automatic_var_52878_0 ;
  GGS_string automatic_var_52878_1 ;
  if (var_cas_inRegisterTable.isBuilt ()) {
    var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_52878_0, automatic_var_52878_1 COMMA_SOURCE_FILE_AT_LINE (1556)) ;
  }
  GGS_uint  var_cas_bankAccessibility = GGS_uint (0U) ;
  {
    GGS_uintlist::cEnumerator enumerator_52943 (var_cas_registerAddressList, true) ;
    const GGS_uintlist::cElement * operand_52943 = NULL ;
    while (((operand_52943 = enumerator_52943.nextObject ()))) {
      macroValidPointer (operand_52943) ;
      var_cas_bankAccessibility = (var_cas_bankAccessibility).operator_or (GGS_uint (1U).left_shift_operation (inLexique, operand_52943->mValue.right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (1559)) COMMA_SOURCE_FILE_AT_LINE (1559))) ;
    }
  }
  const GGS_bool cond_53208 = (var_cas_bankAccessibility.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1561))).operator_isNotEqual (GGS_uint (1U).left_shift_operation (inLexique, var_cas_inTotalBankCount COMMA_SOURCE_FILE_AT_LINE (1561))) ;
  if (cond_53208.isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inFirstSaveRegister)).operator_concat (GGS_string ("' variable cannot be accessed from any bank")) COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  }
  const GGS_bool cond_53390 = (var_cas_inNeedsToSavePCLATH).operator_and ((var_cas_size).operator_isNotEqual (GGS_uint (2U))) ;
  if (cond_53390.isBuiltAndTrue ()) {
  ...
  }else if (cond_53390.isBuiltAndFalse ()) {
    const GGS_bool cond_53566 = ((var_cas_inNeedsToSavePCLATH).operator_not ()).operator_and ((var_cas_size).operator_isNotEqual (GGS_uint (1U))) ;
    if (cond_53566.isBuiltAndTrue ()) {
  ...
  GGS_bitSliceTable  automatic_var_53764_0 ;
  GGS_string automatic_var_53764_1 ;
  if (var_cas_inRegisterTable.isBuilt ()) {
    var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_53764_0, automatic_var_53764_1 COMMA_SOURCE_FILE_AT_LINE (1570)) ;
  }
  var_cas_bankAccessibility = GGS_uint (0U) ;
  {
    GGS_uintlist::cEnumerator enumerator_53823 (var_cas_registerAddressList, true) ;
    const GGS_uintlist::cElement * operand_53823 = NULL ;
    while (((operand_53823 = enumerator_53823.nextObject ()))) {
      macroValidPointer (operand_53823) ;
      var_cas_bankAccessibility = (var_cas_bankAccessibility).operator_or (GGS_uint (1U).left_shift_operation (inLexique, operand_53823->mValue.right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (1573)) COMMA_SOURCE_FILE_AT_LINE (1573))) ;
    }
  }
  const GGS_bool cond_54090 = (var_cas_bankAccessibility.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1575))).operator_isNotEqual (GGS_uint (1U).left_shift_operation (inLexique, var_cas_inTotalBankCount COMMA_SOURCE_FILE_AT_LINE (1575))) ;
  if (cond_54090.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_54248 = (var_cas_size).operator_isNotEqual (GGS_uint (1U)) ;
  if (cond_54248.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_59867 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1582))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_59867.isBuiltAndTrue ()) {
    ...
    GGS_bitSliceTable  automatic_var_54639_0 ;
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_first_register.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_first_register (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_54639_0 COMMA_SOURCE_FILE_AT_LINE (1585)) ;
      }
    }
    ...
    GGS_bitSliceTable  automatic_var_54968_0 ;
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_second_register.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_second_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1596)), var_cas_inRegisterTable, var_cas_second_IPICregisterDescription, automatic_var_54968_0 COMMA_SOURCE_FILE_AT_LINE (1594)) ;
      }
    }
    ...
    GGS_midrange_ipic_registerExpression var_cas_STATUS_IPICregisterDescription ;
    GGS_bitSliceTable  automatic_var_55344_0 ;
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_STATUS_register.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_STATUS_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1606)), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_55344_0 COMMA_SOURCE_FILE_AT_LINE (1604)) ;
      }
    }
    ...
    const GGS_bool cond_57274 = var_cas_inNeedsToSavePCLATH ;
    if (cond_57274.isBuiltAndTrue ()) {
      ...
      GGS_bitSliceTable  automatic_var_56382_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_first_register_second_byte.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_first_register_second_byte (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_56382_0 COMMA_SOURCE_FILE_AT_LINE (1618)) ;
        }
      }
      ...
      GGS_bitSliceTable  automatic_var_56778_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_PCLATH_register.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_PCLATH_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1630)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_56778_0 COMMA_SOURCE_FILE_AT_LINE (1628)) ;
        }
      }
    ...
    ::routine_handleMidrangeInstructionList (inLexique,  var_cas_inInterruptRoutineInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioGenerationOptimizationMessages,  var_cas_inTotalBankCount,  var_cas_currentBank,  GGS_bool (false),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (inLexique COMMA_SOURCE_FILE_AT_LINE (1654)) COMMA_SOURCE_FILE_AT_LINE (1642)) ;
    const GGS_bool cond_57934 = (var_cas_continuesInSequence).operator_not () ;
    if (cond_57934.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_59095 = var_cas_inNeedsToSavePCLATH ;
    if (cond_59095.isBuiltAndTrue ()) {
      ...
      GGS_midrange_ipic_registerExpression var_cas_first_var_second_byte_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_58357_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_first_register_second_byte.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_first_register_second_byte (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_58357_0 COMMA_SOURCE_FILE_AT_LINE (1662)) ;
        }
      }
      ...
      GGS_midrange_ipic_registerExpression var_cas_PCLATH_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_58753_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_PCLATH_register.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_PCLATH_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1674)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_58753_0 COMMA_SOURCE_FILE_AT_LINE (1672)) ;
        }
      }
...
void routine_generateInterruptRoutineForControllerWithoutSharedRAM (C_Compiler & inLexique,
  ...
  GGS_uintlist  var_cas_registerAddressList ;
  GGS_uint  var_cas_size ;
  GGS_bitSliceTable  automatic_var_60701_0 ;
  GGS_string automatic_var_60701_1 ;
  if (var_cas_inRegisterTable.isBuilt ()) {
    var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_60701_0, automatic_var_60701_1 COMMA_SOURCE_FILE_AT_LINE (1711)) ;
  }
  GGS_bool var_cas_accessibleFromBank0 = GGS_bool (false) ;
  GGS_uint  var_cas_offset = GGS_uint (0U) ;
  {
    GGS_uintlist::cEnumerator enumerator_60806 (var_cas_registerAddressList, true) ;
    const GGS_uintlist::cElement * operand_60806 = NULL ;
    while (((operand_60806 = enumerator_60806.nextObject ()))
        && ((var_cas_accessibleFromBank0).operator_not ().isBuiltAndTrue ())) {
      macroValidPointer (operand_60806) ;
      var_cas_offset = (operand_60806->mValue).operator_and (GGS_uint (127U)) ;
      var_cas_accessibleFromBank0 = ((operand_60806->mValue).operator_and (GGS_uint (3968U))).operator_isEqual (GGS_uint (0U)) ;
    }
  }
  const GGS_bool cond_61085 = (var_cas_accessibleFromBank0).operator_not () ;
  if (cond_61085.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_61267 = (var_cas_inNeedsToSavePCLATH).operator_and ((var_cas_size).operator_isNotEqual (GGS_uint (3U))) ;
  if (cond_61267.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_61443 = ((var_cas_inNeedsToSavePCLATH).operator_not ()).operator_and ((var_cas_size).operator_isNotEqual (GGS_uint (2U))) ;
    if (cond_61443.isBuiltAndTrue ()) {
  ...
  GGS_bitSliceTable  automatic_var_61706_0 ;
  GGS_string automatic_var_61706_1 ;
  if (var_cas_inRegisterTable.isBuilt ()) {
    var_cas_inRegisterTable (HERE)->method_searchKey (inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_61706_0, automatic_var_61706_1 COMMA_SOURCE_FILE_AT_LINE (1728)) ;
  }
  var_cas_saveStatusRegisterAddressList = (var_cas_saveStatusRegisterAddressList).operator_concat (var_cas_registerAddressList) ;
  const GGS_bool cond_61950 = (var_cas_size).operator_isNotEqual (GGS_uint (1U)) ;
  if (cond_61950.isBuiltAndTrue ()) {
  ...
  {
    GGS_uintlist::cEnumerator enumerator_62074 (var_cas_registerAddressList, true) ;
    const GGS_uintlist::cElement * operand_62074 = NULL ;
    while (((operand_62074 = enumerator_62074.nextObject ()))
        && ((var_cas_accessibleFromBank1).operator_not ().isBuiltAndTrue ())) {
      macroValidPointer (operand_62074) ;
      var_cas_accessibleFromBank1 = ((operand_62074->mValue).operator_and (GGS_uint (3968U))).operator_isEqual (GGS_uint (128U)) ;
    }
  }
  const GGS_bool cond_62328 = (var_cas_accessibleFromBank1).operator_not () ;
  if (cond_62328.isBuiltAndTrue ()) {
  ...
  {
    GGS_uintlist::cEnumerator enumerator_62485 (var_cas_registerAddressList, true) ;
    const GGS_uintlist::cElement * operand_62485 = NULL ;
    while (((operand_62485 = enumerator_62485.nextObject ()))
        && (var_cas_offsetOk.isBuiltAndTrue ())) {
      macroValidPointer (operand_62485) ;
      var_cas_offsetOk = (var_cas_offset).operator_isEqual ((operand_62485->mValue).operator_and (GGS_uint (127U))) ;
      const GGS_bool cond_62854 = (var_cas_offsetOk).operator_not () ;
      if (cond_62854.isBuiltAndTrue ()) {
        var_cas_inSecondSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("the '")).operator_concat (var_cas_inSecondSaveRegister)).operator_concat (GGS_string ("' variable has an offset equal to "))).operator_concat ((operand_62485->mValue).operator_and (GGS_uint (127U)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (1747)))).operator_concat (GGS_string (", while '"))).operator_concat (var_cas_inFirstSaveRegister)).operator_concat (GGS_string ("' has an offset equal to "))).operator_concat (var_cas_offset.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (1748)))).operator_concat (GGS_string (" (tthe two offsets should be equal)")) COMMA_SOURCE_FILE_AT_LINE (1749)) ;
      }
    }
  }
  const GGS_bool cond_68533 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1752))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_68533.isBuiltAndTrue ()) {
    ...
    GGS_midrange_ipic_registerExpression var_cas_first_IPICregisterDescription ;
    GGS_bitSliceTable  automatic_var_63260_0 ;
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_first_register.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_first_register (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_63260_0 COMMA_SOURCE_FILE_AT_LINE (1755)) ;
      }
    }
    ...
    GGS_bitSliceTable  automatic_var_63630_0 ;
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_first_register_second_byte.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_first_register_second_byte (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_reg_second_byte_IPICregisterDescription, automatic_var_63630_0 COMMA_SOURCE_FILE_AT_LINE (1764)) ;
      }
    }
    ...
    GGS_midrange_ipic_registerExpression var_cas_STATUS_IPICregisterDescription ;
    GGS_bitSliceTable  automatic_var_64006_0 ;
    { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_STATUS_register.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_STATUS_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1776)), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_64006_0 COMMA_SOURCE_FILE_AT_LINE (1774)) ;
      }
    }
    ...
    const GGS_bool cond_65947 = var_cas_inNeedsToSavePCLATH ;
    if (cond_65947.isBuiltAndTrue ()) {
      ...
      GGS_bitSliceTable  automatic_var_65056_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_first_register_third_byte.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_first_register_third_byte (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_third_byte_IPICregisterDescription, automatic_var_65056_0 COMMA_SOURCE_FILE_AT_LINE (1788)) ;
        }
      }
      ...
      GGS_midrange_ipic_registerExpression var_cas_PCLATH_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_65452_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_PCLATH_register.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_PCLATH_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1800)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_65452_0 COMMA_SOURCE_FILE_AT_LINE (1798)) ;
        }
      }
    ...
    const GGS_bool cond_66590 = (var_cas_continuesInSequence).operator_not () ;
    if (cond_66590.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_67748 = var_cas_inNeedsToSavePCLATH ;
    if (cond_67748.isBuiltAndTrue ()) {
      ...
      GGS_midrange_ipic_registerExpression var_cas_first_var_second_byte_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_67010_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_first_register_third_byte.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_first_register_third_byte (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_67010_0 COMMA_SOURCE_FILE_AT_LINE (1832)) ;
        }
      }
      ...
      GGS_midrange_ipic_registerExpression var_cas_PCLATH_IPICregisterDescription ;
      GGS_bitSliceTable  automatic_var_67406_0 ;
      { typeCategoryMethod__registerExpression__resolveMidrangeAccess method = findCategoryMethod__registerExpression__resolveMidrangeAccess (var_cas_PCLATH_register.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, var_cas_PCLATH_register (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1844)), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_67406_0 COMMA_SOURCE_FILE_AT_LINE (1842)) ;
        }
      }
...
void routine_build_midrange_assembly_instruction_list (C_Compiler & inLexique,
  ...
  {
    GGS_midrange_routineDefinitionList::cEnumerator enumerator_69102 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (1878)), true) ;
    const GGS_midrange_routineDefinitionList::cElement * operand_69102 = NULL ;
    while (((operand_69102 = enumerator_69102.nextObject ()))) {
      macroValidPointer (operand_69102) ;
      const GGS_bool cond_69316 = ((operand_69102->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1879))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1879)))).operator_and ((operand_69102->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1879))).operator_strictSup (GGS_uint (15U))) ;
      if (cond_69316.isBuiltAndTrue ()) {
        operand_69102->mRequiredBank.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1881)) ;
      }
      const GGS_bool cond_69494 = ((operand_69102->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1882))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (1882)))).operator_and ((operand_69102->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1882))).operator_strictSup (GGS_uint (15U))) ;
      if (cond_69494.isBuiltAndTrue ()) {
        operand_69102->mReturnedBank.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1884)) ;
      }
      var_cas_routineMap.modifier_insertKey (inLexique, operand_69102->mRoutineName, operand_69102->mIsNoReturn, operand_69102->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1885)), operand_69102->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1885)), operand_69102->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1885)) ;
    }
  }
  ...
  {
    GGS_constantDefinitionList::cEnumerator enumerator_69902 (var_cas_inPiccoloModel.reader_mConstantDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (1893)), true) ;
    const GGS_constantDefinitionList::cElement * operand_69902 = NULL ;
    while (((operand_69902 = enumerator_69902.nextObject ()))) {
      macroValidPointer (operand_69902) ;
      GGS_sint  var_cas_result ;
      { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_69902->mExpression.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_69902->mExpression (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1894)) ;
        }
      }
      const GGS_bool cond_70203 = var_cas_inRegisterTable.reader_hasKey (operand_69902->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1895))) ;
      if (cond_70203.isBuiltAndTrue ()) {
        operand_69902->mConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (operand_69902->mConstantName)).operator_concat (GGS_string ("' is already declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1897)) ;
      }else if (cond_70203.isBuiltAndFalse ()) {
        var_cas_constantMap.modifier_insertKey (inLexique, operand_69902->mConstantName, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1898)) ;
      }
    }
  }
  const GGS_bool cond_70488 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_70488.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_71071 = var_cas_routineMap.reader_hasKey (GGS_string ("main")) ;
  if (cond_71071.isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_70739_0 ;
    GGS_bool automatic_var_70739_1 ;
    if (var_cas_routineMap.isBuilt ()) {
      var_cas_routineMap (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("main"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1912)), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_70739_0, automatic_var_70739_1 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
    }
    const GGS_bool cond_70893 = (var_cas_isNoReturn).operator_not () ;
    if (cond_70893.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_71059 = (var_cas_requiredBank).operator_isNotEqual (GGS_uint (0U)) ;
    if (cond_71059.isBuiltAndTrue ()) {
  ...
  }else if (cond_71071.isBuiltAndFalse ()) {
  ...
  {
    GGS_midrange_routineDefinitionList::cEnumerator enumerator_71318 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (1924)), true) ;
    const GGS_midrange_routineDefinitionList::cElement * operand_71318 = NULL ;
    while (((operand_71318 = enumerator_71318.nextObject ()))) {
      macroValidPointer (operand_71318) ;
      const GGS_bool cond_71430 = (operand_71318->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1925))).operator_strictSup (GGS_uint (0U)) ;
      if (cond_71430.isBuiltAndTrue ()) {
        var_cas_needsToSavePCLATH = GGS_bool (true) ;
      }
      const GGS_bool cond_71623 = (operand_71318->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1928))).operator_supOrEqual (var_cas_inTotalPageCount) ;
      if (cond_71623.isBuiltAndTrue ()) {
        operand_71318->mPage.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("invalid value (")).operator_concat (operand_71318->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1929)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1929)))).operator_concat (GGS_string ("); the device has "))).operator_concat (var_cas_inTotalPageCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1929)))).operator_concat (GGS_string (" 2k page(s) on rom")) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      }
    }
  }
  const GGS_bool cond_72073 = var_cas_needsToSavePCLATH ;
  if (cond_72073.isBuiltAndTrue ()) {
    var_cas_needsToSavePCLATH = GGS_bool (false) ;
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_71825 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (1935)), true) ;
      const GGS_midrange_interruptDefinitionList::cElement * operand_71825 = NULL ;
      while (((operand_71825 = enumerator_71825.nextObject ()))
          && ((var_cas_needsToSavePCLATH).operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_71825) ;
        {
          GGS_midrange_instructionList::cEnumerator enumerator_71927 (operand_71825->mInstructionList, true) ;
          const GGS_midrange_instructionList::cElement * operand_71927 = NULL ;
          while (((operand_71927 = enumerator_71927.nextObject ()))
              && ((var_cas_needsToSavePCLATH).operator_not ().isBuiltAndTrue ())) {
            macroValidPointer (operand_71927) ;
            { typeCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL method = findCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL (operand_71927->mInstruction.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_71927->mInstruction (HERE), var_cas_needsToSavePCLATH COMMA_SOURCE_FILE_AT_LINE (1937)) ;
              }
            }
          }
        }
  ...
  const GGS_bool cond_73609 = var_cas_inHasInterrupt ;
  if (cond_73609.isBuiltAndTrue ()) {
    ...
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_72614 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (1954)), true) ;
      const GGS_midrange_interruptDefinitionList::cElement * operand_72614 = NULL ;
      while (((operand_72614 = enumerator_72614.nextObject ()))) {
        macroValidPointer (operand_72614) ;
        const GGS_bool cond_73134 = var_cas_inHasSharedRAMBank ;
        if (cond_73134.isBuiltAndTrue ()) {
          ::routine_generateInterruptRoutineForControllerWithSharedRAM (inLexique,  var_cas_inTotalBankCount,  var_cas_inRegisterTable,  operand_72614->mFirstSaveRegister,  operand_72614->mSecondSaveRegister,  var_cas_needsToSavePCLATH,  operand_72614->mInstructionList,  var_cas_routineMap,  var_cas_constantMap,  operand_72614->mEndOfInterruptLocation,  var_cas_outGeneratedInstructionList,  var_cas_localLabelIndex,  var_cas_generationOptimizationMessages COMMA_SOURCE_FILE_AT_LINE (1956)) ;
        }else if (cond_73134.isBuiltAndFalse ()) {
  ...
  GGS_uint _variant_75574 = var_cas_inTotalPageCount ;
  GGS_bool _condition_75574 (_variant_75574.isBuilt (), true) ;
  while (_condition_75574.isBuiltAndTrue ()) {
    _condition_75574 = (var_cas_currentPage).operator_strictInf (var_cas_inTotalPageCount) ;
    if (_condition_75574.isBuiltAndTrue ()) {
      if (_variant_75574.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2034)) ;
        _condition_75574 = GGS_bool (false) ;
      }else{
        _variant_75574.decrement_operation (inLexique COMMA_HERE) ;
        GGS_bool var_cas_orgGenerated = (var_cas_currentPage).operator_isEqual (GGS_uint (0U)) ;
        {
          GGS_midrange_routineDefinitionList::cEnumerator enumerator_73853 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (1992)), true) ;
          const GGS_midrange_routineDefinitionList::cElement * operand_73853 = NULL ;
          while (((operand_73853 = enumerator_73853.nextObject ()))) {
            macroValidPointer (operand_73853) ;
            const GGS_bool cond_75524 = (operand_73853->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1993))).operator_isEqual (var_cas_currentPage) ;
            if (cond_75524.isBuiltAndTrue ()) {
              const GGS_bool cond_74110 = (var_cas_orgGenerated).operator_not () ;
              if (cond_74110.isBuiltAndTrue ()) {
              ...
              GGS_bool var_cas_continuesInSequence ;
              GGS_uint  var_cas_currentBank = operand_73853->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1999)) ;
              GGS_routineKind var_cas_routineKind ;
              const GGS_bool cond_74337 = operand_73853->mIsNoReturn ;
              if (cond_74337.isBuiltAndTrue ()) {
                var_cas_routineKind = GGS_routineKind::constructor_noReturnRoutine (inLexique COMMA_SOURCE_FILE_AT_LINE (2002)) ;
              }else if (cond_74337.isBuiltAndFalse ()) {
                var_cas_routineKind = GGS_routineKind::constructor_regularRoutine (inLexique COMMA_SOURCE_FILE_AT_LINE (2004)) ;
              }
              var_cas_outGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_73853->mRoutineName COMMA_SOURCE_FILE_AT_LINE (2006))) ;
              ::routine_handleMidrangeInstructionList (inLexique,  operand_73853->mInstructionList,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_inTotalBankCount,  var_cas_currentBank,  operand_73853->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (2007)) ;
              const GGS_bool cond_75125 = (((operand_73853->mIsNoReturn).operator_not ()).operator_and ((operand_73853->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2021))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (2021))))).operator_and ((var_cas_currentBank).operator_isNotEqual (operand_73853->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2021)))) ;
              if (cond_75125.isBuiltAndTrue ()) {
                operand_73853->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("execution will not set bank selection to ")).operator_concat (operand_73853->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2022)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2022))) COMMA_SOURCE_FILE_AT_LINE (2023)) ;
              }
              const GGS_bool cond_75286 = (operand_73853->mIsNoReturn).operator_and (var_cas_continuesInSequence) ;
              if (cond_75286.isBuiltAndTrue ()) {
                operand_73853->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2026)) ;
              }
              const GGS_bool cond_75509 = (operand_73853->mIsNoReturn).operator_not () ;
              if (cond_75509.isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList.addAssign_operation (GGS_midrange_ipic_instruction_RETURN ::constructor_new (inLexique, operand_73853->mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (2029)) COMMA_SOURCE_FILE_AT_LINE (2029))) ;
              }
            }
          }
        }
  ...
  const GGS_bool cond_76746 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_76746.isBuiltAndTrue ()) {
    ...
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    const GGS_bool cond_76151 = (var_cas_generationOptimizationMessages.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_76151.isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_76310 = enumerator_76310.nextObject ()))) {
        ...
        if (operand_76310->mInstruction.isBuilt ()) {
          operand_76310->mInstruction (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2049)) ;
        }
        ...
        var_cas_ioListFileContents.appendCString (": ") ;
        if (operand_76310->mInstruction.isBuilt ()) {
          operand_76310->mInstruction (HERE)->method_displayIPICinstruction (inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2051)) ;
        }
        var_cas_ioListFileContents.appendCString ("\n") ;
