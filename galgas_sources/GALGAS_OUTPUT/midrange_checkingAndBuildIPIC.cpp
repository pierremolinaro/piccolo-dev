  ...
  var_cas_outContinuesInSequence = GGS_bool (true) ;
  {
    ...
    while (((operand_3177 = enumerator_3177.nextObject ()))) {
      ...
      if (((var_cas_outContinuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
        operand_3177->mInstruction.reader_mInstructionLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (106)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (107)) ;
        var_cas_outContinuesInSequence = GGS_bool (true) ;
      }
...
category_method__midrange_instruction_nobanksel__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_3853 != NULL) {
    if ((var_cas_inShouldPreserveBank).isBuiltAndTrue ()) {
      operand_3853->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("cannot use \"nobank\" here: bank selection should be preserved (use it in a \"banksave\" construct)") COMMA_SOURCE_FILE_AT_LINE (142)) ;
    }
...
category_method__midrange_instruction_savebank__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_4666 != NULL) {
    ...
    var_cas_STATUS_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("STATUS"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (_temp_5283.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_5283 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (165)) ;
      }
    }
    ...
    if (_temp_5558.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_5558 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_save_IPICregisterDescription, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (174)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, operand_4666->mInstructionLocation, GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_STATUS_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    if (((var_cas_ioContinuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
      operand_4666->mEndOfSaveBankInstruction.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("useless saving: execution does reach the end of \"savebank\" instruction list") COMMA_SOURCE_FILE_AT_LINE (212)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, operand_4666->mInstructionLocation, GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_save_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
...
category_method__midrange_instruction_banksel__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_7349 != NULL) {
    if ((var_cas_inShouldPreserveBank).isBuiltAndTrue ()) {
      operand_7349->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("cannot use \"banksel\" here: bank selection should be preserved (save it with \"banksave\" construct)") COMMA_SOURCE_FILE_AT_LINE (245)) ;
    }
    GGS_registerExpression  var_cas_STATUS_register ;
    var_cas_STATUS_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("STATUS"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    GGS_midrange_ipic_registerExpression var_cas_STATUS_IPICregisterDescription ;
    ...
    if (_temp_8176.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_8176 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (250)) ;
      }
    }
    GGS_lstring  var_cas_RP ;
    var_cas_RP = GGS_lstring ::constructor_new (_inLexique, GGS_string ("RP"), operand_7349->mInstructionLocation COMMA_HERE) ;
    ...
    if (_temp_8414.isBuilt ()) {
      _temp_8414 (HERE)->method_searchKey (_inLexique, var_cas_RP, var_cas_rpIndex, var_cas_sliceSize COMMA_SOURCE_FILE_AT_LINE (260)) ;
    }
    if (((var_cas_sliceSize)._operator_isNotEqual (var_cas_inTotalBankCount._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (261)).reader_significantBitCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)))).isBuiltAndTrue ()) {
      operand_7349->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string ("internal error: sliceSize == "))._operator_concat (var_cas_sliceSize.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (262))))._operator_concat (GGS_string (", significant bit count == ")))._operator_concat (var_cas_inTotalBankCount._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (262)).reader_significantBitCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (262))) COMMA_SOURCE_FILE_AT_LINE (263)) ;
    }
    if (((operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (265)))._operator_isEqual (var_cas_ioCurrentBank)).isBuiltAndTrue ()) {
      operand_7349->mBankIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("useless instruction: the bank "))._operator_concat (var_cas_ioCurrentBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (266))))._operator_concat (GGS_string (" is already selected")) COMMA_SOURCE_FILE_AT_LINE (266)) ;
    }else if (((operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_supOrEqual (var_cas_inTotalBankCount)).isBuiltAndTrue ()) {
      operand_7349->mBankIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the bank "))._operator_concat (operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (268))))._operator_concat (GGS_string (" does not exist (the device has ")))._operator_concat (var_cas_inTotalBankCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (268))))._operator_concat (GGS_string (" bank(s))")) COMMA_SOURCE_FILE_AT_LINE (269)) ;
    }else if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_uint  var_cas_n ;
      var_cas_n = var_cas_inTotalBankCount._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (270)).reader_significantBitCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
      GGS_uint  var_cas_shiftedBank ;
      var_cas_shiftedBank = operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
      ...
      while (_condition_9762.isBuiltAndTrue ()) {
        _condition_9762 = (var_cas_index)._operator_strictInf (var_cas_sliceSize) ;
        if (_condition_9762.isBuiltAndTrue ()) {
          if (_variant_9762.uintValue () == 0) {
            ...
            _variant_9762._decrement_operation (_inLexique COMMA_HERE) ;
            GGS_midrange_bit_oriented_op var_cas_op ;
            if ((((var_cas_shiftedBank)._operator_and (GGS_uint (1U)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            ...
            var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (_inLexique, operand_7349->mInstructionLocation, var_cas_op, var_cas_STATUS_IPICregisterDescription, var_cas_rpIndex._add_operation (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (284)) COMMA_HERE)) ;
            var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (286)) ;
            var_cas_shiftedBank = var_cas_shiftedBank._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (287)) ;
          }
        }
      }
      var_cas_ioCurrentBank = operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (289)) ;
    }else{
      GGS_bool var_cas_optimize ;
      var_cas_optimize = GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (291))) ;
      GGS_uint  var_cas_shiftedBank ;
      var_cas_shiftedBank = operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (292)) ;
      GGS_uint  var_cas_shiftedXorBank ;
      var_cas_shiftedXorBank = (operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)))._operator_xor (var_cas_ioCurrentBank) ;
      GGS_uint  var_cas_index ;
      var_cas_index = GGS_uint (0U) ;
      ...
      while (_condition_10910.isBuiltAndTrue ()) {
        _condition_10910 = (var_cas_index)._operator_strictInf (var_cas_sliceSize) ;
        if (_condition_10910.isBuiltAndTrue ()) {
          if (_variant_10910.uintValue () == 0) {
            ...
            _variant_10910._decrement_operation (_inLexique COMMA_HERE) ;
            GGS_midrange_bit_oriented_op var_cas_op ;
            if ((((var_cas_shiftedBank)._operator_and (GGS_uint (1U)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_op = GGS_midrange_bit_oriented_op::constructor_BCF (_inLexique COMMA_HERE) ;
            }else{
            ...
            if (((((var_cas_shiftedXorBank)._operator_and (GGS_uint (1U)))._operator_isNotEqual (GGS_uint (0U)))._operator_or ((var_cas_optimize)._operator_not ())).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (_inLexique, operand_7349->mInstructionLocation, var_cas_op, var_cas_STATUS_IPICregisterDescription, var_cas_rpIndex._add_operation (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_HERE)) ;
            }else{
            ...
            var_cas_shiftedBank = var_cas_shiftedBank._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (315)) ;
            var_cas_shiftedXorBank = var_cas_shiftedXorBank._right_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (316)) ;
          }
        }
      }
      var_cas_ioCurrentBank = operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (318)) ;
    }
  }
}
...
category_method__midrange_instruction_FD__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_11116 != NULL) {
    ...
    if (_temp_11635.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_11635 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (338)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, operand_11116->mInstructionLocation, operand_11116->mInstruction_FD_base_code, var_cas_IPICregisterDescription, operand_11116->m_W_isDestination COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_F__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_12068 != NULL) {
    ...
    if (_temp_12587.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_12587 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (369)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_F ::constructor_new (_inLexique, operand_12068->mInstructionLocation, operand_12068->mFAinstruction, var_cas_IPICregisterDescription COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_FB__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_12986 != NULL) {
    ...
    if (_temp_13538.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_13538 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (400)) ;
      }
    }
    ...
    if (_temp_13701.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_13701 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (408)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (_inLexique, operand_12986->mInstructionLocation, operand_12986->mBitOrientedOp, var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_JSR__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_14053 != NULL) {
    ...
    if (_temp_14612.isBuilt ()) {
      _temp_14612 (HERE)->method_searchKey (_inLexique, operand_14053->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (440)) ;
    }
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      ...
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_14053->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (442))) ;
      ...
      operand_14053->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (450)) ;
    }
    if ((var_cas_isNoReturn).isBuiltAndTrue ()) {
      operand_14053->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine should be called with a GOTO or JUMP instruction") COMMA_SOURCE_FILE_AT_LINE (453)) ;
    }
    if (((var_cas_preservesBank)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioCurrentBank = var_cas_returnedBank ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_JSR ::constructor_new (_inLexique, operand_14053->mInstructionLocation, operand_14053->mTargetLabel, GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE) COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_CALL__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_15712 != NULL) {
    ...
    if (_temp_16271.isBuilt ()) {
      _temp_16271 (HERE)->method_searchKey (_inLexique, operand_15712->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (486)) ;
    }
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_15712->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (488))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
      ...
      operand_15712->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (496)) ;
    }
    if ((var_cas_isNoReturn).isBuiltAndTrue ()) {
      operand_15712->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine should be called with a GOTO or JUMP instruction") COMMA_SOURCE_FILE_AT_LINE (499)) ;
    }
    if (((var_cas_preservesBank)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioCurrentBank = var_cas_returnedBank ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_CALL ::constructor_new (_inLexique, operand_15712->mInstructionLocation, operand_15712->mTargetLabel COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_JUMP__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_17292 != NULL) {
    ...
    if (_temp_17797.isBuilt ()) {
      _temp_17797 (HERE)->method_searchKey (_inLexique, operand_17292->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (528)) ;
    }
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_17292->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (530))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
      ...
      operand_17292->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (538)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      operand_17292->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a regular routine should be called with a CALL or JSR instruction") COMMA_SOURCE_FILE_AT_LINE (541)) ;
    }
    var_cas_ioContinuesInSequence = GGS_bool (false) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_JUMP ::constructor_new (_inLexique, operand_17292->mInstructionLocation, operand_17292->mTargetLabel, GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE) COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_GOTO__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_18833 != NULL) {
    ...
    if (_temp_19338.isBuilt ()) {
      _temp_19338 (HERE)->method_searchKey (_inLexique, operand_18833->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (570)) ;
    }
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_18833->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (572))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
      ...
      operand_18833->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (580)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      operand_18833->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a regular routine should be called with a CALL or JSR instruction") COMMA_SOURCE_FILE_AT_LINE (583)) ;
    }
    var_cas_ioContinuesInSequence = GGS_bool (false) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (_inLexique, operand_18833->mInstructionLocation, operand_18833->mTargetLabel COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_CLRWDT__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_20296 != NULL) {
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_CLRWDT ::constructor_new (_inLexique, operand_20296->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_CLRW__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_20982 != NULL) {
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_CLRW ::constructor_new (_inLexique, operand_20982->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_NOP__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_21665 != NULL) {
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_NOP ::constructor_new (_inLexique, operand_21665->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_SLEEP__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_22349 != NULL) {
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_SLEEP ::constructor_new (_inLexique, operand_22349->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_literalOperation__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_23046 != NULL) {
    ...
    if (_temp_23508.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_23508 (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (687)) ;
      }
    }
    if ((((var_cas_result)._operator_strictSup (GGS_sint (255L)))._operator_or ((var_cas_result)._operator_strictInf (GGS_sint (128L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
      operand_23046->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("immediate value is evaluated as "))._operator_concat (var_cas_result.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (690))))._operator_concat (GGS_string (" (should be betwween -128 and 255)")) COMMA_SOURCE_FILE_AT_LINE (691)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_literalOperation ::constructor_new (_inLexique, operand_23046->mInstructionLocation, operand_23046->mLiteralInstruction, (var_cas_result)._operator_and (GGS_sint (255L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (696)) COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_MNOP__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_26181 != NULL) {
    if (((operand_26181->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (765)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      operand_26181->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("occurrence argument is zero: no generated code") COMMA_SOURCE_FILE_AT_LINE (766)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_MNOP ::constructor_new (_inLexique, operand_26181->mInstructionLocation, operand_26181->mOccurrenceFactor COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_FOREVER__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_32036 != NULL) {
    ...
    case GGS_routineKind::enum_regularRoutine:
      {
      operand_32036->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a regular routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (911)) ;
      }
      break ;
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_32036->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("an interrupt routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (914)) ;
      }
      break ;
    ...
    var_cas_label0 = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (917))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (918)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label0, operand_32036->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    ::routine_handleMidrangeInstructionList (_inLexique,  operand_32036->mInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_finalBank,  var_cas_inShouldPreserveBank,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (920)) ;
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_32036->mEndOfInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("instruction list does not leave bank selection unchanged") COMMA_SOURCE_FILE_AT_LINE (936)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (_inLexique, operand_32036->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label0, operand_32036->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    var_cas_ioContinuesInSequence = GGS_bool (false) ;
  }
}
...
category_method__midrange_instruction_IF_BitTest__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_33819 != NULL) {
    ...
    if (_temp_34329.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_34329 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (963)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    ...
    if (_temp_34492.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_34492 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (971)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (_inLexique, operand_33819->mInstructionLocation, operand_33819->mSkipIfSet, var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
...
category_method__midrange_incDecRegisterInCondition__buildIPICinstructionForCondition (C_Compiler & _inLexique,
  ...
  if (operand_35889 != NULL) {
    ...
    if (_temp_36313.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_36313 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1033)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_incDecRegisterInCondition ::constructor_new (_inLexique, var_cas_inInstructionLocation, var_cas_IPICregisterDescription, var_cas_inTargetLabel, operand_35889->mIncrement, operand_35889->m_W_isDestination, (operand_35889->mBranchIfZero)._operator_xor (var_cas_inComplementaryBranch) COMMA_HERE)) ;
  }
}
...
category_method__midrange_incDecRegisterInCondition__computeInstructionCountForCondition (C_Compiler &,
  ...
  if (operand_36822 != NULL) {
    if (((operand_36822->mBranchIfZero)._operator_xor (var_cas_inComplementaryBranch)).isBuiltAndTrue ()) {
...
category_method__midrange_negateCondition__computeInstructionCountForCondition (C_Compiler & _inLexique,
  ...
  if (operand_37883 != NULL) {
    ...
    if (_temp_37996.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_37996 (HERE), (var_cas_inComplementaryBranch)._operator_not (), var_cas_outInstructionCount COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      }
    }
  }
}
  ...
  if (operand_38200 != NULL) {
    if ((var_cas_inComplementaryBranch).isBuiltAndTrue ()) {
      ...
      if (_temp_38589.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_38589 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1116)) ;
        }
      }
      ...
      if (_temp_38870.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_38870 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1127)) ;
        }
      }
    }else{
      GGS_string var_cas_label0 ;
      var_cas_label0 = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1139))) ;
      ...
      if (_temp_39243.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_39243 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1140)) ;
        }
      }
      ...
      if (_temp_39517.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_39517 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1151)) ;
        }
      }
...
category_method__midrange_andCondition__computeInstructionCountForCondition (C_Compiler & _inLexique,
  ...
  if (operand_40018 != NULL) {
    ...
    if (_temp_40156.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_40156 (HERE), var_cas_inComplementaryBranch, var_cas_countLeft COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      }
    }
    ...
    if (_temp_40280.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_40280 (HERE), var_cas_inComplementaryBranch, var_cas_countRight COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      }
    }
...
category_method__midrange_bitTest_in_structured_if_condition__buildIPICinstructionForCondition (C_Compiler & _inLexique,
  ...
  if (operand_40543 != NULL) {
    ...
    if (_temp_41000.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_41000 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    ...
    if (_temp_41163.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_41163 (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (1208)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (_inLexique, var_cas_inInstructionLocation, (operand_40543->mBTFSSinstruction)._operator_xor (var_cas_inComplementaryBranch), var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
...
category_method__midrange_instruction_structured_if__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_42062 != NULL) {
    ...
    if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (1253)))).isBuiltAndTrue ()) {
      ...
      if (_temp_42640.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_42640 (HERE), GGS_bool (true), var_cas_directCount COMMA_SOURCE_FILE_AT_LINE (1254)) ;
        }
      }
      if (((operand_42062->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1255)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      if (_temp_42825.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_42825 (HERE), GGS_bool (false), var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1258)) ;
        }
      }
      if (((operand_42062->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1259)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_complementaryCount)._operator_strictInf (var_cas_directCount)).isBuiltAndTrue ()) {
        ...
        if (((var_cas_directCount._substract_operation (_inLexique, var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1266)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_generateComplementaryCondition).isBuiltAndTrue ()) {
      ...
      var_cas_label_nextCondition = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1278))) ;
      ...
      var_cas_label_endOfIfinstruction = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1279))) ;
      ...
      if (_temp_43890.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_43890 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_42062->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        }
      }
      ::routine_handleMidrangeInstructionList (_inLexique,  operand_42062->mElseInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_elseBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_elseContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1293)) ;
      if (((operand_42062->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1308)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (_inLexique, operand_42062->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_nextCondition, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ::routine_handleMidrangeInstructionList (_inLexique,  operand_42062->mThenInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1312)) ;
      if (((operand_42062->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1326)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
    }else{
      GGS_string var_cas_label_nextCondition ;
      var_cas_label_nextCondition = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1331))) ;
      var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1331)) ;
      GGS_string var_cas_label_endOfIfinstruction ;
      var_cas_label_endOfIfinstruction = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1332))) ;
      ...
      if (_temp_45713.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_45713 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_42062->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        }
      }
      ::routine_handleMidrangeInstructionList (_inLexique,  operand_42062->mThenInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      if (((operand_42062->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1361)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (_inLexique, operand_42062->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_nextCondition, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ::routine_handleMidrangeInstructionList (_inLexique,  operand_42062->mElseInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_elseBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_elseContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1365)) ;
      if (((operand_42062->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1379)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
    }
    if (((var_cas_elseBranchFinalBank)._operator_isEqual (var_cas_thenBranchFinalBank)).isBuiltAndTrue ()) {
      ...
      operand_42062->mEndOfElsePartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("This branch does not leave bank selection value as the first one does") COMMA_SOURCE_FILE_AT_LINE (1387)) ;
...
category_method__midrange_instruction_do_while__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_47787 != NULL) {
    ...
    var_cas_labelInstructionBegin = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1409))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1409)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_labelInstructionBegin, operand_47787->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    GGS_uint  var_cas_finalBank ;
    var_cas_finalBank = var_cas_ioCurrentBank ;
    ::routine_handleMidrangeInstructionList (_inLexique,  operand_47787->mRepeatedInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_finalBank,  var_cas_inShouldPreserveBank,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_47787->mEndOfRepeatedInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("This branch does not leave bank selection value unchanged") COMMA_SOURCE_FILE_AT_LINE (1430)) ;
    }
    {
      ...
      while (((operand_48990 = enumerator_48990.nextObject ()))) {
        ...
        if (((operand_48990->mInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1433)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          if (_temp_49087.isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_49087 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_47787->mInstructionLocation, var_cas_labelInstructionBegin, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1434)) ;
            }
          }
        }else{
          GGS_string var_cas_nextBranchLabel ;
          var_cas_nextBranchLabel = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1446))) ;
          ...
          if (_temp_49498.isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_49498 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_47787->mInstructionLocation, var_cas_nextBranchLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1447)) ;
            }
          }
          GGS_uint  var_cas_bank ;
          var_cas_bank = var_cas_ioCurrentBank ;
          ::routine_handleMidrangeInstructionList (_inLexique,  operand_48990->mInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_bank,  var_cas_inShouldPreserveBank,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1459)) ;
          if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_bank)).isBuiltAndTrue ()) {
            operand_48990->mEndOfPartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("This branch does not leave bank selection value unchanged") COMMA_SOURCE_FILE_AT_LINE (1475)) ;
          }
          var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (_inLexique, operand_47787->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_labelInstructionBegin, operand_47787->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
          var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_nextBranchLabel, operand_47787->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
        }
      }
    }
  }
...
category_method__midrange_instruction_IF_IncDec__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_50744 != NULL) {
    ...
    if (_temp_51442.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_51442 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1506)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, operand_50744->mInstructionLocation, var_cas_baseCode, var_cas_IPICregisterDescription, operand_50744->m_W_isDestination COMMA_HERE)) ;
    GGS_bool var_cas_unusedContinuesInSequence ;
    var_cas_unusedContinuesInSequence = GGS_bool (true) ;
    ...
    if (_temp_51818.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_51818 (HERE), var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inShouldPreserveBank, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1522)) ;
      }
    }
  }
}
...
void routine_generateInterruptRoutineForControllerWithSharedRAM (C_Compiler & _inLexique,
  ...
  if (_temp_52853.isBuilt ()) {
    _temp_52853 (HERE)->method_searchKey (_inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (1556)) ;
  }
  ...
  var_cas_accessibleFromBank0 = GGS_bool (false) ;
  {
    ...
    while (((operand_52980 = enumerator_52980.nextObject ()))
      ...
      var_cas_accessibleFromBank0 = ((operand_52980->mValue)._operator_and (GGS_uint (3968U)))._operator_isEqual (GGS_uint (0U)) ;
    }
  }
  if (((var_cas_accessibleFromBank0)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from bank 0")) COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  }
  if (((var_cas_inNeedsToSavePCLATH)._operator_and ((var_cas_size)._operator_isNotEqual (GGS_uint (2U)))).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1565))))._operator_concat (GGS_string (" (it should be 2)")) COMMA_SOURCE_FILE_AT_LINE (1566)) ;
  }else if ((((var_cas_inNeedsToSavePCLATH)._operator_not ())._operator_and ((var_cas_size)._operator_isNotEqual (GGS_uint (1U)))).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1567))))._operator_concat (GGS_string (" (it should be 1)")) COMMA_SOURCE_FILE_AT_LINE (1568)) ;
  }
  ...
  if (_temp_53728.isBuilt ()) {
    _temp_53728 (HERE)->method_searchKey (_inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_12, automatic_var_13 COMMA_SOURCE_FILE_AT_LINE (1570)) ;
  }
  ...
  var_cas_bankAccessibility = GGS_uint (0U) ;
  {
    ...
    while (((operand_53850 = enumerator_53850.nextObject ()))) {
      ...
      var_cas_bankAccessibility = (var_cas_bankAccessibility)._operator_or (GGS_uint (1U)._left_shift_operation (_inLexique, operand_53850->mValue._right_shift_operation (_inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (1573)) COMMA_SOURCE_FILE_AT_LINE (1573))) ;
    }
  }
  if (((var_cas_bankAccessibility._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1575)))._operator_isNotEqual (GGS_uint (1U)._left_shift_operation (_inLexique, var_cas_inTotalBankCount COMMA_SOURCE_FILE_AT_LINE (1575)))).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from any bank")) COMMA_SOURCE_FILE_AT_LINE (1577)) ;
  }
  if (((var_cas_size)._operator_isNotEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1579))))._operator_concat (GGS_string (" (it should be 1)")) COMMA_SOURCE_FILE_AT_LINE (1580)) ;
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_first_register = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (_temp_54558.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_54558 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1585)) ;
      }
    }
    GGS_registerExpression  var_cas_second_register ;
    var_cas_second_register = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inSecondSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (_temp_54876.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_54876 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_second_IPICregisterDescription, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (1594)) ;
      }
    }
    GGS_registerExpression  var_cas_STATUS_register ;
    var_cas_STATUS_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("STATUS"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (_temp_55252.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_55252 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1604)) ;
      }
    }
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_STATUS_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      var_cas_first_register_second_byte = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_56273.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_56273 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1618)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register ;
      var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("PCLATH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_56674.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_56674 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1628)) ;
        }
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_MOVF (_inLexique COMMA_HERE), var_cas_PCLATH_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_inEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1658)) ;
    }
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      GGS_registerExpression  var_cas_first_register_second_byte ;
      var_cas_first_register_second_byte = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_58231.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_58231 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_19 COMMA_SOURCE_FILE_AT_LINE (1662)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register ;
      var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("PCLATH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_58632.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_58632 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (1672)) ;
        }
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_MOVF (_inLexique COMMA_HERE), var_cas_first_var_second_byte_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_first_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_second_IPICregisterDescription, GGS_bool (false) COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_second_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
...
void routine_generateInterruptRoutineForControllerWithoutSharedRAM (C_Compiler & _inLexique,
  ...
  if (_temp_60656.isBuilt ()) {
    _temp_60656 (HERE)->method_searchKey (_inLexique, var_cas_inFirstSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_21, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (1711)) ;
  }
  GGS_bool var_cas_accessibleFromBank0 ;
  var_cas_accessibleFromBank0 = GGS_bool (false) ;
  ...
  var_cas_offset = GGS_uint (0U) ;
  {
    ...
    while (((operand_60816 = enumerator_60816.nextObject ()))
      ...
      var_cas_offset = (operand_60816->mValue)._operator_and (GGS_uint (127U)) ;
      var_cas_accessibleFromBank0 = ((operand_60816->mValue)._operator_and (GGS_uint (3968U)))._operator_isEqual (GGS_uint (0U)) ;
    }
  }
  if (((var_cas_accessibleFromBank0)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from bank 0")) COMMA_SOURCE_FILE_AT_LINE (1720)) ;
  }
  if (((var_cas_inNeedsToSavePCLATH)._operator_and ((var_cas_size)._operator_isNotEqual (GGS_uint (3U)))).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1722))))._operator_concat (GGS_string (" (it should be 3)")) COMMA_SOURCE_FILE_AT_LINE (1723)) ;
  }else if ((((var_cas_inNeedsToSavePCLATH)._operator_not ())._operator_and ((var_cas_size)._operator_isNotEqual (GGS_uint (2U)))).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1724))))._operator_concat (GGS_string (" (it should be 2)")) COMMA_SOURCE_FILE_AT_LINE (1725)) ;
  }
  ...
  if (_temp_61659.isBuilt ()) {
    _temp_61659 (HERE)->method_searchKey (_inLexique, var_cas_inSecondSaveRegister, var_cas_registerAddressList, var_cas_size, automatic_var_23, automatic_var_24 COMMA_SOURCE_FILE_AT_LINE (1728)) ;
  }
  var_cas_saveStatusRegisterAddressList = (var_cas_saveStatusRegisterAddressList)._operator_concat (var_cas_registerAddressList) ;
  if (((var_cas_size)._operator_isNotEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1731))))._operator_concat (GGS_string (" (it should be 1)")) COMMA_SOURCE_FILE_AT_LINE (1732)) ;
  }
  ...
  var_cas_accessibleFromBank1 = GGS_bool (false) ;
  {
    ...
    while (((operand_62084 = enumerator_62084.nextObject ()))
      ...
      var_cas_accessibleFromBank1 = ((operand_62084->mValue)._operator_and (GGS_uint (3968U)))._operator_isEqual (GGS_uint (128U)) ;
    }
  }
  if (((var_cas_accessibleFromBank1)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from bank 1")) COMMA_SOURCE_FILE_AT_LINE (1740)) ;
  }
  ...
  var_cas_offsetOk = GGS_bool (true) ;
  {
    ...
    while (((operand_62495 = enumerator_62495.nextObject ()))
      ...
      var_cas_offsetOk = (var_cas_offset)._operator_isEqual ((operand_62495->mValue)._operator_and (GGS_uint (127U))) ;
      if (((var_cas_offsetOk)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_inSecondSaveRegister.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable has an offset equal to ")))._operator_concat ((operand_62495->mValue)._operator_and (GGS_uint (127U)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1747))))._operator_concat (GGS_string (", while '")))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' has an offset equal to ")))._operator_concat (var_cas_offset.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1748))))._operator_concat (GGS_string (" (tthe two offsets should be equal)")) COMMA_SOURCE_FILE_AT_LINE (1749)) ;
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    if (_temp_63162.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_63162 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (1755)) ;
      }
    }
    GGS_registerExpression  var_cas_first_register_second_byte ;
    var_cas_first_register_second_byte = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (_temp_63515.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_63515 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_reg_second_byte_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (1764)) ;
      }
    }
    GGS_registerExpression  var_cas_STATUS_register ;
    var_cas_STATUS_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("STATUS"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (_temp_63897.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_63897 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_STATUS_IPICregisterDescription, automatic_var_27 COMMA_SOURCE_FILE_AT_LINE (1774)) ;
      }
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_F ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_F_instruction_base_code::constructor_MOVWF (_inLexique COMMA_HERE), var_cas_first_IPICregisterDescription COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_STATUS_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      var_cas_first_register_third_byte = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (2U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_64931.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_64931 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_third_byte_IPICregisterDescription, automatic_var_28 COMMA_SOURCE_FILE_AT_LINE (1788)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register ;
      var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("PCLATH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_65331.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_65331 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_29 COMMA_SOURCE_FILE_AT_LINE (1798)) ;
        }
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_MOVF (_inLexique COMMA_HERE), var_cas_PCLATH_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    ...
    if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_inEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1828)) ;
    }
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      GGS_registerExpression  var_cas_first_register_third_byte ;
      var_cas_first_register_third_byte = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (2U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_66884.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_66884 (HERE), var_cas_inTotalBankCount, GGS_uint (0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_30 COMMA_SOURCE_FILE_AT_LINE (1832)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register ;
      var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("PCLATH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
      ...
      if (_temp_67285.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_67285 (HERE), var_cas_inTotalBankCount, GGS_uint ::constructor_max (_inLexique COMMA_HERE), var_cas_inRegisterTable, var_cas_PCLATH_IPICregisterDescription, automatic_var_31 COMMA_SOURCE_FILE_AT_LINE (1842)) ;
        }
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_MOVF (_inLexique COMMA_HERE), var_cas_first_var_second_byte_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_F ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_F_instruction_base_code::constructor_MOVWF (_inLexique COMMA_HERE), var_cas_PCLATH_IPICregisterDescription COMMA_HERE)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_first_reg_second_byte_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_F ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_F_instruction_base_code::constructor_MOVWF (_inLexique COMMA_HERE), var_cas_STATUS_IPICregisterDescription COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_first_IPICregisterDescription, GGS_bool (false) COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FD ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_midrange_instruction_FD_base_code::constructor_SWAPF (_inLexique COMMA_HERE), var_cas_first_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_RETFIE ::constructor_new (_inLexique, GGS_location (_inLexique) COMMA_HERE)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_build_midrange_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  {
    GGS_midrange_routineDefinitionList::cEnumerator enumerator_69112 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1878)), true) ;
    ...
    while (((operand_69112 = enumerator_69112.nextObject ()))) {
      ...
      if ((((operand_69112->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1879)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_69112->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1879)))._operator_strictSup (GGS_uint (15U)))).isBuiltAndTrue ()) {
        operand_69112->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1881)) ;
      }
      if ((((operand_69112->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1882)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_69112->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1882)))._operator_strictSup (GGS_uint (15U)))).isBuiltAndTrue ()) {
        operand_69112->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1884)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_69112->mRoutineName, operand_69112->mIsNoReturn, operand_69112->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1885)), operand_69112->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1885)), operand_69112->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1885)) ;
    }
  }
  ...
  var_cas_romSizeString = GGS_lstring ::constructor_new (_inLexique, GGS_string ("ROM_SIZE"), GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_constantMap.modifier_insertKey (_inLexique, var_cas_romSizeString, var_cas_inROMSize COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  {
    GGS_constantDefinitionList::cEnumerator enumerator_69912 (var_cas_inPiccoloModel.reader_mConstantDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1893)), true) ;
    ...
    while (((operand_69912 = enumerator_69912.nextObject ()))) {
      ...
      if (_temp_69991.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_69991 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1894)) ;
        }
      }
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_69912->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1895)) COMMA_SOURCE_FILE_AT_LINE (1895))).isBuiltAndTrue ()) {
        operand_69912->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("'"))._operator_concat (operand_69912->mConstantName))._operator_concat (GGS_string ("' is already declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1897)) ;
      }else{
        var_cas_constantMap.modifier_insertKey (_inLexique, operand_69912->mConstantName, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1898)) ;
      }
    }
  }
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1902)))).isBuiltAndTrue ()) {
    ::routine_print_constant_definition (_inLexique,  var_cas_constantMap,  var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1903)) ;
  }
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string ("main") COMMA_SOURCE_FILE_AT_LINE (1909))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    ...
    if (_temp_70680.isBuilt ()) {
      _temp_70680 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_32, automatic_var_33 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1915)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1918)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (1920)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (1921)) ;
  }
  GGS_bool var_cas_needsToSavePCLATH ;
  var_cas_needsToSavePCLATH = GGS_bool (false) ;
  {
    GGS_midrange_routineDefinitionList::cEnumerator enumerator_71322 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1924)), true) ;
    ...
    while (((operand_71322 = enumerator_71322.nextObject ()))) {
      ...
      if (((operand_71322->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1925)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_needsToSavePCLATH = GGS_bool (true) ;
      }
      if (((operand_71322->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1928)))._operator_supOrEqual (var_cas_inTotalPageCount)).isBuiltAndTrue ()) {
        operand_71322->mPage.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("invalid value ("))._operator_concat (operand_71322->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1929)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1929))))._operator_concat (GGS_string ("); the device has ")))._operator_concat (var_cas_inTotalPageCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1929))))._operator_concat (GGS_string (" 2k page(s) on rom")) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      }
    }
  }
  if ((var_cas_needsToSavePCLATH).isBuiltAndTrue ()) {
    var_cas_needsToSavePCLATH = GGS_bool (false) ;
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_71829 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1935)), true) ;
        ...
        macroValidPointer (operand_71829) ;
        {
          ...
          while (((operand_71931 = enumerator_71931.nextObject ()))
            ...
            if (_temp_72010.isBuilt ()) {
              ...
              if (_method != NULL) {
                _method (_inLexique, _temp_72010 (HERE), var_cas_needsToSavePCLATH COMMA_SOURCE_FILE_AT_LINE (1937)) ;
              }
            }
          }
        }
  ...
  var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_lstring ::constructor_new (_inLexique, GGS_string ("main"), GGS_location (_inLexique) COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE) COMMA_HERE)) ;
  if ((var_cas_inHasInterrupt).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_ORG ::constructor_new (_inLexique, GGS_uint (4U) COMMA_HERE)) ;
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_72618 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1954)), true) ;
      ...
      while (((operand_72618 = enumerator_72618.nextObject ()))) {
        ...
        if ((var_cas_inHasSharedRAMBank).isBuiltAndTrue ()) {
          ::routine_generateInterruptRoutineForControllerWithSharedRAM (_inLexique,  var_cas_inTotalBankCount,  var_cas_inRegisterTable,  operand_72618->mFirstSaveRegister,  operand_72618->mSecondSaveRegister,  var_cas_needsToSavePCLATH,  operand_72618->mInstructionList,  var_cas_routineMap,  var_cas_constantMap,  operand_72618->mEndOfInterruptLocation,  var_cas_outGeneratedInstructionList,  var_cas_localLabelIndex,  var_cas_generationOptimizationMessages COMMA_SOURCE_FILE_AT_LINE (1956)) ;
        }else{
          ::routine_generateInterruptRoutineForControllerWithoutSharedRAM (_inLexique,  var_cas_inTotalBankCount,  var_cas_inRegisterTable,  operand_72618->mFirstSaveRegister,  operand_72618->mSecondSaveRegister,  var_cas_needsToSavePCLATH,  operand_72618->mInstructionList,  var_cas_routineMap,  var_cas_constantMap,  operand_72618->mEndOfInterruptLocation,  var_cas_outGeneratedInstructionList,  var_cas_localLabelIndex,  var_cas_generationOptimizationMessages COMMA_SOURCE_FILE_AT_LINE (1971)) ;
        }
      }
    }
  }
  ...
  while (_condition_75578.isBuiltAndTrue ()) {
    _condition_75578 = (var_cas_currentPage)._operator_strictInf (var_cas_inTotalPageCount) ;
    if (_condition_75578.isBuiltAndTrue ()) {
      if (_variant_75578.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2034)) ;
        _condition_75578 = GGS_bool (false) ;
      }else{
        _variant_75578._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_bool var_cas_orgGenerated ;
        var_cas_orgGenerated = (var_cas_currentPage)._operator_isEqual (GGS_uint (0U)) ;
        {
          GGS_midrange_routineDefinitionList::cEnumerator enumerator_73857 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1992)), true) ;
          ...
          while (((operand_73857 = enumerator_73857.nextObject ()))) {
            ...
            if (((operand_73857->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1993)))._operator_isEqual (var_cas_currentPage)).isBuiltAndTrue ()) {
              if (((var_cas_orgGenerated)._operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_currentPage._multiply_operation (_inLexique, GGS_uint (2048U) COMMA_SOURCE_FILE_AT_LINE (1995)) COMMA_HERE)) ;
                var_cas_orgGenerated = GGS_bool (true) ;
              }
              GGS_bool var_cas_continuesInSequence ;
              GGS_uint  var_cas_currentBank ;
              var_cas_currentBank = operand_73857->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1999)) ;
              ...
              var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_73857->mRoutineName COMMA_HERE)) ;
              ::routine_handleMidrangeInstructionList (_inLexique,  operand_73857->mInstructionList,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_inTotalBankCount,  var_cas_currentBank,  operand_73857->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (2007)) ;
              if (((((operand_73857->mIsNoReturn)._operator_not ())._operator_and ((operand_73857->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2021)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_73857->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2021))))).isBuiltAndTrue ()) {
                operand_73857->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("execution will not set bank selection to "))._operator_concat (operand_73857->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2022)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2022))) COMMA_SOURCE_FILE_AT_LINE (2023)) ;
              }
              if (((operand_73857->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
                operand_73857->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2026)) ;
              }
              if (((operand_73857->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_73857->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2029)) COMMA_HERE)) ;
              }
            }
          }
        }
        var_cas_currentPage._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2033)) ;
      }
    }
  }
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2036)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (2037))) ;
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (2038))) ;
    var_cas_ioListFileContents.appendCString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (2039))) ;
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2040)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_currentAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_76310 = enumerator_76310.nextObject ()))) {
        ...
        if (_temp_76351.isBuilt ()) {
          _temp_76351 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2049)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2050)).reader_stringByLeftPadding (_inLexique, GGS_uint (5U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (2050))) ;
        var_cas_ioListFileContents.appendCString (": ") ;
        const GGS_midrange_ipic_instruction  _temp_76496 = operand_76310->mInstruction ;
        if (_temp_76496.isBuilt ()) {
          _temp_76496 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2051)) ;
        }
        var_cas_ioListFileContents.appendCString ("\n") ;
        var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2053)) ;
      }
    }
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("Minimum code size without optimization: ") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2056))) ;
