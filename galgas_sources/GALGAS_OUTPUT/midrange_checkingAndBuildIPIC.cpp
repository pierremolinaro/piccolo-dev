...
//                    november 29th, 2008, at 15h59'41"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__midrange_instruction_banksel__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_7349 != NULL) {
    if ((var_cas_inShouldPreserveBank).isBuiltAndTrue ()) {
      operand_7349->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "cannot use \"banksel\" here: bank selection should be preserved (save it with \"banksave\" construct)") COMMA_SOURCE_FILE_AT_LINE (245)) ;
    }
    GGS_registerExpression  var_cas_STATUS_register ;
    var_cas_STATUS_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "STATUS"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    GGS_midrange_ipic_registerExpression var_cas_STATUS_IPICregisterDescription ;
    ...
    var_cas_RP = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "RP"), operand_7349->mInstructionLocation COMMA_HERE) ;
    GGS_uint  var_cas_rpIndex ;
    GGS_uint  var_cas_sliceSize ;
    const GGS_bitSliceTable  _temp_8414 = var_cas_bitSliceTable ;
    if (_temp_8414._isBuilt ()) {
    ...
    if (((operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (265)))._operator_isEqual (var_cas_ioCurrentBank)).isBuiltAndTrue ()) {
      ...
      operand_7349->mBankIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the bank "))._operator_concat (operand_7349->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (268))))._operator_concat (GGS_string (true, " does not exist (the device has ")))._operator_concat (var_cas_inTotalBankCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (268))))._operator_concat (GGS_string (true, " bank(s))")) COMMA_SOURCE_FILE_AT_LINE (269)) ;
      ...
      GGS_bool _condition_9762 (_variant_9762._isBuilt (), true) ;
      while (_condition_9762.isBuiltAndTrue ()) {
        ...
        if (_condition_9762.isBuiltAndTrue ()) {
          if (_variant_9762.uintValue () == 0) {
            ...
            _condition_9762 = GGS_bool (true, false) ;
          }else{
      ...
      GGS_bool _condition_10910 (_variant_10910._isBuilt (), true) ;
      while (_condition_10910.isBuiltAndTrue ()) {
        ...
        if (_condition_10910.isBuiltAndTrue ()) {
          if (_variant_10910.uintValue () == 0) {
            ...
            _condition_10910 = GGS_bool (true, false) ;
          }else{
...
category_method__midrange_instruction_JSR__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_14053 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      ...
      var_cas_errorMessage = (((GGS_string (true, "the routine '"))._operator_concat (operand_14053->mTargetLabel))._operator_concat (GGS_string (true, "' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (442))) ;
    ...
    if ((var_cas_isNoReturn).isBuiltAndTrue ()) {
      operand_14053->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine should be called with a GOTO or JUMP instruction") COMMA_SOURCE_FILE_AT_LINE (453)) ;
    }
...
category_method__midrange_instruction_CALL__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_15712 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string (true, "the routine '"))._operator_concat (operand_15712->mTargetLabel))._operator_concat (GGS_string (true, "' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (488))) ;
      var_cas_errorMessage.writeString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.writeString ("does contain any reliable value") ;
      }else{
    ...
    if ((var_cas_isNoReturn).isBuiltAndTrue ()) {
      operand_15712->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine should be called with a GOTO or JUMP instruction") COMMA_SOURCE_FILE_AT_LINE (499)) ;
    }
    if (((var_cas_preservesBank)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioCurrentBank = var_cas_returnedBank ;
    }
...
category_method__midrange_instruction_JUMP__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_17292 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string (true, "the routine '"))._operator_concat (operand_17292->mTargetLabel))._operator_concat (GGS_string (true, "' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (530))) ;
      var_cas_errorMessage.writeString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.writeString ("does contain any reliable value") ;
      }else{
    ...
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      operand_17292->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a regular routine should be called with a CALL or JSR instruction") COMMA_SOURCE_FILE_AT_LINE (541)) ;
    }
...
category_method__midrange_instruction_GOTO__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_18833 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string (true, "the routine '"))._operator_concat (operand_18833->mTargetLabel))._operator_concat (GGS_string (true, "' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (572))) ;
      var_cas_errorMessage.writeString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.writeString ("does contain any reliable value") ;
      }else{
    ...
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      operand_18833->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a regular routine should be called with a CALL or JSR instruction") COMMA_SOURCE_FILE_AT_LINE (583)) ;
    }
    var_cas_ioContinuesInSequence = GGS_bool (true, false) ;
...
category_method__midrange_instruction_MNOP__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_26181 != NULL) {
    if (((operand_26181->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (765)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_26181->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "occurrence argument is zero: no generated code") COMMA_SOURCE_FILE_AT_LINE (766)) ;
    }
...
category_method__midrange_instruction_FOREVER__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_32036 != NULL) {
    ...
    case GGS_routineKind::enum_regularRoutine:
      {
      operand_32036->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a regular routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (911)) ;
      }
      break ;
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_32036->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an interrupt routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (914)) ;
      }
      break ;
    ...
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_32036->mEndOfInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "instruction list does not leave bank selection unchanged") COMMA_SOURCE_FILE_AT_LINE (936)) ;
    }
  ...
  if (operand_38200 != NULL) {
    if ((var_cas_inComplementaryBranch).isBuiltAndTrue ()) {
      ...
      if (_temp_38589._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_38589 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1116)) ;
        }
      }
      const GGS_midrange_conditionExpression  _temp_38870 = operand_38200->mRightExpression ;
      if (_temp_38870._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_38870 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1127)) ;
        }
      }
    }else{
      GGS_string var_cas_label0 ;
      ...
      if (_temp_39243._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_39243 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, true), var_cas_inInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1140)) ;
        }
      }
      const GGS_midrange_conditionExpression  _temp_39517 = operand_38200->mRightExpression ;
      if (_temp_39517._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_39517 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, false), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1151)) ;
        }
      }
  ...
  if (operand_42062 != NULL) {
    ...
    if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (1253)))).isBuiltAndTrue ()) {
      ...
      if (_temp_42640._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_42640 (HERE), GGS_bool (true, true), var_cas_directCount COMMA_SOURCE_FILE_AT_LINE (1254)) ;
        }
      }
      if (((operand_42062->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1255)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      if (_temp_42825._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_42825 (HERE), GGS_bool (true, false), var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1258)) ;
        }
      }
      if (((operand_42062->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1259)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_generateComplementaryCondition).isBuiltAndTrue ()) {
      ...
      if (_temp_43890._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_43890 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, false), operand_42062->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        }
      }
      ...
      if (((operand_42062->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1308)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      if (((operand_42062->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1326)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      if (_temp_45713._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_45713 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, true), operand_42062->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        }
      }
      ::routine_handleMidrangeInstructionList (_inLexique,  operand_42062->mThenInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      if (((operand_42062->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1361)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (_inLexique, operand_42062->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_nextCondition, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ::routine_handleMidrangeInstructionList (_inLexique,  operand_42062->mElseInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_elseBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_elseContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1365)) ;
      if (((operand_42062->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1379)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
    }
    if (((var_cas_elseBranchFinalBank)._operator_isEqual (var_cas_thenBranchFinalBank)).isBuiltAndTrue ()) {
      ...
      operand_42062->mEndOfElsePartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave bank selection value as the first one does") COMMA_SOURCE_FILE_AT_LINE (1387)) ;
...
category_method__midrange_instruction_do_while__build_midrange_ipic_instructionList (C_Compiler & _inLexique,
  ...
  if (operand_47787 != NULL) {
    ...
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_47787->mEndOfRepeatedInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave bank selection value unchanged") COMMA_SOURCE_FILE_AT_LINE (1430)) ;
    }
    {
      ...
      while (((operand_48990 = enumerator_48990.nextObject ()))) {
        ...
        if (((operand_48990->mInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1433)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          const GGS_midrange_conditionExpression  _temp_49087 = operand_48990->mCondition ;
          if (_temp_49087._isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_49087 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, false), operand_47787->mInstructionLocation, var_cas_labelInstructionBegin, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1434)) ;
            }
          }
        }else{
          ...
          if (_temp_49498._isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_49498 (HERE), var_cas_inTotalBankCount, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true, true), operand_47787->mInstructionLocation, var_cas_nextBranchLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1447)) ;
            }
          }
          ...
          if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_bank)).isBuiltAndTrue ()) {
            operand_48990->mEndOfPartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave bank selection value unchanged") COMMA_SOURCE_FILE_AT_LINE (1475)) ;
          }
...
void routine_generateInterruptRoutineForControllerWithSharedRAM (C_Compiler & _inLexique,
  ...
  var_cas_accessibleFromBank0 = GGS_bool (true, false) ;
  {
    ...
    while (((operand_52980 = enumerator_52980.nextObject ()))
      ...
      var_cas_accessibleFromBank0 = ((operand_52980->mValue)._operator_and (GGS_uint (true, 3968U)))._operator_isEqual (GGS_uint (true, 0U)) ;
    }
  }
  ...
  var_cas_bankAccessibility = GGS_uint (true, 0U) ;
  {
    ...
    while (((operand_53850 = enumerator_53850.nextObject ()))) {
      ...
      var_cas_bankAccessibility = (var_cas_bankAccessibility)._operator_or (GGS_uint (true, 1U)._left_shift_operation (_inLexique, operand_53850->mValue._right_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (1573)) COMMA_SOURCE_FILE_AT_LINE (1573))) ;
    }
  }
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (_temp_54558._isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_54558 (HERE), var_cas_inTotalBankCount, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1585)) ;
      }
    }
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      if (_temp_56273._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_56273 (HERE), var_cas_inTotalBankCount, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1618)) ;
        }
      }
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      if (_temp_58231._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_58231 (HERE), var_cas_inTotalBankCount, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_19 COMMA_SOURCE_FILE_AT_LINE (1662)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register ;
      var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "PCLATH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
...
void routine_generateInterruptRoutineForControllerWithoutSharedRAM (C_Compiler & _inLexique,
  ...
  var_cas_offset = GGS_uint (true, 0U) ;
  {
    ...
    while (((operand_60816 = enumerator_60816.nextObject ()))
      ...
      var_cas_offset = (operand_60816->mValue)._operator_and (GGS_uint (true, 127U)) ;
      var_cas_accessibleFromBank0 = ((operand_60816->mValue)._operator_and (GGS_uint (true, 3968U)))._operator_isEqual (GGS_uint (true, 0U)) ;
    }
  }
  if (((var_cas_accessibleFromBank0)._operator_not ()).isBuiltAndTrue ()) {
  ...
  var_cas_accessibleFromBank1 = GGS_bool (true, false) ;
  {
    ...
    while (((operand_62084 = enumerator_62084.nextObject ()))
      ...
      var_cas_accessibleFromBank1 = ((operand_62084->mValue)._operator_and (GGS_uint (true, 3968U)))._operator_isEqual (GGS_uint (true, 128U)) ;
    }
  }
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (_temp_63162._isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_63162 (HERE), var_cas_inTotalBankCount, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_first_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (1755)) ;
      }
    }
    GGS_registerExpression  var_cas_first_register_second_byte ;
    var_cas_first_register_second_byte = GGS_registerExpression ::constructor_new (_inLexique, var_cas_inFirstSaveRegister, GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 1U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (_temp_63515._isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (_inLexique, _temp_63515 (HERE), var_cas_inTotalBankCount, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_first_reg_second_byte_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (1764)) ;
      }
    }
    GGS_registerExpression  var_cas_STATUS_register ;
    var_cas_STATUS_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "STATUS"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      if (_temp_64931._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_64931 (HERE), var_cas_inTotalBankCount, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_first_var_third_byte_IPICregisterDescription, automatic_var_28 COMMA_SOURCE_FILE_AT_LINE (1788)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register ;
      var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "PCLATH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if ((var_cas_inNeedsToSavePCLATH).isBuiltAndTrue ()) {
      ...
      if (_temp_66884._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_66884 (HERE), var_cas_inTotalBankCount, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_first_var_second_byte_IPICregisterDescription, automatic_var_30 COMMA_SOURCE_FILE_AT_LINE (1832)) ;
        }
      }
      GGS_registerExpression  var_cas_PCLATH_register ;
      var_cas_PCLATH_register = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "PCLATH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
...
void routine_build_midrange_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  {
    GGS_midrange_routineDefinitionList::cEnumerator enumerator_69092 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1877)), true) ;
    ...
    while (((operand_69092 = enumerator_69092.nextObject ()))) {
      ...
      if ((((operand_69092->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1878)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_69092->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1878)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_69092->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1880)) ;
      }
      if ((((operand_69092->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1881)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_69092->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1881)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_69092->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1883)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_69092->mRoutineName, operand_69092->mIsNoReturn, operand_69092->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1884)), operand_69092->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1884)), operand_69092->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1884)) ;
    }
  }
  GGS_constantMap  var_cas_constantMap ;
  var_cas_constantMap = GGS_constantMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    GGS_constantDefinitionList::cEnumerator enumerator_69728 (var_cas_inPiccoloModel.reader_mConstantDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1888)), true) ;
    const GGS_constantDefinitionList::cElement * operand_69728 = NULL ;
    while (((operand_69728 = enumerator_69728.nextObject ()))) {
      macroValidPointer (operand_69728) ;
      GGS_sint  var_cas_result ;
      const GGS_immediatExpression  _temp_69807 = operand_69728->mExpression ;
      if (_temp_69807._isBuilt ()) {
        typeCategoryMethod__immediatExpression__eval _method = findCategoryMethod__immediatExpression__eval (_temp_69807._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_69807 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1889)) ;
        }
      }
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_69728->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1890)) COMMA_SOURCE_FILE_AT_LINE (1890))).isBuiltAndTrue ()) {
        operand_69728->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_69728->mConstantName))._operator_concat (GGS_string (true, "' is already declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1892)) ;
      }else{
        var_cas_constantMap.modifier_insertKey (_inLexique, operand_69728->mConstantName, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1893)) ;
      }
    }
  }
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1897)))).isBuiltAndTrue ()) {
    ::routine_print_constant_definition (_inLexique,  var_cas_constantMap,  var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1898)) ;
  }
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (1904))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_32 ;
    GGS_bool automatic_var_33 ;
    const GGS_routineMap  _temp_70496 = var_cas_routineMap ;
    if (_temp_70496._isBuilt ()) {
      _temp_70496 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_32, automatic_var_33 COMMA_SOURCE_FILE_AT_LINE (1907)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1910)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1913)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (1915)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (1916)) ;
  }
  GGS_bool var_cas_needsToSavePCLATH ;
  var_cas_needsToSavePCLATH = GGS_bool (true, false) ;
  {
    GGS_midrange_routineDefinitionList::cEnumerator enumerator_71138 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1919)), true) ;
    const GGS_midrange_routineDefinitionList::cElement * operand_71138 = NULL ;
    while (((operand_71138 = enumerator_71138.nextObject ()))) {
      macroValidPointer (operand_71138) ;
      if (((operand_71138->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1920)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_needsToSavePCLATH = GGS_bool (true, true) ;
      }
      if (((operand_71138->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1923)))._operator_supOrEqual (var_cas_inTotalPageCount)).isBuiltAndTrue ()) {
        operand_71138->mPage.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "invalid value ("))._operator_concat (operand_71138->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1924)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1924))))._operator_concat (GGS_string (true, "); the device has ")))._operator_concat (var_cas_inTotalPageCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1924))))._operator_concat (GGS_string (true, " 2k page(s) on rom")) COMMA_SOURCE_FILE_AT_LINE (1925)) ;
      }
    }
  }
  if ((var_cas_needsToSavePCLATH).isBuiltAndTrue ()) {
    var_cas_needsToSavePCLATH = GGS_bool (true, false) ;
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_71645 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1930)), true) ;
      const GGS_midrange_interruptDefinitionList::cElement * operand_71645 = NULL ;
      while (((operand_71645 = enumerator_71645.nextObject ()))
          && ((var_cas_needsToSavePCLATH)._operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_71645) ;
        {
          GGS_midrange_instructionList::cEnumerator enumerator_71747 (operand_71645->mInstructionList, true) ;
          const GGS_midrange_instructionList::cElement * operand_71747 = NULL ;
          while (((operand_71747 = enumerator_71747.nextObject ()))
              && ((var_cas_needsToSavePCLATH)._operator_not ().isBuiltAndTrue ())) {
            macroValidPointer (operand_71747) ;
            const GGS_midrange_instruction  _temp_71826 = operand_71747->mInstruction ;
            if (_temp_71826._isBuilt ()) {
              typeCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL _method = findCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL (_temp_71826._galgasObjectRunTimeInfo ()) ;
              if (_method != NULL) {
                _method (_inLexique, _temp_71826 (HERE), var_cas_needsToSavePCLATH COMMA_SOURCE_FILE_AT_LINE (1932)) ;
              }
            }
          }
        }
  ...
  if ((var_cas_inHasInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_72434 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1949)), true) ;
      const GGS_midrange_interruptDefinitionList::cElement * operand_72434 = NULL ;
      while (((operand_72434 = enumerator_72434.nextObject ()))) {
        macroValidPointer (operand_72434) ;
        if ((var_cas_inHasSharedRAMBank).isBuiltAndTrue ()) {
          ::routine_generateInterruptRoutineForControllerWithSharedRAM (_inLexique,  var_cas_inTotalBankCount,  var_cas_inRegisterTable,  operand_72434->mFirstSaveRegister,  operand_72434->mSecondSaveRegister,  var_cas_needsToSavePCLATH,  operand_72434->mInstructionList,  var_cas_routineMap,  var_cas_constantMap,  operand_72434->mEndOfInterruptLocation,  var_cas_outGeneratedInstructionList,  var_cas_localLabelIndex,  var_cas_generationOptimizationMessages COMMA_SOURCE_FILE_AT_LINE (1951)) ;
        }else{
          ::routine_generateInterruptRoutineForControllerWithoutSharedRAM (_inLexique,  var_cas_inTotalBankCount,  var_cas_inRegisterTable,  operand_72434->mFirstSaveRegister,  operand_72434->mSecondSaveRegister,  var_cas_needsToSavePCLATH,  operand_72434->mInstructionList,  var_cas_routineMap,  var_cas_constantMap,  operand_72434->mEndOfInterruptLocation,  var_cas_outGeneratedInstructionList,  var_cas_localLabelIndex,  var_cas_generationOptimizationMessages COMMA_SOURCE_FILE_AT_LINE (1966)) ;
        }
      }
    }
  }
  ...
  GGS_uint _variant_75394 = var_cas_inTotalPageCount ;
  GGS_bool _condition_75394 (_variant_75394._isBuilt (), true) ;
  while (_condition_75394.isBuiltAndTrue ()) {
    _condition_75394 = (var_cas_currentPage)._operator_strictInf (var_cas_inTotalPageCount) ;
    if (_condition_75394.isBuiltAndTrue ()) {
      if (_variant_75394.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2029)) ;
        _condition_75394 = GGS_bool (true, false) ;
      }else{
        _variant_75394._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_bool var_cas_orgGenerated ;
        var_cas_orgGenerated = (var_cas_currentPage)._operator_isEqual (GGS_uint (true, 0U)) ;
        {
          GGS_midrange_routineDefinitionList::cEnumerator enumerator_73673 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1987)), true) ;
          const GGS_midrange_routineDefinitionList::cElement * operand_73673 = NULL ;
          while (((operand_73673 = enumerator_73673.nextObject ()))) {
            macroValidPointer (operand_73673) ;
            if (((operand_73673->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1988)))._operator_isEqual (var_cas_currentPage)).isBuiltAndTrue ()) {
              if (((var_cas_orgGenerated)._operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_currentPage._multiply_operation (_inLexique, GGS_uint (true, 2048U) COMMA_SOURCE_FILE_AT_LINE (1990)) COMMA_HERE)) ;
                var_cas_orgGenerated = GGS_bool (true, true) ;
              }
              GGS_bool var_cas_continuesInSequence ;
              GGS_uint  var_cas_currentBank ;
              var_cas_currentBank = operand_73673->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1994)) ;
              GGS_routineKind var_cas_routineKind ;
              if ((operand_73673->mIsNoReturn).isBuiltAndTrue ()) {
              ...
              var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_73673->mRoutineName COMMA_HERE)) ;
              ::routine_handleMidrangeInstructionList (_inLexique,  operand_73673->mInstructionList,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_inTotalBankCount,  var_cas_currentBank,  operand_73673->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (2002)) ;
              if (((((operand_73673->mIsNoReturn)._operator_not ())._operator_and ((operand_73673->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2016)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_73673->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2016))))).isBuiltAndTrue ()) {
                operand_73673->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set bank selection to "))._operator_concat (operand_73673->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2017)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2017))) COMMA_SOURCE_FILE_AT_LINE (2018)) ;
              }
              if (((operand_73673->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
                operand_73673->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2021)) ;
              }
              if (((operand_73673->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_73673->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2024)) COMMA_HERE)) ;
              }
            }
          }
        }
        var_cas_currentPage._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2028)) ;
      }
    }
  }
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2031)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2032))) ;
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2033))) ;
    var_cas_ioListFileContents.writeString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2034))) ;
    var_cas_ioListFileContents.writeString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2035)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_midrange_ipic_instructionList::cEnumerator enumerator_76126 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_midrange_ipic_instructionList::cElement * operand_76126 = NULL ;
      while (((operand_76126 = enumerator_76126.nextObject ()))) {
        macroValidPointer (operand_76126) ;
        const GGS_midrange_ipic_instruction  _temp_76167 = operand_76126->mInstruction ;
        if (_temp_76167._isBuilt ()) {
          _temp_76167 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2044)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2045)).reader_stringByLeftPadding (_inLexique, GGS_uint (true, 5U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2045))) ;
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_midrange_ipic_instruction  _temp_76312 = operand_76126->mInstruction ;
        if (_temp_76312._isBuilt ()) {
          _temp_76312 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2046)) ;
        }
        var_cas_ioListFileContents.writeString ("\n") ;
        var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2048)) ;
      }
    }
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("Minimum code size without optimization: ") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2051))) ;
