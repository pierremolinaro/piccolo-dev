...
category_method__midrange_instruction_banksel__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_7349 != NULL) {
    ...
    if (((var_cas_sliceSize)._operator_isNotEqual (var_cas_inTotalBankCount._substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (261)).reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (261)))).isBuiltAndTrue ()) {
      operand_7349->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("internal error: sliceSize == "))._operator_concat (var_cas_sliceSize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262))))._operator_concat (GGS_string (", significant bit count == ")))._operator_concat (var_cas_inTotalBankCount._substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (262)).reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262))) COMMA_SOURCE_FILE_AT_LINE (263)) ;
    }
    if (((operand_7349->mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (265)))._operator_isEqual (var_cas_ioCurrentBank)).isBuiltAndTrue ()) {
      operand_7349->mBankIndex.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("useless instruction: the bank "))._operator_concat (var_cas_ioCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266))))._operator_concat (GGS_string (" is already selected")) COMMA_SOURCE_FILE_AT_LINE (266)) ;
    }else if (((operand_7349->mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_supOrEqual (var_cas_inTotalBankCount)).isBuiltAndTrue ()) {
      operand_7349->mBankIndex.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the bank "))._operator_concat (operand_7349->mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (268)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (268))))._operator_concat (GGS_string (" does not exist (the device has ")))._operator_concat (var_cas_inTotalBankCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (268))))._operator_concat (GGS_string (" bank(s))")) COMMA_SOURCE_FILE_AT_LINE (269)) ;
    }else if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_uint  var_cas_n ;
      var_cas_n = var_cas_inTotalBankCount._substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (270)).reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
      ...
      while (_condition_9762.isBuiltAndTrue ()) {
        ...
        if (_condition_9762.isBuiltAndTrue ()) {
          if (_variant_9762.uintValue () == 0) {
            ...
            _variant_9762._decrement_operation (inLexique COMMA_HERE) ;
            ...
            var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (inLexique, operand_7349->mInstructionLocation, var_cas_op, var_cas_STATUS_IPICregisterDescription, var_cas_rpIndex._add_operation (inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (284)) COMMA_HERE)) ;
            var_cas_index._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (286)) ;
            var_cas_shiftedBank = var_cas_shiftedBank._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (287)) ;
          }
        }
      }
      ...
      var_cas_shiftedXorBank = (operand_7349->mBankIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (293)))._operator_xor (var_cas_ioCurrentBank) ;
      GGS_uint  var_cas_index ;
      var_cas_index = GGS_uint (0U) ;
      ...
      while (_condition_10910.isBuiltAndTrue ()) {
        ...
        if (_condition_10910.isBuiltAndTrue ()) {
          if (_variant_10910.uintValue () == 0) {
            ...
            _variant_10910._decrement_operation (inLexique COMMA_HERE) ;
            GGS_midrange_bit_oriented_op var_cas_op ;
            if ((((var_cas_shiftedBank)._operator_and (GGS_uint (1U)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_op = GGS_midrange_bit_oriented_op::constructor_BCF (inLexique COMMA_HERE) ;
            }else{
            ...
            if (((((var_cas_shiftedXorBank)._operator_and (GGS_uint (1U)))._operator_isNotEqual (GGS_uint (0U)))._operator_or ((var_cas_optimize)._operator_not ())).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_FB ::constructor_new (inLexique, operand_7349->mInstructionLocation, var_cas_op, var_cas_STATUS_IPICregisterDescription, var_cas_rpIndex._add_operation (inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_HERE)) ;
            }else{
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_ioGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (310)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (310))) ;
              var_cas_ioListFileContents.appendCString (": useless '") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_op.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (311))) ;
              var_cas_ioListFileContents.appendCString (" STATUS, ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_rpIndex._add_operation (inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (312)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (312))) ;
              var_cas_ioListFileContents.appendCString ("' not generated\n") ;
            }
            var_cas_index._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (314)) ;
            var_cas_shiftedBank = var_cas_shiftedBank._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (315)) ;
            var_cas_shiftedXorBank = var_cas_shiftedXorBank._right_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (316)) ;
          }
        }
      }
...
category_method__midrange_instruction_JSR__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_14053 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      ...
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_14053->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (442))) ;
      ...
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        ...
        var_cas_errorMessage._dotAssign_operation (var_cas_ioCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (447))) ;
      }
...
category_method__midrange_instruction_CALL__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_15712 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_15712->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (488))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
        var_cas_errorMessage.appendCString ("is set to ") ;
        var_cas_errorMessage._dotAssign_operation (var_cas_ioCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (493))) ;
      }
...
category_method__midrange_instruction_JUMP__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_17292 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_17292->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (530))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
        var_cas_errorMessage.appendCString ("is set to ") ;
        var_cas_errorMessage._dotAssign_operation (var_cas_ioCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (535))) ;
      }
...
category_method__midrange_instruction_GOTO__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_18833 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_18833->mTargetLabel))._operator_concat (GGS_string ("' requires bank selection to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (572))) ;
      var_cas_errorMessage.appendCString (", but bank selection ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
        var_cas_errorMessage.appendCString ("is set to ") ;
        var_cas_errorMessage._dotAssign_operation (var_cas_ioCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (577))) ;
      }
...
category_method__midrange_instruction_literalOperation__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_23046 != NULL) {
    ...
    if ((((var_cas_result)._operator_strictSup (GGS_sint (255L)))._operator_or ((var_cas_result)._operator_strictInf (GGS_sint (128L)._operator_unary_minus (inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
      operand_23046->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("immediate value is evaluated as "))._operator_concat (var_cas_result.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (690))))._operator_concat (GGS_string (" (should be betwween -128 and 255)")) COMMA_SOURCE_FILE_AT_LINE (691)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_literalOperation ::constructor_new (inLexique, operand_23046->mInstructionLocation, operand_23046->mLiteralInstruction, (var_cas_result)._operator_and (GGS_sint (255L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (696)) COMMA_HERE)) ;
  }
}
...
category_method__midrange_instruction_MNOP__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_26181 != NULL) {
    if (((operand_26181->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (765)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
...
category_method__midrange_instruction_FOREVER__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_32036 != NULL) {
    ...
    var_cas_label0 = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (917))) ;
    var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (918)) ;
...
category_method__midrange_negateCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_37158 != NULL) {
    ...
    if (_temp_37508.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (inLexique, _temp_37508 (HERE), var_cas_inTotalBankCount, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, (var_cas_inComplementaryBranch)._operator_not (), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1077)) ;
      }
    }
  }
}
...
category_method__midrange_negateCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_37883 != NULL) {
    ...
    if (_temp_37996.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (inLexique, _temp_37996 (HERE), (var_cas_inComplementaryBranch)._operator_not (), var_cas_outInstructionCount COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      }
    }
  }
}
...
category_method__midrange_andCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_38200 != NULL) {
    if ((var_cas_inComplementaryBranch).isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_label0 ;
      var_cas_label0 = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1139))) ;
      var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1139)) ;
...
category_method__midrange_andCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_40018 != NULL) {
    ...
    var_cas_outInstructionCount = var_cas_countLeft._add_operation (inLexique, var_cas_countRight COMMA_SOURCE_FILE_AT_LINE (1182)) ;
  }
}
...
category_method__midrange_bitTest_in_structured_if_condition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_40543 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (inLexique, var_cas_inInstructionLocation, (operand_40543->mBTFSSinstruction)._operator_xor (var_cas_inComplementaryBranch), var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
...
category_method__midrange_instruction_structured_if__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_42062 != NULL) {
    ...
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (1253)))).isBuiltAndTrue ()) {
      ...
      if (((operand_42062->mElseInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1255)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_directCount._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1256)) ;
      }
      ...
      if (((operand_42062->mThenInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1259)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_complementaryCount._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1260)) ;
      }
      if (((var_cas_complementaryCount)._operator_strictInf (var_cas_directCount)).isBuiltAndTrue ()) {
        ...
        var_cas_ioListFileContents.appendCString ("  line ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_ioGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1264)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))) ;
        var_cas_ioListFileContents.appendCString (": generates complementary test (saves ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_directCount._substract_operation (inLexique, var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1265)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1265))) ;
        var_cas_ioListFileContents.appendCString (" instruction") ;
        if (((var_cas_directCount._substract_operation (inLexique, var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1266)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_generateComplementaryCondition).isBuiltAndTrue ()) {
      ...
      var_cas_label_nextCondition = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1278))) ;
      var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1278)) ;
      GGS_string var_cas_label_endOfIfinstruction ;
      var_cas_label_endOfIfinstruction = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1279))) ;
      var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1279)) ;
      ...
      if (((operand_42062->mThenInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1308)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      if (((operand_42062->mThenInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1326)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_label_nextCondition ;
      var_cas_label_nextCondition = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1331))) ;
      var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)) ;
      GGS_string var_cas_label_endOfIfinstruction ;
      var_cas_label_endOfIfinstruction = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1332))) ;
      var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)) ;
      ...
      ::routine_handleMidrangeInstructionList (inLexique,  operand_42062->mThenInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      if (((operand_42062->mElseInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1361)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_GOTO ::constructor_new (inLexique, operand_42062->mInstructionLocation, GGS_lstring ::constructor_new (inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label_nextCondition, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ::routine_handleMidrangeInstructionList (inLexique,  operand_42062->mElseInstructionList,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_inTotalBankCount,  var_cas_elseBranchFinalBank,  var_cas_inShouldPreserveBank,  var_cas_elseContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1365)) ;
      if (((operand_42062->mElseInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1379)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label_endOfIfinstruction, operand_42062->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
    }
...
category_method__midrange_instruction_do_while__build_midrange_ipic_instructionList (C_Compiler & inLexique,
  ...
  if (operand_47787 != NULL) {
    ...
    var_cas_labelInstructionBegin = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1409))) ;
    var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1409)) ;
    ...
    }
    {
      ...
      while (((operand_48990 = enumerator_48990.nextObject ()))) {
        ...
        if (((operand_48990->mInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1433)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          var_cas_nextBranchLabel = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1446))) ;
          var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1446)) ;
...
void routine_generateInterruptRoutineForControllerWithSharedRAM (C_Compiler & inLexique,
  ...
  if (((var_cas_accessibleFromBank0)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from bank 0")) COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  }
  if (((var_cas_inNeedsToSavePCLATH)._operator_and ((var_cas_size)._operator_isNotEqual (GGS_uint (2U)))).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1565))))._operator_concat (GGS_string (" (it should be 2)")) COMMA_SOURCE_FILE_AT_LINE (1566)) ;
    ...
    var_cas_inFirstSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1567))))._operator_concat (GGS_string (" (it should be 1)")) COMMA_SOURCE_FILE_AT_LINE (1568)) ;
  }
  ...
  var_cas_bankAccessibility = GGS_uint (0U) ;
  {
    ...
    while (((operand_53850 = enumerator_53850.nextObject ()))) {
      ...
      var_cas_bankAccessibility = (var_cas_bankAccessibility)._operator_or (GGS_uint (1U)._left_shift_operation (inLexique, operand_53850->mValue._right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (1573)) COMMA_SOURCE_FILE_AT_LINE (1573))) ;
    }
  }
  if (((var_cas_bankAccessibility._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1575)))._operator_isNotEqual (GGS_uint (1U)._left_shift_operation (inLexique, var_cas_inTotalBankCount COMMA_SOURCE_FILE_AT_LINE (1575)))).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from any bank")) COMMA_SOURCE_FILE_AT_LINE (1577)) ;
  }
  if (((var_cas_size)._operator_isNotEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1579))))._operator_concat (GGS_string (" (it should be 1)")) COMMA_SOURCE_FILE_AT_LINE (1580)) ;
  }
...
void routine_generateInterruptRoutineForControllerWithoutSharedRAM (C_Compiler & inLexique,
  ...
  if (((var_cas_accessibleFromBank0)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from bank 0")) COMMA_SOURCE_FILE_AT_LINE (1720)) ;
  }
  if (((var_cas_inNeedsToSavePCLATH)._operator_and ((var_cas_size)._operator_isNotEqual (GGS_uint (3U)))).isBuiltAndTrue ()) {
    var_cas_inFirstSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1722))))._operator_concat (GGS_string (" (it should be 3)")) COMMA_SOURCE_FILE_AT_LINE (1723)) ;
    ...
    var_cas_inFirstSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1724))))._operator_concat (GGS_string (" (it should be 2)")) COMMA_SOURCE_FILE_AT_LINE (1725)) ;
  }
  ...
  if (((var_cas_size)._operator_isNotEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable size is ")))._operator_concat (var_cas_size.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1731))))._operator_concat (GGS_string (" (it should be 1)")) COMMA_SOURCE_FILE_AT_LINE (1732)) ;
  }
  ...
  if (((var_cas_accessibleFromBank1)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_inSecondSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable cannot be accessed from bank 1")) COMMA_SOURCE_FILE_AT_LINE (1740)) ;
  }
  ...
  var_cas_offsetOk = GGS_bool (true) ;
  {
    ...
    while (((operand_62495 = enumerator_62495.nextObject ()))
      ...
      if (((var_cas_offsetOk)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_inSecondSaveRegister.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("the '"))._operator_concat (var_cas_inSecondSaveRegister))._operator_concat (GGS_string ("' variable has an offset equal to ")))._operator_concat ((operand_62495->mValue)._operator_and (GGS_uint (127U)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (1747))))._operator_concat (GGS_string (", while '")))._operator_concat (var_cas_inFirstSaveRegister))._operator_concat (GGS_string ("' has an offset equal to ")))._operator_concat (var_cas_offset.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (1748))))._operator_concat (GGS_string (" (tthe two offsets should be equal)")) COMMA_SOURCE_FILE_AT_LINE (1749)) ;
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
...
void routine_build_midrange_assembly_instruction_list (C_Compiler & inLexique,
  ...
  var_cas_routineMap = GGS_routineMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_69112 = enumerator_69112.nextObject ()))) {
      ...
      if ((((operand_69112->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1879)))._operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)))._operator_and ((operand_69112->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1879)))._operator_strictSup (GGS_uint (15U)))).isBuiltAndTrue ()) {
      ...
      if ((((operand_69112->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1882)))._operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)))._operator_and ((operand_69112->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1882)))._operator_strictSup (GGS_uint (15U)))).isBuiltAndTrue ()) {
  ...
  var_cas_constantMap.modifier_insertKey (inLexique, var_cas_romSizeString, var_cas_inROMSize COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  {
    ...
    while (((operand_69912 = enumerator_69912.nextObject ()))) {
      ...
      if ((var_cas_inRegisterTable.reader_hasKey (inLexique, operand_69912->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1895)) COMMA_SOURCE_FILE_AT_LINE (1895))).isBuiltAndTrue ()) {
        operand_69912->mConstantName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'"))._operator_concat (operand_69912->mConstantName))._operator_concat (GGS_string ("' is already declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1897)) ;
      }else{
  ...
  var_cas_needsToSavePCLATH = GGS_bool (false) ;
  {
    ...
    while (((operand_71322 = enumerator_71322.nextObject ()))) {
      ...
      if (((operand_71322->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1925)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_needsToSavePCLATH = GGS_bool (true) ;
      }
      if (((operand_71322->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1928)))._operator_supOrEqual (var_cas_inTotalPageCount)).isBuiltAndTrue ()) {
        operand_71322->mPage.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("invalid value ("))._operator_concat (operand_71322->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1929)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1929))))._operator_concat (GGS_string ("); the device has ")))._operator_concat (var_cas_inTotalPageCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1929))))._operator_concat (GGS_string (" 2k page(s) on rom")) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      }
    }
  }
  ...
  while (_condition_75578.isBuiltAndTrue ()) {
    ...
    if (_condition_75578.isBuiltAndTrue ()) {
      if (_variant_75578.uintValue () == 0) {
        ...
        _variant_75578._decrement_operation (inLexique COMMA_HERE) ;
        ...
        var_cas_orgGenerated = (var_cas_currentPage)._operator_isEqual (GGS_uint (0U)) ;
        {
          ...
          while (((operand_73857 = enumerator_73857.nextObject ()))) {
            ...
            if (((operand_73857->mPage.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1993)))._operator_isEqual (var_cas_currentPage)).isBuiltAndTrue ()) {
              if (((var_cas_orgGenerated)._operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_currentPage._multiply_operation (inLexique, GGS_uint (2048U) COMMA_SOURCE_FILE_AT_LINE (1995)) COMMA_HERE)) ;
              ...
              if (((((operand_73857->mIsNoReturn)._operator_not ())._operator_and ((operand_73857->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2021)))._operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_73857->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2021))))).isBuiltAndTrue ()) {
                operand_73857->mRoutineName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("execution will not set bank selection to "))._operator_concat (operand_73857->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2022)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2022))) COMMA_SOURCE_FILE_AT_LINE (2023)) ;
              }
        ...
        var_cas_currentPage._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2033)) ;
      }
    }
  }
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2036)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (2037))) ;
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (2038))) ;
    var_cas_ioListFileContents.appendCString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (2039))) ;
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (2040)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_currentAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_76310 = enumerator_76310.nextObject ()))) {
        ...
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2050)).reader_stringByLeftPadding (inLexique, GGS_uint (5U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (2050))) ;
        var_cas_ioListFileContents.appendCString (": ") ;
        ...
        var_cas_ioListFileContents.appendCString ("\n") ;
        var_cas_index._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2053)) ;
      }
    }
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("Minimum code size without optimization: ") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2056))) ;
