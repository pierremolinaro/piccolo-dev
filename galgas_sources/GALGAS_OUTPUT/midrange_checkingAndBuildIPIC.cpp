...
void routine_build_midrange_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  var_cas_constantMap = GGS_constantMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_69728 = enumerator_69728.nextObject ()))) {
      ...
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_69728->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1890)) COMMA_SOURCE_FILE_AT_LINE (1890))).isBuiltAndTrue ()) {
        operand_69728->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_69728->mConstantName))._operator_concat (GGS_string (true, "' is alreday declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1892)) ;
      }else{
  ...
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (1897))).isBuiltAndTrue ()) {
    ...
    const GGS_routineMap  _temp_70298 = var_cas_routineMap ;
    if (_temp_70298._isBuilt ()) {
      _temp_70298 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_32, automatic_var_33 COMMA_SOURCE_FILE_AT_LINE (1900)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1903)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1906)) ;
    }
  }else{
  ...
  {
    GGS_midrange_routineDefinitionList::cEnumerator enumerator_70940 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1912)), true) ;
    const GGS_midrange_routineDefinitionList::cElement * operand_70940 = NULL ;
    while (((operand_70940 = enumerator_70940.nextObject ()))) {
      macroValidPointer (operand_70940) ;
      if (((operand_70940->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1913)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_needsToSavePCLATH = GGS_bool (true, true) ;
      }
      if (((operand_70940->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1916)))._operator_supOrEqual (var_cas_inTotalPageCount)).isBuiltAndTrue ()) {
        operand_70940->mPage.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "invalid value ("))._operator_concat (operand_70940->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1917)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1917))))._operator_concat (GGS_string (true, "); the device has ")))._operator_concat (var_cas_inTotalPageCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1917))))._operator_concat (GGS_string (true, " 2k page(s) on rom")) COMMA_SOURCE_FILE_AT_LINE (1918)) ;
      }
    }
  }
  if ((var_cas_needsToSavePCLATH).isBuiltAndTrue ()) {
    var_cas_needsToSavePCLATH = GGS_bool (true, false) ;
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_71447 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1923)), true) ;
      const GGS_midrange_interruptDefinitionList::cElement * operand_71447 = NULL ;
      while (((operand_71447 = enumerator_71447.nextObject ()))
          && ((var_cas_needsToSavePCLATH)._operator_not ().isBuiltAndTrue ())) {
        macroValidPointer (operand_71447) ;
        {
          GGS_midrange_instructionList::cEnumerator enumerator_71549 (operand_71447->mInstructionList, true) ;
          const GGS_midrange_instructionList::cElement * operand_71549 = NULL ;
          while (((operand_71549 = enumerator_71549.nextObject ()))
              && ((var_cas_needsToSavePCLATH)._operator_not ().isBuiltAndTrue ())) {
            macroValidPointer (operand_71549) ;
            const GGS_midrange_instruction  _temp_71628 = operand_71549->mInstruction ;
            if (_temp_71628._isBuilt ()) {
              typeCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL _method = findCategoryMethod__midrange_instruction__instructionUsesGOTOorCALL (_temp_71628._galgasObjectRunTimeInfo ()) ;
              if (_method != NULL) {
                _method (_inLexique, _temp_71628 (HERE), var_cas_needsToSavePCLATH COMMA_SOURCE_FILE_AT_LINE (1925)) ;
              }
            }
          }
        }
  ...
  if ((var_cas_inHasInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_midrange_interruptDefinitionList::cEnumerator enumerator_72236 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1942)), true) ;
      const GGS_midrange_interruptDefinitionList::cElement * operand_72236 = NULL ;
      while (((operand_72236 = enumerator_72236.nextObject ()))) {
        macroValidPointer (operand_72236) ;
        if ((var_cas_inHasSharedRAMBank).isBuiltAndTrue ()) {
          ::routine_generateInterruptRoutineForControllerWithSharedRAM (_inLexique,  var_cas_inTotalBankCount,  var_cas_inRegisterTable,  operand_72236->mFirstSaveRegister,  operand_72236->mSecondSaveRegister,  var_cas_needsToSavePCLATH,  operand_72236->mInstructionList,  var_cas_routineMap,  var_cas_constantMap,  operand_72236->mEndOfInterruptLocation,  var_cas_outGeneratedInstructionList,  var_cas_localLabelIndex,  var_cas_generationOptimizationMessages COMMA_SOURCE_FILE_AT_LINE (1944)) ;
        }else{
          ::routine_generateInterruptRoutineForControllerWithoutSharedRAM (_inLexique,  var_cas_inTotalBankCount,  var_cas_inRegisterTable,  operand_72236->mFirstSaveRegister,  operand_72236->mSecondSaveRegister,  var_cas_needsToSavePCLATH,  operand_72236->mInstructionList,  var_cas_routineMap,  var_cas_constantMap,  operand_72236->mEndOfInterruptLocation,  var_cas_outGeneratedInstructionList,  var_cas_localLabelIndex,  var_cas_generationOptimizationMessages COMMA_SOURCE_FILE_AT_LINE (1959)) ;
        }
      }
    }
  }
  ...
  GGS_uint _variant_75196 = var_cas_inTotalPageCount ;
  GGS_bool _condition_75196 (_variant_75196._isBuilt (), true) ;
  while (_condition_75196.isBuiltAndTrue ()) {
    _condition_75196 = (var_cas_currentPage)._operator_strictInf (var_cas_inTotalPageCount) ;
    if (_condition_75196.isBuiltAndTrue ()) {
      if (_variant_75196.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2022)) ;
        _condition_75196 = GGS_bool (true, false) ;
      }else{
        _variant_75196._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_bool var_cas_orgGenerated ;
        var_cas_orgGenerated = (var_cas_currentPage)._operator_isEqual (GGS_uint (true, 0U)) ;
        {
          GGS_midrange_routineDefinitionList::cEnumerator enumerator_73475 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1980)), true) ;
          const GGS_midrange_routineDefinitionList::cElement * operand_73475 = NULL ;
          while (((operand_73475 = enumerator_73475.nextObject ()))) {
            macroValidPointer (operand_73475) ;
            if (((operand_73475->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1981)))._operator_isEqual (var_cas_currentPage)).isBuiltAndTrue ()) {
              ...
              GGS_bool var_cas_continuesInSequence ;
              GGS_uint  var_cas_currentBank ;
              var_cas_currentBank = operand_73475->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1987)) ;
              GGS_routineKind var_cas_routineKind ;
              if ((operand_73475->mIsNoReturn).isBuiltAndTrue ()) {
              ...
              var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_73475->mRoutineName COMMA_HERE)) ;
              ::routine_handleMidrangeInstructionList (_inLexique,  operand_73475->mInstructionList,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_inTotalBankCount,  var_cas_currentBank,  operand_73475->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (1995)) ;
              if (((((operand_73475->mIsNoReturn)._operator_not ())._operator_and ((operand_73475->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2009)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_73475->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2009))))).isBuiltAndTrue ()) {
                operand_73475->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set bank selection to "))._operator_concat (operand_73475->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2010)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2010))) COMMA_SOURCE_FILE_AT_LINE (2011)) ;
              }
              if (((operand_73475->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
                operand_73475->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2014)) ;
              }
              if (((operand_73475->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_73475->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2017)) COMMA_HERE)) ;
              }
            }
          }
        }
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2024)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_midrange_ipic_instructionList::cEnumerator enumerator_75928 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_midrange_ipic_instructionList::cElement * operand_75928 = NULL ;
      while (((operand_75928 = enumerator_75928.nextObject ()))) {
        macroValidPointer (operand_75928) ;
        const GGS_midrange_ipic_instruction  _temp_75969 = operand_75928->mInstruction ;
        if (_temp_75969._isBuilt ()) {
          _temp_75969 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2037)) ;
        }
        ...
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_midrange_ipic_instruction  _temp_76114 = operand_75928->mInstruction ;
        if (_temp_76114._isBuilt ()) {
          _temp_76114 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2039)) ;
        }
        var_cas_ioListFileContents.writeString ("\n") ;
