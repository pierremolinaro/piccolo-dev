...
void routine_build_midrange_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  var_cas_routineMap = GGS_routineMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_69112 = enumerator_69112.nextObject ()))) {
      ...
      if ((((operand_69112->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1879)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_69112->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1879)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_69112->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1881)) ;
      }
      if ((((operand_69112->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1882)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_69112->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1882)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_69112->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1884)) ;
      }
  ...
  var_cas_romSizeString = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "ROM_SIZE"), GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_constantMap.modifier_insertKey (_inLexique, var_cas_romSizeString, var_cas_inROMSize COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  {
    ...
    while (((operand_69912 = enumerator_69912.nextObject ()))) {
      ...
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_69912->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1895)) COMMA_SOURCE_FILE_AT_LINE (1895))).isBuiltAndTrue ()) {
        operand_69912->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_69912->mConstantName))._operator_concat (GGS_string (true, "' is already declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1897)) ;
      }else{
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1902)))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (1909))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_32 ;
    GGS_bool automatic_var_33 ;
    const GGS_routineMap  _temp_70680 = var_cas_routineMap ;
    if (_temp_70680._isBuilt ()) {
      _temp_70680 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_32, automatic_var_33 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1915)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main bank:requires 0\"") COMMA_SOURCE_FILE_AT_LINE (1918)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (1920)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (1921)) ;
  }
  ...
  var_cas_needsToSavePCLATH = GGS_bool (true, false) ;
  {
    ...
    while (((operand_71322 = enumerator_71322.nextObject ()))) {
      ...
      if (((operand_71322->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1925)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      if (((operand_71322->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1928)))._operator_supOrEqual (var_cas_inTotalPageCount)).isBuiltAndTrue ()) {
        operand_71322->mPage.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "invalid value ("))._operator_concat (operand_71322->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1929)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1929))))._operator_concat (GGS_string (true, "); the device has ")))._operator_concat (var_cas_inTotalPageCount.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1929))))._operator_concat (GGS_string (true, " 2k page(s) on rom")) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      }
    }
  }
  ...
  GGS_bool _condition_75578 (_variant_75578._isBuilt (), true) ;
  while (_condition_75578.isBuiltAndTrue ()) {
    ...
    if (_condition_75578.isBuiltAndTrue ()) {
      if (_variant_75578.uintValue () == 0) {
        ...
        _condition_75578 = GGS_bool (true, false) ;
      }else{
          ...
          while (((operand_73857 = enumerator_73857.nextObject ()))) {
            ...
            if (((operand_73857->mPage.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1993)))._operator_isEqual (var_cas_currentPage)).isBuiltAndTrue ()) {
              if (((var_cas_orgGenerated)._operator_not ()).isBuiltAndTrue ()) {
                var_cas_outGeneratedInstructionList._addAssign_operation (GGS_midrange_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_currentPage._multiply_operation (_inLexique, GGS_uint (true, 2048U) COMMA_SOURCE_FILE_AT_LINE (1995)) COMMA_HERE)) ;
              ...
              if (((((operand_73857->mIsNoReturn)._operator_not ())._operator_and ((operand_73857->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2021)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_73857->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2021))))).isBuiltAndTrue ()) {
                operand_73857->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set bank selection to "))._operator_concat (operand_73857->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2022)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2022))) COMMA_SOURCE_FILE_AT_LINE (2023)) ;
              }
              if (((operand_73857->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
                operand_73857->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2026)) ;
              }
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2036)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2037))) ;
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2038))) ;
    var_cas_ioListFileContents.writeString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2039))) ;
    var_cas_ioListFileContents.writeString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2040)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_currentAddress = GGS_uint (true, 0U) ;
    {
      ...
      while (((operand_76310 = enumerator_76310.nextObject ()))) {
        ...
        if (_temp_76351._isBuilt ()) {
          _temp_76351 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2049)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2050)).reader_stringByLeftPadding (_inLexique, GGS_uint (true, 5U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2050))) ;
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_midrange_ipic_instruction  _temp_76496 = operand_76310->mInstruction ;
        if (_temp_76496._isBuilt ()) {
