...
void routine_midrange_5F_compute_5F_JSR_5F_JUMP (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (340)).isValid ()) {
    PMUInt32 variant_13555 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (340)).uintValue () ;
    bool loop_13555 = true ;
    while (loop_13555) {
      loop_13555 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (341)).isValid () ;
      if (loop_13555) {
        loop_13555 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (341)).boolValue () ;
      }
      if (loop_13555 && (0 == variant_13555)) {
        loop_13555 = false ;
      ...
      if (loop_13555) {
        ...
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_13978 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_13978.hasCurrentObject ()) {
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_defineLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_13978.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (350)) ;
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_14259 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_14253 ((PMUInt32) 0) ;
        while (enumerator_14259.hasCurrentObject ()) {
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_compute ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_14259.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, var_JUMP_5F_or_5F_JSR_5F_fixed, ioArgument_ioGeneratedInstructionList, index_14253, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          var_currentAddress = var_currentAddress.add_operation (callCategoryReader_instructionLength ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_14259.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (357)), inCompiler COMMA_SOURCE_FILE_AT_LINE (357)) ;
          enumerator_14259.gotoNextObject () ;
          index_14253.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
        }
        ...
        if (kBoolTrue == test_0) {
          ...
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentAddress.reader_hexString (SOURCE_FILE_AT_LINE (360)) COMMA_SOURCE_FILE_AT_LINE (360)).operator_concat (GALGAS_string (" value when checking relative branches, while it gets ") COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)).operator_concat (GALGAS_string (" value when computing routine map") COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (360)) ;
        }
        //-------- @ifInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_defineLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("internal error: current address (").operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE_AT_LINE (45)) COMMA_SOURCE_FILE_AT_LINE (45)).operator_concat (GALGAS_string (") is greater than origin (") COMMA_SOURCE_FILE_AT_LINE (45)).operator_concat (object->mAttribute_mOrigin.reader_hexString (SOURCE_FILE_AT_LINE (45)) COMMA_SOURCE_FILE_AT_LINE (45)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (45)) COMMA_SOURCE_FILE_AT_LINE (44)) ;
  }
  //-------- @assignmentInstructionForGeneration
