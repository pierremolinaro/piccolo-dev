...
void routine_midrange_5F_compute_5F_JSR_5F_JUMP (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("COMPUTE JSR and JUMP").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string ("\n"
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (340)).isValid ()) {
    uint32_t variant_13553 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (340)).uintValue () ;
    bool loop_13553 = true ;
    while (loop_13553) {
      loop_13553 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE_AT_LINE (341)).isValid () ;
      if (loop_13553) {
        loop_13553 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE_AT_LINE (341)).boolValue () ;
      }
...
static void categoryMethod_midrange_5F_intermediate_5F_actualInstruction_defineLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_nextAddress.operator_xor (ioArgument_ioAddress COMMA_SOURCE_FILE_AT_LINE (58)).operator_and (GALGAS_uint ((uint32_t) 63488U) COMMA_SOURCE_FILE_AT_LINE (58)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_compute (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE_AT_LINE (133)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (134)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE_AT_LINE (135)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE_AT_LINE (142)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (143)) ;
  }else if (kBoolFalse == test_2) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE_AT_LINE (144)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
...
static void categoryMethod_midrange_5F_intermediate_5F_JSR_compute (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_midrange_5F_call_5F_goto_5F_bit var_bit_31__31_ ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE_AT_LINE (179)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (180)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE_AT_LINE (181)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
  ...
  GALGAS_midrange_5F_call_5F_goto_5F_bit var_bit_31__32_ ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE_AT_LINE (188)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (189)) ;
  }else if (kBoolFalse == test_2) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE_AT_LINE (190)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
