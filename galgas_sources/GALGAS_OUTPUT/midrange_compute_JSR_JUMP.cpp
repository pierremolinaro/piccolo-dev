...
const C_galgas_type_reference kTypeReference_midrange_symbolTableForConvertingRelatives ("midrange_symbolTableForConvertingRelatives") ;
...
void routine_midrange_compute_JSR_JUMP (C_Compiler & inLexique,
  ...
  GGS_uint _variant_14876 = var_cas_ioGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
  GGS_bool _condition_14876 (_variant_14876.isBuilt (), true) ;
  while (_condition_14876.isBuiltAndTrue ()) {
    _condition_14876 = (var_cas_JUMP_or_JSR_fixed).operator_and ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))) ;
