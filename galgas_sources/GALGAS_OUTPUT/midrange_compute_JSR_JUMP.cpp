...
void routine_midrange_5F_compute_5F_JSR_5F_JUMP (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 335)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 335))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 335)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("COMPUTE JSR and JUMP").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 336))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 336)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 336))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 336)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 337)).operator_concat (GALGAS_string ("\n"
    "\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 337))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 337)) ;
  GALGAS_bool var_JUMP_5F_or_5F_JSR_5F_fixed = GALGAS_bool (true) ;
  GALGAS_uint var_iteration = GALGAS_uint ((uint32_t) 0U) ;
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 340)).isValid ()) {
    uint32_t variant_13553 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 340)).uintValue () ;
    bool loop_13553 = true ;
    while (loop_13553) {
      loop_13553 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 341)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 341)).isValid () ;
      if (loop_13553) {
        loop_13553 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 341)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 341)).boolValue () ;
      }
      if (loop_13553 && (0 == variant_13553)) {
        loop_13553 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 340)) ;
      }
      if (loop_13553) {
        variant_13553 -- ;
        var_JUMP_5F_or_5F_JSR_5F_fixed = GALGAS_bool (false) ;
        var_iteration.increment_operation (inCompiler  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 344)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Pass ").operator_concat (var_iteration.reader_string (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 345))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 345)).operator_concat (GALGAS_string (":\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 345))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 345)) ;
        GALGAS_midrange_5F_symbolTableForConvertingRelatives var_symbolTable = GALGAS_midrange_5F_symbolTableForConvertingRelatives::constructor_emptyMap (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 347)) ;
        ...
        while (enumerator_13975.hasCurrentObject ()) {
          callCategoryMethod_defineLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_13975.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 350)) ;
        ...
        if (kBoolTrue == test_0) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("Internal second pass error: the last address gets ").operator_concat (var_currentAddress.reader_hexString (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 360))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 360)).operator_concat (GALGAS_string (" value when checking relative branches, while it gets ")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 360)).operator_concat (var_lastAddressForFirstPass.reader_hexString (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 362))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 361)).operator_concat (GALGAS_string (" value when computing routine map")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 362))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 360)) ;
        }
        const enumGalgasBool test_1 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_not (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 364)).boolEnum () ;
        if (kBoolTrue == test_1) {
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  No JUMP, no JSR to fix\n"
            "\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 365)) ;
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Program size: ").operator_concat (var_currentAddress.reader_string (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 366))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 366)).operator_concat (GALGAS_string (" instructions\n"
            "\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 366))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 366)) ;
        }
      }
    }
  }
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_defineLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  {
  ioArgument_ioRoutineSymbolTable.modifier_insertKey (object->mAttribute_mLabel, ioArgument_ioAddress, inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 33)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_defineLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("internal error: current address (").operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 45))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 44)).operator_concat (GALGAS_string (") is greater than origin (")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 45)).operator_concat (object->mAttribute_mOrigin.reader_hexString (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 45))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 45)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 45))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 44)) ;
  }
...
static void categoryMethod_midrange_5F_intermediate_5F_actualInstruction_defineLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_nextAddress = ioArgument_ioAddress.add_operation (callCategoryReader_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 57)), inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 57)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_nextAddress.operator_xor (ioArgument_ioAddress COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 58)).operator_and (GALGAS_uint ((uint32_t) 63488U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 58)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("Routine too long, crosses page boundary at this instruction")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 59)) ;
  }
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_compute (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 129)) ;
  GALGAS_uint var_flags = ioArgument_ioAddress.operator_xor (var_targetAddress COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 131)) ;
  GALGAS_midrange_5F_call_5F_goto_5F_bit var_bit_31__31_ ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 133)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 134)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 135)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_clear (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 136)) ;
    }else if (kBoolFalse == test_1) {
      var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_set (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 138)) ;
    }
  }
  GALGAS_midrange_5F_call_5F_goto_5F_bit var_bit_31__32_ ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 142)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 143)) ;
  }else if (kBoolFalse == test_2) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 144)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_clear (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 145)) ;
    }else if (kBoolFalse == test_3) {
      var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_set (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 147)) ;
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_bit_31__31_.objectCompare (object->mAttribute_mBit_31__31_)).operator_or (GALGAS_bool (kIsNotEqual, var_bit_31__32_.objectCompare (object->mAttribute_mBit_31__32_)) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 150)).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_midrange_5F_intermediate_5F_actualInstruction var_instruction = GALGAS_midrange_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, var_bit_31__31_, var_bit_31__32_  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 151)) ;
    {
    ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (var_instruction, constinArgument_inIndex, inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 157)) ;
    }
    ioArgument_ioJUMP_5F_or_5F_JSR_5F_fixed = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inIndex.reader_string (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 159))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 159)).operator_concat (GALGAS_string (":  JUMP to other page fixed\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 159))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 159)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_JSR_compute (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 175)) ;
  GALGAS_uint var_flags = ioArgument_ioAddress.operator_xor (var_targetAddress COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 177)) ;
  GALGAS_midrange_5F_call_5F_goto_5F_bit var_bit_31__31_ ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 179)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 180)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 2048U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 181)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_clear (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 182)) ;
    }else if (kBoolFalse == test_1) {
      var_bit_31__31_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_set (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 184)) ;
    }
  }
  GALGAS_midrange_5F_call_5F_goto_5F_bit var_bit_31__32_ ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_flags.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 188)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 189)) ;
  }else if (kBoolFalse == test_2) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_targetAddress.operator_and (GALGAS_uint ((uint32_t) 4096U) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 190)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_clear (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 191)) ;
    }else if (kBoolFalse == test_3) {
      var_bit_31__32_ = GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_set (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 193)) ;
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_bit_31__31_.objectCompare (object->mAttribute_mBit_31__31_)).operator_or (GALGAS_bool (kIsNotEqual, var_bit_31__32_.objectCompare (object->mAttribute_mBit_31__32_)) COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 196)).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_midrange_5F_intermediate_5F_actualInstruction var_instruction = GALGAS_midrange_5F_intermediate_5F_JSR::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTargetLabel, var_bit_31__31_, var_bit_31__32_  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 197)) ;
    {
    ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (var_instruction, constinArgument_inIndex, inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 203)) ;
    }
    ioArgument_ioJUMP_5F_or_5F_JSR_5F_fixed = GALGAS_bool (true) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (constinArgument_inIndex.reader_string (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 205))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 205)).operator_concat (GALGAS_string (":  JSR to other page fixed\n")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 205))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 205)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_compute (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  macroValidSharedObject (object, cPtr_midrange_5F_intermediate_5F_pseudo_5F_LABEL) ;
  GALGAS_uint var_targetAddress ;
  constinArgument_inRoutineSymbolTable.method_searchKey (object->mAttribute_mLabel, var_targetAddress, inCompiler COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 220)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("Internal second pass error: the '").operator_concat (object->mAttribute_mLabel.reader_string (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 222))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 222)).operator_concat (GALGAS_string ("' label gets ")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 222)).operator_concat (ioArgument_ioAddress.reader_hexString (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 223))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 223)).operator_concat (GALGAS_string (" value in second pass, while it gets ")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 223)).operator_concat (var_targetAddress.reader_hexString (SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 224))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 223)).operator_concat (GALGAS_string (" in first pass")  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 224))  COMMA_SOURCE_FILE ("midrange_compute_JSR_JUMP.gSemantics", 222)) ;
  }
}
//-----------------------------------------------------------------------------*
