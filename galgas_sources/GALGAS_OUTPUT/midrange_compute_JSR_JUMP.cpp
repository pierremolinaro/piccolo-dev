...
const C_galgas_type_descriptor kTypeDescriptor_GGS_midrange_symbolTableForConvertingRelatives ("midrange_symbolTableForConvertingRelatives", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_midrange_symbolTableForConvertingRelatives::typeDescriptor (void) const {
