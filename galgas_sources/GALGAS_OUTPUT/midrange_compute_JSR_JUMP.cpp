...
enterCategoryMethod__midrange_ipic_instruction__defineLabelAtAddress (typeCategoryMethod__midrange_ipic_instruction__defineLabelAtAddress inRoutine,
  ...
  gDispatchTableForMethod__midrange_ipic_instruction__defineLabelAtAddress.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_instruction__defineLabelAtAddress (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_instruction__defineLabelAtAddress.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__midrange_ipic_pseudo_ORG__defineLabelAtAddress (C_Compiler & inLexique,
  ...
  if (operand_1492 != NULL) {
    if (((var_cas_ioAddress).operator_strictSup (operand_1492->mOrigin)).isBuiltAndTrue ()) {
...
category_method__midrange_ipic_actualInstruction__defineLabelAtAddress (C_Compiler & inLexique,
  ...
  if (operand_1964 != NULL) {
    ...
    var_cas_nextAddress = var_cas_ioAddress.add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (58)) ;
    if (((((var_cas_nextAddress).operator_xor (var_cas_ioAddress)).operator_and (GGS_uint (63488U))).operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
...
enterCategoryMethod__midrange_ipic_instruction__compute (typeCategoryMethod__midrange_ipic_instruction__compute inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__midrange_ipic_instruction__compute.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_instruction__compute (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_instruction__compute.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__midrange_ipic_JUMP__compute (C_Compiler & inLexique,
  ...
  if (operand_4514 != NULL) {
    ...
    var_cas_flags = (var_cas_ioAddress).operator_xor (var_cas_targetAddress) ;
    GGS_midrange_call_goto_bit var_cas_bit11 ;
    if ((((var_cas_flags).operator_and (GGS_uint (2048U))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_bit11 = GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE) ;
    }else if ((((var_cas_targetAddress).operator_and (GGS_uint (2048U))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    if ((((var_cas_flags).operator_and (GGS_uint (4096U))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_bit12 = GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE) ;
    }else if ((((var_cas_targetAddress).operator_and (GGS_uint (4096U))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    if ((((var_cas_bit11).operator_isNotEqual (operand_4514->mBit11)).operator_or ((var_cas_bit12).operator_isNotEqual (operand_4514->mBit12))).isBuiltAndTrue ()) {
...
category_method__midrange_ipic_JSR__compute (C_Compiler & inLexique,
  ...
  if (operand_6080 != NULL) {
    ...
    if ((((var_cas_bit11).operator_isNotEqual (operand_6080->mBit11)).operator_or ((var_cas_bit12).operator_isNotEqual (operand_6080->mBit12))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_actualInstruction  var_cas_instruction ;
...
void routine_midrange_compute_JSR_JUMP (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (336))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("COMPUTE JSR and JUMP").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (337))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (338))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  ...
  while (_condition_14870.isBuiltAndTrue ()) {
    _condition_14870 = (var_cas_JUMP_or_JSR_fixed).operator_and ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))) ;
    if (_condition_14870.isBuiltAndTrue ()) {
      if (_variant_14870.uintValue () == 0) {
        ...
        _variant_14870.decrement_operation (inLexique COMMA_HERE) ;
        ...
        var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_14030 = enumerator_14030.nextObject ()))) {
            ...
            GGS_uint  var_cas_instructionLength ;
            const GGS_midrange_ipic_instruction  temp_14107 = operand_14030->mInstruction ;
            if (temp_14107.isBuilt ()) {
              temp_14107 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (358)) ;
            }
            const GGS_midrange_ipic_instruction  temp_14157 = operand_14030->mInstruction ;
            if (temp_14157.isBuilt ()) {
              typeCategoryMethod__midrange_ipic_instruction__compute method = findCategoryMethod__midrange_ipic_instruction__compute (temp_14157.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, temp_14157 (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_JUMP_or_JSR_fixed, var_cas_ioGeneratedInstructionList, var_cas_idx, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (359)) ;
              }
            }
        ...
        if (((var_cas_JUMP_or_JSR_fixed).operator_not ()).isBuiltAndTrue ()) {
