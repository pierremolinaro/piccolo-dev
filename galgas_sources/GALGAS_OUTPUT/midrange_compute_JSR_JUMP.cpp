...
category_method__midrange_ipic_actualInstruction__defineLabelAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_1964 != NULL) {
    ...
    if (((((var_cas_nextAddress)._operator_xor (var_cas_ioAddress))._operator_and (GGS_uint (true, 63488U)))._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_1964->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Routine too long, crosses page boundary at this instruction") COMMA_SOURCE_FILE_AT_LINE (61)) ;
    }
...
category_method__midrange_ipic_pseudo_ORG__compute (C_Compiler &,
                                const cPtr_midrange_ipic_pseudo_ORG * operand_3247,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3247 != NULL) {
    var_cas_ioAddress = operand_3247->mOrigin ;
  }
}
...
category_method__midrange_ipic_JUMP__compute (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_JUMP * operand_3677,
                                const GGS_midrange_symbolTableForConvertingRelatives   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress,
                                GGS_bool & var_cas_ioJUMP_or_JSR_fixed,
                                GGS_midrange_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
  ...
  if (operand_3677 != NULL) {
    ...
    const GGS_midrange_symbolTableForConvertingRelatives  _temp_3995 = var_cas_inRoutineSymbolTable ;
    if (_temp_3995._isBuilt ()) {
      _temp_3995 (HERE)->method_searchKey (_inLexique, operand_3677->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (106)) ;
    }
    ...
    if ((((var_cas_flags)._operator_and (GGS_uint (true, 2048U)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_bit11 = GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE) ;
    }else if ((((var_cas_targetAddress)._operator_and (GGS_uint (true, 2048U)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if ((((var_cas_flags)._operator_and (GGS_uint (true, 4096U)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_bit12 = GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE) ;
    }else if ((((var_cas_targetAddress)._operator_and (GGS_uint (true, 4096U)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if ((((var_cas_bit11)._operator_isNotEqual (operand_3677->mBit11))._operator_or ((var_cas_bit12)._operator_isNotEqual (operand_3677->mBit12))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_actualInstruction  var_cas_instruction ;
      var_cas_instruction = GGS_midrange_ipic_JUMP ::constructor_new (_inLexique, operand_3677->mInstructionLocation, operand_3677->mTargetLabel, var_cas_bit11, var_cas_bit12 COMMA_HERE) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_instruction, var_cas_inIndex COMMA_SOURCE_FILE_AT_LINE (134)) ;
      var_cas_ioJUMP_or_JSR_fixed = GGS_bool (true, true) ;
      var_cas_ioListFileContents.writeString ("  line ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (136))) ;
      var_cas_ioListFileContents.writeString (":  JUMP to other page fixed\n") ;
    }
  }
}
...
category_method__midrange_ipic_JSR__compute (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_JSR * operand_5243,
                                const GGS_midrange_symbolTableForConvertingRelatives   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress,
                                GGS_bool & var_cas_ioJUMP_or_JSR_fixed,
                                GGS_midrange_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
                                ...
                                GGS_string & var_cas_ioListFileContents
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5243 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_midrange_symbolTableForConvertingRelatives  _temp_5561 = var_cas_inRoutineSymbolTable ;
    if (_temp_5561._isBuilt ()) {
      _temp_5561 (HERE)->method_searchKey (_inLexique, operand_5243->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (152)) ;
    }
    GGS_uint  var_cas_flags ;
    var_cas_flags = (var_cas_ioAddress)._operator_xor (var_cas_targetAddress) ;
    GGS_midrange_call_goto_bit var_cas_bit11 ;
    ...
    if ((((var_cas_bit11)._operator_isNotEqual (operand_5243->mBit11))._operator_or ((var_cas_bit12)._operator_isNotEqual (operand_5243->mBit12))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_actualInstruction  var_cas_instruction ;
      var_cas_instruction = GGS_midrange_ipic_JSR ::constructor_new (_inLexique, operand_5243->mInstructionLocation, operand_5243->mTargetLabel, var_cas_bit11, var_cas_bit12 COMMA_HERE) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_instruction, var_cas_inIndex COMMA_SOURCE_FILE_AT_LINE (180)) ;
      var_cas_ioJUMP_or_JSR_fixed = GGS_bool (true, true) ;
      var_cas_ioListFileContents.writeString ("  line ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (182))) ;
      var_cas_ioListFileContents.writeString (":  JSR to other page fixed\n") ;
    }
  }
}
...
category_method__midrange_ipic_pseudo_LABEL__compute (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_pseudo_LABEL * operand_6816,
                                const GGS_midrange_symbolTableForConvertingRelatives   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress,
                                GGS_bool & /* var_cas_ioJUMP_or_JSR_fixed */,
                                GGS_midrange_ipic_instructionList  & /* var_cas_ioGeneratedInstructionList */,
                                ...
                                GGS_string & /* var_cas_ioListFileContents */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6816 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_midrange_symbolTableForConvertingRelatives  _temp_7134 = var_cas_inRoutineSymbolTable ;
    if (_temp_7134._isBuilt ()) {
      _temp_7134 (HERE)->method_searchKey (_inLexique, operand_6816->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (197)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_6816->mLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "Internal second pass error: the '"))._operator_concat (operand_6816->mLabel))._operator_concat (GGS_string (true, "' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (201))))._operator_concat (GGS_string (true, " in first pass")) COMMA_SOURCE_FILE_AT_LINE (202)) ;
    }
  }
}
...
void routine_midrange_compute_JSR_JUMP (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (312))) ;
  var_cas_ioListFileContents.writeString ("\n") ;
  var_cas_ioListFileContents.writeString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "COMPUTE JSR and JUMP").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (313))) ;
  var_cas_ioListFileContents.writeString ("*\n") ;
  ...
  var_cas_JUMP_or_JSR_fixed = GGS_bool (true, true) ;
  GGS_uint  var_cas_iteration ;
  var_cas_iteration = GGS_uint (true, 0U) ;
  GGS_uint _variant_14033 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (317)) ;
  GGS_bool _condition_14033 (_variant_14033._isBuilt (), true) ;
  while (_condition_14033.isBuiltAndTrue ()) {
    _condition_14033 = (var_cas_JUMP_or_JSR_fixed)._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))) ;
    if (_condition_14033.isBuiltAndTrue ()) {
      if (_variant_14033.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (347)) ;
        _condition_14033 = GGS_bool (true, false) ;
      }else{
        _variant_14033._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_JUMP_or_JSR_fixed = GGS_bool (true, false) ;
        var_cas_iteration._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (321)) ;
        var_cas_ioListFileContents.writeString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (322))) ;
        var_cas_ioListFileContents.writeString (":\n") ;
        ...
        {
          GGS_midrange_ipic_instructionList::cEnumerator enumerator_12915 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_midrange_ipic_instructionList::cElement * operand_12915 = NULL ;
          while (((operand_12915 = enumerator_12915.nextObject ()))) {
            macroValidPointer (operand_12915) ;
            const GGS_midrange_ipic_instruction  _temp_12959 = operand_12915->mInstruction ;
            if (_temp_12959._isBuilt ()) {
              typeCategoryMethod__midrange_ipic_instruction__defineLabelAtAddress _method = findCategoryMethod__midrange_ipic_instruction__defineLabelAtAddress (_temp_12959._galgasObjectRunTimeInfo ()) ;
              if (_method != NULL) {
                _method (_inLexique, _temp_12959 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (327)) ;
              }
            }
          }
        }
        ...
        var_cas_currentAddress = GGS_uint (true, 0U) ;
        {
          ...
          GGS_midrange_ipic_instructionList::cEnumerator enumerator_13193 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_midrange_ipic_instructionList::cElement * operand_13193 = NULL ;
          while (((operand_13193 = enumerator_13193.nextObject ()))) {
            macroValidPointer (operand_13193) ;
            GGS_uint  var_cas_instructionLength ;
            const GGS_midrange_ipic_instruction  _temp_13270 = operand_13193->mInstruction ;
            if (_temp_13270._isBuilt ()) {
              _temp_13270 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (334)) ;
            }
            const GGS_midrange_ipic_instruction  _temp_13320 = operand_13193->mInstruction ;
            if (_temp_13320._isBuilt ()) {
              typeCategoryMethod__midrange_ipic_instruction__compute _method = findCategoryMethod__midrange_ipic_instruction__compute (_temp_13320._galgasObjectRunTimeInfo ()) ;
              if (_method != NULL) {
                _method (_inLexique, _temp_13320 (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_JUMP_or_JSR_fixed, var_cas_ioGeneratedInstructionList, var_cas_idx, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (335)) ;
              }
            }
            var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (336)) ;
            var_cas_idx.mValue ++ ;
          }
        }
        if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (339))))._operator_concat (GGS_string (true, " value when checking relative branches, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (341))))._operator_concat (GGS_string (true, " value when computing routine map")) COMMA_SOURCE_FILE_AT_LINE (342)) ;
        }
        if (((var_cas_JUMP_or_JSR_fixed)._operator_not ()).isBuiltAndTrue ()) {
          var_cas_ioListFileContents.writeString ("  No JUMP, no JSR to fix\n"
            "\n") ;
          var_cas_ioListFileContents.writeString ("Program size: ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (345))) ;
