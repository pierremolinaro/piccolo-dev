...
void routine_midrange_5F_compute_5F_JSR_5F_JUMP (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (340)).isValid ()) {
    PMUInt32 variant_13509 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (340)).uintValue () ;
    bool loop_13509 = true ;
    while (loop_13509) {
      loop_13509 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (341)).isValid () ;
      if (loop_13509) {
        loop_13509 = var_JUMP_5F_or_5F_JSR_5F_fixed.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) COMMA_SOURCE_FILE_AT_LINE (341)).boolValue () ;
      }
      if (loop_13509 && (0 == variant_13509)) {
        loop_13509 = false ;
      ...
      if (loop_13509) {
        ...
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_13932 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_13932.hasCurrentObject ()) {
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_defineLabelAtAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_13932.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (350)) ;
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_14213 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_14207 ((PMUInt32) 0) ;
        while (enumerator_14213.hasCurrentObject ()) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_uint var_instructionLength ;
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_instructionLength ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_14213.current_mInstruction (HERE).ptr (), var_instructionLength, inCompiler COMMA_SOURCE_FILE_AT_LINE (357)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_compute ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_14213.current_mInstruction (HERE).ptr (), var_symbolTable, var_currentAddress, var_JUMP_5F_or_5F_JSR_5F_fixed, ioArgument_ioGeneratedInstructionList, index_14207, ioArgument_ioListFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (358)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ...
          index_14207.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
        }
...
static void categoryMethod_midrange_5F_intermediate_5F_actualInstruction_defineLabelAtAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) temp_0.ptr (), var_instructionLength, inCompiler COMMA_SOURCE_FILE_AT_LINE (56)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
