...
GGS_midrange_symbolTableForConvertingRelatives GGS_midrange_symbolTableForConvertingRelatives::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_midrange_symbolTableForConvertingRelatives result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
category_method__midrange_ipic_JUMP__compute (C_Compiler & inLexique,
  ...
  if (operand_4514 != NULL) {
    ...
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_4514->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (130)) ;
    }
...
category_method__midrange_ipic_JSR__compute (C_Compiler & inLexique,
  ...
  if (operand_6080 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_6080->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (176)) ;
    }
    GGS_uint  var_cas_flags = (var_cas_ioAddress).operator_xor (var_cas_targetAddress) ;
    GGS_midrange_call_goto_bit var_cas_bit11 ;
...
category_method__midrange_ipic_pseudo_LABEL__compute (C_Compiler & inLexique,
  ...
  if (operand_7653 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    if (var_cas_inRoutineSymbolTable.isBuilt ()) {
      var_cas_inRoutineSymbolTable (HERE)->method_searchKey (inLexique, operand_7653->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (221)) ;
    }
      ...
      if (_variant_14876.uintValue () == 0) {
        ...
        GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_13752 = enumerator_13752.nextObject ()))) {
            ...
            { typeCategoryMethod__midrange_ipic_instruction__defineLabelAtAddress method = findCategoryMethod__midrange_ipic_instruction__defineLabelAtAddress (operand_13752->mInstruction.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_13752->mInstruction (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (351)) ;
              }
            }
          }
        }
        ...
        var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_14030 = enumerator_14030.nextObject ()))) {
            ...
            GGS_uint  var_cas_instructionLength ;
            if (operand_14030->mInstruction.isBuilt ()) {
              operand_14030->mInstruction (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (358)) ;
            }
            { typeCategoryMethod__midrange_ipic_instruction__compute method = findCategoryMethod__midrange_ipic_instruction__compute (operand_14030->mInstruction.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_14030->mInstruction (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_JUMP_or_JSR_fixed, var_cas_ioGeneratedInstructionList, var_cas_idx, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (359)) ;
              }
            }
