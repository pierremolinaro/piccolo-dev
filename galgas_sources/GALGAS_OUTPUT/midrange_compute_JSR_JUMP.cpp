...
category_method__midrange_ipic_actualInstruction__defineLabelAtAddress (C_Compiler & inLexique,
  ...
  if (operand_1964 != NULL) {
    ...
    var_cas_nextAddress = var_cas_ioAddress._add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (58)) ;
...
category_method__midrange_ipic_JUMP__compute (C_Compiler & inLexique,
  ...
  if (operand_4514 != NULL) {
    ...
    if (_temp_4832.isBuilt ()) {
      _temp_4832 (HERE)->method_searchKey (inLexique, operand_4514->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (130)) ;
    }
    ...
    if ((((var_cas_flags)._operator_and (GGS_uint (2048U)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_bit11 = GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE) ;
    }else if ((((var_cas_targetAddress)._operator_and (GGS_uint (2048U)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_bit11 = GGS_midrange_call_goto_bit::constructor_clear (inLexique COMMA_HERE) ;
    }else{
      var_cas_bit11 = GGS_midrange_call_goto_bit::constructor_set (inLexique COMMA_HERE) ;
    }
    ...
    if ((((var_cas_flags)._operator_and (GGS_uint (4096U)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_bit12 = GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE) ;
    }else if ((((var_cas_targetAddress)._operator_and (GGS_uint (4096U)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_bit12 = GGS_midrange_call_goto_bit::constructor_clear (inLexique COMMA_HERE) ;
    }else{
      var_cas_bit12 = GGS_midrange_call_goto_bit::constructor_set (inLexique COMMA_HERE) ;
    }
    if ((((var_cas_bit11)._operator_isNotEqual (operand_4514->mBit11))._operator_or ((var_cas_bit12)._operator_isNotEqual (operand_4514->mBit12))).isBuiltAndTrue ()) {
      ...
      var_cas_instruction = GGS_midrange_ipic_JUMP ::constructor_new (inLexique, operand_4514->mInstructionLocation, operand_4514->mTargetLabel, var_cas_bit11, var_cas_bit12 COMMA_HERE) ;
      ...
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160))) ;
...
category_method__midrange_ipic_JSR__compute (C_Compiler & inLexique,
  ...
  if (operand_6080 != NULL) {
    ...
    if (_temp_6398.isBuilt ()) {
      _temp_6398 (HERE)->method_searchKey (inLexique, operand_6080->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (176)) ;
    }
    GGS_uint  var_cas_flags ;
    var_cas_flags = (var_cas_ioAddress)._operator_xor (var_cas_targetAddress) ;
    GGS_midrange_call_goto_bit var_cas_bit11 ;
    ...
    if ((((var_cas_bit11)._operator_isNotEqual (operand_6080->mBit11))._operator_or ((var_cas_bit12)._operator_isNotEqual (operand_6080->mBit12))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_actualInstruction  var_cas_instruction ;
      var_cas_instruction = GGS_midrange_ipic_JSR ::constructor_new (inLexique, operand_6080->mInstructionLocation, operand_6080->mTargetLabel, var_cas_bit11, var_cas_bit12 COMMA_HERE) ;
      ...
      var_cas_ioJUMP_or_JSR_fixed = GGS_bool (true) ;
      var_cas_ioListFileContents.appendCString ("  line ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
...
category_method__midrange_ipic_pseudo_LABEL__compute (C_Compiler & inLexique,
  ...
  if (operand_7653 != NULL) {
    ...
    if (_temp_7971.isBuilt ()) {
      _temp_7971 (HERE)->method_searchKey (inLexique, operand_7653->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (221)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_7653->mLabel.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("Internal second pass error: the '"))._operator_concat (operand_7653->mLabel))._operator_concat (GGS_string ("' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (224))))._operator_concat (GGS_string (" value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (225))))._operator_concat (GGS_string (" in first pass")) COMMA_SOURCE_FILE_AT_LINE (226)) ;
    }
  }
}
...
void routine_midrange_compute_JSR_JUMP (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (336))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("COMPUTE JSR and JUMP").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (337))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (338))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  ...
  GGS_uint _variant_14870 = var_cas_ioGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
  GGS_bool _condition_14870 (_variant_14870.isBuilt (), true) ;
  while (_condition_14870.isBuiltAndTrue ()) {
    _condition_14870 = (var_cas_JUMP_or_JSR_fixed)._operator_and ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))) ;
    if (_condition_14870.isBuiltAndTrue ()) {
      if (_variant_14870.uintValue () == 0) {
        ...
        _variant_14870._decrement_operation (inLexique COMMA_HERE) ;
        var_cas_JUMP_or_JSR_fixed = GGS_bool (false) ;
        var_cas_iteration._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (345)) ;
        var_cas_ioListFileContents.appendCString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (346))) ;
        var_cas_ioListFileContents.appendCString (":\n") ;
        GGS_midrange_symbolTableForConvertingRelatives  var_cas_symbolTable ;
        var_cas_symbolTable = GGS_midrange_symbolTableForConvertingRelatives ::constructor_emptyMap (inLexique COMMA_HERE) ;
        ...
        var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_13752 = enumerator_13752.nextObject ()))) {
            ...
            if (_temp_13796.isBuilt ()) {
              ...
              if (_method != NULL) {
                _method (inLexique, _temp_13796 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (351)) ;
              }
            }
          }
        }
        ...
        var_cas_currentAddress = GGS_uint (0U) ;
        {
          ...
          while (((operand_14030 = enumerator_14030.nextObject ()))) {
            ...
            if (_temp_14107.isBuilt ()) {
              _temp_14107 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (358)) ;
            }
            ...
            if (_temp_14157.isBuilt ()) {
              ...
              if (_method != NULL) {
                _method (inLexique, _temp_14157 (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_JUMP_or_JSR_fixed, var_cas_ioGeneratedInstructionList, var_cas_idx, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (359)) ;
              }
            }
            var_cas_currentAddress = var_cas_currentAddress._add_operation (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (360)) ;
            var_cas_idx.mValue ++ ;
          }
        }
        if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (363))))._operator_concat (GGS_string (" value when checking relative branches, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (365))))._operator_concat (GGS_string (" value when computing routine map")) COMMA_SOURCE_FILE_AT_LINE (366)) ;
        }
        if (((var_cas_JUMP_or_JSR_fixed)._operator_not ()).isBuiltAndTrue ()) {
          ...
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (369))) ;
