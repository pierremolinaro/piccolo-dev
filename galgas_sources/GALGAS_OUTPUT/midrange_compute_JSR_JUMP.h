...
//--- Current element access
  public : class GALGAS_midrange_5F_symbolTableForConvertingRelatives_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_midrange_5F_symbolTableForConvertingRelatives_2E_element constructor_new (const class GALGAS_lstring & inOperand0,
