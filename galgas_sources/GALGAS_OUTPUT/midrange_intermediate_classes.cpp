...
static void categoryMethod_registerExpression_resolveMidrangeAccess (const cPtr_registerExpression * inObject,
  ...
  GALGAS_string joker_929_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, var_registerAddressList, var_size, outArgument_outBitSliceTable, joker_929_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (27)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mOffset.reader_uint (SOURCE_FILE_AT_LINE (35)).objectCompare (var_size)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (object->mAttribute_mOffset.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("maximum index value is ").operator_concat (var_size.substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (36)).reader_string (SOURCE_FILE_AT_LINE (36)) COMMA_SOURCE_FILE_AT_LINE (36)) COMMA_SOURCE_FILE_AT_LINE (36)) ;
  }
  GALGAS_uintlist var_acceptableBanks = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (39)) ;
  cEnumerator_uintlist enumerator_1154 (var_registerAddressList, kEnumeration_up) ;
  while (enumerator_1154.hasCurrentObject ()) {
    var_acceptableBanks.addAssign_operation (enumerator_1154.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)) ;
    enumerator_1154.gotoNextObject () ;
  }
  GALGAS_uint var_registerAddress = GALGAS_uint ((PMUInt32) 0U) ;
  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, constinArgument_inCurrentBank.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (45)))).boolEnum () ;
  if (kBoolTrue == test_3) {
    ...
    if (constinArgument_inTotalBankCount.isValid ()) {
      PMUInt32 variant_1420 = constinArgument_inTotalBankCount.uintValue () ;
      bool loop_1420 = true ;
      while (loop_1420) {
        loop_1420 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (49)).isValid () ;
        if (loop_1420) {
          loop_1420 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (49)).boolValue () ;
        }
        if (loop_1420 && (0 == variant_1420)) {
          loop_1420 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (49)) ;
        }
        if (loop_1420) {
          variant_1420 -- ;
          var_ok = GALGAS_bool (false) ;
          cEnumerator_uintlist enumerator_1522 (var_registerAddressList, kEnumeration_up) ;
          bool bool_4 = var_ok.operator_not (SOURCE_FILE_AT_LINE (51)).isValidAndTrue () ;
          if (enumerator_1522.hasCurrentObject () && bool_4) {
            while (enumerator_1522.hasCurrentObject () && bool_4) {
              var_ok = GALGAS_bool (kIsSupOrEqual, enumerator_1522.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (52)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_1522.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (52)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (52)))) COMMA_SOURCE_FILE_AT_LINE (52)) ;
              var_registerAddress = enumerator_1522.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (53)) ;
              enumerator_1522.gotoNextObject () ;
              if (enumerator_1522.hasCurrentObject ()) {
                bool_4 = var_ok.operator_not (SOURCE_FILE_AT_LINE (51)).isValidAndTrue () ;
              }
            }
          }
          var_bank.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (55)) ;
        }
      }
    }
    const enumGalgasBool test_5 = var_ok.operator_not (SOURCE_FILE_AT_LINE (57)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_string var_acceptableBankMessage = GALGAS_string::makeEmptyString () ;
      cEnumerator_uintlist enumerator_1805 (var_registerAddressList, kEnumeration_up) ;
      while (enumerator_1805.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_1805.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (60)).reader_string (SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60)) ;
        if (enumerator_1805.hasNextObject ()) {
          var_acceptableBankMessage.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (61)) ;
        }
      ...
      inCompiler->emitSemanticError (location_6, GALGAS_string ("as no bank is currently known, the '").operator_concat (object->mAttribute_mRegisterName.reader_string (SOURCE_FILE_AT_LINE (63)) COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (GALGAS_string ("' register accessible from bank ") COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (var_acceptableBankMessage COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (GALGAS_string (", but should be able to be accessed from any bank setting") COMMA_SOURCE_FILE_AT_LINE (63)) COMMA_SOURCE_FILE_AT_LINE (63)) ;
    }
  }else if (kBoolFalse == test_3) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_uintlist enumerator_2210 (var_registerAddressList, kEnumeration_up) ;
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (67)).isValidAndTrue () ;
    if (enumerator_2210.hasCurrentObject () && bool_7) {
      while (enumerator_2210.hasCurrentObject () && bool_7) {
        var_found = GALGAS_bool (kIsSupOrEqual, enumerator_2210.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (68)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_2210.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (68)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (68)))) COMMA_SOURCE_FILE_AT_LINE (68)) ;
        var_registerAddress = enumerator_2210.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (69)) ;
        enumerator_2210.gotoNextObject () ;
        if (enumerator_2210.hasCurrentObject ()) {
          bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (67)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (71)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_acceptableBankMessage = GALGAS_string::makeEmptyString () ;
      cEnumerator_uintlist enumerator_2483 (var_registerAddressList, kEnumeration_up) ;
      while (enumerator_2483.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_2483.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (SOURCE_FILE_AT_LINE (74)) COMMA_SOURCE_FILE_AT_LINE (74)) ;
        if (enumerator_2483.hasNextObject ()) {
          var_acceptableBankMessage.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (75)) ;
        }
      ...
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (object->mAttribute_mRegisterName.reader_string (SOURCE_FILE_AT_LINE (77)) COMMA_SOURCE_FILE_AT_LINE (77)).operator_concat (GALGAS_string ("' register cannot be accessed from bank ") COMMA_SOURCE_FILE_AT_LINE (77)).operator_concat (constinArgument_inCurrentBank.reader_string (SOURCE_FILE_AT_LINE (77)) COMMA_SOURCE_FILE_AT_LINE (77)).operator_concat (GALGAS_string (" (valid bank setting: ") COMMA_SOURCE_FILE_AT_LINE (77)).operator_concat (var_acceptableBankMessage COMMA_SOURCE_FILE_AT_LINE (77)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (77)) COMMA_SOURCE_FILE_AT_LINE (77)) ;
    }
  }
  outArgument_outIPICregisterDescription = GALGAS_midrange_5F_intermediate_5F_registerExpression::constructor_new (var_assemblyString, var_registerAddress.add_operation (object->mAttribute_mOffset.reader_uint (SOURCE_FILE_AT_LINE (83)), inCompiler COMMA_SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (81)) ;
}
//---------------------------------------------------------------------------*
