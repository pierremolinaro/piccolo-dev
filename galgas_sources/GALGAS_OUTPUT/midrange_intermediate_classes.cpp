...
static void categoryMethod_registerExpression_resolveMidrangeAccess (const cPtr_registerExpression * inObject,
  ...
  GALGAS_string joker_1005_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, var_registerAddressList, var_size, outArgument_outBitSliceTable, joker_1005_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (29)) ;
  ...
  cEnumerator_uintlist enumerator_1230 (var_registerAddressList, kEnumeration_up) ;
  while (enumerator_1230.hasCurrentObject ()) {
    var_acceptableBanks.addAssign_operation (enumerator_1230.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    if (constinArgument_inTotalBankCount.isValid ()) {
      PMUInt32 variant_1496 = constinArgument_inTotalBankCount.uintValue () ;
      bool loop_1496 = true ;
      while (loop_1496) {
        loop_1496 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (51)).isValid () ;
        if (loop_1496) {
          loop_1496 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (51)).boolValue () ;
        }
        if (loop_1496 && (0 == variant_1496)) {
          loop_1496 = false ;
        ...
        if (loop_1496) {
          ...
          cEnumerator_uintlist enumerator_1598 (var_registerAddressList, kEnumeration_up) ;
          bool bool_4 = var_ok.operator_not (SOURCE_FILE_AT_LINE (53)).isValidAndTrue () ;
          if (enumerator_1598.hasCurrentObject () && bool_4) {
            while (enumerator_1598.hasCurrentObject () && bool_4) {
              var_ok = GALGAS_bool (kIsSupOrEqual, enumerator_1598.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_1598.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)))) COMMA_SOURCE_FILE_AT_LINE (54)) ;
              var_registerAddress = enumerator_1598.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (55)) ;
              enumerator_1598.gotoNextObject () ;
              if (enumerator_1598.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_5) {
      ...
      cEnumerator_uintlist enumerator_1881 (var_registerAddressList, kEnumeration_up) ;
      while (enumerator_1881.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_1881.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (62)).reader_string (SOURCE_FILE_AT_LINE (62)) COMMA_SOURCE_FILE_AT_LINE (62)) ;
    ...
    cEnumerator_uintlist enumerator_2286 (var_registerAddressList, kEnumeration_up) ;
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (69)).isValidAndTrue () ;
    if (enumerator_2286.hasCurrentObject () && bool_7) {
      while (enumerator_2286.hasCurrentObject () && bool_7) {
        var_found = GALGAS_bool (kIsSupOrEqual, enumerator_2286.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_2286.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)))) COMMA_SOURCE_FILE_AT_LINE (70)) ;
        var_registerAddress = enumerator_2286.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (71)) ;
    ...
    if (kBoolTrue == test_8) {
      GALGAS_string var_acceptableBankMessage = GALGAS_string::makeEmptyString () ;
      cEnumerator_uintlist enumerator_2559 (var_registerAddressList, kEnumeration_up) ;
      while (enumerator_2559.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_2559.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (76)).reader_string (SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
        if (enumerator_2559.hasNextObject ()) {
