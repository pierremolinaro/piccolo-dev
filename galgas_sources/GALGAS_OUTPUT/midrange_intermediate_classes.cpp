...
static void categoryMethod_registerExpression_resolveMidrangeAccess (const cPtr_registerExpression * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mOffset.reader_uint (SOURCE_FILE_AT_LINE (25)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  if (kBoolTrue == test_1) {
    ...
    inCompiler->emitSemanticError (location_2, GALGAS_string ("maximum index value is ").operator_concat (var_size.substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (38)).reader_string (SOURCE_FILE_AT_LINE (38)) COMMA_SOURCE_FILE_AT_LINE (38)) COMMA_SOURCE_FILE_AT_LINE (38)) ;
  }
  ...
  while (enumerator_1227.hasCurrentObject ()) {
    var_acceptableBanks.addAssign_operation (enumerator_1227.current_mValue (HERE).right_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    if (constinArgument_inTotalBankCount.isValid ()) {
      uint32_t variant_1479 = constinArgument_inTotalBankCount.uintValue () ;
      bool loop_1479 = true ;
      while (loop_1479) {
        ...
        if (loop_1479) {
          ...
          if (enumerator_1592.hasCurrentObject () && bool_4) {
            while (enumerator_1592.hasCurrentObject () && bool_4) {
              var_ok = GALGAS_bool (kIsSupOrEqual, enumerator_1592.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((uint32_t) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_1592.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((uint32_t) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)).add_operation (GALGAS_uint ((uint32_t) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)))) COMMA_SOURCE_FILE_AT_LINE (54)) ;
              var_registerAddress = enumerator_1592.current_mValue (HERE).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE_AT_LINE (55)) ;
    ...
    if (kBoolTrue == test_5) {
      ...
      while (enumerator_1872.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_1872.current_mValue (HERE).right_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE_AT_LINE (62)).reader_string (SOURCE_FILE_AT_LINE (62)) COMMA_SOURCE_FILE_AT_LINE (62)) ;
    ...
    if (enumerator_2280.hasCurrentObject () && bool_7) {
      while (enumerator_2280.hasCurrentObject () && bool_7) {
        var_found = GALGAS_bool (kIsSupOrEqual, enumerator_2280.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((uint32_t) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_2280.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((uint32_t) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)).add_operation (GALGAS_uint ((uint32_t) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)))) COMMA_SOURCE_FILE_AT_LINE (70)) ;
        var_registerAddress = enumerator_2280.current_mValue (HERE).operator_and (GALGAS_uint ((uint32_t) 127U) COMMA_SOURCE_FILE_AT_LINE (71)) ;
    ...
    if (kBoolTrue == test_8) {
      ...
      while (enumerator_2550.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_2550.current_mValue (HERE).right_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE_AT_LINE (76)).reader_string (SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
