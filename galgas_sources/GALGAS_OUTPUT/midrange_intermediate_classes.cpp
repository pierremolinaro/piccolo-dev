...
static void categoryMethod_registerExpression_resolveMidrangeAccess (const cPtr_registerExpression * inObject,
  ...
  ioArgument_ioUsedRegisters.addAssign_operation (object->mAttribute_mRegisterName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (22)) ;
  ...
  GALGAS_string joker_1004_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, var_registerAddressList, var_size, outArgument_outBitSliceTable, joker_1004_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (29)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mOffset.reader_uint (SOURCE_FILE_AT_LINE (37)).objectCompare (var_size)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (object->mAttribute_mOffset.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("maximum index value is ").operator_concat (var_size.substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (38)).reader_string (SOURCE_FILE_AT_LINE (38)) COMMA_SOURCE_FILE_AT_LINE (38)) COMMA_SOURCE_FILE_AT_LINE (38)) ;
  }
  GALGAS_uintlist var_acceptableBanks = GALGAS_uintlist::constructor_emptyList (SOURCE_FILE_AT_LINE (41)) ;
  cEnumerator_uintlist enumerator_1227 (var_registerAddressList, kEnumeration_up) ;
  while (enumerator_1227.hasCurrentObject ()) {
    var_acceptableBanks.addAssign_operation (enumerator_1227.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    enumerator_1227.gotoNextObject () ;
  }
  GALGAS_uint var_registerAddress = GALGAS_uint ((PMUInt32) 0U) ;
  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, constinArgument_inCurrentBank.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (47)))).boolEnum () ;
  if (kBoolTrue == test_3) {
    ...
    if (constinArgument_inTotalBankCount.isValid ()) {
      PMUInt32 variant_1479 = constinArgument_inTotalBankCount.uintValue () ;
      bool loop_1479 = true ;
      while (loop_1479) {
        loop_1479 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (51)).isValid () ;
        if (loop_1479) {
          loop_1479 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (51)).boolValue () ;
        }
        if (loop_1479 && (0 == variant_1479)) {
          loop_1479 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (51)) ;
        }
        if (loop_1479) {
          variant_1479 -- ;
          var_ok = GALGAS_bool (false) ;
          cEnumerator_uintlist enumerator_1592 (var_registerAddressList, kEnumeration_up) ;
          bool bool_4 = var_ok.operator_not (SOURCE_FILE_AT_LINE (53)).isValidAndTrue () ;
          if (enumerator_1592.hasCurrentObject () && bool_4) {
            while (enumerator_1592.hasCurrentObject () && bool_4) {
              var_ok = GALGAS_bool (kIsSupOrEqual, enumerator_1592.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_1592.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)))) COMMA_SOURCE_FILE_AT_LINE (54)) ;
              var_registerAddress = enumerator_1592.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (55)) ;
              enumerator_1592.gotoNextObject () ;
              if (enumerator_1592.hasCurrentObject ()) {
                bool_4 = var_ok.operator_not (SOURCE_FILE_AT_LINE (53)).isValidAndTrue () ;
              }
            }
          }
          var_bank.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (57)) ;
        }
      }
    }
    const enumGalgasBool test_5 = var_ok.operator_not (SOURCE_FILE_AT_LINE (59)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_string var_acceptableBankMessage = GALGAS_string::makeEmptyString () ;
      cEnumerator_uintlist enumerator_1872 (var_registerAddressList, kEnumeration_up) ;
      while (enumerator_1872.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_1872.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (62)).reader_string (SOURCE_FILE_AT_LINE (62)) COMMA_SOURCE_FILE_AT_LINE (62)) ;
        if (enumerator_1872.hasNextObject ()) {
          var_acceptableBankMessage.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (63)) ;
        }
      ...
      inCompiler->emitSemanticError (location_6, GALGAS_string ("as no bank is currently known, the '").operator_concat (object->mAttribute_mRegisterName.reader_string (SOURCE_FILE_AT_LINE (65)) COMMA_SOURCE_FILE_AT_LINE (65)).operator_concat (GALGAS_string ("' register accessible from bank ") COMMA_SOURCE_FILE_AT_LINE (65)).operator_concat (var_acceptableBankMessage COMMA_SOURCE_FILE_AT_LINE (65)).operator_concat (GALGAS_string (", but should be able to be accessed from any bank setting") COMMA_SOURCE_FILE_AT_LINE (65)) COMMA_SOURCE_FILE_AT_LINE (65)) ;
    }
  }else if (kBoolFalse == test_3) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_uintlist enumerator_2280 (var_registerAddressList, kEnumeration_up) ;
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (69)).isValidAndTrue () ;
    if (enumerator_2280.hasCurrentObject () && bool_7) {
      while (enumerator_2280.hasCurrentObject () && bool_7) {
        var_found = GALGAS_bool (kIsSupOrEqual, enumerator_2280.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_2280.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)))) COMMA_SOURCE_FILE_AT_LINE (70)) ;
        var_registerAddress = enumerator_2280.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (71)) ;
        enumerator_2280.gotoNextObject () ;
        if (enumerator_2280.hasCurrentObject ()) {
          bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (69)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (73)).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_acceptableBankMessage = GALGAS_string::makeEmptyString () ;
      cEnumerator_uintlist enumerator_2550 (var_registerAddressList, kEnumeration_up) ;
      while (enumerator_2550.hasCurrentObject ()) {
        var_acceptableBankMessage.dotAssign_operation (enumerator_2550.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (76)).reader_string (SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
        if (enumerator_2550.hasNextObject ()) {
          var_acceptableBankMessage.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (77)) ;
        }
      ...
      inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (object->mAttribute_mRegisterName.reader_string (SOURCE_FILE_AT_LINE (79)) COMMA_SOURCE_FILE_AT_LINE (79)).operator_concat (GALGAS_string ("' register cannot be accessed from bank ") COMMA_SOURCE_FILE_AT_LINE (79)).operator_concat (constinArgument_inCurrentBank.reader_string (SOURCE_FILE_AT_LINE (79)) COMMA_SOURCE_FILE_AT_LINE (79)).operator_concat (GALGAS_string (" (valid bank setting: ") COMMA_SOURCE_FILE_AT_LINE (79)).operator_concat (var_acceptableBankMessage COMMA_SOURCE_FILE_AT_LINE (79)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (79)) COMMA_SOURCE_FILE_AT_LINE (79)) ;
    }
  }
  outArgument_outIPICregisterDescription = GALGAS_midrange_5F_intermediate_5F_registerExpression::constructor_new (var_assemblyString, var_registerAddress.add_operation (object->mAttribute_mOffset.reader_uint (SOURCE_FILE_AT_LINE (85)), inCompiler COMMA_SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (83)) ;
}
//---------------------------------------------------------------------------*
