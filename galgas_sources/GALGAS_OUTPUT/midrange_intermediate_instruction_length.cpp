...
static GALGAS_uint categoryReader_midrange_5F_intermediate_5F_JSR_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outLength = result_outLength.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    //-------- @assignmentInstructionForGeneration
    result_outLength = result_outLength.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)) ;
  }
//---
  return result_outLength ;
}
