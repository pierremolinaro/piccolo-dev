...
category_method__midrange_ipic_incDecRegisterInCondition__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_2920 != NULL) {
    ...
    if ((operand_2920->mBranchIfZero).isBuiltAndTrue ()) {
      ...
      var_cas_localLabel = (GGS_string ("_local_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (115))) ;
...
category_method__midrange_ipic_instruction_MNOP__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_7198 != NULL) {
    if (((operand_7198->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (259)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      operand_7198->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("No generated code") COMMA_SOURCE_FILE_AT_LINE (260)) ;
    }
...
void routine_midrange_build_assembly_code (C_Compiler & _inLexique,
  ...
  var_cas_outAssemblyCode.appendCString ("W EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (360)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      "\n") ;
    {
      ...
      while (((operand_10711 = enumerator_10711.nextObject ()))) {
        ...
        var_cas_outAssemblyCode.appendCString (", ") ;
        var_cas_outAssemblyCode._dotAssign_operation ((operand_10711->mInfo.mRegisterValue)._operator_and (GGS_uint (255U)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (363))) ;
        var_cas_outAssemblyCode.appendCString ("\n") ;
      }
    }
  }
