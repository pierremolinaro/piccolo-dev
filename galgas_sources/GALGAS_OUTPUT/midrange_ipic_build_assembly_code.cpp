...
void routine_midrange_5F_build_5F_assembly_5F_code (const GALGAS_string constinArgument_inProcessorName,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_9607 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_9607.hasCurrentObject ()) {
    callCategoryMethod_buildAssemblyCode ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_9607.current_mInstruction (HERE).ptr (), outArgument_outAssemblyCode, var_bccLabelIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
  ...
  cEnumerator_registerTable enumerator_9836 (constinArgument_inPredefinedRegisters, kEnumeration_up) ;
  while (enumerator_9836.hasCurrentObject ()) {
    GALGAS_uint var_firstRegister ;
    enumerator_9836.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (341)) ;
    outArgument_outAssemblyCode.dotAssign_operation (enumerator_9836.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (342)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (342)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (342)) COMMA_SOURCE_FILE_AT_LINE (342)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (342)) COMMA_SOURCE_FILE_AT_LINE (342)) ;
  ...
  cEnumerator_registerTable enumerator_10163 (constinArgument_inAllRegisters, kEnumeration_up) ;
  while (enumerator_10163.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inPredefinedRegisters.reader_hasKey (enumerator_10163.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)).operator_not (SOURCE_FILE_AT_LINE (348)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_uint var_firstRegister ;
      enumerator_10163.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
      outArgument_outAssemblyCode.dotAssign_operation (enumerator_10163.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (350)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (350)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)) ;
    }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_actualConfigurationMap enumerator_10752 (constinArgument_inActualConfigurationMap, kEnumeration_up) ;
    while (enumerator_10752.hasCurrentObject ()) {
      outArgument_outAssemblyCode.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_10752.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (enumerator_10752.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (361)).reader_hexString (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_buildAssemblyCode (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (261)).isValid ()) {
    PMUInt32 variant_7392 = object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (261)).uintValue () ;
    bool loop_7392 = true ;
    while (loop_7392) {
      loop_7392 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (262)))).isValid () ;
      if (loop_7392) {
        loop_7392 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mOccurrenceFactor.reader_uint (SOURCE_FILE_AT_LINE (262)))).boolValue () ;
      }
      if (loop_7392 && (0 == variant_7392)) {
        loop_7392 = false ;
