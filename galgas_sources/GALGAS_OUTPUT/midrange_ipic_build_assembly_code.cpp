...
category_method__midrange_ipic_pseudo_ORG__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_906 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_906->mOrigin.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (30))) ;
...
category_method__midrange_ipic_pseudo_LABEL__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_1150 != NULL) {
    var_cas_ioString._dotAssign_operation (operand_1150->mLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (39))) ;
    var_cas_ioString.appendCString (":\n") ;
  }
}
...
category_method__midrange_ipic_instruction_FD__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_1382 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1382->mInstruction_FD_base_code.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (48))) ;
    var_cas_ioString.appendCString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_1382->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (48))) ;
...
category_method__midrange_ipic_instruction_FB__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_1796 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1796->mBitOrientedOp.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (63))) ;
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1796->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (64))) ;
    var_cas_ioString.appendCString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_1796->mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (65))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__midrange_ipic_instruction_BitTestSkip__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_2172 != NULL) {
    ...
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_2172->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (81))) ;
    var_cas_ioString.appendCString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_2172->mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (82))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__midrange_ipic_instruction_F__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_2601 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_2601->mFinstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (92))) ;
    var_cas_ioString.appendCString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_2601->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (92))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__midrange_ipic_incDecRegisterInCondition__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_2920 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_2920->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (107))) ;
    ...
    if ((operand_2920->mBranchIfZero).isBuiltAndTrue ()) {
      ...
      var_cas_localLabel = (GGS_string ("_local_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115))) ;
      var_cas_ioLocalLabelIndex._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (115)) ;
...
category_method__midrange_ipic_JUMP__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_3696 != NULL) {
    ...
    var_cas_ioString.appendCString ("  GOTO   ") ;
    var_cas_ioString._dotAssign_operation (operand_3696->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__midrange_ipic_GOTO__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_4233 != NULL) {
    var_cas_ioString.appendCString ("  GOTO   ") ;
    var_cas_ioString._dotAssign_operation (operand_4233->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (149))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__midrange_ipic_JSR__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_4473 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_4473->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168))) ;
    var_cas_ioString.appendCString ("\n") ;
    switch (operand_4473->mBit11.enumValue ()) {
    case GGS_midrange_call_goto_bit::enum_set:
      {
...
category_method__midrange_ipic_CALL__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_5305 != NULL) {
    var_cas_ioString.appendCString ("  CALL  ") ;
    var_cas_ioString._dotAssign_operation (operand_5305->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__midrange_ipic_instruction_literalOperation__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_6909 != NULL) {
    var_cas_ioString.appendCString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_6909->mLiteralInstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (250))) ;
    var_cas_ioString.appendCString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_6909->mLiteralValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (250))) ;
    var_cas_ioString.appendCString ("\n") ;
  }
}
...
category_method__midrange_ipic_instruction_MNOP__buildAssemblyCode (C_Compiler & inLexique,
  ...
  if (operand_7198 != NULL) {
    if (((operand_7198->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (259)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    while (_condition_7504.isBuiltAndTrue ()) {
      _condition_7504 = (var_cas_idx)._operator_strictInf (operand_7198->mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (264))) ;
      if (_condition_7504.isBuiltAndTrue ()) {
        if (_variant_7504.uintValue () == 0) {
          ...
          _variant_7504._decrement_operation (inLexique COMMA_HERE) ;
          var_cas_ioString.appendCString ("  NOP\n") ;
          var_cas_idx._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ;
        }
      }
    }
  }
...
void routine_midrange_build_assembly_code (C_Compiler & inLexique,
  ...
  var_cas_bccLabelIndex = GGS_uint (0U) ;
  {
    ...
    while (((operand_9569 = enumerator_9569.nextObject ()))) {
      ...
      if (_temp_9608.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (inLexique, _temp_9608 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (337)) ;
        }
      }
    }
  }
  ...
  var_cas_outAssemblyCode.appendCString (";--- Prefefined registers\n") ;
  {
    ...
    while (((operand_9798 = enumerator_9798.nextObject ()))) {
      ...
      if (_temp_9855.isBuilt ()) {
        _temp_9855 (HERE)->method_first (inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (343)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_9798->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (344))) ;
      var_cas_outAssemblyCode.appendCString (" EQU ") ;
      var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (344))) ;
      var_cas_outAssemblyCode.appendCString ("\n") ;
    }
  }
  var_cas_outAssemblyCode.appendCString ("\n") ;
  var_cas_outAssemblyCode.appendCString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_10124 = enumerator_10124.nextObject ()))) {
      ...
      if (((var_cas_inPredefinedRegisters.reader_hasKey (inLexique, operand_10124->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_10244 = operand_10124->mInfo.mRegisterAddressList ;
        if (_temp_10244.isBuilt ()) {
          _temp_10244 (HERE)->method_first (inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (351)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_10124->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (352))) ;
        var_cas_outAssemblyCode.appendCString (" EQU ") ;
        var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (352))) ;
        var_cas_outAssemblyCode.appendCString ("\n") ;
      }
    }
  }
  ...
  var_cas_outAssemblyCode.appendCString ("W EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (360)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      "\n") ;
    {
      ...
      while (((operand_10711 = enumerator_10711.nextObject ()))) {
        ...
        var_cas_outAssemblyCode._dotAssign_operation (operand_10711->mInfo.mRegisterAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (363))) ;
        var_cas_outAssemblyCode.appendCString (", ") ;
        var_cas_outAssemblyCode._dotAssign_operation ((operand_10711->mInfo.mRegisterValue)._operator_and (GGS_uint (255U)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (363))) ;
        var_cas_outAssemblyCode.appendCString ("\n") ;
      }
    }
  }
