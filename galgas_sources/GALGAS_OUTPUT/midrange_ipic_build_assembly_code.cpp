...
void routine_midrange_5F_build_5F_assembly_5F_code (const GALGAS_string constinArgument_inProcessorName,
  ...
  while (enumerator_9603.hasCurrentObject ()) {
    callCategoryMethod_buildAssemblyCode ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_9603.current_mInstruction (HERE).ptr (), outArgument_outAssemblyCode, var_bccLabelIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
  ...
  while (enumerator_9832.hasCurrentObject ()) {
    ...
    enumerator_9832.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (341)) ;
    outArgument_outAssemblyCode.dotAssign_operation (enumerator_9832.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (342)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (342)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (342)) COMMA_SOURCE_FILE_AT_LINE (342)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (342)) COMMA_SOURCE_FILE_AT_LINE (342)) ;
  ...
  while (enumerator_10159.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inPredefinedRegisters.reader_hasKey (enumerator_10159.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)).operator_not (SOURCE_FILE_AT_LINE (348)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_uint var_firstRegister ;
      enumerator_10159.current_mRegisterAddressList (HERE).method_first (var_firstRegister, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
      outArgument_outAssemblyCode.dotAssign_operation (enumerator_10159.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (350)).operator_concat (GALGAS_string (" EQU ") COMMA_SOURCE_FILE_AT_LINE (350)).operator_concat (var_firstRegister.reader_hexString (SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)) ;
    }
  ...
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_10748.hasCurrentObject ()) {
      outArgument_outAssemblyCode.dotAssign_operation (GALGAS_string ("  __config ").operator_concat (enumerator_10748.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (enumerator_10748.current_mRegisterValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 255U) COMMA_SOURCE_FILE_AT_LINE (361)).reader_hexString (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_buildAssemblyCode (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (kBoolTrue == test_2) {
    GALGAS_string var_localLabel = GALGAS_string (".LL").operator_concat (ioArgument_ioLocalLabelIndex.reader_string (SOURCE_FILE_AT_LINE (113)) COMMA_SOURCE_FILE_AT_LINE (113)) ;
