...
void routine_midrange_build_assembly_code (C_Compiler & inLexique,
  ...
  var_cas_outAssemblyCode.appendCString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_10124 = enumerator_10124.nextObject ()))) {
      ...
      const GGS_bool cond_10355 = (var_cas_inPredefinedRegisters.reader_hasKey (inLexique, operand_10124->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350))).operator_not () ;
  ...
  var_cas_outAssemblyCode.appendCString ("W EQU 1\n"
    "\n") ;
  const GGS_bool cond_10859 = (var_cas_inActualConfigurationMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (360))).operator_strictSup (GGS_uint (0U)) ;
