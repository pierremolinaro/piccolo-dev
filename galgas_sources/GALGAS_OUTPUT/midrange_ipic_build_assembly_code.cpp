...
category_method__midrange_ipic_pseudo_ORG__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_pseudo_ORG * operand_714,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_714 != NULL) {
    var_cas_ioString.writeString ("  ORG ") ;
    var_cas_ioString._dotAssign_operation (operand_714->mOrigin.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (22))) ;
...
category_method__midrange_ipic_pseudo_LABEL__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_pseudo_LABEL * operand_956,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_956 != NULL) {
    var_cas_ioString._dotAssign_operation (operand_956->mLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (31))) ;
    var_cas_ioString.writeString (":\n") ;
  }
}
...
category_method__midrange_ipic_instruction_FD__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_FD * operand_1186,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_1186 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1186->mInstruction_FD_base_code.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (40))) ;
    var_cas_ioString.writeString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_1186->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (40))) ;
    if ((operand_1186->m_W_isDestination).isBuiltAndTrue ()) {
...
category_method__midrange_ipic_instruction_FB__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_FB * operand_1598,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_1598 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1598->mBitOrientedOp.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (55))) ;
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1598->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (56))) ;
    var_cas_ioString.writeString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_1598->mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (57))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__midrange_ipic_instruction_BitTestSkip__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_BitTestSkip * operand_1972,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_1972 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    if ((operand_1972->mSkipIfSet).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("BTFSS") ;
    }else{
      var_cas_ioString.writeString ("BTFSC") ;
    }
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_1972->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (73))) ;
    var_cas_ioString.writeString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_1972->mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__midrange_ipic_instruction_F__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_F * operand_2399,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_2399 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_2399->mFinstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (84))) ;
    var_cas_ioString.writeString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_2399->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (84))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__midrange_ipic_incDecRegisterInCondition__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_incDecRegisterInCondition * operand_2716,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_2716 != NULL) {
    if ((operand_2716->mIncrement).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  "
      "INCFSZ ") ;
    }else{
      var_cas_ioString.writeString ("  "
    ...
    var_cas_ioString._dotAssign_operation (operand_2716->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (99))) ;
    if ((operand_2716->m_W_isDestination).isBuiltAndTrue ()) {
      var_cas_ioString.writeString (", W") ;
    }else{
      var_cas_ioString.writeString (", F") ;
    }
    ...
    var_cas_ioString._dotAssign_operation (operand_2716->mTargetLabel) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__midrange_ipic_JUMP__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_JUMP * operand_3223,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3223 != NULL) {
    switch (operand_3223->mKind.enumValue ()) {
    case GGS_midrange_jumpInstructionKind::enum_ipicExtended:
      {
      var_cas_ioString.writeString ("  GOTO   ") ;
      var_cas_ioString._dotAssign_operation (operand_3223->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (116))) ;
      var_cas_ioString.writeString ("\n") ;
      }
      break ;
    case GGS_midrange_jumpInstructionKind::enum_native:
      {
      var_cas_ioString.writeString ("  GOTO  ") ;
      var_cas_ioString._dotAssign_operation (operand_3223->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (117))) ;
      var_cas_ioString.writeString ("\n") ;
      }
      break ;
...
category_method__midrange_ipic_JSR__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_JSR * operand_3593,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3593 != NULL) {
    switch (operand_3593->mKind.enumValue ()) {
    case GGS_midrange_jumpInstructionKind::enum_ipicExtended:
      {
      var_cas_ioString.writeString ("  CALL   ") ;
      var_cas_ioString._dotAssign_operation (operand_3593->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (128))) ;
      var_cas_ioString.writeString ("\n") ;
      }
      break ;
    case GGS_midrange_jumpInstructionKind::enum_native:
      {
      var_cas_ioString.writeString ("  CALL  ") ;
      var_cas_ioString._dotAssign_operation (operand_3593->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (129))) ;
      var_cas_ioString.writeString ("\n") ;
      }
      break ;
    case GGS_midrange_jumpInstructionKind::kNotBuilt:
...
category_method__midrange_ipic_instruction_CLRWDT__buildAssemblyCode (C_Compiler &,
                                const cPtr_midrange_ipic_instruction_CLRWDT * operand_3978,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3978 != NULL) {
...
category_method__midrange_ipic_instruction_CLRW__buildAssemblyCode (C_Compiler &,
                                const cPtr_midrange_ipic_instruction_CLRW * operand_4199,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4199 != NULL) {
...
category_method__midrange_ipic_instruction_NOP__buildAssemblyCode (C_Compiler &,
                                const cPtr_midrange_ipic_instruction_NOP * operand_4417,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4417 != NULL) {
...
category_method__midrange_ipic_instruction_RETURN__buildAssemblyCode (C_Compiler &,
                                const cPtr_midrange_ipic_instruction_RETURN * operand_4637,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__midrange_ipic_instruction_RETFIE__buildAssemblyCode (C_Compiler &,
                                const cPtr_midrange_ipic_instruction_RETFIE * operand_4861,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__midrange_ipic_instruction_SLEEP__buildAssemblyCode (C_Compiler &,
                                const cPtr_midrange_ipic_instruction_SLEEP * operand_5084,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5084 != NULL) {
...
category_method__midrange_ipic_instruction_literalOperation__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_literalOperation * operand_5316,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5316 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_5316->mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))) ;
    var_cas_ioString.writeString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_5316->mLiteralValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__midrange_ipic_instruction_MNOP__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_midrange_ipic_instruction_MNOP * operand_5603,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5603 != NULL) {
    if (((operand_5603->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_5603->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (203)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_5907 = operand_5603->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
    GGS_bool _condition_5907 (_variant_5907._isBuilt (), true) ;
    while (_condition_5907.isBuiltAndTrue ()) {
      _condition_5907 = (var_cas_idx)._operator_strictInf (operand_5603->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (207))) ;
      if (_condition_5907.isBuiltAndTrue ()) {
        if (_variant_5907.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (211)) ;
          _condition_5907 = GGS_bool (true, false) ;
        }else{
          _variant_5907._decrement_operation (_inLexique COMMA_HERE) ;
          var_cas_ioString.writeString ("  NOP\n") ;
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
      }
    }
  }
...
void routine_midrange_build_assembly_code (C_Compiler & _inLexique,
  ...
  {
    GGS_midrange_ipic_instructionList::cEnumerator enumerator_7881 (var_cas_inInstructionList, true) ;
    const GGS_midrange_ipic_instructionList::cElement * operand_7881 = NULL ;
    while (((operand_7881 = enumerator_7881.nextObject ()))) {
      macroValidPointer (operand_7881) ;
      const GGS_midrange_ipic_instruction  _temp_7920 = operand_7881->mInstruction ;
      if (_temp_7920._isBuilt ()) {
        typeCategoryMethod__midrange_ipic_instruction__buildAssemblyCode _method = findCategoryMethod__midrange_ipic_instruction__buildAssemblyCode (_temp_7920._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_7920 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (279)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_8110 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_8110 = NULL ;
    while (((operand_8110 = enumerator_8110.nextObject ()))) {
      macroValidPointer (operand_8110) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_8167 = operand_8110->mInfo.mRegisterAddressList ;
      if (_temp_8167._isBuilt ()) {
        _temp_8167 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (285)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_8110->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
      var_cas_outAssemblyCode.writeString (" EQU ") ;
      var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
      var_cas_outAssemblyCode.writeString ("\n") ;
    }
  }
  var_cas_outAssemblyCode.writeString ("\n") ;
  ...
  {
    GGS_registerTable::cEnumerator enumerator_8436 (var_cas_inAllRegisters, true) ;
    const GGS_registerTable::cElement * operand_8436 = NULL ;
    while (((operand_8436 = enumerator_8436.nextObject ()))) {
      macroValidPointer (operand_8436) ;
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_8436->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (292)) COMMA_SOURCE_FILE_AT_LINE (292)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_8556 = operand_8436->mInfo.mRegisterAddressList ;
        if (_temp_8556._isBuilt ()) {
          _temp_8556 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (293)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_8436->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (294))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
        var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (294))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
  ...
  var_cas_outAssemblyCode.writeString ("BSR_ACCESS EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (304)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outAssemblyCode.writeString (";--- Configuration\n"
      "\n") ;
    {
      GGS_actualConfigurationMap::cEnumerator enumerator_9103 (var_cas_inActualConfigurationMap, true) ;
      const GGS_actualConfigurationMap::cElement * operand_9103 = NULL ;
      while (((operand_9103 = enumerator_9103.nextObject ()))) {
        macroValidPointer (operand_9103) ;
        var_cas_outAssemblyCode.writeString ("  __config ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_9103->mInfo.mRegisterAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (307))) ;
        var_cas_outAssemblyCode.writeString (", ") ;
        var_cas_outAssemblyCode._dotAssign_operation ((operand_9103->mInfo.mRegisterValue)._operator_and (GGS_uint (true, 255U)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (307))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
