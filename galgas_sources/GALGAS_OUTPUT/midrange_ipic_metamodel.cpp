...
category_method__registerExpression__resolveMidrangeAccess (C_Compiler & _inLexique,
  ...
  if (operand_530 != NULL) {
    ...
    if (((operand_530->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (25)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_acceptableBanks = GGS_uintlist ::constructor_emptyList () ;
    {
      ...
      while (((operand_1184 = enumerator_1184.nextObject ()))) {
        ...
        var_cas_acceptableBanks._addAssign_operation (operand_1184->mValue._right_shift_operation (_inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (36))) ;
      }
    }
    if (((var_cas_inCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          ...
          if (_variant_1694.uintValue () == 0) {
            ...
            var_cas_ok = GGS_bool (false) ;
            {
              ...
              while (((operand_1518 = enumerator_1518.nextObject ()))
                ...
                var_cas_ok = ((operand_1518->mValue)._operator_supOrEqual (var_cas_bank._multiply_operation (_inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (46))))._operator_and ((operand_1518->mValue)._operator_strictInf (var_cas_bank._multiply_operation (_inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (46))._add_operation (_inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (46)))) ;
                var_cas_registerAddress = (operand_1518->mValue)._operator_and (GGS_uint (127U)) ;
              }
            }
      ...
      if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
        ...
        var_cas_acceptableBankMessage = GGS_string ("") ;
        {
          ...
          if ((operand_1798 != NULL)) {
            ...
            do{
              ...
              var_cas_acceptableBankMessage._dotAssign_operation (operand_1798->mValue._right_shift_operation (_inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (54)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (54))) ;
        ...
        operand_530->mRegisterName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("as no bank is currently known, the '"))._operator_concat (operand_530->mRegisterName))._operator_concat (GGS_string ("' register accessible from bank ")))._operator_concat (var_cas_acceptableBankMessage))._operator_concat (GGS_string (", but should be able to be accessed from any bank setting")) COMMA_SOURCE_FILE_AT_LINE (58)) ;
      }
    }else{
      ...
      var_cas_found = GGS_bool (false) ;
      {
        ...
        while (((operand_2206 = enumerator_2206.nextObject ()))
          ...
          var_cas_found = ((operand_2206->mValue)._operator_supOrEqual (var_cas_inCurrentBank._multiply_operation (_inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (62))))._operator_and ((operand_2206->mValue)._operator_strictInf (var_cas_inCurrentBank._multiply_operation (_inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (62))._add_operation (_inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (62)))) ;
          var_cas_registerAddress = (operand_2206->mValue)._operator_and (GGS_uint (127U)) ;
        }
      }
      if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
        ...
        var_cas_acceptableBankMessage = GGS_string ("") ;
        {
          ...
          if ((operand_2476 != NULL)) {
            ...
            do{
              ...
              var_cas_acceptableBankMessage._dotAssign_operation (operand_2476->mValue._right_shift_operation (_inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (68)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (68))) ;
        ...
        operand_530->mRegisterName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string ("the '"))._operator_concat (operand_530->mRegisterName))._operator_concat (GGS_string ("' register cannot be accessed from bank ")))._operator_concat (var_cas_inCurrentBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (71))))._operator_concat (GGS_string (" (valid bank setting: ")))._operator_concat (var_cas_acceptableBankMessage))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
      }
    }
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  var_cas_outLength = GGS_uint (1U) ;
  if (((mBit11)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (387)) ;
  }
  if (((mBit12)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (390)) ;
  }
}
