...
category_method__registerExpression__resolveMidrangeAccess (C_Compiler & inLexique,
  ...
  if (operand_530 != NULL) {
    ...
    if (((operand_530->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (25))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_acceptableBanks = GGS_uintlist ::constructor_emptyList () ;
    {
      ...
      while (((operand_1184 = enumerator_1184.nextObject ()))) {
        ...
        var_cas_acceptableBanks._addAssign_operation (operand_1184->mValue.right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (36))) ;
      }
    }
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (1U) ;
  if (((mBit11).operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (316)) ;
  }
  if (((mBit12).operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
