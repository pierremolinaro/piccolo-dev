...
void GGS_midrange_ipic_registerExpression::_drop (void) {
...
bool GGS_midrange_ipic_registerExpression::_isBuilt (void) const {
...
_operator_isEqual (const GGS_midrange_ipic_registerExpression & inOperand) const {
...
GGS_bool GGS_midrange_ipic_registerExpression::
_operator_isNotEqual (const GGS_midrange_ipic_registerExpression & inOperand) const {
...
static void
category_method__registerExpression__resolveMidrangeAccess (C_Compiler & _inLexique,
                                const cPtr_registerExpression * operand_494,
  ...
  if (operand_494 != NULL) {
    ...
    var_cas_assemblyString = operand_494->mRegisterName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (23)) ;
    if (((operand_494->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (24)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.writeString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_494->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (25)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (25))) ;
    }
    ...
    const GGS_registerTable  _temp_975 = var_cas_inRegisterTable ;
    if (_temp_975._isBuilt ()) {
      _temp_975 (HERE)->method_searchKey (_inLexique, operand_494->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (31)) ;
    }
    GGS_uintlist  var_cas_acceptableBanks ;
    var_cas_acceptableBanks = GGS_uintlist ::constructor_emptyList () ;
    {
      GGS_uintlist::cEnumerator enumerator_1148 (var_cas_registerAddressList, true) ;
      const GGS_uintlist::cElement * operand_1148 = NULL ;
      while (((operand_1148 = enumerator_1148.nextObject ()))) {
        macroValidPointer (operand_1148) ;
        var_cas_acceptableBanks._addAssign_operation (operand_1148->mValue._right_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (35))) ;
      }
    }
    if (((var_cas_inCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      ...
      var_cas_bank = GGS_uint (true, 0U) ;
      GGS_bool var_cas_ok ;
      var_cas_ok = GGS_bool (true, true) ;
      GGS_uint _variant_1658 = var_cas_inTotalBankCount ;
      GGS_bool _condition_1658 (_variant_1658._isBuilt (), true) ;
      while (_condition_1658.isBuiltAndTrue ()) {
        _condition_1658 = ((var_cas_bank)._operator_strictInf (var_cas_inTotalBankCount))._operator_and (var_cas_ok) ;
        if (_condition_1658.isBuiltAndTrue ()) {
          if (_variant_1658.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (49)) ;
            _condition_1658 = GGS_bool (true, false) ;
          }else{
            _variant_1658._decrement_operation (_inLexique COMMA_HERE) ;
            var_cas_ok = GGS_bool (true, false) ;
            {
              GGS_uintlist::cEnumerator enumerator_1482 (var_cas_registerAddressList, true) ;
              const GGS_uintlist::cElement * operand_1482 = NULL ;
              while (((operand_1482 = enumerator_1482.nextObject ()))
                  && ((var_cas_ok)._operator_not ().isBuiltAndTrue ())) {
                macroValidPointer (operand_1482) ;
                var_cas_ok = ((operand_1482->mValue)._operator_supOrEqual (var_cas_bank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (45))))._operator_and ((operand_1482->mValue)._operator_strictInf (var_cas_bank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (45))._add_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (45)))) ;
                var_cas_registerAddress = (operand_1482->mValue)._operator_and (GGS_uint (true, 127U)) ;
              }
            }
            var_cas_bank._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (48)) ;
          }
        }
      }
      if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
        GGS_string var_cas_acceptableBankMessage ;
        var_cas_acceptableBankMessage = GGS_string (true, "") ;
        {
          GGS_uintlist::cEnumerator enumerator_1762 (var_cas_registerAddressList, true) ;
          const GGS_uintlist::cElement * operand_1762 = enumerator_1762.nextObject () ;
          if ((operand_1762 != NULL)) {
            bool _foreach_loop_1762 ;
            do{
              macroValidPointer (operand_1762) ;
              var_cas_acceptableBankMessage._dotAssign_operation (operand_1762->mValue._right_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (53)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (53))) ;
              operand_1762 = enumerator_1762.nextObject () ;
              _foreach_loop_1762 = ((operand_1762 != NULL)) ;
              if (_foreach_loop_1762) {
                var_cas_acceptableBankMessage.writeString (", ") ;
              }
            }while (_foreach_loop_1762) ;
          }
        }
        operand_494->mRegisterName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "as no bank is currently known, the '"))._operator_concat (operand_494->mRegisterName))._operator_concat (GGS_string (true, "' register accessible from bank ")))._operator_concat (var_cas_acceptableBankMessage))._operator_concat (GGS_string (true, ", but should be able to be accessed from any bank setting")) COMMA_SOURCE_FILE_AT_LINE (57)) ;
      }
    }else{
      GGS_bool var_cas_found ;
      var_cas_found = GGS_bool (true, false) ;
      {
        GGS_uintlist::cEnumerator enumerator_2170 (var_cas_registerAddressList, true) ;
        const GGS_uintlist::cElement * operand_2170 = NULL ;
        while (((operand_2170 = enumerator_2170.nextObject ()))
            && ((var_cas_found)._operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_2170) ;
          var_cas_found = ((operand_2170->mValue)._operator_supOrEqual (var_cas_inCurrentBank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (61))))._operator_and ((operand_2170->mValue)._operator_strictInf (var_cas_inCurrentBank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (61))._add_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (61)))) ;
          var_cas_registerAddress = (operand_2170->mValue)._operator_and (GGS_uint (true, 127U)) ;
        }
      }
      if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
        ...
        var_cas_acceptableBankMessage = GGS_string (true, "") ;
        {
          GGS_uintlist::cEnumerator enumerator_2440 (var_cas_registerAddressList, true) ;
          const GGS_uintlist::cElement * operand_2440 = enumerator_2440.nextObject () ;
          if ((operand_2440 != NULL)) {
            bool _foreach_loop_2440 ;
            do{
              macroValidPointer (operand_2440) ;
              var_cas_acceptableBankMessage._dotAssign_operation (operand_2440->mValue._right_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (67))) ;
              operand_2440 = enumerator_2440.nextObject () ;
              _foreach_loop_2440 = ((operand_2440 != NULL)) ;
              if (_foreach_loop_2440) {
                var_cas_acceptableBankMessage.writeString (", ") ;
              }
            }while (_foreach_loop_2440) ;
          }
        }
        operand_494->mRegisterName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "the '"))._operator_concat (operand_494->mRegisterName))._operator_concat (GGS_string (true, "' register cannot be accessed from bank ")))._operator_concat (var_cas_inCurrentBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (70))))._operator_concat (GGS_string (true, " (valid bank setting: ")))._operator_concat (var_cas_acceptableBankMessage))._operator_concat (GGS_string (true, ")")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
      }
    }
    var_cas_outIPICregisterDescription = GGS_midrange_ipic_registerExpression::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (_inLexique, operand_494->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76))) ;
  }
}
...
static TC_UniqueArray <typeCategoryMethod__registerExpression__resolveMidrangeAccess> gDispatchTableFor__registerExpression__resolveMidrangeAccess ;
...
enterCategoryMethod__registerExpression__resolveMidrangeAccess (typeCategoryMethod__registerExpression__resolveMidrangeAccess inRoutine,
  ...
  gDispatchTableFor__registerExpression__resolveMidrangeAccess.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__registerExpression__resolveMidrangeAccess (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (inClassPtr->slotID () < gDispatchTableFor__registerExpression__resolveMidrangeAccess.count ()) {
    result = gDispatchTableFor__registerExpression__resolveMidrangeAccess (inClassPtr->slotID () COMMA_HERE) ;
  }
  if (result == NULL) {
    AC_galgasClassRunTimeInformation * superClassPtr = inClassPtr->superClassPtr () ;
    if (superClassPtr != NULL) {
      result = findCategoryMethod__registerExpression__resolveMidrangeAccess (superClassPtr) ;
      gDispatchTableFor__registerExpression__resolveMidrangeAccess.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
method_setCurrentAddress (C_Compiler & _inLexique,
  ...
  method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (88)) ;
  var_cas_ioCurrentAddress = var_cas_ioCurrentAddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (89)) ;
}
...
GGS_midrange_ipic_instruction (cPtr__AC_galgas_class * inPointer) {
...
_castFrom (C_Compiler & inLexique,
           ...
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction _result ;
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction (inPointer) ;
    }else{
...
AC_galgasClassRunTimeInformation * GGS_midrange_ipic_instruction::_galgasObjectRunTimeInfo (void) const {
...
C_galgasRootClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction ("midrange_ipic_instruction") ;
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    const elementOf_GGS_midrange_ipic_instructionList * _p = dynamic_cast <const elementOf_GGS_midrange_ipic_instructionList *> (inOperand) ;
...
_internalAppendValues (const GGS_midrange_ipic_instruction & argument_0
                    COMMA_LOCATION_ARGS) {
...
void GGS_midrange_ipic_instructionList::
_internalPrependValues (const GGS_midrange_ipic_instruction & argument_0
                    COMMA_LOCATION_ARGS) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0
                                COMMA_THERE)) ;
...
void GGS_midrange_ipic_instructionList::
_addAssign_operation (const GGS_midrange_ipic_instruction & argument_0) {
...
_operator_concat (const GGS_midrange_ipic_instructionList & inOperand) const {
...
void GGS_midrange_ipic_instructionList::
_dotAssign_operation (const GGS_midrange_ipic_instructionList inOperand) {
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@midrange_ipic_instructionList", inIndentation COMMA_THERE) ;
}
...
GGS_midrange_ipic_NULL (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_NULL _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_NULL (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_NULL ("midrange_ipic_NULL", gClassInfoFor__midrange_ipic_instruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    const cPtr_midrange_ipic_pseudo_ORG * _p = dynamic_cast <const cPtr_midrange_ipic_pseudo_ORG *> (inOperand) ;
    macroValidPointer (_p) ;
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOrigin.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (150))) ;
}
...
GGS_midrange_ipic_pseudo_ORG (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_pseudo_ORG _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_pseudo_ORG (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_pseudo_ORG ("midrange_ipic_pseudo_ORG", gClassInfoFor__midrange_ipic_instruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_pseudo_LABEL * _p = dynamic_cast <const cPtr_midrange_ipic_pseudo_LABEL *> (inOperand) ;
    macroValidPointer (_p) ;
...
GGS_midrange_ipic_pseudo_LABEL (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_pseudo_LABEL _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_pseudo_LABEL (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_pseudo_LABEL ("midrange_ipic_pseudo_LABEL", gClassInfoFor__midrange_ipic_instruction) ;
...
method_instructionLength (C_Compiler & /* _inLexique */,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (true, 1U) ;
}
...
GGS_midrange_ipic_actualInstruction (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_actualInstruction _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_actualInstruction (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_actualInstruction ("midrange_ipic_actualInstruction", gClassInfoFor__midrange_ipic_instruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_FD * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_FD *> (inOperand) ;
    macroValidPointer (_p) ;
...
method_getBaseCode (C_Compiler & _inLexique,
  ...
  ::routine_getMidRangeFDInstructionBaseCode (_inLexique,  mInstruction_FD_base_code,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (195)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mInstruction_FD_base_code.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))) ;
...
GGS_midrange_ipic_instruction_FD (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_FD _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_FD (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_FD ("midrange_ipic_instruction_FD", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
void routine_getMidRangeFinstructionBaseCode (C_Compiler &,
  ...
  case GGS_midrange_F_instruction_base_code::enum_CLRF:
    {
    var_cas_outBaseCode = GGS_uint (true, 384U) ;
    }
    break ;
  case GGS_midrange_F_instruction_base_code::enum_MOVWF:
    {
    var_cas_outBaseCode = GGS_uint (true, 128U) ;
    }
    break ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_F * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_F *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mFinstruction._operator_isEqual (_p->mFinstruction).boolValue ()
         && mRegisterDescription._operator_isEqual (_p->mRegisterDescription).boolValue () ;
  }
  return equal ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getMidRangeFinstructionBaseCode (_inLexique,  mFinstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (226)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mFinstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (231))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (231))) ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@midrange_ipic_instruction_F:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mFinstruction.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mRegisterDescription.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_midrange_ipic_instruction_F (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_F _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_F (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_F ("midrange_ipic_instruction_F", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_FB * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_FB *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getMidRangeBitOrientedOpBaseCode (_inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (253)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mBitOrientedOp.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (258))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (258))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (258))) ;
}
...
GGS_midrange_ipic_instruction_FB (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_FB _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_FB (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_FB ("midrange_ipic_instruction_FB", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_BitTestSkip * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_BitTestSkip *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  if ((mSkipIfSet).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString ("BTFSS") ;
  }else{
    var_cas_ioListFileContents.writeString ("BTFSC") ;
  }
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (285))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (285))) ;
}
...
GGS_midrange_ipic_instruction_BitTestSkip (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_BitTestSkip _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_BitTestSkip (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_BitTestSkip ("midrange_ipic_instruction_BitTestSkip", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
_operator_isEqual (const GGS_midrange_call_goto_bit inOperand) const {
...
GGS_bool GGS_midrange_call_goto_bit::
_operator_isNotEqual (const GGS_midrange_call_goto_bit inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue != inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_call_goto_bit::
_operator_infOrEqual (const GGS_midrange_call_goto_bit inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue <= inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_call_goto_bit::
_operator_supOrEqual (const GGS_midrange_call_goto_bit inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue >= inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_call_goto_bit::
_operator_strictInf (const GGS_midrange_call_goto_bit inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue < inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_call_goto_bit::
_operator_strictSup (const GGS_midrange_call_goto_bit inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue > inOperand.mValue) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_JUMP * _p = dynamic_cast <const cPtr_midrange_ipic_JUMP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue ()
         && mBit11._operator_isEqual (_p->mBit11).boolValue ()
         && mBit12._operator_isEqual (_p->mBit12).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (true, 1U) ;
  if (((mBit11)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)) ;
  }
  if (((mBit12)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (318)) ;
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (332))) ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@midrange_ipic_JUMP:"
           ...
           << mBit11.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mBit12.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_midrange_ipic_JUMP (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_JUMP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_JUMP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_JUMP ("midrange_ipic_JUMP", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_GOTO * _p = dynamic_cast <const cPtr_midrange_ipic_GOTO *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue () ;
  }
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (356))) ;
}
...
GGS_midrange_ipic_GOTO (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_GOTO _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_GOTO (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_GOTO ("midrange_ipic_GOTO", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_CALL * _p = dynamic_cast <const cPtr_midrange_ipic_CALL *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue () ;
  }
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (371))) ;
}
...
GGS_midrange_ipic_CALL (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_CALL _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_CALL (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_CALL ("midrange_ipic_CALL", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_JSR * _p = dynamic_cast <const cPtr_midrange_ipic_JSR *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue ()
         && mBit11._operator_isEqual (_p->mBit11).boolValue ()
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  var_cas_outLength = GGS_uint (true, 1U) ;
  if (((mBit11)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (386)) ;
  }
  if (((mBit12)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (389)) ;
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (399))) ;
}
...
GGS_midrange_ipic_JSR (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_midrange_ipic_JSR (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_JSR ("midrange_ipic_JSR", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_CLRWDT * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_CLRWDT *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
GGS_midrange_ipic_instruction_CLRWDT (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_CLRWDT _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_CLRWDT (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_CLRWDT ("midrange_ipic_instruction_CLRWDT", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_CLRW * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_CLRW *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
method_displayIPICinstruction (C_Compiler & /* _inLexique */,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents.writeString ("CLRW") ;
}
...
GGS_midrange_ipic_instruction_CLRW (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_CLRW _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_CLRW (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_CLRW ("midrange_ipic_instruction_CLRW", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_NOP * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_NOP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
GGS_midrange_ipic_instruction_NOP (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_NOP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_NOP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_NOP ("midrange_ipic_instruction_NOP", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_RETURN * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_RETURN *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
GGS_midrange_ipic_instruction_RETURN (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_RETURN _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_RETURN (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_RETURN ("midrange_ipic_instruction_RETURN", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_RETFIE * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_RETFIE *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
GGS_midrange_ipic_instruction_RETFIE (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_RETFIE _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_RETFIE (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_RETFIE ("midrange_ipic_instruction_RETFIE", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_SLEEP * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_SLEEP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue () ;
  }
  return equal ;
...
GGS_midrange_ipic_instruction_SLEEP (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_SLEEP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_SLEEP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_SLEEP ("midrange_ipic_instruction_SLEEP", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
void routine_getLiteralInstructionBaseCode (C_Compiler &,
  ...
  case GGS_midrange_literal_instruction_opcode::enum_ADDLW:
    {
    var_cas_outBaseCode = GGS_uint (true, 15872U) ;
    }
    break ;
  case GGS_midrange_literal_instruction_opcode::enum_ANDLW:
    {
    var_cas_outBaseCode = GGS_uint (true, 14592U) ;
    }
    break ;
  ...
  case GGS_midrange_literal_instruction_opcode::enum_XORLW:
    {
    var_cas_outBaseCode = GGS_uint (true, 14848U) ;
    }
    break ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_literalOperation * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_literalOperation *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (497))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (497))) ;
}
...
method_nextInstructionIsReachable (C_Compiler & _inLexique,
                                GGS_bool& var_cas_outIsReachable COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outIsReachable = (mLiteralInstruction)._operator_isNotEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (_inLexique COMMA_HERE)) ;
}
...
GGS_midrange_ipic_instruction_literalOperation (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_literalOperation _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_literalOperation (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_literalOperation ("midrange_ipic_instruction_literalOperation", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_instruction_MNOP * _p = dynamic_cast <const cPtr_midrange_ipic_instruction_MNOP *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (511)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (516)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (516))) ;
}
...
GGS_midrange_ipic_instruction_MNOP (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_instruction_MNOP _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_instruction_MNOP (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_instruction_MNOP ("midrange_ipic_instruction_MNOP", gClassInfoFor__midrange_ipic_actualInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_ipic_incDecRegisterInCondition * _p = dynamic_cast <const cPtr_midrange_ipic_incDecRegisterInCondition *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mRegisterDescription._operator_isEqual (_p->mRegisterDescription).boolValue ()
         && mTargetLabel._operator_isEqual (_p->mTargetLabel).boolValue ()
...
method_instructionLength (C_Compiler & /* _inLexique */,
  ...
  if ((mBranchIfZero).isBuiltAndTrue ()) {
    var_cas_outLength = GGS_uint (true, 3U) ;
  }else{
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (698))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
...
GGS_midrange_ipic_incDecRegisterInCondition (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_ipic_incDecRegisterInCondition _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_ipic_incDecRegisterInCondition (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__midrange_ipic_incDecRegisterInCondition ("midrange_ipic_incDecRegisterInCondition", gClassInfoFor__midrange_ipic_actualInstruction) ;
