...
category_method__registerExpression__resolveMidrangeAccess (C_Compiler & _inLexique,
  ...
  if (operand_530 != NULL) {
    ...
    var_cas_assemblyString = operand_530->mRegisterName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
    if (((operand_530->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (25)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.writeString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_530->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (26)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (26))) ;
    }
    ...
    const GGS_registerTable  _temp_1011 = var_cas_inRegisterTable ;
    if (_temp_1011._isBuilt ()) {
      _temp_1011 (HERE)->method_searchKey (_inLexique, operand_530->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (32)) ;
    }
    ...
    var_cas_acceptableBanks = GGS_uintlist ::constructor_emptyList () ;
    {
      ...
      while (((operand_1184 = enumerator_1184.nextObject ()))) {
        ...
        var_cas_acceptableBanks._addAssign_operation (operand_1184->mValue._right_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (36))) ;
      }
    }
    if (((var_cas_inCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      ...
      GGS_bool _condition_1694 (_variant_1694._isBuilt (), true) ;
      while (_condition_1694.isBuiltAndTrue ()) {
        _condition_1694 = ((var_cas_bank)._operator_strictInf (var_cas_inTotalBankCount))._operator_and (var_cas_ok) ;
        if (_condition_1694.isBuiltAndTrue ()) {
          if (_variant_1694.uintValue () == 0) {
            _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (50)) ;
            _condition_1694 = GGS_bool (true, false) ;
          }else{
            _variant_1694._decrement_operation (_inLexique COMMA_HERE) ;
            var_cas_ok = GGS_bool (true, false) ;
            {
              ...
              while (((operand_1518 = enumerator_1518.nextObject ()))
                ...
                var_cas_ok = ((operand_1518->mValue)._operator_supOrEqual (var_cas_bank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (46))))._operator_and ((operand_1518->mValue)._operator_strictInf (var_cas_bank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (46))._add_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (46)))) ;
                var_cas_registerAddress = (operand_1518->mValue)._operator_and (GGS_uint (true, 127U)) ;
              }
            }
            var_cas_bank._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (49)) ;
          }
        }
      }
      if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
        ...
        var_cas_acceptableBankMessage = GGS_string (true, "") ;
        {
          ...
          if ((operand_1798 != NULL)) {
            ...
            do{
              ...
              var_cas_acceptableBankMessage._dotAssign_operation (operand_1798->mValue._right_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (54)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (54))) ;
        ...
        operand_530->mRegisterName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "as no bank is currently known, the '"))._operator_concat (operand_530->mRegisterName))._operator_concat (GGS_string (true, "' register accessible from bank ")))._operator_concat (var_cas_acceptableBankMessage))._operator_concat (GGS_string (true, ", but should be able to be accessed from any bank setting")) COMMA_SOURCE_FILE_AT_LINE (58)) ;
      }
    }else{
      ...
      var_cas_found = GGS_bool (true, false) ;
      {
        ...
        while (((operand_2206 = enumerator_2206.nextObject ()))
          ...
          var_cas_found = ((operand_2206->mValue)._operator_supOrEqual (var_cas_inCurrentBank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (62))))._operator_and ((operand_2206->mValue)._operator_strictInf (var_cas_inCurrentBank._multiply_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (62))._add_operation (_inLexique, GGS_uint (true, 128U) COMMA_SOURCE_FILE_AT_LINE (62)))) ;
          var_cas_registerAddress = (operand_2206->mValue)._operator_and (GGS_uint (true, 127U)) ;
        }
      }
      if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
        ...
        var_cas_acceptableBankMessage = GGS_string (true, "") ;
        {
          ...
          if ((operand_2476 != NULL)) {
            ...
            do{
              ...
              var_cas_acceptableBankMessage._dotAssign_operation (operand_2476->mValue._right_shift_operation (_inLexique, GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (68)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (68))) ;
        ...
        operand_530->mRegisterName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "the '"))._operator_concat (operand_530->mRegisterName))._operator_concat (GGS_string (true, "' register cannot be accessed from bank ")))._operator_concat (var_cas_inCurrentBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (71))))._operator_concat (GGS_string (true, " (valid bank setting: ")))._operator_concat (var_cas_acceptableBankMessage))._operator_concat (GGS_string (true, ")")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
      }
    }
    var_cas_outIPICregisterDescription = GGS_midrange_ipic_registerExpression::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (_inLexique, operand_530->mOffset.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)) COMMA_SOURCE_FILE_AT_LINE (77))) ;
  }
}
...
method_setCurrentAddress (C_Compiler & _inLexique,
  ...
  method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (89)) ;
  var_cas_ioCurrentAddress = var_cas_ioCurrentAddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (90)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOrigin.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (151))) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
  ...
  ::routine_getMidRangeFDInstructionBaseCode (_inLexique,  mInstruction_FD_base_code,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (196)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mInstruction_FD_base_code.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (201))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (201))) ;
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getMidRangeFinstructionBaseCode (_inLexique,  mFinstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (227)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mFinstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (232))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (232))) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getMidRangeBitOrientedOpBaseCode (_inLexique,  mBitOrientedOp,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (254)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mBitOrientedOp.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
  var_cas_ioListFileContents.writeString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  if (((mBit11)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (316)) ;
  }
  if (((mBit12)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (319)) ;
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (333))) ;
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (357))) ;
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (372))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  var_cas_outLength = GGS_uint (true, 1U) ;
  if (((mBit11)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (387)) ;
  }
  if (((mBit12)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (390)) ;
  }
}
...
method_enterReferencedLabel (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (400))) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getMidRangeLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (493)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents.writeString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (498))) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (512)) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (517)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (517))) ;
}
...
method_displayIPICinstruction (C_Compiler & _inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (699))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.writeString (", W") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
