...
category_method__registerExpression__resolveMidrangeAccess (C_Compiler & inLexique,
  ...
  if (operand_530 != NULL) {
    ...
    var_cas_assemblyString = operand_530->mRegisterName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
    if (((operand_530->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (25)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      var_cas_assemblyString.appendCString (" + ") ;
      var_cas_assemblyString._dotAssign_operation (operand_530->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (26)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (26))) ;
    }
    ...
    if (_temp_1011.isBuilt ()) {
      _temp_1011 (HERE)->method_searchKey (inLexique, operand_530->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (32)) ;
    }
    ...
    var_cas_acceptableBanks = GGS_uintlist ::constructor_emptyList () ;
    {
      ...
      while (((operand_1184 = enumerator_1184.nextObject ()))) {
        ...
        var_cas_acceptableBanks._addAssign_operation (operand_1184->mValue._right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (36))) ;
      }
    }
    if (((var_cas_inCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      ...
      while (_condition_1694.isBuiltAndTrue ()) {
        ...
        if (_condition_1694.isBuiltAndTrue ()) {
          if (_variant_1694.uintValue () == 0) {
            ...
            _variant_1694._decrement_operation (inLexique COMMA_HERE) ;
            var_cas_ok = GGS_bool (false) ;
            {
              ...
              while (((operand_1518 = enumerator_1518.nextObject ()))
                ...
                var_cas_ok = ((operand_1518->mValue)._operator_supOrEqual (var_cas_bank._multiply_operation (inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (46))))._operator_and ((operand_1518->mValue)._operator_strictInf (var_cas_bank._multiply_operation (inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (46))._add_operation (inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (46)))) ;
                var_cas_registerAddress = (operand_1518->mValue)._operator_and (GGS_uint (127U)) ;
              }
            }
            var_cas_bank._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (49)) ;
          }
        }
      }
        ...
        var_cas_acceptableBankMessage = GGS_string ("") ;
        {
          ...
          if ((operand_1798 != NULL)) {
            ...
            do{
              ...
              var_cas_acceptableBankMessage._dotAssign_operation (operand_1798->mValue._right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (54)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (54))) ;
      ...
      var_cas_found = GGS_bool (false) ;
      {
        ...
        while (((operand_2206 = enumerator_2206.nextObject ()))
          ...
          var_cas_found = ((operand_2206->mValue)._operator_supOrEqual (var_cas_inCurrentBank._multiply_operation (inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (62))))._operator_and ((operand_2206->mValue)._operator_strictInf (var_cas_inCurrentBank._multiply_operation (inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (62))._add_operation (inLexique, GGS_uint (128U) COMMA_SOURCE_FILE_AT_LINE (62)))) ;
      ...
      if (((var_cas_found)._operator_not ()).isBuiltAndTrue ()) {
        ...
        var_cas_acceptableBankMessage = GGS_string ("") ;
        {
          ...
          if ((operand_2476 != NULL)) {
            ...
            do{
              ...
              var_cas_acceptableBankMessage._dotAssign_operation (operand_2476->mValue._right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (68)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (68))) ;
        ...
        operand_530->mRegisterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("the '"))._operator_concat (operand_530->mRegisterName))._operator_concat (GGS_string ("' register cannot be accessed from bank ")))._operator_concat (var_cas_inCurrentBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71))))._operator_concat (GGS_string (" (valid bank setting: ")))._operator_concat (var_cas_acceptableBankMessage))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
      }
    }
    var_cas_outIPICregisterDescription = GGS_midrange_ipic_registerExpression::constructor_new (var_cas_assemblyString, var_cas_registerAddress._add_operation (inLexique, operand_530->mOffset.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) COMMA_SOURCE_FILE_AT_LINE (77))) ;
  }
}
...
method_setCurrentAddress (C_Compiler & inLexique,
  ...
  var_cas_ioCurrentAddress = var_cas_ioCurrentAddress._add_operation (inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (90)) ;
}
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@midrange_ipic_instructionList", inIndentation COMMA_THERE) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mOrigin._operator_isEqual (ptr->mOrigin).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOrigin.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (151))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mLabel._operator_isEqual (ptr->mLabel).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mInstruction_FD_base_code._operator_isEqual (ptr->mInstruction_FD_base_code).boolValue ()
         && mRegisterDescription._operator_isEqual (ptr->mRegisterDescription).boolValue ()
         && m_W_isDestination._operator_isEqual (ptr->m_W_isDestination).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mInstruction_FD_base_code.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (201))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (201))) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mFinstruction._operator_isEqual (ptr->mFinstruction).boolValue ()
         && mRegisterDescription._operator_isEqual (ptr->mRegisterDescription).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mFinstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (232))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (232))) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@midrange_ipic_instruction_F:"
           << mInstructionLocation.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << mFinstruction.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << mRegisterDescription.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mBitOrientedOp._operator_isEqual (ptr->mBitOrientedOp).boolValue ()
         && mRegisterDescription._operator_isEqual (ptr->mRegisterDescription).boolValue ()
         && mBitNumber._operator_isEqual (ptr->mBitNumber).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mBitOrientedOp.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mSkipIfSet._operator_isEqual (ptr->mSkipIfSet).boolValue ()
         && mRegisterDescription._operator_isEqual (ptr->mRegisterDescription).boolValue ()
         && mBitNumber._operator_isEqual (ptr->mBitNumber).boolValue () ;
  }
  return equal ;
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
  var_cas_ioListFileContents.appendCString (", ") ;
  var_cas_ioListFileContents._dotAssign_operation (mBitNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mTargetLabel._operator_isEqual (ptr->mTargetLabel).boolValue ()
         && mBit11._operator_isEqual (ptr->mBit11).boolValue ()
         && mBit12._operator_isEqual (ptr->mBit12).boolValue () ;
  }
  return equal ;
}
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (1U) ;
  if (((mBit11)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (316)) ;
  }
  if (((mBit12)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (319)) ;
  }
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (333))) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@midrange_ipic_JUMP:"
           ...
           << mBit11.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << mBit12.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (357))) ;
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (372))) ;
}
...
method_instructionLength (C_Compiler & inLexique,
  ...
  var_cas_outLength = GGS_uint (1U) ;
  if (((mBit11)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (387)) ;
  }
  if (((mBit12)._operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (390)) ;
  }
}
...
method_enterReferencedLabel (C_Compiler & inLexique,
                                GGS_stringset & var_cas_ioReferencedLabelSet COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioReferencedLabelSet._addAssign_operation (mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (400))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mLiteralInstruction._operator_isEqual (ptr->mLiteralInstruction).boolValue ()
         && mLiteralValue._operator_isEqual (ptr->mLiteralValue).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
                                GGS_string& var_cas_ioListFileContents COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_ioListFileContents._dotAssign_operation (mLiteralInstruction.reader_mnemonic (inLexique COMMA_SOURCE_FILE_AT_LINE (498))) ;
  var_cas_ioListFileContents.appendCString (" ") ;
  var_cas_ioListFileContents._dotAssign_operation (mLiteralValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (498))) ;
}
...
method_nextInstructionIsReachable (C_Compiler & inLexique,
                                GGS_bool& var_cas_outIsReachable COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outIsReachable = (mLiteralInstruction)._operator_isNotEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE)) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mOccurrenceFactor._operator_isEqual (ptr->mOccurrenceFactor).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mOccurrenceFactor.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (517)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (517))) ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mRegisterDescription._operator_isEqual (ptr->mRegisterDescription).boolValue ()
         && mTargetLabel._operator_isEqual (ptr->mTargetLabel).boolValue ()
         && mIncrement._operator_isEqual (ptr->mIncrement).boolValue ()
         && m_W_isDestination._operator_isEqual (ptr->m_W_isDestination).boolValue ()
         && mBranchIfZero._operator_isEqual (ptr->mBranchIfZero).boolValue () ;
  }
  return equal ;
}
...
method_displayIPICinstruction (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents._dotAssign_operation (mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (699))) ;
  if ((m_W_isDestination).isBuiltAndTrue ()) {
    var_cas_ioListFileContents.appendCString (", W") ;
  }
  if ((mBranchIfZero).isBuiltAndTrue ()) {
