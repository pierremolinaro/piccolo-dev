...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (1U) ;
  const GGS_bool cond_9564 = (mBit11).operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE)) ;
  if (cond_9564.isBuiltAndTrue ()) {
    var_cas_outLength.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (314)) ;
  }
  const GGS_bool cond_9655 = (mBit12).operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE)) ;
...
method_instructionLength (C_Compiler & inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = GGS_uint (1U) ;
  const GGS_bool cond_11565 = (mBit11).operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE)) ;
  ...
  const GGS_bool cond_11671 = (mBit12).operator_isNotEqual (GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE)) ;
