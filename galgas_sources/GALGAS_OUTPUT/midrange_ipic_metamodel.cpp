...
category_method__registerExpression__resolveMidrangeAccess (C_Compiler & inLexique,
  ...
  if (operand_530 != NULL) {
    ...
    if (temp_1011.isBuilt ()) {
      temp_1011 (HERE)->method_searchKey (inLexique, operand_530->mRegisterName, var_cas_registerAddressList, var_cas_size, var_cas_outBitSliceTable, automatic_var_1075_0 COMMA_SOURCE_FILE_AT_LINE (32)) ;
    }
