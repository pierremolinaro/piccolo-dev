...
GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL::constructor_new (const GALGAS_lstring & inAttribute_mLabel
  ...
  if (inAttribute_mLabel.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_midrange_5F_intermediate_5F_pseudo_5F_LABEL (inAttribute_mLabel COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_midrange_5F_intermediate_5F_pseudo_5F_LABEL (p->mAttribute_mLabel COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
static void categoryMethod_registerExpression_resolveMidrangeAccess (const cPtr_registerExpression * inObject,
  ...
  GALGAS_string joker_956_0 ; // Joker input parameter
  constinArgument_inRegisterTable.method_searchKey (object->mAttribute_mRegisterName, var_registerAddressList, var_size, outArgument_outBitSliceTable, joker_956_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (30)) ;
  ...
  cEnumerator_uintlist enumerator_1069 (var_registerAddressList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_1069.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_acceptableBanks.addAssign_operation (enumerator_1069.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (34)) COMMA_SOURCE_FILE_AT_LINE (34)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    if (constinArgument_inTotalBankCount.isValid ()) {
      PMUInt32 variant_1304 = constinArgument_inTotalBankCount.uintValue () ;
      bool loop_1304 = true ;
      while (loop_1304) {
        loop_1304 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (41)).isValid () ;
        if (loop_1304) {
          loop_1304 = GALGAS_bool (kIsStrictInf, var_bank.objectCompare (constinArgument_inTotalBankCount)).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (41)).boolValue () ;
        }
        if (loop_1304 && (0 == variant_1304)) {
          loop_1304 = false ;
        ...
        if (loop_1304) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_uintlist enumerator_1406 (var_registerAddressList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_2 = var_ok.operator_not (SOURCE_FILE_AT_LINE (43)).isValidAndTrue () ;
          if (enumerator_1406.hasCurrentObject () && bool_2) {
            while (enumerator_1406.hasCurrentObject () && bool_2) {
              //-------- @assignmentInstructionForGeneration
              var_ok = GALGAS_bool (kIsSupOrEqual, enumerator_1406.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (44)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_1406.current_mValue (HERE).objectCompare (var_bank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (44)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (44)))) COMMA_SOURCE_FILE_AT_LINE (44)) ;
              //-------- @assignmentInstructionForGeneration
              var_registerAddress = enumerator_1406.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (45)) ;
              enumerator_1406.gotoNextObject () ;
              if (enumerator_1406.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_3) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_uintlist enumerator_1689 (var_registerAddressList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_1689.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_acceptableBankMessage.dotAssign_operation (enumerator_1689.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (52)).reader_string (SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52)) ;
        if (enumerator_1689.hasNextObject ()) {
          //-------- @concatInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_uintlist enumerator_2094 (var_registerAddressList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (59)).isValidAndTrue () ;
    if (enumerator_2094.hasCurrentObject () && bool_5) {
      while (enumerator_2094.hasCurrentObject () && bool_5) {
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsSupOrEqual, enumerator_2094.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (60)))).operator_and (GALGAS_bool (kIsStrictInf, enumerator_2094.current_mValue (HERE).objectCompare (constinArgument_inCurrentBank.multiply_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (60)).add_operation (GALGAS_uint ((PMUInt32) 128U), inCompiler COMMA_SOURCE_FILE_AT_LINE (60)))) COMMA_SOURCE_FILE_AT_LINE (60)) ;
        //-------- @assignmentInstructionForGeneration
        var_registerAddress = enumerator_2094.current_mValue (HERE).operator_and (GALGAS_uint ((PMUInt32) 127U) COMMA_SOURCE_FILE_AT_LINE (61)) ;
        enumerator_2094.gotoNextObject () ;
        if (enumerator_2094.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_6) {
      ...
      GALGAS_string var_acceptableBankMessage = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_uintlist enumerator_2367 (var_registerAddressList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_2367.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_acceptableBankMessage.dotAssign_operation (enumerator_2367.current_mValue (HERE).right_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (66)).reader_string (SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Abstract category method '@midrange_intermediate_instruction instructionLength'*
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_instructionLength> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_instructionLength (const PMSInt32 inClassIndex,
                                            categoryMethodSignature_midrange_5F_intermediate_5F_instruction_instructionLength inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_instructionLength (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_instructionLength (NULL,
                                                                                      freeCategoryMethod_midrange_5F_intermediate_5F_instruction_instructionLength) ;

//---------------------------------------------------------------------------*

void callCategoryMethod_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
...
//--- Find method
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_instructionLength f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_instructionLength.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_setCurrentAddress (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  callCategoryMethod_instructionLength ((const cPtr_midrange_5F_intermediate_5F_instruction *) temp_0.ptr (), var_length, inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
//---------------------------------------------------------------------------*
//                                                                           *
//     Category method '@midrange_intermediate_instruction isLABELorORG'     *
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_isLABELorORG> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_isLABELorORG (const PMSInt32 inClassIndex,
                                       categoryMethodSignature_midrange_5F_intermediate_5F_instruction_isLABELorORG inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

void callCategoryMethod_isLABELorORG (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_isLABELorORG f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_isLABELorORG (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_isLABELorORG (void) {
  enterCategoryMethod_isLABELorORG (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction.mSlotID,
                                    categoryMethod_midrange_5F_intermediate_5F_instruction_isLABELorORG) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_isLABELorORG (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isLABELorORG.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_isLABELorORG (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_isLABELorORG,
                                                                                 freeCategoryMethod_midrange_5F_intermediate_5F_instruction_isLABELorORG) ;

//---------------------------------------------------------------------------*
//                                                                           *
//        Category method '@midrange_intermediate_instruction isNULL'        *
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_isNULL> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_isNULL (const PMSInt32 inClassIndex,
                                 categoryMethodSignature_midrange_5F_intermediate_5F_instruction_isNULL inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

void callCategoryMethod_isNULL (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
  ...
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_isNULL f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_isNULL (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_isNULL (void) {
  enterCategoryMethod_isNULL (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction.mSlotID,
                              categoryMethod_midrange_5F_intermediate_5F_instruction_isNULL) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_isNULL (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_isNULL.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_isNULL (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_isNULL,
                                                                           freeCategoryMethod_midrange_5F_intermediate_5F_instruction_isNULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_NULL instructionLength' *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_NULL_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_NULL_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_NULL.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_NULL_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_NULL_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_NULL_instructionLength, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//      Overriding category method '@midrange_intermediate_NULL isNULL'      *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_NULL_isNULL (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
                                                                    GALGAS_bool & outArgument_outIsNULL,
                                                                    C_Compiler * /* inCompiler */
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_NULL_isNULL (void) {
  enterCategoryMethod_isNULL (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_NULL.mSlotID,
                              categoryMethod_midrange_5F_intermediate_5F_NULL_isNULL) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_NULL_isNULL (defineCategoryMethod_midrange_5F_intermediate_5F_NULL_isNULL, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_pseudo_ORG instructionLength'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
                                                                                        GALGAS_uint & outArgument_outLength,
                                                                                        C_Compiler * /* inCompiler */
                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_pseudo_5F_ORG.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_instructionLength, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_pseudo_ORG isLABELorORG'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_isLABELorORG (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
                                                                                   GALGAS_bool & outArgument_outIsLABELorORG,
                                                                                   C_Compiler * /* inCompiler */
                                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_isLABELorORG (void) {
  enterCategoryMethod_isLABELorORG (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_pseudo_5F_ORG.mSlotID,
                                    categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_isLABELorORG) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_isLABELorORG (defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_ORG_isLABELorORG, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_pseudo_LABEL instructionLength'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
                                                                                          GALGAS_uint & outArgument_outLength,
                                                                                          C_Compiler * /* inCompiler */
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_instructionLength, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_pseudo_LABEL isLABELorORG'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_isLABELorORG (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
                                                                                     GALGAS_bool & outArgument_outIsLABELorORG,
                                                                                     C_Compiler * /* inCompiler */
                                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_isLABELorORG (void) {
  enterCategoryMethod_isLABELorORG (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL.mSlotID,
                                    categoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_isLABELorORG) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_isLABELorORG (defineCategoryMethod_midrange_5F_intermediate_5F_pseudo_5F_LABEL_isLABELorORG, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_actualInstruction instructionLength'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_actualInstruction_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
                                                                                            GALGAS_uint & outArgument_outLength,
                                                                                            C_Compiler * /* inCompiler */
                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_actualInstruction_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_actualInstruction.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_actualInstruction_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_actualInstruction_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_actualInstruction_instructionLength, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//    Category method '@midrange_intermediate_instruction_FD getBaseCode'    *
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_getBaseCode (const PMSInt32 inClassIndex,
                                      categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

void callCategoryMethod_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_FD * inObject,
                                     GALGAS_uint & out_outBaseCode,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) {
  out_outBaseCode.drop () ;
  if (NULL != inObject) {
    macroValidSharedObject (inObject, const cPtr_midrange_5F_intermediate_5F_instruction_5F_FD) ;
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_FD * inObject,
                                                                                      GALGAS_uint & outArgument_outBaseCode,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_midrange_5F_intermediate_5F_instruction_5F_FD * object = inObject ;
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode (void) {
  enterCategoryMethod_getBaseCode (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_FD.mSlotID,
                                   categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode,
                                                                                      freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FD_getBaseCode) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//    Category method '@midrange_intermediate_instruction_F getBaseCode'     *
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_getBaseCode (const PMSInt32 inClassIndex,
                                      categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

void callCategoryMethod_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_F * inObject,
                                     GALGAS_uint & out_outBaseCode,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) {
  out_outBaseCode.drop () ;
  if (NULL != inObject) {
    macroValidSharedObject (inObject, const cPtr_midrange_5F_intermediate_5F_instruction_5F_F) ;
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_F * inObject,
                                                                                     GALGAS_uint & outArgument_outBaseCode,
                                                                                     C_Compiler * inCompiler
                                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_midrange_5F_intermediate_5F_instruction_5F_F * object = inObject ;
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode (void) {
  enterCategoryMethod_getBaseCode (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_F.mSlotID,
                                   categoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode,
                                                                                     freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_F_getBaseCode) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//    Category method '@midrange_intermediate_instruction_FB getBaseCode'    *
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_getBaseCode (const PMSInt32 inClassIndex,
                                      categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

void callCategoryMethod_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_FB * inObject,
                                     GALGAS_uint & out_outBaseCode,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) {
  out_outBaseCode.drop () ;
  if (NULL != inObject) {
    macroValidSharedObject (inObject, const cPtr_midrange_5F_intermediate_5F_instruction_5F_FB) ;
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_FB * inObject,
                                                                                      GALGAS_uint & outArgument_outBaseCode,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_midrange_5F_intermediate_5F_instruction_5F_FB * object = inObject ;
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode (void) {
  enterCategoryMethod_getBaseCode (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_FB.mSlotID,
                                   categoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode,
                                                                                      freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_FB_getBaseCode) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Category method '@midrange_intermediate_instruction_BitTestSkip getBaseCode'*
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_getBaseCode (const PMSInt32 inClassIndex,
                                      categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

void callCategoryMethod_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip * inObject,
                                     GALGAS_uint & out_outBaseCode,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) {
  out_outBaseCode.drop () ;
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip * inObject,
                                                                                               GALGAS_uint & outArgument_outBaseCode,
                                                                                               C_Compiler * /* inCompiler */
                                                                                               COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode (void) {
  enterCategoryMethod_getBaseCode (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip.mSlotID,
                                   categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode,
                                                                                               freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_getBaseCode) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_JUMP instructionLength' *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_JUMP_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
                                                                               GALGAS_uint & outArgument_outLength,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_JUMP_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_JUMP_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_JUMP_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_JUMP_instructionLength, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_GOTO instructionLength' *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_GOTO_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * /* inObject */,
                                                                               GALGAS_uint & outArgument_outLength,
                                                                               C_Compiler * /* inCompiler */
                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_GOTO_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_GOTO.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_GOTO_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_GOTO_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_GOTO_instructionLength, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
// Overriding category method '@midrange_intermediate_JSR instructionLength' *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_JSR_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
                                                                              GALGAS_uint & outArgument_outLength,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_JSR_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JSR.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_JSR_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_JSR_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_JSR_instructionLength, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Category method '@midrange_intermediate_instruction_literalOperation getBaseCode'*
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode> gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode ;

//---------------------------------------------------------------------------*

void enterCategoryMethod_getBaseCode (const PMSInt32 inClassIndex,
                                      categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode inMethod) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

void callCategoryMethod_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation * inObject,
                                     GALGAS_uint & out_outBaseCode,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) {
  out_outBaseCode.drop () ;
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode f = NULL ;
    if (classIndex < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode.count ()) {
      f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode.count ()) {
           f = gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode (const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation * inObject,
                                                                                                    GALGAS_uint & outArgument_outBaseCode,
                                                                                                    C_Compiler * inCompiler
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode (void) {
  enterCategoryMethod_getBaseCode (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation.mSlotID,
                                   categoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode (void) {
  gCategoryMethodTable_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode,
                                                                                                    freeCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_getBaseCode) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_instruction_MNOP instructionLength'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
                                                                                              GALGAS_uint & outArgument_outLength,
                                                                                              C_Compiler * /* inCompiler */
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_MNOP.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_instruction_5F_MNOP_instructionLength, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@midrange_intermediate_incDecRegisterInCondition instructionLength'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_instructionLength (const cPtr_midrange_5F_intermediate_5F_instruction * inObject,
                                                                                                    GALGAS_uint & outArgument_outLength,
                                                                                                    C_Compiler * /* inCompiler */
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_instructionLength (void) {
  enterCategoryMethod_instructionLength (kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition.mSlotID,
                                         categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_instructionLength) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_instructionLength (defineCategoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_instructionLength, NULL) ;
