...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_instruction_savebank * _p = dynamic_cast <const cPtr_midrange_instruction_savebank *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
//---------------------------------------------------------------------------*
//                                                                           *
//           Class for 'midrange_jumpInstructionKind' Enumeration            *
//                                                                           *
//---------------------------------------------------------------------------*

bool GGS_midrange_jumpInstructionKind::
_isBuilt (void) const {
  return mValue > kNotBuilt ;
}
...
GGS_bool GGS_midrange_jumpInstructionKind::
_operator_isEqual (const GGS_midrange_jumpInstructionKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue == inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_jumpInstructionKind::
_operator_isNotEqual (const GGS_midrange_jumpInstructionKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue != inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_jumpInstructionKind::
_operator_infOrEqual (const GGS_midrange_jumpInstructionKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue <= inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_jumpInstructionKind::
_operator_supOrEqual (const GGS_midrange_jumpInstructionKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue >= inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_jumpInstructionKind::
_operator_strictInf (const GGS_midrange_jumpInstructionKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue < inOperand.mValue) ;
}
...
GGS_bool GGS_midrange_jumpInstructionKind::
_operator_strictSup (const GGS_midrange_jumpInstructionKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue > inOperand.mValue) ;
}
...
GGS_string GGS_midrange_jumpInstructionKind::
reader_description (C_Compiler & /* _inLexique */
                    COMMA_UNUSED_LOCATION_ARGS,
                    const sint32 /* inIndentation */) const {
  C_String s ;
  s << "<enum @midrange_jumpInstructionKind" ;
  switch (mValue) {
  case enum_ipicExtended:
    s << " ipicExtended>" ;
    break ;
  case enum_native:
    s << " native>" ;
...
GGS_midrange_jumpInstructionKind GGS_midrange_instruction_JSR::
reader_mKind (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_JSR *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_midrange_instruction_JSR *) mPointer)->mKind ;
  }
  return result ;
}
...
GGS_midrange_jumpInstructionKind GGS_midrange_instruction_JUMP::
reader_mKind (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_midrange_jumpInstructionKind  result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_JUMP *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_midrange_instruction_JUMP *) mPointer)->mKind ;
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//             class 'cPtr_midrange_instruction_computed_retlw'              *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_midrange_instruction_computed_retlw::
cPtr_midrange_instruction_computed_retlw (const GGS_location & argument_0,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_midrange_instruction_computed_retlw * GGS_midrange_instruction_computed_retlw::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_computed_retlw *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_midrange_instruction_computed_retlw *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_midrange_instruction_computed_retlw::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_instruction_computed_retlw * _p = dynamic_cast <const cPtr_midrange_instruction_computed_retlw *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
...
void cPtr_midrange_instruction_computed_retlw::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@midrange_instruction_computed_retlw:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_midrange_instruction_computed_retlw::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_midrange_instruction_computed_retlw (& typeid (cPtr_midrange_instruction_computed_retlw), & typeid (cPtr_midrange_instruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_midrange_instruction_computed_retlw::galgasRTTI (void) const {
  return & gClassInfoFor__midrange_instruction_computed_retlw ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//          GALGAS class 'GGS_midrange_instruction_computed_retlw'           *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_midrange_instruction_computed_retlw::
GGS_midrange_instruction_computed_retlw (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_midrange_instruction_computed_retlw::
GGS_midrange_instruction_computed_retlw (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_midrange_instruction_computed_retlw GGS_midrange_instruction_computed_retlw::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_instruction_computed_retlw _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_midrange_instruction_computed_retlw *> (inPointer) != NULL)
      : (typeid (cPtr_midrange_instruction_computed_retlw) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_midrange_instruction_computed_retlw (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_midrange_instruction_computed_retlw),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_immediatExpressionList & argument_2
                                COMMA_LOCATION_ARGS) {
  GGS_midrange_instruction_computed_retlw result ;
  macroMyNew (result.mPointer, cPtr_midrange_instruction_computed_retlw (argument_0,
                                argument_1,
                                argument_2 COMMA_THERE)) ;
  return result ;
}
...
GGS_immediatExpression  GGS_midrange_instruction_computed_retlw::
reader_mSizeExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_computed_retlw *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_midrange_instruction_computed_retlw *) mPointer)->mSizeExpression ;
  }
  return result ;
}
...
GGS_immediatExpressionList  GGS_midrange_instruction_computed_retlw::
reader_mImmediateExpressionList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_computed_retlw *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_midrange_instruction_computed_retlw *) mPointer)->mImmediateExpressionList ;
  }
  return result ;
}
...
const char * GGS_midrange_instruction_computed_retlw::actualTypeName (void) const {
  return "midrange_instruction_computed_retlw" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__midrange_instruction_computed_retlw ("midrange_instruction_computed_retlw", gClassInfoFor__midrange_instruction) ;

//---------------------------------------------------------------------------*
//                                                                           *
//             class 'cPtr_midrange_instruction_computed_goto'               *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_midrange_instruction_computed_goto::
cPtr_midrange_instruction_computed_goto (const GGS_location & argument_0,
                                const GGS_immediatExpression & argument_1,
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_midrange_instruction_computed_goto * GGS_midrange_instruction_computed_goto::
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_computed_goto *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    return (cPtr_midrange_instruction_computed_goto *) mPointer ;
  }
#endif

//---------------------------------------------------------------------------*

bool cPtr_midrange_instruction_computed_goto::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_midrange_instruction_computed_goto * _p = dynamic_cast <const cPtr_midrange_instruction_computed_goto *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         && mSizeExpression._operator_isEqual (_p->mSizeExpression).boolValue ()
...
void cPtr_midrange_instruction_computed_goto::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "->@midrange_instruction_computed_goto:"
           << mInstructionLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mSizeExpression.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
const char * cPtr_midrange_instruction_computed_goto::
_message (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_midrange_instruction_computed_goto (& typeid (cPtr_midrange_instruction_computed_goto), & typeid (cPtr_midrange_instruction), "") ;
//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformation * cPtr_midrange_instruction_computed_goto::galgasRTTI (void) const {
  return & gClassInfoFor__midrange_instruction_computed_goto ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//          GALGAS class 'GGS_midrange_instruction_computed_goto'            *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_midrange_instruction_computed_goto::
GGS_midrange_instruction_computed_goto (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_midrange_instruction_computed_goto::
GGS_midrange_instruction_computed_goto (cPtr__AC_galgas_class & inObject) {
  macroAssignPointer (mPointer, & inObject) ;
}
...
//--- _castFrom class method (implements cast expression)
GGS_midrange_instruction_computed_goto GGS_midrange_instruction_computed_goto::
_castFrom (C_Compiler & inLexique,
           cPtr__AC_galgas_class * inPointer,
           const bool inUseKindOfClass,
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_instruction_computed_goto _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_midrange_instruction_computed_goto *> (inPointer) != NULL)
      : (typeid (cPtr_midrange_instruction_computed_goto) == typeid (*inPointer)) ;
    if (ok) {
      _result = GGS_midrange_instruction_computed_goto (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_midrange_instruction_computed_goto),
                                       inUseKindOfClass,
                                       inPointer->_message ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_Compiler & /* inLexique */,
                 ...
                 const GGS_lstringlist & argument_2
                                COMMA_LOCATION_ARGS) {
  GGS_midrange_instruction_computed_goto result ;
  macroMyNew (result.mPointer, cPtr_midrange_instruction_computed_goto (argument_0,
                                argument_1,
                                argument_2 COMMA_THERE)) ;
  return result ;
}
...
GGS_immediatExpression  GGS_midrange_instruction_computed_goto::
reader_mSizeExpression (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_immediatExpression   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_computed_goto *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_midrange_instruction_computed_goto *) mPointer)->mSizeExpression ;
  }
  return result ;
}
...
GGS_lstringlist  GGS_midrange_instruction_computed_goto::
reader_mTargetLabels (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_midrange_instruction_computed_goto *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_midrange_instruction_computed_goto *) mPointer)->mTargetLabels ;
  }
  return result ;
}
...
const char * GGS_midrange_instruction_computed_goto::actualTypeName (void) const {
  return "midrange_instruction_computed_goto" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformation gClassInfoFor__midrange_instruction_computed_goto ("midrange_instruction_computed_goto", gClassInfoFor__midrange_instruction) ;
...
elementOf_GGS_midrange_interruptDefinitionList (const GGS_midrange_instructionList & argument_0,
                                const GGS_location & argument_1
                                COMMA_LOCATION_ARGS) :
AC_galgas_list::cListElement (THERE),
mInstructionList (argument_0),
mInterruptLocation (argument_1) {
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = mInstructionList._operator_isEqual (_p->mInstructionList).boolValue ()
         && mInterruptLocation._operator_isEqual (_p->mInterruptLocation).boolValue () ;
  }
  return equal ;
}
...
_internalAppendValues (const GGS_midrange_instructionList & argument_0,
                    const GGS_location & argument_1
                    COMMA_LOCATION_ARGS) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0,
...
void GGS_midrange_interruptDefinitionList::
_internalPrependValues (const GGS_midrange_instructionList & argument_0,
                    const GGS_location & argument_1
                    COMMA_LOCATION_ARGS) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0,
...
void GGS_midrange_interruptDefinitionList::
_addAssign_operation (const GGS_midrange_instructionList & argument_0,
                                const GGS_location & argument_1) {
    ...
    if (count () == 0) {
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_midrange_instructionList  p_0 = p->mInstructionList ;
          GGS_location  p_1 = p->mInterruptLocation ;
...
void GGS_midrange_interruptDefinitionList::
modifier_prependValue (C_Compiler & /* inLexique */,
                     const GGS_midrange_instructionList & argument_0,
                     const GGS_location & argument_1
                     COMMA_UNUSED_LOCATION_ARGS) {
  if (_isBuilt ()) {
    _insulateList () ;
...
GGS_midrange_interruptDefinitionList  GGS_midrange_interruptDefinitionList::
constructor_listWithValue (const GGS_midrange_instructionList & argument_0,
                                const GGS_location & argument_1) {
  GGS_midrange_interruptDefinitionList result ;
  result._alloc () ;
...
internalSubListWithRange (GGS_midrange_interruptDefinitionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mInstructionList, _p->mInterruptLocation) ;
      _p = _p->nextObject () ;
    }
  }
}
...
void GGS_midrange_interruptDefinitionList::
method_first (C_Compiler & _inLexique,
              GGS_midrange_instructionList & _out_0,
              GGS_location & _out_1
              COMMA_LOCATION_ARGS) const {
  cElement * _p = NULL ;
  if (_isBuilt ()) {
...
elementOf_GGS_midrange_routineDefinitionList (const GGS_lstring & argument_0,
                                ...
                                const GGS_bool& argument_3,
                                const GGS_bool& argument_4,
                                const GGS_midrange_instructionList & argument_5,
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_midrange_instructionList  p_5 = p->mInstructionList ;
...
method_first (C_Compiler & _inLexique,
              ...
              GGS_bool& _out_3,
              GGS_bool& _out_4,
              GGS_midrange_instructionList & _out_5,
              GGS_location & _out_6
              COMMA_LOCATION_ARGS) const {
  cElement * _p = NULL ;
  if (_isBuilt ()) {
