...
method_getBaseCode (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_6304 = mSkipIfSet ;
  if (cond_6304.isBuiltAndTrue ()) {
    var_cas_outBaseCode = GGS_uint (7168U) ;
  }else if (cond_6304.isBuiltAndFalse ()) {
...
method_getMnemonic (C_Compiler & /* inLexique */,
  ...
  const GGS_bool cond_6479 = mSkipIfSet ;
  if (cond_6479.isBuiltAndTrue ()) {
    var_cas_outMnemonic = GGS_string ("BTFSS") ;
  }else if (cond_6479.isBuiltAndFalse ()) {
