...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mRegister._operator_isEqual (ptr->mRegister).boolValue ()
         && mInstructionList._operator_isEqual (ptr->mInstructionList).boolValue ()
         && mEndOfSaveBankInstruction._operator_isEqual (ptr->mEndOfSaveBankInstruction).boolValue () ;
  }
  return equal ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_midrange_instruction_savebank _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_midrange_instruction_savebank (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         ...
         && mRegisterExpression._operator_isEqual (ptr->mRegisterExpression).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         ...
         && mImmediatExpression._operator_isEqual (ptr->mImmediatExpression).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mInstructionList._operator_isEqual (ptr->mInstructionList).boolValue ()
         && mEndOfInstructionList._operator_isEqual (ptr->mEndOfInstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mInstruction._operator_isEqual (ptr->mInstruction).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mRegisterExpression._operator_isEqual (ptr->mRegisterExpression).boolValue ()
         && mIncrement._operator_isEqual (ptr->mIncrement).boolValue ()
         && m_W_isDestination._operator_isEqual (ptr->m_W_isDestination).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mCondition._operator_isEqual (ptr->mCondition).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mRegisterExpression._operator_isEqual (ptr->mRegisterExpression).boolValue ()
         && mBitNumber._operator_isEqual (ptr->mBitNumber).boolValue ()
         && mBTFSSinstruction._operator_isEqual (ptr->mBTFSSinstruction).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mIfCondition._operator_isEqual (ptr->mIfCondition).boolValue ()
         && mThenInstructionList._operator_isEqual (ptr->mThenInstructionList).boolValue ()
         && mElseInstructionList._operator_isEqual (ptr->mElseInstructionList).boolValue ()
         && mEndOfElsePartLocation._operator_isEqual (ptr->mEndOfElsePartLocation).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = mCondition._operator_isEqual (ptr->mCondition).boolValue ()
         && mInstructionList._operator_isEqual (ptr->mInstructionList).boolValue ()
         && mEndOfPartLocation._operator_isEqual (ptr->mEndOfPartLocation).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mRepeatedInstructionList._operator_isEqual (ptr->mRepeatedInstructionList).boolValue ()
         && mEndOfRepeatedInstructionList._operator_isEqual (ptr->mEndOfRepeatedInstructionList).boolValue ()
         && mWhilePartList._operator_isEqual (ptr->mWhilePartList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInterruptLocation._operator_isEqual (ptr->mInterruptLocation).boolValue ()
         && mInstructionList._operator_isEqual (ptr->mInstructionList).boolValue ()
         && mFirstSaveRegister._operator_isEqual (ptr->mFirstSaveRegister).boolValue ()
         && mSecondSaveRegister._operator_isEqual (ptr->mSecondSaveRegister).boolValue ()
         && mEndOfInterruptLocation._operator_isEqual (ptr->mEndOfInterruptLocation).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = mRoutineName._operator_isEqual (ptr->mRoutineName).boolValue ()
         && mPage._operator_isEqual (ptr->mPage).boolValue ()
         && mRequiredBank._operator_isEqual (ptr->mRequiredBank).boolValue ()
         && mReturnedBank._operator_isEqual (ptr->mReturnedBank).boolValue ()
         && mPreservesBank._operator_isEqual (ptr->mPreservesBank).boolValue ()
         && mIsNoReturn._operator_isEqual (ptr->mIsNoReturn).boolValue ()
         && mInstructionList._operator_isEqual (ptr->mInstructionList).boolValue ()
         && mEndOfRoutineLocation._operator_isEqual (ptr->mEndOfRoutineLocation).boolValue () ;
  }
  return equal ;
}
