...
class GGS_midrange_jumpInstructionKind ;
...
class GGS_midrange_instruction_computed_retlw ;
class cPtr_midrange_instruction_computed_retlw ;
class GGS_midrange_instruction_computed_goto ;
...
class GGS_midrange_jumpInstructionKind {
//--- Enumeration
  public : enum enumeration {kNotBuilt, enum_ipicExtended, enum_native} ;
...
//--- Default constructor
  public : inline GGS_midrange_jumpInstructionKind (void) : mValue (kNotBuilt) {}

//--- Internal constructor
  private : inline GGS_midrange_jumpInstructionKind (const enumeration inValue) : mValue (inValue) {}
...
//--- Construction from GALGAS constructor
  public : static inline GGS_midrange_jumpInstructionKind  constructor_ipicExtended (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_midrange_jumpInstructionKind (enum_ipicExtended) ;
  }
  public : static inline GGS_midrange_jumpInstructionKind  constructor_native (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_midrange_jumpInstructionKind (enum_native) ;
  }
...
//--- Comparison operators
  public : GGS_bool _operator_isEqual (const GGS_midrange_jumpInstructionKind inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_midrange_jumpInstructionKind inOperand) const ;
  public : GGS_bool _operator_infOrEqual (const GGS_midrange_jumpInstructionKind inOperand) const ;
  public : GGS_bool _operator_supOrEqual (const GGS_midrange_jumpInstructionKind inOperand) const ;
  public : GGS_bool _operator_strictInf (const GGS_midrange_jumpInstructionKind inOperand) const ;
  public : GGS_bool _operator_strictSup (const GGS_midrange_jumpInstructionKind inOperand) const ;
} ;
...
class GGS_midrange_instruction_computed_retlw : public GGS_midrange_instruction {
//--- Default constructor
  public : inline GGS_midrange_instruction_computed_retlw (void) : GGS_midrange_instruction () {}

//--- Pointer assignment constructor
  public : GGS_midrange_instruction_computed_retlw (cPtr__AC_galgas_class * inPointer) ;

//--- Object assignment constructor
  public : GGS_midrange_instruction_computed_retlw (cPtr__AC_galgas_class & inObject) ;

//--- _castFrom class method (implements cast expression)
  public : static GGS_midrange_instruction_computed_retlw
  _castFrom (C_Compiler & inLexique,
             cPtr__AC_galgas_class * inPointer,
             const bool inUseKindOfClass,
             const GGS_location & inErrorLocation
...
//--- 'new' constructor
  public : static GGS_midrange_instruction_computed_retlw constructor_new (C_Compiler & inLexique,
                                const GGS_location & argument_0,
...
//--- getPtr
  public : inline cPtr_midrange_instruction_computed_retlw * getPtr (void) const {
...
//--- operator ()
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : cPtr_midrange_instruction_computed_retlw * operator () (LOCATION_ARGS) const ;
  #else
    public : inline cPtr_midrange_instruction_computed_retlw * operator () (LOCATION_ARGS) const {
      return (cPtr_midrange_instruction_computed_retlw *) mPointer ;
    }
  #endif
...
extern C_galgasClassRunTimeInformation gClassInfoFor__midrange_instruction_computed_retlw ;
...
class GGS_midrange_instruction_computed_goto : public GGS_midrange_instruction {
//--- Default constructor
  public : inline GGS_midrange_instruction_computed_goto (void) : GGS_midrange_instruction () {}

//--- Pointer assignment constructor
  public : GGS_midrange_instruction_computed_goto (cPtr__AC_galgas_class * inPointer) ;

//--- Object assignment constructor
  public : GGS_midrange_instruction_computed_goto (cPtr__AC_galgas_class & inObject) ;

//--- _castFrom class method (implements cast expression)
  public : static GGS_midrange_instruction_computed_goto
  _castFrom (C_Compiler & inLexique,
             cPtr__AC_galgas_class * inPointer,
             const bool inUseKindOfClass,
             const GGS_location & inErrorLocation
...
//--- 'new' constructor
  public : static GGS_midrange_instruction_computed_goto constructor_new (C_Compiler & inLexique,
                                const GGS_location & argument_0,
                                const GGS_immediatExpression & argument_1,
...
//--- getPtr
  public : inline cPtr_midrange_instruction_computed_goto * getPtr (void) const {
...
//--- operator ()
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : cPtr_midrange_instruction_computed_goto * operator () (LOCATION_ARGS) const ;
  #else
    public : inline cPtr_midrange_instruction_computed_goto * operator () (LOCATION_ARGS) const {
      return (cPtr_midrange_instruction_computed_goto *) mPointer ;
    }
  #endif
...
extern C_galgasClassRunTimeInformation gClassInfoFor__midrange_instruction_computed_goto ;
...
//--- Constructor 'emptyList'
  ...
  public : static GGS_midrange_interruptDefinitionList constructor_listWithValue (const GGS_midrange_instructionList & argument_0,
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_midrange_instructionList & argument_0,
                                const GGS_location & argument_1) ;
//--- Handling '.' GALGAS operator
  ...
  public : void modifier_prependValue (C_Compiler & _inLexique,
                                ...
                                COMMA_LOCATION_ARGS) ;
//--- Internal Methods
  protected : void _internalAppendValues (const GGS_midrange_instructionList & argument_0,
                                const GGS_location & argument_1
                                COMMA_LOCATION_ARGS) ;

  protected : void _internalPrependValues (const GGS_midrange_instructionList & argument_0,
                                const GGS_location & argument_1
                                COMMA_LOCATION_ARGS) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//        abstract class 'cPtr_midrange_instruction_computed_retlw'          *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_midrange_instruction_computed_retlw : public cPtr_midrange_instruction {
  private : typedef cPtr_midrange_instruction inherited ;
//--- Constructor
  public : cPtr_midrange_instruction_computed_retlw (const GGS_location & ,
                                const GGS_immediatExpression & ,
...
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_midrange_instruction_computed_retlw (void) {}
  #endif
...
//---------------------------------------------------------------------------*
//                                                                           *
//         abstract class 'cPtr_midrange_instruction_computed_goto'          *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_midrange_instruction_computed_goto : public cPtr_midrange_instruction {
  private : typedef cPtr_midrange_instruction inherited ;
//--- Constructor
  public : cPtr_midrange_instruction_computed_goto (const GGS_location & ,
                                const GGS_immediatExpression & ,
...
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_midrange_instruction_computed_goto (void) {}
  #endif
...
//--- Constructor
  public : elementOf_GGS_midrange_interruptDefinitionList (const GGS_midrange_instructionList & ,
                                const GGS_location & 
                                COMMA_LOCATION_ARGS) ;
