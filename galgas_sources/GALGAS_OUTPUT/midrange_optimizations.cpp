...
category_method__midrange_ipic_JUMP__optimizeJUMP (C_Compiler & inLexique,
  ...
  if (operand_3512 != NULL) {
    ...
    const GGS_bool cond_4216 = var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_3512->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103)) ;
      ...
      { const GGS_midrange_ipic_instruction _var_5951 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5951.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_5951.getPtr ()))) {
            ...
            const GGS_bool cond_5407 = (var_cas_literalOp.reader_mLiteralInstruction (inLexique COMMA_SOURCE_FILE_AT_LINE (122))).operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE)) ;
...
category_method__midrange_ipic_GOTO__optimizeGOTO (C_Compiler & inLexique,
  ...
  if (operand_6109 != NULL) {
    ...
    const GGS_bool cond_6871 = var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_6109->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)) ;
      ...
      { const GGS_midrange_ipic_instruction _var_9066 = var_cas_firstInstruction ; // CAST instruction
        if (_var_9066.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_9066.getPtr ()))) {
            ...
            const GGS_bool cond_8090 = (var_cas_literalOp.reader_mLiteralInstruction (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE)) ;
...
category_method__midrange_ipic_instruction_literalOperation__optimizeMOVLW (C_Compiler & inLexique,
  ...
  if (operand_10173 != NULL) {
    const GGS_bool cond_11136 = (operand_10173->mLiteralInstruction).operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_MOVLW (inLexique COMMA_HERE)) ;
...
void routine_perform_midrange_optimizations (C_Compiler & inLexique,
  ...
  GGS_uint _variant_21017 = var_cas_ioGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (427)) ;
      ...
      if (_variant_21017.uintValue () == 0) {
        ...
        }
        {
          ...
          while (((operand_19115 = enumerator_19115.nextObject ()))) {
            ...
            const GGS_bool cond_19536 = (var_cas_referencedLabels.reader_hasKey (inLexique, operand_19115->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (457)) COMMA_SOURCE_FILE_AT_LINE (457))).operator_not () ;
            if (cond_19536.isBuiltAndTrue ()) {
              ...
              var_cas_symbolTable.modifier_removeKey (inLexique, operand_19115->mKey, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (461)) ;
            }
          }
        }
