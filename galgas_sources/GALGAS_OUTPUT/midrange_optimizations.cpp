...
category_method__midrange_ipic_GOTO__optimizeGOTO (C_Compiler & inLexique,
  ...
  if (operand_6109 != NULL) {
    ...
    if ((var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_6109->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157))).isBuiltAndTrue ()) {
      ...
      GGS_uint  var_cas_line ;
      const GGS_symbolTableForOptimizations  temp_6907 = var_cas_inSymbolTable ;
      if (temp_6907.isBuilt ()) {
        temp_6907 (HERE)->method_searchKey (inLexique, operand_6109->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (162)) ;
      }
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
...
category_method__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & inLexique,
  ...
  if (operand_11216 != NULL) {
    GGS_uint  var_cas_line ;
    const GGS_symbolTableForOptimizations  temp_11494 = var_cas_inSymbolTable ;
    if (temp_11494.isBuilt ()) {
      temp_11494 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11216->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (267)) ;
    }
    GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ...
      { const GGS_midrange_ipic_instruction _var_13748 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (326)) COMMA_SOURCE_FILE_AT_LINE (326)) ; // CAST instruction
        if (_var_13748.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_midrange_ipic_actualInstruction *> (_var_13748.getPtr ()) != NULL) {
            ...
            const GGS_midrange_ipic_actualInstruction  temp_13652 = var_cas_instruction ;
            if (temp_13652.isBuilt ()) {
              temp_13652 (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (328)) ;
            }
...
void routine_perform_midrange_optimizations (C_Compiler & inLexique,
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_16104 = enumerator_16104.nextObject ()))) {
      ...
      const GGS_midrange_ipic_instruction  temp_16147 = operand_16104->mInstruction ;
      if (temp_16147.isBuilt ()) {
        typeCategoryMethod__midrange_ipic_instruction__defineLabel method = findCategoryMethod__midrange_ipic_instruction__defineLabel (temp_16147.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_16147 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (388)) ;
        }
      }
      ...
      if (_variant_19857.uintValue () == 0) {
            ...
            { const GGS_midrange_ipic_instruction _var_17707 = operand_16567->mInstruction ; // CAST instruction
              if (_var_17707.getPtr () != NULL) {
                ...
                if (typeid (cPtr_midrange_ipic_GOTO) == typeid (* (_var_17707.getPtr ()))) {
                  ...
                  const GGS_midrange_ipic_GOTO  temp_16680 = var_cas_ipic_GOTO ;
                  if (temp_16680.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_GOTO__optimizeGOTO method = findCategoryMethod__midrange_ipic_GOTO__optimizeGOTO (temp_16680.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_16680 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (403)) ;
                    }
                  }
                  ...
                  const GGS_midrange_ipic_JUMP  temp_16850 = var_cas_ipic_JUMP ;
                  if (temp_16850.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_JUMP__optimizeJUMP method = findCategoryMethod__midrange_ipic_JUMP__optimizeJUMP (temp_16850.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_16850 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (405)) ;
                    }
                  }
                  ...
                  const GGS_midrange_ipic_instruction_literalOperation  temp_17210 = var_cas_ipic_literal ;
                  if (temp_17210.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW method = findCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW (temp_17210.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_17210 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (409)) ;
                    }
                  }
                  ...
                  const GGS_midrange_ipic_incDecRegisterInCondition  temp_17398 = var_cas_ipic_decInc ;
                  if (temp_17398.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc method = findCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (temp_17398.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_17398 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (411)) ;
                    }
                  }
                  ...
                  const GGS_midrange_ipic_instruction_BitTestSkip  temp_17608 = var_cas_ipic_bitTestSkip ;
                  if (temp_17608.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip method = findCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (temp_17608.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_17608 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (413)) ;
                    }
                  }
                }else{
                }
        ...
        var_cas_referencedLabels = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_17852 = enumerator_17852.nextObject ()))) {
            ...
            const GGS_midrange_ipic_instruction  temp_17896 = operand_17852->mInstruction ;
            if (temp_17896.isBuilt ()) {
              temp_17896 (HERE)->method_enterReferencedLabel (inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (420)) ;
            }
          }
        }
        {
          ...
          while (((operand_17960 = enumerator_17960.nextObject ()))) {
            ...
            if (((var_cas_referencedLabels.reader_hasKey (inLexique, operand_17960->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423))).operator_not ()).isBuiltAndTrue ()) {
              ...
              const GGS_symbolTableForOptimizations  temp_18075 = var_cas_symbolTable ;
              if (temp_18075.isBuilt ()) {
                temp_18075 (HERE)->method_searchKey (inLexique, operand_17960->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (424)) ;
              }
              var_cas_ioListFileContents.appendCString ("  line ") ;
        ...
        var_cas_previousWasSkippingInstruction = GGS_bool (false) ;
        {
          ...
          while (((operand_18595 = enumerator_18595.nextObject ()))) {
            ...
            if (((var_cas_reachable).operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_midrange_ipic_instruction  temp_18711 = operand_18595->mInstruction ;
              if (temp_18711.isBuilt ()) {
                temp_18711 (HERE)->method_nextInstructionIsReachable (inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (436)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_midrange_ipic_instruction  temp_18835 = operand_18595->mInstruction ;
              if (temp_18835.isBuilt ()) {
                temp_18835 (HERE)->method_isSkippingInstruction (inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (438)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_midrange_ipic_instruction  temp_18928 = operand_18595->mInstruction ;
              if (temp_18928.isBuilt ()) {
                temp_18928 (HERE)->method_isLABELorORG (inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (440)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_midrange_ipic_instruction  temp_18990 = operand_18595->mInstruction ;
              if (temp_18990.isBuilt ()) {
                temp_18990 (HERE)->method_isNULL (inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (441)) ;
              }
        ...
        if (((var_cas_optimizationsDone).operator_not ()).isBuiltAndTrue ()) {
          ...
          var_cas_currentAddress = GGS_uint (0U) ;
          {
            ...
            while (((operand_19655 = enumerator_19655.nextObject ()))) {
              ...
              const GGS_midrange_ipic_instruction  temp_19698 = operand_19655->mInstruction ;
              if (temp_19698.isBuilt ()) {
                temp_19698 (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (457)) ;
              }
            }
          }
