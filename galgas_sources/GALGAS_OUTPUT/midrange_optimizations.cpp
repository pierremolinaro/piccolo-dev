...
enterCategoryMethod__midrange_ipic_instruction__defineLabel (typeCategoryMethod__midrange_ipic_instruction__defineLabel inRoutine,
  ...
  gDispatchTableForMethod__midrange_ipic_instruction__defineLabel.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_instruction__defineLabel (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_instruction__defineLabel.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
enterCategoryMethod__midrange_ipic_JUMP__optimizeJUMP (typeCategoryMethod__midrange_ipic_JUMP__optimizeJUMP inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__midrange_ipic_JUMP__optimizeJUMP.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_JUMP__optimizeJUMP (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_JUMP__optimizeJUMP.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__midrange_ipic_GOTO__optimizeGOTO (C_Compiler & inLexique,
  ...
  if (operand_6109 != NULL) {
    ...
    ::routine_findMidRangeFirstInstructionOrLabelFromAddress (inLexique,  var_cas_inLineIndex.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (156)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (156)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_6109->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_NULL ::constructor_new (inLexique COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (159)) ;
      var_cas_ioListFileContents.appendCString ("  line ") ;
      ...
      { const GGS_midrange_ipic_instruction _var_9066 = var_cas_firstInstruction ; // CAST instruction
        if (_var_9066.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_9066.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_instruction_RETURN ::constructor_new (inLexique, operand_6109->mInstructionLocation COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (171)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true) ;
            var_cas_ioListFileContents.appendCString ("  line ") ;
            ...
            if (((var_cas_literalOp.reader_mLiteralInstruction (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            ...
            if (((operand_6109->mTargetLabel).operator_isNotEqual (var_cas_jump.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (187)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_JUMP ::constructor_new (inLexique, operand_6109->mInstructionLocation, var_cas_jump.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (inLexique COMMA_HERE) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (188)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
            ...
            if (((operand_6109->mTargetLabel).operator_isNotEqual (var_cas_goto.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (196)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_GOTO ::constructor_new (inLexique, operand_6109->mInstructionLocation, var_cas_goto.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (198)) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (197)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
...
enterCategoryMethod__midrange_ipic_GOTO__optimizeGOTO (typeCategoryMethod__midrange_ipic_GOTO__optimizeGOTO inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__midrange_ipic_GOTO__optimizeGOTO.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_GOTO__optimizeGOTO (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_GOTO__optimizeGOTO.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__midrange_ipic_instruction_literalOperation__optimizeMOVLW (C_Compiler & inLexique,
  ...
  if (operand_10173 != NULL) {
    if (((operand_10173->mLiteralInstruction).operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_MOVLW (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
...
enterCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW (typeCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & inLexique,
  ...
  if (operand_11302 != NULL) {
    ...
    if (temp_11645.isBuilt ()) {
      temp_11645 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11302->mTargetLabel, GGS_location (inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (270)) ;
    }
    GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
    ...
    { const GGS_midrange_ipic_instruction _var_13920 = var_cas_firstInstruction ; // CAST instruction
      if (_var_13920.getPtr () != NULL) {
        ...
        if (typeid (cPtr_midrange_ipic_JUMP) == typeid (* (_var_13920.getPtr ()))) {
          ...
          if ((operand_11302->mIncrement).isBuiltAndTrue ()) {
          ...
          if ((operand_11302->m_W_isDestination).isBuiltAndTrue ()) {
            var_cas_ioListFileContents.appendCString (", W ") ;
          }
          if ((operand_11302->mBranchIfZero).isBuiltAndTrue ()) {
          ...
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_incDecRegisterInCondition ::constructor_new (inLexique, operand_11302->mInstructionLocation, operand_11302->mRegisterDescription, var_cas_goto.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (312)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (312)), operand_11302->mIncrement, operand_11302->m_W_isDestination, operand_11302->mBranchIfZero COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (308)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true) ;
          var_cas_ioListFileContents.appendCString ("  line ") ;
...
enterCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (typeCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
category_method__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & inLexique,
  ...
  if (operand_14087 != NULL) {
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      GGS_midrange_ipic_instruction  var_cas_thirdInstruction = GGS_midrange_ipic_NULL ::constructor_new (inLexique COMMA_HERE) ;
      GGS_stringset  var_cas_reachedLabelSet ;
      GGS_midrange_ipic_instruction  automatic_var_2 ;
      ::routine_findMidRangeFirstInstructionOrLabelFromAddress (inLexique,  var_cas_inLineIndex.add_operation (inLexique, GGS_uint (3U) COMMA_SOURCE_FILE_AT_LINE (372)),  var_cas_ioGeneratedInstructionList,  automatic_var_2,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (372)) ;
      var_cas_ok = var_cas_reachedLabelSet.reader_hasKey (inLexique, var_cas_jumpLabel COMMA_SOURCE_FILE_AT_LINE (373)) ;
    }
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (inLexique, operand_14087->mInstructionLocation, (operand_14087->mSkipIfSet).operator_not (), operand_14087->mRegisterDescription, operand_14087->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (378)) ;
      ...
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_NULL ::constructor_new (inLexique COMMA_HERE), var_cas_inLineIndex.add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (395)) COMMA_SOURCE_FILE_AT_LINE (393)) ;
      var_cas_ioOptimizationsDone = GGS_bool (true) ;
...
enterCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (typeCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip.forceObjectAtIndex (inClassID, inRoutine, NULL) ;
}
...
findCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (AC_galgasClassRunTimeInformation * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip.forceObjectAtIndex (inClassPtr->slotID (), result, NULL) ;
    }
  }
  return result ;
}
...
void routine_perform_midrange_optimizations (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (416))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (417))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents.dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (418))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  GGS_symbolTableForOptimizations  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_17248 = enumerator_17248.nextObject ()))) {
      ...
      const GGS_midrange_ipic_instruction  temp_17291 = operand_17248->mInstruction ;
      if (temp_17291.isBuilt ()) {
        typeCategoryMethod__midrange_ipic_instruction__defineLabel method = findCategoryMethod__midrange_ipic_instruction__defineLabel (temp_17291.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_17291 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (422)) ;
        }
      }
  ...
  GGS_uint _variant_21001 = var_cas_ioGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (427)) ;
  GGS_bool _condition_21001 (_variant_21001.isBuilt (), true) ;
  while (_condition_21001.isBuiltAndTrue ()) {
    _condition_21001 = var_cas_optimizationsDone ;
    if (_condition_21001.isBuiltAndTrue ()) {
      if (_variant_21001.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (495)) ;
        _condition_21001 = GGS_bool (false) ;
      }else{
        _variant_21001.decrement_operation (inLexique COMMA_HERE) ;
        ...
        var_cas_ioListFileContents.appendCString (":\n") ;
        {
          ...
          GGS_midrange_ipic_instructionList::cEnumerator enumerator_17711 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_midrange_ipic_instructionList::cElement * operand_17711 = NULL ;
          while (((operand_17711 = enumerator_17711.nextObject ()))) {
            macroValidPointer (operand_17711) ;
            { const GGS_midrange_ipic_instruction _var_18851 = operand_17711->mInstruction ; // CAST instruction
              if (_var_18851.getPtr () != NULL) {
                macroValidPointer (_var_18851.getPtr ()) ;
                if (typeid (cPtr_midrange_ipic_GOTO) == typeid (* (_var_18851.getPtr ()))) {
                  const GGS_midrange_ipic_GOTO var_cas_ipic_GOTO (_var_18851.getPtr ()) ;
                  const GGS_midrange_ipic_GOTO  temp_17824 = var_cas_ipic_GOTO ;
                  if (temp_17824.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_GOTO__optimizeGOTO method = findCategoryMethod__midrange_ipic_GOTO__optimizeGOTO (temp_17824.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_17824 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (437)) ;
                    }
                  }
                }else if (typeid (cPtr_midrange_ipic_JUMP) == typeid (* (_var_18851.getPtr ()))) {
                  const GGS_midrange_ipic_JUMP var_cas_ipic_JUMP (_var_18851.getPtr ()) ;
                  const GGS_midrange_ipic_JUMP  temp_17994 = var_cas_ipic_JUMP ;
                  if (temp_17994.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_JUMP__optimizeJUMP method = findCategoryMethod__midrange_ipic_JUMP__optimizeJUMP (temp_17994.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_17994 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (439)) ;
                    }
                  }
                }else if (typeid (cPtr_midrange_ipic_instruction_literalOperation) == typeid (* (_var_18851.getPtr ()))) {
                  const GGS_midrange_ipic_instruction_literalOperation var_cas_ipic_literal (_var_18851.getPtr ()) ;
                  const GGS_midrange_ipic_instruction_literalOperation  temp_18354 = var_cas_ipic_literal ;
                  if (temp_18354.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW method = findCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW (temp_18354.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_18354 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (443)) ;
                    }
                  }
                }else if (typeid (cPtr_midrange_ipic_incDecRegisterInCondition) == typeid (* (_var_18851.getPtr ()))) {
                  const GGS_midrange_ipic_incDecRegisterInCondition var_cas_ipic_decInc (_var_18851.getPtr ()) ;
                  const GGS_midrange_ipic_incDecRegisterInCondition  temp_18542 = var_cas_ipic_decInc ;
                  if (temp_18542.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc method = findCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (temp_18542.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_18542 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (445)) ;
                    }
                  }
                }else if (typeid (cPtr_midrange_ipic_instruction_BitTestSkip) == typeid (* (_var_18851.getPtr ()))) {
                  const GGS_midrange_ipic_instruction_BitTestSkip var_cas_ipic_bitTestSkip (_var_18851.getPtr ()) ;
                  const GGS_midrange_ipic_instruction_BitTestSkip  temp_18752 = var_cas_ipic_bitTestSkip ;
                  if (temp_18752.isBuilt ()) {
                    typeCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip method = findCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (temp_18752.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, temp_18752 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (447)) ;
                    }
                  }
                }else{
                }
        ...
        {
          GGS_midrange_ipic_instructionList::cEnumerator enumerator_18996 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_midrange_ipic_instructionList::cElement * operand_18996 = NULL ;
          while (((operand_18996 = enumerator_18996.nextObject ()))) {
            macroValidPointer (operand_18996) ;
            const GGS_midrange_ipic_instruction  temp_19040 = operand_18996->mInstruction ;
            if (temp_19040.isBuilt ()) {
              temp_19040 (HERE)->method_enterReferencedLabel (inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (454)) ;
            }
          }
        }
        {
          GGS_symbolTableForOptimizations::cEnumerator enumerator_19104 (var_cas_symbolTable, true) ;
          const GGS_symbolTableForOptimizations::cElement * operand_19104 = NULL ;
          while (((operand_19104 = enumerator_19104.nextObject ()))) {
            macroValidPointer (operand_19104) ;
            if (((var_cas_referencedLabels.reader_hasKey (inLexique, operand_19104->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (457)) COMMA_SOURCE_FILE_AT_LINE (457))).operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  temp_19219 = var_cas_symbolTable ;
              if (temp_19219.isBuilt ()) {
                temp_19219 (HERE)->method_searchKey (inLexique, operand_19104->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (458)) ;
              }
              var_cas_ioListFileContents.appendCString ("  line ") ;
              ...
              var_cas_ioListFileContents.dotAssign_operation (operand_19104->mKey) ;
              var_cas_ioListFileContents.appendCString ("' is deleted\n") ;
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_NULL ::constructor_new (inLexique COMMA_HERE), var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (460)) ;
              GGS_uint  automatic_var_3 ;
              var_cas_symbolTable.modifier_removeKey (inLexique, operand_19104->mKey, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (461)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_midrange_ipic_instructionList::cEnumerator enumerator_19739 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_midrange_ipic_instructionList::cElement * operand_19739 = NULL ;
          while (((operand_19739 = enumerator_19739.nextObject ()))) {
            macroValidPointer (operand_19739) ;
            if (((var_cas_reachable).operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              const GGS_midrange_ipic_instruction  temp_19855 = operand_19739->mInstruction ;
              if (temp_19855.isBuilt ()) {
                temp_19855 (HERE)->method_nextInstructionIsReachable (inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (470)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              const GGS_midrange_ipic_instruction  temp_19979 = operand_19739->mInstruction ;
              if (temp_19979.isBuilt ()) {
                temp_19979 (HERE)->method_isSkippingInstruction (inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (472)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_midrange_ipic_instruction  temp_20072 = operand_19739->mInstruction ;
              if (temp_20072.isBuilt ()) {
                temp_20072 (HERE)->method_isLABELorORG (inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (474)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_midrange_ipic_instruction  temp_20134 = operand_19739->mInstruction ;
              if (temp_20134.isBuilt ()) {
                temp_20134 (HERE)->method_isNULL (inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (475)) ;
              }
              if ((((var_cas_isLABELorORG).operator_not ()).operator_and ((var_cas_isNULL).operator_not ())).isBuiltAndTrue ()) {
                ...
                var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_NULL ::constructor_new (inLexique COMMA_HERE), var_cas_idx COMMA_SOURCE_FILE_AT_LINE (478)) ;
        ...
        if (((var_cas_optimizationsDone).operator_not ()).isBuiltAndTrue ()) {
          ...
          {
            GGS_midrange_ipic_instructionList::cEnumerator enumerator_20799 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_midrange_ipic_instructionList::cElement * operand_20799 = NULL ;
            while (((operand_20799 = enumerator_20799.nextObject ()))) {
              macroValidPointer (operand_20799) ;
              const GGS_midrange_ipic_instruction  temp_20842 = operand_20799->mInstruction ;
              if (temp_20842.isBuilt ()) {
                temp_20842 (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (491)) ;
              }
            }
          }
