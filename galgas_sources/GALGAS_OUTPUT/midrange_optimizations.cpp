  ...
  if (operand_3512 != NULL) {
    ...
    if (cond_4216.isBuiltAndTrue ()) {
      ...
      if (var_cas_inSymbolTable.isBuilt ()) {
        var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, operand_3512->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (108)) ;
      }
...
category_method__midrange_ipic_GOTO__optimizeGOTO (C_Compiler & inLexique,
  ...
  if (operand_6109 != NULL) {
    ...
    if (cond_6871.isBuiltAndTrue ()) {
      ...
      GGS_uint  var_cas_line ;
      if (var_cas_inSymbolTable.isBuilt ()) {
        var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, operand_6109->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (163)) ;
      }
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
...
category_method__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & inLexique,
  ...
  if (operand_11302 != NULL) {
    GGS_uint  var_cas_line ;
    if (var_cas_inSymbolTable.isBuilt ()) {
      var_cas_inSymbolTable (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11302->mTargetLabel, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (270)), var_cas_line COMMA_SOURCE_FILE_AT_LINE (270)) ;
    }
    GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
        ...
        if (_var_14892.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_midrange_ipic_actualInstruction *> (_var_14892.getPtr ()) != NULL) {
            ...
            if (var_cas_instruction.isBuilt ()) {
              var_cas_instruction (HERE)->method_instructionLength (inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (362)) ;
            }
...
void routine_perform_midrange_optimizations (C_Compiler & inLexique,
  ...
  GGS_symbolTableForOptimizations  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (420)) ;
  {
    ...
    while (((operand_17248 = enumerator_17248.nextObject ()))) {
      ...
      { typeCategoryMethod__midrange_ipic_instruction__defineLabel method = findCategoryMethod__midrange_ipic_instruction__defineLabel (operand_17248->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_17248->mInstruction (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (422)) ;
        }
      }
  ...
  GGS_uint _variant_21021 = var_cas_ioGeneratedInstructionList.reader_length () ;
  GGS_bool _condition_21021 (_variant_21021.isBuilt (), true) ;
  while (_condition_21021.isBuiltAndTrue ()) {
    _condition_21021 = var_cas_optimizationsDone ;
    if (_condition_21021.isBuiltAndTrue ()) {
      if (_variant_21021.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (495)) ;
        _condition_21021 = GGS_bool (false) ;
      }else{
        _variant_21021.decrement_operation (inLexique COMMA_HERE) ;
            ...
            { const GGS_midrange_ipic_instruction _var_18862 = operand_17717->mInstruction ; // CAST instruction
              if (_var_18862.getPtr () != NULL) {
                ...
                if (typeid (cPtr_midrange_ipic_GOTO) == typeid (* (_var_18862.getPtr ()))) {
                  ...
                  { typeCategoryMethod__midrange_ipic_GOTO__optimizeGOTO method = findCategoryMethod__midrange_ipic_GOTO__optimizeGOTO (var_cas_ipic_GOTO.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_GOTO (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (437)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__midrange_ipic_JUMP__optimizeJUMP method = findCategoryMethod__midrange_ipic_JUMP__optimizeJUMP (var_cas_ipic_JUMP.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_JUMP (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (439)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW method = findCategoryMethod__midrange_ipic_instruction_literalOperation__optimizeMOVLW (var_cas_ipic_literal.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_literal (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (443)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc method = findCategoryMethod__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (var_cas_ipic_decInc.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_decInc (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (445)) ;
                    }
                  }
                  ...
                  { typeCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip method = findCategoryMethod__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (var_cas_ipic_bitTestSkip.galgasObjectRunTimeInfo ()) ;
                    if (method != NULL) {
                      method (inLexique, var_cas_ipic_bitTestSkip (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (447)) ;
                    }
                  }
                }else{
                }
        ...
        GGS_stringset  var_cas_referencedLabels = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_19007 = enumerator_19007.nextObject ()))) {
            ...
            if (operand_19007->mInstruction.isBuilt ()) {
              operand_19007->mInstruction (HERE)->method_enterReferencedLabel (inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (454)) ;
            }
          }
        }
        {
          ...
          while (((operand_19115 = enumerator_19115.nextObject ()))) {
            ...
            const GGS_bool cond_19540 = (var_cas_referencedLabels.reader_hasKey (operand_19115->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (457)))).operator_not () ;
            if (cond_19540.isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              if (var_cas_symbolTable.isBuilt ()) {
                var_cas_symbolTable (HERE)->method_searchKey (inLexique, operand_19115->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (458)) ;
              }
              var_cas_ioListFileContents.appendCString ("  line ") ;
              ...
              GGS_uint  automatic_var_19528_0 ;
              var_cas_symbolTable.modifier_removeKey (inLexique, operand_19115->mKey, automatic_var_19528_0 COMMA_SOURCE_FILE_AT_LINE (461)) ;
            }
          }
        }
        ...
        {
            GGS_uint var_cas_idx (true, 0) ;
          GGS_midrange_ipic_instructionList::cEnumerator enumerator_19754 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_midrange_ipic_instructionList::cElement * operand_19754 = NULL ;
          while (((operand_19754 = enumerator_19754.nextObject ()))) {
            macroValidPointer (operand_19754) ;
            const GGS_bool cond_20035 = (var_cas_reachable).operator_or (var_cas_previousWasSkippingInstruction) ;
            if (cond_20035.isBuiltAndTrue ()) {
              if (operand_19754->mInstruction.isBuilt ()) {
                operand_19754->mInstruction (HERE)->method_nextInstructionIsReachable (inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (470)) ;
              }
              var_cas_previousWasSkippingInstruction = var_cas_skippingInstruction ;
              if (operand_19754->mInstruction.isBuilt ()) {
                operand_19754->mInstruction (HERE)->method_isSkippingInstruction (inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (472)) ;
              }
            }else if (cond_20035.isBuiltAndFalse ()) {
              GGS_bool var_cas_isLABELorORG ;
              if (operand_19754->mInstruction.isBuilt ()) {
                operand_19754->mInstruction (HERE)->method_isLABELorORG (inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (474)) ;
              }
              GGS_bool var_cas_isNULL ;
              if (operand_19754->mInstruction.isBuilt ()) {
                operand_19754->mInstruction (HERE)->method_isNULL (inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (475)) ;
              }
              const GGS_bool cond_20433 = ((var_cas_isLABELorORG).operator_not ()).operator_and ((var_cas_isNULL).operator_not ()) ;
              ...
              }else if (cond_20433.isBuiltAndFalse ()) {
                const GGS_bool cond_20590 = var_cas_isLABELorORG ;
                if (cond_20590.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_21010 = (var_cas_optimizationsDone).operator_not () ;
        if (cond_21010.isBuiltAndTrue ()) {
          var_cas_ioListFileContents.appendCString ("  No optimization\n"
            "\n") ;
          GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
          {
            GGS_midrange_ipic_instructionList::cEnumerator enumerator_20819 (var_cas_ioGeneratedInstructionList, true) ;
            const GGS_midrange_ipic_instructionList::cElement * operand_20819 = NULL ;
            while (((operand_20819 = enumerator_20819.nextObject ()))) {
              macroValidPointer (operand_20819) ;
              if (operand_20819->mInstruction.isBuilt ()) {
                operand_20819->mInstruction (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (491)) ;
              }
            }
          }
