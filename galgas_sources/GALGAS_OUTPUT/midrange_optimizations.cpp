...
category_method__midrange_ipic_JUMP__optimizeJUMP (C_Compiler & _inLexique,
  ...
  if (operand_3512 != NULL) {
    ...
    ::routine_findMidRangeFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (101)),  var_cas_ioGeneratedInstructionList,  automatic_var_0,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (101)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (_inLexique, operand_3512->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103))).isBuiltAndTrue ()) {
      ...
      ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (111)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (111)) ;
...
category_method__midrange_ipic_GOTO__optimizeGOTO (C_Compiler & _inLexique,
  ...
  if (operand_6109 != NULL) {
    ...
    ::routine_findMidRangeFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (155)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (155)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (_inLexique, operand_6109->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157))).isBuiltAndTrue ()) {
      ...
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (165)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (165)) ;
...
category_method__midrange_ipic_instruction_literalOperation__optimizeMOVLW (C_Compiler & _inLexique,
  ...
  if (operand_10087 != NULL) {
    if (((operand_10087->mLiteralInstruction)._operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_MOVLW (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (242)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (242)) ;
...
category_method__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & _inLexique,
  ...
  if (operand_11216 != NULL) {
    ...
    GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
    ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (270)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (270)) ;
...
category_method__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & _inLexique,
  ...
  if (operand_12943 != NULL) {
    ...
    { const GGS_midrange_ipic_instruction _var_13392 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (318)) COMMA_SOURCE_FILE_AT_LINE (318)) ; // CAST instruction
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_midrange_ipic_instruction _var_13748 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (326)) COMMA_SOURCE_FILE_AT_LINE (326)) ; // CAST instruction
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      ::routine_findMidRangeFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (3U) COMMA_SOURCE_FILE_AT_LINE (338)),  var_cas_ioGeneratedInstructionList,  automatic_var_2,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (338)) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      var_cas_ioOptimizationsDone = GGS_bool (true) ;
      ...
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (366)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (366))) ;
...
void routine_perform_midrange_optimizations (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (382))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (383))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (384))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
