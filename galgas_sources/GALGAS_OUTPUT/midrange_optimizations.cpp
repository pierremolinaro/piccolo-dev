...
void routine_findMidRangeFirstInstructionFromAddress (C_Compiler & inLexique,
  ...
  while (_condition_1835.isBuiltAndTrue ()) {
    _condition_1835 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (40))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_1835.isBuiltAndTrue ()) {
      if (_variant_1835.uintValue () == 0) {
        ...
        _variant_1835._decrement_operation (inLexique COMMA_HERE) ;
...
void routine_findMidRangeFirstInstructionOrLabelFromAddress (C_Compiler & inLexique,
  ...
  while (_condition_3054.isBuiltAndTrue ()) {
    _condition_3054 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (67))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_3054.isBuiltAndTrue ()) {
      if (_variant_3054.uintValue () == 0) {
        ...
        _variant_3054._decrement_operation (inLexique COMMA_HERE) ;
        { const GGS_midrange_ipic_instruction _var_3041 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (69)) ; // CAST instruction
          if (_var_3041.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_midrange_ipic_actualInstruction *> (_var_3041.getPtr ()) != NULL) {
              ...
              var_cas_currentAddress._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
            }else{
              var_cas_currentAddress._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
            }
          }
        }
      }
...
category_method__midrange_ipic_JUMP__optimizeJUMP (C_Compiler & inLexique,
  ...
  if (operand_3512 != NULL) {
    ...
    ::routine_findMidRangeFirstInstructionOrLabelFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (101)),  var_cas_ioGeneratedInstructionList,  automatic_var_0,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (101)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_3512->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103))).isBuiltAndTrue ()) {
      ...
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (105))) ;
      ...
      ::routine_findMidRangeFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (111)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (111)) ;
      { const GGS_midrange_ipic_instruction _var_5951 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5951.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_5951.getPtr ()))) {
            ...
            var_cas_ioListFileContents.appendCString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (120))) ;
            ...
            if (((var_cas_literalOp.reader_mLiteralInstruction (inLexique COMMA_SOURCE_FILE_AT_LINE (122)))._operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
              ...
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (128))) ;
            ...
            if (((operand_3512->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (131)))).isBuiltAndTrue ()) {
              ...
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137))) ;
...
category_method__midrange_ipic_GOTO__optimizeGOTO (C_Compiler & inLexique,
  ...
  if (operand_6109 != NULL) {
    ...
    ::routine_findMidRangeFirstInstructionOrLabelFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (155)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (155)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (inLexique, operand_6109->mTargetLabel.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157))).isBuiltAndTrue ()) {
      ...
      var_cas_ioListFileContents.appendCString ("  line ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159))) ;
      ...
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findMidRangeFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (165)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (165)) ;
      { const GGS_midrange_ipic_instruction _var_8980 = var_cas_firstInstruction ; // CAST instruction
        if (_var_8980.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_8980.getPtr ()))) {
            ...
            var_cas_ioOptimizationsDone = GGS_bool (true) ;
            var_cas_ioListFileContents.appendCString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
            ...
            if (((var_cas_literalOp.reader_mLiteralInstruction (inLexique COMMA_SOURCE_FILE_AT_LINE (176)))._operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
              ...
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182))) ;
            ...
            if (((operand_6109->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
              ...
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191))) ;
            ...
            if (((operand_6109->mTargetLabel)._operator_isNotEqual (var_cas_goto.reader_mTargetLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (194)))).isBuiltAndTrue ()) {
              ...
              var_cas_ioOptimizationsDone = GGS_bool (true) ;
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))) ;
              var_cas_ioListFileContents.appendCString (": GOTO branching to JUMP replaced by JUMP\n") ;
            }
          }else{
          }
...
category_method__midrange_ipic_instruction_literalOperation__optimizeMOVLW (C_Compiler & inLexique,
  ...
  if (operand_10087 != NULL) {
    if (((operand_10087->mLiteralInstruction)._operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_MOVLW (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findMidRangeFirstInstructionFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (242)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (242)) ;
      { const GGS_midrange_ipic_instruction _var_11037 = var_cas_firstInstruction ; // CAST instruction
        if (_var_11037.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_11037.getPtr ()))) {
            ...
            var_cas_ioOptimizationsDone = GGS_bool (true) ;
            var_cas_ioListFileContents.appendCString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251))) ;
...
category_method__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & inLexique,
  ...
  if (operand_11216 != NULL) {
    ...
    GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
    ::routine_findMidRangeFirstInstructionFromAddress (inLexique,  var_cas_line._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (270)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (270)) ;
    { const GGS_midrange_ipic_instruction _var_12776 = var_cas_firstInstruction ; // CAST instruction
      if (_var_12776.getPtr () != NULL) {
        ...
        if (typeid (cPtr_midrange_ipic_JUMP) == typeid (* (_var_12776.getPtr ()))) {
          ...
          var_cas_ioOptimizationsDone = GGS_bool (true) ;
          var_cas_ioListFileContents.appendCString ("  line ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
          ...
          var_cas_ioListFileContents._dotAssign_operation (operand_11216->mRegisterDescription.reader_mAssemblyString (inLexique COMMA_SOURCE_FILE_AT_LINE (293))) ;
...
category_method__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & inLexique,
  ...
  if (operand_12943 != NULL) {
    ...
    { const GGS_midrange_ipic_instruction _var_13392 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (318)) COMMA_SOURCE_FILE_AT_LINE (318)) ; // CAST instruction
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_midrange_ipic_instruction _var_13748 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (326)) COMMA_SOURCE_FILE_AT_LINE (326)) ; // CAST instruction
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      ::routine_findMidRangeFirstInstructionOrLabelFromAddress (inLexique,  var_cas_inLineIndex._add_operation (inLexique, GGS_uint (3U) COMMA_SOURCE_FILE_AT_LINE (338)),  var_cas_ioGeneratedInstructionList,  automatic_var_2,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (338)) ;
      var_cas_ok = var_cas_reachedLabelSet.reader_hasKey (inLexique, var_cas_jumpLabel COMMA_SOURCE_FILE_AT_LINE (339)) ;
    }
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (inLexique, operand_12943->mInstructionLocation, (operand_12943->mSkipIfSet)._operator_not (), operand_12943->mRegisterDescription, operand_12943->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (344)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (inLexique, var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)), var_cas_inLineIndex._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (inLexique, GGS_midrange_ipic_NULL ::constructor_new (inLexique COMMA_HERE), var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      var_cas_ioOptimizationsDone = GGS_bool (true) ;
      var_cas_ioListFileContents.appendCString ("  lines ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (366))) ;
      var_cas_ioListFileContents.appendCString (" to ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex._add_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (366)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (366))) ;
...
void routine_perform_midrange_optimizations (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (382))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (383))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (384))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  ...
  while (_condition_19857.isBuiltAndTrue ()) {
    ...
    if (_condition_19857.isBuiltAndTrue ()) {
      if (_variant_19857.uintValue () == 0) {
        ...
        _variant_19857._decrement_operation (inLexique COMMA_HERE) ;
        var_cas_optimizationsDone = GGS_bool (false) ;
        var_cas_iteration._increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (397)) ;
        var_cas_ioListFileContents.appendCString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (398))) ;
        var_cas_ioListFileContents.appendCString (":\n") ;
        {
        ...
        }
        {
          ...
          while (((operand_17960 = enumerator_17960.nextObject ()))) {
            ...
            if (((var_cas_referencedLabels.reader_hasKey (inLexique, operand_17960->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)))._operator_not ()).isBuiltAndTrue ()) {
              ...
              var_cas_ioListFileContents.appendCString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_definitionLine.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (425))) ;
          ...
          while (((operand_18595 = enumerator_18595.nextObject ()))) {
            ...
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              ...
              if ((((var_cas_isLABELorORG)._operator_not ())._operator_and ((var_cas_isNULL)._operator_not ())).isBuiltAndTrue ()) {
                var_cas_ioListFileContents.appendCString ("  line ") ;
                var_cas_ioListFileContents._dotAssign_operation (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (443))) ;
        ...
        if (((var_cas_optimizationsDone)._operator_not ()).isBuiltAndTrue ()) {
          ...
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (459))) ;
