...
void routine_perform_5F_midrange_5F_optimizations (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23359 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_23353 ((PMUInt32) 0) ;
  while (enumerator_23359.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_defineLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23359.current_mInstruction (HERE).ptr (), var_symbolTable, index_23353, inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_23359.gotoNextObject () ;
    index_23353.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).isValid ()) {
    PMUInt32 variant_23574 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).uintValue () ;
    bool loop_23574 = true ;
    while (loop_23574) {
      loop_23574 = var_optimizationsDone.isValid () ;
      if (loop_23574) {
        loop_23574 = var_optimizationsDone.boolValue () ;
      }
      if (loop_23574 && (0 == variant_23574)) {
        loop_23574 = false ;
      ...
      if (loop_23574) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23828 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_23822 ((PMUInt32) 0) ;
        while (enumerator_23828.hasCurrentObject ()) {
          //-------- @structuredCastInstructionForGeneration
          if (enumerator_23828.current_mInstruction (HERE).isValid ()) {
            if (enumerator_23828.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_GOTO) {
              GALGAS_midrange_5F_intermediate_5F_GOTO cast_23913_ipic_GOTO ((cPtr_midrange_5F_intermediate_5F_GOTO *) enumerator_23828.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeGOTO ((const cPtr_midrange_5F_intermediate_5F_GOTO *) cast_23913_ipic_GOTO.ptr (), var_symbolTable, index_23822, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23828.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
              GALGAS_midrange_5F_intermediate_5F_JUMP cast_24091_ipic_JUMP ((cPtr_midrange_5F_intermediate_5F_JUMP *) enumerator_23828.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeJUMP ((const cPtr_midrange_5F_intermediate_5F_JUMP *) cast_24091_ipic_JUMP.ptr (), var_symbolTable, index_23822, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (569)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23828.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation) {
              GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation cast_24463_ipic_literal ((cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) enumerator_23828.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeMOVLW ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) cast_24463_ipic_literal.ptr (), index_23822, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23828.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition) {
              GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition cast_24655_ipic_decInc ((cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition *) enumerator_23828.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeTestDecInc ((const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition *) cast_24655_ipic_decInc.ptr (), var_symbolTable, index_23822, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (575)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23828.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip) {
              GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip cast_24867_ipic_bitTestSkip ((cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) enumerator_23828.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeBitTestSkip ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) cast_24867_ipic_bitTestSkip.ptr (), index_23822, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (577)) ;
              //-------- END @methodCallInstructionForGeneration
            }
          }
          enumerator_23828.gotoNextObject () ;
          index_23822.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
        }
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_stringset var_referencedLabels = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (582)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_25163 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_25163.hasCurrentObject ()) {
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_enterReferencedLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25163.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
          //-------- END @methodCallInstructionForGeneration
          enumerator_25163.gotoNextObject () ;
        }
        //-------- @foreachInstructionForGeneration
        cEnumerator_symbolTableForOptimizations enumerator_25271 (var_symbolTable, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_25271.hasCurrentObject ()) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_25271.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (587)) COMMA_SOURCE_FILE_AT_LINE (587)).operator_not (SOURCE_FILE_AT_LINE (587)).boolEnum () ;
          if (kBoolTrue == test_0) {
            //-------- @localVariableDeclarationForGeneration
            GALGAS_uint var_definitionLine ;
            //-------- @methodCallInstructionForGeneration
            var_symbolTable.method_searchKey (enumerator_25271.current_lkey (HERE), var_definitionLine, inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
            //-------- END @methodCallInstructionForGeneration
            //-------- @concatInstructionForGeneration
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string (": unreferenced label '") COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (enumerator_25271.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string ("' is deleted\n") COMMA_SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)) ;
            ...
            { //-------- @modifierCallInstructionForGeneration
            GALGAS_uint joker_25688_0 ; // Joker input parameter
            var_symbolTable.modifier_removeKey (enumerator_25271.current_lkey (HERE), joker_25688_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
            } //-------- END @typeMethodInstructionForGeneration
          }
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_25921 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_25915 ((PMUInt32) 0) ;
        while (enumerator_25921.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_1) {
            //-------- @assignmentInstructionForGeneration
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25921.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
            //-------- @assignmentInstructionForGeneration
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            //-------- @assignmentInstructionForGeneration
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25921.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
          }else if (kBoolFalse == test_1) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_bool var_isLABELorORG = callCategoryReader_isLABELorORG ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25921.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)) ;
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_2 = var_isLABELorORG.operator_not (SOURCE_FILE_AT_LINE (605)).operator_and (callCategoryReader_isNULL ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25921.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)).operator_not (SOURCE_FILE_AT_LINE (605)) COMMA_SOURCE_FILE_AT_LINE (605)).boolEnum () ;
            if (kBoolTrue == test_2) {
              //-------- @concatInstructionForGeneration
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_25915.reader_string (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)).operator_concat (GALGAS_string (": unreachable instruction is deleted\n") COMMA_SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)) ;
              { //-------- @modifierCallInstructionForGeneration
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (607)), index_25915, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
              } //-------- END @typeMethodInstructionForGeneration
          ...
          index_25915.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
        }
        //-------- @ifInstructionForGeneration
        ...
        if (kBoolTrue == test_4) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_26947 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_26947.hasCurrentObject ()) {
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_setCurrentAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_26947.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (620)) ;
            //-------- END @methodCallInstructionForGeneration
