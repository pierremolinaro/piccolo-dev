...
void routine_findMidRangeFirstInstructionOrLabelFromAddress (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_found ;
  var_cas_found = GGS_bool (true, false) ;
  GGS_uint _variant_3054 = var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (66)) ;
  GGS_bool _condition_3054 (_variant_3054._isBuilt (), true) ;
  while (_condition_3054.isBuiltAndTrue ()) {
    _condition_3054 = ((var_cas_currentAddress)._operator_strictInf (var_cas_inGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (67))))._operator_and ((var_cas_found)._operator_not ()) ;
    if (_condition_3054.isBuiltAndTrue ()) {
      if (_variant_3054.uintValue () == 0) {
        ...
        _condition_3054 = GGS_bool (true, false) ;
      }else{
        _variant_3054._decrement_operation (_inLexique COMMA_HERE) ;
        { const GGS_midrange_ipic_instruction _var_3041 = var_cas_inGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (69)) ; // CAST instruction
          if (_var_3041.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_midrange_ipic_actualInstruction *> (_var_3041.getPtr ()) != NULL) {
              ...
              var_cas_outFirstInstruction = var_cas_instr ;
              var_cas_outReachedLabelSet._addAssign_operation (var_cas_instr.reader_mLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (78))) ;
              var_cas_currentAddress._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
            }else{
              var_cas_currentAddress._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
            }
          }
        }
      }
...
category_method__midrange_ipic_JUMP__optimizeJUMP (C_Compiler & _inLexique,
  ...
  if (operand_3512 != NULL) {
    ...
    ::routine_findMidRangeFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (101)),  var_cas_ioGeneratedInstructionList,  automatic_var_0,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (101)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (_inLexique, operand_3512->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (104)) ;
      var_cas_ioListFileContents.writeString ("  line ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (105))) ;
      ...
      if (_temp_4310._isBuilt ()) {
        _temp_4310 (HERE)->method_searchKey (_inLexique, operand_3512->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (108)) ;
      }
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (111)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (111)) ;
      { const GGS_midrange_ipic_instruction _var_5951 = var_cas_firstInstruction ; // CAST instruction
        if (_var_5951.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_5951.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_3512->mInstructionLocation COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (115)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (120))) ;
            ...
            if (((var_cas_literalOp.reader_mLiteralInstruction (_inLexique COMMA_SOURCE_FILE_AT_LINE (122)))._operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_literalOp, var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (123)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (128))) ;
            ...
            if (((operand_3512->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (131)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_JUMP ::constructor_new (_inLexique, operand_3512->mInstructionLocation, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (133)), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (132)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
...
category_method__midrange_ipic_GOTO__optimizeGOTO (C_Compiler & _inLexique,
  ...
  if (operand_6109 != NULL) {
    ...
    ::routine_findMidRangeFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (155)),  var_cas_ioGeneratedInstructionList,  automatic_var_1,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (155)) ;
    if ((var_cas_reachedLabelSet.reader_hasKey (_inLexique, operand_6109->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (158)) ;
      var_cas_ioListFileContents.writeString ("  line ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (159))) ;
      ...
      if (_temp_6907._isBuilt ()) {
        _temp_6907 (HERE)->method_searchKey (_inLexique, operand_6109->mTargetLabel, var_cas_line COMMA_SOURCE_FILE_AT_LINE (162)) ;
      }
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (165)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (165)) ;
      { const GGS_midrange_ipic_instruction _var_8980 = var_cas_firstInstruction ; // CAST instruction
        if (_var_8980.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_8980.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_instruction_RETURN ::constructor_new (_inLexique, operand_6109->mInstructionLocation COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (169)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
            ...
            if (((var_cas_literalOp.reader_mLiteralInstruction (_inLexique COMMA_SOURCE_FILE_AT_LINE (176)))._operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_RETLW (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_literalOp, var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (177)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (182))) ;
            ...
            if (((operand_6109->mTargetLabel)._operator_isNotEqual (var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_JUMP ::constructor_new (_inLexique, operand_6109->mInstructionLocation, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE), GGS_midrange_call_goto_bit::constructor_noChange (_inLexique COMMA_HERE) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (186)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
            ...
            if (((operand_6109->mTargetLabel)._operator_isNotEqual (var_cas_goto.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))).isBuiltAndTrue ()) {
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_GOTO ::constructor_new (_inLexique, operand_6109->mInstructionLocation, var_cas_goto.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)) COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (195)) ;
              var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
              var_cas_ioListFileContents.writeString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))) ;
              var_cas_ioListFileContents.writeString (": GOTO branching to JUMP replaced by JUMP\n") ;
            }
          }else{
          }
...
category_method__midrange_ipic_instruction_literalOperation__optimizeMOVLW (C_Compiler & _inLexique,
  ...
  if (operand_10087 != NULL) {
    if (((operand_10087->mLiteralInstruction)._operator_isEqual (GGS_midrange_literal_instruction_opcode::constructor_MOVLW (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
      ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (242)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (242)) ;
      { const GGS_midrange_ipic_instruction _var_11037 = var_cas_firstInstruction ; // CAST instruction
        if (_var_11037.getPtr () != NULL) {
          ...
          if (typeid (cPtr_midrange_ipic_instruction_RETURN) == typeid (* (_var_11037.getPtr ()))) {
            var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_instruction_literalOperation ::constructor_new (_inLexique, operand_10087->mInstructionLocation, GGS_midrange_literal_instruction_opcode::constructor_RETLW (_inLexique COMMA_HERE), operand_10087->mLiteralValue COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (246)) ;
            var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
            var_cas_ioListFileContents.writeString ("  line ") ;
            var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (251))) ;
...
category_method__midrange_ipic_incDecRegisterInCondition__optimizeTestDecInc (C_Compiler & _inLexique,
  ...
  if (operand_11216 != NULL) {
    ...
    if (_temp_11494._isBuilt ()) {
      _temp_11494 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_11216->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_line COMMA_SOURCE_FILE_AT_LINE (267)) ;
    }
    GGS_midrange_ipic_instruction  var_cas_firstInstruction ;
    ::routine_findMidRangeFirstInstructionFromAddress (_inLexique,  var_cas_line._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (270)),  var_cas_ioGeneratedInstructionList,  var_cas_firstInstruction COMMA_SOURCE_FILE_AT_LINE (270)) ;
    { const GGS_midrange_ipic_instruction _var_12776 = var_cas_firstInstruction ; // CAST instruction
      if (_var_12776.getPtr () != NULL) {
        ...
        if (typeid (cPtr_midrange_ipic_JUMP) == typeid (* (_var_12776.getPtr ()))) {
          ...
          var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_incDecRegisterInCondition ::constructor_new (_inLexique, operand_11216->mInstructionLocation, operand_11216->mRegisterDescription, var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (278)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (278)), operand_11216->mIncrement, operand_11216->m_W_isDestination, operand_11216->mBranchIfZero COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (274)) ;
          var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
          var_cas_ioListFileContents.writeString ("  line ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (286))) ;
          ...
          var_cas_ioListFileContents._dotAssign_operation (operand_11216->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (293))) ;
...
category_method__midrange_ipic_instruction_BitTestSkip__optimizeBitTestSkip (C_Compiler & _inLexique,
  ...
  if (operand_12943 != NULL) {
    ...
    { const GGS_midrange_ipic_instruction _var_13392 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (318)) COMMA_SOURCE_FILE_AT_LINE (318)) ; // CAST instruction
      if (_var_13392.getPtr () != NULL) {
        ...
        if (typeid (cPtr_midrange_ipic_JUMP) == typeid (* (_var_13392.getPtr ()))) {
          ...
          var_cas_jumpLabel = var_cas_jump.reader_mTargetLabel (_inLexique COMMA_SOURCE_FILE_AT_LINE (320)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (320)) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      { const GGS_midrange_ipic_instruction _var_13748 = var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (326)) COMMA_SOURCE_FILE_AT_LINE (326)) ; // CAST instruction
        if (_var_13748.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_midrange_ipic_actualInstruction *> (_var_13748.getPtr ()) != NULL) {
            ...
            if (_temp_13652._isBuilt ()) {
              _temp_13652 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (328)) ;
            }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      ::routine_findMidRangeFirstInstructionOrLabelFromAddress (_inLexique,  var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (338)),  var_cas_ioGeneratedInstructionList,  automatic_var_2,  var_cas_reachedLabelSet COMMA_SOURCE_FILE_AT_LINE (338)) ;
      var_cas_ok = var_cas_reachedLabelSet.reader_hasKey (_inLexique, var_cas_jumpLabel COMMA_SOURCE_FILE_AT_LINE (339)) ;
    }
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_instruction_BitTestSkip ::constructor_new (_inLexique, operand_12943->mInstructionLocation, (operand_12943->mSkipIfSet)._operator_not (), operand_12943->mRegisterDescription, operand_12943->mBitNumber COMMA_HERE), var_cas_inLineIndex COMMA_SOURCE_FILE_AT_LINE (344)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_ioGeneratedInstructionList.reader_mInstructionAtIndex (_inLexique, var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
      var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      var_cas_ioOptimizationsDone = GGS_bool (true, true) ;
      var_cas_ioListFileContents.writeString ("  lines ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (366))) ;
      var_cas_ioListFileContents.writeString (" to ") ;
      var_cas_ioListFileContents._dotAssign_operation (var_cas_inLineIndex._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (366)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (366))) ;
...
void routine_perform_midrange_optimizations (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (382))) ;
  var_cas_ioListFileContents.writeString ("\n") ;
  var_cas_ioListFileContents.writeString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (383))) ;
  var_cas_ioListFileContents.writeString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (384))) ;
  var_cas_ioListFileContents.writeString ("\n"
    "\n") ;
  ...
  var_cas_symbolTable = GGS_symbolTableForOptimizations ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_16104 = enumerator_16104.nextObject ()))) {
      ...
      if (_temp_16147._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_16147 (HERE), var_cas_symbolTable, var_cas_lineIndex COMMA_SOURCE_FILE_AT_LINE (388)) ;
        }
      }
  ...
  GGS_uint _variant_19857 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (393)) ;
  GGS_bool _condition_19857 (_variant_19857._isBuilt (), true) ;
  while (_condition_19857.isBuiltAndTrue ()) {
    ...
    if (_condition_19857.isBuiltAndTrue ()) {
      if (_variant_19857.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (461)) ;
        _condition_19857 = GGS_bool (true, false) ;
      }else{
        _variant_19857._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_optimizationsDone = GGS_bool (true, false) ;
        var_cas_iteration._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (397)) ;
        var_cas_ioListFileContents.writeString ("Pass ") ;
        var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (398))) ;
        var_cas_ioListFileContents.writeString (":\n") ;
        {
              ...
              if (_var_17707.getPtr () != NULL) {
                ...
                if (typeid (cPtr_midrange_ipic_GOTO) == typeid (* (_var_17707.getPtr ()))) {
                  ...
                  if (_temp_16680._isBuilt ()) {
                    ...
                    if (_method != NULL) {
                      _method (_inLexique, _temp_16680 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (403)) ;
                    }
                  }
                  ...
                  if (_temp_16850._isBuilt ()) {
                    ...
                    if (_method != NULL) {
                      _method (_inLexique, _temp_16850 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (405)) ;
                    }
                  }
                  ...
                  if (_temp_17210._isBuilt ()) {
                    ...
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17210 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (409)) ;
                    }
                  }
                  ...
                  if (_temp_17398._isBuilt ()) {
                    ...
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17398 (HERE), var_cas_symbolTable, var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (411)) ;
                    }
                  }
                  ...
                  if (_temp_17608._isBuilt ()) {
                    ...
                    if (_method != NULL) {
                      _method (_inLexique, _temp_17608 (HERE), var_cas_idx, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_optimizationsDone COMMA_SOURCE_FILE_AT_LINE (413)) ;
                    }
                  }
                }else{
                }
        ...
        var_cas_referencedLabels = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_17852 = enumerator_17852.nextObject ()))) {
            ...
            if (_temp_17896._isBuilt ()) {
              _temp_17896 (HERE)->method_enterReferencedLabel (_inLexique, var_cas_referencedLabels COMMA_SOURCE_FILE_AT_LINE (420)) ;
            }
          }
        }
        {
          ...
          while (((operand_17960 = enumerator_17960.nextObject ()))) {
            ...
            if (((var_cas_referencedLabels.reader_hasKey (_inLexique, operand_17960->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)))._operator_not ()).isBuiltAndTrue ()) {
              GGS_uint  var_cas_definitionLine ;
              const GGS_symbolTableForOptimizations  _temp_18075 = var_cas_symbolTable ;
              if (_temp_18075._isBuilt ()) {
                _temp_18075 (HERE)->method_searchKey (_inLexique, operand_17960->mKey, var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (424)) ;
              }
              var_cas_ioListFileContents.writeString ("  line ") ;
              var_cas_ioListFileContents._dotAssign_operation (var_cas_definitionLine.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (425))) ;
              var_cas_ioListFileContents.writeString (": unreferenced label '") ;
              var_cas_ioListFileContents._dotAssign_operation (operand_17960->mKey) ;
              var_cas_ioListFileContents.writeString ("' is deleted\n") ;
              var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_definitionLine COMMA_SOURCE_FILE_AT_LINE (426)) ;
              GGS_uint  automatic_var_3 ;
              var_cas_symbolTable.modifier_removeKey (_inLexique, operand_17960->mKey, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (427)) ;
            }
          }
        }
        ...
        var_cas_previousWasSkippingInstruction = GGS_bool (true, false) ;
        {
          ...
          while (((operand_18595 = enumerator_18595.nextObject ()))) {
            ...
            if (((var_cas_reachable)._operator_or (var_cas_previousWasSkippingInstruction)).isBuiltAndTrue ()) {
              ...
              if (_temp_18711._isBuilt ()) {
                _temp_18711 (HERE)->method_nextInstructionIsReachable (_inLexique, var_cas_reachable COMMA_SOURCE_FILE_AT_LINE (436)) ;
              }
              ...
              if (_temp_18835._isBuilt ()) {
                _temp_18835 (HERE)->method_isSkippingInstruction (_inLexique, var_cas_skippingInstruction COMMA_SOURCE_FILE_AT_LINE (438)) ;
              }
            }else{
              GGS_bool var_cas_isLABELorORG ;
              const GGS_midrange_ipic_instruction  _temp_18928 = operand_18595->mInstruction ;
              if (_temp_18928._isBuilt ()) {
                _temp_18928 (HERE)->method_isLABELorORG (_inLexique, var_cas_isLABELorORG COMMA_SOURCE_FILE_AT_LINE (440)) ;
              }
              GGS_bool var_cas_isNULL ;
              const GGS_midrange_ipic_instruction  _temp_18990 = operand_18595->mInstruction ;
              if (_temp_18990._isBuilt ()) {
                _temp_18990 (HERE)->method_isNULL (_inLexique, var_cas_isNULL COMMA_SOURCE_FILE_AT_LINE (441)) ;
              }
              if ((((var_cas_isLABELorORG)._operator_not ())._operator_and ((var_cas_isNULL)._operator_not ())).isBuiltAndTrue ()) {
                var_cas_ioListFileContents.writeString ("  line ") ;
                var_cas_ioListFileContents._dotAssign_operation (var_cas_idx.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (443))) ;
                var_cas_ioListFileContents.writeString (": unreachable instruction is deleted\n") ;
                var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, GGS_midrange_ipic_NULL ::constructor_new (_inLexique COMMA_HERE), var_cas_idx COMMA_SOURCE_FILE_AT_LINE (444)) ;
          ...
          var_cas_currentAddress = GGS_uint (true, 0U) ;
          {
            ...
            while (((operand_19655 = enumerator_19655.nextObject ()))) {
              ...
              if (_temp_19698._isBuilt ()) {
                _temp_19698 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (457)) ;
              }
            }
          }
          var_cas_ioListFileContents.writeString ("Minimum code size: ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (459))) ;
