...
void routine_findMidRangeFirstInstructionFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (175)).isValid ()) {
    uint32_t variant_7473 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (175)).uintValue () ;
    bool loop_7473 = true ;
    while (loop_7473) {
...
void routine_findMidRangeFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).isValid ()) {
    uint32_t variant_8448 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).uintValue () ;
    bool loop_8448 = true ;
    while (loop_8448) {
...
void routine_perform_5F_midrange_5F_optimizations (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (546)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (546)) COMMA_SOURCE_FILE_AT_LINE (546)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("CODE OPTIMIZATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (547)) COMMA_SOURCE_FILE_AT_LINE (547)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (547)) COMMA_SOURCE_FILE_AT_LINE (547)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (548)).operator_concat (GALGAS_string ("\n"
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).isValid ()) {
    uint32_t variant_23550 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).uintValue () ;
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_optimizeJUMP (const cPtr_midrange_5F_intermediate_5F_JUMP * inObject,
  ...
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (237)), ioArgument_ioGeneratedInstructionList, joker_9941_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (237)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    routine_findMidRangeFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (247)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (247)) ;
    }
...
static void categoryMethod_midrange_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_midrange_5F_intermediate_5F_GOTO * inObject,
  ...
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (292)), ioArgument_ioGeneratedInstructionList, joker_12659_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_midrange_5F_intermediate_5F_instruction var_firstInstruction ;
    {
    routine_findMidRangeFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (302)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (302)) ;
    }
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_RETURN) {
        {
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_literalOperation_optimizeMOVLW (const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_midrange_5F_intermediate_5F_instruction var_firstInstruction ;
    {
    routine_findMidRangeFirstInstructionFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (380)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
    }
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_RETURN) {
        {
...
static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_optimizeTestDecInc (const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition * inObject,
  ...
  GALGAS_midrange_5F_intermediate_5F_instruction var_firstInstruction ;
  {
  routine_findMidRangeFirstInstructionFromAddress (var_line.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (409)), ioArgument_ioGeneratedInstructionList, var_firstInstruction, inCompiler COMMA_SOURCE_FILE_AT_LINE (409)) ;
  }
  if (var_firstInstruction.isValid ()) {
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_optimizeBitTestSkip (const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip * inObject,
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)).isValid ()) {
    if (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
      GALGAS_midrange_5F_intermediate_5F_JUMP cast_20792_jump ((cPtr_midrange_5F_intermediate_5F_JUMP *) ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)).ptr ()) ;
  ...
  if (kBoolTrue == test_0) {
    if (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_midrange_5F_intermediate_5F_actualInstruction *> (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).ptr ())) {
        GALGAS_midrange_5F_intermediate_5F_actualInstruction cast_21072_instruction ((cPtr_midrange_5F_intermediate_5F_actualInstruction *) ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).ptr ()) ;
        var_ok = GALGAS_bool (kIsEqual, callCategoryReader_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) cast_21072_instruction.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (498)).objectCompare (GALGAS_uint ((uint32_t) 1U))) ;
      }else{
  ...
  if (kBoolTrue == test_1) {
    ...
    routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((uint32_t) 3U), inCompiler COMMA_SOURCE_FILE_AT_LINE (507)), ioArgument_ioGeneratedInstructionList, joker_21456_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (507)) ;
    }
