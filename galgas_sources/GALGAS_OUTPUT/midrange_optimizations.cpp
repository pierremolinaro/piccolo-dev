...
void routine_findMidRangeFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).isValid ()) {
    PMUInt32 variant_8450 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).uintValue () ;
    bool loop_8450 = true ;
    while (loop_8450) {
      loop_8450 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (203)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)).isValid () ;
      if (loop_8450) {
        loop_8450 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (203)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)).boolValue () ;
      }
      if (loop_8450 && (0 == variant_8450)) {
        loop_8450 = false ;
...
void routine_perform_5F_midrange_5F_optimizations (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23337 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
  GALGAS_uint index_23331 ((PMUInt32) 0) ;
  while (enumerator_23337.hasCurrentObject ()) {
    callCategoryMethod_defineLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23337.current_mInstruction (HERE).ptr (), var_symbolTable, index_23331, inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
    enumerator_23337.gotoNextObject () ;
    index_23331.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
  }
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).isValid ()) {
    PMUInt32 variant_23552 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).uintValue () ;
    bool loop_23552 = true ;
    while (loop_23552) {
      loop_23552 = var_optimizationsDone.isValid () ;
      if (loop_23552) {
        loop_23552 = var_optimizationsDone.boolValue () ;
      }
      if (loop_23552 && (0 == variant_23552)) {
        loop_23552 = false ;
      ...
      if (loop_23552) {
        ...
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23806 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        GALGAS_uint index_23800 ((PMUInt32) 0) ;
        while (enumerator_23806.hasCurrentObject ()) {
          if (enumerator_23806.current_mInstruction (HERE).isValid ()) {
            if (enumerator_23806.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_GOTO) {
              GALGAS_midrange_5F_intermediate_5F_GOTO cast_23889_ipic_GOTO ((cPtr_midrange_5F_intermediate_5F_GOTO *) enumerator_23806.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeGOTO ((const cPtr_midrange_5F_intermediate_5F_GOTO *) cast_23889_ipic_GOTO.ptr (), var_symbolTable, index_23800, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
            }else if (enumerator_23806.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
              GALGAS_midrange_5F_intermediate_5F_JUMP cast_24066_ipic_JUMP ((cPtr_midrange_5F_intermediate_5F_JUMP *) enumerator_23806.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeJUMP ((const cPtr_midrange_5F_intermediate_5F_JUMP *) cast_24066_ipic_JUMP.ptr (), var_symbolTable, index_23800, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (569)) ;
            }else if (enumerator_23806.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation) {
              GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation cast_24436_ipic_literal ((cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) enumerator_23806.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeMOVLW ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) cast_24436_ipic_literal.ptr (), index_23800, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
            }else if (enumerator_23806.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition) {
              GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition cast_24627_ipic_decInc ((cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition *) enumerator_23806.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeTestDecInc ((const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition *) cast_24627_ipic_decInc.ptr (), var_symbolTable, index_23800, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (575)) ;
            }else if (enumerator_23806.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip) {
              GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip cast_24838_ipic_bitTestSkip ((cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) enumerator_23806.current_mInstruction (HERE).ptr ()) ;
              callCategoryMethod_optimizeBitTestSkip ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) cast_24838_ipic_bitTestSkip.ptr (), index_23800, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (577)) ;
            }
          }
          enumerator_23806.gotoNextObject () ;
          index_23800.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
        }
        GALGAS_stringset var_referencedLabels = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (582)) ;
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_25133 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        while (enumerator_25133.hasCurrentObject ()) {
          callCategoryMethod_enterReferencedLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25133.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
          enumerator_25133.gotoNextObject () ;
        }
        cEnumerator_symbolTableForOptimizations enumerator_25241 (var_symbolTable, kEnumeration_up) ;
        while (enumerator_25241.hasCurrentObject ()) {
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_25241.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (587)) COMMA_SOURCE_FILE_AT_LINE (587)).operator_not (SOURCE_FILE_AT_LINE (587)).boolEnum () ;
          if (kBoolTrue == test_0) {
            GALGAS_uint var_definitionLine ;
            GALGAS_bool joker_25362_0 ; // Joker input parameter
            var_symbolTable.method_searchKey (enumerator_25241.current_lkey (HERE), var_definitionLine, joker_25362_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string (": unreferenced label '") COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (enumerator_25241.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string ("' is deleted\n") COMMA_SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)) ;
            {
            ...
            {
            GALGAS_uint joker_25644_0 ; // Joker input parameter
            GALGAS_bool joker_25647_0 ; // Joker input parameter
            var_symbolTable.modifier_removeKey (enumerator_25241.current_lkey (HERE), joker_25644_0, joker_25647_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
            }
          }
        ...
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_25880 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        GALGAS_uint index_25874 ((PMUInt32) 0) ;
        while (enumerator_25880.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_1) {
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25880.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25880.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
          }else if (kBoolFalse == test_1) {
            GALGAS_bool var_isLABELorORG = callCategoryReader_isLABELorORG ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25880.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)) ;
            const enumGalgasBool test_2 = var_isLABELorORG.operator_not (SOURCE_FILE_AT_LINE (605)).operator_and (callCategoryReader_isNULL ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25880.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)).operator_not (SOURCE_FILE_AT_LINE (605)) COMMA_SOURCE_FILE_AT_LINE (605)).boolEnum () ;
            if (kBoolTrue == test_2) {
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_25874.reader_string (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)).operator_concat (GALGAS_string (": unreachable instruction is deleted\n") COMMA_SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)) ;
              {
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (607)), index_25874, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
              }
          ...
          index_25874.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
        }
        ...
        if (kBoolTrue == test_4) {
          ...
          cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_26906 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
          while (enumerator_26906.hasCurrentObject ()) {
            callCategoryMethod_setCurrentAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_26906.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (620)) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_optimizeJUMP (const cPtr_midrange_5F_intermediate_5F_JUMP * inObject,
  ...
  {
  GALGAS_midrange_5F_intermediate_5F_instruction joker_9942_0 ; // Joker input parameter
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (237)), ioArgument_ioGeneratedInstructionList, joker_9942_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (237)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_10399_0 ; // Joker input parameter
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, joker_10399_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (244)) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_midrange_5F_intermediate_5F_GOTO * inObject,
  ...
  GALGAS_stringset var_reachedLabelSet ;
  {
  GALGAS_midrange_5F_intermediate_5F_instruction joker_12660_0 ; // Joker input parameter
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (292)), ioArgument_ioGeneratedInstructionList, joker_12660_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_uint var_line ;
    GALGAS_bool joker_13117_0 ; // Joker input parameter
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, joker_13117_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) ;
    GALGAS_midrange_5F_intermediate_5F_instruction var_firstInstruction ;
    {
...
static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_optimizeTestDecInc (const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition * inObject,
  ...
  macroValidSharedObject (object, const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition) ;
  GALGAS_uint var_line ;
  GALGAS_bool joker_17966_0 ; // Joker input parameter
  constinArgument_inSymbolTable.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mTargetLabel, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (406)), var_line, joker_17966_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (406)) ;
  GALGAS_midrange_5F_intermediate_5F_instruction var_firstInstruction ;
  {
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_optimizeBitTestSkip (const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    GALGAS_stringset var_reachedLabelSet ;
    {
    GALGAS_midrange_5F_intermediate_5F_instruction joker_21457_0 ; // Joker input parameter
    routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 3U), inCompiler COMMA_SOURCE_FILE_AT_LINE (507)), ioArgument_ioGeneratedInstructionList, joker_21457_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (507)) ;
    }
