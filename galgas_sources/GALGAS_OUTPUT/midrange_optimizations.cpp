...
void routine_findMidRangeFirstInstructionFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (175)).isValid ()) {
    PMUInt32 variant_7461 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (175)).uintValue () ;
    bool loop_7461 = true ;
    while (loop_7461) {
      loop_7461 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (176)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)).isValid () ;
      if (loop_7461) {
        loop_7461 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (176)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)).boolValue () ;
      }
      if (loop_7461 && (0 == variant_7461)) {
        loop_7461 = false ;
      ...
      if (loop_7461) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_midrange_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)).ptr ())) {
            GALGAS_midrange_5F_intermediate_5F_actualInstruction cast_7712_instr ((cPtr_midrange_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_7712_instr ;
            //-------- @assignmentInstructionForGeneration
...
void routine_findMidRangeFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).isValid ()) {
    PMUInt32 variant_8439 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).uintValue () ;
    bool loop_8439 = true ;
    while (loop_8439) {
      loop_8439 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (203)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)).isValid () ;
      if (loop_8439) {
        loop_8439 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (203)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)).boolValue () ;
      }
      ...
      if (loop_8439) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_midrange_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ())) {
            GALGAS_midrange_5F_intermediate_5F_actualInstruction cast_8690_instr ((cPtr_midrange_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_8690_instr ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (true) ;
            ...
            GALGAS_midrange_5F_intermediate_5F_pseudo_5F_ORG cast_8804_instr ((cPtr_midrange_5F_intermediate_5F_pseudo_5F_ORG *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_8804_instr ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (true) ;
            ...
            GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL cast_8920_instr ((cPtr_midrange_5F_intermediate_5F_pseudo_5F_LABEL *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ()) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outFirstInstruction = cast_8920_instr ;
            //-------- @plusEqualnstructionForGeneration
            outArgument_outReachedLabelSet.addAssign_operation (cast_8920_instr.reader_mLabel (SOURCE_FILE_AT_LINE (214)).reader_string (SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)) ;
            //-------- @incrementInstructionForGeneration
...
void routine_perform_5F_midrange_5F_optimizations (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23367 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  GALGAS_uint index_23361 ((PMUInt32) 0) ;
  while (enumerator_23367.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_defineLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23367.current_mInstruction (HERE).ptr (), var_symbolTable, index_23361, inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_23367.gotoNextObject () ;
    index_23361.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).isValid ()) {
    PMUInt32 variant_23582 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).uintValue () ;
    bool loop_23582 = true ;
    while (loop_23582) {
      loop_23582 = var_optimizationsDone.isValid () ;
      if (loop_23582) {
        loop_23582 = var_optimizationsDone.boolValue () ;
      }
      if (loop_23582 && (0 == variant_23582)) {
        loop_23582 = false ;
      ...
      if (loop_23582) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_23836 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_23830 ((PMUInt32) 0) ;
        while (enumerator_23836.hasCurrentObject ()) {
          //-------- @structuredCastInstructionForGeneration
          if (enumerator_23836.current_mInstruction (HERE).isValid ()) {
            if (enumerator_23836.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_GOTO) {
              GALGAS_midrange_5F_intermediate_5F_GOTO cast_23921_ipic_GOTO ((cPtr_midrange_5F_intermediate_5F_GOTO *) enumerator_23836.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeGOTO ((const cPtr_midrange_5F_intermediate_5F_GOTO *) cast_23921_ipic_GOTO.ptr (), var_symbolTable, index_23830, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23836.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
              GALGAS_midrange_5F_intermediate_5F_JUMP cast_24099_ipic_JUMP ((cPtr_midrange_5F_intermediate_5F_JUMP *) enumerator_23836.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeJUMP ((const cPtr_midrange_5F_intermediate_5F_JUMP *) cast_24099_ipic_JUMP.ptr (), var_symbolTable, index_23830, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (569)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23836.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation) {
              GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation cast_24471_ipic_literal ((cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) enumerator_23836.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeMOVLW ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) cast_24471_ipic_literal.ptr (), index_23830, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23836.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition) {
              GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition cast_24663_ipic_decInc ((cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition *) enumerator_23836.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeTestDecInc ((const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition *) cast_24663_ipic_decInc.ptr (), var_symbolTable, index_23830, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (575)) ;
              //-------- END @methodCallInstructionForGeneration
            }else if (enumerator_23836.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip) {
              GALGAS_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip cast_24875_ipic_bitTestSkip ((cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) enumerator_23836.current_mInstruction (HERE).ptr ()) ;
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_optimizeBitTestSkip ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) cast_24875_ipic_bitTestSkip.ptr (), index_23830, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (577)) ;
              //-------- END @methodCallInstructionForGeneration
            }
          }
          enumerator_23836.gotoNextObject () ;
          index_23830.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
        }
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_stringset var_referencedLabels = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (582)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_25171 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_25171.hasCurrentObject ()) {
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_enterReferencedLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25171.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
          //-------- END @methodCallInstructionForGeneration
          enumerator_25171.gotoNextObject () ;
        }
        //-------- @foreachInstructionForGeneration
        cEnumerator_symbolTableForOptimizations enumerator_25279 (var_symbolTable, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_25279.hasCurrentObject ()) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_25279.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (587)) COMMA_SOURCE_FILE_AT_LINE (587)).operator_not (SOURCE_FILE_AT_LINE (587)).boolEnum () ;
          if (kBoolTrue == test_0) {
            //-------- @localVariableDeclarationForGeneration
            GALGAS_uint var_definitionLine ;
            //-------- @methodCallInstructionForGeneration
            var_symbolTable.method_searchKey (enumerator_25279.current_lkey (HERE), var_definitionLine, inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
            //-------- END @methodCallInstructionForGeneration
            //-------- @concatInstructionForGeneration
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string (": unreferenced label '") COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (enumerator_25279.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string ("' is deleted\n") COMMA_SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)) ;
            ...
            { //-------- @modifierCallInstructionForGeneration
            GALGAS_uint joker_25696_0 ; // Joker input parameter
            var_symbolTable.modifier_removeKey (enumerator_25279.current_lkey (HERE), joker_25696_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
            } //-------- END @typeMethodInstructionForGeneration
          }
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_25929 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
        //--- simple foreach instruction
        GALGAS_uint index_25923 ((PMUInt32) 0) ;
        while (enumerator_25929.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_1) {
            //-------- @assignmentInstructionForGeneration
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25929.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
            //-------- @assignmentInstructionForGeneration
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            //-------- @assignmentInstructionForGeneration
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25929.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
          }else if (kBoolFalse == test_1) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_bool var_isLABELorORG = callCategoryReader_isLABELorORG ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25929.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)) ;
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_2 = var_isLABELorORG.operator_not (SOURCE_FILE_AT_LINE (605)).operator_and (callCategoryReader_isNULL ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25929.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)).operator_not (SOURCE_FILE_AT_LINE (605)) COMMA_SOURCE_FILE_AT_LINE (605)).boolEnum () ;
            if (kBoolTrue == test_2) {
              //-------- @concatInstructionForGeneration
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_25923.reader_string (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)).operator_concat (GALGAS_string (": unreachable instruction is deleted\n") COMMA_SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)) ;
              { //-------- @modifierCallInstructionForGeneration
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (607)), index_25923, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
              } //-------- END @typeMethodInstructionForGeneration
          ...
          index_25923.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
        }
        //-------- @ifInstructionForGeneration
        ...
        if (kBoolTrue == test_4) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_midrange_5F_intermediate_5F_instructionList enumerator_26955 (ioArgument_ioGeneratedInstructionList, kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_26955.hasCurrentObject ()) {
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_setCurrentAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_26955.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (620)) ;
            //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_optimizeJUMP (const cPtr_midrange_5F_intermediate_5F_JUMP * inObject,
  ...
  GALGAS_midrange_5F_intermediate_5F_instruction joker_9936_0 ; // Joker input parameter
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (237)), ioArgument_ioGeneratedInstructionList, joker_9936_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (237)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_RETURN) {
        ...
        GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation cast_11129_literalOp ((cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_11129_literalOp.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (258)).objectCompare (GALGAS_midrange_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (258)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_11129_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (259)) ;
          } //-------- END @typeMethodInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          //-------- @concatInstructionForGeneration
        ...
        GALGAS_midrange_5F_intermediate_5F_JUMP cast_11556_jump ((cPtr_midrange_5F_intermediate_5F_JUMP *) var_firstInstruction.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_11556_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (267)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_11556_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (269)), GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (269)), GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
          } //-------- END @typeMethodInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          //-------- @concatInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_midrange_5F_intermediate_5F_GOTO * inObject,
  ...
  GALGAS_stringset var_reachedLabelSet ;
  { //-------- @routineCallInstructionForGeneration
  GALGAS_midrange_5F_intermediate_5F_instruction joker_12663_0 ; // Joker input parameter
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (292)), ioArgument_ioGeneratedInstructionList, joker_12663_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_RETURN) {
        ...
        GALGAS_midrange_5F_intermediate_5F_instruction_5F_literalOperation cast_13884_literalOp ((cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) var_firstInstruction.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_13884_literalOp.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (314)).objectCompare (GALGAS_midrange_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (314)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_13884_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)) ;
          } //-------- END @typeMethodInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          //-------- @concatInstructionForGeneration
        ...
        GALGAS_midrange_5F_intermediate_5F_JUMP cast_14311_jump ((cPtr_midrange_5F_intermediate_5F_JUMP *) var_firstInstruction.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_14311_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (323)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_14311_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (325)), GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (325)), GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (324)) ;
          } //-------- END @typeMethodInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          //-------- @concatInstructionForGeneration
        ...
        GALGAS_midrange_5F_intermediate_5F_GOTO cast_14831_goto ((cPtr_midrange_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_14831_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (332)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          { //-------- @modifierCallInstructionForGeneration
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, cast_14831_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (334)) COMMA_SOURCE_FILE_AT_LINE (334)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (333)) ;
          } //-------- END @typeMethodInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
          //-------- @concatInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_optimizeTestDecInc (const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition * inObject,
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
      GALGAS_midrange_5F_intermediate_5F_JUMP cast_18326_jump ((cPtr_midrange_5F_intermediate_5F_JUMP *) var_firstInstruction.ptr ()) ;
      { //-------- @modifierCallInstructionForGeneration
      ...
      GALGAS_midrange_5F_intermediate_5F_GOTO cast_19307_goto ((cPtr_midrange_5F_intermediate_5F_GOTO *) var_firstInstruction.ptr ()) ;
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mRegisterDescription, cast_19307_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (448)).reader_string (SOURCE_FILE_AT_LINE (448)), object->mAttribute_mIncrement, object->mAttribute_m_5F_W_5F_isDestination, object->mAttribute_mBranchIfZero COMMA_SOURCE_FILE_AT_LINE (445)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @assignmentInstructionForGeneration
      ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
      //-------- @concatInstructionForGeneration
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_optimizeBitTestSkip (const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_midrange_5F_intermediate_5F_actualInstruction *> (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).ptr ())) {
        GALGAS_midrange_5F_intermediate_5F_actualInstruction cast_21101_instruction ((cPtr_midrange_5F_intermediate_5F_actualInstruction *) ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).ptr ()) ;
        //-------- @assignmentInstructionForGeneration
        var_ok = GALGAS_bool (kIsEqual, callCategoryReader_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) cast_21101_instruction.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (498)).objectCompare (GALGAS_uint ((PMUInt32) 1U))) ;
      }else{
        //-------- @assignmentInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    ...
    GALGAS_stringset var_reachedLabelSet ;
    { //-------- @routineCallInstructionForGeneration
    GALGAS_midrange_5F_intermediate_5F_instruction joker_21487_0 ; // Joker input parameter
    routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 3U), inCompiler COMMA_SOURCE_FILE_AT_LINE (507)), ioArgument_ioGeneratedInstructionList, joker_21487_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (507)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
