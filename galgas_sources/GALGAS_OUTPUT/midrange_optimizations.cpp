...
void routine_findMidRangeFirstInstructionFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (175)).isValid ()) {
    PMUInt32 variant_7473 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (175)).uintValue () ;
    bool loop_7473 = true ;
    while (loop_7473) {
      loop_7473 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (176)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)).isValid () ;
      if (loop_7473) {
        loop_7473 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (176)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)).boolValue () ;
      }
      ...
      if (loop_7473) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_midrange_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)).ptr ())) {
            GALGAS_midrange_5F_intermediate_5F_actualInstruction cast_7724_instr ((cPtr_midrange_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)).ptr ()) ;
...
void routine_findMidRangeFirstInstructionOrLabelFromAddress (const GALGAS_uint constinArgument_inLineIndex,
  ...
  if (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).isValid ()) {
    PMUInt32 variant_8448 = constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (202)).uintValue () ;
    bool loop_8448 = true ;
    while (loop_8448) {
      loop_8448 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (203)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)).isValid () ;
      if (loop_8448) {
        loop_8448 = GALGAS_bool (kIsStrictInf, var_currentAddress.objectCompare (constinArgument_inGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (203)))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)).boolValue () ;
      }
      ...
      if (loop_8448) {
        ...
        if (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).isValid ()) {
          if (NULL != dynamic_cast <const cPtr_midrange_5F_intermediate_5F_actualInstruction *> (constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ())) {
            GALGAS_midrange_5F_intermediate_5F_actualInstruction cast_8699_instr ((cPtr_midrange_5F_intermediate_5F_actualInstruction *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ()) ;
            ...
            GALGAS_midrange_5F_intermediate_5F_pseudo_5F_ORG cast_8812_instr ((cPtr_midrange_5F_intermediate_5F_pseudo_5F_ORG *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ()) ;
            ...
            GALGAS_midrange_5F_intermediate_5F_pseudo_5F_LABEL cast_8927_instr ((cPtr_midrange_5F_intermediate_5F_pseudo_5F_LABEL *) constinArgument_inGeneratedInstructionList.reader_mInstructionAtIndex (var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)).ptr ()) ;
            outArgument_outFirstInstruction = cast_8927_instr ;
            outArgument_outReachedLabelSet.addAssign_operation (cast_8927_instr.reader_mLabel (SOURCE_FILE_AT_LINE (214)).reader_string (SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)) ;
...
void routine_perform_5F_midrange_5F_optimizations (GALGAS_midrange_5F_intermediate_5F_instructionList & ioArgument_ioGeneratedInstructionList,
  ...
  GALGAS_uint index_23304 ((PMUInt32) 0) ;
  while (enumerator_23331.hasCurrentObject ()) {
    callCategoryMethod_defineLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_23331.current_mInstruction (HERE).ptr (), var_symbolTable, index_23304, inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
    enumerator_23331.gotoNextObject () ;
    index_23304.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
  }
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).isValid ()) {
    PMUInt32 variant_23550 = ioArgument_ioGeneratedInstructionList.reader_length (SOURCE_FILE_AT_LINE (557)).uintValue () ;
    ...
    while (loop_23550) {
      ...
      if (loop_23550) {
        ...
        GALGAS_uint index_23773 ((PMUInt32) 0) ;
        while (enumerator_23800.hasCurrentObject ()) {
          if (enumerator_23800.current_mInstruction (HERE).isValid ()) {
            if (enumerator_23800.current_mInstruction (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_GOTO) {
              ...
              callCategoryMethod_optimizeGOTO ((const cPtr_midrange_5F_intermediate_5F_GOTO *) cast_23889_ipic_GOTO.ptr (), var_symbolTable, index_23773, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
              ...
              callCategoryMethod_optimizeJUMP ((const cPtr_midrange_5F_intermediate_5F_JUMP *) cast_24066_ipic_JUMP.ptr (), var_symbolTable, index_23773, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (569)) ;
              ...
              callCategoryMethod_optimizeMOVLW ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_literalOperation *) cast_24436_ipic_literal.ptr (), index_23773, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (573)) ;
              ...
              callCategoryMethod_optimizeTestDecInc ((const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition *) cast_24627_ipic_decInc.ptr (), var_symbolTable, index_23773, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (575)) ;
              ...
              callCategoryMethod_optimizeBitTestSkip ((const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip *) cast_24838_ipic_bitTestSkip.ptr (), index_23773, ioArgument_ioGeneratedInstructionList, ioArgument_ioListFileContents, var_optimizationsDone, inCompiler COMMA_SOURCE_FILE_AT_LINE (577)) ;
            }
          }
          enumerator_23800.gotoNextObject () ;
          index_23773.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
        }
        ...
        while (enumerator_25130.hasCurrentObject ()) {
          callCategoryMethod_enterReferencedLabel ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25130.current_mInstruction (HERE).ptr (), var_referencedLabels, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
        ...
        while (enumerator_25238.hasCurrentObject ()) {
          const enumGalgasBool test_0 = var_referencedLabels.reader_hasKey (enumerator_25238.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (587)) COMMA_SOURCE_FILE_AT_LINE (587)).operator_not (SOURCE_FILE_AT_LINE (587)).boolEnum () ;
          if (kBoolTrue == test_0) {
            GALGAS_uint var_definitionLine ;
            GALGAS_bool joker_25361_0 ; // Joker input parameter
            var_symbolTable.method_searchKey (enumerator_25238.current_lkey (HERE), var_definitionLine, joker_25361_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
            ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (var_definitionLine.reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string (": unreferenced label '") COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (enumerator_25238.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)).operator_concat (GALGAS_string ("' is deleted\n") COMMA_SOURCE_FILE_AT_LINE (589)) COMMA_SOURCE_FILE_AT_LINE (589)) ;
            {
            ...
            var_symbolTable.modifier_removeKey (enumerator_25238.current_lkey (HERE), joker_25643_0, joker_25646_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
            }
          }
        ...
        GALGAS_uint index_25847 ((PMUInt32) 0) ;
        while (enumerator_25874.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_1) {
            var_reachable = callCategoryReader_nextInstructionIsReachable ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25874.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
            var_previousWasSkippingInstruction = var_skippingInstruction ;
            var_skippingInstruction = callCategoryReader_isSkippingInstruction ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25874.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
          }else if (kBoolFalse == test_1) {
            GALGAS_bool var_isLABELorORG = callCategoryReader_isLABELorORG ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25874.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (604)) ;
            const enumGalgasBool test_2 = var_isLABELorORG.operator_not (SOURCE_FILE_AT_LINE (605)).operator_and (callCategoryReader_isNULL ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_25874.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)).operator_not (SOURCE_FILE_AT_LINE (605)) COMMA_SOURCE_FILE_AT_LINE (605)).boolEnum () ;
            if (kBoolTrue == test_2) {
              ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  line ").operator_concat (index_25847.reader_string (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)).operator_concat (GALGAS_string (": unreachable instruction is deleted\n") COMMA_SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)) ;
              {
              ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_NULL::constructor_new (SOURCE_FILE_AT_LINE (607)), index_25847, inCompiler COMMA_SOURCE_FILE_AT_LINE (607)) ;
              }
          ...
          index_25847.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
        }
        ...
        if (kBoolTrue == test_4) {
          ...
          while (enumerator_26903.hasCurrentObject ()) {
            callCategoryMethod_setCurrentAddress ((const cPtr_midrange_5F_intermediate_5F_instruction *) enumerator_26903.current_mInstruction (HERE).ptr (), var_currentAddress, inCompiler COMMA_SOURCE_FILE_AT_LINE (620)) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_JUMP_optimizeJUMP (const cPtr_midrange_5F_intermediate_5F_JUMP * inObject,
  ...
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (237)), ioArgument_ioGeneratedInstructionList, joker_9941_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (237)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, joker_10398_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (244)) ;
    ...
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_RETURN) {
        ...
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_11128_literalOp.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (258)).objectCompare (GALGAS_midrange_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (258)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_11128_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (259)) ;
          }
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_GOTO_optimizeGOTO (const cPtr_midrange_5F_intermediate_5F_GOTO * inObject,
  ...
  routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (292)), ioArgument_ioGeneratedInstructionList, joker_12659_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    constinArgument_inSymbolTable.method_searchKey (object->mAttribute_mTargetLabel, var_line, joker_13116_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) ;
    GALGAS_midrange_5F_intermediate_5F_instruction var_firstInstruction ;
    {
    ...
    if (var_firstInstruction.isValid ()) {
      if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_instruction_5F_RETURN) {
        ...
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, cast_13874_literalOp.reader_mLiteralInstruction (SOURCE_FILE_AT_LINE (314)).objectCompare (GALGAS_midrange_5F_literal_5F_instruction_5F_opcode::constructor_RETLW (SOURCE_FILE_AT_LINE (314)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (cast_13874_literalOp, constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)) ;
          }
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ...
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_14300_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (323)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_JUMP::constructor_new (object->mAttribute_mInstructionLocation, cast_14300_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (325)), GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (325)), GALGAS_midrange_5F_call_5F_goto_5F_bit::constructor_noChange (SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (324)) ;
          }
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
        ...
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, object->mAttribute_mTargetLabel.objectCompare (cast_14819_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (332)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
          ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_GOTO::constructor_new (object->mAttribute_mInstructionLocation, cast_14819_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (334)) COMMA_SOURCE_FILE_AT_LINE (334)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (333)) ;
          }
          ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_incDecRegisterInCondition_optimizeTestDecInc (const cPtr_midrange_5F_intermediate_5F_incDecRegisterInCondition * inObject,
  ...
  constinArgument_inSymbolTable.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mTargetLabel, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (406)), var_line, joker_17965_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (406)) ;
  GALGAS_midrange_5F_intermediate_5F_instruction var_firstInstruction ;
  {
  ...
  if (var_firstInstruction.isValid ()) {
    if (var_firstInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
      ...
      {
      ioArgument_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (GALGAS_midrange_5F_intermediate_5F_incDecRegisterInCondition::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mRegisterDescription, cast_19284_goto.reader_mTargetLabel (SOURCE_FILE_AT_LINE (448)).reader_string (SOURCE_FILE_AT_LINE (448)), object->mAttribute_mIncrement, object->mAttribute_m_5F_W_5F_isDestination, object->mAttribute_mBranchIfZero COMMA_SOURCE_FILE_AT_LINE (445)), constinArgument_inLineIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
      ioArgument_ioOptimizationsDone = GALGAS_bool (true) ;
...
static void categoryMethod_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip_optimizeBitTestSkip (const cPtr_midrange_5F_intermediate_5F_instruction_5F_BitTestSkip * inObject,
  ...
  if (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)).isValid ()) {
    if (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_midrange_5F_intermediate_5F_JUMP) {
      ...
      var_jumpLabel = cast_20792_jump.reader_mTargetLabel (SOURCE_FILE_AT_LINE (490)).reader_string (SOURCE_FILE_AT_LINE (490)) ;
  ...
  if (kBoolTrue == test_0) {
    if (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_midrange_5F_intermediate_5F_actualInstruction *> (ioArgument_ioGeneratedInstructionList.reader_mInstructionAtIndex (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)).ptr ())) {
        ...
        var_ok = GALGAS_bool (kIsEqual, callCategoryReader_instructionLength ((const cPtr_midrange_5F_intermediate_5F_actualInstruction *) cast_21072_instruction.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (498)).objectCompare (GALGAS_uint ((PMUInt32) 1U))) ;
      }else{
  ...
  if (kBoolTrue == test_1) {
    ...
    routine_findMidRangeFirstInstructionOrLabelFromAddress (constinArgument_inLineIndex.add_operation (GALGAS_uint ((PMUInt32) 3U), inCompiler COMMA_SOURCE_FILE_AT_LINE (507)), ioArgument_ioGeneratedInstructionList, joker_21456_0, var_reachedLabelSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (507)) ;
    }
