...
void cMapElement_midrange_5F_declaredRoutineMap::description (C_String & /* ioString */, const PMSInt32 /* inIndentation */) const {
}
...
void routine_midrange_5F_analyze (const GALGAS_midrange_5F_model constinArgument_inPiccoloModel,
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the program name ('").operator_concat (constinArgument_inPiccoloModel.reader_mProgramName (SOURCE_FILE_AT_LINE (30)).reader_string (SOURCE_FILE_AT_LINE (30)) COMMA_SOURCE_FILE_AT_LINE (30)).operator_concat (GALGAS_string ("') should be identical to the file base name '") COMMA_SOURCE_FILE_AT_LINE (31)).operator_concat (var_sourceFileBaseName COMMA_SOURCE_FILE_AT_LINE (31)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (31)) COMMA_SOURCE_FILE_AT_LINE (30)) ;
  }
  ...
  cEnumerator_midrange_5F_interruptDefinitionList enumerator_2303 (constinArgument_inPiccoloModel.reader_mInterruptDefinitionList (SOURCE_FILE_AT_LINE (44)), kEnumeration_up) ;
  while (enumerator_2303.hasCurrentObject ()) {
    const enumGalgasBool test_4 = var_hasInterrupt.boolEnum () ;
    if (kBoolTrue == test_4) {
      inCompiler->emitSemanticError (enumerator_2303.current_mInterruptLocation (HERE), GALGAS_string ("only one interrupt routine can be defined") COMMA_SOURCE_FILE_AT_LINE (46)) ;
    }
  ...
  cEnumerator_midrange_5F_routineDefinitionList enumerator_3995 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_3995.hasCurrentObject ()) {
    {
    var_declaredRoutineMap.modifier_insertKey (enumerator_3995.current_mRoutineName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (91)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_4224 (constinArgument_inPiccoloModel.mAttribute_mUnusedRoutineList, kEnumeration_up) ;
  while (enumerator_4224.hasCurrentObject ()) {
    const enumGalgasBool test_5 = var_declaredRoutineMap.reader_hasKey (enumerator_4224.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (96)).operator_not (SOURCE_FILE_AT_LINE (96)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_4224.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("the '").operator_concat (enumerator_4224.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (GALGAS_string ("' routine is not declared") COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)) ;
    }else if (kBoolFalse == test_5) {
      const enumGalgasBool test_7 = var_unusedRoutineDeclarationUnicity.reader_hasKey (enumerator_4224.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (98)).boolEnum () ;
      if (kBoolTrue == test_7) {
        GALGAS_location location_8 (enumerator_4224.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_8, GALGAS_string ("the '").operator_concat (enumerator_4224.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (GALGAS_string ("' routine is already declared as unused") COMMA_SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_9 = var_usedRoutineSet.reader_hasKey (enumerator_4224.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (100)).boolEnum () ;
        if (kBoolTrue == test_9) {
          GALGAS_location location_10 (enumerator_4224.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_10, GALGAS_string ("the '").operator_concat (enumerator_4224.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)).operator_concat (GALGAS_string ("' routine is declared as unused, but is used") COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)) ;
        }
      }
    }
    var_unusedRoutineDeclarationUnicity.addAssign_operation (enumerator_4224.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (103)) ;
    enumerator_4224.gotoNextObject () ;
  }
  cEnumerator_midrange_5F_declaredRoutineMap enumerator_4776 (var_declaredRoutineMap, kEnumeration_up) ;
  while (enumerator_4776.hasCurrentObject ()) {
    const enumGalgasBool test_11 = var_usedRoutineSet.reader_hasKey (enumerator_4776.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (106)).operator_not (SOURCE_FILE_AT_LINE (106)).operator_and (var_unusedRoutineDeclarationUnicity.reader_hasKey (enumerator_4776.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (106)).operator_not (SOURCE_FILE_AT_LINE (106)) COMMA_SOURCE_FILE_AT_LINE (106)).boolEnum () ;
    if (kBoolTrue == test_11) {
      GALGAS_location location_12 (enumerator_4776.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_12, GALGAS_string ("the '").operator_concat (enumerator_4776.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)).operator_concat (GALGAS_string ("' routine is unused") COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_5181 (constinArgument_inPiccoloModel.mAttribute_mUnusedRegisterList, kEnumeration_up) ;
  while (enumerator_5181.hasCurrentObject ()) {
    const enumGalgasBool test_13 = var_registerTable.reader_hasKey (enumerator_5181.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (113)).operator_not (SOURCE_FILE_AT_LINE (113)).boolEnum () ;
    if (kBoolTrue == test_13) {
      GALGAS_location location_14 (enumerator_5181.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_14, GALGAS_string ("the '").operator_concat (enumerator_5181.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).operator_concat (GALGAS_string ("' byte is not declared") COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)) ;
    }else if (kBoolFalse == test_13) {
      const enumGalgasBool test_15 = var_unusedByteDeclarationUnicity.reader_hasKey (enumerator_5181.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (115)).boolEnum () ;
      if (kBoolTrue == test_15) {
        GALGAS_location location_16 (enumerator_5181.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_16, GALGAS_string ("the '").operator_concat (enumerator_5181.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)).operator_concat (GALGAS_string ("' byte is already declared as unused") COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)) ;
      }else if (kBoolFalse == test_15) {
        const enumGalgasBool test_17 = var_usedRegisters.reader_hasKey (enumerator_5181.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (117)).boolEnum () ;
        if (kBoolTrue == test_17) {
          GALGAS_location location_18 (enumerator_5181.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_18, GALGAS_string ("the '").operator_concat (enumerator_5181.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)).operator_concat (GALGAS_string ("' byte is declared as unused, but is used") COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)) ;
        }
      }
    }
    var_unusedByteDeclarationUnicity.addAssign_operation (enumerator_5181.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (120)) ;
    enumerator_5181.gotoNextObject () ;
  }
  cEnumerator_declaredByteMap enumerator_5709 (var_declaredByteMap, kEnumeration_up) ;
  while (enumerator_5709.hasCurrentObject ()) {
    const enumGalgasBool test_19 = var_usedRegisters.reader_hasKey (enumerator_5709.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (123)).operator_not (SOURCE_FILE_AT_LINE (123)).operator_and (var_unusedByteDeclarationUnicity.reader_hasKey (enumerator_5709.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (123)).operator_not (SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).boolEnum () ;
    if (kBoolTrue == test_19) {
      GALGAS_location location_20 (enumerator_5709.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_20, GALGAS_string ("the '").operator_concat (enumerator_5709.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (GALGAS_string ("' byte is unused") COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)) ;
    }
    enumerator_5709.gotoNextObject () ;
  }
  const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (128)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (128)).boolEnum () ;
  ...
  const enumGalgasBool test_22 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (132)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  ...
  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (137)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_23) {
    ...
    GALGAS_bool joker_6998_0 ; // Joker input parameter
    var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_6998_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
    ...
    if (kBoolTrue == test_24) {
      ...
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_7368_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
      {
      ...
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_7569_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) ;
    }
    ...
    if (kBoolTrue == test_25) {
      ...
      var_verboseMessage.dotAssign_operation (var_usedROMsize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).divide_operation (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (166)).reader_uint (SOURCE_FILE_AT_LINE (166)), inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).reader_string (SOURCE_FILE_AT_LINE (166)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
      cEnumerator_ramBankTable enumerator_7974 (var_ramBank, kEnumeration_up) ;
      while (enumerator_7974.hasCurrentObject ()) {
        GALGAS_uint var_bankSize = enumerator_7974.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_7974.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
        GALGAS_uint var_usedSize = enumerator_7974.current_mFirstFreeAddress (HERE).substract_operation (enumerator_7974.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
        var_verboseMessage.dotAssign_operation (GALGAS_string ("  RAM bank '").operator_concat (enumerator_7974.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)).operator_concat (GALGAS_string ("': ") COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)) ;
        ...
        var_verboseMessage.dotAssign_operation (var_usedSize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (173)).divide_operation (var_bankSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (173)).reader_string (SOURCE_FILE_AT_LINE (173)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)) ;
    ...
    if (kBoolTrue == test_26) {
      ...
      GALGAS_bool joker_8989_0 ; // Joker input parameter
      var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_8989_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) ;
    }
  ...
  if (kBoolTrue == test_29) {
    ...
    GALGAS_bool joker_9727_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_9727_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
  }
}
