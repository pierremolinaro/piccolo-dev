...
void routine_midrange_5F_analyze (const GALGAS_midrange_5F_model constinArgument_inPiccoloModel,
  ...
  GALGAS_bool temp_54 (gOption_piccolo_5F_options_performOptimizations.mValue) ;
  ...
  //-------- @ifInstructionForGeneration
  //--- @optionValueExpressionForGeneration
  GALGAS_bool temp_59 (gOption_piccolo_5F_options_ouputListingFile.mValue) ;
  ...
  if (temp_65.isValidAndTrue ()) {
    ...
    //-------- @ifInstructionForGeneration
    //--- @optionValueExpressionForGeneration
    GALGAS_bool temp_73 (gOption_piccolo_5F_options_output_5F_C_5F_Array.mValue) ;
    ...
    //-------- @ifInstructionForGeneration
    //--- @optionValueExpressionForGeneration
    GALGAS_bool temp_82 (gOption_galgas_5F_cli_5F_options_verbose_5F_output.mValue) ;
    ...
    //-------- @ifInstructionForGeneration
    //--- @optionValueExpressionForGeneration
    GALGAS_bool temp_122 (gOption_piccolo_5F_options_generateAssembly.mValue) ;
