...
void routine_midrange_analyze (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3918 = ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (gOption_piccolo_5F_options_performOptimizations.value ()) ;
  if (cond_3918.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_4108 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_4108.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_4374 = gOption_piccolo_5F_options_ouputListingFile.value () ;
  if (cond_4374.isBuiltAndTrue ()) {
    GGS_string var_cas_listFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (86))).operator_concat (GGS_string (".list")) ;
  ...
  const GGS_bool cond_6438 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_6438.isBuiltAndTrue ()) {
    ...
    GGS_string var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (104))).operator_concat (GGS_string (".hex")) ;
    ...
    const GGS_bool cond_5847 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.value () ;
    if (cond_5847.isBuiltAndTrue ()) {
      ...
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        ...
        while (((operand_5395 = enumerator_5395.nextObject ()))) {
          ...
          GGS_uint  var_cas_bankSize = operand_5395->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_5395->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (112)) ;
          GGS_uint  var_cas_usedSize = operand_5395->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_5395->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (113)) ;
    ...
    const GGS_bool cond_6426 = gOption_piccolo_5F_options_generateAssembly.value () ;
    if (cond_6426.isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (132))).operator_concat (GGS_string (".asm")) ;
  ...
  }else if (cond_6438.isBuiltAndFalse ()) {
    GGS_string var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (136))).operator_concat (GGS_string (".hex")) ;
    const GGS_bool cond_6679 = var_cas_hexDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
    if (cond_6679.isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (138)) ;
    }
    GGS_string var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (140))).operator_concat (GGS_string (".asm")) ;
    const GGS_bool cond_6879 = var_cas_asmDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
    if (cond_6879.isBuiltAndTrue ()) {
