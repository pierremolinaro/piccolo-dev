...
//                    november 26th, 2009, at 17h19'39"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_midrange_analyze (C_Compiler & inLexique,
  ...
  if (cond_4386.isBuiltAndTrue ()) {
    ...
    if (temp_4364.isBuilt ()) {
      temp_4364 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (87)) ;
    }
  }
  ...
  if (cond_6462.isBuiltAndTrue ()) {
    ...
    if (temp_5001.isBuilt ()) {
      temp_5001 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (105)) ;
    }
    ...
    if (cond_6450.isBuiltAndTrue ()) {
      ...
      if (temp_6416.isBuilt ()) {
        temp_6416 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (133)) ;
      }
    }
