...
void routine_midrange_analyze (C_Compiler & inLexique,
  ...
  if ((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (77))))).isBuiltAndTrue ()) {
  ...
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (85)))).isBuiltAndTrue ()) {
    ...
    var_cas_listFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (86))).operator_concat (GGS_string (".list")) ;
    GGS_bool automatic_var_0 ;
    const GGS_string temp_4352 = var_cas_listFileContents ;
    if (temp_4352.isBuilt ()) {
      temp_4352 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (87)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (104))).operator_concat (GGS_string (".hex")) ;
    GGS_bool automatic_var_1 ;
    const GGS_string temp_4989 = var_cas_contents ;
    if (temp_4989.isBuilt ()) {
      temp_4989 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (105)) ;
    }
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (107)))).isBuiltAndTrue ()) {
      ...
      var_cas_verboseMessage = ((GGS_string ("  ROM size: ")).operator_concat (var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (108)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (108)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (108)))).operator_concat (GGS_string (" words;")) ;
      ...
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        ...
        while (((operand_5395 = enumerator_5395.nextObject ()))) {
          ...
          var_cas_bankSize = operand_5395->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_5395->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (112)) ;
          GGS_uint  var_cas_usedSize ;
          var_cas_usedSize = operand_5395->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_5395->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (113)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage.dotAssign_operation (operand_5395->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (114))) ;
          var_cas_verboseMessage.appendCString ("': ") ;
    ...
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (122)))).isBuiltAndTrue ()) {
      ...
      var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (132))).operator_concat (GGS_string (".asm")) ;
      GGS_bool automatic_var_2 ;
      const GGS_string temp_6392 = var_cas_assemblyCode ;
      if (temp_6392.isBuilt ()) {
        temp_6392 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (133)) ;
      }
    }
  }else{
    GGS_string var_cas_hexDestinationFile ;
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (136))).operator_concat (GGS_string (".hex")) ;
    ...
    GGS_string var_cas_asmDestinationFile ;
    var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (140))).operator_concat (GGS_string (".asm")) ;
