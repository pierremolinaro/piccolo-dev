...
void routine_midrange_analyze (C_Compiler & inLexique,
  ...
  const GGS_bool cond_6454 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_6454.isBuiltAndTrue ()) {
    ...
    if (var_cas_contents.isBuilt ()) {
      var_cas_contents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_5025_0 COMMA_SOURCE_FILE_AT_LINE (105)) ;
    }
    const GGS_bool cond_5857 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
    if (cond_5857.isBuiltAndTrue ()) {
      ...
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        ...
        while (((operand_5413 = enumerator_5413.nextObject ()))) {
          ...
          var_cas_verboseMessage.dotAssign_operation (operand_5413->mKey) ;
          var_cas_verboseMessage.appendCString ("': ") ;
    ...
    const GGS_bool cond_6442 = gOption_piccolo_5F_options_generateAssembly.reader_value () ;
    if (cond_6442.isBuiltAndTrue ()) {
      ...
      GGS_bool automatic_var_6432_0 ;
      if (var_cas_assemblyCode.isBuilt ()) {
        var_cas_assemblyCode (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_6432_0 COMMA_SOURCE_FILE_AT_LINE (133)) ;
      }
    }
  }else if (cond_6454.isBuiltAndFalse ()) {
    GGS_string var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension ()).operator_concat (GGS_string (".hex")) ;
    const GGS_bool cond_6695 = var_cas_hexDestinationFile.reader_fileExists () ;
    if (cond_6695.isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (138)) ;
    }
    GGS_string var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension ()).operator_concat (GGS_string (".asm")) ;
    const GGS_bool cond_6895 = var_cas_asmDestinationFile.reader_fileExists () ;
    if (cond_6895.isBuiltAndTrue ()) {
