...
void routine_midrange_analyze (C_Compiler & inLexique,
  ...
  var_cas_ramBank = var_cas_piccoloDeviceModel.reader_mRamBankTable (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
  GGS_registerTable  var_cas_registerTable ;
  var_cas_registerTable = var_cas_piccoloDeviceModel.reader_mRegisterTable (inLexique COMMA_SOURCE_FILE_AT_LINE (54)) ;
  ...
  ::routine_build_midrange_assembly_instruction_list (inLexique,  var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (66)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (66))._add_operation (inLexique, GGS_uint (2047U) COMMA_SOURCE_FILE_AT_LINE (66))._divide_operation (inLexique, GGS_uint (2048U) COMMA_SOURCE_FILE_AT_LINE (66)),  var_cas_piccoloDeviceModel.reader_mBankCount (inLexique COMMA_SOURCE_FILE_AT_LINE (67)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (67)),  var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (68)),  (var_cas_piccoloDeviceModel.reader_mSharedBankName (inLexique COMMA_SOURCE_FILE_AT_LINE (69)))._operator_isNotEqual (GGS_string ("")),  var_cas_registerTable,  var_cas_inPiccoloModel,  var_cas_hasInterrupt,  var_cas_generatedInstructionList,  var_cas_listFileContents COMMA_SOURCE_FILE_AT_LINE (65)) ;
  if ((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U)))._operator_and (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (77))))).isBuiltAndTrue ()) {
  ...
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (85)))).isBuiltAndTrue ()) {
    GGS_string var_cas_listFile ;
    var_cas_listFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (86)))._operator_concat (GGS_string (".list")) ;
    GGS_bool automatic_var_0 ;
    const GGS_string _temp_4352 = var_cas_listFileContents ;
    if (_temp_4352.isBuilt ()) {
      _temp_4352 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (87)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (104)))._operator_concat (GGS_string (".hex")) ;
    GGS_bool automatic_var_1 ;
    const GGS_string _temp_4989 = var_cas_contents ;
    if (_temp_4989.isBuilt ()) {
      _temp_4989 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (105)) ;
    }
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (107)))).isBuiltAndTrue ()) {
      GGS_string var_cas_verboseMessage ;
      var_cas_verboseMessage = ((GGS_string ("  ROM size: "))._operator_concat (var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (108)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (108)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (108))))._operator_concat (GGS_string (" words;")) ;
      var_cas_verboseMessage.appendCString (" used: ") ;
      var_cas_verboseMessage._dotAssign_operation (var_cas_usedROMsize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (109))) ;
      var_cas_verboseMessage.appendCString (" words (") ;
      var_cas_verboseMessage._dotAssign_operation (var_cas_usedROMsize._multiply_operation (inLexique, GGS_uint (100U) COMMA_SOURCE_FILE_AT_LINE (110))._divide_operation (inLexique, var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (110)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110))) ;
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        ...
        while (((operand_5395 = enumerator_5395.nextObject ()))) {
          ...
          var_cas_bankSize = operand_5395->mInfo.mLastAddressPlusOne._substract_operation (inLexique, operand_5395->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (112)) ;
          GGS_uint  var_cas_usedSize ;
          var_cas_usedSize = operand_5395->mInfo.mFirstFreeAddress._substract_operation (inLexique, operand_5395->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (113)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage._dotAssign_operation (operand_5395->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (114))) ;
          var_cas_verboseMessage.appendCString ("': ") ;
          var_cas_verboseMessage._dotAssign_operation (var_cas_bankSize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115))) ;
          var_cas_verboseMessage.appendCString (" bytes, used ") ;
          var_cas_verboseMessage._dotAssign_operation (var_cas_usedSize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116))) ;
          var_cas_verboseMessage.appendCString (" bytes (") ;
          var_cas_verboseMessage._dotAssign_operation (var_cas_usedSize._multiply_operation (inLexique, GGS_uint (100U) COMMA_SOURCE_FILE_AT_LINE (117))._divide_operation (inLexique, var_cas_bankSize COMMA_SOURCE_FILE_AT_LINE (117)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (117))) ;
          var_cas_verboseMessage.appendCString ("%).\n") ;
        }
      }
      inLexique.printMessage (var_cas_verboseMessage COMMA_SOURCE_FILE_AT_LINE (119)) ;
    }
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (122)))).isBuiltAndTrue ()) {
      ...
      var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (132)))._operator_concat (GGS_string (".asm")) ;
      GGS_bool automatic_var_2 ;
      const GGS_string _temp_6392 = var_cas_assemblyCode ;
      if (_temp_6392.isBuilt ()) {
        _temp_6392 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (133)) ;
      }
    }
  }else{
    GGS_string var_cas_hexDestinationFile ;
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (136)))._operator_concat (GGS_string (".hex")) ;
    if ((var_cas_hexDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (137))).isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (138)) ;
    }
    GGS_string var_cas_asmDestinationFile ;
    var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (140)))._operator_concat (GGS_string (".asm")) ;
    if ((var_cas_asmDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (141))).isBuiltAndTrue ()) {
