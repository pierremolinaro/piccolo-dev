...
void routine_midrange_analyze (C_Compiler & inLexique,
  ...
  const GGS_bool cond_6462 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (GGS_uint (0U)) ;
