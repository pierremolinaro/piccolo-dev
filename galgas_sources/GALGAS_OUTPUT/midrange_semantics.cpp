...
//                    september 14th, 2008, at 19h47'0"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_midrange_analyze (C_Compiler & _inLexique,
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (83)))).isBuiltAndTrue ()) {
    ...
    if (_temp_4237._isBuilt ()) {
      _temp_4237 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_listFile COMMA_SOURCE_FILE_AT_LINE (85)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_string _temp_4828 = var_cas_contents ;
    if (_temp_4828._isBuilt ()) {
      _temp_4828 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (101)) ;
    }
    if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (103)))).isBuiltAndTrue ()) {
      ...
      const GGS_string _temp_5391 = var_cas_assemblyCode ;
      if (_temp_5391._isBuilt ()) {
        _temp_5391 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_asmDestinationFile COMMA_SOURCE_FILE_AT_LINE (114)) ;
      }
    }
  }else{
    GGS_string var_cas_hexDestinationFile ;
