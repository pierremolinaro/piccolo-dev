...
#ifndef midrange_5F_semantics_ENTITIES_DEFINED
#define midrange_5F_semantics_ENTITIES_DEFINED
...
//--- Current element access
  public : class GALGAS_midrange_5F_declaredRoutineMap_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_midrange_5F_declaredRoutineMap_2E_element constructor_new (const class GALGAS_lstring & inOperand0
                                                                                    COMMA_LOCATION_ARGS) ;
