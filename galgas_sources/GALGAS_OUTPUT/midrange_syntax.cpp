    ...
    case 2 : {
      ...
      switch (select_midrange_syntax_5 (_inLexique)) {
          ...
          switch (select_midrange_syntax_6 (_inLexique)) {
            ...
            case 2 : {
              ...
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (238)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (245)) ;
          }
          var_cas_preservesBank = GGS_bool (true, false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
...
void midrange_syntax::
pr_midrange_structured_instruction_midrange_syntax_263_38_ (piccolo_lexique & _inLexique,
  ...
  switch (select_midrange_syntax_7 (_inLexique)) {
    ...
    case 4 : {
      ...
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (343)) ;
    ...
    case 5 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)) ;
      if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (375)) ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3A) COMMA_HERE) ;
      GGS_midrange_instruction  var_cas_instruction ;
      nt_midrange_simple_instruction_ (_inLexique, var_cas_instruction) ;
...
void midrange_syntax::
pr_midrange_structured_if_instruction_midrange_syntax_451_41_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void midrange_syntax::
pr_midrange_simple_instruction_midrange_syntax_498_34_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction) {
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_641_32_ (piccolo_lexique & _inLexique,
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_652_32_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_660_32_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
  switch (select_midrange_syntax_17 (_inLexique)) {
    case 1 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (690)) ;
...
void midrange_syntax::
pr_midrange_condition_expression_midrange_syntax_726_36_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
void midrange_syntax::
pr_midrange_condition_term_midrange_syntax_745_30_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
