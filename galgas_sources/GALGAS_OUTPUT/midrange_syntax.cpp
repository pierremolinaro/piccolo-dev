...
pr_midrange_interrupt_definition_midrange_syntax_164_36_ (piccolo_lexique & _inLexique,
  ...
  var_cas_ioInterruptDefinitionList._addAssign_operation (var_cas_instructionList, var_cas_interruptionLocation) ;
}
    ...
    case 4 : {
      ...
      switch (select_midrange_syntax_7 (_inLexique)) {
        case 1 : {
          ...
          { bool syntaxRepeat_8 = true ;
            while (syntaxRepeat_8) {
              ...
              switch (select_repeat_midrange_syntax_8 (_inLexique)) {
                case 2 : {
          ...
          var_cas_outInstruction = GGS_midrange_instruction_computed_retlw ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_sizeExpression, var_cas_argumentList COMMA_HERE) ;
        ...
        case 2 : {
          ...
          var_cas_outInstruction = GGS_midrange_instruction_computed_goto ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_sizeExpression, var_cas_argumentList COMMA_HERE) ;
...
void midrange_syntax::
pr_midrange_structured_if_instruction_midrange_syntax_438_41_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void midrange_syntax::
pr_midrange_simple_instruction_midrange_syntax_485_34_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction) {
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_645_32_ (piccolo_lexique & _inLexique,
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_656_32_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
pr_midrange_condition_factor_midrange_syntax_664_32_ (piccolo_lexique & _inLexique,
  ...
  switch (select_midrange_syntax_19 (_inLexique)) {
    case 1 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (683)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (683)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (694)) ;
...
void midrange_syntax::
pr_midrange_condition_expression_midrange_syntax_730_36_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
  ...
  { bool syntaxRepeat_22 = true ;
    while (syntaxRepeat_22) {
      switch (select_repeat_midrange_syntax_22 (_inLexique)) {
        case 2 : {
...
void midrange_syntax::
pr_midrange_condition_term_midrange_syntax_749_30_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
