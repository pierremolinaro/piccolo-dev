...
pr_start_symbol_midrange_syntax_119_19_ (piccolo_lexique & inLexique) {
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (173))).operator_concat (GGS_string (".hex")) ;
    ...
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (177))).operator_concat (GGS_string (".asm")) ;
...
pr_midrange_structured_instruction_midrange_syntax_352_38_ (piccolo_lexique & inLexique,
  ...
  switch (select_midrange_syntax_7 (inLexique)) {
        ...
        case 2 : {
          ...
          switch (select_midrange_syntax_9 (inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_condition).operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if ! ")).operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (456)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (456))) ;
                if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (457)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (457))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_condition).operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if ")).operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (465)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (465))) ;
                if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (466)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (466))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
    ...
    case 6 : {
      ...
      if (((var_cas_condition).operator_isNotEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
      ...
      switch (select_midrange_syntax_22 (inLexique)) {
        ...
        case 2 : {
          ...
          if (((var_cas_condition).operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
            ...
            GGS_string var_cas_s ;
            var_cas_s = (GGS_string ("! ")).operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (844)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (844))) ;
            if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (845)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (845))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
            ...
            if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (853)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (853))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
