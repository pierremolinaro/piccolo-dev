...
//                    december 31th, 2008, at 16h49'16"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_start_symbol_midrange_syntax_117_19_ (piccolo_lexique & _inLexique) {
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    ::routine_midrange_analyze (_inLexique,  var_cas_piccoloModel,  GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (169)) ;
  }else{
    GGS_string var_cas_hexDestinationFile ;
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (171)))._operator_concat (GGS_string (true, ".hex")) ;
    if ((var_cas_hexDestinationFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (172))).isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (_inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (173)) ;
    }
    GGS_string var_cas_asmDestinationFile ;
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)))._operator_concat (GGS_string (true, ".asm")) ;
    if ((var_cas_asmDestinationFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (176))).isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (_inLexique, var_cas_asmDestinationFile COMMA_SOURCE_FILE_AT_LINE (177)) ;
    }
  }
}
...
void midrange_syntax::
pr_start_symbol_midrange_syntax_117_19_importBootloaderSpecification (piccolo_lexique & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_programName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  var_cas_programName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this file does not define a bootloader specification") COMMA_SOURCE_FILE_AT_LINE (193)) ;
...
void midrange_syntax::
pr_midrange_instruction_list_midrange_syntax_215_32_ (piccolo_lexique & _inLexique,
...
void midrange_syntax::
pr_midrange_instruction_list_midrange_syntax_215_32_parse (piccolo_lexique & _inLexique) {
  { bool syntaxRepeat_1 = true ;
    while (syntaxRepeat_1) {
      switch (select_repeat_midrange_syntax_1 (_inLexique)) {
        case 2 : {
...
void midrange_syntax::
pr_midrange_interrupt_definition_midrange_syntax_239_36_ (piccolo_lexique & _inLexique,
...
void midrange_syntax::
pr_midrange_interrupt_definition_midrange_syntax_239_36_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_interrupt) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_contextsave) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2C) COMMA_HERE) ;
...
void midrange_syntax::
pr_midrange_routine_definition_midrange_syntax_269_34_ (piccolo_lexique & _inLexique,
      ...
      switch (select_midrange_syntax_5 (_inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (306)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_midrange_syntax_6 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (321)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (328)) ;
          }
          var_cas_preservesBank = GGS_bool (true, false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
...
void midrange_syntax::
pr_midrange_routine_definition_midrange_syntax_269_34_parse (piccolo_lexique & _inLexique) {
  switch (select_midrange_syntax_2 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void midrange_syntax::
pr_midrange_structured_instruction_midrange_syntax_346_38_ (piccolo_lexique & _inLexique,
  ...
  switch (select_midrange_syntax_7 (_inLexique)) {
        ...
        case 2 : {
          ...
          switch (select_midrange_syntax_9 (_inLexique)) {
            ...
            case 2 : {
              ...
              var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (447)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (447)) ;
              if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true, true) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string (true, "if ! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (450)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (450))) ;
                if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (451)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (451)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                  var_cas_s.writeString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (452)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (452)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (452))) ;
                  var_cas_s.writeString ("]") ;
                }
                var_cas_s.writeString (".") ;
                const GGS_bitNumberExpression  _temp_12492 = var_cas_bitNumberExpression ;
                if (_temp_12492._isBuilt ()) {
                  _temp_12492 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (454)) ;
                }
                var_cas_s.writeString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (456)) ;
              }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true, false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string (true, "if "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (459)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (459))) ;
                if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (460)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (460)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                  var_cas_s.writeString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (461)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (461)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (461))) ;
                  var_cas_s.writeString ("]") ;
                }
                var_cas_s.writeString (".") ;
                const GGS_bitNumberExpression  _temp_12995 = var_cas_bitNumberExpression ;
                if (_temp_12995._isBuilt ()) {
                  _temp_12995 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (463)) ;
                }
                var_cas_s.writeString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (465)) ;
              }else{
    ...
    case 6 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (499)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (499)) ;
      if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (502)) ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3A) COMMA_HERE) ;
      GGS_midrange_instruction  var_cas_instruction ;
      nt_midrange_simple_instruction_ (_inLexique, var_cas_instruction) ;
...
void midrange_syntax::
pr_midrange_structured_instruction_midrange_syntax_346_38_parse (piccolo_lexique & _inLexique) {
  switch (select_midrange_syntax_7 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_banksel) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
...
void midrange_syntax::
pr_midrange_structured_if_instruction_midrange_syntax_578_41_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void midrange_syntax::
pr_midrange_structured_if_instruction_midrange_syntax_578_41_parse (piccolo_lexique & _inLexique) {
  nt_midrange_condition_expression_parse (_inLexique) ;
  nt_midrange_instruction_list_parse (_inLexique) ;
  switch (select_midrange_syntax_13 (_inLexique)) {
    case 1 : {
...
void midrange_syntax::
pr_midrange_simple_instruction_midrange_syntax_625_34_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction) {
...
void midrange_syntax::
pr_midrange_simple_instruction_midrange_syntax_625_34_parse (piccolo_lexique & _inLexique) {
  switch (select_midrange_syntax_14 (_inLexique)) {
    case 1 : {
      switch (select_midrange_syntax_15 (_inLexique)) {
        case 1 : {
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_768_32_ (piccolo_lexique & _inLexique,
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_768_32_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__21) COMMA_HERE) ;
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_779_32_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_779_32_parse (piccolo_lexique & _inLexique) {
  nt_midrange_condition_expression_parse (_inLexique) ;
}
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_787_32_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
  switch (select_midrange_syntax_19 (_inLexique)) {
    case 1 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (806)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (806)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (817)) ;
    ...
    case 2 : {
      ...
      switch (select_midrange_syntax_22 (_inLexique)) {
        ...
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (835)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (835)) ;
          if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true, true) ;
            GGS_string var_cas_s ;
            var_cas_s = (GGS_string (true, "! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (838)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (838))) ;
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (839)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (839)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              var_cas_s.writeString (" [") ;
              var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (840)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (840)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (840))) ;
              var_cas_s.writeString ("]") ;
            }
            var_cas_s.writeString (".") ;
            const GGS_bitNumberExpression  _temp_24454 = var_cas_bitNumberExpression ;
            if (_temp_24454._isBuilt ()) {
              _temp_24454 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (842)) ;
            }
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (843)) ;
          }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true, false) ;
            GGS_string var_cas_s ;
            var_cas_s = var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (846)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (846)) ;
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (847)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (847)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              var_cas_s.writeString (" [") ;
              var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (848)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (848)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (848))) ;
              var_cas_s.writeString ("]") ;
            }
            var_cas_s.writeString (".") ;
            const GGS_bitNumberExpression  _temp_24918 = var_cas_bitNumberExpression ;
            if (_temp_24918._isBuilt ()) {
              _temp_24918 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (850)) ;
            }
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (851)) ;
          }else{
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (857)) ;
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_787_32_parse (piccolo_lexique & _inLexique) {
  switch (select_midrange_syntax_19 (_inLexique)) {
    case 1 : {
      switch (select_midrange_syntax_20 (_inLexique)) {
        case 1 : {
...
void midrange_syntax::
pr_midrange_condition_expression_midrange_syntax_869_36_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
void midrange_syntax::
pr_midrange_condition_expression_midrange_syntax_869_36_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__28) COMMA_HERE) ;
...
void midrange_syntax::
pr_midrange_condition_term_midrange_syntax_888_30_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
void midrange_syntax::
pr_midrange_condition_term_midrange_syntax_888_30_parse (piccolo_lexique & _inLexique) {
  nt_midrange_condition_factor_parse (_inLexique) ;
  { bool syntaxRepeat_24 = true ;
    while (syntaxRepeat_24) {
      switch (select_repeat_midrange_syntax_24 (_inLexique)) {
