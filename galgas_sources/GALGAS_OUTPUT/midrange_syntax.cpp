...
pr_start_symbol_midrange_syntax_119_19_ (piccolo_lexique & inLexique) {
  ...
  const GGS_bool cond_4442 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_4442.isBuiltAndTrue ()) {
  ...
  }else if (cond_4442.isBuiltAndFalse ()) {
    GGS_string var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (173))).operator_concat (GGS_string (".hex")) ;
    const GGS_bool cond_4655 = var_cas_hexDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
    if (cond_4655.isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (175)) ;
    }
    GGS_string var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (177))).operator_concat (GGS_string (".asm")) ;
    const GGS_bool cond_4873 = var_cas_asmDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (178)) ;
    ...
    case 2 : {
      ...
      switch (select_midrange_syntax_5 (inLexique)) {
        case 1 : {
          ...
          const GGS_bool cond_8284 = var_cas_noreturn ;
          if (cond_8284.isBuiltAndTrue ()) {
        ...
        case 2 : {
          ...
          switch (select_midrange_syntax_6 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              const GGS_bool cond_8782 = var_cas_noreturn ;
        ...
        case 3 : {
          ...
          inLexique.assignFromAttribute_uint32value (var_cas_returnedBank) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          const GGS_bool cond_8984 = var_cas_noreturn ;
...
pr_midrange_structured_instruction_midrange_syntax_352_38_ (piccolo_lexique & inLexique,
  ...
  switch (select_midrange_syntax_7 (inLexique)) {
        ...
        case 2 : {
          ...
          switch (select_midrange_syntax_9 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
              GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (453)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (453)) ;
              const GGS_bool cond_12925 = (var_cas_condition).operator_isEqual (GGS_string ("Z")) ;
              if (cond_12925.isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true) ;
                GGS_string var_cas_s = (GGS_string ("if ! ")).operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (456)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (456))) ;
                const GGS_bool cond_12702 = (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (457)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (457))).operator_strictSup (GGS_uint (0U)) ;
                if (cond_12702.isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
                  var_cas_s.dotAssign_operation (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (458)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (458)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (458))) ;
                  var_cas_s.appendCString ("]") ;
                }
                var_cas_s.appendCString (".") ;
                const GGS_bitNumberExpression  temp_12757 = var_cas_bitNumberExpression ;
                if (temp_12757.isBuilt ()) {
                  temp_12757 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (460)) ;
                }
                var_cas_s.appendCString (" :") ;
                var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '")).operator_concat (var_cas_s)).operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (462)) ;
              }else if (cond_12925.isBuiltAndFalse ()) {
                const GGS_bool cond_13427 = (var_cas_condition).operator_isEqual (GGS_string ("NZ")) ;
                if (cond_13427.isBuiltAndTrue ()) {
                  var_cas_skipIfSet = GGS_bool (false) ;
                  GGS_string var_cas_s = (GGS_string ("if ")).operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (465)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (465))) ;
                  const GGS_bool cond_13205 = (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (466)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (466))).operator_strictSup (GGS_uint (0U)) ;
                  if (cond_13205.isBuiltAndTrue ()) {
                    var_cas_s.appendCString (" [") ;
                    var_cas_s.dotAssign_operation (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (467)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (467)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (467))) ;
                    var_cas_s.appendCString ("]") ;
                  }
                  var_cas_s.appendCString (".") ;
                  const GGS_bitNumberExpression  temp_13260 = var_cas_bitNumberExpression ;
                  if (temp_13260.isBuilt ()) {
                    temp_13260 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (469)) ;
                  }
                  var_cas_s.appendCString (" :") ;
                  var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '")).operator_concat (var_cas_s)).operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (471)) ;
                }else if (cond_13427.isBuiltAndFalse ()) {
                  var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '")).operator_concat (var_cas_condition)).operator_concat (GGS_string ("' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (474)) ;
    ...
    case 6 : {
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_conditionString) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (505)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (505)) ;
      const GGS_bool cond_14523 = (var_cas_condition).operator_isNotEqual (GGS_string ("NZ")) ;
      if (cond_14523.isBuiltAndTrue ()) {
        var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '")).operator_concat (var_cas_condition)).operator_concat (GGS_string ("' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (508)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3A_) COMMA_HERE) ;
      GGS_midrange_instruction  var_cas_instruction ;
      nt_midrange_simple_instruction_ (inLexique, var_cas_instruction) ;
...
pr_midrange_condition_factor_midrange_syntax_793_32_ (piccolo_lexique & inLexique,
  ...
  switch (select_midrange_syntax_19 (inLexique)) {
    case 1 : {
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_conditionString) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (812)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (812)) ;
      GGS_bool var_cas_branchIfZero ;
      const GGS_bool cond_23608 = (var_cas_condition).operator_isEqual (GGS_string ("Z")) ;
      if (cond_23608.isBuiltAndTrue ()) {
        var_cas_branchIfZero = GGS_bool (true) ;
      }else if (cond_23608.isBuiltAndFalse ()) {
        const GGS_bool cond_23670 = (var_cas_condition).operator_isEqual (GGS_string ("NZ")) ;
        if (cond_23670.isBuiltAndTrue ()) {
          var_cas_branchIfZero = GGS_bool (false) ;
        }else if (cond_23670.isBuiltAndFalse ()) {
          var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '")).operator_concat (var_cas_conditionString)).operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (823)) ;
    ...
    case 2 : {
      ...
      switch (select_midrange_syntax_22 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_conditionString) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (841)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (841)) ;
          const GGS_bool cond_24861 = (var_cas_condition).operator_isEqual (GGS_string ("Z")) ;
          if (cond_24861.isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true) ;
            GGS_string var_cas_s = (GGS_string ("! ")).operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (844)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (844))) ;
            const GGS_bool cond_24666 = (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (845)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (845))).operator_strictSup (GGS_uint (0U)) ;
            if (cond_24666.isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
              var_cas_s.dotAssign_operation (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (846)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (846)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (846))) ;
              var_cas_s.appendCString ("]") ;
            }
            var_cas_s.appendCString (".") ;
            const GGS_bitNumberExpression  temp_24719 = var_cas_bitNumberExpression ;
            if (temp_24719.isBuilt ()) {
              temp_24719 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (848)) ;
            }
            var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '")).operator_concat (var_cas_s)).operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (849)) ;
          }else if (cond_24861.isBuiltAndFalse ()) {
            const GGS_bool cond_25324 = (var_cas_condition).operator_isEqual (GGS_string ("NZ")) ;
            if (cond_25324.isBuiltAndTrue ()) {
              var_cas_BTFSSinstruction = GGS_bool (false) ;
              GGS_string var_cas_s = var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (852)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (852)) ;
              const GGS_bool cond_25130 = (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (853)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (853))).operator_strictSup (GGS_uint (0U)) ;
              if (cond_25130.isBuiltAndTrue ()) {
                var_cas_s.appendCString (" [") ;
                var_cas_s.dotAssign_operation (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (854)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (854)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (854))) ;
                var_cas_s.appendCString ("]") ;
              }
              var_cas_s.appendCString (".") ;
              const GGS_bitNumberExpression  temp_25183 = var_cas_bitNumberExpression ;
              if (temp_25183.isBuilt ()) {
                temp_25183 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (856)) ;
              }
              var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '")).operator_concat (var_cas_s)).operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (857)) ;
            }else if (cond_25324.isBuiltAndFalse ()) {
              var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '")).operator_concat (var_cas_conditionString)).operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (863)) ;
