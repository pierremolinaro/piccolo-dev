...
pr_start_symbol_midrange_syntax_119_19_ (piccolo_lexique & _inLexique) {
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (173)))._operator_concat (GGS_string (".hex")) ;
    ...
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_concat (GGS_string (".asm")) ;
...
pr_start_symbol_midrange_syntax_119_19_importBootloaderSpecification (piccolo_lexique & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_programName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  var_cas_programName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("this file does not define a bootloader specification") COMMA_SOURCE_FILE_AT_LINE (199)) ;
...
pr_midrange_routine_definition_midrange_syntax_275_34_ (piccolo_lexique & _inLexique,
  ...
  switch (select_midrange_syntax_3 (_inLexique)) {
    case 1 : {
      var_cas_page = GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      switch (select_midrange_syntax_5 (_inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (312)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_midrange_syntax_6 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (327)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (334)) ;
          }
          var_cas_preservesBank = GGS_bool (false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
  ...
  switch (select_midrange_syntax_7 (_inLexique)) {
          ...
          switch (select_midrange_syntax_9 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
                ...
                var_cas_s = (GGS_string ("if ! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (456)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (456))) ;
                if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (457)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (457)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                ...
                var_cas_s.appendCString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (462)) ;
              }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (465)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (465))) ;
                if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (466)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (466)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
                ...
                var_cas_s.appendCString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (471)) ;
              }else{
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (474)) ;
    ...
    case 6 : {
      ...
      if (((var_cas_condition)._operator_isNotEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (508)) ;
      }
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3A) COMMA_HERE) ;
      GGS_midrange_instruction  var_cas_instruction ;
      nt_midrange_simple_instruction_ (_inLexique, var_cas_instruction) ;
  ...
  switch (select_midrange_syntax_19 (_inLexique)) {
    case 1 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (823)) ;
      ...
      switch (select_midrange_syntax_22 (_inLexique)) {
        ...
        case 2 : {
          ...
          if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
            ...
            GGS_string var_cas_s ;
            var_cas_s = (GGS_string ("! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (844)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (844))) ;
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (845)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (845)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
            ...
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (849)) ;
          }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (false) ;
            GGS_string var_cas_s ;
            ...
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (853)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (853)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
            ...
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (857)) ;
          }else{
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (863)) ;
