...
pr_start_symbol_midrange_syntax_120_19_ (piccolo_lexique & inLexique) {
  ...
  if (cond_4476.isBuiltAndTrue ()) {
    ...
    GGS_string var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_concat (GGS_string (".hex")) ;
    const GGS_bool cond_4689 = var_cas_hexDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
    ...
    GGS_string var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).operator_concat (GGS_string (".asm")) ;
    const GGS_bool cond_4907 = var_cas_asmDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
...
pr_midrange_structured_instruction_midrange_syntax_353_38_ (piccolo_lexique & inLexique,
  ...
  switch (select_midrange_syntax_7 (inLexique)) {
        ...
        case 2 : {
          ...
          switch (select_midrange_syntax_9 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
              GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (454)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (454)) ;
    ...
    case 6 : {
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_conditionString) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (506)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (506)) ;
...
pr_midrange_condition_factor_midrange_syntax_794_32_ (piccolo_lexique & inLexique,
  ...
  switch (select_midrange_syntax_19 (inLexique)) {
    case 1 : {
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_conditionString) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (813)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (813)) ;
    ...
    case 2 : {
      ...
      switch (select_midrange_syntax_22 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_conditionString) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (842)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (842)) ;
