...
void midrange_syntax::
pr_midrange_structured_if_instruction_midrange_syntax_465_41_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void midrange_syntax::
pr_midrange_simple_instruction_midrange_syntax_512_34_ (piccolo_lexique & _inLexique,
                                GGS_midrange_instruction  &var_cas_outInstruction) {
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_657_32_ (piccolo_lexique & _inLexique,
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_668_32_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
void midrange_syntax::
pr_midrange_condition_factor_midrange_syntax_676_32_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
  switch (select_midrange_syntax_17 (_inLexique)) {
    case 1 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (695)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (695)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (706)) ;
    ...
    case 2 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (731)) ;
...
void midrange_syntax::
pr_midrange_condition_expression_midrange_syntax_742_36_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
...
void midrange_syntax::
pr_midrange_condition_term_midrange_syntax_761_30_ (piccolo_lexique & _inLexique,
                                GGS_midrange_conditionExpression  &var_cas_outCondition) {
