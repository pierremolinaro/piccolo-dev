...
void routine_addMidRangeUsedRoutinesFromInstructionList (const GALGAS_midrange_5F_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_midrange_5F_instructionList enumerator_6223 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_6223.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_midrange_5F_instruction *) enumerator_6223.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
...
GALGAS_stringset function_midrange_5F_computeUsedRoutines (const GALGAS_midrange_5F_interruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  cEnumerator_midrange_5F_interruptDefinitionList enumerator_6762 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_6762.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_6762.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
    }
  ...
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (230)).isValid ()) {
    PMUInt32 variant_6962 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (230)).uintValue () ;
    bool loop_6962 = true ;
    while (loop_6962) {
      loop_6962 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_6962) {
        loop_6962 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      ...
      if (loop_6962) {
        ...
        cEnumerator_midrange_5F_routineDefinitionList enumerator_7096 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_7096.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_7096.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (234)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_7096.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (235)) ;
            }
          }
...
static void categoryMethod_midrange_5F_instruction_5F_do_5F_while_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  cEnumerator_midrange_5F_partList enumerator_4412 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_4412.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_4412.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (151)) ;
    }
