...
void routine_addMidRangeUsedRoutinesFromInstructionList (const GALGAS_midrange_5F_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_midrange_5F_instructionList enumerator_6226 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_6226.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_midrange_5F_instruction *) enumerator_6226.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
...
GALGAS_stringset function_midrange_5F_computeUsedRoutines (const GALGAS_midrange_5F_interruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (220)) ;
  cEnumerator_midrange_5F_interruptDefinitionList enumerator_6765 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_6765.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_6765.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
    }
    enumerator_6765.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (229)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (230)).isValid ()) {
    PMUInt32 variant_6964 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (230)).uintValue () ;
    bool loop_6964 = true ;
    while (loop_6964) {
      loop_6964 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_6964) {
        loop_6964 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_6964 && (0 == variant_6964)) {
        loop_6964 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (230)) ;
      }
      if (loop_6964) {
        variant_6964 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_midrange_5F_routineDefinitionList enumerator_7099 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_7099.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_7099.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (234)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_7099.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (235)) ;
            }
          }
...
static void categoryMethod_midrange_5F_instruction_5F_do_5F_while_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
  cEnumerator_midrange_5F_partList enumerator_4415 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_4415.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_4415.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (151)) ;
    }
...
static void categoryMethod_midrange_5F_instruction_5F_savebank_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_instruction_5F_structured_5F_if_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)) ;
  }
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (176)) ;
  }
}
//---------------------------------------------------------------------------*
