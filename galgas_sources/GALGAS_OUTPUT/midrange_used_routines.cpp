...
void routine_addMidRangeUsedRoutinesFromInstructionList (const GALGAS_midrange_5F_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_midrange_5F_instructionList enumerator_5756 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_5756.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_midrange_5F_instruction *) enumerator_5756.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) ;
...
GALGAS_stringset function_midrange_5F_computeUsedRoutines (const GALGAS_midrange_5F_interruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (205)) ;
  cEnumerator_midrange_5F_interruptDefinitionList enumerator_6295 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_6295.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_6295.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
    }
    enumerator_6295.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (214)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (215)).isValid ()) {
    PMUInt32 variant_6494 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (215)).uintValue () ;
    bool loop_6494 = true ;
    while (loop_6494) {
      loop_6494 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_6494) {
        loop_6494 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_6494 && (0 == variant_6494)) {
        loop_6494 = false ;
      ...
      if (loop_6494) {
        ...
        cEnumerator_midrange_5F_routineDefinitionList enumerator_6629 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_6629.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_6629.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (219)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_6629.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (220)) ;
            }
          }
...
static void categoryMethod_midrange_5F_instruction_5F_do_5F_while_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  cEnumerator_midrange_5F_partList enumerator_3945 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_3945.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_3945.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) ;
    }
...
static void categoryMethod_midrange_5F_instruction_5F_savebank_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_instruction_5F_structured_5F_if_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) ;
  }
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (161)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_instruction_5F_JSR_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  ioArgument_ioUsedRoutines.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (176)) ;
}
//---------------------------------------------------------------------------*
