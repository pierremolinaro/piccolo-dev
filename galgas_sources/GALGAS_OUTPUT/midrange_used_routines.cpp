...
void routine_addMidRangeUsedRoutinesFromInstructionList (const GALGAS_midrange_5F_instructionList constinArgument_inInstructionList,
  ...
  cEnumerator_midrange_5F_instructionList enumerator_5951 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_5951.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_midrange_5F_instruction *) enumerator_5951.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
...
GALGAS_stringset function_midrange_5F_computeUsedRoutines (const GALGAS_midrange_5F_interruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (212)) ;
  cEnumerator_midrange_5F_interruptDefinitionList enumerator_6490 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_6490.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_6490.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (215)) ;
    }
    enumerator_6490.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (221)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (222)).isValid ()) {
    PMUInt32 variant_6689 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (222)).uintValue () ;
    bool loop_6689 = true ;
    while (loop_6689) {
      loop_6689 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_6689) {
        loop_6689 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_6689 && (0 == variant_6689)) {
        loop_6689 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (222)) ;
      }
      if (loop_6689) {
        variant_6689 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_midrange_5F_routineDefinitionList enumerator_6824 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_6824.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_6824.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (226)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_6824.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (227)) ;
            }
          }
...
static void categoryMethod_midrange_5F_instruction_5F_do_5F_while_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
  }
  cEnumerator_midrange_5F_partList enumerator_4140 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_4140.hasCurrentObject ()) {
    {
    routine_addMidRangeUsedRoutinesFromInstructionList (enumerator_4140.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) ;
    }
...
static void categoryMethod_midrange_5F_instruction_5F_savebank_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_instruction_5F_structured_5F_if_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) ;
  }
  {
  routine_addMidRangeUsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_midrange_5F_instruction_5F_JSR_addUsedRoutines (const cPtr_midrange_5F_instruction * inObject,
  ...
  ioArgument_ioUsedRoutines.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (183)) ;
}
//---------------------------------------------------------------------------*
