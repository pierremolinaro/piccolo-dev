...
void routine_pic18BootloaderSpecificationAnalysis (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_sourceFileBaseName = var_cas_inSourceFileName.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (22)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (22)) ;
  ...
  GGS_uint  var_cas_entryPointAddress = GGS_uint (4U) ;
  {
    ...
    while (((operand_4012 = enumerator_4012.nextObject ()))) {
      ...
      const GGS_bool cond_4144 = var_cas_routineNameSet.reader_hasKey (inLexique, operand_4012->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (73)) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  ...
  var_cas_entryPointAddress = var_cas_inReservedRomSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
  {
    ...
    while (((operand_5084 = enumerator_5084.nextObject ()))) {
      ...
      const GGS_bool cond_5216 = var_cas_routineNameSet.reader_hasKey (inLexique, operand_5084->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)) ;
