...
//                    november 14th, 2009, at 17h40'41"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_pic18BootloaderSpecificationAnalysis (C_Compiler & inLexique,
  ...
  var_cas_outListFileContents.appendCString ("\n"
    "\n") ;
  const GGS_bool cond_2364 = (var_cas_inReservedRomSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (40))).operator_supOrEqual (var_cas_outPiccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (40)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (40))) ;
  if (cond_2364.isBuiltAndTrue ()) {
  ...
  GGS_uint  var_cas_entryPointAddress = GGS_uint (4U) ;
  {
    ...
    while (((operand_4012 = enumerator_4012.nextObject ()))) {
      ...
      const GGS_bool cond_4144 = var_cas_routineNameSet.reader_hasKey (operand_4012->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (73))) ;
      if (cond_4144.isBuiltAndTrue ()) {
      ...
      var_cas_routineNameSet.addAssign_operation (operand_4012->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76))) ;
      var_cas_outListFileContents.dotAssign_operation (operand_4012->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (77)).reader_stringByLeftPadding (GGS_uint (40U), GGS_char (TO_UNICODE (' ')))) ;
      var_cas_outListFileContents.appendCString (" ") ;
      ...
      const GGS_bool cond_4454 = (var_cas_entryPointAddress).operator_isEqual (GGS_uint (8U)) ;
      if (cond_4454.isBuiltAndTrue ()) {
        var_cas_entryPointAddress = GGS_uint (12U) ;
      }else if (cond_4454.isBuiltAndFalse ()) {
        const GGS_bool cond_4527 = (var_cas_entryPointAddress).operator_isEqual (GGS_uint (24U)) ;
        if (cond_4527.isBuiltAndTrue ()) {
  ...
  var_cas_entryPointAddress = var_cas_inReservedRomSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
  {
    ...
    while (((operand_5084 = enumerator_5084.nextObject ()))) {
      ...
      const GGS_bool cond_5216 = var_cas_routineNameSet.reader_hasKey (operand_5084->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93))) ;
      ...
      var_cas_routineNameSet.addAssign_operation (operand_5084->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96))) ;
      var_cas_outListFileContents.dotAssign_operation (operand_5084->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (97)).reader_stringByLeftPadding (GGS_uint (40U), GGS_char (TO_UNICODE (' ')))) ;
      var_cas_outListFileContents.appendCString (" ") ;
