...
pr_parse_bootloader_pic18_bootloader_syntax_45_23_ (piccolo_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_tokenString (var_cas_outBootloaderName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  inLexique._assignFromAttribute_tokenString (var_cas_outDeviceName) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_pic18_bootloader_syntax_0 (inLexique)) {
        ...
        case 3 : {
          ...
          inLexique._assignFromAttribute_uint32value (var_cas_rs) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if (((var_cas_outReservedRomSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (75)))._operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("ROM size already defined") COMMA_SOURCE_FILE_AT_LINE (77)) ;
          }else if (((var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (77)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("ROM size should be > 0") COMMA_SOURCE_FILE_AT_LINE (79)) ;
          }else if (((var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (79))._modulo_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (79)))._operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("ROM size should be a multiple of 8") COMMA_SOURCE_FILE_AT_LINE (81)) ;
          }else{
        ...
        case 4 : {
          ...
          inLexique._assignFromAttribute_uint32value (var_cas_rs) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_outBootloaderReservedRAMmap.reader_hasKey (inLexique, var_cas_bankName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) COMMA_SOURCE_FILE_AT_LINE (89))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("RAM size already defined for '"))._operator_concat (var_cas_bankName))._operator_concat (GGS_string ("' bank")) COMMA_SOURCE_FILE_AT_LINE (91)) ;
          }else if (((var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (91)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("RAM size should be > 0") COMMA_SOURCE_FILE_AT_LINE (93)) ;
          }else{
            var_cas_outBootloaderReservedRAMmap.modifier_insertKey (inLexique, var_cas_bankName, var_cas_rs COMMA_SOURCE_FILE_AT_LINE (94)) ;
          }
          } break ;
        default :
...
void pic18_bootloader_syntax::
pr_start_symbol_pic18_bootloader_syntax_134_19_ (piccolo_lexique & inLexique) {
  ...
  var_cas_listingFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (162)))._operator_concat (GGS_string (".list")) ;
  if ((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U)))._operator_and (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (163))))).isBuiltAndTrue ()) {
    GGS_bool automatic_var_0 ;
    const GGS_string _temp_5218 = var_cas_listFileContents ;
    if (_temp_5218.isBuilt ()) {
      _temp_5218 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listingFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (164)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_listingFile COMMA_SOURCE_FILE_AT_LINE (167)) ;
  }
}
...
void pic18_bootloader_syntax::
pr_start_symbol_pic18_bootloader_syntax_134_19_importBootloaderSpecification (piccolo_lexique & inLexique,
                                GGS_piccoloDeviceModel &var_cas_outPiccoloDeviceModel,
                                GGS_uint  &var_cas_outAccessBankSplitOffset,
                                GGS_ramBankTable  &var_cas_outRamBank,
                                GGS_registerTable  &var_cas_outRegisterTable,
...
void pic18_bootloader_syntax::
pr_routine_declaration_pic18_bootloader_syntax_201_26_ (piccolo_lexique & inLexique,
      ...
      switch (select_pic18_bootloader_syntax_5 (inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (227)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_pic18_bootloader_syntax_6 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (242)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (249)) ;
          }
          var_cas_preservesBank = GGS_bool (false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (inLexique, GGS_uint ::constructor_max (inLexique COMMA_HERE), GGS_location (inLexique) COMMA_HERE) ;
          } break ;
