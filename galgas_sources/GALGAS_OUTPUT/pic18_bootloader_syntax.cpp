...
void cParser_pic_31__38__5F_bootloader_5F_syntax::rule_pic_31__38__5F_bootloader_5F_syntax_parse_5F_bootloader_i0_ (GALGAS_lstring & outArgument_outBootloaderName,
  ...
  outArgument_outReservedRomSize = GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (51)) ;
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      ...
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, outArgument_outReservedRomSize.reader_uint (SOURCE_FILE_AT_LINE (59)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_1) {
        ...
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_rs.reader_uint (SOURCE_FILE_AT_LINE (61)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_rs.reader_uint (SOURCE_FILE_AT_LINE (63)).modulo_operation (GALGAS_uint ((uint32_t) 8U), inCompiler COMMA_SOURCE_FILE_AT_LINE (63)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_5) {
    ...
    case 4: {
      ...
      if (kBoolTrue == test_7) {
        ...
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_rs.reader_uint (SOURCE_FILE_AT_LINE (75)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_9) {
...
void cParser_pic_31__38__5F_bootloader_5F_syntax::rule_pic_31__38__5F_bootloader_5F_syntax_start_5F_symbol_i1_ (C_Lexique_piccolo_5F_lexique * inCompiler) {
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (147)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_ouputListingFile.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (147)).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
