    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_pic18_bootloader_syntax_0 (inLexique)) {
        ...
        case 3 : {
          ...
          const GGS_bool cond_2644 = (var_cas_outReservedRomSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (75))).operator_isNotEqual (GGS_uint (0U)) ;
          if (cond_2644.isBuiltAndTrue ()) {
          ...
          }else if (cond_2644.isBuiltAndFalse ()) {
            const GGS_bool cond_2717 = (var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (77))).operator_isEqual (GGS_uint (0U)) ;
            ...
            }else if (cond_2717.isBuiltAndFalse ()) {
              const GGS_bool cond_2809 = (var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (79)).modulo_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (79))).operator_isNotEqual (GGS_uint (0U)) ;
        ...
        case 4 : {
          ...
          inLexique.assignFromAttribute_uint32value (var_cas_rs) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          const GGS_bool cond_3104 = var_cas_outBootloaderReservedRAMmap.reader_hasKey (inLexique, var_cas_bankName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) COMMA_SOURCE_FILE_AT_LINE (89)) ;
          if (cond_3104.isBuiltAndTrue ()) {
            var_cas_rs.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("RAM size already defined for '")).operator_concat (var_cas_bankName)).operator_concat (GGS_string ("' bank")) COMMA_SOURCE_FILE_AT_LINE (91)) ;
          }else if (cond_3104.isBuiltAndFalse ()) {
            const GGS_bool cond_3176 = (var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (GGS_uint (0U)) ;
            if (cond_3176.isBuiltAndTrue ()) {
            ...
            }else if (cond_3176.isBuiltAndFalse ()) {
...
pr_start_symbol_pic18_bootloader_syntax_134_19_ (piccolo_lexique & inLexique) {
  ...
  GGS_string var_cas_listingFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (162))).operator_concat (GGS_string (".list")) ;
  const GGS_bool cond_5243 = ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (gOption_piccolo_5F_options_ouputListingFile.value ()) ;
  if (cond_5243.isBuiltAndTrue ()) {
    GGS_bool automatic_var_0 ;
    const GGS_string temp_5218 = var_cas_listFileContents ;
    if (temp_5218.isBuilt ()) {
      temp_5218 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listingFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (164)) ;
    }
  }
  const GGS_bool cond_5335 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_strictSup (GGS_uint (0U)) ;
    ...
    case 2 : {
      ...
      switch (select_pic18_bootloader_syntax_5 (inLexique)) {
        case 1 : {
          ...
          const GGS_bool cond_6927 = var_cas_noreturn ;
          if (cond_6927.isBuiltAndTrue ()) {
        ...
        case 2 : {
          ...
          switch (select_pic18_bootloader_syntax_6 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              const GGS_bool cond_7425 = var_cas_noreturn ;
              if (cond_7425.isBuiltAndTrue ()) {
        ...
        case 3 : {
          ...
          inLexique.assignFromAttribute_uint32value (var_cas_returnedBank) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          const GGS_bool cond_7627 = var_cas_noreturn ;
          if (cond_7627.isBuiltAndTrue ()) {
