...
void pic18_bootloader_syntax::rule_pic_31__38__5F_bootloader_5F_syntax_start_5F_symbol_i1_ (C_Lexique_piccolo_5F_lexique & inLexique) {
  ...
  GGS_string var_cas_listingFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension ()).operator_concat (GGS_string (".list")) ;
  const GGS_bool cond_5283 = ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (gOption_piccolo_5F_options_ouputListingFile.reader_value ()) ;
  ...
  const GGS_bool cond_5375 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_strictSup (GGS_uint (0U)) ;
