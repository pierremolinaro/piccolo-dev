...
//                    november 26th, 2009, at 17h18'20"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_start_symbol_pic18_bootloader_syntax_135_19_ (piccolo_lexique & inLexique) {
  ...
  if (cond_5283.isBuiltAndTrue ()) {
    ...
    if (temp_5258.isBuilt ()) {
      temp_5258 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listingFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (165)) ;
    }
  }
