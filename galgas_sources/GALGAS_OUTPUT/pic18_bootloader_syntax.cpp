    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_pic18_bootloader_syntax_0 (inLexique)) {
        ...
        case 3 : {
          ...
          if (((var_cas_outReservedRomSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (75))).operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          }else if (((var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (77))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          }else if (((var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (79)).modulo_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (79))).operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        case 4 : {
          ...
          }else if (((var_cas_rs.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
...
pr_start_symbol_pic18_bootloader_syntax_134_19_ (piccolo_lexique & inLexique) {
  ...
  var_cas_listingFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (162))).operator_concat (GGS_string (".list")) ;
  if ((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (163))))).isBuiltAndTrue ()) {
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
