...
pr_parse_bootloader_pic18_bootloader_syntax_43_23_ (piccolo_lexique & _inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_pic18_bootloader_syntax_0 (_inLexique)) {
        ...
        case 3 : {
          ...
          if (((var_cas_outReservedRomSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (73)))._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "ROM size already defined") COMMA_SOURCE_FILE_AT_LINE (75)) ;
          }else if (((var_cas_rs.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (75)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "ROM size should be > 0") COMMA_SOURCE_FILE_AT_LINE (77)) ;
          }else if (((var_cas_rs.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (77))._modulo_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (77)))._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "ROM size should be a multiple of 8") COMMA_SOURCE_FILE_AT_LINE (79)) ;
          }else{
        ...
        case 4 : {
          ...
          _inLexique._assignFromAttribute_uint32value (var_cas_rs) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_outBootloaderReservedRAMmap.reader_hasKey (_inLexique, var_cas_bankName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (87)) COMMA_SOURCE_FILE_AT_LINE (87))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "RAM size already defined for '"))._operator_concat (var_cas_bankName))._operator_concat (GGS_string (true, "' bank")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
          }else if (((var_cas_rs.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (89)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_rs.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "RAM size should be > 0") COMMA_SOURCE_FILE_AT_LINE (91)) ;
          }else{
            var_cas_outBootloaderReservedRAMmap.modifier_insertKey (_inLexique, var_cas_bankName, var_cas_rs COMMA_SOURCE_FILE_AT_LINE (92)) ;
          }
          } break ;
        default :
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7D) COMMA_HERE) ;
  ::routine_pic18BootloaderSpecificationAnalysis (_inLexique,  GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE),  var_cas_outBootloaderName,  var_cas_outDeviceName,  var_cas_outBootloaderRoutineDeclarationList,  var_cas_outBootloaderReservedRAMmap,  var_cas_outReservedRomSize,  var_cas_outUserRoutineDeclarationList,  var_cas_outSharedRamDefinitionList,  var_cas_outListFileContents,  var_cas_outPiccoloDeviceModel,  var_cas_outAccessBankSplitOffset,  var_cas_outRamBank,  var_cas_outRegisterTable COMMA_SOURCE_FILE_AT_LINE (113)) ;
}
...
void pic18_bootloader_syntax::
pr_start_symbol_pic18_bootloader_syntax_132_19_ (piccolo_lexique & _inLexique) {
  ...
  var_cas_listingFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)))._operator_concat (GGS_string (true, ".list")) ;
  if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (161))))).isBuiltAndTrue ()) {
    GGS_bool automatic_var_0 ;
    const GGS_string _temp_5122 = var_cas_listFileContents ;
    if (_temp_5122._isBuilt ()) {
      _temp_5122 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_listingFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (162)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_deleteFileIfExists (_inLexique, var_cas_listingFile COMMA_SOURCE_FILE_AT_LINE (165)) ;
  }
}
...
void pic18_bootloader_syntax::
pr_start_symbol_pic18_bootloader_syntax_132_19_importBootloaderSpecification (piccolo_lexique & _inLexique,
                                GGS_piccoloDeviceModel &var_cas_outPiccoloDeviceModel,
                                GGS_uint  &var_cas_outAccessBankSplitOffset,
                                GGS_ramBankTable  &var_cas_outRamBank,
                                GGS_registerTable  &var_cas_outRegisterTable,
...
void pic18_bootloader_syntax::
pr_routine_declaration_pic18_bootloader_syntax_199_26_ (piccolo_lexique & _inLexique,
      ...
      switch (select_pic18_bootloader_syntax_5 (_inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (225)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_pic18_bootloader_syntax_6 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (240)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (247)) ;
          }
          var_cas_preservesBank = GGS_bool (true, false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
