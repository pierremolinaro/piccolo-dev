...
category_method__negateCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_45897 != NULL) {
    ...
    if (_temp_46247.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (inLexique, _temp_46247 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, (var_cas_inComplementaryBranch).operator_not (), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1355)) ;
      }
    }
  }
}
...
category_method__negateCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_46620 != NULL) {
    ...
    if (_temp_46733.isBuilt ()) {
      ...
      if (_method != NULL) {
        _method (inLexique, _temp_46733 (HERE), (var_cas_inComplementaryBranch).operator_not (), var_cas_outInstructionCount COMMA_SOURCE_FILE_AT_LINE (1374)) ;
      }
    }
  }
}
