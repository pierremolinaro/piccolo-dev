...
//                    november 14th, 2009, at 17h40'39"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__instruction_structured_if__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_50676 != NULL) {
    ...
    if (cond_52007.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_51352 = (operand_50676->mElseInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      ...
      const GGS_bool cond_51552 = (operand_50676->mThenInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    ...
    if (cond_54051.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_53379 = (operand_50676->mThenInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      ...
      const GGS_bool cond_54039 = (operand_50676->mThenInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      ...
      ::routine_handleInstructionList (inLexique,  operand_50676->mThenInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBSR,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1618)) ;
      const GGS_bool cond_55214 = (operand_50676->mElseInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_55214.isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, operand_50676->mInstructionLocation, GGS_lstring ::constructor_new (inLexique, var_cas_label_endOfIfinstruction, operand_50676->mInstructionLocation COMMA_HERE), GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
      }
      var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label_nextCondition, operand_50676->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ::routine_handleInstructionList (inLexique,  operand_50676->mElseInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_elseBranchFinalBank,  var_cas_inShouldPreserveBSR,  var_cas_elseContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1637)) ;
      const GGS_bool cond_55872 = (operand_50676->mElseInstructionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  ...
  if (operand_56384 != NULL) {
    ...
    }
    {
      ...
      while (((operand_57562 = enumerator_57562.nextObject ()))) {
        ...
        const GGS_bool cond_57929 = (operand_57562->mInstructionList.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & inLexique,
  ...
  }
  {
    ...
    while (((operand_62957 = enumerator_62957.nextObject ()))) {
      ...
      const GGS_bool cond_63584 = var_cas_routineMap.reader_hasKey (operand_62957->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1852))) ;
  ...
  }
  {
    ...
    while (((operand_63950 = enumerator_63950.nextObject ()))) {
      ...
      const GGS_bool cond_64577 = var_cas_routineMap.reader_hasKey (operand_63950->mRoutineName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1868))) ;
  ...
  }
  {
    ...
    while (((operand_65266 = enumerator_65266.nextObject ()))) {
      ...
      const GGS_bool cond_65567 = var_cas_inRegisterTable.reader_hasKey (operand_65266->mConstantName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1894))) ;
  ...
  if (cond_66618.isBuiltAndTrue ()) {
    const GGS_bool cond_66503 = var_cas_routineMap.reader_hasKey (GGS_string ("main")) ;
  ...
  const GGS_bool cond_68569 = (var_cas_tempBootloaderRoutineDeclarationList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  ...
  var_cas_entryPoint = GGS_uint (12U) ;
  GGS_uint _variant_69545 = var_cas_tempBootloaderRoutineDeclarationList.reader_length () ;
  GGS_bool _condition_69545 (_variant_69545.isBuilt (), true) ;
  while (_condition_69545.isBuiltAndTrue ()) {
    _condition_69545 = ((var_cas_tempBootloaderRoutineDeclarationList.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and ((var_cas_entryPoint).operator_strictInf (GGS_uint (24U))) ;
  ...
  if (cond_79031.isBuiltAndTrue ()) {
    ...
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    const GGS_bool cond_78443 = (var_cas_generationOptimizationMessages.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
