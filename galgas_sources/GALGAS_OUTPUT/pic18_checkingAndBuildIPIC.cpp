...
category_method__instruction_FDA__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_6381 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (inLexique, operand_6381->mInstructionLocation, operand_6381->mInstruction_FDA_base_code, var_cas_IPICregisterDescription, operand_6381->m_W_isDestination COMMA_HERE)) ;
  }
}
...
category_method__instruction_FA__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_7298 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FA ::constructor_new (inLexique, operand_7298->mInstructionLocation, operand_7298->mFAinstruction, var_cas_IPICregisterDescription COMMA_HERE)) ;
  }
}
...
category_method__instruction_MOVFF__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_8182 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_MOVFF ::constructor_new (inLexique, operand_8182->mInstructionLocation, var_cas_sourceIPICregisterDescription, var_cas_destinationIPICregisterDescription COMMA_HERE)) ;
  }
}
...
category_method__instruction_FBA__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_9315 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FBA ::constructor_new (inLexique, operand_9315->mInstructionLocation, operand_9315->mBitOrientedOp, var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
  }
}
...
category_method__instruction_JSR__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_10345 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_JSR ::constructor_new (inLexique, operand_10345->mInstructionLocation, operand_10345->mTargetLabel, operand_10345->mKind COMMA_HERE)) ;
  }
}
...
category_method__instruction_JUMP__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_12008 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, operand_12008->mInstructionLocation, operand_12008->mTargetLabel, operand_12008->mKind COMMA_HERE)) ;
  }
}
...
category_method__instruction_JUMPCC__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_13437 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_conditionalBranch ::constructor_new (inLexique, operand_13437->mInstructionLocation, var_cas_mode, operand_13437->mConditionalBranch, operand_13437->mTargetLabel COMMA_HERE)) ;
  }
}
...
category_method__instruction_CLRWDT__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_15023 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_CLRWDT ::constructor_new (inLexique, operand_15023->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__instruction_DAW__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_15680 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_DAW ::constructor_new (inLexique, operand_15680->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__instruction_NOP__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_16334 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_NOP ::constructor_new (inLexique, operand_16334->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__instruction_POP__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_16988 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_POP ::constructor_new (inLexique, operand_16988->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__instruction_PUSH__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_17643 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_PUSH ::constructor_new (inLexique, operand_17643->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__instruction_RESET__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_18300 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RESET ::constructor_new (inLexique, operand_18300->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__instruction_SLEEP__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_18958 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_SLEEP ::constructor_new (inLexique, operand_18958->mInstructionLocation COMMA_HERE)) ;
  }
}
...
category_method__instruction_literalOperation__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_19627 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_literalOperation ::constructor_new (inLexique, operand_19627->mInstructionLocation, operand_19627->mLiteralInstruction, (var_cas_result).operator_and (GGS_sint (255L)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (611)) COMMA_HERE)) ;
  }
}
...
category_method__instruction_LFSR__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_20621 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_LFSR ::constructor_new (inLexique, operand_20621->mInstructionLocation, operand_20621->mFSRindex, var_cas_result.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (642)) COMMA_HERE)) ;
  }
}
...
category_method__instruction_TBLRD__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_21730 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_TBLRD ::constructor_new (inLexique, operand_21730->mInstructionLocation, operand_21730->mOption COMMA_HERE)) ;
  }
}
...
category_method__instruction_TBLWT__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_22401 != NULL) {
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_TBLWT ::constructor_new (inLexique, operand_22401->mInstructionLocation, operand_22401->mOption COMMA_HERE)) ;
  }
}
...
category_method__instruction_computed_retlw__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_23081 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_computed_retlw ::constructor_new (inLexique, operand_23081->mInstructionLocation, var_cas_literalValues, operand_23081->mUsesRelativeCall COMMA_HERE)) ;
  }
}
...
category_method__instruction_MNOP__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_25126 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_MNOP ::constructor_new (inLexique, operand_25126->mInstructionLocation, operand_25126->mOccurrenceFactor COMMA_HERE)) ;
  }
}
...
category_method__instruction_computed_bra__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_25955 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_computed_bra ::constructor_new (inLexique, operand_25955->mInstructionLocation, operand_25955->mTargetLabels, operand_25955->mUsesRelativeCall COMMA_HERE)) ;
  }
}
...
category_method__instruction_computed_goto__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_29588 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_computed_goto ::constructor_new (inLexique, operand_29588->mInstructionLocation, operand_29588->mTargetLabels, operand_29588->mUsesRelativeCall COMMA_HERE)) ;
  }
}
...
category_method__instruction_computed_rcall__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_32002 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_computed_rcall ::constructor_new (inLexique, operand_32002->mInstructionLocation, operand_32002->mTargetLabels, var_cas_label0, operand_32002->mUsesRelativeCall COMMA_HERE)) ;
  }
}
...
category_method__instruction_FOREVER__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_35499 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label0, operand_35499->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
...
category_method__instruction_IF_FA_SEMI_COLON__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_37268 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FA ::constructor_new (inLexique, operand_37268->mInstructionLocation, var_cas_baseCode, var_cas_IPICregisterDescription COMMA_HERE)) ;
...
category_method__instruction_IF_BitTest__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_38828 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_BitTestSkip ::constructor_new (inLexique, operand_38828->mInstructionLocation, operand_38828->mSkipIfSet, var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
    GGS_bool var_cas_unusedContinuesInSequence ;
    var_cas_unusedContinuesInSequence = GGS_bool (true) ;
...
category_method__registerTestCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_44682 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_jump_test_register ::constructor_new (inLexique, var_cas_inInstructionLocation, var_cas_IPICregisterDescription, var_cas_inTargetLabel, (operand_44682->mBranchIfZero).operator_xor (var_cas_inComplementaryBranch), GGS_bool (true) COMMA_HERE)) ;
  }
}
...
category_method__bitTest_in_structured_if_condition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_49272 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_BitTestSkip ::constructor_new (inLexique, var_cas_inInstructionLocation, (operand_49272->mBTFSSinstruction).operator_xor (var_cas_inComplementaryBranch), var_cas_IPICregisterDescription, var_cas_bitNumber COMMA_HERE)) ;
...
category_method__instruction_structured_if__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_50677 != NULL) {
    ...
    if ((var_cas_generateComplementaryCondition).isBuiltAndTrue ()) {
      ...
      var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label_nextCondition, operand_50677->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ...
      if (((operand_50677->mThenInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1598))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_label_endOfIfinstruction, operand_50677->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
    }else{
      GGS_string var_cas_label_nextCondition ;
...
category_method__instruction_do_while__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_56385 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_labelInstructionBegin, operand_56385->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    GGS_uint  var_cas_finalBank ;
    var_cas_finalBank = var_cas_ioCurrentBank ;
    ...
    }
    {
      ...
      while (((operand_57563 = enumerator_57563.nextObject ()))) {
        ...
        if (((operand_57563->mInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1705))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_nextBranchLabel, operand_56385->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
        }
      }
    }
  }
...
category_method__instruction_IF_IncDec__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_59317 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (inLexique, operand_59317->mInstructionLocation, var_cas_baseCode, var_cas_IPICregisterDescription, operand_59317->m_W_isDestination COMMA_HERE)) ;
    GGS_bool var_cas_unusedContinuesInSequence ;
    var_cas_unusedContinuesInSequence = GGS_bool (true) ;
...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & inLexique,
  ...
  var_cas_entryPoint = GGS_uint (4U) ;
  {
    ...
    while (((operand_66880 = enumerator_66880.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_66880->mRoutineName COMMA_HERE)) ;
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1937)) ;
  {
    ...
    while (((operand_67422 = enumerator_67422.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, GGS_location (inLexique), operand_67422->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
  ...
  var_cas_entryPoint = GGS_uint (28U) ;
  {
    ...
    while (((operand_70031 = enumerator_70031.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, GGS_location (inLexique), operand_70031->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
    ...
    var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_low_interrupt"), GGS_location (inLexique) COMMA_HERE) COMMA_HERE)) ;
    {
      ...
      while (((operand_70522 = enumerator_70522.nextObject ()))) {
        ...
        if (((operand_70522->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1989))).operator_isEqual (GGS_string ("low"))).isBuiltAndTrue ()) {
          ...
          var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RETFIE ::constructor_new (inLexique, GGS_location (inLexique), operand_70522->mFastReturn COMMA_HERE)) ;
        }
      }
    }
  }
  ...
  }
  {
    ...
    while (((operand_72700 = enumerator_72700.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_72700->mRoutineName COMMA_HERE)) ;
      ...
      if (((operand_72700->mIsNoReturn).operator_not ()).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (inLexique, operand_72700->mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (2076)) COMMA_HERE)) ;
      }
    }
  }
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2168)) ;
  {
    ...
    while (((operand_77304 = enumerator_77304.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_77304->mRoutineName COMMA_HERE)) ;
      if ((operand_77304->mIsNoReturn).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, GGS_location (inLexique), operand_77304->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
        ...
        var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_MOVLB ::constructor_new (inLexique, GGS_location (inLexique), operand_77304->mReturnedBank COMMA_HERE)) ;
      }
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE)) ;
