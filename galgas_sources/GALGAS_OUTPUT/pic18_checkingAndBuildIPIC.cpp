...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  }
  {
    ...
    while (((operand_62207 = enumerator_62207.nextObject ()))) {
      ...
      if ((((operand_62207->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1841)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_62207->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1841)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_62207->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1843)) ;
      }
      if ((((operand_62207->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1844)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_62207->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1844)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_62207->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1846)) ;
      }
    ...
    while (((operand_62958 = enumerator_62958.nextObject ()))) {
      ...
      if ((var_cas_routineMap.reader_hasKey (_inLexique, operand_62958->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1852)) COMMA_SOURCE_FILE_AT_LINE (1852))).isBuiltAndTrue ()) {
        ...
        if ((((((var_cas_isNoReturn)._operator_isNotEqual (operand_62958->mIsNoReturn))._operator_or ((var_cas_requiredBank)._operator_isNotEqual (operand_62958->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1858)))))._operator_or ((var_cas_returnedBank)._operator_isNotEqual (operand_62958->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1858)))))._operator_or ((var_cas_preservesBank)._operator_isNotEqual (operand_62958->mPreservesBank))).isBuiltAndTrue ()) {
          var_cas_routineMap.reader_locationForKey (_inLexique, operand_62958->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1859)) COMMA_SOURCE_FILE_AT_LINE (1859)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_62958->mRoutineName))._operator_concat (GGS_string (true, "' routine header does not conform to its declaration in bootloader specification")) COMMA_SOURCE_FILE_AT_LINE (1860)) ;
        }
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The bootloader specification requires the implementation to define the '"))._operator_concat (operand_62958->mRoutineName))._operator_concat (GGS_string (true, "' routine")) COMMA_SOURCE_FILE_AT_LINE (1863)) ;
      }
    }
  }
  {
    ...
    while (((operand_63951 = enumerator_63951.nextObject ()))) {
      ...
      if ((var_cas_routineMap.reader_hasKey (_inLexique, operand_63951->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1868)) COMMA_SOURCE_FILE_AT_LINE (1868))).isBuiltAndTrue ()) {
        ...
        if ((((((var_cas_isNoReturn)._operator_isNotEqual (operand_63951->mIsNoReturn))._operator_or ((var_cas_requiredBank)._operator_isNotEqual (operand_63951->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1874)))))._operator_or ((var_cas_returnedBank)._operator_isNotEqual (operand_63951->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1874)))))._operator_or ((var_cas_preservesBank)._operator_isNotEqual (operand_63951->mPreservesBank))).isBuiltAndTrue ()) {
          var_cas_routineMap.reader_locationForKey (_inLexique, operand_63951->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1875)) COMMA_SOURCE_FILE_AT_LINE (1875)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_63951->mRoutineName))._operator_concat (GGS_string (true, "' routine header does not conform to its declaration in bootloader specification")) COMMA_SOURCE_FILE_AT_LINE (1876)) ;
        }
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The bootloader specification requires the implementation to define the '"))._operator_concat (operand_63951->mRoutineName))._operator_concat (GGS_string (true, "' routine")) COMMA_SOURCE_FILE_AT_LINE (1879)) ;
      }
    }
  }
  ...
  if (((var_cas_inProgramKind)._operator_isNotEqual (GGS_programKind::constructor_regularProgram (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    ...
    var_cas_bootloaderSizeString = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "BOOTLOADER_SIZE"), GGS_location (_inLexique) COMMA_HERE) ;
  ...
  }
  {
    ...
    while (((operand_65267 = enumerator_65267.nextObject ()))) {
      ...
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_65267->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1894)) COMMA_SOURCE_FILE_AT_LINE (1894))).isBuiltAndTrue ()) {
        operand_65267->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_65267->mConstantName))._operator_concat (GGS_string (true, "' is already declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1896)) ;
      }else{
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1901)))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inProgramKind)._operator_isNotEqual (GGS_programKind::constructor_userProgram (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (1909))).isBuiltAndTrue ()) {
      ...
      if (_temp_66097._isBuilt ()) {
        _temp_66097 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
      }
      if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1915)) ;
      }
      if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1918)) ;
      }
    }else{
  ...
  var_cas_entryPoint = GGS_uint (true, 4U) ;
  {
    ...
    while (((operand_66880 = enumerator_66880.nextObject ()))) {
      ...
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1929)) ;
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1937)) ;
  {
    ...
    while (((operand_67422 = enumerator_67422.nextObject ()))) {
      ...
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1941)) ;
    }
  }
  if (((var_cas_inProgramKind)._operator_isNotEqual (GGS_programKind::constructor_userProgram (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1950)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
  ...
  GGS_bool _condition_69546 (_variant_69546._isBuilt (), true) ;
  while (_condition_69546.isBuiltAndTrue ()) {
    _condition_69546 = ((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1964)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_entryPoint)._operator_strictInf (GGS_uint (true, 24U))) ;
    if (_condition_69546.isBuiltAndTrue ()) {
      if (_variant_69546.uintValue () == 0) {
        ...
        _condition_69546 = GGS_bool (true, false) ;
      }else{
        ...
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_routineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
        var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1970)) ;
      }
    }
  }
  ...
  var_cas_entryPoint = GGS_uint (true, 28U) ;
  {
    ...
    while (((operand_70031 = enumerator_70031.nextObject ()))) {
      ...
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1982)) ;
    }
  }
  ...
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_low_interrupt"), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE)) ;
    {
      ...
      while (((operand_70522 = enumerator_70522.nextObject ()))) {
        ...
        if (((operand_70522->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1989)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          ...
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_70522->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2008)) ;
          }
  ...
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_high_interrupt"), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE)) ;
    {
      ...
      while (((operand_71689 = enumerator_71689.nextObject ()))) {
        ...
        if (((operand_71689->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2018)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          GGS_bool var_cas_continuesInSequence ;
          GGS_uint  var_cas_currentBank ;
          var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          ...
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_71689->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2037)) ;
          }
  ...
  }
  {
    ...
    while (((operand_72700 = enumerator_72700.nextObject ()))) {
      ...
      if (((operand_72700->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
        operand_72700->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2073)) ;
      }
  ...
  if (_temp_74307._isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_74307 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (2083)) ;
    }
  }
  ...
  if (_temp_74644._isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_74644 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_24 COMMA_SOURCE_FILE_AT_LINE (2093)) ;
    }
  }
  ...
  if (_temp_74981._isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_74981 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (2103)) ;
    }
  }
  ...
  if (_temp_75318._isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_75318 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (2113)) ;
    }
  }
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2168)) ;
  {
    ...
    while (((operand_77304 = enumerator_77304.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, GGS_location (_inLexique) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (2178)) ;
    }
  }
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2181)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2182))) ;
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2183))) ;
    var_cas_ioListFileContents.writeString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2184))) ;
    var_cas_ioListFileContents.writeString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2185)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_currentAddress = GGS_uint (true, 0U) ;
    {
      ...
      while (((operand_78605 = enumerator_78605.nextObject ()))) {
        ...
        if (_temp_78646._isBuilt ()) {
          _temp_78646 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2194)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2195)).reader_stringByLeftPadding (_inLexique, GGS_uint (true, 5U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2195))) ;
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_ipic18_instruction  _temp_78791 = operand_78605->mInstruction ;
        if (_temp_78791._isBuilt ()) {
