...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_61569 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1830)), true) ;
    const GGS_routineDefinitionList::cElement * operand_61569 = NULL ;
    while (((operand_61569 = enumerator_61569.nextObject ()))) {
      macroValidPointer (operand_61569) ;
      if ((((operand_61569->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1831)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_61569->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1831)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_61569->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1833)) ;
      }
      if ((((operand_61569->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1834)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_61569->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1834)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_61569->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1836)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_61569->mRoutineName, operand_61569->mIsNoReturn, operand_61569->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1837)), operand_61569->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1837)), operand_61569->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1837)) ;
    }
  }
  {
    GGS_routineDeclarationList::cEnumerator enumerator_62139 (var_cas_inUserRoutineDeclarationList, true) ;
    const GGS_routineDeclarationList::cElement * operand_62139 = NULL ;
    while (((operand_62139 = enumerator_62139.nextObject ()))) {
      macroValidPointer (operand_62139) ;
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_62139->mRoutineName, operand_62139->mIsNoReturn, operand_62139->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1840)), operand_62139->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1840)), operand_62139->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1840)) ;
    }
  }
  {
    GGS_routineDeclarationList::cEnumerator enumerator_62469 (var_cas_inBootloaderRoutineDeclarationList, true) ;
    const GGS_routineDeclarationList::cElement * operand_62469 = NULL ;
    while (((operand_62469 = enumerator_62469.nextObject ()))) {
      macroValidPointer (operand_62469) ;
      if ((var_cas_routineMap.reader_hasKey (_inLexique, operand_62469->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1845)) COMMA_SOURCE_FILE_AT_LINE (1845))).isBuiltAndTrue ()) {
        GGS_bool var_cas_isNoReturn ;
        GGS_uint  var_cas_requiredBank ;
        GGS_uint  var_cas_returnedBank ;
        GGS_bool var_cas_preservesBank ;
        const GGS_routineMap  _temp_62662 = var_cas_routineMap ;
        if (_temp_62662._isBuilt ()) {
          _temp_62662 (HERE)->method_searchKey (_inLexique, operand_62469->mRoutineName, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (1850)) ;
        }
        if ((((((var_cas_isNoReturn)._operator_isNotEqual (operand_62469->mIsNoReturn))._operator_or ((var_cas_requiredBank)._operator_isNotEqual (operand_62469->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1851)))))._operator_or ((var_cas_returnedBank)._operator_isNotEqual (operand_62469->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1851)))))._operator_or ((var_cas_preservesBank)._operator_isNotEqual (operand_62469->mPreservesBank))).isBuiltAndTrue ()) {
          var_cas_routineMap.reader_locationForKey (_inLexique, operand_62469->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1852)) COMMA_SOURCE_FILE_AT_LINE (1852)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_62469->mRoutineName))._operator_concat (GGS_string (true, "' routine header does not conform to its declaration in bootloader specification")) COMMA_SOURCE_FILE_AT_LINE (1853)) ;
        }
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The bootloader specification requires the implementation to define the '"))._operator_concat (operand_62469->mRoutineName))._operator_concat (GGS_string (true, "' routine")) COMMA_SOURCE_FILE_AT_LINE (1856)) ;
      }
    }
  }
  ...
  {
    GGS_constantDefinitionList::cEnumerator enumerator_63353 (var_cas_inPiccoloModel.reader_mConstantDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1860)), true) ;
    const GGS_constantDefinitionList::cElement * operand_63353 = NULL ;
    while (((operand_63353 = enumerator_63353.nextObject ()))) {
      macroValidPointer (operand_63353) ;
      GGS_sint  var_cas_result ;
      const GGS_immediatExpression  _temp_63432 = operand_63353->mExpression ;
      if (_temp_63432._isBuilt ()) {
        typeCategoryMethod__immediatExpression__eval _method = findCategoryMethod__immediatExpression__eval (_temp_63432._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_63432 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1861)) ;
        }
      }
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_63353->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1862)) COMMA_SOURCE_FILE_AT_LINE (1862))).isBuiltAndTrue ()) {
        operand_63353->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_63353->mConstantName))._operator_concat (GGS_string (true, "' is alreday declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1864)) ;
      }else{
        var_cas_constantMap.modifier_insertKey (_inLexique, operand_63353->mConstantName, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1865)) ;
      }
    }
  }
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1869)))).isBuiltAndTrue ()) {
    ::routine_print_constant_definition (_inLexique,  var_cas_constantMap,  var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1870)) ;
  }
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (1876))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_13 ;
    GGS_bool automatic_var_14 ;
    const GGS_routineMap  _temp_64121 = var_cas_routineMap ;
    if (_temp_64121._isBuilt ()) {
      _temp_64121 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1879)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1882)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1885)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (1887)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (1888)) ;
  }
  ...
  var_cas_tempBootloaderRoutineDeclarationList = var_cas_inBootloaderRoutineDeclarationList ;
  if (((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1896)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_tempBootloaderRoutineDeclarationList.modifier_popFirst (_inLexique, var_cas_routineName, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1899)) ;
  ...
  GGS_uint _variant_66411 = var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1909)) ;
  GGS_bool _condition_66411 (_variant_66411._isBuilt (), true) ;
  while (_condition_66411.isBuiltAndTrue ()) {
    _condition_66411 = ((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1910)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_entryPoint)._operator_strictInf (GGS_uint (true, 24U))) ;
    if (_condition_66411.isBuiltAndTrue ()) {
      if (_variant_66411.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1917)) ;
        _condition_66411 = GGS_bool (true, false) ;
      }else{
        _variant_66411._decrement_operation (_inLexique COMMA_HERE) ;
        ...
        var_cas_tempBootloaderRoutineDeclarationList.modifier_popFirst (_inLexique, var_cas_routineName, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (1914)) ;
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_routineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
        var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1916)) ;
      }
    }
  }
  ...
  {
    GGS_routineDeclarationList::cEnumerator enumerator_66865 (var_cas_tempBootloaderRoutineDeclarationList, true) ;
    const GGS_routineDeclarationList::cElement * operand_66865 = NULL ;
    while (((operand_66865 = enumerator_66865.nextObject ()))) {
      macroValidPointer (operand_66865) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), operand_66865->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1928)) ;
    }
  }
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_67296 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1933)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_67296 = NULL ;
      while (((operand_67296 = enumerator_67296.nextObject ()))) {
        macroValidPointer (operand_67296) ;
        if (((operand_67296->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1934)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          ...
          ::routine_handleInstructionList (_inLexique,  operand_67296->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_67296->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1937)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_67296->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1953)) ;
          }
          var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETFIE ::constructor_new (_inLexique, GGS_location (_inLexique), operand_67296->mFastReturn COMMA_HERE)) ;
        }
      }
    }
  }
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_68440 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1962)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_68440 = NULL ;
      while (((operand_68440 = enumerator_68440.nextObject ()))) {
        macroValidPointer (operand_68440) ;
        if (((operand_68440->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1963)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          GGS_bool var_cas_continuesInSequence ;
          GGS_uint  var_cas_currentBank ;
          var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          ::routine_handleInstructionList (_inLexique,  operand_68440->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_68440->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1966)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_68440->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1982)) ;
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_69451 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1989)), true) ;
    const GGS_routineDefinitionList::cElement * operand_69451 = NULL ;
    while (((operand_69451 = enumerator_69451.nextObject ()))) {
      macroValidPointer (operand_69451) ;
      GGS_bool var_cas_continuesInSequence ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = operand_69451->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1991)) ;
      GGS_routineKind var_cas_routineKind ;
      if ((operand_69451->mIsNoReturn).isBuiltAndTrue ()) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_69451->mRoutineName COMMA_HERE)) ;
      ::routine_handleInstructionList (_inLexique,  operand_69451->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  operand_69451->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (1999)) ;
      if (((((operand_69451->mIsNoReturn)._operator_not ())._operator_and ((operand_69451->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2013)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_69451->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2013))))).isBuiltAndTrue ()) {
        operand_69451->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set BSR to "))._operator_concat (operand_69451->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2014)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2014))) COMMA_SOURCE_FILE_AT_LINE (2015)) ;
      }
      if (((operand_69451->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
        operand_69451->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2018)) ;
      }
      if (((operand_69451->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, operand_69451->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2021)) COMMA_HERE)) ;
      }
    }
  }
  ...
  const GGS_registerExpression  _temp_71058 = var_cas_WREGregister ;
  if (_temp_71058._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_71058._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_71058 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (2028)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_71395 = var_cas_TOSLregister ;
  if (_temp_71395._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_71395._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_71395 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_24 COMMA_SOURCE_FILE_AT_LINE (2038)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_71732 = var_cas_TOSHregister ;
  if (_temp_71732._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_71732._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_71732 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (2048)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_72069 = var_cas_TOSUregister ;
  if (_temp_72069._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_72069._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_72069 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (2058)) ;
    }
  }
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2066))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2075))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2078)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2078)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), var_cas_WREG_IPICregisterDescription, GGS_bool (true, true) COMMA_HERE)) ;
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2113)) ;
  {
    GGS_routineDeclarationList::cEnumerator enumerator_74028 (var_cas_inUserRoutineDeclarationList, true) ;
    const GGS_routineDeclarationList::cElement * operand_74028 = NULL ;
    while (((operand_74028 = enumerator_74028.nextObject ()))) {
      macroValidPointer (operand_74028) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_74028->mRoutineName COMMA_HERE)) ;
      if ((operand_74028->mIsNoReturn).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), operand_74028->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
      }else if (((operand_74028->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2119)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_MOVLB ::constructor_new (_inLexique, GGS_location (_inLexique), operand_74028->mReturnedBank COMMA_HERE)) ;
      }
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, GGS_location (_inLexique) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (2123)) ;
    }
  }
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2126)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2127))) ;
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2128))) ;
    var_cas_ioListFileContents.writeString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2129))) ;
    var_cas_ioListFileContents.writeString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2130)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_ipic18_instructionList::cEnumerator enumerator_75329 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_ipic18_instructionList::cElement * operand_75329 = NULL ;
      while (((operand_75329 = enumerator_75329.nextObject ()))) {
        macroValidPointer (operand_75329) ;
        const GGS_ipic18_instruction  _temp_75370 = operand_75329->mInstruction ;
        if (_temp_75370._isBuilt ()) {
          _temp_75370 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2139)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2140)).reader_stringByLeftPadding (_inLexique, GGS_uint (true, 5U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2140))) ;
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_ipic18_instruction  _temp_75515 = operand_75329->mInstruction ;
        if (_temp_75515._isBuilt ()) {
          _temp_75515 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2141)) ;
        }
        var_cas_ioListFileContents.writeString ("\n") ;
        var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2143)) ;
      }
    }
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("Minimum code size without optimization: ") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2146))) ;
