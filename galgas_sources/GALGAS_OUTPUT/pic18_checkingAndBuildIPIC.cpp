...
//                    november 26th, 2009, at 17h18'21"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__instruction_do_while__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_56390 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_labelInstructionBegin, operand_56390->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    GGS_uint  var_cas_finalBank = var_cas_ioCurrentBank ;
    ...
    }
    {
      ...
      while (((operand_57568 = enumerator_57568.nextObject ()))) {
        ...
        if (cond_57935.isBuiltAndTrue ()) {
          ...
          var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_nextBranchLabel, operand_56390->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
        }
      }
    }
  }
...
category_method__instruction_IF_IncDec__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_59322 != NULL) {
    ...
    if (temp_60186.isBuilt ()) {
      ...
      if (method != NULL) {
        method (inLexique, temp_60186 (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_12 COMMA_SOURCE_FILE_AT_LINE (1782)) ;
      }
    }
    var_cas_ioGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (inLexique, operand_59322->mInstructionLocation, var_cas_baseCode, var_cas_IPICregisterDescription, operand_59322->m_W_isDestination COMMA_HERE)) ;
    GGS_bool var_cas_unusedContinuesInSequence = GGS_bool (true) ;
...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & inLexique,
  ...
  }
  {
    ...
    while (((operand_62212 = enumerator_62212.nextObject ()))) {
      ...
      const GGS_bool cond_62426 = ((operand_62212->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1841))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((operand_62212->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1841))).operator_strictSup (GGS_uint (15U))) ;
      ...
      const GGS_bool cond_62604 = ((operand_62212->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1844))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((operand_62212->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1844))).operator_strictSup (GGS_uint (15U))) ;
  ...
  const GGS_bool cond_65227 = (var_cas_inProgramKind).operator_isNotEqual (GGS_programKind::constructor_regularProgram (inLexique COMMA_HERE)) ;
  ...
  const GGS_bool cond_66630 = (var_cas_inProgramKind).operator_isNotEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE)) ;
  if (cond_66630.isBuiltAndTrue ()) {
    ...
    if (cond_66515.isBuiltAndTrue ()) {
      ...
      if (temp_66108.isBuilt ()) {
        temp_66108 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("main"), GGS_location (inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
      }
  ...
  GGS_uint  var_cas_entryPoint = GGS_uint (4U) ;
  {
    ...
    while (((operand_66891 = enumerator_66891.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_66891->mRoutineName COMMA_HERE)) ;
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1937)) ;
  {
    ...
    while (((operand_67433 = enumerator_67433.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, GGS_location (inLexique), operand_67433->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint.add_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (1941)) ;
    }
  }
  const GGS_bool cond_68000 = (var_cas_inProgramKind).operator_isNotEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE)) ;
  ...
  var_cas_entryPoint = GGS_uint (28U) ;
  {
    ...
    while (((operand_70042 = enumerator_70042.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, GGS_location (inLexique), operand_70042->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
    ...
    var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("_low_interrupt"), GGS_location (inLexique) COMMA_HERE) COMMA_HERE)) ;
    {
      ...
      while (((operand_70533 = enumerator_70533.nextObject ()))) {
        ...
        if (cond_71444.isBuiltAndTrue ()) {
          ...
          var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RETFIE ::constructor_new (inLexique, GGS_location (inLexique), operand_70533->mFastReturn COMMA_HERE)) ;
        }
      }
    }
  }
  ...
  }
  {
    ...
    while (((operand_72711 = enumerator_72711.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_72711->mRoutineName COMMA_HERE)) ;
      ...
      const GGS_bool cond_73637 = (((operand_72711->mIsNoReturn).operator_not ()).operator_and ((operand_72711->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2068))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)))).operator_and ((var_cas_currentBank).operator_isNotEqual (operand_72711->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2068)))) ;
      ...
      if (cond_73986.isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (inLexique, operand_72711->mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (2076)) COMMA_HERE)) ;
      }
    }
  }
  ...
  if (temp_74318.isBuilt ()) {
    ...
    if (method != NULL) {
      method (inLexique, temp_74318 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (2083)) ;
    }
  }
  ...
  if (temp_74655.isBuilt ()) {
    ...
    if (method != NULL) {
      method (inLexique, temp_74655 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_24 COMMA_SOURCE_FILE_AT_LINE (2093)) ;
    }
  }
  ...
  if (temp_74992.isBuilt ()) {
    ...
    if (method != NULL) {
      method (inLexique, temp_74992 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (2103)) ;
    }
  }
  ...
  if (temp_75329.isBuilt ()) {
    ...
    if (method != NULL) {
      method (inLexique, temp_75329 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (2113)) ;
    }
  }
  ...
  const GGS_bool cond_77126 = (var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (inLexique COMMA_SOURCE_FILE_AT_LINE (2133))).operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (inLexique COMMA_SOURCE_FILE_AT_LINE (2133))) ;
  if (cond_77126.isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (inLexique, GGS_location (inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (inLexique COMMA_HERE), var_cas_WREG_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
  ...
  {
    GGS_routineDeclarationList::cEnumerator enumerator_77315 (var_cas_inUserRoutineDeclarationListForBootloaderImplementation, true) ;
    const GGS_routineDeclarationList::cElement * operand_77315 = NULL ;
    while (((operand_77315 = enumerator_77315.nextObject ()))) {
      macroValidPointer (operand_77315) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_77315->mRoutineName COMMA_HERE)) ;
      const GGS_bool cond_77616 = operand_77315->mIsNoReturn ;
      if (cond_77616.isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, GGS_location (inLexique), operand_77315->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
      }else if (cond_77616.isBuiltAndFalse ()) {
        const GGS_bool cond_77758 = (operand_77315->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2174))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)) ;
        if (cond_77758.isBuiltAndTrue ()) {
          var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_MOVLB ::constructor_new (inLexique, GGS_location (inLexique), operand_77315->mReturnedBank COMMA_HERE)) ;
        }
      }
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE)) ;
  ...
  const GGS_bool cond_79049 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_79049.isBuiltAndTrue ()) {
    ...
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    const GGS_bool cond_78461 = (var_cas_generationOptimizationMessages.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_78461.isBuiltAndTrue ()) {
    ...
    {
      GGS_ipic18_instructionList::cEnumerator enumerator_78620 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_ipic18_instructionList::cElement * operand_78620 = NULL ;
      while (((operand_78620 = enumerator_78620.nextObject ()))) {
        macroValidPointer (operand_78620) ;
        const GGS_ipic18_instruction  temp_78661 = operand_78620->mInstruction ;
        if (temp_78661.isBuilt ()) {
          temp_78661 (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2194)) ;
        }
        ...
        var_cas_ioListFileContents.appendCString (": ") ;
        const GGS_ipic18_instruction  temp_78804 = operand_78620->mInstruction ;
        if (temp_78804.isBuilt ()) {
          temp_78804 (HERE)->method_displayIPICinstruction (inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2196)) ;
        }
        var_cas_ioListFileContents.appendCString ("\n") ;
