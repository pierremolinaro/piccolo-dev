...
category_method__instruction_JSR__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_10345 != NULL) {
    ...
    if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_10345->mTargetLabel)).operator_concat (GGS_string ("' requires BSR to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (333))) ;
...
category_method__instruction_JUMP__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_12008 != NULL) {
    ...
    if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_12008->mTargetLabel)).operator_concat (GGS_string ("' requires BSR to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (379))) ;
      var_cas_errorMessage.appendCString (", but BSR ") ;
      if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
...
category_method__instruction_JUMPCC__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_13437 != NULL) {
    ...
    if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_13437->mTargetLabel)).operator_concat (GGS_string ("' requires BSR to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (420))) ;
      var_cas_errorMessage.appendCString (", but BSR ") ;
      if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
  ...
  if (operand_25955 != NULL) {
    ...
    GGS_uint  var_cas_returnedBankValue = GGS_uint ::constructor_max (inLexique COMMA_HERE) ;
    {
      ...
      while (((operand_26474 = enumerator_26474.nextObject ()))) {
        ...
        if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_26474->mValue)).operator_concat (GGS_string ("' requires BSR to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (790))) ;
          var_cas_errorMessage.appendCString (", but BSR ") ;
          if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.appendCString ("does contain any reliable value") ;
          }else{
  ...
  if (operand_29588 != NULL) {
    {
      ...
      while (((operand_30007 = enumerator_30007.nextObject ()))) {
        ...
        if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_30007->mValue)).operator_concat (GGS_string ("' requires BSR to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (869))) ;
          var_cas_errorMessage.appendCString (", but BSR ") ;
          if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.appendCString ("does contain any reliable value") ;
          }else{
  ...
  if (operand_32002 != NULL) {
    ...
    GGS_uint  var_cas_returnedBankSelection = var_cas_ioCurrentBank ;
    {
      ...
      while (((operand_32532 = enumerator_32532.nextObject ()))) {
        ...
        if ((((var_cas_requiredBank).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).operator_and ((var_cas_requiredBank).operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage = (((GGS_string ("the routine '")).operator_concat (operand_32532->mValue)).operator_concat (GGS_string ("' requires BSR to be set to "))).operator_concat (var_cas_requiredBank.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (933))) ;
          var_cas_errorMessage.appendCString (", but BSR ") ;
          if (((var_cas_ioCurrentBank).operator_isEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.appendCString ("does contain any reliable value") ;
          }else{
        ...
        if (((var_cas_inShouldPreserveBSR).operator_and ((var_cas_preservesBank).operator_not ())).isBuiltAndTrue ()) {
          ...
          if (((var_cas_someReturnsBank).operator_not ()).isBuiltAndTrue ()) {
            ...
            GGS_string var_cas_errorMessage = ((GGS_string ("the '")).operator_concat (operand_32532->mValue)).operator_concat (GGS_string ("' routine returns ")) ;
...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & inLexique,
  ...
  }
  {
    ...
    while (((operand_72700 = enumerator_72700.nextObject ()))) {
      ...
      GGS_bool var_cas_continuesInSequence ;
      GGS_uint  var_cas_currentBank = operand_72700->mRequiredBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2046)) ;
