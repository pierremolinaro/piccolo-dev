...
void routine_handleInstructionList (C_Compiler & inLexique,
  ...
  var_cas_outContinuesInSequence = GGS_bool (true) ;
  {
    ...
    while (((operand_1728 = enumerator_1728.nextObject ()))) {
      ...
      { typeCategoryMethod__piccolo_instruction__buildIPICinstructionList method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (operand_1728->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_1728->mInstruction (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_outContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (52)) ;
        }
      }
    }
  }
...
category_method__instruction_savebank__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_3159 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank method = findCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank (var_cas_BSRregister.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, var_cas_BSRregister (HERE), var_cas_inRegisterTable, var_cas_BSR_IPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (108)) ;
      }
    }
    GGS_ipic_registerExpressionWithoutBSRIndication var_cas_save_IPICregisterDescription ;
    { typeCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank method = findCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank (operand_3159->mRegister.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_3159->mRegister (HERE), var_cas_inRegisterTable, var_cas_save_IPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (114)) ;
      }
    }
...
category_method__instruction_FDA__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_6379 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_6379->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_6379->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_6989_0 COMMA_SOURCE_FILE_AT_LINE (197)) ;
      }
    }
...
category_method__instruction_FA__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_7296 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_7296->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_7296->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_7906_0 COMMA_SOURCE_FILE_AT_LINE (228)) ;
      }
    }
...
category_method__instruction_MOVFF__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_8180 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank method = findCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank (operand_8180->mSourceRegisterName.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_8180->mSourceRegisterName (HERE), var_cas_inRegisterTable, var_cas_sourceIPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (258)) ;
      }
    }
    GGS_ipic_registerExpressionWithoutBSRIndication var_cas_destinationIPICregisterDescription ;
    { typeCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank method = findCategoryMethod__registerExpression__resolveAccessWithoutCheckingBank (operand_8180->mDestinationRegisterName.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_8180->mDestinationRegisterName (HERE), var_cas_inRegisterTable, var_cas_destinationIPICregisterDescription COMMA_SOURCE_FILE_AT_LINE (263)) ;
      }
    }
...
category_method__instruction_FBA__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_9313 != NULL) {
    ...
    GGS_ipic_registerExpression var_cas_IPICregisterDescription ;
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_9313->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_9313->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (291)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    { typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (operand_9313->mBitNumber.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_9313->mBitNumber (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (299)) ;
      }
    }
...
category_method__instruction_JSR__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_10343 != NULL) {
    ...
    if (var_cas_inRoutineMap.isBuilt ()) {
      var_cas_inRoutineMap (HERE)->method_searchKey (inLexique, operand_10343->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (331)) ;
    }
...
category_method__instruction_JUMP__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_12006 != NULL) {
    ...
    if (var_cas_inRoutineMap.isBuilt ()) {
      var_cas_inRoutineMap (HERE)->method_searchKey (inLexique, operand_12006->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_12557_0, automatic_var_12557_1 COMMA_SOURCE_FILE_AT_LINE (377)) ;
    }
...
category_method__instruction_JUMPCC__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_13435 != NULL) {
    ...
    if (var_cas_inRoutineMap.isBuilt ()) {
      var_cas_inRoutineMap (HERE)->method_searchKey (inLexique, operand_13435->mTargetLabel, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13975_0, automatic_var_13975_1 COMMA_SOURCE_FILE_AT_LINE (418)) ;
    }
...
category_method__instruction_literalOperation__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_19625 != NULL) {
    ...
    { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_19625->mImmediatExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_19625->mImmediatExpression (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (602)) ;
      }
    }
...
category_method__instruction_LFSR__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_20619 != NULL) {
    ...
    GGS_sint  var_cas_result ;
    { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_20619->mImmediatExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_20619->mImmediatExpression (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (634)) ;
      }
    }
...
category_method__instruction_computed_retlw__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_23077 != NULL) {
    ...
    { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_23077->mSizeExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_23077->mSizeExpression (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_size COMMA_SOURCE_FILE_AT_LINE (712)) ;
      }
    }
    ...
    GGS_uintlist  var_cas_literalValues = GGS_uintlist ::constructor_emptyList () ;
    {
      ...
      while (((operand_24511 = enumerator_24511.nextObject ()))) {
        ...
        GGS_sint  var_cas_v ;
        { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_24511->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_24511->mExpression (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_v COMMA_SOURCE_FILE_AT_LINE (723)) ;
          }
        }
  ...
  if (operand_25954 != NULL) {
    ...
    GGS_uint  var_cas_returnedBankValue = GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (781)) ;
    {
      ...
      while (((operand_26473 = enumerator_26473.nextObject ()))) {
        ...
        GGS_bool var_cas_preservesBank ;
        if (var_cas_inRoutineMap.isBuilt ()) {
          var_cas_inRoutineMap (HERE)->method_searchKey (inLexique, operand_26473->mValue, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (787)) ;
        }
    ...
    GGS_sint  var_cas_size ;
    { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_25954->mSizeExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_25954->mSizeExpression (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_size COMMA_SOURCE_FILE_AT_LINE (832)) ;
      }
    }
  ...
  if (operand_29587 != NULL) {
    {
      ...
      while (((operand_30006 = enumerator_30006.nextObject ()))) {
        ...
        if (var_cas_inRoutineMap.isBuilt ()) {
          var_cas_inRoutineMap (HERE)->method_searchKey (inLexique, operand_30006->mValue, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_30126_0, automatic_var_30126_1 COMMA_SOURCE_FILE_AT_LINE (867)) ;
        }
    ...
    GGS_sint  var_cas_size ;
    { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_29587->mSizeExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_29587->mSizeExpression (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_size COMMA_SOURCE_FILE_AT_LINE (891)) ;
      }
    }
  ...
  if (operand_32001 != NULL) {
    ...
    GGS_uint  var_cas_returnedBankSelection = var_cas_ioCurrentBank ;
    {
      ...
      while (((operand_32531 = enumerator_32531.nextObject ()))) {
        ...
        GGS_bool var_cas_preservesBank ;
        if (var_cas_inRoutineMap.isBuilt ()) {
          var_cas_inRoutineMap (HERE)->method_searchKey (inLexique, operand_32531->mValue, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (931)) ;
        }
    ...
    GGS_sint  var_cas_size ;
    { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_32001->mSizeExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_32001->mSizeExpression (HERE), var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_size COMMA_SOURCE_FILE_AT_LINE (973)) ;
      }
    }
...
category_method__instruction_IF_FA_SEMI_COLON__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_37267 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_37267->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_37267->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_38174_0 COMMA_SOURCE_FILE_AT_LINE (1065)) ;
      }
    }
    ...
    { typeCategoryMethod__piccolo_instruction__buildIPICinstructionList method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (operand_37267->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_37267->mInstruction (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1079)) ;
      }
    }
  }
}
...
category_method__instruction_IF_BitTest__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_38827 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_ipic_registerExpression var_cas_IPICregisterDescription ;
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_38827->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_38827->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (1111)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    { typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (operand_38827->mBitNumber.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_38827->mBitNumber (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (1119)) ;
      }
    }
    ...
    GGS_bool var_cas_unusedContinuesInSequence = GGS_bool (true) ;
    { typeCategoryMethod__piccolo_instruction__buildIPICinstructionList method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (operand_38827->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_38827->mInstruction (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1131)) ;
      }
    }
  }
}
...
category_method__registerComparisonCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_41971 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_41971->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_41971->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_42675_0 COMMA_SOURCE_FILE_AT_LINE (1224)) ;
      }
    }
...
category_method__incDecRegisterInCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_43502 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_43502->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_43502->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_44018_0 COMMA_SOURCE_FILE_AT_LINE (1270)) ;
      }
    }
...
category_method__registerTestCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_44681 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_44681->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_44681->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_45197_0 COMMA_SOURCE_FILE_AT_LINE (1312)) ;
      }
    }
...
category_method__negateCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_45896 != NULL) {
    { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_45896->mCondition.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_45896->mCondition (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, (var_cas_inComplementaryBranch).operator_not (), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1355)) ;
      }
    }
  }
}
...
category_method__negateCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_46619 != NULL) {
    { typeCategoryMethod__conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__conditionExpression__computeInstructionCountForCondition (operand_46619->mCondition.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_46619->mCondition (HERE), (var_cas_inComplementaryBranch).operator_not (), var_cas_outInstructionCount COMMA_SOURCE_FILE_AT_LINE (1374)) ;
      }
    }
  }
}
...
category_method__andCondition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_46927 != NULL) {
    ...
    if (cond_47844.isBuiltAndTrue ()) {
      { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_46927->mLeftExpression.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_46927->mLeftExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1394)) ;
        }
      }
      { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_46927->mRightExpression.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_46927->mRightExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1405)) ;
        }
      }
      ...
      { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_46927->mLeftExpression.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_46927->mLeftExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1418)) ;
        }
      }
      { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_46927->mRightExpression.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
...
category_method__andCondition__computeInstructionCountForCondition (C_Compiler & inLexique,
  ...
  if (operand_48755 != NULL) {
    ...
    { typeCategoryMethod__conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__conditionExpression__computeInstructionCountForCondition (operand_48755->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_48755->mLeftExpression (HERE), var_cas_inComplementaryBranch, var_cas_countLeft COMMA_SOURCE_FILE_AT_LINE (1451)) ;
      }
    }
    GGS_uint  var_cas_countRight ;
    { typeCategoryMethod__conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__conditionExpression__computeInstructionCountForCondition (operand_48755->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_48755->mLeftExpression (HERE), var_cas_inComplementaryBranch, var_cas_countRight COMMA_SOURCE_FILE_AT_LINE (1456)) ;
      }
    }
...
category_method__bitTest_in_structured_if_condition__buildIPICinstructionForCondition (C_Compiler & inLexique,
  ...
  if (operand_49271 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    GGS_ipic_registerExpression var_cas_IPICregisterDescription ;
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_49271->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_49271->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (1478)) ;
      }
    }
    GGS_uint  var_cas_bitNumber ;
    { typeCategoryMethod__bitNumberExpression__getBitNumber method = findCategoryMethod__bitNumberExpression__getBitNumber (operand_49271->mBitNumber.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_49271->mBitNumber (HERE), var_cas_bitSliceTable, var_cas_bitNumber COMMA_SOURCE_FILE_AT_LINE (1486)) ;
      }
    }
...
category_method__instruction_structured_if__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_50676 != NULL) {
    ...
    if (cond_52013.isBuiltAndTrue ()) {
      ...
      { typeCategoryMethod__conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__conditionExpression__computeInstructionCountForCondition (operand_50676->mIfCondition.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_50676->mIfCondition (HERE), GGS_bool (true), var_cas_directCount COMMA_SOURCE_FILE_AT_LINE (1526)) ;
        }
      }
      ...
      { typeCategoryMethod__conditionExpression__computeInstructionCountForCondition method = findCategoryMethod__conditionExpression__computeInstructionCountForCondition (operand_50676->mIfCondition.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_50676->mIfCondition (HERE), GGS_bool (false), var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1530)) ;
        }
      }
    ...
    if (cond_54057.isBuiltAndTrue ()) {
      ...
      { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_50676->mIfCondition.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_50676->mIfCondition (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_50676->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1553)) ;
        }
      }
      ...
      { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_50676->mIfCondition.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_50676->mIfCondition (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_50676->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1606)) ;
        }
      }
      ::routine_handleInstructionList (inLexique,  operand_50676->mThenInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBSR,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1618)) ;
    ...
    }
    {
      ...
      while (((operand_57568 = enumerator_57568.nextObject ()))) {
        ...
        if (cond_57935.isBuiltAndTrue ()) {
          { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_57568->mCondition.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_57568->mCondition (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_56390->mInstructionLocation, var_cas_labelInstructionBegin, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1706)) ;
            }
          }
          ...
          { typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (operand_57568->mCondition.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_57568->mCondition (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_56390->mInstructionLocation, var_cas_nextBranchLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1719)) ;
            }
          }
...
category_method__instruction_IF_IncDec__buildIPICinstructionList (C_Compiler & inLexique,
  ...
  if (operand_59322 != NULL) {
    ...
    { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (operand_59322->mRegisterExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_59322->mRegisterExpression (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_IPICregisterDescription, automatic_var_60295_0 COMMA_SOURCE_FILE_AT_LINE (1782)) ;
      }
    }
    ...
    GGS_bool var_cas_unusedContinuesInSequence = GGS_bool (true) ;
    { typeCategoryMethod__piccolo_instruction__buildIPICinstructionList method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (operand_59322->mInstruction.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_59322->mInstruction (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_inConstantMap, var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1798)) ;
      }
    }
  }
}
...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & inLexique,
    ...
    while (((operand_62963 = enumerator_62963.nextObject ()))) {
      ...
      if (cond_63590.isBuiltAndTrue ()) {
        ...
        if (var_cas_routineMap.isBuilt ()) {
          var_cas_routineMap (HERE)->method_searchKey (inLexique, operand_62963->mRoutineName, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (1857)) ;
        }
  ...
  }
  {
    ...
    while (((operand_63956 = enumerator_63956.nextObject ()))) {
      ...
      if (cond_64583.isBuiltAndTrue ()) {
        ...
        GGS_bool var_cas_preservesBank ;
        if (var_cas_routineMap.isBuilt ()) {
          var_cas_routineMap (HERE)->method_searchKey (inLexique, operand_63956->mRoutineName, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (1873)) ;
        }
  ...
  }
  {
    ...
    while (((operand_65272 = enumerator_65272.nextObject ()))) {
      ...
      GGS_sint  var_cas_result ;
      { typeCategoryMethod__immediatExpression__eval method = findCategoryMethod__immediatExpression__eval (operand_65272->mExpression.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_65272->mExpression (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1893)) ;
        }
      }
  ...
  if (cond_66630.isBuiltAndTrue ()) {
    ...
    if (cond_66515.isBuiltAndTrue ()) {
      ...
      if (var_cas_routineMap.isBuilt ()) {
        var_cas_routineMap (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("main"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1912)), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_66171_0, automatic_var_66171_1 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
      }
  ...
  { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (var_cas_WREGregister.galgasObjectRunTimeInfo ()) ;
    if (method != NULL) {
      method (inLexique, var_cas_WREGregister (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_74435_0 COMMA_SOURCE_FILE_AT_LINE (2083)) ;
    }
  }
  ...
  { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (var_cas_TOSLregister.galgasObjectRunTimeInfo ()) ;
    if (method != NULL) {
      method (inLexique, var_cas_TOSLregister (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_74772_0 COMMA_SOURCE_FILE_AT_LINE (2093)) ;
    }
  }
  ...
  { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (var_cas_TOSHregister.galgasObjectRunTimeInfo ()) ;
    if (method != NULL) {
      method (inLexique, var_cas_TOSHregister (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_75109_0 COMMA_SOURCE_FILE_AT_LINE (2103)) ;
    }
  }
  ...
  { typeCategoryMethod__registerExpression__resolveAccess method = findCategoryMethod__registerExpression__resolveAccess (var_cas_TOSUregister.galgasObjectRunTimeInfo ()) ;
    if (method != NULL) {
      method (inLexique, var_cas_TOSUregister (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_75446_0 COMMA_SOURCE_FILE_AT_LINE (2113)) ;
    }
  }
  ...
  if (cond_79047.isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_78618 = enumerator_78618.nextObject ()))) {
        ...
        if (operand_78618->mInstruction.isBuilt ()) {
          operand_78618->mInstruction (HERE)->method_setCurrentAddress (inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2194)) ;
        }
        ...
        var_cas_ioListFileContents.appendCString (": ") ;
        if (operand_78618->mInstruction.isBuilt ()) {
          operand_78618->mInstruction (HERE)->method_displayIPICinstruction (inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2196)) ;
        }
        var_cas_ioListFileContents.appendCString ("\n") ;
