...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_61354 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1827)), true) ;
    const GGS_routineDefinitionList::cElement * operand_61354 = NULL ;
    while (((operand_61354 = enumerator_61354.nextObject ()))) {
      macroValidPointer (operand_61354) ;
      if ((((operand_61354->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1828)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_61354->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1828)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_61354->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1830)) ;
      }
      if ((((operand_61354->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1831)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_61354->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1831)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_61354->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1833)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_61354->mRoutineName, operand_61354->mIsNoReturn, operand_61354->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1834)), operand_61354->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1834)), operand_61354->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1834)) ;
    }
  }
  GGS_constantMap  var_cas_constantMap ;
  var_cas_constantMap = GGS_constantMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    GGS_constantDefinitionList::cEnumerator enumerator_61990 (var_cas_inPiccoloModel.reader_mConstantDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1838)), true) ;
    const GGS_constantDefinitionList::cElement * operand_61990 = NULL ;
    while (((operand_61990 = enumerator_61990.nextObject ()))) {
      macroValidPointer (operand_61990) ;
      GGS_sint  var_cas_result ;
      const GGS_immediatExpression  _temp_62069 = operand_61990->mExpression ;
      if (_temp_62069._isBuilt ()) {
        typeCategoryMethod__immediatExpression__eval _method = findCategoryMethod__immediatExpression__eval (_temp_62069._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_62069 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1839)) ;
        }
      }
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_61990->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1840)) COMMA_SOURCE_FILE_AT_LINE (1840))).isBuiltAndTrue ()) {
        operand_61990->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_61990->mConstantName))._operator_concat (GGS_string (true, "' is alreday declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1842)) ;
      }else{
        var_cas_constantMap.modifier_insertKey (_inLexique, operand_61990->mConstantName, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1843)) ;
      }
    }
  }
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1847)))).isBuiltAndTrue ()) {
    ::routine_print_constant_definition (_inLexique,  var_cas_constantMap,  var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1848)) ;
  }
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (1854))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_13 ;
    GGS_bool automatic_var_14 ;
    const GGS_routineMap  _temp_62758 = var_cas_routineMap ;
    if (_temp_62758._isBuilt ()) {
      _temp_62758 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1857)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1860)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1863)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (1865)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (1866)) ;
  }
  ...
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_64108 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1880)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_64108 = NULL ;
      while (((operand_64108 = enumerator_64108.nextObject ()))) {
        macroValidPointer (operand_64108) ;
        if (((operand_64108->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1881)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          ...
          ::routine_handleInstructionList (_inLexique,  operand_64108->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_64108->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1884)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_64108->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1900)) ;
          }
          var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETFIE ::constructor_new (_inLexique, GGS_location (_inLexique), operand_64108->mFastReturn COMMA_HERE)) ;
        }
      }
    }
  }
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_65364 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1913)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_65364 = NULL ;
      while (((operand_65364 = enumerator_65364.nextObject ()))) {
        macroValidPointer (operand_65364) ;
        if (((operand_65364->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1914)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          GGS_bool var_cas_continuesInSequence ;
          GGS_uint  var_cas_currentBank ;
          var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          ::routine_handleInstructionList (_inLexique,  operand_65364->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_65364->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1917)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_65364->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1933)) ;
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_66375 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1940)), true) ;
    const GGS_routineDefinitionList::cElement * operand_66375 = NULL ;
    while (((operand_66375 = enumerator_66375.nextObject ()))) {
      macroValidPointer (operand_66375) ;
      GGS_bool var_cas_continuesInSequence ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = operand_66375->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1942)) ;
      GGS_routineKind var_cas_routineKind ;
      if ((operand_66375->mIsNoReturn).isBuiltAndTrue ()) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_66375->mRoutineName COMMA_HERE)) ;
      ::routine_handleInstructionList (_inLexique,  operand_66375->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  operand_66375->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (1950)) ;
      if (((((operand_66375->mIsNoReturn)._operator_not ())._operator_and ((operand_66375->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1964)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_66375->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1964))))).isBuiltAndTrue ()) {
        operand_66375->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set BSR to "))._operator_concat (operand_66375->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1965)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1965))) COMMA_SOURCE_FILE_AT_LINE (1966)) ;
      }
      if (((operand_66375->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
        operand_66375->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (1969)) ;
      }
      if (((operand_66375->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, operand_66375->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1972)) COMMA_HERE)) ;
      }
    }
  }
  ...
  const GGS_registerExpression  _temp_67889 = var_cas_WREGregister ;
  if (_temp_67889._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_67889._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_67889 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (1978)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_68226 = var_cas_TOSLregister ;
  if (_temp_68226._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_68226._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_68226 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (1988)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_68563 = var_cas_TOSHregister ;
  if (_temp_68563._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_68563._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_68563 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (1998)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_68900 = var_cas_TOSUregister ;
  if (_temp_68900._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_68900._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_68900 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (2008)) ;
    }
  }
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2016))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2025))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2028)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2028)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), var_cas_WREG_IPICregisterDescription, GGS_bool (true, true) COMMA_HERE)) ;
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2063)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2064))) ;
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2065))) ;
    var_cas_ioListFileContents.writeString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2066))) ;
    var_cas_ioListFileContents.writeString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2067)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_ipic18_instructionList::cEnumerator enumerator_71427 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_ipic18_instructionList::cElement * operand_71427 = NULL ;
      while (((operand_71427 = enumerator_71427.nextObject ()))) {
        macroValidPointer (operand_71427) ;
        const GGS_ipic18_instruction  _temp_71468 = operand_71427->mInstruction ;
        if (_temp_71468._isBuilt ()) {
          _temp_71468 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2076)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2077)).reader_stringByLeftPadding (_inLexique, GGS_uint (true, 5U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2077))) ;
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_ipic18_instruction  _temp_71613 = operand_71427->mInstruction ;
        if (_temp_71613._isBuilt ()) {
          _temp_71613 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2078)) ;
        }
        var_cas_ioListFileContents.writeString ("\n") ;
        var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2080)) ;
      }
    }
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("Minimum code size without optimization: ") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2083))) ;
