...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_61445 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1828)), true) ;
    const GGS_routineDefinitionList::cElement * operand_61445 = NULL ;
    while (((operand_61445 = enumerator_61445.nextObject ()))) {
      macroValidPointer (operand_61445) ;
      if ((((operand_61445->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1829)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_61445->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1829)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_61445->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1831)) ;
      }
      if ((((operand_61445->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1832)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_61445->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1832)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_61445->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1834)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_61445->mRoutineName, operand_61445->mIsNoReturn, operand_61445->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1835)), operand_61445->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1835)), operand_61445->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1835)) ;
    }
  }
  {
    GGS_routineDeclarationList::cEnumerator enumerator_62169 (var_cas_inBootloaderRoutineDeclarationList, true) ;
    const GGS_routineDeclarationList::cElement * operand_62169 = NULL ;
    while (((operand_62169 = enumerator_62169.nextObject ()))) {
      macroValidPointer (operand_62169) ;
      if ((var_cas_routineMap.reader_hasKey (_inLexique, operand_62169->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1840)) COMMA_SOURCE_FILE_AT_LINE (1840))).isBuiltAndTrue ()) {
        GGS_bool var_cas_isNoReturn ;
        GGS_uint  var_cas_requiredBank ;
        GGS_uint  var_cas_returnedBank ;
        GGS_bool var_cas_preservesBank ;
        const GGS_routineMap  _temp_62362 = var_cas_routineMap ;
        if (_temp_62362._isBuilt ()) {
          _temp_62362 (HERE)->method_searchKey (_inLexique, operand_62169->mRoutineName, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (1845)) ;
        }
        if ((((((var_cas_isNoReturn)._operator_isNotEqual (operand_62169->mIsNoReturn))._operator_or ((var_cas_requiredBank)._operator_isNotEqual (operand_62169->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1846)))))._operator_or ((var_cas_returnedBank)._operator_isNotEqual (operand_62169->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1846)))))._operator_or ((var_cas_preservesBank)._operator_isNotEqual (operand_62169->mPreservesBank))).isBuiltAndTrue ()) {
          var_cas_routineMap.reader_locationForKey (_inLexique, operand_62169->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1847)) COMMA_SOURCE_FILE_AT_LINE (1847)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_62169->mRoutineName))._operator_concat (GGS_string (true, "' routine header does not conform to its declaration in bootloader specification")) COMMA_SOURCE_FILE_AT_LINE (1848)) ;
        }
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The bootloader specification requires the implementation to define the '"))._operator_concat (operand_62169->mRoutineName))._operator_concat (GGS_string (true, "' routine")) COMMA_SOURCE_FILE_AT_LINE (1851)) ;
      }
    }
  }
  ...
  {
    GGS_constantDefinitionList::cEnumerator enumerator_63053 (var_cas_inPiccoloModel.reader_mConstantDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1855)), true) ;
    const GGS_constantDefinitionList::cElement * operand_63053 = NULL ;
    while (((operand_63053 = enumerator_63053.nextObject ()))) {
      macroValidPointer (operand_63053) ;
      GGS_sint  var_cas_result ;
      const GGS_immediatExpression  _temp_63132 = operand_63053->mExpression ;
      if (_temp_63132._isBuilt ()) {
        typeCategoryMethod__immediatExpression__eval _method = findCategoryMethod__immediatExpression__eval (_temp_63132._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_63132 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1856)) ;
        }
      }
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_63053->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1857)) COMMA_SOURCE_FILE_AT_LINE (1857))).isBuiltAndTrue ()) {
        operand_63053->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "'"))._operator_concat (operand_63053->mConstantName))._operator_concat (GGS_string (true, "' is alreday declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1859)) ;
      }else{
        var_cas_constantMap.modifier_insertKey (_inLexique, operand_63053->mConstantName, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1860)) ;
      }
    }
  }
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1864)))).isBuiltAndTrue ()) {
    ::routine_print_constant_definition (_inLexique,  var_cas_constantMap,  var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1865)) ;
  }
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (1871))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_13 ;
    GGS_bool automatic_var_14 ;
    const GGS_routineMap  _temp_63821 = var_cas_routineMap ;
    if (_temp_63821._isBuilt ()) {
      _temp_63821 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1874)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1877)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1880)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (1882)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (1883)) ;
  }
  ...
  if (((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1891)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_tempBootloaderRoutineDeclarationList.modifier_popFirst (_inLexique, var_cas_routineName, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1894)) ;
  ...
  GGS_uint _variant_66111 = var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1904)) ;
  GGS_bool _condition_66111 (_variant_66111._isBuilt (), true) ;
  while (_condition_66111.isBuiltAndTrue ()) {
    _condition_66111 = ((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1905)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_entryPoint)._operator_strictInf (GGS_uint (true, 24U))) ;
    if (_condition_66111.isBuiltAndTrue ()) {
      if (_variant_66111.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1912)) ;
        _condition_66111 = GGS_bool (true, false) ;
      }else{
        _variant_66111._decrement_operation (_inLexique COMMA_HERE) ;
        ...
        var_cas_tempBootloaderRoutineDeclarationList.modifier_popFirst (_inLexique, var_cas_routineName, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (1909)) ;
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_routineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
        var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1911)) ;
      }
    }
  }
  ...
  {
    GGS_routineDeclarationList::cEnumerator enumerator_66565 (var_cas_tempBootloaderRoutineDeclarationList, true) ;
    const GGS_routineDeclarationList::cElement * operand_66565 = NULL ;
    while (((operand_66565 = enumerator_66565.nextObject ()))) {
      macroValidPointer (operand_66565) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), operand_66565->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (1923)) ;
    }
  }
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_66996 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1928)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_66996 = NULL ;
      while (((operand_66996 = enumerator_66996.nextObject ()))) {
        macroValidPointer (operand_66996) ;
        if (((operand_66996->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1929)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          ...
          ::routine_handleInstructionList (_inLexique,  operand_66996->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_66996->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1932)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_66996->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1948)) ;
          }
          var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETFIE ::constructor_new (_inLexique, GGS_location (_inLexique), operand_66996->mFastReturn COMMA_HERE)) ;
        }
      }
    }
  }
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_68140 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1957)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_68140 = NULL ;
      while (((operand_68140 = enumerator_68140.nextObject ()))) {
        macroValidPointer (operand_68140) ;
        if (((operand_68140->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1958)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          GGS_bool var_cas_continuesInSequence ;
          GGS_uint  var_cas_currentBank ;
          var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          ::routine_handleInstructionList (_inLexique,  operand_68140->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_68140->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1961)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_68140->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1977)) ;
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_69151 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1984)), true) ;
    const GGS_routineDefinitionList::cElement * operand_69151 = NULL ;
    while (((operand_69151 = enumerator_69151.nextObject ()))) {
      macroValidPointer (operand_69151) ;
      GGS_bool var_cas_continuesInSequence ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = operand_69151->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1986)) ;
      GGS_routineKind var_cas_routineKind ;
      if ((operand_69151->mIsNoReturn).isBuiltAndTrue ()) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_69151->mRoutineName COMMA_HERE)) ;
      ::routine_handleInstructionList (_inLexique,  operand_69151->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  operand_69151->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (1994)) ;
      if (((((operand_69151->mIsNoReturn)._operator_not ())._operator_and ((operand_69151->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2008)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_69151->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2008))))).isBuiltAndTrue ()) {
        operand_69151->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set BSR to "))._operator_concat (operand_69151->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2009)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2009))) COMMA_SOURCE_FILE_AT_LINE (2010)) ;
      }
      if (((operand_69151->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
        operand_69151->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2013)) ;
      }
      if (((operand_69151->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, operand_69151->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2016)) COMMA_HERE)) ;
      }
    }
  }
  ...
  const GGS_registerExpression  _temp_70665 = var_cas_WREGregister ;
  if (_temp_70665._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_70665._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_70665 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (2022)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_71002 = var_cas_TOSLregister ;
  if (_temp_71002._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_71002._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_71002 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_24 COMMA_SOURCE_FILE_AT_LINE (2032)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_71339 = var_cas_TOSHregister ;
  if (_temp_71339._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_71339._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_71339 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (2042)) ;
    }
  }
  ...
  const GGS_registerExpression  _temp_71676 = var_cas_TOSUregister ;
  if (_temp_71676._isBuilt ()) {
    typeCategoryMethod__registerExpression__resolveAccess _method = findCategoryMethod__registerExpression__resolveAccess (_temp_71676._galgasObjectRunTimeInfo ()) ;
    if (_method != NULL) {
      _method (_inLexique, _temp_71676 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (true, 0U), var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (2052)) ;
    }
  }
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2060))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2069))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2072)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2072)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), var_cas_WREG_IPICregisterDescription, GGS_bool (true, true) COMMA_HERE)) ;
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2107)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2108))) ;
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2109))) ;
    var_cas_ioListFileContents.writeString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (2110))) ;
    var_cas_ioListFileContents.writeString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2111)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_ipic18_instructionList::cEnumerator enumerator_74203 (var_cas_outGeneratedInstructionList, true) ;
      const GGS_ipic18_instructionList::cElement * operand_74203 = NULL ;
      while (((operand_74203 = enumerator_74203.nextObject ()))) {
        macroValidPointer (operand_74203) ;
        const GGS_ipic18_instruction  _temp_74244 = operand_74203->mInstruction ;
        if (_temp_74244._isBuilt ()) {
          _temp_74244 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2120)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2121)).reader_stringByLeftPadding (_inLexique, GGS_uint (true, 5U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (2121))) ;
        var_cas_ioListFileContents.writeString (": ") ;
        const GGS_ipic18_instruction  _temp_74389 = operand_74203->mInstruction ;
        if (_temp_74389._isBuilt ()) {
          _temp_74389 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2122)) ;
        }
        var_cas_ioListFileContents.writeString ("\n") ;
        var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2124)) ;
      }
    }
    var_cas_ioListFileContents.writeString ("\n") ;
    var_cas_ioListFileContents.writeString ("Minimum code size without optimization: ") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2127))) ;
