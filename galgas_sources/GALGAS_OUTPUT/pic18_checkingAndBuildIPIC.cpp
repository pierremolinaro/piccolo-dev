  ...
  var_cas_outContinuesInSequence = GGS_bool (true) ;
  {
    ...
    while (((operand_1728 = enumerator_1728.nextObject ()))) {
      ...
      if (((var_cas_outContinuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
        operand_1728->mInstruction.reader_mInstructionLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (49)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Unreachable code") COMMA_SOURCE_FILE_AT_LINE (50)) ;
        var_cas_outContinuesInSequence = GGS_bool (true) ;
      }
...
category_method__instruction_nobanksel__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_2379 != NULL) {
    if ((var_cas_inShouldPreserveBSR).isBuiltAndTrue ()) {
      operand_2379->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("cannot use \"nobank\" here: BSR should be preserved (use it in a \"banksave\" construct)") COMMA_SOURCE_FILE_AT_LINE (85)) ;
    }
...
category_method__instruction_savebank__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_3159 != NULL) {
    ...
    var_cas_BSRregister = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("BSR"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
    ...
    if (((var_cas_ioContinuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
      operand_3159->mEndOfSaveBankInstruction.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("useless saving: execution does reach the end of \"savebank\" instruction list") COMMA_SOURCE_FILE_AT_LINE (142)) ;
    }
...
category_method__instruction_banksel__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_5186 != NULL) {
    if ((var_cas_inShouldPreserveBSR).isBuiltAndTrue ()) {
      operand_5186->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("cannot use \"banksel\" here: BSR should be preserved (use it in \"banksave\" construct)") COMMA_SOURCE_FILE_AT_LINE (168)) ;
    }
    if (((operand_5186->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (169)))._operator_strictSup (GGS_uint (15U))).isBuiltAndTrue ()) {
      operand_5186->mBankIndex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("selected bank index should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (171)) ;
      var_cas_ioCurrentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
...
category_method__instruction_JSR__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_10345 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      ...
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_10345->mTargetLabel))._operator_concat (GGS_string ("' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (333))) ;
    ...
    if ((var_cas_isNoReturn).isBuiltAndTrue ()) {
      operand_10345->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine should be called with a BRA, GOTO, Bcc or JUMP instruction") COMMA_SOURCE_FILE_AT_LINE (344)) ;
    }
    if (((var_cas_preservesBank)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioCurrentBank = var_cas_returnedBank ;
      if ((var_cas_inShouldPreserveBSR).isBuiltAndTrue ()) {
        operand_10345->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the routine call should preserve bank selection") COMMA_SOURCE_FILE_AT_LINE (349)) ;
      }
    }
...
category_method__instruction_JUMP__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_12008 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_12008->mTargetLabel))._operator_concat (GGS_string ("' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (379))) ;
      var_cas_errorMessage.appendCString (", but BSR ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
    ...
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      operand_12008->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a regular routine should be called with a RCALL, CALL or JSR instruction") COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
...
category_method__instruction_JUMPCC__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_13437 != NULL) {
    ...
    if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_13437->mTargetLabel))._operator_concat (GGS_string ("' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (420))) ;
      var_cas_errorMessage.appendCString (", but BSR ") ;
      if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_errorMessage.appendCString ("does contain any reliable value") ;
      }else{
    ...
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      operand_13437->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a regular routine should be called with a RCALL, CALL or JSR instruction") COMMA_SOURCE_FILE_AT_LINE (431)) ;
    }
...
category_method__instruction_literalOperation__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_19627 != NULL) {
    ...
    if ((((var_cas_result)._operator_strictSup (GGS_sint (255L)))._operator_or ((var_cas_result)._operator_strictInf (GGS_sint (128L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
      operand_19627->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("immediate value is evaluated as "))._operator_concat (var_cas_result.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (605))))._operator_concat (GGS_string (" (should be betwween -128 and 255)")) COMMA_SOURCE_FILE_AT_LINE (606)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_literalOperation ::constructor_new (_inLexique, operand_19627->mInstructionLocation, operand_19627->mLiteralInstruction, (var_cas_result)._operator_and (GGS_sint (255L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (611)) COMMA_HERE)) ;
  }
}
...
category_method__instruction_LFSR__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_20621 != NULL) {
    if (((operand_20621->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (630)))._operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
      operand_20621->mFSRindex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the LFSR register index ("))._operator_concat (operand_20621->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (631)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (631))))._operator_concat (GGS_string (") should be lower or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (632)) ;
    }
    GGS_sint  var_cas_result ;
    ...
    if ((((var_cas_result)._operator_strictSup (GGS_sint (4095L)))._operator_or ((var_cas_result)._operator_strictInf (GGS_sint (0L)))).isBuiltAndTrue ()) {
      operand_20621->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("immediate value is evaluated as "))._operator_concat (var_cas_result.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (637))))._operator_concat (GGS_string (" (should be between 0 and 4095)")) COMMA_SOURCE_FILE_AT_LINE (638)) ;
    }
...
category_method__instruction_computed_retlw__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_23081 != NULL) {
    ...
    case GGS_routineKind::enum_noReturnRoutine:
      {
      operand_23081->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine does not accept computed retlw instruction") COMMA_SOURCE_FILE_AT_LINE (708)) ;
      }
      break ;
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_23081->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("an interrupt routine does not accept computed retlw instruction") COMMA_SOURCE_FILE_AT_LINE (710)) ;
      }
      break ;
    ...
    if (((var_cas_size)._operator_strictInf (GGS_sint (2L))).isBuiltAndTrue ()) {
      operand_23081->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (714))))._operator_concat (GGS_string (") should be greater or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (715)) ;
    }else if (((var_cas_size)._operator_strictSup (GGS_sint (128L))).isBuiltAndTrue ()) {
      operand_23081->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (716))))._operator_concat (GGS_string (") should be lower or equal to 128")) COMMA_SOURCE_FILE_AT_LINE (717)) ;
      ...
      operand_23081->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the constant list length ("))._operator_concat (operand_23081->mImmediateExpressionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (718)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (718))))._operator_concat (GGS_string (") should be equal to the computed range (")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (718))))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (719)) ;
    }
    ...
    var_cas_literalValues = GGS_uintlist ::constructor_emptyList () ;
    {
      ...
      while (((operand_24515 = enumerator_24515.nextObject ()))) {
        ...
        if ((((var_cas_v)._operator_strictSup (GGS_sint (255L)))._operator_or ((var_cas_v)._operator_strictInf (GGS_sint (128L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
          operand_23081->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("immediate value with index "))._operator_concat (var_cas_idx.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (725))))._operator_concat (GGS_string (" is evaluated as ")))._operator_concat (var_cas_v.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (725))))._operator_concat (GGS_string (" (should be <= 255)")) COMMA_SOURCE_FILE_AT_LINE (726)) ;
        }
        var_cas_literalValues._addAssign_operation ((var_cas_v)._operator_and (GGS_sint (255L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (727))) ;
        var_cas_idx.mValue ++ ;
      }
    }
...
category_method__instruction_MNOP__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_25126 != NULL) {
    if (((operand_25126->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (753)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      operand_25126->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("occurrence argument is zero: no generated code") COMMA_SOURCE_FILE_AT_LINE (754)) ;
    }
  ...
  if (operand_25955 != NULL) {
    ...
    var_cas_returnedBankValue = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
    {
      ...
      while (((operand_26474 = enumerator_26474.nextObject ()))) {
        ...
        if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage ;
          var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_26474->mValue))._operator_concat (GGS_string ("' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (790))) ;
          var_cas_errorMessage.appendCString (", but BSR ") ;
          if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.appendCString ("does contain any reliable value") ;
          }else{
        ...
        if ((var_cas_preservesBank).isBuiltAndTrue ()) {
          ...
          operand_26474->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((((GGS_string ("this routine ensures setting of bank '"))._operator_concat (var_cas_returnedBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (803))))._operator_concat (GGS_string ("', but ")))._operator_concat (GGS_string ("previous routine(s) ensure setting of bank '")))._operator_concat (var_cas_returnedBankValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (804))))._operator_concat (GGS_string ("'.")) COMMA_SOURCE_FILE_AT_LINE (805)) ;
        }else{
    ...
    if (((var_cas_allReturnBank)._operator_and ((var_cas_allPreserveBankSetting)._operator_not ())).isBuiltAndTrue ()) {
      ...
      operand_25955->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("invoked routine should either all preserve bank, eihter return the same selected bank") COMMA_SOURCE_FILE_AT_LINE (818)) ;
    }
    if (((var_cas_inShouldPreserveBSR)._operator_and ((var_cas_allPreserveBankSetting)._operator_not ())).isBuiltAndTrue ()) {
      operand_25955->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("invoked routine(s) do(es) not preserve bank selection") COMMA_SOURCE_FILE_AT_LINE (821)) ;
    }
    var_cas_ioContinuesInSequence = GGS_bool (false) ;
    switch (var_cas_inRoutineKind.enumValue ()) {
    case GGS_routineKind::enum_regularRoutine:
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_25955->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("an interrupt routine does not accept computed bra instruction") COMMA_SOURCE_FILE_AT_LINE (830)) ;
      }
      break ;
    case GGS_routineKind::kNotBuilt:
      break ;
    ...
    if (((var_cas_size)._operator_strictInf (GGS_sint (2L))).isBuiltAndTrue ()) {
      operand_25955->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (834))))._operator_concat (GGS_string (") should be greater or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (835)) ;
    }else if (((var_cas_size)._operator_strictSup (GGS_sint (128L))).isBuiltAndTrue ()) {
      operand_25955->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (836))))._operator_concat (GGS_string (") should be lower or equal to 128")) COMMA_SOURCE_FILE_AT_LINE (837)) ;
      ...
      operand_25955->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the routine name list length ("))._operator_concat (operand_25955->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (838)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (838))))._operator_concat (GGS_string (") should be equal to the computed range (")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (838))))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (839)) ;
    }
  ...
  if (operand_29588 != NULL) {
    {
      ...
      while (((operand_30007 = enumerator_30007.nextObject ()))) {
        ...
        if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage ;
          var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_30007->mValue))._operator_concat (GGS_string ("' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (869))) ;
          var_cas_errorMessage.appendCString (", but BSR ") ;
          if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.appendCString ("does contain any reliable value") ;
          }else{
        ...
        if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
          operand_30007->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("for being named in a computed goto, the '"))._operator_concat (operand_30007->mValue))._operator_concat (GGS_string ("' routine should be declared with the \"noreturn\" qualifier")) COMMA_SOURCE_FILE_AT_LINE (880)) ;
        }
      }
    }
    var_cas_ioContinuesInSequence = GGS_bool (false) ;
    ...
    case GGS_routineKind::enum_regularRoutine:
      {
      operand_29588->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a regular routine does not accept computed goto instruction") COMMA_SOURCE_FILE_AT_LINE (886)) ;
      }
      break ;
    case GGS_routineKind::enum_noReturnRoutine:
      {
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_29588->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("an interrupt routine does not accept computed goto instruction") COMMA_SOURCE_FILE_AT_LINE (889)) ;
      }
      break ;
    case GGS_routineKind::kNotBuilt:
      break ;
    ...
    if (((var_cas_size)._operator_strictInf (GGS_sint (2L))).isBuiltAndTrue ()) {
      operand_29588->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (893))))._operator_concat (GGS_string (") should be greater or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (894)) ;
    }else if (((var_cas_size)._operator_strictSup (GGS_sint (64L))).isBuiltAndTrue ()) {
      operand_29588->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (895))))._operator_concat (GGS_string (") should be lower or equal to 64")) COMMA_SOURCE_FILE_AT_LINE (896)) ;
      ...
      operand_29588->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the routine name list length ("))._operator_concat (operand_29588->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (897)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (897))))._operator_concat (GGS_string (") should be equal to the computed range (")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (897))))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (898)) ;
    }
  ...
  if (operand_32002 != NULL) {
    ...
    var_cas_returnedBankSelection = var_cas_ioCurrentBank ;
    {
      ...
      while (((operand_32532 = enumerator_32532.nextObject ()))) {
        ...
        if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage ;
          var_cas_errorMessage = (((GGS_string ("the routine '"))._operator_concat (operand_32532->mValue))._operator_concat (GGS_string ("' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (933))) ;
          var_cas_errorMessage.appendCString (", but BSR ") ;
          if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.appendCString ("does contain any reliable value") ;
          }else{
        ...
        if ((var_cas_isNoReturn).isBuiltAndTrue ()) {
          operand_32532->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("for being named in a computed rcall, the '"))._operator_concat (operand_32532->mValue))._operator_concat (GGS_string ("' routine should be declared without the \"noreturn\" qualifier")) COMMA_SOURCE_FILE_AT_LINE (944)) ;
        }
        if (((var_cas_inShouldPreserveBSR)._operator_and ((var_cas_preservesBank)._operator_not ())).isBuiltAndTrue ()) {
          operand_32532->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (operand_32532->mValue))._operator_concat (GGS_string ("' routine should preserved bank selection")) COMMA_SOURCE_FILE_AT_LINE (947)) ;
    ...
    if (((var_cas_size)._operator_strictInf (GGS_sint (2L))).isBuiltAndTrue ()) {
      operand_32002->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (975))))._operator_concat (GGS_string (") should be greater or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (976)) ;
    }else if (((var_cas_size)._operator_strictSup (GGS_sint (64L))).isBuiltAndTrue ()) {
      operand_32002->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the computed range ("))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (977))))._operator_concat (GGS_string (") should be lower or equal to 64")) COMMA_SOURCE_FILE_AT_LINE (978)) ;
      ...
      operand_32002->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the routine name list length ("))._operator_concat (operand_32002->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (979)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (979))))._operator_concat (GGS_string (") should be equal to the computed range (")))._operator_concat (var_cas_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (979))))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (980)) ;
    }
    GGS_string var_cas_label0 ;
    var_cas_label0 = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (982))) ;
...
category_method__instruction_FOREVER__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_35499 != NULL) {
    ...
    case GGS_routineKind::enum_regularRoutine:
      {
      operand_35499->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a regular routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (1010)) ;
      }
      break ;
    case GGS_routineKind::enum_noReturnRoutine:
      {
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_35499->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("an interrupt routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (1013)) ;
      }
      break ;
    case GGS_routineKind::kNotBuilt:
      break ;
    ...
    var_cas_finalBank = var_cas_ioCurrentBank ;
    GGS_string var_cas_label0 ;
    var_cas_label0 = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1016))) ;
    ...
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_35499->mEndOfInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("instruction list does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (1035)) ;
    }
...
category_method__registerComparisonCondition__buildIPICinstructionForCondition (C_Compiler & _inLexique,
  ...
  if (operand_41972 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_registerComparisonCondition ::constructor_new (_inLexique, var_cas_inInstructionLocation, var_cas_IPICregisterDescription, var_cas_inTargetLabel, var_cas_comparison, GGS_bool (true) COMMA_HERE)) ;
  }
}
...
category_method__registerTestCondition__buildIPICinstructionForCondition (C_Compiler & _inLexique,
  ...
  if (operand_44682 != NULL) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_jump_test_register ::constructor_new (_inLexique, var_cas_inInstructionLocation, var_cas_IPICregisterDescription, var_cas_inTargetLabel, (operand_44682->mBranchIfZero)._operator_xor (var_cas_inComplementaryBranch), GGS_bool (true) COMMA_HERE)) ;
  }
}
  ...
  if (operand_46928 != NULL) {
    if ((var_cas_inComplementaryBranch).isBuiltAndTrue ()) {
      ...
      if (_temp_47317.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_47317 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1394)) ;
        }
      }
      ...
      if (_temp_47605.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_47605 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1405)) ;
        }
      }
    }else{
      GGS_string var_cas_label0 ;
      var_cas_label0 = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1417))) ;
      ...
      if (_temp_47985.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_47985 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), var_cas_inInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1418)) ;
        }
      }
      ...
      if (_temp_48266.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_48266 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), var_cas_inInstructionLocation, var_cas_inTargetLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1429)) ;
        }
      }
...
category_method__instruction_structured_if__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_50677 != NULL) {
    ...
    if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (1525)))).isBuiltAndTrue ()) {
      ...
      if (_temp_51254.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_51254 (HERE), GGS_bool (true), var_cas_directCount COMMA_SOURCE_FILE_AT_LINE (1526)) ;
        }
      }
      if (((operand_50677->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1527)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      if (_temp_51439.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_51439 (HERE), GGS_bool (false), var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1530)) ;
        }
      }
      if (((operand_50677->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1531)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_complementaryCount)._operator_strictInf (var_cas_directCount)).isBuiltAndTrue ()) {
        ...
        if (((var_cas_directCount._substract_operation (_inLexique, var_cas_complementaryCount COMMA_SOURCE_FILE_AT_LINE (1538)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_generateComplementaryCondition).isBuiltAndTrue ()) {
      ...
      var_cas_label_nextCondition = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1550))) ;
      ...
      var_cas_label_endOfIfinstruction = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1551))) ;
      ...
      if (_temp_52504.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_52504 (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_50677->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1553)) ;
        }
      }
      ...
      if (((operand_50677->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1580)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      if (((operand_50677->mThenInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1598)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_label_nextCondition ;
      var_cas_label_nextCondition = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1603))) ;
      var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1603)) ;
      GGS_string var_cas_label_endOfIfinstruction ;
      var_cas_label_endOfIfinstruction = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1604))) ;
      ...
      if (_temp_54340.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_54340 (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_50677->mInstructionLocation, var_cas_label_nextCondition, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1606)) ;
        }
      }
      ::routine_handleInstructionList (_inLexique,  operand_50677->mThenInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_thenBranchFinalBank,  var_cas_inShouldPreserveBSR,  var_cas_thenContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1618)) ;
      if (((operand_50677->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1633)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, operand_50677->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_50677->mInstructionLocation COMMA_HERE), GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
      }
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_nextCondition, operand_50677->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      ::routine_handleInstructionList (_inLexique,  operand_50677->mElseInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_inConstantMap,  var_cas_ioLocalLabelIndex,  var_cas_ioGeneratedInstructionList,  var_cas_ioListFileContents,  var_cas_elseBranchFinalBank,  var_cas_inShouldPreserveBSR,  var_cas_elseContinuesInSequence,  var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (1637)) ;
      if (((operand_50677->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1651)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label_endOfIfinstruction, operand_50677->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
      }
    }
    if (((var_cas_elseBranchFinalBank)._operator_isEqual (var_cas_thenBranchFinalBank)).isBuiltAndTrue ()) {
      ...
      operand_50677->mEndOfElsePartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("This branch does not leave BSR value as the first one does") COMMA_SOURCE_FILE_AT_LINE (1659)) ;
...
category_method__instruction_do_while__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_56385 != NULL) {
    ...
    var_cas_labelInstructionBegin = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1681))) ;
    ...
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_56385->mEndOfRepeatedInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (1702)) ;
    }
    {
      ...
      while (((operand_57563 = enumerator_57563.nextObject ()))) {
        ...
        if (((operand_57563->mInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1705)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          if (_temp_57660.isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_57660 (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (false), operand_56385->mInstructionLocation, var_cas_labelInstructionBegin, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1706)) ;
            }
          }
        }else{
          GGS_string var_cas_nextBranchLabel ;
          var_cas_nextBranchLabel = (GGS_string ("_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1718))) ;
          ...
          if (_temp_58078.isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_58078 (HERE), var_cas_inAccessBankSplitOffset, var_cas_ioCurrentBank, var_cas_inRegisterTable, var_cas_ioLocalLabelIndex, GGS_bool (true), operand_56385->mInstructionLocation, var_cas_nextBranchLabel, var_cas_ioGeneratedInstructionList, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1719)) ;
            }
          }
          ...
          if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_bank)).isBuiltAndTrue ()) {
            operand_57563->mEndOfPartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (1747)) ;
          }
...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & _inLexique,
  ...
  var_cas_routineMap = GGS_routineMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_61848 = enumerator_61848.nextObject ()))) {
      ...
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_61848->mRoutineName, operand_61848->mIsNoReturn, operand_61848->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1835)), operand_61848->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1835)), operand_61848->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1835)) ;
    }
  }
  {
    ...
    while (((operand_62058 = enumerator_62058.nextObject ()))) {
      ...
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_62058->mRoutineName, operand_62058->mIsNoReturn, operand_62058->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1838)), operand_62058->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1838)), operand_62058->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1838)) ;
    }
  }
  {
    GGS_routineDefinitionList::cEnumerator enumerator_62207 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1840)), true) ;
    ...
    while (((operand_62207 = enumerator_62207.nextObject ()))) {
      ...
      if ((((operand_62207->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1841)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_62207->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1841)))._operator_strictSup (GGS_uint (15U)))).isBuiltAndTrue ()) {
        operand_62207->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1843)) ;
      }
      if ((((operand_62207->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1844)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_62207->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1844)))._operator_strictSup (GGS_uint (15U)))).isBuiltAndTrue ()) {
        operand_62207->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (1846)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_62207->mRoutineName, operand_62207->mIsNoReturn, operand_62207->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1847)), operand_62207->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1847)), operand_62207->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (1847)) ;
    }
  }
  {
    ...
    while (((operand_62958 = enumerator_62958.nextObject ()))) {
      ...
      if ((var_cas_routineMap.reader_hasKey (_inLexique, operand_62958->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1852)) COMMA_SOURCE_FILE_AT_LINE (1852))).isBuiltAndTrue ()) {
        GGS_bool var_cas_isNoReturn ;
        GGS_uint  var_cas_requiredBank ;
        GGS_uint  var_cas_returnedBank ;
        GGS_bool var_cas_preservesBank ;
        ...
        if (_temp_63151.isBuilt ()) {
          _temp_63151 (HERE)->method_searchKey (_inLexique, operand_62958->mRoutineName, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (1857)) ;
        }
        if ((((((var_cas_isNoReturn)._operator_isNotEqual (operand_62958->mIsNoReturn))._operator_or ((var_cas_requiredBank)._operator_isNotEqual (operand_62958->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1858)))))._operator_or ((var_cas_returnedBank)._operator_isNotEqual (operand_62958->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1858)))))._operator_or ((var_cas_preservesBank)._operator_isNotEqual (operand_62958->mPreservesBank))).isBuiltAndTrue ()) {
          var_cas_routineMap.reader_locationForKey (_inLexique, operand_62958->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1859)) COMMA_SOURCE_FILE_AT_LINE (1859)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (operand_62958->mRoutineName))._operator_concat (GGS_string ("' routine header does not conform to its declaration in bootloader specification")) COMMA_SOURCE_FILE_AT_LINE (1860)) ;
        }
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("The bootloader specification requires the implementation to define the '"))._operator_concat (operand_62958->mRoutineName))._operator_concat (GGS_string ("' routine")) COMMA_SOURCE_FILE_AT_LINE (1863)) ;
      }
    }
  }
  {
    ...
    while (((operand_63951 = enumerator_63951.nextObject ()))) {
      ...
      if ((var_cas_routineMap.reader_hasKey (_inLexique, operand_63951->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1868)) COMMA_SOURCE_FILE_AT_LINE (1868))).isBuiltAndTrue ()) {
        GGS_bool var_cas_isNoReturn ;
        GGS_uint  var_cas_requiredBank ;
        GGS_uint  var_cas_returnedBank ;
        GGS_bool var_cas_preservesBank ;
        ...
        if (_temp_64144.isBuilt ()) {
          _temp_64144 (HERE)->method_searchKey (_inLexique, operand_63951->mRoutineName, var_cas_isNoReturn, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank COMMA_SOURCE_FILE_AT_LINE (1873)) ;
        }
        if ((((((var_cas_isNoReturn)._operator_isNotEqual (operand_63951->mIsNoReturn))._operator_or ((var_cas_requiredBank)._operator_isNotEqual (operand_63951->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1874)))))._operator_or ((var_cas_returnedBank)._operator_isNotEqual (operand_63951->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1874)))))._operator_or ((var_cas_preservesBank)._operator_isNotEqual (operand_63951->mPreservesBank))).isBuiltAndTrue ()) {
          var_cas_routineMap.reader_locationForKey (_inLexique, operand_63951->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1875)) COMMA_SOURCE_FILE_AT_LINE (1875)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (operand_63951->mRoutineName))._operator_concat (GGS_string ("' routine header does not conform to its declaration in bootloader specification")) COMMA_SOURCE_FILE_AT_LINE (1876)) ;
        }
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("The bootloader specification requires the implementation to define the '"))._operator_concat (operand_63951->mRoutineName))._operator_concat (GGS_string ("' routine")) COMMA_SOURCE_FILE_AT_LINE (1879)) ;
      }
    }
  }
  ...
  var_cas_constantMap.modifier_insertKey (_inLexique, var_cas_romSizeString, var_cas_inROMSize COMMA_SOURCE_FILE_AT_LINE (1885)) ;
  if (((var_cas_inProgramKind)._operator_isNotEqual (GGS_programKind::constructor_regularProgram (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    GGS_lstring  var_cas_bootloaderSizeString ;
    var_cas_bootloaderSizeString = GGS_lstring ::constructor_new (_inLexique, GGS_string ("BOOTLOADER_SIZE"), GGS_location (_inLexique) COMMA_HERE) ;
    var_cas_constantMap.modifier_insertKey (_inLexique, var_cas_bootloaderSizeString, var_cas_inBootloaderReservedROMsize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1889)).reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1889)) COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  }
  {
    GGS_constantDefinitionList::cEnumerator enumerator_65267 (var_cas_inPiccoloModel.reader_mConstantDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1892)), true) ;
    ...
    while (((operand_65267 = enumerator_65267.nextObject ()))) {
      ...
      if (_temp_65346.isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_65346 (HERE), var_cas_inRegisterTable, var_cas_constantMap, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1893)) ;
        }
      }
      if ((var_cas_inRegisterTable.reader_hasKey (_inLexique, operand_65267->mConstantName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1894)) COMMA_SOURCE_FILE_AT_LINE (1894))).isBuiltAndTrue ()) {
        operand_65267->mConstantName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("'"))._operator_concat (operand_65267->mConstantName))._operator_concat (GGS_string ("' is already declared as ram register or special register")) COMMA_SOURCE_FILE_AT_LINE (1896)) ;
      }else{
        var_cas_constantMap.modifier_insertKey (_inLexique, operand_65267->mConstantName, var_cas_result COMMA_SOURCE_FILE_AT_LINE (1897)) ;
      }
    }
  }
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (1901)))).isBuiltAndTrue ()) {
    ::routine_print_constant_definition (_inLexique,  var_cas_constantMap,  var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (1902)) ;
  }
  if (((var_cas_inProgramKind)._operator_isNotEqual (GGS_programKind::constructor_userProgram (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string ("main") COMMA_SOURCE_FILE_AT_LINE (1909))).isBuiltAndTrue ()) {
      ...
      if (_temp_66097.isBuilt ()) {
        _temp_66097 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (1912)) ;
      }
      if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1915)) ;
      }
      if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (1918)) ;
      }
    }else{
  ...
  var_cas_entryPoint = GGS_uint (4U) ;
  {
    ...
    while (((operand_66880 = enumerator_66880.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_66880->mRoutineName COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (1929)) ;
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1937)) ;
  {
    ...
    while (((operand_67422 = enumerator_67422.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), operand_67422->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (1941)) ;
    }
  }
  if (((var_cas_inProgramKind)._operator_isNotEqual (GGS_programKind::constructor_userProgram (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, GGS_uint (0U) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_lstring ::constructor_new (_inLexique, GGS_string ("main"), GGS_location (_inLexique) COMMA_HERE), GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
  }
  ...
  if (((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1950)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, GGS_uint (4U) COMMA_HERE)) ;
    ...
    var_cas_tempBootloaderRoutineDeclarationList.modifier_popFirst (_inLexique, var_cas_routineName, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (1953)) ;
  ...
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, GGS_uint (8U) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_lstring ::constructor_new (_inLexique, GGS_string ("_high_interrupt"), GGS_location (_inLexique) COMMA_HERE), GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
  }
  var_cas_entryPoint = GGS_uint (12U) ;
  GGS_uint _variant_69546 = var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1963)) ;
  GGS_bool _condition_69546 (_variant_69546.isBuilt (), true) ;
  while (_condition_69546.isBuiltAndTrue ()) {
    _condition_69546 = ((var_cas_tempBootloaderRoutineDeclarationList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1964)))._operator_strictSup (GGS_uint (0U)))._operator_and ((var_cas_entryPoint)._operator_strictInf (GGS_uint (24U))) ;
    if (_condition_69546.isBuiltAndTrue ()) {
      if (_variant_69546.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1971)) ;
        _condition_69546 = GGS_bool (false) ;
      }else{
        _variant_69546._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_entryPoint COMMA_HERE)) ;
        GGS_lstring  var_cas_routineName ;
        ...
        var_cas_tempBootloaderRoutineDeclarationList.modifier_popFirst (_inLexique, var_cas_routineName, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22 COMMA_SOURCE_FILE_AT_LINE (1968)) ;
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_routineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
        var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (1970)) ;
      }
    }
  }
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, GGS_uint (24U) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_lstring ::constructor_new (_inLexique, GGS_string ("_low_interrupt"), GGS_location (_inLexique) COMMA_HERE), GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
  }
  var_cas_entryPoint = GGS_uint (28U) ;
  {
    ...
    while (((operand_70031 = enumerator_70031.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), operand_70031->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (1982)) ;
    }
  }
  GGS_uint  var_cas_localLabelIndex ;
  var_cas_localLabelIndex = GGS_uint (0U) ;
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("_low_interrupt"), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_70522 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1988)), true) ;
      ...
      while (((operand_70522 = enumerator_70522.nextObject ()))) {
        ...
        if (((operand_70522->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1989)))._operator_isEqual (GGS_string ("low"))).isBuiltAndTrue ()) {
          ...
          ::routine_handleInstructionList (_inLexique,  operand_70522->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_70522->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1992)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_70522->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2008)) ;
          }
          var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETFIE ::constructor_new (_inLexique, GGS_location (_inLexique), operand_70522->mFastReturn COMMA_HERE)) ;
        }
      }
    }
  }
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("_high_interrupt"), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_71689 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (2017)), true) ;
      ...
      while (((operand_71689 = enumerator_71689.nextObject ()))) {
        ...
        if (((operand_71689->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2018)))._operator_isEqual (GGS_string ("high"))).isBuiltAndTrue ()) {
          GGS_bool var_cas_continuesInSequence ;
          GGS_uint  var_cas_currentBank ;
          var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          ::routine_handleInstructionList (_inLexique,  operand_71689->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  (operand_71689->mFastReturn)._operator_not (),  var_cas_continuesInSequence,  GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (2021)) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_71689->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (2037)) ;
          }
          var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETFIE ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_bool (true) COMMA_HERE)) ;
        }
      }
    }
  }
  {
    GGS_routineDefinitionList::cEnumerator enumerator_72700 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (2044)), true) ;
    ...
    while (((operand_72700 = enumerator_72700.nextObject ()))) {
      ...
      GGS_bool var_cas_continuesInSequence ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = operand_72700->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2046)) ;
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_72700->mRoutineName COMMA_HERE)) ;
      ::routine_handleInstructionList (_inLexique,  operand_72700->mInstructionList,  var_cas_inAccessBankSplitOffset,  var_cas_routineMap,  var_cas_inRegisterTable,  var_cas_constantMap,  var_cas_localLabelIndex,  var_cas_outGeneratedInstructionList,  var_cas_generationOptimizationMessages,  var_cas_currentBank,  operand_72700->mPreservesBank,  var_cas_continuesInSequence,  var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (2054)) ;
      if (((((operand_72700->mIsNoReturn)._operator_not ())._operator_and ((operand_72700->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2068)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_72700->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2068))))).isBuiltAndTrue ()) {
        operand_72700->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("execution will not set BSR to "))._operator_concat (operand_72700->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2069)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2069))) COMMA_SOURCE_FILE_AT_LINE (2070)) ;
      }
      if (((operand_72700->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
        operand_72700->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (2073)) ;
      }
      if (((operand_72700->mIsNoReturn)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, operand_72700->mRoutineName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (2076)) COMMA_HERE)) ;
      }
    }
  }
  GGS_registerExpression  var_cas_WREGregister ;
  var_cas_WREGregister = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("WREG"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
  ...
  if (_temp_74307.isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_74307 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_WREG_IPICregisterDescription, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (2083)) ;
    }
  }
  GGS_registerExpression  var_cas_TOSLregister ;
  var_cas_TOSLregister = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("TOSL"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
  ...
  if (_temp_74644.isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_74644 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSL_IPICregisterDescription, automatic_var_24 COMMA_SOURCE_FILE_AT_LINE (2093)) ;
    }
  }
  GGS_registerExpression  var_cas_TOSHregister ;
  var_cas_TOSHregister = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("TOSH"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
  ...
  if (_temp_74981.isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_74981 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSH_IPICregisterDescription, automatic_var_25 COMMA_SOURCE_FILE_AT_LINE (2103)) ;
    }
  }
  GGS_registerExpression  var_cas_TOSUregister ;
  var_cas_TOSUregister = GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("TOSU"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE) ;
  ...
  if (_temp_75318.isBuilt ()) {
    ...
    if (_method != NULL) {
      _method (_inLexique, _temp_75318 (HERE), var_cas_inAccessBankSplitOffset, GGS_uint (0U), var_cas_inRegisterTable, var_cas_TOSU_IPICregisterDescription, automatic_var_26 COMMA_SOURCE_FILE_AT_LINE (2113)) ;
    }
  }
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2121))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), var_cas_WREG_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
  }
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2130))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE)) ;
  }
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2133)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (2133)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), var_cas_WREG_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWFC (_inLexique COMMA_HERE), var_cas_TOSL_IPICregisterDescription, GGS_bool (false) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_literalOperation ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_literal_instruction_opcode::constructor_MOVLW (_inLexique COMMA_HERE), GGS_uint (0U) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWFC (_inLexique COMMA_HERE), var_cas_TOSH_IPICregisterDescription, GGS_bool (false) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWFC (_inLexique COMMA_HERE), var_cas_TOSU_IPICregisterDescription, GGS_bool (false) COMMA_HERE)) ;
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2168)) ;
  {
    ...
    while (((operand_77304 = enumerator_77304.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (_inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_77304->mRoutineName COMMA_HERE)) ;
      if ((operand_77304->mIsNoReturn).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_JUMP ::constructor_new (_inLexique, GGS_location (_inLexique), operand_77304->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (_inLexique COMMA_HERE) COMMA_HERE)) ;
      }else if (((operand_77304->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (2174)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_MOVLB ::constructor_new (_inLexique, GGS_location (_inLexique), operand_77304->mReturnedBank COMMA_HERE)) ;
      }
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (_inLexique, GGS_location (_inLexique) COMMA_HERE)) ;
      var_cas_entryPoint = var_cas_entryPoint._add_operation (_inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (2178)) ;
    }
  }
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (2181)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (2182))) ;
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("IPIC INSTRUCTION LIST").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (2183))) ;
    var_cas_ioListFileContents.appendCString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (2184))) ;
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    if (((var_cas_generationOptimizationMessages.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (2185)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_currentAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_78605 = enumerator_78605.nextObject ()))) {
        ...
        if (_temp_78646.isBuilt ()) {
          _temp_78646 (HERE)->method_setCurrentAddress (_inLexique, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (2194)) ;
        }
        var_cas_ioListFileContents._dotAssign_operation (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2195)).reader_stringByLeftPadding (_inLexique, GGS_uint (5U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (2195))) ;
        var_cas_ioListFileContents.appendCString (": ") ;
        const GGS_ipic18_instruction  _temp_78791 = operand_78605->mInstruction ;
        if (_temp_78791.isBuilt ()) {
          _temp_78791 (HERE)->method_displayIPICinstruction (_inLexique, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (2196)) ;
        }
        var_cas_ioListFileContents.appendCString ("\n") ;
        var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (2198)) ;
      }
    }
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("Minimum code size without optimization: ") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (2201))) ;
