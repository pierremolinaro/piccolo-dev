...
//                    february 20th, 2010, at 22h32'46"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_build_ipic18_assembly_instruction_list (C_Compiler & inLexique,
  ...
  if (cond_77124.isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (inLexique, GGS_location (inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (inLexique COMMA_HERE), var_cas_WREG_IPICregisterDescription, GGS_bool (true) COMMA_HERE)) ;
    var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_FDA ::constructor_new (inLexique, GGS_location (inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (inLexique COMMA_HERE), var_cas_TOSL_IPICregisterDescription, GGS_bool (false) COMMA_HERE)) ;
  ...
  var_cas_entryPoint = var_cas_inBootloaderReservedROMsize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2168)) ;
  {
    ...
    while (((operand_77313 = enumerator_77313.nextObject ()))) {
      ...
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_ORG ::constructor_new (inLexique, var_cas_entryPoint COMMA_HERE)) ;
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (inLexique, operand_77313->mRoutineName COMMA_HERE)) ;
      const GGS_bool cond_77614 = operand_77313->mIsNoReturn ;
      if (cond_77614.isBuiltAndTrue ()) {
        var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic_JUMP ::constructor_new (inLexique, GGS_location (inLexique), operand_77313->mRoutineName, GGS_jumpInstructionKind::constructor_ipicRelative (inLexique COMMA_HERE) COMMA_HERE)) ;
      }else if (cond_77614.isBuiltAndFalse ()) {
        const GGS_bool cond_77756 = (operand_77313->mReturnedBank.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2174))).operator_isNotEqual (GGS_uint ::constructor_max (inLexique COMMA_HERE)) ;
        if (cond_77756.isBuiltAndTrue ()) {
          var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_MOVLB ::constructor_new (inLexique, GGS_location (inLexique), operand_77313->mReturnedBank COMMA_HERE)) ;
        }
      }
      var_cas_outGeneratedInstructionList.addAssign_operation (GGS_ipic18_instruction_RETURN ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE)) ;
