...
method_searchKey (C_Compiler & inLexique,
  ...
  _searchElement (inLexique,
                  "the reserved size for the '%K' bank is not declared",
                  inKey,
                  outParameter0,
                  NULL
                  COMMA_THERE) ;
...
_operator_isEqual (const GGS_programKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue == inOperand.mValue) ;
}
...
GGS_bool GGS_programKind::
_operator_isNotEqual (const GGS_programKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue != inOperand.mValue) ;
}
...
GGS_bool GGS_programKind::
_operator_infOrEqual (const GGS_programKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue <= inOperand.mValue) ;
}
...
GGS_bool GGS_programKind::
_operator_supOrEqual (const GGS_programKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue >= inOperand.mValue) ;
}
...
GGS_bool GGS_programKind::
_operator_strictInf (const GGS_programKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue < inOperand.mValue) ;
}
...
GGS_bool GGS_programKind::
_operator_strictSup (const GGS_programKind inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (),
                   mValue > inOperand.mValue) ;
}
...
void GGS_piccoloModel::_drop (void) {
  mProgramName._drop () ;
  mProgramKind._drop () ;
  mDeviceNameOrBootLoaderReference._drop () ;
...
bool GGS_piccoloModel::_isBuilt (void) const {
  return mProgramName._isBuilt ()
    && mProgramKind._isBuilt ()
    && mDeviceNameOrBootLoaderReference._isBuilt ()
...
_operator_isEqual (const GGS_piccoloModel & inOperand) const {
  return mProgramName._operator_isEqual (inOperand.mProgramName)
    ._operator_and (mProgramKind._operator_isEqual (inOperand.mProgramKind))
    ._operator_and (mDeviceNameOrBootLoaderReference._operator_isEqual (inOperand.mDeviceNameOrBootLoaderReference))
...
_operator_isNotEqual (const GGS_piccoloModel & inOperand) const {
  return mProgramName._operator_isNotEqual (inOperand.mProgramName)
    ._operator_or (mProgramKind._operator_isNotEqual (inOperand.mProgramKind))
    ._operator_or (mDeviceNameOrBootLoaderReference._operator_isNotEqual (inOperand.mDeviceNameOrBootLoaderReference))
...
reader_description (C_Compiler & _inLexique
  ...
  if (_isBuilt ()) {
    ...
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mProgramKind " ;
    _s << mProgramKind.reader_description (_inLexique COMMA_THERE, inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mDeviceNameOrBootLoaderReference " ;
    _s << mDeviceNameOrBootLoaderReference.reader_description (_inLexique COMMA_THERE, inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
