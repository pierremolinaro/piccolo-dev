...
enumComparisonResult cMapElement_bootloaderReservedRAMmap::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_bootloaderReservedRAMmap_searchKey [52] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_bootloaderReservedRAMmap::method_searchKey (GALGAS_lstring inKey,
  ...
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_bootloaderReservedRAMmap_searchKey COMMA_THERE) ;
  const cMapElement_bootloaderReservedRAMmap * p = (const cMapElement_bootloaderReservedRAMmap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_bootloaderReservedRAMmap) ;
...
void GALGAS_bootloaderReservedRAMmap::modifier_setMReservedSizeForKey (GALGAS_luint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_bootloaderReservedRAMmap) ;
...
cMapElement_bootloaderReservedRAMmap * GALGAS_bootloaderReservedRAMmap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_bootloaderReservedRAMmap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_bootloaderReservedRAMmap::current_lkey (void) const {
...
GALGAS_luint cEnumerator_bootloaderReservedRAMmap::current_mReservedSize (void) const {
  const cMapElement_bootloaderReservedRAMmap * p = (const cMapElement_bootloaderReservedRAMmap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_bootloaderReservedRAMmap) ;
...
cCollectionElement * cCollectionElement_instructionList::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_instructionList (mAttribute_mInstruction COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cCollectionElement_instructionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_instructionList::modifier_popFirst (GALGAS_piccolo_5F_instruction & outOperand0,
  ...
  cCollectionElement_instructionList * p = (cCollectionElement_instructionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_instructionList) ;
...
GALGAS_instructionList GALGAS_instructionList::reader_subListWithRange (const GALGAS_uint & inIndex,
...
void GALGAS_instructionList::modifier_setMInstructionAtIndex (GALGAS_piccolo_5F_instruction inOperand,
                                                              GALGAS_uint inIndex,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_instructionList * p = (cCollectionElement_instructionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_instructionList) ;
...
GALGAS_piccolo_5F_instruction cEnumerator_instructionList::current_mInstruction (void) const {
  const cCollectionElement_instructionList * p = (const cCollectionElement_instructionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_instructionList) ;
...
static const char * gEnumNameArrayFor_instruction_5F_FDA_5F_base_5F_code_mnemonic [22] = {
  "",
  "ADDWF",
  "ADDWFC",
  "ANDWF",
...
GALGAS_string GALGAS_instruction_5F_FDA_5F_base_5F_code::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_instruction_5F_FDA_5F_base_5F_code_mnemonic [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_instruction_5F_FDA_5F_base_5F_code::objectCompare (const GALGAS_instruction_5F_FDA_5F_base_5F_code & inOperand) const {
...
static const char * gEnumNameArrayFor_FA_5F_instruction_5F_base_5F_code_mnemonic [10] = {
  "",
  "CLRF",
  "CPFSEQ",
  "CPFSGT",
...
GALGAS_string GALGAS_FA_5F_instruction_5F_base_5F_code::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_FA_5F_instruction_5F_base_5F_code_mnemonic [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_FA_5F_instruction_5F_base_5F_code::objectCompare (const GALGAS_FA_5F_instruction_5F_base_5F_code & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static const char * gEnumNameArrayFor_bit_5F_oriented_5F_op_mnemonic [4] = {
  "",
  "BCF",
  "BSF",
  "BTG"
...
GALGAS_string GALGAS_bit_5F_oriented_5F_op::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_bit_5F_oriented_5F_op_mnemonic [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_bit_5F_oriented_5F_op::objectCompare (const GALGAS_bit_5F_oriented_5F_op & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static const char * gEnumNameArrayFor_conditional_5F_branch_mnemonic [9] = {
  "",
  "BZ",
  "BNZ",
  "BN",
...
GALGAS_string GALGAS_conditional_5F_branch::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_conditional_5F_branch_mnemonic [mEnum]) ;
  }
  return result ;
}
...
static const char * gEnumNameArrayFor_conditional_5F_branch_condition [9] = {
  "",
  "Z",
  "NZ",
  "N",
...
GALGAS_string GALGAS_conditional_5F_branch::reader_condition (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_conditional_5F_branch_condition [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_conditional_5F_branch::objectCompare (const GALGAS_conditional_5F_branch & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
void routine_getComplementaryBcc (const GALGAS_conditional_5F_branch constinArgument_inConditionalBranch,
  ...
  if (constinArgument_inConditionalBranch.isValid ()) {
    ...
    case GALGAS_conditional_5F_branch::kEnum_bz: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_0 (GALGAS_conditional_5F_branch::constructor_bnz (SOURCE_FILE_AT_LINE (202))) ;
      outArgument_outComplementary = temp_0 ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnz: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_1 (GALGAS_conditional_5F_branch::constructor_bz (SOURCE_FILE_AT_LINE (203))) ;
      outArgument_outComplementary = temp_1 ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bn: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_2 (GALGAS_conditional_5F_branch::constructor_bnn (SOURCE_FILE_AT_LINE (204))) ;
      outArgument_outComplementary = temp_2 ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnn: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_3 (GALGAS_conditional_5F_branch::constructor_bn (SOURCE_FILE_AT_LINE (205))) ;
      outArgument_outComplementary = temp_3 ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bc: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_4 (GALGAS_conditional_5F_branch::constructor_bnc (SOURCE_FILE_AT_LINE (206))) ;
      outArgument_outComplementary = temp_4 ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnc: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_5 (GALGAS_conditional_5F_branch::constructor_bc (SOURCE_FILE_AT_LINE (207))) ;
      outArgument_outComplementary = temp_5 ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bov: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_6 (GALGAS_conditional_5F_branch::constructor_bnov (SOURCE_FILE_AT_LINE (208))) ;
      outArgument_outComplementary = temp_6 ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnov: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_conditional_5F_branch temp_7 (GALGAS_conditional_5F_branch::constructor_bov (SOURCE_FILE_AT_LINE (209))) ;
      outArgument_outComplementary = temp_7 ;
      } break ;
    }
  }
}
...
enumComparisonResult GALGAS_jumpInstructionKind::objectCompare (const GALGAS_jumpInstructionKind & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static const char * gEnumNameArrayFor_literal_5F_instruction_5F_opcode_mnemonic [9] = {
  "",
  "ADDLW",
  "ANDLW",
  "IORLW",
...
GALGAS_string GALGAS_literal_5F_instruction_5F_opcode::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_literal_5F_instruction_5F_opcode_mnemonic [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_literal_5F_instruction_5F_opcode::objectCompare (const GALGAS_literal_5F_instruction_5F_opcode & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static const char * gEnumNameArrayFor_tableAccessOption_mnemonic [5] = {
  "",
  "*",
  "*+",
  "*-",
...
GALGAS_string GALGAS_tableAccessOption::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_tableAccessOption_mnemonic [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_tableAccessOption::objectCompare (const GALGAS_tableAccessOption & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static const char * gEnumNameArrayFor_if_5F_semi_5F_colon_5F_op_mnemonic [5] = {
  "",
  "CPFSEQ",
  "CPFSGT",
  "CPFSLT",
...
GALGAS_string GALGAS_if_5F_semi_5F_colon_5F_op::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_if_5F_semi_5F_colon_5F_op_mnemonic [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_if_5F_semi_5F_colon_5F_op::objectCompare (const GALGAS_if_5F_semi_5F_colon_5F_op & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static const char * gEnumNameArrayFor_registerComparison_mnemonic [7] = {
  "",
  "!=",
  "==",
  ">=",
...
GALGAS_string GALGAS_registerComparison::reader_mnemonic (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_registerComparison_mnemonic [mEnum]) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_registerComparison::objectCompare (const GALGAS_registerComparison & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
void routine_getRegisterComparisonComplementary (const GALGAS_registerComparison constinArgument_inComparison,
  ...
  if (constinArgument_inComparison.isValid ()) {
    ...
    case GALGAS_registerComparison::kEnum_notEqual: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_registerComparison temp_0 (GALGAS_registerComparison::constructor_equal (SOURCE_FILE_AT_LINE (471))) ;
      outArgument_outComparison = temp_0 ;
      } break ;
    case GALGAS_registerComparison::kEnum_equal: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_registerComparison temp_1 (GALGAS_registerComparison::constructor_notEqual (SOURCE_FILE_AT_LINE (472))) ;
      outArgument_outComparison = temp_1 ;
      } break ;
    case GALGAS_registerComparison::kEnum_greaterOrEqual: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_registerComparison temp_2 (GALGAS_registerComparison::constructor_lower (SOURCE_FILE_AT_LINE (473))) ;
      outArgument_outComparison = temp_2 ;
      } break ;
    case GALGAS_registerComparison::kEnum_greater: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_registerComparison temp_3 (GALGAS_registerComparison::constructor_lowerOrEqual (SOURCE_FILE_AT_LINE (474))) ;
      outArgument_outComparison = temp_3 ;
      } break ;
    case GALGAS_registerComparison::kEnum_lowerOrEqual: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_registerComparison temp_4 (GALGAS_registerComparison::constructor_greater (SOURCE_FILE_AT_LINE (475))) ;
      outArgument_outComparison = temp_4 ;
      } break ;
    case GALGAS_registerComparison::kEnum_lower: {
      //-------- @assignmentInstructionForGeneration
      GALGAS_registerComparison temp_5 (GALGAS_registerComparison::constructor_greaterOrEqual (SOURCE_FILE_AT_LINE (476))) ;
      outArgument_outComparison = temp_5 ;
      } break ;
    }
  }
}
...
void routine_getRegisterComparisonInstructionCount (const GALGAS_registerComparison constinArgument_inComparison,
  ...
  if (constinArgument_inComparison.isValid ()) {
    ...
    case GALGAS_registerComparison::kEnum_greater: {
      //-------- @assignmentInstructionForGeneration
      //--- @literalUIntExpressionForGeneration
      GALGAS_uint temp_3 ((PMUInt32) 3U) ;
      outArgument_outInstructionCount = temp_3 ;
      } break ;
    case GALGAS_registerComparison::kEnum_lowerOrEqual: {
      //-------- @assignmentInstructionForGeneration
      //--- @literalUIntExpressionForGeneration
      GALGAS_uint temp_4 ((PMUInt32) 2U) ;
      outArgument_outInstructionCount = temp_4 ;
      } break ;
    case GALGAS_registerComparison::kEnum_lower: {
      //-------- @assignmentInstructionForGeneration
      //--- @literalUIntExpressionForGeneration
      GALGAS_uint temp_5 ((PMUInt32) 3U) ;
      outArgument_outInstructionCount = temp_5 ;
      } break ;
    }
  }
}
...
cCollectionElement * cCollectionElement_partList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_partList (mAttribute_mCondition, mAttribute_mInstructionList, mAttribute_mEndOfPartLocation COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cCollectionElement_partList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_partList::modifier_popFirst (GALGAS_conditionExpression & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_partList * p = (cCollectionElement_partList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_partList) ;
...
GALGAS_partList GALGAS_partList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                          const GALGAS_uint & inLength,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) const {
...
void GALGAS_partList::modifier_setMConditionAtIndex (GALGAS_conditionExpression inOperand,
                                                     GALGAS_uint inIndex,
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_partList * p = (cCollectionElement_partList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_partList) ;
...
void GALGAS_partList::modifier_setMInstructionListAtIndex (GALGAS_instructionList inOperand,
                                                           GALGAS_uint inIndex,
                                                           C_Compiler * inCompiler
                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement_partList * p = (cCollectionElement_partList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_partList::modifier_setMEndOfPartLocationAtIndex (GALGAS_location inOperand,
                                                             GALGAS_uint inIndex,
                                                             C_Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_partList * p = (cCollectionElement_partList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_conditionExpression cEnumerator_partList::current_mCondition (void) const {
  const cCollectionElement_partList * p = (const cCollectionElement_partList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_partList) ;
  return p->mAttribute_mCondition ;
}

//---------------------------------------------------------------------------*

GALGAS_instructionList cEnumerator_partList::current_mInstructionList (void) const {
  const cCollectionElement_partList * p = (const cCollectionElement_partList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_partList) ;
...
GALGAS_location cEnumerator_partList::current_mEndOfPartLocation (void) const {
  const cCollectionElement_partList * p = (const cCollectionElement_partList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_partList) ;
...
cCollectionElement_interruptDefinitionList::cCollectionElement_interruptDefinitionList (const GALGAS_lstring & in_mInterruptName,
                                                                                        ...
                                                                                        COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mAttribute_mInterruptName (in_mInterruptName),
...
cCollectionElement * cCollectionElement_interruptDefinitionList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_interruptDefinitionList (mAttribute_mInterruptName, mAttribute_mFastReturn, mAttribute_mInstructionList, mAttribute_mEndOfInterruptLocation COMMA_HERE)) ;
  return result ;
}
...
// mAttribute_mInterruptName.description (ioString, inIndentation) ;
// mAttribute_mFastReturn.description (ioString, inIndentation) ;
// mAttribute_mInstructionList.description (ioString, inIndentation) ;
...
enumComparisonResult cCollectionElement_interruptDefinitionList::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_interruptDefinitionList * operand = (cCollectionElement_interruptDefinitionList *) inOperand ;
  enumComparisonResult result = kOperandEqual ;
  if (kOperandEqual == result) {
    result = mAttribute_mInterruptName.objectCompare (operand->mAttribute_mInterruptName) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mFastReturn.objectCompare (operand->mAttribute_mFastReturn) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionList.objectCompare (operand->mAttribute_mInstructionList) ;
  }
...
void GALGAS_interruptDefinitionList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_interruptDefinitionList * p = (cCollectionElement_interruptDefinitionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
    ...
    macroValidObject (p, cCollectionElement_interruptDefinitionList) ;
    outOperand0 = p->mAttribute_mInterruptName ;
    outOperand1 = p->mAttribute_mFastReturn ;
    outOperand2 = p->mAttribute_mInstructionList ;
    outOperand3 = p->mAttribute_mEndOfInterruptLocation ;
  }
}
...
GALGAS_interruptDefinitionList GALGAS_interruptDefinitionList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                        const GALGAS_uint & inLength,
                                                                                        C_Compiler * inCompiler
                                                                                        COMMA_LOCATION_ARGS) const {
...
void GALGAS_interruptDefinitionList::modifier_setMInterruptNameAtIndex (GALGAS_lstring inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_interruptDefinitionList * p = (cCollectionElement_interruptDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_interruptDefinitionList) ;
    p->mAttribute_mInterruptName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_interruptDefinitionList::modifier_setMFastReturnAtIndex (GALGAS_bool inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_interruptDefinitionList * p = (cCollectionElement_interruptDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_interruptDefinitionList) ;
    p->mAttribute_mFastReturn = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_interruptDefinitionList::modifier_setMInstructionListAtIndex (GALGAS_instructionList inOperand,
                                                                          GALGAS_uint inIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_interruptDefinitionList * p = (cCollectionElement_interruptDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_interruptDefinitionList::modifier_setMEndOfInterruptLocationAtIndex (GALGAS_location inOperand,
                                                                                 GALGAS_uint inIndex,
                                                                                 C_Compiler * inCompiler
                                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement_interruptDefinitionList * p = (cCollectionElement_interruptDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring GALGAS_interruptDefinitionList::reader_mInterruptNameAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_interruptDefinitionList) ;
    result = p->mAttribute_mInterruptName ;
  }
  return result ;
}
...
GALGAS_lstring cEnumerator_interruptDefinitionList::current_mInterruptName (void) const {
  const cCollectionElement_interruptDefinitionList * p = (const cCollectionElement_interruptDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_interruptDefinitionList) ;
  return p->mAttribute_mInterruptName ;
}

//---------------------------------------------------------------------------*

GALGAS_bool cEnumerator_interruptDefinitionList::current_mFastReturn (void) const {
  const cCollectionElement_interruptDefinitionList * p = (const cCollectionElement_interruptDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_interruptDefinitionList) ;
  return p->mAttribute_mFastReturn ;
}

//---------------------------------------------------------------------------*

GALGAS_instructionList cEnumerator_interruptDefinitionList::current_mInstructionList (void) const {
  const cCollectionElement_interruptDefinitionList * p = (const cCollectionElement_interruptDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_interruptDefinitionList) ;
  return p->mAttribute_mInstructionList ;
}
...
GALGAS_location cEnumerator_interruptDefinitionList::current_mEndOfInterruptLocation (void) const {
  const cCollectionElement_interruptDefinitionList * p = (const cCollectionElement_interruptDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_interruptDefinitionList) ;
...
cCollectionElement * cCollectionElement_routineDefinitionList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_routineDefinitionList (mAttribute_mRoutineName, mAttribute_mRequiredBank, mAttribute_mReturnedBank, mAttribute_mPreservesBank, mAttribute_mIsNoReturn, mAttribute_mInstructionList, mAttribute_mEndOfRoutineLocation COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cCollectionElement_routineDefinitionList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_routineDefinitionList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
    ...
    macroValidObject (p, cCollectionElement_routineDefinitionList) ;
    outOperand0 = p->mAttribute_mRoutineName ;
    outOperand1 = p->mAttribute_mRequiredBank ;
    outOperand2 = p->mAttribute_mReturnedBank ;
    outOperand3 = p->mAttribute_mPreservesBank ;
    outOperand4 = p->mAttribute_mIsNoReturn ;
    outOperand5 = p->mAttribute_mInstructionList ;
    outOperand6 = p->mAttribute_mEndOfRoutineLocation ;
  }
}
...
GALGAS_routineDefinitionList GALGAS_routineDefinitionList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                    const GALGAS_uint & inLength,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const {
...
void GALGAS_routineDefinitionList::modifier_setMRoutineNameAtIndex (GALGAS_lstring inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_routineDefinitionList) ;
...
void GALGAS_routineDefinitionList::modifier_setMRequiredBankAtIndex (GALGAS_luint inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDefinitionList::modifier_setMReturnedBankAtIndex (GALGAS_luint inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDefinitionList::modifier_setMPreservesBankAtIndex (GALGAS_bool inOperand,
                                                                      GALGAS_uint inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDefinitionList::modifier_setMIsNoReturnAtIndex (GALGAS_bool inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDefinitionList::modifier_setMInstructionListAtIndex (GALGAS_instructionList inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDefinitionList::modifier_setMEndOfRoutineLocationAtIndex (GALGAS_location inOperand,
                                                                             GALGAS_uint inIndex,
                                                                             C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDefinitionList * p = (cCollectionElement_routineDefinitionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring cEnumerator_routineDefinitionList::current_mRoutineName (void) const {
  const cCollectionElement_routineDefinitionList * p = (const cCollectionElement_routineDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDefinitionList) ;
  return p->mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_luint cEnumerator_routineDefinitionList::current_mRequiredBank (void) const {
  const cCollectionElement_routineDefinitionList * p = (const cCollectionElement_routineDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDefinitionList) ;
...
GALGAS_luint cEnumerator_routineDefinitionList::current_mReturnedBank (void) const {
  const cCollectionElement_routineDefinitionList * p = (const cCollectionElement_routineDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDefinitionList) ;
...
GALGAS_bool cEnumerator_routineDefinitionList::current_mPreservesBank (void) const {
  const cCollectionElement_routineDefinitionList * p = (const cCollectionElement_routineDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDefinitionList) ;
...
GALGAS_bool cEnumerator_routineDefinitionList::current_mIsNoReturn (void) const {
  const cCollectionElement_routineDefinitionList * p = (const cCollectionElement_routineDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDefinitionList) ;
...
GALGAS_instructionList cEnumerator_routineDefinitionList::current_mInstructionList (void) const {
  const cCollectionElement_routineDefinitionList * p = (const cCollectionElement_routineDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDefinitionList) ;
  return p->mAttribute_mInstructionList ;
}
...
GALGAS_location cEnumerator_routineDefinitionList::current_mEndOfRoutineLocation (void) const {
  const cCollectionElement_routineDefinitionList * p = (const cCollectionElement_routineDefinitionList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDefinitionList) ;
...
cCollectionElement * cCollectionElement_routineDeclarationList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_routineDeclarationList (mAttribute_mRoutineName, mAttribute_mRequiredBank, mAttribute_mReturnedBank, mAttribute_mPreservesBank, mAttribute_mIsNoReturn COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cCollectionElement_routineDeclarationList::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_routineDeclarationList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_routineDeclarationList * p = (cCollectionElement_routineDeclarationList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
    ...
    macroValidObject (p, cCollectionElement_routineDeclarationList) ;
    outOperand0 = p->mAttribute_mRoutineName ;
    outOperand1 = p->mAttribute_mRequiredBank ;
    outOperand2 = p->mAttribute_mReturnedBank ;
    outOperand3 = p->mAttribute_mPreservesBank ;
...
GALGAS_routineDeclarationList GALGAS_routineDeclarationList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                      const GALGAS_uint & inLength,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
...
void GALGAS_routineDeclarationList::modifier_setMRoutineNameAtIndex (GALGAS_lstring inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDeclarationList * p = (cCollectionElement_routineDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_routineDeclarationList) ;
    p->mAttribute_mRoutineName = inOperand ;
  }
...
void GALGAS_routineDeclarationList::modifier_setMRequiredBankAtIndex (GALGAS_luint inOperand,
                                                                      GALGAS_uint inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDeclarationList * p = (cCollectionElement_routineDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDeclarationList::modifier_setMReturnedBankAtIndex (GALGAS_luint inOperand,
                                                                      GALGAS_uint inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDeclarationList * p = (cCollectionElement_routineDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDeclarationList::modifier_setMPreservesBankAtIndex (GALGAS_bool inOperand,
                                                                       GALGAS_uint inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDeclarationList * p = (cCollectionElement_routineDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_routineDeclarationList::modifier_setMIsNoReturnAtIndex (GALGAS_bool inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_routineDeclarationList * p = (cCollectionElement_routineDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring cEnumerator_routineDeclarationList::current_mRoutineName (void) const {
  const cCollectionElement_routineDeclarationList * p = (const cCollectionElement_routineDeclarationList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDeclarationList) ;
  return p->mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_luint cEnumerator_routineDeclarationList::current_mRequiredBank (void) const {
  const cCollectionElement_routineDeclarationList * p = (const cCollectionElement_routineDeclarationList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDeclarationList) ;
  return p->mAttribute_mRequiredBank ;
}
...
GALGAS_luint cEnumerator_routineDeclarationList::current_mReturnedBank (void) const {
  const cCollectionElement_routineDeclarationList * p = (const cCollectionElement_routineDeclarationList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDeclarationList) ;
  return p->mAttribute_mReturnedBank ;
}
...
GALGAS_bool cEnumerator_routineDeclarationList::current_mPreservesBank (void) const {
  const cCollectionElement_routineDeclarationList * p = (const cCollectionElement_routineDeclarationList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDeclarationList) ;
  return p->mAttribute_mPreservesBank ;
}
...
GALGAS_bool cEnumerator_routineDeclarationList::current_mIsNoReturn (void) const {
  const cCollectionElement_routineDeclarationList * p = (const cCollectionElement_routineDeclarationList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_routineDeclarationList) ;
  return p->mAttribute_mIsNoReturn ;
}
...
enumComparisonResult GALGAS_programKind::objectCompare (const GALGAS_programKind & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
/* GALGAS_piccoloModel::GALGAS_piccoloModel (const GALGAS_piccoloModel & inSource) :
//mAttribute_mProgramName (inSource.mAttribute_mProgramName),
//mAttribute_mProgramKind (inSource.mAttribute_mProgramKind),
//mAttribute_mDeviceNameOrBootLoaderReference (inSource.mAttribute_mDeviceNameOrBootLoaderReference),
...
/* GALGAS_piccoloModel & GALGAS_piccoloModel::operator = (const GALGAS_piccoloModel & inOperand) {
  mAttribute_mProgramName = inOperand.mAttribute_mProgramName ;
  mAttribute_mProgramKind = inOperand.mAttribute_mProgramKind ;
  mAttribute_mDeviceNameOrBootLoaderReference = inOperand.mAttribute_mDeviceNameOrBootLoaderReference ;
...
enumComparisonResult GALGAS_piccoloModel::objectCompare (const GALGAS_piccoloModel & inOperand) const {
   enumComparisonResult result = kOperandEqual ;
...
enumComparisonResult GALGAS_conditionExpression::objectCompare (const GALGAS_conditionExpression & inOperand) const {
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_conditionExpression) ;
}
...
enumComparisonResult GALGAS_andCondition::objectCompare (const GALGAS_andCondition & inOperand) const {
  enumComparisonResult result = GALGAS_conditionExpression::objectCompare (inOperand) ;
  const cPtr_andCondition * p = (const cPtr_andCondition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_andCondition) ;
  const cPtr_andCondition * q = (const cPtr_andCondition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_andCondition) ;
  if (kOperandEqual == result) {
...
GALGAS_conditionExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_andCondition) ;
}
...
void GALGAS_andCondition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_andCondition) ;
...
GALGAS_conditionExpression GALGAS_andCondition::reader_mLeftExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_andCondition * p = (const cPtr_andCondition *) mObjectPtr ;
    macroValidObject (p, const cPtr_andCondition) ;
...
void GALGAS_andCondition::modifier_setMLeftExpression (GALGAS_conditionExpression inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_andCondition * p = (cPtr_andCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_andCondition) ;
    p->mAttribute_mLeftExpression = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_andCondition::modifier_setMRightExpression (GALGAS_conditionExpression inValue
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_andCondition * p = (cPtr_andCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_andCondition) ;
    p->mAttribute_mRightExpression = inValue ;
  }
}
...
enumComparisonResult GALGAS_bcc_5F_in_5F_structured_5F_if_5F_condition::objectCompare (const GALGAS_bcc_5F_in_5F_structured_5F_if_5F_condition & inOperand) const {
  enumComparisonResult result = GALGAS_conditionExpression::objectCompare (inOperand) ;
  const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition * p = (const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition) ;
  const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition * q = (const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition) ;
  if (kOperandEqual == result) {
...
GALGAS_conditionExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition) ;
}
...
void GALGAS_bcc_5F_in_5F_structured_5F_if_5F_condition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition) ;
...
GALGAS_conditional_5F_branch GALGAS_bcc_5F_in_5F_structured_5F_if_5F_condition::reader_mCondition (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition * p = (const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition *) mObjectPtr ;
    macroValidObject (p, const cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition) ;
    result = p->mAttribute_mCondition ;
  }
  return result ;
}
...
void GALGAS_bcc_5F_in_5F_structured_5F_if_5F_condition::modifier_setMCondition (GALGAS_conditional_5F_branch inValue
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition * p = (cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition *) mObjectPtr ;
    macroValidObject (p, cPtr_bcc_5F_in_5F_structured_5F_if_5F_condition) ;
    p->mAttribute_mCondition = inValue ;
  }
}
...
enumComparisonResult GALGAS_bitTest_5F_in_5F_structured_5F_if_5F_condition::objectCompare (const GALGAS_bitTest_5F_in_5F_structured_5F_if_5F_condition & inOperand) const {
  enumComparisonResult result = GALGAS_conditionExpression::objectCompare (inOperand) ;
  ...
  macroNullOrValidObject (p, const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
  const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition * q = (const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
  if (kOperandEqual == result) {
...
GALGAS_conditionExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
}
...
void GALGAS_bitTest_5F_in_5F_structured_5F_if_5F_condition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
...
GALGAS_registerExpression GALGAS_bitTest_5F_in_5F_structured_5F_if_5F_condition::reader_mRegisterExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition * p = (const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition *) mObjectPtr ;
    macroValidObject (p, const cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
...
void GALGAS_bitTest_5F_in_5F_structured_5F_if_5F_condition::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition * p = (cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition *) mObjectPtr ;
    macroValidObject (p, cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
    p->mAttribute_mRegisterExpression = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_bitTest_5F_in_5F_structured_5F_if_5F_condition::modifier_setMBitNumber (GALGAS_bitNumberExpression inValue
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition * p = (cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition *) mObjectPtr ;
    macroValidObject (p, cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
...
void GALGAS_bitTest_5F_in_5F_structured_5F_if_5F_condition::modifier_setMBTFSSinstruction (GALGAS_bool inValue
                                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition * p = (cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition *) mObjectPtr ;
    macroValidObject (p, cPtr_bitTest_5F_in_5F_structured_5F_if_5F_condition) ;
    p->mAttribute_mBTFSSinstruction = inValue ;
  }
}
...
enumComparisonResult GALGAS_incDecRegisterInCondition::objectCompare (const GALGAS_incDecRegisterInCondition & inOperand) const {
  enumComparisonResult result = GALGAS_conditionExpression::objectCompare (inOperand) ;
  const cPtr_incDecRegisterInCondition * p = (const cPtr_incDecRegisterInCondition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_incDecRegisterInCondition) ;
  const cPtr_incDecRegisterInCondition * q = (const cPtr_incDecRegisterInCondition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_incDecRegisterInCondition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mRegisterExpression.objectCompare (q->mAttribute_mRegisterExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_conditionExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_incDecRegisterInCondition) ;
}
...
void GALGAS_incDecRegisterInCondition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_incDecRegisterInCondition) ;
...
GALGAS_registerExpression GALGAS_incDecRegisterInCondition::reader_mRegisterExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_incDecRegisterInCondition * p = (const cPtr_incDecRegisterInCondition *) mObjectPtr ;
    macroValidObject (p, const cPtr_incDecRegisterInCondition) ;
    result = p->mAttribute_mRegisterExpression ;
  }
  return result ;
}
...
void GALGAS_incDecRegisterInCondition::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_incDecRegisterInCondition * p = (cPtr_incDecRegisterInCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_incDecRegisterInCondition) ;
...
void GALGAS_incDecRegisterInCondition::modifier_setMIncrement (GALGAS_bool inValue
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_incDecRegisterInCondition * p = (cPtr_incDecRegisterInCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_incDecRegisterInCondition) ;
...
void GALGAS_incDecRegisterInCondition::modifier_setM_5F_W_5F_isDestination (GALGAS_bool inValue
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_incDecRegisterInCondition * p = (cPtr_incDecRegisterInCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_incDecRegisterInCondition) ;
...
void GALGAS_incDecRegisterInCondition::modifier_setMBranchIfZero (GALGAS_bool inValue
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_incDecRegisterInCondition * p = (cPtr_incDecRegisterInCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_incDecRegisterInCondition) ;
...
enumComparisonResult GALGAS_negateCondition::objectCompare (const GALGAS_negateCondition & inOperand) const {
  enumComparisonResult result = GALGAS_conditionExpression::objectCompare (inOperand) ;
  const cPtr_negateCondition * p = (const cPtr_negateCondition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_negateCondition) ;
  const cPtr_negateCondition * q = (const cPtr_negateCondition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_negateCondition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mCondition.objectCompare (q->mAttribute_mCondition) ;
  }
  return result ;
...
GALGAS_conditionExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_negateCondition) ;
}
...
void GALGAS_negateCondition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_negateCondition) ;
...
GALGAS_conditionExpression GALGAS_negateCondition::reader_mCondition (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_negateCondition * p = (const cPtr_negateCondition *) mObjectPtr ;
    macroValidObject (p, const cPtr_negateCondition) ;
    result = p->mAttribute_mCondition ;
  }
  return result ;
}
...
void GALGAS_negateCondition::modifier_setMCondition (GALGAS_conditionExpression inValue
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_negateCondition * p = (cPtr_negateCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_negateCondition) ;
...
enumComparisonResult GALGAS_registerComparisonCondition::objectCompare (const GALGAS_registerComparisonCondition & inOperand) const {
  enumComparisonResult result = GALGAS_conditionExpression::objectCompare (inOperand) ;
  const cPtr_registerComparisonCondition * p = (const cPtr_registerComparisonCondition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_registerComparisonCondition) ;
  const cPtr_registerComparisonCondition * q = (const cPtr_registerComparisonCondition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_registerComparisonCondition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mRegisterExpression.objectCompare (q->mAttribute_mRegisterExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_conditionExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_registerComparisonCondition) ;
}
...
void GALGAS_registerComparisonCondition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_registerComparisonCondition) ;
...
GALGAS_registerExpression GALGAS_registerComparisonCondition::reader_mRegisterExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_registerComparisonCondition * p = (const cPtr_registerComparisonCondition *) mObjectPtr ;
    macroValidObject (p, const cPtr_registerComparisonCondition) ;
    result = p->mAttribute_mRegisterExpression ;
  }
  return result ;
}
...
void GALGAS_registerComparisonCondition::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_registerComparisonCondition * p = (cPtr_registerComparisonCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_registerComparisonCondition) ;
...
void GALGAS_registerComparisonCondition::modifier_setMComparison (GALGAS_registerComparison inValue
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_registerComparisonCondition * p = (cPtr_registerComparisonCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_registerComparisonCondition) ;
...
enumComparisonResult GALGAS_registerTestCondition::objectCompare (const GALGAS_registerTestCondition & inOperand) const {
  enumComparisonResult result = GALGAS_conditionExpression::objectCompare (inOperand) ;
  const cPtr_registerTestCondition * p = (const cPtr_registerTestCondition *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_registerTestCondition) ;
  const cPtr_registerTestCondition * q = (const cPtr_registerTestCondition *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_registerTestCondition) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mRegisterExpression.objectCompare (q->mAttribute_mRegisterExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_conditionExpression (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_registerTestCondition) ;
}
...
void GALGAS_registerTestCondition::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_registerTestCondition) ;
...
GALGAS_registerExpression GALGAS_registerTestCondition::reader_mRegisterExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_registerTestCondition * p = (const cPtr_registerTestCondition *) mObjectPtr ;
    macroValidObject (p, const cPtr_registerTestCondition) ;
    result = p->mAttribute_mRegisterExpression ;
  }
  return result ;
}
...
void GALGAS_registerTestCondition::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_registerTestCondition * p = (cPtr_registerTestCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_registerTestCondition) ;
...
void GALGAS_registerTestCondition::modifier_setMBranchIfZero (GALGAS_bool inValue
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_registerTestCondition * p = (cPtr_registerTestCondition *) mObjectPtr ;
    macroValidObject (p, cPtr_registerTestCondition) ;
...
enumComparisonResult GALGAS_piccolo_5F_instruction::objectCompare (const GALGAS_piccolo_5F_instruction & inOperand) const {
  enumComparisonResult result = kOperandEqual ;
  const cPtr_piccolo_5F_instruction * p = (const cPtr_piccolo_5F_instruction *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_piccolo_5F_instruction) ;
  const cPtr_piccolo_5F_instruction * q = (const cPtr_piccolo_5F_instruction *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_piccolo_5F_instruction) ;
  if (kOperandEqual == result) {
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_piccolo_5F_instruction) ;
}
...
GALGAS_location GALGAS_piccolo_5F_instruction::reader_mInstructionLocation (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_piccolo_5F_instruction * p = (const cPtr_piccolo_5F_instruction *) mObjectPtr ;
    macroValidObject (p, const cPtr_piccolo_5F_instruction) ;
...
void GALGAS_piccolo_5F_instruction::modifier_setMInstructionLocation (GALGAS_location inValue
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_piccolo_5F_instruction * p = (cPtr_piccolo_5F_instruction *) mObjectPtr ;
    macroValidObject (p, cPtr_piccolo_5F_instruction) ;
...
enumComparisonResult GALGAS_instruction_5F_CLRWDT::objectCompare (const GALGAS_instruction_5F_CLRWDT & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_CLRWDT) ;
}
...
void GALGAS_instruction_5F_CLRWDT::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_CLRWDT) ;
...
enumComparisonResult GALGAS_instruction_5F_DAW::objectCompare (const GALGAS_instruction_5F_DAW & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_DAW) ;
}
...
void GALGAS_instruction_5F_DAW::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_DAW) ;
...
enumComparisonResult GALGAS_instruction_5F_FA::objectCompare (const GALGAS_instruction_5F_FA & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_FA * p = (const cPtr_instruction_5F_FA *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_FA) ;
  const cPtr_instruction_5F_FA * q = (const cPtr_instruction_5F_FA *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_FA) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_FA) ;
}
...
void GALGAS_instruction_5F_FA::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_FA) ;
...
GALGAS_FA_5F_instruction_5F_base_5F_code GALGAS_instruction_5F_FA::reader_mFAinstruction (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_FA * p = (const cPtr_instruction_5F_FA *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_FA) ;
...
void GALGAS_instruction_5F_FA::modifier_setMFAinstruction (GALGAS_FA_5F_instruction_5F_base_5F_code inValue
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FA * p = (cPtr_instruction_5F_FA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FA) ;
...
void GALGAS_instruction_5F_FA::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FA * p = (cPtr_instruction_5F_FA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FA) ;
...
enumComparisonResult GALGAS_instruction_5F_FBA::objectCompare (const GALGAS_instruction_5F_FBA & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_FBA * p = (const cPtr_instruction_5F_FBA *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_FBA) ;
  const cPtr_instruction_5F_FBA * q = (const cPtr_instruction_5F_FBA *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_FBA) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_FBA) ;
}
...
void GALGAS_instruction_5F_FBA::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_FBA) ;
...
GALGAS_bit_5F_oriented_5F_op GALGAS_instruction_5F_FBA::reader_mBitOrientedOp (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_FBA * p = (const cPtr_instruction_5F_FBA *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_FBA) ;
...
void GALGAS_instruction_5F_FBA::modifier_setMBitOrientedOp (GALGAS_bit_5F_oriented_5F_op inValue
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FBA * p = (cPtr_instruction_5F_FBA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FBA) ;
...
void GALGAS_instruction_5F_FBA::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FBA * p = (cPtr_instruction_5F_FBA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FBA) ;
...
void GALGAS_instruction_5F_FBA::modifier_setMBitNumber (GALGAS_bitNumberExpression inValue
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FBA * p = (cPtr_instruction_5F_FBA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FBA) ;
...
enumComparisonResult GALGAS_instruction_5F_FDA::objectCompare (const GALGAS_instruction_5F_FDA & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_FDA * p = (const cPtr_instruction_5F_FDA *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_FDA) ;
  const cPtr_instruction_5F_FDA * q = (const cPtr_instruction_5F_FDA *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_FDA) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_FDA) ;
}
...
void GALGAS_instruction_5F_FDA::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_FDA) ;
...
GALGAS_instruction_5F_FDA_5F_base_5F_code GALGAS_instruction_5F_FDA::reader_mInstruction_5F_FDA_5F_base_5F_code (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_FDA * p = (const cPtr_instruction_5F_FDA *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_FDA) ;
...
void GALGAS_instruction_5F_FDA::modifier_setMInstruction_5F_FDA_5F_base_5F_code (GALGAS_instruction_5F_FDA_5F_base_5F_code inValue
                                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FDA * p = (cPtr_instruction_5F_FDA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FDA) ;
...
void GALGAS_instruction_5F_FDA::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FDA * p = (cPtr_instruction_5F_FDA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FDA) ;
...
void GALGAS_instruction_5F_FDA::modifier_setM_5F_W_5F_isDestination (GALGAS_bool inValue
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FDA * p = (cPtr_instruction_5F_FDA *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FDA) ;
...
enumComparisonResult GALGAS_instruction_5F_FOREVER::objectCompare (const GALGAS_instruction_5F_FOREVER & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_FOREVER * p = (const cPtr_instruction_5F_FOREVER *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_FOREVER) ;
  const cPtr_instruction_5F_FOREVER * q = (const cPtr_instruction_5F_FOREVER *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_FOREVER) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_FOREVER) ;
}
...
void GALGAS_instruction_5F_FOREVER::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_FOREVER) ;
...
GALGAS_instructionList GALGAS_instruction_5F_FOREVER::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_FOREVER * p = (const cPtr_instruction_5F_FOREVER *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_FOREVER) ;
    result = p->mAttribute_mInstructionList ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_FOREVER::modifier_setMInstructionList (GALGAS_instructionList inValue
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FOREVER * p = (cPtr_instruction_5F_FOREVER *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FOREVER) ;
    p->mAttribute_mInstructionList = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_FOREVER::modifier_setMEndOfInstructionList (GALGAS_location inValue
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_FOREVER * p = (cPtr_instruction_5F_FOREVER *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_FOREVER) ;
    p->mAttribute_mEndOfInstructionList = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON::objectCompare (const GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON * p = (const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON) ;
  const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON * q = (const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON) ;
}
...
GALGAS_piccolo_5F_instruction GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON::reader_mInstruction (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON * p = (const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_IF_5F_SEMI_5F_COLON) ;
    result = p->mAttribute_mInstruction ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON::modifier_setMInstruction (GALGAS_piccolo_5F_instruction inValue
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_SEMI_5F_COLON * p = (cPtr_instruction_5F_IF_5F_SEMI_5F_COLON *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_SEMI_5F_COLON) ;
    p->mAttribute_mInstruction = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_IF_5F_BitTest::objectCompare (const GALGAS_instruction_5F_IF_5F_BitTest & inOperand) const {
  enumComparisonResult result = GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON::objectCompare (inOperand) ;
  const cPtr_instruction_5F_IF_5F_BitTest * p = (const cPtr_instruction_5F_IF_5F_BitTest *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_IF_5F_BitTest) ;
  const cPtr_instruction_5F_IF_5F_BitTest * q = (const cPtr_instruction_5F_IF_5F_BitTest *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_IF_5F_BitTest) ;
  if (kOperandEqual == result) {
...
GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_IF_5F_BitTest) ;
}
...
void GALGAS_instruction_5F_IF_5F_BitTest::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_IF_5F_BitTest) ;
...
void cPtr_instruction_5F_IF_5F_BitTest::method_getBaseCode (GALGAS_uint & outArgument_outBaseCode,
                                                            C_Compiler * /* inCompiler */
                                                            COMMA_UNUSED_LOCATION_ARGS) const {
  outArgument_outBaseCode.drop () ; // Release 'out' argument
...
void cPtr_instruction_5F_IF_5F_BitTest::method_getMnemonic (GALGAS_string & outArgument_outMnemonic,
                                                            C_Compiler * /* inCompiler */
                                                            COMMA_UNUSED_LOCATION_ARGS) const {
...
GALGAS_bool GALGAS_instruction_5F_IF_5F_BitTest::reader_mSkipIfSet (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_IF_5F_BitTest * p = (const cPtr_instruction_5F_IF_5F_BitTest *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_IF_5F_BitTest) ;
...
void GALGAS_instruction_5F_IF_5F_BitTest::modifier_setMSkipIfSet (GALGAS_bool inValue
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_BitTest * p = (cPtr_instruction_5F_IF_5F_BitTest *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_BitTest) ;
...
void GALGAS_instruction_5F_IF_5F_BitTest::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_BitTest * p = (cPtr_instruction_5F_IF_5F_BitTest *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_BitTest) ;
...
void GALGAS_instruction_5F_IF_5F_BitTest::modifier_setMBitNumber (GALGAS_bitNumberExpression inValue
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_BitTest * p = (cPtr_instruction_5F_IF_5F_BitTest *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_BitTest) ;
...
void GALGAS_instruction_5F_IF_5F_BitTest::method_getBaseCode (GALGAS_uint & outArgument0,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) const {
  if (mObjectPtr != NULL) {
    const cPtr_instruction_5F_IF_5F_BitTest * p = (const cPtr_instruction_5F_IF_5F_BitTest *) mObjectPtr ;
...
void GALGAS_instruction_5F_IF_5F_BitTest::method_getMnemonic (GALGAS_string & outArgument0,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) const {
  if (mObjectPtr != NULL) {
    const cPtr_instruction_5F_IF_5F_BitTest * p = (const cPtr_instruction_5F_IF_5F_BitTest *) mObjectPtr ;
...
enumComparisonResult GALGAS_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON::objectCompare (const GALGAS_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON & inOperand) const {
  enumComparisonResult result = GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON::objectCompare (inOperand) ;
  const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON * p = (const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON) ;
  const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON * q = (const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mOpCode.objectCompare (q->mAttribute_mOpCode) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mRegisterExpression.objectCompare (q->mAttribute_mRegisterExpression) ;
  }
...
GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON) ;
}
...
void GALGAS_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON) ;
...
GALGAS_if_5F_semi_5F_colon_5F_op GALGAS_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON::reader_mOpCode (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON * p = (const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON) ;
...
void GALGAS_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON::modifier_setMOpCode (GALGAS_if_5F_semi_5F_colon_5F_op inValue
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON * p = (cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON) ;
    p->mAttribute_mOpCode = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON * p = (cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_FA_5F_SEMI_5F_COLON) ;
...
enumComparisonResult GALGAS_instruction_5F_IF_5F_IncDec::objectCompare (const GALGAS_instruction_5F_IF_5F_IncDec & inOperand) const {
  enumComparisonResult result = GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON::objectCompare (inOperand) ;
  const cPtr_instruction_5F_IF_5F_IncDec * p = (const cPtr_instruction_5F_IF_5F_IncDec *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_IF_5F_IncDec) ;
  const cPtr_instruction_5F_IF_5F_IncDec * q = (const cPtr_instruction_5F_IF_5F_IncDec *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_IF_5F_IncDec) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mIncrement.objectCompare (q->mAttribute_mIncrement) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mSkipIfZero.objectCompare (q->mAttribute_mSkipIfZero) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mRegisterExpression.objectCompare (q->mAttribute_mRegisterExpression) ;
  }
...
GALGAS_instruction_5F_IF_5F_SEMI_5F_COLON (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_IF_5F_IncDec) ;
}
...
void GALGAS_instruction_5F_IF_5F_IncDec::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_IF_5F_IncDec) ;
...
GALGAS_bool GALGAS_instruction_5F_IF_5F_IncDec::reader_mIncrement (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_IF_5F_IncDec * p = (const cPtr_instruction_5F_IF_5F_IncDec *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_IF_5F_IncDec) ;
    result = p->mAttribute_mIncrement ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_IF_5F_IncDec::modifier_setMIncrement (GALGAS_bool inValue
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_IncDec * p = (cPtr_instruction_5F_IF_5F_IncDec *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_IncDec) ;
...
void GALGAS_instruction_5F_IF_5F_IncDec::modifier_setMSkipIfZero (GALGAS_bool inValue
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_IncDec * p = (cPtr_instruction_5F_IF_5F_IncDec *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_IncDec) ;
    p->mAttribute_mSkipIfZero = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_IF_5F_IncDec::modifier_setMRegisterExpression (GALGAS_registerExpression inValue
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_IncDec * p = (cPtr_instruction_5F_IF_5F_IncDec *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_IncDec) ;
...
void GALGAS_instruction_5F_IF_5F_IncDec::modifier_setM_5F_W_5F_isDestination (GALGAS_bool inValue
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_IF_5F_IncDec * p = (cPtr_instruction_5F_IF_5F_IncDec *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_IF_5F_IncDec) ;
...
enumComparisonResult GALGAS_instruction_5F_JSR::objectCompare (const GALGAS_instruction_5F_JSR & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_JSR * p = (const cPtr_instruction_5F_JSR *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_JSR) ;
  const cPtr_instruction_5F_JSR * q = (const cPtr_instruction_5F_JSR *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_JSR) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_JSR) ;
}
...
void GALGAS_instruction_5F_JSR::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_JSR) ;
...
GALGAS_lstring GALGAS_instruction_5F_JSR::reader_mTargetLabel (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_JSR * p = (const cPtr_instruction_5F_JSR *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_JSR) ;
...
void GALGAS_instruction_5F_JSR::modifier_setMTargetLabel (GALGAS_lstring inValue
                                                          COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_JSR * p = (cPtr_instruction_5F_JSR *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_JSR) ;
...
void GALGAS_instruction_5F_JSR::modifier_setMKind (GALGAS_jumpInstructionKind inValue
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_JSR * p = (cPtr_instruction_5F_JSR *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_JSR) ;
...
enumComparisonResult GALGAS_instruction_5F_JUMP::objectCompare (const GALGAS_instruction_5F_JUMP & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_JUMP * p = (const cPtr_instruction_5F_JUMP *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_JUMP) ;
  const cPtr_instruction_5F_JUMP * q = (const cPtr_instruction_5F_JUMP *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_JUMP) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mTargetLabel.objectCompare (q->mAttribute_mTargetLabel) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_JUMP) ;
}
...
void GALGAS_instruction_5F_JUMP::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_JUMP) ;
...
GALGAS_lstring GALGAS_instruction_5F_JUMP::reader_mTargetLabel (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_JUMP * p = (const cPtr_instruction_5F_JUMP *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_JUMP) ;
    result = p->mAttribute_mTargetLabel ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_JUMP::modifier_setMTargetLabel (GALGAS_lstring inValue
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_JUMP * p = (cPtr_instruction_5F_JUMP *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_JUMP) ;
...
void GALGAS_instruction_5F_JUMP::modifier_setMKind (GALGAS_jumpInstructionKind inValue
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_JUMP * p = (cPtr_instruction_5F_JUMP *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_JUMP) ;
...
enumComparisonResult GALGAS_instruction_5F_JUMPCC::objectCompare (const GALGAS_instruction_5F_JUMPCC & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_JUMPCC * p = (const cPtr_instruction_5F_JUMPCC *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_JUMPCC) ;
  const cPtr_instruction_5F_JUMPCC * q = (const cPtr_instruction_5F_JUMPCC *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_JUMPCC) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mTargetLabel.objectCompare (q->mAttribute_mTargetLabel) ;
  }
  if (kOperandEqual == result) {
  ...
  if (kOperandEqual == result) {
    result = p->mAttribute_mIsBcc.objectCompare (q->mAttribute_mIsBcc) ;
  }
  return result ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_JUMPCC) ;
}
...
void GALGAS_instruction_5F_JUMPCC::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_JUMPCC) ;
...
GALGAS_lstring GALGAS_instruction_5F_JUMPCC::reader_mTargetLabel (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_JUMPCC * p = (const cPtr_instruction_5F_JUMPCC *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_JUMPCC) ;
    result = p->mAttribute_mTargetLabel ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_JUMPCC::modifier_setMTargetLabel (GALGAS_lstring inValue
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_JUMPCC * p = (cPtr_instruction_5F_JUMPCC *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_JUMPCC) ;
...
void GALGAS_instruction_5F_JUMPCC::modifier_setMConditionalBranch (GALGAS_conditional_5F_branch inValue
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_JUMPCC * p = (cPtr_instruction_5F_JUMPCC *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_JUMPCC) ;
...
void GALGAS_instruction_5F_JUMPCC::modifier_setMIsBcc (GALGAS_bool inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_JUMPCC * p = (cPtr_instruction_5F_JUMPCC *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_JUMPCC) ;
    p->mAttribute_mIsBcc = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_LFSR::objectCompare (const GALGAS_instruction_5F_LFSR & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_LFSR * p = (const cPtr_instruction_5F_LFSR *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_LFSR) ;
  const cPtr_instruction_5F_LFSR * q = (const cPtr_instruction_5F_LFSR *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_LFSR) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_LFSR) ;
}
...
void GALGAS_instruction_5F_LFSR::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_LFSR) ;
...
GALGAS_luint GALGAS_instruction_5F_LFSR::reader_mFSRindex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_LFSR * p = (const cPtr_instruction_5F_LFSR *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_LFSR) ;
...
void GALGAS_instruction_5F_LFSR::modifier_setMFSRindex (GALGAS_luint inValue
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_LFSR * p = (cPtr_instruction_5F_LFSR *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_LFSR) ;
...
void GALGAS_instruction_5F_LFSR::modifier_setMImmediatExpression (GALGAS_immediatExpression inValue
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_LFSR * p = (cPtr_instruction_5F_LFSR *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_LFSR) ;
    p->mAttribute_mImmediatExpression = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_MNOP::objectCompare (const GALGAS_instruction_5F_MNOP & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_MNOP * p = (const cPtr_instruction_5F_MNOP *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_MNOP) ;
  const cPtr_instruction_5F_MNOP * q = (const cPtr_instruction_5F_MNOP *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_MNOP) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_MNOP) ;
}
...
void GALGAS_instruction_5F_MNOP::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_MNOP) ;
...
GALGAS_luint GALGAS_instruction_5F_MNOP::reader_mOccurrenceFactor (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_MNOP * p = (const cPtr_instruction_5F_MNOP *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_MNOP) ;
...
void GALGAS_instruction_5F_MNOP::modifier_setMOccurrenceFactor (GALGAS_luint inValue
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_MNOP * p = (cPtr_instruction_5F_MNOP *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_MNOP) ;
...
enumComparisonResult GALGAS_instruction_5F_MOVFF::objectCompare (const GALGAS_instruction_5F_MOVFF & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_MOVFF * p = (const cPtr_instruction_5F_MOVFF *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_MOVFF) ;
  const cPtr_instruction_5F_MOVFF * q = (const cPtr_instruction_5F_MOVFF *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_MOVFF) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mSourceRegisterName.objectCompare (q->mAttribute_mSourceRegisterName) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mDestinationRegisterName.objectCompare (q->mAttribute_mDestinationRegisterName) ;
  }
  return result ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_MOVFF) ;
}
...
void GALGAS_instruction_5F_MOVFF::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_MOVFF) ;
...
GALGAS_registerExpression GALGAS_instruction_5F_MOVFF::reader_mSourceRegisterName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_MOVFF * p = (const cPtr_instruction_5F_MOVFF *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_MOVFF) ;
...
void GALGAS_instruction_5F_MOVFF::modifier_setMSourceRegisterName (GALGAS_registerExpression inValue
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_MOVFF * p = (cPtr_instruction_5F_MOVFF *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_MOVFF) ;
    p->mAttribute_mSourceRegisterName = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_MOVFF::modifier_setMDestinationRegisterName (GALGAS_registerExpression inValue
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_MOVFF * p = (cPtr_instruction_5F_MOVFF *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_MOVFF) ;
    p->mAttribute_mDestinationRegisterName = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_NOP::objectCompare (const GALGAS_instruction_5F_NOP & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_NOP) ;
}
...
void GALGAS_instruction_5F_NOP::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_NOP) ;
...
enumComparisonResult GALGAS_instruction_5F_POP::objectCompare (const GALGAS_instruction_5F_POP & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_POP) ;
}
...
void GALGAS_instruction_5F_POP::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_POP) ;
...
enumComparisonResult GALGAS_instruction_5F_PUSH::objectCompare (const GALGAS_instruction_5F_PUSH & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_PUSH) ;
}
...
void GALGAS_instruction_5F_PUSH::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_PUSH) ;
...
enumComparisonResult GALGAS_instruction_5F_RESET::objectCompare (const GALGAS_instruction_5F_RESET & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_RESET) ;
}
...
void GALGAS_instruction_5F_RESET::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_RESET) ;
...
enumComparisonResult GALGAS_instruction_5F_SLEEP::objectCompare (const GALGAS_instruction_5F_SLEEP & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_SLEEP) ;
}
...
void GALGAS_instruction_5F_SLEEP::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_SLEEP) ;
...
enumComparisonResult GALGAS_instruction_5F_TBLRD::objectCompare (const GALGAS_instruction_5F_TBLRD & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_TBLRD * p = (const cPtr_instruction_5F_TBLRD *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_TBLRD) ;
  const cPtr_instruction_5F_TBLRD * q = (const cPtr_instruction_5F_TBLRD *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_TBLRD) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_TBLRD) ;
}
...
void GALGAS_instruction_5F_TBLRD::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_TBLRD) ;
...
GALGAS_tableAccessOption GALGAS_instruction_5F_TBLRD::reader_mOption (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_TBLRD * p = (const cPtr_instruction_5F_TBLRD *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_TBLRD) ;
...
void GALGAS_instruction_5F_TBLRD::modifier_setMOption (GALGAS_tableAccessOption inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_TBLRD * p = (cPtr_instruction_5F_TBLRD *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_TBLRD) ;
...
enumComparisonResult GALGAS_instruction_5F_TBLWT::objectCompare (const GALGAS_instruction_5F_TBLWT & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_TBLWT * p = (const cPtr_instruction_5F_TBLWT *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_TBLWT) ;
  const cPtr_instruction_5F_TBLWT * q = (const cPtr_instruction_5F_TBLWT *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_TBLWT) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mOption.objectCompare (q->mAttribute_mOption) ;
  }
  return result ;
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_TBLWT) ;
}
...
void GALGAS_instruction_5F_TBLWT::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_TBLWT) ;
...
GALGAS_tableAccessOption GALGAS_instruction_5F_TBLWT::reader_mOption (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_TBLWT * p = (const cPtr_instruction_5F_TBLWT *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_TBLWT) ;
    result = p->mAttribute_mOption ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_TBLWT::modifier_setMOption (GALGAS_tableAccessOption inValue
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_TBLWT * p = (cPtr_instruction_5F_TBLWT *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_TBLWT) ;
...
enumComparisonResult GALGAS_instruction_5F_banksel::objectCompare (const GALGAS_instruction_5F_banksel & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_banksel * p = (const cPtr_instruction_5F_banksel *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_banksel) ;
  const cPtr_instruction_5F_banksel * q = (const cPtr_instruction_5F_banksel *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_banksel) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_banksel) ;
}
...
void GALGAS_instruction_5F_banksel::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_banksel) ;
...
GALGAS_luint GALGAS_instruction_5F_banksel::reader_mBankIndex (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_banksel * p = (const cPtr_instruction_5F_banksel *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_banksel) ;
...
void GALGAS_instruction_5F_banksel::modifier_setMBankIndex (GALGAS_luint inValue
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_banksel * p = (cPtr_instruction_5F_banksel *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_banksel) ;
...
enumComparisonResult GALGAS_instruction_5F_computed_5F_bra::objectCompare (const GALGAS_instruction_5F_computed_5F_bra & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_computed_5F_bra * p = (const cPtr_instruction_5F_computed_5F_bra *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_computed_5F_bra) ;
  const cPtr_instruction_5F_computed_5F_bra * q = (const cPtr_instruction_5F_computed_5F_bra *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_computed_5F_bra) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mSizeExpression.objectCompare (q->mAttribute_mSizeExpression) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mTargetLabels.objectCompare (q->mAttribute_mTargetLabels) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mUsesRelativeCall.objectCompare (q->mAttribute_mUsesRelativeCall) ;
  }
  return result ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_computed_5F_bra) ;
}
...
void GALGAS_instruction_5F_computed_5F_bra::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_computed_5F_bra) ;
...
GALGAS_immediatExpression GALGAS_instruction_5F_computed_5F_bra::reader_mSizeExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_computed_5F_bra * p = (const cPtr_instruction_5F_computed_5F_bra *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_computed_5F_bra) ;
...
void GALGAS_instruction_5F_computed_5F_bra::modifier_setMSizeExpression (GALGAS_immediatExpression inValue
                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_bra * p = (cPtr_instruction_5F_computed_5F_bra *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_bra) ;
    p->mAttribute_mSizeExpression = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_computed_5F_bra::modifier_setMTargetLabels (GALGAS_lstringlist inValue
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_bra * p = (cPtr_instruction_5F_computed_5F_bra *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_bra) ;
...
void GALGAS_instruction_5F_computed_5F_bra::modifier_setMUsesRelativeCall (GALGAS_bool inValue
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_bra * p = (cPtr_instruction_5F_computed_5F_bra *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_bra) ;
    p->mAttribute_mUsesRelativeCall = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_computed_5F_goto::objectCompare (const GALGAS_instruction_5F_computed_5F_goto & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_computed_5F_goto * p = (const cPtr_instruction_5F_computed_5F_goto *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_computed_5F_goto) ;
  const cPtr_instruction_5F_computed_5F_goto * q = (const cPtr_instruction_5F_computed_5F_goto *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_computed_5F_goto) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mSizeExpression.objectCompare (q->mAttribute_mSizeExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_computed_5F_goto) ;
}
...
void GALGAS_instruction_5F_computed_5F_goto::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_computed_5F_goto) ;
...
GALGAS_immediatExpression GALGAS_instruction_5F_computed_5F_goto::reader_mSizeExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_computed_5F_goto * p = (const cPtr_instruction_5F_computed_5F_goto *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_computed_5F_goto) ;
    result = p->mAttribute_mSizeExpression ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_computed_5F_goto::modifier_setMSizeExpression (GALGAS_immediatExpression inValue
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_goto * p = (cPtr_instruction_5F_computed_5F_goto *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_goto) ;
...
void GALGAS_instruction_5F_computed_5F_goto::modifier_setMTargetLabels (GALGAS_lstringlist inValue
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_goto * p = (cPtr_instruction_5F_computed_5F_goto *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_goto) ;
...
void GALGAS_instruction_5F_computed_5F_goto::modifier_setMUsesRelativeCall (GALGAS_bool inValue
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_goto * p = (cPtr_instruction_5F_computed_5F_goto *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_goto) ;
...
enumComparisonResult GALGAS_instruction_5F_computed_5F_rcall::objectCompare (const GALGAS_instruction_5F_computed_5F_rcall & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_computed_5F_rcall * p = (const cPtr_instruction_5F_computed_5F_rcall *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_computed_5F_rcall) ;
  const cPtr_instruction_5F_computed_5F_rcall * q = (const cPtr_instruction_5F_computed_5F_rcall *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_computed_5F_rcall) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mSizeExpression.objectCompare (q->mAttribute_mSizeExpression) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_computed_5F_rcall) ;
}
...
void GALGAS_instruction_5F_computed_5F_rcall::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_computed_5F_rcall) ;
...
GALGAS_immediatExpression GALGAS_instruction_5F_computed_5F_rcall::reader_mSizeExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_computed_5F_rcall * p = (const cPtr_instruction_5F_computed_5F_rcall *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_computed_5F_rcall) ;
    result = p->mAttribute_mSizeExpression ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_computed_5F_rcall::modifier_setMSizeExpression (GALGAS_immediatExpression inValue
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_rcall * p = (cPtr_instruction_5F_computed_5F_rcall *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_rcall) ;
...
void GALGAS_instruction_5F_computed_5F_rcall::modifier_setMTargetLabels (GALGAS_lstringlist inValue
                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_rcall * p = (cPtr_instruction_5F_computed_5F_rcall *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_rcall) ;
...
void GALGAS_instruction_5F_computed_5F_rcall::modifier_setMUsesRelativeCall (GALGAS_bool inValue
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_rcall * p = (cPtr_instruction_5F_computed_5F_rcall *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_rcall) ;
...
enumComparisonResult GALGAS_instruction_5F_computed_5F_retlw::objectCompare (const GALGAS_instruction_5F_computed_5F_retlw & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_computed_5F_retlw * p = (const cPtr_instruction_5F_computed_5F_retlw *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_computed_5F_retlw) ;
  const cPtr_instruction_5F_computed_5F_retlw * q = (const cPtr_instruction_5F_computed_5F_retlw *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_computed_5F_retlw) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mSizeExpression.objectCompare (q->mAttribute_mSizeExpression) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mImmediateExpressionList.objectCompare (q->mAttribute_mImmediateExpressionList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mUsesRelativeCall.objectCompare (q->mAttribute_mUsesRelativeCall) ;
  }
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_computed_5F_retlw) ;
}
...
void GALGAS_instruction_5F_computed_5F_retlw::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_computed_5F_retlw) ;
...
GALGAS_immediatExpression GALGAS_instruction_5F_computed_5F_retlw::reader_mSizeExpression (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_computed_5F_retlw * p = (const cPtr_instruction_5F_computed_5F_retlw *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_computed_5F_retlw) ;
    result = p->mAttribute_mSizeExpression ;
  }
  return result ;
}
...
void GALGAS_instruction_5F_computed_5F_retlw::modifier_setMSizeExpression (GALGAS_immediatExpression inValue
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_retlw * p = (cPtr_instruction_5F_computed_5F_retlw *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_retlw) ;
...
void GALGAS_instruction_5F_computed_5F_retlw::modifier_setMImmediateExpressionList (GALGAS_immediatExpressionList inValue
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_retlw * p = (cPtr_instruction_5F_computed_5F_retlw *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_retlw) ;
    p->mAttribute_mImmediateExpressionList = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_computed_5F_retlw::modifier_setMUsesRelativeCall (GALGAS_bool inValue
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_computed_5F_retlw * p = (cPtr_instruction_5F_computed_5F_retlw *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_computed_5F_retlw) ;
...
enumComparisonResult GALGAS_instruction_5F_do_5F_while::objectCompare (const GALGAS_instruction_5F_do_5F_while & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_do_5F_while * p = (const cPtr_instruction_5F_do_5F_while *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_do_5F_while) ;
  const cPtr_instruction_5F_do_5F_while * q = (const cPtr_instruction_5F_do_5F_while *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_do_5F_while) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_do_5F_while) ;
}
...
void GALGAS_instruction_5F_do_5F_while::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_do_5F_while) ;
...
GALGAS_instructionList GALGAS_instruction_5F_do_5F_while::reader_mRepeatedInstructionList (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_do_5F_while * p = (const cPtr_instruction_5F_do_5F_while *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_do_5F_while) ;
...
void GALGAS_instruction_5F_do_5F_while::modifier_setMRepeatedInstructionList (GALGAS_instructionList inValue
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_do_5F_while * p = (cPtr_instruction_5F_do_5F_while *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_do_5F_while) ;
    p->mAttribute_mRepeatedInstructionList = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_do_5F_while::modifier_setMEndOfRepeatedInstructionList (GALGAS_location inValue
                                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_do_5F_while * p = (cPtr_instruction_5F_do_5F_while *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_do_5F_while) ;
    p->mAttribute_mEndOfRepeatedInstructionList = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_do_5F_while::modifier_setMWhilePartList (GALGAS_partList inValue
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_do_5F_while * p = (cPtr_instruction_5F_do_5F_while *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_do_5F_while) ;
    p->mAttribute_mWhilePartList = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_literalOperation::objectCompare (const GALGAS_instruction_5F_literalOperation & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_literalOperation * p = (const cPtr_instruction_5F_literalOperation *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_literalOperation) ;
  const cPtr_instruction_5F_literalOperation * q = (const cPtr_instruction_5F_literalOperation *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_literalOperation) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_literalOperation) ;
}
...
void GALGAS_instruction_5F_literalOperation::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_literalOperation) ;
...
GALGAS_literal_5F_instruction_5F_opcode GALGAS_instruction_5F_literalOperation::reader_mLiteralInstruction (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_literalOperation * p = (const cPtr_instruction_5F_literalOperation *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_literalOperation) ;
...
void GALGAS_instruction_5F_literalOperation::modifier_setMLiteralInstruction (GALGAS_literal_5F_instruction_5F_opcode inValue
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_literalOperation * p = (cPtr_instruction_5F_literalOperation *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_literalOperation) ;
...
void GALGAS_instruction_5F_literalOperation::modifier_setMImmediatExpression (GALGAS_immediatExpression inValue
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_literalOperation * p = (cPtr_instruction_5F_literalOperation *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_literalOperation) ;
...
enumComparisonResult GALGAS_instruction_5F_nobanksel::objectCompare (const GALGAS_instruction_5F_nobanksel & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_nobanksel) ;
}
...
void GALGAS_instruction_5F_nobanksel::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_nobanksel) ;
...
enumComparisonResult GALGAS_instruction_5F_savebank::objectCompare (const GALGAS_instruction_5F_savebank & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_savebank * p = (const cPtr_instruction_5F_savebank *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_savebank) ;
  const cPtr_instruction_5F_savebank * q = (const cPtr_instruction_5F_savebank *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_savebank) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_savebank) ;
}
...
void GALGAS_instruction_5F_savebank::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_savebank) ;
...
GALGAS_registerExpression GALGAS_instruction_5F_savebank::reader_mRegister (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_savebank * p = (const cPtr_instruction_5F_savebank *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_savebank) ;
...
void GALGAS_instruction_5F_savebank::modifier_setMRegister (GALGAS_registerExpression inValue
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_savebank * p = (cPtr_instruction_5F_savebank *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_savebank) ;
    p->mAttribute_mRegister = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_savebank::modifier_setMInstructionList (GALGAS_instructionList inValue
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_savebank * p = (cPtr_instruction_5F_savebank *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_savebank) ;
...
void GALGAS_instruction_5F_savebank::modifier_setMEndOfSaveBankInstruction (GALGAS_location inValue
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_savebank * p = (cPtr_instruction_5F_savebank *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_savebank) ;
    p->mAttribute_mEndOfSaveBankInstruction = inValue ;
  }
}
...
enumComparisonResult GALGAS_instruction_5F_structured_5F_if::objectCompare (const GALGAS_instruction_5F_structured_5F_if & inOperand) const {
  enumComparisonResult result = GALGAS_piccolo_5F_instruction::objectCompare (inOperand) ;
  const cPtr_instruction_5F_structured_5F_if * p = (const cPtr_instruction_5F_structured_5F_if *) mObjectPtr ;
  macroNullOrValidObject (p, const cPtr_instruction_5F_structured_5F_if) ;
  const cPtr_instruction_5F_structured_5F_if * q = (const cPtr_instruction_5F_structured_5F_if *) inOperand.mObjectPtr ;
  macroNullOrValidObject (q, const cPtr_instruction_5F_structured_5F_if) ;
  if (kOperandEqual == result) {
...
GALGAS_piccolo_5F_instruction (inSourcePtr) {
  macroNullOrValidObject (inSourcePtr, const cPtr_instruction_5F_structured_5F_if) ;
}
...
void GALGAS_instruction_5F_structured_5F_if::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidObject (p, cPtr_instruction_5F_structured_5F_if) ;
...
GALGAS_conditionExpression GALGAS_instruction_5F_structured_5F_if::reader_mIfCondition (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    const cPtr_instruction_5F_structured_5F_if * p = (const cPtr_instruction_5F_structured_5F_if *) mObjectPtr ;
    macroValidObject (p, const cPtr_instruction_5F_structured_5F_if) ;
...
void GALGAS_instruction_5F_structured_5F_if::modifier_setMIfCondition (GALGAS_conditionExpression inValue
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_structured_5F_if * p = (cPtr_instruction_5F_structured_5F_if *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_structured_5F_if) ;
    p->mAttribute_mIfCondition = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_structured_5F_if::modifier_setMThenInstructionList (GALGAS_instructionList inValue
                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_structured_5F_if * p = (cPtr_instruction_5F_structured_5F_if *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_structured_5F_if) ;
    p->mAttribute_mThenInstructionList = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_structured_5F_if::modifier_setMElseInstructionList (GALGAS_instructionList inValue
                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_structured_5F_if * p = (cPtr_instruction_5F_structured_5F_if *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_structured_5F_if) ;
    p->mAttribute_mElseInstructionList = inValue ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_instruction_5F_structured_5F_if::modifier_setMEndOfElsePartLocation (GALGAS_location inValue
                                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_instruction_5F_structured_5F_if * p = (cPtr_instruction_5F_structured_5F_if *) mObjectPtr ;
    macroValidObject (p, cPtr_instruction_5F_structured_5F_if) ;
    p->mAttribute_mEndOfElsePartLocation = inValue ;
  }
}
