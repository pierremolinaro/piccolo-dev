...
GALGAS_dataList GALGAS_dataList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_dataList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "dataList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_LDATAPTR GALGAS_instruction_5F_LDATAPTR::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_LDATAPTR *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "instruction_LDATAPTR", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_LTBLPTR GALGAS_instruction_5F_LTBLPTR::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_LTBLPTR *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "instruction_LTBLPTR", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_dataList_2E_element GALGAS_dataList_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_dataList_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "dataList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
