...
void GALGAS_instructionList::modifier_prependValue (GALGAS_pic_31__38_PiccoloInstruction inOperand0
                                                    COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_instructionList (inOperand0 COMMA_THERE)) ;
...
void GALGAS_dataList::modifier_prependValue (GALGAS_lstring inOperand0,
                                             GALGAS_luintlist inOperand1
                                             COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_dataList (inOperand0, inOperand1 COMMA_THERE)) ;
...
void GALGAS_checkpicList::modifier_prependValue (GALGAS_location inOperand0,
