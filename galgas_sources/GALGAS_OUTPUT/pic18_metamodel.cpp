...
void routine_getRegisterComparisonComplementary (const GALGAS_registerComparison constinArgument_inComparison,
  ...
  if (constinArgument_inComparison.isValid ()) {
    ...
    case GALGAS_registerComparison::kEnum_notEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_equal (SOURCE_FILE_AT_LINE (495)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_equal: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_notEqual (SOURCE_FILE_AT_LINE (496)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_greaterOrEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_lower (SOURCE_FILE_AT_LINE (497)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_greater: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_lowerOrEqual (SOURCE_FILE_AT_LINE (498)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_lowerOrEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_greater (SOURCE_FILE_AT_LINE (499)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_lower: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_greaterOrEqual (SOURCE_FILE_AT_LINE (500)) ;
      } break ;
    }
  }
}
