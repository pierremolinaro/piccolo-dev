...
GALGAS_bootloaderReservedRAMmap_3A_element cEnumerator_bootloaderReservedRAMmap::current (LOCATION_ARGS) const {
  const cMapElement_bootloaderReservedRAMmap * p = (const cMapElement_bootloaderReservedRAMmap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_bootloaderReservedRAMmap) ;
  return GALGAS_bootloaderReservedRAMmap_3A_element (p->mAttribute_lkey, p->mAttribute_mReservedSize) ;
}
...
class cCollectionElement_instructionList : public cCollectionElement {
  public : GALGAS_instructionList_3A_element mObject ;
...
GALGAS_instructionList_3A_element cEnumerator_instructionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_partList : public cCollectionElement {
  public : GALGAS_partList_3A_element mObject ;
...
GALGAS_partList_3A_element cEnumerator_partList::current (LOCATION_ARGS) const {
...
class cCollectionElement_interruptDefinitionList : public cCollectionElement {
  public : GALGAS_interruptDefinitionList_3A_element mObject ;
...
GALGAS_interruptDefinitionList_3A_element cEnumerator_interruptDefinitionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_routineDefinitionList : public cCollectionElement {
  public : GALGAS_routineDefinitionList_3A_element mObject ;
...
GALGAS_routineDefinitionList_3A_element cEnumerator_routineDefinitionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_routineDeclarationList : public cCollectionElement {
  public : GALGAS_routineDeclarationList_3A_element mObject ;
...
GALGAS_routineDeclarationList_3A_element cEnumerator_routineDeclarationList::current (LOCATION_ARGS) const {
...
GALGAS_bootloaderReservedRAMmap_3A_element::GALGAS_bootloaderReservedRAMmap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_bootloaderReservedRAMmap_3A_element::GALGAS_bootloaderReservedRAMmap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                        const GALGAS_luint & inOperand1) :
...
/* GALGAS_bootloaderReservedRAMmap_3A_element & GALGAS_bootloaderReservedRAMmap_3A_element::operator = (const GALGAS_bootloaderReservedRAMmap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mReservedSize = inOperand.mAttribute_mReservedSize ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_bootloaderReservedRAMmap_3A_element GALGAS_bootloaderReservedRAMmap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                        const GALGAS_luint & inOperand1 
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bootloaderReservedRAMmap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_bootloaderReservedRAMmap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_bootloaderReservedRAMmap_3A_element::objectCompare (const GALGAS_bootloaderReservedRAMmap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_bootloaderReservedRAMmap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mReservedSize.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_bootloaderReservedRAMmap_3A_element::drop (void) {
...
void GALGAS_bootloaderReservedRAMmap_3A_element::description (C_String & ioString,
                                                              const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_bootloaderReservedRAMmap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_bootloaderReservedRAMmap_3A_element::reader_mReservedSize (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_bootloaderReservedRAMmap_3A_element ("bootloaderReservedRAMmap:element",
                                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_bootloaderReservedRAMmap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_bootloaderReservedRAMmap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_bootloaderReservedRAMmap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_bootloaderReservedRAMmap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_bootloaderReservedRAMmap_3A_element GALGAS_bootloaderReservedRAMmap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                      C_Compiler * inCompiler,
                                                                                                      const GALGAS_location & inErrorLocation
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_bootloaderReservedRAMmap_3A_element result ;
  const GALGAS_bootloaderReservedRAMmap_3A_element * p = (const GALGAS_bootloaderReservedRAMmap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_bootloaderReservedRAMmap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_instructionList_3A_element::GALGAS_instructionList_3A_element (void) :
...
GALGAS_instructionList_3A_element::GALGAS_instructionList_3A_element (const GALGAS_piccolo_5F_instruction & inOperand0) :
mAttribute_mInstruction (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_instructionList_3A_element & GALGAS_instructionList_3A_element::operator = (const GALGAS_instructionList_3A_element & inOperand) {
...
GALGAS_instructionList_3A_element GALGAS_instructionList_3A_element::constructor_new (const GALGAS_piccolo_5F_instruction & inOperand0 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_instructionList_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_instructionList_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_instructionList_3A_element::objectCompare (const GALGAS_instructionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_instructionList_3A_element::isValid (void) const {
  return mAttribute_mInstruction.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_instructionList_3A_element::drop (void) {
  mAttribute_mInstruction.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_instructionList_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_piccolo_5F_instruction GALGAS_instructionList_3A_element::reader_mInstruction (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_instructionList_3A_element ("instructionList:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_instructionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_instructionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_instructionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_instructionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_instructionList_3A_element GALGAS_instructionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_instructionList_3A_element result ;
  const GALGAS_instructionList_3A_element * p = (const GALGAS_instructionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instructionList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_partList_3A_element::GALGAS_partList_3A_element (void) :
...
GALGAS_partList_3A_element::GALGAS_partList_3A_element (const GALGAS_conditionExpression & inOperand0,
                                                        const GALGAS_instructionList & inOperand1,
                                                        const GALGAS_location & inOperand2) :
...
/* GALGAS_partList_3A_element & GALGAS_partList_3A_element::operator = (const GALGAS_partList_3A_element & inOperand) {
...
GALGAS_partList_3A_element GALGAS_partList_3A_element::constructor_new (const GALGAS_conditionExpression & inOperand0,
                                                                        const GALGAS_instructionList & inOperand1,
                                                                        const GALGAS_location & inOperand2 
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_partList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_partList_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_partList_3A_element::objectCompare (const GALGAS_partList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
void GALGAS_partList_3A_element::description (C_String & ioString,
                                              const PMSInt32 inIndentation) const {
...
GALGAS_conditionExpression GALGAS_partList_3A_element::reader_mCondition (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCondition ;
}

//---------------------------------------------------------------------------*

GALGAS_instructionList GALGAS_partList_3A_element::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_partList_3A_element::reader_mEndOfPartLocation (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_partList_3A_element ("partList:element",
                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_partList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_partList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_partList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_partList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_partList_3A_element GALGAS_partList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                      C_Compiler * inCompiler,
                                                                      const GALGAS_location & inErrorLocation
                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_partList_3A_element result ;
  const GALGAS_partList_3A_element * p = (const GALGAS_partList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_partList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_interruptDefinitionList_3A_element::GALGAS_interruptDefinitionList_3A_element (void) :
...
GALGAS_interruptDefinitionList_3A_element::GALGAS_interruptDefinitionList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                      const GALGAS_bool & inOperand1,
                                                                                      const GALGAS_instructionList & inOperand2,
                                                                                      const GALGAS_location & inOperand3) :
...
/* GALGAS_interruptDefinitionList_3A_element & GALGAS_interruptDefinitionList_3A_element::operator = (const GALGAS_interruptDefinitionList_3A_element & inOperand) {
  mAttribute_mInterruptName = inOperand.mAttribute_mInterruptName ;
  mAttribute_mFastReturn = inOperand.mAttribute_mFastReturn ;
  mAttribute_mInstructionList = inOperand.mAttribute_mInstructionList ;
...
GALGAS_interruptDefinitionList_3A_element GALGAS_interruptDefinitionList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                      const GALGAS_bool & inOperand1,
                                                                                                      const GALGAS_instructionList & inOperand2,
                                                                                                      const GALGAS_location & inOperand3 
                                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_interruptDefinitionList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_interruptDefinitionList_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_interruptDefinitionList_3A_element::objectCompare (const GALGAS_interruptDefinitionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_interruptDefinitionList_3A_element::isValid (void) const {
...
void GALGAS_interruptDefinitionList_3A_element::drop (void) {
...
void GALGAS_interruptDefinitionList_3A_element::description (C_String & ioString,
                                                             const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_interruptDefinitionList_3A_element::reader_mInterruptName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInterruptName ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_interruptDefinitionList_3A_element::reader_mFastReturn (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFastReturn ;
}

//---------------------------------------------------------------------------*

GALGAS_instructionList GALGAS_interruptDefinitionList_3A_element::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_interruptDefinitionList_3A_element::reader_mEndOfInterruptLocation (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_interruptDefinitionList_3A_element ("interruptDefinitionList:element",
                                                           NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_interruptDefinitionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_interruptDefinitionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_interruptDefinitionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_interruptDefinitionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_interruptDefinitionList_3A_element GALGAS_interruptDefinitionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                    C_Compiler * inCompiler,
                                                                                                    const GALGAS_location & inErrorLocation
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_interruptDefinitionList_3A_element result ;
  const GALGAS_interruptDefinitionList_3A_element * p = (const GALGAS_interruptDefinitionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_interruptDefinitionList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_routineDefinitionList_3A_element::GALGAS_routineDefinitionList_3A_element (void) :
...
GALGAS_routineDefinitionList_3A_element::GALGAS_routineDefinitionList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_luint & inOperand1,
                                                                                  const GALGAS_luint & inOperand2,
                                                                                  const GALGAS_bool & inOperand3,
                                                                                  const GALGAS_bool & inOperand4,
...
/* GALGAS_routineDefinitionList_3A_element & GALGAS_routineDefinitionList_3A_element::operator = (const GALGAS_routineDefinitionList_3A_element & inOperand) {
...
GALGAS_routineDefinitionList_3A_element GALGAS_routineDefinitionList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                  const GALGAS_luint & inOperand1,
                                                                                                  const GALGAS_luint & inOperand2,
                                                                                                  const GALGAS_bool & inOperand3,
                                                                                                  const GALGAS_bool & inOperand4,
                                                                                                  ...
                                                                                                  const GALGAS_location & inOperand6 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineDefinitionList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_routineDefinitionList_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_routineDefinitionList_3A_element::objectCompare (const GALGAS_routineDefinitionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_routineDefinitionList_3A_element::isValid (void) const {
...
void GALGAS_routineDefinitionList_3A_element::drop (void) {
...
void GALGAS_routineDefinitionList_3A_element::description (C_String & ioString,
                                                           const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_routineDefinitionList_3A_element::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_routineDefinitionList_3A_element::reader_mRequiredBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRequiredBank ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_routineDefinitionList_3A_element::reader_mReturnedBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mReturnedBank ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_routineDefinitionList_3A_element::reader_mPreservesBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPreservesBank ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_routineDefinitionList_3A_element::reader_mIsNoReturn (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsNoReturn ;
}

//---------------------------------------------------------------------------*

GALGAS_instructionList GALGAS_routineDefinitionList_3A_element::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_routineDefinitionList_3A_element::reader_mEndOfRoutineLocation (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_routineDefinitionList_3A_element ("routineDefinitionList:element",
                                                         NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_routineDefinitionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_routineDefinitionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_routineDefinitionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_routineDefinitionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_routineDefinitionList_3A_element GALGAS_routineDefinitionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler,
                                                                                                const GALGAS_location & inErrorLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_routineDefinitionList_3A_element result ;
  const GALGAS_routineDefinitionList_3A_element * p = (const GALGAS_routineDefinitionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_routineDefinitionList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_routineDeclarationList_3A_element::GALGAS_routineDeclarationList_3A_element (void) :
mAttribute_mRoutineName (),
mAttribute_mRequiredBank (),
mAttribute_mReturnedBank (),
mAttribute_mPreservesBank (),
...
GALGAS_routineDeclarationList_3A_element::GALGAS_routineDeclarationList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_luint & inOperand1,
                                                                                    const GALGAS_luint & inOperand2,
                                                                                    const GALGAS_bool & inOperand3,
                                                                                    const GALGAS_bool & inOperand4) :
...
/* GALGAS_routineDeclarationList_3A_element & GALGAS_routineDeclarationList_3A_element::operator = (const GALGAS_routineDeclarationList_3A_element & inOperand) {
  mAttribute_mRoutineName = inOperand.mAttribute_mRoutineName ;
  mAttribute_mRequiredBank = inOperand.mAttribute_mRequiredBank ;
  mAttribute_mReturnedBank = inOperand.mAttribute_mReturnedBank ;
  mAttribute_mPreservesBank = inOperand.mAttribute_mPreservesBank ;
...
GALGAS_routineDeclarationList_3A_element GALGAS_routineDeclarationList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                    const GALGAS_luint & inOperand1,
                                                                                                    const GALGAS_luint & inOperand2,
                                                                                                    const GALGAS_bool & inOperand3,
                                                                                                    const GALGAS_bool & inOperand4 
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineDeclarationList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_routineDeclarationList_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_routineDeclarationList_3A_element::objectCompare (const GALGAS_routineDeclarationList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mRoutineName.objectCompare (inOperand.mAttribute_mRoutineName) ;
  }
...
bool GALGAS_routineDeclarationList_3A_element::isValid (void) const {
...
void GALGAS_routineDeclarationList_3A_element::drop (void) {
  mAttribute_mRoutineName.drop () ;
  mAttribute_mRequiredBank.drop () ;
  mAttribute_mReturnedBank.drop () ;
  mAttribute_mPreservesBank.drop () ;
...
void GALGAS_routineDeclarationList_3A_element::description (C_String & ioString,
                                                            const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_routineDeclarationList_3A_element::reader_mRoutineName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRoutineName ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_routineDeclarationList_3A_element::reader_mRequiredBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRequiredBank ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_routineDeclarationList_3A_element::reader_mReturnedBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mReturnedBank ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_routineDeclarationList_3A_element::reader_mPreservesBank (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPreservesBank ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_routineDeclarationList_3A_element::reader_mIsNoReturn (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsNoReturn ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_routineDeclarationList_3A_element ("routineDeclarationList:element",
                                                          NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_routineDeclarationList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_routineDeclarationList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_routineDeclarationList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_routineDeclarationList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_routineDeclarationList_3A_element GALGAS_routineDeclarationList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                  C_Compiler * inCompiler,
                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_routineDeclarationList_3A_element result ;
  const GALGAS_routineDeclarationList_3A_element * p = (const GALGAS_routineDeclarationList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_routineDeclarationList_3A_element *> (p)) {
      result = *p ;
    }else{
