...
cCollectionElement * cCollectionElement_pic_31__38_CaseExpressionList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_pic_31__38_CaseExpressionList (mObject.mAttribute_mCaseExpression COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_pic_31__38_CaseExpressionList::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_pic_31__38_CaseExpressionList (in_mCaseExpression COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
GALGAS_pic_31__38_CaseExpressionList_2E_element GALGAS_pic_31__38_CaseExpressionList_2E_element::constructor_new (const GALGAS_immediatExpression & inOperand0 
  ...
  if (inOperand0.isValid ()) {
    result = GALGAS_pic_31__38_CaseExpressionList_2E_element (inOperand0) ;
  }
  return result ;
}
...
bool GALGAS_pic_31__38_CaseExpressionList_2E_element::isValid (void) const {
  return mAttribute_mCaseExpression.isValid () ;
}
