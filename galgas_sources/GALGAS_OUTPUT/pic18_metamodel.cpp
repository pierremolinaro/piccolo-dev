...
GGS_bootloaderReservedRAMmap GGS_bootloaderReservedRAMmap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_luint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_bootloaderReservedRAMmap result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
void routine_getComplementaryBcc (C_Compiler & inLexique,
                                ...
                                GGS_conditional_branch & var_cas_outComplementary
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_getRegisterComparisonComplementary (C_Compiler & inLexique,
                                ...
                                GGS_registerComparison & var_cas_outComparison
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
