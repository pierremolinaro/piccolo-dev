...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mReservedSize._operator_isEqual (ptr->mInfo.mReservedSize)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mSourceRegisterName._operator_isEqual (ptr->mSourceRegisterName).boolValue ()
         && mDestinationRegisterName._operator_isEqual (ptr->mDestinationRegisterName).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         ...
         && mIsBcc._operator_isEqual (ptr->mIsBcc).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         ...
         && mOpCode._operator_isEqual (ptr->mOpCode).boolValue ()
         && mRegisterExpression._operator_isEqual (ptr->mRegisterExpression).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         ...
         && mSkipIfZero._operator_isEqual (ptr->mSkipIfZero).boolValue ()
         && mRegisterExpression._operator_isEqual (ptr->mRegisterExpression).boolValue ()
         && m_W_isDestination._operator_isEqual (ptr->m_W_isDestination).boolValue () ;
  }
  return equal ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInstructionLocation._operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mSizeExpression._operator_isEqual (ptr->mSizeExpression).boolValue ()
         && mImmediateExpressionList._operator_isEqual (ptr->mImmediateExpressionList).boolValue ()
         && mUsesRelativeCall._operator_isEqual (ptr->mUsesRelativeCall).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mInterruptName._operator_isEqual (ptr->mInterruptName).boolValue ()
