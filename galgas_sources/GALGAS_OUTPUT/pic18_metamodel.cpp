...
void routine_getComplementaryBcc (const GALGAS_conditional_5F_branch constinArgument_inConditionalBranch,
  ...
  if (constinArgument_inConditionalBranch.isValid ()) {
    ...
    case GALGAS_conditional_5F_branch::kEnum_bz: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnz (SOURCE_FILE_AT_LINE (202)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnz: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bz (SOURCE_FILE_AT_LINE (203)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bn: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnn (SOURCE_FILE_AT_LINE (204)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnn: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bn (SOURCE_FILE_AT_LINE (205)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bc: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnc (SOURCE_FILE_AT_LINE (206)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnc: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bc (SOURCE_FILE_AT_LINE (207)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bov: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnov (SOURCE_FILE_AT_LINE (208)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnov: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bov (SOURCE_FILE_AT_LINE (209)) ;
      } break ;
    }
  }
}
...
void routine_getRegisterComparisonComplementary (const GALGAS_registerComparison constinArgument_inComparison,
  ...
  if (constinArgument_inComparison.isValid ()) {
    ...
    case GALGAS_registerComparison::kEnum_notEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_equal (SOURCE_FILE_AT_LINE (471)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_equal: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_notEqual (SOURCE_FILE_AT_LINE (472)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_greaterOrEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_lower (SOURCE_FILE_AT_LINE (473)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_greater: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_lowerOrEqual (SOURCE_FILE_AT_LINE (474)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_lowerOrEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_greater (SOURCE_FILE_AT_LINE (475)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_lower: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_greaterOrEqual (SOURCE_FILE_AT_LINE (476)) ;
      } break ;
    }
  }
}
