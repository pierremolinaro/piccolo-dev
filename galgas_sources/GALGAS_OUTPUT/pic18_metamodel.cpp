...
void routine_getRegisterComparisonComplementary (const GALGAS_registerComparison constinArgument_inComparison,
  ...
  if (constinArgument_inComparison.isValid ()) {
    ...
    case GALGAS_registerComparison::kEnum_notEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_equal (SOURCE_FILE_AT_LINE (508)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_equal: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_notEqual (SOURCE_FILE_AT_LINE (509)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_greaterOrEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_lower (SOURCE_FILE_AT_LINE (510)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_greater: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_lowerOrEqual (SOURCE_FILE_AT_LINE (511)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_lowerOrEqual: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_greater (SOURCE_FILE_AT_LINE (512)) ;
      } break ;
    case GALGAS_registerComparison::kEnum_lower: {
      //-------- @assignmentInstructionForGeneration
      outArgument_outComparison = GALGAS_registerComparison::constructor_greaterOrEqual (SOURCE_FILE_AT_LINE (513)) ;
      } break ;
    }
  }
}
