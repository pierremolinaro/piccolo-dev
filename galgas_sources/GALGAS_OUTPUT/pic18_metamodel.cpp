...
GALGAS_registerComparison GALGAS_registerComparison::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_registerComparison *> (p)) {
      ...
      inCompiler->castError ("registerComparison", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_piccolo_5F_instruction GALGAS_piccolo_5F_instruction::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_piccolo_5F_instruction *> (p)) {
      ...
      inCompiler->castError ("piccolo_instruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_CLRWDT GALGAS_instruction_5F_CLRWDT::constructor_default (LOCATION_ARGS) {
  return GALGAS_instruction_5F_CLRWDT::constructor_new (GALGAS_location::constructor_nowhere (HERE)
                                                        COMMA_THERE) ;
}
...
GALGAS_instruction_5F_CLRWDT GALGAS_instruction_5F_CLRWDT::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_CLRWDT *> (p)) {
      ...
      inCompiler->castError ("instruction_CLRWDT", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_DAW GALGAS_instruction_5F_DAW::constructor_default (LOCATION_ARGS) {
  return GALGAS_instruction_5F_DAW::constructor_new (GALGAS_location::constructor_nowhere (HERE)
                                                     COMMA_THERE) ;
}
...
GALGAS_instruction_5F_DAW GALGAS_instruction_5F_DAW::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_DAW *> (p)) {
      ...
      inCompiler->castError ("instruction_DAW", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_NOP GALGAS_instruction_5F_NOP::constructor_default (LOCATION_ARGS) {
  return GALGAS_instruction_5F_NOP::constructor_new (GALGAS_location::constructor_nowhere (HERE)
                                                     COMMA_THERE) ;
}
...
GALGAS_instruction_5F_NOP GALGAS_instruction_5F_NOP::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_NOP *> (p)) {
      ...
      inCompiler->castError ("instruction_NOP", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_POP GALGAS_instruction_5F_POP::constructor_default (LOCATION_ARGS) {
  return GALGAS_instruction_5F_POP::constructor_new (GALGAS_location::constructor_nowhere (HERE)
                                                     COMMA_THERE) ;
}
...
GALGAS_instruction_5F_POP GALGAS_instruction_5F_POP::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_POP *> (p)) {
      ...
      inCompiler->castError ("instruction_POP", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_PUSH GALGAS_instruction_5F_PUSH::constructor_default (LOCATION_ARGS) {
  return GALGAS_instruction_5F_PUSH::constructor_new (GALGAS_location::constructor_nowhere (HERE)
                                                      COMMA_THERE) ;
}
...
GALGAS_instruction_5F_PUSH GALGAS_instruction_5F_PUSH::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_PUSH *> (p)) {
      ...
      inCompiler->castError ("instruction_PUSH", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_RESET GALGAS_instruction_5F_RESET::constructor_default (LOCATION_ARGS) {
  return GALGAS_instruction_5F_RESET::constructor_new (GALGAS_location::constructor_nowhere (HERE)
                                                       COMMA_THERE) ;
}
...
GALGAS_instruction_5F_RESET GALGAS_instruction_5F_RESET::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_RESET *> (p)) {
      ...
      inCompiler->castError ("instruction_RESET", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instruction_5F_SLEEP GALGAS_instruction_5F_SLEEP::constructor_default (LOCATION_ARGS) {
  return GALGAS_instruction_5F_SLEEP::constructor_new (GALGAS_location::constructor_nowhere (HERE)
                                                       COMMA_THERE) ;
}
...
GALGAS_instruction_5F_SLEEP GALGAS_instruction_5F_SLEEP::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instruction_5F_SLEEP *> (p)) {
      ...
      inCompiler->castError ("instruction_SLEEP", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
