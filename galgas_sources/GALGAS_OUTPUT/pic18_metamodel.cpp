...
cCollectionElement_pic_31__38_BlockInstructionBlockList::cCollectionElement_pic_31__38_BlockInstructionBlockList (const GALGAS_lstring & in_mBlockName,
                                                                                                                  ...
                                                                                                                  COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mBlockName, in_mInstructionList, in_mBlockTerminaisonForBlockInstruction) {
}
...
cCollectionElement * cCollectionElement_pic_31__38_BlockInstructionBlockList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_pic_31__38_BlockInstructionBlockList (mObject.mAttribute_mBlockName, mObject.mAttribute_mInstructionList, mObject.mAttribute_mBlockTerminaisonForBlockInstruction COMMA_HERE)) ;
  return result ;
}
...
GALGAS_pic_31__38_BlockInstructionBlockList GALGAS_pic_31__38_BlockInstructionBlockList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_pic_31__38_BlockInstructionBlockList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_pic_31__38_BlockInstructionBlockList::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_pic_31__38_BlockInstructionBlockList (in_mBlockName,
                                                                          in_mInstructionList,
                                                                          in_mBlockTerminaisonForBlockInstruction COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_pic_31__38_BlockInstructionBlockList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_pic_31__38_BlockInstructionBlockList (inOperand0, inOperand1, inOperand2 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_pic_31__38_BlockInstructionBlockList::modifier_removeAtIndex (GALGAS_lstring & outOperand0,
                                                                          ...
                                                                          GALGAS_abstractBlockTerminaisonForBlockInstruction & outOperand2,
                                                                          const GALGAS_uint inRemoveIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  if (isValid () && inRemoveIndex.isValid ()) {
...
GALGAS_abstractBlockTerminaisonForBlockInstruction GALGAS_pic_31__38_BlockInstructionBlockList::reader_mBlockTerminaisonForBlockInstructionAtIndex (const GALGAS_uint & inIndex,
                                                                                                                                                    C_Compiler * inCompiler
                                                                                                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_pic_31__38_BlockInstructionBlockList * p = (cCollectionElement_pic_31__38_BlockInstructionBlockList *) attributes.ptr () ;
...
GALGAS_abstractBlockTerminaisonForBlockInstruction cEnumerator_pic_31__38_BlockInstructionBlockList::current_mBlockTerminaisonForBlockInstruction (LOCATION_ARGS) const {
  const cCollectionElement_pic_31__38_BlockInstructionBlockList * p = (const cCollectionElement_pic_31__38_BlockInstructionBlockList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_pic_31__38_BlockInstructionBlockList) ;
...
typeComparisonResult GALGAS_abstractBlockTerminaisonForBlockInstruction::objectCompare (const GALGAS_abstractBlockTerminaisonForBlockInstruction & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
...
GALGAS_abstractBlockTerminaisonForBlockInstruction::GALGAS_abstractBlockTerminaisonForBlockInstruction (void) :
AC_GALGAS_class () {
}

//---------------------------------------------------------------------------*

GALGAS_abstractBlockTerminaisonForBlockInstruction::GALGAS_abstractBlockTerminaisonForBlockInstruction (const cPtr_abstractBlockTerminaisonForBlockInstruction * inSourcePtr) :
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_abstractBlockTerminaisonForBlockInstruction) ;
}
...
cPtr_abstractBlockTerminaisonForBlockInstruction::cPtr_abstractBlockTerminaisonForBlockInstruction (LOCATION_ARGS) :
acPtr_class (THERE) {
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//             @abstractBlockTerminaisonForBlockInstruction type             *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_abstractBlockTerminaisonForBlockInstruction ("abstractBlockTerminaisonForBlockInstruction",
                                                                    NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_abstractBlockTerminaisonForBlockInstruction::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_abstractBlockTerminaisonForBlockInstruction ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_abstractBlockTerminaisonForBlockInstruction::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_abstractBlockTerminaisonForBlockInstruction (*this)) ;
  }
  return result ;
}
...
GALGAS_abstractBlockTerminaisonForBlockInstruction GALGAS_abstractBlockTerminaisonForBlockInstruction::extractObject (const GALGAS_object & inObject,
                                                                                                                      C_Compiler * inCompiler
                                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_abstractBlockTerminaisonForBlockInstruction result ;
  const GALGAS_abstractBlockTerminaisonForBlockInstruction * p = (const GALGAS_abstractBlockTerminaisonForBlockInstruction *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_abstractBlockTerminaisonForBlockInstruction *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("abstractBlockTerminaisonForBlockInstruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_exitBlockTerminaisonForBlockInstruction::dynamicObjectCompare (const acPtr_class * /* inOperandPtr */) const {
...
typeComparisonResult GALGAS_exitBlockTerminaisonForBlockInstruction::objectCompare (const GALGAS_exitBlockTerminaisonForBlockInstruction & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_exitBlockTerminaisonForBlockInstruction::GALGAS_exitBlockTerminaisonForBlockInstruction (void) :
GALGAS_abstractBlockTerminaisonForBlockInstruction () {
}

//---------------------------------------------------------------------------*

GALGAS_exitBlockTerminaisonForBlockInstruction GALGAS_exitBlockTerminaisonForBlockInstruction::constructor_default (LOCATION_ARGS) {
  return GALGAS_exitBlockTerminaisonForBlockInstruction::constructor_new (THERE) ;
}

//---------------------------------------------------------------------------*

GALGAS_exitBlockTerminaisonForBlockInstruction::GALGAS_exitBlockTerminaisonForBlockInstruction (const cPtr_exitBlockTerminaisonForBlockInstruction * inSourcePtr) :
GALGAS_abstractBlockTerminaisonForBlockInstruction (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_exitBlockTerminaisonForBlockInstruction) ;
}

//---------------------------------------------------------------------------*

GALGAS_exitBlockTerminaisonForBlockInstruction GALGAS_exitBlockTerminaisonForBlockInstruction::constructor_new (LOCATION_ARGS) {
  GALGAS_exitBlockTerminaisonForBlockInstruction result ;
  macroMyNew (result.mObjectPtr, cPtr_exitBlockTerminaisonForBlockInstruction (THERE)) ;
  return result ;
}
...
cPtr_exitBlockTerminaisonForBlockInstruction::cPtr_exitBlockTerminaisonForBlockInstruction (LOCATION_ARGS) :
cPtr_abstractBlockTerminaisonForBlockInstruction (THERE) {
}

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * cPtr_exitBlockTerminaisonForBlockInstruction::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_exitBlockTerminaisonForBlockInstruction ;
}

void cPtr_exitBlockTerminaisonForBlockInstruction::description (C_String & ioString,
                                                                const PMSInt32 /* inIndentation */) const {
  ioString << "[@exitBlockTerminaisonForBlockInstruction]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//               @exitBlockTerminaisonForBlockInstruction type               *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_exitBlockTerminaisonForBlockInstruction ("exitBlockTerminaisonForBlockInstruction",
                                                                & kTypeDescriptor_GALGAS_abstractBlockTerminaisonForBlockInstruction) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_exitBlockTerminaisonForBlockInstruction::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_exitBlockTerminaisonForBlockInstruction ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_exitBlockTerminaisonForBlockInstruction::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_exitBlockTerminaisonForBlockInstruction (*this)) ;
  }
  return result ;
}
...
GALGAS_exitBlockTerminaisonForBlockInstruction GALGAS_exitBlockTerminaisonForBlockInstruction::extractObject (const GALGAS_object & inObject,
                                                                                                              C_Compiler * inCompiler
                                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_exitBlockTerminaisonForBlockInstruction result ;
  const GALGAS_exitBlockTerminaisonForBlockInstruction * p = (const GALGAS_exitBlockTerminaisonForBlockInstruction *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_exitBlockTerminaisonForBlockInstruction *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("exitBlockTerminaisonForBlockInstruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_pic_31__38_BlockInstructionBlockList_2E_element GALGAS_pic_31__38_BlockInstructionBlockList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_pic_31__38_BlockInstructionBlockList_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
bool GALGAS_pic_31__38_BlockInstructionBlockList_2E_element::isValid (void) const {
  return mAttribute_mBlockName.isValid () && mAttribute_mInstructionList.isValid () && mAttribute_mBlockTerminaisonForBlockInstruction.isValid () ;
}
...
GALGAS_abstractBlockTerminaisonForBlockInstruction GALGAS_pic_31__38_BlockInstructionBlockList_2E_element::reader_mBlockTerminaisonForBlockInstruction (UNUSED_LOCATION_ARGS) const {
