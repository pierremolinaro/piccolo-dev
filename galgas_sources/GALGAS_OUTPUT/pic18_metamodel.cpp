...
GALGAS_piccoloModel GALGAS_piccoloModel::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_piccoloModel (GALGAS_lstring::constructor_default (HERE),
...
GALGAS_piccoloModel GALGAS_piccoloModel::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid () && inOperand12.isValid () && inOperand13.isValid () && inOperand14.isValid () && inOperand15.isValid ()) {
    result = GALGAS_piccoloModel (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11, inOperand12, inOperand13, inOperand14, inOperand15) ;
  }
  return result ;
}
...
GALGAS_lstringlist GALGAS_piccoloModel::reader_mUnusedRegisterList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mUnusedRegisterList ;
}

//---------------------------------------------------------------------------*

GALGAS_checkpicList GALGAS_piccoloModel::reader_mCheckpicList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCheckpicList ;
}

//---------------------------------------------------------------------------*

GALGAS_dataList GALGAS_piccoloModel::reader_mDataList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDataList ;
}

//---------------------------------------------------------------------------*

GALGAS_pic_31__38_InterruptDefinitionList GALGAS_piccoloModel::reader_mInterruptDefinitionList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_pic_31__38_RoutineDefinitionList GALGAS_piccoloModel::reader_mRoutineDefinitionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRoutineDefinitionList ;
}

//---------------------------------------------------------------------------*

GALGAS_lstringlist GALGAS_piccoloModel::reader_mUnusedRoutineList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mUnusedRoutineList ;
}

//---------------------------------------------------------------------------*

GALGAS_lstringlist GALGAS_piccoloModel::reader_mInlinedRoutineList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_piccoloModel GALGAS_piccoloModel::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_piccoloModel *> (p)) {
      ...
      inCompiler->castError ("piccoloModel", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
