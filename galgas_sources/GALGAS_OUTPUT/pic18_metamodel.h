...
//--- Comparison methods
  public : GGS_bool _operator_isEqual (const GGS_bootloaderReservedRAMmap & inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_bootloaderReservedRAMmap & inOperand) const ;
...
//--- Modifier 'popFirst'
  public : void modifier_popFirst (C_Compiler & inLexique,
                                 ...
                                 COMMA_LOCATION_ARGS) ;
//--- Handle '.=' operator
  public : void _dotAssign_operation (const GGS_routineDeclarationList inOperand) ;
...
//--- Comparison operators
  public : GGS_bool _operator_isEqual (const GGS_programKind inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_programKind inOperand) const ;
  public : GGS_bool _operator_infOrEqual (const GGS_programKind inOperand) const ;
  public : GGS_bool _operator_supOrEqual (const GGS_programKind inOperand) const ;
  public : GGS_bool _operator_strictInf (const GGS_programKind inOperand) const ;
  public : GGS_bool _operator_strictSup (const GGS_programKind inOperand) const ;
} ;
