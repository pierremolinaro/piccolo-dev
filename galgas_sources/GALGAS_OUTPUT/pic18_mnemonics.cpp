...
void routine_getComplementaryBcc (const GALGAS_conditional_5F_branch constinArgument_inConditionalBranch,
  ...
  if (constinArgument_inConditionalBranch.isValid ()) {
    ...
    case GALGAS_conditional_5F_branch::kEnum_bz: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnz (SOURCE_FILE ("pic18_mnemonics.gSemantics", 93)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnz: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bz (SOURCE_FILE ("pic18_mnemonics.gSemantics", 94)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bn: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnn (SOURCE_FILE ("pic18_mnemonics.gSemantics", 95)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnn: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bn (SOURCE_FILE ("pic18_mnemonics.gSemantics", 96)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bc: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnc (SOURCE_FILE ("pic18_mnemonics.gSemantics", 97)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnc: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bc (SOURCE_FILE ("pic18_mnemonics.gSemantics", 98)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bov: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bnov (SOURCE_FILE ("pic18_mnemonics.gSemantics", 99)) ;
      } break ;
    case GALGAS_conditional_5F_branch::kEnum_bnov: {
      outArgument_outComplementary = GALGAS_conditional_5F_branch::constructor_bov (SOURCE_FILE ("pic18_mnemonics.gSemantics", 100)) ;
      } break ;
    }
  }
}
