...
void routine_performInlineFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_5371 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_5371.hasCurrentObject ()) {
    callCategoryMethod_performInlining ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_5371.current_mInstruction (HERE).ptr (), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, outArgument_outInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (173)) ;
...
void routine_pic_31__38_PerformRoutineInline (const GALGAS_stringset constinArgument_inInlinedRoutineSet,
  ...
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_5969 (ioArgument_ioInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_5969.hasCurrentObject ()) {
    GALGAS_pic_31__38_InstructionList var_instructionList ;
    {
    routine_performInlineFromInstructionList (enumerator_5969.current_mInstructionList (HERE), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) ;
    }
    var_interruptDefinitionList.addAssign_operation (enumerator_5969.current_mInterruptName (HERE), enumerator_5969.current_mFastReturn (HERE), var_instructionList, enumerator_5969.current_mEndOfInterruptLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (198)) ;
  ...
  cEnumerator_pic_31__38_RoutineDefinitionList enumerator_6467 (ioArgument_ioRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_6467.hasCurrentObject ()) {
    GALGAS_pic_31__38_InstructionList var_instructionList ;
    {
    routine_performInlineFromInstructionList (enumerator_6467.current_mInstructionList (HERE), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (209)) ;
    }
    var_routineDefinitionList.addAssign_operation (enumerator_6467.current_mRoutineName (HERE), enumerator_6467.current_mRequiredBank (HERE), enumerator_6467.current_mReturnedBank (HERE), enumerator_6467.current_mPreservesBank (HERE), enumerator_6467.current_mIsNoReturn (HERE), var_instructionList, enumerator_6467.current_mEndOfRoutineLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (215)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_do_5F_while_performInlining (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_pic_31__38_DoWhilePartList enumerator_1865 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_1865.hasCurrentObject ()) {
    GALGAS_pic_31__38_InstructionList var_instructionList ;
    {
    routine_performInlineFromInstructionList (enumerator_1865.current_mInstructionList (HERE), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (61)) ;
    }
    var_whilePartList.addAssign_operation (enumerator_1865.current_mCondition (HERE), var_instructionList, enumerator_1865.current_mEndOfPartLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (67)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_JSR_performInlining (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_pic_31__38_InstructionList var_instructionList ;
    constinArgument_inDeclaredRoutineMap.method_searchKey (object->mAttribute_mTargetLabel, var_requiredBank, var_returnedBank, var_preservesBank, var_isNoReturn, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) ;
    ...
    if (kBoolTrue == test_1) {
      ...
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_returnedBank.mAttribute_uint.objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (150)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        ioArgument_ioInstructionList.addAssign_operation (GALGAS_pic_31__38_Instruction_5F_checkbank::constructor_new (object->mAttribute_mInstructionLocation, var_returnedBank.mAttribute_uint COMMA_SOURCE_FILE_AT_LINE (151)) COMMA_SOURCE_FILE_AT_LINE (151)) ;
      }
  ...
  const enumGalgasBool test_5 = var_inlineDone.operator_not (SOURCE_FILE_AT_LINE (158)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //--- @selfCopyInExpressionForGeneration
    const GALGAS_pic_31__38_Instruction_5F_JSR temp_6 = object ;
    ioArgument_ioInstructionList.addAssign_operation (temp_6 COMMA_SOURCE_FILE_AT_LINE (159)) ;
  }
}
//---------------------------------------------------------------------------*
