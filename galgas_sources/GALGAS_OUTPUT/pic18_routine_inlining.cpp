...
void routine_performInlineFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_5382 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_5382.hasCurrentObject ()) {
    callCategoryMethod_performInlining ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_5382.current_mInstruction (HERE).ptr (), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, outArgument_outInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (173)) ;
...
void routine_pic_31__38_PerformRoutineInline (const GALGAS_stringset constinArgument_inInlinedRoutineSet,
  ...
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_5980 (ioArgument_ioInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_5980.hasCurrentObject ()) {
    GALGAS_pic_31__38_InstructionList var_instructionList ;
    {
    routine_performInlineFromInstructionList (enumerator_5980.current_mInstructionList (HERE), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) ;
    }
    var_interruptDefinitionList.addAssign_operation (enumerator_5980.current_mInterruptName (HERE), enumerator_5980.current_mFastReturn (HERE), var_instructionList, enumerator_5980.current_mEndOfInterruptLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (198)) ;
  ...
  cEnumerator_pic_31__38_RoutineDefinitionList enumerator_6478 (ioArgument_ioRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_6478.hasCurrentObject ()) {
    GALGAS_pic_31__38_InstructionList var_instructionList ;
    {
    routine_performInlineFromInstructionList (enumerator_6478.current_mInstructionList (HERE), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (209)) ;
    }
    var_routineDefinitionList.addAssign_operation (enumerator_6478.current_mRoutineName (HERE), enumerator_6478.current_mRequiredBank (HERE), enumerator_6478.current_mReturnedBank (HERE), enumerator_6478.current_mPreservesBank (HERE), enumerator_6478.current_mIsNoReturn (HERE), var_instructionList, enumerator_6478.current_mEndOfRoutineLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (215)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_JSR_performInlining (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_pic_31__38_InstructionList var_instructionList ;
    GALGAS_luint joker_4183_0 ; // Joker input parameter
    GALGAS_bool joker_4215_0 ; // Joker input parameter
    constinArgument_inDeclaredRoutineMap.method_searchKey (object->mAttribute_mTargetLabel, var_requiredBank, joker_4183_0, joker_4215_0, var_isNoReturn, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) ;
