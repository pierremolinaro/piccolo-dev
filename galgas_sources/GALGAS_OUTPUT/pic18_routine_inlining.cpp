...
void routine_pic_31__38_PerformRoutineInline (const GALGAS_stringset constinArgument_inInlinedRoutineSet,
  ...
  while (enumerator_6799.hasCurrentObject ()) {
    ...
    {
    routine_performInlineFromInstructionList (enumerator_6799.current_mInstructionList (HERE), constinArgument_inInlinedRoutineSet, constinArgument_inDeclaredRoutineMap, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (219)), var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (215)) ;
    }
    var_interruptDefinitionList.addAssign_operation (enumerator_6799.current_mInterruptName (HERE), enumerator_6799.current_mFastReturn (HERE), var_instructionList, enumerator_6799.current_mEndOfInterruptLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (222)) ;
