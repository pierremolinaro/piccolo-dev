...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  if (kBoolTrue == test_23) {
    ...
    if (kBoolTrue == test_26) {
      ...
      GALGAS_bool joker_16336_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16336_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (338)) ;
      ...
      if (kBoolTrue == test_27) {
        ...
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16716_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (343)) ;
        {
        ...
        GALGAS_bool joker_16923_0 ; // Joker input parameter
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16923_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) ;
      }
      ...
      if (kBoolTrue == test_28) {
        ...
        cEnumerator_ramBankTable enumerator_17390 (var_ramBank, kEnumeration_up) ;
        while (enumerator_17390.hasCurrentObject ()) {
          GALGAS_uint var_bankSize = enumerator_17390.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_17390.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
          GALGAS_uint var_usedSize = enumerator_17390.current_mFirstFreeAddress (HERE).substract_operation (enumerator_17390.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
          var_verboseMessage.dotAssign_operation (GALGAS_string ("  RAM bank '").operator_concat (enumerator_17390.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)).operator_concat (GALGAS_string ("': ") COMMA_SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
      ...
      if (kBoolTrue == test_29) {
        ...
        GALGAS_bool joker_18429_0 ; // Joker input parameter
        var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_18429_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (375)) ;
      }
  ...
  if (kBoolTrue == test_32) {
    ...
    GALGAS_bool joker_19931_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_19931_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (406)) ;
  }
}
