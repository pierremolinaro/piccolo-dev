...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  const enumGalgasBool test_23 = GALGAS_bool (gOption_piccolo_5F_options_useOldCompiler.reader_value ()).operator_not (SOURCE_FILE_AT_LINE (273)).boolEnum () ;
  if (kBoolTrue == test_23) {
    {
    routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (constinArgument_inSourceFileName, var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (277)).reader_uint (SOURCE_FILE_AT_LINE (277)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (277)), var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (278)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, var_dataMap, constinArgument_inPiccoloModel, var_hasHighInterrupt, var_hasLowInterrupt, var_dataLengthConstantMap, var_piccoloDeviceModel.reader_mDeviceName (SOURCE_FILE_AT_LINE (291)).reader_string (SOURCE_FILE_AT_LINE (291)), var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (292)), var_actualConfigurationMap, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (275)) ;
    }
  }else if (kBoolFalse == test_23) {
    GALGAS_pic_31__38__5F_intermediate_5F_instructionList var_generatedInstructionList ;
    {
    routine_build_5F_pic_31__38__5F_intermediate_5F_assembly_5F_instruction_5F_list (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (300)).reader_uint (SOURCE_FILE_AT_LINE (300)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (300)), var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (301)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, var_dataMap, constinArgument_inPiccoloModel, var_hasHighInterrupt, var_hasLowInterrupt, var_dataGeneratedInstructionList, var_dataLengthConstantMap, var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) ;
    }
    const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (319)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (319)).boolEnum () ;
    if (kBoolTrue == test_24) {
      {
      routine_performOptimizations (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
      }
    }
    const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (323)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_25) {
      {
      routine_pic_31__38__5F_intermediate_5F_convertRelativeBranchsToAbsoluteWhenNeeded (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (324)) ;
      }
    }
    const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (327)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_uint var_usedROMsize ;
      {
      routine_build_5F_pic_31__38__5F_intermediate_5F_binary_5F_code (var_generatedInstructionList, var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (332)).reader_uint (SOURCE_FILE_AT_LINE (332)), var_actualConfigurationMap, var_usedROMsize, inCompiler COMMA_SOURCE_FILE_AT_LINE (330)) ;
      }
      GALGAS_string var_contents ;
      {
      routine_getGeneratedContents (var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (337)) ;
      }
      GALGAS_string var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (338)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (338)) ;
      GALGAS_bool joker_16374_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16374_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (339)) ;
      const enumGalgasBool test_27 = GALGAS_bool (gOption_piccolo_5F_options_output_5F_C_5F_Array.reader_value ()).boolEnum () ;
      if (kBoolTrue == test_27) {
        GALGAS_string var_baseName = constinArgument_inSourceFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (341)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (341)) ;
        {
        routine_get_5F_C_5F_ArrayImplementation (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (342)) ;
        }
        var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string (".c") COMMA_SOURCE_FILE_AT_LINE (343)) ;
        GALGAS_bool joker_16754_0 ; // Joker input parameter
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16754_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (344)) ;
        {
        routine_get_5F_C_5F_ArrayHeader (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (345)) ;
        }
        var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (346)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (346)) ;
        GALGAS_bool joker_16961_0 ; // Joker input parameter
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16961_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (347)) ;
      }
      ...
      if (kBoolTrue == test_28) {
        ...
        var_verboseMessage.dotAssign_operation (GALGAS_string ("  ROM size: ").operator_concat (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (352)).reader_uint (SOURCE_FILE_AT_LINE (352)).reader_string (SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (GALGAS_string (" bytes;") COMMA_SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)) ;
        var_verboseMessage.dotAssign_operation (GALGAS_string (" used: ").operator_concat (var_usedROMsize.reader_string (SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)) ;
        var_verboseMessage.dotAssign_operation (var_usedROMsize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (354)).divide_operation (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (354)).reader_uint (SOURCE_FILE_AT_LINE (354)), inCompiler COMMA_SOURCE_FILE_AT_LINE (354)).reader_string (SOURCE_FILE_AT_LINE (354)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
        cEnumerator_ramBankTable enumerator_17428 (var_ramBank, kEnumeration_up) ;
        while (enumerator_17428.hasCurrentObject ()) {
          GALGAS_uint var_bankSize = enumerator_17428.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_17428.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
          GALGAS_uint var_usedSize = enumerator_17428.current_mFirstFreeAddress (HERE).substract_operation (enumerator_17428.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (357)) ;
          var_verboseMessage.dotAssign_operation (GALGAS_string ("  RAM bank '").operator_concat (enumerator_17428.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string ("': ") COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
          var_verboseMessage.dotAssign_operation (var_bankSize.reader_string (SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string (" bytes, used ") COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
          var_verboseMessage.dotAssign_operation (var_usedSize.reader_string (SOURCE_FILE_AT_LINE (360)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (360)) COMMA_SOURCE_FILE_AT_LINE (360)) ;
          var_verboseMessage.dotAssign_operation (var_usedSize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (361)).divide_operation (var_bankSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (361)).reader_string (SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)) ;
          enumerator_17428.gotoNextObject () ;
        }
        inCompiler->printMessage (var_verboseMessage COMMA_SOURCE_FILE_AT_LINE (363)) ;
      }
      ...
      if (kBoolTrue == test_29) {
        ...
        {
        routine_pic_31__38__5F_build_5F_assembly_5F_code (var_piccoloDeviceModel.reader_mDeviceName (SOURCE_FILE_AT_LINE (368)).reader_string (SOURCE_FILE_AT_LINE (368)), var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (369)), var_registerTable, var_generatedInstructionList, var_actualConfigurationMap, var_assemblyCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (367)) ;
        }
        ...
        GALGAS_bool joker_18467_0 ; // Joker input parameter
        var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_18467_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
      }
      ...
      {
      GALGAS_string::class_method_deleteFileIfExists (var_hexDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
      }
      ...
      {
      GALGAS_string::class_method_deleteFileIfExists (var_asmDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }
    }
    const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (385)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_30) {
      {
      routine_pic_31__38__5F_build_5F_listing_5F_of_5F_generated_5F_code (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (386)) ;
      }
    }
    const enumGalgasBool test_31 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (392)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (392)))) COMMA_SOURCE_FILE_AT_LINE (392)).boolEnum () ;
    if (kBoolTrue == test_31) {
      {
      routine_pic_31__38__5F_compute_5F_metrics (constinArgument_inPiccoloModel, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_generatedInstructionList, var_listFileContents, constinArgument_inSourceFileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_32) {
    ...
    GALGAS_string var_listFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (406)).operator_concat (GALGAS_string (".list") COMMA_SOURCE_FILE_AT_LINE (406)) ;
    GALGAS_bool joker_19969_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_19969_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (407)) ;
  }
}
