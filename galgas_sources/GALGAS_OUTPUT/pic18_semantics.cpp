...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  if (kBoolTrue == test_23) {
    {
    routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (constinArgument_inSourceFileName, var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (277)).reader_uint (SOURCE_FILE_AT_LINE (277)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (277)), var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (278)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, var_dataMap, constinArgument_inPiccoloModel, var_hasHighInterrupt, var_hasLowInterrupt, var_dataLengthConstantMap, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (275)) ;
    }
  }else if (kBoolFalse == test_23) {
    GALGAS_pic_31__38__5F_intermediate_5F_instructionList var_generatedInstructionList ;
    {
    routine_build_5F_pic_31__38__5F_intermediate_5F_assembly_5F_instruction_5F_list (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (297)).reader_uint (SOURCE_FILE_AT_LINE (297)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (297)), var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (298)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, var_dataMap, constinArgument_inPiccoloModel, var_hasHighInterrupt, var_hasLowInterrupt, var_dataGeneratedInstructionList, var_dataLengthConstantMap, var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (296)) ;
    }
    const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (316)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (316)).boolEnum () ;
    if (kBoolTrue == test_24) {
      {
      routine_performOptimizations (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (317)) ;
      }
    }
    const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (320)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_25) {
      {
      routine_pic_31__38__5F_intermediate_5F_convertRelativeBranchsToAbsoluteWhenNeeded (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (321)) ;
      }
    }
    const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (324)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_uint var_usedROMsize ;
      {
      routine_build_5F_pic_31__38__5F_intermediate_5F_binary_5F_code (var_generatedInstructionList, var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (329)).reader_uint (SOURCE_FILE_AT_LINE (329)), var_actualConfigurationMap, var_usedROMsize, inCompiler COMMA_SOURCE_FILE_AT_LINE (327)) ;
      }
      GALGAS_string var_contents ;
      {
      routine_getGeneratedContents (var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (334)) ;
      }
      GALGAS_string var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (335)) ;
      GALGAS_bool joker_16252_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16252_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (336)) ;
      const enumGalgasBool test_27 = GALGAS_bool (gOption_piccolo_5F_options_output_5F_C_5F_Array.reader_value ()).boolEnum () ;
      if (kBoolTrue == test_27) {
        GALGAS_string var_baseName = constinArgument_inSourceFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (338)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (338)) ;
        {
        routine_get_5F_C_5F_ArrayImplementation (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (339)) ;
        }
        var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (340)).operator_concat (GALGAS_string (".c") COMMA_SOURCE_FILE_AT_LINE (340)) ;
        GALGAS_bool joker_16632_0 ; // Joker input parameter
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16632_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (341)) ;
        {
        routine_get_5F_C_5F_ArrayHeader (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (342)) ;
        }
        var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (343)) ;
        GALGAS_bool joker_16839_0 ; // Joker input parameter
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16839_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (344)) ;
      }
      ...
      if (kBoolTrue == test_28) {
        ...
        var_verboseMessage.dotAssign_operation (GALGAS_string ("  ROM size: ").operator_concat (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (349)).reader_uint (SOURCE_FILE_AT_LINE (349)).reader_string (SOURCE_FILE_AT_LINE (349)) COMMA_SOURCE_FILE_AT_LINE (349)).operator_concat (GALGAS_string (" bytes;") COMMA_SOURCE_FILE_AT_LINE (349)) COMMA_SOURCE_FILE_AT_LINE (349)) ;
        var_verboseMessage.dotAssign_operation (GALGAS_string (" used: ").operator_concat (var_usedROMsize.reader_string (SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)) ;
        var_verboseMessage.dotAssign_operation (var_usedROMsize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (351)).divide_operation (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (351)).reader_uint (SOURCE_FILE_AT_LINE (351)), inCompiler COMMA_SOURCE_FILE_AT_LINE (351)).reader_string (SOURCE_FILE_AT_LINE (351)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (351)) COMMA_SOURCE_FILE_AT_LINE (351)) ;
        cEnumerator_ramBankTable enumerator_17306 (var_ramBank, kEnumeration_up) ;
        while (enumerator_17306.hasCurrentObject ()) {
          GALGAS_uint var_bankSize = enumerator_17306.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_17306.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (353)) ;
          GALGAS_uint var_usedSize = enumerator_17306.current_mFirstFreeAddress (HERE).substract_operation (enumerator_17306.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (354)) ;
          var_verboseMessage.dotAssign_operation (GALGAS_string ("  RAM bank '").operator_concat (enumerator_17306.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)).operator_concat (GALGAS_string ("': ") COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)) ;
          var_verboseMessage.dotAssign_operation (var_bankSize.reader_string (SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string (" bytes, used ") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
          var_verboseMessage.dotAssign_operation (var_usedSize.reader_string (SOURCE_FILE_AT_LINE (357)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
          var_verboseMessage.dotAssign_operation (var_usedSize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (358)).divide_operation (var_bankSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (358)).reader_string (SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
          enumerator_17306.gotoNextObject () ;
        }
        inCompiler->printMessage (var_verboseMessage COMMA_SOURCE_FILE_AT_LINE (360)) ;
      }
      ...
      if (kBoolTrue == test_29) {
        ...
        {
        routine_pic_31__38__5F_build_5F_assembly_5F_code (var_piccoloDeviceModel.reader_mDeviceName (SOURCE_FILE_AT_LINE (365)).reader_string (SOURCE_FILE_AT_LINE (365)), var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (366)), var_registerTable, var_generatedInstructionList, var_actualConfigurationMap, var_assemblyCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (364)) ;
        }
        GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (372)) ;
        GALGAS_bool joker_18345_0 ; // Joker input parameter
        var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_18345_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
      }
    }else if (kBoolFalse == test_26) {
      GALGAS_string var_hexDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (376)) ;
      {
      GALGAS_string::class_method_deleteFileIfExists (var_hexDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
      }
      GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (378)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (378)) ;
      {
      GALGAS_string::class_method_deleteFileIfExists (var_asmDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (379)) ;
      }
    }
    const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (382)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_30) {
      {
      routine_pic_31__38__5F_build_5F_listing_5F_of_5F_generated_5F_code (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (383)) ;
      }
    }
    const enumGalgasBool test_31 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (389)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (389)))) COMMA_SOURCE_FILE_AT_LINE (389)).boolEnum () ;
    if (kBoolTrue == test_31) {
      {
      routine_pic_31__38__5F_compute_5F_metrics (constinArgument_inPiccoloModel, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_generatedInstructionList, var_listFileContents, constinArgument_inSourceFileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (390)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_32) {
    ...
    GALGAS_string var_listFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (403)).operator_concat (GALGAS_string (".list") COMMA_SOURCE_FILE_AT_LINE (403)) ;
    GALGAS_bool joker_19847_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_19847_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (404)) ;
  }
}
