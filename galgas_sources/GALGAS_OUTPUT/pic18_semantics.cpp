...
void routine_pic18_analyze (C_Compiler & _inLexique,
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (98)))).isBuiltAndTrue ()) {
    ...
    const GGS_string _temp_4710 = var_cas_listFileContents ;
    if (_temp_4710._isBuilt ()) {
      _temp_4710 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_listFile COMMA_SOURCE_FILE_AT_LINE (100)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_string _temp_5177 = var_cas_contents ;
    if (_temp_5177._isBuilt ()) {
      _temp_5177 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (113)) ;
    }
    if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (115)))).isBuiltAndTrue ()) {
      ...
      ::routine_buildAssemblyCode (_inLexique,  var_cas_piccoloDeviceModel.reader_mDeviceName (_inLexique COMMA_SOURCE_FILE_AT_LINE (118)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (118)),  var_cas_piccoloDeviceModel.reader_mRegisterTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)),  var_cas_registerTable,  var_cas_generatedInstructionList,  var_cas_actualConfigurationMap,  var_cas_assemblyCode COMMA_SOURCE_FILE_AT_LINE (117)) ;
      ...
      const GGS_string _temp_5729 = var_cas_assemblyCode ;
      if (_temp_5729._isBuilt ()) {
        _temp_5729 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_asmDestinationFile COMMA_SOURCE_FILE_AT_LINE (126)) ;
      }
    }
  }else{
    GGS_string var_cas_hexDestinationFile ;
