...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  {
  routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (constinArgument_inSourceFileName, var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (275)).reader_uint (SOURCE_FILE_AT_LINE (275)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (275)), var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (276)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, var_dataMap, constinArgument_inPiccoloModel, var_hasHighInterrupt, var_hasLowInterrupt, var_dataLengthConstantMap, var_generatedBlockList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (273)) ;
  }
  GALGAS_pic_31__38__5F_intermediate_5F_instructionList var_generatedInstructionList ;
  {
  routine_build_5F_pic_31__38__5F_intermediate_5F_assembly_5F_instruction_5F_list (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (295)).reader_uint (SOURCE_FILE_AT_LINE (295)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (295)), var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (296)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, var_dataMap, constinArgument_inPiccoloModel, var_hasHighInterrupt, var_hasLowInterrupt, var_dataGeneratedInstructionList, var_dataLengthConstantMap, var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (294)) ;
  }
  const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (314)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (314)).boolEnum () ;
  if (kBoolTrue == test_23) {
    {
    routine_performOptimizations (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)) ;
    }
  }
  const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (318)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_24) {
    {
    routine_pic_31__38__5F_intermediate_5F_convertRelativeBranchsToAbsoluteWhenNeeded (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
    }
  }
  ...
  if (kBoolTrue == test_25) {
    ...
    {
    routine_build_5F_pic_31__38__5F_intermediate_5F_binary_5F_code (var_generatedInstructionList, var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (327)).reader_uint (SOURCE_FILE_AT_LINE (327)), var_actualConfigurationMap, var_usedROMsize, inCompiler COMMA_SOURCE_FILE_AT_LINE (325)) ;
    }
    GALGAS_string var_contents ;
    {
    routine_getGeneratedContents (var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (332)) ;
    }
    GALGAS_string var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (333)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (333)) ;
    GALGAS_bool joker_16058_0 ; // Joker input parameter
    var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16058_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (334)) ;
    const enumGalgasBool test_26 = GALGAS_bool (gOption_piccolo_5F_options_output_5F_C_5F_Array.reader_value ()).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_string var_baseName = constinArgument_inSourceFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (336)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (336)) ;
      {
      routine_get_5F_C_5F_ArrayImplementation (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (337)) ;
      }
      var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (338)).operator_concat (GALGAS_string (".c") COMMA_SOURCE_FILE_AT_LINE (338)) ;
      GALGAS_bool joker_16428_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16428_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (339)) ;
      {
      routine_get_5F_C_5F_ArrayHeader (var_baseName, var_contents, inCompiler COMMA_SOURCE_FILE_AT_LINE (340)) ;
      }
      var_destinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (341)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (341)) ;
      GALGAS_bool joker_16629_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16629_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (342)) ;
    }
    ...
    if (kBoolTrue == test_27) {
      ...
      var_verboseMessage.dotAssign_operation (GALGAS_string ("  ROM size: ").operator_concat (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (347)).reader_uint (SOURCE_FILE_AT_LINE (347)).reader_string (SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (347)).operator_concat (GALGAS_string (" bytes;") COMMA_SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (347)) ;
      var_verboseMessage.dotAssign_operation (GALGAS_string (" used: ").operator_concat (var_usedROMsize.reader_string (SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)) ;
      var_verboseMessage.dotAssign_operation (var_usedROMsize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (349)).divide_operation (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (349)).reader_uint (SOURCE_FILE_AT_LINE (349)), inCompiler COMMA_SOURCE_FILE_AT_LINE (349)).reader_string (SOURCE_FILE_AT_LINE (349)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (349)) COMMA_SOURCE_FILE_AT_LINE (349)) ;
      cEnumerator_ramBankTable enumerator_17080 (var_ramBank, kEnumeration_up) ;
      while (enumerator_17080.hasCurrentObject ()) {
        GALGAS_uint var_bankSize = enumerator_17080.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_17080.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (351)) ;
        GALGAS_uint var_usedSize = enumerator_17080.current_mFirstFreeAddress (HERE).substract_operation (enumerator_17080.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (352)) ;
        var_verboseMessage.dotAssign_operation (GALGAS_string ("  RAM bank '").operator_concat (enumerator_17080.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)).operator_concat (GALGAS_string ("': ") COMMA_SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)) ;
        var_verboseMessage.dotAssign_operation (var_bankSize.reader_string (SOURCE_FILE_AT_LINE (354)).operator_concat (GALGAS_string (" bytes, used ") COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
        var_verboseMessage.dotAssign_operation (var_usedSize.reader_string (SOURCE_FILE_AT_LINE (355)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)) ;
        var_verboseMessage.dotAssign_operation (var_usedSize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (356)).divide_operation (var_bankSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (356)).reader_string (SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
        enumerator_17080.gotoNextObject () ;
      }
      inCompiler->printMessage (var_verboseMessage COMMA_SOURCE_FILE_AT_LINE (358)) ;
    }
    ...
    if (kBoolTrue == test_28) {
      ...
      {
      routine_pic_31__38__5F_build_5F_assembly_5F_code (var_piccoloDeviceModel.reader_mDeviceName (SOURCE_FILE_AT_LINE (363)).reader_string (SOURCE_FILE_AT_LINE (363)), var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (364)), var_registerTable, var_generatedInstructionList, var_actualConfigurationMap, var_assemblyCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (362)) ;
      }
      GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (370)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (370)) ;
      GALGAS_bool joker_18077_0 ; // Joker input parameter
      var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_18077_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (371)) ;
    }
  }else if (kBoolFalse == test_25) {
    GALGAS_string var_hexDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (374)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (374)) ;
    {
    GALGAS_string::class_method_deleteFileIfExists (var_hexDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (375)) ;
    }
    GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (376)) ;
    {
    GALGAS_string::class_method_deleteFileIfExists (var_asmDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
    }
  }
  const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (380)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_pic_31__38__5F_build_5F_listing_5F_of_5F_generated_5F_code (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
    }
  }
  const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (387)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (387)))) COMMA_SOURCE_FILE_AT_LINE (387)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_pic_31__38__5F_compute_5F_metrics (constinArgument_inPiccoloModel, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_generatedInstructionList, var_listFileContents, constinArgument_inSourceFileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (388)) ;
    }
  }
  ...
  if (kBoolTrue == test_31) {
    ...
    GALGAS_string var_listFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (400)).operator_concat (GALGAS_string (".list") COMMA_SOURCE_FILE_AT_LINE (400)) ;
    GALGAS_bool joker_19518_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_19518_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (401)) ;
  }
}
