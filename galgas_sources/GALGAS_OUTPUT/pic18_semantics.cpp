...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  if (kBoolTrue == test_25) {
    ...
    if (kBoolTrue == test_27) {
      GALGAS_string var_verboseMessage = GALGAS_string ("  ROM size: ").operator_concat (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (346)).reader_uint (SOURCE_FILE_AT_LINE (346)).reader_string (SOURCE_FILE_AT_LINE (346)) COMMA_SOURCE_FILE_AT_LINE (346)).operator_concat (GALGAS_string (" bytes;") COMMA_SOURCE_FILE_AT_LINE (346)) ;
      var_verboseMessage.dotAssign_operation (GALGAS_string (" used: ").operator_concat (var_usedROMsize.reader_string (SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (347)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (347)) ;
      var_verboseMessage.dotAssign_operation (var_usedROMsize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (348)).divide_operation (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (348)).reader_uint (SOURCE_FILE_AT_LINE (348)), inCompiler COMMA_SOURCE_FILE_AT_LINE (348)).reader_string (SOURCE_FILE_AT_LINE (348)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)) ;
      cEnumerator_ramBankTable enumerator_17034 (var_ramBank, kEnumeration_up) ;
      while (enumerator_17034.hasCurrentObject ()) {
        GALGAS_uint var_bankSize = enumerator_17034.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_17034.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (350)) ;
        GALGAS_uint var_usedSize = enumerator_17034.current_mFirstFreeAddress (HERE).substract_operation (enumerator_17034.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (351)) ;
        var_verboseMessage.dotAssign_operation (GALGAS_string ("  RAM bank '").operator_concat (enumerator_17034.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (GALGAS_string ("': ") COMMA_SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)) ;
        var_verboseMessage.dotAssign_operation (var_bankSize.reader_string (SOURCE_FILE_AT_LINE (353)).operator_concat (GALGAS_string (" bytes, used ") COMMA_SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)) ;
        var_verboseMessage.dotAssign_operation (var_usedSize.reader_string (SOURCE_FILE_AT_LINE (354)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
        var_verboseMessage.dotAssign_operation (var_usedSize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (355)).divide_operation (var_bankSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (355)).reader_string (SOURCE_FILE_AT_LINE (355)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)) ;
        enumerator_17034.gotoNextObject () ;
      }
      inCompiler->printMessage (var_verboseMessage COMMA_SOURCE_FILE_AT_LINE (357)) ;
    }
    ...
    if (kBoolTrue == test_28) {
      ...
      {
      routine_pic_31__38__5F_build_5F_assembly_5F_code (var_piccoloDeviceModel.reader_mDeviceName (SOURCE_FILE_AT_LINE (362)).reader_string (SOURCE_FILE_AT_LINE (362)), var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (363)), var_registerTable, var_generatedInstructionList, var_actualConfigurationMap, var_assemblyCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (361)) ;
      }
      GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (369)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (369)) ;
      GALGAS_bool joker_18031_0 ; // Joker input parameter
      var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_18031_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (370)) ;
    }
  }else if (kBoolFalse == test_25) {
    GALGAS_string var_hexDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (373)).operator_concat (GALGAS_string (".hex") COMMA_SOURCE_FILE_AT_LINE (373)) ;
    {
    GALGAS_string::class_method_deleteFileIfExists (var_hexDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (374)) ;
    }
    ...
    {
    GALGAS_string::class_method_deleteFileIfExists (var_asmDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
    }
  }
  const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (379)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_29) {
    {
    routine_pic_31__38__5F_build_5F_listing_5F_of_5F_generated_5F_code (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
    }
  }
  const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (386)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (386)))) COMMA_SOURCE_FILE_AT_LINE (386)).boolEnum () ;
  if (kBoolTrue == test_30) {
    {
    routine_pic_31__38__5F_compute_5F_metrics (constinArgument_inPiccoloModel, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_generatedInstructionList, var_listFileContents, constinArgument_inSourceFileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (387)) ;
    }
  }
  ...
  if (kBoolTrue == test_31) {
    ...
    GALGAS_string var_listFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (399)).operator_concat (GALGAS_string (".list") COMMA_SOURCE_FILE_AT_LINE (399)) ;
    GALGAS_bool joker_19472_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_19472_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
  }
}
