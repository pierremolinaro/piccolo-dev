...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13854 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13854.isBuiltAndTrue ()) {
    ...
    GGS_bool automatic_var_12428_0 ;
    if (var_cas_contents.isBuilt ()) {
      var_cas_contents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_12428_0 COMMA_SOURCE_FILE_AT_LINE (245)) ;
    }
    const GGS_bool cond_13260 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
    if (cond_13260.isBuiltAndTrue ()) {
      ...
      {
        GGS_ramBankTable::cEnumerator enumerator_12816 (var_cas_ramBank, true) ;
        const GGS_ramBankTable::cElement * operand_12816 = NULL ;
        while (((operand_12816 = enumerator_12816.nextObject ()))) {
          macroValidPointer (operand_12816) ;
          GGS_uint  var_cas_bankSize = operand_12816->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_12816->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (252)) ;
          GGS_uint  var_cas_usedSize = operand_12816->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_12816->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (253)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage.dotAssign_operation (operand_12816->mKey) ;
          var_cas_verboseMessage.appendCString ("': ") ;
    ...
    const GGS_bool cond_13842 = gOption_piccolo_5F_options_generateAssembly.reader_value () ;
    if (cond_13842.isBuiltAndTrue ()) {
      ...
      GGS_bool automatic_var_13832_0 ;
      if (var_cas_assemblyCode.isBuilt ()) {
        var_cas_assemblyCode (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_13832_0 COMMA_SOURCE_FILE_AT_LINE (273)) ;
      }
    }
  }else if (cond_13854.isBuiltAndFalse ()) {
    GGS_string var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension ()).operator_concat (GGS_string (".hex")) ;
  ...
  const GGS_bool cond_14644 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_14644.isBuiltAndTrue ()) {
    const GGS_bool cond_14477 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (283))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_14477.isBuiltAndTrue ()) {
    ...
    GGS_bool automatic_var_14636_0 ;
    if (var_cas_listFileContents.isBuilt ()) {
      var_cas_listFileContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_14636_0 COMMA_SOURCE_FILE_AT_LINE (290)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
