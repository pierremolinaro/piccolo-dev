...
void routine_pic_31__38__5F_analyze (const GALGAS_pic_31__38_AST constinArgument_inPiccoloModel,
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the program name ('").operator_concat (constinArgument_inPiccoloModel.reader_mProgramName (SOURCE_FILE_AT_LINE (20)).reader_string (SOURCE_FILE_AT_LINE (20)) COMMA_SOURCE_FILE_AT_LINE (20)).operator_concat (GALGAS_string ("') should be identical to the file base name '") COMMA_SOURCE_FILE_AT_LINE (20)).operator_concat (var_sourceFileBaseName COMMA_SOURCE_FILE_AT_LINE (21)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (21)) COMMA_SOURCE_FILE_AT_LINE (20)) ;
  }
  ...
  if (constinArgument_inPiccoloModel.mAttribute_mProgramKind.isValid ()) {
    ...
    case GALGAS_programKind::kEnum_regularProgram: {
      ...
      var_bootloaderReservedROMsize = GALGAS_luint::constructor_new (GALGAS_uint ((uint32_t) 0U), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (53)) ;
      } break ;
    case GALGAS_programKind::kEnum_bootloaderProgram: {
      ...
      while (enumerator_4082.hasCurrentObject ()) {
        {
        var_ramBank.modifier_setMFirstFreeAddressForKey (enumerator_4082.current_mFirstAddress (HERE), enumerator_4082.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (69)), inCompiler COMMA_SOURCE_FILE_AT_LINE (69)) ;
        }
  ...
  while (enumerator_5686.hasCurrentObject ()) {
    const enumGalgasBool test_4 = var_declaredRoutineMap.reader_hasKey (enumerator_5686.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (107)).operator_not (SOURCE_FILE_AT_LINE (107)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_5686.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (enumerator_5686.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).operator_concat (GALGAS_string ("' routine is not declared") COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)) ;
    }else if (kBoolFalse == test_4) {
      const enumGalgasBool test_6 = var_unusedDeclarationUnicity.reader_hasKey (enumerator_5686.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (109)).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_5686.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_7, GALGAS_string ("the '").operator_concat (enumerator_5686.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (GALGAS_string ("' routine is already declared as unused") COMMA_SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = var_usedRoutineSet.reader_hasKey (enumerator_5686.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (111)).boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_5686.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_9, GALGAS_string ("the '").operator_concat (enumerator_5686.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (GALGAS_string ("' routine is declared as unused, but is used") COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)) ;
        }
      }
    }
    var_unusedDeclarationUnicity.addAssign_operation (enumerator_5686.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (114)) ;
  ...
  while (enumerator_6224.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_usedRoutineSet.reader_hasKey (enumerator_6224.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (117)).operator_not (SOURCE_FILE_AT_LINE (117)).operator_and (var_unusedDeclarationUnicity.reader_hasKey (enumerator_6224.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (117)).operator_not (SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_location location_11 (enumerator_6224.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_11, GALGAS_string ("the '").operator_concat (enumerator_6224.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)).operator_concat (GALGAS_string ("' routine is unused") COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)) ;
    }
  ...
  while (enumerator_6570.hasCurrentObject ()) {
    const enumGalgasBool test_12 = var_declaredRoutineMap.reader_hasKey (enumerator_6570.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (124)).operator_not (SOURCE_FILE_AT_LINE (124)).boolEnum () ;
    if (kBoolTrue == test_12) {
      GALGAS_location location_13 (enumerator_6570.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, GALGAS_string ("the '").operator_concat (enumerator_6570.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_concat (GALGAS_string ("' routine is not declared") COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)) ;
    }else if (kBoolFalse == test_12) {
      const enumGalgasBool test_14 = var_usedRoutineSet.reader_hasKey (enumerator_6570.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (126)).operator_not (SOURCE_FILE_AT_LINE (126)).boolEnum () ;
      if (kBoolTrue == test_14) {
        GALGAS_location location_15 (enumerator_6570.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_15, GALGAS_string ("useless declaration, the '").operator_concat (enumerator_6570.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)).operator_concat (GALGAS_string ("' routine is unused") COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
      }else if (kBoolFalse == test_14) {
        var_inlinedRoutineSet.addAssign_operation (enumerator_6570.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (129)) ;
      }
    }
  ...
  while (enumerator_7371.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_17) {
      inCompiler->emitSemanticError (enumerator_7371.current_mErrorLocation (HERE), GALGAS_string ("this code is not available for '").operator_concat (var_piccoloDeviceName COMMA_SOURCE_FILE_AT_LINE (147)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
    }
  ...
  while (enumerator_7885.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_7885.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (159)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
    if (kBoolTrue == test_20) {
      ...
      const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_7885.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (165)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
  ...
  if (kBoolTrue == test_29) {
    cEnumerator_configDefinitionList enumerator_9069 (constinArgument_inPiccoloModel.reader_mConfigDefinitionList (SOURCE_FILE_AT_LINE (181)), kEnumeration_up) ;
    while (enumerator_9069.hasCurrentObject ()) {
      inCompiler->emitSemanticError (enumerator_9069.current_mDefinitionLocation (HERE), GALGAS_string ("configuration is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (182)) ;
  ...
  if (kBoolTrue == test_30) {
    ...
    while (enumerator_9936.hasCurrentObject ()) {
      const enumGalgasBool test_31 = var_bootloaderReservedRAMmap.reader_hasKey (enumerator_9936.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (206)).boolEnum () ;
      if (kBoolTrue == test_31) {
        GALGAS_luint var_bootloaderReservedSize ;
        var_bootloaderReservedRAMmap.method_searchKey (enumerator_9936.current_lkey (HERE), var_bootloaderReservedSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
        const enumGalgasBool test_32 = GALGAS_bool (kIsStrictSup, enumerator_9936.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9936.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (209)).objectCompare (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (209)))).boolEnum () ;
        if (kBoolTrue == test_32) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_9936.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (enumerator_9936.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9936.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (211)).reader_string (SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves ") COMMA_SOURCE_FILE_AT_LINE (211)).operator_concat (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (213)).reader_string (SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (GALGAS_string (" byte(s)") COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
        ...
        if (kBoolTrue == test_33) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_9936.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (enumerator_9936.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9936.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (218)).reader_string (SOURCE_FILE_AT_LINE (218)) COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves no space") COMMA_SOURCE_FILE_AT_LINE (218)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
        }
      }
  ...
  if (kBoolTrue == test_35) {
    ...
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_12452_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) ;
  }
}
