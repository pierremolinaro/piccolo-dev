...
//                    november 28th, 2008, at 17h23'57"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_pic18_analyze (C_Compiler & _inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_string _temp_5189 = var_cas_contents ;
    if (_temp_5189._isBuilt ()) {
      _temp_5189 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_hexDestinationFile, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (113)) ;
    }
    if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (115)))).isBuiltAndTrue ()) {
      ...
      const GGS_string _temp_5752 = var_cas_assemblyCode ;
      if (_temp_5752._isBuilt ()) {
        _temp_5752 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_asmDestinationFile, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (126)) ;
      }
    }
  }else{
    GGS_string var_cas_hexDestinationFile ;
