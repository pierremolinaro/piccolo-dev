...
void routine_pic_31__38__5F_analyze (const GALGAS_pic_31__38_AST constinArgument_inPiccoloModel,
  ...
  if (constinArgument_inPiccoloModel.mAttribute_mProgramKind.isValid ()) {
    ...
    case GALGAS_programKind::kEnum_bootloaderProgram: {
      ...
      cEnumerator_ramBankTable enumerator_4085 (var_ramBank, kEnumeration_up) ;
      while (enumerator_4085.hasCurrentObject ()) {
        {
        var_ramBank.modifier_setMFirstFreeAddressForKey (enumerator_4085.current_mFirstAddress (HERE), enumerator_4085.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (69)), inCompiler COMMA_SOURCE_FILE_AT_LINE (69)) ;
        }
  ...
  cEnumerator_pic_31__38_RoutineDefinitionList enumerator_5349 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_5349.hasCurrentObject ()) {
    {
    var_declaredRoutineMap.modifier_insertKey (enumerator_5349.current_mRoutineName (HERE), enumerator_5349.current_mRequiredBank (HERE), enumerator_5349.current_mReturnedBank (HERE), enumerator_5349.current_mPreservesBank (HERE), enumerator_5349.current_mIsNoReturn (HERE), enumerator_5349.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_5689 (constinArgument_inPiccoloModel.mAttribute_mUnusedRoutineList, kEnumeration_up) ;
  while (enumerator_5689.hasCurrentObject ()) {
    const enumGalgasBool test_4 = var_declaredRoutineMap.reader_hasKey (enumerator_5689.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (107)).operator_not (SOURCE_FILE_AT_LINE (107)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_5689.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (enumerator_5689.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).operator_concat (GALGAS_string ("' routine is not declared") COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)) ;
    }else if (kBoolFalse == test_4) {
      const enumGalgasBool test_6 = var_unusedDeclarationUnicity.reader_hasKey (enumerator_5689.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (109)).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_5689.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_7, GALGAS_string ("the '").operator_concat (enumerator_5689.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (GALGAS_string ("' routine is already declared as unused") COMMA_SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = var_usedRoutineSet.reader_hasKey (enumerator_5689.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (111)).boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_5689.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_9, GALGAS_string ("the '").operator_concat (enumerator_5689.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (GALGAS_string ("' routine is declared as unused, but is used") COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)) ;
        }
      }
    }
    var_unusedDeclarationUnicity.addAssign_operation (enumerator_5689.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (114)) ;
    enumerator_5689.gotoNextObject () ;
  }
  cEnumerator_declaredRoutineMap enumerator_6227 (var_declaredRoutineMap, kEnumeration_up) ;
  while (enumerator_6227.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_usedRoutineSet.reader_hasKey (enumerator_6227.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (117)).operator_not (SOURCE_FILE_AT_LINE (117)).operator_and (var_unusedDeclarationUnicity.reader_hasKey (enumerator_6227.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (117)).operator_not (SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_location location_11 (enumerator_6227.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_11, GALGAS_string ("the '").operator_concat (enumerator_6227.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)).operator_concat (GALGAS_string ("' routine is unused") COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_6573 (constinArgument_inPiccoloModel.mAttribute_mInlinedRoutineList, kEnumeration_up) ;
  while (enumerator_6573.hasCurrentObject ()) {
    const enumGalgasBool test_12 = var_declaredRoutineMap.reader_hasKey (enumerator_6573.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (124)).operator_not (SOURCE_FILE_AT_LINE (124)).boolEnum () ;
    if (kBoolTrue == test_12) {
      GALGAS_location location_13 (enumerator_6573.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, GALGAS_string ("the '").operator_concat (enumerator_6573.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_concat (GALGAS_string ("' routine is not declared") COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)) ;
    }else if (kBoolFalse == test_12) {
      const enumGalgasBool test_14 = var_usedRoutineSet.reader_hasKey (enumerator_6573.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (126)).operator_not (SOURCE_FILE_AT_LINE (126)).boolEnum () ;
      if (kBoolTrue == test_14) {
        GALGAS_location location_15 (enumerator_6573.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_15, GALGAS_string ("useless declaration, the '").operator_concat (enumerator_6573.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)).operator_concat (GALGAS_string ("' routine is unused") COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
      }else if (kBoolFalse == test_14) {
        var_inlinedRoutineSet.addAssign_operation (enumerator_6573.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (129)) ;
      }
    }
  ...
  cEnumerator_checkpicList enumerator_7374 (constinArgument_inPiccoloModel.mAttribute_mCheckpicList, kEnumeration_up) ;
  while (enumerator_7374.hasCurrentObject ()) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_7430 (enumerator_7374.current_mValueList (HERE), kEnumeration_up) ;
    bool bool_16 = var_found.operator_not (SOURCE_FILE_AT_LINE (143)).isValidAndTrue () ;
    if (enumerator_7430.hasCurrentObject () && bool_16) {
      while (enumerator_7430.hasCurrentObject () && bool_16) {
        var_found = GALGAS_bool (kIsEqual, enumerator_7430.current_mValue (HERE).mAttribute_string.objectCompare (var_piccoloDeviceName)) ;
        enumerator_7430.gotoNextObject () ;
        if (enumerator_7430.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_17) {
      inCompiler->emitSemanticError (enumerator_7374.current_mErrorLocation (HERE), GALGAS_string ("this code is not available for '").operator_concat (var_piccoloDeviceName COMMA_SOURCE_FILE_AT_LINE (147)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
    }
  ...
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_7888 (var_interruptDefinitionList, kEnumeration_up) ;
  while (enumerator_7888.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_18) {
      GALGAS_location location_19 (enumerator_7888.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_7888.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (159)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
    if (kBoolTrue == test_20) {
      var_highInterruptIsFast = enumerator_7888.current_mFastReturn (HERE) ;
      const enumGalgasBool test_21 = var_hasHighInterrupt.boolEnum () ;
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_7888.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_7888.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (165)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
      if (kBoolTrue == test_23) {
        var_lowInterruptIsFast = enumerator_7888.current_mFastReturn (HERE) ;
        const enumGalgasBool test_24 = var_hasLowInterrupt.boolEnum () ;
        if (kBoolTrue == test_24) {
          GALGAS_location location_25 (enumerator_7888.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        GALGAS_location location_26 (enumerator_7888.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_27) {
      GALGAS_location location_28 (enumerator_7888.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  if (kBoolTrue == test_29) {
    cEnumerator_configDefinitionList enumerator_9072 (constinArgument_inPiccoloModel.reader_mConfigDefinitionList (SOURCE_FILE_AT_LINE (181)), kEnumeration_up) ;
    while (enumerator_9072.hasCurrentObject ()) {
      inCompiler->emitSemanticError (enumerator_9072.current_mDefinitionLocation (HERE), GALGAS_string ("configuration is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (182)) ;
  ...
  if (kBoolTrue == test_30) {
    cEnumerator_ramBankTable enumerator_9939 (var_ramBank, kEnumeration_up) ;
    while (enumerator_9939.hasCurrentObject ()) {
      const enumGalgasBool test_31 = var_bootloaderReservedRAMmap.reader_hasKey (enumerator_9939.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (206)).boolEnum () ;
      if (kBoolTrue == test_31) {
        GALGAS_luint var_bootloaderReservedSize ;
        var_bootloaderReservedRAMmap.method_searchKey (enumerator_9939.current_lkey (HERE), var_bootloaderReservedSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
        const enumGalgasBool test_32 = GALGAS_bool (kIsStrictSup, enumerator_9939.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9939.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (209)).objectCompare (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (209)))).boolEnum () ;
        if (kBoolTrue == test_32) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_9939.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (enumerator_9939.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9939.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (211)).reader_string (SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (211)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves ") COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (213)).reader_string (SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)).operator_concat (GALGAS_string (" byte(s)") COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (210)) ;
        }
      }else if (kBoolFalse == test_31) {
        const enumGalgasBool test_33 = GALGAS_bool (kIsStrictSup, enumerator_9939.current_mFirstFreeAddress (HERE).objectCompare (enumerator_9939.current_mFirstAddress (HERE))).boolEnum () ;
        if (kBoolTrue == test_33) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_9939.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (enumerator_9939.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9939.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (218)).reader_string (SOURCE_FILE_AT_LINE (218)) COMMA_SOURCE_FILE_AT_LINE (218)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves no space") COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
        }
      }
  ...
  cEnumerator_ramBankTable enumerator_10932 (var_ramBank, kEnumeration_up) ;
  while (enumerator_10932.hasCurrentObject ()) {
    const enumGalgasBool test_34 = GALGAS_bool (kIsStrictSup, enumerator_10932.current_mLastAddressPlusOne (HERE).objectCompare (var_RAMsize)).boolEnum () ;
    if (kBoolTrue == test_34) {
      var_RAMsize = enumerator_10932.current_mLastAddressPlusOne (HERE) ;
    }
  ...
  if (kBoolTrue == test_35) {
    ...
    GALGAS_bool joker_12453_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_12453_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) ;
  }
}
