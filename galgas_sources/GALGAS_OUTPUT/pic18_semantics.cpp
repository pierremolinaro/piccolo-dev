...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  if (((var_cas_sourceFileBaseName).operator_isNotEqual (var_cas_inPiccoloModel.reader_mProgramName (inLexique COMMA_SOURCE_FILE_AT_LINE (22)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (22)))).isBuiltAndTrue ()) {
  ...
  var_cas_lowInterruptIsFast = GGS_bool (false) ;
  {
    ...
    while (((operand_5243 = enumerator_5243.nextObject ()))) {
      ...
      if (((var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      ...
      if (((operand_5243->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94))).operator_isEqual (GGS_string ("high"))).isBuiltAndTrue ()) {
      ...
      }else if (((operand_5243->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100))).operator_isEqual (GGS_string ("low"))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_highInterruptIsFast).operator_and (var_cas_lowInterruptIsFast)).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (115))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    {
  ...
  if (((var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (139))).operator_isEqual (GGS_programKind::constructor_bootloaderProgram (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    {
      ...
      while (((operand_7347 = enumerator_7347.nextObject ()))) {
        ...
        if ((var_cas_bootloaderReservedRAMmap.reader_hasKey (inLexique, operand_7347->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (141))).isBuiltAndTrue ()) {
          ...
          if (((operand_7347->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_7347->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (144))).operator_strictSup (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (144)))).isBuiltAndTrue ()) {
        ...
        }else if (((operand_7347->mInfo.mFirstFreeAddress).operator_strictSup (operand_7347->mInfo.mFirstAddress)).isBuiltAndTrue ()) {
  ...
  if ((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (177))))).isBuiltAndTrue ()) {
  ...
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
    ...
    var_cas_listFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_concat (GGS_string (".list")) ;
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (201))).operator_concat (GGS_string (".hex")) ;
    ...
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (204)))).isBuiltAndTrue ()) {
      ...
      var_cas_verboseMessage = ((GGS_string ("  ROM size: ")).operator_concat (var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)))).operator_concat (GGS_string (" bytes;")) ;
      ...
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        ...
        while (((operand_10616 = enumerator_10616.nextObject ()))) {
          ...
          var_cas_bankSize = operand_10616->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_10616->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (209)) ;
          GGS_uint  var_cas_usedSize ;
          var_cas_usedSize = operand_10616->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_10616->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (210)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage.dotAssign_operation (operand_10616->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (211))) ;
          var_cas_verboseMessage.appendCString ("': ") ;
    ...
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (219)))).isBuiltAndTrue ()) {
      ...
      var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (229))).operator_concat (GGS_string (".asm")) ;
    ...
    GGS_string var_cas_hexDestinationFile ;
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_concat (GGS_string (".hex")) ;
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (234)) ;
    GGS_string var_cas_asmDestinationFile ;
    var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (235))).operator_concat (GGS_string (".asm")) ;
