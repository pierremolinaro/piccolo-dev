...
//                    february 24th, 2010, at 15h26'24"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_pic18_build_listing_of_generated_code (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_currentAddress = GGS_uint (0U) ;
  {
    ...
    while (((operand_1201 = enumerator_1201.nextObject ()))) {
      ...
      const GGS_ipic18_instruction  temp_1242 = operand_1201->mInstruction ;
      if (temp_1242.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__enterLabelAtAddress method = findCategoryMethod__ipic18_instruction__enterLabelAtAddress (temp_1242.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_1242 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (25)) ;
        }
      }
    }
  }
  ...
  var_cas_currentAddress = GGS_uint (0U) ;
  {
    ...
    while (((operand_1770 = enumerator_1770.nextObject ()))) {
      ...
      const GGS_ipic18_instruction  temp_1858 = operand_1770->mInstruction ;
      if (temp_1858.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__buildAssemblyCode method = findCategoryMethod__ipic18_instruction__buildAssemblyCode (temp_1858.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_1858 (HERE), var_cas_lineList, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (35)) ;
        }
      }
      GGS_emittedCodeList  var_cas_code = GGS_emittedCodeList ::constructor_emptyList () ;
      const GGS_ipic18_instruction  temp_1974 = operand_1770->mInstruction ;
      if (temp_1974.isBuilt ()) {
        typeCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress method = findCategoryMethod__ipic18_instruction__generateBinaryCodeAtAddress (temp_1974.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_1974 (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_code COMMA_SOURCE_FILE_AT_LINE (37)) ;
        }
      }
...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  case GGS_programKind::enum_bootloaderProgram:
    ...
    {
      GGS_ramBankTable::cEnumerator enumerator_6698 (var_cas_ramBank, true) ;
      const GGS_ramBankTable::cElement * operand_6698 = NULL ;
      while (((operand_6698 = enumerator_6698.nextObject ()))) {
        macroValidPointer (operand_6698) ;
        var_cas_ramBank.modifier_setMFirstFreeAddressForKey (inLexique, operand_6698->mInfo.mFirstAddress, operand_6698->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)) ;
      }
    }
    }
    break ;
  ...
  {
    GGS_interruptDefinitionList::cEnumerator enumerator_7697 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (138)), true) ;
    const GGS_interruptDefinitionList::cElement * operand_7697 = NULL ;
    while (((operand_7697 = enumerator_7697.nextObject ()))) {
      macroValidPointer (operand_7697) ;
      const GGS_bool cond_7915 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (139))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE)) ;
      if (cond_7915.isBuiltAndTrue ()) {
        operand_7697->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("interrupt routine is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (141)) ;
      }
      const GGS_bool cond_8177 = (operand_7697->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).operator_isEqual (GGS_string ("high")) ;
      if (cond_8177.isBuiltAndTrue ()) {
        var_cas_highInterruptIsFast = operand_7697->mFastReturn ;
        const GGS_bool cond_8129 = var_cas_hasHighInterrupt ;
        if (cond_8129.isBuiltAndTrue ()) {
          operand_7697->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Only one 'high' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (146)) ;
        }
        var_cas_hasHighInterrupt = GGS_bool (true) ;
      }else if (cond_8177.isBuiltAndFalse ()) {
        const GGS_bool cond_8421 = (operand_7697->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148))).operator_isEqual (GGS_string ("low")) ;
        if (cond_8421.isBuiltAndTrue ()) {
          var_cas_lowInterruptIsFast = operand_7697->mFastReturn ;
          const GGS_bool cond_8375 = var_cas_hasLowInterrupt ;
          if (cond_8375.isBuiltAndTrue ()) {
            operand_7697->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Only one 'low' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (152)) ;
          }
          var_cas_hasLowInterrupt = GGS_bool (true) ;
        }else if (cond_8421.isBuiltAndFalse ()) {
          operand_7697->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("An interrupt routine should be named 'low' or 'high'") COMMA_SOURCE_FILE_AT_LINE (156)) ;
        }
      }
      const GGS_bool cond_8676 = (var_cas_highInterruptIsFast).operator_and (var_cas_lowInterruptIsFast) ;
      if (cond_8676.isBuiltAndTrue ()) {
        operand_7697->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("either low interrupt or high interrupt can be \"fast\", not both") COMMA_SOURCE_FILE_AT_LINE (159)) ;
      }
    }
  }
  GGS_actualConfigurationMap  var_cas_actualConfigurationMap ;
  const GGS_bool cond_9112 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE)) ;
  if (cond_9112.isBuiltAndTrue ()) {
    {
      GGS_configDefinitionList::cEnumerator enumerator_8884 (var_cas_inPiccoloModel.reader_mConfigDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (164)), true) ;
      const GGS_configDefinitionList::cElement * operand_8884 = NULL ;
      while (((operand_8884 = enumerator_8884.nextObject ()))) {
        macroValidPointer (operand_8884) ;
        operand_8884->mDefinitionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("configuration is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (166)) ;
      }
    }
    var_cas_actualConfigurationMap = GGS_actualConfigurationMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  }else if (cond_9112.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_10693 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (187))).operator_isEqual (GGS_programKind::constructor_bootloaderProgram (inLexique COMMA_HERE)) ;
  if (cond_10693.isBuiltAndTrue ()) {
    {
      GGS_ramBankTable::cEnumerator enumerator_9801 (var_cas_ramBank, true) ;
      const GGS_ramBankTable::cElement * operand_9801 = NULL ;
      while (((operand_9801 = enumerator_9801.nextObject ()))) {
        macroValidPointer (operand_9801) ;
        const GGS_bool cond_10391 = var_cas_bootloaderReservedRAMmap.reader_hasKey (operand_9801->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189))) ;
        if (cond_10391.isBuiltAndTrue ()) {
          GGS_luint  var_cas_bootloaderReservedSize ;
          const GGS_bootloaderReservedRAMmap  temp_9950 = var_cas_bootloaderReservedRAMmap ;
          if (temp_9950.isBuilt ()) {
            temp_9950 (HERE)->method_searchKey (inLexique, operand_9801->mKey, var_cas_bootloaderReservedSize COMMA_SOURCE_FILE_AT_LINE (191)) ;
          }
          const GGS_bool cond_10374 = (operand_9801->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9801->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (192))).operator_strictSup (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (192))) ;
          if (cond_10374.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("for '")).operator_concat (operand_9801->mKey)).operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares "))).operator_concat (operand_9801->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9801->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (194)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194)))).operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves "))).operator_concat (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)))).operator_concat (GGS_string (" byte(s)")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
          }
        }else if (cond_10391.isBuiltAndFalse ()) {
          const GGS_bool cond_10664 = (operand_9801->mInfo.mFirstFreeAddress).operator_strictSup (operand_9801->mInfo.mFirstAddress) ;
          if (cond_10664.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("for '")).operator_concat (operand_9801->mKey)).operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares "))).operator_concat (operand_9801->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9801->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (201)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)))).operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves no space")) COMMA_SOURCE_FILE_AT_LINE (203)) ;
          }
        }
      }
    }
  ...
  const GGS_bool cond_11679 = ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (gOption_piccolo_5F_options_performOptimizations.reader_value ()) ;
  ...
  const GGS_bool cond_11910 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11910.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_13859 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13859.isBuiltAndTrue ()) {
    ...
    GGS_bool automatic_var_12425_0 ;
    const GGS_string temp_12401 = var_cas_contents ;
    if (temp_12401.isBuilt ()) {
      temp_12401 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_12425_0 COMMA_SOURCE_FILE_AT_LINE (245)) ;
    }
    const GGS_bool cond_13265 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
    if (cond_13265.isBuiltAndTrue ()) {
      GGS_string var_cas_verboseMessage = ((GGS_string ("  ROM size: ")).operator_concat (var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (248)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (248)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (248)))).operator_concat (GGS_string (" bytes;")) ;
      var_cas_verboseMessage.appendCString (" used: ") ;
      var_cas_verboseMessage.dotAssign_operation (var_cas_usedROMsize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (249))) ;
      var_cas_verboseMessage.appendCString (" bytes (") ;
      var_cas_verboseMessage.dotAssign_operation (var_cas_usedROMsize.multiply_operation (inLexique, GGS_uint (100U) COMMA_SOURCE_FILE_AT_LINE (250)).divide_operation (inLexique, var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (250)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (250))) ;
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        GGS_ramBankTable::cEnumerator enumerator_12813 (var_cas_ramBank, true) ;
        const GGS_ramBankTable::cElement * operand_12813 = NULL ;
        while (((operand_12813 = enumerator_12813.nextObject ()))) {
          macroValidPointer (operand_12813) ;
          GGS_uint  var_cas_bankSize = operand_12813->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_12813->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (252)) ;
          GGS_uint  var_cas_usedSize = operand_12813->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_12813->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (253)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage.dotAssign_operation (operand_12813->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254))) ;
          var_cas_verboseMessage.appendCString ("': ") ;
          var_cas_verboseMessage.dotAssign_operation (var_cas_bankSize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
          var_cas_verboseMessage.appendCString (" bytes, used ") ;
          var_cas_verboseMessage.dotAssign_operation (var_cas_usedSize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (256))) ;
          var_cas_verboseMessage.appendCString (" bytes (") ;
          var_cas_verboseMessage.dotAssign_operation (var_cas_usedSize.multiply_operation (inLexique, GGS_uint (100U) COMMA_SOURCE_FILE_AT_LINE (257)).divide_operation (inLexique, var_cas_bankSize COMMA_SOURCE_FILE_AT_LINE (257)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257))) ;
          var_cas_verboseMessage.appendCString ("%).\n") ;
        }
      }
      inLexique.printMessage (var_cas_verboseMessage COMMA_SOURCE_FILE_AT_LINE (259)) ;
    }
    const GGS_bool cond_13847 = gOption_piccolo_5F_options_generateAssembly.reader_value () ;
    if (cond_13847.isBuiltAndTrue ()) {
      GGS_string var_cas_assemblyCode ;
      ::routine_pic18_build_assembly_code (inLexique,  var_cas_piccoloDeviceModel.reader_mDeviceName (inLexique COMMA_SOURCE_FILE_AT_LINE (265)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)),  var_cas_piccoloDeviceModel.reader_mRegisterTable (inLexique COMMA_SOURCE_FILE_AT_LINE (266)),  var_cas_registerTable,  var_cas_generatedInstructionList,  var_cas_actualConfigurationMap,  var_cas_assemblyCode COMMA_SOURCE_FILE_AT_LINE (264)) ;
      ...
      GGS_bool automatic_var_13837_0 ;
      const GGS_string temp_13813 = var_cas_assemblyCode ;
      if (temp_13813.isBuilt ()) {
        temp_13813 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_13837_0 COMMA_SOURCE_FILE_AT_LINE (273)) ;
      }
    }
  }else if (cond_13859.isBuiltAndFalse ()) {
    GGS_string var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension ()).operator_concat (GGS_string (".hex")) ;
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (277)) ;
    GGS_string var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension ()).operator_concat (GGS_string (".asm")) ;
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_asmDestinationFile COMMA_SOURCE_FILE_AT_LINE (279)) ;
  }
  const GGS_bool cond_14649 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_14649.isBuiltAndTrue ()) {
    const GGS_bool cond_14482 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
    if (cond_14482.isBuiltAndTrue ()) {
      ::routine_pic18_build_listing_of_generated_code (inLexique,  var_cas_generatedInstructionList,  var_cas_listFileContents COMMA_SOURCE_FILE_AT_LINE (284)) ;
    }
    ...
    GGS_bool automatic_var_14641_0 ;
    const GGS_string temp_14627 = var_cas_listFileContents ;
    if (temp_14627.isBuilt ()) {
      temp_14627 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_14641_0 COMMA_SOURCE_FILE_AT_LINE (290)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
