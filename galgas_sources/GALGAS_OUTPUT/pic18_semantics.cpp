...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  {
    GGS_interruptDefinitionList::cEnumerator enumerator_7695 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (138)), true) ;
    const GGS_interruptDefinitionList::cElement * operand_7695 = NULL ;
    while (((operand_7695 = enumerator_7695.nextObject ()))) {
      macroValidPointer (operand_7695) ;
      const GGS_bool cond_7913 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (139))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_SOURCE_FILE_AT_LINE (139))) ;
      if (cond_7913.isBuiltAndTrue ()) {
        operand_7695->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("interrupt routine is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (141)) ;
      }
      const GGS_bool cond_8175 = (operand_7695->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).operator_isEqual (GGS_string ("high")) ;
      if (cond_8175.isBuiltAndTrue ()) {
        var_cas_highInterruptIsFast = operand_7695->mFastReturn ;
        const GGS_bool cond_8127 = var_cas_hasHighInterrupt ;
        if (cond_8127.isBuiltAndTrue ()) {
          operand_7695->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Only one 'high' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (146)) ;
        }
        var_cas_hasHighInterrupt = GGS_bool (true) ;
      }else if (cond_8175.isBuiltAndFalse ()) {
        const GGS_bool cond_8419 = (operand_7695->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148))).operator_isEqual (GGS_string ("low")) ;
        if (cond_8419.isBuiltAndTrue ()) {
          var_cas_lowInterruptIsFast = operand_7695->mFastReturn ;
          const GGS_bool cond_8373 = var_cas_hasLowInterrupt ;
          if (cond_8373.isBuiltAndTrue ()) {
            operand_7695->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Only one 'low' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (152)) ;
          }
          var_cas_hasLowInterrupt = GGS_bool (true) ;
        }else if (cond_8419.isBuiltAndFalse ()) {
          operand_7695->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("An interrupt routine should be named 'low' or 'high'") COMMA_SOURCE_FILE_AT_LINE (156)) ;
        }
      }
      const GGS_bool cond_8674 = (var_cas_highInterruptIsFast).operator_and (var_cas_lowInterruptIsFast) ;
      if (cond_8674.isBuiltAndTrue ()) {
        operand_7695->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("either low interrupt or high interrupt can be \"fast\", not both") COMMA_SOURCE_FILE_AT_LINE (159)) ;
      }
    }
  }
  GGS_actualConfigurationMap  var_cas_actualConfigurationMap ;
  const GGS_bool cond_9110 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_SOURCE_FILE_AT_LINE (163))) ;
  if (cond_9110.isBuiltAndTrue ()) {
    {
      GGS_configDefinitionList::cEnumerator enumerator_8882 (var_cas_inPiccoloModel.reader_mConfigDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (164)), true) ;
      const GGS_configDefinitionList::cElement * operand_8882 = NULL ;
      while (((operand_8882 = enumerator_8882.nextObject ()))) {
        macroValidPointer (operand_8882) ;
        operand_8882->mDefinitionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("configuration is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (166)) ;
      }
    }
    var_cas_actualConfigurationMap = GGS_actualConfigurationMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
  }else if (cond_9110.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_10691 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (187))).operator_isEqual (GGS_programKind::constructor_bootloaderProgram (inLexique COMMA_SOURCE_FILE_AT_LINE (187))) ;
  if (cond_10691.isBuiltAndTrue ()) {
    {
      GGS_ramBankTable::cEnumerator enumerator_9799 (var_cas_ramBank, true) ;
      const GGS_ramBankTable::cElement * operand_9799 = NULL ;
      while (((operand_9799 = enumerator_9799.nextObject ()))) {
        macroValidPointer (operand_9799) ;
        const GGS_bool cond_10389 = var_cas_bootloaderReservedRAMmap.reader_hasKey (operand_9799->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189))) ;
        if (cond_10389.isBuiltAndTrue ()) {
          GGS_luint  var_cas_bootloaderReservedSize ;
          const GGS_bootloaderReservedRAMmap  temp_9948 = var_cas_bootloaderReservedRAMmap ;
          if (temp_9948.isBuilt ()) {
            temp_9948 (HERE)->method_searchKey (inLexique, operand_9799->mKey, var_cas_bootloaderReservedSize COMMA_SOURCE_FILE_AT_LINE (191)) ;
          }
          const GGS_bool cond_10372 = (operand_9799->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9799->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (192))).operator_strictSup (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (192))) ;
          if (cond_10372.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("for '")).operator_concat (operand_9799->mKey)).operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares "))).operator_concat (operand_9799->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9799->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (194)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194)))).operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves "))).operator_concat (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)))).operator_concat (GGS_string (" byte(s)")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
          }
        }else if (cond_10389.isBuiltAndFalse ()) {
          const GGS_bool cond_10662 = (operand_9799->mInfo.mFirstFreeAddress).operator_strictSup (operand_9799->mInfo.mFirstAddress) ;
          if (cond_10662.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("for '")).operator_concat (operand_9799->mKey)).operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares "))).operator_concat (operand_9799->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9799->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (201)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)))).operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves no space")) COMMA_SOURCE_FILE_AT_LINE (203)) ;
          }
        }
      }
    }
  ...
  const GGS_bool cond_11677 = ((GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).operator_isEqual (GGS_uint (0U))).operator_and (gOption_piccolo_5F_options_performOptimizations.reader_value ()) ;
  if (cond_11677.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_11908 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (229))).operator_isEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_13857 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13857.isBuiltAndTrue ()) {
    ...
    GGS_bool automatic_var_12423_0 ;
    const GGS_string temp_12399 = var_cas_contents ;
    if (temp_12399.isBuilt ()) {
      temp_12399 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_12423_0 COMMA_SOURCE_FILE_AT_LINE (245)) ;
    }
    const GGS_bool cond_13263 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
    if (cond_13263.isBuiltAndTrue ()) {
      ...
      {
        GGS_ramBankTable::cEnumerator enumerator_12811 (var_cas_ramBank, true) ;
        const GGS_ramBankTable::cElement * operand_12811 = NULL ;
        while (((operand_12811 = enumerator_12811.nextObject ()))) {
          macroValidPointer (operand_12811) ;
          GGS_uint  var_cas_bankSize = operand_12811->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_12811->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (252)) ;
          GGS_uint  var_cas_usedSize = operand_12811->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_12811->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (253)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage.dotAssign_operation (operand_12811->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254))) ;
          var_cas_verboseMessage.appendCString ("': ") ;
    ...
    const GGS_bool cond_13845 = gOption_piccolo_5F_options_generateAssembly.reader_value () ;
    if (cond_13845.isBuiltAndTrue ()) {
      ...
      GGS_bool automatic_var_13835_0 ;
      const GGS_string temp_13811 = var_cas_assemblyCode ;
      if (temp_13811.isBuilt ()) {
        temp_13811 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_13835_0 COMMA_SOURCE_FILE_AT_LINE (273)) ;
      }
    }
  ...
  const GGS_bool cond_14647 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_14647.isBuiltAndTrue ()) {
    const GGS_bool cond_14480 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (283))).operator_isEqual (GGS_uint (0U)) ;
    ...
    GGS_bool automatic_var_14639_0 ;
    const GGS_string temp_14625 = var_cas_listFileContents ;
    if (temp_14625.isBuilt ()) {
      temp_14625 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_14639_0 COMMA_SOURCE_FILE_AT_LINE (290)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
