...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
    ...
    const GGS_string temp_9697 = var_cas_listFileContents ;
    if (temp_9697.isBuilt ()) {
      temp_9697 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (187)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    const GGS_string temp_10210 = var_cas_contents ;
    if (temp_10210.isBuilt ()) {
      temp_10210 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (202)) ;
    }
    ...
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (219)))).isBuiltAndTrue ()) {
      ...
      const GGS_string temp_11610 = var_cas_assemblyCode ;
      if (temp_11610.isBuilt ()) {
        temp_11610 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (230)) ;
      }
    }
  }else{
    GGS_string var_cas_hexDestinationFile ;
