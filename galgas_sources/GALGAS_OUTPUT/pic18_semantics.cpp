...
void routine_analyze_5F_data_5F_sections (const GALGAS_dataList constinArgument_inDataDefinitionList,
  ...
  cEnumerator_dataList enumerator_3704 (constinArgument_inDataDefinitionList, kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_3704.hasCurrentObject () && bool_0) {
    ...
    while (enumerator_3704.hasCurrentObject () && bool_0) {
      ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Data '").operator_concat (enumerator_3704.current_mDataName (HERE).reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string ("', ") COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (enumerator_3704.current_mValueList (HERE).reader_length (SOURCE_FILE_AT_LINE (84)).reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string (" words (") COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (enumerator_3704.current_mValueList (HERE).reader_length (SOURCE_FILE_AT_LINE (84)).multiply_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (84)).reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string (" bytes).\n") COMMA_SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)) ;
      {
      outArgument_outDataMap.modifier_insertKey (enumerator_3704.current_mDataName (HERE), enumerator_3704.current_mValueList (HERE).reader_length (SOURCE_FILE_AT_LINE (85)), inCompiler COMMA_SOURCE_FILE_AT_LINE (85)) ;
      }
      {
      outArgument_outConstantMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_3704.current_mDataName (HERE).mAttribute_string.operator_concat (GALGAS_string ("_BYTE_COUNT") COMMA_SOURCE_FILE_AT_LINE (86)), enumerator_3704.current_mDataName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (86)), enumerator_3704.current_mValueList (HERE).reader_length (SOURCE_FILE_AT_LINE (86)).multiply_operation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (86)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (86)), inCompiler COMMA_SOURCE_FILE_AT_LINE (86)) ;
      }
      GALGAS_lstring var_dataName = GALGAS_lstring::constructor_new (GALGAS_string ("_data_").operator_concat (enumerator_3704.current_mDataName (HERE).reader_string (SOURCE_FILE_AT_LINE (87)) COMMA_SOURCE_FILE_AT_LINE (87)), enumerator_3704.current_mDataName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (87)) ;
      ...
      cEnumerator_luintlist enumerator_4585 (enumerator_3704.current_mValueList (HERE), kEnumeration_up) ;
      while (enumerator_4585.hasCurrentObject ()) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, enumerator_4585.current_mValue (HERE).mAttribute_uint.objectCompare (GALGAS_uint ((PMUInt32) 65535U))).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_4585.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("data value is ").operator_concat (enumerator_4585.current_mValue (HERE).mAttribute_uint.reader_hexString (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string (" (greater than 0xFFFF)") COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) ;
        }else if (kBoolFalse == test_1) {
          outArgument_outDataGeneratedInstructionList.addAssign_operation (GALGAS_pic_31__38__5F_intermediate_5F_word::constructor_new (enumerator_4585.current_mValue (HERE).mAttribute_uint COMMA_SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)) ;
        }
...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  if (constinArgument_inPiccoloModel.mAttribute_mProgramKind.isValid ()) {
    ...
    case GALGAS_programKind::kEnum_bootloaderProgram: {
      ...
      cEnumerator_ramBankTable enumerator_8647 (var_ramBank, kEnumeration_up) ;
      while (enumerator_8647.hasCurrentObject ()) {
        {
        var_ramBank.modifier_setMFirstFreeAddressForKey (enumerator_8647.current_mFirstAddress (HERE), enumerator_8647.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (158)), inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
        }
  ...
  cEnumerator_checkpicList enumerator_9567 (constinArgument_inPiccoloModel.mAttribute_mCheckpicList, kEnumeration_up) ;
  while (enumerator_9567.hasCurrentObject ()) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_9623 (enumerator_9567.current_mValueList (HERE), kEnumeration_up) ;
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (178)).isValidAndTrue () ;
    if (enumerator_9623.hasCurrentObject () && bool_4) {
      while (enumerator_9623.hasCurrentObject () && bool_4) {
        var_found = GALGAS_bool (kIsEqual, enumerator_9623.current_mValue (HERE).mAttribute_string.objectCompare (var_piccoloDeviceName)) ;
        enumerator_9623.gotoNextObject () ;
        if (enumerator_9623.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_5) {
      inCompiler->emitSemanticError (enumerator_9567.current_mErrorLocation (HERE), GALGAS_string ("this code is not available for '").operator_concat (var_piccoloDeviceName COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)) ;
    }
  ...
  cEnumerator_interruptDefinitionList enumerator_10098 (constinArgument_inPiccoloModel.mAttribute_mInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_10098.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_6) {
      GALGAS_location location_7 (enumerator_10098.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_10098.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (194)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
    if (kBoolTrue == test_8) {
      var_highInterruptIsFast = enumerator_10098.current_mFastReturn (HERE) ;
      const enumGalgasBool test_9 = var_hasHighInterrupt.boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (enumerator_10098.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_10098.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (200)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
      if (kBoolTrue == test_11) {
        var_lowInterruptIsFast = enumerator_10098.current_mFastReturn (HERE) ;
        const enumGalgasBool test_12 = var_hasLowInterrupt.boolEnum () ;
        if (kBoolTrue == test_12) {
          GALGAS_location location_13 (enumerator_10098.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        GALGAS_location location_14 (enumerator_10098.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_15) {
      GALGAS_location location_16 (enumerator_10098.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  if (kBoolTrue == test_17) {
    cEnumerator_configDefinitionList enumerator_11282 (constinArgument_inPiccoloModel.reader_mConfigDefinitionList (SOURCE_FILE_AT_LINE (216)), kEnumeration_up) ;
    while (enumerator_11282.hasCurrentObject ()) {
      inCompiler->emitSemanticError (enumerator_11282.current_mDefinitionLocation (HERE), GALGAS_string ("configuration is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (217)) ;
  ...
  if (kBoolTrue == test_18) {
    cEnumerator_ramBankTable enumerator_12110 (var_ramBank, kEnumeration_up) ;
    while (enumerator_12110.hasCurrentObject ()) {
      const enumGalgasBool test_19 = var_bootloaderReservedRAMmap.reader_hasKey (enumerator_12110.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (240)) COMMA_SOURCE_FILE_AT_LINE (240)).boolEnum () ;
      if (kBoolTrue == test_19) {
        GALGAS_luint var_bootloaderReservedSize ;
        var_bootloaderReservedRAMmap.method_searchKey (enumerator_12110.current_lkey (HERE), var_bootloaderReservedSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (242)) ;
        const enumGalgasBool test_20 = GALGAS_bool (kIsStrictSup, enumerator_12110.current_mFirstFreeAddress (HERE).substract_operation (enumerator_12110.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (243)).objectCompare (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (243)))).boolEnum () ;
        if (kBoolTrue == test_20) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_12110.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (enumerator_12110.current_mFirstFreeAddress (HERE).substract_operation (enumerator_12110.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (245)).reader_string (SOURCE_FILE_AT_LINE (245)) COMMA_SOURCE_FILE_AT_LINE (245)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves ") COMMA_SOURCE_FILE_AT_LINE (246)).operator_concat (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (247)).reader_string (SOURCE_FILE_AT_LINE (247)) COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string (" byte(s)") COMMA_SOURCE_FILE_AT_LINE (248)) COMMA_SOURCE_FILE_AT_LINE (244)) ;
        }
      }else if (kBoolFalse == test_19) {
        const enumGalgasBool test_21 = GALGAS_bool (kIsStrictSup, enumerator_12110.current_mFirstFreeAddress (HERE).objectCompare (enumerator_12110.current_mFirstAddress (HERE))).boolEnum () ;
        if (kBoolTrue == test_21) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_12110.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (enumerator_12110.current_mFirstFreeAddress (HERE).substract_operation (enumerator_12110.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (252)).reader_string (SOURCE_FILE_AT_LINE (252)) COMMA_SOURCE_FILE_AT_LINE (252)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves no space") COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (251)) ;
        }
      }
  ...
  cEnumerator_ramBankTable enumerator_13103 (var_ramBank, kEnumeration_up) ;
  while (enumerator_13103.hasCurrentObject ()) {
    const enumGalgasBool test_22 = GALGAS_bool (kIsStrictSup, enumerator_13103.current_mLastAddressPlusOne (HERE).objectCompare (var_RAMsize)).boolEnum () ;
    if (kBoolTrue == test_22) {
      var_RAMsize = enumerator_13103.current_mLastAddressPlusOne (HERE) ;
    }
  ...
  if (kBoolTrue == test_23) {
    {
    routine_build_5F_ipic_31__38__5F_block_5F_representation_5F_list (constinArgument_inSourceFileName, var_piccoloDeviceModel, var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (270)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, constinArgument_inPiccoloModel, var_ramBank, var_hasHighInterrupt, var_hasLowInterrupt, var_piccoloDeviceModel.reader_mDeviceName (SOURCE_FILE_AT_LINE (282)).reader_string (SOURCE_FILE_AT_LINE (282)), var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (283)), var_actualConfigurationMap, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (267)) ;
    }
    ...
    {
    routine_analyze_5F_data_5F_sections (constinArgument_inPiccoloModel.mAttribute_mDataList, var_listFileContents, var_dataGeneratedInstructionList, var_dataMap, var_dataLengthConstantMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (289)) ;
    }
    GALGAS_pic_31__38__5F_intermediate_5F_instructionList var_generatedInstructionList ;
    {
    routine_build_5F_pic_31__38__5F_intermediate_5F_assembly_5F_instruction_5F_list (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (299)).reader_uint (SOURCE_FILE_AT_LINE (299)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (299)), var_RAMsize.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (300)), var_bootloaderRoutineDeclarationListForBootloaderImplementation, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderReservedROMsize, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_userRoutineDeclarationListForUserProgramImplementation, var_accessBankSplitOffset, var_registerTable, var_dataMap, constinArgument_inPiccoloModel, var_hasHighInterrupt, var_hasLowInterrupt, var_dataGeneratedInstructionList, var_dataLengthConstantMap, var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
    }
    const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (318)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_piccolo_5F_options_performOptimizations.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (318)).boolEnum () ;
    if (kBoolTrue == test_24) {
      {
      routine_performOptimizations (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
      }
    }
    const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (322)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_25) {
      {
      routine_pic_31__38__5F_intermediate_5F_convertRelativeBranchsToAbsoluteWhenNeeded (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (323)) ;
      }
    }
    const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (326)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_26) {
      GALGAS_uint var_usedROMsize ;
      {
      routine_build_5F_pic_31__38__5F_intermediate_5F_binary_5F_code (var_generatedInstructionList, var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (331)).reader_uint (SOURCE_FILE_AT_LINE (331)), var_actualConfigurationMap, var_usedROMsize, inCompiler COMMA_SOURCE_FILE_AT_LINE (329)) ;
      }
      ...
      GALGAS_bool joker_16327_0 ; // Joker input parameter
      var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16327_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (338)) ;
      ...
      if (kBoolTrue == test_27) {
        ...
        GALGAS_bool joker_16707_0 ; // Joker input parameter
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16707_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (343)) ;
        {
        ...
        GALGAS_bool joker_16914_0 ; // Joker input parameter
        var_contents.method_writeToFileWhenDifferentContents (var_destinationFile, joker_16914_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) ;
      }
      ...
      if (kBoolTrue == test_28) {
        ...
        var_verboseMessage.dotAssign_operation (GALGAS_string ("  ROM size: ").operator_concat (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (351)).reader_uint (SOURCE_FILE_AT_LINE (351)).reader_string (SOURCE_FILE_AT_LINE (351)) COMMA_SOURCE_FILE_AT_LINE (351)).operator_concat (GALGAS_string (" bytes;") COMMA_SOURCE_FILE_AT_LINE (351)) COMMA_SOURCE_FILE_AT_LINE (351)) ;
        var_verboseMessage.dotAssign_operation (GALGAS_string (" used: ").operator_concat (var_usedROMsize.reader_string (SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)) ;
        var_verboseMessage.dotAssign_operation (var_usedROMsize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (353)).divide_operation (var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (353)).reader_uint (SOURCE_FILE_AT_LINE (353)), inCompiler COMMA_SOURCE_FILE_AT_LINE (353)).reader_string (SOURCE_FILE_AT_LINE (353)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)) ;
        cEnumerator_ramBankTable enumerator_17381 (var_ramBank, kEnumeration_up) ;
        while (enumerator_17381.hasCurrentObject ()) {
          GALGAS_uint var_bankSize = enumerator_17381.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_17381.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
          GALGAS_uint var_usedSize = enumerator_17381.current_mFirstFreeAddress (HERE).substract_operation (enumerator_17381.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (356)) ;
          var_verboseMessage.dotAssign_operation (GALGAS_string ("  RAM bank '").operator_concat (enumerator_17381.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)).operator_concat (GALGAS_string ("': ") COMMA_SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
          var_verboseMessage.dotAssign_operation (var_bankSize.reader_string (SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string (" bytes, used ") COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
          var_verboseMessage.dotAssign_operation (var_usedSize.reader_string (SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string (" bytes (") COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
          var_verboseMessage.dotAssign_operation (var_usedSize.multiply_operation (GALGAS_uint ((PMUInt32) 100U), inCompiler COMMA_SOURCE_FILE_AT_LINE (360)).divide_operation (var_bankSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (360)).reader_string (SOURCE_FILE_AT_LINE (360)).operator_concat (GALGAS_string ("%).\n") COMMA_SOURCE_FILE_AT_LINE (360)) COMMA_SOURCE_FILE_AT_LINE (360)) ;
          enumerator_17381.gotoNextObject () ;
        }
        inCompiler->printMessage (var_verboseMessage COMMA_SOURCE_FILE_AT_LINE (362)) ;
      }
      ...
      if (kBoolTrue == test_29) {
        ...
        {
        routine_pic_31__38__5F_build_5F_assembly_5F_code (var_piccoloDeviceModel.reader_mDeviceName (SOURCE_FILE_AT_LINE (367)).reader_string (SOURCE_FILE_AT_LINE (367)), var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (368)), var_registerTable, var_generatedInstructionList, var_actualConfigurationMap, var_assemblyCode, inCompiler COMMA_SOURCE_FILE_AT_LINE (366)) ;
        }
        ...
        GALGAS_bool joker_18420_0 ; // Joker input parameter
        var_assemblyCode.method_writeToFileWhenDifferentContents (var_asmDestinationFile, joker_18420_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (375)) ;
      }
      ...
      {
      GALGAS_string::class_method_deleteFileIfExists (var_hexDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (379)) ;
      }
      GALGAS_string var_asmDestinationFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (380)).operator_concat (GALGAS_string (".asm") COMMA_SOURCE_FILE_AT_LINE (380)) ;
      {
      GALGAS_string::class_method_deleteFileIfExists (var_asmDestinationFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
      }
    }
    const enumGalgasBool test_30 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (384)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_30) {
      {
      routine_pic_31__38__5F_build_5F_listing_5F_of_5F_generated_5F_code (var_generatedInstructionList, var_listFileContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) ;
      }
    }
    const enumGalgasBool test_31 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (391)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, constinArgument_inPiccoloModel.mAttribute_mProgramKind.objectCompare (GALGAS_programKind::constructor_userProgram (SOURCE_FILE_AT_LINE (391)))) COMMA_SOURCE_FILE_AT_LINE (391)).boolEnum () ;
    if (kBoolTrue == test_31) {
      {
      routine_pic_31__38__5F_compute_5F_metrics (constinArgument_inPiccoloModel, var_userRoutineDeclarationListForBootloaderImplementation, var_bootloaderRoutineDeclarationListForUserProgramImplementation, var_generatedInstructionList, var_listFileContents, constinArgument_inSourceFileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (392)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_32) {
    ...
    GALGAS_string var_listFile = constinArgument_inSourceFileName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string (".list") COMMA_SOURCE_FILE_AT_LINE (405)) ;
    GALGAS_bool joker_19922_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_19922_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (406)) ;
  }
}
