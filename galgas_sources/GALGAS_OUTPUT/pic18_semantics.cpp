...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  if (cond_8239.isBuiltAndTrue ()) {
    {
      ...
      while (((operand_7347 = enumerator_7347.nextObject ()))) {
        ...
        const GGS_bool cond_7937 = var_cas_bootloaderReservedRAMmap.reader_hasKey (inLexique, operand_7347->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (141)) ;
  ...
  const GGS_bool cond_9219 = ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (gOption_piccolo_5F_options_performOptimizations.value ()) ;
  if (cond_9219.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_9450 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9450.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_9719 = gOption_piccolo_5F_options_ouputListingFile.value () ;
  ...
  const GGS_bool cond_11656 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_11656.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_11068 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.value () ;
    ...
    const GGS_bool cond_11644 = gOption_piccolo_5F_options_generateAssembly.value () ;
    if (cond_11644.isBuiltAndTrue ()) {
  ...
  }else if (cond_11656.isBuiltAndFalse ()) {
