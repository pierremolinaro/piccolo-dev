...
//                    february 22th, 2010, at 22h34'37"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3940 = (var_cas_sourceFileBaseName).operator_isNotEqual (var_cas_inPiccoloModel.reader_mProgramName (inLexique COMMA_SOURCE_FILE_AT_LINE (70)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (70))) ;
  if (cond_3940.isBuiltAndTrue ()) {
  ...
  case GGS_programKind::enum_bootloaderProgram:
    ...
    {
      GGS_ramBankTable::cEnumerator enumerator_6676 (var_cas_ramBank, true) ;
      const GGS_ramBankTable::cElement * operand_6676 = NULL ;
      while (((operand_6676 = enumerator_6676.nextObject ()))) {
        macroValidPointer (operand_6676) ;
        var_cas_ramBank.modifier_setMFirstFreeAddressForKey (inLexique, operand_6676->mInfo.mFirstAddress, operand_6676->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)) ;
      }
    }
    }
    break ;
  ...
  {
    GGS_interruptDefinitionList::cEnumerator enumerator_7675 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (138)), true) ;
    const GGS_interruptDefinitionList::cElement * operand_7675 = NULL ;
    while (((operand_7675 = enumerator_7675.nextObject ()))) {
      macroValidPointer (operand_7675) ;
      const GGS_bool cond_7893 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (139))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE)) ;
      if (cond_7893.isBuiltAndTrue ()) {
        operand_7675->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("interrupt routine is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (141)) ;
      }
      const GGS_bool cond_8155 = (operand_7675->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).operator_isEqual (GGS_string ("high")) ;
      if (cond_8155.isBuiltAndTrue ()) {
        var_cas_highInterruptIsFast = operand_7675->mFastReturn ;
        const GGS_bool cond_8107 = var_cas_hasHighInterrupt ;
        if (cond_8107.isBuiltAndTrue ()) {
          operand_7675->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Only one 'high' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (146)) ;
        }
        var_cas_hasHighInterrupt = GGS_bool (true) ;
      }else if (cond_8155.isBuiltAndFalse ()) {
        const GGS_bool cond_8399 = (operand_7675->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148))).operator_isEqual (GGS_string ("low")) ;
        if (cond_8399.isBuiltAndTrue ()) {
          var_cas_lowInterruptIsFast = operand_7675->mFastReturn ;
          const GGS_bool cond_8353 = var_cas_hasLowInterrupt ;
          if (cond_8353.isBuiltAndTrue ()) {
            operand_7675->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Only one 'low' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (152)) ;
          }
          var_cas_hasLowInterrupt = GGS_bool (true) ;
        }else if (cond_8399.isBuiltAndFalse ()) {
          operand_7675->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("An interrupt routine should be named 'low' or 'high'") COMMA_SOURCE_FILE_AT_LINE (156)) ;
        }
      }
      const GGS_bool cond_8654 = (var_cas_highInterruptIsFast).operator_and (var_cas_lowInterruptIsFast) ;
      if (cond_8654.isBuiltAndTrue ()) {
        operand_7675->mInterruptName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("either low interrupt or high interrupt can be \"fast\", not both") COMMA_SOURCE_FILE_AT_LINE (159)) ;
      }
    }
  }
  GGS_actualConfigurationMap  var_cas_actualConfigurationMap ;
  const GGS_bool cond_9090 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE)) ;
  if (cond_9090.isBuiltAndTrue ()) {
    {
      GGS_configDefinitionList::cEnumerator enumerator_8862 (var_cas_inPiccoloModel.reader_mConfigDefinitionList (inLexique COMMA_SOURCE_FILE_AT_LINE (164)), true) ;
      const GGS_configDefinitionList::cElement * operand_8862 = NULL ;
      while (((operand_8862 = enumerator_8862.nextObject ()))) {
        macroValidPointer (operand_8862) ;
        operand_8862->mDefinitionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("configuration is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (166)) ;
      }
    }
  ...
  const GGS_bool cond_10671 = (var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (187))).operator_isEqual (GGS_programKind::constructor_bootloaderProgram (inLexique COMMA_HERE)) ;
  if (cond_10671.isBuiltAndTrue ()) {
    {
      GGS_ramBankTable::cEnumerator enumerator_9779 (var_cas_ramBank, true) ;
      const GGS_ramBankTable::cElement * operand_9779 = NULL ;
      while (((operand_9779 = enumerator_9779.nextObject ()))) {
        macroValidPointer (operand_9779) ;
        const GGS_bool cond_10369 = var_cas_bootloaderReservedRAMmap.reader_hasKey (operand_9779->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189))) ;
        if (cond_10369.isBuiltAndTrue ()) {
          GGS_luint  var_cas_bootloaderReservedSize ;
          const GGS_bootloaderReservedRAMmap  temp_9928 = var_cas_bootloaderReservedRAMmap ;
          if (temp_9928.isBuilt ()) {
            temp_9928 (HERE)->method_searchKey (inLexique, operand_9779->mKey, var_cas_bootloaderReservedSize COMMA_SOURCE_FILE_AT_LINE (191)) ;
          }
          const GGS_bool cond_10352 = (operand_9779->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9779->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (192))).operator_strictSup (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (192))) ;
          if (cond_10352.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("for '")).operator_concat (operand_9779->mKey)).operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares "))).operator_concat (operand_9779->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9779->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (194)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194)))).operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves "))).operator_concat (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)))).operator_concat (GGS_string (" byte(s)")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
          }
        }else if (cond_10369.isBuiltAndFalse ()) {
          const GGS_bool cond_10642 = (operand_9779->mInfo.mFirstFreeAddress).operator_strictSup (operand_9779->mInfo.mFirstAddress) ;
          if (cond_10642.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("for '")).operator_concat (operand_9779->mKey)).operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares "))).operator_concat (operand_9779->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_9779->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (201)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)))).operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves no space")) COMMA_SOURCE_FILE_AT_LINE (203)) ;
          }
        }
      }
    }
  ...
  const GGS_bool cond_11657 = ((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and (gOption_piccolo_5F_options_performOptimizations.reader_value ()) ;
  if (cond_11657.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_11888 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_13837 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13837.isBuiltAndTrue ()) {
    ...
    GGS_bool automatic_var_12403_0 ;
    const GGS_string temp_12379 = var_cas_contents ;
    if (temp_12379.isBuilt ()) {
      temp_12379 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_12403_0 COMMA_SOURCE_FILE_AT_LINE (245)) ;
    }
    const GGS_bool cond_13243 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
    if (cond_13243.isBuiltAndTrue ()) {
      ...
      {
        GGS_ramBankTable::cEnumerator enumerator_12791 (var_cas_ramBank, true) ;
        const GGS_ramBankTable::cElement * operand_12791 = NULL ;
        while (((operand_12791 = enumerator_12791.nextObject ()))) {
          macroValidPointer (operand_12791) ;
          GGS_uint  var_cas_bankSize = operand_12791->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_12791->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (252)) ;
          GGS_uint  var_cas_usedSize = operand_12791->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_12791->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (253)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage.dotAssign_operation (operand_12791->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254))) ;
          var_cas_verboseMessage.appendCString ("': ") ;
    ...
    const GGS_bool cond_13825 = gOption_piccolo_5F_options_generateAssembly.reader_value () ;
    if (cond_13825.isBuiltAndTrue ()) {
      ...
      GGS_bool automatic_var_13815_0 ;
      const GGS_string temp_13791 = var_cas_assemblyCode ;
      if (temp_13791.isBuilt ()) {
        temp_13791 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_13815_0 COMMA_SOURCE_FILE_AT_LINE (273)) ;
      }
    }
  ...
  const GGS_bool cond_14627 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_14627.isBuiltAndTrue ()) {
    const GGS_bool cond_14460 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
    ...
    GGS_bool automatic_var_14619_0 ;
    const GGS_string temp_14605 = var_cas_listFileContents ;
    if (temp_14605.isBuilt ()) {
      temp_14605 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_14619_0 COMMA_SOURCE_FILE_AT_LINE (290)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
