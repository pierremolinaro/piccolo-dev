...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  var_cas_sourceFileBaseName = var_cas_inSourceFileName.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (21)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (21)) ;
  if (((var_cas_sourceFileBaseName)._operator_isNotEqual (var_cas_inPiccoloModel.reader_mProgramName (inLexique COMMA_SOURCE_FILE_AT_LINE (22)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (22)))).isBuiltAndTrue ()) {
    var_cas_inPiccoloModel.reader_mProgramName (inLexique COMMA_SOURCE_FILE_AT_LINE (23)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the program name ('"))._operator_concat (var_cas_inPiccoloModel.reader_mProgramName (inLexique COMMA_SOURCE_FILE_AT_LINE (23))))._operator_concat (GGS_string ("') should be identical to the file base name '")))._operator_concat (var_cas_sourceFileBaseName))._operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (25)) ;
  }
  ...
  var_cas_lowInterruptIsFast = GGS_bool (false) ;
  {
    ...
    while (((operand_5243 = enumerator_5243.nextObject ()))) {
      ...
      if (((var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (91)))._operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
      ...
      if (((operand_5243->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94)))._operator_isEqual (GGS_string ("high"))).isBuiltAndTrue ()) {
      ...
      }else if (((operand_5243->mInterruptName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)))._operator_isEqual (GGS_string ("low"))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (115)))._operator_isEqual (GGS_programKind::constructor_userProgram (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    {
  ...
  if (((var_cas_inPiccoloModel.reader_mProgramKind (inLexique COMMA_SOURCE_FILE_AT_LINE (139)))._operator_isEqual (GGS_programKind::constructor_bootloaderProgram (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
    {
      ...
      while (((operand_7347 = enumerator_7347.nextObject ()))) {
        ...
        if ((var_cas_bootloaderReservedRAMmap.reader_hasKey (inLexique, operand_7347->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (141))).isBuiltAndTrue ()) {
          ...
          if (_temp_7496.isBuilt ()) {
            _temp_7496 (HERE)->method_searchKey (inLexique, operand_7347->mKey, var_cas_bootloaderReservedSize COMMA_SOURCE_FILE_AT_LINE (143)) ;
          }
          if (((operand_7347->mInfo.mFirstFreeAddress._substract_operation (inLexique, operand_7347->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (144)))._operator_strictSup (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (144)))).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("for '"))._operator_concat (operand_7347->mKey))._operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares ")))._operator_concat (operand_7347->mInfo.mFirstFreeAddress._substract_operation (inLexique, operand_7347->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (146)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (146))))._operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves ")))._operator_concat (var_cas_bootloaderReservedSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (148)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148))))._operator_concat (GGS_string (" byte(s)")) COMMA_SOURCE_FILE_AT_LINE (150)) ;
          }
        }else if (((operand_7347->mInfo.mFirstFreeAddress)._operator_strictSup (operand_7347->mInfo.mFirstAddress)).isBuiltAndTrue ()) {
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("for '"))._operator_concat (operand_7347->mKey))._operator_concat (GGS_string ("' RAM bank, the bootloader implementation declares ")))._operator_concat (operand_7347->mInfo.mFirstFreeAddress._substract_operation (inLexique, operand_7347->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (153)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (153))))._operator_concat (GGS_string (" byte(s), althought the bootloader specification reserves no space")) COMMA_SOURCE_FILE_AT_LINE (155)) ;
        }
      }
    }
  }
  ...
  if ((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U)))._operator_and (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "performOptimizations" COMMA_SOURCE_FILE_AT_LINE (177))))).isBuiltAndTrue ()) {
  ...
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
    GGS_string var_cas_listFile ;
    var_cas_listFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_concat (GGS_string (".list")) ;
    GGS_bool automatic_var_0 ;
    const GGS_string _temp_9697 = var_cas_listFileContents ;
    if (_temp_9697.isBuilt ()) {
      _temp_9697 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (187)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (201)))._operator_concat (GGS_string (".hex")) ;
    GGS_bool automatic_var_1 ;
    const GGS_string _temp_10210 = var_cas_contents ;
    if (_temp_10210.isBuilt ()) {
      _temp_10210 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (202)) ;
    }
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (204)))).isBuiltAndTrue ()) {
      GGS_string var_cas_verboseMessage ;
      var_cas_verboseMessage = ((GGS_string ("  ROM size: "))._operator_concat (var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205))))._operator_concat (GGS_string (" bytes;")) ;
      var_cas_verboseMessage.appendCString (" used: ") ;
      var_cas_verboseMessage._dotAssign_operation (var_cas_usedROMsize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
      var_cas_verboseMessage.appendCString (" bytes (") ;
      var_cas_verboseMessage._dotAssign_operation (var_cas_usedROMsize._multiply_operation (inLexique, GGS_uint (100U) COMMA_SOURCE_FILE_AT_LINE (207))._divide_operation (inLexique, var_cas_piccoloDeviceModel.reader_mRomSize (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207))) ;
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        ...
        while (((operand_10616 = enumerator_10616.nextObject ()))) {
          ...
          var_cas_bankSize = operand_10616->mInfo.mLastAddressPlusOne._substract_operation (inLexique, operand_10616->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (209)) ;
          GGS_uint  var_cas_usedSize ;
          var_cas_usedSize = operand_10616->mInfo.mFirstFreeAddress._substract_operation (inLexique, operand_10616->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (210)) ;
          var_cas_verboseMessage.appendCString ("  RAM bank '") ;
          var_cas_verboseMessage._dotAssign_operation (operand_10616->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (211))) ;
          var_cas_verboseMessage.appendCString ("': ") ;
          var_cas_verboseMessage._dotAssign_operation (var_cas_bankSize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (212))) ;
          var_cas_verboseMessage.appendCString (" bytes, used ") ;
          var_cas_verboseMessage._dotAssign_operation (var_cas_usedSize.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (213))) ;
          var_cas_verboseMessage.appendCString (" bytes (") ;
          var_cas_verboseMessage._dotAssign_operation (var_cas_usedSize._multiply_operation (inLexique, GGS_uint (100U) COMMA_SOURCE_FILE_AT_LINE (214))._divide_operation (inLexique, var_cas_bankSize COMMA_SOURCE_FILE_AT_LINE (214)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214))) ;
          var_cas_verboseMessage.appendCString ("%).\n") ;
        }
      }
      inLexique.printMessage (var_cas_verboseMessage COMMA_SOURCE_FILE_AT_LINE (216)) ;
    }
    if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (219)))).isBuiltAndTrue ()) {
      ...
      var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (229)))._operator_concat (GGS_string (".asm")) ;
      GGS_bool automatic_var_2 ;
      const GGS_string _temp_11610 = var_cas_assemblyCode ;
      if (_temp_11610.isBuilt ()) {
        _temp_11610 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (230)) ;
      }
    }
  }else{
    GGS_string var_cas_hexDestinationFile ;
    var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (233)))._operator_concat (GGS_string (".hex")) ;
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (234)) ;
    GGS_string var_cas_asmDestinationFile ;
    var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (235)))._operator_concat (GGS_string (".asm")) ;
