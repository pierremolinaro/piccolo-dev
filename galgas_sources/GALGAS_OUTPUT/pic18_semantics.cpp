...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  GALGAS_bool temp_127 (gOption_piccolo_5F_options_performOptimizations.reader_value ()) ;
  ...
  if (temp_134.isValidAndTrue ()) {
    ...
    //-------- @ifInstructionForGeneration
    //--- @optionValueExpressionForGeneration
    GALGAS_bool temp_140 (gOption_piccolo_5F_options_output_5F_C_5F_Array.reader_value ()) ;
    ...
    //-------- @ifInstructionForGeneration
    //--- @optionValueExpressionForGeneration
    GALGAS_bool temp_149 (gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value ()) ;
    ...
    //-------- @ifInstructionForGeneration
    //--- @optionValueExpressionForGeneration
    GALGAS_bool temp_189 (gOption_piccolo_5F_options_generateAssembly.reader_value ()) ;
  ...
  //-------- @ifInstructionForGeneration
  //--- @optionValueExpressionForGeneration
  GALGAS_bool temp_202 (gOption_piccolo_5F_options_ouputListingFile.reader_value ()) ;
