...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_sourceFileBaseName = var_cas_inSourceFileName.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (21)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (21)) ;
  ...
  if ((gOption_piccolo_5F_options_ouputListingFile.value ()).isBuiltAndTrue ()) {
    GGS_string var_cas_listFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_concat (GGS_string (".list")) ;
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    GGS_string var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (201))).operator_concat (GGS_string (".hex")) ;
    ...
    if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
      ...
      var_cas_verboseMessage.appendCString ("%).\n") ;
      {
        ...
        while (((operand_10616 = enumerator_10616.nextObject ()))) {
          ...
          GGS_uint  var_cas_bankSize = operand_10616->mInfo.mLastAddressPlusOne.substract_operation (inLexique, operand_10616->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (209)) ;
          GGS_uint  var_cas_usedSize = operand_10616->mInfo.mFirstFreeAddress.substract_operation (inLexique, operand_10616->mInfo.mFirstAddress COMMA_SOURCE_FILE_AT_LINE (210)) ;
    ...
    if ((gOption_piccolo_5F_options_generateAssembly.value ()).isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (229))).operator_concat (GGS_string (".asm")) ;
    ...
    GGS_string var_cas_hexDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_concat (GGS_string (".hex")) ;
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (234)) ;
    GGS_string var_cas_asmDestinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (235))).operator_concat (GGS_string (".asm")) ;
