...
void routine_pic_31__38__5F_analyze (const GALGAS_piccoloModel constinArgument_inPiccoloModel,
  ...
  cEnumerator_pic_31__38_RoutineDefinitionList enumerator_5561 (constinArgument_inPiccoloModel.mAttribute_mRoutineDefinitionList, kEnumeration_up) ;
  while (enumerator_5561.hasCurrentObject ()) {
    {
    var_declaredRoutineMap.modifier_insertKey (enumerator_5561.current_mRoutineName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_5783 (constinArgument_inPiccoloModel.mAttribute_mUnusedRoutineList, kEnumeration_up) ;
  while (enumerator_5783.hasCurrentObject ()) {
    const enumGalgasBool test_4 = var_declaredRoutineMap.reader_hasKey (enumerator_5783.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (106)).operator_not (SOURCE_FILE_AT_LINE (106)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_5783.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (enumerator_5783.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)).operator_concat (GALGAS_string ("' routine is not declared") COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)) ;
    }else if (kBoolFalse == test_4) {
      const enumGalgasBool test_6 = var_unusedDeclarationUnicity.reader_hasKey (enumerator_5783.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (108)).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_5783.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticWarning (location_7, GALGAS_string ("the '").operator_concat (enumerator_5783.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)).operator_concat (GALGAS_string ("' routine is already declared as unused") COMMA_SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = var_usedRoutineSet.reader_hasKey (enumerator_5783.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (110)).boolEnum () ;
        if (kBoolTrue == test_8) {
          GALGAS_location location_9 (enumerator_5783.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_9, GALGAS_string ("the '").operator_concat (enumerator_5783.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)).operator_concat (GALGAS_string ("' routine is declared as unused, but is used") COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)) ;
        }
      }
    }
    var_unusedDeclarationUnicity.addAssign_operation (enumerator_5783.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (113)) ;
    enumerator_5783.gotoNextObject () ;
  }
  cEnumerator_declaredRoutineMap enumerator_6321 (var_declaredRoutineMap, kEnumeration_up) ;
  while (enumerator_6321.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_usedRoutineSet.reader_hasKey (enumerator_6321.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (116)).operator_not (SOURCE_FILE_AT_LINE (116)).operator_and (var_unusedDeclarationUnicity.reader_hasKey (enumerator_6321.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (116)).operator_not (SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_location location_11 (enumerator_6321.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticWarning (location_11, GALGAS_string ("the '").operator_concat (enumerator_6321.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)).operator_concat (GALGAS_string ("' routine is unused") COMMA_SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)) ;
    }
    enumerator_6321.gotoNextObject () ;
  }
  cEnumerator_checkpicList enumerator_6631 (constinArgument_inPiccoloModel.mAttribute_mCheckpicList, kEnumeration_up) ;
  while (enumerator_6631.hasCurrentObject ()) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_6687 (enumerator_6631.current_mValueList (HERE), kEnumeration_up) ;
    bool bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (123)).isValidAndTrue () ;
    if (enumerator_6687.hasCurrentObject () && bool_12) {
      while (enumerator_6687.hasCurrentObject () && bool_12) {
        var_found = GALGAS_bool (kIsEqual, enumerator_6687.current_mValue (HERE).mAttribute_string.objectCompare (var_piccoloDeviceName)) ;
        enumerator_6687.gotoNextObject () ;
        if (enumerator_6687.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_13) {
      inCompiler->emitSemanticError (enumerator_6631.current_mErrorLocation (HERE), GALGAS_string ("this code is not available for '").operator_concat (var_piccoloDeviceName COMMA_SOURCE_FILE_AT_LINE (127)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
    }
  ...
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_7162 (constinArgument_inPiccoloModel.mAttribute_mInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_7162.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_14) {
      GALGAS_location location_15 (enumerator_7162.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_7162.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (139)).objectCompare (GALGAS_string ("high"))).boolEnum () ;
    if (kBoolTrue == test_16) {
      var_highInterruptIsFast = enumerator_7162.current_mFastReturn (HERE) ;
      const enumGalgasBool test_17 = var_hasHighInterrupt.boolEnum () ;
      if (kBoolTrue == test_17) {
        GALGAS_location location_18 (enumerator_7162.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_7162.current_mInterruptName (HERE).reader_string (SOURCE_FILE_AT_LINE (145)).objectCompare (GALGAS_string ("low"))).boolEnum () ;
      if (kBoolTrue == test_19) {
        var_lowInterruptIsFast = enumerator_7162.current_mFastReturn (HERE) ;
        const enumGalgasBool test_20 = var_hasLowInterrupt.boolEnum () ;
        if (kBoolTrue == test_20) {
          GALGAS_location location_21 (enumerator_7162.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        GALGAS_location location_22 (enumerator_7162.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_23) {
      GALGAS_location location_24 (enumerator_7162.current_mInterruptName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  if (kBoolTrue == test_25) {
    cEnumerator_configDefinitionList enumerator_8346 (constinArgument_inPiccoloModel.reader_mConfigDefinitionList (SOURCE_FILE_AT_LINE (161)), kEnumeration_up) ;
    while (enumerator_8346.hasCurrentObject ()) {
      inCompiler->emitSemanticError (enumerator_8346.current_mDefinitionLocation (HERE), GALGAS_string ("configuration is not allowed for a bootloader user program") COMMA_SOURCE_FILE_AT_LINE (162)) ;
  ...
  if (kBoolTrue == test_26) {
    cEnumerator_ramBankTable enumerator_9213 (var_ramBank, kEnumeration_up) ;
    while (enumerator_9213.hasCurrentObject ()) {
      const enumGalgasBool test_27 = var_bootloaderReservedRAMmap.reader_hasKey (enumerator_9213.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)).boolEnum () ;
      if (kBoolTrue == test_27) {
        GALGAS_luint var_bootloaderReservedSize ;
        var_bootloaderReservedRAMmap.method_searchKey (enumerator_9213.current_lkey (HERE), var_bootloaderReservedSize, inCompiler COMMA_SOURCE_FILE_AT_LINE (188)) ;
        const enumGalgasBool test_28 = GALGAS_bool (kIsStrictSup, enumerator_9213.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9213.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (189)).objectCompare (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (189)))).boolEnum () ;
        if (kBoolTrue == test_28) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_9213.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (enumerator_9213.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9213.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (191)).reader_string (SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves ") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (var_bootloaderReservedSize.reader_uint (SOURCE_FILE_AT_LINE (193)).reader_string (SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string (" byte(s)") COMMA_SOURCE_FILE_AT_LINE (194)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
        }
      }else if (kBoolFalse == test_27) {
        const enumGalgasBool test_29 = GALGAS_bool (kIsStrictSup, enumerator_9213.current_mFirstFreeAddress (HERE).objectCompare (enumerator_9213.current_mFirstAddress (HERE))).boolEnum () ;
        if (kBoolTrue == test_29) {
          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("for '").operator_concat (enumerator_9213.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (197)) COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (GALGAS_string ("' RAM bank, the bootloader implementation declares ") COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (enumerator_9213.current_mFirstFreeAddress (HERE).substract_operation (enumerator_9213.current_mFirstAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (198)).reader_string (SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)).operator_concat (GALGAS_string (" byte(s), althought the bootloader specification reserves no space") COMMA_SOURCE_FILE_AT_LINE (199)) COMMA_SOURCE_FILE_AT_LINE (197)) ;
        }
      }
  ...
  cEnumerator_ramBankTable enumerator_10206 (var_ramBank, kEnumeration_up) ;
  while (enumerator_10206.hasCurrentObject ()) {
    const enumGalgasBool test_30 = GALGAS_bool (kIsStrictSup, enumerator_10206.current_mLastAddressPlusOne (HERE).objectCompare (var_RAMsize)).boolEnum () ;
    if (kBoolTrue == test_30) {
      var_RAMsize = enumerator_10206.current_mLastAddressPlusOne (HERE) ;
    }
  ...
  if (kBoolTrue == test_31) {
    ...
    GALGAS_bool joker_11481_0 ; // Joker input parameter
    var_listFileContents.method_writeToFileWhenDifferentContents (var_listFile, joker_11481_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (236)) ;
  }
}
