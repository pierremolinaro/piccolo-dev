...
//                    november 26th, 2009, at 17h18'22"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_pic18_analyze (C_Compiler & inLexique,
  ...
  if (cond_9731.isBuiltAndTrue ()) {
    ...
    if (temp_9709.isBuilt ()) {
      temp_9709 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_listFile, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (187)) ;
    }
  }
  ...
  if (cond_11680.isBuiltAndTrue ()) {
    ...
    if (temp_10222.isBuilt ()) {
      temp_10222 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_hexDestinationFile, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (202)) ;
    }
    ...
    if (cond_11668.isBuiltAndTrue ()) {
      ...
      if (temp_11634.isBuilt ()) {
        temp_11634 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_asmDestinationFile, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (230)) ;
      }
    }
