    ...
    case 2: {
      ...
      case 2: {
        ...
        if (kBoolTrue == test_9) {
          ...
          const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_registerName.reader_mOffset (SOURCE_FILE_AT_LINE (798)).reader_uint (SOURCE_FILE_AT_LINE (798)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
          if (kBoolTrue == test_10) {
          ...
          if (kBoolTrue == test_12) {
            ...
            const enumGalgasBool test_13 = GALGAS_bool (kIsStrictSup, var_registerName.reader_mOffset (SOURCE_FILE_AT_LINE (807)).reader_uint (SOURCE_FILE_AT_LINE (807)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
            if (kBoolTrue == test_13) {
