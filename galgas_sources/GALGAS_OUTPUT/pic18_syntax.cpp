...
//                    december 20th, 2013, at 23h14'52"                      *
//                                                                           *
//---------------------------------------------------------------------------*
              ...
              if (kBoolTrue == test_23) {
                ...
                if (kBoolTrue == test_24) {
                  ...
                  if (kBoolTrue == test_25) {
                    ...
                    inCompiler->emitSemanticError (location_26, GALGAS_string ("invalid '").operator_concat (var_conditionString.reader_string (SOURCE_FILE_AT_LINE (909)) COMMA_SOURCE_FILE_AT_LINE (909)).operator_concat (GALGAS_string ("' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'") COMMA_SOURCE_FILE_AT_LINE (910)) COMMA_SOURCE_FILE_AT_LINE (909)) ;
                    var_conditional_5F_branch.drop () ; // Release error dropped variable
                  }
                }
              }
