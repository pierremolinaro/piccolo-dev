...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_7500 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_7500.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_7500.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (258)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (272)) ;
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_8203 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_8203.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8203.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (275)) ;
    }
    enumerator_8203.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8430 (constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_8430.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8430.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (282)) ;
    enumerator_8430.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8593 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_8593.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8593.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (286)) ;
    enumerator_8593.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (289)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (290)).isValid ()) {
    PMUInt32 variant_8736 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (290)).uintValue () ;
    bool loop_8736 = true ;
    while (loop_8736) {
      loop_8736 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_8736) {
        loop_8736 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_8736 && (0 == variant_8736)) {
        loop_8736 = false ;
      ...
      if (loop_8736) {
        ...
        cEnumerator_pic_31__38_RoutineDefinitionList enumerator_8871 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_8871.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_8871.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (294)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8871.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
            }
          }
