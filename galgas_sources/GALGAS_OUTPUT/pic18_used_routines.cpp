...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_8180 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_8180.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_8180.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (296)) ;
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_8883 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_8883.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8883.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) ;
    }
    enumerator_8883.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_9110 (constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_9110.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_9110.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (306)) ;
    enumerator_9110.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_9273 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_9273.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_9273.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (310)) ;
    enumerator_9273.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (313)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (314)).isValid ()) {
    PMUInt32 variant_9417 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (314)).uintValue () ;
    bool loop_9417 = true ;
    while (loop_9417) {
      loop_9417 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_9417) {
        loop_9417 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_9417 && (0 == variant_9417)) {
        loop_9417 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (314)) ;
      }
      if (loop_9417) {
        variant_9417 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_pic_31__38_RoutineDefinitionList enumerator_9551 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_9551.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_9551.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (318)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9551.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
            }
          }
...
static void categoryMethod_pic_31__38_Instruction_5F_block_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_pic_31__38_BlockInstructionBlockList enumerator_7829 (object->mAttribute_mBlockList, kEnumeration_up) ;
  while (enumerator_7829.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_7829.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (271)) ;
    }
