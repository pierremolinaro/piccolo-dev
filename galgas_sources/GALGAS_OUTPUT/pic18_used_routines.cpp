...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  while (enumerator_8559.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_8559.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (293)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  while (enumerator_9262.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9262.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (310)) ;
    }
  ...
  while (enumerator_9489.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_9489.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (317)) ;
  ...
  while (enumerator_9652.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_9652.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (321)) ;
  ...
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (325)).isValid ()) {
    uint32_t variant_9796 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (325)).uintValue () ;
    bool loop_9796 = true ;
    while (loop_9796) {
      ...
      if (loop_9796) {
        ...
        while (enumerator_9930.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_9930.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (329)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9930.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (330)) ;
            }
          }
