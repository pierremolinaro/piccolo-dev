...
//                    december 16th, 2013, at 14h14'15"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_7802 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_7802.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_7802.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_8505 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_8505.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8505.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (285)) ;
    }
    enumerator_8505.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8732 (constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_8732.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8732.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (292)) ;
    enumerator_8732.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8895 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_8895.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8895.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (296)) ;
  ...
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (300)).isValid ()) {
    PMUInt32 variant_9038 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (300)).uintValue () ;
    bool loop_9038 = true ;
    while (loop_9038) {
      loop_9038 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_9038) {
        loop_9038 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_9038 && (0 == variant_9038)) {
        loop_9038 = false ;
      ...
      if (loop_9038) {
        ...
        cEnumerator_pic_31__38_RoutineDefinitionList enumerator_9173 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_9173.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_9173.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (304)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9173.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (305)) ;
            }
          }
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_bra_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3316 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3316.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3316.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (114)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_goto_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3588 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3588.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3588.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (124)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_rcall_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3861 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3861.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3861.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (134)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_do_5F_while_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_pic_31__38_DoWhilePartList enumerator_4413 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_4413.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_4413.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
    }
...
static void categoryMethod_pic_31__38_Instruction_5F_block_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_pic_31__38_BlockInstructionBlockList enumerator_7451 (object->mAttribute_mBlockList, kEnumeration_up) ;
  while (enumerator_7451.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_7451.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (257)) ;
    }
