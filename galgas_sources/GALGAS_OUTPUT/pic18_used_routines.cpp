...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_7799 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_7799.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_7799.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (282)) ;
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_8502 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_8502.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8502.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (285)) ;
    }
    enumerator_8502.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8729 (constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_8729.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8729.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (292)) ;
    enumerator_8729.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8892 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_8892.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8892.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (296)) ;
    enumerator_8892.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (299)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (300)).isValid ()) {
    PMUInt32 variant_9036 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (300)).uintValue () ;
    bool loop_9036 = true ;
    while (loop_9036) {
      loop_9036 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_9036) {
        loop_9036 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_9036 && (0 == variant_9036)) {
        loop_9036 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (300)) ;
      }
      if (loop_9036) {
        variant_9036 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_pic_31__38_RoutineDefinitionList enumerator_9170 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_9170.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_9170.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (304)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9170.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (305)) ;
            }
          }
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_bra_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3313 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3313.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3313.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (114)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_goto_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3585 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3585.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3585.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (124)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_rcall_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3858 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3858.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3858.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (134)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_do_5F_while_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (150)) ;
  }
  cEnumerator_pic_31__38_DoWhilePartList enumerator_4410 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_4410.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_4410.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
    }
...
static void categoryMethod_pic_31__38_Instruction_5F_savebank_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_structured_5F_if_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (176)) ;
  }
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_JSR_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  ioArgument_ioUsedRoutines.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (206)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_block_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_pic_31__38_BlockInstructionBlockList enumerator_7448 (object->mAttribute_mBlockList, kEnumeration_up) ;
  while (enumerator_7448.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_7448.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (257)) ;
    }
