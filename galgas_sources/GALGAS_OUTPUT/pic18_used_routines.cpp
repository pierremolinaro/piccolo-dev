...
//                    december 26th, 2013, at 12h38'32"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_7993 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_7993.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_7993.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (275)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (289)) ;
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_8696 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_8696.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8696.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)) ;
    }
    enumerator_8696.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8923 (constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_8923.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8923.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (299)) ;
    enumerator_8923.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_9086 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_9086.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_9086.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (303)) ;
    enumerator_9086.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (306)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (307)).isValid ()) {
    PMUInt32 variant_9230 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (307)).uintValue () ;
    bool loop_9230 = true ;
    while (loop_9230) {
      loop_9230 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_9230) {
        loop_9230 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_9230 && (0 == variant_9230)) {
        loop_9230 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (307)) ;
      }
      if (loop_9230) {
        variant_9230 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_pic_31__38_RoutineDefinitionList enumerator_9364 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_9364.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_9364.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (311)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9364.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (312)) ;
            }
          }
...
static void categoryMethod_pic_31__38_Instruction_5F_JSR_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  ioArgument_ioUsedRoutines.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (213)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_block_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_pic_31__38_BlockInstructionBlockList enumerator_7642 (object->mAttribute_mBlockList, kEnumeration_up) ;
  while (enumerator_7642.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_7642.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (264)) ;
    }
