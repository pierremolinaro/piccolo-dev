...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_8565 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_8565.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_8565.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (293)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (307)) ;
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_9268 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_9268.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9268.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (310)) ;
    }
    enumerator_9268.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_9495 (constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_9495.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_9495.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (317)) ;
    enumerator_9495.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_9658 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_9658.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_9658.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (321)) ;
    enumerator_9658.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (324)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (325)).isValid ()) {
    PMUInt32 variant_9802 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (325)).uintValue () ;
    bool loop_9802 = true ;
    while (loop_9802) {
      loop_9802 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_9802) {
        loop_9802 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_9802 && (0 == variant_9802)) {
        loop_9802 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (325)) ;
      }
      if (loop_9802) {
        variant_9802 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_pic_31__38_RoutineDefinitionList enumerator_9936 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_9936.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_9936.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (329)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_9936.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (330)) ;
            }
          }
...
static void categoryMethod_pic_31__38_Instruction_5F_repetitionStatique_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (63)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_bra_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  while (enumerator_3507.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3507.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (121)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_goto_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  while (enumerator_3779.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3779.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (131)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_rcall_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  while (enumerator_4052.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_4052.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (141)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_do_5F_while_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) ;
  }
  ...
  while (enumerator_4604.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_4604.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) ;
    }
...
static void categoryMethod_pic_31__38_Instruction_5F_savebank_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_structured_5F_if_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (183)) ;
  }
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (184)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_switch_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  while (enumerator_5716.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_5716.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) ;
    }
    enumerator_5716.gotoNextObject () ;
  }
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (195)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_JSR_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  ioArgument_ioUsedRoutines.addAssign_operation (object->mAttribute_mTargetLabel.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (224)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_block_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  while (enumerator_8214.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8214.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
    }
