...
void routine_addPic_31__38_UsedRoutinesFromInstructionList (const GALGAS_pic_31__38_InstructionList constinArgument_inInstructionList,
  ...
  cEnumerator_pic_31__38_InstructionList enumerator_7227 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_7227.hasCurrentObject ()) {
    callCategoryMethod_addUsedRoutines ((const cPtr_pic_31__38_PiccoloInstruction *) enumerator_7227.current_mInstruction (HERE).ptr (), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (250)) ;
...
GALGAS_stringset function_pic_31__38__5F_computeUsedRoutines (const GALGAS_pic_31__38_InterruptDefinitionList & constinArgument_inInterruptDefinitionList,
  ...
  result_outUsedRoutineSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("main") COMMA_SOURCE_FILE_AT_LINE (264)) ;
  cEnumerator_pic_31__38_InterruptDefinitionList enumerator_7930 (constinArgument_inInterruptDefinitionList, kEnumeration_up) ;
  while (enumerator_7930.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_7930.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (267)) ;
    }
    enumerator_7930.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8157 (constinArgument_inBootloaderRoutineDeclarationListForBootloaderImplementation, kEnumeration_up) ;
  while (enumerator_8157.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8157.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (274)) ;
    enumerator_8157.gotoNextObject () ;
  }
  cEnumerator_routineDeclarationList enumerator_8320 (constinArgument_inUserRoutineDeclarationListForUserProgramImplementation, kEnumeration_up) ;
  while (enumerator_8320.hasCurrentObject ()) {
    result_outUsedRoutineSet.addAssign_operation (enumerator_8320.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (278)) ;
    enumerator_8320.gotoNextObject () ;
  }
  GALGAS_stringset var_s = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (281)) ;
  if (constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (282)).isValid ()) {
    PMUInt32 variant_8463 = constinArgument_inRoutineDefinitionList.reader_length (SOURCE_FILE_AT_LINE (282)).uintValue () ;
    bool loop_8463 = true ;
    while (loop_8463) {
      loop_8463 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).isValid () ;
      if (loop_8463) {
        loop_8463 = GALGAS_bool (kIsNotEqual, var_s.objectCompare (result_outUsedRoutineSet)).boolValue () ;
      }
      if (loop_8463 && (0 == variant_8463)) {
        loop_8463 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (282)) ;
      }
      if (loop_8463) {
        variant_8463 -- ;
        var_s = result_outUsedRoutineSet ;
        cEnumerator_pic_31__38_RoutineDefinitionList enumerator_8598 (constinArgument_inRoutineDefinitionList, kEnumeration_up) ;
        while (enumerator_8598.hasCurrentObject ()) {
          const enumGalgasBool test_0 = result_outUsedRoutineSet.reader_hasKey (enumerator_8598.current_mRoutineName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (286)).boolEnum () ;
          if (kBoolTrue == test_0) {
            {
            routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_8598.current_mInstructionList (HERE), result_outUsedRoutineSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (287)) ;
            }
          }
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_bra_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3043 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3043.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3043.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (106)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_goto_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  cEnumerator_lstringlist enumerator_3315 (object->mAttribute_mTargetLabels, kEnumeration_up) ;
  while (enumerator_3315.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3315.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (116)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_computed_5F_rcall_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  while (enumerator_3588.hasCurrentObject ()) {
    ioArgument_ioUsedRoutines.addAssign_operation (enumerator_3588.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (126)) ;
...
static void categoryMethod_pic_31__38_Instruction_5F_do_5F_while_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (142)) ;
  }
  cEnumerator_pic_31__38_DoWhilePartList enumerator_4140 (object->mAttribute_mWhilePartList, kEnumeration_up) ;
  while (enumerator_4140.hasCurrentObject ()) {
    {
    routine_addPic_31__38_UsedRoutinesFromInstructionList (enumerator_4140.current_mInstructionList (HERE), ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) ;
    }
...
static void categoryMethod_pic_31__38_Instruction_5F_savebank_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_pic_31__38_Instruction_5F_structured_5F_if_addUsedRoutines (const cPtr_pic_31__38_PiccoloInstruction * inObject,
  ...
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mThenInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  }
  {
  routine_addPic_31__38_UsedRoutinesFromInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioUsedRoutines, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
  }
}
//---------------------------------------------------------------------------*
