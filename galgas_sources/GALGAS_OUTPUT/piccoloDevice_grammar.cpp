...
void C_Grammar_piccoloDevice_5F_grammar::_performSourceFileParsing_ (C_Compiler & inCompiler,
  ...
  if (sourceFileName.fileExists ()) {
    ...
    macroMyNew (scanner, C_Lexique_piccoloDevice_5F_lexique (& inCompiler, inDependancyExtension, inDependancyPath, inCompiler.ioParametersPtr (), sourceFileName COMMA_HERE)) ;
    ...
    if (scanner->needsCompiling ()) {
      if (scanner->sourceText () != NULL) {
        ...
        if (ok && ! scanner->mParseOnlyFlag) {
          ...
          _grammar.nt_start_5F_symbol_ (*scanner, parameter_1) ;
...
void C_Grammar_piccoloDevice_5F_grammar::_performSourceStringParsing_ (C_Compiler & inCompiler,
  ...
  C_Lexique_piccoloDevice_5F_lexique * scanner = NULL ;
  macroMyNew (scanner, C_Lexique_piccoloDevice_5F_lexique (& inCompiler, inCompiler.ioParametersPtr (), inSourceString.string (), "Error when parsing dynamic string" COMMA_HERE)) ;
  macroRetainObject (scanner) ;
  scanner->mPerformGeneration = inCompiler.mPerformGeneration ;
  const bool ok = scanner->performTopDownParsing (gProductions, gProductionNames, gProductionIndexes,
                                                   gFirstProductionIndexes, gDecision, gDecisionIndexes, 144) ;
