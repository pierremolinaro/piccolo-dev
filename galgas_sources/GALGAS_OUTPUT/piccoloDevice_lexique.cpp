...
piccoloDevice_lexique (C_galgas_io * inParametersPtr,
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [30] = {"end of source",
...
const sint16 piccoloDevice_lexique::piccoloDevice_lexique_table_size_controlKeyWordList = 14 ;

const C_lexique_table_entry piccoloDevice_lexique::piccoloDevice_lexique_table_for_controlKeyWordList [14] = {
  ...
  C_lexique_table_entry ("config", 6, piccoloDevice_lexique_1_config),
  ...
  if (_p == NULL) {
    ...
    case  piccoloDevice_lexique_1_comment:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccoloDevice_lexique_1_config:
      s << '$'
        << "config"
        << '$' ;
      break;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [30] = {0,
    ...
    1 /* piccoloDevice_lexique_1_config */,
