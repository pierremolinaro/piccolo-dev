    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        if (_token.mTokenCode == -1) {
          _token.mTokenCode = piccoloDevice_lexique_1_identifier ;
        }
        _enterToken (_token) ;
        ...
        loop_ = true ;
        _token.mTokenCode = piccoloDevice_lexique_1_integer ;
        _enterToken (_token) ;
        ...
        loop_ = true ;
        if (testForInputUTF32Char (TO_UNICODE ('\"'))) {
          _token.mTokenCode = piccoloDevice_lexique_1_string ;
          _enterToken (_token) ;
        }else{
        ...
        _token.mTokenCode = piccoloDevice_lexique_1_ ; // Empty string code
  ...
  while (_token.mTokenCode < 0) {
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        loop_ = true ;
        _token.mTokenCode = piccoloDevice_lexique_1_comment ;
      }else if (testForInputUTF32CharRange (TO_UNICODE (1), TO_UNICODE (' '))) {
      }else if (testForInputUTF32Char (TO_UNICODE ('\0'))) { // End of source text ? 
        _token.mTokenCode = piccoloDevice_lexique_1_ ; // Empty string code
      }else{ // Unknown input character
