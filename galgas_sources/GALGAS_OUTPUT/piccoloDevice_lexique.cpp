      ...
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        do {
          if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
            ::scanner_action_enterHexDigitIntoUlong (*this, token.uint32value, previousChar (), gErrorMessage_0, gErrorMessage_2) ;
        ...
        ::scanner_action_enterDigitIntoUlong (*this, token.uint32value, previousChar (), gErrorMessage_1, gErrorMessage_2) ;
        do {
          if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
            ::scanner_action_enterDigitIntoUlong (*this, token.uint32value, previousChar (), gErrorMessage_1, gErrorMessage_2) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('_'))) {
        ...
        do {
          if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
            if (testForInputUTF32Char (TO_UNICODE ('f'))) {
              ::scanner_action_enterCharacterIntoString (*this, token.tokenString, TO_UNICODE ('\f')) ;
              ...
              ::scanner_action_enterCharacterIntoString (*this, token.tokenString, TO_UNICODE ('\r')) ;
            }else if (testForInputUTF32Char (TO_UNICODE ('t'))) {
              ::scanner_action_enterCharacterIntoString (*this, token.tokenString, TO_UNICODE ('\t')) ;
            }else if (testForInputUTF32Char (TO_UNICODE ('v'))) {
              ::scanner_action_enterCharacterIntoString (*this, token.tokenString, TO_UNICODE ('\v')) ;
            }else if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
              ::scanner_action_enterCharacterIntoString (*this, token.tokenString, TO_UNICODE ('\\')) ;
              ...
              do {
                ::scanner_action_enterHexDigitIntoASCIIcharacter (*this, token.charValue, previousChar (), gErrorMessage_4, gErrorMessage_2) ;
                if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
                }else{
                  loop = false ;
                }
              ...
              loop = true ;
              ::scanner_action_enterCharacterIntoString (*this, token.tokenString, token.charValue) ;
            }else{
