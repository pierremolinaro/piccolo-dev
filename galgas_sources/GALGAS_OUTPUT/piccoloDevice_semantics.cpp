...
enumComparisonResult cMapElement_registerTable::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_registerTable_searchKey [34] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_registerTable::method_searchKey (GALGAS_lstring inKey,
  ...
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_registerTable_searchKey COMMA_THERE) ;
  const cMapElement_registerTable * p = (const cMapElement_registerTable *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_registerTable) ;
...
void GALGAS_registerTable::modifier_setMRegisterAddressListForKey (GALGAS_uintlist inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_registerTable) ;
...
cMapElement_registerTable * GALGAS_registerTable::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_registerTable) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_registerTable::current_lkey (void) const {
...
GALGAS_uintlist cEnumerator_registerTable::current_mRegisterAddressList (void) const {
  const cMapElement_registerTable * p = (const cMapElement_registerTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_registerTable) ;
...
GALGAS_uint cEnumerator_registerTable::current_mSize (void) const {
  const cMapElement_registerTable * p = (const cMapElement_registerTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_registerTable) ;
...
GALGAS_bitSliceTable cEnumerator_registerTable::current_mBitSliceTable (void) const {
  const cMapElement_registerTable * p = (const cMapElement_registerTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_registerTable) ;
...
GALGAS_string cEnumerator_registerTable::current_mBitDefinitionString (void) const {
  const cMapElement_registerTable * p = (const cMapElement_registerTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_registerTable) ;
...
enumComparisonResult cMapElement_ramBankTable::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_ramBankTable_searchKey [34] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_ramBankTable::method_searchKey (GALGAS_lstring inKey,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_ramBankTable_searchKey COMMA_THERE) ;
  const cMapElement_ramBankTable * p = (const cMapElement_ramBankTable *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_ramBankTable) ;
...
void GALGAS_ramBankTable::modifier_setMFirstAddressForKey (GALGAS_uint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_ramBankTable) ;
...
cMapElement_ramBankTable * GALGAS_ramBankTable::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_ramBankTable) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_ramBankTable::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_uint cEnumerator_ramBankTable::current_mFirstAddress (void) const {
  const cMapElement_ramBankTable * p = (const cMapElement_ramBankTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_ramBankTable) ;
...
GALGAS_uint cEnumerator_ramBankTable::current_mFirstFreeAddress (void) const {
  const cMapElement_ramBankTable * p = (const cMapElement_ramBankTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_ramBankTable) ;
...
GALGAS_uint cEnumerator_ramBankTable::current_mLastAddressPlusOne (void) const {
  const cMapElement_ramBankTable * p = (const cMapElement_ramBankTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_ramBankTable) ;
...
GALGAS_uintlist cEnumerator_ramBankTable::current_mMirrorOffsetList (void) const {
  const cMapElement_ramBankTable * p = (const cMapElement_ramBankTable *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_ramBankTable) ;
...
enumComparisonResult GALGAS_processorType::objectCompare (const GALGAS_processorType & inOperand) const {
...
mAttribute_mIllegalValue (in_mIllegalValue),
mAttribute_mIllegalMask (in_mIllegalMask),
...
cCollectionElement * cCollectionElement_illegalMaskList::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_illegalMaskList (mAttribute_mIllegalValue, mAttribute_mIllegalMask, mAttribute_mDescription COMMA_HERE)) ;
  return result ;
}
...
// mAttribute_mIllegalValue.description (ioString, inIndentation) ;
// mAttribute_mIllegalMask.description (ioString, inIndentation) ;
// mAttribute_mDescription.description (ioString, inIndentation) ;
}

//---------------------------------------------------------------------------*

enumComparisonResult cCollectionElement_illegalMaskList::compare (const cCollectionElement * inOperand) const {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_mIllegalValue.objectCompare (operand->mAttribute_mIllegalValue) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mIllegalMask.objectCompare (operand->mAttribute_mIllegalMask) ;
  }
  if (kOperandEqual == result) {
...
void GALGAS_illegalMaskList::modifier_popFirst (GALGAS_luint & outOperand0,
  ...
  cCollectionElement_illegalMaskList * p = (cCollectionElement_illegalMaskList *) attributes.ptrNoVerif () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
  }else{
    macroValidObject (p, cCollectionElement_illegalMaskList) ;
    outOperand0 = p->mAttribute_mIllegalValue ;
    outOperand1 = p->mAttribute_mIllegalMask ;
    outOperand2 = p->mAttribute_mDescription ;
  }
}
...
GALGAS_illegalMaskList GALGAS_illegalMaskList::reader_subListWithRange (const GALGAS_uint & inIndex,
...
void GALGAS_illegalMaskList::modifier_setMIllegalValueAtIndex (GALGAS_luint inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_illegalMaskList * p = (cCollectionElement_illegalMaskList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_illegalMaskList) ;
    p->mAttribute_mIllegalValue = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_illegalMaskList::modifier_setMIllegalMaskAtIndex (GALGAS_luint inOperand,
                                                              GALGAS_uint inIndex,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_illegalMaskList * p = (cCollectionElement_illegalMaskList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_illegalMaskList) ;
    p->mAttribute_mIllegalMask = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_illegalMaskList::modifier_setMDescriptionAtIndex (GALGAS_lstring inOperand,
                                                              GALGAS_uint inIndex,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_illegalMaskList * p = (cCollectionElement_illegalMaskList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_illegalMaskList) ;
    p->mAttribute_mDescription = inOperand ;
  }
}
...
GALGAS_luint GALGAS_illegalMaskList::reader_mIllegalValueAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_illegalMaskList) ;
    result = p->mAttribute_mIllegalValue ;
  }
  return result ;
}
...
GALGAS_luint GALGAS_illegalMaskList::reader_mIllegalMaskAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidObject (p, cCollectionElement_illegalMaskList) ;
    result = p->mAttribute_mIllegalMask ;
  }
  return result ;
}
...
GALGAS_luint cEnumerator_illegalMaskList::current_mIllegalValue (void) const {
  const cCollectionElement_illegalMaskList * p = (const cCollectionElement_illegalMaskList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_illegalMaskList) ;
  return p->mAttribute_mIllegalValue ;
}

//---------------------------------------------------------------------------*

GALGAS_luint cEnumerator_illegalMaskList::current_mIllegalMask (void) const {
  const cCollectionElement_illegalMaskList * p = (const cCollectionElement_illegalMaskList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_illegalMaskList) ;
  return p->mAttribute_mIllegalMask ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring cEnumerator_illegalMaskList::current_mDescription (void) const {
  const cCollectionElement_illegalMaskList * p = (const cCollectionElement_illegalMaskList *) currentObjectPtr () ;
  macroValidObject (p, const cCollectionElement_illegalMaskList) ;
...
enumComparisonResult cMapElement_fieldSettingMap::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_fieldSettingMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  attributes.setPointer (p) ;
  macroReleaseObject (p) ;
  const utf32 kInsertErrorMessage [66] = {
    TO_UNICODE ('t'),
    TO_UNICODE ('h'),
    TO_UNICODE ('e'),
    TO_UNICODE (' '),
...
static const utf32 kSearchErrorMessage_fieldSettingMap_searchKey [56] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_fieldSettingMap::method_searchKey (GALGAS_lstring inKey,
                                               ...
                                               C_Compiler * inCompiler
                                               COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_fieldSettingMap_searchKey COMMA_THERE) ;
  const cMapElement_fieldSettingMap * p = (const cMapElement_fieldSettingMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_fieldSettingMap) ;
...
void GALGAS_fieldSettingMap::modifier_setMValueForKey (GALGAS_uint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_fieldSettingMap) ;
...
cMapElement_fieldSettingMap * GALGAS_fieldSettingMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_fieldSettingMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_fieldSettingMap::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_uint cEnumerator_fieldSettingMap::current_mValue (void) const {
  const cMapElement_fieldSettingMap * p = (const cMapElement_fieldSettingMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_fieldSettingMap) ;
...
GALGAS_uint cEnumerator_fieldSettingMap::current_mMask (void) const {
  const cMapElement_fieldSettingMap * p = (const cMapElement_fieldSettingMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_fieldSettingMap) ;
...
enumComparisonResult cMapElement_configRegisterMaskMap::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_configRegisterMaskMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  attributes.setPointer (p) ;
  macroReleaseObject (p) ;
  const utf32 kInsertErrorMessage [63] = {
    TO_UNICODE ('t'),
    TO_UNICODE ('h'),
    TO_UNICODE ('e'),
    TO_UNICODE (' '),
...
static const utf32 kSearchErrorMessage_configRegisterMaskMap_searchKey [53] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_configRegisterMaskMap::method_searchKey (GALGAS_lstring inKey,
                                                     ...
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_configRegisterMaskMap_searchKey COMMA_THERE) ;
  const cMapElement_configRegisterMaskMap * p = (const cMapElement_configRegisterMaskMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_configRegisterMaskMap) ;
...
void GALGAS_configRegisterMaskMap::modifier_setMMaskValueForKey (GALGAS_luint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_configRegisterMaskMap) ;
...
cMapElement_configRegisterMaskMap * GALGAS_configRegisterMaskMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_configRegisterMaskMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_configRegisterMaskMap::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_luint cEnumerator_configRegisterMaskMap::current_mMaskValue (void) const {
  const cMapElement_configRegisterMaskMap * p = (const cMapElement_configRegisterMaskMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_configRegisterMaskMap) ;
...
GALGAS_lstring cEnumerator_configRegisterMaskMap::current_mDescription (void) const {
  const cMapElement_configRegisterMaskMap * p = (const cMapElement_configRegisterMaskMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_configRegisterMaskMap) ;
  return p->mAttribute_mDescription ;
}
...
GALGAS_fieldSettingMap cEnumerator_configRegisterMaskMap::current_mFieldSettingMap (void) const {
  const cMapElement_configRegisterMaskMap * p = (const cMapElement_configRegisterMaskMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_configRegisterMaskMap) ;
...
enumComparisonResult cMapElement_configRegisterMap::compare (const cCollectionElement * inOperand) const {
...
static const utf32 kSearchErrorMessage_configRegisterMap_searchKey [48] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void GALGAS_configRegisterMap::method_searchKey (GALGAS_lstring inKey,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = performSearch (inKey, inCompiler, kSearchErrorMessage_configRegisterMap_searchKey COMMA_THERE) ;
  const cMapElement_configRegisterMap * p = (const cMapElement_configRegisterMap *) attributes ;
  if (NULL != p) {
    macroValidObject (p, const cMapElement_configRegisterMap) ;
...
void GALGAS_configRegisterMap::modifier_setMRegisterAddressForKey (GALGAS_luint inAttributeValue,
  ...
  if (NULL != p) {
    macroValidObject (p, cMapElement_configRegisterMap) ;
...
cMapElement_configRegisterMap * GALGAS_configRegisterMap::readWriteAccessForWithInstruction_hasKey (C_Compiler * inCompiler,
  ...
  macroNullOrValidObject (result, cMapElement_configRegisterMap) ;
  return result ;
}
...
GALGAS_lstring cEnumerator_configRegisterMap::current_lkey (void) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement) ;
  return p->mAttribute_lkey ;
}
...
GALGAS_luint cEnumerator_configRegisterMap::current_mRegisterAddress (void) const {
  const cMapElement_configRegisterMap * p = (const cMapElement_configRegisterMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_configRegisterMap) ;
...
GALGAS_luint cEnumerator_configRegisterMap::current_mRegisterWidth (void) const {
  const cMapElement_configRegisterMap * p = (const cMapElement_configRegisterMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_configRegisterMap) ;
...
GALGAS_configRegisterMaskMap cEnumerator_configRegisterMap::current_mConfigRegisterMaskMap (void) const {
  const cMapElement_configRegisterMap * p = (const cMapElement_configRegisterMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_configRegisterMap) ;
...
GALGAS_illegalMaskList cEnumerator_configRegisterMap::current_mIllegalMaskList (void) const {
  const cMapElement_configRegisterMap * p = (const cMapElement_configRegisterMap *) currentObjectPtr () ;
  macroValidObject (p, const cMapElement_configRegisterMap) ;
...
/* GALGAS_piccoloDeviceModel::GALGAS_piccoloDeviceModel (const GALGAS_piccoloDeviceModel & inSource) :
//mAttribute_mDeviceName (inSource.mAttribute_mDeviceName),
//mAttribute_mProcessorType (inSource.mAttribute_mProcessorType),
//mAttribute_mRomSize (inSource.mAttribute_mRomSize),
//mAttribute_mBankCount (inSource.mAttribute_mBankCount),
//mAttribute_mRegisterTable (inSource.mAttribute_mRegisterTable),
//mAttribute_mRamBankTable (inSource.mAttribute_mRamBankTable),
//mAttribute_mEepromSize (inSource.mAttribute_mEepromSize),
//mAttribute_mEepromAddress (inSource.mAttribute_mEepromAddress),
//mAttribute_mConfigRegisterMap (inSource.mAttribute_mConfigRegisterMap),
//mAttribute_mSharedBankName (inSource.mAttribute_mSharedBankName) {
} */
...
enumComparisonResult GALGAS_piccoloDeviceModel::objectCompare (const GALGAS_piccoloDeviceModel & inOperand) const {
   enumComparisonResult result = kOperandEqual ;
