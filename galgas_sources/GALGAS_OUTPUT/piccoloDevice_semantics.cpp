...
constructor_new (const GGS_lstring & argument_0,
                 ...
                 const GGS_registerTable & argument_3,
                 const GGS_ramBankTable & argument_4) {
  GGS_piccoloDeviceModel result ;
  result.mDeviceName = argument_0 ;
  result.mRomSize = argument_1 ;
  result.mBankCount = argument_2 ;
  result.mRegisterTable = argument_3 ;
  result.mRamBankTable = argument_4 ;
  return result ;
}
