...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mRegisterAddressList._operator_isEqual (ptr->mInfo.mRegisterAddressList)).boolValue ()
           && (mInfo.mSize._operator_isEqual (ptr->mInfo.mSize)).boolValue ()
           && (mInfo.mBitSliceTable._operator_isEqual (ptr->mInfo.mBitSliceTable)).boolValue ()
           && (mInfo.mBitDefinitionString._operator_isEqual (ptr->mInfo.mBitDefinitionString)).boolValue () ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mFirstAddress._operator_isEqual (ptr->mInfo.mFirstAddress)).boolValue ()
           && (mInfo.mFirstFreeAddress._operator_isEqual (ptr->mInfo.mFirstFreeAddress)).boolValue ()
           && (mInfo.mLastAddressPlusOne._operator_isEqual (ptr->mInfo.mLastAddressPlusOne)).boolValue ()
           && (mInfo.mMirrorOffsetList._operator_isEqual (ptr->mInfo.mMirrorOffsetList)).boolValue () ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mIllegalValue._operator_isEqual (ptr->mIllegalValue).boolValue ()
         && mIllegalMask._operator_isEqual (ptr->mIllegalMask).boolValue ()
         && mDescription._operator_isEqual (ptr->mDescription).boolValue () ;
  }
  return equal ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mValue._operator_isEqual (ptr->mInfo.mValue)).boolValue ()
           && (mInfo.mMask._operator_isEqual (ptr->mInfo.mMask)).boolValue () ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mMaskValue._operator_isEqual (ptr->mInfo.mMaskValue)).boolValue ()
           && (mInfo.mDescription._operator_isEqual (ptr->mInfo.mDescription)).boolValue ()
           && (mInfo.mFieldSettingMap._operator_isEqual (ptr->mInfo.mFieldSettingMap)).boolValue () ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mRegisterAddress._operator_isEqual (ptr->mInfo.mRegisterAddress)).boolValue ()
           && (mInfo.mRegisterWidth._operator_isEqual (ptr->mInfo.mRegisterWidth)).boolValue ()
           && (mInfo.mConfigRegisterMaskMap._operator_isEqual (ptr->mInfo.mConfigRegisterMaskMap)).boolValue ()
           && (mInfo.mIllegalMaskList._operator_isEqual (ptr->mInfo.mIllegalMaskList)).boolValue () ;
}
