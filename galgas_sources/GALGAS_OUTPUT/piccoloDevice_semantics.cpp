...
void cMapElement_registerTable::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
GALGAS_registerTable GALGAS_registerTable::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_registerTable result ;
...
GALGAS_registerTable_3A_element cEnumerator_registerTable::current (LOCATION_ARGS) const {
  const cMapElement_registerTable * p = (const cMapElement_registerTable *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_registerTable) ;
  return GALGAS_registerTable_3A_element (p->mAttribute_lkey, p->mAttribute_mRegisterAddressList, p->mAttribute_mSize, p->mAttribute_mBitSliceTable, p->mAttribute_mBitDefinitionString) ;
}
...
GALGAS_registerTable GALGAS_registerTable::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_registerTable *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "registerTable", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_ramBankTable::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
GALGAS_ramBankTable GALGAS_ramBankTable::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_ramBankTable result ;
  getOverridenMap (result) ;
  return result ;
}
...
GALGAS_ramBankTable_3A_element cEnumerator_ramBankTable::current (LOCATION_ARGS) const {
  const cMapElement_ramBankTable * p = (const cMapElement_ramBankTable *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_ramBankTable) ;
  return GALGAS_ramBankTable_3A_element (p->mAttribute_lkey, p->mAttribute_mFirstAddress, p->mAttribute_mFirstFreeAddress, p->mAttribute_mLastAddressPlusOne, p->mAttribute_mMirrorOffsetList) ;
}
...
GALGAS_ramBankTable GALGAS_ramBankTable::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ramBankTable *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "ramBankTable", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_processorType GALGAS_processorType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_processorType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "processorType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
class cCollectionElement_illegalMaskList : public cCollectionElement {
  public : GALGAS_illegalMaskList_3A_element mObject ;
...
void cCollectionElement_illegalMaskList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
void GALGAS_illegalMaskList::modifier_prependValue (GALGAS_luint inOperand0,
...
GALGAS_illegalMaskList_3A_element cEnumerator_illegalMaskList::current (LOCATION_ARGS) const {
...
GALGAS_illegalMaskList GALGAS_illegalMaskList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_illegalMaskList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "illegalMaskList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_fieldSettingMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mValue" ":" ;
...
GALGAS_fieldSettingMap GALGAS_fieldSettingMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_fieldSettingMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
GALGAS_fieldSettingMap_3A_element cEnumerator_fieldSettingMap::current (LOCATION_ARGS) const {
  const cMapElement_fieldSettingMap * p = (const cMapElement_fieldSettingMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_fieldSettingMap) ;
  return GALGAS_fieldSettingMap_3A_element (p->mAttribute_lkey, p->mAttribute_mValue, p->mAttribute_mMask) ;
}
...
GALGAS_fieldSettingMap GALGAS_fieldSettingMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_fieldSettingMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "fieldSettingMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_configRegisterMaskMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mMaskValue" ":" ;
...
GALGAS_configRegisterMaskMap GALGAS_configRegisterMaskMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_configRegisterMaskMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
GALGAS_configRegisterMaskMap_3A_element cEnumerator_configRegisterMaskMap::current (LOCATION_ARGS) const {
  const cMapElement_configRegisterMaskMap * p = (const cMapElement_configRegisterMaskMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_configRegisterMaskMap) ;
  return GALGAS_configRegisterMaskMap_3A_element (p->mAttribute_lkey, p->mAttribute_mMaskValue, p->mAttribute_mDescription, p->mAttribute_mFieldSettingMap) ;
}
...
GALGAS_configRegisterMaskMap GALGAS_configRegisterMaskMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_configRegisterMaskMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "configRegisterMaskMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_configRegisterMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
GALGAS_configRegisterMap GALGAS_configRegisterMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_configRegisterMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
GALGAS_configRegisterMap_3A_element cEnumerator_configRegisterMap::current (LOCATION_ARGS) const {
  const cMapElement_configRegisterMap * p = (const cMapElement_configRegisterMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_configRegisterMap) ;
  return GALGAS_configRegisterMap_3A_element (p->mAttribute_lkey, p->mAttribute_mRegisterAddress, p->mAttribute_mRegisterWidth, p->mAttribute_mConfigRegisterMaskMap, p->mAttribute_mIllegalMaskList) ;
}
...
GALGAS_configRegisterMap GALGAS_configRegisterMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_configRegisterMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "configRegisterMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
/* GALGAS_piccoloDeviceModel & GALGAS_piccoloDeviceModel::operator = (const GALGAS_piccoloDeviceModel & inOperand) {
  mAttribute_mDeviceName = inOperand.mAttribute_mDeviceName ;
  mAttribute_mProcessorType = inOperand.mAttribute_mProcessorType ;
  mAttribute_mRomSize = inOperand.mAttribute_mRomSize ;
  mAttribute_mBankCount = inOperand.mAttribute_mBankCount ;
  mAttribute_mRegisterTable = inOperand.mAttribute_mRegisterTable ;
  mAttribute_mRamBankTable = inOperand.mAttribute_mRamBankTable ;
  mAttribute_mEepromSize = inOperand.mAttribute_mEepromSize ;
  mAttribute_mEepromAddress = inOperand.mAttribute_mEepromAddress ;
  mAttribute_mConfigRegisterMap = inOperand.mAttribute_mConfigRegisterMap ;
  mAttribute_mSharedBankName = inOperand.mAttribute_mSharedBankName ;
  return *this ;
} */
...
GALGAS_piccoloDeviceModel GALGAS_piccoloDeviceModel::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_piccoloDeviceModel *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "piccoloDeviceModel", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_registerTable_3A_element::GALGAS_registerTable_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_registerTable_3A_element::GALGAS_registerTable_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_registerTable_3A_element & GALGAS_registerTable_3A_element::operator = (const GALGAS_registerTable_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mRegisterAddressList = inOperand.mAttribute_mRegisterAddressList ;
  mAttribute_mSize = inOperand.mAttribute_mSize ;
  mAttribute_mBitSliceTable = inOperand.mAttribute_mBitSliceTable ;
  mAttribute_mBitDefinitionString = inOperand.mAttribute_mBitDefinitionString ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_registerTable_3A_element GALGAS_registerTable_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_uintlist & inOperand1,
                                                                                  const GALGAS_uint & inOperand2,
                                                                                  const GALGAS_bitSliceTable & inOperand3,
                                                                                  const GALGAS_string & inOperand4 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_registerTable_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_registerTable_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_registerTable_3A_element::objectCompare (const GALGAS_registerTable_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_registerTable_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRegisterAddressList.isValid () && mAttribute_mSize.isValid () && mAttribute_mBitSliceTable.isValid () && mAttribute_mBitDefinitionString.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_registerTable_3A_element::drop (void) {
...
void GALGAS_registerTable_3A_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_registerTable_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uintlist GALGAS_registerTable_3A_element::reader_mRegisterAddressList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegisterAddressList ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_registerTable_3A_element::reader_mSize (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSize ;
}

//---------------------------------------------------------------------------*

GALGAS_bitSliceTable GALGAS_registerTable_3A_element::reader_mBitSliceTable (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBitSliceTable ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_registerTable_3A_element::reader_mBitDefinitionString (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_registerTable_3A_element ("registerTable:element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_registerTable_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_registerTable_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_registerTable_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_registerTable_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_registerTable_3A_element GALGAS_registerTable_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_registerTable_3A_element result ;
  const GALGAS_registerTable_3A_element * p = (const GALGAS_registerTable_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_registerTable_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "registerTable:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_ramBankTable_3A_element::GALGAS_ramBankTable_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_ramBankTable_3A_element::GALGAS_ramBankTable_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_ramBankTable_3A_element & GALGAS_ramBankTable_3A_element::operator = (const GALGAS_ramBankTable_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mFirstAddress = inOperand.mAttribute_mFirstAddress ;
  mAttribute_mFirstFreeAddress = inOperand.mAttribute_mFirstFreeAddress ;
  mAttribute_mLastAddressPlusOne = inOperand.mAttribute_mLastAddressPlusOne ;
  mAttribute_mMirrorOffsetList = inOperand.mAttribute_mMirrorOffsetList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_ramBankTable_3A_element GALGAS_ramBankTable_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                const GALGAS_uint & inOperand1,
                                                                                const GALGAS_uint & inOperand2,
                                                                                const GALGAS_uint & inOperand3,
                                                                                const GALGAS_uintlist & inOperand4 
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ramBankTable_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_ramBankTable_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_ramBankTable_3A_element::objectCompare (const GALGAS_ramBankTable_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_ramBankTable_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mFirstAddress.isValid () && mAttribute_mFirstFreeAddress.isValid () && mAttribute_mLastAddressPlusOne.isValid () && mAttribute_mMirrorOffsetList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_ramBankTable_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_ramBankTable_3A_element::description (C_String & ioString,
                                                  const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_ramBankTable_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_ramBankTable_3A_element::reader_mFirstAddress (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFirstAddress ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_ramBankTable_3A_element::reader_mFirstFreeAddress (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFirstFreeAddress ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_ramBankTable_3A_element::reader_mLastAddressPlusOne (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLastAddressPlusOne ;
}

//---------------------------------------------------------------------------*

GALGAS_uintlist GALGAS_ramBankTable_3A_element::reader_mMirrorOffsetList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_ramBankTable_3A_element ("ramBankTable:element",
                                                NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_ramBankTable_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_ramBankTable_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_ramBankTable_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_ramBankTable_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_ramBankTable_3A_element GALGAS_ramBankTable_3A_element::extractObject (const GALGAS_object & inObject,
                                                                              C_Compiler * inCompiler,
                                                                              const GALGAS_location & inErrorLocation
                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_ramBankTable_3A_element result ;
  const GALGAS_ramBankTable_3A_element * p = (const GALGAS_ramBankTable_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_ramBankTable_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "ramBankTable:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_illegalMaskList_3A_element::GALGAS_illegalMaskList_3A_element (void) :
...
GALGAS_illegalMaskList_3A_element::GALGAS_illegalMaskList_3A_element (const GALGAS_luint & inOperand0,
                                                                      const GALGAS_luint & inOperand1,
                                                                      const GALGAS_lstring & inOperand2) :
...
/* GALGAS_illegalMaskList_3A_element & GALGAS_illegalMaskList_3A_element::operator = (const GALGAS_illegalMaskList_3A_element & inOperand) {
  mAttribute_mIllegalValue = inOperand.mAttribute_mIllegalValue ;
  mAttribute_mIllegalMask = inOperand.mAttribute_mIllegalMask ;
  mAttribute_mDescription = inOperand.mAttribute_mDescription ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_illegalMaskList_3A_element GALGAS_illegalMaskList_3A_element::constructor_new (const GALGAS_luint & inOperand0,
                                                                                      const GALGAS_luint & inOperand1,
                                                                                      const GALGAS_lstring & inOperand2 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_illegalMaskList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_illegalMaskList_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_illegalMaskList_3A_element::objectCompare (const GALGAS_illegalMaskList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_illegalMaskList_3A_element::isValid (void) const {
  return mAttribute_mIllegalValue.isValid () && mAttribute_mIllegalMask.isValid () && mAttribute_mDescription.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_illegalMaskList_3A_element::drop (void) {
...
void GALGAS_illegalMaskList_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_luint GALGAS_illegalMaskList_3A_element::reader_mIllegalValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIllegalValue ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_illegalMaskList_3A_element::reader_mIllegalMask (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIllegalMask ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_illegalMaskList_3A_element::reader_mDescription (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_illegalMaskList_3A_element ("illegalMaskList:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_illegalMaskList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_illegalMaskList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_illegalMaskList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_illegalMaskList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_illegalMaskList_3A_element GALGAS_illegalMaskList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_illegalMaskList_3A_element result ;
  const GALGAS_illegalMaskList_3A_element * p = (const GALGAS_illegalMaskList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_illegalMaskList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "illegalMaskList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_fieldSettingMap_3A_element::GALGAS_fieldSettingMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mValue (),
mAttribute_mMask () {
}
...
GALGAS_fieldSettingMap_3A_element::GALGAS_fieldSettingMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                      const GALGAS_uint & inOperand1,
                                                                      const GALGAS_uint & inOperand2) :
mAttribute_lkey (inOperand0),
...
/* GALGAS_fieldSettingMap_3A_element & GALGAS_fieldSettingMap_3A_element::operator = (const GALGAS_fieldSettingMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mValue = inOperand.mAttribute_mValue ;
  mAttribute_mMask = inOperand.mAttribute_mMask ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_fieldSettingMap_3A_element GALGAS_fieldSettingMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                      const GALGAS_uint & inOperand1,
                                                                                      const GALGAS_uint & inOperand2 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_fieldSettingMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_fieldSettingMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_fieldSettingMap_3A_element::objectCompare (const GALGAS_fieldSettingMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_fieldSettingMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mValue.isValid () && mAttribute_mMask.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_fieldSettingMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_fieldSettingMap_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_fieldSettingMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_fieldSettingMap_3A_element::reader_mValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mValue ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_fieldSettingMap_3A_element::reader_mMask (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_fieldSettingMap_3A_element ("fieldSettingMap:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_fieldSettingMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_fieldSettingMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_fieldSettingMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_fieldSettingMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_fieldSettingMap_3A_element GALGAS_fieldSettingMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_fieldSettingMap_3A_element result ;
  const GALGAS_fieldSettingMap_3A_element * p = (const GALGAS_fieldSettingMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_fieldSettingMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "fieldSettingMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_configRegisterMaskMap_3A_element::GALGAS_configRegisterMaskMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_configRegisterMaskMap_3A_element::GALGAS_configRegisterMaskMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_luint & inOperand1,
                                                                                  const GALGAS_lstring & inOperand2,
...
/* GALGAS_configRegisterMaskMap_3A_element & GALGAS_configRegisterMaskMap_3A_element::operator = (const GALGAS_configRegisterMaskMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mMaskValue = inOperand.mAttribute_mMaskValue ;
  mAttribute_mDescription = inOperand.mAttribute_mDescription ;
  mAttribute_mFieldSettingMap = inOperand.mAttribute_mFieldSettingMap ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_configRegisterMaskMap_3A_element GALGAS_configRegisterMaskMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                  const GALGAS_luint & inOperand1,
                                                                                                  const GALGAS_lstring & inOperand2,
                                                                                                  const GALGAS_fieldSettingMap & inOperand3 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_configRegisterMaskMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_configRegisterMaskMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_configRegisterMaskMap_3A_element::objectCompare (const GALGAS_configRegisterMaskMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_configRegisterMaskMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mMaskValue.isValid () && mAttribute_mDescription.isValid () && mAttribute_mFieldSettingMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_configRegisterMaskMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_configRegisterMaskMap_3A_element::description (C_String & ioString,
                                                           const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_configRegisterMaskMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_configRegisterMaskMap_3A_element::reader_mMaskValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mMaskValue ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_configRegisterMaskMap_3A_element::reader_mDescription (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDescription ;
}

//---------------------------------------------------------------------------*

GALGAS_fieldSettingMap GALGAS_configRegisterMaskMap_3A_element::reader_mFieldSettingMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_configRegisterMaskMap_3A_element ("configRegisterMaskMap:element",
                                                         NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_configRegisterMaskMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_configRegisterMaskMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_configRegisterMaskMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_configRegisterMaskMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_configRegisterMaskMap_3A_element GALGAS_configRegisterMaskMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler,
                                                                                                const GALGAS_location & inErrorLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_configRegisterMaskMap_3A_element result ;
  const GALGAS_configRegisterMaskMap_3A_element * p = (const GALGAS_configRegisterMaskMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_configRegisterMaskMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "configRegisterMaskMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_configRegisterMap_3A_element::GALGAS_configRegisterMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_configRegisterMap_3A_element::GALGAS_configRegisterMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_luint & inOperand1,
                                                                          const GALGAS_luint & inOperand2,
...
/* GALGAS_configRegisterMap_3A_element & GALGAS_configRegisterMap_3A_element::operator = (const GALGAS_configRegisterMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mRegisterAddress = inOperand.mAttribute_mRegisterAddress ;
  mAttribute_mRegisterWidth = inOperand.mAttribute_mRegisterWidth ;
  mAttribute_mConfigRegisterMaskMap = inOperand.mAttribute_mConfigRegisterMaskMap ;
  mAttribute_mIllegalMaskList = inOperand.mAttribute_mIllegalMaskList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_configRegisterMap_3A_element GALGAS_configRegisterMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_luint & inOperand1,
                                                                                          const GALGAS_luint & inOperand2,
                                                                                          const GALGAS_configRegisterMaskMap & inOperand3,
                                                                                          const GALGAS_illegalMaskList & inOperand4 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_configRegisterMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_configRegisterMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_configRegisterMap_3A_element::objectCompare (const GALGAS_configRegisterMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_configRegisterMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRegisterAddress.isValid () && mAttribute_mRegisterWidth.isValid () && mAttribute_mConfigRegisterMaskMap.isValid () && mAttribute_mIllegalMaskList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_configRegisterMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_configRegisterMap_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_configRegisterMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_configRegisterMap_3A_element::reader_mRegisterAddress (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegisterAddress ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_configRegisterMap_3A_element::reader_mRegisterWidth (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegisterWidth ;
}

//---------------------------------------------------------------------------*

GALGAS_configRegisterMaskMap GALGAS_configRegisterMap_3A_element::reader_mConfigRegisterMaskMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mConfigRegisterMaskMap ;
}

//---------------------------------------------------------------------------*

GALGAS_illegalMaskList GALGAS_configRegisterMap_3A_element::reader_mIllegalMaskList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_configRegisterMap_3A_element ("configRegisterMap:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_configRegisterMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_configRegisterMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_configRegisterMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_configRegisterMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_configRegisterMap_3A_element GALGAS_configRegisterMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_configRegisterMap_3A_element result ;
  const GALGAS_configRegisterMap_3A_element * p = (const GALGAS_configRegisterMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_configRegisterMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "configRegisterMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
