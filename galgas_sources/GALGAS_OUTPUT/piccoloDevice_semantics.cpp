...
cCollectionElement_illegalMaskList * GALGAS_illegalMaskList::makeElement (const GALGAS_luint & in_mIllegalValue,
                                                                          const GALGAS_luint & in_mIllegalMask,
                                                                          const GALGAS_lstring & in_mDescription
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_illegalMaskList * result = NULL ;
  macroMyNew (result, cCollectionElement_illegalMaskList (in_mIllegalValue,
                                                                          in_mIllegalMask,
