...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_registerTable ("registerTable", false, NULL) ;
...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mRegisterAddressList.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mSize.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mBitSliceTable.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mBitDefinitionString.reader_description (inIndentation + 1) ;
}
...
GGS_object GGS_registerTable::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_registerTable * p = NULL ;
    macroMyNew (p, GGS_registerTable (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_registerTable GGS_registerTable::castFromObject (C_Compiler & inLexique,
  ...
  if (NULL != embeddedObject) {
    const GGS_registerTable * p = dynamic_cast <const GGS_registerTable *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_registerTable, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_registerTable::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_registerTable ;
}

//---------------------------------------------------------------------------*

GGS_registerTable GGS_registerTable::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uintlist & inValue0,
                                             const GGS_uint & inValue1,
                                             const GGS_bitSliceTable & inValue2,
                                             const GGS_string& inValue3
                                             COMMA_LOCATION_ARGS) {
  GGS_registerTable result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_ramBankTable ("ramBankTable", false, NULL) ;
...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mFirstAddress.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mFirstFreeAddress.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mLastAddressPlusOne.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mMirrorOffsetList.reader_description (inIndentation + 1) ;
}
...
GGS_object GGS_ramBankTable::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_ramBankTable * p = NULL ;
    macroMyNew (p, GGS_ramBankTable (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_ramBankTable GGS_ramBankTable::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_ramBankTable result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_ramBankTable * p = dynamic_cast <const GGS_ramBankTable *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_ramBankTable, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_ramBankTable::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_ramBankTable ;
}

//---------------------------------------------------------------------------*

GGS_ramBankTable GGS_ramBankTable::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0,
                                             const GGS_uint & inValue1,
                                             const GGS_uint & inValue2,
                                             const GGS_uintlist & inValue3
                                             COMMA_LOCATION_ARGS) {
  GGS_ramBankTable result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_processorType ("processorType", false, NULL) ;
...
GGS_object GGS_processorType::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_processorType * p = NULL ;
    macroMyNew (p, GGS_processorType (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_processorType GGS_processorType::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_processorType * p = dynamic_cast <const GGS_processorType *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_processorType, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_processorType::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_processorType ;
}
...
appendForDescription (C_String & ioString,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mIllegalValue.reader_description (inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mIllegalMask.reader_description (inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mDescription.reader_description (inIndentation) ;
}
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_illegalMaskList ("illegalMaskList", false, NULL) ;
...
insulateList (void) {
  if (isShared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      internalAppendValues (ptr->mIllegalValue,
                                ptr->mIllegalMask,
                                ptr->mDescription
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
...
internalSubListWithRange (GGS_illegalMaskList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (PMSInt32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList.addAssign_operation (ptr->mIllegalValue, ptr->mIllegalMask, ptr->mDescription) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
reader_description (const PMSInt32 inIndentation) const {
  return performDescription ("@illegalMaskList", inIndentation) ;
}
...
GGS_object GGS_illegalMaskList::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_illegalMaskList * p = NULL ;
    macroMyNew (p, GGS_illegalMaskList (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_illegalMaskList GGS_illegalMaskList::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_illegalMaskList result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_illegalMaskList * p = dynamic_cast <const GGS_illegalMaskList *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_illegalMaskList, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_illegalMaskList::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_illegalMaskList ;
}
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_fieldSettingMap ("fieldSettingMap", false, NULL) ;
...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mMask.reader_description (inIndentation + 1) ;
}
...
GGS_object GGS_fieldSettingMap::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_fieldSettingMap * p = NULL ;
    macroMyNew (p, GGS_fieldSettingMap (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_fieldSettingMap GGS_fieldSettingMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_fieldSettingMap result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_fieldSettingMap * p = dynamic_cast <const GGS_fieldSettingMap *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_fieldSettingMap, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_fieldSettingMap::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_fieldSettingMap ;
}

//---------------------------------------------------------------------------*

GGS_fieldSettingMap GGS_fieldSettingMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0,
                                             const GGS_uint & inValue1
                                             COMMA_LOCATION_ARGS) {
  GGS_fieldSettingMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_configRegisterMaskMap ("configRegisterMaskMap", false, NULL) ;
...
GGS_object GGS_configRegisterMaskMap::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_configRegisterMaskMap * p = NULL ;
    macroMyNew (p, GGS_configRegisterMaskMap (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_configRegisterMaskMap GGS_configRegisterMaskMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_configRegisterMaskMap result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_configRegisterMaskMap * p = dynamic_cast <const GGS_configRegisterMaskMap *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_configRegisterMaskMap, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_configRegisterMaskMap::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_configRegisterMaskMap ;
}

//---------------------------------------------------------------------------*

GGS_configRegisterMaskMap GGS_configRegisterMaskMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_luint & inValue0,
                                             const GGS_lstring & inValue1,
                                             const GGS_fieldSettingMap & inValue2
                                             COMMA_LOCATION_ARGS) {
  GGS_configRegisterMaskMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_configRegisterMap ("configRegisterMap", false, NULL) ;
...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mRegisterWidth.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mConfigRegisterMaskMap.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mIllegalMaskList.reader_description (inIndentation + 1) ;
}
...
GGS_object GGS_configRegisterMap::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_configRegisterMap * p = NULL ;
    macroMyNew (p, GGS_configRegisterMap (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_configRegisterMap GGS_configRegisterMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_configRegisterMap result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_configRegisterMap * p = dynamic_cast <const GGS_configRegisterMap *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_configRegisterMap, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_configRegisterMap::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_configRegisterMap ;
}

//---------------------------------------------------------------------------*

GGS_configRegisterMap GGS_configRegisterMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_luint & inValue0,
                                             const GGS_luint & inValue1,
                                             const GGS_configRegisterMaskMap & inValue2,
                                             const GGS_illegalMaskList & inValue3
                                             COMMA_LOCATION_ARGS) {
  GGS_configRegisterMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_piccoloDeviceModel ("piccoloDeviceModel", false, NULL) ;
...
reader_description (const PMSInt32 inIndentation) const {
  ...
  if (isBuilt ()) {
    ...
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mProcessorType " ;
    _s << mProcessorType.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mRomSize " ;
    _s << mRomSize.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mBankCount " ;
    _s << mBankCount.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mRegisterTable " ;
    _s << mRegisterTable.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mRamBankTable " ;
    _s << mRamBankTable.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mEepromSize " ;
    _s << mEepromSize.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mEepromAddress " ;
    _s << mEepromAddress.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mConfigRegisterMap " ;
    _s << mConfigRegisterMap.reader_description (inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mSharedBankName " ;
    _s << mSharedBankName.reader_description (inIndentation + 1) ;
  }else{
    _s << "not built" ;
  }
  _s << "\n" ;
...
GGS_object GGS_piccoloDeviceModel::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_piccoloDeviceModel * p = NULL ;
    macroMyNew (p, GGS_piccoloDeviceModel (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_piccoloDeviceModel GGS_piccoloDeviceModel::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_piccoloDeviceModel result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_piccoloDeviceModel * p = dynamic_cast <const GGS_piccoloDeviceModel *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_piccoloDeviceModel, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_piccoloDeviceModel::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_piccoloDeviceModel ;
}
