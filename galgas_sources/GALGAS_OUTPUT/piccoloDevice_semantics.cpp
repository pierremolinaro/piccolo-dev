...
//---------------------------------------------------------------------------*
//                                                                           *
//                   Element of list '@fieldSettingList'                     *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_fieldSettingList::
elementOf_GGS_fieldSettingList (const GGS_uint & argument_0,
...
bool elementOf_GGS_fieldSettingList::
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_fieldSettingList * _p = dynamic_cast <const elementOf_GGS_fieldSettingList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mValue._operator_isEqual (_p->mValue).boolValue ()
         && mMask._operator_isEqual (_p->mMask).boolValue ()
         && mDescription._operator_isEqual (_p->mDescription).boolValue () ;
  }
  return equal ;
}
...
void elementOf_GGS_fieldSettingList::
appendForDescription (C_Compiler & _inLexique,
                          C_String & ioString,
                          const sint32 inIndentation
                          COMMA_LOCATION_ARGS) const {
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mMask.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mDescription.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
...
GGS_fieldSettingList GGS_fieldSettingList::
_operator_concat (const GGS_fieldSettingList & inOperand) const {
  GGS_fieldSettingList result = * this ;
  result._dotAssign_operation (inOperand) ;
  return result ;
}
...
void GGS_fieldSettingList::
_dotAssign_operation (const GGS_fieldSettingList inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
      if (inOperand.count () > 0) {
        _insulateList () ;
        elementOf_GGS_fieldSettingList * p = inOperand.firstObject () ;
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_uint  p_0 = p->mValue ;
          GGS_uint  p_1 = p->mMask ;
          GGS_string p_2 = p->mDescription ;
          _internalAppendValues (p_0, p_1, p_2 COMMA_HERE) ;
          p = p->nextObject () ;
        }
      }
...
void GGS_fieldSettingList::
internalSubListWithRange (GGS_fieldSettingList & ioList,
                          const sint32 inFirstIndex,
                          const sint32 inCount) const {
  ioList._alloc () ;
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mValue, _p->mMask, _p->mDescription) ;
      _p = _p->nextObject () ;
    }
  }
}
...
GGS_string GGS_fieldSettingList::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@fieldSettingList", inIndentation COMMA_THERE) ;
}
...
GGS_uint  GGS_fieldSettingList::
reader_mMaskAtIndex (C_Compiler & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const {
  GGS_uint  result ;
  if (_isBuilt () && inIndex._isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
    if (object != NULL) {
...
void GGS_fieldSettingList::
modifier_setMMaskAtIndex (C_Compiler & inLexique,
                              const GGS_uint  & inObject,
                              const GGS_uint & inIndex
                              COMMA_LOCATION_ARGS) const {
  if (_isBuilt () && inIndex._isBuilt ()) {
...
/* const */ GGS_uint  & GGS_fieldSettingList::cEnumerator::_mValue (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
/* const */ GGS_uint  & GGS_fieldSettingList::cEnumerator::_mMask (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mMask ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_string & GGS_fieldSettingList::cEnumerator::_mDescription (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mDescription ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mFieldSettingList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mMaskValue._operator_isEqual (_p->mInfo.mMaskValue)).boolValue ()
           ...
           && (mInfo.mFieldSettingList._operator_isEqual (_p->mInfo.mFieldSettingList)).boolValue () ;
}
...
_insertElement (C_Compiler & inLexique,
                ...
                const GGS_fieldSettingList & inParameter2,
                GGS_luint * outIndex
                COMMA_LOCATION_ARGS) {
  sint32 elementID = - 1 ;
  if (_isBuilt ()
   ...
   && inKey._isBuilt ()) {
    ...
    info.mFieldSettingList = inParameter2 ;
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mSharedMapRoot->_mRoot, elementID, existingKeyLocation) ;
    if (elementID < 0) {
      emitInsertMapSemanticErrorMessage (inLexique, inKey, inErrorMessage, existingKeyLocation COMMA_THERE) ;
...
_searchElement (C_Compiler & inLexique,
               ...
               GGS_fieldSettingList   & outParameter2,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) const {
  cElement * node = NULL  ;
  if (_isBuilt () && inKey._isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter2 = node->mInfo.mFieldSettingList ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mID), inKey) ;
    }
  }
...
void GGS_configRegisterMaskMap::
modifier_setMFieldSettingListForKey (C_Compiler & inLexique,
                        const GGS_fieldSettingList & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMFieldSettingListForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mFieldSettingList = inValue ;
    }
  }
}
...
method_searchKey (C_Compiler & inLexique,
                                ...
                                GGS_luint   & outParameter0,
                                GGS_lstring   & outParameter1,
                                GGS_fieldSettingList   & outParameter2 COMMA_LOCATION_ARGS) const {
  _searchElement (inLexique,
...
modifier_insertKey (C_Compiler & _inLexique,
                                ...
                                const GGS_luint & inParameter0,
                                const GGS_lstring & inParameter1,
                                const GGS_fieldSettingList & inParameter2 COMMA_LOCATION_ARGS) {
  _insertElement (_inLexique,
...
/* const */ GGS_fieldSettingList  & GGS_configRegisterMaskMap::cEnumerator::_mFieldSettingList (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mFieldSettingList ;
}
