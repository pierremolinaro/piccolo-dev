...
class elementOf_GGS_fieldSettingList ;

class GGS_fieldSettingList : public AC_galgas_list {
  public : typedef elementOf_GGS_fieldSettingList cElement ;

//--- Constructor 'emptyList'
  public : static GGS_fieldSettingList constructor_emptyList (void) ;
  public : static GGS_fieldSettingList constructor_listWithValue (const GGS_uint & argument_0,
...
//--- Operator () used for method call
  public : const GGS_fieldSettingList * operator () (UNUSED_LOCATION_ARGS) const { return this ;} 
//--- Method 'first'
  public : void method_first (C_Compiler & _inLexique,
                              GGS_uint & _out_0,
                              GGS_uint & _out_1,
...
//--- Modifier 'popFirst'
  public : void modifier_popFirst (C_Compiler & _inLexique,
                                 ...
                                 COMMA_LOCATION_ARGS) ;
//--- Handle '.=' operator
  public : void _dotAssign_operation (const GGS_fieldSettingList inOperand) ;
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_uint & argument_0,
                                ...
                                const GGS_string& argument_2) ;
//--- Handling '.' GALGAS operator
  public : GGS_fieldSettingList _operator_concat (const GGS_fieldSettingList & inOperand) const ;
  public : void modifier_prependValue (C_Compiler & _inLexique,
...
//--------------------------------- List Enumerator
  public : class cEnumerator : public cAbstractListEnumerator {
  //--- Constructor
    public : inline cEnumerator (const GGS_fieldSettingList & inList,
                                 const bool inAscending) :
    cAbstractListEnumerator (inList, inAscending) {
    }
  //--- Iterator method
  ...
  public : /* const */ GGS_string  & _mDescription (LOCATION_ARGS) const ;
  } ;
...
//--- Modifiers "set'Value'ForKey"
  ...
  public : void modifier_setMDescriptionForKey (C_Compiler & inLexique,
                        ...
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) ;
  public : void modifier_setMFieldSettingListForKey (C_Compiler & inLexique,
...
//--------------------------------- Map Enumerator
  ...
  //--- Iterator method
    ...
    public : /* const */ GGS_lstring   & _mDescription (LOCATION_ARGS) const ;
    public : /* const */ GGS_fieldSettingList   & _mFieldSettingList (LOCATION_ARGS) const ;
  } ;
} ;
...
class elementOf_GGS_fieldSettingList : public AC_galgas_list::cListElement {
//--- Attributes
  public : GGS_uint  mValue ;
  public : GGS_uint  mMask ;
  public : GGS_string mDescription ;
//--- Constructor
  public : elementOf_GGS_fieldSettingList (const GGS_uint & ,
                                const GGS_uint & ,
                                const GGS_string& 
                                COMMA_LOCATION_ARGS) ;

//--- Access to next
  public : inline elementOf_GGS_fieldSettingList * nextObject (void) const { return (elementOf_GGS_fieldSettingList *) internalNextItem () ; }

//--- Access to previous
  public : inline elementOf_GGS_fieldSettingList * previousObject (void) const { return (elementOf_GGS_fieldSettingList *) internalPreviousItem () ; }
...
//--- Friend class declaration
  friend class GGS_fieldSettingList ;
} ;
...
class e_configRegisterMaskMap {
  ...
  public : GGS_lstring  mDescription ;
  public : GGS_fieldSettingList  mFieldSettingList ;
