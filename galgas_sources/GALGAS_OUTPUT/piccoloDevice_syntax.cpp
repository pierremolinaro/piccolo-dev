    ...
    while (syntaxRepeat_10) {
      switch (select_repeat_piccoloDevice_syntax_10 (_inLexique)) {
        case 2 : {
            ...
            while (syntaxRepeat_12) {
              switch (select_repeat_piccoloDevice_syntax_12 (_inLexique)) {
                case 2 : {
                  ...
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_string) COMMA_HERE) ;
                  GGS_fieldSettingList  var_cas_fieldSettingList ;
                  var_cas_fieldSettingList = GGS_fieldSettingList ::constructor_emptyList () ;
                  { bool syntaxRepeat_13 = true ;
                    while (syntaxRepeat_13) {
                        ...
                        _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_string) COMMA_HERE) ;
                        var_cas_fieldSettingList._addAssign_operation (var_cas_value.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (170)), var_cas_mask.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (170)), var_cas_descriptionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (170))) ;
                  ...
                  var_cas_configRegisterMaskMap.modifier_insertKey (_inLexique, var_cas_maskName, var_cas_maskValue, var_cas_maskDescriptionString, var_cas_fieldSettingList COMMA_SOURCE_FILE_AT_LINE (173)) ;
                  } break ;
                default :
          ...
          var_cas_configRegisterMap.modifier_insertKey (_inLexique, var_cas_configRegisterName, var_cas_configRegisterAddress, var_cas_configRegisterWidth, var_cas_configRegisterMaskMap, var_cas_illegalMaskList COMMA_SOURCE_FILE_AT_LINE (176)) ;
          } break ;
        default :
