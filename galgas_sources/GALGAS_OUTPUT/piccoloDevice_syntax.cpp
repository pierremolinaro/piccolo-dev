...
pr_start_symbol_piccoloDevice_syntax_13_4_ (piccoloDevice_lexique & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__7D) COMMA_HERE) ;
  var_cas_outPiccoloDeviceModel = GGS_piccoloDeviceModel::constructor_new (var_cas_deviceName, var_cas_processorType, var_cas_romSize, var_cas_bankCount, var_cas_registerTable, var_cas_ramBankTable, var_cas_eepromSize, var_cas_eepromAddress) ;
}
