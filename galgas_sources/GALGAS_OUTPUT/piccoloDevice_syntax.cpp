    ...
    while (syntaxRepeat_3) {
      switch (select_repeat_piccoloDevice_syntax_3 (_inLexique)) {
        case 2 : {
          ...
          var_cas_registerTable.modifier_insertKey (_inLexique, var_cas_registerName, var_cas_registerAddressList, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (70)) ;
