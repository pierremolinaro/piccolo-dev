...
pr_start_symbol_piccoloDevice_syntax_13_4_ (piccoloDevice_lexique & _inLexique,
      ...
      switch (select_repeat_piccoloDevice_syntax_4 (_inLexique)) {
        case 2 : {
            ...
            while (syntaxRepeat_6) {
                switch (select_piccoloDevice_syntax_7 (_inLexique)) {
                  case 1 : {
                          ...
                          switch (select_piccoloDevice_syntax_9 (_inLexique)) {
                            case 1 : {
                              if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 1U)))).isBuiltAndTrue ()) {
                                var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (101)) ;
                              }
                            ...
                            case 2 : {
                              ...
                              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_integer) COMMA_HERE) ;
                              if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (107))))).isBuiltAndTrue ()) {
                                var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (108))))._operator_concat (GGS_string (true, " bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (108)) ;
                              }
                              var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
                              var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (111))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)) ;
                              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__5D) COMMA_HERE) ;
                              } break ;
                            default :
                              break ;
                          }
                          var_cas_bitSliceTable.modifier_insertKey (_inLexique, var_cas_sliceName, var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (114)), var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (114)) ;
                    ...
                    var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (118)) ;
                    } break ;
                  case 2 : {
                    _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__2D) COMMA_HERE) ;
                    var_cas_sliceIndex._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (121)) ;
                    } break ;
                  default :
                    break ;
                }
          ...
          if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_registerName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "Incorrect bit definition for register '"))._operator_concat (var_cas_registerName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__3E) COMMA_HERE) ;
          var_cas_registerTable.modifier_insertKey (_inLexique, var_cas_registerName, var_cas_registerAddressList, GGS_uint (true, 1U), var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (130)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__3B) COMMA_HERE) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_10) {
      switch (select_repeat_piccoloDevice_syntax_10 (_inLexique)) {
        case 2 : {
            ...
            while (syntaxRepeat_12) {
              switch (select_repeat_piccoloDevice_syntax_12 (_inLexique)) {
                case 2 : {
                  ...
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_identifier) COMMA_HERE) ;
                  if ((var_cas_settingNameSet.reader_hasKey (_inLexique, var_cas_maskName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159))).isBuiltAndTrue ()) {
                    var_cas_maskName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The '"))._operator_concat (var_cas_maskName))._operator_concat (GGS_string (true, "' setting is already defined")) COMMA_SOURCE_FILE_AT_LINE (160)) ;
                  }
                  var_cas_settingNameSet._addAssign_operation (var_cas_maskName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (162))) ;
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_mask) COMMA_HERE) ;
                  ...
                  { bool syntaxRepeat_13 = true ;
                    while (syntaxRepeat_13) {
                        ...
                        _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_string) COMMA_HERE) ;
                        var_cas_fieldSettingMap.modifier_insertKey (_inLexique, var_cas_descriptionString, var_cas_value.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)), var_cas_mask.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)) COMMA_SOURCE_FILE_AT_LINE (175)) ;
                  ...
                  var_cas_configRegisterMaskMap.modifier_insertKey (_inLexique, var_cas_maskName, var_cas_maskValue, var_cas_maskDescriptionString, var_cas_fieldSettingMap COMMA_SOURCE_FILE_AT_LINE (178)) ;
                  } break ;
                default :
          ...
          var_cas_configRegisterMap.modifier_insertKey (_inLexique, var_cas_configRegisterName, var_cas_configRegisterAddress, var_cas_configRegisterWidth, var_cas_configRegisterMaskMap, var_cas_illegalMaskList COMMA_SOURCE_FILE_AT_LINE (181)) ;
          } break ;
        default :
  ...
  const GGS_registerTable  _temp_5468 = var_cas_registerTable ;
  if (_temp_5468._isBuilt ()) {
    _temp_5468 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "BSR"), GGS_location (_inLexique) COMMA_HERE), automatic_var_0, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (191)) ;
  }
  GGS_uintlist  automatic_var_3 ;
  GGS_uint  automatic_var_4 ;
  GGS_bitSliceTable  automatic_var_5 ;
  const GGS_registerTable  _temp_5536 = var_cas_registerTable ;
  if (_temp_5536._isBuilt ()) {
    _temp_5536 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "TOSL"), GGS_location (_inLexique) COMMA_HERE), automatic_var_3, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (192)) ;
  }
  GGS_uintlist  automatic_var_6 ;
  GGS_uint  automatic_var_7 ;
  GGS_bitSliceTable  automatic_var_8 ;
  const GGS_registerTable  _temp_5605 = var_cas_registerTable ;
  if (_temp_5605._isBuilt ()) {
    _temp_5605 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "TOSH"), GGS_location (_inLexique) COMMA_HERE), automatic_var_6, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (193)) ;
  }
  GGS_uintlist  automatic_var_9 ;
  GGS_uint  automatic_var_10 ;
  GGS_bitSliceTable  automatic_var_11 ;
  const GGS_registerTable  _temp_5674 = var_cas_registerTable ;
  if (_temp_5674._isBuilt ()) {
    _temp_5674 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "TOSU"), GGS_location (_inLexique) COMMA_HERE), automatic_var_9, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (194)) ;
  }
