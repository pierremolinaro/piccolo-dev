...
pr_start_symbol_piccoloDevice_syntax_13_4_ (piccoloDevice_lexique & _inLexique,
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_4 = true ;
            while (syntaxRepeat_4) {
                ...
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_integer) COMMA_HERE) ;
                var_cas_registerAddressList._addAssign_operation (var_cas_registerAddress.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (66))) ;
            ...
            while (syntaxRepeat_5) {
                switch (select_piccoloDevice_syntax_6 (_inLexique)) {
                  case 1 : {
                          ...
                          switch (select_piccoloDevice_syntax_8 (_inLexique)) {
                            case 1 : {
                              if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 1U)))).isBuiltAndTrue ()) {
                                var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (81)) ;
                              }
                            ...
                            case 2 : {
                              ...
                              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_integer) COMMA_HERE) ;
                              if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (87))))).isBuiltAndTrue ()) {
                                var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (88))))._operator_concat (GGS_string (true, " bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
                              }
                              var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
                              var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (91))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) ;
                              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__5D) COMMA_HERE) ;
                              } break ;
                            default :
                              break ;
                          }
                          var_cas_bitSliceTable.modifier_insertKey (_inLexique, var_cas_sliceName, var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (94)), var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (94)) ;
                    ...
                    var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (98)) ;
                    } break ;
                  case 2 : {
                    _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__2D) COMMA_HERE) ;
                    var_cas_sliceIndex._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
                    } break ;
                  default :
                    break ;
                }
          ...
          if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_registerName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "Incorrect bit definition for register '"))._operator_concat (var_cas_registerName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__3E) COMMA_HERE) ;
          var_cas_registerTable.modifier_insertKey (_inLexique, var_cas_registerName, var_cas_registerAddressList, GGS_uint (true, 1U), var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (110)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__3B) COMMA_HERE) ;
          } break ;
        default :
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__7D) COMMA_HERE) ;
  var_cas_outPiccoloDeviceModel = GGS_piccoloDeviceModel::constructor_new (var_cas_romSize, var_cas_bankCount, var_cas_registerTable) ;
}
