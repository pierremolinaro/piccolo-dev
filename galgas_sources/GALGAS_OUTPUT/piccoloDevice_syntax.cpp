...
pr_start_symbol_piccoloDevice_syntax_14_19_ (piccoloDevice_lexique & inLexique,
            ...
            while (syntaxRepeat_14) {
              switch (select_piccoloDevice_syntax_14 (inLexique)) {
                case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_identifier) COMMA_HERE) ;
                  const GGS_bool cond_5525 = var_cas_settingNameSet.reader_hasKey (inLexique, var_cas_maskName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) COMMA_SOURCE_FILE_AT_LINE (184)) ;
  ...
  if (cond_6795.isBuiltAndTrue ()) {
    ...
    if (temp_6555.isBuilt ()) {
      temp_6555 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("BSR"), GGS_location (inLexique) COMMA_HERE), automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (217)) ;
    }
    ...
    if (temp_6620.isBuilt ()) {
      temp_6620 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("TOSL"), GGS_location (inLexique) COMMA_HERE), automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (218)) ;
    }
    ...
    if (temp_6686.isBuilt ()) {
      temp_6686 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("TOSH"), GGS_location (inLexique) COMMA_HERE), automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (219)) ;
    }
    ...
    if (temp_6752.isBuilt ()) {
      temp_6752 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("TOSU"), GGS_location (inLexique) COMMA_HERE), automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (220)) ;
    }
  }
