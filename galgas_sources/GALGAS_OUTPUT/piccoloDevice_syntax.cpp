...
pr_start_symbol_piccoloDevice_syntax_13_19_ (piccoloDevice_lexique & inLexique,
  ...
  const GGS_bool cond_690 = (var_cas_processorName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (22))).operator_isEqual (GGS_string ("pic18_60")) ;
  if (cond_690.isBuiltAndTrue ()) {
    var_cas_processorType = GGS_processorType::constructor_pic18_60 (inLexique COMMA_HERE) ;
  }else if (cond_690.isBuiltAndFalse ()) {
    const GGS_bool cond_789 = (var_cas_processorName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24))).operator_isEqual (GGS_string ("pic18_80")) ;
    if (cond_789.isBuiltAndTrue ()) {
      var_cas_processorType = GGS_processorType::constructor_pic18_80 (inLexique COMMA_HERE) ;
    }else if (cond_789.isBuiltAndFalse ()) {
      const GGS_bool cond_889 = (var_cas_processorName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (26))).operator_isEqual (GGS_string ("mid-range")) ;
      if (cond_889.isBuiltAndTrue ()) {
        var_cas_processorType = GGS_processorType::constructor_midrange (inLexique COMMA_HERE) ;
      }else if (cond_889.isBuiltAndFalse ()) {
        const GGS_bool cond_987 = (var_cas_processorName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (28))).operator_isEqual (GGS_string ("baseline")) ;
        if (cond_987.isBuiltAndTrue ()) {
          var_cas_processorType = GGS_processorType::constructor_baseline (inLexique COMMA_HERE) ;
        }else if (cond_987.isBuiltAndFalse ()) {
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_5 = true ;
                while (syntaxRepeat_5) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_integer) COMMA_HERE) ;
                    var_cas_mirrorOffsetList.addAssign_operation (var_cas_mirrorStartAddress.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (80)).substract_operation (inLexique, var_cas_ramStart.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (80)) COMMA_SOURCE_FILE_AT_LINE (80))) ;
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_7 = true ;
            while (syntaxRepeat_7) {
                ...
                inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_integer) COMMA_HERE) ;
                var_cas_registerAddressList.addAssign_operation (var_cas_registerAddress.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (103))) ;
                    ...
                    { bool syntaxRepeat_10 = true ;
                      while (syntaxRepeat_10) {
                          ...
                          switch (select_piccoloDevice_syntax_11 (inLexique)) {
                            case 1 : {
                              const GGS_bool cond_3227 = ((var_cas_sliceWidth).operator_isNotEqual (GGS_uint (0U))).operator_and ((var_cas_sliceWidth).operator_isNotEqual (GGS_uint (1U))) ;
                              if (cond_3227.isBuiltAndTrue ()) {
                            ...
                            case 2 : {
                              ...
                              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_integer) COMMA_HERE) ;
                              const GGS_bool cond_3597 = ((var_cas_sliceWidth).operator_isNotEqual (GGS_uint (0U))).operator_and ((var_cas_sliceWidth).operator_isNotEqual (var_cas_sliceSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (126)))) ;
                              if (cond_3597.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_4374 = (var_cas_sliceIndex).operator_isNotEqual (GGS_uint (0U)) ;
          if (cond_4374.isBuiltAndTrue ()) {
            ...
            while (syntaxRepeat_14) {
              switch (select_repeat_piccoloDevice_syntax_14 (inLexique)) {
                case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_identifier) COMMA_HERE) ;
                  const GGS_bool cond_5485 = var_cas_settingNameSet.reader_hasKey (inLexique, var_cas_maskName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) COMMA_SOURCE_FILE_AT_LINE (183)) ;
                  if (cond_5485.isBuiltAndTrue ()) {
                  ...
                  var_cas_settingNameSet.addAssign_operation (var_cas_maskName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1_mask) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccoloDevice_lexique::piccoloDevice_lexique_1__7D_) COMMA_HERE) ;
  const GGS_bool cond_6755 = ((var_cas_processorName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).operator_isEqual (GGS_string ("pic18_60"))).operator_or ((var_cas_processorName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).operator_isEqual (GGS_string ("pic18_80"))) ;
  if (cond_6755.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_7328 = (var_cas_processorName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (223))).operator_isEqual (GGS_string ("mid-range")) ;
  if (cond_7328.isBuiltAndTrue ()) {
    {
      ...
      while (((operand_6937 = enumerator_6937.nextObject ()))
        ...
        GGS_uint  var_cas_bankAccessibility = GGS_uint (1U).left_shift_operation (inLexique, operand_6937->mInfo.mFirstFreeAddress.right_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (225)) COMMA_SOURCE_FILE_AT_LINE (225)) ;
        {
        ...
        const GGS_bool cond_7299 = (GGS_uint (1U).left_shift_operation (inLexique, var_cas_bankCount.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (229))).operator_isEqual (var_cas_bankAccessibility.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (229))) ;
