...
class piccoloDevice_syntax {
  ...
  protected : virtual void nt_start_5F_symbol_ (C_Lexique_piccoloDevice_5F_lexique &,
                                GGS_piccoloDeviceModel &) = 0 ;

  protected : void rule_piccoloDevice_5F_syntax_start_5F_symbol_i0_ (C_Lexique_piccoloDevice_5F_lexique &,
