...
category_method__ipic_registerComparisonCondition__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_registerComparisonCondition * operand_7659,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & var_cas_ioBccLabelIndex
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7659 != NULL) {
    switch (operand_7659->mComparison.enumValue ()) {
    ...
    const GGS_registerExpression  _temp_8115 = operand_7659->mRegisterExpression ;
    if (_temp_8115._isBuilt ()) {
      typeCategoryMethod__registerExpression__buildAssemblyCode _method = findCategoryMethod__registerExpression__buildAssemblyCode (_temp_8115._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_8115 (HERE), var_cas_inRegisterTable, var_cas_ioString, var_cas_useBSRaccess, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (247)) ;
      }
    }
    if ((var_cas_useBSRaccess).isBuiltAndTrue ()) {
      var_cas_ioString.writeString (", BSR_ACCESS") ;
    ...
    operand_7659->method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (252)) ;
    if ((var_cas_usesIntermediateBRA).isBuiltAndTrue ()) {
      GGS_string var_cas_aLabel ;
      var_cas_aLabel = (GGS_string (true, "_bcc_label_"))._operator_concat (var_cas_ioBccLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (254))) ;
      var_cas_ioBccLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
      var_cas_ioString.writeString ("  BRA ") ;
      var_cas_ioString._dotAssign_operation (var_cas_aLabel) ;
      var_cas_ioString.writeString ("\n") ;
      if ((operand_7659->mUsesBra).isBuiltAndTrue ()) {
        var_cas_ioString.writeString ("  BRA ") ;
        var_cas_ioString._dotAssign_operation (operand_7659->mTargetLabel) ;
        var_cas_ioString.writeString ("\n") ;
      }else{
        var_cas_ioString.writeString ("  GOTO ") ;
        var_cas_ioString._dotAssign_operation (operand_7659->mTargetLabel) ;
...
category_method__ipic_instruction_BRA__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_BRA * operand_8960,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8960 != NULL) {
    var_cas_ioString.writeString ("  BRA  ") ;
    var_cas_ioString._dotAssign_operation (operand_8960->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (278))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_CALL__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_CALL * operand_9242,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9242 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_9242->mTargetLabel) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_GOTO__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_GOTO * operand_9515,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9515 != NULL) {
    var_cas_ioString.writeString ("  GOTO ") ;
    var_cas_ioString._dotAssign_operation (operand_9515->mTargetLabel) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_RCALL__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RCALL * operand_9789,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9789 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_9789->mTargetLabel) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_CLRWDT__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_CLRWDT * operand_10065,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10065 != NULL) {
...
category_method__ipic_instruction_DAW__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_DAW * operand_10318,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10318 != NULL) {
...
category_method__ipic_instruction_NOP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_NOP * operand_10568,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_POP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_POP * operand_10818,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10818 != NULL) {
...
category_method__ipic_instruction_PUSH__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_PUSH * operand_11069,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RESET__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RESET * operand_11322,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11322 != NULL) {
...
category_method__ipic_instruction_RETURN__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RETURN * operand_11577,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11577 != NULL) {
...
category_method__ipic_instruction_RETFIE__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RETFIE * operand_11834,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11834 != NULL) {
    ...
    if ((operand_11834->mFastReturn).isBuiltAndTrue ()) {
...
category_method__ipic_instruction_SLEEP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_SLEEP * operand_12165,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_literalOperation__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_literalOperation * operand_12430,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12430 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_12430->mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (412))) ;
    var_cas_ioString.writeString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_12430->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (412)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (412))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_LFSR__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_LFSR * operand_12758,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12758 != NULL) {
    var_cas_ioString.writeString ("  LFSR ") ;
    var_cas_ioString._dotAssign_operation (operand_12758->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (422)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (422))) ;
    var_cas_ioString.writeString (", ") ;
    GGS_bool automatic_var_8 ;
    GGS_bitSliceTable  automatic_var_9 ;
    const GGS_registerExpression  _temp_12950 = operand_12758->mRegisterExpression ;
    if (_temp_12950._isBuilt ()) {
      typeCategoryMethod__registerExpression__buildAssemblyCode _method = findCategoryMethod__registerExpression__buildAssemblyCode (_temp_12950._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_12950 (HERE), var_cas_inRegisterTable, var_cas_ioString, automatic_var_8, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (423)) ;
      }
    }
    var_cas_ioString.writeString ("\n") ;
  }
...
category_method__ipic_instruction_MOVAW__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVAW * operand_13158,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13158 != NULL) {
    ...
    const GGS_registerExpression  _temp_13316 = operand_13158->mRegisterExpression ;
    if (_temp_13316._isBuilt ()) {
      typeCategoryMethod__registerExpression__buildAssemblyCode _method = findCategoryMethod__registerExpression__buildAssemblyCode (_temp_13316._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_13316 (HERE), var_cas_inRegisterTable, var_cas_ioString, automatic_var_10, automatic_var_11 COMMA_SOURCE_FILE_AT_LINE (440)) ;
      }
    }
    var_cas_ioString.writeString ("\n") ;
  }
...
category_method__ipic_instruction_MNOP__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MNOP * operand_13522,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13522 != NULL) {
    if (((operand_13522->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (456)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_13522->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (457)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_13879 = operand_13522->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (460)) ;
    GGS_bool _condition_13879 (_variant_13879._isBuilt (), true) ;
    while (_condition_13879.isBuiltAndTrue ()) {
      _condition_13879 = (var_cas_idx)._operator_strictInf (operand_13522->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (461))) ;
      if (_condition_13879.isBuiltAndTrue ()) {
        if (_variant_13879.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (464)) ;
          _condition_13879 = GGS_bool (true, false) ;
        }else{
          _variant_13879._decrement_operation (_inLexique COMMA_HERE) ;
          var_cas_ioString.writeString ("  NOP\n") ;
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (464)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_TBLRD__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLRD * operand_14003,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14003 != NULL) {
    var_cas_ioString.writeString ("  TBLRD ") ;
    var_cas_ioString._dotAssign_operation (operand_14003->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (475))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_TBLWT__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLWT * operand_14284,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14284 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_14284->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (485))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_computed_retlw__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_retlw * operand_14574,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14574 != NULL) {
    if ((operand_14574->mUsesRelativeCall).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_14838 (operand_14574->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_14838 = NULL ;
      while (((operand_14838 = enumerator_14838.nextObject ()))) {
        macroValidPointer (operand_14838) ;
        var_cas_ioString.writeString ("  RETLW ") ;
        var_cas_ioString._dotAssign_operation (operand_14838->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (501)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (501))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_15054,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15054 != NULL) {
    if ((operand_15054->mUsesRelativeCall).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_15318 (operand_15054->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_15318 = NULL ;
      while (((operand_15318 = enumerator_15318.nextObject ()))) {
        macroValidPointer (operand_15318) ;
        var_cas_ioString.writeString ("  BRA ") ;
        var_cas_ioString._dotAssign_operation (operand_15318->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (518))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_goto__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_15522,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15522 != NULL) {
    if ((operand_15522->mUsesRelativeCall).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_4\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_4\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_15786 (operand_15522->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_15786 = NULL ;
      while (((operand_15786 = enumerator_15786.nextObject ()))) {
        macroValidPointer (operand_15786) ;
        var_cas_ioString.writeString ("  GOTO ") ;
        var_cas_ioString._dotAssign_operation (operand_15786->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (535))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
void routine_buildAssemblyCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_16328 (var_cas_inInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_16328 = NULL ;
    while (((operand_16328 = enumerator_16328.nextObject ()))) {
      macroValidPointer (operand_16328) ;
      const GGS_ipic_instruction  _temp_16367 = operand_16328->mInstruction ;
      if (_temp_16367._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__buildAssemblyCode _method = findCategoryMethod__ipic_instruction__buildAssemblyCode (_temp_16367._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_16367 (HERE), var_cas_inAllRegisters, var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (554)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_16569 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_16569 = NULL ;
    while (((operand_16569 = enumerator_16569.nextObject ()))) {
      macroValidPointer (operand_16569) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_16642 = operand_16569->mInfo.mRegisterAddressList ;
      if (_temp_16642._isBuilt ()) {
        _temp_16642 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (560)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_16569->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (561))) ;
      var_cas_outAssemblyCode.writeString (" EQU ") ;
      var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (561))) ;
      var_cas_outAssemblyCode.writeString ("\n") ;
    }
  }
  var_cas_outAssemblyCode.writeString ("\n") ;
  ...
  {
    GGS_registerTable::cEnumerator enumerator_16902 (var_cas_inAllRegisters, true) ;
    const GGS_registerTable::cElement * operand_16902 = NULL ;
    while (((operand_16902 = enumerator_16902.nextObject ()))) {
      macroValidPointer (operand_16902) ;
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_16902->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (567)) COMMA_SOURCE_FILE_AT_LINE (567)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_17031 = operand_16902->mInfo.mRegisterAddressList ;
        if (_temp_17031._isBuilt ()) {
          _temp_17031 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (568)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_16902->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (569))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
        var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (569))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
