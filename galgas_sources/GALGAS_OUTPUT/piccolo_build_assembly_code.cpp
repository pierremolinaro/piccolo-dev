...
void routine_buildAssemblyCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_14061 (var_cas_inInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_14061 = NULL ;
    while (((operand_14061 = enumerator_14061.nextObject ()))) {
      macroValidPointer (operand_14061) ;
      const GGS_ipic_instruction  _temp_14100 = operand_14061->mInstruction ;
      if (_temp_14100._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__buildAssemblyCode _method = findCategoryMethod__ipic_instruction__buildAssemblyCode (_temp_14100._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_14100 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (483)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14286 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_14286 = NULL ;
    while (((operand_14286 = enumerator_14286.nextObject ()))) {
      macroValidPointer (operand_14286) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_14359 = operand_14286->mInfo.mRegisterAddressList ;
      if (_temp_14359._isBuilt ()) {
        _temp_14359 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (489)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_14286->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (490))) ;
  ...
  var_cas_outAssemblyCode.writeString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_14619 = enumerator_14619.nextObject ()))) {
      ...
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_14619->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_14748 = operand_14619->mInfo.mRegisterAddressList ;
        if (_temp_14748._isBuilt ()) {
          _temp_14748 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (497)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_14619->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (498))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
  ...
  if (((var_cas_inActualConfigurationMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outAssemblyCode.writeString (";--- Configuration\n"
      "\n") ;
    {
      GGS_actualConfigurationMap::cEnumerator enumerator_15276 (var_cas_inActualConfigurationMap, true) ;
      const GGS_actualConfigurationMap::cElement * operand_15276 = NULL ;
      while (((operand_15276 = enumerator_15276.nextObject ()))) {
        macroValidPointer (operand_15276) ;
        var_cas_outAssemblyCode.writeString ("  ORG ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_15276->mInfo.mRegisterAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (511))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
        var_cas_outAssemblyCode.writeString ("  DW ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_15276->mInfo.mRegisterValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (512))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
