...
category_method__ipic_instruction_computed_retlw__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_12184 != NULL) {
    if ((operand_12184->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_12399 (operand_12184->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_12399 = NULL ;
      while (((operand_12399 = enumerator_12399.nextObject ()))) {
        macroValidPointer (operand_12399) ;
        var_cas_ioString.writeString ("  RETLW ") ;
        var_cas_ioString._dotAssign_operation (operand_12399->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (435)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (435))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_12615,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12615 != NULL) {
    if ((operand_12615->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_12830 (operand_12615->mTargetLabels, true) ;
      ...
      while (((operand_12830 = enumerator_12830.nextObject ()))) {
        ...
        var_cas_ioString.writeString ("  BRA ") ;
        var_cas_ioString._dotAssign_operation (operand_12830->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (451))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_goto__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_13034,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13034 != NULL) {
    if ((operand_13034->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_4\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_4\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_13249 (operand_13034->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_13249 = NULL ;
      while (((operand_13249 = enumerator_13249.nextObject ()))) {
        macroValidPointer (operand_13249) ;
        var_cas_ioString.writeString ("  GOTO ") ;
        var_cas_ioString._dotAssign_operation (operand_13249->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (467))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
void routine_buildAssemblyCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_13791 (var_cas_inInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_13791 = NULL ;
    while (((operand_13791 = enumerator_13791.nextObject ()))) {
      macroValidPointer (operand_13791) ;
      const GGS_ipic_instruction  _temp_13830 = operand_13791->mInstruction ;
      if (_temp_13830._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__buildAssemblyCode _method = findCategoryMethod__ipic_instruction__buildAssemblyCode (_temp_13830._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_13830 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (486)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14016 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_14016 = NULL ;
    while (((operand_14016 = enumerator_14016.nextObject ()))) {
      macroValidPointer (operand_14016) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_14089 = operand_14016->mInfo.mRegisterAddressList ;
      if (_temp_14089._isBuilt ()) {
        _temp_14089 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (492)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_14016->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (493))) ;
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14349 (var_cas_inAllRegisters, true) ;
    const GGS_registerTable::cElement * operand_14349 = NULL ;
    while (((operand_14349 = enumerator_14349.nextObject ()))) {
      macroValidPointer (operand_14349) ;
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_14349->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (499)) COMMA_SOURCE_FILE_AT_LINE (499)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_14478 = operand_14349->mInfo.mRegisterAddressList ;
        if (_temp_14478._isBuilt ()) {
          _temp_14478 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (500)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_14349->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (501))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
