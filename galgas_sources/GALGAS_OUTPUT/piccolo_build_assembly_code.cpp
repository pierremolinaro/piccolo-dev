...
category_method__ipic_instruction_CLRWDT__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_CLRWDT * operand_8648,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8648 != NULL) {
...
category_method__ipic_instruction_DAW__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_DAW * operand_8859,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8859 != NULL) {
...
category_method__ipic_instruction_NOP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_NOP * operand_9067,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_POP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_POP * operand_9275,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9275 != NULL) {
...
category_method__ipic_instruction_PUSH__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_PUSH * operand_9484,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9484 != NULL) {
...
category_method__ipic_instruction_RESET__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RESET * operand_9695,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RETURN__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RETURN * operand_9908,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RETFIE__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RETFIE * operand_10123,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10123 != NULL) {
    var_cas_ioString.writeString ("  RETFIE") ;
    if ((operand_10123->mFastReturn).isBuiltAndTrue ()) {
...
category_method__ipic_instruction_SLEEP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_SLEEP * operand_10412,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_literalOperation__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_literalOperation * operand_10635,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10635 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_10635->mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (361))) ;
    var_cas_ioString.writeString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_10635->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (361)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (361))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_LFSR__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_LFSR * operand_10921,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10921 != NULL) {
    var_cas_ioString.writeString ("  LFSR ") ;
    var_cas_ioString._dotAssign_operation (operand_10921->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (370)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (370))) ;
    var_cas_ioString.writeString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_10921->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (371))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_MOVAW__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVAW * operand_11229,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11229 != NULL) {
    var_cas_ioString.writeString ("  MOVLW ") ;
    var_cas_ioString._dotAssign_operation (operand_11229->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (380))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_MNOP__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MNOP * operand_11487,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11487 != NULL) {
    if (((operand_11487->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (389)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_11487->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_11802 = operand_11487->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (393)) ;
    GGS_bool _condition_11802 (_variant_11802._isBuilt (), true) ;
    while (_condition_11802.isBuiltAndTrue ()) {
      _condition_11802 = (var_cas_idx)._operator_strictInf (operand_11487->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (394))) ;
      if (_condition_11802.isBuiltAndTrue ()) {
        if (_variant_11802.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (397)) ;
          _condition_11802 = GGS_bool (true, false) ;
        }else{
          _variant_11802._decrement_operation (_inLexique COMMA_HERE) ;
          var_cas_ioString.writeString ("  NOP\n") ;
...
category_method__ipic_instruction_TBLRD__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLRD * operand_11926,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11926 != NULL) {
    var_cas_ioString.writeString ("  TBLRD ") ;
    var_cas_ioString._dotAssign_operation (operand_11926->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (407))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_TBLWT__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLWT * operand_12165,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12165 != NULL) {
    var_cas_ioString.writeString ("  TBLWT ") ;
    var_cas_ioString._dotAssign_operation (operand_12165->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (416))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_computed_retlw__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_retlw * operand_12413,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12413 != NULL) {
    if ((operand_12413->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_12628 (operand_12413->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_12628 = NULL ;
      while (((operand_12628 = enumerator_12628.nextObject ()))) {
        macroValidPointer (operand_12628) ;
        var_cas_ioString.writeString ("  RETLW ") ;
        var_cas_ioString._dotAssign_operation (operand_12628->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (431)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (431))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_12844,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12844 != NULL) {
    if ((operand_12844->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_13059 (operand_12844->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_13059 = NULL ;
      while (((operand_13059 = enumerator_13059.nextObject ()))) {
        macroValidPointer (operand_13059) ;
        var_cas_ioString.writeString ("  BRA ") ;
        var_cas_ioString._dotAssign_operation (operand_13059->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (447))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_goto__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_13263,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13263 != NULL) {
    if ((operand_13263->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_4\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_4\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_13478 (operand_13263->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_13478 = NULL ;
      while (((operand_13478 = enumerator_13478.nextObject ()))) {
        macroValidPointer (operand_13478) ;
        var_cas_ioString.writeString ("  GOTO ") ;
        var_cas_ioString._dotAssign_operation (operand_13478->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (463))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
void routine_buildAssemblyCode (C_Compiler & _inLexique,
  ...
  var_cas_bccLabelIndex = GGS_uint (true, 0U) ;
  {
    ...
    while (((operand_14073 = enumerator_14073.nextObject ()))) {
      ...
      if (_temp_14112._isBuilt ()) {
        ...
        if (_method != NULL) {
          _method (_inLexique, _temp_14112 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (483)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14298 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_14298 = NULL ;
    while (((operand_14298 = enumerator_14298.nextObject ()))) {
      macroValidPointer (operand_14298) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_14371 = operand_14298->mInfo.mRegisterAddressList ;
      if (_temp_14371._isBuilt ()) {
        _temp_14371 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (489)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_14298->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (490))) ;
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14631 (var_cas_inAllRegisters, true) ;
    const GGS_registerTable::cElement * operand_14631 = NULL ;
    while (((operand_14631 = enumerator_14631.nextObject ()))) {
      macroValidPointer (operand_14631) ;
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_14631->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_14760 = operand_14631->mInfo.mRegisterAddressList ;
        if (_temp_14760._isBuilt ()) {
          _temp_14760 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (497)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_14631->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (498))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
  ...
  if (((var_cas_inActualConfigurationMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outAssemblyCode.writeString (";--- Configuration\n"
      "\n") ;
    {
      GGS_actualConfigurationMap::cEnumerator enumerator_15288 (var_cas_inActualConfigurationMap, true) ;
      const GGS_actualConfigurationMap::cElement * operand_15288 = NULL ;
      while (((operand_15288 = enumerator_15288.nextObject ()))) {
        macroValidPointer (operand_15288) ;
        var_cas_outAssemblyCode.writeString ("  ORG ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_15288->mInfo.mRegisterAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (511))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
        var_cas_outAssemblyCode.writeString ("  DW ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_15288->mInfo.mRegisterValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (512))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
