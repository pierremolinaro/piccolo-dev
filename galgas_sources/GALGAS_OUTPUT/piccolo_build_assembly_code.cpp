...
category_method__ipic_instruction_literalOperation__buildAssemblyCode (C_Compiler & _inLexique,
  ...
  if (operand_10885 != NULL) {
    ...
    var_cas_ioString.writeString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_10885->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (370)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (370))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_LFSR__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_LFSR * operand_11171,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11171 != NULL) {
    var_cas_ioString.writeString ("  LFSR ") ;
    var_cas_ioString._dotAssign_operation (operand_11171->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (379)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (379))) ;
    var_cas_ioString.writeString (", ") ;
    var_cas_ioString._dotAssign_operation (operand_11171->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (380))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_MOVAW__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVAW * operand_11479,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11479 != NULL) {
    var_cas_ioString.writeString ("  MOVLW ") ;
    var_cas_ioString._dotAssign_operation (operand_11479->mRegisterDescription.reader_mAssemblyString (_inLexique COMMA_SOURCE_FILE_AT_LINE (389))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_MNOP__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MNOP * operand_11737,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11737 != NULL) {
    if (((operand_11737->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (398)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_11737->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (399)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_12052 = operand_11737->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (402)) ;
    GGS_bool _condition_12052 (_variant_12052._isBuilt (), true) ;
    while (_condition_12052.isBuiltAndTrue ()) {
      _condition_12052 = (var_cas_idx)._operator_strictInf (operand_11737->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (403))) ;
      if (_condition_12052.isBuiltAndTrue ()) {
        if (_variant_12052.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (406)) ;
          _condition_12052 = GGS_bool (true, false) ;
        }else{
          _variant_12052._decrement_operation (_inLexique COMMA_HERE) ;
          var_cas_ioString.writeString ("  NOP\n") ;
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (406)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_TBLRD__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLRD * operand_12176,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12176 != NULL) {
    var_cas_ioString.writeString ("  TBLRD ") ;
    var_cas_ioString._dotAssign_operation (operand_12176->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (416))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_TBLWT__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLWT * operand_12415,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12415 != NULL) {
    var_cas_ioString.writeString ("  TBLWT ") ;
    var_cas_ioString._dotAssign_operation (operand_12415->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (425))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_computed_retlw__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_retlw * operand_12663,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12663 != NULL) {
    if ((operand_12663->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_12878 (operand_12663->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_12878 = NULL ;
      while (((operand_12878 = enumerator_12878.nextObject ()))) {
        macroValidPointer (operand_12878) ;
        var_cas_ioString.writeString ("  RETLW ") ;
        var_cas_ioString._dotAssign_operation (operand_12878->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (440)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (440))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_13094,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13094 != NULL) {
    if ((operand_13094->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_13309 (operand_13094->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_13309 = NULL ;
      while (((operand_13309 = enumerator_13309.nextObject ()))) {
        macroValidPointer (operand_13309) ;
        var_cas_ioString.writeString ("  BRA ") ;
        var_cas_ioString._dotAssign_operation (operand_13309->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (456))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_goto__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_13513,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13513 != NULL) {
    if ((operand_13513->mUsesRCALL).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_4\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_4\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_13728 (operand_13513->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_13728 = NULL ;
      while (((operand_13728 = enumerator_13728.nextObject ()))) {
        macroValidPointer (operand_13728) ;
        var_cas_ioString.writeString ("  GOTO ") ;
        var_cas_ioString._dotAssign_operation (operand_13728->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (472))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
void routine_buildAssemblyCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_14323 (var_cas_inInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_14323 = NULL ;
    while (((operand_14323 = enumerator_14323.nextObject ()))) {
      macroValidPointer (operand_14323) ;
      const GGS_ipic_instruction  _temp_14362 = operand_14323->mInstruction ;
      if (_temp_14362._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__buildAssemblyCode _method = findCategoryMethod__ipic_instruction__buildAssemblyCode (_temp_14362._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_14362 (HERE), var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (492)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14548 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_14548 = NULL ;
    while (((operand_14548 = enumerator_14548.nextObject ()))) {
      macroValidPointer (operand_14548) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_14621 = operand_14548->mInfo.mRegisterAddressList ;
      if (_temp_14621._isBuilt ()) {
        _temp_14621 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (498)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_14548->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (499))) ;
      var_cas_outAssemblyCode.writeString (" EQU ") ;
      var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (499))) ;
      var_cas_outAssemblyCode.writeString ("\n") ;
    }
  }
  var_cas_outAssemblyCode.writeString ("\n") ;
  ...
  {
    GGS_registerTable::cEnumerator enumerator_14881 (var_cas_inAllRegisters, true) ;
    const GGS_registerTable::cElement * operand_14881 = NULL ;
    while (((operand_14881 = enumerator_14881.nextObject ()))) {
      macroValidPointer (operand_14881) ;
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_14881->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_15010 = operand_14881->mInfo.mRegisterAddressList ;
        if (_temp_15010._isBuilt ()) {
          _temp_15010 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (506)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_14881->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (507))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
        var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (507))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
  ...
  var_cas_outAssemblyCode.writeString ("BSR_ACCESS EQU 1\n"
    "\n") ;
  if (((var_cas_inActualConfigurationMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (517)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outAssemblyCode.writeString (";--- Configuration\n"
      "\n") ;
    {
      GGS_actualConfigurationMap::cEnumerator enumerator_15538 (var_cas_inActualConfigurationMap, true) ;
      const GGS_actualConfigurationMap::cElement * operand_15538 = NULL ;
      while (((operand_15538 = enumerator_15538.nextObject ()))) {
        macroValidPointer (operand_15538) ;
        var_cas_outAssemblyCode.writeString ("  ORG ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_15538->mInfo.mRegisterAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (520))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
        var_cas_outAssemblyCode.writeString ("  DW ") ;
        var_cas_outAssemblyCode._dotAssign_operation (operand_15538->mInfo.mRegisterValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (521))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
