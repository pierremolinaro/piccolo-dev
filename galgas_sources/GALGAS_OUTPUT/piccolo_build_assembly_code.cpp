...
category_method__ipic_instruction_BRA__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_BRA * operand_7647,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7647 != NULL) {
    var_cas_ioString.writeString ("  BRA  ") ;
    var_cas_ioString._dotAssign_operation (operand_7647->mTargetLabel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (238))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_CALL__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_CALL * operand_7929,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7929 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_7929->mTargetLabel) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_GOTO__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_GOTO * operand_8202,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8202 != NULL) {
    var_cas_ioString.writeString ("  GOTO ") ;
    var_cas_ioString._dotAssign_operation (operand_8202->mTargetLabel) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_RCALL__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RCALL * operand_8476,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8476 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_8476->mTargetLabel) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_CLRWDT__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_CLRWDT * operand_8752,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8752 != NULL) {
...
category_method__ipic_instruction_DAW__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_DAW * operand_9005,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_NOP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_NOP * operand_9255,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_POP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_POP * operand_9505,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_PUSH__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_PUSH * operand_9756,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RESET__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RESET * operand_10009,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RETURN__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RETURN * operand_10264,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RETFIE__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_RETFIE * operand_10521,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10521 != NULL) {
    ...
    if ((operand_10521->mFastReturn).isBuiltAndTrue ()) {
...
category_method__ipic_instruction_SLEEP__buildAssemblyCode (C_Compiler &,
                                const cPtr_ipic_instruction_SLEEP * operand_10852,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10852 != NULL) {
...
category_method__ipic_instruction_literalOperation__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_literalOperation * operand_11117,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11117 != NULL) {
    var_cas_ioString.writeString ("  ") ;
    var_cas_ioString._dotAssign_operation (operand_11117->mLiteralInstruction.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (372))) ;
    var_cas_ioString.writeString (" ") ;
    var_cas_ioString._dotAssign_operation (operand_11117->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (372))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_LFSR__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_LFSR * operand_11445,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11445 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_11445->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (382)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (382))) ;
    var_cas_ioString.writeString (", ") ;
    GGS_bool automatic_var_7 ;
    GGS_bitSliceTable  automatic_var_8 ;
    const GGS_registerExpression  _temp_11637 = operand_11445->mRegisterExpression ;
    if (_temp_11637._isBuilt ()) {
      typeCategoryMethod__registerExpression__buildAssemblyCode _method = findCategoryMethod__registerExpression__buildAssemblyCode (_temp_11637._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_11637 (HERE), var_cas_inRegisterTable, var_cas_ioString, automatic_var_7, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (383)) ;
      }
    }
    var_cas_ioString.writeString ("\n") ;
  }
...
category_method__ipic_instruction_MOVAW__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVAW * operand_11845,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11845 != NULL) {
    var_cas_ioString.writeString ("  MOVLW ") ;
    GGS_bool automatic_var_9 ;
    GGS_bitSliceTable  automatic_var_10 ;
    const GGS_registerExpression  _temp_12003 = operand_11845->mRegisterExpression ;
    if (_temp_12003._isBuilt ()) {
      typeCategoryMethod__registerExpression__buildAssemblyCode _method = findCategoryMethod__registerExpression__buildAssemblyCode (_temp_12003._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_12003 (HERE), var_cas_inRegisterTable, var_cas_ioString, automatic_var_9, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (400)) ;
      }
    }
    var_cas_ioString.writeString ("\n") ;
  }
...
category_method__ipic_instruction_MNOP__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MNOP * operand_12209,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12209 != NULL) {
    if (((operand_12209->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_12209->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (417)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_12566 = operand_12209->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (420)) ;
    GGS_bool _condition_12566 (_variant_12566._isBuilt (), true) ;
    while (_condition_12566.isBuiltAndTrue ()) {
      _condition_12566 = (var_cas_idx)._operator_strictInf (operand_12209->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (421))) ;
      if (_condition_12566.isBuiltAndTrue ()) {
        if (_variant_12566.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (424)) ;
          _condition_12566 = GGS_bool (true, false) ;
        }else{
          _variant_12566._decrement_operation (_inLexique COMMA_HERE) ;
          var_cas_ioString.writeString ("  NOP\n") ;
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (424)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_TBLRD__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLRD * operand_12690,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12690 != NULL) {
    var_cas_ioString.writeString ("  TBLRD ") ;
    var_cas_ioString._dotAssign_operation (operand_12690->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (435))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_TBLWT__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLWT * operand_12971,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12971 != NULL) {
    ...
    var_cas_ioString._dotAssign_operation (operand_12971->mOption.reader_mnemonic (_inLexique COMMA_SOURCE_FILE_AT_LINE (445))) ;
    var_cas_ioString.writeString ("\n") ;
  }
}
...
category_method__ipic_instruction_computed_retlw__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_retlw * operand_13261,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13261 != NULL) {
    if ((operand_13261->mUsesRelativeCall).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_13525 (operand_13261->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_13525 = NULL ;
      while (((operand_13525 = enumerator_13525.nextObject ()))) {
        macroValidPointer (operand_13525) ;
        var_cas_ioString.writeString ("  RETLW ") ;
        var_cas_ioString._dotAssign_operation (operand_13525->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (461)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (461))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_13741,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13741 != NULL) {
    if ((operand_13741->mUsesRelativeCall).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_2\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_2\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_14005 (operand_13741->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_14005 = NULL ;
      while (((operand_14005 = enumerator_14005.nextObject ()))) {
        macroValidPointer (operand_14005) ;
        var_cas_ioString.writeString ("  BRA ") ;
        var_cas_ioString._dotAssign_operation (operand_14005->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (478))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
category_method__ipic_instruction_computed_goto__buildAssemblyCode (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_14209,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_string & var_cas_ioString,
                                GGS_uint  & /* var_cas_ioBccLabelIndex */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14209 != NULL) {
    if ((operand_14209->mUsesRelativeCall).isBuiltAndTrue ()) {
      var_cas_ioString.writeString ("  RCALL _computed_goto_4\n") ;
    }else{
      var_cas_ioString.writeString ("  CALL _computed_goto_4\n") ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_14473 (operand_14209->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_14473 = NULL ;
      while (((operand_14473 = enumerator_14473.nextObject ()))) {
        macroValidPointer (operand_14473) ;
        var_cas_ioString.writeString ("  GOTO ") ;
        var_cas_ioString._dotAssign_operation (operand_14473->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (495))) ;
        var_cas_ioString.writeString ("\n") ;
      }
    }
  }
...
void routine_buildAssemblyCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_15015 (var_cas_inInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_15015 = NULL ;
    while (((operand_15015 = enumerator_15015.nextObject ()))) {
      macroValidPointer (operand_15015) ;
      const GGS_ipic_instruction  _temp_15054 = operand_15015->mInstruction ;
      if (_temp_15054._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__buildAssemblyCode _method = findCategoryMethod__ipic_instruction__buildAssemblyCode (_temp_15054._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_15054 (HERE), var_cas_inAllRegisters, var_cas_outAssemblyCode, var_cas_bccLabelIndex COMMA_SOURCE_FILE_AT_LINE (514)) ;
        }
      }
    }
  }
  ...
  {
    GGS_registerTable::cEnumerator enumerator_15256 (var_cas_inPredefinedRegisters, true) ;
    const GGS_registerTable::cElement * operand_15256 = NULL ;
    while (((operand_15256 = enumerator_15256.nextObject ()))) {
      macroValidPointer (operand_15256) ;
      GGS_uint  var_cas_firstRegister ;
      const GGS_uintlist  _temp_15329 = operand_15256->mInfo.mRegisterAddressList ;
      if (_temp_15329._isBuilt ()) {
        _temp_15329 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (520)) ;
      }
      var_cas_outAssemblyCode._dotAssign_operation (operand_15256->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (521))) ;
      var_cas_outAssemblyCode.writeString (" EQU ") ;
      var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (521))) ;
      var_cas_outAssemblyCode.writeString ("\n") ;
    }
  }
  var_cas_outAssemblyCode.writeString ("\n") ;
  var_cas_outAssemblyCode.writeString (";--- User defined registers (in RAM)\n") ;
  {
    ...
    while (((operand_15589 = enumerator_15589.nextObject ()))) {
      ...
      if (((var_cas_inPredefinedRegisters.reader_hasKey (_inLexique, operand_15589->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (527)) COMMA_SOURCE_FILE_AT_LINE (527)))._operator_not ()).isBuiltAndTrue ()) {
        GGS_uint  var_cas_firstRegister ;
        const GGS_uintlist  _temp_15718 = operand_15589->mInfo.mRegisterAddressList ;
        if (_temp_15718._isBuilt ()) {
          _temp_15718 (HERE)->method_first (_inLexique, var_cas_firstRegister COMMA_SOURCE_FILE_AT_LINE (528)) ;
        }
        var_cas_outAssemblyCode._dotAssign_operation (operand_15589->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (529))) ;
        var_cas_outAssemblyCode.writeString (" EQU ") ;
        var_cas_outAssemblyCode._dotAssign_operation (var_cas_firstRegister.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (529))) ;
        var_cas_outAssemblyCode.writeString ("\n") ;
      }
    }
  }
