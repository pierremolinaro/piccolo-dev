...
category_method__ipic_instruction_literalOperation__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_18050 != NULL) {
    ...
    var_cas_code = (var_cas_code)._operator_or (operand_18050->mLiteralValue) ;
    if (var_cas_code._isBuilt ()) {
...
category_method__ipic_instruction_LFSR__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_LFSR * operand_18395,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18395 != NULL) {
    if (((GGS_uint (true, 60928U))._operator_or (operand_18395->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (586))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (586))))._operator_or (operand_18395->mValue._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (586)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  ((GGS_uint (true, 60928U))._operator_or (operand_18395->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (586))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (586))))._operator_or (operand_18395->mValue._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (586))) COMMA_SOURCE_FILE_AT_LINE (585)) ;
    }
    if ((GGS_uint (true, 61440U))._operator_or ((operand_18395->mValue)._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or ((operand_18395->mValue)._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (586)) ;
    }
  }
}
...
category_method__ipic_instruction_MOVLB__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVLB * operand_18732,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18732 != NULL) {
    if ((GGS_uint (true, 256U))._operator_or (operand_18732->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (596)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 256U))._operator_or (operand_18732->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (596))) COMMA_SOURCE_FILE_AT_LINE (595)) ;
    }
  }
}
...
category_method__ipic_instruction_TBLRD__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLRD * operand_19564,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19564 != NULL) {
    switch (operand_19564->mOption.enumValue ()) {
...
category_method__ipic_instruction_TBLWT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLWT * operand_20000,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20000 != NULL) {
    switch (operand_20000->mOption.enumValue ()) {
    case GGS_tableAccessOption::enum_simpleAccess:
      {
...
category_method__ipic_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MNOP * operand_20435,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20435 != NULL) {
    if (((operand_20435->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (648)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_20435->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (649)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_20773 = operand_20435->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (652)) ;
    GGS_bool _condition_20773 (_variant_20773._isBuilt (), true) ;
    while (_condition_20773.isBuiltAndTrue ()) {
      _condition_20773 = (var_cas_idx)._operator_strictInf (operand_20435->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (653))) ;
      if (_condition_20773.isBuiltAndTrue ()) {
        if (_variant_20773.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (656)) ;
          _condition_20773 = GGS_bool (true, false) ;
        }else{
          _variant_20773._decrement_operation (_inLexique COMMA_HERE) ;
          if (GGS_uint (true, 0U)._isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (654)) ;
          }
...
category_method__ipic_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_retlw * operand_20930,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20930 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_21065 = var_cas_inRoutineSymbolTable ;
    if (_temp_21065._isBuilt ()) {
      _temp_21065 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (667)) ;
    }
    if ((operand_20930->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_20930->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (668)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (670)) ;
    }
    {
      GGS_uintlist::cEnumerator enumerator_21301 (operand_20930->mLiteralValues, true) ;
      const GGS_uintlist::cElement * operand_21301 = NULL ;
      while (((operand_21301 = enumerator_21301.nextObject ()))) {
        macroValidPointer (operand_21301) ;
        if ((GGS_uint (true, 3072U))._operator_or (operand_21301->mValue)._isBuilt ()) {
          ::routine_emitCode (_inLexique,  (GGS_uint (true, 3072U))._operator_or (operand_21301->mValue) COMMA_SOURCE_FILE_AT_LINE (673)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_21509,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21509 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_21644 = var_cas_inRoutineSymbolTable ;
    if (_temp_21644._isBuilt ()) {
      _temp_21644 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (685)) ;
    }
    if ((operand_21509->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_21509->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (686)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (688)) ;
    }
    ...
    if (((operand_21509->mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
    ...
    {
      GGS_lstringlist::cEnumerator enumerator_22061 (operand_21509->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22061 = NULL ;
      while (((operand_22061 = enumerator_22061.nextObject ()))) {
        macroValidPointer (operand_22061) ;
        const GGS_symbolTable  _temp_22104 = var_cas_inRoutineSymbolTable ;
        if (_temp_22104._isBuilt ()) {
          _temp_22104 (HERE)->method_searchKey (_inLexique, operand_22061->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (698)) ;
        }
        ::routine_emitBRAinstruction (_inLexique,  var_cas_addressForComputingBRA,  var_cas_targetAddress,  operand_22061->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (702)) COMMA_SOURCE_FILE_AT_LINE (698)) ;
...
category_method__ipic_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_22463,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22463 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_22598 = var_cas_inRoutineSymbolTable ;
    if (_temp_22598._isBuilt ()) {
      _temp_22598 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (715)) ;
    }
    if ((operand_22463->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_22463->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (716)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (718)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_22833 (operand_22463->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22833 = NULL ;
      while (((operand_22833 = enumerator_22833.nextObject ()))) {
        macroValidPointer (operand_22833) ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_symbolTable  _temp_22909 = var_cas_inRoutineSymbolTable ;
        if (_temp_22909._isBuilt ()) {
          _temp_22909 (HERE)->method_searchKey (_inLexique, operand_22833->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (723)) ;
        }
        ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (723)) ;
      }
    }
  }
}
...
void routine_buildBinaryCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_23716 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_23716 = NULL ;
    while (((operand_23716 = enumerator_23716.nextObject ()))) {
      macroValidPointer (operand_23716) ;
      const GGS_ipic_instruction  _temp_23764 = operand_23716->mInstruction ;
      if (_temp_23764._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__enterLabelAtAddress _method = findCategoryMethod__ipic_instruction__enterLabelAtAddress (_temp_23764._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_23764 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (745)) ;
        }
      }
    }
  }
  ...
  var_cas_currentAddress = GGS_uint (true, 0U) ;
  if (GGS_uint (true, 0U)._isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (749)) ;
  }
  {
    GGS_ipic_instructionList::cEnumerator enumerator_24003 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_24003 = NULL ;
    while (((operand_24003 = enumerator_24003.nextObject ()))) {
      macroValidPointer (operand_24003) ;
      const GGS_ipic_instruction  _temp_24051 = operand_24003->mInstruction ;
      if (_temp_24051._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress (_temp_24051._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_24051 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (752)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic_instruction  _temp_24160 = operand_24003->mInstruction ;
      if (_temp_24160._isBuilt ()) {
        _temp_24160 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (754)) ;
      }
      ...
      ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (755)) ;
    }
  }
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (759))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (761))))._operator_concat (GGS_string (true, " value in first pass")) COMMA_SOURCE_FILE_AT_LINE (761)) ;
  }else if (((var_cas_lastAddressForFirstPass)._operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Program too large: "))._operator_concat (var_cas_lastAddressForFirstPass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (763))))._operator_concat (GGS_string (true, " bytes (rom size is ")))._operator_concat (var_cas_inROMsize.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (765))))._operator_concat (GGS_string (true, " bytes)")) COMMA_SOURCE_FILE_AT_LINE (765)) ;
  }
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_24850 (var_cas_inActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_24850 = NULL ;
    while (((operand_24850 = enumerator_24850.nextObject ()))) {
      macroValidPointer (operand_24850) ;
      if (operand_24850->mInfo.mRegisterAddress._isBuilt ()) {
        ::routine_setEmitAddress (_inLexique,  operand_24850->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (768)) ;
      }
      if (operand_24850->mInfo.mRegisterValue._isBuilt ()) {
        ::routine_emitCode (_inLexique,  operand_24850->mInfo.mRegisterValue COMMA_SOURCE_FILE_AT_LINE (769)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
