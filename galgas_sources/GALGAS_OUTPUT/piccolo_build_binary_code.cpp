...
category_method__ipic_jump_test_register__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_jump_test_register * operand_11045,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11045 != NULL) {
    GGS_uint  var_cas_code ;
    var_cas_code = GGS_uint (true, 26112U) ;
    if ((operand_11045->mRegisterDescription.reader_mNeedsBSR (_inLexique COMMA_SOURCE_FILE_AT_LINE (346))).isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code)._operator_or (GGS_uint (true, 256U)) ;
    }
    var_cas_code = (var_cas_code)._operator_or ((operand_11045->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (349)))._operator_and (GGS_uint (true, 255U))) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (349)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_11461 = var_cas_inRoutineSymbolTable ;
    if (_temp_11461._isBuilt ()) {
      _temp_11461 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_11045->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (353)) ;
    }
    if ((operand_11045->mBranchIfZero).isBuiltAndTrue ()) {
      GGS_uint  var_cas_intermediateTargetAddress ;
      if ((operand_11045->mUsesBra).isBuiltAndTrue ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 6U) COMMA_SOURCE_FILE_AT_LINE (357)) ;
      }else{
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (359)) ;
      }
      ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (362)),  var_cas_intermediateTargetAddress,  operand_11045->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (360)) ;
      if ((operand_11045->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (367)),  var_cas_targetAddress,  operand_11045->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (366)) ;
      }else{
        ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (368)) ;
      }
    }else{
      if ((operand_11045->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (373)),  var_cas_targetAddress,  operand_11045->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (372)) ;
      }else{
...
category_method__ipic_incDecRegisterInCondition__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_incDecRegisterInCondition * operand_12310,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12310 != NULL) {
    GGS_uint  var_cas_code ;
    if (((operand_12310->mBranchIfZero)._operator_and (operand_12310->mIncrement)).isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (true, 18432U) ;
    }else if (((operand_12310->mBranchIfZero)._operator_and ((operand_12310->mIncrement)._operator_not ())).isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (true, 19456U) ;
    }else if ((((operand_12310->mBranchIfZero)._operator_not ())._operator_and (operand_12310->mIncrement)).isBuiltAndTrue ()) {
      var_cas_code = GGS_uint (true, 15360U) ;
    }else{
      var_cas_code = GGS_uint (true, 11264U) ;
    }
    if (((operand_12310->m_W_isDestination)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code)._operator_or (GGS_uint (true, 512U)) ;
    }
    if ((operand_12310->mRegisterDescription.reader_mNeedsBSR (_inLexique COMMA_SOURCE_FILE_AT_LINE (399))).isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code)._operator_or (GGS_uint (true, 256U)) ;
    }
    var_cas_code = (var_cas_code)._operator_or ((operand_12310->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (402)))._operator_and (GGS_uint (true, 255U))) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (402)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_13009 = var_cas_inRoutineSymbolTable ;
    if (_temp_13009._isBuilt ()) {
      _temp_13009 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_12310->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (406)) ;
    }
    if ((operand_12310->mUsesBra).isBuiltAndTrue ()) {
      ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (408)),  var_cas_targetAddress,  operand_12310->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (407)) ;
    }else{
      ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (409)) ;
    }
  }
}
...
category_method__ipic_registerComparisonCondition__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_registerComparisonCondition * operand_13349,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13349 != NULL) {
    GGS_uint  var_cas_code ;
    switch (operand_13349->mComparison.enumValue ()) {
    ...
    if ((operand_13349->mRegisterDescription.reader_mNeedsBSR (_inLexique COMMA_SOURCE_FILE_AT_LINE (430))).isBuiltAndTrue ()) {
      var_cas_code = (var_cas_code)._operator_or (GGS_uint (true, 256U)) ;
    }
    var_cas_code = (var_cas_code)._operator_or ((operand_13349->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (433)))._operator_and (GGS_uint (true, 255U))) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (433)) ;
    }
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_14117 = var_cas_inRoutineSymbolTable ;
    if (_temp_14117._isBuilt ()) {
      _temp_14117 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_13349->mTargetLabel, GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (437)) ;
    }
    GGS_bool var_cas_usesIntermediateBRA ;
    operand_13349->method_usesIntermediateBRA (_inLexique, var_cas_usesIntermediateBRA COMMA_SOURCE_FILE_AT_LINE (438)) ;
    if ((var_cas_usesIntermediateBRA).isBuiltAndTrue ()) {
      GGS_uint  var_cas_intermediateTargetAddress ;
      if ((operand_13349->mUsesBra).isBuiltAndTrue ()) {
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 6U) COMMA_SOURCE_FILE_AT_LINE (442)) ;
      }else{
        var_cas_intermediateTargetAddress = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
      ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (447)),  var_cas_intermediateTargetAddress,  operand_13349->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (445)) ;
      if ((operand_13349->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (452)),  var_cas_targetAddress,  operand_13349->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (451)) ;
      }else{
        ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (453)) ;
      }
    }else{
      if ((operand_13349->mUsesBra).isBuiltAndTrue ()) {
        ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (458)),  var_cas_targetAddress,  operand_13349->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (457)) ;
      }else{
...
category_method__ipic_instruction_RCALL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_RCALL * operand_15068,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15068 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_15203 = var_cas_inRoutineSymbolTable ;
    if (_temp_15203._isBuilt ()) {
      _temp_15203 (HERE)->method_searchKey (_inLexique, operand_15068->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (472)) ;
    }
    ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_15068->mTargetLabel.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (477)) COMMA_SOURCE_FILE_AT_LINE (472)) ;
  }
}
...
category_method__ipic_instruction_CLRWDT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_CLRWDT * operand_15486,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_DAW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_DAW * operand_15741,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15741 != NULL) {
...
category_method__ipic_instruction_NOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_NOP * operand_15996,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_POP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_POP * operand_16251,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_PUSH__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_PUSH * operand_16507,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RESET__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_RESET * operand_16764,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16764 != NULL) {
...
category_method__ipic_instruction_RETURN__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_RETURN * operand_17022,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__ipic_instruction_RETFIE__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_RETFIE * operand_17280,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17280 != NULL) {
    if (GGS_uint (true, 17U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 17U) COMMA_SOURCE_FILE_AT_LINE (549)) ;
    }
  }
}
...
category_method__ipic_instruction_SLEEP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_SLEEP * operand_17537,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17537 != NULL) {
    if (GGS_uint (true, 3U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (558)) ;
    }
  }
}
...
category_method__ipic_instruction_literalOperation__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_literalOperation * operand_17805,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17805 != NULL) {
    GGS_uint  var_cas_code ;
    operand_17805->method_getBaseCode (_inLexique, var_cas_code COMMA_SOURCE_FILE_AT_LINE (569)) ;
    var_cas_code = (var_cas_code)._operator_or (operand_17805->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (570))) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (570)) ;
    }
  }
}
...
category_method__ipic_instruction_LFSR__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_LFSR * operand_18157,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18157 != NULL) {
    if (((GGS_uint (true, 60928U))._operator_or (operand_18157->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (580))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (580))))._operator_or (operand_18157->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (580))._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (580)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  ((GGS_uint (true, 60928U))._operator_or (operand_18157->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (580))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (580))))._operator_or (operand_18157->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (580))._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (580))) COMMA_SOURCE_FILE_AT_LINE (579)) ;
    }
    if ((GGS_uint (true, 61440U))._operator_or ((operand_18157->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (581)))._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or ((operand_18157->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (581)))._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (580)) ;
    }
  }
}
...
category_method__ipic_instruction_MOVLB__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVLB * operand_18560,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18560 != NULL) {
    if ((GGS_uint (true, 256U))._operator_or (operand_18560->mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (590)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 256U))._operator_or (operand_18560->mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (590))) COMMA_SOURCE_FILE_AT_LINE (589)) ;
    }
  }
}
...
category_method__ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_pseudo_LABEL * operand_18832,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18832 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_18967 = var_cas_inRoutineSymbolTable ;
    if (_temp_18967._isBuilt ()) {
      _temp_18967 (HERE)->method_searchKey (_inLexique, operand_18832->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (600)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_18832->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "Internal second pass error: the '"))._operator_concat (operand_18832->mTargetLabel))._operator_concat (GGS_string (true, "' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (603))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (604))))._operator_concat (GGS_string (true, " in first pass")) COMMA_SOURCE_FILE_AT_LINE (604)) ;
    }
  }
}
...
category_method__ipic_instruction_MOVAW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVAW * operand_19410,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19410 != NULL) {
    if ((GGS_uint (true, 3584U))._operator_or (operand_19410->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (614)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 3584U))._operator_or (operand_19410->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (614))) COMMA_SOURCE_FILE_AT_LINE (613)) ;
    }
  }
}
...
category_method__ipic_instruction_TBLRD__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLRD * operand_19709,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19709 != NULL) {
    switch (operand_19709->mOption.enumValue ()) {
    case GGS_tableAccessOption::enum_simpleAccess:
      {
      if (GGS_uint (true, 8U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (624)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (true, 9U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (625)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (true, 10U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 10U) COMMA_SOURCE_FILE_AT_LINE (626)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (true, 11U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 11U) COMMA_SOURCE_FILE_AT_LINE (627)) ;
      }
      }
      break ;
...
category_method__ipic_instruction_TBLWT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLWT * operand_20145,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20145 != NULL) {
    switch (operand_20145->mOption.enumValue ()) {
    case GGS_tableAccessOption::enum_simpleAccess:
      {
      if (GGS_uint (true, 12U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 12U) COMMA_SOURCE_FILE_AT_LINE (638)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (true, 13U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 13U) COMMA_SOURCE_FILE_AT_LINE (639)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (true, 14U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 14U) COMMA_SOURCE_FILE_AT_LINE (640)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (true, 15U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 15U) COMMA_SOURCE_FILE_AT_LINE (641)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::kNotBuilt:
...
category_method__ipic_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MNOP * operand_20580,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20580 != NULL) {
    if (((operand_20580->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (651)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_20580->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (652)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_20918 = operand_20580->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (655)) ;
    GGS_bool _condition_20918 (_variant_20918._isBuilt (), true) ;
    while (_condition_20918.isBuiltAndTrue ()) {
      _condition_20918 = (var_cas_idx)._operator_strictInf (operand_20580->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (656))) ;
      if (_condition_20918.isBuiltAndTrue ()) {
        if (_variant_20918.uintValue () == 0) {
          ...
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (659)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_retlw * operand_21075,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21075 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_21210 = var_cas_inRoutineSymbolTable ;
    if (_temp_21210._isBuilt ()) {
      _temp_21210 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (670)) ;
    }
    if ((operand_21075->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_21075->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (671)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (673)) ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_21453 (operand_21075->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_21453 = NULL ;
      while (((operand_21453 = enumerator_21453.nextObject ()))) {
        macroValidPointer (operand_21453) ;
        if ((GGS_uint (true, 3072U))._operator_or (operand_21453->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (677)))._isBuilt ()) {
          ::routine_emitCode (_inLexique,  (GGS_uint (true, 3072U))._operator_or (operand_21453->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (677))) COMMA_SOURCE_FILE_AT_LINE (676)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_21668,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21668 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_21803 = var_cas_inRoutineSymbolTable ;
    if (_temp_21803._isBuilt ()) {
      _temp_21803 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (688)) ;
    }
    if ((operand_21668->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_21668->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (689)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (691)) ;
    }
    GGS_uint  var_cas_address ;
    var_cas_address = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (694)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_22081 (operand_21668->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22081 = NULL ;
      while (((operand_22081 = enumerator_22081.nextObject ()))) {
        macroValidPointer (operand_22081) ;
        const GGS_symbolTable  _temp_22124 = var_cas_inRoutineSymbolTable ;
        if (_temp_22124._isBuilt ()) {
          _temp_22124 (HERE)->method_searchKey (_inLexique, operand_22081->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (696)) ;
        }
        ::routine_emitBRAinstruction (_inLexique,  var_cas_address,  var_cas_targetAddress,  operand_22081->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (700)) COMMA_SOURCE_FILE_AT_LINE (696)) ;
...
category_method__ipic_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_22438,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22438 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_22573 = var_cas_inRoutineSymbolTable ;
    if (_temp_22573._isBuilt ()) {
      _temp_22573 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (713)) ;
    }
    if ((operand_22438->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_22438->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (714)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (716)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_22815 (operand_22438->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22815 = NULL ;
      while (((operand_22815 = enumerator_22815.nextObject ()))) {
        macroValidPointer (operand_22815) ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_symbolTable  _temp_22891 = var_cas_inRoutineSymbolTable ;
        if (_temp_22891._isBuilt ()) {
          _temp_22891 (HERE)->method_searchKey (_inLexique, operand_22815->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (721)) ;
        }
        ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (721)) ;
      }
    }
  }
}
...
void routine_buildBinaryCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_23645 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_23645 = NULL ;
    while (((operand_23645 = enumerator_23645.nextObject ()))) {
      macroValidPointer (operand_23645) ;
      const GGS_ipic_instruction  _temp_23693 = operand_23645->mInstruction ;
      if (_temp_23693._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__enterLabelAtAddress _method = findCategoryMethod__ipic_instruction__enterLabelAtAddress (_temp_23693._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_23693 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (742)) ;
        }
      }
    }
  }
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_23932 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_23932 = NULL ;
    while (((operand_23932 = enumerator_23932.nextObject ()))) {
      macroValidPointer (operand_23932) ;
      const GGS_ipic_instruction  _temp_23980 = operand_23932->mInstruction ;
      if (_temp_23980._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress (_temp_23980._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_23980 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (749)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic_instruction  _temp_24089 = operand_23932->mInstruction ;
      if (_temp_24089._isBuilt ()) {
        _temp_24089 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (751)) ;
      }
