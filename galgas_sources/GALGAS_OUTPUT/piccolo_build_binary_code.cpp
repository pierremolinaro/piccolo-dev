...
category_method__ipic_instruction_RETFIE__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_17406 != NULL) {
    GGS_uint  var_cas_code ;
    if ((operand_17406->mFastReturn).isBuiltAndTrue ()) {
...
category_method__ipic_instruction_SLEEP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_SLEEP * operand_17782,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17782 != NULL) {
    if (GGS_uint (true, 3U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (564)) ;
    }
  }
}
...
category_method__ipic_instruction_literalOperation__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_literalOperation * operand_18050,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18050 != NULL) {
    GGS_uint  var_cas_code ;
    operand_18050->method_getBaseCode (_inLexique, var_cas_code COMMA_SOURCE_FILE_AT_LINE (575)) ;
    var_cas_code = (var_cas_code)._operator_or (operand_18050->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (576))) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (576)) ;
    }
  }
}
...
category_method__ipic_instruction_LFSR__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_LFSR * operand_18402,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18402 != NULL) {
    if (((GGS_uint (true, 60928U))._operator_or (operand_18402->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (586))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (586))))._operator_or (operand_18402->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (586))._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (586)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  ((GGS_uint (true, 60928U))._operator_or (operand_18402->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (586))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (586))))._operator_or (operand_18402->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (586))._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (586))) COMMA_SOURCE_FILE_AT_LINE (585)) ;
    }
    if ((GGS_uint (true, 61440U))._operator_or ((operand_18402->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (587)))._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or ((operand_18402->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (587)))._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (586)) ;
    }
  }
}
...
category_method__ipic_instruction_MOVLB__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVLB * operand_18805,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18805 != NULL) {
    if ((GGS_uint (true, 256U))._operator_or (operand_18805->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (596)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 256U))._operator_or (operand_18805->mBankIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (596))) COMMA_SOURCE_FILE_AT_LINE (595)) ;
    }
  }
}
...
category_method__ipic_pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_pseudo_LABEL * operand_19077,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19077 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_19212 = var_cas_inRoutineSymbolTable ;
    if (_temp_19212._isBuilt ()) {
      _temp_19212 (HERE)->method_searchKey (_inLexique, operand_19077->mLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (606)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_19077->mLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "Internal second pass error: the '"))._operator_concat (operand_19077->mLabel))._operator_concat (GGS_string (true, "' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (609))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (610))))._operator_concat (GGS_string (true, " in first pass")) COMMA_SOURCE_FILE_AT_LINE (610)) ;
    }
  }
}
...
category_method__ipic_instruction_MOVAW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MOVAW * operand_19637,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19637 != NULL) {
    if ((GGS_uint (true, 3584U))._operator_or (operand_19637->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (620)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 3584U))._operator_or (operand_19637->mRegisterDescription.reader_mRegisterAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (620))) COMMA_SOURCE_FILE_AT_LINE (619)) ;
    }
  }
}
...
category_method__ipic_instruction_TBLRD__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLRD * operand_19936,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19936 != NULL) {
    switch (operand_19936->mOption.enumValue ()) {
    case GGS_tableAccessOption::enum_simpleAccess:
      {
      if (GGS_uint (true, 8U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (630)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (true, 9U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (631)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (true, 10U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 10U) COMMA_SOURCE_FILE_AT_LINE (632)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (true, 11U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 11U) COMMA_SOURCE_FILE_AT_LINE (633)) ;
      }
      }
      break ;
...
category_method__ipic_instruction_TBLWT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_TBLWT * operand_20372,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20372 != NULL) {
    switch (operand_20372->mOption.enumValue ()) {
    case GGS_tableAccessOption::enum_simpleAccess:
      {
      if (GGS_uint (true, 12U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 12U) COMMA_SOURCE_FILE_AT_LINE (644)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (true, 13U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 13U) COMMA_SOURCE_FILE_AT_LINE (645)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (true, 14U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 14U) COMMA_SOURCE_FILE_AT_LINE (646)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (true, 15U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 15U) COMMA_SOURCE_FILE_AT_LINE (647)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::kNotBuilt:
...
category_method__ipic_instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_MNOP * operand_20807,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20807 != NULL) {
    if (((operand_20807->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (657)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_20807->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (658)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_21145 = operand_20807->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (661)) ;
    GGS_bool _condition_21145 (_variant_21145._isBuilt (), true) ;
    while (_condition_21145.isBuiltAndTrue ()) {
      _condition_21145 = (var_cas_idx)._operator_strictInf (operand_20807->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (662))) ;
      if (_condition_21145.isBuiltAndTrue ()) {
        if (_variant_21145.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (665)) ;
          _condition_21145 = GGS_bool (true, false) ;
        }else{
          _variant_21145._decrement_operation (_inLexique COMMA_HERE) ;
          if (GGS_uint (true, 0U)._isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (663)) ;
          }
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (665)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_retlw * operand_21302,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21302 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_21437 = var_cas_inRoutineSymbolTable ;
    if (_temp_21437._isBuilt ()) {
      _temp_21437 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (676)) ;
    }
    if ((operand_21302->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_21302->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (677)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (679)) ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_21673 (operand_21302->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_21673 = NULL ;
      while (((operand_21673 = enumerator_21673.nextObject ()))) {
        macroValidPointer (operand_21673) ;
        if ((GGS_uint (true, 3072U))._operator_or (operand_21673->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (683)))._isBuilt ()) {
          ::routine_emitCode (_inLexique,  (GGS_uint (true, 3072U))._operator_or (operand_21673->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (683))) COMMA_SOURCE_FILE_AT_LINE (682)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_21888,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21888 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_22023 = var_cas_inRoutineSymbolTable ;
    if (_temp_22023._isBuilt ()) {
      _temp_22023 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (694)) ;
    }
    if ((operand_21888->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_21888->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (695)) ;
    }else{
    ...
    var_cas_addressForComputingBRA = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (701)) ;
    if (((operand_21888->mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_addressForComputingBRA = var_cas_addressForComputingBRA._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (703)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_22440 (operand_21888->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22440 = NULL ;
      while (((operand_22440 = enumerator_22440.nextObject ()))) {
        macroValidPointer (operand_22440) ;
        const GGS_symbolTable  _temp_22483 = var_cas_inRoutineSymbolTable ;
        if (_temp_22483._isBuilt ()) {
          _temp_22483 (HERE)->method_searchKey (_inLexique, operand_22440->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (707)) ;
        }
        ::routine_emitBRAinstruction (_inLexique,  var_cas_addressForComputingBRA,  var_cas_targetAddress,  operand_22440->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (711)) COMMA_SOURCE_FILE_AT_LINE (707)) ;
        var_cas_addressForComputingBRA = var_cas_addressForComputingBRA._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (713)) ;
      }
    }
  }
}
...
category_method__ipic_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_22842,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22842 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_22977 = var_cas_inRoutineSymbolTable ;
    if (_temp_22977._isBuilt ()) {
      _temp_22977 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (724)) ;
    }
    if ((operand_22842->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_22842->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (725)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (727)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_23212 (operand_22842->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_23212 = NULL ;
      while (((operand_23212 = enumerator_23212.nextObject ()))) {
        macroValidPointer (operand_23212) ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_symbolTable  _temp_23288 = var_cas_inRoutineSymbolTable ;
        if (_temp_23288._isBuilt ()) {
          _temp_23288 (HERE)->method_searchKey (_inLexique, operand_23212->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (732)) ;
        }
        ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (732)) ;
      }
    }
  }
}
...
void routine_buildBinaryCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_24095 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_24095 = NULL ;
    while (((operand_24095 = enumerator_24095.nextObject ()))) {
      macroValidPointer (operand_24095) ;
      const GGS_ipic_instruction  _temp_24143 = operand_24095->mInstruction ;
      if (_temp_24143._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__enterLabelAtAddress _method = findCategoryMethod__ipic_instruction__enterLabelAtAddress (_temp_24143._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_24143 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (754)) ;
        }
      }
    }
  }
  ...
  var_cas_currentAddress = GGS_uint (true, 0U) ;
  if (GGS_uint (true, 0U)._isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (758)) ;
  }
  {
    GGS_ipic_instructionList::cEnumerator enumerator_24382 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_24382 = NULL ;
    while (((operand_24382 = enumerator_24382.nextObject ()))) {
      macroValidPointer (operand_24382) ;
      const GGS_ipic_instruction  _temp_24430 = operand_24382->mInstruction ;
      if (_temp_24430._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress (_temp_24430._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_24430 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (761)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic_instruction  _temp_24539 = operand_24382->mInstruction ;
      if (_temp_24539._isBuilt ()) {
        _temp_24539 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (763)) ;
      }
      var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (764)) ;
      ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (764)) ;
    }
  }
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (768))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (770))))._operator_concat (GGS_string (true, " value in first pass")) COMMA_SOURCE_FILE_AT_LINE (770)) ;
  }else if (((var_cas_lastAddressForFirstPass)._operator_strictSup (var_cas_inROMsize)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Program too large: "))._operator_concat (var_cas_lastAddressForFirstPass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (772))))._operator_concat (GGS_string (true, " bytes (rom size is ")))._operator_concat (var_cas_inROMsize.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (774))))._operator_concat (GGS_string (true, " bytes)")) COMMA_SOURCE_FILE_AT_LINE (774)) ;
  }
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_25229 (var_cas_inActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_25229 = NULL ;
    while (((operand_25229 = enumerator_25229.nextObject ()))) {
      macroValidPointer (operand_25229) ;
      if (operand_25229->mInfo.mRegisterAddress._isBuilt ()) {
        ::routine_setEmitAddress (_inLexique,  operand_25229->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (777)) ;
      }
      if (operand_25229->mInfo.mRegisterValue._isBuilt ()) {
        ::routine_emitCode (_inLexique,  operand_25229->mInfo.mRegisterValue COMMA_SOURCE_FILE_AT_LINE (778)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
