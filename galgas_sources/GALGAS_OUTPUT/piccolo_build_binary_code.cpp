...
category_method__instruction_conditionalBranch__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_conditionalBranch * operand_8501,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8501 != NULL) {
    ...
    const GGS_symbolTable  _temp_8678 = var_cas_inRoutineSymbolTable ;
    if (_temp_8678._isBuilt ()) {
      _temp_8678 (HERE)->method_searchKey (_inLexique, operand_8501->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (261)) ;
    }
    ::routine_emitConditionalBranchInstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_8501->mTargetLabel.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (266)),  operand_8501->mConditionalBranch COMMA_SOURCE_FILE_AT_LINE (261)) ;
  }
}
...
void routine_emitBRAinstruction (C_Compiler & _inLexique,
  ...
  #endif
  GGS_sint  var_cas_displacement ;
  var_cas_displacement = var_cas_inTargetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (278))._substract_operation (_inLexique, GGS_sint (true, 2L) COMMA_SOURCE_FILE_AT_LINE (278))._substract_operation (_inLexique, var_cas_inBRAinstructionAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (278))._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (278)) ;
  if ((((var_cas_displacement)._operator_strictSup (GGS_sint (true, 1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (true, 1024L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "displacement too large for BRA instruction") COMMA_SOURCE_FILE_AT_LINE (280)) ;
  }
  if ((GGS_uint (true, 53248U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (true, 2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 53248U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (true, 2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (283))) COMMA_SOURCE_FILE_AT_LINE (281)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__instruction_BRA__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_BRA * operand_9517,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9517 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_9693 = var_cas_inRoutineSymbolTable ;
    if (_temp_9693._isBuilt ()) {
      _temp_9693 (HERE)->method_searchKey (_inLexique, operand_9517->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (294)) ;
    }
    GGS_sint  var_cas_displacement ;
    var_cas_displacement = var_cas_targetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (296))._substract_operation (_inLexique, GGS_sint (true, 2L) COMMA_SOURCE_FILE_AT_LINE (296))._substract_operation (_inLexique, var_cas_ioAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296))._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (296)) ;
    if ((((var_cas_displacement)._operator_strictSup (GGS_sint (true, 2048L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (true, 2048L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
      operand_9517->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "displacement too large for RCALL instruction") COMMA_SOURCE_FILE_AT_LINE (298)) ;
    }
    ::routine_emitBRAinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_9517->mTargetLabel.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (299)) ;
  }
}
...
void routine_emitGOTOinstruction (C_Compiler & _inLexique,
  ...
  #endif
  if ((GGS_uint (true, 61184U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (313)))._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 61184U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (313)))._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (312)) ;
  }
  if ((GGS_uint (true, 61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (314)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (314))) COMMA_SOURCE_FILE_AT_LINE (313)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__instruction_GOTO__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_GOTO * operand_10457,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10457 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_10641 = var_cas_inRoutineSymbolTable ;
    if (_temp_10641._isBuilt ()) {
      _temp_10641 (HERE)->method_searchKey (_inLexique, operand_10457->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (325)) ;
    }
    ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (325)) ;
  }
}
...
void routine_emitCALLinstruction (C_Compiler & _inLexique,
  ...
  #endif
  if ((GGS_uint (true, 60416U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (335)))._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 60416U))._operator_or ((var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (335)))._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (334)) ;
  }
  if ((GGS_uint (true, 61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (336)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or (var_cas_inTargetAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (336))) COMMA_SOURCE_FILE_AT_LINE (335)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__instruction_CALL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_CALL * operand_11117,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11117 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_11301 = var_cas_inRoutineSymbolTable ;
    if (_temp_11301._isBuilt ()) {
      _temp_11301 (HERE)->method_searchKey (_inLexique, operand_11117->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (347)) ;
    }
...
void routine_emitRCALLinstruction (C_Compiler & _inLexique,
  ...
  #endif
  GGS_sint  var_cas_displacement ;
  var_cas_displacement = var_cas_inTargetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (359))._substract_operation (_inLexique, GGS_sint (true, 2L) COMMA_SOURCE_FILE_AT_LINE (359))._substract_operation (_inLexique, var_cas_inRCALLinstructionAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359))._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (359)) ;
  if ((((var_cas_displacement)._operator_strictSup (GGS_sint (true, 1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (true, 1024L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "displacement too large for RCALL instruction") COMMA_SOURCE_FILE_AT_LINE (361)) ;
  }
  if ((GGS_uint (true, 55296U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (true, 2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (364)))._isBuilt ()) {
    ::routine_emitCode (_inLexique,  (GGS_uint (true, 55296U))._operator_or ((var_cas_displacement)._operator_and (GGS_sint (true, 2047L)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (364))) COMMA_SOURCE_FILE_AT_LINE (362)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__instruction_RCALL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_RCALL * operand_12063,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12063 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_12240 = var_cas_inRoutineSymbolTable ;
    if (_temp_12240._isBuilt ()) {
      _temp_12240 (HERE)->method_searchKey (_inLexique, operand_12063->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (375)) ;
    }
    ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_12063->mTargetLabel.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (380)) COMMA_SOURCE_FILE_AT_LINE (375)) ;
  }
}
...
category_method__instruction_CLRWDT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_CLRWDT * operand_12518,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12518 != NULL) {
    if (GGS_uint (true, 4U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
  }
}
...
category_method__instruction_DAW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_DAW * operand_12810,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12810 != NULL) {
    if (GGS_uint (true, 7U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 7U) COMMA_SOURCE_FILE_AT_LINE (400)) ;
    }
  }
}
...
category_method__instruction_NOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_NOP * operand_13102,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13102 != NULL) {
    if (GGS_uint (true, 0U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (410)) ;
    }
  }
}
...
category_method__instruction_POP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_POP * operand_13394,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13394 != NULL) {
    if (GGS_uint (true, 6U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 6U) COMMA_SOURCE_FILE_AT_LINE (420)) ;
    }
  }
}
...
category_method__instruction_PUSH__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_PUSH * operand_13687,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13687 != NULL) {
    if (GGS_uint (true, 5U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 5U) COMMA_SOURCE_FILE_AT_LINE (430)) ;
    }
  }
}
...
category_method__instruction_RESET__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_RESET * operand_13981,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13981 != NULL) {
    if (GGS_uint (true, 255U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 255U) COMMA_SOURCE_FILE_AT_LINE (440)) ;
    }
  }
}
...
category_method__instruction_RETURN__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_RETURN * operand_14276,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14276 != NULL) {
    if (GGS_uint (true, 18U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 18U) COMMA_SOURCE_FILE_AT_LINE (450)) ;
    }
  }
}
...
category_method__instruction_RETFIE__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_RETFIE * operand_14571,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14571 != NULL) {
    if (GGS_uint (true, 17U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 17U) COMMA_SOURCE_FILE_AT_LINE (460)) ;
    }
  }
}
...
category_method__instruction_SLEEP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_SLEEP * operand_14865,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14865 != NULL) {
    if (GGS_uint (true, 3U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 3U) COMMA_SOURCE_FILE_AT_LINE (470)) ;
    }
  }
}
...
category_method__instruction_literalOperation__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_literalOperation * operand_15170,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15170 != NULL) {
    GGS_uint  var_cas_code ;
    operand_15170->method_getBaseCode (_inLexique, var_cas_code COMMA_SOURCE_FILE_AT_LINE (482)) ;
    var_cas_code = (var_cas_code)._operator_or (operand_15170->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (483))) ;
    if (var_cas_code._isBuilt ()) {
      ::routine_emitCode (_inLexique,  var_cas_code COMMA_SOURCE_FILE_AT_LINE (483)) ;
    }
  }
}
...
category_method__instruction_LFSR__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_LFSR * operand_15559,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15559 != NULL) {
    GGS_uint  var_cas_sourceRegisterAddress ;
    const GGS_registerExpression  _temp_15750 = operand_15559->mRegisterExpression ;
    if (_temp_15750._isBuilt ()) {
      typeCategoryMethod__registerExpression__getRegisterAddress _method = findCategoryMethod__registerExpression__getRegisterAddress (_temp_15750._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_15750 (HERE), var_cas_inRegisterTable, var_cas_sourceRegisterAddress COMMA_SOURCE_FILE_AT_LINE (495)) ;
      }
    }
    if (((GGS_uint (true, 60928U))._operator_or (operand_15559->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (496))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (496))))._operator_or (var_cas_sourceRegisterAddress._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (496)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  ((GGS_uint (true, 60928U))._operator_or (operand_15559->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (496))._left_shift_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (496))))._operator_or (var_cas_sourceRegisterAddress._right_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (496))) COMMA_SOURCE_FILE_AT_LINE (495)) ;
    }
    if ((GGS_uint (true, 61440U))._operator_or ((var_cas_sourceRegisterAddress)._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or ((var_cas_sourceRegisterAddress)._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (496)) ;
    }
  }
}
...
category_method__instruction_MOVLB__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_MOVLB * operand_16073,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16073 != NULL) {
    if ((GGS_uint (true, 256U))._operator_or (operand_16073->mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (507)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 256U))._operator_or (operand_16073->mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (507))) COMMA_SOURCE_FILE_AT_LINE (506)) ;
    }
  }
}
...
category_method__pseudo_LABEL__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_pseudo_LABEL * operand_16382,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16382 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_16559 = var_cas_inRoutineSymbolTable ;
    if (_temp_16559._isBuilt ()) {
      _temp_16559 (HERE)->method_searchKey (_inLexique, operand_16382->mTargetLabel, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (518)) ;
    }
    if (((var_cas_targetAddress)._operator_isNotEqual (var_cas_ioAddress)).isBuiltAndTrue ()) {
      operand_16382->mTargetLabel.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((GGS_string (true, "Internal second pass error: the '"))._operator_concat (operand_16382->mTargetLabel))._operator_concat (GGS_string (true, "' label gets ")))._operator_concat (var_cas_ioAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (521))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_targetAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (522))))._operator_concat (GGS_string (true, " in first pass")) COMMA_SOURCE_FILE_AT_LINE (522)) ;
    }
  }
}
...
category_method__instruction_MOVAW__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_MOVAW * operand_16997,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16997 != NULL) {
    ...
    const GGS_registerExpression  _temp_17182 = operand_16997->mRegisterExpression ;
    if (_temp_17182._isBuilt ()) {
      typeCategoryMethod__registerExpression__getRegisterAddress _method = findCategoryMethod__registerExpression__getRegisterAddress (_temp_17182._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_17182 (HERE), var_cas_inRegisterTable, var_cas_registerAddress COMMA_SOURCE_FILE_AT_LINE (534)) ;
      }
    }
    if ((GGS_uint (true, 3584U))._operator_or (var_cas_registerAddress)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 3584U))._operator_or (var_cas_registerAddress) COMMA_SOURCE_FILE_AT_LINE (537)) ;
    }
  }
}
...
category_method__instruction_TBLRD__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_TBLRD * operand_17418,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17418 != NULL) {
    switch (operand_17418->mOption.enumValue ()) {
    case GGS_tableAccessOption::enum_simpleAccess:
      {
      if (GGS_uint (true, 8U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (549)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (true, 9U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (550)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (true, 10U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 10U) COMMA_SOURCE_FILE_AT_LINE (551)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (true, 11U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 11U) COMMA_SOURCE_FILE_AT_LINE (552)) ;
      }
      }
      break ;
...
category_method__instruction_TBLWT__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_TBLWT * operand_17891,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17891 != NULL) {
    switch (operand_17891->mOption.enumValue ()) {
    case GGS_tableAccessOption::enum_simpleAccess:
      {
      if (GGS_uint (true, 12U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 12U) COMMA_SOURCE_FILE_AT_LINE (564)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postIncrement:
      ...
      if (GGS_uint (true, 13U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 13U) COMMA_SOURCE_FILE_AT_LINE (565)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_postDecrement:
      ...
      if (GGS_uint (true, 14U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 14U) COMMA_SOURCE_FILE_AT_LINE (566)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::enum_preIncrement:
      ...
      if (GGS_uint (true, 15U)._isBuilt ()) {
        ::routine_emitCode (_inLexique,  GGS_uint (true, 15U) COMMA_SOURCE_FILE_AT_LINE (567)) ;
      }
      }
      break ;
    case GGS_tableAccessOption::kNotBuilt:
...
category_method__instruction_MNOP__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_MNOP * operand_18363,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   /* var_cas_inRoutineSymbolTable */,
                                GGS_uint  & /* var_cas_ioAddress */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18363 != NULL) {
    if (((operand_18363->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (578)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_18363->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "No generated code") COMMA_SOURCE_FILE_AT_LINE (579)) ;
    }
    GGS_uint  var_cas_idx ;
    var_cas_idx = GGS_uint (true, 0U) ;
    GGS_uint _variant_18743 = operand_18363->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (582)) ;
    GGS_bool _condition_18743 (_variant_18743._isBuilt (), true) ;
    while (_condition_18743.isBuiltAndTrue ()) {
      _condition_18743 = (var_cas_idx)._operator_strictInf (operand_18363->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (583))) ;
      if (_condition_18743.isBuiltAndTrue ()) {
        if (_variant_18743.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (586)) ;
          _condition_18743 = GGS_bool (true, false) ;
        }else{
          _variant_18743._decrement_operation (_inLexique COMMA_HERE) ;
          if (GGS_uint (true, 0U)._isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (584)) ;
          }
          var_cas_idx._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (586)) ;
        }
      }
    }
  }
...
category_method__instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_retlw * operand_18895,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18895 != NULL) {
    ...
    if (_temp_19073._isBuilt ()) {
      _temp_19073 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (598)) ;
    }
    if ((operand_18895->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_18895->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (599)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (601)) ;
    }
    {
      GGS_luintlist::cEnumerator enumerator_19316 (operand_18895->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_19316 = NULL ;
      while (((operand_19316 = enumerator_19316.nextObject ()))) {
        macroValidPointer (operand_19316) ;
        if ((GGS_uint (true, 3072U))._operator_or (operand_19316->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (605)))._isBuilt ()) {
          ::routine_emitCode (_inLexique,  (GGS_uint (true, 3072U))._operator_or (operand_19316->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (605))) COMMA_SOURCE_FILE_AT_LINE (604)) ;
        }
      }
    }
  }
...
category_method__instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_bra * operand_19526,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19526 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_19703 = var_cas_inRoutineSymbolTable ;
    if (_temp_19703._isBuilt ()) {
      _temp_19703 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (617)) ;
    }
    if ((operand_19526->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_19526->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (618)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (620)) ;
    }
    GGS_uint  var_cas_address ;
    var_cas_address = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (623)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_19981 (operand_19526->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_19981 = NULL ;
      while (((operand_19981 = enumerator_19981.nextObject ()))) {
        macroValidPointer (operand_19981) ;
        const GGS_symbolTable  _temp_20024 = var_cas_inRoutineSymbolTable ;
        if (_temp_20024._isBuilt ()) {
          _temp_20024 (HERE)->method_searchKey (_inLexique, operand_19981->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (625)) ;
        }
        ::routine_emitBRAinstruction (_inLexique,  var_cas_address,  var_cas_targetAddress,  operand_19981->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (625)) ;
        var_cas_address = var_cas_address._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (631)) ;
      }
    }
  }
}
...
category_method__instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_goto * operand_20333,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20333 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_20510 = var_cas_inRoutineSymbolTable ;
    if (_temp_20510._isBuilt ()) {
      _temp_20510 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (643)) ;
    }
    if ((operand_20333->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_20333->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (644)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (646)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_20752 (operand_20333->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_20752 = NULL ;
      while (((operand_20752 = enumerator_20752.nextObject ()))) {
        macroValidPointer (operand_20752) ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_symbolTable  _temp_20828 = var_cas_inRoutineSymbolTable ;
        if (_temp_20828._isBuilt ()) {
          _temp_20828 (HERE)->method_searchKey (_inLexique, operand_20752->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (651)) ;
        }
        ::routine_emitGOTOinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (651)) ;
      }
    }
  }
}
...
void routine_buildBinaryCode (C_Compiler & _inLexique,
  ...
  {
    GGS_instructionList::cEnumerator enumerator_21592 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_instructionList::cElement * operand_21592 = NULL ;
    while (((operand_21592 = enumerator_21592.nextObject ()))) {
      macroValidPointer (operand_21592) ;
      const GGS_instruction  _temp_21640 = operand_21592->mInstruction ;
      if (_temp_21640._isBuilt ()) {
        typeCategoryMethod__instruction__enterLabelAtAddress _method = findCategoryMethod__instruction__enterLabelAtAddress (_temp_21640._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_21640 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (672)) ;
        }
      }
    }
  }
  ...
  var_cas_currentAddress = GGS_uint (true, 0U) ;
  if (GGS_uint (true, 0U)._isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (676)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_21879 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_instructionList::cElement * operand_21879 = NULL ;
    while (((operand_21879 = enumerator_21879.nextObject ()))) {
      macroValidPointer (operand_21879) ;
      const GGS_instruction  _temp_21927 = operand_21879->mInstruction ;
      if (_temp_21927._isBuilt ()) {
        typeCategoryMethod__instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__instruction__generateBinaryCodeAtAddress (_temp_21927._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_21927 (HERE), var_cas_inRegisterTable, var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (679)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_instruction  _temp_22053 = operand_21879->mInstruction ;
      if (_temp_22053._isBuilt ()) {
        _temp_22053 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (681)) ;
      }
      var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (682)) ;
      ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (682)) ;
    }
  }
  if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (686))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (688))))._operator_concat (GGS_string (true, " value in first pass")) COMMA_SOURCE_FILE_AT_LINE (688)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
