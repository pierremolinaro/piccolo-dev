...
category_method__ipic_instruction_MOVLB__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_18686 != NULL) {
    if ((GGS_uint (true, 256U))._operator_or (operand_18686->mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (589)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 256U))._operator_or (operand_18686->mPageIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (589))) COMMA_SOURCE_FILE_AT_LINE (588)) ;
    }
  }
}
...
category_method__ipic_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_21769 != NULL) {
    ...
    {
      GGS_lstringlist::cEnumerator enumerator_22175 (operand_21769->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22175 = NULL ;
      while (((operand_22175 = enumerator_22175.nextObject ()))) {
        macroValidPointer (operand_22175) ;
        const GGS_symbolTable  _temp_22218 = var_cas_inRoutineSymbolTable ;
        if (_temp_22218._isBuilt ()) {
          _temp_22218 (HERE)->method_searchKey (_inLexique, operand_22175->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (695)) ;
        }
        ::routine_emitBRAinstruction (_inLexique,  var_cas_address,  var_cas_targetAddress,  operand_22175->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (699)) COMMA_SOURCE_FILE_AT_LINE (695)) ;
...
category_method__ipic_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_22532 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_22667 = var_cas_inRoutineSymbolTable ;
    if (_temp_22667._isBuilt ()) {
      _temp_22667 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (712)) ;
    }
    if ((operand_22532->mUsesRCALL).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_22532->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (713)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (715)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_22902 (operand_22532->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22902 = NULL ;
      while (((operand_22902 = enumerator_22902.nextObject ()))) {
        macroValidPointer (operand_22902) ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_symbolTable  _temp_22978 = var_cas_inRoutineSymbolTable ;
        if (_temp_22978._isBuilt ()) {
          _temp_22978 (HERE)->method_searchKey (_inLexique, operand_22902->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (720)) ;
        }
...
void routine_buildBinaryCode (C_Compiler & _inLexique,
  ...
  var_cas_currentAddress = GGS_uint (true, 0U) ;
  {
    ...
    while (((operand_23785 = enumerator_23785.nextObject ()))) {
      ...
      const GGS_ipic_instruction  _temp_23833 = operand_23785->mInstruction ;
      if (_temp_23833._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__enterLabelAtAddress _method = findCategoryMethod__ipic_instruction__enterLabelAtAddress (_temp_23833._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_23833 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (742)) ;
        }
      }
    }
  }
  ...
  }
  {
    ...
    while (((operand_24072 = enumerator_24072.nextObject ()))) {
      ...
      const GGS_ipic_instruction  _temp_24120 = operand_24072->mInstruction ;
      if (_temp_24120._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress (_temp_24120._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_24120 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (749)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic_instruction  _temp_24229 = operand_24072->mInstruction ;
      if (_temp_24229._isBuilt ()) {
        _temp_24229 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (751)) ;
      }
  ...
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_24919 (var_cas_inActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_24919 = NULL ;
    while (((operand_24919 = enumerator_24919.nextObject ()))) {
      macroValidPointer (operand_24919) ;
      if (operand_24919->mInfo.mRegisterAddress._isBuilt ()) {
        ::routine_setEmitAddress (_inLexique,  operand_24919->mInfo.mRegisterAddress COMMA_SOURCE_FILE_AT_LINE (765)) ;
      }
      if (operand_24919->mInfo.mRegisterValue._isBuilt ()) {
        ::routine_emitCode (_inLexique,  operand_24919->mInfo.mRegisterValue COMMA_SOURCE_FILE_AT_LINE (766)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
