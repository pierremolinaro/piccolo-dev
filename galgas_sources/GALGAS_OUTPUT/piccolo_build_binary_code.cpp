...
category_method__ipic_instruction_computed_retlw__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
  ...
  if (operand_21577 != NULL) {
    ...
    if ((operand_21577->mUsesRelativeCall).isBuiltAndTrue ()) {
    ...
    {
      GGS_luintlist::cEnumerator enumerator_21955 (operand_21577->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_21955 = NULL ;
      while (((operand_21955 = enumerator_21955.nextObject ()))) {
        macroValidPointer (operand_21955) ;
        if ((GGS_uint (true, 3072U))._operator_or (operand_21955->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (697)))._isBuilt ()) {
          ::routine_emitCode (_inLexique,  (GGS_uint (true, 3072U))._operator_or (operand_21955->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (697))) COMMA_SOURCE_FILE_AT_LINE (696)) ;
        }
      }
    }
  }
...
category_method__ipic_instruction_computed_bra__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_bra * operand_22170,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22170 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_22305 = var_cas_inRoutineSymbolTable ;
    if (_temp_22305._isBuilt ()) {
      _temp_22305 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_2"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (708)) ;
    }
    if ((operand_22170->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_22170->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (709)) ;
    }else{
    ...
    {
      GGS_lstringlist::cEnumerator enumerator_22583 (operand_22170->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_22583 = NULL ;
      while (((operand_22583 = enumerator_22583.nextObject ()))) {
        macroValidPointer (operand_22583) ;
        const GGS_symbolTable  _temp_22626 = var_cas_inRoutineSymbolTable ;
        if (_temp_22626._isBuilt ()) {
          _temp_22626 (HERE)->method_searchKey (_inLexique, operand_22583->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (716)) ;
        }
        ::routine_emitBRAinstruction (_inLexique,  var_cas_address,  var_cas_targetAddress,  operand_22583->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (720)) COMMA_SOURCE_FILE_AT_LINE (716)) ;
...
category_method__ipic_instruction_computed_goto__generateBinaryCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_22940,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22940 != NULL) {
    GGS_uint  var_cas_targetAddress ;
    const GGS_symbolTable  _temp_23075 = var_cas_inRoutineSymbolTable ;
    if (_temp_23075._isBuilt ()) {
      _temp_23075 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (733)) ;
    }
    if ((operand_22940->mUsesRelativeCall).isBuiltAndTrue ()) {
      ::routine_emitRCALLinstruction (_inLexique,  var_cas_ioAddress,  var_cas_targetAddress,  operand_22940->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (734)) ;
    }else{
      ::routine_emitCALLinstruction (_inLexique,  var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (736)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_23317 (operand_22940->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_23317 = NULL ;
      while (((operand_23317 = enumerator_23317.nextObject ()))) {
        macroValidPointer (operand_23317) ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_symbolTable  _temp_23393 = var_cas_inRoutineSymbolTable ;
        if (_temp_23393._isBuilt ()) {
          _temp_23393 (HERE)->method_searchKey (_inLexique, operand_23317->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (741)) ;
        }
...
void routine_buildBinaryCode (C_Compiler & _inLexique,
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_24147 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_24147 = NULL ;
    while (((operand_24147 = enumerator_24147.nextObject ()))) {
      macroValidPointer (operand_24147) ;
      const GGS_ipic_instruction  _temp_24195 = operand_24147->mInstruction ;
      if (_temp_24195._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__enterLabelAtAddress _method = findCategoryMethod__ipic_instruction__enterLabelAtAddress (_temp_24195._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_24195 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (762)) ;
        }
      }
    }
  }
  ...
  {
    GGS_ipic_instructionList::cEnumerator enumerator_24434 (var_cas_inGeneratedInstructionList, true) ;
    const GGS_ipic_instructionList::cElement * operand_24434 = NULL ;
    while (((operand_24434 = enumerator_24434.nextObject ()))) {
      macroValidPointer (operand_24434) ;
      const GGS_ipic_instruction  _temp_24482 = operand_24434->mInstruction ;
      if (_temp_24482._isBuilt ()) {
        typeCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress _method = findCategoryMethod__ipic_instruction__generateBinaryCodeAtAddress (_temp_24482._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_24482 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (769)) ;
        }
      }
      GGS_uint  var_cas_instructionLength ;
      const GGS_ipic_instruction  _temp_24591 = operand_24434->mInstruction ;
      if (_temp_24591._isBuilt ()) {
        _temp_24591 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (771)) ;
      }
