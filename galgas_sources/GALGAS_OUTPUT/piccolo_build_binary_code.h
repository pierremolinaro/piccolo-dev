...
//---------------------------------------------------------------------------*
//                                                                           *
//        Category method '@instruction.generateBinaryCodeAtAddress'         *
//                                                                           *
//---------------------------------------------------------------------------*

typedef void (*typeCategoryMethod__instruction__generateBinaryCodeAtAddress)  (C_Compiler & _inLexique,
                                const cPtr_instruction * inObjectPtr,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_symbolTable   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress
...
void routine_buildBinaryCode (C_Compiler &,
                                ...
                                const GGS_instructionList   COMMA_LOCATION_ARGS) ;
