...
#import "piccolo_lexique.h"
#import "piccolo_options.h"
...
static const unsigned kBoolOptionCount = 16 ;
...
static const unsigned kStringOptionCount = 4 ;
...
static piccolo_options gOption0 ;
...
static piccolo_lexique * gScannerPtr = NULL ;
...
static uint16 kPopUpListData_21 [] = {1, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_22 [] = {135, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_29 [] = {1, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_33 [] = {1, 0} ;
...
sint32 getStylesCount (void) {
  return piccolo_lexique::getStylesCount () ;
}

//---------------------------------------------------------------------------*

const char * getStyleName (const sint32 inIndex) {
  return piccolo_lexique::getStyleName (inIndex) ;
}

//---------------------------------------------------------------------------*

const char * getStyleIdentifier (const sint32 inIndex) {
  return piccolo_lexique::getStyleIdentifier (inIndex) ;
}
...
scanThenGetStyledRangeArray (NSString * inSourceString,
  ...
  if (gScannerPtr == NULL) {
    ...
    macroMyNew (gScannerPtr, piccolo_lexique (NULL, "", "", gIOParametersPtr, "" COMMA_HERE)) ;
  }
