...
void routine_actualBuildConfig (C_Compiler & _inLexique,
  ...
  {
    GGS_configRegisterMap::cEnumerator enumerator_1196 (var_cas_inConfigRegisterMap, true) ;
    const GGS_configRegisterMap::cElement * operand_1196 = NULL ;
    while (((operand_1196 = enumerator_1196.nextObject ()))) {
      macroValidPointer (operand_1196) ;
      GGS_uint  var_cas_defaultValue ;
      var_cas_defaultValue = GGS_uint (true, 1U)._left_shift_operation (_inLexique, operand_1196->mInfo.mRegisterWidth.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (31)) COMMA_SOURCE_FILE_AT_LINE (31))._substract_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (31)) ;
      var_cas_temporaryActualConfigurationMap.modifier_insertKey (_inLexique, operand_1196->mKey, operand_1196->mInfo.mRegisterAddress.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (32)), var_cas_defaultValue COMMA_SOURCE_FILE_AT_LINE (32)) ;
      GGS_lstring  var_cas_registerName ;
      var_cas_registerName = operand_1196->mKey ;
      {
        GGS_configRegisterMaskMap::cEnumerator enumerator_1423 (operand_1196->mInfo.mConfigRegisterMaskMap, true) ;
        const GGS_configRegisterMaskMap::cElement * operand_1423 = NULL ;
        while (((operand_1423 = enumerator_1423.nextObject ()))) {
          macroValidPointer (operand_1423) ;
          var_cas_configFieldMap.modifier_insertKey (_inLexique, operand_1423->mKey, var_cas_registerName, operand_1423->mInfo.mMaskValue, operand_1423->mInfo.mDescription, operand_1423->mInfo.mFieldSettingMap COMMA_SOURCE_FILE_AT_LINE (35)) ;
        }
      }
    }
  }
  ...
  {
    GGS_configDefinitionList::cEnumerator enumerator_1666 (var_cas_inConfigDefinitionList, true) ;
    const GGS_configDefinitionList::cElement * operand_1666 = NULL ;
    while (((operand_1666 = enumerator_1666.nextObject ()))) {
      macroValidPointer (operand_1666) ;
      {
        GGS_configSettingList::cEnumerator enumerator_1704 (operand_1666->mSettingList, true) ;
        const GGS_configSettingList::cElement * operand_1704 = NULL ;
        while (((operand_1704 = enumerator_1704.nextObject ()))) {
          macroValidPointer (operand_1704) ;
          if ((var_cas_actualSettingNameSet.reader_hasKey (_inLexique, operand_1704->mSettingName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (42)) COMMA_SOURCE_FILE_AT_LINE (42))).isBuiltAndTrue ()) {
            operand_1704->mSettingName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_1704->mSettingName))._operator_concat (GGS_string (true, "' setting is already defined")) COMMA_SOURCE_FILE_AT_LINE (43)) ;
          }
          var_cas_actualSettingNameSet._addAssign_operation (operand_1704->mSettingName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (45))) ;
          GGS_lstring  var_cas_registerName ;
          GGS_luint  var_cas_maskValue ;
          GGS_lstring  var_cas_settingDescription ;
          GGS_fieldSettingMap  var_cas_fieldSettingMap ;
          const GGS_configFieldMap  _temp_2097 = var_cas_configFieldMap ;
          if (_temp_2097._isBuilt ()) {
            _temp_2097 (HERE)->method_searchKey (_inLexique, operand_1704->mSettingName, var_cas_registerName, var_cas_maskValue, var_cas_settingDescription, var_cas_fieldSettingMap COMMA_SOURCE_FILE_AT_LINE (50)) ;
          }
          if ((var_cas_fieldSettingMap.reader_hasKey (_inLexique, operand_1704->mSettingValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (51)) COMMA_SOURCE_FILE_AT_LINE (51))).isBuiltAndTrue ()) {
            GGS_uint  var_cas_settingValue ;
            GGS_uint  var_cas_settingMask ;
            const GGS_fieldSettingMap  _temp_2331 = var_cas_fieldSettingMap ;
            if (_temp_2331._isBuilt ()) {
              _temp_2331 (HERE)->method_searchKey (_inLexique, operand_1704->mSettingValue, var_cas_settingValue, var_cas_settingMask COMMA_SOURCE_FILE_AT_LINE (54)) ;
            }
            GGS_uint  var_cas_registerValue ;
            GGS_uint  automatic_var_0 ;
            const GGS_actualConfigurationMap  _temp_2457 = var_cas_temporaryActualConfigurationMap ;
            if (_temp_2457._isBuilt ()) {
              _temp_2457 (HERE)->method_searchKey (_inLexique, var_cas_registerName, automatic_var_0, var_cas_registerValue COMMA_SOURCE_FILE_AT_LINE (56)) ;
            }
            ...
            var_cas_errorMessage = ((((GGS_string (true, "the '"))._operator_concat (operand_1704->mSettingValue))._operator_concat (GGS_string (true, "' value is not defined for configuration setting '")))._operator_concat (operand_1704->mSettingName))._operator_concat (GGS_string (true, "'; possible values are:")) ;
            {
              GGS_fieldSettingMap::cEnumerator enumerator_2910 (var_cas_fieldSettingMap, true) ;
              const GGS_fieldSettingMap::cElement * operand_2910 = NULL ;
              while (((operand_2910 = enumerator_2910.nextObject ()))) {
                macroValidPointer (operand_2910) ;
                var_cas_errorMessage.writeString ("\n"
                  "-  \"") ;
                var_cas_errorMessage._dotAssign_operation (operand_2910->mKey) ;
                var_cas_errorMessage.writeString ("\"") ;
              }
            }
            operand_1704->mSettingValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (65)) ;
          }
        }
      }
    }
  ...
  if (((var_cas_inAcceptDefaultConfiguration)._operator_not ()).isBuiltAndTrue ()) {
    ...
    if (((var_cas_notDefinedSetting.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringset::cEnumerator enumerator_3416 (var_cas_notDefinedSetting, true) ;
        while (enumerator_3416.hc ()) {
          var_cas_errorMessage.writeString ("\n"
            "-  ") ;
          var_cas_errorMessage._dotAssign_operation (enumerator_3416._key (HERE)) ;
          enumerator_3416.next () ;
        }
      }
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (77)) ;
    }
  }
  var_cas_outActualConfigurationMap = GGS_actualConfigurationMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_3745 (var_cas_temporaryActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_3745 = NULL ;
    while (((operand_3745 = enumerator_3745.nextObject ()))) {
      macroValidPointer (operand_3745) ;
      GGS_uint  var_cas_registerAddress ;
      var_cas_registerAddress = (operand_3745->mInfo.mRegisterAddress)._operator_and (GGS_uint ::constructor_max (_inLexique COMMA_HERE)._substract_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (84))) ;
      ...
      if ((var_cas_outActualConfigurationMap.reader_hasKey (_inLexique, var_cas_newKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (86))).isBuiltAndTrue ()) {
        ...
        const GGS_actualConfigurationMap  _temp_4025 = var_cas_outActualConfigurationMap ;
        if (_temp_4025._isBuilt ()) {
          _temp_4025 (HERE)->method_searchKey (_inLexique, var_cas_newKey, automatic_var_1, var_cas_value COMMA_SOURCE_FILE_AT_LINE (88)) ;
        }
        if ((((operand_3745->mInfo.mRegisterAddress)._operator_and (GGS_uint (true, 1U)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_value = ((var_cas_value)._operator_and (GGS_uint (true, 65280U)))._operator_or (operand_3745->mInfo.mRegisterValue) ;
        }else{
          var_cas_value = ((var_cas_value)._operator_and (GGS_uint (true, 255U)))._operator_or (operand_3745->mInfo.mRegisterValue._left_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (92))) ;
        }
        ...
        if ((((operand_3745->mInfo.mRegisterAddress)._operator_and (GGS_uint (true, 1U)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_value = (GGS_uint (true, 65280U))._operator_or (operand_3745->mInfo.mRegisterValue) ;
        }else{
          var_cas_value = (GGS_uint (true, 255U))._operator_or (operand_3745->mInfo.mRegisterValue._left_shift_operation (_inLexique, GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (100))) ;
        }
  ...
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_4695 (var_cas_temporaryActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_4695 = NULL ;
    while (((operand_4695 = enumerator_4695.nextObject ()))) {
      ...
      var_cas_ioListFileContents._dotAssign_operation (operand_4695->mKey) ;
      var_cas_ioListFileContents.writeString ("' at ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_4695->mInfo.mRegisterAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (107))) ;
      var_cas_ioListFileContents.writeString (" set to ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_4695->mInfo.mRegisterValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (107))) ;
      ...
      const GGS_configRegisterMap  _temp_4943 = var_cas_inConfigRegisterMap ;
      if (_temp_4943._isBuilt ()) {
        _temp_4943 (HERE)->method_searchKey (_inLexique, operand_4695->mKey, automatic_var_2, automatic_var_3, var_cas_configRegisterMaskMap, automatic_var_4 COMMA_SOURCE_FILE_AT_LINE (109)) ;
      }
      {
        GGS_configRegisterMaskMap::cEnumerator enumerator_5005 (var_cas_configRegisterMaskMap, true) ;
        const GGS_configRegisterMaskMap::cElement * operand_5005 = NULL ;
        while (((operand_5005 = enumerator_5005.nextObject ()))) {
          macroValidPointer (operand_5005) ;
          GGS_lstring  var_cas_settingName ;
          var_cas_settingName = operand_5005->mKey ;
          {
            GGS_fieldSettingMap::cEnumerator enumerator_5080 (operand_5005->mInfo.mFieldSettingMap, true) ;
            const GGS_fieldSettingMap::cElement * operand_5080 = NULL ;
            while (((operand_5080 = enumerator_5080.nextObject ()))) {
              macroValidPointer (operand_5080) ;
              if ((((operand_4695->mInfo.mRegisterValue)._operator_and (operand_5005->mInfo.mMaskValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (113))))._operator_isEqual (operand_5080->mInfo.mValue)).isBuiltAndTrue ()) {
                var_cas_ioListFileContents.writeString ("  setting '") ;
                var_cas_ioListFileContents._dotAssign_operation (var_cas_settingName) ;
                var_cas_ioListFileContents.writeString ("' set to ") ;
                var_cas_ioListFileContents._dotAssign_operation (operand_5080->mInfo.mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (114))) ;
                var_cas_ioListFileContents.writeString (" (\"") ;
                var_cas_ioListFileContents._dotAssign_operation (operand_5080->mKey) ;
                var_cas_ioListFileContents.writeString ("\")\n") ;
              }
            }
          }
  ...
  {
    GGS_actualConfigurationMap::cEnumerator enumerator_5434 (var_cas_temporaryActualConfigurationMap, true) ;
    const GGS_actualConfigurationMap::cElement * operand_5434 = NULL ;
    while (((operand_5434 = enumerator_5434.nextObject ()))) {
      macroValidPointer (operand_5434) ;
      ...
      const GGS_configRegisterMap  _temp_5533 = var_cas_inConfigRegisterMap ;
      if (_temp_5533._isBuilt ()) {
        _temp_5533 (HERE)->method_searchKey (_inLexique, operand_5434->mKey, automatic_var_5, automatic_var_6, automatic_var_7, var_cas_illegalMaskList COMMA_SOURCE_FILE_AT_LINE (123)) ;
      }
      {
        GGS_illegalMaskList::cEnumerator enumerator_5590 (var_cas_illegalMaskList, true) ;
        const GGS_illegalMaskList::cElement * operand_5590 = NULL ;
        while (((operand_5590 = enumerator_5590.nextObject ()))) {
          macroValidPointer (operand_5590) ;
          if ((((operand_5434->mInfo.mRegisterValue)._operator_and (operand_5590->mIllegalMask.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (125))))._operator_isEqual (operand_5590->mIllegalValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (125)))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "illegal setting for '"))._operator_concat (operand_5434->mKey))._operator_concat (GGS_string (true, "' register: ")))._operator_concat (operand_5590->mDescription) COMMA_SOURCE_FILE_AT_LINE (126)) ;
            var_cas_ioListFileContents.writeString ("*** ILLEGAL SETTING for register '") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_5434->mKey) ;
            var_cas_ioListFileContents.writeString ("' ***\n") ;
            var_cas_ioListFileContents.writeString ("  message: ") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_5590->mDescription) ;
            var_cas_ioListFileContents.writeString ("\n"
              "\n") ;
          }
        }
...
void routine_buildConfig (C_Compiler & _inLexique,
  ...
  if (((var_cas_inConfigDefinitionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (148)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ::routine_actualBuildConfig (_inLexique,  var_cas_inConfigRegisterMap,  var_cas_inConfigDefinitionList,  var_cas_inAcceptDefaultConfiguration,  var_cas_ioListFileContents,  var_cas_outActualConfigurationMap COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }else{
    var_cas_outActualConfigurationMap = GGS_actualConfigurationMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
