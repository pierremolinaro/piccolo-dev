...
GALGAS_configFieldMap_3A_element cEnumerator_configFieldMap::current (LOCATION_ARGS) const {
  const cMapElement_configFieldMap * p = (const cMapElement_configFieldMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_configFieldMap) ;
  return GALGAS_configFieldMap_3A_element (p->mAttribute_lkey, p->mAttribute_mRegisterName, p->mAttribute_mMaskValue, p->mAttribute_mDescription, p->mAttribute_mFieldSettingMap) ;
}
...
GALGAS_configFieldMap_3A_element::GALGAS_configFieldMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_configFieldMap_3A_element::GALGAS_configFieldMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_configFieldMap_3A_element & GALGAS_configFieldMap_3A_element::operator = (const GALGAS_configFieldMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mRegisterName = inOperand.mAttribute_mRegisterName ;
...
GALGAS_configFieldMap_3A_element GALGAS_configFieldMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_lstring & inOperand1,
                                                                                    const GALGAS_luint & inOperand2,
                                                                                    const GALGAS_lstring & inOperand3,
                                                                                    const GALGAS_fieldSettingMap & inOperand4 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_configFieldMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_configFieldMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_configFieldMap_3A_element::objectCompare (const GALGAS_configFieldMap_3A_element & inOperand) const {
...
bool GALGAS_configFieldMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRegisterName.isValid () && mAttribute_mMaskValue.isValid () && mAttribute_mDescription.isValid () && mAttribute_mFieldSettingMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_configFieldMap_3A_element::drop (void) {
...
void GALGAS_configFieldMap_3A_element::description (C_String & ioString,
...
GALGAS_lstring GALGAS_configFieldMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_configFieldMap_3A_element::reader_mRegisterName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRegisterName ;
}

//---------------------------------------------------------------------------*

GALGAS_luint GALGAS_configFieldMap_3A_element::reader_mMaskValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mMaskValue ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_configFieldMap_3A_element::reader_mDescription (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDescription ;
}

//---------------------------------------------------------------------------*

GALGAS_fieldSettingMap GALGAS_configFieldMap_3A_element::reader_mFieldSettingMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_configFieldMap_3A_element ("configFieldMap:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_configFieldMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_configFieldMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_configFieldMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_configFieldMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_configFieldMap_3A_element GALGAS_configFieldMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_configFieldMap_3A_element result ;
  const GALGAS_configFieldMap_3A_element * p = (const GALGAS_configFieldMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_configFieldMap_3A_element *> (p)) {
      result = *p ;
    }else{
