...
void routine_actualBuildConfig (const GALGAS_configRegisterMap constinArgument_inConfigRegisterMap,
  ...
  cEnumerator_configRegisterMap enumerator_1070 (constinArgument_inConfigRegisterMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_1070.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_defaultValue = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (enumerator_1070.current_mRegisterWidth (HERE).reader_uint (SOURCE_FILE_AT_LINE (29)) COMMA_SOURCE_FILE_AT_LINE (29)).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (29)) ;
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outActualConfigurationMap.modifier_insertKey (enumerator_1070.current_lkey (HERE), enumerator_1070.current_mRegisterAddress (HERE).reader_uint (SOURCE_FILE_AT_LINE (30)), var_defaultValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (30)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_lstring var_registerName = enumerator_1070.current_lkey (HERE) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_configRegisterMaskMap enumerator_1305 (enumerator_1070.current_mConfigRegisterMaskMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_1305.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_configFieldMap.modifier_insertKey (enumerator_1305.current_lkey (HERE), var_registerName, enumerator_1305.current_mMaskValue (HERE), enumerator_1305.current_mDescription (HERE), enumerator_1305.current_mFieldSettingMap (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (33)) ;
      } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_configDefinitionList enumerator_1583 (constinArgument_inConfigDefinitionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_1583.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_configSettingList enumerator_1611 (enumerator_1583.current_mSettingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_1611.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = var_actualSettingNameSet.reader_hasKey (enumerator_1611.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (40)) COMMA_SOURCE_FILE_AT_LINE (40)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_1 (enumerator_1611.current_mSettingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_1611.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)).operator_concat (GALGAS_string ("' setting is already defined") COMMA_SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_actualSettingNameSet.addAssign_operation (enumerator_1611.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
      ...
      var_configFieldMap.method_searchKey (enumerator_1611.current_mSettingName (HERE), var_registerName, var_maskValue, var_settingDescription, var_fieldSettingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (48)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_fieldSettingMap.reader_hasKey (enumerator_1611.current_mSettingValue (HERE).reader_string (SOURCE_FILE_AT_LINE (49)) COMMA_SOURCE_FILE_AT_LINE (49)).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @localVariableDeclarationForGeneration
        ...
        //-------- @methodCallInstructionForGeneration
        var_fieldSettingMap.method_searchKey (enumerator_1611.current_mSettingValue (HERE), var_settingValue, var_settingMask, inCompiler COMMA_SOURCE_FILE_AT_LINE (52)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableDeclarationForGeneration
        GALGAS_uint var_registerValue ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_uint joker_2369_0 ; // Joker input parameter
        outArgument_outActualConfigurationMap.method_searchKey (var_registerName, joker_2369_0, var_registerValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (54)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        ...
        if (kBoolTrue == test_3) {
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_string var_errorMessage = GALGAS_string ("the '").operator_concat (enumerator_1611.current_mSettingValue (HERE).reader_string (SOURCE_FILE_AT_LINE (58)) COMMA_SOURCE_FILE_AT_LINE (58)).operator_concat (GALGAS_string ("' value is not defined for configuration setting '") COMMA_SOURCE_FILE_AT_LINE (58)).operator_concat (enumerator_1611.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)).operator_concat (GALGAS_string ("'; possible values are:") COMMA_SOURCE_FILE_AT_LINE (59)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_fieldSettingMap enumerator_2807 (var_fieldSettingMap, kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_2807.hasCurrentObject ()) {
            //-------- @concatInstructionForGeneration
            var_errorMessage.dotAssign_operation (GALGAS_string ("\n"
              "-  \"").operator_concat (enumerator_2807.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61)) ;
            enumerator_2807.gotoNextObject () ;
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_4 (enumerator_1611.current_mSettingValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_stringset var_notDefinedSetting = var_configFieldMap.reader_allKeys (SOURCE_FILE_AT_LINE (68)).substract_operation (var_actualSettingNameSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (68)) ;
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_5) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringset enumerator_3271 (var_notDefinedSetting, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_3271.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_errorMessage.dotAssign_operation (GALGAS_string ("\n"
        "-  ").operator_concat (enumerator_3271.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_3458 (outArgument_outActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3458.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Register '").operator_concat (enumerator_3458.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (enumerator_3458.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string (" set to ") COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (enumerator_3458.current_mRegisterValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_configRegisterMaskMap var_configRegisterMaskMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_luint joker_3691_0 ; // Joker input parameter
    GALGAS_luint joker_3694_0 ; // Joker input parameter
    GALGAS_illegalMaskList joker_3720_0 ; // Joker input parameter
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_3458.current_lkey (HERE), joker_3691_0, joker_3694_0, var_configRegisterMaskMap, joker_3720_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (80)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_configRegisterMaskMap enumerator_3768 (var_configRegisterMaskMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_3768.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_lstring var_settingName = enumerator_3768.current_lkey (HERE) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_fieldSettingMap enumerator_3872 (enumerator_3768.current_mFieldSettingMap (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_3872.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_3458.current_mRegisterValue (HERE).operator_and (enumerator_3768.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).objectCompare (enumerator_3872.current_mValue (HERE))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @concatInstructionForGeneration
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (var_settingName.reader_string (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string ("' set to ") COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (enumerator_3872.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string (" (\"") COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (enumerator_3872.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string ("\")\n") COMMA_SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)) ;
        }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_4275 (outArgument_outActualConfigurationMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_4275.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_illegalMaskList var_illegalMaskList ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_luint joker_4358_0 ; // Joker input parameter
    GALGAS_luint joker_4361_0 ; // Joker input parameter
    GALGAS_configRegisterMaskMap joker_4364_0 ; // Joker input parameter
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_4275.current_lkey (HERE), joker_4358_0, joker_4361_0, joker_4364_0, var_illegalMaskList, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_illegalMaskList enumerator_4416 (var_illegalMaskList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_4416.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_4275.current_mRegisterValue (HERE).operator_and (enumerator_4416.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)).objectCompare (enumerator_4416.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (96)))).boolEnum () ;
      if (kBoolTrue == test_7) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("illegal setting for '").operator_concat (enumerator_4275.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (GALGAS_string ("' register: ") COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (enumerator_4416.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*** ILLEGAL SETTING for register '").operator_concat (enumerator_4275.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).operator_concat (GALGAS_string ("' ***\n") COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)) ;
        //-------- @concatInstructionForGeneration
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  message: ").operator_concat (enumerator_4416.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (GALGAS_string ("\n"
