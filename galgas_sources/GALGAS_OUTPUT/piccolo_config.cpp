...
void routine_actualBuildConfig (const GALGAS_configRegisterMap constinArgument_inConfigRegisterMap,
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_stringset enumerator_3270 (var_notDefinedSetting, kEnumeration_up) ;
    while (enumerator_3270.hasCurrentObject ()) {
      var_errorMessage.dotAssign_operation (GALGAS_string ("\n"
        "-  ").operator_concat (enumerator_3270.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_SOURCE_FILE_AT_LINE (72)) ;
      enumerator_3270.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (inCompiler->here (), var_errorMessage COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  cEnumerator_actualConfigurationMap enumerator_3457 (outArgument_outActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_3457.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Register '").operator_concat (enumerator_3457.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (enumerator_3457.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string (" set to ") COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (enumerator_3457.current_mRegisterValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)) ;
    GALGAS_configRegisterMaskMap var_configRegisterMaskMap ;
    GALGAS_luint joker_3690_0 ; // Joker input parameter
    GALGAS_luint joker_3693_0 ; // Joker input parameter
    GALGAS_illegalMaskList joker_3719_0 ; // Joker input parameter
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_3457.current_lkey (HERE), joker_3690_0, joker_3693_0, var_configRegisterMaskMap, joker_3719_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (80)) ;
    cEnumerator_configRegisterMaskMap enumerator_3767 (var_configRegisterMaskMap, kEnumeration_up) ;
    while (enumerator_3767.hasCurrentObject ()) {
      GALGAS_lstring var_settingName = enumerator_3767.current_lkey (HERE) ;
      cEnumerator_fieldSettingMap enumerator_3871 (enumerator_3767.current_mFieldSettingMap (HERE), kEnumeration_up) ;
      while (enumerator_3871.hasCurrentObject ()) {
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_3457.current_mRegisterValue (HERE).operator_and (enumerator_3767.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).objectCompare (enumerator_3871.current_mValue (HERE))).boolEnum () ;
        if (kBoolTrue == test_6) {
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (var_settingName.reader_string (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string ("' set to ") COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (enumerator_3871.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string (" (\"") COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (enumerator_3871.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string ("\")\n") COMMA_SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)) ;
        }
  ...
  cEnumerator_actualConfigurationMap enumerator_4274 (outArgument_outActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_4274.hasCurrentObject ()) {
    GALGAS_illegalMaskList var_illegalMaskList ;
    GALGAS_luint joker_4357_0 ; // Joker input parameter
    GALGAS_luint joker_4360_0 ; // Joker input parameter
    GALGAS_configRegisterMaskMap joker_4363_0 ; // Joker input parameter
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_4274.current_lkey (HERE), joker_4357_0, joker_4360_0, joker_4363_0, var_illegalMaskList, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
    cEnumerator_illegalMaskList enumerator_4415 (var_illegalMaskList, kEnumeration_up) ;
    while (enumerator_4415.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_4274.current_mRegisterValue (HERE).operator_and (enumerator_4415.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)).objectCompare (enumerator_4415.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (96)))).boolEnum () ;
      if (kBoolTrue == test_7) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("illegal setting for '").operator_concat (enumerator_4274.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (GALGAS_string ("' register: ") COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (enumerator_4415.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*** ILLEGAL SETTING for register '").operator_concat (enumerator_4274.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).operator_concat (GALGAS_string ("' ***\n") COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  message: ").operator_concat (enumerator_4415.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (GALGAS_string ("\n"
