...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mRegisterName._operator_isEqual (ptr->mInfo.mRegisterName)).boolValue ()
           && (mInfo.mMaskValue._operator_isEqual (ptr->mInfo.mMaskValue)).boolValue ()
...
void routine_actualBuildConfig (C_Compiler & inLexique,
  ...
  var_cas_configFieldMap = GGS_configFieldMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_1259 = enumerator_1259.nextObject ()))) {
      ...
      var_cas_defaultValue = GGS_uint (1U)._left_shift_operation (inLexique, operand_1259->mInfo.mRegisterWidth.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (32)) COMMA_SOURCE_FILE_AT_LINE (32))._substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (32)) ;
      ...
      macroValidPointer (operand_1727) ;
      {
        ...
        while (((operand_1755 = enumerator_1755.nextObject ()))) {
          ...
          if ((var_cas_actualSettingNameSet.reader_hasKey (inLexique, operand_1755->mSettingName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43))).isBuiltAndTrue ()) {
            operand_1755->mSettingName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '"))._operator_concat (operand_1755->mSettingName))._operator_concat (GGS_string ("' setting is already defined")) COMMA_SOURCE_FILE_AT_LINE (45)) ;
          }
          ...
          if (_temp_2145.isBuilt ()) {
            _temp_2145 (HERE)->method_searchKey (inLexique, operand_1755->mSettingName, var_cas_registerName, var_cas_maskValue, var_cas_settingDescription, var_cas_fieldSettingMap COMMA_SOURCE_FILE_AT_LINE (51)) ;
          }
          if ((var_cas_fieldSettingMap.reader_hasKey (inLexique, operand_1755->mSettingValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
            ...
            if (_temp_2379.isBuilt ()) {
              _temp_2379 (HERE)->method_searchKey (inLexique, operand_1755->mSettingValue, var_cas_settingValue, var_cas_settingMask COMMA_SOURCE_FILE_AT_LINE (55)) ;
            }
            ...
            if (_temp_2499.isBuilt ()) {
              _temp_2499 (HERE)->method_searchKey (inLexique, var_cas_registerName, automatic_var_0, var_cas_registerValue COMMA_SOURCE_FILE_AT_LINE (57)) ;
            }
          ...
          }else if (((var_cas_fieldSettingMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (60)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
            GGS_string var_cas_errorMessage ;
            var_cas_errorMessage = ((((GGS_string ("the '"))._operator_concat (operand_1755->mSettingValue))._operator_concat (GGS_string ("' value is not defined for configuration setting '")))._operator_concat (operand_1755->mSettingName))._operator_concat (GGS_string ("'; possible values are:")) ;
            {
              ...
              while (((operand_2951 = enumerator_2951.nextObject ()))) {
                ...
                var_cas_errorMessage.appendCString ("\n"
                  "-  \"") ;
                var_cas_errorMessage._dotAssign_operation (operand_2951->mKey) ;
                var_cas_errorMessage.appendCString ("\"") ;
              }
            }
  ...
  if (((var_cas_inAcceptDefaultConfiguration)._operator_not ()).isBuiltAndTrue ()) {
    ...
    var_cas_notDefinedSetting = var_cas_configFieldMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (72))._substract_operation (inLexique, var_cas_actualSettingNameSet COMMA_SOURCE_FILE_AT_LINE (72)) ;
    if (((var_cas_notDefinedSetting.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (73)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = GGS_string ("the following configuration settings are not defined:") ;
      {
        ...
        while (enumerator_3459.hc ()) {
          var_cas_errorMessage.appendCString ("\n"
            "-  ") ;
          var_cas_errorMessage._dotAssign_operation (enumerator_3459._key (HERE)) ;
  ...
  }
  {
    ...
    while (((operand_3665 = enumerator_3665.nextObject ()))) {
      ...
      var_cas_ioListFileContents._dotAssign_operation (operand_3665->mKey) ;
      var_cas_ioListFileContents.appendCString ("' at ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_3665->mInfo.mRegisterAddress.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (83))) ;
      var_cas_ioListFileContents.appendCString (" set to ") ;
      var_cas_ioListFileContents._dotAssign_operation (operand_3665->mInfo.mRegisterValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (83))) ;
      ...
      const GGS_configRegisterMap  _temp_3891 = var_cas_inConfigRegisterMap ;
      if (_temp_3891.isBuilt ()) {
        _temp_3891 (HERE)->method_searchKey (inLexique, operand_3665->mKey, automatic_var_1, automatic_var_2, var_cas_configRegisterMaskMap, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (85)) ;
      }
      {
        ...
        while (((operand_3965 = enumerator_3965.nextObject ()))) {
          ...
          var_cas_settingName = operand_3965->mKey ;
          {
            ...
            while (((operand_4035 = enumerator_4035.nextObject ()))) {
              ...
              if ((((operand_3665->mInfo.mRegisterValue)._operator_and (operand_3965->mInfo.mMaskValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (89))))._operator_isEqual (operand_4035->mInfo.mValue)).isBuiltAndTrue ()) {
                var_cas_ioListFileContents.appendCString ("  setting '") ;
                var_cas_ioListFileContents._dotAssign_operation (var_cas_settingName) ;
                var_cas_ioListFileContents.appendCString ("' set to ") ;
                var_cas_ioListFileContents._dotAssign_operation (operand_4035->mInfo.mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (90))) ;
                var_cas_ioListFileContents.appendCString (" (\"") ;
                var_cas_ioListFileContents._dotAssign_operation (operand_4035->mKey) ;
                var_cas_ioListFileContents.appendCString ("\")\n") ;
              }
            }
          }
  ...
  }
  {
    ...
    while (((operand_4398 = enumerator_4398.nextObject ()))) {
      ...
      const GGS_configRegisterMap  _temp_4475 = var_cas_inConfigRegisterMap ;
      if (_temp_4475.isBuilt ()) {
        _temp_4475 (HERE)->method_searchKey (inLexique, operand_4398->mKey, automatic_var_4, automatic_var_5, automatic_var_6, var_cas_illegalMaskList COMMA_SOURCE_FILE_AT_LINE (99)) ;
      }
      {
        ...
        while (((operand_4538 = enumerator_4538.nextObject ()))) {
          ...
          if ((((operand_4398->mInfo.mRegisterValue)._operator_and (operand_4538->mIllegalMask.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (101))))._operator_isEqual (operand_4538->mIllegalValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (101)))).isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("illegal setting for '"))._operator_concat (operand_4398->mKey))._operator_concat (GGS_string ("' register: ")))._operator_concat (operand_4538->mDescription) COMMA_SOURCE_FILE_AT_LINE (103)) ;
            var_cas_ioListFileContents.appendCString ("*** ILLEGAL SETTING for register '") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_4398->mKey) ;
            var_cas_ioListFileContents.appendCString ("' ***\n") ;
            var_cas_ioListFileContents.appendCString ("  message: ") ;
            var_cas_ioListFileContents._dotAssign_operation (operand_4538->mDescription) ;
            var_cas_ioListFileContents.appendCString ("\n"
              "\n") ;
          }
        }
...
void routine_buildConfig (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (120))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("MICROCONTROLLER CONFIGURATION").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (121))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (122))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  if (((var_cas_inConfigDefinitionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (124)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
