...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mRegisterName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mMaskValue.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mDescription.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mFieldSettingMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
void routine_actualBuildConfig (C_Compiler & _inLexique,
  ...
  var_cas_configFieldMap = GGS_configFieldMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_1259 = enumerator_1259.nextObject ()))) {
      ...
      var_cas_defaultValue = GGS_uint (1U)._left_shift_operation (_inLexique, operand_1259->mInfo.mRegisterWidth.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (32)) COMMA_SOURCE_FILE_AT_LINE (32))._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (32)) ;
      ...
      macroValidPointer (operand_1727) ;
      {
        ...
        while (((operand_1755 = enumerator_1755.nextObject ()))) {
          ...
          if ((var_cas_actualSettingNameSet.reader_hasKey (_inLexique, operand_1755->mSettingName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43))).isBuiltAndTrue ()) {
            operand_1755->mSettingName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("the '"))._operator_concat (operand_1755->mSettingName))._operator_concat (GGS_string ("' setting is already defined")) COMMA_SOURCE_FILE_AT_LINE (45)) ;
          }
          ...
          }else if (((var_cas_fieldSettingMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (60)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inAcceptDefaultConfiguration)._operator_not ()).isBuiltAndTrue ()) {
    ...
    if (((var_cas_notDefinedSetting.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (73)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      ...
      }
      {
        ...
        while (((operand_4539 = enumerator_4539.nextObject ()))) {
          ...
          if ((((operand_4399->mInfo.mRegisterValue)._operator_and (operand_4539->mIllegalMask.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (101))))._operator_isEqual (operand_4539->mIllegalValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string ("illegal setting for '"))._operator_concat (operand_4399->mKey))._operator_concat (GGS_string ("' register: ")))._operator_concat (operand_4539->mDescription) COMMA_SOURCE_FILE_AT_LINE (103)) ;
...
void routine_buildConfig (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (120))) ;
  var_cas_ioListFileContents.appendCString ("\n") ;
  var_cas_ioListFileContents.appendCString ("*") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("MICROCONTROLLER CONFIGURATION").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (121))) ;
  var_cas_ioListFileContents.appendCString ("*\n") ;
  var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (122))) ;
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  if (((var_cas_inConfigDefinitionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (124)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
