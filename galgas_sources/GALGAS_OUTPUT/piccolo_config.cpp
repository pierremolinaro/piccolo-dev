    ...
    while (((operand_1769 = enumerator_1769.nextObject ()))) {
      macroValidPointer (operand_1769) ;
      {
        ...
        while (((operand_1797 = enumerator_1797.nextObject ()))) {
          ...
          if ((var_cas_actualSettingNameSet.reader_hasKey (inLexique, operand_1797->mSettingName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43))).isBuiltAndTrue ()) {
          ...
          if ((var_cas_fieldSettingMap.reader_hasKey (inLexique, operand_1797->mSettingValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
        ...
        while (((operand_4007 = enumerator_4007.nextObject ()))) {
          ...
          GGS_lstring  var_cas_settingName = operand_4007->mKey ;
          {
            ...
            while (((operand_4110 = enumerator_4110.nextObject ()))) {
              ...
              if ((((operand_3707->mInfo.mRegisterValue).operator_and (operand_4007->mInfo.mMaskValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (89)))).operator_isEqual (operand_4110->mInfo.mValue)).isBuiltAndTrue ()) {
    ...
    while (((operand_4520 = enumerator_4520.nextObject ()))) {
      ...
      }
      {
        ...
        while (((operand_4660 = enumerator_4660.nextObject ()))) {
          ...
          if ((((operand_4520->mInfo.mRegisterValue).operator_and (operand_4660->mIllegalMask.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (101)))).operator_isEqual (operand_4660->mIllegalValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (101)))).isBuiltAndTrue ()) {
