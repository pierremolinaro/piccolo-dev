...
void routine_actualBuildConfig (const GALGAS_configRegisterMap constinArgument_inConfigRegisterMap,
  ...
  while (enumerator_1070.hasCurrentObject ()) {
    ...
    cEnumerator_configRegisterMaskMap enumerator_1296 (enumerator_1070.current_mConfigRegisterMaskMap (HERE), kEnumeration_up) ;
    while (enumerator_1296.hasCurrentObject ()) {
      {
      var_configFieldMap.modifier_insertKey (enumerator_1296.current_lkey (HERE), var_registerName, enumerator_1296.current_mMaskValue (HERE), enumerator_1296.current_mDescription (HERE), enumerator_1296.current_mFieldSettingMap (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (33)) ;
      }
  ...
  cEnumerator_configDefinitionList enumerator_1574 (constinArgument_inConfigDefinitionList, kEnumeration_up) ;
  while (enumerator_1574.hasCurrentObject ()) {
    cEnumerator_configSettingList enumerator_1602 (enumerator_1574.current_mSettingList (HERE), kEnumeration_up) ;
    while (enumerator_1602.hasCurrentObject ()) {
      const enumGalgasBool test_0 = var_actualSettingNameSet.reader_hasKey (enumerator_1602.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (40)) COMMA_SOURCE_FILE_AT_LINE (40)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_location location_1 (enumerator_1602.current_mSettingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_1602.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)).operator_concat (GALGAS_string ("' setting is already defined") COMMA_SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)) ;
      }
      var_actualSettingNameSet.addAssign_operation (enumerator_1602.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
      ...
      var_configFieldMap.method_searchKey (enumerator_1602.current_mSettingName (HERE), var_registerName, var_maskValue, var_settingDescription, var_fieldSettingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (48)) ;
      const enumGalgasBool test_2 = var_fieldSettingMap.reader_hasKey (enumerator_1602.current_mSettingValue (HERE).reader_string (SOURCE_FILE_AT_LINE (49)) COMMA_SOURCE_FILE_AT_LINE (49)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_uint var_settingValue ;
        GALGAS_uint var_settingMask ;
        var_fieldSettingMap.method_searchKey (enumerator_1602.current_mSettingValue (HERE), var_settingValue, var_settingMask, inCompiler COMMA_SOURCE_FILE_AT_LINE (52)) ;
        GALGAS_uint var_registerValue ;
        GALGAS_uint joker_2360_0 ; // Joker input parameter
        outArgument_outActualConfigurationMap.method_searchKey (var_registerName, joker_2360_0, var_registerValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (54)) ;
        ...
        if (kBoolTrue == test_3) {
          GALGAS_string var_errorMessage = GALGAS_string ("the '").operator_concat (enumerator_1602.current_mSettingValue (HERE).reader_string (SOURCE_FILE_AT_LINE (58)) COMMA_SOURCE_FILE_AT_LINE (58)).operator_concat (GALGAS_string ("' value is not defined for configuration setting '") COMMA_SOURCE_FILE_AT_LINE (58)).operator_concat (enumerator_1602.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)).operator_concat (GALGAS_string ("'; possible values are:") COMMA_SOURCE_FILE_AT_LINE (59)) ;
          cEnumerator_fieldSettingMap enumerator_2798 (var_fieldSettingMap, kEnumeration_up) ;
          while (enumerator_2798.hasCurrentObject ()) {
            var_errorMessage.dotAssign_operation (GALGAS_string ("\n"
              "-  \"").operator_concat (enumerator_2798.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61)).operator_concat (GALGAS_string ("\"") COMMA_SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61)) ;
            enumerator_2798.gotoNextObject () ;
          }
          GALGAS_location location_4 (enumerator_1602.current_mSettingValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_stringset enumerator_3261 (var_notDefinedSetting, kEnumeration_up) ;
    while (enumerator_3261.hasCurrentObject ()) {
      var_errorMessage.dotAssign_operation (GALGAS_string ("\n"
        "-  ").operator_concat (enumerator_3261.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_SOURCE_FILE_AT_LINE (72)) ;
      enumerator_3261.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (inCompiler->here (), var_errorMessage COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  cEnumerator_actualConfigurationMap enumerator_3448 (outArgument_outActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_3448.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Register '").operator_concat (enumerator_3448.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (enumerator_3448.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string (" set to ") COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (enumerator_3448.current_mRegisterValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)) ;
    GALGAS_configRegisterMaskMap var_configRegisterMaskMap ;
    GALGAS_luint joker_3681_0 ; // Joker input parameter
    GALGAS_luint joker_3684_0 ; // Joker input parameter
    GALGAS_illegalMaskList joker_3710_0 ; // Joker input parameter
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_3448.current_lkey (HERE), joker_3681_0, joker_3684_0, var_configRegisterMaskMap, joker_3710_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (80)) ;
    cEnumerator_configRegisterMaskMap enumerator_3749 (var_configRegisterMaskMap, kEnumeration_up) ;
    while (enumerator_3749.hasCurrentObject ()) {
      GALGAS_lstring var_settingName = enumerator_3749.current_lkey (HERE) ;
      cEnumerator_fieldSettingMap enumerator_3844 (enumerator_3749.current_mFieldSettingMap (HERE), kEnumeration_up) ;
      while (enumerator_3844.hasCurrentObject ()) {
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_3448.current_mRegisterValue (HERE).operator_and (enumerator_3749.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).objectCompare (enumerator_3844.current_mValue (HERE))).boolEnum () ;
        if (kBoolTrue == test_6) {
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (var_settingName.reader_string (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string ("' set to ") COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (enumerator_3844.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string (" (\"") COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (enumerator_3844.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string ("\")\n") COMMA_SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)) ;
        }
  ...
  cEnumerator_actualConfigurationMap enumerator_4247 (outArgument_outActualConfigurationMap, kEnumeration_up) ;
  while (enumerator_4247.hasCurrentObject ()) {
    GALGAS_illegalMaskList var_illegalMaskList ;
    GALGAS_luint joker_4330_0 ; // Joker input parameter
    GALGAS_luint joker_4333_0 ; // Joker input parameter
    GALGAS_configRegisterMaskMap joker_4336_0 ; // Joker input parameter
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_4247.current_lkey (HERE), joker_4330_0, joker_4333_0, joker_4336_0, var_illegalMaskList, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
    cEnumerator_illegalMaskList enumerator_4388 (var_illegalMaskList, kEnumeration_up) ;
    while (enumerator_4388.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_4247.current_mRegisterValue (HERE).operator_and (enumerator_4388.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)).objectCompare (enumerator_4388.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (96)))).boolEnum () ;
      if (kBoolTrue == test_7) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("illegal setting for '").operator_concat (enumerator_4247.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (GALGAS_string ("' register: ") COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (enumerator_4388.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*** ILLEGAL SETTING for register '").operator_concat (enumerator_4247.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).operator_concat (GALGAS_string ("' ***\n") COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  message: ").operator_concat (enumerator_4388.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_concat (GALGAS_string ("\n"
          "\n") COMMA_SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)) ;
      }
      enumerator_4388.gotoNextObject () ;
    }
