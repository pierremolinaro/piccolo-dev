    ...
    while (((operand_1727 = enumerator_1727.nextObject ()))) {
      macroValidPointer (operand_1727) ;
      {
        ...
        while (((operand_1755 = enumerator_1755.nextObject ()))) {
          ...
          var_cas_actualSettingNameSet.addAssign_operation (operand_1755->mSettingName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (46))) ;
          ...
          if ((var_cas_fieldSettingMap.reader_hasKey (inLexique, operand_1755->mSettingValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
            ...
            GGS_string var_cas_errorMessage = ((((GGS_string ("the '")).operator_concat (operand_1755->mSettingValue)).operator_concat (GGS_string ("' value is not defined for configuration setting '"))).operator_concat (operand_1755->mSettingName)).operator_concat (GGS_string ("'; possible values are:")) ;
            {
    ...
    while (((operand_3665 = enumerator_3665.nextObject ()))) {
      ...
      }
      {
        ...
        while (((operand_3965 = enumerator_3965.nextObject ()))) {
          ...
          GGS_lstring  var_cas_settingName = operand_3965->mKey ;
          {
