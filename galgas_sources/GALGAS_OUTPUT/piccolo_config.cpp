...
void routine_actualBuildConfig (const GALGAS_configRegisterMap constinArgument_inConfigRegisterMap,
  ...
  cEnumerator_configRegisterMap enumerator_1108 (constinArgument_inConfigRegisterMap, true) ;
  ...
  while (enumerator_1108.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_configRegisterMaskMap enumerator_1343 (enumerator_1108.current_mConfigRegisterMaskMap (HERE), true) ;
    //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_configDefinitionList enumerator_1621 (constinArgument_inConfigDefinitionList, true) ;
  //--- simple foreach instruction
  while (enumerator_1621.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_configSettingList enumerator_1649 (enumerator_1621.current_mSettingList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_1649.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      if (var_actualSettingNameSet.reader_hasKey (enumerator_1649.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_0 (enumerator_1649.current_mSettingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_1649.current_mSettingName (HERE).reader_string (SOURCE_FILE_AT_LINE (42)) COMMA_SOURCE_FILE_AT_LINE (42)).operator_concat (GALGAS_string ("' setting is already defined") COMMA_SOURCE_FILE_AT_LINE (42)) COMMA_SOURCE_FILE_AT_LINE (42)) ;
      }
      ...
      //-------- @ifInstructionForGeneration
      if (var_fieldSettingMap.reader_hasKey (enumerator_1649.current_mSettingValue (HERE).reader_string (SOURCE_FILE_AT_LINE (50)) COMMA_SOURCE_FILE_AT_LINE (50)).isValidAndTrue ()) {
        //-------- @localVariableDeclarationForGeneration
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsStrictSup, var_fieldSettingMap.reader_count (SOURCE_FILE_AT_LINE (58)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_fieldSettingMap enumerator_2845 (var_fieldSettingMap, true) ;
          //--- simple foreach instruction
          ...
          //-------- @errorInstructionForGeneration
          GALGAS_location location_1 (enumerator_1649.current_mSettingValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_1, var_errorMessage COMMA_SOURCE_FILE_AT_LINE (64)) ;
        }
      }
  ...
  //-------- @ifInstructionForGeneration
  if (constinArgument_inAcceptDefaultConfiguration.operator_not (SOURCE_FILE_AT_LINE (69)).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsStrictSup, var_notDefinedSetting.reader_count (SOURCE_FILE_AT_LINE (71)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_errorMessage = GALGAS_string ("the following configuration settings are not defined:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_3354 (var_notDefinedSetting, true) ;
      //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_3560 (outArgument_outActualConfigurationMap, true) ;
  //--- simple foreach instruction
  while (enumerator_3560.hasCurrentObject ()) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_configRegisterMaskMap enumerator_3870 (var_configRegisterMaskMap, true) ;
    //--- simple foreach instruction
    while (enumerator_3870.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_lstring var_settingName = enumerator_3870.current_lkey (HERE) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_fieldSettingMap enumerator_3974 (enumerator_3870.current_mFieldSettingMap (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_3974.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsEqual, enumerator_3560.current_mRegisterValue (HERE).operator_and (enumerator_3870.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (87)) COMMA_SOURCE_FILE_AT_LINE (87)).objectCompare (enumerator_3974.current_mValue (HERE))).isValidAndTrue ()) {
          //-------- @appendInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_actualConfigurationMap enumerator_4377 (outArgument_outActualConfigurationMap, true) ;
  //--- simple foreach instruction
  while (enumerator_4377.hasCurrentObject ()) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_illegalMaskList enumerator_4518 (var_illegalMaskList, true) ;
    //--- simple foreach instruction
    while (enumerator_4518.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, enumerator_4377.current_mRegisterValue (HERE).operator_and (enumerator_4518.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).objectCompare (enumerator_4518.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (99)))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
...
void routine_buildConfig (const GALGAS_configRegisterMap constinArgument_inConfigRegisterMap,
  ...
  outArgument_outActualConfigurationMap.drop () ; // Release 'out' argument
  //-------- @appendInstructionForGeneration
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("").reader_stringByLeftAndRightPadding (GALGAS_uint ((PMUInt32) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (118)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  //-------- @appendInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, constinArgument_inConfigDefinitionList.reader_length (SOURCE_FILE_AT_LINE (122)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
