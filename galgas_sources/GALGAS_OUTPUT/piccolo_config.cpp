...
void routine_actualBuildConfig (const GALGAS_configRegisterMap constinArgument_inConfigRegisterMap,
  ...
  outArgument_outActualConfigurationMap = GALGAS_actualConfigurationMap::constructor_emptyMap (SOURCE_FILE ("piccolo_config.gSemantics", 26)) ;
  GALGAS_configFieldMap var_configFieldMap = GALGAS_configFieldMap::constructor_emptyMap (SOURCE_FILE ("piccolo_config.gSemantics", 27)) ;
  ...
  while (enumerator_1067.hasCurrentObject ()) {
    GALGAS_uint var_defaultValue = GALGAS_uint ((uint32_t) 1U).left_shift_operation (enumerator_1067.current_mRegisterWidth (HERE).reader_uint (SOURCE_FILE ("piccolo_config.gSemantics", 29)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 29)).substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 29)) ;
    {
    outArgument_outActualConfigurationMap.modifier_insertKey (enumerator_1067.current_lkey (HERE), enumerator_1067.current_mRegisterAddress (HERE).reader_uint (SOURCE_FILE ("piccolo_config.gSemantics", 30)), var_defaultValue, inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 30)) ;
    }
    ...
    while (enumerator_1294.hasCurrentObject ()) {
      {
      var_configFieldMap.modifier_insertKey (enumerator_1294.current_lkey (HERE), var_registerName, enumerator_1294.current_mMaskValue (HERE), enumerator_1294.current_mDescription (HERE), enumerator_1294.current_mFieldSettingMap (HERE), inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 33)) ;
      }
      enumerator_1294.gotoNextObject () ;
    }
    enumerator_1067.gotoNextObject () ;
  }
  GALGAS_stringset var_actualSettingNameSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("piccolo_config.gSemantics", 37)) ;
  ...
  while (enumerator_1571.hasCurrentObject ()) {
    ...
    while (enumerator_1599.hasCurrentObject ()) {
      const enumGalgasBool test_0 = var_actualSettingNameSet.reader_hasKey (enumerator_1599.current_mSettingName (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 40)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 40)).boolEnum () ;
      if (kBoolTrue == test_0) {
        ...
        inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_1599.current_mSettingName (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 41))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 41)).operator_concat (GALGAS_string ("' setting is already defined")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 41))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 41)) ;
      }
      var_actualSettingNameSet.addAssign_operation (enumerator_1599.current_mSettingName (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 43))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 43)) ;
      ...
      var_configFieldMap.method_searchKey (enumerator_1599.current_mSettingName (HERE), var_registerName, var_maskValue, var_settingDescription, var_fieldSettingMap, inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 48)) ;
      const enumGalgasBool test_2 = var_fieldSettingMap.reader_hasKey (enumerator_1599.current_mSettingValue (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 49)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 49)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_uint var_settingValue ;
        GALGAS_uint var_settingMask ;
        var_fieldSettingMap.method_searchKey (enumerator_1599.current_mSettingValue (HERE), var_settingValue, var_settingMask, inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 52)) ;
        GALGAS_uint var_registerValue ;
        GALGAS_uint joker_2359_0 ; // Joker input parameter
        outArgument_outActualConfigurationMap.method_searchKey (var_registerName, joker_2359_0, var_registerValue, inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 54)) ;
        var_registerValue = var_registerValue.operator_and (var_settingMask.operator_tilde (SOURCE_FILE ("piccolo_config.gSemantics", 55)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 55)).operator_or (var_settingValue COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 55)) ;
        {
        outArgument_outActualConfigurationMap.modifier_setMRegisterValueForKey (var_registerValue, var_registerName.reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 56)), inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 56)) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_fieldSettingMap.reader_count (SOURCE_FILE ("piccolo_config.gSemantics", 57)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_string var_errorMessage = GALGAS_string ("the '").operator_concat (enumerator_1599.current_mSettingValue (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 58))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 58)).operator_concat (GALGAS_string ("' value is not defined for configuration setting '")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 58)).operator_concat (enumerator_1599.current_mSettingName (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 58))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 58)).operator_concat (GALGAS_string ("'; possible values are:")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 59)) ;
          ...
          while (enumerator_2795.hasCurrentObject ()) {
            var_errorMessage.dotAssign_operation (GALGAS_string ("\n"
              "-  \"").operator_concat (enumerator_2795.current_lkey (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 61))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 61)).operator_concat (GALGAS_string ("\"")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 61))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 61)) ;
          ...
          inCompiler->emitSemanticError (location_4, var_errorMessage  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 63)) ;
        }
      }
  ...
  GALGAS_stringset var_notDefinedSetting = var_configFieldMap.reader_keySet (SOURCE_FILE ("piccolo_config.gSemantics", 68)).substract_operation (var_actualSettingNameSet, inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 68)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_notDefinedSetting.reader_count (SOURCE_FILE ("piccolo_config.gSemantics", 69)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    ...
    while (enumerator_3258.hasCurrentObject ()) {
      var_errorMessage.dotAssign_operation (GALGAS_string ("\n"
        "-  ").operator_concat (enumerator_3258.current_key (HERE)  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 72))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 72)) ;
      enumerator_3258.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (inCompiler->here (), var_errorMessage  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 74)) ;
  }
  ...
  while (enumerator_3445.hasCurrentObject ()) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Register '").operator_concat (enumerator_3445.current_lkey (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 78))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 78)).operator_concat (GALGAS_string ("' at ")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 78)).operator_concat (enumerator_3445.current_mRegisterAddress (HERE).reader_hexString (SOURCE_FILE ("piccolo_config.gSemantics", 78))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 78)).operator_concat (GALGAS_string (" set to ")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 78)).operator_concat (enumerator_3445.current_mRegisterValue (HERE).reader_hexString (SOURCE_FILE ("piccolo_config.gSemantics", 78))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 78)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 78))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 78)) ;
    ...
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_3445.current_lkey (HERE), joker_3680_0, joker_3683_0, var_configRegisterMaskMap, joker_3709_0, inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 80)) ;
    ...
    while (enumerator_3747.hasCurrentObject ()) {
      ...
      while (enumerator_3842.hasCurrentObject ()) {
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_3445.current_mRegisterValue (HERE).operator_and (enumerator_3747.current_mMaskValue (HERE).reader_uint (SOURCE_FILE ("piccolo_config.gSemantics", 84)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 84)).objectCompare (enumerator_3842.current_mValue (HERE))).boolEnum () ;
        if (kBoolTrue == test_6) {
          ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (var_settingName.reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 85))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 85)).operator_concat (GALGAS_string ("' set to ")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 85)).operator_concat (enumerator_3842.current_mValue (HERE).reader_hexString (SOURCE_FILE ("piccolo_config.gSemantics", 85))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 85)).operator_concat (GALGAS_string (" (\"")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 85)).operator_concat (enumerator_3842.current_lkey (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 85))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 85)).operator_concat (GALGAS_string ("\")\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 85))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 85)) ;
        }
        enumerator_3842.gotoNextObject () ;
      }
      enumerator_3747.gotoNextObject () ;
    }
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 89)) ;
  ...
  while (enumerator_4244.hasCurrentObject ()) {
    ...
    constinArgument_inConfigRegisterMap.method_searchKey (enumerator_4244.current_lkey (HERE), joker_4329_0, joker_4332_0, joker_4335_0, var_illegalMaskList, inCompiler COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 94)) ;
    cEnumerator_illegalMaskList enumerator_4385 (var_illegalMaskList, kEnumeration_up) ;
    while (enumerator_4385.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_4244.current_mRegisterValue (HERE).operator_and (enumerator_4385.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE ("piccolo_config.gSemantics", 96)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 96)).objectCompare (enumerator_4385.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE ("piccolo_config.gSemantics", 96)))).boolEnum () ;
      if (kBoolTrue == test_7) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("illegal setting for '").operator_concat (enumerator_4244.current_lkey (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 97))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 97)).operator_concat (GALGAS_string ("' register: ")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 97)).operator_concat (enumerator_4385.current_mDescription (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 97))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 97))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 97)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*** ILLEGAL SETTING for register '").operator_concat (enumerator_4244.current_lkey (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 98))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 98)).operator_concat (GALGAS_string ("' ***\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 98))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 98)) ;
        ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("  message: ").operator_concat (enumerator_4385.current_mDescription (HERE).reader_string (SOURCE_FILE ("piccolo_config.gSemantics", 99))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 99)).operator_concat (GALGAS_string ("\n"
          "\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 99))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 99)) ;
      }
...
void routine_buildConfig (const GALGAS_configRegisterMap constinArgument_inConfigRegisterMap,
                          ...
                          COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outActualConfigurationMap.drop () ; // Release 'out' argument
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 114)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 114))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 114)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (GALGAS_string ("MICROCONTROLLER CONFIGURATION").reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 115))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 115)).operator_concat (GALGAS_string ("*\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 115))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 115)) ;
  ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 116)).operator_concat (GALGAS_string ("\n"
    "\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 116))  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 116)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inConfigDefinitionList.reader_length (SOURCE_FILE ("piccolo_config.gSemantics", 118)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    routine_actualBuildConfig (constinArgument_inConfigRegisterMap, constinArgument_inConfigDefinitionList, ioArgument_ioListFileContents, outArgument_outActualConfigurationMap, inCompiler  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 119)) ;
    }
  }else if (kBoolFalse == test_0) {
    outArgument_outActualConfigurationMap = GALGAS_actualConfigurationMap::constructor_emptyMap (SOURCE_FILE ("piccolo_config.gSemantics", 126)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("No configuration.\n"
      "\n")  COMMA_SOURCE_FILE ("piccolo_config.gSemantics", 127)) ;
  }
}
