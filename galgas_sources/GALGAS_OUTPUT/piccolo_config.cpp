...
void routine_actualBuildConfig (C_Compiler & inLexique,
    ...
    while (((operand_1769 = enumerator_1769.nextObject ()))) {
      macroValidPointer (operand_1769) ;
      {
        ...
        while (((operand_1797 = enumerator_1797.nextObject ()))) {
          ...
          const GGS_bool cond_1963 = var_cas_actualSettingNameSet.reader_hasKey (operand_1797->mSettingName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (43))) ;
          ...
          const GGS_bool cond_2764 = var_cas_fieldSettingMap.reader_hasKey (operand_1797->mSettingValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52))) ;
          if (cond_2764.isBuiltAndTrue ()) {
            ...
            GGS_uint  automatic_var_2574_0 ;
            const GGS_actualConfigurationMap  temp_2541 = var_cas_outActualConfigurationMap ;
            if (temp_2541.isBuilt ()) {
              temp_2541 (HERE)->method_searchKey (inLexique, var_cas_registerName, automatic_var_2574_0, var_cas_registerValue COMMA_SOURCE_FILE_AT_LINE (57)) ;
            }
            ...
            const GGS_bool cond_3123 = (var_cas_fieldSettingMap.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  ...
  if (cond_3617.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_3606 = (var_cas_notDefinedSetting.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  ...
  }
  {
    ...
    while (((operand_3707 = enumerator_3707.nextObject ()))) {
      ...
      GGS_luint  automatic_var_3971_0 ;
      GGS_luint  automatic_var_3971_1 ;
      GGS_illegalMaskList  automatic_var_3971_2 ;
      const GGS_configRegisterMap  temp_3933 = var_cas_inConfigRegisterMap ;
      if (temp_3933.isBuilt ()) {
        temp_3933 (HERE)->method_searchKey (inLexique, operand_3707->mKey, automatic_var_3971_0, automatic_var_3971_1, var_cas_configRegisterMaskMap, automatic_var_3971_2 COMMA_SOURCE_FILE_AT_LINE (85)) ;
      }
      {
  ...
  }
  {
    ...
    while (((operand_4520 = enumerator_4520.nextObject ()))) {
      ...
      GGS_luint  automatic_var_4629_0 ;
      GGS_luint  automatic_var_4629_1 ;
      GGS_configRegisterMaskMap  automatic_var_4629_2 ;
      const GGS_configRegisterMap  temp_4597 = var_cas_inConfigRegisterMap ;
      if (temp_4597.isBuilt ()) {
        temp_4597 (HERE)->method_searchKey (inLexique, operand_4520->mKey, automatic_var_4629_0, automatic_var_4629_1, automatic_var_4629_2, var_cas_illegalMaskList COMMA_SOURCE_FILE_AT_LINE (99)) ;
      }
      {
...
void routine_buildConfig (C_Compiler & inLexique,
  ...
  var_cas_ioListFileContents.appendCString ("\n"
    "\n") ;
  const GGS_bool cond_5844 = (var_cas_inConfigDefinitionList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
