...
//--- Comparison methods
  public : GGS_bool _operator_isEqual (const GGS_configFieldMap & inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_configFieldMap & inOperand) const ;
...
//--- Modifiers "set'Value'ForKey"
  public : void modifier_setMRegisterNameForKey (C_Compiler & inLexique,
