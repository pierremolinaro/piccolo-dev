...
category_method__ipic_instruction_computed_bra__checkRelativeBranch (C_Compiler & _inLexique,
  ...
  if (operand_14777 != NULL) {
    ...
    var_cas_addressForCheckingBRA = var_cas_ioAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (401)) ;
    if (((operand_14777->mUsesRCALL)._operator_not ()).isBuiltAndTrue ()) {
      var_cas_addressForCheckingBRA = var_cas_addressForCheckingBRA._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (403)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_15992 (operand_14777->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_15992 = NULL ;
      while (((operand_15992 = enumerator_15992.nextObject ()))) {
        macroValidPointer (operand_15992) ;
        GGS_uint  var_cas_targetAddress ;
        const GGS_symbolTableForConvertingRelatives  _temp_16061 = var_cas_inRoutineSymbolTable ;
        if (_temp_16061._isBuilt ()) {
          _temp_16061 (HERE)->method_searchKey (_inLexique, operand_15992->mValue, var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (407)) ;
        }
        GGS_sint  var_cas_displacement ;
        var_cas_displacement = var_cas_targetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (408))._substract_operation (_inLexique, GGS_sint (true, 2L) COMMA_SOURCE_FILE_AT_LINE (408))._substract_operation (_inLexique, var_cas_addressForCheckingBRA.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408))._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (408)) ;
        if ((((var_cas_displacement)._operator_strictSup (GGS_sint (true, 1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (true, 1024L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
          operand_15992->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "displacement ("))._operator_concat (var_cas_displacement.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (410))))._operator_concat (GGS_string (true, ") too large for BRA instruction (limited to [-1024, 1023])")) COMMA_SOURCE_FILE_AT_LINE (410)) ;
        }
...
category_method__ipic_instruction_computed_goto__checkRelativeBranch (C_Compiler & _inLexique,
                                const cPtr_ipic_instruction_computed_goto * operand_16606,
                                const GGS_symbolTableForConvertingRelatives   var_cas_inRoutineSymbolTable,
                                GGS_uint  & var_cas_ioAddress,
                                GGS_bool & var_cas_ioRelativeBranchOverflow,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList,
  ...
  if (operand_16606 != NULL) {
    if ((operand_16606->mUsesRCALL).isBuiltAndTrue ()) {
      GGS_uint  var_cas_targetAddress ;
      const GGS_symbolTableForConvertingRelatives  _temp_16917 = var_cas_inRoutineSymbolTable ;
      if (_temp_16917._isBuilt ()) {
        _temp_16917 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "_computed_goto_4"), GGS_location (_inLexique) COMMA_HERE), var_cas_targetAddress COMMA_SOURCE_FILE_AT_LINE (428)) ;
      }
      GGS_sint  var_cas_displacement ;
      var_cas_displacement = var_cas_targetAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (429))._substract_operation (_inLexique, GGS_sint (true, 2L) COMMA_SOURCE_FILE_AT_LINE (429))._substract_operation (_inLexique, var_cas_ioAddress.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (429)) COMMA_SOURCE_FILE_AT_LINE (429))._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (429)) ;
      if ((((var_cas_displacement)._operator_strictSup (GGS_sint (true, 1023L)))._operator_or ((var_cas_displacement)._operator_strictInf (GGS_sint (true, 1024L)._operator_unary_minus (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
        var_cas_ioRelativeBranchOverflow = GGS_bool (true, true) ;
        if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListFile" COMMA_SOURCE_FILE_AT_LINE (432)))).isBuiltAndTrue ()) {
          var_cas_ioListFileContents.writeString ("line ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_inIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (433))) ;
          var_cas_ioListFileContents.writeString (":  COMPUTED GOTO with RCALL overflow, converted to COMPUTED GOTO with CALL\n") ;
        }
        GGS_ipic_actualInstruction  var_cas_instruction ;
        var_cas_instruction = GGS_ipic_instruction_computed_goto ::constructor_new (_inLexique, operand_16606->mInstructionLocation, operand_16606->mTargetLabels, GGS_bool (true, false) COMMA_HERE) ;
        var_cas_ioGeneratedInstructionList.modifier_setMInstructionAtIndex (_inLexique, var_cas_instruction, var_cas_inIndex COMMA_SOURCE_FILE_AT_LINE (440)) ;
      }
    }
    {
      GGS_lstringlist::cEnumerator enumerator_17656 (operand_16606->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_17656 = NULL ;
      while (((operand_17656 = enumerator_17656.nextObject ()))) {
        macroValidPointer (operand_17656) ;
        GGS_uint  automatic_var_0 ;
        const GGS_symbolTableForConvertingRelatives  _temp_17699 = var_cas_inRoutineSymbolTable ;
        if (_temp_17699._isBuilt ()) {
          _temp_17699 (HERE)->method_searchKey (_inLexique, operand_17656->mValue, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (444)) ;
        }
      }
    }
  }
...
void routine_convertRelativeBranchsToAbsoluteWhenNeeded (C_Compiler & _inLexique,
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListFile" COMMA_SOURCE_FILE_AT_LINE (458)))).isBuiltAndTrue ()) {
    ...
    var_cas_ioListFileContents.writeString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "CONVERT RELATIVES").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 77U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (460))) ;
    var_cas_ioListFileContents.writeString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string (true, "").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (true, 79U), GGS_char (true, '*') COMMA_SOURCE_FILE_AT_LINE (461))) ;
    var_cas_ioListFileContents.writeString ("\n"
      "\n") ;
  }
  ...
  GGS_uint _variant_20307 = var_cas_ioGeneratedInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (465)) ;
  GGS_bool _condition_20307 (_variant_20307._isBuilt (), true) ;
  while (_condition_20307.isBuiltAndTrue ()) {
    _condition_20307 = var_cas_relativeBranchOverflow ;
    if (_condition_20307.isBuiltAndTrue ()) {
      if (_variant_20307.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (496)) ;
        _condition_20307 = GGS_bool (true, false) ;
      }else{
        _variant_20307._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_relativeBranchOverflow = GGS_bool (true, false) ;
        var_cas_iteration._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (469)) ;
        if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListFile" COMMA_SOURCE_FILE_AT_LINE (470)))).isBuiltAndTrue ()) {
          var_cas_ioListFileContents.writeString ("Pass ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_iteration.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (471))) ;
          var_cas_ioListFileContents.writeString (":\n") ;
        }
        ...
        {
          GGS_ipic_instructionList::cEnumerator enumerator_19110 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_19110 = NULL ;
          while (((operand_19110 = enumerator_19110.nextObject ()))) {
            macroValidPointer (operand_19110) ;
            const GGS_ipic_instruction  _temp_19160 = operand_19110->mInstruction ;
            if (_temp_19160._isBuilt ()) {
              typeCategoryMethod__ipic_instruction__defineLabelAtAddress _method = findCategoryMethod__ipic_instruction__defineLabelAtAddress (_temp_19160._galgasObjectRunTimeInfo ()) ;
              if (_method != NULL) {
                _method (_inLexique, _temp_19160 (HERE), var_cas_symbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (477)) ;
              }
            }
          }
        }
        ...
        var_cas_currentAddress = GGS_uint (true, 0U) ;
        {
          ...
          GGS_ipic_instructionList::cEnumerator enumerator_19388 (var_cas_ioGeneratedInstructionList, true) ;
          const GGS_ipic_instructionList::cElement * operand_19388 = NULL ;
          while (((operand_19388 = enumerator_19388.nextObject ()))) {
            macroValidPointer (operand_19388) ;
            GGS_uint  var_cas_instructionLength ;
            const GGS_ipic_instruction  _temp_19474 = operand_19388->mInstruction ;
            if (_temp_19474._isBuilt ()) {
              _temp_19474 (HERE)->method_instructionLength (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (484)) ;
            }
            const GGS_ipic_instruction  _temp_19534 = operand_19388->mInstruction ;
            if (_temp_19534._isBuilt ()) {
              typeCategoryMethod__ipic_instruction__checkRelativeBranch _method = findCategoryMethod__ipic_instruction__checkRelativeBranch (_temp_19534._galgasObjectRunTimeInfo ()) ;
              if (_method != NULL) {
                _method (_inLexique, _temp_19534 (HERE), var_cas_symbolTable, var_cas_currentAddress, var_cas_relativeBranchOverflow, var_cas_ioGeneratedInstructionList, var_cas_idx, var_cas_ioListFileContents COMMA_SOURCE_FILE_AT_LINE (485)) ;
              }
            }
            var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_instructionLength COMMA_SOURCE_FILE_AT_LINE (486)) ;
            var_cas_idx.mValue ++ ;
          }
        }
        if (((var_cas_lastAddressForFirstPass)._operator_isNotEqual (var_cas_currentAddress)).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (489))))._operator_concat (GGS_string (true, " value when checking relative branches, while it gets ")))._operator_concat (var_cas_lastAddressForFirstPass.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (491))))._operator_concat (GGS_string (true, " value when computing routine map")) COMMA_SOURCE_FILE_AT_LINE (491)) ;
        }
        if ((((var_cas_relativeBranchOverflow)._operator_not ())._operator_and (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListFile" COMMA_SOURCE_FILE_AT_LINE (493))))).isBuiltAndTrue ()) {
          var_cas_ioListFileContents.writeString ("  No relative to convert\n"
            "\n") ;
          var_cas_ioListFileContents.writeString ("Program size: ") ;
          var_cas_ioListFileContents._dotAssign_operation (var_cas_currentAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (495))) ;
