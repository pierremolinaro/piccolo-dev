...
void routine_buildAssemblyInstructionList (C_Compiler & _inLexique,
  ...
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_6680 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_6680 = NULL ;
      while (((operand_6680 = enumerator_6680.nextObject ()))) {
        macroValidPointer (operand_6680) ;
        if (((operand_6680->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (178)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_6788 (operand_6680->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_6788 = NULL ;
            while (((operand_6788 = enumerator_6788.nextObject ()))) {
              macroValidPointer (operand_6788) ;
              var_cas_outGeneratedInstructionList._addAssign_operation (operand_6788->mInstruction) ;
              const GGS_instruction  _temp_6889 = operand_6788->mInstruction ;
              if (_temp_6889._isBuilt ()) {
                typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_6889._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_6889 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (181)) ;
                }
              }
            }
          }
  ...
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_7454 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (195)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_7454 = NULL ;
      while (((operand_7454 = enumerator_7454.nextObject ()))) {
        macroValidPointer (operand_7454) ;
        if (((operand_7454->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_7563 (operand_7454->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_7563 = NULL ;
            while (((operand_7563 = enumerator_7563.nextObject ()))) {
              macroValidPointer (operand_7563) ;
              var_cas_outGeneratedInstructionList._addAssign_operation (operand_7563->mInstruction) ;
              const GGS_instruction  _temp_7664 = operand_7563->mInstruction ;
              if (_temp_7664._isBuilt ()) {
                typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_7664._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_7664 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (199)) ;
                }
              }
            }
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_7961 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (207)), true) ;
    const GGS_routineDefinitionList::cElement * operand_7961 = NULL ;
    while (((operand_7961 = enumerator_7961.nextObject ()))) {
      macroValidPointer (operand_7961) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, operand_7961->mRoutineName COMMA_HERE)) ;
      {
        GGS_instructionList::cEnumerator enumerator_8088 (operand_7961->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_8088 = NULL ;
        while (((operand_8088 = enumerator_8088.nextObject ()))) {
          macroValidPointer (operand_8088) ;
          var_cas_outGeneratedInstructionList._addAssign_operation (operand_8088->mInstruction) ;
          const GGS_instruction  _temp_8181 = operand_8088->mInstruction ;
          if (_temp_8181._isBuilt ()) {
            typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_8181._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_8181 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (211)) ;
            }
          }
        }
      }
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (215))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (224))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "WREG"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE), GGS_bool (true, true) COMMA_HERE)) ;
