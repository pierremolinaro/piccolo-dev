...
category_method__bcc_in_structured_if_condition__decomposeIFcondition (C_Compiler & _inLexique,
  ...
  if (operand_3225 != NULL) {
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_instruction_conditionalBranch ::constructor_new (_inLexique, var_cas_inInstructionLocation, operand_3225->mCondition, GGS_lstring ::constructor_new (_inLexique, var_cas_inTargetLabel, var_cas_inInstructionLocation COMMA_HERE) COMMA_HERE)) ;
  }
}
...
category_method__bitTest_in_structured_if_condition__decomposeIFcondition (C_Compiler & _inLexique,
                                const cPtr_bitTest_in_structured_if_condition * operand_3656,
                                const GGS_location   var_cas_inInstructionLocation,
                                const GGS_string  var_cas_inTargetLabel,
                                GGS_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3656 != NULL) {
    ...
    if ((operand_3656->mBTFSSinstruction).isBuiltAndTrue ()) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_instruction_FBA ::constructor_new (_inLexique, var_cas_inInstructionLocation, var_cas_op, operand_3656->mRegisterExpression, operand_3656->mBitNumber COMMA_HERE)) ;
...
category_method__instruction_structured_if__decomposeComplexInstruction (C_Compiler & _inLexique,
                                const cPtr_instruction_structured_if * operand_4318,
                                GGS_uint  & var_cas_ioLocalLabelIndex,
                                GGS_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4318 != NULL) {
    GGS_instruction  automatic_var_3 ;
    var_cas_ioGeneratedInstructionList.modifier_popLast (_inLexique, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (131)) ;
    GGS_string var_cas_label0 ;
    var_cas_label0 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (132))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
    GGS_string var_cas_label1 ;
    var_cas_label1 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (133))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
    const GGS_structured_if_condition  _temp_4683 = operand_4318->mIfCondition ;
    if (_temp_4683._isBuilt ()) {
      typeCategoryMethod__structured_if_condition__decomposeIFcondition _method = findCategoryMethod__structured_if_condition__decomposeIFcondition (_temp_4683._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_4683 (HERE), operand_4318->mInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (135)) ;
      }
    }
    {
      GGS_instructionList::cEnumerator enumerator_4801 (operand_4318->mThenInstructionList, true) ;
      const GGS_instructionList::cElement * operand_4801 = NULL ;
      while (((operand_4801 = enumerator_4801.nextObject ()))) {
        macroValidPointer (operand_4801) ;
        var_cas_ioGeneratedInstructionList._addAssign_operation (operand_4801->mInstruction) ;
        const GGS_instruction  _temp_4893 = operand_4801->mInstruction ;
        if (_temp_4893._isBuilt ()) {
          typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_4893._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_4893 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (139)) ;
          }
        }
      }
    }
    if (((operand_4318->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (141)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_instruction_BRA ::constructor_new (_inLexique, operand_4318->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label1, operand_4318->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label0, operand_4318->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_instructionList::cEnumerator enumerator_5308 (operand_4318->mElseInstructionList, true) ;
      const GGS_instructionList::cElement * operand_5308 = NULL ;
      while (((operand_5308 = enumerator_5308.nextObject ()))) {
        macroValidPointer (operand_5308) ;
        var_cas_ioGeneratedInstructionList._addAssign_operation (operand_5308->mInstruction) ;
        const GGS_instruction  _temp_5400 = operand_5308->mInstruction ;
        if (_temp_5400._isBuilt ()) {
          typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_5400._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_5400 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (148)) ;
          }
        }
      }
    }
    if (((operand_4318->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (150)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label1, operand_4318->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    }
  }
}
...
void routine_buildAssemblyInstructionList (C_Compiler & _inLexique,
  ...
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_6645 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (176)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_6645 = NULL ;
      while (((operand_6645 = enumerator_6645.nextObject ()))) {
        macroValidPointer (operand_6645) ;
        if (((operand_6645->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_6753 (operand_6645->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_6753 = NULL ;
            while (((operand_6753 = enumerator_6753.nextObject ()))) {
              macroValidPointer (operand_6753) ;
              var_cas_outGeneratedInstructionList._addAssign_operation (operand_6753->mInstruction) ;
              const GGS_instruction  _temp_6854 = operand_6753->mInstruction ;
              if (_temp_6854._isBuilt ()) {
                typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_6854._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_6854 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (180)) ;
                }
              }
            }
          }
  ...
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_7419 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_7419 = NULL ;
      while (((operand_7419 = enumerator_7419.nextObject ()))) {
        macroValidPointer (operand_7419) ;
        if (((operand_7419->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (195)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_7528 (operand_7419->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_7528 = NULL ;
            while (((operand_7528 = enumerator_7528.nextObject ()))) {
              macroValidPointer (operand_7528) ;
              var_cas_outGeneratedInstructionList._addAssign_operation (operand_7528->mInstruction) ;
              const GGS_instruction  _temp_7629 = operand_7528->mInstruction ;
              if (_temp_7629._isBuilt ()) {
                typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_7629._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_7629 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (198)) ;
                }
              }
            }
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_7926 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (206)), true) ;
    const GGS_routineDefinitionList::cElement * operand_7926 = NULL ;
    while (((operand_7926 = enumerator_7926.nextObject ()))) {
      macroValidPointer (operand_7926) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, operand_7926->mRoutineName COMMA_HERE)) ;
      {
        GGS_instructionList::cEnumerator enumerator_8053 (operand_7926->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_8053 = NULL ;
        while (((operand_8053 = enumerator_8053.nextObject ()))) {
          macroValidPointer (operand_8053) ;
          var_cas_outGeneratedInstructionList._addAssign_operation (operand_8053->mInstruction) ;
          const GGS_instruction  _temp_8146 = operand_8053->mInstruction ;
          if (_temp_8146._isBuilt ()) {
            typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_8146._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_8146 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (210)) ;
            }
          }
        }
      }
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (214))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (223))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "WREG"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE), GGS_bool (true, true) COMMA_HERE)) ;
