...
category_method__instruction_structured_if__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_18061 != NULL) {
    GGS_string var_cas_label0 ;
    var_cas_label0 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (614))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (614)) ;
    GGS_string var_cas_label1 ;
    var_cas_label1 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (615))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (615)) ;
    const GGS_conditionExpression  _temp_18382 = operand_18061->mIfCondition ;
    if (_temp_18382._isBuilt ()) {
      typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition _method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (_temp_18382._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_18382 (HERE), var_cas_ioLocalLabelIndex, GGS_bool (true, true), operand_18061->mInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (617)) ;
      }
    }
    {
      GGS_instructionList::cEnumerator enumerator_18538 (operand_18061->mThenInstructionList, true) ;
      const GGS_instructionList::cElement * operand_18538 = NULL ;
      while (((operand_18538 = enumerator_18538.nextObject ()))) {
        macroValidPointer (operand_18538) ;
        const GGS_piccolo_instruction  _temp_18580 = operand_18538->mInstruction ;
        if (_temp_18580._isBuilt ()) {
          typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_18580._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_18580 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (620)) ;
          }
        }
      }
    }
    if (((operand_18061->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (622)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_instruction_BRA ::constructor_new (_inLexique, operand_18061->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label1, operand_18061->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label0, operand_18061->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_instructionList::cEnumerator enumerator_19002 (operand_18061->mElseInstructionList, true) ;
      const GGS_instructionList::cElement * operand_19002 = NULL ;
      while (((operand_19002 = enumerator_19002.nextObject ()))) {
        macroValidPointer (operand_19002) ;
        const GGS_piccolo_instruction  _temp_19044 = operand_19002->mInstruction ;
        if (_temp_19044._isBuilt ()) {
          typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_19044._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_19044 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (628)) ;
          }
        }
      }
    }
    if (((operand_18061->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (630)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label1, operand_18061->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    }
  }
}
...
category_method__instruction_do_while__buildIPICinstructionList (C_Compiler & _inLexique,
                                const cPtr_instruction_do_while * operand_19409,
                                GGS_uint  & var_cas_ioLocalLabelIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19409 != NULL) {
    GGS_string var_cas_label0 ;
    var_cas_label0 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (643))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (643)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label0, operand_19409->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_instructionList::cEnumerator enumerator_19786 (operand_19409->mRepeatedInstructionList, true) ;
      const GGS_instructionList::cElement * operand_19786 = NULL ;
      while (((operand_19786 = enumerator_19786.nextObject ()))) {
        macroValidPointer (operand_19786) ;
        const GGS_piccolo_instruction  _temp_19832 = operand_19786->mInstruction ;
        if (_temp_19832._isBuilt ()) {
          typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_19832._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_19832 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (648)) ;
          }
        }
      }
    }
    const GGS_conditionExpression  _temp_19969 = operand_19409->mWhileCondition ;
    if (_temp_19969._isBuilt ()) {
      typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition _method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (_temp_19969._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_19969 (HERE), var_cas_ioLocalLabelIndex, GGS_bool (true, false), operand_19409->mInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (651)) ;
      }
    }
  }
}
...
category_method__instruction_IF_IncDec__buildIPICinstructionList (C_Compiler & _inLexique,
                                const cPtr_instruction_IF_IncDec * operand_20201,
                                GGS_uint  & var_cas_ioLocalLabelIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20201 != NULL) {
    GGS_instruction_FDA_base_code var_cas_baseCode ;
    if (((operand_20201->mIncrement)._operator_and (operand_20201->mSkipIfZero)).isBuiltAndTrue ()) {
      var_cas_baseCode = GGS_instruction_FDA_base_code::constructor_INCFSZ (_inLexique COMMA_HERE) ;
    }else if (((operand_20201->mIncrement)._operator_and ((operand_20201->mSkipIfZero)._operator_not ())).isBuiltAndTrue ()) {
      var_cas_baseCode = GGS_instruction_FDA_base_code::constructor_INFSNZ (_inLexique COMMA_HERE) ;
    }else if ((((operand_20201->mIncrement)._operator_not ())._operator_and (operand_20201->mSkipIfZero)).isBuiltAndTrue ()) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_instruction_FDA ::constructor_new (_inLexique, operand_20201->mInstructionLocation, var_cas_baseCode, operand_20201->mRegisterExpression, operand_20201->m_W_isDestination COMMA_HERE)) ;
    const GGS_piccolo_instruction  _temp_20910 = operand_20201->mInstruction ;
    if (_temp_20910._isBuilt ()) {
      typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_20910._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_20910 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (679)) ;
      }
    }
  }
}
...
void routine_buildAssemblyInstructionList (C_Compiler & _inLexique,
  ...
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_22070 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (705)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_22070 = NULL ;
      while (((operand_22070 = enumerator_22070.nextObject ()))) {
        macroValidPointer (operand_22070) ;
        if (((operand_22070->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (706)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_22178 (operand_22070->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_22178 = NULL ;
            while (((operand_22178 = enumerator_22178.nextObject ()))) {
              macroValidPointer (operand_22178) ;
              const GGS_piccolo_instruction  _temp_22222 = operand_22178->mInstruction ;
              if (_temp_22222._isBuilt ()) {
                typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_22222._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_22222 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (708)) ;
                }
              }
            }
          }
  ...
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_22799 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (722)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_22799 = NULL ;
      while (((operand_22799 = enumerator_22799.nextObject ()))) {
        macroValidPointer (operand_22799) ;
        if (((operand_22799->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (723)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_22908 (operand_22799->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_22908 = NULL ;
            while (((operand_22908 = enumerator_22908.nextObject ()))) {
              macroValidPointer (operand_22908) ;
              const GGS_piccolo_instruction  _temp_22952 = operand_22908->mInstruction ;
              if (_temp_22952._isBuilt ()) {
                typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_22952._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_22952 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (725)) ;
                }
              }
            }
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_23250 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (733)), true) ;
    const GGS_routineDefinitionList::cElement * operand_23250 = NULL ;
    while (((operand_23250 = enumerator_23250.nextObject ()))) {
      macroValidPointer (operand_23250) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_23250->mRoutineName COMMA_HERE)) ;
      {
        GGS_instructionList::cEnumerator enumerator_23382 (operand_23250->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_23382 = NULL ;
        while (((operand_23382 = enumerator_23382.nextObject ()))) {
          macroValidPointer (operand_23382) ;
          const GGS_piccolo_instruction  _temp_23422 = operand_23382->mInstruction ;
          if (_temp_23422._isBuilt ()) {
            typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_23422._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_23422 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (736)) ;
            }
          }
        }
      }
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (740))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (749))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (752)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (752)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "WREG"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE), GGS_bool (true, true) COMMA_HERE)) ;
