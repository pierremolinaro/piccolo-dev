...
category_method__instruction_structured_if__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_18061 != NULL) {
    ...
    {
      GGS_partList::cEnumerator enumerator_18746 (operand_18061->mElsifPartList, true) ;
      const GGS_partList::cElement * operand_18746 = NULL ;
...
category_method__instruction_do_while__buildIPICinstructionList (C_Compiler & _inLexique,
  ...
  if (operand_20259 != NULL) {
    ...
    var_cas_labelInstructionBegin = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (652))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (652)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_labelInstructionBegin, operand_20259->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_instructionList::cEnumerator enumerator_20661 (operand_20259->mRepeatedInstructionList, true) ;
      const GGS_instructionList::cElement * operand_20661 = NULL ;
      while (((operand_20661 = enumerator_20661.nextObject ()))) {
        macroValidPointer (operand_20661) ;
        const GGS_piccolo_instruction  _temp_20707 = operand_20661->mInstruction ;
        if (_temp_20707._isBuilt ()) {
          typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_20707._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_20707 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (657)) ;
          }
        }
      }
    }
    {
      GGS_partList::cEnumerator enumerator_20827 (operand_20259->mWhilePartList, true) ;
      const GGS_partList::cElement * operand_20827 = NULL ;
      while (((operand_20827 = enumerator_20827.nextObject ()))) {
        macroValidPointer (operand_20827) ;
        if (((operand_20827->mInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (661)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          const GGS_conditionExpression  _temp_20906 = operand_20827->mCondition ;
          if (_temp_20906._isBuilt ()) {
            typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition _method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (_temp_20906._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_20906 (HERE), var_cas_ioLocalLabelIndex, GGS_bool (true, false), operand_20259->mInstructionLocation, var_cas_labelInstructionBegin, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (662)) ;
            }
          }
        }else{
          GGS_string var_cas_nextBranchLabel ;
          var_cas_nextBranchLabel = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (664))) ;
          var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (664)) ;
          const GGS_conditionExpression  _temp_21167 = operand_20827->mCondition ;
          if (_temp_21167._isBuilt ()) {
            typeCategoryMethod__conditionExpression__buildIPICinstructionForCondition _method = findCategoryMethod__conditionExpression__buildIPICinstructionForCondition (_temp_21167._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_21167 (HERE), var_cas_ioLocalLabelIndex, GGS_bool (true, true), operand_20259->mInstructionLocation, var_cas_nextBranchLabel, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (665)) ;
            }
          }
          {
            GGS_instructionList::cEnumerator enumerator_21311 (operand_20827->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_21311 = NULL ;
            while (((operand_21311 = enumerator_21311.nextObject ()))) {
              macroValidPointer (operand_21311) ;
              const GGS_piccolo_instruction  _temp_21353 = operand_21311->mInstruction ;
              if (_temp_21353._isBuilt ()) {
                typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_21353._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_21353 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (667)) ;
                }
              }
            }
          }
          var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_nextBranchLabel, operand_20259->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
        }
      }
    }
  }
...
category_method__instruction_IF_IncDec__buildIPICinstructionList (C_Compiler & _inLexique,
                                const cPtr_instruction_IF_IncDec * operand_21708,
                                GGS_uint  & var_cas_ioLocalLabelIndex,
                                GGS_ipic_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21708 != NULL) {
    GGS_instruction_FDA_base_code var_cas_baseCode ;
    if (((operand_21708->mIncrement)._operator_and (operand_21708->mSkipIfZero)).isBuiltAndTrue ()) {
      var_cas_baseCode = GGS_instruction_FDA_base_code::constructor_INCFSZ (_inLexique COMMA_HERE) ;
    }else if (((operand_21708->mIncrement)._operator_and ((operand_21708->mSkipIfZero)._operator_not ())).isBuiltAndTrue ()) {
      var_cas_baseCode = GGS_instruction_FDA_base_code::constructor_INFSNZ (_inLexique COMMA_HERE) ;
    }else if ((((operand_21708->mIncrement)._operator_not ())._operator_and (operand_21708->mSkipIfZero)).isBuiltAndTrue ()) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_ipic_instruction_FDA ::constructor_new (_inLexique, operand_21708->mInstructionLocation, var_cas_baseCode, operand_21708->mRegisterExpression, operand_21708->m_W_isDestination COMMA_HERE)) ;
    const GGS_piccolo_instruction  _temp_22417 = operand_21708->mInstruction ;
    if (_temp_22417._isBuilt ()) {
      typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_22417._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_22417 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (699)) ;
      }
    }
  }
}
...
void routine_buildAssemblyInstructionList (C_Compiler & _inLexique,
  ...
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_23577 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (725)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_23577 = NULL ;
      while (((operand_23577 = enumerator_23577.nextObject ()))) {
        macroValidPointer (operand_23577) ;
        if (((operand_23577->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (726)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_23685 (operand_23577->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_23685 = NULL ;
            while (((operand_23685 = enumerator_23685.nextObject ()))) {
              macroValidPointer (operand_23685) ;
              const GGS_piccolo_instruction  _temp_23729 = operand_23685->mInstruction ;
              if (_temp_23729._isBuilt ()) {
                typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_23729._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_23729 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (728)) ;
                }
              }
            }
          }
  ...
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_24306 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (742)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_24306 = NULL ;
      while (((operand_24306 = enumerator_24306.nextObject ()))) {
        macroValidPointer (operand_24306) ;
        if (((operand_24306->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (743)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_24415 (operand_24306->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_24415 = NULL ;
            while (((operand_24415 = enumerator_24415.nextObject ()))) {
              macroValidPointer (operand_24415) ;
              const GGS_piccolo_instruction  _temp_24459 = operand_24415->mInstruction ;
              if (_temp_24459._isBuilt ()) {
                typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_24459._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_24459 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (745)) ;
                }
              }
            }
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_24757 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (753)), true) ;
    const GGS_routineDefinitionList::cElement * operand_24757 = NULL ;
    while (((operand_24757 = enumerator_24757.nextObject ()))) {
      macroValidPointer (operand_24757) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_pseudo_LABEL ::constructor_new (_inLexique, operand_24757->mRoutineName COMMA_HERE)) ;
      {
        GGS_instructionList::cEnumerator enumerator_24889 (operand_24757->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_24889 = NULL ;
        while (((operand_24889 = enumerator_24889.nextObject ()))) {
          macroValidPointer (operand_24889) ;
          const GGS_piccolo_instruction  _temp_24929 = operand_24889->mInstruction ;
          if (_temp_24929._isBuilt ()) {
            typeCategoryMethod__piccolo_instruction__buildIPICinstructionList _method = findCategoryMethod__piccolo_instruction__buildIPICinstructionList (_temp_24929._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_24929 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (756)) ;
            }
          }
        }
      }
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (760))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (769))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (772)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (772)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_ipic_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "WREG"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE), GGS_bool (true, true) COMMA_HERE)) ;
