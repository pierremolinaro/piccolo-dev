...
category_method__bcc_in_structured_if_condition__decomposeIFcondition (C_Compiler & _inLexique,
                                const cPtr_bcc_in_structured_if_condition * operand_3253,
                                ...
                                GGS_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3253 != NULL) {
    GGS_conditional_branch var_cas_condition ;
    if ((var_cas_inComplementaryBranch).isBuiltAndTrue ()) {
      ::routine_getComplementaryBcc (_inLexique,  operand_3253->mCondition,  var_cas_condition COMMA_SOURCE_FILE_AT_LINE (98)) ;
    }else{
      var_cas_condition = operand_3253->mCondition ;
    }
...
category_method__bitTest_in_structured_if_condition__decomposeIFcondition (C_Compiler & _inLexique,
                                const cPtr_bitTest_in_structured_if_condition * operand_3913,
                                const GGS_bool  var_cas_inComplementaryBranch,
                                const GGS_location   var_cas_inInstructionLocation,
                                const GGS_string  var_cas_inTargetLabel,
                                GGS_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_3913 != NULL) {
    GGS_bit_oriented_op var_cas_op ;
    if (((operand_3913->mBTFSSinstruction)._operator_xor (var_cas_inComplementaryBranch)).isBuiltAndTrue ()) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_instruction_FBA ::constructor_new (_inLexique, var_cas_inInstructionLocation, var_cas_op, operand_3913->mRegisterExpression, operand_3913->mBitNumber COMMA_HERE)) ;
...
category_method__instruction_structured_if__decomposeComplexInstruction (C_Compiler & _inLexique,
                                const cPtr_instruction_structured_if * operand_4631,
                                GGS_uint  & var_cas_ioLocalLabelIndex,
                                GGS_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4631 != NULL) {
    GGS_instruction  automatic_var_3 ;
    var_cas_ioGeneratedInstructionList.modifier_popLast (_inLexique, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (141)) ;
    GGS_string var_cas_label0 ;
    var_cas_label0 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (142))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (142)) ;
    GGS_string var_cas_label1 ;
    var_cas_label1 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (143))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
    const GGS_conditionExpression  _temp_4996 = operand_4631->mIfCondition ;
    if (_temp_4996._isBuilt ()) {
      typeCategoryMethod__conditionExpression__decomposeIFcondition _method = findCategoryMethod__conditionExpression__decomposeIFcondition (_temp_4996._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_4996 (HERE), GGS_bool (true, true), operand_4631->mInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }
    }
    {
      GGS_instructionList::cEnumerator enumerator_5120 (operand_4631->mThenInstructionList, true) ;
      const GGS_instructionList::cElement * operand_5120 = NULL ;
      while (((operand_5120 = enumerator_5120.nextObject ()))) {
        macroValidPointer (operand_5120) ;
        var_cas_ioGeneratedInstructionList._addAssign_operation (operand_5120->mInstruction) ;
        const GGS_instruction  _temp_5212 = operand_5120->mInstruction ;
        if (_temp_5212._isBuilt ()) {
          typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_5212._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_5212 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (149)) ;
          }
        }
      }
    }
    if (((operand_4631->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (151)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_instruction_BRA ::constructor_new (_inLexique, operand_4631->mInstructionLocation, GGS_lstring ::constructor_new (_inLexique, var_cas_label1, operand_4631->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    }
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label0, operand_4631->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_instructionList::cEnumerator enumerator_5627 (operand_4631->mElseInstructionList, true) ;
      const GGS_instructionList::cElement * operand_5627 = NULL ;
      while (((operand_5627 = enumerator_5627.nextObject ()))) {
        macroValidPointer (operand_5627) ;
        var_cas_ioGeneratedInstructionList._addAssign_operation (operand_5627->mInstruction) ;
        const GGS_instruction  _temp_5719 = operand_5627->mInstruction ;
        if (_temp_5719._isBuilt ()) {
          typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_5719._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_5719 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (158)) ;
          }
        }
      }
    }
    if (((operand_4631->mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label1, operand_4631->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    }
  }
}
...
category_method__instruction_do_while__decomposeComplexInstruction (C_Compiler & _inLexique,
                                const cPtr_instruction_do_while * operand_6082,
                                GGS_uint  & var_cas_ioLocalLabelIndex,
                                GGS_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6082 != NULL) {
    GGS_instruction  automatic_var_4 ;
    var_cas_ioGeneratedInstructionList.modifier_popLast (_inLexique, automatic_var_4 COMMA_SOURCE_FILE_AT_LINE (172)) ;
    GGS_string var_cas_label0 ;
    var_cas_label0 = (GGS_string (true, "_label_"))._operator_concat (var_cas_ioLocalLabelIndex.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
    var_cas_ioLocalLabelIndex._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, var_cas_label0, operand_6082->mInstructionLocation COMMA_HERE) COMMA_HERE)) ;
    {
      GGS_instructionList::cEnumerator enumerator_6498 (operand_6082->mRepeatedInstructionList, true) ;
      const GGS_instructionList::cElement * operand_6498 = NULL ;
      while (((operand_6498 = enumerator_6498.nextObject ()))) {
        macroValidPointer (operand_6498) ;
        var_cas_ioGeneratedInstructionList._addAssign_operation (operand_6498->mInstruction) ;
        const GGS_instruction  _temp_6594 = operand_6498->mInstruction ;
        if (_temp_6594._isBuilt ()) {
          typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_6594._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_6594 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (180)) ;
          }
        }
      }
    }
    const GGS_conditionExpression  _temp_6734 = operand_6082->mWhileCondition ;
    if (_temp_6734._isBuilt ()) {
      typeCategoryMethod__conditionExpression__decomposeIFcondition _method = findCategoryMethod__conditionExpression__decomposeIFcondition (_temp_6734._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_6734 (HERE), GGS_bool (true, false), operand_6082->mInstructionLocation, var_cas_label0, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (183)) ;
      }
    }
  }
}
...
category_method__instruction_IF_IncDec__decomposeComplexInstruction (C_Compiler & _inLexique,
                                const cPtr_instruction_IF_IncDec * operand_6934,
                                GGS_uint  & var_cas_ioLocalLabelIndex,
                                GGS_instructionList  & var_cas_ioGeneratedInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6934 != NULL) {
    GGS_instruction  automatic_var_5 ;
    var_cas_ioGeneratedInstructionList.modifier_popLast (_inLexique, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (193)) ;
    GGS_instruction_FDA_base_code var_cas_baseCode ;
    if (((operand_6934->mIncrement)._operator_and (operand_6934->mSkipIfZero)).isBuiltAndTrue ()) {
      var_cas_baseCode = GGS_instruction_FDA_base_code::constructor_INCFSZ (_inLexique COMMA_HERE) ;
    }else if (((operand_6934->mIncrement)._operator_and ((operand_6934->mSkipIfZero)._operator_not ())).isBuiltAndTrue ()) {
      var_cas_baseCode = GGS_instruction_FDA_base_code::constructor_INFSNZ (_inLexique COMMA_HERE) ;
    }else if ((((operand_6934->mIncrement)._operator_not ())._operator_and (operand_6934->mSkipIfZero)).isBuiltAndTrue ()) {
    ...
    var_cas_ioGeneratedInstructionList._addAssign_operation (GGS_instruction_FDA ::constructor_new (_inLexique, operand_6934->mInstructionLocation, var_cas_baseCode, operand_6934->mRegisterExpression, operand_6934->m_W_isDestination COMMA_HERE)) ;
    var_cas_ioGeneratedInstructionList._addAssign_operation (operand_6934->mInstruction) ;
    const GGS_instruction  _temp_7730 = operand_6934->mInstruction ;
    if (_temp_7730._isBuilt ()) {
      typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_7730._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_7730 (HERE), var_cas_ioLocalLabelIndex, var_cas_ioGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }
    }
  }
}
...
void routine_buildAssemblyInstructionList (C_Compiler & _inLexique,
  ...
  if ((var_cas_inHasLowInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_8801 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_8801 = NULL ;
      while (((operand_8801 = enumerator_8801.nextObject ()))) {
        macroValidPointer (operand_8801) ;
        if (((operand_8801->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (238)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_8909 (operand_8801->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_8909 = NULL ;
            while (((operand_8909 = enumerator_8909.nextObject ()))) {
              macroValidPointer (operand_8909) ;
              var_cas_outGeneratedInstructionList._addAssign_operation (operand_8909->mInstruction) ;
              const GGS_instruction  _temp_9010 = operand_8909->mInstruction ;
              if (_temp_9010._isBuilt ()) {
                typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_9010._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_9010 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (241)) ;
                }
              }
            }
          }
  ...
  if ((var_cas_inHasHighInterrupt).isBuiltAndTrue ()) {
    ...
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_9575 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (255)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_9575 = NULL ;
      while (((operand_9575 = enumerator_9575.nextObject ()))) {
        macroValidPointer (operand_9575) ;
        if (((operand_9575->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (256)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          {
            GGS_instructionList::cEnumerator enumerator_9684 (operand_9575->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_9684 = NULL ;
            while (((operand_9684 = enumerator_9684.nextObject ()))) {
              macroValidPointer (operand_9684) ;
              var_cas_outGeneratedInstructionList._addAssign_operation (operand_9684->mInstruction) ;
              const GGS_instruction  _temp_9785 = operand_9684->mInstruction ;
              if (_temp_9785._isBuilt ()) {
                typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_9785._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_9785 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (259)) ;
                }
              }
            }
          }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_10082 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)), true) ;
    const GGS_routineDefinitionList::cElement * operand_10082 = NULL ;
    while (((operand_10082 = enumerator_10082.nextObject ()))) {
      macroValidPointer (operand_10082) ;
      var_cas_outGeneratedInstructionList._addAssign_operation (GGS_pseudo_LABEL ::constructor_new (_inLexique, operand_10082->mRoutineName COMMA_HERE)) ;
      {
        GGS_instructionList::cEnumerator enumerator_10209 (operand_10082->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_10209 = NULL ;
        while (((operand_10209 = enumerator_10209.nextObject ()))) {
          macroValidPointer (operand_10209) ;
          var_cas_outGeneratedInstructionList._addAssign_operation (operand_10209->mInstruction) ;
          const GGS_instruction  _temp_10302 = operand_10209->mInstruction ;
          if (_temp_10302._isBuilt ()) {
            typeCategoryMethod__instruction__decomposeComplexInstruction _method = findCategoryMethod__instruction__decomposeComplexInstruction (_temp_10302._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_10302 (HERE), var_cas_localLabelIndex, var_cas_outGeneratedInstructionList COMMA_SOURCE_FILE_AT_LINE (271)) ;
            }
          }
        }
      }
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (275))).isBuiltAndTrue ()) {
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (284))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (287)))._operator_or (var_cas_inPiccoloModel.reader_mNeedsComputedGoto4 (_inLexique COMMA_SOURCE_FILE_AT_LINE (287)))).isBuiltAndTrue ()) {
    var_cas_outGeneratedInstructionList._addAssign_operation (GGS_instruction_FDA ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_instruction_FDA_base_code::constructor_ADDWF (_inLexique COMMA_HERE), GGS_registerExpression ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "WREG"), GGS_location (_inLexique) COMMA_HERE), GGS_luint ::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) COMMA_HERE), GGS_bool (true, true) COMMA_HERE)) ;
