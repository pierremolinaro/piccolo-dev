...
void routine_parseDeviceDefinition (C_Compiler & _inLexique,
  ...
  var_cas_deviceFullName = (var_cas_inDeviceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (19)))._operator_concat (GGS_string (true, ".piccoloDevice")) ;
  if ((var_cas_fw.reader_fileExistsAtPath (_inLexique, var_cas_deviceFullName COMMA_SOURCE_FILE_AT_LINE (20))).isBuiltAndTrue ()) {
    GGS_string var_cas_definitionString ;
    var_cas_definitionString = var_cas_fw.reader_fileContentsAtPath (_inLexique, var_cas_deviceFullName COMMA_SOURCE_FILE_AT_LINE (21)) ;
    ...
    var_cas_inDeviceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The '"))._operator_concat (var_cas_inDeviceName))._operator_concat (GGS_string (true, "' definition file is not defined")) COMMA_SOURCE_FILE_AT_LINE (28)) ;
