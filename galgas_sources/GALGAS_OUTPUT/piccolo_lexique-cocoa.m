...
static const BOOL kEndOfScriptInTemplateArray_piccolo_5F_lexique [136] = {
  NO /* identifier */,
  NO /* integer */,
  NO /* literal_char */,
  NO /* literal_string */,
...
static SInt32 search_into_piccolo_5F_lexique_controlKeyWordList (NSString * inSearchedString) {
...
static const C_cocoa_lexique_table_entry ktable_for_piccolo_5F_lexique_instructionKeyWordList [62] = {
...
static SInt32 search_into_piccolo_5F_lexique_instructionKeyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_piccolo_5F_lexique_instructionKeyWordList, 62) ;
}
...
- (UInt32) styleIndexForTerminal: (SInt32) inTerminal {
  static const UInt32 kTerminalSymbolStyles [137] = {0,
