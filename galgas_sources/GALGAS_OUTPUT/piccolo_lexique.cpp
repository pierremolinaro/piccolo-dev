...
static const char * gSyntaxErrorMessage_required = "the 'required' keyword" ;

//--- Syntax error message for terminal '$returned$' :
static const char * gSyntaxErrorMessage_returned = "the 'returned' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [118] = {"end of source",
       ...
       gSyntaxErrorMessage_required,
       gSyntaxErrorMessage_returned,
...
const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_controlKeyWordList [27] = {
  ...
  C_lexique_table_entry ("required", 8, piccolo_lexique_1_required),
  C_lexique_table_entry ("returned", 8, piccolo_lexique_1_returned),
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_instructionKeyWordList = 60 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_instructionKeyWordList [60] = {
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_delimitorsList = 25 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_delimitorsList [25] = {
  ...
  if (_p == NULL) {
    ...
    case  piccolo_lexique_1_ram:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1_required:
      s << '$'
        << "required"
        << '$' ;
      break;
    case  piccolo_lexique_1_returned:
      s << '$'
        << "returned"
        << '$' ;
      break;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [118] = {0,
    ...
    1 /* piccolo_lexique_1_required */,
    1 /* piccolo_lexique_1_returned */,
