...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [99] = {"end of source",
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_controlKeyWordList = 13 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_controlKeyWordList [13] = {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [99] = {0,
