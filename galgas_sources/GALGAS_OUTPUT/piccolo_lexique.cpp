...
//--- Message 0
static const char * gErrorMessage_0 = "ASCII code > 255" ;
//--- Message 1
static const char * gErrorMessage_1 = "decimal number too large" ;
//--- Message 2
static const char * gErrorMessage_2 = "incorrect literal character" ;
//--- Message 3
static const char * gErrorMessage_3 = "string does not end with '\"'" ;
//--- Message 4
...
//--- Syntax error message for terminal '$cpfseq$' :
static const char * gSyntaxErrorMessage_cpfseq = "the 'cpfseq' instruction" ;
...
//--- Syntax error message for terminal '$retfie$' :
static const char * gSyntaxErrorMessage_retfie = "the 'retfie' instruction" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [115] = {"end of source",
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_controlKeyWordList = 8 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_controlKeyWordList [8] = {
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_delimitorsList = 35 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_delimitorsList [35] = {
  ...
  C_lexique_table_entry ("\?", 1, piccolo_lexique_1__3F),
  ...
  C_lexique_table_entry ("!\?", 2, piccolo_lexique_1__21_3F),
  C_lexique_table_entry ("++", 2, piccolo_lexique_1__2B_2B),
  C_lexique_table_entry ("+=", 2, piccolo_lexique_1__2B_3D),
  C_lexique_table_entry ("--", 2, piccolo_lexique_1__2D_2D),
  C_lexique_table_entry ("-=", 2, piccolo_lexique_1__2D_3D),
  C_lexique_table_entry ("->", 2, piccolo_lexique_1__2D_3E),
  C_lexique_table_entry ("::", 2, piccolo_lexique_1__3A_3A),
  C_lexique_table_entry (":=", 2, piccolo_lexique_1__3A_3D),
  C_lexique_table_entry ("<-", 2, piccolo_lexique_1__3C_2D),
  ...
  C_lexique_table_entry ("\?!", 2, piccolo_lexique_1__3F_21),
  C_lexique_table_entry ("\?\?", 2, piccolo_lexique_1__3F_3F)
} ;
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_instructionKeyWordList = 66 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_instructionKeyWordList [66] = {
  ...
  C_lexique_table_entry ("cpfseq", 6, piccolo_lexique_1_cpfseq),
  ...
  C_lexique_table_entry ("retfie", 6, piccolo_lexique_1_retfie),
  ...
  if (_p == NULL) {
    ...
    case  piccolo_lexique_1__2B:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1__2B_2B:
      s << '$'
        << "++"
        << '$' ;
      break;
    case  piccolo_lexique_1__2B_3D:
      s << '$'
        << "+="
        << '$' ;
      break;
    ...
    case  piccolo_lexique_1__2D:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1__2D_2D:
      s << '$'
        << "--"
        << '$' ;
      break;
    case  piccolo_lexique_1__2D_3D:
      s << '$'
        << "-="
        << '$' ;
      break;
    case  piccolo_lexique_1__2D_3E:
      s << '$'
        << "->"
        << '$' ;
      break;
    ...
    case  piccolo_lexique_1__3A:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1__3A_3A:
      s << '$'
        << "::"
        << '$' ;
      break;
    case  piccolo_lexique_1__3A_3D:
      s << '$'
        << ":="
        << '$' ;
      break;
    ...
    case  piccolo_lexique_1__3E_3E:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1__3F:
      s << '$'
        << "\?"
        << '$' ;
      break;
    case  piccolo_lexique_1__3F_21:
      s << '$'
        << "\?!"
        << '$' ;
      break;
    case  piccolo_lexique_1__3F_3F:
      s << '$'
        << "\?\?"
        << '$' ;
      break;
    ...
    case  piccolo_lexique_1_tstfsz:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1_unsigned_5Fliteral_5Finteger:
      s << '$'
  ...
  while ((_token._mTokenCode < 0) && (mCurrentChar != '\0')) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        loop_ = true ;
        scanner_action_convertDecimalStringIntoUInt (_token.tokenString, _token.uint32value, gErrorMessage_0, gErrorMessage_1) ;
        _token._mTokenCode = piccolo_lexique_1_unsigned_5Fliteral_5Finteger ;
        _enterToken (_token) ;
        ...
        if (testForInputChar ('\\')) {
          if (testForInputChar ('f')) {
            ...
            if (testForInputChar ('0', '9') ||
                ...
                testForInputChar ('A', 'F')) {
              do {
                scanner_action_enterHexDigitIntoASCIIcharacter (_token.charValue, previousChar (), gErrorMessage_3, gErrorMessage_1) ;
                if (testForInputChar ('0', '9') ||
                    testForInputChar ('a', 'f') ||
                    testForInputChar ('A', 'F')) {
                }else{
        ...
        _token._mTokenCode = piccolo_lexique_1__21_3F ;
        _enterToken (_token) ;
      }else if (testForInputString ("++", 2)) {
        _token._mTokenCode = piccolo_lexique_1__2B_2B ;
        _enterToken (_token) ;
      }else if (testForInputString ("+=", 2)) {
        _token._mTokenCode = piccolo_lexique_1__2B_3D ;
        _enterToken (_token) ;
      }else if (testForInputString ("--", 2)) {
        _token._mTokenCode = piccolo_lexique_1__2D_2D ;
        _enterToken (_token) ;
      }else if (testForInputString ("-=", 2)) {
        _token._mTokenCode = piccolo_lexique_1__2D_3D ;
        _enterToken (_token) ;
      }else if (testForInputString ("->", 2)) {
        _token._mTokenCode = piccolo_lexique_1__2D_3E ;
        _enterToken (_token) ;
      }else if (testForInputString ("::", 2)) {
        _token._mTokenCode = piccolo_lexique_1__3A_3A ;
        _enterToken (_token) ;
      }else if (testForInputString (":=", 2)) {
        _token._mTokenCode = piccolo_lexique_1__3A_3D ;
        _enterToken (_token) ;
      }else if (testForInputString ("<-", 2)) {
        _token._mTokenCode = piccolo_lexique_1__3C_2D ;
        _enterToken (_token) ;
      }else if (testForInputString ("==", 2)) {
        ...
        _token._mTokenCode = piccolo_lexique_1__3F_21 ;
        _enterToken (_token) ;
      }else if (testForInputString ("\?\?", 2)) {
        _token._mTokenCode = piccolo_lexique_1__3F_3F ;
        _enterToken (_token) ;
        ...
        _token._mTokenCode = piccolo_lexique_1__3F ;
        _enterToken (_token) ;
      }else if (testForInputString ("[", 1)) {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [115] = {0,
    ...
    4 /* piccolo_lexique_1_unsigned_5Fliteral_5Finteger */,
