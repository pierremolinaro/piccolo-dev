  ...
  while ((_token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        loop_ = true ;
        _token.mTokenCode = search_into_instructionKeyWordList (_token.identifierString) ;
        if (_token.mTokenCode == -1) {
          _token.mTokenCode = search_into_controlKeyWordList (_token.identifierString) ;
        }
        if (_token.mTokenCode == -1) {
          _token.mTokenCode = piccolo_lexique_1_identifier ;
        }
        _enterToken (_token) ;
        ...
        loop_ = true ;
        _token.mTokenCode = piccolo_lexique_1_integer ;
        _enterToken (_token) ;
        ...
        if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
          if (testForInputUTF32Char (TO_UNICODE ('f'))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\f')) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('n'))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\n')) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('r'))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\r')) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('t'))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\t')) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('v'))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\v')) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\\')) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('0'))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\0')) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('\''))) {
            scanner_action_enterCharacterIntoCharacter (_token.charValue, TO_UNICODE ('\'')) ;
        ...
        loop_ = true ;
        if (testForInputUTF32Char (TO_UNICODE ('\"'))) {
          _token.mTokenCode = piccolo_lexique_1_literal_5Fstring ;
          _enterToken (_token) ;
        }else{
        ...
        _token.mTokenCode = piccolo_lexique_1_ ; // Empty string code
  ...
  while (_token.mTokenCode < 0) {
    ...
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
        ...
        loop_ = true ;
        _token.mTokenCode = piccolo_lexique_1_comment ;
      }else if (testForInputUTF32CharRange (TO_UNICODE (1), TO_UNICODE (' '))) {
      }else if (testForInputUTF32Char (TO_UNICODE ('\0'))) { // End of source text ? 
        _token.mTokenCode = piccolo_lexique_1_ ; // Empty string code
      }else{ // Unknown input character
