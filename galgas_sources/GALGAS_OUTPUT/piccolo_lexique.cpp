...
//--- Syntax error message for terminal '$rcomputed$' :
static const char * gSyntaxErrorMessage_rcomputed = "the 'rcomputed' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [105] = {"end of source",
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_controlKeyWordList = 22 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_controlKeyWordList [22] = {
  ...
  C_lexique_table_entry ("rcomputed", 9, piccolo_lexique_1_rcomputed)
} ;
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_instructionKeyWordList = 52 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_instructionKeyWordList [52] = {
  ...
  if (_p == NULL) {
    ...
    case  piccolo_lexique_1_computed:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1_rcomputed:
      s << '$'
        << "rcomputed"
        << '$' ;
      break;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [105] = {0,
