...
//--- Syntax error message for terminal '$requiresbank$' :
static const char * gSyntaxErrorMessage_requiresbank = "the 'requiresbank' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [115] = {"end of source",
       ...
       gSyntaxErrorMessage_requiresbank,
...
const sint16 piccolo_lexique::piccolo_lexique_table_size_controlKeyWordList = 25 ;

const C_lexique_table_entry piccolo_lexique::piccolo_lexique_table_for_controlKeyWordList [25] = {
  ...
  C_lexique_table_entry ("requiresbank", 12, piccolo_lexique_1_requiresbank)
} ;
  ...
  if (_p == NULL) {
    ...
    case  piccolo_lexique_1_label:
      s << '$'
        ...
        << '$' ;
      break;
    case  piccolo_lexique_1_requiresbank:
      s << '$'
        << "requiresbank"
        << '$' ;
      break;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [115] = {0,
    ...
    1 /* piccolo_lexique_1_requiresbank */,
