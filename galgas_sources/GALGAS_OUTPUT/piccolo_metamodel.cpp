...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getLiteralInstructionBaseCode (_inLexique,  mLiteralInstruction,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (466)) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (529))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (529)) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  var_cas_outLength = GGS_uint (true, 2U) ;
  {
    GGS_instructionList::cEnumerator enumerator_13724 (mInstructionList, true) ;
    const GGS_instructionList::cElement * operand_13724 = NULL ;
    while (((operand_13724 = enumerator_13724.nextObject ()))) {
      macroValidPointer (operand_13724) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_13775 = operand_13724->mInstruction ;
      if (_temp_13775._isBuilt ()) {
        _temp_13775 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (541)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (542)) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_instruction  _temp_14788 = mInstruction ;
  if (_temp_14788._isBuilt ()) {
    _temp_14788 (HERE)->method_instructionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (581)) ;
  }
  var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (582)) ;
}
...
method_getBaseCode (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outBaseCode COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_getBaseCodeForIfSemiColonOp (_inLexique,  mOpCode,  var_cas_outBaseCode COMMA_SOURCE_FILE_AT_LINE (592)) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (630))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (630))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (630)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (632)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (645))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (645))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (645)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (647)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (660))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (660))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (660)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (662)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_structured_if_condition  _temp_18195 = mIfCondition ;
  if (_temp_18195._isBuilt ()) {
    _temp_18195 (HERE)->method_conditionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (709)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_18237 (mThenInstructionList, true) ;
    const GGS_instructionList::cElement * operand_18237 = NULL ;
    while (((operand_18237 = enumerator_18237.nextObject ()))) {
      macroValidPointer (operand_18237) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_18292 = operand_18237->mInstruction ;
      if (_temp_18292._isBuilt ()) {
        _temp_18292 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (711)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (712)) ;
    }
  }
  if (((mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (714)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (715)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_18504 (mElseInstructionList, true) ;
    const GGS_instructionList::cElement * operand_18504 = NULL ;
    while (((operand_18504 = enumerator_18504.nextObject ()))) {
      macroValidPointer (operand_18504) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_18559 = operand_18504->mInstruction ;
      if (_temp_18559._isBuilt ()) {
        _temp_18559 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (718)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (719)) ;
    }
  }
}
