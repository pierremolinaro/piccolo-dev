...
mInstructionList (argument_1),
mEndOfInterruptLocation (argument_2) {
}
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_instructionList  p_1 = p->mInstructionList ;
          GGS_location  p_2 = p->mEndOfInterruptLocation ;
          _internalAppendValues (p_0, p_1, p_2 COMMA_HERE) ;
          p = p->nextObject () ;
        }
      }
...
internalSubListWithRange (GGS_interruptDefinitionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mInterruptName, _p->mInstructionList, _p->mEndOfInterruptLocation) ;
      _p = _p->nextObject () ;
    }
  }
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    ...
    _out_1 = _p->mInstructionList ;
    _out_2 = _p->mEndOfInterruptLocation ;
  }else{
    _out_0._drop () ;
    _out_1._drop () ;
    _out_2._drop () ;
