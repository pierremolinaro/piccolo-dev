...
GGS_immediatExpression (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_immediatExpression _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_immediatExpression (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
AC_galgasClassRunTimeInformation * GGS_immediatExpression::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatInteger * _p = dynamic_cast <const cPtr_immediatInteger *> (inOperand) ;
    macroValidPointer (_p) ;
...
GGS_immediatInteger::
GGS_immediatInteger (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatInteger (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatRegister * _p = dynamic_cast <const cPtr_immediatRegister *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mRegister._operator_isEqual (_p->mRegister).boolValue () ;
  }
  return equal ;
}
...
GGS_immediatRegister (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatRegister (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatAdd * _p = dynamic_cast <const cPtr_immediatAdd *> (inOperand) ;
    macroValidPointer (_p) ;
...
GGS_immediatAdd::
GGS_immediatAdd (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatAdd (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatSub * _p = dynamic_cast <const cPtr_immediatSub *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatSub::
GGS_immediatSub (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatSub (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatMul * _p = dynamic_cast <const cPtr_immediatMul *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatMul::
GGS_immediatMul (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatMul (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatDiv * _p = dynamic_cast <const cPtr_immediatDiv *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatDiv::
GGS_immediatDiv (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatDiv (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatMod * _p = dynamic_cast <const cPtr_immediatMod *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatMod::
GGS_immediatMod (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatMod (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatOr * _p = dynamic_cast <const cPtr_immediatOr *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatOr::
GGS_immediatOr (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatOr (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatAnd * _p = dynamic_cast <const cPtr_immediatAnd *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatAnd::
GGS_immediatAnd (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatAnd (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatXor * _p = dynamic_cast <const cPtr_immediatXor *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatXor::
GGS_immediatXor (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatXor (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatLeftShift * _p = dynamic_cast <const cPtr_immediatLeftShift *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatLeftShift (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatLeftShift (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatRightShift * _p = dynamic_cast <const cPtr_immediatRightShift *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatRightShift (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_immediatRightShift _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_immediatRightShift (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatEqualTest * _p = dynamic_cast <const cPtr_immediatEqualTest *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatEqualTest (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatEqualTest (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatNotEqualTest * _p = dynamic_cast <const cPtr_immediatNotEqualTest *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatNotEqualTest (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_immediatNotEqualTest _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_immediatNotEqualTest (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatGreaterTest * _p = dynamic_cast <const cPtr_immediatGreaterTest *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatGreaterTest (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_immediatGreaterTest _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_immediatGreaterTest (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatGreaterOrEqualTest * _p = dynamic_cast <const cPtr_immediatGreaterOrEqualTest *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatGreaterOrEqualTest (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_immediatGreaterOrEqualTest _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_immediatGreaterOrEqualTest (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatLowerTest * _p = dynamic_cast <const cPtr_immediatLowerTest *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatLowerTest (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatLowerTest (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatLowerOrEqualTest * _p = dynamic_cast <const cPtr_immediatLowerOrEqualTest *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mLeftExpression._operator_isEqual (_p->mLeftExpression).boolValue ()
         && mRightExpression._operator_isEqual (_p->mRightExpression).boolValue () ;
  }
...
GGS_immediatLowerOrEqualTest (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_immediatLowerOrEqualTest _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_immediatLowerOrEqualTest (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatNegate * _p = dynamic_cast <const cPtr_immediatNegate *> (inOperand) ;
    macroValidPointer (_p) ;
...
GGS_immediatNegate::
GGS_immediatNegate (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatNegate (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatComplement * _p = dynamic_cast <const cPtr_immediatComplement *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mExpression._operator_isEqual (_p->mExpression).boolValue () ;
  }
  return equal ;
...
GGS_immediatComplement (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_immediatComplement _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_immediatComplement (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_immediatSliceExpressionList * _p = dynamic_cast <const elementOf_GGS_immediatSliceExpressionList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mSliceName._operator_isEqual (_p->mSliceName).boolValue ()
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mSliceName.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
_operator_concat (const GGS_immediatSliceExpressionList & inOperand) const {
...
void GGS_immediatSliceExpressionList::
_dotAssign_operation (const GGS_immediatSliceExpressionList inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mSliceName,
                                _p->mExpression
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
...
internalSubListWithRange (GGS_immediatSliceExpressionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mSliceName, _p->mExpression) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@immediatSliceExpressionList", inIndentation COMMA_THERE) ;
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mSliceName ;
    _out_1 = _p->mExpression ;
  }else{
    _out_0._drop () ;
    _out_1._drop () ;
  }
...
/* const */ GGS_lstring  & GGS_immediatSliceExpressionList::cEnumerator::_mSliceName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mSliceName ;
}
...
/* const */ GGS_immediatExpression  & GGS_immediatSliceExpressionList::cEnumerator::_mExpression (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mExpression ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_immediatSlice * _p = dynamic_cast <const cPtr_immediatSlice *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mRegisterName._operator_isEqual (_p->mRegisterName).boolValue ()
         && mSliceExpressionList._operator_isEqual (_p->mSliceExpressionList).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@immediatSlice:"
           << mRegisterName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mSliceExpressionList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_immediatSlice::
GGS_immediatSlice (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_immediatSlice (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_immediatExpressionList * _p = dynamic_cast <const elementOf_GGS_immediatExpressionList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mExpression._operator_isEqual (_p->mExpression).boolValue () ;
  }
  return equal ;
...
_operator_concat (const GGS_immediatExpressionList & inOperand) const {
...
void GGS_immediatExpressionList::
_dotAssign_operation (const GGS_immediatExpressionList inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@immediatExpressionList", inIndentation COMMA_THERE) ;
}
...
GGS_declarationInRam (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_declarationInRam (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
AC_galgasClassRunTimeInformation * GGS_declarationInRam::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_byteDeclarationInRam * _p = dynamic_cast <const cPtr_byteDeclarationInRam *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mName._operator_isEqual (_p->mName).boolValue ()
         && mSize._operator_isEqual (_p->mSize).boolValue ()
         && mBitSliceTable._operator_isEqual (_p->mBitSliceTable).boolValue ()
         && mBitDefinitionString._operator_isEqual (_p->mBitDefinitionString).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@byteDeclarationInRam:"
           ...
           << mSize.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mBitSliceTable.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mBitDefinitionString.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_byteDeclarationInRam (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_byteDeclarationInRam _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_byteDeclarationInRam (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mDeclaration._operator_isEqual (_p->mDeclaration).boolValue () ;
  }
  return equal ;
}
    ...
    if (count () == 0) {
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_declarationInRam  p_0 = p->mDeclaration ;
          _internalAppendValues (p_0 COMMA_HERE) ;
          p = p->nextObject () ;
        }
      }
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mDeclaration
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
  }
...
internalSubListWithRange (GGS_declarationInRamList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mDeclaration) ;
      _p = _p->nextObject () ;
    }
  }
}
...
/* const */ GGS_declarationInRam  & GGS_declarationInRamList::cEnumerator::_mDeclaration (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_commonBranchList * _p = dynamic_cast <const elementOf_GGS_commonBranchList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mDeclarations._operator_isEqual (_p->mDeclarations).boolValue ()
         && mEndOfBranchLocation._operator_isEqual (_p->mEndOfBranchLocation).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mDeclarations.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mEndOfBranchLocation.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}
...
_operator_concat (const GGS_commonBranchList & inOperand) const {
...
void GGS_commonBranchList::
_dotAssign_operation (const GGS_commonBranchList inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mDeclarations,
                                _p->mEndOfBranchLocation
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
  }
...
internalSubListWithRange (GGS_commonBranchList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mDeclarations, _p->mEndOfBranchLocation) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@commonBranchList", inIndentation COMMA_THERE) ;
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mDeclarations ;
    _out_1 = _p->mEndOfBranchLocation ;
  }else{
    _out_0._drop () ;
    _out_1._drop () ;
  }
...
/* const */ GGS_declarationInRamList  & GGS_commonBranchList::cEnumerator::_mDeclarations (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mDeclarations ;
}
...
/* const */ GGS_location  & GGS_commonBranchList::cEnumerator::_mEndOfBranchLocation (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mEndOfBranchLocation ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_commonDeclarationInRam * _p = dynamic_cast <const cPtr_commonDeclarationInRam *> (inOperand) ;
    macroValidPointer (_p) ;
...
GGS_commonDeclarationInRam (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_commonDeclarationInRam _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_commonDeclarationInRam (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_configSettingList * _p = dynamic_cast <const elementOf_GGS_configSettingList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mSettingName._operator_isEqual (_p->mSettingName).boolValue ()
         && mSettingValue._operator_isEqual (_p->mSettingValue).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mSettingName.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mSettingValue.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}
...
_operator_concat (const GGS_configSettingList & inOperand) const {
...
void GGS_configSettingList::
_dotAssign_operation (const GGS_configSettingList inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mSettingName,
                                _p->mSettingValue
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
...
internalSubListWithRange (GGS_configSettingList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mSettingName, _p->mSettingValue) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@configSettingList", inIndentation COMMA_THERE) ;
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mSettingName ;
    _out_1 = _p->mSettingValue ;
  }else{
    _out_0._drop () ;
    _out_1._drop () ;
  }
...
/* const */ GGS_lstring  & GGS_configSettingList::cEnumerator::_mSettingName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mSettingName ;
}
...
/* const */ GGS_lstring  & GGS_configSettingList::cEnumerator::_mSettingValue (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mSettingValue ;
}
...
elementOf_GGS_configDefinitionList (const GGS_configSettingList & argument_0
                                COMMA_LOCATION_ARGS) :
AC_galgas_list::cListElement (THERE),
mSettingList (argument_0) {
}
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_configDefinitionList * _p = dynamic_cast <const elementOf_GGS_configDefinitionList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mSettingList._operator_isEqual (_p->mSettingList).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mSettingList.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}
...
_internalAppendValues (const GGS_configSettingList & argument_0
                    COMMA_LOCATION_ARGS) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0
                                COMMA_THERE)) ;
...
void GGS_configDefinitionList::
_internalPrependValues (const GGS_configSettingList & argument_0
                    COMMA_LOCATION_ARGS) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0
                                COMMA_THERE)) ;
...
void GGS_configDefinitionList::
_addAssign_operation (const GGS_configSettingList & argument_0) {
  if (_isBuilt ()&& argument_0._isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (argument_0
                                COMMA_HERE) ;
...
_operator_concat (const GGS_configDefinitionList & inOperand) const {
...
void GGS_configDefinitionList::
_dotAssign_operation (const GGS_configDefinitionList inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_configSettingList  p_0 = p->mSettingList ;
          _internalAppendValues (p_0 COMMA_HERE) ;
          p = p->nextObject () ;
        }
      }
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mSettingList
                                COMMA_HERE) ;
      _p = _p->nextObject () ;
    }
  }
...
GGS_configDefinitionList  GGS_configDefinitionList::
constructor_listWithValue (const GGS_configSettingList & argument_0) {
  GGS_configDefinitionList result ;
  result._alloc () ;
  result._addAssign_operation (argument_0) ;
  return result ;
...
internalSubListWithRange (GGS_configDefinitionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mSettingList) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@configDefinitionList", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_configSettingList  & GGS_configDefinitionList::cEnumerator::_mSettingList (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mSettingList ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_constantDefinitionList * _p = dynamic_cast <const elementOf_GGS_constantDefinitionList *> (inOperand) ;
    macroValidPointer (_p) ;
...
_operator_concat (const GGS_constantDefinitionList & inOperand) const {
...
void GGS_constantDefinitionList::
_dotAssign_operation (const GGS_constantDefinitionList inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
internalSubListWithRange (GGS_constantDefinitionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mConstantName, _p->mExpression) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@constantDefinitionList", inIndentation COMMA_THERE) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mRegisterValue.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_actualConfigurationMap * _p = dynamic_cast <const elementOf_GGS_actualConfigurationMap *> (inOperand) ;
  macroValidPointer (_p) ;
  return (mInfo.mRegisterAddress._operator_isEqual (_p->mInfo.mRegisterAddress)).boolValue ()
           && (mInfo.mRegisterValue._operator_isEqual (_p->mInfo.mRegisterValue)).boolValue () ;
}
...
_operator_isEqual (const GGS_actualConfigurationMap & inOperand) const {
...
GGS_bool GGS_actualConfigurationMap::
_operator_isNotEqual (const GGS_actualConfigurationMap & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToMap (inOperand)) ;
}
