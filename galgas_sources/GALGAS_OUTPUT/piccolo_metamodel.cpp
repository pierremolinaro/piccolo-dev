...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (649))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (649))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (649)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (651)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (664))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (664))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (664)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (666)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (679))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (679))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (679)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (681)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_structured_if_condition  _temp_18624 = mIfCondition ;
  if (_temp_18624._isBuilt ()) {
    _temp_18624 (HERE)->method_conditionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (728)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_18666 (mThenInstructionList, true) ;
    const GGS_instructionList::cElement * operand_18666 = NULL ;
    while (((operand_18666 = enumerator_18666.nextObject ()))) {
      macroValidPointer (operand_18666) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_18721 = operand_18666->mInstruction ;
      if (_temp_18721._isBuilt ()) {
        _temp_18721 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (730)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (731)) ;
    }
  }
  if (((mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (733)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (734)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_18933 (mElseInstructionList, true) ;
    const GGS_instructionList::cElement * operand_18933 = NULL ;
    while (((operand_18933 = enumerator_18933.nextObject ()))) {
      macroValidPointer (operand_18933) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_18988 = operand_18933->mInstruction ;
      if (_temp_18988._isBuilt ()) {
        _temp_18988 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (737)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (738)) ;
    }
  }
}
