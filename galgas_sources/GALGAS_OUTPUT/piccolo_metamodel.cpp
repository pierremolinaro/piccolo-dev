...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (512))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (512)) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
  ...
  var_cas_outLength = GGS_uint (true, 2U) ;
  {
    GGS_instructionList::cEnumerator enumerator_13493 (mInstructionList, true) ;
    const GGS_instructionList::cElement * operand_13493 = NULL ;
    while (((operand_13493 = enumerator_13493.nextObject ()))) {
      macroValidPointer (operand_13493) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_13544 = operand_13493->mInstruction ;
      if (_temp_13544._isBuilt ()) {
        _temp_13544 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (524)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (525)) ;
    }
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_instruction  _temp_13964 = mInstruction ;
  if (_temp_13964._isBuilt ()) {
    _temp_13964 (HERE)->method_instructionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (540)) ;
  }
  var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (541)) ;
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (620))._multiply_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (620))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (620)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (622)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outLength = mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (635))._multiply_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (635))._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (635)) ;
  if (((mUsesRelativeCall)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (637)) ;
  }
}
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_structured_if_condition  _temp_17783 = mIfCondition ;
  if (_temp_17783._isBuilt ()) {
    _temp_17783 (HERE)->method_conditionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (685)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_17825 (mThenInstructionList, true) ;
    const GGS_instructionList::cElement * operand_17825 = NULL ;
    while (((operand_17825 = enumerator_17825.nextObject ()))) {
      macroValidPointer (operand_17825) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_17880 = operand_17825->mInstruction ;
      if (_temp_17880._isBuilt ()) {
        _temp_17880 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (687)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (688)) ;
    }
  }
  if (((mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (690)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (691)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_18092 (mElseInstructionList, true) ;
    const GGS_instructionList::cElement * operand_18092 = NULL ;
    while (((operand_18092 = enumerator_18092.nextObject ()))) {
      macroValidPointer (operand_18092) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_18147 = operand_18092->mInstruction ;
      if (_temp_18147._isBuilt ()) {
        _temp_18147 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (694)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (695)) ;
    }
  }
}
