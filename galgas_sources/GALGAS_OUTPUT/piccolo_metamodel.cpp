...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_structured_if_condition  _temp_19566 = mIfCondition ;
  if (_temp_19566._isBuilt ()) {
    _temp_19566 (HERE)->method_conditionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (761)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_19608 (mThenInstructionList, true) ;
    const GGS_instructionList::cElement * operand_19608 = NULL ;
    while (((operand_19608 = enumerator_19608.nextObject ()))) {
      macroValidPointer (operand_19608) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_19663 = operand_19608->mInstruction ;
      if (_temp_19663._isBuilt ()) {
        _temp_19663 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (763)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (764)) ;
    }
  }
  if (((mElseInstructionList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (766)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_outLength = var_cas_outLength._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (767)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_19875 (mElseInstructionList, true) ;
    const GGS_instructionList::cElement * operand_19875 = NULL ;
    while (((operand_19875 = enumerator_19875.nextObject ()))) {
      macroValidPointer (operand_19875) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_19930 = operand_19875->mInstruction ;
      if (_temp_19930._isBuilt ()) {
        _temp_19930 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (770)) ;
      }
...
method_instructionLength (C_Compiler & _inLexique,
                                GGS_uint & var_cas_outLength COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_structured_if_condition  _temp_20309 = mWhileCondition ;
  if (_temp_20309._isBuilt ()) {
    _temp_20309 (HERE)->method_conditionLength (_inLexique, var_cas_outLength COMMA_SOURCE_FILE_AT_LINE (783)) ;
  }
  {
    GGS_instructionList::cEnumerator enumerator_20351 (mRepeatedInstructionList, true) ;
    const GGS_instructionList::cElement * operand_20351 = NULL ;
    while (((operand_20351 = enumerator_20351.nextObject ()))) {
      macroValidPointer (operand_20351) ;
      GGS_uint  var_cas_lg ;
      const GGS_instruction  _temp_20410 = operand_20351->mInstruction ;
      if (_temp_20410._isBuilt ()) {
        _temp_20410 (HERE)->method_instructionLength (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (785)) ;
      }
      var_cas_outLength = var_cas_outLength._add_operation (_inLexique, var_cas_lg COMMA_SOURCE_FILE_AT_LINE (786)) ;
    }
  }
}
...
GGS_structured_if_condition  GGS_instruction_do_while::
