...
GGS_luint  GGS_instruction_computed_retlw::
reader_mSize (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_instruction_computed_retlw *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_instruction_computed_retlw *) mPointer)->mSize ;
  }
  return result ;
}
...
GGS_luint  GGS_instruction_computed_bra::
reader_mSize (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_luint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_instruction_computed_bra *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_instruction_computed_bra *) mPointer)->mSize ;
  }
  return result ;
}
...
GGS_luint  GGS_instruction_computed_goto::
reader_mSize (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_luint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_instruction_computed_goto *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_instruction_computed_goto *) mPointer)->mSize ;
  }
  return result ;
}
...
mElsifPartList (argument_3),
mElseInstructionList (argument_4),
mEndOfElsePartLocation (argument_5) {
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation._operator_isEqual (_p->mInstructionLocation).boolValue ()
         ...
         && mElsifPartList._operator_isEqual (_p->mElsifPartList).boolValue ()
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@instruction_structured_if:"
           ...
           << mElsifPartList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
GGS_partList  GGS_instruction_structured_if::
reader_mElsifPartList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_partList   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_instruction_structured_if *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_instruction_structured_if *) mPointer)->mElsifPartList ;
  }
  return result ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = mInterruptName._operator_isEqual (_p->mInterruptName).boolValue ()
         && mIsFast._operator_isEqual (_p->mIsFast).boolValue ()
         && mInstructionList._operator_isEqual (_p->mInstructionList).boolValue ()
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mIsFast.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mInstructionList.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
...
internalSubListWithRange (GGS_interruptDefinitionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mInterruptName, _p->mIsFast, _p->mInstructionList, _p->mEndOfInterruptLocation) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_mIsFastAtIndex (C_Compiler & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const {
  GGS_bool result ;
  if (_isBuilt () && inIndex._isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
    if (object != NULL) {
      result = object->mIsFast ;
    }
  }
  return result ;
}
...
void GGS_interruptDefinitionList::
modifier_setMIsFastAtIndex (C_Compiler & inLexique,
...
/* const */ GGS_bool & GGS_interruptDefinitionList::cEnumerator::_mIsFast (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mIsFast ;
}
