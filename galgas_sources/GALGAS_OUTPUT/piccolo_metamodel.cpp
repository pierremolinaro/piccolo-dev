...
constructor_new (const GGS_lstring & argument_0,
                 ...
                 const GGS_ramDefinitionList & argument_3,
                 const GGS_interruptDefinitionList & argument_4,
                 const GGS_routineDefinitionList & argument_5,
  ...
  result.mRamDefinitionList = argument_3 ;
  result.mInterruptDefinitionList = argument_4 ;
  result.mRoutineDefinitionList = argument_5 ;
  result.mNeedsComputedGoto2 = argument_6 ;
  result.mNeedsComputedGoto4 = argument_7 ;
  return result ;
}
