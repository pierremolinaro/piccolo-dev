...
mBanksel (argument_1),
mIsNoReturn (argument_2),
mInstructionList (argument_3),
mEndOfRoutineLocation (argument_4) {
}
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_bool p_2 = p->mIsNoReturn ;
          GGS_instructionList  p_3 = p->mInstructionList ;
          GGS_location  p_4 = p->mEndOfRoutineLocation ;
...
internalSubListWithRange (GGS_routineDefinitionList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mRoutineName, _p->mBanksel, _p->mIsNoReturn, _p->mInstructionList, _p->mEndOfRoutineLocation) ;
      _p = _p->nextObject () ;
    }
  }
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    ...
    _out_1 = _p->mBanksel ;
    _out_2 = _p->mIsNoReturn ;
    _out_3 = _p->mInstructionList ;
    _out_4 = _p->mEndOfRoutineLocation ;
  }else{
    _out_0._drop () ;
    _out_1._drop () ;
    _out_2._drop () ;
