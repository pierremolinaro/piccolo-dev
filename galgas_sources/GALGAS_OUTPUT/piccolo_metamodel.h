...
class GGS_pseudo_LABEL : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_pseudo_LABEL (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_conditionalBranch : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_conditionalBranch (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_BRA : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_BRA (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_CALL : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_CALL (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_GOTO : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_GOTO (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_RCALL : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_RCALL (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_RETURN : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_RETURN (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_RETFIE : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_RETFIE (void) : GGS_piccolo_instruction () {}
...
class GGS_instruction_MOVLB : public GGS_piccolo_instruction {
//--- Default constructor
  public : inline GGS_instruction_MOVLB (void) : GGS_piccolo_instruction () {}
...
class elementOf_GGS_elsifPartList ;

class GGS_elsifPartList : public AC_galgas_list {
  public : typedef elementOf_GGS_elsifPartList cElement ;

//--- Constructor 'emptyList'
  public : static GGS_elsifPartList constructor_emptyList (void) ;
  public : static GGS_elsifPartList constructor_listWithValue (const GGS_conditionExpression & argument_0,
                                const GGS_instructionList & argument_1) ;
//--- Get sublist
  protected : void
  internalSubListWithRange (GGS_elsifPartList & ioList,
                            const sint32 inFirstIndex,
                            const sint32 inCount) const ;

  public : GGS_elsifPartList
  reader_subListWithRange (C_Compiler & _inLexique,
                           const GGS_uint & inFirstIndex,
                           const GGS_uint & inCount
                           COMMA_LOCATION_ARGS) const ;
...
//--- Operator () used for method call
  public : const GGS_elsifPartList * operator () (UNUSED_LOCATION_ARGS) const { return this ;} 
//--- Method 'first'
  public : void method_first (C_Compiler & _inLexique,
...
//--- Modifier 'popFirst'
  public : void modifier_popFirst (C_Compiler & _inLexique,
                                 ...
                                 COMMA_LOCATION_ARGS) ;
//--- Handle '.=' operator
  public : void _dotAssign_operation (const GGS_elsifPartList inOperand) ;

//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_conditionExpression & argument_0,
                                const GGS_instructionList & argument_1) ;
//--- Handling '.' GALGAS operator
  public : GGS_elsifPartList _operator_concat (const GGS_elsifPartList & inOperand) const ;
  public : void modifier_prependValue (C_Compiler & _inLexique,
                                const GGS_conditionExpression & argument_0,
                                const GGS_instructionList & argument_1
                                COMMA_LOCATION_ARGS) ;
...
//--------------------------------- List Enumerator
  public : class cEnumerator : public cAbstractListEnumerator {
  //--- Constructor
    public : inline cEnumerator (const GGS_elsifPartList & inList,
                                 const bool inAscending) :
    cAbstractListEnumerator (inList, inAscending) {
    }
  //--- Iterator method
...
//--- 'new' constructor
  public : static GGS_instruction_structured_if constructor_new (C_Compiler & inLexique,
                                ...
                                const GGS_elsifPartList & argument_3,
...
//--- Readers
  ...
  public : GGS_elsifPartList  reader_mElsifPartList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     Element of list '@elsifPartList'                      *
//                                                                           *
//---------------------------------------------------------------------------*

class elementOf_GGS_elsifPartList : public AC_galgas_list::cListElement {
//--- Attributes
  public : GGS_conditionExpression  mCondition ;
  public : GGS_instructionList  mInstructionList ;
//--- Constructor
  public : elementOf_GGS_elsifPartList (const GGS_conditionExpression & ,
                                const GGS_instructionList & 
                                COMMA_LOCATION_ARGS) ;

//--- Access to next
  public : inline elementOf_GGS_elsifPartList * nextObject (void) const { return (elementOf_GGS_elsifPartList *) internalNextItem () ; }

//--- Access to previous
  public : inline elementOf_GGS_elsifPartList * previousObject (void) const { return (elementOf_GGS_elsifPartList *) internalPreviousItem () ; }
...
//--- Friend class declaration
  friend class GGS_elsifPartList ;
} ;
