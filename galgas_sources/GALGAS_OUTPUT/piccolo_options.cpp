...
char piccolo_options::getBoolOptionChar (const sint32 inIndex) const {
  const char kCharArray [4] = {'r', 's', 'L', '\0'} ;
...
const char * piccolo_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [4] = {"do-not-convert-relative",
    "asm",
    "log",
    ""} ;
...
const char * piccolo_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [4] = {"Do not convert relative branch to absolute ones, when needed",
...
boolOptionValueFromKeys (const char * inModuleName,
                         ...
                         bool * outFound) const {
  const char * kKeyArray [4] = {"doNotConvertRelative",
    "generateAssembly",
    "ouputListFile",
    ""} ;
  bool result = false ;
