...
getStringOptionChar (const sint32 inIndex) const {
  static const char kCharArray [2] = {'M', '\0'} ;
...
getStringOptionString (const sint32 inIndex) const {
  static const char * kStringArray [2] = {"memory",
    ""} ;
...
getStringOptionDescription (const sint32 inIndex) const {
  static const char * kDescriptionArray [2] = {"Output the description of RAM, ROM and EEPROM of the device named by string",
    ""} ;
...
stringOptionValueFromKeys (const char * inModuleName,
                           const char * inOptionName,
                           bool * outFound) const {
  static const char * kKeyArray [2] = {"memoryDescription",
    ""} ;
  C_String result ;
  bool found = strcmp (inModuleName, "piccolo_options") == 0 ;
  if (found) {
