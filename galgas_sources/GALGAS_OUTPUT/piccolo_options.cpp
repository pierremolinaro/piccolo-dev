...
const char * piccolo_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [3] = {"do-not-convert-relative",
    "asm",
    ""} ;
...
const char * piccolo_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [3] = {"Do not convert relative branch to absolute ones, when needed",
...
boolOptionValueFromKeys (const char * inModuleName,
                         ...
                         bool * outFound) const {
  const char * kKeyArray [3] = {"doNotConvertRelative",
    "generateAssembly",
    ""} ;
  bool result = false ;
