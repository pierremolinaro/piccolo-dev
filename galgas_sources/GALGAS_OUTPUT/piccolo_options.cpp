...
char piccolo_options::getBoolOptionChar (const sint32 inIndex) const {
  const char kCharArray [5] = {'C', 'S', 'D', 'L', '\0'} ;
...
const char * piccolo_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [5] = {"do-not-convert-relative",
    "asm",
    "device-list",
    "log",
    ""} ;
...
const char * piccolo_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [5] = {"Do not convert relative branch to absolute ones, when needed",
    "Generate assembly language text file, instead of hex file",
...
boolOptionValueFromKeys (const char * inModuleName,
                         ...
                         bool * outFound) const {
  const char * kKeyArray [5] = {"doNotConvertRelative",
    "generateAssembly",
    "ouputDeviceList",
    "ouputListFile",
    ""} ;
...
getStringOptionChar (const sint32 inIndex) const {
  static const char kCharArray [3] = {'M', 'R', '\0'} ;
...
getStringOptionString (const sint32 inIndex) const {
  static const char * kStringArray [3] = {"memory",
    "registers",
    ""} ;
...
getStringOptionDescription (const sint32 inIndex) const {
  static const char * kDescriptionArray [3] = {"Output the RAM, ROM and EEPROM description of the device named by string",
    "Output the register descriptionof the device named by string",
    ""} ;
...
stringOptionValueFromKeys (const char * inModuleName,
                           const char * inOptionName,
                           bool * outFound) const {
  static const char * kKeyArray [3] = {"memoryDescription",
    "registerDescription",
    ""} ;
  C_String result ;
  bool found = strcmp (inModuleName, "piccolo_options") == 0 ;
