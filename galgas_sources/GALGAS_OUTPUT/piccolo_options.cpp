...
char piccolo_options::getBoolOptionChar (const sint32 inIndex) const {
  const char kCharArray [6] = {'C', 'S', 'D', 'L', 'O', '\0'} ;
...
const char * piccolo_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [6] = {"do-not-convert-relative",
    "asm",
    "device-list",
    "list",
    "optimize",
...
const char * piccolo_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [6] = {"Do not convert relative branch to absolute ones, when needed",
...
boolOptionValueFromKeys (const char * inModuleName,
                         ...
                         bool * outFound) const {
  const char * kKeyArray [6] = {"doNotConvertRelative",
    "generateAssembly",
    "ouputDeviceList",
    "ouputListFile",
...
getStringOptionChar (const sint32 inIndex) const {
  static const char kCharArray [4] = {'F', 'M', 'R', '\0'} ;
...
getStringOptionString (const sint32 inIndex) const {
  static const char * kStringArray [4] = {"configuration",
    "memory",
    "registers",
    ""} ;
...
getStringOptionDescription (const sint32 inIndex) const {
  static const char * kDescriptionArray [4] = {"Output the configuration register description of the device named by string",
...
stringOptionValueFromKeys (const char * inModuleName,
                           const char * inOptionName,
                           bool * outFound) const {
  static const char * kKeyArray [4] = {"configDescription",
    "memoryDescription",
    "registerDescription",
    ""} ;
  C_String result ;
