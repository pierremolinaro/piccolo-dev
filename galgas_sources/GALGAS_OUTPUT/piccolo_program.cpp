...
//                    february 25th, 2009, at 20h14'26"                      *
//                                                                           *
//---------------------------------------------------------------------------*
    ...
    var_cas_ok = GGS_bool (true, true) ;
    {
      ...
      while (((operand_901 = enumerator_901.nextObject ()))
        ...
        case GGS_processorType::enum_midrange:
          ...
          if (((var_cas_piccoloDeviceModel.reader_mBankCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (29)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (29)))._operator_strictSup (GGS_uint (true, 4U))).isBuiltAndTrue ()) {
            _inLexique.printMessage ((((var_cas_name)._operator_concat (GGS_string (true, " has ")))._operator_concat (var_cas_piccoloDeviceModel.reader_mBankCount (_inLexique COMMA_SOURCE_FILE_AT_LINE (30)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (30)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (30))))._operator_concat (GGS_string (true, " banks\n")) COMMA_SOURCE_FILE_AT_LINE (30)) ;
          }
          }
          break ;
    ...
    if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "outputDeviceList" COMMA_SOURCE_FILE_AT_LINE (46))))._operator_or (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "outputBaselineDeviceList" COMMA_SOURCE_FILE_AT_LINE (46))))).isBuiltAndTrue ()) {
      ...
      var_cas_index = GGS_uint (true, 0U) ;
      {
        ...
        while (((operand_2241 = enumerator_2241.nextObject ()))) {
          ...
          _inLexique.printMessage (operand_2241->mValue.reader_stringByRightPadding (_inLexique, GGS_uint (true, 15U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (50)) COMMA_SOURCE_FILE_AT_LINE (50)) ;
    ...
    if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "outputDeviceList" COMMA_SOURCE_FILE_AT_LINE (62))))._operator_or (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "outputMidrangeDeviceList" COMMA_SOURCE_FILE_AT_LINE (62))))).isBuiltAndTrue ()) {
      ...
      var_cas_index = GGS_uint (true, 0U) ;
      {
        ...
        while (((operand_2845 = enumerator_2845.nextObject ()))) {
          ...
          _inLexique.printMessage (operand_2845->mValue.reader_stringByRightPadding (_inLexique, GGS_uint (true, 15U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)) ;
    ...
    if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "outputDeviceList" COMMA_SOURCE_FILE_AT_LINE (78))))._operator_or (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "outputPic18DeviceList" COMMA_SOURCE_FILE_AT_LINE (78))))).isBuiltAndTrue ()) {
      ...
      var_cas_index = GGS_uint (true, 0U) ;
      {
        ...
        while (((operand_3432 = enumerator_3432.nextObject ()))) {
          ...
          _inLexique.printMessage (operand_3432->mValue.reader_stringByRightPadding (_inLexique, GGS_uint (true, 15U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (82)) COMMA_SOURCE_FILE_AT_LINE (82)) ;
    ...
    if ((GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (_inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (113))).isBuiltAndTrue ()) {
      ...
      _inLexique.printMessage (((((GGS_string (true, "  "))._operator_concat (var_cas_piccoloDeviceModel.reader_mRamBankTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (121))))._operator_concat (GGS_string (true, " RAM banks (total ")))._operator_concat (var_cas_totalRam.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (121))))._operator_concat (GGS_string (true, " bytes):\n")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
      {
        ...
        while (((operand_5297 = enumerator_5297.nextObject ()))) {
          ...
          _inLexique.printMessage (((((((((GGS_string (true, "    bank \""))._operator_concat (operand_5297->mKey))._operator_concat (GGS_string (true, "\" from ")))._operator_concat (operand_5297->mInfo.mFirstFreeAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (123))))._operator_concat (GGS_string (true, " to ")))._operator_concat (operand_5297->mInfo.mLastAddressPlusOne._substract_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (124)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (124))))._operator_concat (GGS_string (true, " (")))._operator_concat (operand_5297->mInfo.mLastAddressPlusOne._substract_operation (_inLexique, operand_5297->mInfo.mFirstFreeAddress COMMA_SOURCE_FILE_AT_LINE (125)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (125))))._operator_concat (GGS_string (true, " bytes)")) COMMA_SOURCE_FILE_AT_LINE (123)) ;
          {
    ...
    if ((GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (_inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (161))).isBuiltAndTrue ()) {
      ...
      _inLexique.printMessage ((((var_cas_deviceForRegistersDescription)._operator_concat (GGS_string (true, " has ")))._operator_concat (var_cas_piccoloDeviceModel.reader_mRegisterTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (164))))._operator_concat (GGS_string (true, " special registers:\n")) COMMA_SOURCE_FILE_AT_LINE (164)) ;
      {
        ...
        while (((operand_7536 = enumerator_7536.nextObject ()))) {
          ...
          GGS_string var_cas_s ;
          var_cas_s = ((GGS_string (true, "  '"))._operator_concat (operand_7536->mKey))._operator_concat (GGS_string (true, "' at ")) ;
          {
