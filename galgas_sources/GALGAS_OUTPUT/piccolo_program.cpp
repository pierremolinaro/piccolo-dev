...
piccolo_program_prologue (C_Compiler & inLexique,
    ...
    GGS_stringlist  var_cas_allDevices = GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_allFilePathes (inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
    {
      ...
      while (((operand_4205 = enumerator_4205.nextObject ()))) {
        ...
        if (var_cas_definitionString.isBuilt ()) {
          var_cas_definitionString (HERE)->method_writeToFile (inLexique, (var_cas_dir).operator_concat (operand_4205->mValue) COMMA_SOURCE_FILE_AT_LINE (105)) ;
        }
      }
    }
  ...
  const GGS_bool cond_6899 = (var_cas_deviceForMemoryDescription.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_6899.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_6778 = GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (113)) ;
    if (cond_6778.isBuiltAndTrue ()) {
      GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
      ...
      inLexique.printMessage (((((GGS_string ("  ")).operator_concat (var_cas_piccoloDeviceModel.reader_mRamBankTable (inLexique COMMA_SOURCE_FILE_AT_LINE (121)).reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121)))).operator_concat (GGS_string (" RAM banks (total "))).operator_concat (var_cas_totalRam.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121)))).operator_concat (GGS_string (" bytes):\n")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
      {
        ...
        while (((operand_5345 = enumerator_5345.nextObject ()))) {
          ...
          {
            GGS_uintlist::cEnumerator enumerator_5628 (operand_5345->mInfo.mMirrorOffsetList, true) ;
            const GGS_uintlist::cElement * operand_5628 = enumerator_5628.nextObject () ;
            if ((operand_5628 != NULL)) {
              inLexique.printMessage (GGS_string (", mirror at ") COMMA_SOURCE_FILE_AT_LINE (127)) ;
              bool _foreach_loop_5628 ;
              do{
                macroValidPointer (operand_5628) ;
                inLexique.printMessage (operand_5345->mInfo.mFirstFreeAddress.add_operation (inLexique, operand_5628->mValue COMMA_SOURCE_FILE_AT_LINE (128)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) COMMA_SOURCE_FILE_AT_LINE (128)) ;
                operand_5628 = enumerator_5628.nextObject () ;
                _foreach_loop_5628 = ((operand_5628 != NULL)) ;
                if (_foreach_loop_5628) {
                  inLexique.printMessage (GGS_string (", ") COMMA_SOURCE_FILE_AT_LINE (129)) ;
                }
              }while (_foreach_loop_5628) ;
            }
          }
      ...
      case GGS_processorType::enum_midrange:
        ...
        const GGS_bool cond_6195 = (var_cas_pageCount).operator_strictSup (GGS_uint (1U)) ;
        if (cond_6195.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_6592 = (var_cas_piccoloDeviceModel.reader_mEepromSize (inLexique COMMA_SOURCE_FILE_AT_LINE (147))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_6592.isBuiltAndTrue ()) {
        inLexique.printMessage (GGS_string ("  No EEPROM\n") COMMA_SOURCE_FILE_AT_LINE (148)) ;
      }else if (cond_6592.isBuiltAndFalse ()) {
    ...
    }else if (cond_6778.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_8014 = (var_cas_deviceForRegistersDescription.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_8014.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_7890 = GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (161)) ;
    if (cond_7890.isBuiltAndTrue ()) {
      GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
      ...
      {
        GGS_registerTable::cEnumerator enumerator_7591 (var_cas_piccoloDeviceModel.reader_mRegisterTable (inLexique COMMA_SOURCE_FILE_AT_LINE (165)), true) ;
        const GGS_registerTable::cElement * operand_7591 = NULL ;
        while (((operand_7591 = enumerator_7591.nextObject ()))) {
          macroValidPointer (operand_7591) ;
          GGS_string var_cas_s = ((GGS_string ("  '")).operator_concat (operand_7591->mKey)).operator_concat (GGS_string ("' at ")) ;
          {
            GGS_uintlist::cEnumerator enumerator_7711 (operand_7591->mInfo.mRegisterAddressList, true) ;
            const GGS_uintlist::cElement * operand_7711 = enumerator_7711.nextObject () ;
            if ((operand_7711 != NULL)) {
              bool _foreach_loop_7711 ;
              do{
                macroValidPointer (operand_7711) ;
                var_cas_s.dotAssign_operation (operand_7711->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (168))) ;
                operand_7711 = enumerator_7711.nextObject () ;
                _foreach_loop_7711 = ((operand_7711 != NULL)) ;
                if (_foreach_loop_7711) {
                  var_cas_s.appendCString (", ") ;
                }
              }while (_foreach_loop_7711) ;
            }
          }
          var_cas_s.dotAssign_operation (operand_7591->mInfo.mBitDefinitionString) ;
          var_cas_s.appendCString ("\n") ;
          inLexique.printMessage (var_cas_s COMMA_SOURCE_FILE_AT_LINE (172)) ;
        }
      }
    }else if (cond_7890.isBuiltAndFalse ()) {
  ...
  const GGS_bool cond_9698 = (var_cas_deviceForConfigDescription.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_9698.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_9577 = GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (182)) ;
    if (cond_9577.isBuiltAndTrue ()) {
      GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
      ...
      {
        GGS_configRegisterMap::cEnumerator enumerator_8703 (var_cas_piccoloDeviceModel.reader_mConfigRegisterMap (inLexique COMMA_SOURCE_FILE_AT_LINE (186)), true) ;
        const GGS_configRegisterMap::cElement * operand_8703 = NULL ;
        while (((operand_8703 = enumerator_8703.nextObject ()))) {
          macroValidPointer (operand_8703) ;
          GGS_string var_cas_s = ((((((GGS_string ("REGISTER '")).operator_concat (operand_8703->mKey)).operator_concat (GGS_string ("' at "))).operator_concat (operand_8703->mInfo.mRegisterAddress.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (187)))).operator_concat (GGS_string (", width "))).operator_concat (operand_8703->mInfo.mRegisterWidth.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)))).operator_concat (GGS_string ("\n")) ;
          {
            GGS_illegalMaskList::cEnumerator enumerator_8921 (operand_8703->mInfo.mIllegalMaskList, true) ;
            const GGS_illegalMaskList::cElement * operand_8921 = NULL ;
            while (((operand_8921 = enumerator_8921.nextObject ()))) {
              macroValidPointer (operand_8921) ;
              var_cas_s.appendCString ("  illegal value ") ;
              var_cas_s.dotAssign_operation (operand_8921->mIllegalValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (189))) ;
              var_cas_s.appendCString (" mask ") ;
              var_cas_s.dotAssign_operation (operand_8921->mIllegalMask.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (189))) ;
              var_cas_s.appendCString (" description \"") ;
              var_cas_s.dotAssign_operation (operand_8921->mDescription) ;
              var_cas_s.appendCString ("\"\n") ;
            }
          }
          {
            GGS_configRegisterMaskMap::cEnumerator enumerator_9145 (operand_8703->mInfo.mConfigRegisterMaskMap, true) ;
            const GGS_configRegisterMaskMap::cElement * operand_9145 = NULL ;
            while (((operand_9145 = enumerator_9145.nextObject ()))) {
              macroValidPointer (operand_9145) ;
              var_cas_s.appendCString ("  setting '") ;
              var_cas_s.dotAssign_operation (operand_9145->mKey) ;
              var_cas_s.appendCString ("': mask ") ;
              var_cas_s.dotAssign_operation (operand_9145->mInfo.mMaskValue.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (192))) ;
              var_cas_s.appendCString (" description \"") ;
              var_cas_s.dotAssign_operation (operand_9145->mInfo.mDescription) ;
              var_cas_s.appendCString ("\"\n") ;
              {
                GGS_fieldSettingMap::cEnumerator enumerator_9357 (operand_9145->mInfo.mFieldSettingMap, true) ;
                const GGS_fieldSettingMap::cElement * operand_9357 = NULL ;
                while (((operand_9357 = enumerator_9357.nextObject ()))) {
                  macroValidPointer (operand_9357) ;
                  var_cas_s.appendCString ("    value ") ;
                  var_cas_s.dotAssign_operation (operand_9357->mInfo.mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (194))) ;
                  var_cas_s.appendCString (" description \"") ;
                  var_cas_s.dotAssign_operation (operand_9357->mKey) ;
                  var_cas_s.appendCString ("\"\n") ;
                }
              }
            }
    ...
    }else if (cond_9577.isBuiltAndFalse ()) {
