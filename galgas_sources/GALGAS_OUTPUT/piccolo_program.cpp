...
//                    november 15th, 2010, at 20h33'29"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_before (C_Compiler * inCompiler
  ...
  if (GALGAS_bool (gOption_piccolo_5F_options_outputDeviceList.reader_value ()).operator_or (GALGAS_bool (gOption_piccolo_5F_options_outputPic_31__38_DeviceList.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (10)).operator_or (GALGAS_bool (gOption_piccolo_5F_options_outputBaselineDeviceList.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (11)).operator_or (GALGAS_bool (gOption_piccolo_5F_options_outputMidrangeDeviceList.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (12)).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringlist var_allDevices = GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_allFilePathes (SOURCE_FILE_AT_LINE (14)) ;
    ...
    cEnumerator_stringlist enumerator_825 (var_allDevices, true) ;
    //--- complex foreach instruction
    bool bool_0 = var_ok.isValidAndTrue () ;
    if (enumerator_825.hasCurrentObject () && bool_0) {
      while (enumerator_825.hasCurrentObject () && bool_0) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_piccoloDeviceModel var_piccoloDeviceModel ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_name = enumerator_825.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (22)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (22)) ;
        ...
        if (var_piccoloDeviceModel.reader_mProcessorType (SOURCE_FILE_AT_LINE (24)).isValid ()) {
          ...
          case GALGAS_processorType::kEnum_midrange: {
            ...
            //-------- @ifInstructionForGeneration
            if (GALGAS_bool (kIsStrictSup, var_piccoloDeviceModel.reader_mBankCount (SOURCE_FILE_AT_LINE (27)).reader_uint (SOURCE_FILE_AT_LINE (27)).objectCompare (GALGAS_uint ((PMUInt32) 4U))).isValidAndTrue ()) {
        ...
        if (enumerator_825.hasCurrentObject ()) {
          bool_0 = var_ok.isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (gOption_piccolo_5F_options_outputDeviceList.reader_value ()).operator_or (GALGAS_bool (gOption_piccolo_5F_options_outputBaselineDeviceList.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (44)).isValidAndTrue ()) {
      //-------- @messageInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_2172 (var_baseline_5F_devices, true) ;
      //--- simple foreach instruction
      while (enumerator_2172.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_2172.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (48)) COMMA_SOURCE_FILE_AT_LINE (48)) ;
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (gOption_piccolo_5F_options_outputDeviceList.reader_value ()).operator_or (GALGAS_bool (gOption_piccolo_5F_options_outputMidrangeDeviceList.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (60)).isValidAndTrue ()) {
      //-------- @messageInstructionForGeneration
      ...
      GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_2778 (var_midrange_5F_devices, true) ;
      //--- simple foreach instruction
      while (enumerator_2778.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_2778.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (64)) COMMA_SOURCE_FILE_AT_LINE (64)) ;
        //-------- @incrementInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (gOption_piccolo_5F_options_outputDeviceList.reader_value ()).operator_or (GALGAS_bool (gOption_piccolo_5F_options_outputPic_31__38_DeviceList.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (76)).isValidAndTrue ()) {
      //-------- @messageInstructionForGeneration
      ...
      GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_3367 (var_pic_31__38__5F_devices, true) ;
      //--- simple foreach instruction
      while (enumerator_3367.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_3367.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (80)) COMMA_SOURCE_FILE_AT_LINE (80)) ;
        //-------- @incrementInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, GALGAS_string (gOption_piccolo_5F_options_exportDeviceFiles.reader_value ()).reader_length (SOURCE_FILE_AT_LINE (94)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_dir = GALGAS_string (gOption_piccolo_5F_options_exportDeviceFiles.reader_value ()) ;
    //-------- @ifInstructionForGeneration
    if (var_dir.reader_directoryExists (SOURCE_FILE_AT_LINE (96)).operator_not (SOURCE_FILE_AT_LINE (96)).isValidAndTrue ()) {
    ...
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringlist var_allDevices = GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_allFilePathes (SOURCE_FILE_AT_LINE (100)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_4102 (var_allDevices, true) ;
    //--- simple foreach instruction
    while (enumerator_4102.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_definitionString = var_fw.reader_fileContentsAtPath (enumerator_4102.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (102)) ;
      //-------- @methodCallInstructionForGeneration
      var_definitionString.method_writeToFile (var_dir.operator_concat (enumerator_4102.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (103)), inCompiler COMMA_SOURCE_FILE_AT_LINE (103)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, var_deviceForMemoryDescription.reader_length (SOURCE_FILE_AT_LINE (109)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (var_devicePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (111)).isValidAndTrue ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_piccoloDeviceModel var_piccoloDeviceModel ;
      { //-------- @routineCallInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_ramBankTable enumerator_4937 (var_piccoloDeviceModel.reader_mRamBankTable (SOURCE_FILE_AT_LINE (115)), true) ;
      //--- simple foreach instruction
      while (enumerator_4937.hasCurrentObject ()) {
        //-------- @assignmentInstructionForGeneration
        var_totalRam = var_totalRam.add_operation (enumerator_4937.current_mLastAddressPlusOne (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)).substract_operation (enumerator_4937.current_mFirstFreeAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) ;
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_ramBankTable enumerator_5275 (var_piccoloDeviceModel.reader_mRamBankTable (SOURCE_FILE_AT_LINE (120)), true) ;
      //--- simple foreach instruction
      while (enumerator_5275.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (GALGAS_string ("    bank \"").operator_concat (enumerator_5275.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string ("\" from ") COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (enumerator_5275.current_mFirstFreeAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string (" to ") COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (enumerator_5275.current_mLastAddressPlusOne (HERE).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (122)).reader_hexString (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (enumerator_5275.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_5275.current_mFirstFreeAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (123)).reader_string (SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (GALGAS_string (" bytes)") COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (121)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_uintlist enumerator_5537 (enumerator_5275.current_mMirrorOffsetList (HERE), true) ;
        //--- complex foreach instruction
        const bool bool_1 = true ;
        if (enumerator_5537.hasCurrentObject () && bool_1) {
          //-------- @messageInstructionForGeneration
          inCompiler->printMessage (GALGAS_string (", mirror at ") COMMA_SOURCE_FILE_AT_LINE (125)) ;
          while (enumerator_5537.hasCurrentObject () && bool_1) {
            //-------- @messageInstructionForGeneration
            inCompiler->printMessage (enumerator_5275.current_mFirstFreeAddress (HERE).add_operation (enumerator_5537.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (126)).reader_hexString (SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)) ;
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, var_piccoloDeviceModel.reader_mEepromSize (SOURCE_FILE_AT_LINE (145)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @messageInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, var_deviceForRegistersDescription.reader_length (SOURCE_FILE_AT_LINE (157)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (var_devicePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (159)).isValidAndTrue ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_piccoloDeviceModel var_piccoloDeviceModel ;
      { //-------- @routineCallInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_registerTable enumerator_7522 (var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (163)), true) ;
      //--- simple foreach instruction
      while (enumerator_7522.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("  '").operator_concat (enumerator_7522.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (164)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_uintlist enumerator_7616 (enumerator_7522.current_mRegisterAddressList (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_7616.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (enumerator_7616.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
          if (enumerator_7616.hasNextObject ()) {
            //-------- @appendInstructionForGeneration
        ...
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (enumerator_7522.current_mBitDefinitionString (HERE).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)) ;
        //-------- @messageInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, var_deviceForConfigDescription.reader_length (SOURCE_FILE_AT_LINE (178)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (var_devicePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (180)).isValidAndTrue ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_piccoloDeviceModel var_piccoloDeviceModel ;
      { //-------- @routineCallInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_configRegisterMap enumerator_8638 (var_piccoloDeviceModel.reader_mConfigRegisterMap (SOURCE_FILE_AT_LINE (184)), true) ;
      //--- simple foreach instruction
      while (enumerator_8638.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("REGISTER '").operator_concat (enumerator_8638.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_8638.current_mRegisterAddress (HERE).reader_uint (SOURCE_FILE_AT_LINE (185)).reader_hexString (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string (", width ") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_8638.current_mRegisterWidth (HERE).reader_uint (SOURCE_FILE_AT_LINE (185)).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (185)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_illegalMaskList enumerator_8818 (enumerator_8638.current_mIllegalMaskList (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_8818.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("  illegal value ").operator_concat (enumerator_8818.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (187)).reader_hexString (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string (" mask ") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_8818.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE_AT_LINE (187)).reader_hexString (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_8818.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)) ;
          enumerator_8818.gotoNextObject () ;
        }
        //-------- @foreachInstructionForGeneration
        cEnumerator_configRegisterMaskMap enumerator_9050 (enumerator_8638.current_mConfigRegisterMaskMap (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_9050.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (enumerator_9050.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string ("': mask ") COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (enumerator_9050.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (190)).reader_hexString (SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (enumerator_9050.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_fieldSettingMap enumerator_9262 (enumerator_9050.current_mFieldSettingMap (HERE), true) ;
          //--- simple foreach instruction
          while (enumerator_9262.hasCurrentObject ()) {
            //-------- @appendInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("    value ").operator_concat (enumerator_9262.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (enumerator_9262.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)) ;
