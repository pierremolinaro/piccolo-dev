...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "piccolo_program.ggs", line
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("piccolo") == 0) {
          ...
          ::routine_analyze (_inLexique,  var_cas_piccoloModel,  var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (18)) COMMA_SOURCE_FILE_AT_LINE (17)) ;
          if (verboseOptionOn) {
