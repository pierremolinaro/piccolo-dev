  ...
  if (kBoolTrue == test_19) {
    ...
    if (kBoolTrue == test_20) {
      ...
      while (enumerator_8606.hasCurrentObject ()) {
        ...
        cEnumerator_configRegisterMaskMap enumerator_9009 (enumerator_8606.current_mConfigRegisterMaskMap (HERE), kEnumeration_up) ;
        while (enumerator_9009.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (enumerator_9009.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("': mask ") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_9009.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (185)).reader_hexString (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_9009.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
          cEnumerator_fieldSettingMap enumerator_9212 (enumerator_9009.current_mFieldSettingMap (HERE), kEnumeration_up) ;
          while (enumerator_9212.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string ("    value ").operator_concat (enumerator_9212.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_9212.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)) ;
