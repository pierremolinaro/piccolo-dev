...
piccolo_program_prologue (C_Compiler & _inLexique,
  ...
  if (((GGS_string (true, _inLexique.stringOptionValueFromKeys ("piccolo_options", "ramDescription" COMMA_SOURCE_FILE_AT_LINE (33))).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (33)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_devicePath ;
    var_cas_devicePath = ((GGS_string (true, "/"))._operator_concat (GGS_string (true, _inLexique.stringOptionValueFromKeys ("piccolo_options", "ramDescription" COMMA_SOURCE_FILE_AT_LINE (34)))))._operator_concat (GGS_string (true, ".piccoloDevice")) ;
    if ((GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (_inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (35))).isBuiltAndTrue ()) {
      GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
      ::routine_parseDeviceDefinition (_inLexique,  GGS_lstring ::constructor_new (_inLexique, GGS_string (true, _inLexique.stringOptionValueFromKeys ("piccolo_options", "ramDescription" COMMA_SOURCE_FILE_AT_LINE (37))), GGS_location (_inLexique) COMMA_HERE),  var_cas_piccoloDeviceModel COMMA_SOURCE_FILE_AT_LINE (36)) ;
      _inLexique.printMessage (((((GGS_string (true, "The "))._operator_concat (GGS_string (true, _inLexique.stringOptionValueFromKeys ("piccolo_options", "ramDescription" COMMA_SOURCE_FILE_AT_LINE (38)))))._operator_concat (GGS_string (true, " device has ")))._operator_concat (var_cas_piccoloDeviceModel.reader_mRamBankTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (39)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (39)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (39))))._operator_concat (GGS_string (true, " RAM banks:\n")) COMMA_SOURCE_FILE_AT_LINE (38)) ;
      {
        GGS_ramBankTable::cEnumerator enumerator_1703 (var_cas_piccoloDeviceModel.reader_mRamBankTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (40)), true) ;
        const GGS_ramBankTable::cElement * operand_1703 = NULL ;
        while (((operand_1703 = enumerator_1703.nextObject ()))) {
          macroValidPointer (operand_1703) ;
          _inLexique.printMessage (((((((((GGS_string (true, "  bank \""))._operator_concat (operand_1703->mKey))._operator_concat (GGS_string (true, "\" from ")))._operator_concat (operand_1703->mInfo.mFirstFreeAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (41))))._operator_concat (GGS_string (true, " to ")))._operator_concat (operand_1703->mInfo.mLastAddressPlusOne._substract_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (42)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (42))))._operator_concat (GGS_string (true, " (")))._operator_concat (operand_1703->mInfo.mLastAddressPlusOne._substract_operation (_inLexique, operand_1703->mInfo.mFirstFreeAddress COMMA_SOURCE_FILE_AT_LINE (43)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (43))))._operator_concat (GGS_string (true, " bytes)\n")) COMMA_SOURCE_FILE_AT_LINE (41)) ;
        }
      }
    }else{
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The "))._operator_concat (GGS_string (true, _inLexique.stringOptionValueFromKeys ("piccolo_options", "ramDescription" COMMA_SOURCE_FILE_AT_LINE (46)))))._operator_concat (GGS_string (true, " device is not supported")) COMMA_SOURCE_FILE_AT_LINE (46)) ;
    }
  }
}
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("piccolo") == 0) {
          ...
          ::routine_analyze (_inLexique,  var_cas_piccoloModel,  var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (57)) COMMA_SOURCE_FILE_AT_LINE (56)) ;
          if (verboseOptionOn) {
