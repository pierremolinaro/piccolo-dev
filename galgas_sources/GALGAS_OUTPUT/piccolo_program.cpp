...
piccolo_program_prologue (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9686 = (var_cas_deviceForConfigDescription.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_9686.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_9565 = GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (182)) ;
    if (cond_9565.isBuiltAndTrue ()) {
      GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
        ...
        while (((operand_8701 = enumerator_8701.nextObject ()))) {
          ...
          }
          {
            ...
            while (((operand_9142 = enumerator_9142.nextObject ()))) {
              ...
              var_cas_s.dotAssign_operation (operand_8701->mKey) ;
              var_cas_s.appendCString ("': mask ") ;
              ...
              var_cas_s.appendCString ("\"\n") ;
              {
                GGS_fieldSettingMap::cEnumerator enumerator_9346 (operand_9142->mInfo.mFieldSettingMap, true) ;
                const GGS_fieldSettingMap::cElement * operand_9346 = NULL ;
                while (((operand_9346 = enumerator_9346.nextObject ()))) {
                  macroValidPointer (operand_9346) ;
                  var_cas_s.appendCString ("    value ") ;
                  var_cas_s.dotAssign_operation (operand_9346->mInfo.mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (194))) ;
                  var_cas_s.appendCString (" description \"") ;
                  var_cas_s.dotAssign_operation (operand_9346->mKey) ;
                  var_cas_s.appendCString ("\"\n") ;
                }
              }
            }
    ...
    }else if (cond_9565.isBuiltAndFalse ()) {
