...
static void print_tool_help_message (void) {
  co << "Compiled with GALGAS revision 1764\n" ;
}
...
void routine_before (C_Compiler * inCompiler
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_stringlist enumerator_870 (var_allDevices, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_870.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_name = enumerator_870.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (21)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (21)) ;
    ...
    if (kBoolTrue == test_1) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_2015 (var_baseline_5F_devices, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_2015.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_2015.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    ...
    if (kBoolTrue == test_4) {
      ...
      GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_2647 (var_midrange_5F_devices, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_2647.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_2647.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)) ;
        //-------- @incrementInstructionForGeneration
    ...
    if (kBoolTrue == test_7) {
      ...
      GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_3262 (var_pic_31__38__5F_devices, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_3262.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_3262.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (75)) ;
        //-------- @incrementInstructionForGeneration
  ...
  if (kBoolTrue == test_10) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_4027 (var_allDevices, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_4027.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_definitionString = var_fw.reader_textFileContentsAtPath (enumerator_4027.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (97)) ;
      //-------- @methodCallInstructionForGeneration
      var_definitionString.method_writeToFile (var_dir.operator_concat (enumerator_4027.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (98)), inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  if (kBoolTrue == test_12) {
    ...
    if (kBoolTrue == test_13) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_ramBankTable enumerator_4879 (var_piccoloDeviceModel.reader_mRamBankTable (SOURCE_FILE_AT_LINE (110)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_4879.hasCurrentObject ()) {
        //-------- @assignmentInstructionForGeneration
        var_totalRam = var_totalRam.add_operation (enumerator_4879.current_mLastAddressPlusOne (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)).substract_operation (enumerator_4879.current_mFirstFreeAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_ramBankTable enumerator_5217 (var_piccoloDeviceModel.reader_mRamBankTable (SOURCE_FILE_AT_LINE (115)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_5217.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (GALGAS_string ("    bank \"").operator_concat (enumerator_5217.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)).operator_concat (GALGAS_string ("\" from ") COMMA_SOURCE_FILE_AT_LINE (116)).operator_concat (enumerator_5217.current_mFirstFreeAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)).operator_concat (GALGAS_string (" to ") COMMA_SOURCE_FILE_AT_LINE (117)).operator_concat (enumerator_5217.current_mLastAddressPlusOne (HERE).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (117)).reader_hexString (SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (118)).operator_concat (enumerator_5217.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_5217.current_mFirstFreeAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).reader_string (SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)).operator_concat (GALGAS_string (" bytes)") COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (116)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_uintlist enumerator_5479 (enumerator_5217.current_mMirrorOffsetList (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        const bool bool_14 = true ;
        if (enumerator_5479.hasCurrentObject () && bool_14) {
          //-------- @messageInstructionForGeneration
          inCompiler->printMessage (GALGAS_string (", mirror at ") COMMA_SOURCE_FILE_AT_LINE (120)) ;
          while (enumerator_5479.hasCurrentObject () && bool_14) {
            //-------- @messageInstructionForGeneration
            inCompiler->printMessage (enumerator_5217.current_mFirstFreeAddress (HERE).add_operation (enumerator_5479.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (121)).reader_hexString (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)) ;
      ...
      if (kBoolTrue == test_16) {
        ...
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (GALGAS_string ("  EEPROM size: ").operator_concat (var_piccoloDeviceModel.reader_mEepromSize (SOURCE_FILE_AT_LINE (143)).reader_string (SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).operator_concat (GALGAS_string (" bytes (at ") COMMA_SOURCE_FILE_AT_LINE (143)).operator_concat (var_piccoloDeviceModel.reader_mEepromAddress (SOURCE_FILE_AT_LINE (144)).reader_hexString (SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (143)) ;
      }
  ...
  if (kBoolTrue == test_17) {
    ...
    if (kBoolTrue == test_18) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_registerTable enumerator_7477 (var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (158)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7477.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("  '").operator_concat (enumerator_7477.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (159)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_uintlist enumerator_7571 (enumerator_7477.current_mRegisterAddressList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_7571.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (enumerator_7571.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (161)) COMMA_SOURCE_FILE_AT_LINE (161)) ;
          if (enumerator_7571.hasNextObject ()) {
            //-------- @concatInstructionForGeneration
        ...
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (enumerator_7477.current_mBitDefinitionString (HERE).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)) ;
        //-------- @messageInstructionForGeneration
  ...
  if (kBoolTrue == test_19) {
    ...
    if (kBoolTrue == test_20) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_configRegisterMap enumerator_8606 (var_piccoloDeviceModel.reader_mConfigRegisterMap (SOURCE_FILE_AT_LINE (179)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8606.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("REGISTER '").operator_concat (enumerator_8606.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (enumerator_8606.current_mRegisterAddress (HERE).reader_uint (SOURCE_FILE_AT_LINE (180)).reader_hexString (SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string (", width ") COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (enumerator_8606.current_mRegisterWidth (HERE).reader_uint (SOURCE_FILE_AT_LINE (180)).reader_string (SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (180)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_illegalMaskList enumerator_8786 (enumerator_8606.current_mIllegalMaskList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_8786.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("  illegal value ").operator_concat (enumerator_8786.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (182)).reader_hexString (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (GALGAS_string (" mask ") COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (enumerator_8786.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE_AT_LINE (182)).reader_hexString (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (enumerator_8786.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)) ;
          enumerator_8786.gotoNextObject () ;
        }
        //-------- @foreachInstructionForGeneration
        cEnumerator_configRegisterMaskMap enumerator_9018 (enumerator_8606.current_mConfigRegisterMaskMap (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_9018.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (enumerator_9018.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("': mask ") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_9018.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (185)).reader_hexString (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_9018.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_fieldSettingMap enumerator_9230 (enumerator_9018.current_mFieldSettingMap (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_9230.hasCurrentObject ()) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("    value ").operator_concat (enumerator_9230.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_9230.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)) ;
