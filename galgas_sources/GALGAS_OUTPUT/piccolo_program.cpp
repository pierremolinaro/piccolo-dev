        ...
        while (((operand_9121 = enumerator_9121.nextObject ()))) {
          ...
          }
          {
            ...
            while (((operand_9521 = enumerator_9521.nextObject ()))) {
              ...
              var_cas_s.writeString ("\"\n") ;
              {
                GGS_fieldSettingList::cEnumerator enumerator_9685 (operand_9521->mInfo.mFieldSettingList, true) ;
                const GGS_fieldSettingList::cElement * operand_9685 = NULL ;
                while (((operand_9685 = enumerator_9685.nextObject ()))) {
                  macroValidPointer (operand_9685) ;
                  var_cas_s.writeString ("      setting ") ;
                  var_cas_s._dotAssign_operation (operand_9685->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (211))) ;
                  var_cas_s.writeString (" description \"") ;
                  var_cas_s._dotAssign_operation (operand_9685->mDescription) ;
                  var_cas_s.writeString ("\"\n") ;
                }
              }
            }
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("piccolo") == 0) {
          ...
          ::routine_analyze (_inLexique,  var_cas_piccoloModel,  var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (228)) ;
          if (verboseOptionOn) {
