        ...
        while (((operand_9121 = enumerator_9121.nextObject ()))) {
          ...
          var_cas_s = ((((((GGS_string (true, "  '"))._operator_concat (operand_9121->mKey))._operator_concat (GGS_string (true, "' at ")))._operator_concat (operand_9121->mInfo.mRegisterAddress.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (204))))._operator_concat (GGS_string (true, ", width ")))._operator_concat (operand_9121->mInfo.mRegisterWidth.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204))))._operator_concat (GGS_string (true, "\n")) ;
          {
            ...
            while (((operand_9316 = enumerator_9316.nextObject ()))) {
              ...
              var_cas_s._dotAssign_operation (operand_9316->mIllegalValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
          ...
          {
            GGS_configRegisterMaskMap::cEnumerator enumerator_9536 (operand_9121->mInfo.mConfigRegisterMaskMap, true) ;
            const GGS_configRegisterMaskMap::cElement * operand_9536 = NULL ;
            while (((operand_9536 = enumerator_9536.nextObject ()))) {
              macroValidPointer (operand_9536) ;
              var_cas_s.writeString ("    '") ;
              var_cas_s._dotAssign_operation (operand_9536->mKey) ;
              var_cas_s.writeString ("': mask ") ;
              var_cas_s._dotAssign_operation (operand_9536->mInfo.mMaskValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (209)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (209))) ;
              var_cas_s.writeString (" description \"") ;
              var_cas_s._dotAssign_operation (operand_9536->mInfo.mDescription) ;
              var_cas_s.writeString ("\"\n") ;
              {
                GGS_fieldSettingMap::cEnumerator enumerator_9700 (operand_9536->mInfo.mFieldSettingMap, true) ;
                const GGS_fieldSettingMap::cElement * operand_9700 = NULL ;
                while (((operand_9700 = enumerator_9700.nextObject ()))) {
                  macroValidPointer (operand_9700) ;
                  var_cas_s.writeString ("      setting ") ;
                  var_cas_s._dotAssign_operation (operand_9700->mInfo.mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (211))) ;
                  var_cas_s.writeString (" description \"") ;
                  var_cas_s._dotAssign_operation (operand_9700->mKey) ;
                  var_cas_s.writeString ("\"\n") ;
                }
              }
            }
