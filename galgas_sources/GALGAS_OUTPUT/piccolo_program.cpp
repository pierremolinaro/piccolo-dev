...
#ifndef DO_NOT_GENERATE_CHECKINGS
  const char * kVersionString = "version " "version PICCOLO_BETA_VERSION" " [debug]" ;
#else
  const char * kVersionString = "version " "version PICCOLO_BETA_VERSION" ;
#endif
