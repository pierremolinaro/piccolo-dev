...
piccolo_program_prologue (C_Compiler & inLexique,
  ...
  if (((((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputDeviceList" COMMA_SOURCE_FILE_AT_LINE (11)))).operator_or (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputPic18DeviceList" COMMA_SOURCE_FILE_AT_LINE (12))))).operator_or (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputBaselineDeviceList" COMMA_SOURCE_FILE_AT_LINE (13))))).operator_or (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputMidrangeDeviceList" COMMA_SOURCE_FILE_AT_LINE (14))))).isBuiltAndTrue ()) {
    ...
    if (((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputDeviceList" COMMA_SOURCE_FILE_AT_LINE (46)))).operator_or (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputBaselineDeviceList" COMMA_SOURCE_FILE_AT_LINE (46))))).isBuiltAndTrue ()) {
    ...
    if (((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputDeviceList" COMMA_SOURCE_FILE_AT_LINE (62)))).operator_or (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputMidrangeDeviceList" COMMA_SOURCE_FILE_AT_LINE (62))))).isBuiltAndTrue ()) {
    ...
    if (((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputDeviceList" COMMA_SOURCE_FILE_AT_LINE (78)))).operator_or (GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "outputPic18DeviceList" COMMA_SOURCE_FILE_AT_LINE (78))))).isBuiltAndTrue ()) {
  ...
  if (((GGS_string (true, inLexique.stringOptionValueFromKeys ("piccolo_options", "exportDeviceFiles" COMMA_SOURCE_FILE_AT_LINE (96))).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (96))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
