...
void routine_before (C_Compiler * inCompiler
  ...
  if (kBoolTrue == test_0) {
    ...
    if (enumerator_825.hasCurrentObject () && bool_1) {
      while (enumerator_825.hasCurrentObject () && bool_1) {
  ...
  if (kBoolTrue == test_14) {
    ...
    if (kBoolTrue == test_15) {
      ...
      while (enumerator_5275.hasCurrentObject ()) {
        ...
        if (enumerator_5537.hasCurrentObject () && bool_16) {
          //-------- @messageInstructionForGeneration
          inCompiler->printMessage (GALGAS_string (", mirror at ") COMMA_SOURCE_FILE_AT_LINE (125)) ;
          while (enumerator_5537.hasCurrentObject () && bool_16) {
            //-------- @messageInstructionForGeneration
