...
void routine_before (C_Compiler * inCompiler
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      while (enumerator_2012.hasCurrentObject ()) {
        inCompiler->printMessage (enumerator_2012.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (43)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
    ...
    if (kBoolTrue == test_4) {
      ...
      while (enumerator_2644.hasCurrentObject ()) {
        inCompiler->printMessage (enumerator_2644.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)) ;
    ...
    if (kBoolTrue == test_7) {
      ...
      while (enumerator_3259.hasCurrentObject ()) {
        inCompiler->printMessage (enumerator_3259.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  ...
  const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, GALGAS_string (gOption_piccolo_5F_options_5F_not_5F_in_5F_cocoa_exportDeviceFiles.reader_value ()).reader_length (SOURCE_FILE_AT_LINE (89)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  ...
  const enumGalgasBool test_12 = GALGAS_bool (kIsStrictSup, var_deviceForMemoryDescription.reader_length (SOURCE_FILE_AT_LINE (104)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_12) {
    ...
    if (kBoolTrue == test_13) {
      ...
      if (var_piccoloDeviceModel.reader_mProcessorType (SOURCE_FILE_AT_LINE (126)).isValid ()) {
        ...
        case GALGAS_processorType::kEnum_midrange: {
          GALGAS_uint var_pageCount = var_piccoloDeviceModel.reader_mRomSize (SOURCE_FILE_AT_LINE (130)).reader_uint (SOURCE_FILE_AT_LINE (130)).add_operation (GALGAS_uint ((uint32_t) 2047U), inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).divide_operation (GALGAS_uint ((uint32_t) 2048U), inCompiler COMMA_SOURCE_FILE_AT_LINE (130)) ;
      ...
      const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, var_piccoloDeviceModel.reader_mEepromSize (SOURCE_FILE_AT_LINE (140)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  ...
  const enumGalgasBool test_17 = GALGAS_bool (kIsStrictSup, var_deviceForRegistersDescription.reader_length (SOURCE_FILE_AT_LINE (152)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  ...
  const enumGalgasBool test_19 = GALGAS_bool (kIsStrictSup, var_deviceForConfigDescription.reader_length (SOURCE_FILE_AT_LINE (173)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  {
    cGrammar_pic_31__38__5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile COMMA_SOURCE_FILE_AT_LINE (204)) ;
  }
}
