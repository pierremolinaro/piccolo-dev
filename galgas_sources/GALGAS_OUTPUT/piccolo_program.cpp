...
piccolo_program_prologue (C_Compiler & _inLexique,
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputDeviceList" COMMA_SOURCE_FILE_AT_LINE (11)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_1316 (var_cas_pic_60_devices, true) ;
      const GGS_stringlist::cElement * operand_1316 = NULL ;
      while (((operand_1316 = enumerator_1316.nextObject ()))) {
        macroValidPointer (operand_1316) ;
        _inLexique.printMessage (operand_1316->mValue.reader_stringByRightPadding (_inLexique, GGS_uint (true, 15U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (31)) COMMA_SOURCE_FILE_AT_LINE (31)) ;
    ...
    {
      GGS_stringlist::cEnumerator enumerator_1722 (var_cas_pic_80_devices, true) ;
      const GGS_stringlist::cElement * operand_1722 = NULL ;
      while (((operand_1722 = enumerator_1722.nextObject ()))) {
        macroValidPointer (operand_1722) ;
        _inLexique.printMessage (operand_1722->mValue.reader_stringByRightPadding (_inLexique, GGS_uint (true, 15U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (45)) COMMA_SOURCE_FILE_AT_LINE (45)) ;
  ...
  var_cas_deviceForMemoryDescription = GGS_string (true, _inLexique.stringOptionValueFromKeys ("piccolo_options", "memoryDescription" COMMA_SOURCE_FILE_AT_LINE (57))) ;
  if (((var_cas_deviceForMemoryDescription.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (58)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if ((GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (_inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (60))).isBuiltAndTrue ()) {
      GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
      ::routine_parseDeviceDefinition (_inLexique,  GGS_lstring ::constructor_new (_inLexique, var_cas_deviceForMemoryDescription, GGS_location (_inLexique) COMMA_HERE),  var_cas_piccoloDeviceModel COMMA_SOURCE_FILE_AT_LINE (61)) ;
      GGS_uint  var_cas_totalRam ;
      var_cas_totalRam = GGS_uint (true, 0U) ;
      {
        GGS_ramBankTable::cEnumerator enumerator_2532 (var_cas_piccoloDeviceModel.reader_mRamBankTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (64)), true) ;
        const GGS_ramBankTable::cElement * operand_2532 = NULL ;
        while (((operand_2532 = enumerator_2532.nextObject ()))) {
          macroValidPointer (operand_2532) ;
          var_cas_totalRam = var_cas_totalRam._add_operation (_inLexique, operand_2532->mInfo.mLastAddressPlusOne COMMA_SOURCE_FILE_AT_LINE (65))._substract_operation (_inLexique, operand_2532->mInfo.mFirstFreeAddress COMMA_SOURCE_FILE_AT_LINE (65)) ;
        }
      }
      ...
      _inLexique.printMessage (((((GGS_string (true, "  "))._operator_concat (var_cas_piccoloDeviceModel.reader_mRamBankTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (68))))._operator_concat (GGS_string (true, " RAM banks (total ")))._operator_concat (var_cas_totalRam.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (68))))._operator_concat (GGS_string (true, " bytes):\n")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
      {
        GGS_ramBankTable::cEnumerator enumerator_2870 (var_cas_piccoloDeviceModel.reader_mRamBankTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (69)), true) ;
        const GGS_ramBankTable::cElement * operand_2870 = NULL ;
        while (((operand_2870 = enumerator_2870.nextObject ()))) {
          macroValidPointer (operand_2870) ;
          _inLexique.printMessage (((((((((GGS_string (true, "    bank \""))._operator_concat (operand_2870->mKey))._operator_concat (GGS_string (true, "\" from ")))._operator_concat (operand_2870->mInfo.mFirstFreeAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (70))))._operator_concat (GGS_string (true, " to ")))._operator_concat (operand_2870->mInfo.mLastAddressPlusOne._substract_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (71)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (71))))._operator_concat (GGS_string (true, " (")))._operator_concat (operand_2870->mInfo.mLastAddressPlusOne._substract_operation (_inLexique, operand_2870->mInfo.mFirstFreeAddress COMMA_SOURCE_FILE_AT_LINE (72)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (72))))._operator_concat (GGS_string (true, " bytes)\n")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
        }
      }
      _inLexique.printMessage (((GGS_string (true, "  ROM size: "))._operator_concat (var_cas_piccoloDeviceModel.reader_mRomSize (_inLexique COMMA_SOURCE_FILE_AT_LINE (74)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74))))._operator_concat (GGS_string (true, " bytes\n")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
      if (((var_cas_piccoloDeviceModel.reader_mEepromSize (_inLexique COMMA_SOURCE_FILE_AT_LINE (75)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        _inLexique.printMessage (GGS_string (true, "  No EEPROM\n") COMMA_SOURCE_FILE_AT_LINE (76)) ;
      }else{
        _inLexique.printMessage (((((GGS_string (true, "  EEPROM size: "))._operator_concat (var_cas_piccoloDeviceModel.reader_mEepromSize (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (78))))._operator_concat (GGS_string (true, " bytes (at ")))._operator_concat (var_cas_piccoloDeviceModel.reader_mEepromAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (79))))._operator_concat (GGS_string (true, ")\n")) COMMA_SOURCE_FILE_AT_LINE (78)) ;
      }
    }else{
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The "))._operator_concat (var_cas_deviceForMemoryDescription))._operator_concat (GGS_string (true, " device is not supported or does not exist")) COMMA_SOURCE_FILE_AT_LINE (82)) ;
    }
  }
  GGS_string var_cas_deviceForRegistersDescription ;
  var_cas_deviceForRegistersDescription = GGS_string (true, _inLexique.stringOptionValueFromKeys ("piccolo_options", "registerDescription" COMMA_SOURCE_FILE_AT_LINE (86))) ;
  if (((var_cas_deviceForRegistersDescription.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (87)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_devicePath ;
    ...
    if ((GGS_filewrapper (gWrapperDirectory_0_embeddedDevices).reader_fileExistsAtPath (_inLexique, var_cas_devicePath COMMA_SOURCE_FILE_AT_LINE (89))).isBuiltAndTrue ()) {
      GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
      ::routine_parseDeviceDefinition (_inLexique,  GGS_lstring ::constructor_new (_inLexique, var_cas_deviceForRegistersDescription, GGS_location (_inLexique) COMMA_HERE),  var_cas_piccoloDeviceModel COMMA_SOURCE_FILE_AT_LINE (90)) ;
      _inLexique.printMessage ((((var_cas_deviceForRegistersDescription)._operator_concat (GGS_string (true, " has ")))._operator_concat (var_cas_piccoloDeviceModel.reader_mRegisterTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (92))))._operator_concat (GGS_string (true, " registers:\n")) COMMA_SOURCE_FILE_AT_LINE (92)) ;
      {
        GGS_registerTable::cEnumerator enumerator_4314 (var_cas_piccoloDeviceModel.reader_mRegisterTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (93)), true) ;
        const GGS_registerTable::cElement * operand_4314 = NULL ;
        while (((operand_4314 = enumerator_4314.nextObject ()))) {
          macroValidPointer (operand_4314) ;
          GGS_string var_cas_s ;
          var_cas_s = ((GGS_string (true, "  '"))._operator_concat (operand_4314->mKey))._operator_concat (GGS_string (true, "' at ")) ;
          {
            GGS_uintlist::cEnumerator enumerator_4414 (operand_4314->mInfo.mRegisterAddressList, true) ;
            const GGS_uintlist::cElement * operand_4414 = enumerator_4414.nextObject () ;
            if ((operand_4414 != NULL)) {
              bool _foreach_loop_4414 ;
              do{
                macroValidPointer (operand_4414) ;
                var_cas_s._dotAssign_operation (operand_4414->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (96))) ;
                operand_4414 = enumerator_4414.nextObject () ;
                _foreach_loop_4414 = ((operand_4414 != NULL)) ;
                if (_foreach_loop_4414) {
                  var_cas_s.writeString (", ") ;
                }
              }while (_foreach_loop_4414) ;
            }
          }
          var_cas_s.writeString ("\n") ;
          _inLexique.printMessage (var_cas_s COMMA_SOURCE_FILE_AT_LINE (100)) ;
        }
      }
    }else{
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "The "))._operator_concat (var_cas_deviceForRegistersDescription))._operator_concat (GGS_string (true, " device is not supported or does not exist")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
    }
  }
}
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("piccolo") == 0) {
          ...
          ::routine_analyze (_inLexique,  var_cas_piccoloModel,  var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (113)) ;
          if (verboseOptionOn) {
