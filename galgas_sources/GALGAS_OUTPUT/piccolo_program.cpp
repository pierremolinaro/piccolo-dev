...
//                    september 27th, 2012, at 20h18'12"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_before (C_Compiler * inCompiler
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_stringlist enumerator_798 (var_allDevices, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_1 = var_ok.isValidAndTrue () ;
    if (enumerator_798.hasCurrentObject () && bool_1) {
      while (enumerator_798.hasCurrentObject () && bool_1) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_piccoloDeviceModel var_piccoloDeviceModel ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_name = enumerator_798.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (22)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (22)) ;
        ...
        if (enumerator_798.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_3) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_2145 (var_baseline_5F_devices, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_2145.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_2145.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (48)) COMMA_SOURCE_FILE_AT_LINE (48)) ;
    ...
    if (kBoolTrue == test_6) {
      ...
      GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_2751 (var_midrange_5F_devices, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_2751.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_2751.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (64)) COMMA_SOURCE_FILE_AT_LINE (64)) ;
        //-------- @incrementInstructionForGeneration
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_3340 (var_pic_31__38__5F_devices, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_3340.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (enumerator_3340.current_mValue (HERE).reader_stringByRightPadding (GALGAS_uint ((PMUInt32) 15U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (80)) COMMA_SOURCE_FILE_AT_LINE (80)) ;
        //-------- @incrementInstructionForGeneration
  ...
  if (kBoolTrue == test_12) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_4079 (var_allDevices, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_4079.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_definitionString = var_fw.reader_textFileContentsAtPath (enumerator_4079.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (102)) ;
      //-------- @methodCallInstructionForGeneration
      var_definitionString.method_writeToFile (var_dir.operator_concat (enumerator_4079.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (103)), inCompiler COMMA_SOURCE_FILE_AT_LINE (103)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  if (kBoolTrue == test_14) {
    ...
    if (kBoolTrue == test_15) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_ramBankTable enumerator_4918 (var_piccoloDeviceModel.reader_mRamBankTable (SOURCE_FILE_AT_LINE (115)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_4918.hasCurrentObject ()) {
        //-------- @assignmentInstructionForGeneration
        var_totalRam = var_totalRam.add_operation (enumerator_4918.current_mLastAddressPlusOne (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)).substract_operation (enumerator_4918.current_mFirstFreeAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) ;
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_ramBankTable enumerator_5256 (var_piccoloDeviceModel.reader_mRamBankTable (SOURCE_FILE_AT_LINE (120)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_5256.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (GALGAS_string ("    bank \"").operator_concat (enumerator_5256.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string ("\" from ") COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (enumerator_5256.current_mFirstFreeAddress (HERE).reader_hexString (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (121)).operator_concat (GALGAS_string (" to ") COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (enumerator_5256.current_mLastAddressPlusOne (HERE).substract_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (122)).reader_hexString (SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (enumerator_5256.current_mLastAddressPlusOne (HERE).substract_operation (enumerator_5256.current_mFirstFreeAddress (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (123)).reader_string (SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (GALGAS_string (" bytes)") COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (121)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_uintlist enumerator_5518 (enumerator_5256.current_mMirrorOffsetList (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        const bool bool_16 = true ;
        if (enumerator_5518.hasCurrentObject () && bool_16) {
          //-------- @messageInstructionForGeneration
          inCompiler->printMessage (GALGAS_string (", mirror at ") COMMA_SOURCE_FILE_AT_LINE (125)) ;
          while (enumerator_5518.hasCurrentObject () && bool_16) {
            //-------- @messageInstructionForGeneration
            inCompiler->printMessage (enumerator_5256.current_mFirstFreeAddress (HERE).add_operation (enumerator_5518.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (126)).reader_hexString (SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  ...
  if (kBoolTrue == test_19) {
    ...
    if (kBoolTrue == test_20) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_registerTable enumerator_7503 (var_piccoloDeviceModel.reader_mRegisterTable (SOURCE_FILE_AT_LINE (163)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7503.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("  '").operator_concat (enumerator_7503.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (164)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_uintlist enumerator_7597 (enumerator_7503.current_mRegisterAddressList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_7597.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (enumerator_7597.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
          if (enumerator_7597.hasNextObject ()) {
            //-------- @concatInstructionForGeneration
        ...
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (enumerator_7503.current_mBitDefinitionString (HERE).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)) ;
        //-------- @messageInstructionForGeneration
  ...
  if (kBoolTrue == test_21) {
    ...
    if (kBoolTrue == test_22) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_configRegisterMap enumerator_8619 (var_piccoloDeviceModel.reader_mConfigRegisterMap (SOURCE_FILE_AT_LINE (184)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8619.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("REGISTER '").operator_concat (enumerator_8619.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("' at ") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_8619.current_mRegisterAddress (HERE).reader_uint (SOURCE_FILE_AT_LINE (185)).reader_hexString (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string (", width ") COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (enumerator_8619.current_mRegisterWidth (HERE).reader_uint (SOURCE_FILE_AT_LINE (185)).reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (185)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_illegalMaskList enumerator_8799 (enumerator_8619.current_mIllegalMaskList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_8799.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("  illegal value ").operator_concat (enumerator_8799.current_mIllegalValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (187)).reader_hexString (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string (" mask ") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_8799.current_mIllegalMask (HERE).reader_uint (SOURCE_FILE_AT_LINE (187)).reader_hexString (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (enumerator_8799.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)) ;
          enumerator_8799.gotoNextObject () ;
        }
        //-------- @foreachInstructionForGeneration
        cEnumerator_configRegisterMaskMap enumerator_9031 (enumerator_8619.current_mConfigRegisterMaskMap (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_9031.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("  setting '").operator_concat (enumerator_9031.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string ("': mask ") COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (enumerator_9031.current_mMaskValue (HERE).reader_uint (SOURCE_FILE_AT_LINE (190)).reader_hexString (SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (enumerator_9031.current_mDescription (HERE).reader_string (SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_fieldSettingMap enumerator_9243 (enumerator_9031.current_mFieldSettingMap (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_9243.hasCurrentObject ()) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("    value ").operator_concat (enumerator_9243.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string (" description \"") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (enumerator_9243.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)) ;
