...
void routine_analyze (C_Compiler & _inLexique,
  ...
  switch (var_cas_piccoloDeviceModel.reader_mProcessorType (_inLexique COMMA_SOURCE_FILE_AT_LINE (115)).enumValue ()) {
  ...
  ::routine_buildIPICAssemblyInstructionList (_inLexique,  var_cas_accessBankSplitOffset,  var_cas_registerTable,  var_cas_inPiccoloModel,  var_cas_hasHighInterrupt,  var_cas_hasLowInterrupt,  var_cas_generatedInstructionList COMMA_SOURCE_FILE_AT_LINE (119)) ;
  if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "doNotConvertRelative" COMMA_SOURCE_FILE_AT_LINE (129))))._operator_not ()).isBuiltAndTrue ()) {
    ::routine_convertRelativeBranchsToAbsoluteWhenNeeded (_inLexique,  var_cas_generatedInstructionList COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (135)))).isBuiltAndTrue ()) {
      GGS_string var_cas_assemblyCode ;
      ::routine_buildAssemblyCode (_inLexique,  var_cas_piccoloDeviceModel.reader_mDeviceName (_inLexique COMMA_SOURCE_FILE_AT_LINE (138)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (138)),  var_cas_piccoloDeviceModel.reader_mRegisterTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (139)),  var_cas_registerTable,  var_cas_generatedInstructionList,  var_cas_assemblyCode COMMA_SOURCE_FILE_AT_LINE (136)) ;
      GGS_string var_cas_destinationFile ;
      var_cas_destinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (144)))._operator_concat (GGS_string (true, ".asm")) ;
      const GGS_string _temp_6411 = var_cas_assemblyCode ;
      if (_temp_6411._isBuilt ()) {
        _temp_6411 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_destinationFile COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }
    }else{
      ::routine_buildBinaryCode (_inLexique,  var_cas_generatedInstructionList,  var_cas_piccoloDeviceModel.reader_mRomSize (_inLexique COMMA_SOURCE_FILE_AT_LINE (149)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (146)) ;
      GGS_string var_cas_contents ;
      ::routine_getGeneratedContents (_inLexique,  var_cas_contents COMMA_SOURCE_FILE_AT_LINE (151)) ;
      GGS_string var_cas_destinationFile ;
      var_cas_destinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (153)))._operator_concat (GGS_string (true, ".hex")) ;
      const GGS_string _temp_6756 = var_cas_contents ;
      if (_temp_6756._isBuilt ()) {
        _temp_6756 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_destinationFile COMMA_SOURCE_FILE_AT_LINE (154)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
