...
category_method__instruction_computed_retlw__generateCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_retlw * operand_26290,
                                const GGS_codeGenerationContext  var_cas_inCodeGenerationContext,
                                const GGS_uint   /* var_cas_inAddress */,
                                GGS_bool & var_cas_ioContinuesInSequence
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26290 != NULL) {
    ::routine_checkInstructionIsReachable (_inLexique,  var_cas_ioContinuesInSequence,  operand_26290->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (763)) ;
    var_cas_ioContinuesInSequence = GGS_bool (true, false) ;
    ::routine_emitCALLinstruction (_inLexique,  var_cas_inCodeGenerationContext.reader_mComputedGoto2RoutineAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (766)) COMMA_SOURCE_FILE_AT_LINE (765)) ;
    {
      GGS_luintlist::cEnumerator enumerator_26626 (operand_26290->mLiteralValues, true) ;
      const GGS_luintlist::cElement * operand_26626 = NULL ;
      while (((operand_26626 = enumerator_26626.nextObject ()))) {
        macroValidPointer (operand_26626) ;
        if (((operand_26626->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (768)))._operator_strictSup (GGS_uint (true, 255U))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "immediate value ("))._operator_concat (operand_26626->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (769)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (769))))._operator_concat (GGS_string (true, ") should be lower or equal to 255")) COMMA_SOURCE_FILE_AT_LINE (769)) ;
        }
        if ((GGS_uint (true, 3072U))._operator_or (operand_26626->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (771)))._isBuilt ()) {
          ::routine_emitCode (_inLexique,  (GGS_uint (true, 3072U))._operator_or (operand_26626->mValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (771))) COMMA_SOURCE_FILE_AT_LINE (770)) ;
        }
      }
    }
  }
...
category_method__instruction_computed_bra__generateCodeAtAddress (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_bra * operand_26974,
                                const GGS_codeGenerationContext  var_cas_inCodeGenerationContext,
                                const GGS_uint   var_cas_inAddress,
                                GGS_bool & var_cas_ioContinuesInSequence
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26974 != NULL) {
    ::routine_checkInstructionIsReachable (_inLexique,  var_cas_ioContinuesInSequence,  operand_26974->mInstructionLocation COMMA_SOURCE_FILE_AT_LINE (781)) ;
    var_cas_ioContinuesInSequence = GGS_bool (true, false) ;
    ::routine_emitCALLinstruction (_inLexique,  var_cas_inCodeGenerationContext.reader_mComputedGoto2RoutineAddress (_inLexique COMMA_SOURCE_FILE_AT_LINE (784)) COMMA_SOURCE_FILE_AT_LINE (783)) ;
    GGS_uint  var_cas_address ;
    var_cas_address = var_cas_inAddress._add_operation (_inLexique, GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (785)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_27338 (operand_26974->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_27338 = NULL ;
      while (((operand_27338 = enumerator_27338.nextObject ()))) {
        macroValidPointer (operand_27338) ;
        GGS_uint  var_cas_targetAddress ;
        GGS_uint  var_cas_requiredSelectedBank ;
        const GGS_routineSymbolTable  _temp_27465 = var_cas_inCodeGenerationContext.reader_mRoutineSymbolTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (789)) ;
        if (_temp_27465._isBuilt ()) {
          _temp_27465 (HERE)->method_searchKey (_inLexique, operand_27338->mValue, var_cas_targetAddress, var_cas_requiredSelectedBank COMMA_SOURCE_FILE_AT_LINE (789)) ;
        }
        ::routine_emitBRAinstruction (_inLexique,  var_cas_address,  var_cas_targetAddress,  operand_27338->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (793)) COMMA_SOURCE_FILE_AT_LINE (789)) ;
        var_cas_address = var_cas_address._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (795)) ;
      }
    }
  }
}
...
void routine_analyze (C_Compiler & _inLexique,
  ...
  var_cas_sourceFileBaseName = var_cas_inSourceFileName.reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (806)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (806)) ;
  if (((var_cas_sourceFileBaseName)._operator_isNotEqual (var_cas_inPiccoloModel.reader_mProgramName (_inLexique COMMA_SOURCE_FILE_AT_LINE (807)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (807)))).isBuiltAndTrue ()) {
    var_cas_inPiccoloModel.reader_mProgramName (_inLexique COMMA_SOURCE_FILE_AT_LINE (808)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the program name ('"))._operator_concat (var_cas_inPiccoloModel.reader_mProgramName (_inLexique COMMA_SOURCE_FILE_AT_LINE (808))))._operator_concat (GGS_string (true, "') should be identical to the file base name '")))._operator_concat (var_cas_sourceFileBaseName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (809)) ;
  }
  GGS_piccoloDeviceModel var_cas_piccoloDeviceModel ;
  ::routine_parseDeviceDefinition (_inLexique,  var_cas_inPiccoloModel.reader_mDeviceName (_inLexique COMMA_SOURCE_FILE_AT_LINE (813)),  var_cas_piccoloDeviceModel COMMA_SOURCE_FILE_AT_LINE (812)) ;
  ...
  {
    GGS_interruptDefinitionList::cEnumerator enumerator_28793 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (817)), true) ;
    const GGS_interruptDefinitionList::cElement * operand_28793 = NULL ;
    while (((operand_28793 = enumerator_28793.nextObject ()))) {
      macroValidPointer (operand_28793) ;
      if (((operand_28793->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (818)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
        if ((var_cas_hasHighInterrupt).isBuiltAndTrue ()) {
          operand_28793->mInterruptName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Only one 'high' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (820)) ;
        }
        var_cas_hasHighInterrupt = GGS_bool (true, true) ;
      }else if (((operand_28793->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (823)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
        if ((var_cas_hasLowInterrupt).isBuiltAndTrue ()) {
          operand_28793->mInterruptName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Only one 'low' interrupt routine is allowed") COMMA_SOURCE_FILE_AT_LINE (825)) ;
        }
        var_cas_hasLowInterrupt = GGS_bool (true, true) ;
      }else{
        operand_28793->mInterruptName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "An interrupt routine should be named 'low' or 'high'") COMMA_SOURCE_FILE_AT_LINE (829)) ;
      }
    }
  }
  ...
  if ((var_cas_hasLowInterrupt).isBuiltAndTrue ()) {
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_29583 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (837)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_29583 = NULL ;
      while (((operand_29583 = enumerator_29583.nextObject ()))) {
        macroValidPointer (operand_29583) ;
        if (((operand_29583->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (838)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          GGS_uint  var_cas_currentlySelectedBank ;
          var_cas_currentlySelectedBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          {
            GGS_instructionList::cEnumerator enumerator_29765 (operand_29583->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_29765 = NULL ;
            while (((operand_29765 = enumerator_29765.nextObject ()))) {
              macroValidPointer (operand_29765) ;
              const GGS_instruction  _temp_29809 = operand_29765->mInstruction ;
              if (_temp_29809._isBuilt ()) {
                typeCategoryMethod__instruction__enterLabelAtAddress _method = findCategoryMethod__instruction__enterLabelAtAddress (_temp_29809._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_29809 (HERE), var_cas_routineSymbolTable, var_cas_currentROMaddress, var_cas_currentlySelectedBank COMMA_SOURCE_FILE_AT_LINE (841)) ;
                }
              }
              GGS_uint  var_cas_length ;
              const GGS_instruction  _temp_29945 = operand_29765->mInstruction ;
              if (_temp_29945._isBuilt ()) {
                _temp_29945 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (843)) ;
              }
              var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (844)) ;
            }
          }
          var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (847)) ;
        }
      }
    }
  }
  ...
  if ((var_cas_hasHighInterrupt).isBuiltAndTrue ()) {
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_30403 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (857)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_30403 = NULL ;
      while (((operand_30403 = enumerator_30403.nextObject ()))) {
        macroValidPointer (operand_30403) ;
        if (((operand_30403->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (858)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          GGS_uint  var_cas_currentlySelectedBank ;
          var_cas_currentlySelectedBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          {
            GGS_instructionList::cEnumerator enumerator_30586 (operand_30403->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_30586 = NULL ;
            while (((operand_30586 = enumerator_30586.nextObject ()))) {
              macroValidPointer (operand_30586) ;
              const GGS_instruction  _temp_30630 = operand_30586->mInstruction ;
              if (_temp_30630._isBuilt ()) {
                typeCategoryMethod__instruction__enterLabelAtAddress _method = findCategoryMethod__instruction__enterLabelAtAddress (_temp_30630._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_30630 (HERE), var_cas_routineSymbolTable, var_cas_currentROMaddress, var_cas_currentlySelectedBank COMMA_SOURCE_FILE_AT_LINE (861)) ;
                }
              }
              GGS_uint  var_cas_length ;
              const GGS_instruction  _temp_30766 = operand_30586->mInstruction ;
              if (_temp_30766._isBuilt ()) {
                _temp_30766 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (863)) ;
              }
              var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (864)) ;
            }
          }
          var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (867)) ;
        }
      }
    }
  }
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_31160 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (875)), true) ;
    const GGS_routineDefinitionList::cElement * operand_31160 = NULL ;
    while (((operand_31160 = enumerator_31160.nextObject ()))) {
      macroValidPointer (operand_31160) ;
      GGS_uint  var_cas_currentlySelectedBank ;
      var_cas_currentlySelectedBank = operand_31160->mBanksel.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (876)) ;
      var_cas_routineSymbolTable.modifier_insertKey (_inLexique, operand_31160->mRoutineName, var_cas_currentROMaddress, var_cas_currentlySelectedBank COMMA_SOURCE_FILE_AT_LINE (877)) ;
      {
        GGS_instructionList::cEnumerator enumerator_31363 (operand_31160->mInstructionList, true) ;
        ...
        while (((operand_31363 = enumerator_31363.nextObject ()))) {
          ...
          const GGS_instruction  _temp_31403 = operand_31363->mInstruction ;
          if (_temp_31403._isBuilt ()) {
            typeCategoryMethod__instruction__enterLabelAtAddress _method = findCategoryMethod__instruction__enterLabelAtAddress (_temp_31403._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_31403 (HERE), var_cas_routineSymbolTable, var_cas_currentROMaddress, var_cas_currentlySelectedBank COMMA_SOURCE_FILE_AT_LINE (879)) ;
            }
          }
          GGS_uint  var_cas_length ;
          const GGS_instruction  _temp_31531 = operand_31363->mInstruction ;
          if (_temp_31531._isBuilt ()) {
            _temp_31531 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (881)) ;
          }
          var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (882)) ;
        }
      }
    }
  }
  ...
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (887))).isBuiltAndTrue ()) {
    var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, GGS_uint (true, 10U) COMMA_SOURCE_FILE_AT_LINE (888)) ;
  }
  GGS_ramBankTable  var_cas_ramBank ;
  var_cas_ramBank = var_cas_piccoloDeviceModel.reader_mRamBankTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (891)) ;
  GGS_registerTable  var_cas_registerTable ;
  var_cas_registerTable = var_cas_piccoloDeviceModel.reader_mRegisterTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (892)) ;
  {
    GGS_ramDefinitionList::cEnumerator enumerator_32036 (var_cas_inPiccoloModel.reader_mRamDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (893)), true) ;
    const GGS_ramDefinitionList::cElement * operand_32036 = NULL ;
    while (((operand_32036 = enumerator_32036.nextObject ()))) {
      ...
      const GGS_ramBankTable  _temp_32169 = var_cas_ramBank ;
      if (_temp_32169._isBuilt ()) {
        _temp_32169 (HERE)->method_searchKey (_inLexique, operand_32036->mBankName, var_cas_firstFreeAddress, var_cas_lastAddressPlusOne COMMA_SOURCE_FILE_AT_LINE (897)) ;
      }
      {
        GGS_declarationInRamList::cEnumerator enumerator_32243 (operand_32036->mDeclaration, true) ;
        const GGS_declarationInRamList::cElement * operand_32243 = NULL ;
        while (((operand_32243 = enumerator_32243.nextObject ()))) {
          macroValidPointer (operand_32243) ;
          if (((operand_32243->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (899)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            operand_32243->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "zero size is not allowed") COMMA_SOURCE_FILE_AT_LINE (900)) ;
          }
          GGS_bitSliceTable  var_cas_bitSliceTable ;
          var_cas_bitSliceTable = GGS_bitSliceTable ::constructor_emptyMap (_inLexique COMMA_HERE) ;
          var_cas_registerTable.modifier_insertKey (_inLexique, operand_32243->mName, GGS_uintlist ::constructor_listWithValue (var_cas_firstFreeAddress), operand_32243->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (903)), var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (903)) ;
          var_cas_firstFreeAddress = var_cas_firstFreeAddress._add_operation (_inLexique, operand_32243->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) ;
          var_cas_ramBank.modifier_setMFirstFreeAddressForKey (_inLexique, var_cas_firstFreeAddress, operand_32036->mBankName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (905)) COMMA_SOURCE_FILE_AT_LINE (905)) ;
          if (((var_cas_firstFreeAddress)._operator_strictSup (var_cas_lastAddressPlusOne)).isBuiltAndTrue ()) {
            operand_32243->mName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "overflow in '"))._operator_concat (operand_32036->mBankName))._operator_concat (GGS_string (true, "' ram bank for '")))._operator_concat (operand_32243->mName))._operator_concat (GGS_string (true, "' declaration")) COMMA_SOURCE_FILE_AT_LINE (907)) ;
          }
        }
      }
    }
  ...
  if (GGS_uint (true, 0U)._isBuilt ()) {
    ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (912)) ;
  }
  if (((var_cas_routineSymbolTable.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (916)))._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there is no 'main' routine") COMMA_SOURCE_FILE_AT_LINE (917)) ;
  }else{
    GGS_uint  var_cas_mainRoutineAddress ;
    GGS_uint  automatic_var_7 ;
    const GGS_routineSymbolTable  _temp_33272 = var_cas_routineSymbolTable ;
    if (_temp_33272._isBuilt ()) {
      _temp_33272 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_mainRoutineAddress, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (920)) ;
    }
    if ((GGS_uint (true, 61184U))._operator_or ((var_cas_mainRoutineAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (921)))._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61184U))._operator_or ((var_cas_mainRoutineAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (921)))._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (920)) ;
    }
    if ((GGS_uint (true, 61440U))._operator_or (var_cas_mainRoutineAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (922)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or (var_cas_mainRoutineAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (922))) COMMA_SOURCE_FILE_AT_LINE (921)) ;
    }
  }
  if (((var_cas_hasHighInterrupt)._operator_and (var_cas_hasLowInterrupt)).isBuiltAndTrue ()) {
    if (GGS_uint (true, 8U)._isBuilt ()) {
      ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (927)) ;
    }
    if ((GGS_uint (true, 61184U))._operator_or ((var_cas_highInterruptStartAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (929)))._operator_and (GGS_uint (true, 255U)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61184U))._operator_or ((var_cas_highInterruptStartAddress._right_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (929)))._operator_and (GGS_uint (true, 255U))) COMMA_SOURCE_FILE_AT_LINE (928)) ;
    }
    if ((GGS_uint (true, 61440U))._operator_or (var_cas_highInterruptStartAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (930)))._isBuilt ()) {
      ::routine_emitCode (_inLexique,  (GGS_uint (true, 61440U))._operator_or (var_cas_highInterruptStartAddress._right_shift_operation (_inLexique, GGS_uint (true, 9U) COMMA_SOURCE_FILE_AT_LINE (930))) COMMA_SOURCE_FILE_AT_LINE (929)) ;
    }
  }
  ...
  if ((var_cas_hasLowInterrupt).isBuiltAndTrue ()) {
    if (GGS_uint (true, 24U)._isBuilt ()) {
      ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (941)) ;
    }
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_34227 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (943)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_34227 = NULL ;
      while (((operand_34227 = enumerator_34227.nextObject ()))) {
        macroValidPointer (operand_34227) ;
        if (((operand_34227->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (944)))._operator_isEqual (GGS_string (true, "low"))).isBuiltAndTrue ()) {
          var_cas_codeGenerationContext.mCurrentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          GGS_bool var_cas_continuesInSequence ;
          var_cas_continuesInSequence = GGS_bool (true, true) ;
          {
            GGS_instructionList::cEnumerator enumerator_34458 (operand_34227->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_34458 = NULL ;
            while (((operand_34458 = enumerator_34458.nextObject ()))) {
              macroValidPointer (operand_34458) ;
              const GGS_instruction  _temp_34502 = operand_34458->mInstruction ;
              if (_temp_34502._isBuilt ()) {
                typeCategoryMethod__instruction__generateCodeAtAddress _method = findCategoryMethod__instruction__generateCodeAtAddress (_temp_34502._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_34502 (HERE), var_cas_codeGenerationContext, var_cas_currentROMaddress, var_cas_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (948)) ;
                }
              }
              GGS_uint  var_cas_length ;
              const GGS_instruction  _temp_34640 = operand_34458->mInstruction ;
              if (_temp_34640._isBuilt ()) {
                _temp_34640 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (950)) ;
              }
              var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (951)) ;
              ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentROMaddress COMMA_SOURCE_FILE_AT_LINE (951)) ;
            }
          }
          var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (954)) ;
          if (GGS_uint (true, 17U)._isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (true, 17U) COMMA_SOURCE_FILE_AT_LINE (954)) ;
          }
          ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentROMaddress COMMA_SOURCE_FILE_AT_LINE (955)) ;
        }
      }
    }
  }
  if (((var_cas_hasLowInterrupt)._operator_not ()).isBuiltAndTrue ()) {
    var_cas_currentROMaddress = GGS_uint (true, 8U) ;
    if (GGS_uint (true, 8U)._isBuilt ()) {
      ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 8U) COMMA_SOURCE_FILE_AT_LINE (962)) ;
    }
  }
  if ((var_cas_hasHighInterrupt).isBuiltAndTrue ()) {
    {
      GGS_interruptDefinitionList::cEnumerator enumerator_35177 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (966)), true) ;
      const GGS_interruptDefinitionList::cElement * operand_35177 = NULL ;
      while (((operand_35177 = enumerator_35177.nextObject ()))) {
        macroValidPointer (operand_35177) ;
        if (((operand_35177->mInterruptName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (967)))._operator_isEqual (GGS_string (true, "high"))).isBuiltAndTrue ()) {
          var_cas_codeGenerationContext.mCurrentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
          GGS_bool var_cas_continuesInSequence ;
          var_cas_continuesInSequence = GGS_bool (true, true) ;
          {
            GGS_instructionList::cEnumerator enumerator_35409 (operand_35177->mInstructionList, true) ;
            const GGS_instructionList::cElement * operand_35409 = NULL ;
            while (((operand_35409 = enumerator_35409.nextObject ()))) {
              macroValidPointer (operand_35409) ;
              const GGS_instruction  _temp_35453 = operand_35409->mInstruction ;
              if (_temp_35453._isBuilt ()) {
                typeCategoryMethod__instruction__generateCodeAtAddress _method = findCategoryMethod__instruction__generateCodeAtAddress (_temp_35453._galgasObjectRunTimeInfo ()) ;
                if (_method != NULL) {
                  _method (_inLexique, _temp_35453 (HERE), var_cas_codeGenerationContext, var_cas_currentROMaddress, var_cas_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (971)) ;
                }
              }
              GGS_uint  var_cas_length ;
              const GGS_instruction  _temp_35591 = operand_35409->mInstruction ;
              if (_temp_35591._isBuilt ()) {
                _temp_35591 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (973)) ;
              }
              var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (974)) ;
              ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentROMaddress COMMA_SOURCE_FILE_AT_LINE (974)) ;
            }
          }
          var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (977)) ;
          if (GGS_uint (true, 17U)._isBuilt ()) {
            ::routine_emitCode (_inLexique,  GGS_uint (true, 17U) COMMA_SOURCE_FILE_AT_LINE (977)) ;
          }
          ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentROMaddress COMMA_SOURCE_FILE_AT_LINE (978)) ;
        }
      }
    }
  }
  if ((((var_cas_hasLowInterrupt)._operator_not ())._operator_and ((var_cas_hasHighInterrupt)._operator_not ())).isBuiltAndTrue ()) {
    var_cas_currentROMaddress = GGS_uint (true, 4U) ;
    if (GGS_uint (true, 4U)._isBuilt ()) {
      ::routine_setEmitAddress (_inLexique,  GGS_uint (true, 4U) COMMA_SOURCE_FILE_AT_LINE (985)) ;
    }
  }
  {
    GGS_routineDefinitionList::cEnumerator enumerator_36103 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (988)), true) ;
    const GGS_routineDefinitionList::cElement * operand_36103 = NULL ;
    while (((operand_36103 = enumerator_36103.nextObject ()))) {
      macroValidPointer (operand_36103) ;
      var_cas_codeGenerationContext.mCurrentBank = operand_36103->mBanksel.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (989)) ;
      if ((((operand_36103->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (990)))._operator_isEqual (GGS_string (true, "main")))._operator_and ((operand_36103->mBanksel.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (990)))._operator_isNotEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
        operand_36103->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "as PIC18 is started with BSR register set to 0, the 'main' routine requires the 'banksel 0' declaration") COMMA_SOURCE_FILE_AT_LINE (991)) ;
      }
      if ((((operand_36103->mRoutineName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (993)))._operator_isEqual (GGS_string (true, "main")))._operator_and ((operand_36103->mHasNoReturn)._operator_not ())).isBuiltAndTrue ()) {
        operand_36103->mRoutineName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "as the 'main' routine is an endless loop, it should be declared with 'noreturn' qualifier") COMMA_SOURCE_FILE_AT_LINE (994)) ;
      }
      GGS_bool var_cas_continuesInSequence ;
      var_cas_continuesInSequence = GGS_bool (true, true) ;
      {
        GGS_instructionList::cEnumerator enumerator_36672 (operand_36103->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_36672 = NULL ;
        while (((operand_36672 = enumerator_36672.nextObject ()))) {
          macroValidPointer (operand_36672) ;
          const GGS_instruction  _temp_36712 = operand_36672->mInstruction ;
          if (_temp_36712._isBuilt ()) {
            typeCategoryMethod__instruction__generateCodeAtAddress _method = findCategoryMethod__instruction__generateCodeAtAddress (_temp_36712._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_36712 (HERE), var_cas_codeGenerationContext, var_cas_currentROMaddress, var_cas_continuesInSequence COMMA_SOURCE_FILE_AT_LINE (998)) ;
            }
          }
          GGS_uint  var_cas_length ;
          const GGS_instruction  _temp_36842 = operand_36672->mInstruction ;
          if (_temp_36842._isBuilt ()) {
            _temp_36842 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (1000)) ;
          }
          ...
          ::routine_checkCurrentEmitAddress (_inLexique,  var_cas_currentROMaddress COMMA_SOURCE_FILE_AT_LINE (1001)) ;
        }
      }
    }
  }
  if ((var_cas_inPiccoloModel.reader_mNeedsComputedGoto2 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1006))).isBuiltAndTrue ()) {
    if (GGS_uint (true, 9448U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 9448U) COMMA_SOURCE_FILE_AT_LINE (1006)) ;
    }
    if (GGS_uint (true, 9981U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 9981U) COMMA_SOURCE_FILE_AT_LINE (1007)) ;
    }
    if (GGS_uint (true, 3584U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 3584U) COMMA_SOURCE_FILE_AT_LINE (1008)) ;
    }
    if (GGS_uint (true, 8958U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 8958U) COMMA_SOURCE_FILE_AT_LINE (1009)) ;
    }
    if (GGS_uint (true, 18U)._isBuilt ()) {
      ::routine_emitCode (_inLexique,  GGS_uint (true, 18U) COMMA_SOURCE_FILE_AT_LINE (1010)) ;
    }
    var_cas_currentROMaddress = var_cas_currentROMaddress._add_operation (_inLexique, GGS_uint (true, 10U) COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  }
  if (((var_cas_programSize)._operator_isNotEqual (var_cas_currentROMaddress)).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Internal second pass error: the last address gets "))._operator_concat (var_cas_currentROMaddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1016))))._operator_concat (GGS_string (true, " value in second pass, while it gets ")))._operator_concat (var_cas_programSize.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1018))))._operator_concat (GGS_string (true, " in first pass")) COMMA_SOURCE_FILE_AT_LINE (1018)) ;
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    ::routine_getGeneratedContents (_inLexique,  var_cas_contents COMMA_SOURCE_FILE_AT_LINE (1022)) ;
    GGS_string var_cas_destinationFile ;
    var_cas_destinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (1024)))._operator_concat (GGS_string (true, ".hex")) ;
    const GGS_string _temp_37921 = var_cas_contents ;
    if (_temp_37921._isBuilt ()) {
      _temp_37921 (HERE)->method_writeToFile (_inLexique, var_cas_destinationFile COMMA_SOURCE_FILE_AT_LINE (1025)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
