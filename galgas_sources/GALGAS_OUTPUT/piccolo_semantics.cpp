...
void routine_analyze (C_Compiler & _inLexique,
  ...
  #endif
  ::routine_parseDeviceDefinition (_inLexique,  var_cas_inPiccoloModel.reader_mDeviceName (_inLexique COMMA_SOURCE_FILE_AT_LINE (45)) COMMA_SOURCE_FILE_AT_LINE (43)) ;
  GGS_uint  var_cas_currentAddress ;
  var_cas_currentAddress = GGS_uint (true, 26U) ;
  ...
  {
    GGS_interruptDefinitionList::cEnumerator enumerator_1539 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (49)), true) ;
    const GGS_interruptDefinitionList::cElement * operand_1539 = NULL ;
    while (((operand_1539 = enumerator_1539.nextObject ()))) {
      macroValidPointer (operand_1539) ;
      {
        GGS_instructionList::cEnumerator enumerator_1596 (operand_1539->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_1596 = NULL ;
        while (((operand_1596 = enumerator_1596.nextObject ()))) {
          macroValidPointer (operand_1596) ;
          const GGS_instruction  _temp_1636 = operand_1596->mInstruction ;
          if (_temp_1636._isBuilt ()) {
            typeCategoryMethod__instruction__enterLabelAtAddress _method = findCategoryMethod__instruction__enterLabelAtAddress (_temp_1636._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_1636 (HERE), var_cas_routineSymbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (51)) ;
            }
          }
          GGS_uint  var_cas_length ;
          const GGS_instruction  _temp_1737 = operand_1596->mInstruction ;
          if (_temp_1737._isBuilt ()) {
            _temp_1737 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (53)) ;
          }
          var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (54)) ;
        }
      }
      var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, GGS_uint (true, 2U) COMMA_SOURCE_FILE_AT_LINE (57)) ;
    }
  }
  {
    GGS_routineDefinitionList::cEnumerator enumerator_1939 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (59)), true) ;
    const GGS_routineDefinitionList::cElement * operand_1939 = NULL ;
    while (((operand_1939 = enumerator_1939.nextObject ()))) {
      macroValidPointer (operand_1939) ;
      var_cas_routineSymbolTable.modifier_insertKey (_inLexique, operand_1939->mRoutineName, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (60)) ;
      {
        GGS_instructionList::cEnumerator enumerator_2063 (operand_1939->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_2063 = NULL ;
        while (((operand_2063 = enumerator_2063.nextObject ()))) {
          macroValidPointer (operand_2063) ;
          const GGS_instruction  _temp_2103 = operand_2063->mInstruction ;
          if (_temp_2103._isBuilt ()) {
            typeCategoryMethod__instruction__enterLabelAtAddress _method = findCategoryMethod__instruction__enterLabelAtAddress (_temp_2103._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_2103 (HERE), var_cas_routineSymbolTable, var_cas_currentAddress COMMA_SOURCE_FILE_AT_LINE (62)) ;
            }
          }
          GGS_uint  var_cas_length ;
          const GGS_instruction  _temp_2204 = operand_2063->mInstruction ;
          if (_temp_2204._isBuilt ()) {
            _temp_2204 (HERE)->method_instructionLength (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (64)) ;
          }
          var_cas_currentAddress = var_cas_currentAddress._add_operation (_inLexique, var_cas_length COMMA_SOURCE_FILE_AT_LINE (65)) ;
        }
      }
    }
  }
  {
    GGS_routineSymbolTable::cEnumerator enumerator_2328 (var_cas_routineSymbolTable, true) ;
    const GGS_routineSymbolTable::cElement * operand_2328 = NULL ;
    while (((operand_2328 = enumerator_2328.nextObject ()))) {
      macroValidPointer (operand_2328) ;
      _inLexique.printMessage (((((GGS_string (true, "Symbol '"))._operator_concat (operand_2328->mKey))._operator_concat (GGS_string (true, "': ")))._operator_concat (operand_2328->mInfo.mRoutineAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (69))))._operator_concat (GGS_string (true, "\n")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
    }
  }
  _inLexique.printMessage (((GGS_string (true, "Last Address: "))._operator_concat (var_cas_currentAddress.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (71))))._operator_concat (GGS_string (true, "\n")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  ...
  {
    GGS_ramDefinitionList::cEnumerator enumerator_2614 (var_cas_inPiccoloModel.reader_mRamDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (75)), true) ;
    const GGS_ramDefinitionList::cElement * operand_2614 = NULL ;
    while (((operand_2614 = enumerator_2614.nextObject ()))) {
      macroValidPointer (operand_2614) ;
      var_cas_registerTable.modifier_insertKey (_inLexique, operand_2614->mName, var_cas_currentRamAddress, operand_2614->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
      var_cas_currentRamAddress = var_cas_currentRamAddress._add_operation (_inLexique, operand_2614->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)) COMMA_SOURCE_FILE_AT_LINE (77)) ;
    }
  }
  _inLexique.printMessage (((GGS_string (true, "Used RAM size: "))._operator_concat (var_cas_currentRamAddress.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (79))))._operator_concat (GGS_string (true, " bytes\n")) COMMA_SOURCE_FILE_AT_LINE (79)) ;
  #ifdef DEBUG_TRACE_ENABLED
