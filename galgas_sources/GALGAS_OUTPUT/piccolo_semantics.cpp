...
void routine_analyze (C_Compiler & _inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ::routine_buildBinaryCode (_inLexique,  var_cas_generatedInstructionList,  var_cas_piccoloDeviceModel.reader_mRomSize (_inLexique COMMA_SOURCE_FILE_AT_LINE (181)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (181)),  var_cas_actualConfigurationMap COMMA_SOURCE_FILE_AT_LINE (177)) ;
    ...
    var_cas_destinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_concat (GGS_string (true, ".hex")) ;
    const GGS_string _temp_8185 = var_cas_contents ;
    if (_temp_8185._isBuilt ()) {
      _temp_8185 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_destinationFile COMMA_SOURCE_FILE_AT_LINE (187)) ;
    }
    if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "generateAssembly" COMMA_SOURCE_FILE_AT_LINE (189)))).isBuiltAndTrue ()) {
      GGS_string var_cas_assemblyCode ;
      ::routine_buildAssemblyCode (_inLexique,  var_cas_piccoloDeviceModel.reader_mDeviceName (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)),  var_cas_piccoloDeviceModel.reader_mRegisterTable (_inLexique COMMA_SOURCE_FILE_AT_LINE (193)),  var_cas_registerTable,  var_cas_generatedInstructionList,  var_cas_actualConfigurationMap,  var_cas_assemblyCode COMMA_SOURCE_FILE_AT_LINE (190)) ;
      GGS_string var_cas_destinationFile ;
      var_cas_destinationFile = (var_cas_inSourceFileName.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)))._operator_concat (GGS_string (true, ".asm")) ;
      const GGS_string _temp_8731 = var_cas_assemblyCode ;
      if (_temp_8731._isBuilt ()) {
        _temp_8731 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_destinationFile COMMA_SOURCE_FILE_AT_LINE (200)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
