...
pr_structured_instruction_piccolo_syntax_276_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_9 (_inLexique)) {
    ...
    case 2 : {
      ...
      switch (select_piccolo_syntax_10 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (305)))._operator_isNotEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
            var_cas_condition.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (306)) ;
          }
    ...
    case 3 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_condition) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (328)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, true) ;
      }else if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (330)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, false) ;
      }else{
        var_cas_condition.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (333)) ;
    ...
    case 7 : {
      ...
      switch (select_piccolo_syntax_17 (_inLexique)) {
        case 1 : {
          ...
          if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (426)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true, false) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (428)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true, true) ;
          }else{
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (434)) ;
        ...
        case 2 : {
          ...
          _inLexique._assignFromAttribute_tokenString (var_cas_conditionString) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (444)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (_inLexique COMMA_HERE) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (446)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (_inLexique COMMA_HERE) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (448)))._operator_isEqual (GGS_string (true, "n"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bnn (_inLexique COMMA_HERE) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (450)))._operator_isEqual (GGS_string (true, "nn"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bn (_inLexique COMMA_HERE) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (452)))._operator_isEqual (GGS_string (true, "c"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bnc (_inLexique COMMA_HERE) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (454)))._operator_isEqual (GGS_string (true, "nc"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bc (_inLexique COMMA_HERE) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (456)))._operator_isEqual (GGS_string (true, "ov"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bnov (_inLexique COMMA_HERE) ;
          }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (458)))._operator_isEqual (GGS_string (true, "nov"))).isBuiltAndTrue ()) {
            var_cas_conditional_branch = GGS_conditional_branch::constructor_bov (_inLexique COMMA_HERE) ;
          }else{
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (464)) ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_500_4_ (piccolo_lexique & _inLexique,
                                GGS_instruction  &var_cas_outInstruction) {
  GGS_location  var_cas_instructionLocation ;
  var_cas_instructionLocation = GGS_location (_inLexique) ;
