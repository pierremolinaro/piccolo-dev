  ...
  switch (select_piccolo_syntax_2 (_inLexique)) {
    ...
    case 2 : {
        ...
        while (syntaxRepeat_3) {
            switch (select_piccolo_syntax_4 (_inLexique)) {
              case 1 : {
                ...
                { bool syntaxRepeat_5 = true ;
                  while (syntaxRepeat_5) {
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
                        var_cas_sliceBase = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
                      }
                      ...
                      switch (select_piccolo_syntax_6 (_inLexique)) {
                        case 1 : {
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 1U)))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
                          }
                        ...
                        case 2 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (150))))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (151))))._operator_concat (GGS_string (true, " bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (151)) ;
                          }
                          var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
                          var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (154))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (154)) ;
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
                          } break ;
                        default :
                          break ;
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (158)))).isBuiltAndTrue ()) {
                        var_cas_base = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (159))._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (159)) ;
                      }
                      var_cas_bitSliceTable.modifier_insertKey (_inLexique, var_cas_sliceName, var_cas_base, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (161)) ;
                ...
                var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)) ;
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
                var_cas_sliceIndex._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
                } break ;
              default :
                break ;
            }
      ...
      if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Incorrect bit definition for register '"))._operator_concat (var_cas_name))._operator_concat (GGS_string (true, "': ")))._operator_concat (GGS_sint (true, 8L)._substract_operation (_inLexique, var_cas_sliceIndex COMMA_SOURCE_FILE_AT_LINE (174)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (174))))._operator_concat (GGS_string (true, " bits (s) are defined, instead of 8")) COMMA_SOURCE_FILE_AT_LINE (174)) ;
      }
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_183_4_ (piccolo_lexique & _inLexique,
                                GGS_declarationInRam  &var_cas_outDeclaration) {
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_206_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_225_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_249_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_269_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_13 (_inLexique)) {
    case 1 : {
      ...
      if ((var_cas_noreturn).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A routine declared with 'noreturn' qualifier cannot end with a computed RETLW") COMMA_SOURCE_FILE_AT_LINE (303)) ;
      }
      ...
      var_cas_instructionList._addAssign_operation (GGS_instruction_computed_retlw ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_argumentList, GGS_bool (true, true) COMMA_HERE)) ;
    ...
    case 2 : {
      ...
      if (((var_cas_noreturn)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A routine declared without 'noreturn' qualifier cannot end with a computed BRA") COMMA_SOURCE_FILE_AT_LINE (323)) ;
      }
      ...
      var_cas_instructionList._addAssign_operation (GGS_instruction_computed_bra ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_argumentList, GGS_bool (true, true) COMMA_HERE)) ;
      var_cas_ioNeedsComputedGoto2 = GGS_bool (true, true) ;
      } break ;
    case 3 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_computed) COMMA_HERE) ;
      ...
      if (((var_cas_noreturn)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A routine declared without 'noreturn' qualifier cannot end with a computed GOTO") COMMA_SOURCE_FILE_AT_LINE (342)) ;
      }
      GGS_lstringlist  var_cas_argumentList ;
      var_cas_argumentList = GGS_lstringlist ::constructor_emptyList () ;
      ...
      var_cas_instructionList._addAssign_operation (GGS_instruction_computed_goto ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_argumentList, GGS_bool (true, true) COMMA_HERE)) ;
      var_cas_ioNeedsComputedGoto4 = GGS_bool (true, true) ;
      } break ;
    case 4 : {
      if (((var_cas_noreturn)._operator_not ()).isBuiltAndTrue ()) {
        var_cas_instructionList._addAssign_operation (GGS_instruction_RETURN ::constructor_new (_inLexique, var_cas_instructionLocation COMMA_HERE)) ;
      }
      } break ;
    default :
      break ;
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_368_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_386_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_401_4_ (piccolo_lexique & _inLexique,
                                GGS_bitNumberExpression  &var_cas_outBitNumber) {
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_408_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_414_4_ (piccolo_lexique & _inLexique,
                                GGS_luint  &var_cas_outLiteralValue) {
  ...
  var_cas_outLiteralValue = GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)) COMMA_HERE) ;
}
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_421_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_433_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_444_4_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
pr_condition_factor_piccolo_syntax_452_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_20 (_inLexique)) {
    case 1 : {
      ...
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (471)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (471)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (481)) ;
    ...
    case 3 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (527)) ;
    ...
    case 4 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (538)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (538)) ;
      GGS_bool var_cas_branchIfZero ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_branchIfZero = GGS_bool (true, true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (548)) ;
        var_cas_branchIfZero._drop () ;
      }
    ...
    case 5 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (575)) ;
...
void piccolo_syntax::
pr_condition_expression_piccolo_syntax_583_4_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_term_piccolo_syntax_602_4_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_617_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_26 (_inLexique)) {
    ...
    case 2 : {
      ...
      switch (select_piccolo_syntax_27 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (645)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (645)) ;
          if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (647)) ;
          }
    ...
    case 3 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (669)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (669)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, false) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (675)) ;
    ...
    case 4 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (705)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (705)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, false) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, true) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (711)) ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_804_4_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction) {
  GGS_location  var_cas_instructionLocation ;
  var_cas_instructionLocation = GGS_location (_inLexique) ;
  switch (select_piccolo_syntax_33 (_inLexique)) {
    ...
    case 5 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_JSR ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 6 : {
