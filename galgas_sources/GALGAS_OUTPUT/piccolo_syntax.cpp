...
pr_start_symbol_piccolo_syntax_130_19_ (piccolo_lexique & inLexique) {
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_concat (GGS_string (".hex")) ;
    ...
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_concat (GGS_string (".asm")) ;
...
pr_declaration_in_ram_piccolo_syntax_288_25_ (piccolo_lexique & inLexique,
  ...
  switch (select_piccolo_syntax_5 (inLexique)) {
    ...
    case 2 : {
              ...
              case 1 : {
                ...
                { bool syntaxRepeat_8 = true ;
                  while (syntaxRepeat_8) {
                      ...
                      if (((var_cas_sliceIndex).operator_supOrEqual (GGS_sint (0L))).isBuiltAndTrue ()) {
                      ...
                      switch (select_piccolo_syntax_9 (inLexique)) {
                        ...
                        case 2 : {
                          ...
                          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth).operator_isNotEqual (GGS_uint (0U))).operator_and ((var_cas_sliceWidth).operator_isNotEqual (var_cas_sliceSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (327))))).isBuiltAndTrue ()) {
                      ...
                      if (((var_cas_sliceIndex).operator_supOrEqual (var_cas_sliceWidth.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (336)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_sliceIndex).operator_isNotEqual (GGS_sint (0L))).isBuiltAndTrue ()) {
      ...
      switch (select_piccolo_syntax_26 (inLexique)) {
        ...
        case 2 : {
          ...
          if (((var_cas_condition).operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
            ...
            var_cas_s = (GGS_string ("! ")).operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (682)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (682))) ;
            if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (683)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (683))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
            ...
            if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (691)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (691))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
          ...
          switch (select_piccolo_syntax_37 (inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_condition).operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if ! ")).operator_concat (var_cas_registerName.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (954))) ;
                if (((var_cas_registerName.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (955)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (955))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
                ...
                var_cas_skipIfSet = GGS_bool (false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if ")).operator_concat (var_cas_registerName.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (963))) ;
                if (((var_cas_registerName.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (964)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (964))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
