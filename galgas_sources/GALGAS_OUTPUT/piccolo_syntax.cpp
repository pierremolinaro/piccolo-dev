...
void cParser_piccolo_5F_syntax::rule_piccolo_5F_syntax_start_5F_symbol_i0_ (C_Lexique_piccolo_5F_lexique * inCompiler) {
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (180)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_hexDestinationFile.reader_fileExists (SOURCE_FILE_AT_LINE (198)).boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_asmDestinationFile.reader_fileExists (SOURCE_FILE_AT_LINE (202)).boolEnum () ;
    if (kBoolTrue == test_3) {
      { //-------- @typeMethodInstructionForGeneration
    ...
    while (repeatFlag_0) {
      ...
      case 1: {
        ...
        while (repeatFlag_1) {
          ...
          case 1: {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (GALGAS_uint ((PMUInt32) 1U))) COMMA_SOURCE_FILE_AT_LINE (318)).boolEnum () ;
            if (kBoolTrue == test_3) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_4 (var_sliceName.reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_4, GALGAS_string ("a slice of 1 bit is expected for '").operator_concat (var_sliceName.reader_string (SOURCE_FILE_AT_LINE (319)) COMMA_SOURCE_FILE_AT_LINE (319)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (319)) COMMA_SOURCE_FILE_AT_LINE (319)) ;
            }
            //-------- @assignmentInstructionForGeneration
          ...
          case 2: {
            ...
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsNotEqual, var_sliceWidth.objectCompare (var_sliceSize.reader_uint (SOURCE_FILE_AT_LINE (326)))) COMMA_SOURCE_FILE_AT_LINE (326)).boolEnum () ;
            if (kBoolTrue == test_5) {
              //-------- @errorInstructionForGeneration
          ...
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsSupOrEqual, var_sliceIndex.objectCompare (var_sliceWidth.reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (335)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @assignmentInstructionForGeneration
  ...
  case 1: {
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        inCompiler->emitSemanticError (location_2, GALGAS_string ("invalid '").operator_concat (var_conditionString.reader_string (SOURCE_FILE_AT_LINE (635)) COMMA_SOURCE_FILE_AT_LINE (635)).operator_concat (GALGAS_string ("' condition; valid ones are: 'z' and 'nz'") COMMA_SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (635)) ;
  ...
  case 3: {
    ...
    case 2: {
      ...
      if (kBoolTrue == test_3) {
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_registerExpression.reader_mOffset (SOURCE_FILE_AT_LINE (682)).reader_uint (SOURCE_FILE_AT_LINE (682)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @appendInstructionForGeneration
        ...
        callCategoryMethod_display ((const cPtr_bitNumberExpression *) var_bitNumberExpression.ptr (), var_s, inCompiler COMMA_SOURCE_FILE_AT_LINE (685)) ;
        ...
        inCompiler->emitSemanticWarning (location_5, GALGAS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (686)).operator_concat (GALGAS_string ("' instead") COMMA_SOURCE_FILE_AT_LINE (686)) COMMA_SOURCE_FILE_AT_LINE (686)) ;
        ...
        if (kBoolTrue == test_6) {
          ...
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, var_registerExpression.reader_mOffset (SOURCE_FILE_AT_LINE (690)).reader_uint (SOURCE_FILE_AT_LINE (690)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @appendInstructionForGeneration
          ...
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_display ((const cPtr_bitNumberExpression *) var_bitNumberExpression.ptr (), var_s, inCompiler COMMA_SOURCE_FILE_AT_LINE (693)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @warningInstructionForGeneration
          GALGAS_location location_8 (var_conditionString.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_8, GALGAS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (694)).operator_concat (GALGAS_string ("' instead") COMMA_SOURCE_FILE_AT_LINE (694)) COMMA_SOURCE_FILE_AT_LINE (694)) ;
        }else if (kBoolFalse == test_6) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_9 (var_conditionString.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_9, GALGAS_string ("invalid '").operator_concat (var_conditionString.reader_string (SOURCE_FILE_AT_LINE (696)) COMMA_SOURCE_FILE_AT_LINE (696)).operator_concat (GALGAS_string ("' condition; valid ones are: 'z' and 'nz'") COMMA_SOURCE_FILE_AT_LINE (697)) COMMA_SOURCE_FILE_AT_LINE (696)) ;
  ...
  case 4: {
    ...
    if (kBoolTrue == test_10) {
      ...
      if (kBoolTrue == test_11) {
        ...
        inCompiler->emitSemanticError (location_12, GALGAS_string ("invalid '").operator_concat (var_conditionString.reader_string (SOURCE_FILE_AT_LINE (718)) COMMA_SOURCE_FILE_AT_LINE (718)).operator_concat (GALGAS_string ("' condition; valid ones are: 'z' and 'nz'") COMMA_SOURCE_FILE_AT_LINE (719)) COMMA_SOURCE_FILE_AT_LINE (718)) ;
        var_branchIfZero.drop () ; // Release error dropped variable
      }
    }
    //-------- @assignmentInstructionForGeneration
              ...
              if (kBoolTrue == test_18) {
                ...
                if (kBoolTrue == test_19) {
                  ...
                  if (kBoolTrue == test_20) {
                    ...
                    inCompiler->emitSemanticError (location_21, GALGAS_string ("invalid '").operator_concat (var_conditionString.reader_string (SOURCE_FILE_AT_LINE (745)) COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (GALGAS_string ("' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'") COMMA_SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (745)) ;
  ...
  case 6: {
    ...
    case 4: {
      ...
      if (kBoolTrue == test_4) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_5 (var_conditionString.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_5, GALGAS_string ("invalid '").operator_concat (var_condition COMMA_SOURCE_FILE_AT_LINE (917)).operator_concat (GALGAS_string ("' condition; it should be 'nz'") COMMA_SOURCE_FILE_AT_LINE (917)) COMMA_SOURCE_FILE_AT_LINE (917)) ;
      }
      //-------- @assignmentInstructionForGeneration
    ...
    case 2: {
      ...
      case 2: {
        ...
        if (kBoolTrue == test_6) {
          ...
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, var_registerName.reader_mOffset (SOURCE_FILE_AT_LINE (954)).reader_uint (SOURCE_FILE_AT_LINE (954)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @appendInstructionForGeneration
          ...
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_display ((const cPtr_bitNumberExpression *) var_bitNumber.ptr (), var_s, inCompiler COMMA_SOURCE_FILE_AT_LINE (957)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" :") COMMA_SOURCE_FILE_AT_LINE (958)) ;
          //-------- @warningInstructionForGeneration
          GALGAS_location location_8 (var_conditionString.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticWarning (location_8, GALGAS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (959)).operator_concat (GALGAS_string ("' instead") COMMA_SOURCE_FILE_AT_LINE (959)) COMMA_SOURCE_FILE_AT_LINE (959)) ;
        }else if (kBoolFalse == test_6) {
          //-------- @ifInstructionForGeneration
          ...
          if (kBoolTrue == test_9) {
            ...
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_registerName.reader_mOffset (SOURCE_FILE_AT_LINE (963)).reader_uint (SOURCE_FILE_AT_LINE (963)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
            if (kBoolTrue == test_10) {
              //-------- @appendInstructionForGeneration
            ...
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_display ((const cPtr_bitNumberExpression *) var_bitNumber.ptr (), var_s, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
            //-------- END @methodCallInstructionForGeneration
            //-------- @appendInstructionForGeneration
            ...
            inCompiler->emitSemanticWarning (location_11, GALGAS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (968)).operator_concat (GALGAS_string ("' instead") COMMA_SOURCE_FILE_AT_LINE (968)) COMMA_SOURCE_FILE_AT_LINE (968)) ;
          }else if (kBoolFalse == test_9) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_12 (var_conditionString.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_12, GALGAS_string ("invalid '").operator_concat (var_condition COMMA_SOURCE_FILE_AT_LINE (970)).operator_concat (GALGAS_string ("' condition; it should be 'z' or 'nz'") COMMA_SOURCE_FILE_AT_LINE (970)) COMMA_SOURCE_FILE_AT_LINE (970)) ;
  ...
  case 8: {
    ...
    if (kBoolTrue == test_13) {
      ...
      if (kBoolTrue == test_14) {
        ...
        inCompiler->emitSemanticError (location_15, GALGAS_string ("invalid '").operator_concat (var_condition COMMA_SOURCE_FILE_AT_LINE (1009)).operator_concat (GALGAS_string ("' condition; it should be 'z' or 'nz'") COMMA_SOURCE_FILE_AT_LINE (1009)) COMMA_SOURCE_FILE_AT_LINE (1009)) ;
              ...
              if (kBoolTrue == test_5) {
                ...
                if (kBoolTrue == test_6) {
                  ...
                  if (kBoolTrue == test_7) {
                    ...
                    //-------- @errorInstructionForGeneration
                    GALGAS_location location_8 (var_conditionString.reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_8, GALGAS_string ("invalid '").operator_concat (var_conditionString.reader_string (SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1348)).operator_concat (GALGAS_string ("' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'") COMMA_SOURCE_FILE_AT_LINE (1349)) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
                    var_conditional_5F_branch.drop () ; // Release error dropped variable
                  }
                }
              }
