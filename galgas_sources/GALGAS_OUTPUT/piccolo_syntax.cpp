...
void piccolo_syntax::
pr_start_symbol_piccolo_syntax_128_19_ (piccolo_lexique & _inLexique) {
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    ::routine_pic18_analyze (_inLexique,  var_cas_piccoloModel,  GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (190)) ;
  }else{
    GGS_string var_cas_hexDestinationFile ;
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)))._operator_concat (GGS_string (true, ".hex")) ;
    if ((var_cas_hexDestinationFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))).isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (_inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (194)) ;
    }
    GGS_string var_cas_asmDestinationFile ;
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)))._operator_concat (GGS_string (true, ".asm")) ;
    if ((var_cas_asmDestinationFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (197))).isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (_inLexique, var_cas_asmDestinationFile COMMA_SOURCE_FILE_AT_LINE (198)) ;
    }
  }
}
...
void piccolo_syntax::
pr_start_symbol_piccolo_syntax_128_19_importBootloaderSpecification (piccolo_lexique & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_programName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  var_cas_programName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this file does not define a bootloader specification") COMMA_SOURCE_FILE_AT_LINE (215)) ;
...
void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_243_31_ (piccolo_lexique & _inLexique,
      ...
      switch (select_repeat_piccolo_syntax_2 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_ioAcceptDefaultConfiguration).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "'default' for configuration is already set") COMMA_SOURCE_FILE_AT_LINE (254)) ;
          }
...
void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_243_31_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_configuration) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7B) COMMA_HERE) ;
  { bool syntaxRepeat_2 = true ;
    while (syntaxRepeat_2) {
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_274_25_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_5 (_inLexique)) {
    ...
    case 2 : {
        ...
        while (syntaxRepeat_6) {
            switch (select_piccolo_syntax_7 (_inLexique)) {
              case 1 : {
                ...
                { bool syntaxRepeat_8 = true ;
                  while (syntaxRepeat_8) {
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
                        var_cas_sliceBase = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)) ;
                      }
                      ...
                      switch (select_piccolo_syntax_9 (_inLexique)) {
                        case 1 : {
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 1U)))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (307)) ;
                          }
                          var_cas_sliceWidth = GGS_uint (true, 1U) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (309))) ;
                          } break ;
                        case 2 : {
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (314))))._operator_concat (GGS_string (true, " bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (315)) ;
                          }
                          var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (316)) ;
                          var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (317))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (317)) COMMA_SOURCE_FILE_AT_LINE (317)) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (318))) ;
                          var_cas_bitDefinitionString.writeString ("[") ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (318)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (318))) ;
                          var_cas_bitDefinitionString.writeString ("]") ;
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
                          } break ;
                        default :
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)))).isBuiltAndTrue ()) {
                        var_cas_base = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (323))._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (323)) ;
                      }
                      var_cas_bitSliceTable.modifier_insertKey (_inLexique, var_cas_sliceName, var_cas_base, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (325)) ;
                ...
                var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) ;
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
                var_cas_bitDefinitionString.writeString ("-") ;
                var_cas_sliceIndex._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (334)) ;
                } break ;
              default :
                break ;
            }
      ...
      if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Incorrect bit definition for register '"))._operator_concat (var_cas_name))._operator_concat (GGS_string (true, "': ")))._operator_concat (GGS_sint (true, 8L)._substract_operation (_inLexique, var_cas_sliceIndex COMMA_SOURCE_FILE_AT_LINE (341)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341))))._operator_concat (GGS_string (true, " bits (s) are defined, instead of 8")) COMMA_SOURCE_FILE_AT_LINE (342)) ;
      }
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_274_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_byte) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_4 (_inLexique)) {
    case 1 : {
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_351_25_ (piccolo_lexique & _inLexique,
                                GGS_declarationInRam  &var_cas_outDeclaration) {
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_351_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_common) COMMA_HERE) ;
  { bool syntaxRepeat_10 = true ;
    while (syntaxRepeat_10) {
        { bool syntaxRepeat_11 = true ;
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_374_21_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_374_21_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_ram) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7B) COMMA_HERE) ;
  { bool syntaxRepeat_12 = true ;
...
void piccolo_syntax::
pr_constant_definition_piccolo_syntax_393_26_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_constant_definition_piccolo_syntax_393_26_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_const) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3D) COMMA_HERE) ;
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_406_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_406_23_parse (piccolo_lexique & _inLexique) {
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
      switch (select_repeat_piccolo_syntax_13 (_inLexique)) {
        case 2 : {
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_430_27_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_430_27_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_interrupt) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_14 (_inLexique)) {
    case 1 : {
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_457_25_ (piccolo_lexique & _inLexique,
      ...
      switch (select_piccolo_syntax_17 (_inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (485)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_piccolo_syntax_18 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (500)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (507)) ;
          }
          var_cas_preservesBank = GGS_bool (true, false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_457_25_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_15 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_525_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_525_23_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_19 (_inLexique)) {
    case 1 : {
      } break ;
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_543_25_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_543_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_20 (_inLexique)) {
    case 1 : {
      } break ;
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_558_25_ (piccolo_lexique & _inLexique,
                                GGS_bitNumberExpression  &var_cas_outBitNumber) {
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_558_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
}
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_565_25_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_565_25_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_21 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_577_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_577_23_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__21) COMMA_HERE) ;
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_588_23_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_588_23_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_596_23_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
  switch (select_piccolo_syntax_22 (_inLexique)) {
    case 1 : {
      ...
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (615)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (615)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (626)) ;
    ...
    case 3 : {
      ...
      switch (select_piccolo_syntax_26 (_inLexique)) {
        ...
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (665)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (665)) ;
          if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true, true) ;
            GGS_string var_cas_s ;
            var_cas_s = (GGS_string (true, "! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (668)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (668))) ;
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (669)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (669)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              var_cas_s.writeString (" [") ;
              var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (670)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (670)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (670))) ;
              var_cas_s.writeString ("]") ;
            }
            var_cas_s.writeString (".") ;
            const GGS_bitNumberExpression  _temp_18123 = var_cas_bitNumberExpression ;
            if (_temp_18123._isBuilt ()) {
              _temp_18123 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (672)) ;
            }
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (673)) ;
          }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true, false) ;
            GGS_string var_cas_s ;
            var_cas_s = var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (676)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (676)) ;
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (677)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (677)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              var_cas_s.writeString (" [") ;
              var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (678)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (678)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (678))) ;
              var_cas_s.writeString ("]") ;
            }
            var_cas_s.writeString (".") ;
            const GGS_bitNumberExpression  _temp_18587 = var_cas_bitNumberExpression ;
            if (_temp_18587._isBuilt ()) {
              _temp_18587 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (680)) ;
            }
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (681)) ;
          }else{
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (687)) ;
    ...
    case 4 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (698)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (698)) ;
      GGS_bool var_cas_branchIfZero ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_branchIfZero = GGS_bool (true, true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (709)) ;
        var_cas_branchIfZero._drop () ;
      }
    ...
    case 5 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (714)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (714)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (736)) ;
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_596_23_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_22 (_inLexique)) {
    case 1 : {
      switch (select_piccolo_syntax_23 (_inLexique)) {
        case 1 : {
...
void piccolo_syntax::
pr_condition_expression_piccolo_syntax_743_27_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_expression_piccolo_syntax_743_27_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__28) COMMA_HERE) ;
...
void piccolo_syntax::
pr_condition_term_piccolo_syntax_762_21_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_term_piccolo_syntax_762_21_parse (piccolo_lexique & _inLexique) {
  nt_condition_factor_parse (_inLexique) ;
  { bool syntaxRepeat_28 = true ;
    while (syntaxRepeat_28) {
      switch (select_repeat_piccolo_syntax_28 (_inLexique)) {
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_777_29_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_29 (_inLexique)) {
    ...
    case 6 : {
      ...
      switch (select_piccolo_syntax_35 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (902)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (902)) ;
          if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (905)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_piccolo_syntax_37 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
              GGS_string var_cas_condition ;
              var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (937)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (937)) ;
              if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true, true) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string (true, "if ! "))._operator_concat (var_cas_registerName.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (940))) ;
                if (((var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (941)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (941)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                  var_cas_s.writeString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (942)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (942)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (942))) ;
                  var_cas_s.writeString ("]") ;
                }
                var_cas_s.writeString (".") ;
                const GGS_bitNumberExpression  _temp_26506 = var_cas_bitNumber ;
                if (_temp_26506._isBuilt ()) {
                  _temp_26506 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (944)) ;
                }
                var_cas_s.writeString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (946)) ;
              }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true, false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string (true, "if "))._operator_concat (var_cas_registerName.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (949))) ;
                if (((var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (950)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (950)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                  var_cas_s.writeString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (951)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (951)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (951))) ;
                  var_cas_s.writeString ("]") ;
                }
                var_cas_s.writeString (".") ;
                const GGS_bitNumberExpression  _temp_26972 = var_cas_bitNumber ;
                if (_temp_26972._isBuilt ()) {
                  _temp_26972 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (953)) ;
                }
                var_cas_s.writeString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (955)) ;
              }else{
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (958)) ;
    ...
    case 8 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (990)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (990)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, false) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, true) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (997)) ;
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_777_29_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_29 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_banksel) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
...
void piccolo_syntax::
pr_structured_if_instruction_piccolo_syntax_1058_32_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void piccolo_syntax::
pr_structured_if_instruction_piccolo_syntax_1058_32_parse (piccolo_lexique & _inLexique) {
  nt_condition_expression_parse (_inLexique) ;
  nt_instruction_list_parse (_inLexique) ;
  switch (select_piccolo_syntax_41 (_inLexique)) {
    case 1 : {
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_1105_25_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction) {
  switch (select_piccolo_syntax_42 (_inLexique)) {
    ...
    case 12 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1317)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1317)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (_inLexique COMMA_HERE) ;
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (1339)) ;
        var_cas_conditional_branch._drop () ;
      }
      GGS_lstring  var_cas_targetLabelName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_1105_25_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_42 (_inLexique)) {
    case 1 : {
      switch (select_piccolo_syntax_43 (_inLexique)) {
        case 1 : {
...
void piccolo_syntax::
pr_immediate_expression_piccolo_syntax_1442_27_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_immediate_expression_piccolo_syntax_1442_27_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_bitwise_term_piccolo_syntax_1460_30_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_bitwise_term_piccolo_syntax_1460_30_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_bitwise_factor_piccolo_syntax_1473_31_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_bitwise_factor_piccolo_syntax_1473_31_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_term_piccolo_syntax_1511_21_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_term_piccolo_syntax_1511_21_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_factor_piccolo_syntax_1539_23_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_factor_piccolo_syntax_1539_23_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_primary_piccolo_syntax_1563_24_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
  switch (select_piccolo_syntax_55 (_inLexique)) {
    ...
    case 4 : {
      ...
      var_cas_outExpression = GGS_immediatInteger ::constructor_new (_inLexique, GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (1579)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1579)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1579)) COMMA_HERE) COMMA_HERE) ;
      } break ;
    case 5 : {
      GGS_lstring  var_cas_registerName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_registerName) ;
...
void piccolo_syntax::
pr_immediate_primary_piccolo_syntax_1563_24_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_55 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
      nt_immediate_primary_parse (_inLexique) ;
