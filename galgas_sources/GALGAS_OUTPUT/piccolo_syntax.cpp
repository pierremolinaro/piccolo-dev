...
void piccolo_syntax::
pr_start_symbol_piccolo_syntax_50_4_ (piccolo_lexique & _inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_piccolo_syntax_0 (_inLexique)) {
        ...
        case 4 : {
          nt_interrupt_definition_ (_inLexique, var_cas_interruptDefinitionList, var_cas_needsComputedGoto2) ;
          } break ;
        case 5 : {
          nt_routine_definition_ (_inLexique, var_cas_routineDefinitionList, var_cas_needsComputedGoto2) ;
          } break ;
        default :
  ...
  var_cas_outPiccoloModel = GGS_piccoloModel::constructor_new (var_cas_programName, var_cas_deviceName, var_cas_ramDefinitionList, var_cas_interruptDefinitionList, var_cas_routineDefinitionList, var_cas_needsComputedGoto2) ;
}
...
void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_84_4_ (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_92_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_119_4_ (piccolo_lexique & _inLexique,
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
      switch (select_repeat_piccolo_syntax_3 (_inLexique)) {
        ...
        case 3 : {
          GGS_instruction  var_cas_instruction ;
          nt_structured_instruction_ (_inLexique, var_cas_instruction, var_cas_ioNeedsComputedGoto2) ;
          var_cas_outInstructionList._addAssign_operation (var_cas_instruction) ;
          } break ;
        default :
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_138_4_ (piccolo_lexique & _inLexique,
  ...
  nt_instruction_list_ (_inLexique, var_cas_instructionList, var_cas_ioNeedsComputedGoto2) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7D) COMMA_HERE) ;
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_153_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_182_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_200_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_215_4_ (piccolo_lexique & _inLexique,
                                GGS_bitNumberExpression  &var_cas_outBitNumber) {
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_222_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_228_4_ (piccolo_lexique & _inLexique,
                                GGS_luint  &var_cas_outLiteralValue) {
  ...
  var_cas_outLiteralValue = GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)) COMMA_HERE) ;
}
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_235_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_247_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_9 (_inLexique)) {
    ...
    case 8 : {
      ...
      var_cas_outInstruction = GGS_instruction_computed_retlw ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_argumentList COMMA_HERE) ;
    ...
    case 9 : {
      ...
      var_cas_outInstruction = GGS_instruction_computed_bra ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_argumentList COMMA_HERE) ;
      var_cas_ioNeedsComputedGoto2 = GGS_bool (true, true) ;
      } break ;
    default :
      break ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_385_4_ (piccolo_lexique & _inLexique,
                                GGS_instruction  &var_cas_outInstruction) {
  GGS_location  var_cas_instructionLocation ;
  var_cas_instructionLocation = GGS_location (_inLexique) ;
