...
pr_structured_instruction_piccolo_syntax_276_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_9 (_inLexique)) {
    ...
    case 6 : {
      ...
      GGS_instruction  var_cas_instruction ;
      nt_simple_instruction_ (_inLexique, var_cas_instruction) ;
      var_cas_outInstruction = GGS_instruction_IF_BitTest_Set ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_registerName, var_cas_instruction, var_cas_bitNumber COMMA_HERE) ;
      } break ;
    case 7 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_if) COMMA_HERE) ;
      ...
      GGS_instruction  var_cas_instruction ;
      nt_simple_instruction_ (_inLexique, var_cas_instruction) ;
      var_cas_outInstruction = GGS_instruction_IF_BitTest_Clear ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_registerName, var_cas_instruction, var_cas_bitNumber COMMA_HERE) ;
      } break ;
    case 8 : {
    ...
    case 11 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (453)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (455)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (457)))._operator_isEqual (GGS_string (true, "n"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnn (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (459)))._operator_isEqual (GGS_string (true, "nn"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bn (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (461)))._operator_isEqual (GGS_string (true, "c"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnc (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (463)))._operator_isEqual (GGS_string (true, "nc"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bc (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (465)))._operator_isEqual (GGS_string (true, "ov"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnov (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (467)))._operator_isEqual (GGS_string (true, "nov"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bov (_inLexique COMMA_HERE) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (473)) ;
      ...
      var_cas_outInstruction = GGS_instruction_structured_if ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_conditional_branch, var_cas_thenInstructionList COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7D) COMMA_HERE) ;
      } break ;
    default :
      break ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_493_4_ (piccolo_lexique & _inLexique,
                                GGS_instruction  &var_cas_outInstruction) {
  GGS_location  var_cas_instructionLocation ;
  var_cas_instructionLocation = GGS_location (_inLexique) ;
  switch (select_piccolo_syntax_16 (_inLexique)) {
    ...
    case 36 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BC ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 37 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BN ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 38 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BNC ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 39 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BNN ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 40 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BNOV ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 41 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BNZ ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 42 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BOV ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 43 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_BZ ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 44 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_bra) COMMA_HERE) ;
      GGS_lstring  var_cas_targetLabelName ;
