...
pr_structured_instruction_piccolo_syntax_667_29_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_27 (_inLexique)) {
    ...
    case 6 : {
      ...
      switch (select_piccolo_syntax_32 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (776)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (776)) ;
          if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (779)) ;
          }
    ...
    case 7 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (801)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (801)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, false) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (808)) ;
    ...
    case 8 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (838)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (838)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, false) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, true) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (845)) ;
    ...
    case 10 : {
      ...
      { bool syntaxRepeat_35 = true ;
        while (syntaxRepeat_35) {
          ...
          switch (select_repeat_piccolo_syntax_35 (_inLexique)) {
            case 2 : {
              } break ;
            default :
...
void piccolo_syntax::
pr_structured_if_instruction_piccolo_syntax_906_32_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_953_25_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction) {
  switch (select_piccolo_syntax_37 (_inLexique)) {
    ...
    case 12 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1165)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1165)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (_inLexique COMMA_HERE) ;
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
        var_cas_conditional_branch._drop () ;
      }
      GGS_lstring  var_cas_targetLabelName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
...
void piccolo_syntax::
pr_immediate_expression_piccolo_syntax_1290_27_ (piccolo_lexique & _inLexique,
  ...
  { bool syntaxRepeat_45 = true ;
    while (syntaxRepeat_45) {
      switch (select_repeat_piccolo_syntax_45 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7C) COMMA_HERE) ;
...
void piccolo_syntax::
pr_immediate_bitwise_term_piccolo_syntax_1308_30_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_bitwise_factor_piccolo_syntax_1321_31_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_term_piccolo_syntax_1359_21_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
  nt_immediate_factor_ (_inLexique, var_cas_outExpression) ;
  { bool syntaxRepeat_48 = true ;
    while (syntaxRepeat_48) {
      switch (select_repeat_piccolo_syntax_48 (_inLexique)) {
        case 2 : {
...
void piccolo_syntax::
pr_immediate_factor_piccolo_syntax_1387_23_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_primary_piccolo_syntax_1411_24_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
  switch (select_piccolo_syntax_50 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
      GGS_immediatExpression  var_cas_expression ;
    ...
    case 4 : {
      ...
      var_cas_outExpression = GGS_immediatInteger ::constructor_new (_inLexique, GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (1427)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1427)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1427)) COMMA_HERE) COMMA_HERE) ;
      } break ;
    case 5 : {
      GGS_lstring  var_cas_registerName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_registerName) ;
