...
void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_114_4_ (piccolo_lexique & _inLexique,
      ...
      switch (select_repeat_piccolo_syntax_1 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_ioAcceptDefaultConfiguration).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "'default' for configuration is already set") COMMA_SOURCE_FILE_AT_LINE (125)) ;
          }
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_145_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_4 (_inLexique)) {
    ...
    case 2 : {
        ...
        while (syntaxRepeat_5) {
            switch (select_piccolo_syntax_6 (_inLexique)) {
              case 1 : {
                ...
                { bool syntaxRepeat_7 = true ;
                  while (syntaxRepeat_7) {
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
                        var_cas_sliceBase = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
                      }
                      ...
                      switch (select_piccolo_syntax_8 (_inLexique)) {
                        case 1 : {
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 1U)))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (174)) ;
                          }
                        ...
                        case 2 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (180))))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (181))))._operator_concat (GGS_string (true, " bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (181)) ;
                          }
                          var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
                          var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (184))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (184)) COMMA_SOURCE_FILE_AT_LINE (184)) ;
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
                          } break ;
                        default :
                          break ;
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)))).isBuiltAndTrue ()) {
                        var_cas_base = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (189))._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (189)) ;
                      }
                      var_cas_bitSliceTable.modifier_insertKey (_inLexique, var_cas_sliceName, var_cas_base, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (191)) ;
                ...
                var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (195)) ;
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
                var_cas_sliceIndex._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (198)) ;
                } break ;
              default :
                break ;
            }
      ...
      if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Incorrect bit definition for register '"))._operator_concat (var_cas_name))._operator_concat (GGS_string (true, "': ")))._operator_concat (GGS_sint (true, 8L)._substract_operation (_inLexique, var_cas_sliceIndex COMMA_SOURCE_FILE_AT_LINE (204)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204))))._operator_concat (GGS_string (true, " bits (s) are defined, instead of 8")) COMMA_SOURCE_FILE_AT_LINE (204)) ;
      }
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_213_4_ (piccolo_lexique & _inLexique,
                                GGS_declarationInRam  &var_cas_outDeclaration) {
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_236_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_255_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_279_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_299_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_15 (_inLexique)) {
    case 1 : {
      ...
      if ((var_cas_noreturn).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A routine declared with 'noreturn' qualifier cannot end with a computed RETLW") COMMA_SOURCE_FILE_AT_LINE (333)) ;
      }
    ...
    case 2 : {
      ...
      if (((var_cas_noreturn)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A routine declared without 'noreturn' qualifier cannot end with a computed BRA") COMMA_SOURCE_FILE_AT_LINE (353)) ;
      }
    ...
    case 3 : {
      ...
      if (((var_cas_noreturn)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "A routine declared without 'noreturn' qualifier cannot end with a computed GOTO") COMMA_SOURCE_FILE_AT_LINE (372)) ;
      }
      GGS_lstringlist  var_cas_argumentList ;
      var_cas_argumentList = GGS_lstringlist ::constructor_emptyList () ;
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_398_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_416_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_431_4_ (piccolo_lexique & _inLexique,
                                GGS_bitNumberExpression  &var_cas_outBitNumber) {
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_438_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_444_4_ (piccolo_lexique & _inLexique,
                                GGS_luint  &var_cas_outLiteralValue) {
  ...
  var_cas_outLiteralValue = GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (446)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (446)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (446)) COMMA_HERE) ;
}
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_451_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_474_4_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_482_4_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
  switch (select_piccolo_syntax_22 (_inLexique)) {
    case 1 : {
      ...
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (501)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (501)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (511)) ;
    ...
    case 3 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (547)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (547)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (557)) ;
    ...
    case 4 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (568)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (568)) ;
      GGS_bool var_cas_branchIfZero ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_branchIfZero = GGS_bool (true, true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
    ...
    case 5 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (584)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (584)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (605)) ;
...
void piccolo_syntax::
pr_condition_expression_piccolo_syntax_613_4_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_term_piccolo_syntax_632_4_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_647_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_28 (_inLexique)) {
    ...
    case 2 : {
      ...
      switch (select_piccolo_syntax_29 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (675)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (675)) ;
          if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (677)) ;
          }
    ...
    case 3 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (699)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (699)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, false) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (705)) ;
    ...
    case 4 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (735)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (735)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, false) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, true) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (741)) ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_834_4_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction) {
  GGS_location  var_cas_instructionLocation ;
  var_cas_instructionLocation = GGS_location (_inLexique) ;
