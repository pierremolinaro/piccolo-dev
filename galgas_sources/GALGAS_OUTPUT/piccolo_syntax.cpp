...
pr_start_symbol_piccolo_syntax_130_19_ (piccolo_lexique & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_pic18) COMMA_HERE) ;
  ...
  inLexique._assignFromAttribute_tokenString (var_cas_deviceNameOrBootloaderReference) ;
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (198)))._operator_concat (GGS_string (".hex")) ;
    if ((var_cas_hexDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (199))).isBuiltAndTrue ()) {
    ...
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (202)))._operator_concat (GGS_string (".asm")) ;
    if ((var_cas_asmDestinationFile.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).isBuiltAndTrue ()) {
...
pr_configuration_definition_piccolo_syntax_256_31_ (piccolo_lexique & inLexique,
  ...
  var_cas_defLocation = GGS_location (inLexique) ;
      ...
      switch (select_repeat_piccolo_syntax_2 (inLexique)) {
        ...
        case 3 : {
          ...
          switch (select_piccolo_syntax_3 (inLexique)) {
            case 1 : {
              inLexique._assignFromAttribute_tokenString (var_cas_settingValue) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
              } break ;
            case 2 : {
              inLexique._assignFromAttribute_tokenString (var_cas_settingValue) ;
...
pr_declaration_in_ram_piccolo_syntax_288_25_ (piccolo_lexique & inLexique,
  ...
  switch (select_piccolo_syntax_4 (inLexique)) {
    ...
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
      inLexique._assignFromAttribute_uint32value (var_cas_size) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
  ...
  switch (select_piccolo_syntax_5 (inLexique)) {
    ...
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3C) COMMA_HERE) ;
      var_cas_bitDefinitionString = GGS_string (" <") ;
              ...
              case 1 : {
                ...
                { bool syntaxRepeat_8 = true ;
                  while (syntaxRepeat_8) {
                      ...
                      switch (select_piccolo_syntax_9 (inLexique)) {
                        case 1 : {
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (1U)))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (321)) ;
                          }
                          var_cas_sliceWidth = GGS_uint (1U) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (323))) ;
                          } break ;
                        case 2 : {
                          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
                          ...
                          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (327))))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (328))))._operator_concat (GGS_string (" bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (329)) ;
                          }
                          var_cas_sliceWidth = var_cas_sliceSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (330)) ;
                          var_cas_sliceBase = var_cas_sliceBase._add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (331))._substract_operation (inLexique, var_cas_sliceSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (332))) ;
                          var_cas_bitDefinitionString.appendCString ("[") ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (332)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (332))) ;
                          var_cas_bitDefinitionString.appendCString ("]") ;
                          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
                          } break ;
                        default :
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (var_cas_sliceWidth.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (336)))).isBuiltAndTrue ()) {
                        var_cas_base = var_cas_sliceIndex.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (337))._substract_operation (inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (337)) ;
                      }
                    ...
                    switch (select_repeat_piccolo_syntax_8 (inLexique)) {
                      case 2 : {
                        inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2F) COMMA_HERE) ;
                        var_cas_bitDefinitionString.appendCString ("/") ;
                        } break ;
                      default :
                ...
                var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (inLexique, var_cas_sliceWidth.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (344)) COMMA_SOURCE_FILE_AT_LINE (344)) ;
                } break ;
              case 2 : {
                inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
                var_cas_bitDefinitionString.appendCString ("-") ;
                var_cas_sliceIndex._decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (348)) ;
                } break ;
              default :
                break ;
            }
      ...
      if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_sint (0L))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("Incorrect bit definition for register '"))._operator_concat (var_cas_name))._operator_concat (GGS_string ("': ")))._operator_concat (GGS_sint (8L)._substract_operation (inLexique, var_cas_sliceIndex COMMA_SOURCE_FILE_AT_LINE (355)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355))))._operator_concat (GGS_string (" bits (s) are defined, instead of 8")) COMMA_SOURCE_FILE_AT_LINE (356)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3E) COMMA_HERE) ;
      var_cas_bitDefinitionString.appendCString (">") ;
      } break ;
    default :
      break ;
...
pr_declaration_in_ram_piccolo_syntax_365_25_ (piccolo_lexique & inLexique,
  ...
  { bool syntaxRepeat_10 = true ;
    while (syntaxRepeat_10) {
        ...
        var_cas_commonBranchList._addAssign_operation (var_cas_declarationInRamList, GGS_location (inLexique)) ;
...
pr_ram_definition_piccolo_syntax_388_21_ (piccolo_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_tokenString (var_cas_bankName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7B) COMMA_HERE) ;
  GGS_declarationInRamList  var_cas_declarationInRamList ;
  var_cas_declarationInRamList = GGS_declarationInRamList ::constructor_emptyList () ;
...
pr_constant_definition_piccolo_syntax_407_26_ (piccolo_lexique & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3D) COMMA_HERE) ;
...
pr_interrupt_definition_piccolo_syntax_444_27_ (piccolo_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_tokenString (var_cas_interruptName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7D) COMMA_HERE) ;
  var_cas_ioInterruptDefinitionList._addAssign_operation (var_cas_interruptName, var_cas_isFast, var_cas_instructionList, GGS_location (inLexique)) ;
}
...
pr_routine_definition_piccolo_syntax_471_25_ (piccolo_lexique & inLexique,
  ...
  nt_instruction_list_ (inLexique, var_cas_instructionList, var_cas_ioNeedsComputedGoto2, var_cas_ioNeedsComputedGoto4) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7D) COMMA_HERE) ;
  var_cas_ioRoutineDefinitionList._addAssign_operation (var_cas_routineName, var_cas_requiredBank, var_cas_returnedBank, var_cas_preservesBank, var_cas_noreturn, var_cas_instructionList, GGS_location (inLexique)) ;
}
...
pr_register_parsing_piccolo_syntax_539_23_ (piccolo_lexique & inLexique,
  ...
  switch (select_piccolo_syntax_19 (inLexique)) {
    ...
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
      inLexique._assignFromAttribute_uint32value (var_cas_offset) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
      } break ;
    default :
...
pr_bit_number_parsing_piccolo_syntax_557_25_ (piccolo_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_tokenString (var_cas_bitNumberLabel) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  ...
  switch (select_piccolo_syntax_20 (inLexique)) {
    ...
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
      inLexique._assignFromAttribute_uint32value (var_cas_bitIndex) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
      } break ;
    default :
...
pr_bit_number_parsing_piccolo_syntax_572_25_ (piccolo_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_uint32value (var_cas_bitNumberLiteral) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
...
pr_condition_factor_piccolo_syntax_610_23_ (piccolo_lexique & inLexique,
  ...
  switch (select_piccolo_syntax_22 (inLexique)) {
    case 1 : {
      ...
      var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (629)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (629)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (640)) ;
    ...
    case 2 : {
      ...
      switch (select_piccolo_syntax_25 (inLexique)) {
        case 1 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__21_3D) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_w) COMMA_HERE) ;
          var_cas_comparison = GGS_registerComparison::constructor_notEqual (inLexique COMMA_HERE) ;
          } break ;
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3D_3D) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_w) COMMA_HERE) ;
          var_cas_comparison = GGS_registerComparison::constructor_equal (inLexique COMMA_HERE) ;
          } break ;
        case 3 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3C_3D) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_w) COMMA_HERE) ;
          var_cas_comparison = GGS_registerComparison::constructor_lowerOrEqual (inLexique COMMA_HERE) ;
          } break ;
        case 4 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3E_3D) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_w) COMMA_HERE) ;
    ...
    case 3 : {
      ...
      switch (select_piccolo_syntax_26 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (679)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (679)) ;
          if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true) ;
            GGS_string var_cas_s ;
            var_cas_s = (GGS_string ("! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (682)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (682))) ;
            if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (683)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (683)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
              var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (684)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (684)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (684))) ;
              var_cas_s.appendCString ("]") ;
            }
            var_cas_s.appendCString (".") ;
            const GGS_bitNumberExpression  _temp_18557 = var_cas_bitNumberExpression ;
            if (_temp_18557.isBuilt ()) {
              _temp_18557 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (686)) ;
            }
            var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (687)) ;
          }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (false) ;
            GGS_string var_cas_s ;
            var_cas_s = var_cas_registerExpression.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (690)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (690)) ;
            if (((var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (691)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (691)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
              var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (692)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (692)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (692))) ;
              var_cas_s.appendCString ("]") ;
            }
            var_cas_s.appendCString (".") ;
            const GGS_bitNumberExpression  _temp_19021 = var_cas_bitNumberExpression ;
            if (_temp_19021.isBuilt ()) {
              _temp_19021 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (694)) ;
            }
            var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (695)) ;
          }else{
            var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (701)) ;
    ...
    case 4 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (712)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (712)) ;
      GGS_bool var_cas_branchIfZero ;
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        var_cas_branchIfZero = GGS_bool (true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (723)) ;
        var_cas_branchIfZero.drop () ;
      }
    ...
    case 5 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (728)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (728)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (750)) ;
    ...
    while (syntaxRepeat_27) {
      switch (select_repeat_piccolo_syntax_27 (inLexique)) {
        case 2 : {
          ...
          var_cas_rc = GGS_negateCondition ::constructor_new (inLexique, var_cas_c COMMA_HERE) ;
          GGS_conditionExpression  var_cas_lc ;
          var_cas_lc = GGS_negateCondition ::constructor_new (inLexique, var_cas_outCondition COMMA_HERE) ;
...
pr_structured_instruction_piccolo_syntax_791_29_ (piccolo_lexique & inLexique,
  ...
  switch (select_piccolo_syntax_29 (inLexique)) {
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_32 = true ;
            while (syntaxRepeat_32) {
                ...
                inLexique._assignFromAttribute_tokenString (var_cas_targetRoutine) ;
                inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
    ...
    case 6 : {
      ...
      switch (select_piccolo_syntax_35 (inLexique)) {
        ...
        case 4 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (916)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (916)) ;
          if (((var_cas_condition)._operator_isNotEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (919)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_piccolo_syntax_37 (inLexique)) {
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
              GGS_string var_cas_condition ;
              var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (951)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (951)) ;
              if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if ! "))._operator_concat (var_cas_registerName.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (954))) ;
                if (((var_cas_registerName.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (955)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (955)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerName.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (956)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (956)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (956))) ;
                  var_cas_s.appendCString ("]") ;
                }
                var_cas_s.appendCString (".") ;
                const GGS_bitNumberExpression  _temp_26940 = var_cas_bitNumber ;
                if (_temp_26940.isBuilt ()) {
                  _temp_26940 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (958)) ;
                }
                var_cas_s.appendCString (" :") ;
                var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (960)) ;
              }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if "))._operator_concat (var_cas_registerName.reader_mRegisterName (inLexique COMMA_SOURCE_FILE_AT_LINE (963))) ;
                if (((var_cas_registerName.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (964)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (964)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerName.reader_mOffset (inLexique COMMA_SOURCE_FILE_AT_LINE (965)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (965)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (965))) ;
                  var_cas_s.appendCString ("]") ;
                }
                var_cas_s.appendCString (".") ;
                const GGS_bitNumberExpression  _temp_27406 = var_cas_bitNumber ;
                if (_temp_27406.isBuilt ()) {
                  _temp_27406 (HERE)->method_display (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (967)) ;
                }
                var_cas_s.appendCString (" :") ;
                var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (969)) ;
              }else{
                var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (972)) ;
    ...
    case 8 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1004)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (1004)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (false) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true) ;
      }else{
        var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
...
pr_simple_instruction_piccolo_syntax_1119_25_ (piccolo_lexique & inLexique,
  ...
  switch (select_piccolo_syntax_42 (inLexique)) {
    ...
    case 12 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)).reader_uppercaseString (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (inLexique COMMA_HERE) ;
        ...
        var_cas_conditionString.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (1353)) ;
        var_cas_conditional_branch.drop () ;
      }
      GGS_lstring  var_cas_targetLabelName ;
      inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
    ...
    case 21 : {
      ...
      inLexique._assignFromAttribute_uint32value (var_cas_FSRindex) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2C) COMMA_HERE) ;
      GGS_immediatExpression  var_cas_expression ;
      nt_immediate_expression_ (inLexique, var_cas_expression) ;
    ...
    case 22 : {
      ...
      switch (select_piccolo_syntax_48 (inLexique)) {
        case 1 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2A) COMMA_HERE) ;
          var_cas_accessOption = GGS_tableAccessOption::constructor_simpleAccess (inLexique COMMA_HERE) ;
          } break ;
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2A_2B) COMMA_HERE) ;
          var_cas_accessOption = GGS_tableAccessOption::constructor_postIncrement (inLexique COMMA_HERE) ;
          } break ;
        case 3 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2A_2D) COMMA_HERE) ;
          var_cas_accessOption = GGS_tableAccessOption::constructor_postDecrement (inLexique COMMA_HERE) ;
          } break ;
        case 4 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2B_2A) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_50 = true ;
    while (syntaxRepeat_50) {
      switch (select_repeat_piccolo_syntax_50 (inLexique)) {
        ...
        case 3 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5E) COMMA_HERE) ;
          GGS_immediatExpression  var_cas_rightExpression ;
          nt_immediate_bitwise_term_ (inLexique, var_cas_rightExpression) ;
  ...
  { bool syntaxRepeat_53 = true ;
    while (syntaxRepeat_53) {
      switch (select_repeat_piccolo_syntax_53 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2B) COMMA_HERE) ;
          GGS_immediatExpression  var_cas_rightExpression ;
        ...
        case 4 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3C_3C) COMMA_HERE) ;
          GGS_immediatExpression  var_cas_rightExpression ;
          nt_immediate_factor_ (inLexique, var_cas_rightExpression) ;
        ...
        case 5 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3E_3E) COMMA_HERE) ;
          GGS_immediatExpression  var_cas_rightExpression ;
          nt_immediate_factor_ (inLexique, var_cas_rightExpression) ;
  ...
  { bool syntaxRepeat_54 = true ;
    while (syntaxRepeat_54) {
      switch (select_repeat_piccolo_syntax_54 (inLexique)) {
        ...
        case 3 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__25) COMMA_HERE) ;
          GGS_immediatExpression  var_cas_rightExpression ;
          nt_immediate_primary_ (inLexique, var_cas_rightExpression) ;
...
pr_immediate_primary_piccolo_syntax_1577_24_ (piccolo_lexique & inLexique,
  ...
  switch (select_piccolo_syntax_55 (inLexique)) {
    ...
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7E) COMMA_HERE) ;
      GGS_immediatExpression  var_cas_expression ;
      nt_immediate_primary_ (inLexique, var_cas_expression) ;
    ...
    case 3 : {
      ...
      inLexique._assignFromAttribute_uint32value (var_cas_constant) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
    ...
    case 4 : {
      ...
      inLexique._assignFromAttribute_charValue (var_cas_literalCharValue) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_literal_5Fchar) COMMA_HERE) ;
    ...
    case 5 : {
      ...
      GGS_registerExpression  var_cas_registerExpression ;
      var_cas_registerExpression = GGS_registerExpression ::constructor_new (inLexique, var_cas_registerName, var_cas_offset COMMA_HERE) ;
    ...
    case 7 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__40) COMMA_HERE) ;
      GGS_lstring  var_cas_registerName ;
      inLexique._assignFromAttribute_tokenString (var_cas_registerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__28) COMMA_HERE) ;
