...
pr_start_symbol_piccolo_syntax_130_19_ (piccolo_lexique & _inLexique) {
  ...
  switch (select_piccolo_syntax_0 (_inLexique)) {
    ...
    case 3 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_uses) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_bootloader) COMMA_HERE) ;
      var_cas_programKind = GGS_programKind::constructor_userProgram (_inLexique COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    ::routine_pic18_analyze (_inLexique,  var_cas_piccoloModel,  GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (196)) ;
  }else{
    GGS_string var_cas_hexDestinationFile ;
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (198)))._operator_concat (GGS_string (".hex")) ;
    if ((var_cas_hexDestinationFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (199))).isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (_inLexique, var_cas_hexDestinationFile COMMA_SOURCE_FILE_AT_LINE (200)) ;
    }
    GGS_string var_cas_asmDestinationFile ;
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)))._operator_concat (GGS_string (".asm")) ;
    if ((var_cas_asmDestinationFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (203))).isBuiltAndTrue ()) {
      GGS_string::class_method_deleteFile (_inLexique, var_cas_asmDestinationFile COMMA_SOURCE_FILE_AT_LINE (204)) ;
    }
  }
}
...
pr_start_symbol_piccolo_syntax_130_19_importBootloaderSpecification (piccolo_lexique & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_programName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  var_cas_programName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("this file does not define a bootloader specification") COMMA_SOURCE_FILE_AT_LINE (225)) ;
...
void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_256_31_ (piccolo_lexique & _inLexique,
  ...
  GGS_location  var_cas_defLocation ;
  var_cas_defLocation = GGS_location (_inLexique) ;
      ...
      switch (select_repeat_piccolo_syntax_2 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_ioAcceptDefaultConfiguration).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("'default' for configuration is already set") COMMA_SOURCE_FILE_AT_LINE (268)) ;
          }
  ...
  var_cas_ioConfigDefinitionList._addAssign_operation (var_cas_defLocation, var_cas_settingList) ;
}

//---------------------------------------------------------------------------*

void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_256_31_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_configuration) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7B) COMMA_HERE) ;
  { bool syntaxRepeat_2 = true ;
    while (syntaxRepeat_2) {
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_288_25_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_4 (_inLexique)) {
    case 1 : {
      var_cas_size = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
  ...
  switch (select_piccolo_syntax_5 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_sliceIndex = GGS_sint (8L) ;
              ...
              case 1 : {
                ...
                { bool syntaxRepeat_8 = true ;
                  while (syntaxRepeat_8) {
                      ...
                      var_cas_sliceBase = GGS_uint (0U) ;
                      if (((var_cas_sliceIndex)._operator_supOrEqual (GGS_sint (0L))).isBuiltAndTrue ()) {
                        var_cas_sliceBase = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)) ;
                      }
                      ...
                      switch (select_piccolo_syntax_9 (_inLexique)) {
                        case 1 : {
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (1U)))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (321)) ;
                          }
                          var_cas_sliceWidth = GGS_uint (1U) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323))) ;
                          } break ;
                        case 2 : {
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (327))))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (328))))._operator_concat (GGS_string (" bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (329)) ;
                          }
                          var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (330)) ;
                          var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (331))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (332))) ;
                          var_cas_bitDefinitionString.appendCString ("[") ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (332)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (332))) ;
                          var_cas_bitDefinitionString.appendCString ("]") ;
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
                          } break ;
                        default :
                      ...
                      var_cas_base = GGS_uint (0U) ;
                      if (((var_cas_sliceIndex)._operator_supOrEqual (var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)))).isBuiltAndTrue ()) {
                        var_cas_base = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (337))._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (337)) ;
                      }
                      var_cas_bitSliceTable.modifier_insertKey (_inLexique, var_cas_sliceName, var_cas_base, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (339)) ;
                ...
                var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (344)) COMMA_SOURCE_FILE_AT_LINE (344)) ;
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
                var_cas_bitDefinitionString.appendCString ("-") ;
                var_cas_sliceIndex._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)) ;
                } break ;
              default :
                break ;
            }
      ...
      if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_sint (0L))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("Incorrect bit definition for register '"))._operator_concat (var_cas_name))._operator_concat (GGS_string ("': ")))._operator_concat (GGS_sint (8L)._substract_operation (_inLexique, var_cas_sliceIndex COMMA_SOURCE_FILE_AT_LINE (355)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355))))._operator_concat (GGS_string (" bits (s) are defined, instead of 8")) COMMA_SOURCE_FILE_AT_LINE (356)) ;
      }
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_288_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_byte) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_4 (_inLexique)) {
    case 1 : {
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_365_25_ (piccolo_lexique & _inLexique,
                                GGS_declarationInRam  &var_cas_outDeclaration) {
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_365_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_common) COMMA_HERE) ;
  { bool syntaxRepeat_10 = true ;
    while (syntaxRepeat_10) {
        { bool syntaxRepeat_11 = true ;
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_388_21_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_388_21_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_ram) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7B) COMMA_HERE) ;
  { bool syntaxRepeat_12 = true ;
...
void piccolo_syntax::
pr_constant_definition_piccolo_syntax_407_26_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_constant_definition_piccolo_syntax_407_26_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_const) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__3D) COMMA_HERE) ;
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_420_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_420_23_parse (piccolo_lexique & _inLexique) {
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
      switch (select_repeat_piccolo_syntax_13 (_inLexique)) {
        case 2 : {
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_444_27_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_444_27_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_interrupt) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_14 (_inLexique)) {
    case 1 : {
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_471_25_ (piccolo_lexique & _inLexique,
      ...
      switch (select_piccolo_syntax_17 (_inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (499)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_piccolo_syntax_18 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (514)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (521)) ;
          }
          var_cas_preservesBank = GGS_bool (false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_471_25_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_15 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_539_23_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_19 (_inLexique)) {
    case 1 : {
      var_cas_offset = GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_539_23_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_19 (_inLexique)) {
    case 1 : {
      } break ;
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_557_25_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_20 (_inLexique)) {
    case 1 : {
      var_cas_bitIndex = GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_557_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  switch (select_piccolo_syntax_20 (_inLexique)) {
    case 1 : {
      } break ;
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_572_25_ (piccolo_lexique & _inLexique,
                                GGS_bitNumberExpression  &var_cas_outBitNumber) {
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_572_25_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
}
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_579_25_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_579_25_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_21 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_591_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_591_23_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__21) COMMA_HERE) ;
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_610_23_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
  switch (select_piccolo_syntax_22 (_inLexique)) {
    case 1 : {
      ...
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (629)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (629)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (640)) ;
    ...
    case 3 : {
      ...
      switch (select_piccolo_syntax_26 (_inLexique)) {
        ...
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (679)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (679)) ;
          if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (true) ;
            GGS_string var_cas_s ;
            var_cas_s = (GGS_string ("! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (682)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (682))) ;
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (683)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (683)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
            ...
            var_cas_s.appendCString (".") ;
            const GGS_bitNumberExpression  _temp_18557 = var_cas_bitNumberExpression ;
            if (_temp_18557.isBuilt ()) {
              _temp_18557 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (686)) ;
            }
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (687)) ;
          }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
            var_cas_BTFSSinstruction = GGS_bool (false) ;
            GGS_string var_cas_s ;
            var_cas_s = var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (690)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (690)) ;
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (691)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (691)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
              var_cas_s.appendCString (" [") ;
              var_cas_s._dotAssign_operation (var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (692)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (692)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (692))) ;
              var_cas_s.appendCString ("]") ;
            }
            var_cas_s.appendCString (".") ;
            const GGS_bitNumberExpression  _temp_19021 = var_cas_bitNumberExpression ;
            if (_temp_19021.isBuilt ()) {
              _temp_19021 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (694)) ;
            }
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (695)) ;
          }else{
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (701)) ;
    ...
    case 4 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (723)) ;
        var_cas_branchIfZero.drop () ;
      }
    ...
    case 5 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (728)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (728)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
      ...
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NN"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnn (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("N"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bn (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("C"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bc (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NC"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnc (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("OV"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bov (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NOV"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnov (_inLexique COMMA_HERE) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (750)) ;
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_610_23_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_22 (_inLexique)) {
    case 1 : {
      switch (select_piccolo_syntax_23 (_inLexique)) {
        case 1 : {
...
void piccolo_syntax::
pr_condition_expression_piccolo_syntax_757_27_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_expression_piccolo_syntax_757_27_parse (piccolo_lexique & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__28) COMMA_HERE) ;
...
void piccolo_syntax::
pr_condition_term_piccolo_syntax_776_21_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_term_piccolo_syntax_776_21_parse (piccolo_lexique & _inLexique) {
  nt_condition_factor_parse (_inLexique) ;
  { bool syntaxRepeat_28 = true ;
    while (syntaxRepeat_28) {
      switch (select_repeat_piccolo_syntax_28 (_inLexique)) {
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_791_29_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_29 (_inLexique)) {
    ...
    case 4 : {
      ...
      switch (select_piccolo_syntax_30 (_inLexique)) {
        case 1 : {
          ...
          var_cas_outInstruction = GGS_instruction_computed_retlw ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_sizeExpression, var_cas_argumentList, GGS_bool (true) COMMA_HERE) ;
        ...
        case 2 : {
          ...
          var_cas_outInstruction = GGS_instruction_computed_bra ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_sizeExpression, var_cas_argumentList, GGS_bool (true) COMMA_HERE) ;
          var_cas_ioNeedsComputedGoto2 = GGS_bool (true) ;
          } break ;
        case 3 : {
          ...
          var_cas_outInstruction = GGS_instruction_computed_goto ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_sizeExpression, var_cas_argumentList, GGS_bool (true) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          var_cas_outInstruction = GGS_instruction_computed_rcall ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_sizeExpression, var_cas_argumentList, GGS_bool (true) COMMA_HERE) ;
          var_cas_ioNeedsComputedGoto4 = GGS_bool (true) ;
          } break ;
        default :
          break ;
    ...
    case 6 : {
      ...
      switch (select_piccolo_syntax_35 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (916)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (916)) ;
          if (((var_cas_condition)._operator_isNotEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (919)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_piccolo_syntax_37 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
              GGS_string var_cas_condition ;
              var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (951)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (951)) ;
              if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if ! "))._operator_concat (var_cas_registerName.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (954))) ;
                if (((var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (955)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (955)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (956))) ;
                  var_cas_s.appendCString ("]") ;
                }
                var_cas_s.appendCString (".") ;
                const GGS_bitNumberExpression  _temp_26940 = var_cas_bitNumber ;
                if (_temp_26940.isBuilt ()) {
                  _temp_26940 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (958)) ;
                }
                var_cas_s.appendCString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (960)) ;
              }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string ("if "))._operator_concat (var_cas_registerName.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (963))) ;
                if (((var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (964)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (964)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_s.appendCString (" [") ;
                  var_cas_s._dotAssign_operation (var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (965)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (965)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (965))) ;
                  var_cas_s.appendCString ("]") ;
                }
                var_cas_s.appendCString (".") ;
                const GGS_bitNumberExpression  _temp_27406 = var_cas_bitNumber ;
                if (_temp_27406.isBuilt ()) {
                  _temp_27406 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (967)) ;
                }
                var_cas_s.appendCString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string ("' instead")) COMMA_SOURCE_FILE_AT_LINE (969)) ;
              }else{
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (972)) ;
    ...
    case 8 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1004)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1004)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (false) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string ("' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_791_29_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_29 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_banksel) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
...
void piccolo_syntax::
pr_structured_if_instruction_piccolo_syntax_1072_32_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void piccolo_syntax::
pr_structured_if_instruction_piccolo_syntax_1072_32_parse (piccolo_lexique & _inLexique) {
  nt_condition_expression_parse (_inLexique) ;
  nt_instruction_list_parse (_inLexique) ;
  switch (select_piccolo_syntax_41 (_inLexique)) {
    case 1 : {
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_1119_25_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction) {
  switch (select_piccolo_syntax_42 (_inLexique)) {
    ...
    case 11 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_JUMPCC ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName, var_cas_condition, GGS_bool (true) COMMA_HERE) ;
      } break ;
    case 12 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_jump) COMMA_HERE) ;
      GGS_location  var_cas_instructionLocation ;
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1331)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1331)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string ("Z"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string ("NZ"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (_inLexique COMMA_HERE) ;
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string ("' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (1353)) ;
        var_cas_conditional_branch.drop () ;
      }
      GGS_lstring  var_cas_targetLabelName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_instruction_JUMPCC ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_targetLabelName, var_cas_conditional_branch, GGS_bool (false) COMMA_HERE) ;
      } break ;
    case 13 : {
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_1119_25_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_42 (_inLexique)) {
    case 1 : {
      switch (select_piccolo_syntax_43 (_inLexique)) {
        case 1 : {
...
void piccolo_syntax::
pr_immediate_expression_piccolo_syntax_1456_27_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_immediate_expression_piccolo_syntax_1456_27_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_bitwise_term_piccolo_syntax_1474_30_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_bitwise_term_piccolo_syntax_1474_30_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_bitwise_factor_piccolo_syntax_1487_31_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_bitwise_factor_piccolo_syntax_1487_31_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_term_piccolo_syntax_1525_21_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_term_piccolo_syntax_1525_21_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_factor_piccolo_syntax_1553_23_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_factor_piccolo_syntax_1553_23_parse (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_immediate_primary_piccolo_syntax_1577_24_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
  switch (select_piccolo_syntax_55 (_inLexique)) {
    ...
    case 4 : {
      ...
      var_cas_outExpression = GGS_immediatInteger ::constructor_new (_inLexique, GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (1593)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1593)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1593)) COMMA_HERE) COMMA_HERE) ;
      } break ;
    case 5 : {
      GGS_lstring  var_cas_registerName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_registerName) ;
...
void piccolo_syntax::
pr_immediate_primary_piccolo_syntax_1577_24_parse (piccolo_lexique & _inLexique) {
  switch (select_piccolo_syntax_55 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
      nt_immediate_primary_parse (_inLexique) ;
