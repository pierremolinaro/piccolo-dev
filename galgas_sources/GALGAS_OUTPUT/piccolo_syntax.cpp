...
pr_start_symbol_piccolo_syntax_130_19_ (piccolo_lexique & _inLexique) {
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_hexDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (198)))._operator_concat (GGS_string (true, ".hex")) ;
    ...
    var_cas_asmDestinationFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)))._operator_concat (GGS_string (true, ".asm")) ;
...
pr_start_symbol_piccolo_syntax_130_19_importBootloaderSpecification (piccolo_lexique & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_programName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
  var_cas_programName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this file does not define a bootloader specification") COMMA_SOURCE_FILE_AT_LINE (225)) ;
      ...
      switch (select_repeat_piccolo_syntax_2 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_ioAcceptDefaultConfiguration).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "'default' for configuration is already set") COMMA_SOURCE_FILE_AT_LINE (268)) ;
          }
  ...
  switch (select_piccolo_syntax_5 (_inLexique)) {
    ...
    case 2 : {
                      ...
                      switch (select_piccolo_syntax_9 (_inLexique)) {
                        case 1 : {
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 1U)))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (321)) ;
                          }
                        ...
                        case 2 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (327))))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (328))))._operator_concat (GGS_string (true, " bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (329)) ;
                          }
                          var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (330)) ;
                          var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (331))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
      ...
      if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Incorrect bit definition for register '"))._operator_concat (var_cas_name))._operator_concat (GGS_string (true, "': ")))._operator_concat (GGS_sint (true, 8L)._substract_operation (_inLexique, var_cas_sliceIndex COMMA_SOURCE_FILE_AT_LINE (355)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355))))._operator_concat (GGS_string (true, " bits (s) are defined, instead of 8")) COMMA_SOURCE_FILE_AT_LINE (356)) ;
      }
      ...
      switch (select_piccolo_syntax_17 (_inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (499)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_piccolo_syntax_18 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (514)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (521)) ;
          }
          var_cas_preservesBank = GGS_bool (true, false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
  ...
  switch (select_piccolo_syntax_22 (_inLexique)) {
    case 1 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (640)) ;
      ...
      switch (select_piccolo_syntax_26 (_inLexique)) {
        ...
        case 2 : {
          ...
          if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
            ...
            var_cas_s = (GGS_string (true, "! "))._operator_concat (var_cas_registerExpression.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (682)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (682))) ;
            ...
            if (((var_cas_registerExpression.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (691)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (691)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
              var_cas_s.writeString (" [") ;
            ...
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (695)) ;
          }else{
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (701)) ;
    ...
    case 4 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (723)) ;
        var_cas_branchIfZero._drop () ;
      }
    ...
    case 5 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (750)) ;
  ...
  switch (select_piccolo_syntax_29 (_inLexique)) {
      ...
      switch (select_piccolo_syntax_35 (_inLexique)) {
        ...
        case 4 : {
          ...
          if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (919)) ;
          }
          ...
          switch (select_piccolo_syntax_37 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true, true) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string (true, "if ! "))._operator_concat (var_cas_registerName.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (954))) ;
                if (((var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (955)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (955)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                  var_cas_s.writeString (" [") ;
                ...
                if (_temp_26940._isBuilt ()) {
                  _temp_26940 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (958)) ;
                }
                var_cas_s.writeString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (960)) ;
              }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
                var_cas_skipIfSet = GGS_bool (true, false) ;
                GGS_string var_cas_s ;
                var_cas_s = (GGS_string (true, "if "))._operator_concat (var_cas_registerName.reader_mRegisterName (_inLexique COMMA_SOURCE_FILE_AT_LINE (963))) ;
                if (((var_cas_registerName.reader_mOffset (_inLexique COMMA_SOURCE_FILE_AT_LINE (964)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (964)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                  var_cas_s.writeString (" [") ;
                ...
                if (_temp_27406._isBuilt ()) {
                  _temp_27406 (HERE)->method_display (_inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (967)) ;
                }
                var_cas_s.writeString (" :") ;
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "In Piccolo 1.2.0 and later, this construction is deprecated; use '"))._operator_concat (var_cas_s))._operator_concat (GGS_string (true, "' instead")) COMMA_SOURCE_FILE_AT_LINE (969)) ;
              }else{
                var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (972)) ;
    ...
    case 8 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
  ...
  switch (select_piccolo_syntax_42 (_inLexique)) {
    ...
    case 12 : {
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (1353)) ;
        var_cas_conditional_branch._drop () ;
      }
      GGS_lstring  var_cas_targetLabelName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
