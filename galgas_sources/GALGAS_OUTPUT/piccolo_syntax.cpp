...
pr_structured_instruction_piccolo_syntax_465_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_15 (_inLexique)) {
    ...
    case 8 : {
      ...
      GGS_elsifPartList  var_cas_elsifPartList ;
      var_cas_elsifPartList = GGS_elsifPartList ::constructor_emptyList () ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_706_4_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction) {
  GGS_location  var_cas_instructionLocation ;
  var_cas_instructionLocation = GGS_location (_inLexique) ;
