...
void piccolo_syntax::
pr_start_symbol_piccolo_syntax_82_19_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_131_31_ (piccolo_lexique & _inLexique,
      ...
      switch (select_repeat_piccolo_syntax_1 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_ioAcceptDefaultConfiguration).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "'default' for configuration is already set") COMMA_SOURCE_FILE_AT_LINE (142)) ;
          }
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_162_25_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_4 (_inLexique)) {
    ...
    case 2 : {
        ...
        while (syntaxRepeat_5) {
            switch (select_piccolo_syntax_6 (_inLexique)) {
              case 1 : {
                ...
                { bool syntaxRepeat_7 = true ;
                  while (syntaxRepeat_7) {
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
                        var_cas_sliceBase = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
                      }
                      ...
                      switch (select_piccolo_syntax_8 (_inLexique)) {
                        case 1 : {
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 1U)))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a slice of 1 bit is expected for '"))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (195)) ;
                          }
                          var_cas_sliceWidth = GGS_uint (true, 1U) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (197))) ;
                          } break ;
                        case 2 : {
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5B) COMMA_HERE) ;
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
                          if ((((var_cas_sliceWidth)._operator_isNotEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_sliceWidth)._operator_isNotEqual (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (201))))).isBuiltAndTrue ()) {
                            var_cas_sliceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "a slice of "))._operator_concat (var_cas_sliceWidth.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (202))))._operator_concat (GGS_string (true, " bits is expected for '")))._operator_concat (var_cas_sliceName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (203)) ;
                          }
                          var_cas_sliceWidth = var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)) ;
                          var_cas_sliceBase = var_cas_sliceBase._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (205))._substract_operation (_inLexique, var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)) ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
                          var_cas_bitDefinitionString.writeString ("[") ;
                          var_cas_bitDefinitionString._dotAssign_operation (var_cas_sliceSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
                          var_cas_bitDefinitionString.writeString ("]") ;
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__5D) COMMA_HERE) ;
                          } break ;
                        default :
                      ...
                      if (((var_cas_sliceIndex)._operator_supOrEqual (var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)))).isBuiltAndTrue ()) {
                        var_cas_base = var_cas_sliceIndex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (211))._substract_operation (_inLexique, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (211)) ;
                      }
                      var_cas_bitSliceTable.modifier_insertKey (_inLexique, var_cas_sliceName, var_cas_base, var_cas_sliceWidth COMMA_SOURCE_FILE_AT_LINE (213)) ;
                ...
                var_cas_sliceIndex = var_cas_sliceIndex._substract_operation (_inLexique, var_cas_sliceWidth.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (218)) COMMA_SOURCE_FILE_AT_LINE (218)) ;
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2D) COMMA_HERE) ;
                var_cas_bitDefinitionString.writeString ("-") ;
                var_cas_sliceIndex._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
                } break ;
              default :
                break ;
            }
      ...
      if (((var_cas_sliceIndex)._operator_isNotEqual (GGS_sint (true, 0L))).isBuiltAndTrue ()) {
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "Incorrect bit definition for register '"))._operator_concat (var_cas_name))._operator_concat (GGS_string (true, "': ")))._operator_concat (GGS_sint (true, 8L)._substract_operation (_inLexique, var_cas_sliceIndex COMMA_SOURCE_FILE_AT_LINE (229)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229))))._operator_concat (GGS_string (true, " bits (s) are defined, instead of 8")) COMMA_SOURCE_FILE_AT_LINE (230)) ;
      }
...
void piccolo_syntax::
pr_declaration_in_ram_piccolo_syntax_239_25_ (piccolo_lexique & _inLexique,
                                GGS_declarationInRam  &var_cas_outDeclaration) {
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_262_21_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_281_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_305_27_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_332_25_ (piccolo_lexique & _inLexique,
      ...
      switch (select_piccolo_syntax_16 (_inLexique)) {
        case 1 : {
          ...
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:preserved\" setting") COMMA_SOURCE_FILE_AT_LINE (360)) ;
          }
        ...
        case 2 : {
          ...
          switch (select_piccolo_syntax_17 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
              if ((var_cas_noreturn).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (375)) ;
              }
              } break ;
            default :
              break ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_integer) COMMA_HERE) ;
          if ((var_cas_noreturn).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine cannot accept \"bank:returned\" setting") COMMA_SOURCE_FILE_AT_LINE (382)) ;
          }
          var_cas_preservesBank = GGS_bool (true, false) ;
          var_cas_requiredBank = GGS_luint ::constructor_new (_inLexique, GGS_uint ::constructor_max (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_400_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_418_25_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_433_25_ (piccolo_lexique & _inLexique,
                                GGS_bitNumberExpression  &var_cas_outBitNumber) {
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_440_25_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_452_23_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_463_23_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_factor_piccolo_syntax_471_23_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
  switch (select_piccolo_syntax_21 (_inLexique)) {
    case 1 : {
      ...
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (490)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (490)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (501)) ;
    ...
    case 3 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (536)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (536)) ;
      ...
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (547)) ;
    ...
    case 5 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (573)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (573)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (595)) ;
...
void piccolo_syntax::
pr_condition_expression_piccolo_syntax_602_27_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_condition_term_piccolo_syntax_621_21_ (piccolo_lexique & _inLexique,
                                GGS_conditionExpression  &var_cas_outCondition) {
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_636_29_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_27 (_inLexique)) {
    ...
    case 6 : {
      ...
      switch (select_piccolo_syntax_32 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          GGS_string var_cas_condition ;
          var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (745)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (745)) ;
          if (((var_cas_condition)._operator_isNotEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
            var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (748)) ;
          }
    ...
    case 7 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (770)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (770)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, true) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, false) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (777)) ;
    ...
    case 8 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (807)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (807)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, false) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, true) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (814)) ;
...
void piccolo_syntax::
pr_structured_if_instruction_piccolo_syntax_875_32_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction,
                                GGS_bool &var_cas_ioNeedsComputedGoto2,
                                GGS_bool &var_cas_ioNeedsComputedGoto4) {
  GGS_location  var_cas_instructionLocation ;
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_922_25_ (piccolo_lexique & _inLexique,
                                GGS_piccolo_instruction  &var_cas_outInstruction) {
  switch (select_piccolo_syntax_37 (_inLexique)) {
    ...
    case 12 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      GGS_string var_cas_condition ;
      var_cas_condition = var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1134)).reader_uppercaseString (_inLexique COMMA_SOURCE_FILE_AT_LINE (1134)) ;
      if (((var_cas_condition)._operator_isEqual (GGS_string (true, "Z"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_condition)._operator_isEqual (GGS_string (true, "NZ"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (_inLexique COMMA_HERE) ;
        ...
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (1156)) ;
        var_cas_conditional_branch._drop () ;
      }
      GGS_lstring  var_cas_targetLabelName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
...
void piccolo_syntax::
pr_immediate_expression_piccolo_syntax_1259_27_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_immediate_bitwise_term_piccolo_syntax_1277_30_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_bitwise_factor_piccolo_syntax_1290_31_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_term_piccolo_syntax_1328_21_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_factor_piccolo_syntax_1356_23_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
...
void piccolo_syntax::
pr_immediate_primary_piccolo_syntax_1380_24_ (piccolo_lexique & _inLexique,
                                GGS_immediatExpression  &var_cas_outExpression) {
  switch (select_piccolo_syntax_50 (_inLexique)) {
    ...
    case 4 : {
      ...
      var_cas_outExpression = GGS_immediatInteger ::constructor_new (_inLexique, GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (1396)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1396)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1396)) COMMA_HERE) COMMA_HERE) ;
      } break ;
    case 5 : {
      GGS_lstring  var_cas_registerName ;
      _inLexique._assignFromAttribute_tokenString (var_cas_registerName) ;
