...
void piccolo_syntax::
pr_start_symbol_piccolo_syntax_56_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_configuration_definition_piccolo_syntax_100_4_ (piccolo_lexique & _inLexique) {
...
void piccolo_syntax::
pr_ram_definition_piccolo_syntax_108_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_instruction_list_piccolo_syntax_135_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_interrupt_definition_piccolo_syntax_159_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_routine_definition_piccolo_syntax_179_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_register_parsing_piccolo_syntax_213_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_231_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_bit_number_parsing_piccolo_syntax_246_4_ (piccolo_lexique & _inLexique,
                                GGS_bitNumberExpression  &var_cas_outBitNumber) {
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_253_4_ (piccolo_lexique & _inLexique,
...
void piccolo_syntax::
pr_literal_value_parsing_piccolo_syntax_259_4_ (piccolo_lexique & _inLexique,
                                GGS_luint  &var_cas_outLiteralValue) {
  ...
  var_cas_outLiteralValue = GGS_luint ::constructor_new (_inLexique, var_cas_literalCharValue.reader_char (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)).reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)), var_cas_literalCharValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)) COMMA_HERE) ;
}
...
void piccolo_syntax::
pr_optional_w_as_dest_piccolo_syntax_266_4_ (piccolo_lexique & _inLexique,
...
//---------------------------------------------------------------------------*
//                                                                           *
//              Implementation of production rule 'condition'                *
//                                                                           *
//---------------------------------------------------------------------------*

void piccolo_syntax::
pr_condition_piccolo_syntax_278_4_ (piccolo_lexique & _inLexique,
                                GGS_structured_if_condition  &var_cas_outCondition,
                                const GGS_bool var_cas_inComplement) {
  ...
  switch (select_piccolo_syntax_9 (_inLexique)) {
    case 1 : {
      ...
      if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (291)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
        var_cas_BTFSSinstruction = var_cas_inComplement ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
        var_cas_BTFSSinstruction = (var_cas_inComplement)._operator_not () ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z' and 'nz'")) COMMA_SOURCE_FILE_AT_LINE (299)) ;
    ...
    case 2 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_conditionString) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (309)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (311)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bz (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (313)))._operator_isEqual (GGS_string (true, "n"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnn (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)))._operator_isEqual (GGS_string (true, "nn"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bn (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (317)))._operator_isEqual (GGS_string (true, "c"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnc (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (319)))._operator_isEqual (GGS_string (true, "nc"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bc (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (321)))._operator_isEqual (GGS_string (true, "ov"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bnov (_inLexique COMMA_HERE) ;
      }else if (((var_cas_conditionString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)))._operator_isEqual (GGS_string (true, "nov"))).isBuiltAndTrue ()) {
        var_cas_conditional_branch = GGS_conditional_branch::constructor_bov (_inLexique COMMA_HERE) ;
      }else{
        var_cas_conditionString.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_conditionString))._operator_concat (GGS_string (true, "' condition; valid ones are: 'z', 'nz', 'n', 'nn', 'c', 'nc', 'ov' and 'nov'")) COMMA_SOURCE_FILE_AT_LINE (329)) ;
        var_cas_conditional_branch._drop () ;
      }
      if ((var_cas_inComplement).isBuiltAndTrue ()) {
        GGS_conditional_branch var_cas_complementaryCondition ;
        ::routine_getComplementaryBcc (_inLexique,  var_cas_conditional_branch,  var_cas_complementaryCondition COMMA_SOURCE_FILE_AT_LINE (332)) ;
        var_cas_outCondition = GGS_bcc_in_structured_if_condition ::constructor_new (_inLexique, var_cas_complementaryCondition COMMA_HERE) ;
      }else{
...
void piccolo_syntax::
pr_structured_instruction_piccolo_syntax_344_4_ (piccolo_lexique & _inLexique,
  ...
  switch (select_piccolo_syntax_10 (_inLexique)) {
    ...
    case 2 : {
      ...
      switch (select_piccolo_syntax_11 (_inLexique)) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
          if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (373)))._operator_isNotEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
            var_cas_condition.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'nz'")) COMMA_SOURCE_FILE_AT_LINE (374)) ;
          }
    ...
    case 3 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_condition) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (396)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, true) ;
      }else if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (398)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
        var_cas_skipIfSet = GGS_bool (true, false) ;
      }else{
        var_cas_condition.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (401)) ;
    ...
    case 4 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_condition) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (431)))._operator_isEqual (GGS_string (true, "z"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, false) ;
      }else if (((var_cas_condition.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (433)))._operator_isEqual (GGS_string (true, "nz"))).isBuiltAndTrue ()) {
        var_cas_skipIfZero = GGS_bool (true, true) ;
      }else{
        var_cas_condition.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "invalid '"))._operator_concat (var_cas_condition))._operator_concat (GGS_string (true, "' condition; it should be 'z' or 'nz'")) COMMA_SOURCE_FILE_AT_LINE (436)) ;
    ...
    case 6 : {
      ...
      { bool syntaxRepeat_17 = true ;
        while (syntaxRepeat_17) {
          ...
          switch (select_repeat_piccolo_syntax_17 (_inLexique)) {
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2C) COMMA_HERE) ;
              } break ;
            default :
    ...
    case 7 : {
      ...
      { bool syntaxRepeat_19 = true ;
        while (syntaxRepeat_19) {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
            var_cas_argumentList._addAssign_operation (var_cas_targetRoutine) ;
          switch (select_repeat_piccolo_syntax_19 (_inLexique)) {
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__2C) COMMA_HERE) ;
              } break ;
            default :
    ...
    case 8 : {
      ...
      nt_condition_ (_inLexique, var_cas_structured_if_condition, GGS_bool (true, false)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1__7B) COMMA_HERE) ;
    ...
    case 9 : {
      ...
      GGS_structured_if_condition  var_cas_whileCondition ;
      nt_condition_ (_inLexique, var_cas_whileCondition, GGS_bool (true, true)) ;
      var_cas_outInstruction = GGS_instruction_do_while ::constructor_new (_inLexique, var_cas_instructionLocation, var_cas_whileCondition, var_cas_repeatedInstructionList COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
void piccolo_syntax::
pr_simple_instruction_piccolo_syntax_571_4_ (piccolo_lexique & _inLexique,
                                GGS_instruction  &var_cas_outInstruction) {
  GGS_location  var_cas_instructionLocation ;
  var_cas_instructionLocation = GGS_location (_inLexique) ;
  switch (select_piccolo_syntax_21 (_inLexique)) {
    ...
    case 21 : {
      ...
      _inLexique._assignFromAttribute_tokenString (var_cas_targetLabelName) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (piccolo_lexique::piccolo_lexique_1_identifier) COMMA_HERE) ;
      var_cas_outInstruction = GGS_pseudo_LABEL ::constructor_new (_inLexique, var_cas_targetLabelName COMMA_HERE) ;
      } break ;
    case 22 : {
