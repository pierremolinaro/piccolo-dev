...
class piccolo_syntax {
  ...
  protected : void pr_start_symbol_piccolo_syntax_40_4_ (piccolo_lexique &,
                                GGS_piccoloModel &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_0 (piccolo_lexique &) = 0 ;

  protected : void pr_configuration_definition_piccolo_syntax_72_4_ (piccolo_lexique &) ;

  protected : void pr_ram_definition_piccolo_syntax_80_4_ (piccolo_lexique &,
  ...
  protected : void pr_instruction_list_piccolo_syntax_107_4_ (piccolo_lexique &,
                                GGS_instructionList  &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_3 (piccolo_lexique &) = 0 ;

  protected : void pr_interrupt_definition_piccolo_syntax_125_4_ (piccolo_lexique &,
                                GGS_interruptDefinitionList  &) ;

  protected : void pr_routine_definition_piccolo_syntax_139_4_ (piccolo_lexique &,
  ...
  protected : void pr_register_parsing_piccolo_syntax_167_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_6 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_185_4_ (piccolo_lexique &,
  ...
  protected : void pr_literal_value_parsing_piccolo_syntax_207_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_213_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_220_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_8 (piccolo_lexique &) = 0 ;

  protected : void pr_structured_instruction_piccolo_syntax_232_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;

  protected : virtual sint16 select_piccolo_syntax_9 (piccolo_lexique &) = 0 ;

  protected : void pr_simple_instruction_piccolo_syntax_336_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;
