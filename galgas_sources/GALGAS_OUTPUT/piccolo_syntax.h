...
class piccolo_syntax {
  ...
  protected : void pr_start_symbol_piccolo_syntax_50_4_ (piccolo_lexique &,
                                GGS_piccoloModel &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_0 (piccolo_lexique &) = 0 ;

  protected : void pr_configuration_definition_piccolo_syntax_84_4_ (piccolo_lexique &) ;

  protected : void pr_ram_definition_piccolo_syntax_92_4_ (piccolo_lexique &,
  ...
  protected : void pr_instruction_list_piccolo_syntax_119_4_ (piccolo_lexique &,
                                GGS_instructionList  &,
                                GGS_bool &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_3 (piccolo_lexique &) = 0 ;

  protected : void pr_interrupt_definition_piccolo_syntax_138_4_ (piccolo_lexique &,
                                GGS_interruptDefinitionList  &,
                                GGS_bool &) ;

  protected : void pr_routine_definition_piccolo_syntax_153_4_ (piccolo_lexique &,
                                GGS_routineDefinitionList  &,
                                GGS_bool &) ;
  ...
  protected : void pr_register_parsing_piccolo_syntax_182_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_6 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_200_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_7 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_215_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_222_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_228_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_235_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_8 (piccolo_lexique &) = 0 ;

  protected : void pr_structured_instruction_piccolo_syntax_247_4_ (piccolo_lexique &,
                                GGS_instruction  &,
                                GGS_bool &) ;
  ...
  protected : void pr_simple_instruction_piccolo_syntax_385_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;
