...
class piccolo_syntax {
  ...
  protected : void pr_start_symbol_piccolo_syntax_55_4_ (piccolo_lexique &,
                                GGS_piccoloModel &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_0 (piccolo_lexique &) = 0 ;

  protected : void pr_configuration_definition_piccolo_syntax_99_4_ (piccolo_lexique &) ;

  protected : void pr_ram_definition_piccolo_syntax_107_4_ (piccolo_lexique &,
  ...
  protected : void pr_instruction_list_piccolo_syntax_134_4_ (piccolo_lexique &,
                                GGS_instructionList  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_interrupt_definition_piccolo_syntax_158_4_ (piccolo_lexique &,
                                GGS_interruptDefinitionList  &,
                                GGS_bool &,
                                GGS_bool &) ;

  protected : void pr_routine_definition_piccolo_syntax_178_4_ (piccolo_lexique &,
                                GGS_routineDefinitionList  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_register_parsing_piccolo_syntax_212_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_6 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_230_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_7 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_245_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_252_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_258_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_265_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_8 (piccolo_lexique &) = 0 ;

  protected : void pr_condition_piccolo_syntax_277_4_ (piccolo_lexique &,
  ...
  protected : void pr_structured_instruction_piccolo_syntax_410_4_ (piccolo_lexique &,
                                GGS_piccolo_instruction  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_simple_instruction_piccolo_syntax_636_4_ (piccolo_lexique &,
                                GGS_piccolo_instruction  &) ;
