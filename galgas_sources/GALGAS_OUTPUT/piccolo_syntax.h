...
class piccolo_syntax {
  ...
  protected : void pr_structured_instruction_piccolo_syntax_376_4_ (piccolo_lexique &,
                                GGS_piccolo_instruction  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_simple_instruction_piccolo_syntax_602_4_ (piccolo_lexique &,
                                GGS_piccolo_instruction  &) ;
