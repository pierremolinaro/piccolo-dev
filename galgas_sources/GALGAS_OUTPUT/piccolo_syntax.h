...
class piccolo_syntax {
  ...
  protected : void pr_register_parsing_piccolo_syntax_139_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_5 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_157_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_bit_number_parsing_piccolo_syntax_164_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_171_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_177_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_184_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_6 (piccolo_lexique &) = 0 ;

  protected : void pr_instruction_piccolo_syntax_196_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;
