...
class piccolo_syntax {
  ...
  protected : void pr_structured_instruction_piccolo_syntax_356_4_ (piccolo_lexique &,
                                GGS_instruction  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_simple_instruction_piccolo_syntax_582_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;
