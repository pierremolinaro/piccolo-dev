...
class piccolo_syntax {
  ...
  protected : virtual void nt_instruction_ (piccolo_lexique &,
                                GGS_instruction  &) = 0 ;
  ...
  protected : void pr_start_symbol_piccolo_syntax_36_4_ (piccolo_lexique &,
                                GGS_piccoloModel &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_0 (piccolo_lexique &) = 0 ;

  protected : void pr_configuration_definition_piccolo_syntax_68_4_ (piccolo_lexique &) ;

  protected : void pr_ram_definition_piccolo_syntax_76_4_ (piccolo_lexique &,
  ...
  protected : void pr_interrupt_definition_piccolo_syntax_100_4_ (piccolo_lexique &,
                                GGS_interruptDefinitionList  &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_3 (piccolo_lexique &) = 0 ;

  protected : void pr_routine_definition_piccolo_syntax_118_4_ (piccolo_lexique &,
  ...
  protected : void pr_register_parsing_piccolo_syntax_144_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_6 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_162_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_bit_number_parsing_piccolo_syntax_169_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_176_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_182_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_189_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_7 (piccolo_lexique &) = 0 ;

  protected : void pr_instruction_piccolo_syntax_201_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;
