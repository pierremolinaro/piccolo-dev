...
class piccolo_syntax {
  ...
  protected : void pr_start_symbol_piccolo_syntax_59_4_ (piccolo_lexique &,
                                GGS_piccoloModel &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_0 (piccolo_lexique &) = 0 ;

  protected : void pr_configuration_definition_piccolo_syntax_103_4_ (piccolo_lexique &) ;

  protected : void pr_ram_definition_piccolo_syntax_111_4_ (piccolo_lexique &,
  ...
  protected : void pr_instruction_list_piccolo_syntax_138_4_ (piccolo_lexique &,
                                GGS_instructionList  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_interrupt_definition_piccolo_syntax_162_4_ (piccolo_lexique &,
                                GGS_interruptDefinitionList  &,
                                GGS_bool &,
                                GGS_bool &) ;

  protected : void pr_routine_definition_piccolo_syntax_182_4_ (piccolo_lexique &,
                                GGS_routineDefinitionList  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_register_parsing_piccolo_syntax_216_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_6 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_234_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_7 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_249_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_256_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_262_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_269_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_8 (piccolo_lexique &) = 0 ;

  protected : void pr_condition_factor_piccolo_syntax_281_4_ (piccolo_lexique &,
                                GGS_conditionExpression  &) ;

  protected : void pr_condition_factor_piccolo_syntax_292_4_ (piccolo_lexique &,
                                GGS_conditionExpression  &) ;

  protected : void pr_condition_factor_piccolo_syntax_300_4_ (piccolo_lexique &,
                                GGS_conditionExpression  &) ;
  ...
  protected : void pr_condition_expression_piccolo_syntax_431_4_ (piccolo_lexique &,
                                GGS_conditionExpression  &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_13 (piccolo_lexique &) = 0 ;

  protected : void pr_condition_term_piccolo_syntax_450_4_ (piccolo_lexique &,
                                GGS_conditionExpression  &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_14 (piccolo_lexique &) = 0 ;

  protected : void pr_structured_instruction_piccolo_syntax_465_4_ (piccolo_lexique &,
                                GGS_piccolo_instruction  &,
                                GGS_bool &,
                                GGS_bool &) ;
  ...
  protected : void pr_simple_instruction_piccolo_syntax_722_4_ (piccolo_lexique &,
                                GGS_piccolo_instruction  &) ;
