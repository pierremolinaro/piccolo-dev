...
class piccolo_syntax {
  ...
  protected : void pr_interrupt_definition_piccolo_syntax_103_4_ (piccolo_lexique &,
                                GGS_interruptDefinitionList  &) ;

  protected : virtual sint16 select_repeat_piccolo_syntax_3 (piccolo_lexique &) = 0 ;

  protected : void pr_routine_definition_piccolo_syntax_122_4_ (piccolo_lexique &,
  ...
  protected : void pr_register_parsing_piccolo_syntax_155_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_7 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_173_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_8 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_188_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_195_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_201_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_208_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_9 (piccolo_lexique &) = 0 ;

  protected : void pr_instruction_piccolo_syntax_220_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;
