...
class piccolo_syntax {
  ...
  protected : void pr_routine_definition_piccolo_syntax_119_4_ (piccolo_lexique &,
  ...
  protected : void pr_register_parsing_piccolo_syntax_145_4_ (piccolo_lexique &,
                                GGS_registerExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_6 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_163_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : virtual sint16 select_piccolo_syntax_7 (piccolo_lexique &) = 0 ;

  protected : void pr_bit_number_parsing_piccolo_syntax_178_4_ (piccolo_lexique &,
                                GGS_bitNumberExpression  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_185_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_literal_value_parsing_piccolo_syntax_191_4_ (piccolo_lexique &,
                                GGS_luint  &) ;

  protected : void pr_optional_w_as_dest_piccolo_syntax_198_4_ (piccolo_lexique &,
                                GGS_bool &) ;

  protected : virtual sint16 select_piccolo_syntax_8 (piccolo_lexique &) = 0 ;

  protected : void pr_instruction_piccolo_syntax_210_4_ (piccolo_lexique &,
                                GGS_instruction  &) ;
