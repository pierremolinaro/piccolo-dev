...
void routine_analyze_5F_ram_5F_sections (const GALGAS_string constinArgument_inListingTitle,
  ...
  while (enumerator_2685.hasCurrentObject ()) {
    ...
    while (enumerator_2713.hasCurrentObject ()) {
      callCategoryMethod_handleDeclaration ((const cPtr_declarationInRam *) enumerator_2713.current_mDeclarationInRAM (HERE).ptr (), ioArgument_ioRamBankTable, ioArgument_ioAllRegisters, enumerator_2685.current_mBankName (HERE), outArgument_outDeclaredByteMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
  ...
  if (kBoolTrue == test_0) {
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (70)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (70)) COMMA_SOURCE_FILE_AT_LINE (70)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("*").operator_concat (constinArgument_inListingTitle.reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (71)) COMMA_SOURCE_FILE_AT_LINE (71)).operator_concat (GALGAS_string ("*\n") COMMA_SOURCE_FILE_AT_LINE (71)) COMMA_SOURCE_FILE_AT_LINE (71)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string::makeEmptyString ().reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 79U), GALGAS_char (TO_UNICODE (42)) COMMA_SOURCE_FILE_AT_LINE (72)).operator_concat (GALGAS_string ("\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_SOURCE_FILE_AT_LINE (72)) ;
    ioArgument_ioListFileContents.dotAssign_operation (GALGAS_string ("Variable").reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (73)).operator_concat (GALGAS_string (" Address\n") COMMA_SOURCE_FILE_AT_LINE (73)) COMMA_SOURCE_FILE_AT_LINE (73)) ;
    ...
    while (enumerator_3284.hasCurrentObject ()) {
      const enumGalgasBool test_1 = constinArgument_inSpecialRegisterTable.reader_hasKey (enumerator_3284.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (75)).operator_not (SOURCE_FILE_AT_LINE (75)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioListFileContents.dotAssign_operation (enumerator_3284.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (76)).reader_stringByLeftPadding (GALGAS_uint ((uint32_t) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (76)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
        ...
        while (enumerator_3472.hasCurrentObject ()) {
          ioArgument_ioListFileContents.dotAssign_operation (enumerator_3472.current_mValue (HERE).reader_hexString (SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)) ;
...
static void categoryMethod_byteDeclarationInRam_handleDeclaration (const cPtr_declarationInRam * inObject,
  ...
  ioArgument_ioRamBank.method_searchKey (constinArgument_inCurrentRamBank, joker_1088_0, var_firstFreeAddress, var_lastAddressPlusOne, var_mirrorOffsetList, inCompiler COMMA_SOURCE_FILE_AT_LINE (29)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSize.reader_uint (SOURCE_FILE_AT_LINE (30)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  while (enumerator_1320.hasCurrentObject ()) {
    var_addressList.addAssign_operation (var_firstFreeAddress.add_operation (enumerator_1320.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (35)) COMMA_SOURCE_FILE_AT_LINE (35)) ;
