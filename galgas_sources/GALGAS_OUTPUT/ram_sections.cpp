...
category_method__commonDeclarationInRam__handleDeclaration (C_Compiler & inLexique,
  ...
  if (operand_1005 != NULL) {
    ...
    if (_temp_1162.isBuilt ()) {
      _temp_1162 (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_0, var_cas_firstFreeAddressBeforeCommon, automatic_var_1, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (29)) ;
    }
    ...
    var_cas_firstFreeAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_1319 = enumerator_1319.nextObject ()))) {
        ...
        var_cas_ramBank = var_cas_ioRamBank ;
        {
          ...
          while (((operand_1389 = enumerator_1389.nextObject ()))) {
            ...
            if (_temp_1435.isBuilt ()) {
              ...
              if (_method != NULL) {
                _method (inLexique, _temp_1435 (HERE), var_cas_ramBank, var_cas_ioRegisterTable, var_cas_inCurrentRamBank COMMA_SOURCE_FILE_AT_LINE (35)) ;
              }
            }
          }
        }
        ...
        if (_temp_1541.isBuilt ()) {
          _temp_1541 (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_3, var_cas_ffa, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (38)) ;
        }
        if (((var_cas_firstFreeAddressDefined)._operator_not ()).isBuiltAndTrue ()) {
          ...
          operand_1319->mEndOfBranchLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this branch allocates "))._operator_concat (var_cas_ffa._substract_operation (inLexique, var_cas_firstFreeAddressBeforeCommon COMMA_SOURCE_FILE_AT_LINE (43)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (43))))._operator_concat (GGS_string (" byte(s), while the first branch allocates ")))._operator_concat (var_cas_firstFreeAddress._substract_operation (inLexique, var_cas_firstFreeAddressBeforeCommon COMMA_SOURCE_FILE_AT_LINE (45)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (45))))._operator_concat (GGS_string (" byte(s)")) COMMA_SOURCE_FILE_AT_LINE (46)) ;
        }
      }
    }
...
category_method__byteDeclarationInRam__handleDeclaration (C_Compiler & inLexique,
  ...
  if (operand_2235 != NULL) {
    ...
    if (_temp_2440.isBuilt ()) {
      _temp_2440 (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_6, var_cas_firstFreeAddress, var_cas_lastAddressPlusOne, var_cas_mirrorOffsetList COMMA_SOURCE_FILE_AT_LINE (61)) ;
    }
    if (((operand_2235->mSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (62)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_addressList = GGS_uintlist ::constructor_listWithValue (var_cas_firstFreeAddress) ;
    {
      ...
      while (((operand_2692 = enumerator_2692.nextObject ()))) {
        ...
        var_cas_addressList._addAssign_operation (var_cas_firstFreeAddress._add_operation (inLexique, operand_2692->mValue COMMA_SOURCE_FILE_AT_LINE (67))) ;
      }
    }
    ...
    var_cas_firstFreeAddress = var_cas_firstFreeAddress._add_operation (inLexique, operand_2235->mSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (70)) COMMA_SOURCE_FILE_AT_LINE (70)) ;
    ...
    if (((var_cas_firstFreeAddress)._operator_strictSup (var_cas_lastAddressPlusOne)).isBuiltAndTrue ()) {
      operand_2235->mName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("overflow in '"))._operator_concat (var_cas_inCurrentRamBank))._operator_concat (GGS_string ("' ram bank for '")))._operator_concat (operand_2235->mName))._operator_concat (GGS_string ("' declaration")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
    }
  }
}
...
void routine_analyze_ram_sections (C_Compiler & inLexique,
      ...
      macroValidPointer (operand_3852) ;
      {
        ...
        while (((operand_3880 = enumerator_3880.nextObject ()))) {
          ...
          if (_temp_3926.isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (inLexique, _temp_3926 (HERE), var_cas_ioRamBankTable, var_cas_ioAllRegisters, operand_3852->mBankName COMMA_SOURCE_FILE_AT_LINE (92)) ;
            }
          }
        }
      }
  ...
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (95)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (96))) ;
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_inListingTitle.reader_stringByLeftAndRightPadding (inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (97))) ;
    var_cas_ioListFileContents.appendCString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (98))) ;
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("Variable").reader_stringByLeftPadding (inLexique, GGS_uint (40U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (99))) ;
    var_cas_ioListFileContents.appendCString (" Address\n") ;
    {
      ...
      while (((operand_4424 = enumerator_4424.nextObject ()))) {
        ...
        if (((var_cas_inSpecialRegisterTable.reader_hasKey (inLexique, operand_4424->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)))._operator_not ()).isBuiltAndTrue ()) {
          var_cas_ioListFileContents._dotAssign_operation (operand_4424->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102)).reader_stringByLeftPadding (inLexique, GGS_uint (40U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (102))) ;
          var_cas_ioListFileContents.appendCString (" ") ;
          {
            ...
            if ((operand_4610 != NULL)) {
              ...
              do{
                ...
                var_cas_ioListFileContents._dotAssign_operation (operand_4610->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (104))) ;
