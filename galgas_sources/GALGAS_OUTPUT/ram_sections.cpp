      ...
      while (((operand_1319 = enumerator_1319.nextObject ()))) {
        ...
        var_cas_ramBank = var_cas_ioRamBank ;
        {
          ...
          while (((operand_1389 = enumerator_1389.nextObject ()))) {
            ...
            const GGS_declarationInRam  _temp_1435 = operand_1389->mDeclarationInRAM ;
            if (_temp_1435._isBuilt ()) {
              typeCategoryMethod__declarationInRam__handleDeclaration _method = findCategoryMethod__declarationInRam__handleDeclaration (_temp_1435._galgasObjectRunTimeInfo ()) ;
              if (_method != NULL) {
                _method (_inLexique, _temp_1435 (HERE), var_cas_ramBank, var_cas_ioRegisterTable, var_cas_inCurrentRamBank COMMA_SOURCE_FILE_AT_LINE (35)) ;
              }
            }
          }
        }
        ...
        const GGS_ramBankTable  _temp_1541 = var_cas_ramBank ;
        if (_temp_1541._isBuilt ()) {
          _temp_1541 (HERE)->method_searchKey (_inLexique, var_cas_inCurrentRamBank, automatic_var_3, var_cas_ffa, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (38)) ;
        }
...
category_method__byteDeclarationInRam__handleDeclaration (C_Compiler & _inLexique,
  ...
  if (operand_2235 != NULL) {
    ...
    const GGS_ramBankTable  _temp_2440 = var_cas_ioRamBank ;
    if (_temp_2440._isBuilt ()) {
      _temp_2440 (HERE)->method_searchKey (_inLexique, var_cas_inCurrentRamBank, automatic_var_6, var_cas_firstFreeAddress, var_cas_lastAddressPlusOne, var_cas_mirrorOffsetList COMMA_SOURCE_FILE_AT_LINE (61)) ;
    }
    if (((operand_2235->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (62)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_2235->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "zero size is not allowed") COMMA_SOURCE_FILE_AT_LINE (64)) ;
    }
    ...
    var_cas_addressList = GGS_uintlist ::constructor_listWithValue (var_cas_firstFreeAddress) ;
    {
      ...
      while (((operand_2692 = enumerator_2692.nextObject ()))) {
        ...
        var_cas_addressList._addAssign_operation (var_cas_firstFreeAddress._add_operation (_inLexique, operand_2692->mValue COMMA_SOURCE_FILE_AT_LINE (67))) ;
      }
    }
    var_cas_ioRegisterTable.modifier_insertKey (_inLexique, operand_2235->mName, var_cas_addressList, operand_2235->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (69)), operand_2235->mBitSliceTable, operand_2235->mBitDefinitionString COMMA_SOURCE_FILE_AT_LINE (69)) ;
    var_cas_firstFreeAddress = var_cas_firstFreeAddress._add_operation (_inLexique, operand_2235->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (70)) COMMA_SOURCE_FILE_AT_LINE (70)) ;
    ...
    if (((var_cas_firstFreeAddress)._operator_strictSup (var_cas_lastAddressPlusOne)).isBuiltAndTrue ()) {
      operand_2235->mName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "overflow in '"))._operator_concat (var_cas_inCurrentRamBank))._operator_concat (GGS_string (true, "' ram bank for '")))._operator_concat (operand_2235->mName))._operator_concat (GGS_string (true, "' declaration")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
    }
  }
}
    ...
    while (((operand_3852 = enumerator_3852.nextObject ()))) {
      macroValidPointer (operand_3852) ;
      {
        ...
        while (((operand_3880 = enumerator_3880.nextObject ()))) {
          ...
          const GGS_declarationInRam  _temp_3926 = operand_3880->mDeclarationInRAM ;
          if (_temp_3926._isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_3926 (HERE), var_cas_ioRamBankTable, var_cas_ioAllRegisters, operand_3852->mBankName COMMA_SOURCE_FILE_AT_LINE (92)) ;
            }
          }
        }
      }
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (95)))).isBuiltAndTrue ()) {
    ...
    var_cas_ioListFileContents.writeString (" Address\n") ;
    {
      ...
      while (((operand_4424 = enumerator_4424.nextObject ()))) {
        ...
        if (((var_cas_inSpecialRegisterTable.reader_hasKey (_inLexique, operand_4424->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)))._operator_not ()).isBuiltAndTrue ()) {
          var_cas_ioListFileContents._dotAssign_operation (operand_4424->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (102)).reader_stringByLeftPadding (_inLexique, GGS_uint (true, 40U), GGS_char (true, ' ') COMMA_SOURCE_FILE_AT_LINE (102))) ;
          var_cas_ioListFileContents.writeString (" ") ;
          {
            ...
            if ((operand_4610 != NULL)) {
              ...
              do{
                ...
                var_cas_ioListFileContents._dotAssign_operation (operand_4610->mValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (104))) ;
          ...
          var_cas_ioListFileContents._dotAssign_operation (operand_4424->mInfo.mBitDefinitionString) ;
          var_cas_ioListFileContents.writeString ("\n") ;
        }
      }
    }
