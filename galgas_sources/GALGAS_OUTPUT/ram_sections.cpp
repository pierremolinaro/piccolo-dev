    ...
    var_cas_firstFreeAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_1319 = enumerator_1319.nextObject ()))) {
        ...
        if (((var_cas_firstFreeAddressDefined)._operator_not ()).isBuiltAndTrue ()) {
          ...
          operand_1319->mEndOfBranchLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("this branch allocates "))._operator_concat (var_cas_ffa._substract_operation (_inLexique, var_cas_firstFreeAddressBeforeCommon COMMA_SOURCE_FILE_AT_LINE (43)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (43))))._operator_concat (GGS_string (" byte(s), while the first branch allocates ")))._operator_concat (var_cas_firstFreeAddress._substract_operation (_inLexique, var_cas_firstFreeAddressBeforeCommon COMMA_SOURCE_FILE_AT_LINE (45)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (45))))._operator_concat (GGS_string (" byte(s)")) COMMA_SOURCE_FILE_AT_LINE (46)) ;
        }
      }
    }
...
category_method__byteDeclarationInRam__handleDeclaration (C_Compiler & _inLexique,
  ...
  if (operand_2235 != NULL) {
    ...
    if (((operand_2235->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (62)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      operand_2235->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("zero size is not allowed") COMMA_SOURCE_FILE_AT_LINE (64)) ;
    }
    ...
    if (((var_cas_firstFreeAddress)._operator_strictSup (var_cas_lastAddressPlusOne)).isBuiltAndTrue ()) {
      operand_2235->mName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("overflow in '"))._operator_concat (var_cas_inCurrentRamBank))._operator_concat (GGS_string ("' ram bank for '")))._operator_concat (operand_2235->mName))._operator_concat (GGS_string ("' declaration")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
    }
  }
}
...
void routine_analyze_ram_sections (C_Compiler & _inLexique,
  ...
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("piccolo_options", "ouputListingFile" COMMA_SOURCE_FILE_AT_LINE (95)))).isBuiltAndTrue ()) {
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (96))) ;
    var_cas_ioListFileContents.appendCString ("\n") ;
    var_cas_ioListFileContents.appendCString ("*") ;
    var_cas_ioListFileContents._dotAssign_operation (var_cas_inListingTitle.reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (77U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (97))) ;
    var_cas_ioListFileContents.appendCString ("*\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("").reader_stringByLeftAndRightPadding (_inLexique, GGS_uint (79U), GGS_char (TO_UNICODE ('*')) COMMA_SOURCE_FILE_AT_LINE (98))) ;
    var_cas_ioListFileContents.appendCString ("\n"
      "\n") ;
    var_cas_ioListFileContents._dotAssign_operation (GGS_string ("Variable").reader_stringByLeftPadding (_inLexique, GGS_uint (40U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (99))) ;
    var_cas_ioListFileContents.appendCString (" Address\n") ;
    {
      ...
      while (((operand_4424 = enumerator_4424.nextObject ()))) {
        ...
        if (((var_cas_inSpecialRegisterTable.reader_hasKey (_inLexique, operand_4424->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)))._operator_not ()).isBuiltAndTrue ()) {
          var_cas_ioListFileContents._dotAssign_operation (operand_4424->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (102)).reader_stringByLeftPadding (_inLexique, GGS_uint (40U), GGS_char (TO_UNICODE (' ')) COMMA_SOURCE_FILE_AT_LINE (102))) ;
          var_cas_ioListFileContents.appendCString (" ") ;
          {
