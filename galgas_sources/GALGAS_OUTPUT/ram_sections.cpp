  ...
  if (cond_4863.isBuiltAndTrue ()) {
    ...
    var_cas_ioListFileContents.appendCString (" Address\n") ;
    {
      ...
      while (((operand_4424 = enumerator_4424.nextObject ()))) {
        ...
        const GGS_bool cond_4801 = (var_cas_inSpecialRegisterTable.reader_hasKey (inLexique, operand_4424->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101))).operator_not () ;
