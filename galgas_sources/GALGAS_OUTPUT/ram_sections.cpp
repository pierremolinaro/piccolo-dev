...
category_method__commonDeclarationInRam__handleDeclaration (C_Compiler & inLexique,
  ...
  if (operand_1005 != NULL) {
    ...
    if (temp_1162.isBuilt ()) {
      temp_1162 (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_1220_0, var_cas_firstFreeAddressBeforeCommon, automatic_var_1220_1, automatic_var_1220_2 COMMA_SOURCE_FILE_AT_LINE (29)) ;
    }
    ...
    GGS_uint  var_cas_firstFreeAddress = GGS_uint (0U) ;
    {
      ...
      while (((operand_1319 = enumerator_1319.nextObject ()))) {
        ...
        if (temp_1541.isBuilt ()) {
          temp_1541 (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_1574_0, var_cas_ffa, automatic_var_1574_1, automatic_var_1574_2 COMMA_SOURCE_FILE_AT_LINE (38)) ;
        }
...
category_method__byteDeclarationInRam__handleDeclaration (C_Compiler & inLexique,
  ...
  if (operand_2235 != NULL) {
    ...
    if (temp_2440.isBuilt ()) {
      temp_2440 (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_2518_0, var_cas_firstFreeAddress, var_cas_lastAddressPlusOne, var_cas_mirrorOffsetList COMMA_SOURCE_FILE_AT_LINE (61)) ;
    }
...
void routine_analyze_ram_sections (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4869 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_4869.isBuiltAndTrue ()) {
    ...
    var_cas_ioListFileContents.appendCString (" Address\n") ;
    {
      ...
      while (((operand_4430 = enumerator_4430.nextObject ()))) {
        ...
        const GGS_bool cond_4807 = (var_cas_inSpecialRegisterTable.reader_hasKey (operand_4430->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101)))).operator_not () ;
        if (cond_4807.isBuiltAndTrue ()) {
          ...
          var_cas_ioListFileContents.appendCString (" ") ;
          {
            GGS_uintlist::cEnumerator enumerator_4616 (operand_4430->mInfo.mRegisterAddressList, true) ;
            const GGS_uintlist::cElement * operand_4616 = enumerator_4616.nextObject () ;
            if ((operand_4616 != NULL)) {
              bool _foreach_loop_4616 ;
              do{
                macroValidPointer (operand_4616) ;
                var_cas_ioListFileContents.dotAssign_operation (operand_4616->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (104))) ;
                operand_4616 = enumerator_4616.nextObject () ;
                _foreach_loop_4616 = ((operand_4616 != NULL)) ;
                if (_foreach_loop_4616) {
                  var_cas_ioListFileContents.appendCString (", ") ;
                }
              }while (_foreach_loop_4616) ;
            }
          }
