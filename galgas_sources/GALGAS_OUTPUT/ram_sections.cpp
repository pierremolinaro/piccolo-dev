...
category_method__commonDeclarationInRam__handleDeclaration (C_Compiler & inLexique,
  ...
  if (operand_1005 != NULL) {
    ...
    GGS_uint  automatic_var_1220_0 ;
    GGS_uint  automatic_var_1220_1 ;
    GGS_uintlist  automatic_var_1220_2 ;
    if (var_cas_ioRamBank.isBuilt ()) {
      var_cas_ioRamBank (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_1220_0, var_cas_firstFreeAddressBeforeCommon, automatic_var_1220_1, automatic_var_1220_2 COMMA_SOURCE_FILE_AT_LINE (29)) ;
    }
      ...
      while (((operand_1319 = enumerator_1319.nextObject ()))) {
        ...
        GGS_ramBankTable  var_cas_ramBank = var_cas_ioRamBank ;
        {
          ...
          while (((operand_1389 = enumerator_1389.nextObject ()))) {
            ...
            { typeCategoryMethod__declarationInRam__handleDeclaration method = findCategoryMethod__declarationInRam__handleDeclaration (operand_1389->mDeclarationInRAM.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_1389->mDeclarationInRAM (HERE), var_cas_ramBank, var_cas_ioRegisterTable, var_cas_inCurrentRamBank COMMA_SOURCE_FILE_AT_LINE (35)) ;
              }
            }
          }
        }
        GGS_uint  var_cas_ffa ;
        GGS_uint  automatic_var_1574_0 ;
        GGS_uint  automatic_var_1574_1 ;
        GGS_uintlist  automatic_var_1574_2 ;
        if (var_cas_ramBank.isBuilt ()) {
          var_cas_ramBank (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_1574_0, var_cas_ffa, automatic_var_1574_1, automatic_var_1574_2 COMMA_SOURCE_FILE_AT_LINE (38)) ;
        }
        const GGS_bool cond_1698 = (var_cas_firstFreeAddressDefined).operator_not () ;
        if (cond_1698.isBuiltAndTrue ()) {
          var_cas_firstFreeAddress = var_cas_ffa ;
          var_cas_firstFreeAddressDefined = GGS_bool (true) ;
        }else if (cond_1698.isBuiltAndFalse ()) {
          const GGS_bool cond_1974 = (var_cas_ffa).operator_isNotEqual (var_cas_firstFreeAddress) ;
          if (cond_1974.isBuiltAndTrue ()) {
...
category_method__byteDeclarationInRam__handleDeclaration (C_Compiler & inLexique,
  ...
  if (operand_2235 != NULL) {
    ...
    GGS_uint  automatic_var_2518_0 ;
    if (var_cas_ioRamBank.isBuilt ()) {
      var_cas_ioRamBank (HERE)->method_searchKey (inLexique, var_cas_inCurrentRamBank, automatic_var_2518_0, var_cas_firstFreeAddress, var_cas_lastAddressPlusOne, var_cas_mirrorOffsetList COMMA_SOURCE_FILE_AT_LINE (61)) ;
    }
    const GGS_bool cond_2600 = (operand_2235->mSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (62))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_2600.isBuiltAndTrue ()) {
    ...
    GGS_uintlist  var_cas_addressList = GGS_uintlist ::constructor_listWithValue (var_cas_firstFreeAddress) ;
    {
      ...
      while (((operand_2692 = enumerator_2692.nextObject ()))) {
        ...
        var_cas_addressList.addAssign_operation (var_cas_firstFreeAddress.add_operation (inLexique, operand_2692->mValue COMMA_SOURCE_FILE_AT_LINE (67))) ;
      }
    }
    ...
    const GGS_bool cond_3166 = (var_cas_firstFreeAddress).operator_strictSup (var_cas_lastAddressPlusOne) ;
...
void routine_analyze_ram_sections (C_Compiler & inLexique,
    ...
    while (((operand_3852 = enumerator_3852.nextObject ()))) {
      macroValidPointer (operand_3852) ;
      {
        ...
        while (((operand_3880 = enumerator_3880.nextObject ()))) {
          ...
          { typeCategoryMethod__declarationInRam__handleDeclaration method = findCategoryMethod__declarationInRam__handleDeclaration (operand_3880->mDeclarationInRAM.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_3880->mDeclarationInRAM (HERE), var_cas_ioRamBankTable, var_cas_ioAllRegisters, operand_3852->mBankName COMMA_SOURCE_FILE_AT_LINE (92)) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_4871 = gOption_piccolo_5F_options_ouputListingFile.reader_value () ;
  if (cond_4871.isBuiltAndTrue ()) {
    ...
    {
      GGS_registerTable::cEnumerator enumerator_4430 (var_cas_ioAllRegisters, true) ;
      const GGS_registerTable::cElement * operand_4430 = NULL ;
      while (((operand_4430 = enumerator_4430.nextObject ()))) {
        macroValidPointer (operand_4430) ;
        const GGS_bool cond_4809 = (var_cas_inSpecialRegisterTable.reader_hasKey (operand_4430->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101)))).operator_not () ;
        if (cond_4809.isBuiltAndTrue ()) {
          var_cas_ioListFileContents.dotAssign_operation (operand_4430->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102)).reader_stringByLeftPadding (GGS_uint (40U), GGS_char (TO_UNICODE (' ')))) ;
          var_cas_ioListFileContents.appendCString (" ") ;
          {
            GGS_uintlist::cEnumerator enumerator_4618 (operand_4430->mInfo.mRegisterAddressList, true) ;
            ...
            if ((operand_4618 != NULL)) {
              ...
              do{
                ...
                var_cas_ioListFileContents.dotAssign_operation (operand_4618->mValue.reader_hexString (inLexique COMMA_SOURCE_FILE_AT_LINE (104))) ;
          ...
          var_cas_ioListFileContents.dotAssign_operation (operand_4430->mInfo.mBitDefinitionString) ;
          var_cas_ioListFileContents.appendCString ("\n") ;
        }
      }
    }
