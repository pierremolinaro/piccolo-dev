...
//                    december 23th, 2013, at 19h51'52"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_analyze_5F_ram_5F_sections (const GALGAS_string constinArgument_inListingTitle,
  ...
  if (kBoolTrue == test_0) {
    ...
    while (enumerator_3284.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_1) {
        ioArgument_ioListFileContents.dotAssign_operation (enumerator_3284.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (76)).reader_stringByLeftPadding (GALGAS_uint ((PMUInt32) 40U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (76)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
