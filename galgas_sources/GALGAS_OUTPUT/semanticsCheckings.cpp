...
category_method__instruction_literalOperation__check (C_Compiler & _inLexique,
                                const cPtr_instruction_literalOperation * operand_14488,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_routineMap   /* var_cas_inRoutineMap */,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_uint  & /* var_cas_ioCurrentBank */,
                                ...
                                const GGS_routineKind  /* var_cas_inRoutineKind */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14488 != NULL) {
    if (((operand_14488->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (425)))._operator_strictSup (GGS_uint (true, 255U))).isBuiltAndTrue ()) {
      operand_14488->mLiteralValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the literal value ("))._operator_concat (operand_14488->mLiteralValue.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (426)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (426))))._operator_concat (GGS_string (true, ") should be lower or equal to 255")) COMMA_SOURCE_FILE_AT_LINE (426)) ;
    }
  }
}
...
category_method__instruction_LFSR__check (C_Compiler & _inLexique,
                                const cPtr_instruction_LFSR * operand_15054,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_routineMap   /* var_cas_inRoutineMap */,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & /* var_cas_ioCurrentBank */,
                                ...
                                const GGS_routineKind  /* var_cas_inRoutineKind */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15054 != NULL) {
    if (((operand_15054->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (441)))._operator_strictSup (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
      operand_15054->mFSRindex.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the LFSR register index ("))._operator_concat (operand_15054->mFSRindex.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (442)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (442))))._operator_concat (GGS_string (true, ") should be lower or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (442)) ;
    }
    const GGS_registerExpression  _temp_15497 = operand_15054->mRegisterExpression ;
    if (_temp_15497._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterDeclaration _method = findCategoryMethod__registerExpression__checkRegisterDeclaration (_temp_15497._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_15497 (HERE), var_cas_inRegisterTable COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
    }
  }
}
...
category_method__instruction_MOVAW__check (C_Compiler & _inLexique,
                                const cPtr_instruction_MOVAW * operand_15672,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_routineMap   /* var_cas_inRoutineMap */,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & /* var_cas_ioCurrentBank */,
  ...
  if (operand_15672 != NULL) {
    const GGS_registerExpression  _temp_15959 = operand_15672->mRegisterExpression ;
    if (_temp_15959._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterDeclarationAndAddressLowerThan256 _method = findCategoryMethod__registerExpression__checkRegisterDeclarationAndAddressLowerThan256 (_temp_15959._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_15959 (HERE), var_cas_inRegisterTable COMMA_SOURCE_FILE_AT_LINE (458)) ;
      }
    }
  }
}
...
category_method__instruction_computed_retlw__check (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_retlw * operand_16165,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_routineMap   /* var_cas_inRoutineMap */,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_uint  & /* var_cas_ioCurrentBank */,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16165 != NULL) {
    if (((operand_16165->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (472)))._operator_strictInf (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
      operand_16165->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the computed range ("))._operator_concat (operand_16165->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (473)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (473))))._operator_concat (GGS_string (true, ") should be greater or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (473)) ;
    }else if (((operand_16165->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (474)))._operator_strictSup (GGS_uint (true, 128U))).isBuiltAndTrue ()) {
      operand_16165->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the computed range ("))._operator_concat (operand_16165->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (475)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (475))))._operator_concat (GGS_string (true, ") should be lower or equal to 128")) COMMA_SOURCE_FILE_AT_LINE (475)) ;
    }else if (((operand_16165->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (476)))._operator_isNotEqual (operand_16165->mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (476)))).isBuiltAndTrue ()) {
      operand_16165->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the constant list length ("))._operator_concat (operand_16165->mLiteralValues.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (477)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (477))))._operator_concat (GGS_string (true, ") should be equal to the computed range (")))._operator_concat (operand_16165->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (477)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (477))))._operator_concat (GGS_string (true, ")")) COMMA_SOURCE_FILE_AT_LINE (477)) ;
    }
    var_cas_ioContinuesInSequence = GGS_bool (true, false) ;
    ...
    case GGS_routineKind::enum_noReturnRoutine:
      {
      operand_16165->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a \"noreturn\" routine does not accept computed retlw instruction") COMMA_SOURCE_FILE_AT_LINE (483)) ;
      }
      break ;
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_16165->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an interrupt routine does not accept computed retlw instruction") COMMA_SOURCE_FILE_AT_LINE (485)) ;
      }
      break ;
...
category_method__instruction_MNOP__check (C_Compiler & _inLexique,
                                const cPtr_instruction_MNOP * operand_17391,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_routineMap   /* var_cas_inRoutineMap */,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_uint  & /* var_cas_ioCurrentBank */,
                                ...
                                const GGS_routineKind  /* var_cas_inRoutineKind */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17391 != NULL) {
    if (((operand_17391->mOccurrenceFactor.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (500)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      operand_17391->mOccurrenceFactor.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "occurrence argument is zero: no generated code") COMMA_SOURCE_FILE_AT_LINE (501)) ;
    }
  }
}
...
category_method__instruction_computed_bra__check (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_bra * operand_17931,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_uint  & var_cas_ioCurrentBank,
  ...
  if (operand_17931 != NULL) {
    if (((operand_17931->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (516)))._operator_strictInf (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
      operand_17931->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the computed range ("))._operator_concat (operand_17931->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (517)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (517))))._operator_concat (GGS_string (true, ") should be greater or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (517)) ;
    }else if (((operand_17931->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (518)))._operator_strictSup (GGS_uint (true, 128U))).isBuiltAndTrue ()) {
      operand_17931->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the computed range ("))._operator_concat (operand_17931->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (519)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (519))))._operator_concat (GGS_string (true, ") should be lower or equal to 128")) COMMA_SOURCE_FILE_AT_LINE (519)) ;
    }else if (((operand_17931->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (520)))._operator_isNotEqual (operand_17931->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (520)))).isBuiltAndTrue ()) {
      operand_17931->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine name list length ("))._operator_concat (operand_17931->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (521)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (521))))._operator_concat (GGS_string (true, ") should be equal to the computed range (")))._operator_concat (operand_17931->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (521)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (521))))._operator_concat (GGS_string (true, ")")) COMMA_SOURCE_FILE_AT_LINE (521)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_18673 (operand_17931->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_18673 = NULL ;
      while (((operand_18673 = enumerator_18673.nextObject ()))) {
        ...
        const GGS_routineMap  _temp_18756 = var_cas_inRoutineMap ;
        if (_temp_18756._isBuilt ()) {
          _temp_18756 (HERE)->method_searchKey (_inLexique, operand_18673->mValue, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_13, automatic_var_14 COMMA_SOURCE_FILE_AT_LINE (526)) ;
        }
        if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage ;
          var_cas_errorMessage = (((GGS_string (true, "the routine '"))._operator_concat (operand_18673->mValue))._operator_concat (GGS_string (true, "' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (528))) ;
          var_cas_errorMessage.writeString (", but BSR ") ;
          if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.writeString ("does contain any reliable value") ;
          }else{
            var_cas_errorMessage.writeString ("is set to ") ;
            var_cas_errorMessage._dotAssign_operation (var_cas_ioCurrentBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (533))) ;
          }
          operand_18673->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (535)) ;
        }
        if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
          operand_18673->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "for being named in a computed bra, the '"))._operator_concat (operand_18673->mValue))._operator_concat (GGS_string (true, "' routine should be declared with the \"noreturn\" qualifier")) COMMA_SOURCE_FILE_AT_LINE (538)) ;
        }
      }
    }
    var_cas_ioContinuesInSequence = GGS_bool (true, false) ;
    ...
    case GGS_routineKind::enum_regularRoutine:
      {
      operand_17931->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a regular routine does not accept computed bra instruction") COMMA_SOURCE_FILE_AT_LINE (544)) ;
      }
      break ;
    case GGS_routineKind::enum_noReturnRoutine:
      {
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_17931->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an interrupt routine does not accept computed bra instruction") COMMA_SOURCE_FILE_AT_LINE (547)) ;
      }
      break ;
    case GGS_routineKind::kNotBuilt:
      break ;
...
category_method__instruction_computed_goto__check (C_Compiler & _inLexique,
                                const cPtr_instruction_computed_goto * operand_19951,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                GGS_uint  & var_cas_ioCurrentBank,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19951 != NULL) {
    if (((operand_19951->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (562)))._operator_strictInf (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
      operand_19951->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the computed range ("))._operator_concat (operand_19951->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (563)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (563))))._operator_concat (GGS_string (true, ") should be greater or equal to 2")) COMMA_SOURCE_FILE_AT_LINE (563)) ;
    }else if (((operand_19951->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (564)))._operator_strictSup (GGS_uint (true, 64U))).isBuiltAndTrue ()) {
      operand_19951->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the computed range ("))._operator_concat (operand_19951->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (565)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (565))))._operator_concat (GGS_string (true, ") should be lower or equal to 64")) COMMA_SOURCE_FILE_AT_LINE (565)) ;
    }else if (((operand_19951->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (566)))._operator_isNotEqual (operand_19951->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (566)))).isBuiltAndTrue ()) {
      operand_19951->mSize.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the routine name list length ("))._operator_concat (operand_19951->mTargetLabels.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (567)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (567))))._operator_concat (GGS_string (true, ") should be equal to the computed range (")))._operator_concat (operand_19951->mSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (567)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (567))))._operator_concat (GGS_string (true, ")")) COMMA_SOURCE_FILE_AT_LINE (567)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_20691 (operand_19951->mTargetLabels, true) ;
      const GGS_lstringlist::cElement * operand_20691 = NULL ;
      while (((operand_20691 = enumerator_20691.nextObject ()))) {
        macroValidPointer (operand_20691) ;
        GGS_bool var_cas_isNoReturn ;
        GGS_uint  var_cas_requiredBank ;
        GGS_uint  automatic_var_15 ;
        GGS_bool automatic_var_16 ;
        const GGS_routineMap  _temp_20774 = var_cas_inRoutineMap ;
        if (_temp_20774._isBuilt ()) {
          _temp_20774 (HERE)->method_searchKey (_inLexique, operand_20691->mValue, var_cas_isNoReturn, var_cas_requiredBank, automatic_var_15, automatic_var_16 COMMA_SOURCE_FILE_AT_LINE (572)) ;
        }
        if ((((var_cas_requiredBank)._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((var_cas_requiredBank)._operator_isNotEqual (var_cas_ioCurrentBank))).isBuiltAndTrue ()) {
          GGS_string var_cas_errorMessage ;
          var_cas_errorMessage = (((GGS_string (true, "the routine '"))._operator_concat (operand_20691->mValue))._operator_concat (GGS_string (true, "' requires BSR to be set to ")))._operator_concat (var_cas_requiredBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (574))) ;
          var_cas_errorMessage.writeString (", but BSR ") ;
          if (((var_cas_ioCurrentBank)._operator_isEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            var_cas_errorMessage.writeString ("does contain any reliable value") ;
          }else{
            var_cas_errorMessage.writeString ("is set to ") ;
            var_cas_errorMessage._dotAssign_operation (var_cas_ioCurrentBank.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (579))) ;
          }
          operand_20691->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (581)) ;
        }
        if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
          operand_20691->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "for being named in a computed goto, the '"))._operator_concat (operand_20691->mValue))._operator_concat (GGS_string (true, "' routine should be declared with the \"noreturn\" qualifier")) COMMA_SOURCE_FILE_AT_LINE (584)) ;
        }
      }
    }
    var_cas_ioContinuesInSequence = GGS_bool (true, false) ;
    ...
    case GGS_routineKind::enum_regularRoutine:
      {
      operand_19951->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a regular routine does not accept computed goto instruction") COMMA_SOURCE_FILE_AT_LINE (590)) ;
      }
      break ;
    case GGS_routineKind::enum_noReturnRoutine:
      {
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_19951->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an interrupt routine does not accept computed goto instruction") COMMA_SOURCE_FILE_AT_LINE (593)) ;
      }
      break ;
    case GGS_routineKind::kNotBuilt:
      break ;
...
category_method__instruction_FOREVER__check (C_Compiler & _inLexique,
                                const cPtr_instruction_FOREVER * operand_21966,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
  ...
  if (operand_21966 != NULL) {
    ...
    case GGS_routineKind::enum_regularRoutine:
      {
      operand_21966->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a regular routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (610)) ;
      }
      break ;
    case GGS_routineKind::enum_noReturnRoutine:
      {
    ...
    case GGS_routineKind::enum_interruptRoutine:
      {
      operand_21966->mInstructionLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an interrupt routine does not accept the \"forever\" instruction") COMMA_SOURCE_FILE_AT_LINE (613)) ;
      }
      break ;
    case GGS_routineKind::kNotBuilt:
      break ;
    ...
    GGS_uint  var_cas_finalBank ;
    var_cas_finalBank = var_cas_ioCurrentBank ;
    ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_finalBank,  var_cas_inShouldPreserveBSR,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind,  operand_21966->mInstructionList COMMA_SOURCE_FILE_AT_LINE (616)) ;
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_21966->mEndOfInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "instruction list does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (628)) ;
    }
    var_cas_ioContinuesInSequence = GGS_bool (true, false) ;
  }
}
...
category_method__instruction_IF_FA_SEMI_COLON__check (C_Compiler & _inLexique,
                                const cPtr_instruction_IF_FA_SEMI_COLON * operand_23109,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
  ...
  if (operand_23109 != NULL) {
    ...
    const GGS_registerExpression  _temp_23361 = operand_23109->mRegisterExpression ;
    if (_temp_23361._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_23361._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_23361 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, automatic_var_17 COMMA_SOURCE_FILE_AT_LINE (645)) ;
      }
    }
    GGS_bool var_cas_unusedContinuesInSequence ;
    var_cas_unusedContinuesInSequence = GGS_bool (true, true) ;
    const GGS_piccolo_instruction  _temp_23572 = operand_23109->mInstruction ;
    if (_temp_23572._isBuilt ()) {
      typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_23572._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_23572 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (653)) ;
      }
    }
  }
}
...
category_method__instruction_IF_BitTest__check (C_Compiler & _inLexique,
                                const cPtr_instruction_IF_BitTest * operand_23883,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23883 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    const GGS_registerExpression  _temp_24168 = operand_23883->mRegisterExpression ;
    if (_temp_24168._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_24168._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_24168 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (676)) ;
      }
    }
    const GGS_bitNumberExpression  _temp_24313 = operand_23883->mBitNumber ;
    if (_temp_24313._isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__checkBitNumber _method = findCategoryMethod__bitNumberExpression__checkBitNumber (_temp_24313._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_24313 (HERE), var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (682)) ;
      }
    }
    GGS_bool var_cas_unusedContinuesInSequence ;
    var_cas_unusedContinuesInSequence = GGS_bool (true, true) ;
    const GGS_piccolo_instruction  _temp_24438 = operand_23883->mInstruction ;
    if (_temp_24438._isBuilt ()) {
      typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_24438._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_24438 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (685)) ;
      }
    }
  }
}
...
category_method__bcc_in_structured_if_condition__checkCondition (C_Compiler &,
                                const cPtr_bcc_in_structured_if_condition * operand_24985,
                                const GGS_uint   /* var_cas_inAccessBankSplitOffset */,
                                const GGS_registerTable   /* var_cas_inRegisterTable */,
                                const GGS_uint   /* var_cas_ioCurrentBank */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24985 != NULL) {
  }
}
...
category_method__registerComparisonCondition__checkCondition (C_Compiler & _inLexique,
                                const cPtr_registerComparisonCondition * operand_25255,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_uint   var_cas_ioCurrentBank
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25255 != NULL) {
    GGS_bitSliceTable  automatic_var_18 ;
    const GGS_registerExpression  _temp_25387 = operand_25255->mRegisterExpression ;
    if (_temp_25387._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_25387._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_25387 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, automatic_var_18 COMMA_SOURCE_FILE_AT_LINE (720)) ;
      }
    }
  }
}
...
category_method__incDecRegisterInCondition__checkCondition (C_Compiler & _inLexique,
                                const cPtr_incDecRegisterInCondition * operand_25644,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_uint   var_cas_ioCurrentBank
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25644 != NULL) {
    ...
    const GGS_registerExpression  _temp_25776 = operand_25644->mRegisterExpression ;
    if (_temp_25776._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_25776._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_25776 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, automatic_var_19 COMMA_SOURCE_FILE_AT_LINE (735)) ;
      }
    }
  }
}
...
category_method__registerTestCondition__checkCondition (C_Compiler & _inLexique,
                                const cPtr_registerTestCondition * operand_26029,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_uint   var_cas_ioCurrentBank
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26029 != NULL) {
    ...
    const GGS_registerExpression  _temp_26161 = operand_26029->mRegisterExpression ;
    if (_temp_26161._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_26161._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_26161 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (750)) ;
      }
    }
  }
}
...
category_method__negateCondition__checkCondition (C_Compiler & _inLexique,
                                const cPtr_negateCondition * operand_26408,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_uint   var_cas_ioCurrentBank
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26408 != NULL) {
    const GGS_conditionExpression  _temp_26531 = operand_26408->mCondition ;
    if (_temp_26531._isBuilt ()) {
      typeCategoryMethod__conditionExpression__checkCondition _method = findCategoryMethod__conditionExpression__checkCondition (_temp_26531._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_26531 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank COMMA_SOURCE_FILE_AT_LINE (765)) ;
      }
    }
  }
}
...
category_method__andCondition__checkCondition (C_Compiler & _inLexique,
                                const cPtr_andCondition * operand_26746,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_uint   var_cas_ioCurrentBank
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26746 != NULL) {
    const GGS_conditionExpression  _temp_26874 = operand_26746->mLeftExpression ;
    if (_temp_26874._isBuilt ()) {
      typeCategoryMethod__conditionExpression__checkCondition _method = findCategoryMethod__conditionExpression__checkCondition (_temp_26874._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_26874 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank COMMA_SOURCE_FILE_AT_LINE (779)) ;
      }
    }
    const GGS_conditionExpression  _temp_26984 = operand_26746->mRightExpression ;
    if (_temp_26984._isBuilt ()) {
      typeCategoryMethod__conditionExpression__checkCondition _method = findCategoryMethod__conditionExpression__checkCondition (_temp_26984._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_26984 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank COMMA_SOURCE_FILE_AT_LINE (784)) ;
      }
    }
  }
}
...
category_method__bitTest_in_structured_if_condition__checkCondition (C_Compiler & _inLexique,
                                const cPtr_bitTest_in_structured_if_condition * operand_27221,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                const GGS_uint   var_cas_ioCurrentBank
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27221 != NULL) {
    GGS_bitSliceTable  var_cas_bitSliceTable ;
    const GGS_registerExpression  _temp_27386 = operand_27221->mRegisterExpression ;
    if (_temp_27386._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_27386._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_27386 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (799)) ;
      }
    }
    const GGS_bitNumberExpression  _temp_27531 = operand_27221->mBitNumber ;
    if (_temp_27531._isBuilt ()) {
      typeCategoryMethod__bitNumberExpression__checkBitNumber _method = findCategoryMethod__bitNumberExpression__checkBitNumber (_temp_27531._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_27531 (HERE), var_cas_bitSliceTable COMMA_SOURCE_FILE_AT_LINE (805)) ;
      }
    }
  }
}
...
category_method__instruction_structured_if__check (C_Compiler & _inLexique,
                                const cPtr_instruction_structured_if * operand_27702,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27702 != NULL) {
    const GGS_conditionExpression  _temp_27961 = operand_27702->mIfCondition ;
    if (_temp_27961._isBuilt ()) {
      typeCategoryMethod__conditionExpression__checkCondition _method = findCategoryMethod__conditionExpression__checkCondition (_temp_27961._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_27961 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank COMMA_SOURCE_FILE_AT_LINE (820)) ;
      }
    }
    GGS_uint  var_cas_firstBranchFinalBank ;
    var_cas_firstBranchFinalBank = var_cas_ioCurrentBank ;
    ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_firstBranchFinalBank,  var_cas_inShouldPreserveBSR,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind,  operand_27702->mThenInstructionList COMMA_SOURCE_FILE_AT_LINE (826)) ;
    GGS_uint  var_cas_finalBank ;
    var_cas_finalBank = var_cas_firstBranchFinalBank ;
    {
      GGS_partList::cEnumerator enumerator_28416 (operand_27702->mElsifPartList, true) ;
      const GGS_partList::cElement * operand_28416 = NULL ;
      while (((operand_28416 = enumerator_28416.nextObject ()))) {
        macroValidPointer (operand_28416) ;
        const GGS_conditionExpression  _temp_28450 = operand_28416->mCondition ;
        if (_temp_28450._isBuilt ()) {
          typeCategoryMethod__conditionExpression__checkCondition _method = findCategoryMethod__conditionExpression__checkCondition (_temp_28450._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_28450 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank COMMA_SOURCE_FILE_AT_LINE (840)) ;
          }
        }
        ...
        ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_elsifPartCurrentBank,  var_cas_inShouldPreserveBSR,  var_cas_continuesInSequence,  var_cas_inRoutineKind,  operand_28416->mInstructionList COMMA_SOURCE_FILE_AT_LINE (846)) ;
        if (((var_cas_elsifPartCurrentBank)._operator_isNotEqual (var_cas_firstBranchFinalBank)).isBuiltAndTrue ()) {
          operand_28416->mEndOfPartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave BSR value as the first one does") COMMA_SOURCE_FILE_AT_LINE (858)) ;
    ...
    ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_elsePartCurrentBank,  var_cas_inShouldPreserveBSR,  var_cas_continuesInSequence,  var_cas_inRoutineKind,  operand_27702->mElseInstructionList COMMA_SOURCE_FILE_AT_LINE (865)) ;
    if (((var_cas_elsePartCurrentBank)._operator_isNotEqual (var_cas_firstBranchFinalBank)).isBuiltAndTrue ()) {
      operand_27702->mEndOfElsePartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave BSR value as the first one does") COMMA_SOURCE_FILE_AT_LINE (877)) ;
      var_cas_finalBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
    }
    var_cas_ioContinuesInSequence = (var_cas_ioContinuesInSequence)._operator_or (var_cas_continuesInSequence) ;
...
category_method__instruction_do_while__check (C_Compiler & _inLexique,
                                const cPtr_instruction_do_while * operand_29959,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29959 != NULL) {
    GGS_uint  var_cas_finalBank ;
    var_cas_finalBank = var_cas_ioCurrentBank ;
    ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_finalBank,  var_cas_inShouldPreserveBSR,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind,  operand_29959->mRepeatedInstructionList COMMA_SOURCE_FILE_AT_LINE (897)) ;
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_29959->mEndOfRepeatedInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (909)) ;
    }
    {
      GGS_partList::cEnumerator enumerator_30622 (operand_29959->mWhilePartList, true) ;
      const GGS_partList::cElement * operand_30622 = NULL ;
      while (((operand_30622 = enumerator_30622.nextObject ()))) {
        macroValidPointer (operand_30622) ;
        const GGS_conditionExpression  _temp_30656 = operand_30622->mCondition ;
        if (_temp_30656._isBuilt ()) {
          typeCategoryMethod__conditionExpression__checkCondition _method = findCategoryMethod__conditionExpression__checkCondition (_temp_30656._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_30656 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank COMMA_SOURCE_FILE_AT_LINE (913)) ;
          }
        }
        GGS_uint  var_cas_bank ;
        var_cas_bank = var_cas_ioCurrentBank ;
        ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_bank,  var_cas_inShouldPreserveBSR,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind,  operand_30622->mInstructionList COMMA_SOURCE_FILE_AT_LINE (918)) ;
        if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_bank)).isBuiltAndTrue ()) {
          operand_30622->mEndOfPartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (930)) ;
        }
      }
    }
  }
...
category_method__instruction_IF_IncDec__check (C_Compiler & _inLexique,
                                const cPtr_instruction_IF_IncDec * operand_31285,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31285 != NULL) {
    GGS_bitSliceTable  automatic_var_21 ;
    const GGS_registerExpression  _temp_31537 = operand_31285->mRegisterExpression ;
    if (_temp_31537._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_31537._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_31537 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, automatic_var_21 COMMA_SOURCE_FILE_AT_LINE (946)) ;
      }
    }
    GGS_bool var_cas_unusedContinuesInSequence ;
    var_cas_unusedContinuesInSequence = GGS_bool (true, true) ;
    const GGS_piccolo_instruction  _temp_31748 = operand_31285->mInstruction ;
    if (_temp_31748._isBuilt ()) {
      typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_31748._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_31748 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (954)) ;
      }
    }
  }
}
...
void routine_semanticsCheckings (C_Compiler & _inLexique,
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_32358 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (977)), true) ;
    const GGS_routineDefinitionList::cElement * operand_32358 = NULL ;
    while (((operand_32358 = enumerator_32358.nextObject ()))) {
      macroValidPointer (operand_32358) ;
      if ((((operand_32358->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_32358->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_32358->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (979)) ;
      }
      if ((((operand_32358->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (981)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_32358->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (981)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_32358->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (982)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_32358->mRoutineName, operand_32358->mIsNoReturn, operand_32358->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (984)), operand_32358->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (984)), operand_32358->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (984)) ;
    }
  }
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (987))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_22 ;
    GGS_bool automatic_var_23 ;
    const GGS_routineMap  _temp_33064 = var_cas_routineMap ;
    if (_temp_33064._isBuilt ()) {
      _temp_33064 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_22, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (990)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (992)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (995)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (998)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (998)) ;
  }
  {
    GGS_routineDefinitionList::cEnumerator enumerator_33631 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1001)), true) ;
    const GGS_routineDefinitionList::cElement * operand_33631 = NULL ;
    while (((operand_33631 = enumerator_33631.nextObject ()))) {
      macroValidPointer (operand_33631) ;
      GGS_bool var_cas_continuesInSequence ;
      var_cas_continuesInSequence = GGS_bool (true, true) ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = operand_33631->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1003)) ;
      GGS_routineKind var_cas_routineKind ;
      if ((operand_33631->mIsNoReturn).isBuiltAndTrue ()) {
      ...
      {
        GGS_instructionList::cEnumerator enumerator_33958 (operand_33631->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_33958 = NULL ;
        while (((operand_33958 = enumerator_33958.nextObject ()))) {
          macroValidPointer (operand_33958) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_33958->mInstruction.reader_mInstructionLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1012)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unreachable code") COMMA_SOURCE_FILE_AT_LINE (1012)) ;
            var_cas_continuesInSequence = GGS_bool (true, true) ;
          }
          const GGS_piccolo_instruction  _temp_34162 = operand_33958->mInstruction ;
          if (_temp_34162._isBuilt ()) {
            typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_34162._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_34162 (HERE), var_cas_inAccessBankSplitOffset, var_cas_routineMap, var_cas_inRegisterTable, var_cas_currentBank, operand_33631->mPreservesBank, var_cas_continuesInSequence, var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (1015)) ;
            }
          }
        }
      }
      if (((((operand_33631->mIsNoReturn)._operator_not ())._operator_and ((operand_33631->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1025)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_33631->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1025))))).isBuiltAndTrue ()) {
        operand_33631->mEndOfRoutineLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set BSR to "))._operator_concat (operand_33631->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1026)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1026))) COMMA_SOURCE_FILE_AT_LINE (1026)) ;
      }
      if (((operand_33631->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
        operand_33631->mEndOfRoutineLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (1029)) ;
      }
    }
  }
  {
    GGS_interruptDefinitionList::cEnumerator enumerator_34830 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1033)), true) ;
    const GGS_interruptDefinitionList::cElement * operand_34830 = NULL ;
    while (((operand_34830 = enumerator_34830.nextObject ()))) {
      macroValidPointer (operand_34830) ;
      GGS_bool var_cas_continuesInSequence ;
      var_cas_continuesInSequence = GGS_bool (true, true) ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
      {
        GGS_instructionList::cEnumerator enumerator_34967 (operand_34830->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_34967 = NULL ;
        while (((operand_34967 = enumerator_34967.nextObject ()))) {
          macroValidPointer (operand_34967) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_34967->mInstruction.reader_mInstructionLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1038)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unreachable code") COMMA_SOURCE_FILE_AT_LINE (1038)) ;
            var_cas_continuesInSequence = GGS_bool (true, true) ;
          }
          const GGS_piccolo_instruction  _temp_35171 = operand_34967->mInstruction ;
          if (_temp_35171._isBuilt ()) {
            typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_35171._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_35171 (HERE), var_cas_inAccessBankSplitOffset, var_cas_routineMap, var_cas_inRegisterTable, var_cas_currentBank, (operand_34830->mFastReturn)._operator_not (), var_cas_continuesInSequence, GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1041)) ;
            }
          }
        }
      }
      if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
        operand_34830->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1052)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
