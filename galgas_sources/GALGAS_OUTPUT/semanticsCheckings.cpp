      ...
      var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
      {
        ...
        while (((operand_34967 = enumerator_34967.nextObject ()))) {
          ...
          if (_temp_35171._isBuilt ()) {
            ...
            if (_method != NULL) {
              _method (_inLexique, _temp_35171 (HERE), var_cas_inAccessBankSplitOffset, var_cas_routineMap, var_cas_inRegisterTable, var_cas_currentBank, GGS_bool (true, false), var_cas_continuesInSequence, GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1041)) ;
            }
          }
        }
      }
