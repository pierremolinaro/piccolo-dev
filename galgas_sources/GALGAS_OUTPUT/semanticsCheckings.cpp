...
category_method__instruction_structured_if__check (C_Compiler & _inLexique,
  ...
  if (operand_27702 != NULL) {
    ...
    ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_elsePartCurrentBank,  var_cas_inShouldPreserveBSR,  var_cas_continuesInSequence,  var_cas_inRoutineKind,  operand_27702->mElseInstructionList COMMA_SOURCE_FILE_AT_LINE (840)) ;
    if (((var_cas_elsePartCurrentBank)._operator_isNotEqual (var_cas_firstBranchFinalBank)).isBuiltAndTrue ()) {
      operand_27702->mEndOfElsePartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave BSR value as the first one does") COMMA_SOURCE_FILE_AT_LINE (852)) ;
...
category_method__instruction_do_while__check (C_Compiler & _inLexique,
                                const cPtr_instruction_do_while * operand_29167,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29167 != NULL) {
    GGS_uint  var_cas_finalBank ;
    var_cas_finalBank = var_cas_ioCurrentBank ;
    ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_finalBank,  var_cas_inShouldPreserveBSR,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind,  operand_29167->mRepeatedInstructionList COMMA_SOURCE_FILE_AT_LINE (872)) ;
    if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_finalBank)).isBuiltAndTrue ()) {
      operand_29167->mEndOfRepeatedInstructionList.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (884)) ;
    }
    {
      GGS_partList::cEnumerator enumerator_29830 (operand_29167->mWhilePartList, true) ;
      const GGS_partList::cElement * operand_29830 = NULL ;
      while (((operand_29830 = enumerator_29830.nextObject ()))) {
        macroValidPointer (operand_29830) ;
        const GGS_conditionExpression  _temp_29864 = operand_29830->mCondition ;
        if (_temp_29864._isBuilt ()) {
          typeCategoryMethod__conditionExpression__checkCondition _method = findCategoryMethod__conditionExpression__checkCondition (_temp_29864._galgasObjectRunTimeInfo ()) ;
          if (_method != NULL) {
            _method (_inLexique, _temp_29864 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank COMMA_SOURCE_FILE_AT_LINE (888)) ;
          }
        }
        GGS_uint  var_cas_bank ;
        var_cas_bank = var_cas_ioCurrentBank ;
        ::routine_checkInstructionList (_inLexique,  var_cas_inAccessBankSplitOffset,  var_cas_inRoutineMap,  var_cas_inRegisterTable,  var_cas_bank,  var_cas_inShouldPreserveBSR,  var_cas_ioContinuesInSequence,  var_cas_inRoutineKind,  operand_29830->mInstructionList COMMA_SOURCE_FILE_AT_LINE (893)) ;
        if (((var_cas_ioCurrentBank)._operator_isNotEqual (var_cas_bank)).isBuiltAndTrue ()) {
          operand_29830->mEndOfPartLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This branch does not leave BSR value unchanged") COMMA_SOURCE_FILE_AT_LINE (905)) ;
        }
      }
    }
  }
...
category_method__instruction_IF_IncDec__check (C_Compiler & _inLexique,
                                const cPtr_instruction_IF_IncDec * operand_30493,
                                const GGS_uint   var_cas_inAccessBankSplitOffset,
                                const GGS_routineMap   var_cas_inRoutineMap,
                                const GGS_registerTable   var_cas_inRegisterTable,
                                GGS_uint  & var_cas_ioCurrentBank,
                                ...
                                const GGS_routineKind  var_cas_inRoutineKind
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30493 != NULL) {
    GGS_bitSliceTable  automatic_var_21 ;
    const GGS_registerExpression  _temp_30745 = operand_30493->mRegisterExpression ;
    if (_temp_30745._isBuilt ()) {
      typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess _method = findCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess (_temp_30745._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_30745 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRegisterTable, var_cas_ioCurrentBank, automatic_var_21 COMMA_SOURCE_FILE_AT_LINE (921)) ;
      }
    }
    GGS_bool var_cas_unusedContinuesInSequence ;
    var_cas_unusedContinuesInSequence = GGS_bool (true, true) ;
    const GGS_piccolo_instruction  _temp_30956 = operand_30493->mInstruction ;
    if (_temp_30956._isBuilt ()) {
      typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_30956._galgasObjectRunTimeInfo ()) ;
      if (_method != NULL) {
        _method (_inLexique, _temp_30956 (HERE), var_cas_inAccessBankSplitOffset, var_cas_inRoutineMap, var_cas_inRegisterTable, var_cas_ioCurrentBank, var_cas_inShouldPreserveBSR, var_cas_unusedContinuesInSequence, var_cas_inRoutineKind COMMA_SOURCE_FILE_AT_LINE (929)) ;
      }
    }
  }
}
...
void routine_semanticsCheckings (C_Compiler & _inLexique,
  ...
  {
    GGS_routineDefinitionList::cEnumerator enumerator_31566 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (952)), true) ;
    const GGS_routineDefinitionList::cElement * operand_31566 = NULL ;
    while (((operand_31566 = enumerator_31566.nextObject ()))) {
      macroValidPointer (operand_31566) ;
      if ((((operand_31566->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (953)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_31566->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (953)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_31566->mRequiredBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the required bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (954)) ;
      }
      if ((((operand_31566->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE)))._operator_and ((operand_31566->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (956)))._operator_strictSup (GGS_uint (true, 15U)))).isBuiltAndTrue ()) {
        operand_31566->mReturnedBank.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the returned bank value should be lower or equal to 15") COMMA_SOURCE_FILE_AT_LINE (957)) ;
      }
      var_cas_routineMap.modifier_insertKey (_inLexique, operand_31566->mRoutineName, operand_31566->mIsNoReturn, operand_31566->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (959)), operand_31566->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (959)), operand_31566->mPreservesBank COMMA_SOURCE_FILE_AT_LINE (959)) ;
    }
  }
  if ((var_cas_routineMap.reader_hasKey (_inLexique, GGS_string (true, "main") COMMA_SOURCE_FILE_AT_LINE (962))).isBuiltAndTrue ()) {
    GGS_bool var_cas_isNoReturn ;
    GGS_uint  var_cas_requiredBank ;
    GGS_uint  automatic_var_22 ;
    GGS_bool automatic_var_23 ;
    const GGS_routineMap  _temp_32272 = var_cas_routineMap ;
    if (_temp_32272._isBuilt ()) {
      _temp_32272 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "main"), GGS_location (_inLexique) COMMA_HERE), var_cas_isNoReturn, var_cas_requiredBank, automatic_var_22, automatic_var_23 COMMA_SOURCE_FILE_AT_LINE (965)) ;
    }
    if (((var_cas_isNoReturn)._operator_not ()).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"noreturn\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (967)) ;
    }
    if (((var_cas_requiredBank)._operator_isNotEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the \"main\" should be declared with \"requiresbank 0\" qualifier: \"noreturn main requiresbank 0\"") COMMA_SOURCE_FILE_AT_LINE (970)) ;
    }
  }else{
    var_cas_inPiccoloModel.reader_mEndOfProgram (_inLexique COMMA_SOURCE_FILE_AT_LINE (973)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the program should declare the \"main\" routine") COMMA_SOURCE_FILE_AT_LINE (973)) ;
  }
  {
    GGS_routineDefinitionList::cEnumerator enumerator_32839 (var_cas_inPiccoloModel.reader_mRoutineDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (976)), true) ;
    const GGS_routineDefinitionList::cElement * operand_32839 = NULL ;
    while (((operand_32839 = enumerator_32839.nextObject ()))) {
      macroValidPointer (operand_32839) ;
      GGS_bool var_cas_continuesInSequence ;
      var_cas_continuesInSequence = GGS_bool (true, true) ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = operand_32839->mRequiredBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)) ;
      GGS_routineKind var_cas_routineKind ;
      if ((operand_32839->mIsNoReturn).isBuiltAndTrue ()) {
      ...
      {
        GGS_instructionList::cEnumerator enumerator_33166 (operand_32839->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_33166 = NULL ;
        while (((operand_33166 = enumerator_33166.nextObject ()))) {
          macroValidPointer (operand_33166) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_33166->mInstruction.reader_mInstructionLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (987)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unreachable code") COMMA_SOURCE_FILE_AT_LINE (987)) ;
            var_cas_continuesInSequence = GGS_bool (true, true) ;
          }
          const GGS_piccolo_instruction  _temp_33370 = operand_33166->mInstruction ;
          if (_temp_33370._isBuilt ()) {
            typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_33370._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_33370 (HERE), var_cas_inAccessBankSplitOffset, var_cas_routineMap, var_cas_inRegisterTable, var_cas_currentBank, operand_32839->mPreservesBank, var_cas_continuesInSequence, var_cas_routineKind COMMA_SOURCE_FILE_AT_LINE (990)) ;
            }
          }
        }
      }
      if (((((operand_32839->mIsNoReturn)._operator_not ())._operator_and ((operand_32839->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1000)))._operator_isNotEqual (GGS_uint ::constructor_max (_inLexique COMMA_HERE))))._operator_and ((var_cas_currentBank)._operator_isNotEqual (operand_32839->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1000))))).isBuiltAndTrue ()) {
        operand_32839->mEndOfRoutineLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "execution will not set BSR to "))._operator_concat (operand_32839->mReturnedBank.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1001)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1001))) COMMA_SOURCE_FILE_AT_LINE (1001)) ;
      }
      if (((operand_32839->mIsNoReturn)._operator_and (var_cas_continuesInSequence)).isBuiltAndTrue ()) {
        operand_32839->mEndOfRoutineLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution should not reach the end of a \"noreturn\" routine") COMMA_SOURCE_FILE_AT_LINE (1004)) ;
      }
    }
  }
  {
    GGS_interruptDefinitionList::cEnumerator enumerator_34038 (var_cas_inPiccoloModel.reader_mInterruptDefinitionList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1008)), true) ;
    const GGS_interruptDefinitionList::cElement * operand_34038 = NULL ;
    while (((operand_34038 = enumerator_34038.nextObject ()))) {
      macroValidPointer (operand_34038) ;
      GGS_bool var_cas_continuesInSequence ;
      var_cas_continuesInSequence = GGS_bool (true, true) ;
      GGS_uint  var_cas_currentBank ;
      var_cas_currentBank = GGS_uint ::constructor_max (_inLexique COMMA_HERE) ;
      {
        GGS_instructionList::cEnumerator enumerator_34175 (operand_34038->mInstructionList, true) ;
        const GGS_instructionList::cElement * operand_34175 = NULL ;
        while (((operand_34175 = enumerator_34175.nextObject ()))) {
          macroValidPointer (operand_34175) ;
          if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
            operand_34175->mInstruction.reader_mInstructionLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1013)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unreachable code") COMMA_SOURCE_FILE_AT_LINE (1013)) ;
            var_cas_continuesInSequence = GGS_bool (true, true) ;
          }
          const GGS_piccolo_instruction  _temp_34379 = operand_34175->mInstruction ;
          if (_temp_34379._isBuilt ()) {
            typeCategoryMethod__piccolo_instruction__check _method = findCategoryMethod__piccolo_instruction__check (_temp_34379._galgasObjectRunTimeInfo ()) ;
            if (_method != NULL) {
              _method (_inLexique, _temp_34379 (HERE), var_cas_inAccessBankSplitOffset, var_cas_routineMap, var_cas_inRegisterTable, var_cas_currentBank, (operand_34038->mFastReturn)._operator_not (), var_cas_continuesInSequence, GGS_routineKind::constructor_interruptRoutine (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1016)) ;
            }
          }
        }
      }
      if (((var_cas_continuesInSequence)._operator_not ()).isBuiltAndTrue ()) {
        operand_34038->mEndOfInterruptLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "execution cannot reach the end of the interrupt routine") COMMA_SOURCE_FILE_AT_LINE (1027)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
