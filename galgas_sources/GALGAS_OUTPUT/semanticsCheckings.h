//---------------------------------------------------------------------------*
//                                                                           *
//                       File 'semanticsCheckings.h'                         *
//                 Generated by version GALGAS_BETA_VERSION                  *
//                      august 1st, 2008, at 13h28'31"                       *
//                                                                           *
//---------------------------------------------------------------------------*
...
#ifndef semanticsCheckings_DEFINED
#define semanticsCheckings_DEFINED
...
//---------------------------------------------------------------------------*
//                                                                           *
//          Category method '@bitNumberExpression.checkBitNumber'            *
//                                                                           *
//---------------------------------------------------------------------------*

typedef void (*typeCategoryMethod__bitNumberExpression__checkBitNumber)  (C_Compiler & _inLexique,
...
typedef void (*typeCategoryMethod__registerExpression__checkRegisterDeclaration)  (C_Compiler & _inLexique,
...
typedef void (*typeCategoryMethod__registerExpression__checkRegisterDeclarationAndAddressLowerThan256)  (C_Compiler & _inLexique,
                                const cPtr_registerExpression * inObjectPtr,
                                const GGS_registerTable   var_cas_inRegisterTable
                                COMMA_LOCATION_ARGS) ;
...
typedef void (*typeCategoryMethod__registerExpression__checkRegisterAddressingAndBankAccess)  (C_Compiler & _inLexique,
                                const cPtr_registerExpression * inObjectPtr,
...
typedef void (*typeCategoryMethod__piccolo_instruction__check)  (C_Compiler & _inLexique,
...
//---------------------------------------------------------------------------*
//                                                                           *
//          Category method '@conditionExpression.checkCondition'            *
//                                                                           *
//---------------------------------------------------------------------------*

typedef void (*typeCategoryMethod__conditionExpression__checkCondition)  (C_Compiler & _inLexique,
...
void routine_checkInstructionList (C_Compiler &,
                                const GGS_uint  ,
                                const GGS_routineMap  ,
                                const GGS_registerTable  ,
                                const GGS_uint  ,
                                GGS_bool &,
                                const GGS_routineKind ,
...
void routine_semanticsCheckings (C_Compiler &,
                                const GGS_uint  ,
                                const GGS_registerTable  ,
