...
//GALGAS_binaryCode::GALGAS_binaryCode (void) :
//mIsValid (false),
//mByteDefined (),
//mDataByte (),
//mEmitAddress (0) {
...
//bool GALGAS_binaryCode::isValid (void) const {
//  return mIsValid ;
//}

//---------------------------------------------------------------------------*

//void GALGAS_binaryCode::drop (void) {
//  mIsValid = false;
//}
...
//typeComparisonResult GALGAS_binaryCode::objectCompare (const GALGAS_binaryCode & inOperand) const {
//  typeComparisonResult result = kOperandNotValid ;
//  if (isValid () && inOperand.isValid ()) {
//    if (mEmitAddress < inOperand.mEmitAddress) {
//      result = kFirstOperandLowerThanSecond ;
//    }else if (mEmitAddress > inOperand.mEmitAddress) {
...
//          result = kFirstOperandGreaterThanSecond ;
//        }else if (mByteDefined [i] && inOperand.mByteDefined [i]) {
//          if (mDataByte [i] < inOperand.mDataByte [i]) {
//            result = kFirstOperandLowerThanSecond ;
//          }else if (mDataByte [i] > inOperand.mDataByte [i]) {
//            result = kFirstOperandGreaterThanSecond ;
//          }
//        }
//      }
...
//GALGAS_binaryCode GALGAS_binaryCode::constructor_new (C_Compiler * /* inCompiler */
//                                                      COMMA_UNUSED_LOCATION_ARGS) {
//  GALGAS_binaryCode result ;
...
//void GALGAS_binaryCode::modifier_setEmitAddress (GALGAS_uint constinArgument0,
//                                                 C_Compiler * /* inCompiler */
//                                                 COMMA_UNUSED_LOCATION_ARGS) {
//  if (constinArgument0.isValid ()) {
//    mEmitAddress = constinArgument0.uintValue () ;
//  }else{
//    drop () ;
//  }
//}
...
//GALGAS_uint GALGAS_binaryCode::reader_currentEmitAddress (C_Compiler * /* inCompiler */
//                                                          COMMA_UNUSED_LOCATION_ARGS) const {
//  GALGAS_uint result ;
//  if (isValid ()) {
//    result = GALGAS_uint (mEmitAddress) ;
//  }
//  return result ;
//}
...
//void GALGAS_binaryCode::modifier_emitCode (GALGAS_uint inValue,
//                                           C_Compiler * inCompiler
//                                           COMMA_LOCATION_ARGS) {
//  if (isValid () && inValue.isValid ()) {
//    if ((mEmitAddress & 1) != 0) {
//      C_String message ;
//      message << "Modifier @binaryCode emitCode: emit address is 0x" ;
//      message.appendUnsignedHex4 (mEmitAddress) ;
//      message << " is odd (should be even)" ;
//      inCompiler->onTheFlyRunTimeError (message COMMA_THERE) ;
//    }else if (mEmitAddress > 0xFFFE) {
//      C_String message ;
//      message << "Modifier @binaryCode emitCode: emit address is 0x" ;
//      message.appendUnsignedHex4 (mEmitAddress) ;
...
//        message.appendUnsignedHex4 (mEmitAddress) ;
//        message << " providen data is 0x" ;
//        message.appendUnsignedHex8 (v) ;
...
//void GALGAS_binaryCode::modifier_emitByte (GALGAS_uint inValue,
//                                           C_Compiler * inCompiler
//                                           COMMA_LOCATION_ARGS) {
//  if (isValid () && inValue.isValid ()) {
//    if (mEmitAddress > 0xFFFF) {
//      C_String message ;
//      message << "Modifier @binaryCode emitByte: emit address is 0x" ;
//      message.appendUnsignedHex4 (mEmitAddress) ;
//      message << " (should be <= 0xFFFF)" ;
//      inCompiler->onTheFlyRunTimeError (message COMMA_THERE) ;
//    }else{
...
//    C_String message ;
//    message << "byte at address is 0x" ;
//    message.appendUnsignedHex4 (mEmitAddress) ;
//    message << " is already defined" ;
//    inCompiler->onTheFlyRunTimeError (message COMMA_THERE) ;
//  }else{
//    mByteDefined [mEmitAddress] = true ;
//    mDataByte [mEmitAddress] = inValue ;
//    mEmitAddress ++ ;
//  }
//}
...
//GALGAS_string GALGAS_binaryCode::reader_getGeneratedContents (C_Compiler * /*inCompiler */
//                                                              COMMA_UNUSED_LOCATION_ARGS) const {
//  GALGAS_string result ;
//  if (isValid()) {
//    C_String contents ;
//  
//    result = GALGAS_string (contents) ;
//  }
//  return result ;
//}
