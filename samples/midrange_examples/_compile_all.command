...
cd `dirname $0` &&
echo "-------------- if_semi_colon" &&
piccolo -v -S -O -L --Werror if_semi_colon.piccolo &&
...
piccolo -v -S -L --Werror structured_if.piccolo &&
