...
piccolo -v -S -O -L --Werror relative_branch_limits.piccolo &&
...
#--- IF and DO tests
echo "-------------- if_do_tests" &&
piccolo -v -S -O -L --Werror if_do_tests.piccolo &&
...
piccolo -v -S -O -L --Werror code_bigger_than_64k.piccolo &&
...
piccolo -v -S -O -L --Werror commonDeclarations.piccolo &&
...
piccolo -v -S -O -L --Werror bootloader_user_program.piccolo &&
