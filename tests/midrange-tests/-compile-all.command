...
../../makefile-macosx/piccolo -v -S -O -L --Werror firmware_16F690.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror blink_led_12F683.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror blink_led_it_12F683.piccolo &&
...
echo "-------------- if_semi_colon" &&
../../makefile-macosx/piccolo -v -S -O -L --Werror if_semi_colon.piccolo &&
...
#../../makefile-macosx/piccolo -v -S -L --Werror structured_if.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror structured_if.piccolo &&
$GPUTILS_PATH/gpasm structured_if.asm -o structured_if-2.hex &&
hexcmp structured_if.hex structured_if-2.hex &&
echo "-------------- multiple_pages" &&
../../makefile-macosx/piccolo -v -S -O -L --Werror multiple_pages.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror blink_led_it_pages_16F690.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror interrupt_16F873_page_0.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror interrupt_16F873_several_pages.piccolo &&
