...
../../makefile-macosx/piccolo -v -S -O -L --Werror relative_branch_limits.piccolo &&
...
#--- IF and DO tests
echo "-------------- if_do_tests" &&
../../makefile-macosx/piccolo -v -S -O -L --Werror if_do_tests.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror code_bigger_than_64k.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror blink_led_18F448.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror blink_led_18F4480.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror blink_led_18F4480_with_blocks.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror blink_led_it_18F448.piccolo &&
...
#--- Exemples BSR
echo "-------------- exemples_bsr" &&
../../makefile-macosx/piccolo -v -S -O -L --Werror exemples_bsr.piccolo &&
$GPUTILS_PATH/gpasm exemples_bsr.asm -o exemples_bsr-2.hex &&
hexcmp exemples_bsr.hex exemples_bsr-2.hex &&
#--- Optimisations
echo "-------------- optimizations" &&
../../makefile-macosx/piccolo -v -S -O -L --Werror optimizations.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror repetition_statique_pic18.piccolo &&
...
#--- Computed RCALL
echo "-------------- Computed RCALL" &&
../../makefile-macosx/piccolo -v -S -O -L --Werror computed_rcall_samples.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror bootloader_specification.piccolo &&
#--- Bootloader implementation
echo "-------------- Bootloader implementation" &&
../../makefile-macosx/piccolo -v -S -O -L --Werror bootloader_implementation.piccolo &&
...
../../makefile-macosx/piccolo -v -S -O -L --Werror bootloader_user_program.piccolo &&
